...
[![Binaries (Stable)](https://api.bintray.com/packages/masd-project/main/dogen/images/download.svg?version=1.0.25) ](https://bintray.com/masd-project/main/dogen/1.0.25/link)
[![GitHub commits](https://img.shields.io/github/commits-since/MASD-Project/dogen/v1.0.25.svg)](https://github.com/MASD-Project/dogen/commits/master)
...
Where ```${VERSION}``` is your Dogen version such as ```1.0.25```.
