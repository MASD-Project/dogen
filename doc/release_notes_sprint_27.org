...
Clock summary at [2013-05-27 Mon 01:01]

| Headline                                                | Time    |       |       |
|---------------------------------------------------------+---------+-------+-------|
| *Total time*                                            | *21:00* |       |       |
|---------------------------------------------------------+---------+-------+-------|
| Development Stories Implemented                         |         | 21:00 |       |
| COMPLETED Make inclusion lists in includer a model type |         |       |  0:15 |
| IMPLEMENTATION Clean up the SML to C++ transformer      |         |       | 20:45 |
#+end:
...
**** IMPLEMENTATION Add support for inheritance in workflow
