...
Clock summary at [2013-05-27 Mon 02:27]

| Headline                                                | Time    |       |       |
|---------------------------------------------------------+---------+-------+-------|
| *Total time*                                            | *22:25* |       |       |
|---------------------------------------------------------+---------+-------+-------|
| Development Stories Implemented                         |         | 22:25 |       |
| COMPLETED Make inclusion lists in includer a model type |         |       |  0:15 |
| IMPLEMENTATION Clean up the SML to C++ transformer      |         |       | 22:10 |
#+end:
...
**** IMPLEMENTATION Add support for visitor
