...
Clock summary at [2013-05-27 Mon 21:40]

| Headline                                                | Time    |       |       |
|---------------------------------------------------------+---------+-------+-------|
| *Total time*                                            | *23:51* |       |       |
|---------------------------------------------------------+---------+-------+-------|
| Development Stories Implemented                         |         | 23:51 |       |
| COMPLETED Make inclusion lists in includer a model type |         |       |  0:15 |
| COMPLETED Clean up the SML to C++ transformer           |         |       | 23:16 |
| IMPLEMENTATION Rename =enumeration_info= to =enum_info= |         |       |  0:20 |
#+end:
...
*** IMPLEMENTATION Rename =enumeration_info= to =enum_info=
