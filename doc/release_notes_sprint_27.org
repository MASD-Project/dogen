...
Clock summary at [2013-05-26 Sun 20:37]

| Headline                                                | Time    |       |       |
|---------------------------------------------------------+---------+-------+-------|
| *Total time*                                            | *18:08* |       |       |
|---------------------------------------------------------+---------+-------+-------|
| Development Stories Implemented                         |         | 18:08 |       |
| COMPLETED Make inclusion lists in includer a model type |         |       |  0:15 |
| IMPLEMENTATION Clean up the SML to C++ transformer      |         |       | 17:53 |
#+end:
...
**** IMPLEMENTATION Create workflow tests and fix new code
