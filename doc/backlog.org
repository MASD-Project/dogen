...
*** Use boost exception infrastructure for inner exceptions

At present our exceptions are not very meaningful; we are not giving
any context around the error. Boost exception comes with support for
this:

http://www.boost.org/doc/libs/1_43_0/libs/exception/doc/motivation.html

We need to start using this infrastructure.
