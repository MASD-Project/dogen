...
Clock summary at [2013-05-12 Sun 20:58]

| Headline                                                                     | Time    |       |      |
|------------------------------------------------------------------------------+---------+-------+------|
| *Total time*                                                                 | *21:02* |       |      |
|------------------------------------------------------------------------------+---------+-------+------|
| Development Stories Implemented                                              |         | 21:02 |      |
...
| IMPLEMENTATION Remove view model namespace and postfix                       |         |       | 1:28 |
...
**** IMPLEMENTATION Move types to top-level namespace
