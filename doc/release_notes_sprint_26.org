...
Clock summary at [2013-05-08 Wed 00:19]

| Headline                                                      | Time   |      |      |
|---------------------------------------------------------------+--------+------+------|
| *Total time*                                                  | *3:37* |      |      |
|---------------------------------------------------------------+--------+------+------|
| Development Stories Implemented                               |        | 3:37 |      |
| COMPLETED Fix build break on visitor tests                    |        |      | 0:32 |
| IMPLEMENTATION Remove workflow aspects from transformer       |        |      | 1:57 |
| Add tests for profiler                                        |        |      | 0:17 |
| IMPLEMENTATION Re-implement key support                       |        |      | 0:15 |
...
*** IMPLEMENTATION Add tests for profiler                             :story:
