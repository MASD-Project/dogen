...
Clock summary at [2013-05-19 Sun 00:46]

| Headline                                                                     | Time    |       |      |
|------------------------------------------------------------------------------+---------+-------+------|
| *Total time*                                                                 | *32:23* |       |      |
|------------------------------------------------------------------------------+---------+-------+------|
| Development Stories Implemented                                              |         | 32:23 |      |
...
| IMPLEMENTATION Clean up the SML to C++ transformer                           |         |       | 8:15 |
...
**** IMPLEMENTATION Add support for package transformation
