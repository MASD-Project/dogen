...
Clock summary at [2013-05-11 Sat 04:45]

| Headline                                                      | Time    |       |      |
|---------------------------------------------------------------+---------+-------+------|
| *Total time*                                                  | *10:20* |       |      |
|---------------------------------------------------------------+---------+-------+------|
| Development Stories Implemented                               |         | 10:20 |      |
...
| IMPLEMENTATION Add =extract_key= function                     |         |       | 0:08 |
| IMPLEMENTATION Add injector tests                             |         |       | 0:42 |
...
*** IMPLEMENTATION Add injector tests                                 :story:
