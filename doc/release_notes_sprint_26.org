...
Clock summary at [2013-05-14 Tue 00:10]

| Headline                                                                     | Time    |       |      |
|------------------------------------------------------------------------------+---------+-------+------|
| *Total time*                                                                 | *24:08* |       |      |
|------------------------------------------------------------------------------+---------+-------+------|
| Development Stories Implemented                                              |         | 24:08 |      |
...
| IMPLEMENTATION Clean up the SML to C++ transformer                           |         |       | 1:08 |
...
**** IMPLEMENTATION Create skeleton for transformer and specs
