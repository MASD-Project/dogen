...
*** The Dogen Command Line Options
...
version is, go to the [[https://github.com/DomainDrivenConsulting/dogen][project page]] in GitHub and look at the number of
commits there.
...
- *General options*: these are not directly related to operational
  aspects, but provide information about the application.
...
We have already seen both =help= and =version=, the most important of the
general options group. Lets look at the remaining groups in more detail.
