...
Clock summary at [2014-05-06 Tue 22:41]

| Headline                                                    | Time   |      |      |
|-------------------------------------------------------------+--------+------+------|
| *Total time*                                                | *6:10* |      |      |
|-------------------------------------------------------------+--------+------+------|
| Development Stories Implemented                             |        | 6:10 |      |
...
| IMPLEMENTATION Move all the configuration options into tags |        |      | 1:19 |
#+end:
...
**** COMPLETED Add missing config options such as annotations to =config= :task:
