...
Clock summary at [2014-05-07 Wed 09:07]

| Headline                                                    | Time   |      |      |
|-------------------------------------------------------------+--------+------+------|
| *Total time*                                                | *8:00* |      |      |
|-------------------------------------------------------------+--------+------+------|
| Development Stories Implemented                             |        | 8:00 |      |
...
| IMPLEMENTATION Move all the configuration options into tags |        |      | 2:53 |
#+end:
...
*** COMPLETED Add support for unique log files                  :story:spike:
...
**** IMPLEMENTATION Split command line settings from model settings   :story:
