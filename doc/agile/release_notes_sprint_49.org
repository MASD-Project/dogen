...
Clock summary at [2014-05-12 Mon 22:35]
...
| IMPLEMENTATION Release notes and backlog grooming               |         |       | 2:42 |
...
*** Split name from content descriptor                                :story:

The qualified name is not really a part of the content descriptor, it
was put there for expediency.
...
**** Get formatters to register themselves with workflow              :story:
