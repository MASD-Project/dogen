...
Clock summary at [2014-05-09 Fri 22:53]

| Headline                                                        | Time    |       |      |
|-----------------------------------------------------------------+---------+-------+------|
| *Total time*                                                    | *14:04* |       |      |
|-----------------------------------------------------------------+---------+-------+------|
| Development Stories Implemented                                 |         | 14:04 |      |
...
| IMPLEMENTATION Split formatting settings from knitting settings |         |       | 4:49 |
...
**** Start using formatting settings in formatters model               :task:
