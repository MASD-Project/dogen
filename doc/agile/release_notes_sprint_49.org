...
Clock summary at [2014-05-08 Thu 23:03]

| Headline                                                    | Time    |       |      |
|-------------------------------------------------------------+---------+-------+------|
| *Total time*                                                | *11:50* |       |      |
|-------------------------------------------------------------+---------+-------+------|
| Development Stories Implemented                             |         | 11:50 |      |
| IMPLEMENTATION Release notes and backlog grooming           |         |       | 1:40 |
...
| IMPLEMENTATION Move all the configuration options into tags |         |       | 3:01 |
#+end:
