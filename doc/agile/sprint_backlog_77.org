...
#+CAPTION: Clock summary at [2016-01-01 Fri 18:02]
| <75>                                                                        |         |       |       |
| Headline                                                                    | Time    |       |       |
|-----------------------------------------------------------------------------+---------+-------+-------|
| *Total time*                                                                | *34:32* |       |       |
...
*** Update settings bundle to include property settings               :story:
...
*** Supply formatter properties and settings directly to formatter    :story:
