...
#+CAPTION: Clock summary at [2015-12-23 Wed 16:58]
| <75>                                                                        |         |       |      |
| Headline                                                                    | Time    |       |      |
|-----------------------------------------------------------------------------+---------+-------+------|
| *Total time*                                                                | *12:47* |       |      |
...
| STARTED Add =iconv.h= to include path on windows                            |         |       | 0:44 |
| STARTED Improve names in yarn around model element location                 |         |       | 0:30 |
| STARTED Add qualified name to yarn properties                               |         |       | 0:31 |
#+end:
...
*** STARTED Add =iconv.h= to include path on windows                  :story:
...
*** STARTED Improve names in yarn around model element location       :story:
...
*** STARTED Add qualified name to yarn properties                     :story:
...
*** Create a top-level settings class with all of the required settings :story:

We need to split settings from element in cpp in preparation for using
yarn types. This means:

- stand alone class with all settings including opaque settings for
  properties.
- change all formatter interfaces to take the formattable and the
  settings separately.
