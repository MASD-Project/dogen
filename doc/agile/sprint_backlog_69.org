...
#+CAPTION: Clock summary at [2015-06-23 Tue 17:55]
| <75>                                                                        |        |      |      |
| Headline                                                                    | Time   |      |      |
|-----------------------------------------------------------------------------+--------+------+------|
| *Total time*                                                                | *6:27* |      |      |
...
| STARTED Add support for opaque settings factories                           |        |      | 0:17 |
#+end:
...
*** STARTED Add support for opaque settings factories                 :story:
