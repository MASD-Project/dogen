...
#+CAPTION: Clock summary at [2015-06-30 Tue 17:30]
| <75>                                                                        |         |       |      |
| Headline                                                                    | Time    |       |      |
|-----------------------------------------------------------------------------+---------+-------+------|
| *Total time*                                                                | *30:48* |       |      |
...
| STARTED Implement odb options formatter in odb                              |         |       | 1:04 |
#+end:
...
- add boilerplate to legacy settings.
- we need to obtain the general settings to generate boilerplate. We
  should copy it from the root object.
