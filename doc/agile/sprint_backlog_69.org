...
#+CAPTION: Clock summary at [2015-06-25 Thu 16:46]
| <75>                                                                        |         |       |      |
| Headline                                                                    | Time    |       |      |
|-----------------------------------------------------------------------------+---------+-------+------|
| *Total time*                                                                | *14:51* |       |      |
...
| STARTED Create a formattables factory                                       |         |       | 0:10 |
| STARTED Thoughts on cpp refactoring                                         |         |       | 1:56 |
#+end:
...
because we are missing some entities.

What is probably needed is to have facets, aspects and "file kinds" as
top-level concepts. We need a good name for "file kinds". This is a
meta-concept, something akin to a file template. The formatter
...
- facet is a good name for grouping archetypes, but model isn't. We
  ...
  conceptual representations in different programming languages.
