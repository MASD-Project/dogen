...
#+CAPTION: Clock summary at [2015-07-01 Wed 17:51]
| <75>                                                                        |         |       |      |
| Headline                                                                    | Time    |       |      |
|-----------------------------------------------------------------------------+---------+-------+------|
| *Total time*                                                                | *34:46* |       |      |
...
| STARTED Implement odb options formatter in odb                              |         |       | 3:34 |
#+end:
...
- we need to obtain the general settings to generate boilerplate. We
  ...
  object.
- extend trivial formatter with annotation formatting support.
