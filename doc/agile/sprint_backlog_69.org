...
#+CAPTION: Clock summary at [2015-06-24 Wed 15:49]
| <75>                                                                        |         |       |      |
| Headline                                                                    | Time    |       |      |
|-----------------------------------------------------------------------------+---------+-------+------|
| *Total time*                                                                | *10:52* |       |      |
...
| STARTED Handling of "singleton" formatters                                  |         |       | 1:34 |
#+end:
...
*** STARTED Handling of "singleton" formatters                        :story:
