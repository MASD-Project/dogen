...
#+CAPTION: Clock summary at [2015-07-05 Sun 23:11]
| <75>                                                                        |         |       |      |
| Headline                                                                    | Time    |       |      |
|-----------------------------------------------------------------------------+---------+-------+------|
| *Total time*                                                                | *44:23* |       |      |
...
| STARTED Thoughts on simplifying the formattables generation                 |         |       | 2:43 |
| STARTED Implement serialisation registrar implementation formatter          |         |       | 2:30 |
#+end:
