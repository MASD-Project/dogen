...
Clock summary at [2013-12-10 Tue 09:09]

| Headline                                                                   | Time    |       |      |
|----------------------------------------------------------------------------+---------+-------+------|
| *Total time*                                                               | *11:43* |       |      |
|----------------------------------------------------------------------------+---------+-------+------|
| Development Stories Implemented                                            |         | 11:43 |      |
...
| IMPLEMENTATION Create a =property_indexer= and add tests                   |         |       | 5:23 |
| IMPLEMENTATION Checking that a model hasn't changed by copying it is wrong |         |       | 0:13 |
#+end:
...
*** IMPLEMENTATION Checking that a model hasn't changed by copying it is wrong :spike:
