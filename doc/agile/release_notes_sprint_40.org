...
Clock summary at [2013-12-15 Sun 00:33]

| Headline                                                                  | Time    |       |       |
|---------------------------------------------------------------------------+---------+-------+-------|
| *Total time*                                                              | *26:53* |       |       |
|---------------------------------------------------------------------------+---------+-------+-------|
| Development Stories Implemented                                           |         | 26:53 |       |
...
| IMPLEMENTATION Remove entity and move all properties into abstract object |         |       |  0:13 |
...
*** IMPLEMENTATION Remove entity and move all properties into abstract object :story:
