...
Clock summary at [2013-12-06 Fri 12:39]

| Headline                                            | Time   |      |      |
|-----------------------------------------------------+--------+------+------|
| *Total time*                                        | *5:42* |      |      |
|-----------------------------------------------------+--------+------+------|
| Development Stories Implemented                     |        | 5:42 |      |
...
| IMPLEMENTATION Plug =concept_indexer= into workflow |        |      | 1:56 |
#+end:
...
**** IMPLEMENTATION Remove resolver concept indexing                   :task:
