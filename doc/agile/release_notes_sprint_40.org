...
Clock summary at [2013-12-14 Sat 21:31]

| Headline                                                              | Time    |       |       |
|-----------------------------------------------------------------------+---------+-------+-------|
| *Total time*                                                          | *24:16* |       |       |
|-----------------------------------------------------------------------+---------+-------+-------|
| Development Stories Implemented                                       |         | 24:16 |       |
...
| IMPLEMENTATION Use relationship container for keys                    |         |       |  0:52 |
...
**** IMPLEMENTATION Collapse all entity classes into just entity       :task:
