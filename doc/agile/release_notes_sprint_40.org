...
Clock summary at [2013-12-14 Sat 23:06]

| Headline                                                              | Time    |       |       |
|-----------------------------------------------------------------------+---------+-------+-------|
| *Total time*                                                          | *25:33* |       |       |
|-----------------------------------------------------------------------+---------+-------+-------|
| Development Stories Implemented                                       |         | 25:33 |       |
...
| IMPLEMENTATION Collapse all entity classes into just entity           |         |       |  1:17 |
...
*** IMPLEMENTATION Collapse all entity classes into just entity       :story:
