...
Clock summary at [2013-12-07 Sat 19:02]

| Headline                                                 | Time   |      |      |
|----------------------------------------------------------+--------+------+------|
| *Total time*                                             | *6:21* |      |      |
|----------------------------------------------------------+--------+------+------|
| Development Stories Implemented                          |        | 6:21 |      |
...
| IMPLEMENTATION Create a =property_indexer= and add tests |        |      | 0:14 |
#+end:
...
**** IMPLEMENTATION Implement indexing of properties
