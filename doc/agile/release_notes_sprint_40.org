...
Clock summary at [2013-12-12 Thu 17:42]

| Headline                                                              | Time    |       |       |
|-----------------------------------------------------------------------+---------+-------+-------|
| *Total time*                                                          | *16:41* |       |       |
|-----------------------------------------------------------------------+---------+-------+-------|
| Development Stories Implemented                                       |         | 16:41 |       |
...
| IMPLEMENTATION Create a =property_indexer= and add tests              |         |       | 10:01 |
#+end:
...
**** IMPLEMENTATION Remove all usages of =parent_name= and =original_parent_name= :spike:
