...
Clock summary at [2013-12-14 Sat 19:18]

| Headline                                                              | Time    |       |       |
|-----------------------------------------------------------------------+---------+-------+-------|
| *Total time*                                                          | *22:56* |       |       |
|-----------------------------------------------------------------------+---------+-------+-------|
| Development Stories Implemented                                       |         | 22:56 |       |
...
| IMPLEMENTATION Inclusion is broken with extractor changes             |         |       |  1:21 |
| IMPLEMENTATION Use relationship container for leaves                  |         |       |  0:44 |
...
*** IMPLEMENTATION Inclusion is broken with extractor changes         :spike:
...
**** IMPLEMENTATION Re-aply changes and try to fix borked code
