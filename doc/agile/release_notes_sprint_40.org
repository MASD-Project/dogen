...
Clock summary at [2013-12-15 Sun 17:55]

| Headline                                                                    | Time    |       |       |
|-----------------------------------------------------------------------------+---------+-------+-------|
| *Total time*                                                                | *34:18* |       |       |
|-----------------------------------------------------------------------------+---------+-------+-------|
| Development Stories Implemented                                             |         | 34:18 |       |
...
| COMPLETED Remove abstract object use of shared pointer in objects container |         |       |  3:29 |
| IMPLEMENTATION Use relationship container for visitors                      |         |       |  0:58 |
...
*** COMPLETED Remove abstract object use of shared pointer in objects container :story:
...
*** IMPLEMENTATION Use relationship container for visitors            :story:

We need to store the two-way relationships related to visitation.

**** COMPLETED Rename enumerators for visitor relationships            :task:
