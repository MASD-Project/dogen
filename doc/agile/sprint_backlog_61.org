...
*** Split file properties from includes                               :story:
...
*** Create provider and provider selector interfaces                  :story:
...
*** Start using =formatters::file= from legacy formatters             :story:
