...
Clock summary at [2015-02-03 Tue 23:00]
...
| STARTED Create a formattables workflow                |        |      | 0:42 |
#+end:
...
*** STARTED Create a formattables workflow                            :story:
...
*** Create a settings facade for querying                             :story:
...
*** Add global formatter settings support                             :story:
...
** Deprecated
*** Towards a more generic use of dynamic extensions                   :epic:
