...
#+CAPTION: Clock summary at [2016-02-12 Fri 18:47]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *21:46* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 21:46   |       |      | 100.0 |
| Active                                                                      |         | 21:46 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 3:35 |  16.5 |
| COMPLETED Make context non-generatable                                      |         |       | 0:49 |   3.8 |
| COMPLETED Setup logging syntax highlighting on emacs                        |         |       | 2:32 |  11.6 |
| COMPLETED Create next interesting blog post                                 |         |       | 0:37 |   2.8 |
| COMPLETED Rename =yarn::nested_name= to =yarn::name_tree=                   |         |       | 1:05 |   5.0 |
| COMPLETED Rename =type= to =parsed_type=                                    |         |       | 0:14 |   1.1 |
| COMPLETED Add index support for =yarn::name_tree=                           |         |       | 1:56 |   8.9 |
| COMPLETED Create a context factory                                          |         |       | 1:13 |   5.6 |
| COMPLETED Split dispatcher from formatters workflow and rename it           |         |       | 0:57 |   4.4 |
| COMPLETED Create a contributing document for Github                         |         |       | 0:22 |   1.7 |
| STARTED Help conan with strange warning                                     |         |       | 1:30 |   6.9 |
| STARTED Add an helper method interface                                      |         |       | 6:56 |  31.9 |
