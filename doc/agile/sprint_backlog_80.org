...
#+CAPTION: Clock summary at [2016-02-13 Sat 00:42]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *23:31* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 23:31   |       |      | 100.0 |
| Active                                                                      |         | 23:31 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 3:35 |  15.2 |
| COMPLETED Make context non-generatable                                      |         |       | 0:49 |   3.5 |
| COMPLETED Setup logging syntax highlighting on emacs                        |         |       | 2:32 |  10.8 |
| COMPLETED Create next interesting blog post                                 |         |       | 0:37 |   2.6 |
| COMPLETED Rename =yarn::nested_name= to =yarn::name_tree=                   |         |       | 1:05 |   4.6 |
| COMPLETED Rename =type= to =parsed_type=                                    |         |       | 0:14 |   1.0 |
| COMPLETED Add index support for =yarn::name_tree=                           |         |       | 1:56 |   8.2 |
| COMPLETED Create a context factory                                          |         |       | 1:13 |   5.2 |
| COMPLETED Split dispatcher from formatters workflow and rename it           |         |       | 0:57 |   4.0 |
| COMPLETED Create a contributing document for Github                         |         |       | 0:22 |   1.6 |
| STARTED Help conan with strange warning                                     |         |       | 1:30 |   6.4 |
| STARTED Add an helper method interface                                      |         |       | 6:56 |  29.5 |
| STARTED Add properties for helpers                                          |         |       | 1:45 |   7.4 |
