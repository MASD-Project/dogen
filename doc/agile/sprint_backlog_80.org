...
#+CAPTION: Clock summary at [2016-02-13 Sat 23:59]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *25:44* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 25:44   |       |      | 100.0 |
| Active                                                                      |         | 25:44 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 3:43 |  14.4 |
| COMPLETED Make context non-generatable                                      |         |       | 0:49 |   3.2 |
| COMPLETED Setup logging syntax highlighting on emacs                        |         |       | 2:32 |   9.8 |
| COMPLETED Create next interesting blog post                                 |         |       | 0:37 |   2.4 |
| COMPLETED Rename =yarn::nested_name= to =yarn::name_tree=                   |         |       | 1:05 |   4.2 |
| COMPLETED Rename =type= to =parsed_type=                                    |         |       | 0:14 |   0.9 |
| COMPLETED Add index support for =yarn::name_tree=                           |         |       | 1:56 |   7.5 |
| COMPLETED Create a context factory                                          |         |       | 1:13 |   4.7 |
| COMPLETED Split dispatcher from formatters workflow and rename it           |         |       | 0:57 |   3.7 |
| COMPLETED Create a contributing document for Github                         |         |       | 0:22 |   1.4 |
| STARTED Help conan with strange warning                                     |         |       | 1:30 |   5.8 |
| STARTED Add an helper method interface                                      |         |       | 6:56 |  26.9 |
| STARTED Add properties for helpers                                          |         |       | 3:50 |  14.9 |
...
*** Sort out problems with main machine                               :story:
