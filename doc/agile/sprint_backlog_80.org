...
#+CAPTION: Clock summary at [2016-02-13 Sat 12:12]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *23:45* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 23:45   |       |      | 100.0 |
| Active                                                                      |         | 23:45 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 3:35 |  15.1 |
| COMPLETED Make context non-generatable                                      |         |       | 0:49 |   3.4 |
| COMPLETED Setup logging syntax highlighting on emacs                        |         |       | 2:32 |  10.7 |
...
| COMPLETED Add index support for =yarn::name_tree=                           |         |       | 1:56 |   8.1 |
| COMPLETED Create a context factory                                          |         |       | 1:13 |   5.1 |
| COMPLETED Split dispatcher from formatters workflow and rename it           |         |       | 0:57 |   4.0 |
| COMPLETED Create a contributing document for Github                         |         |       | 0:22 |   1.5 |
| STARTED Help conan with strange warning                                     |         |       | 1:30 |   6.3 |
| STARTED Add an helper method interface                                      |         |       | 6:56 |  29.2 |
| STARTED Add properties for helpers                                          |         |       | 1:59 |   8.4 |
