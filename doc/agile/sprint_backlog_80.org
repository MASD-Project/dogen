...
#+CAPTION: Clock summary at [2016-02-11 Thu 22:44]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 19:09   |       |      | 100.0 |
| Active                                                                      |         | 19:09 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 3:30 |  18.3 |
| COMPLETED Make context non-generatable                                      |         |       | 0:49 |   4.3 |
| COMPLETED Setup logging syntax highlighting on emacs                        |         |       | 2:32 |  13.2 |
| COMPLETED Create next interesting blog post                                 |         |       | 0:37 |   3.2 |
| COMPLETED Rename =yarn::nested_name= to =yarn::name_tree=                   |         |       | 1:05 |   5.7 |
| COMPLETED Rename =type= to =parsed_type=                                    |         |       | 0:14 |   1.2 |
| COMPLETED Add index support for =yarn::name_tree=                           |         |       | 1:56 |  10.1 |
| STARTED Help conan with strange warning                                     |         |       | 1:30 |   7.8 |
| STARTED Add an helper method interface                                      |         |       | 6:56 |  36.2 |
