...
#+CAPTION: Clock summary at [2016-02-17 Wed 21:49]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *29:22* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 29:22   |       |      | 100.0 |
| Active                                                                      |         | 29:22 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 5:21 |  18.2 |
| COMPLETED Make context non-generatable                                      |         |       | 0:49 |   2.8 |
| COMPLETED Setup logging syntax highlighting on emacs                        |         |       | 2:32 |   8.6 |
| COMPLETED Create next interesting blog post                                 |         |       | 0:37 |   2.1 |
| COMPLETED Rename =yarn::nested_name= to =yarn::name_tree=                   |         |       | 1:05 |   3.7 |
| COMPLETED Rename =type= to =parsed_type=                                    |         |       | 0:14 |   0.8 |
| COMPLETED Add index support for =yarn::name_tree=                           |         |       | 1:56 |   6.6 |
| COMPLETED Create a context factory                                          |         |       | 1:13 |   4.1 |
...
| COMPLETED Sort out problems with main machine                               |         |       | 2:00 |   6.8 |
| STARTED Help conan with strange warning                                     |         |       | 1:30 |   5.1 |
| STARTED Add an helper method interface                                      |         |       | 6:56 |  23.6 |
| STARTED Add properties for helpers                                          |         |       | 3:50 |  13.1 |
