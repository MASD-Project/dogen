...
#+CAPTION: Clock summary at [2016-02-08 Mon 22:29]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 14:06   |       |      | 100.0 |
| Active                                                                      |         | 14:06 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 2:46 |  19.6 |
| COMPLETED Make context non-generatable                                      |         |       | 0:49 |   5.8 |
| COMPLETED Setup logging syntax highlighting on emacs                        |         |       | 2:32 |  18.0 |
| COMPLETED Create next interesting blog post                                 |         |       | 0:37 |   4.4 |
| STARTED Help conan with strange warning                                     |         |       | 0:26 |   3.1 |
| STARTED Add an helper method interface                                      |         |       | 6:56 |  49.2 |
...
Add an index to =yarn::nested_name=. Compute it as part of the
existing yarn infrastructure. Ordinal number is attributed from the
all properties collection, and recurses over the nesting.
