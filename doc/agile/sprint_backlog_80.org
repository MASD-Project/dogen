...
#+CAPTION: Clock summary at [2016-02-11 Thu 21:44]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *18:05* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 18:05   |       |      | 100.0 |
| Active                                                                      |         | 18:05 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 3:30 |  19.4 |
| COMPLETED Make context non-generatable                                      |         |       | 0:49 |   4.5 |
| COMPLETED Setup logging syntax highlighting on emacs                        |         |       | 2:32 |  14.0 |
| COMPLETED Create next interesting blog post                                 |         |       | 0:37 |   3.4 |
| COMPLETED Rename =yarn::nested_name= to =yarn::name_tree=                   |         |       | 1:05 |   6.0 |
| COMPLETED Rename =type= to =parsed_type=                                    |         |       | 0:14 |   1.3 |
| STARTED Help conan with strange warning                                     |         |       | 1:30 |   8.3 |
| STARTED Add an helper method interface                                      |         |       | 6:56 |  38.3 |
| STARTED Add index support for =yarn::name_tree=                             |         |       | 0:52 |   4.8 |
