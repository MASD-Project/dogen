...
#+CAPTION: Clock summary at [2016-02-12 Fri 17:55]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 21:24   |       |      | 100.0 |
| Active                                                                      |         | 21:24 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 3:35 |  16.7 |
| COMPLETED Make context non-generatable                                      |         |       | 0:49 |   3.8 |
| COMPLETED Setup logging syntax highlighting on emacs                        |         |       | 2:32 |  11.8 |
| COMPLETED Create next interesting blog post                                 |         |       | 0:37 |   2.9 |
| COMPLETED Rename =yarn::nested_name= to =yarn::name_tree=                   |         |       | 1:05 |   5.1 |
| COMPLETED Rename =type= to =parsed_type=                                    |         |       | 0:14 |   1.1 |
| COMPLETED Add index support for =yarn::name_tree=                           |         |       | 1:56 |   9.0 |
| COMPLETED Create a context factory                                          |         |       | 1:13 |   5.7 |
| COMPLETED Split dispatcher from formatters workflow and rename it           |         |       | 0:57 |   4.4 |
| STARTED Help conan with strange warning                                     |         |       | 1:30 |   7.0 |
| STARTED Add an helper method interface                                      |         |       | 6:56 |  32.4 |
