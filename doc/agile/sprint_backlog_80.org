...
#+CAPTION: Clock summary at [2016-02-12 Fri 17:49]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *21:19* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 21:19   |       |      | 100.0 |
| Active                                                                      |         | 21:19 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 3:30 |  16.4 |
| COMPLETED Make context non-generatable                                      |         |       | 0:49 |   3.8 |
| COMPLETED Setup logging syntax highlighting on emacs                        |         |       | 2:32 |  11.9 |
...
| COMPLETED Add index support for =yarn::name_tree=                           |         |       | 1:56 |   9.1 |
| COMPLETED Create a context factory                                          |         |       | 1:13 |   5.7 |
| COMPLETED Split dispatcher from formatters workflow and rename it           |         |       | 0:57 |   4.5 |
| STARTED Help conan with strange warning                                     |         |       | 1:30 |   7.0 |
| STARTED Add an helper method interface                                      |         |       | 6:56 |  32.5 |
