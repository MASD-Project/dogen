...
Clock summary at [2015-01-25 Sun 19:03]
...
| STARTED Update c++ settings factory to use dynamic object        |         |       | 1:25 |
#+end:
...
*** STARTED Update c++ settings factory to use dynamic object         :story:
