...
Clock summary at [2015-01-26 Mon 20:00]
...
|------------------------------------------------------------------+---------+-------+------|
| Active                                                           |         | 14:06 |      |
| STARTED Sprint and product backlog grooming                      |         |       | 1:46 |
...
| STARTED Update mock factory to generate dynamic fields           |         |       | 0:18 |
#+end:
...
*** STARTED Update mock factory to generate dynamic fields            :story:
