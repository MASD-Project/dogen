...
Clock summary at [2015-01-30 Fri 08:50]
...
|-----------------------------------------------------------------------+---------+-------+------|
| Active                                                                |         | 24:15 |      |
| STARTED Sprint and product backlog grooming                           |         |       | 2:11 |
...
| STARTED Update meta-data section in manual                            |         |       | 0:49 |
| STARTED Add "model types"                                             |         |       | 0:06 |
#+end:
...
*** STARTED Update meta-data section in manual                        :story:
    CLOCK: [2015-01-29 Thu 20:01]--[2015-01-29 Thu 20:50] =>  0:49

Once we are done with all of the meta-data refactoring, we need to
update the manual.

*** STARTED Add "model types"                                         :story:
    CLOCK: [2015-01-28 Wed 22:29]--[2015-01-28 Wed 22:34] =>  0:05
    CLOCK: [2015-01-28 Wed 22:27]--[2015-01-28 Wed 22:28] =>  0:01
...
*** Create default facet and formatter settings from dynamic          :story:

At present we are manually generating default settings for both facets
and formatters. We should do these from dynamic's field definitions.
