...
Clock summary at [2015-01-24 Sat 20:34]
...
| STARTED Create field definitions for all c++ fields        |         |       | 4:44 |
#+end:
...
*** STARTED Create field definitions for all c++ fields               :story:
...
*** Add default value support to dynamic field definitions            :story:

We need to add a default value to the field definition.

*** Update c++ factories to use dynamic object                        :story:
