...
#+CAPTION: Clock summary at [2017-02-25 Sat 21:53]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *18:27* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 18:27   |       |       | 100.0 |
| Active                                                                      |         | 18:27 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:24 |   2.2 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:30 |   2.7 |
| COMPLETED Fix the handling of ODB pragmas for yarn primitives               |         |       |  0:56 |   5.1 |
| STARTED Implement the database model using Northwind                        |         |       | 16:37 |  90.1 |
...
*** ODB Fixes to support Oracle                                       :story:
