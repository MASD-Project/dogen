...
#+CAPTION: Clock summary at [2017-03-03 Fri 12:47]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *36:52* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 36:52   |       |       | 100.0 |
| Active                                                                      |         | 36:52 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  2:01 |   5.5 |
...
| COMPLETED ODB Fixes to support Oracle                                       |         |       |  2:14 |   6.1 |
| COMPLETED Setup codacy                                                      |         |       |  0:22 |   1.0 |
| STARTED Create a language independent ORM layer                             |         |       |  8:34 |  23.2 |
| STARTED Implement the database model using Northwind                        |         |       | 20:47 |  56.4 |
