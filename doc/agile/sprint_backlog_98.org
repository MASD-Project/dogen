...
#+CAPTION: Clock summary at [2017-02-26 Sun 22:04]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *22:09* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 22:09   |       |       | 100.0 |
| Active                                                                      |         | 22:09 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:24 |   1.8 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:30 |   2.3 |
| COMPLETED Fix the handling of ODB pragmas for yarn primitives               |         |       |  0:56 |   4.2 |
| COMPLETED Rename intermediate model expander and model factory              |         |       |  0:53 |   4.0 |
| COMPLETED Injection splits annotation from intermediate model               |         |       |  0:35 |   2.6 |
| COMPLETED ODB Fixes to support Oracle                                       |         |       |  2:14 |  10.1 |
| STARTED Implement the database model using Northwind                        |         |       | 16:37 |  75.0 |
