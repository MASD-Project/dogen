...
#+CAPTION: Clock summary at [2017-03-04 Sat 19:30]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *42:43* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 42:43   |       |       | 100.0 |
| Active                                                                      |         | 42:43 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  2:01 |   4.7 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:30 |   1.2 |
| COMPLETED Fix the handling of ODB pragmas for yarn primitives               |         |       |  0:56 |   2.2 |
| COMPLETED Rename intermediate model expander and model factory              |         |       |  0:53 |   2.1 |
| COMPLETED Injection splits annotation from intermediate model               |         |       |  0:35 |   1.4 |
| COMPLETED ODB Fixes to support Oracle                                       |         |       |  2:14 |   5.2 |
| COMPLETED Setup codacy                                                      |         |       |  0:22 |   0.9 |
| COMPLETED Fix codacy warning on exceptions                                  |         |       |  0:08 |   0.3 |
| COMPLETED Create a language independent ORM layer                           |         |       | 12:51 |  30.1 |
| COMPLETED Make log directory configurable                                   |         |       |  1:26 |   3.4 |
| STARTED Implement the database model using Northwind                        |         |       | 20:47 |  48.7 |
