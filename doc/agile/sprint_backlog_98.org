...
#+CAPTION: Clock summary at [2017-03-03 Fri 13:22]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| STARTED Create a language independent ORM layer                             |         |       |  9:07 |  24.4 |
| STARTED Implement the database model using Northwind                        |         |       | 20:47 |  55.5 |
