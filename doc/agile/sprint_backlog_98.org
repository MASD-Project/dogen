...
#+CAPTION: Clock summary at [2017-02-24 Fri 10:33]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *9:39* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 9:39   |      |      | 100.0 |
| Active                                                                      |        | 9:39 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:09 |   1.6 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 0:30 |   5.2 |
| STARTED Implement the database model using Northwind                        |        |      | 9:00 |  93.3 |
