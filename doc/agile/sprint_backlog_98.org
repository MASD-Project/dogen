...
#+CAPTION: Clock summary at [2017-03-03 Fri 13:39]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| STARTED Create a language independent ORM layer                             |         |       |  9:23 |  24.9 |
| STARTED Implement the database model using Northwind                        |         |       | 20:47 |  55.2 |
