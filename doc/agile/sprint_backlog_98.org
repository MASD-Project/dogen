...
#+CAPTION: Clock summary at [2017-03-03 Fri 12:58]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                                     | 37:02   |       |       | 100.0 |
| Active                                                                      |         | 37:02 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  2:01 |   5.4 |
...
| COMPLETED Rename intermediate model expander and model factory              |         |       |  0:53 |   2.4 |
| COMPLETED Injection splits annotation from intermediate model               |         |       |  0:35 |   1.6 |
| COMPLETED ODB Fixes to support Oracle                                       |         |       |  2:14 |   6.0 |
| COMPLETED Setup codacy                                                      |         |       |  0:22 |   1.0 |
| STARTED Create a language independent ORM layer                             |         |       |  8:44 |  23.6 |
| STARTED Implement the database model using Northwind                        |         |       | 20:47 |  56.1 |
