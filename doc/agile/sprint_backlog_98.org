...
#+CAPTION: Clock summary at [2017-02-25 Sat 23:52]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| COMPLETED Rename intermediate model expander and model factory              |         |       |  0:53 |   4.3 |
| STARTED Implement the database model using Northwind                        |         |       | 16:37 |  81.6 |
