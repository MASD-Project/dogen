...
#+CAPTION: Clock summary at [2017-03-03 Fri 08:39]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *34:23* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 34:23   |       |       | 100.0 |
| Active                                                                      |         | 34:23 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:42 |   2.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:30 |   1.5 |
| COMPLETED Fix the handling of ODB pragmas for yarn primitives               |         |       |  0:56 |   2.7 |
...
| COMPLETED ODB Fixes to support Oracle                                       |         |       |  2:14 |   6.5 |
| COMPLETED Setup codacy                                                      |         |       |  0:22 |   1.1 |
| STARTED Create a language independent ORM layer                             |         |       |  7:24 |  21.5 |
| STARTED Implement the database model using Northwind                        |         |       | 20:47 |  60.4 |
