...
#+CAPTION: Clock summary at [2017-02-28 Tue 07:26]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *26:19* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 26:19   |       |       | 100.0 |
| Active                                                                      |         | 26:19 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:24 |   1.5 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:30 |   1.9 |
| COMPLETED Fix the handling of ODB pragmas for yarn primitives               |         |       |  0:56 |   3.5 |
| COMPLETED Rename intermediate model expander and model factory              |         |       |  0:53 |   3.4 |
| COMPLETED Injection splits annotation from intermediate model               |         |       |  0:35 |   2.2 |
| COMPLETED ODB Fixes to support Oracle                                       |         |       |  2:14 |   8.5 |
| STARTED Implement the database model using Northwind                        |         |       | 20:47 |  79.0 |
