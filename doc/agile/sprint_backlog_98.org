...
#+CAPTION: Clock summary at [2017-02-25 Sat 23:36]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *20:07* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 20:07   |       |       | 100.0 |
| Active                                                                      |         | 20:07 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:24 |   2.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:30 |   2.5 |
| COMPLETED Fix the handling of ODB pragmas for yarn primitives               |         |       |  0:56 |   4.6 |
| STARTED Implement the database model using Northwind                        |         |       | 16:37 |  82.6 |
| STARTED ODB Fixes to support Oracle                                         |         |       |  1:02 |   5.1 |
| STARTED Rename intermediate model expander and model factory                |         |       |  0:38 |   3.1 |
...
*** STARTED Rename intermediate model expander and model factory      :story:
