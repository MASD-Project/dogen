...
#+CAPTION: Clock summary at [2017-02-26 Sun 23:21]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *23:24* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 23:24   |       |       | 100.0 |
| Active                                                                      |         | 23:24 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:24 |   1.7 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:30 |   2.1 |
| COMPLETED Fix the handling of ODB pragmas for yarn primitives               |         |       |  0:56 |   4.0 |
| COMPLETED Rename intermediate model expander and model factory              |         |       |  0:53 |   3.8 |
| COMPLETED Injection splits annotation from intermediate model               |         |       |  0:35 |   2.5 |
| COMPLETED ODB Fixes to support Oracle                                       |         |       |  2:14 |   9.5 |
| STARTED Implement the database model using Northwind                        |         |       | 17:52 |  76.4 |
