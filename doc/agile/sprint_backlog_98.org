...
#+CAPTION: Clock summary at [2017-03-03 Fri 23:53]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| COMPLETED Rename intermediate model expander and model factory              |         |       |  0:53 |   2.2 |
| COMPLETED Injection splits annotation from intermediate model               |         |       |  0:35 |   1.4 |
| COMPLETED ODB Fixes to support Oracle                                       |         |       |  2:14 |   5.5 |
| COMPLETED Setup codacy                                                      |         |       |  0:22 |   0.9 |
| COMPLETED Fix codacy warning on exceptions                                  |         |       |  0:08 |   0.3 |
| STARTED Create a language independent ORM layer                             |         |       | 12:19 |  30.2 |
| STARTED Implement the database model using Northwind                        |         |       | 20:47 |  51.0 |
