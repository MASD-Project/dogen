...
#+CAPTION: Clock summary at [2017-02-27 Mon 22:34]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *25:35* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 25:35   |       |       | 100.0 |
| Active                                                                      |         | 25:35 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:24 |   1.6 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:30 |   2.0 |
| COMPLETED Fix the handling of ODB pragmas for yarn primitives               |         |       |  0:56 |   3.6 |
| COMPLETED Rename intermediate model expander and model factory              |         |       |  0:53 |   3.5 |
| COMPLETED Injection splits annotation from intermediate model               |         |       |  0:35 |   2.3 |
| COMPLETED ODB Fixes to support Oracle                                       |         |       |  2:14 |   8.7 |
| STARTED Implement the database model using Northwind                        |         |       | 20:03 |  78.4 |
