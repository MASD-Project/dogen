...
#+CAPTION: Clock summary at [2017-02-14 Tue 17:48]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *3:44* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 3:44   |      |      | 100.0 |
| Active                                                                      |        | 3:44 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:09 |   4.0 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 0:30 |  13.4 |
| STARTED Implement the database model using Northwind                        |        |      | 3:05 |  82.6 |
