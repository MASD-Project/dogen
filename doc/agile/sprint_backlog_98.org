...
#+CAPTION: Clock summary at [2017-03-04 Sat 23:37]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| COMPLETED Create a language independent ORM layer                           |         |       | 12:51 |  28.4 |
| COMPLETED Make log directory configurable                                   |         |       |  1:26 |   3.2 |
| STARTED Tidy-up test models                                                 |         |       |  2:31 |   5.6 |
| STARTED Implement the database model using Northwind                        |         |       | 20:47 |  45.9 |
