...
#+CAPTION: Clock summary at [2017-02-26 Sun 00:43]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *21:07* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 21:07   |       |       | 100.0 |
| Active                                                                      |         | 21:07 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:24 |   1.9 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:30 |   2.4 |
| COMPLETED Fix the handling of ODB pragmas for yarn primitives               |         |       |  0:56 |   4.4 |
| COMPLETED Rename intermediate model expander and model factory              |         |       |  0:53 |   4.2 |
| COMPLETED Injection splits annotation from intermediate model               |         |       |  0:35 |   2.8 |
| STARTED ODB Fixes to support Oracle                                         |         |       |  1:12 |   5.7 |
| STARTED Implement the database model using Northwind                        |         |       | 16:37 |  78.7 |
