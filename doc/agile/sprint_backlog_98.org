...
#+CAPTION: Clock summary at [2017-02-27 Mon 00:10]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *24:12* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 24:12   |       |       | 100.0 |
| Active                                                                      |         | 24:12 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:24 |   1.7 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:30 |   2.1 |
| COMPLETED Fix the handling of ODB pragmas for yarn primitives               |         |       |  0:56 |   3.9 |
| COMPLETED Rename intermediate model expander and model factory              |         |       |  0:53 |   3.7 |
| COMPLETED Injection splits annotation from intermediate model               |         |       |  0:35 |   2.4 |
| COMPLETED ODB Fixes to support Oracle                                       |         |       |  2:14 |   9.2 |
| STARTED Implement the database model using Northwind                        |         |       | 18:40 |  77.1 |
