...
#+CAPTION: Clock summary at [2017-03-02 Thu 10:03]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *34:05* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 34:05   |       |       | 100.0 |
| Active                                                                      |         | 34:05 |       | 100.0 |
...
| STARTED Create a language independent ORM layer                             |         |       |  7:24 |  21.7 |
| STARTED Implement the database model using Northwind                        |         |       | 20:47 |  61.0 |
