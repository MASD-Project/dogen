...
#+CAPTION: Clock summary at [2017-03-04 Sat 23:06]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *44:44* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 44:44   |       |       | 100.0 |
| Active                                                                      |         | 44:44 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  2:01 |   4.5 |
...
| COMPLETED ODB Fixes to support Oracle                                       |         |       |  2:14 |   5.0 |
| COMPLETED Setup codacy                                                      |         |       |  0:22 |   0.8 |
| COMPLETED Fix codacy warning on exceptions                                  |         |       |  0:08 |   0.3 |
| COMPLETED Create a language independent ORM layer                           |         |       | 12:51 |  28.7 |
| COMPLETED Make log directory configurable                                   |         |       |  1:26 |   3.2 |
| STARTED Tidy-up test models                                                 |         |       |  2:01 |   4.5 |
| STARTED Implement the database model using Northwind                        |         |       | 20:47 |  46.5 |
