...
Clock summary at [2014-09-12 Fri 22:12]

| Headline                                                     | Time    |       |      |
|--------------------------------------------------------------+---------+-------+------|
| *Total time*                                                 | *10:26* |       |      |
|--------------------------------------------------------------+---------+-------+------|
| Development Stories Implemented                              |         | 10:26 |      |
...
| IMPLEMENTATION Create an SML grapher                         |         |       | 0:25 |
#+end:
...
*** IMPLEMENTATION Create an SML grapher                              :story:
