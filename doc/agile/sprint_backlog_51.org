...
Clock summary at [2014-09-15 Mon 22:35]

| Headline                                                     | Time    |       |      |
|--------------------------------------------------------------+---------+-------+------|
| *Total time*                                                 | *21:55* |       |      |
|--------------------------------------------------------------+---------+-------+------|
| Development Stories Implemented                              |         | 21:55 |      |
...
| IMPLEMENTATION Populate containing module in JSON hydrator   |         |       | 0:10 |
#+end:
...
**** IMPLEMENTATION Read modules from JSON                             :task:


We need to support module definitions in the JSON file format.

**** Add containing module logic to JSON models                        :task:

We need to ensure types are contained by the correct module, and the
model module is contained by the global module.
