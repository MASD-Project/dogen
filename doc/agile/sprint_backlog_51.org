...
Clock summary at [2014-09-11 Thu 22:51]

| Headline                                                | Time   |      |      |
|---------------------------------------------------------+--------+------+------|
| *Total time*                                            | *8:09* |      |      |
|---------------------------------------------------------+--------+------+------|
| Development Stories Implemented                         |        | 8:09 |      |
| IMPLEMENTATION Sprint and product backlog grooming      |        |      | 1:15 |
| IMPLEMENTATION Updates to the manual and readme files   |        |      | 0:17 |
...
| IMPLEMENTATION Implement a grapher in meta_data         |        |      | 1:21 |
| IMPLEMENTATION Move the root enricher to formatters     |        |      | 0:49 |
#+end:
...
*** IMPLEMENTATION Implement a grapher in meta_data                   :story:
...
*** IMPLEMENTATION Move the root enricher to formatters               :story:
