...
Clock summary at [2014-09-14 Sun 19:06]
...
| IMPLEMENTATION Implement the enricher interface in formatters |         |       | 0:46 |
#+end:
...
**** Populate all of the default traits in enricher                   :story:
