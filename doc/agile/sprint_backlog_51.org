...
Clock summary at [2014-09-20 Sat 02:13]

| Headline                                                         | Time    |       |      |
|------------------------------------------------------------------+---------+-------+------|
| *Total time*                                                     | *34:50* |       |      |
|------------------------------------------------------------------+---------+-------+------|
| Development Stories Implemented                                  |         | 34:50 |      |
...
| COMPLETED Implement the backend enricher interface in cpp        |         |       | 2:08 |
#+end:
...
*** COMPLETED Implement the backend enricher interface in cpp         :story:
