...
Clock summary at [2014-09-21 Sun 18:41]

| Headline                                                         | Time    |       |      |
|------------------------------------------------------------------+---------+-------+------|
| *Total time*                                                     | *41:28* |       |      |
|------------------------------------------------------------------+---------+-------+------|
| Development Stories Implemented                                  |         | 41:28 |      |
| IMPLEMENTATION Sprint and product backlog grooming               |         |       | 6:10 |
...
| IMPLEMENTATION Analyse use cases for meta-data                   |         |       | 2:24 |
#+end:
