...
Clock summary at [2014-09-14 Sun 20:04]

| Headline                                                      | Time    |       |      |
|---------------------------------------------------------------+---------+-------+------|
| *Total time*                                                  | *18:51* |       |      |
|---------------------------------------------------------------+---------+-------+------|
| Development Stories Implemented                               |         | 18:51 |      |
...
| IMPLEMENTATION Implement the enricher interface in formatters |         |       | 1:42 |
#+end:
...
**** Populate containing module in JSON hydrator                      :spike:
