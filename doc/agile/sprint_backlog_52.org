...
Clock summary at [2014-10-06 Mon 08:03]
...
*** CANCELLED Refactor types header formatter  :task:refactor:formatters:cpp:
...
*Rationale*: this story no longer matches the current state of the
world. Whilst the refactoring is needed, this description is no
longer accurate. We need to raise a new story for this.
