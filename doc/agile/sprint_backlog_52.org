...
Clock summary at [2014-10-01 Wed 10:28]

| Headline                                                          | Time    |       |      |
|-------------------------------------------------------------------+---------+-------+------|
| *Total time*                                                      | *18:30* |       |      |
|-------------------------------------------------------------------+---------+-------+------|
| Development Stories Implemented                                   |         | 18:30 |      |
...
| IMPLEMENTATION Create the =backend= model                         |         |       | 2:23 |
...
**** IMPLEMENTATION Understand how the backend model fits into the whole
