...
Clock summary at [2014-10-01 Wed 15:44]

| Headline                                                          | Time    |       |      |
|-------------------------------------------------------------------+---------+-------+------|
| *Total time*                                                      | *20:03* |       |      |
|-------------------------------------------------------------------+---------+-------+------|
| Development Stories Implemented                                   |         | 20:03 |      |
...
*** COMPLETED Find a new name for enrichers and builders
...
*** Refactor the =frontend= model                             :task:refactor:

- create a producer in SML.
- rename the sources into file producers and inherit from SML producer.
- return a list of producers from frontend.
- pass list of producers to SML workflow.
