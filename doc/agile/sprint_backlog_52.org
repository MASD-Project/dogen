...
Clock summary at [2014-09-26 Fri 22:07]

| Headline                                                               | Time   |      |      |
|------------------------------------------------------------------------+--------+------+------|
| *Total time*                                                           | *5:46* |      |      |
|------------------------------------------------------------------------+--------+------+------|
| Development Stories Implemented                                        |        | 5:46 |      |
| IMPLEMENTATION Sprint and product backlog grooming                     |        |      | 0:40 |
| IMPLEMENTATION Rethink meta-data subsystem in light of latest analysis |        |      | 2:06 |
| IMPLEMENTATION Create the =frontend= model                             |        |      | 1:53 |
