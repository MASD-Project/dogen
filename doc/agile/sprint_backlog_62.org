...
Clock summary at [2015-03-21 Sat 18:05]
...
| STARTED Create a "default values" expander                               |         |       | 0:35 |
#+end:
...
*** STARTED Determining the model module should be in SML             :spike:
...
*** STARTED Create a "default values" expander                        :story:
...
*** Create a "copy from options" expander                             :story:
...
*** Create a "copy from root" expander                                :story:
