...
Clock summary at [2015-03-27 Fri 00:03]
...
| STARTED Implement the general settings workflow with root object         |         |       | 1:41 |
#+end:
...
*** STARTED Implement the general settings workflow with root object  :story:
