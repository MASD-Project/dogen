...
Clock summary at [2015-03-08 Sun 20:22]
...
| STARTED Create a JSON file format for field definitions               |        |      | 2:42 |
#+end:
...
*** STARTED Create a JSON file format for field definitions           :story:
...
*** Apply relevant parts of dynamic refactor patch                    :story:
...
*** Convert all field definitions into JSON                           :story:
