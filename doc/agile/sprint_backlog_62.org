...
Clock summary at [2015-03-23 Mon 18:08]
...
| STARTED Remove all field definitions in code                             |         |       | 0:24 |
| STARTED Add JSON support to dynamic workflow                             |         |       | 0:50 |
| STARTED Implement the repository workflow                                |         |       | 1:00 |
#+end:
...
*** STARTED Implement the repository workflow                         :story:
