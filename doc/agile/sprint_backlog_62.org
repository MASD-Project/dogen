...
Clock summary at [2015-03-26 Thu 17:31]
...
| COMPLETED Split SML workflow into two                                    |         |       | 0:17 |
| STARTED Create a "supported" expander                                    |         |       | 1:54 |
| STARTED Propagate file and include paths to the formatter                |         |       | 0:03 |
#+end:
...
*** COMPLETED Split SML workflow into two                             :story:
...
*** STARTED Propagate file and include paths to the formatter         :story:
