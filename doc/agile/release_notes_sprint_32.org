...
Clock summary at [2013-08-09 Fri 18:43]

| Headline                                                              | Time   |      |      |
|-----------------------------------------------------------------------+--------+------+------|
| *Total time*                                                          | *7:15* |      |      |
|-----------------------------------------------------------------------+--------+------+------|
| Development Stories Implemented                                       |        | 7:15 |      |
...
| IMPLEMENTATION Tidy-up all C++ models                                 |        |      | 1:42 |
#+end:
...
*** IMPLEMENTATION Tidy-up all C++ models                             :story:
