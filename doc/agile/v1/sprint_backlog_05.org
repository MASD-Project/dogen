...
#+CAPTION: Clock summary at [2017-09-10 Sun 14:48]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| COMPLETED Analysis on annotations and profiles                              |         |       | 2:26 |   8.7 |
| COMPLETED Use namespaced stereotypes                                        |         |       | 1:49 |   6.5 |
| COMPLETED Tailor dogen models                                               |         |       | 0:21 |   1.3 |
| COMPLETED Rename yarn concepts                                              |         |       | 7:49 |  28.1 |
...
| STARTED Add canonical archetype support to yarn                             |         |       | 6:45 |  24.2 |
| STARTED Improve dumping of models                                           |         |       | 2:21 |   8.4 |
