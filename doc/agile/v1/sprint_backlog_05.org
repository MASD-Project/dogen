...
#+CAPTION: Clock summary at [2017-09-10 Sun 11:48]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *26:23* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 26:23   |       |      | 100.0 |
| Active                                                                      |         | 26:23 |      | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:44 |   2.8 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:33 |   5.9 |
| COMPLETED Remove object types in yarn                                       |         |       | 0:52 |   3.3 |
| COMPLETED Clean-up readme                                                   |         |       | 1:15 |   4.7 |
| COMPLETED Rename transformers to adapters                                   |         |       | 0:28 |   1.8 |
| COMPLETED Analysis on annotations and profiles                              |         |       | 2:26 |   9.2 |
| COMPLETED Use namespaced stereotypes                                        |         |       | 1:49 |   6.9 |
| COMPLETED Tailor dogen models                                               |         |       | 0:21 |   1.3 |
| COMPLETED Rename yarn concepts                                              |         |       | 7:49 |  29.6 |
| COMPLETED Remove extra copying in mapper                                    |         |       | 0:05 |   0.3 |
| COMPLETED Investigate the JSON break on Northwind model                     |         |       | 0:57 |   3.6 |
| COMPLETED Rename ODB parameters                                             |         |       | 0:11 |   0.7 |
| COMPLETED Investigate usage of origin type                                  |         |       | 0:15 |   0.9 |
| STARTED Add canonical archetype support to yarn                             |         |       | 6:45 |  25.6 |
| STARTED Improve dumping of models                                           |         |       | 0:53 |   3.3 |
...
: transforms-dump-stats
: transforms-dump-all
: transforms-dump-directory
