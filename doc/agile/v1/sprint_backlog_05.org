...
#+CAPTION: Clock summary at [2017-09-16 Sat 18:17]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *53:44* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 53:44   |       |       | 100.0 |
| Active                                                                      |         | 53:44 |       | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:44 |   1.4 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:43 |   3.2 |
| COMPLETED Remove object types in yarn                                       |         |       |  0:52 |   1.6 |
| COMPLETED Clean-up readme                                                   |         |       |  1:15 |   2.3 |
| COMPLETED Rename transformers to adapters                                   |         |       |  0:28 |   0.9 |
| COMPLETED Analysis on annotations and profiles                              |         |       |  2:26 |   4.5 |
| COMPLETED Use namespaced stereotypes                                        |         |       |  1:49 |   3.4 |
| COMPLETED Tailor dogen models                                               |         |       |  0:21 |   0.7 |
| COMPLETED Rename yarn concepts                                              |         |       |  7:49 |  14.5 |
| COMPLETED Remove extra copying in mapper                                    |         |       |  0:05 |   0.2 |
| COMPLETED Investigate the JSON break on Northwind model                     |         |       |  0:57 |   1.8 |
| COMPLETED Rename ODB parameters                                             |         |       |  0:11 |   0.3 |
| COMPLETED Investigate usage of origin type                                  |         |       |  0:15 |   0.5 |
| COMPLETED Improve dumping of models                                         |         |       | 12:59 |  24.2 |
| COMPLETED Create yarn options                                               |         |       |  1:06 |   2.0 |
| COMPLETED Merge knit with yarn                                              |         |       |  1:13 |   2.3 |
| COMPLETED Add probing support to code generation tests                      |         |       |  2:45 |   5.1 |
| COMPLETED Find some way of scoping transform probing                        |         |       |  3:06 |   5.8 |
| COMPLETED Catch directory generation errors in probe                        |         |       |  1:05 |   2.0 |
| COMPLETED Remove dumping of models from log                                 |         |       |  0:06 |   0.2 |
| COMPLETED Move model sorter from helpers                                    |         |       |  0:32 |   1.0 |
| COMPLETED Add canonical archetype support to yarn                           |         |       |  7:18 |  13.6 |
| STARTED Move enablement into yarn                                           |         |       |  4:39 |   8.7 |
...
*** Remove artefact from assistant casting                            :story:
...
*** Untabify windows templates                                        :story:
