...
#+CAPTION: Clock summary at [2017-09-15 Fri 15:00]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| COMPLETED Rename yarn concepts                                              |         |       |  7:49 |  16.6 |
...
| COMPLETED Improve dumping of models                                         |         |       | 12:59 |  27.6 |
| COMPLETED Create yarn options                                               |         |       |  1:06 |   2.3 |
| COMPLETED Merge knit with yarn                                              |         |       |  1:13 |   2.6 |
| COMPLETED Add probing support to code generation tests                      |         |       |  2:45 |   5.8 |
| COMPLETED Find some way of scoping transform probing                        |         |       |  3:06 |   6.6 |
| STARTED Catch directory generation errors in probe                          |         |       |  0:27 |   1.0 |
| STARTED Add canonical archetype support to yarn                             |         |       |  6:45 |  14.3 |
...
*** STARTED Catch directory generation errors in probe                :story:
