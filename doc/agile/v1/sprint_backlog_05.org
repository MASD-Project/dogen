...
#+CAPTION: Clock summary at [2017-09-16 Sat 15:25]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *51:52* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 51:52   |       |       | 100.0 |
| Active                                                                      |         | 51:52 |       | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:44 |   1.4 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:43 |   3.3 |
| COMPLETED Remove object types in yarn                                       |         |       |  0:52 |   1.7 |
| COMPLETED Clean-up readme                                                   |         |       |  1:15 |   2.4 |
| COMPLETED Rename transformers to adapters                                   |         |       |  0:28 |   0.9 |
| COMPLETED Analysis on annotations and profiles                              |         |       |  2:26 |   4.7 |
| COMPLETED Use namespaced stereotypes                                        |         |       |  1:49 |   3.5 |
| COMPLETED Tailor dogen models                                               |         |       |  0:21 |   0.7 |
| COMPLETED Rename yarn concepts                                              |         |       |  7:49 |  15.1 |
...
| COMPLETED Improve dumping of models                                         |         |       | 12:59 |  25.0 |
| COMPLETED Create yarn options                                               |         |       |  1:06 |   2.1 |
| COMPLETED Merge knit with yarn                                              |         |       |  1:13 |   2.3 |
| COMPLETED Add probing support to code generation tests                      |         |       |  2:45 |   5.3 |
| COMPLETED Find some way of scoping transform probing                        |         |       |  3:06 |   6.0 |
| COMPLETED Catch directory generation errors in probe                        |         |       |  1:05 |   2.1 |
| COMPLETED Remove dumping of models from log                                 |         |       |  0:06 |   0.2 |
| COMPLETED Move model sorter from helpers                                    |         |       |  0:32 |   1.0 |
| COMPLETED Add canonical archetype support to yarn                           |         |       |  7:18 |  14.1 |
| STARTED Move enablement into yarn                                           |         |       |  2:47 |   5.4 |
