...
#+CAPTION: Clock summary at [2017-09-16 Sat 00:28]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *49:14* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 49:14   |       |       | 100.0 |
| Active                                                                      |         | 49:14 |       | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:44 |   1.5 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:33 |   3.1 |
...
| COMPLETED Use namespaced stereotypes                                        |         |       |  1:49 |   3.7 |
| COMPLETED Tailor dogen models                                               |         |       |  0:21 |   0.7 |
| COMPLETED Rename yarn concepts                                              |         |       |  7:49 |  15.9 |
...
| COMPLETED Improve dumping of models                                         |         |       | 12:59 |  26.4 |
| COMPLETED Create yarn options                                               |         |       |  1:06 |   2.2 |
| COMPLETED Merge knit with yarn                                              |         |       |  1:13 |   2.5 |
| COMPLETED Add probing support to code generation tests                      |         |       |  2:45 |   5.6 |
| COMPLETED Find some way of scoping transform probing                        |         |       |  3:06 |   6.3 |
...
| COMPLETED Add canonical archetype support to yarn                           |         |       |  7:18 |  14.8 |
| STARTED Move enablement into yarn                                           |         |       |  0:19 |   0.6 |
