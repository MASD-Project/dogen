...
#+CAPTION: Clock summary at [2017-09-17 Sun 14:41]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| COMPLETED Analysis on annotations and profiles                              |         |       |  2:26 |   4.4 |
| COMPLETED Use namespaced stereotypes                                        |         |       |  1:49 |   3.3 |
| COMPLETED Tailor dogen models                                               |         |       |  0:21 |   0.6 |
| COMPLETED Rename yarn concepts                                              |         |       |  7:49 |  14.1 |
...
| COMPLETED Improve dumping of models                                         |         |       | 12:59 |  23.4 |
| COMPLETED Create yarn options                                               |         |       |  1:06 |   2.0 |
| COMPLETED Merge knit with yarn                                              |         |       |  1:13 |   2.2 |
| COMPLETED Add probing support to code generation tests                      |         |       |  2:45 |   5.0 |
| COMPLETED Find some way of scoping transform probing                        |         |       |  3:06 |   5.6 |
...
| COMPLETED Add canonical archetype support to yarn                           |         |       |  7:18 |  13.2 |
| COMPLETED Remove artefact from assistant casting                            |         |       |  0:20 |   0.6 |
| COMPLETED Untabify windows templates                                        |         |       |  0:04 |   0.1 |
| STARTED Split out transforms from post-processing chain                     |         |       |  1:04 |   1.9 |
| STARTED Move enablement into yarn                                           |         |       |  4:50 |   8.7 |
