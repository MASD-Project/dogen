...
#+CAPTION: Clock summary at [2017-09-15 Fri 13:43]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *46:39* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 46:39   |       |       | 100.0 |
| Active                                                                      |         | 46:39 |       | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:44 |   1.6 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:33 |   3.3 |
| COMPLETED Remove object types in yarn                                       |         |       |  0:52 |   1.9 |
| COMPLETED Clean-up readme                                                   |         |       |  1:15 |   2.7 |
| COMPLETED Rename transformers to adapters                                   |         |       |  0:28 |   1.0 |
| COMPLETED Analysis on annotations and profiles                              |         |       |  2:26 |   5.2 |
| COMPLETED Use namespaced stereotypes                                        |         |       |  1:49 |   3.9 |
| COMPLETED Tailor dogen models                                               |         |       |  0:21 |   0.8 |
| COMPLETED Rename yarn concepts                                              |         |       |  7:49 |  16.8 |
...
| COMPLETED Improve dumping of models                                         |         |       | 12:59 |  27.8 |
| COMPLETED Create yarn options                                               |         |       |  1:06 |   2.4 |
| COMPLETED Merge knit with yarn                                              |         |       |  1:13 |   2.6 |
| COMPLETED Add probing support to code generation tests                      |         |       |  2:45 |   5.9 |
| COMPLETED Find some way of scoping transform probing                        |         |       |  3:06 |   6.6 |
| STARTED Add canonical archetype support to yarn                             |         |       |  6:45 |  14.5 |
