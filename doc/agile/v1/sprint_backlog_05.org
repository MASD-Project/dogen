...
#+CAPTION: Clock summary at [2017-09-13 Wed 08:34]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *36:13* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 36:13   |       |       | 100.0 |
| Active                                                                      |         | 36:13 |       | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:44 |   2.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:33 |   4.3 |
| COMPLETED Remove object types in yarn                                       |         |       |  0:52 |   2.4 |
| COMPLETED Clean-up readme                                                   |         |       |  1:15 |   3.5 |
| COMPLETED Rename transformers to adapters                                   |         |       |  0:28 |   1.3 |
| COMPLETED Analysis on annotations and profiles                              |         |       |  2:26 |   6.7 |
| COMPLETED Use namespaced stereotypes                                        |         |       |  1:49 |   5.0 |
| COMPLETED Tailor dogen models                                               |         |       |  0:21 |   1.0 |
| COMPLETED Rename yarn concepts                                              |         |       |  7:49 |  21.6 |
| COMPLETED Remove extra copying in mapper                                    |         |       |  0:05 |   0.2 |
| COMPLETED Investigate the JSON break on Northwind model                     |         |       |  0:57 |   2.6 |
| COMPLETED Rename ODB parameters                                             |         |       |  0:11 |   0.5 |
| COMPLETED Investigate usage of origin type                                  |         |       |  0:15 |   0.7 |
| STARTED Add canonical archetype support to yarn                             |         |       |  6:45 |  18.6 |
| STARTED Improve dumping of models                                           |         |       | 10:43 |  29.6 |
...
*** STARTED Improve dumping of models                                 :story:
...
FIXME: website should store content on git, and monitor it. We should
allow users to update their git repos and see changes immediately;
browse git revisions/tags and change production.
