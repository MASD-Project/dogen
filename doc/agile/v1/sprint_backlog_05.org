...
#+CAPTION: Clock summary at [2017-09-15 Fri 10:36]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *43:33* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 43:33   |       |       | 100.0 |
| Active                                                                      |         | 43:33 |       | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:44 |   1.7 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:33 |   3.6 |
| COMPLETED Remove object types in yarn                                       |         |       |  0:52 |   2.0 |
| COMPLETED Clean-up readme                                                   |         |       |  1:15 |   2.9 |
| COMPLETED Rename transformers to adapters                                   |         |       |  0:28 |   1.1 |
| COMPLETED Analysis on annotations and profiles                              |         |       |  2:26 |   5.6 |
| COMPLETED Use namespaced stereotypes                                        |         |       |  1:49 |   4.2 |
| COMPLETED Tailor dogen models                                               |         |       |  0:21 |   0.8 |
| COMPLETED Rename yarn concepts                                              |         |       |  7:49 |  17.9 |
| COMPLETED Remove extra copying in mapper                                    |         |       |  0:05 |   0.2 |
| COMPLETED Investigate the JSON break on Northwind model                     |         |       |  0:57 |   2.2 |
| COMPLETED Rename ODB parameters                                             |         |       |  0:11 |   0.4 |
| COMPLETED Investigate usage of origin type                                  |         |       |  0:15 |   0.6 |
| COMPLETED Improve dumping of models                                         |         |       | 12:59 |  29.8 |
| COMPLETED Create yarn options                                               |         |       |  1:06 |   2.5 |
| COMPLETED Merge knit with yarn                                              |         |       |  1:13 |   2.8 |
| COMPLETED Add probing support to code generation tests                      |         |       |  2:45 |   6.3 |
| STARTED Add canonical archetype support to yarn                             |         |       |  6:45 |  15.5 |
...
*** Catch directory generation errors in probe                        :story:
...
*** Find some way of scoping transform probing                        :story:
