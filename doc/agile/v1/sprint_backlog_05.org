...
#+CAPTION: Clock summary at [2017-09-17 Sun 16:49]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *57:22* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 57:22   |       |       | 100.0 |
| Active                                                                      |         | 57:22 |       | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:44 |   1.3 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:43 |   3.0 |
...
| COMPLETED Analysis on annotations and profiles                              |         |       |  2:26 |   4.2 |
| COMPLETED Use namespaced stereotypes                                        |         |       |  1:49 |   3.2 |
| COMPLETED Tailor dogen models                                               |         |       |  0:21 |   0.6 |
| COMPLETED Rename yarn concepts                                              |         |       |  7:49 |  13.6 |
...
| COMPLETED Improve dumping of models                                         |         |       | 12:59 |  22.6 |
| COMPLETED Create yarn options                                               |         |       |  1:06 |   1.9 |
| COMPLETED Merge knit with yarn                                              |         |       |  1:13 |   2.1 |
| COMPLETED Add probing support to code generation tests                      |         |       |  2:45 |   4.8 |
| COMPLETED Find some way of scoping transform probing                        |         |       |  3:06 |   5.4 |
...
| COMPLETED Add canonical archetype support to yarn                           |         |       |  7:18 |  12.7 |
| COMPLETED Remove artefact from assistant casting                            |         |       |  0:20 |   0.6 |
| COMPLETED Untabify windows templates                                        |         |       |  0:04 |   0.1 |
| COMPLETED Output stats in org-mode format                                   |         |       |  0:40 |   1.2 |
| STARTED Split out transforms from post-processing chain                     |         |       |  2:23 |   4.2 |
| STARTED Move enablement into yarn                                           |         |       |  4:50 |   8.4 |
