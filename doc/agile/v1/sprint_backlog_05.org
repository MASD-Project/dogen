...
#+CAPTION: Clock summary at [2017-09-09 Sat 09:27]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *19:23* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 19:23   |       |      | 100.0 |
| Active                                                                      |         | 19:23 |      | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:44 |   3.8 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:22 |   7.1 |
| COMPLETED Remove object types in yarn                                       |         |       | 0:52 |   4.5 |
| COMPLETED Clean-up readme                                                   |         |       | 1:15 |   6.4 |
| COMPLETED Rename transformers to adapters                                   |         |       | 0:28 |   2.4 |
| COMPLETED Analysis on annotations and profiles                              |         |       | 2:26 |  12.6 |
| COMPLETED Use namespaced stereotypes                                        |         |       | 1:49 |   9.4 |
| COMPLETED Tailor dogen models                                               |         |       | 0:21 |   1.8 |
| COMPLETED Rename yarn concepts                                              |         |       | 7:49 |  40.3 |
| COMPLETED Remove extra copying in mapper                                    |         |       | 0:05 |   0.4 |
| COMPLETED Investigate the JSON break on Northwind model                     |         |       | 0:57 |   4.9 |
| COMPLETED Rename ODB parameters                                             |         |       | 0:11 |   0.9 |
| COMPLETED Investigate usage of origin type                                  |         |       | 0:15 |   1.3 |
| STARTED Add canonical archetype support to yarn                             |         |       | 0:49 |   4.2 |
...
- we need to unpick the notion of whether a formatter is "includible"
  ...
  include.
- actually the container must be meta-type to facet to canonical
  artefact. Also, there is no particularly good reason for this to be
  a element property. It is, in fact, a meta-element concept, because
  it is the same for all meta-elements. We should just add this
