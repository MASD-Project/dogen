...
#+CAPTION: Clock summary at [2017-09-01 Fri 13:56]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *5:49* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 5:49   |      |      | 100.0 |
| Active                                                                      |        | 5:49 |      | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 0:44 |  12.6 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:30 |   8.6 |
| COMPLETED Remove object types in yarn                                       |        |      | 0:52 |  14.9 |
| COMPLETED Clean-up readme                                                   |        |      | 1:15 |  21.5 |
| COMPLETED Rename transformers to adapters                                   |        |      | 0:28 |   8.0 |
| STARTED Analysis on profiles and concepts                                   |        |      | 2:00 |  34.4 |
...
- *The annotations type system*. This is at present done by loading type
  ...
  type system.
- *The profiling machinery*. Annotations profiles are, on the main, a
...
As it turns out, plain UML machinery can be used to handle annotations
profiles: UML profiles and UML stereotypes. Let's first look into how
we use stereotypes. We have:
...
- create a new reference type called =profiles=. Problem: at present
  ...
  process the profiles before reading in the target.
