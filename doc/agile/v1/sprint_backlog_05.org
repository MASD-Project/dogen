...
#+CAPTION: Clock summary at [2017-09-13 Wed 22:53]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *39:35* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 39:35   |       |       | 100.0 |
| Active                                                                      |         | 39:35 |       | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:44 |   1.9 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:33 |   3.9 |
| COMPLETED Remove object types in yarn                                       |         |       |  0:52 |   2.2 |
| COMPLETED Clean-up readme                                                   |         |       |  1:15 |   3.2 |
| COMPLETED Rename transformers to adapters                                   |         |       |  0:28 |   1.2 |
| COMPLETED Analysis on annotations and profiles                              |         |       |  2:26 |   6.1 |
| COMPLETED Use namespaced stereotypes                                        |         |       |  1:49 |   4.6 |
| COMPLETED Tailor dogen models                                               |         |       |  0:21 |   0.9 |
| COMPLETED Rename yarn concepts                                              |         |       |  7:49 |  19.7 |
| COMPLETED Remove extra copying in mapper                                    |         |       |  0:05 |   0.2 |
| COMPLETED Investigate the JSON break on Northwind model                     |         |       |  0:57 |   2.4 |
| COMPLETED Rename ODB parameters                                             |         |       |  0:11 |   0.5 |
| COMPLETED Investigate usage of origin type                                  |         |       |  0:15 |   0.6 |
| COMPLETED Improve dumping of models                                         |         |       | 12:59 |  32.8 |
| COMPLETED Create yarn options                                               |         |       |  1:06 |   2.8 |
| STARTED Add canonical archetype support to yarn                             |         |       |  6:45 |  17.1 |
