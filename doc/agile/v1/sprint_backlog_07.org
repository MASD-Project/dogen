...
#+CAPTION: Clock summary at [2017-12-05 Tue 19:41]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *50:20* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 50:20   |       |       | 100.0 |
| Active                                                                      |         | 50:20 |       | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  1:03 |   2.1 |
| STARTED Sprint and product backlog grooming                                 |         |       |  2:13 |   4.4 |
| COMPLETED Remove remnants of upsilon                                        |         |       |  0:35 |   1.2 |
| COMPLETED Create a well-defined set of stereotypes                          |         |       |  8:41 |  17.3 |
| COMPLETED Fix rtags setup in laptop                                         |         |       | 13:43 |  27.3 |
| COMPLETED Analysis on moving naming away from sewing terms                  |         |       |  2:21 |   4.7 |
| COMPLETED Implement exomodel in terms of exoelements                        |         |       | 16:03 |  31.9 |
| COMPLETED Fix JSON tests                                                    |         |       |  0:25 |   0.8 |
| STARTED Finish setting up coveralls                                         |         |       |  2:57 |   5.9 |
| STARTED Create a single binary for all of dogen                             |         |       |  1:03 |   2.1 |
| STARTED Remove all deprecated code after exomodels clean up                 |         |       |  1:16 |   2.5 |
