...
#+CAPTION: Clock summary at [2017-12-07 Thu 09:08]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| STARTED Sprint and product backlog grooming                                 |         |       |  2:13 |   4.0 |
| COMPLETED Remove remnants of upsilon                                        |         |       |  0:35 |   1.1 |
| COMPLETED Create a well-defined set of stereotypes                          |         |       |  8:41 |  15.7 |
| COMPLETED Fix rtags setup in laptop                                         |         |       | 13:43 |  24.8 |
| COMPLETED Analysis on moving naming away from sewing terms                  |         |       |  2:21 |   4.2 |
| COMPLETED Implement exomodel in terms of exoelements                        |         |       | 16:03 |  29.0 |
| COMPLETED Fix JSON tests                                                    |         |       |  0:25 |   0.8 |
| COMPLETED Remove all deprecated code after exomodels clean up               |         |       |  2:00 |   3.6 |
...
| STARTED Finish setting up coveralls                                         |         |       |  2:57 |   5.3 |
...
| STARTED Create the =external= model                                         |         |       |  2:38 |   4.8 |
| STARTED Create a =probing= model                                            |         |       |  0:06 |   0.2 |
...
*** STARTED Create a =probing= model                                  :story:
