...
#+CAPTION: Clock summary at [2017-12-22 Fri 17:45]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *78:14* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 78:14   |       |       | 100.0 |
| Active                                                                      |         | 78:14 |       | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  1:03 |   1.3 |
| STARTED Sprint and product backlog grooming                                 |         |       |  2:51 |   3.6 |
| COMPLETED Remove remnants of upsilon                                        |         |       |  0:35 |   0.7 |
| COMPLETED Create a well-defined set of stereotypes                          |         |       |  8:41 |  11.1 |
| COMPLETED Fix rtags setup in laptop                                         |         |       | 13:43 |  17.5 |
| COMPLETED Analysis on moving naming away from sewing terms                  |         |       |  2:21 |   3.0 |
| COMPLETED Implement exomodel in terms of exoelements                        |         |       | 16:03 |  20.5 |
...
| COMPLETED Create the =external= model                                       |         |       |  5:07 |   6.5 |
...
| COMPLETED Rename =formatters= to =formatting=                               |         |       |  1:45 |   2.2 |
| COMPLETED Rename =yarn= to =modeling=                                       |         |       |  1:58 |   2.5 |
| COMPLETED Rename =quilt.cpp= to =generation.cpp=                            |         |       |  2:04 |   2.6 |
...
| STARTED Create the =templating= model                                       |         |       |  0:30 |   0.6 |
...
*** STARTED Create the =templating= model                             :story:
