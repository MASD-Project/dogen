...
#+CAPTION: Clock summary at [2017-11-17 Fri 15:22]
| <75>                                                                        |        |   |      |       |
| Headline                                                                    | Time   |   |      |     % |
|-----------------------------------------------------------------------------+--------+---+------+-------|
...
|-----------------------------------------------------------------------------+--------+---+------+-------|
| Active                                                                      | 9:23   |   |      | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |        |   | 1:03 |  11.2 |
| COMPLETED Remove remnants of upsilon                                        |        |   | 0:35 |   6.2 |
| STARTED Create a well-defined set of stereotypes                            |        |   | 7:45 |  82.6 |
...
*** STARTED Create a well-defined set of stereotypes                  :story:
