...
#+CAPTION: Clock summary at [2017-12-06 Wed 23:21]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *54:35* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 54:35   |       |       | 100.0 |
| Active                                                                      |         | 54:35 |       | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  1:03 |   1.9 |
| STARTED Sprint and product backlog grooming                                 |         |       |  2:13 |   4.1 |
| COMPLETED Remove remnants of upsilon                                        |         |       |  0:35 |   1.1 |
| COMPLETED Create a well-defined set of stereotypes                          |         |       |  8:41 |  15.9 |
| COMPLETED Fix rtags setup in laptop                                         |         |       | 13:43 |  25.1 |
| COMPLETED Analysis on moving naming away from sewing terms                  |         |       |  2:21 |   4.3 |
| COMPLETED Implement exomodel in terms of exoelements                        |         |       | 16:03 |  29.4 |
| COMPLETED Fix JSON tests                                                    |         |       |  0:25 |   0.8 |
| COMPLETED Remove all deprecated code after exomodels clean up               |         |       |  2:00 |   3.7 |
| COMPLETED Add some kind of identity to exomodels                            |         |       |  0:12 |   0.4 |
| COMPLETED Clean up tagged values                                            |         |       |  0:23 |   0.7 |
| STARTED Finish setting up coveralls                                         |         |       |  2:57 |   5.4 |
...
*** Create a =transforms= model                                       :story:
