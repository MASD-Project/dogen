...
#+CAPTION: Clock summary at [2017-12-14 Thu 08:48]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *69:19* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 69:19   |       |       | 100.0 |
| Active                                                                      |         | 69:19 |       | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  1:03 |   1.5 |
| STARTED Sprint and product backlog grooming                                 |         |       |  2:42 |   3.9 |
| COMPLETED Remove remnants of upsilon                                        |         |       |  0:35 |   0.8 |
| COMPLETED Create a well-defined set of stereotypes                          |         |       |  8:41 |  12.5 |
| COMPLETED Fix rtags setup in laptop                                         |         |       | 13:43 |  19.8 |
| COMPLETED Analysis on moving naming away from sewing terms                  |         |       |  2:21 |   3.4 |
| COMPLETED Implement exomodel in terms of exoelements                        |         |       | 16:03 |  23.2 |
| COMPLETED Fix JSON tests                                                    |         |       |  0:25 |   0.6 |
| COMPLETED Remove all deprecated code after exomodels clean up               |         |       |  2:00 |   2.9 |
...
| COMPLETED Create a =probing= model                                          |         |       |  1:22 |   2.0 |
| COMPLETED Create the =external= model                                       |         |       |  5:07 |   7.4 |
| COMPLETED Rename =yarn.json= to =external.json=                             |         |       |  1:51 |   2.7 |
| COMPLETED Rename =yarn.dia= to =external.dia=                               |         |       |  2:43 |   3.9 |
| COMPLETED Make =dogen= part of model modules                                |         |       |  3:27 |   5.0 |
| COMPLETED Fix travis build                                                  |         |       |  0:03 |   0.1 |
| STARTED Finish setting up coveralls                                         |         |       |  2:57 |   4.3 |
...
| STARTED Remove exomodel and all deprecated classes                          |         |       |  0:40 |   1.0 |
| STARTED Add model modules to name resolution                                |         |       |  1:02 |   1.5 |
...
*** STARTED Add model modules to name resolution                      :story:
