...
#+CAPTION: Clock summary at [2017-12-19 Tue 08:22]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *70:49* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 70:49   |       |       | 100.0 |
| Active                                                                      |         | 70:49 |       | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  1:03 |   1.5 |
| STARTED Sprint and product backlog grooming                                 |         |       |  2:46 |   3.9 |
| COMPLETED Remove remnants of upsilon                                        |         |       |  0:35 |   0.8 |
| COMPLETED Create a well-defined set of stereotypes                          |         |       |  8:41 |  12.3 |
| COMPLETED Fix rtags setup in laptop                                         |         |       | 13:43 |  19.4 |
| COMPLETED Analysis on moving naming away from sewing terms                  |         |       |  2:21 |   3.3 |
| COMPLETED Implement exomodel in terms of exoelements                        |         |       | 16:03 |  22.7 |
...
| COMPLETED Create the =external= model                                       |         |       |  5:07 |   7.2 |
| COMPLETED Rename =yarn.json= to =external.json=                             |         |       |  1:51 |   2.6 |
| COMPLETED Rename =yarn.dia= to =external.dia=                               |         |       |  2:43 |   3.8 |
| COMPLETED Make =dogen= part of model modules                                |         |       |  3:27 |   4.9 |
| COMPLETED Fix travis build                                                  |         |       |  0:03 |   0.1 |
| COMPLETED Do a quick hack to fix name resolution                            |         |       |  1:20 |   1.9 |
| STARTED Finish setting up coveralls                                         |         |       |  2:57 |   4.2 |
| STARTED Create a single binary for all of dogen                             |         |       |  1:03 |   1.5 |
...
| STARTED Rename =formatters= to =formatting=                                 |         |       |  1:08 |   1.6 |
...
*** STARTED Rename =formatters= to =formatting=                       :story:
