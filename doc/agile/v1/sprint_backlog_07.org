...
#+CAPTION: Clock summary at [2017-12-22 Fri 12:34]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *75:16* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 75:16   |       |       | 100.0 |
| Active                                                                      |         | 75:16 |       | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  1:03 |   1.4 |
| STARTED Sprint and product backlog grooming                                 |         |       |  2:51 |   3.8 |
| COMPLETED Remove remnants of upsilon                                        |         |       |  0:35 |   0.8 |
| COMPLETED Create a well-defined set of stereotypes                          |         |       |  8:41 |  11.5 |
| COMPLETED Fix rtags setup in laptop                                         |         |       | 13:43 |  18.2 |
| COMPLETED Analysis on moving naming away from sewing terms                  |         |       |  2:21 |   3.1 |
| COMPLETED Implement exomodel in terms of exoelements                        |         |       | 16:03 |  21.3 |
| COMPLETED Fix JSON tests                                                    |         |       |  0:25 |   0.6 |
| COMPLETED Remove all deprecated code after exomodels clean up               |         |       |  2:00 |   2.7 |
...
| COMPLETED Create the =external= model                                       |         |       |  5:07 |   6.8 |
| COMPLETED Rename =yarn.json= to =external.json=                             |         |       |  1:51 |   2.5 |
| COMPLETED Rename =yarn.dia= to =external.dia=                               |         |       |  2:43 |   3.6 |
| COMPLETED Make =dogen= part of model modules                                |         |       |  3:27 |   4.6 |
| COMPLETED Fix travis build                                                  |         |       |  0:03 |   0.1 |
| COMPLETED Do a quick hack to fix name resolution                            |         |       |  1:20 |   1.8 |
...
| STARTED Rename =quilt.cpp= to =generation.cpp=                              |         |       |  1:47 |   2.4 |
...
*** STARTED Rename =quilt.cpp= to =generation.cpp=                    :story:
