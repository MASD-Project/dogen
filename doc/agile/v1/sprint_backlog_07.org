...
#+CAPTION: Clock summary at [2017-12-02 Sat 23:08]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                                     | 43:22   |       |       | 100.0 |
| Active                                                                      |         | 43:22 |       | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  1:03 |   2.4 |
| STARTED Sprint and product backlog grooming                                 |         |       |  2:08 |   4.9 |
| COMPLETED Remove remnants of upsilon                                        |         |       |  0:35 |   1.3 |
| COMPLETED Create a well-defined set of stereotypes                          |         |       |  8:41 |  20.0 |
| COMPLETED Fix rtags setup in laptop                                         |         |       | 13:43 |  31.6 |
| COMPLETED Analysis on moving naming away from sewing terms                  |         |       |  2:21 |   5.4 |
| STARTED Finish setting up coveralls                                         |         |       |  2:57 |   6.8 |
| STARTED Create a single binary for all of dogen                             |         |       |  1:03 |   2.4 |
| STARTED Implement exomodel in terms of exoelements                          |         |       | 10:51 |  25.0 |
...
- rename key value pairs to tagged values in yarn.dia processed object.
