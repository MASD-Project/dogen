...
#+CAPTION: Clock summary at [2017-12-01 Fri 13:14]
| <75>                                                                        |         |   |       |       |
| Headline                                                                    | Time    |   |       |     % |
|-----------------------------------------------------------------------------+---------+---+-------+-------|
| *Total time*                                                                | *31:21* |   |       | 100.0 |
|-----------------------------------------------------------------------------+---------+---+-------+-------|
| Active                                                                      | 31:21   |   |       | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |   |  1:03 |   3.3 |
| STARTED Sprint and product backlog grooming                                 |         |   |  2:08 |   6.8 |
| COMPLETED Remove remnants of upsilon                                        |         |   |  0:35 |   1.9 |
| COMPLETED Create a well-defined set of stereotypes                          |         |   |  8:41 |  27.7 |
| COMPLETED Fix rtags setup in laptop                                         |         |   | 13:43 |  43.8 |
| STARTED Finish setting up coveralls                                         |         |   |  2:24 |   7.7 |
| STARTED Analysis on moving naming away from sewing terms                    |         |   |  1:44 |   5.5 |
| STARTED Create a single binary for all of dogen                             |         |   |  1:03 |   3.3 |
...
*** STARTED Analysis on moving naming away from sewing terms           :epic:
...
- =codegen=, including =codegen.cpp= and =codegen.csharp=. model and
  ...
  properties.
- =templates=: merges stitch and wale as namespaces.
