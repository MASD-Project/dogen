...
#+CAPTION: Clock summary at [2017-12-09 Sat 21:04]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| COMPLETED Create a well-defined set of stereotypes                          |         |       |  8:41 |  14.5 |
| COMPLETED Fix rtags setup in laptop                                         |         |       | 13:43 |  22.8 |
| COMPLETED Analysis on moving naming away from sewing terms                  |         |       |  2:21 |   3.9 |
| COMPLETED Implement exomodel in terms of exoelements                        |         |       | 16:03 |  26.7 |
...
| COMPLETED Create the =external= model                                       |         |       |  5:07 |   8.5 |
...
| STARTED Rename =yarn.json= to =external.json=                               |         |       |  0:03 |   0.1 |
