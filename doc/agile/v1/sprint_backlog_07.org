...
#+CAPTION: Clock summary at [2017-12-12 Tue 23:13]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *68:14* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 68:14   |       |       | 100.0 |
| Active                                                                      |         | 68:14 |       | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  1:03 |   1.5 |
| STARTED Sprint and product backlog grooming                                 |         |       |  2:42 |   4.0 |
| COMPLETED Remove remnants of upsilon                                        |         |       |  0:35 |   0.9 |
| COMPLETED Create a well-defined set of stereotypes                          |         |       |  8:41 |  12.7 |
| COMPLETED Fix rtags setup in laptop                                         |         |       | 13:43 |  20.1 |
| COMPLETED Analysis on moving naming away from sewing terms                  |         |       |  2:21 |   3.4 |
| COMPLETED Implement exomodel in terms of exoelements                        |         |       | 16:03 |  23.5 |
...
| COMPLETED Create the =external= model                                       |         |       |  5:07 |   7.5 |
| COMPLETED Rename =yarn.json= to =external.json=                             |         |       |  1:51 |   2.7 |
| COMPLETED Rename =yarn.dia= to =external.dia=                               |         |       |  2:43 |   4.0 |
| COMPLETED Make =dogen= part of model modules                                |         |       |  3:27 |   5.1 |
...
*** Add model modules to name resolution
