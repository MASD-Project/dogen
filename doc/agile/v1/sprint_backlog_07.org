...
#+CAPTION: Clock summary at [2017-12-02 Sat 21:15]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| COMPLETED Create a well-defined set of stereotypes                          |         |       |  8:41 |  20.9 |
| COMPLETED Fix rtags setup in laptop                                         |         |       | 13:43 |  33.0 |
| COMPLETED Analysis on moving naming away from sewing terms                  |         |       |  2:21 |   5.7 |
| STARTED Finish setting up coveralls                                         |         |       |  2:57 |   7.1 |
| STARTED Create a single binary for all of dogen                             |         |       |  1:03 |   2.5 |
| STARTED Implement exomodel in terms of exoelements                          |         |       |  9:01 |  21.7 |
