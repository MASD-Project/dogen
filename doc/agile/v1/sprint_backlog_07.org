...
#+CAPTION: Clock summary at [2017-12-10 Sun 21:34]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                                     | 64:47   |       |       | 100.0 |
| Active                                                                      |         | 64:47 |       | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  1:03 |   1.6 |
| STARTED Sprint and product backlog grooming                                 |         |       |  2:42 |   4.2 |
| COMPLETED Remove remnants of upsilon                                        |         |       |  0:35 |   0.9 |
| COMPLETED Create a well-defined set of stereotypes                          |         |       |  8:41 |  13.4 |
| COMPLETED Fix rtags setup in laptop                                         |         |       | 13:43 |  21.2 |
| COMPLETED Analysis on moving naming away from sewing terms                  |         |       |  2:21 |   3.6 |
| COMPLETED Implement exomodel in terms of exoelements                        |         |       | 16:03 |  24.8 |
| COMPLETED Fix JSON tests                                                    |         |       |  0:25 |   0.6 |
| COMPLETED Remove all deprecated code after exomodels clean up               |         |       |  2:00 |   3.1 |
| COMPLETED Add some kind of identity to exomodels                            |         |       |  0:12 |   0.3 |
| COMPLETED Clean up tagged values                                            |         |       |  0:23 |   0.6 |
| COMPLETED Simplify input model generation in cmake                          |         |       |  0:38 |   1.0 |
| COMPLETED Create a =probing= model                                          |         |       |  1:22 |   2.1 |
| COMPLETED Create the =external= model                                       |         |       |  5:07 |   7.9 |
| COMPLETED Rename =yarn.json= to =external.json=                             |         |       |  1:51 |   2.9 |
| COMPLETED Rename =yarn.dia= to =external.dia=                               |         |       |  2:43 |   4.2 |
| STARTED Finish setting up coveralls                                         |         |       |  2:57 |   4.6 |
| STARTED Create a single binary for all of dogen                             |         |       |  1:03 |   1.6 |
...
*** STARTED Make =dogen= part of model modules                        :story:
