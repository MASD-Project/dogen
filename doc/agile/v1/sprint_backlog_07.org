...
#+CAPTION: Clock summary at [2017-12-06 Wed 20:43]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *51:57* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 51:57   |       |       | 100.0 |
| Active                                                                      |         | 51:57 |       | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  1:03 |   2.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  2:13 |   4.3 |
| COMPLETED Remove remnants of upsilon                                        |         |       |  0:35 |   1.1 |
| COMPLETED Create a well-defined set of stereotypes                          |         |       |  8:41 |  16.7 |
| COMPLETED Fix rtags setup in laptop                                         |         |       | 13:43 |  26.4 |
| COMPLETED Analysis on moving naming away from sewing terms                  |         |       |  2:21 |   4.5 |
| COMPLETED Implement exomodel in terms of exoelements                        |         |       | 16:03 |  30.9 |
| COMPLETED Fix JSON tests                                                    |         |       |  0:25 |   0.8 |
| COMPLETED Remove all deprecated code after exomodels clean up               |         |       |  2:00 |   3.8 |
| COMPLETED Add some kind of identity to exomodels                            |         |       |  0:12 |   0.4 |
| COMPLETED Clean up tagged values                                            |         |       |  0:23 |   0.7 |
| STARTED Finish setting up coveralls                                         |         |       |  2:57 |   5.7 |
| STARTED Create a single binary for all of dogen                             |         |       |  1:03 |   2.0 |
| STARTED Investigate current implementation of the origin transform          |         |       |  0:18 |   0.6 |
