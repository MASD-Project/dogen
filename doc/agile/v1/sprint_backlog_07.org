...
#+CAPTION: Clock summary at [2017-12-22 Fri 17:32]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *77:44* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 77:44   |       |       | 100.0 |
| Active                                                                      |         | 77:44 |       | 100.0 |
...
| COMPLETED Create a well-defined set of stereotypes                          |         |       |  8:41 |  11.2 |
| COMPLETED Fix rtags setup in laptop                                         |         |       | 13:43 |  17.6 |
| COMPLETED Analysis on moving naming away from sewing terms                  |         |       |  2:21 |   3.0 |
| COMPLETED Implement exomodel in terms of exoelements                        |         |       | 16:03 |  20.6 |
...
| COMPLETED Create the =external= model                                       |         |       |  5:07 |   6.6 |
| COMPLETED Rename =yarn.json= to =external.json=                             |         |       |  1:51 |   2.4 |
| COMPLETED Rename =yarn.dia= to =external.dia=                               |         |       |  2:43 |   3.5 |
| COMPLETED Make =dogen= part of model modules                                |         |       |  3:27 |   4.4 |
...
| COMPLETED Rename =yarn= to =modeling=                                       |         |       |  1:58 |   2.5 |
| COMPLETED Rename =quilt.cpp= to =generation.cpp=                            |         |       |  2:04 |   2.7 |
| COMPLETED Rename =quilt.csharp= to =generation.csharp=                      |         |       |  2:11 |   2.8 |
| STARTED Finish setting up coveralls                                         |         |       |  2:57 |   3.8 |
