...
#+CAPTION: Clock summary at [2017-12-22 Fri 21:42]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *78:53* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 78:53   |       |       | 100.0 |
| Active                                                                      |         | 78:53 |       | 100.0 |
...
| COMPLETED Create a well-defined set of stereotypes                          |         |       |  8:41 |  11.0 |
| COMPLETED Fix rtags setup in laptop                                         |         |       | 13:43 |  17.4 |
| COMPLETED Analysis on moving naming away from sewing terms                  |         |       |  2:21 |   3.0 |
| COMPLETED Implement exomodel in terms of exoelements                        |         |       | 16:03 |  20.3 |
| COMPLETED Fix JSON tests                                                    |         |       |  0:25 |   0.5 |
| COMPLETED Remove all deprecated code after exomodels clean up               |         |       |  2:00 |   2.5 |
...
| COMPLETED Rename =yarn.json= to =external.json=                             |         |       |  1:51 |   2.3 |
| COMPLETED Rename =yarn.dia= to =external.dia=                               |         |       |  2:43 |   3.4 |
...
| STARTED Finish setting up coveralls                                         |         |       |  2:57 |   3.7 |
...
| STARTED Create the =templating= model                                       |         |       |  1:09 |   1.5 |
