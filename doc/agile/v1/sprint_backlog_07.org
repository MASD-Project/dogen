...
#+CAPTION: Clock summary at [2017-12-10 Sun 00:09]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *62:59* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 62:59   |       |       | 100.0 |
| Active                                                                      |         | 62:59 |       | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  1:03 |   1.7 |
| STARTED Sprint and product backlog grooming                                 |         |       |  2:23 |   3.8 |
| COMPLETED Remove remnants of upsilon                                        |         |       |  0:35 |   0.9 |
| COMPLETED Create a well-defined set of stereotypes                          |         |       |  8:41 |  13.8 |
| COMPLETED Fix rtags setup in laptop                                         |         |       | 13:43 |  21.8 |
| COMPLETED Analysis on moving naming away from sewing terms                  |         |       |  2:21 |   3.7 |
| COMPLETED Implement exomodel in terms of exoelements                        |         |       | 16:03 |  25.5 |
| COMPLETED Fix JSON tests                                                    |         |       |  0:25 |   0.7 |
| COMPLETED Remove all deprecated code after exomodels clean up               |         |       |  2:00 |   3.2 |
...
| COMPLETED Create a =probing= model                                          |         |       |  1:22 |   2.2 |
| COMPLETED Create the =external= model                                       |         |       |  5:07 |   8.1 |
| STARTED Finish setting up coveralls                                         |         |       |  2:57 |   4.7 |
| STARTED Create a single binary for all of dogen                             |         |       |  1:03 |   1.7 |
| STARTED Investigate current implementation of the origin transform          |         |       |  0:18 |   0.5 |
| STARTED Rename =yarn.dia= to =external.dia=                                 |         |       |  1:20 |   2.1 |
| STARTED Rename =yarn.json= to =external.json=                               |         |       |  1:45 |   2.8 |
| STARTED Remove exomodel and all deprecated classes                          |         |       |  0:40 |   1.1 |
...
*** STARTED Rename =yarn.json= to =external.json=                     :story:
