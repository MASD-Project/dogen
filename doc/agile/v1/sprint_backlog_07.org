...
#+CAPTION: Clock summary at [2017-12-22 Fri 15:04]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *76:17* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 76:17   |       |       | 100.0 |
| Active                                                                      |         | 76:17 |       | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  1:03 |   1.4 |
| STARTED Sprint and product backlog grooming                                 |         |       |  2:51 |   3.7 |
| COMPLETED Remove remnants of upsilon                                        |         |       |  0:35 |   0.8 |
| COMPLETED Create a well-defined set of stereotypes                          |         |       |  8:41 |  11.4 |
| COMPLETED Fix rtags setup in laptop                                         |         |       | 13:43 |  18.0 |
| COMPLETED Analysis on moving naming away from sewing terms                  |         |       |  2:21 |   3.1 |
| COMPLETED Implement exomodel in terms of exoelements                        |         |       | 16:03 |  21.0 |
| COMPLETED Fix JSON tests                                                    |         |       |  0:25 |   0.5 |
| COMPLETED Remove all deprecated code after exomodels clean up               |         |       |  2:00 |   2.6 |
...
| COMPLETED Create a =probing= model                                          |         |       |  1:22 |   1.8 |
| COMPLETED Create the =external= model                                       |         |       |  5:07 |   6.7 |
| COMPLETED Rename =yarn.json= to =external.json=                             |         |       |  1:51 |   2.4 |
| COMPLETED Rename =yarn.dia= to =external.dia=                               |         |       |  2:43 |   3.6 |
| COMPLETED Make =dogen= part of model modules                                |         |       |  3:27 |   4.5 |
| COMPLETED Fix travis build                                                  |         |       |  0:03 |   0.1 |
| COMPLETED Do a quick hack to fix name resolution                            |         |       |  1:20 |   1.7 |
| COMPLETED Rename =formatters= to =formatting=                               |         |       |  1:45 |   2.3 |
| COMPLETED Rename =yarn= to =modeling=                                       |         |       |  1:58 |   2.6 |
| COMPLETED Rename =quilt.cpp= to =generation.cpp=                            |         |       |  2:04 |   2.7 |
| STARTED Finish setting up coveralls                                         |         |       |  2:57 |   3.9 |
| STARTED Create a single binary for all of dogen                             |         |       |  1:03 |   1.4 |
| STARTED Investigate current implementation of the origin transform          |         |       |  0:18 |   0.4 |
| STARTED Remove exomodel and all deprecated classes                          |         |       |  0:40 |   0.9 |
| STARTED Rename =quilt.csharp= to =generation.csharp=                        |         |       |  0:44 |   1.0 |
...
*** STARTED Rename =quilt.csharp= to =generation.csharp=              :story:
    CLOCK: [2017-12-22 Fri 14:20]--[2017-12-22 Fri 15:04] =>  0:44

As per analysis story, we are moving away from the sewing terms.

*** Create the =templating= model                                     :story:
