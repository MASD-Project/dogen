...
#+CAPTION: Clock summary at [2017-11-29 Wed 23:47]
| <75>                                                                        |         |   |       |       |
| Headline                                                                    | Time    |   |       |     % |
|-----------------------------------------------------------------------------+---------+---+-------+-------|
...
|-----------------------------------------------------------------------------+---------+---+-------+-------|
| Active                                                                      | 27:46   |   |       | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |   |  1:03 |   3.8 |
| STARTED Sprint and product backlog grooming                                 |         |   |  1:20 |   4.8 |
| COMPLETED Remove remnants of upsilon                                        |         |   |  0:35 |   2.1 |
| COMPLETED Create a well-defined set of stereotypes                          |         |   |  8:41 |  31.3 |
| COMPLETED Fix rtags setup in laptop                                         |         |   | 13:43 |  49.4 |
| STARTED Finish setting up coveralls                                         |         |   |  2:24 |   8.6 |
...
*** Consider moving model names away from sewing terms                 :epic:
