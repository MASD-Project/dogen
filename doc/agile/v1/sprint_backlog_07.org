...
#+CAPTION: Clock summary at [2017-12-23 Sat 12:16]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| COMPLETED Create a well-defined set of stereotypes                          |         |       |  8:41 |  10.7 |
| COMPLETED Fix rtags setup in laptop                                         |         |       | 13:43 |  17.0 |
| COMPLETED Analysis on moving naming away from sewing terms                  |         |       |  2:21 |   2.9 |
| COMPLETED Implement exomodel in terms of exoelements                        |         |       | 16:03 |  19.9 |
...
| COMPLETED Create the =external= model                                       |         |       |  5:07 |   6.3 |
...
| STARTED Create the =generation= model                                       |         |       |  1:50 |   2.3 |
