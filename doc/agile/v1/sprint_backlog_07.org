...
#+CAPTION: Clock summary at [2017-12-01 Fri 23:32]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| COMPLETED Create a well-defined set of stereotypes                          |         |       |  8:41 |  23.4 |
| COMPLETED Fix rtags setup in laptop                                         |         |       | 13:43 |  37.0 |
| COMPLETED Analysis on moving naming away from sewing terms                  |         |       |  2:21 |   6.3 |
| STARTED Finish setting up coveralls                                         |         |       |  2:57 |   8.0 |
| STARTED Create a single binary for all of dogen                             |         |       |  1:03 |   2.8 |
| STARTED Implement exomodel in terms of exoelements                          |         |       |  4:31 |  12.2 |
