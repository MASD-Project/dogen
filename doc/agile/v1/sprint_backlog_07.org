...
#+CAPTION: Clock summary at [2017-12-21 Thu 22:02]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *72:31* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 72:31   |       |       | 100.0 |
| Active                                                                      |         | 72:31 |       | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  1:03 |   1.4 |
| STARTED Sprint and product backlog grooming                                 |         |       |  2:46 |   3.8 |
| COMPLETED Remove remnants of upsilon                                        |         |       |  0:35 |   0.8 |
| COMPLETED Create a well-defined set of stereotypes                          |         |       |  8:41 |  12.0 |
| COMPLETED Fix rtags setup in laptop                                         |         |       | 13:43 |  18.9 |
| COMPLETED Analysis on moving naming away from sewing terms                  |         |       |  2:21 |   3.2 |
| COMPLETED Implement exomodel in terms of exoelements                        |         |       | 16:03 |  22.1 |
| COMPLETED Fix JSON tests                                                    |         |       |  0:25 |   0.6 |
| COMPLETED Remove all deprecated code after exomodels clean up               |         |       |  2:00 |   2.8 |
| COMPLETED Add some kind of identity to exomodels                            |         |       |  0:12 |   0.3 |
| COMPLETED Clean up tagged values                                            |         |       |  0:23 |   0.5 |
| COMPLETED Simplify input model generation in cmake                          |         |       |  0:38 |   0.9 |
| COMPLETED Create a =probing= model                                          |         |       |  1:22 |   1.9 |
| COMPLETED Create the =external= model                                       |         |       |  5:07 |   7.1 |
| COMPLETED Rename =yarn.json= to =external.json=                             |         |       |  1:51 |   2.6 |
| COMPLETED Rename =yarn.dia= to =external.dia=                               |         |       |  2:43 |   3.7 |
| COMPLETED Make =dogen= part of model modules                                |         |       |  3:27 |   4.8 |
| COMPLETED Fix travis build                                                  |         |       |  0:03 |   0.1 |
| COMPLETED Do a quick hack to fix name resolution                            |         |       |  1:20 |   1.8 |
| COMPLETED Rename =formatters= to =formatting=                               |         |       |  1:45 |   2.4 |
| STARTED Finish setting up coveralls                                         |         |       |  2:57 |   4.1 |
...
| STARTED Rename =yarn= to =modeling=                                         |         |       |  1:05 |   1.5 |
...
*** STARTED Rename =yarn= to =modeling=                               :story:
