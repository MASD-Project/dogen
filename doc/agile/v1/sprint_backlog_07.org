...
#+CAPTION: Clock summary at [2017-12-05 Tue 21:36]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| COMPLETED Create a well-defined set of stereotypes                          |         |       |  8:41 |  16.9 |
| COMPLETED Fix rtags setup in laptop                                         |         |       | 13:43 |  26.7 |
| COMPLETED Analysis on moving naming away from sewing terms                  |         |       |  2:21 |   4.6 |
| COMPLETED Implement exomodel in terms of exoelements                        |         |       | 16:03 |  31.3 |
| COMPLETED Fix JSON tests                                                    |         |       |  0:25 |   0.8 |
| COMPLETED Remove all deprecated code after exomodels clean up               |         |       |  2:00 |   3.9 |
...
| STARTED Clean up tagged values                                              |         |       |  0:05 |   0.2 |
...
*** STARTED Clean up tagged values                                    :story:
