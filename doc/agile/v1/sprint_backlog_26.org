...
#+CAPTION: Clock summary at [2020-06-19 Fri 17:56]
| <75>                                                       |         |       |       |       |
| Headline                                                   | Time    |       |       |     % |
|------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                               | *38:03* |       |       | 100.0 |
|------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                    | 38:03   |       |       | 100.0 |
| Active                                                     |         | 38:03 |       | 100.0 |
| Edit release notes for previous sprint                     |         |       |  7:42 |  20.2 |
| Create a demo and presentation for previous sprint         |         |       |  1:11 |   3.1 |
| Sprint and product backlog grooming                        |         |       |  2:43 |   7.1 |
| Nightly nursing                                            |         |       |  0:11 |   0.5 |
| Merge kernel with physical meta-model                      |         |       |  1:31 |   4.0 |
| Convert =wale_template_reference= to meta-data             |         |       |  0:37 |   1.6 |
| Create an emacs mode for wale                              |         |       |  0:14 |   0.6 |
| Create a TS agnostic representation of inclusion           |         |       |  3:04 |   8.1 |
| Analysis on reducing the number of required wale keys      |         |       |  1:11 |   3.1 |
| Use PMM to compute =meta_name_indices=                     |         |       |  3:03 |   8.0 |
| Split archetype factory from transform                     |         |       | 10:57 |  28.8 |
| Paper: Using Aspects to Model Product Line Variability     |         |       |  1:11 |   3.1 |
| Remove traits for archetypes                               |         |       |  0:44 |   1.9 |
| Analysis on solving relationship problems                  |         |       |  3:08 |   8.2 |
| Archetype kind and postfix as symptoms of a larger pattern |         |       |  0:36 |   1.6 |
