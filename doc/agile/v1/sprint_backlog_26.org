...
#+CAPTION: Clock summary at [2020-06-27 Sat 00:13]
| <75>                                                              |         |       |       |       |
| Headline                                                          | Time    |       |       |     % |
|-------------------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                           | 56:09   |       |       | 100.0 |
| Active                                                            |         | 56:09 |       | 100.0 |
| Edit release notes for previous sprint                            |         |       |  7:42 |  13.7 |
| Create a demo and presentation for previous sprint                |         |       |  1:11 |   2.1 |
| Sprint and product backlog grooming                               |         |       |  4:35 |   8.2 |
| Nightly nursing                                                   |         |       |  0:11 |   0.3 |
| Merge kernel with physical meta-model                             |         |       |  1:31 |   2.7 |
| Convert =wale_template_reference= to meta-data                    |         |       |  0:37 |   1.1 |
| Create an emacs mode for wale                                     |         |       |  0:14 |   0.4 |
| Create a TS agnostic representation of inclusion                  |         |       |  3:04 |   5.5 |
| Analysis on reducing the number of required wale keys             |         |       |  1:11 |   2.1 |
| Use PMM to compute =meta_name_indices=                            |         |       |  3:03 |   5.4 |
| Split archetype factory from transform                            |         |       | 10:57 |  19.5 |
| Paper: Using Aspects to Model Product Line Variability            |         |       |  1:11 |   2.1 |
| Remove traits for archetypes                                      |         |       |  0:44 |   1.3 |
| Analysis on solving relationship problems                         |         |       |  4:45 |   8.5 |
| Archetype kind and postfix as parts of a larger pattern           |         |       |  0:36 |   1.1 |
| Paper: A flexible code generator for MOF-based modeling languages |         |       |  1:08 |   2.0 |
| Add labels to archetypes                                          |         |       |  2:22 |   4.2 |
| Improve org-mode converter                                        |         |       |  5:15 |   9.3 |
| Add relations between archetypes in the PMM                       |         |       |  4:00 |   7.1 |
| Analysis on implementing containment with configuration           |         |       |  1:52 |   3.3 |
