...
#+CAPTION: Clock summary at [2020-07-10 Fri 23:17]
| <75>                                                              |         |       |       |       |
| Headline                                                          | Time    |       |       |     % |
|-------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                      | *81:34* |       |       | 100.0 |
|-------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                           | 81:34   |       |       | 100.0 |
| Active                                                            |         | 81:34 |       | 100.0 |
| Edit release notes for previous sprint                            |         |       |  8:00 |   9.8 |
| Create a demo and presentation for previous sprint                |         |       |  1:11 |   1.5 |
| Sprint and product backlog grooming                               |         |       |  5:49 |   7.1 |
| Nightly nursing                                                   |         |       |  0:11 |   0.2 |
| Merge kernel with physical meta-model                             |         |       |  1:31 |   1.9 |
| Convert =wale_template_reference= to meta-data                    |         |       |  0:37 |   0.8 |
| Create an emacs mode for wale                                     |         |       |  0:14 |   0.3 |
| Create a TS agnostic representation of inclusion                  |         |       |  3:04 |   3.8 |
| Analysis on reducing the number of required wale keys             |         |       |  1:11 |   1.5 |
| Use PMM to compute =meta_name_indices=                            |         |       |  3:03 |   3.7 |
| Split archetype factory from transform                            |         |       | 10:57 |  13.4 |
| Paper: Using Aspects to Model Product Line Variability            |         |       |  1:11 |   1.5 |
| Remove traits for archetypes                                      |         |       |  0:44 |   0.9 |
| Analysis on solving relationship problems                         |         |       |  4:45 |   5.8 |
| Archetype kind and postfix as parts of a larger pattern           |         |       |  0:36 |   0.7 |
| Paper: A flexible code generator for MOF-based modeling languages |         |       |  1:08 |   1.4 |
| Add labels to archetypes                                          |         |       |  2:22 |   2.9 |
| Add support for CSV values in variability                         |         |       |  0:56 |   1.1 |
| Add hash map of artefacts in physical model                       |         |       |  2:59 |   3.7 |
| Analysis on archetype relations for stitch templates              |         |       |  2:07 |   2.6 |
...
| Paper: A Comparison of Generative Approaches: XVCL and GenVoca    |         |       |  1:20 |   1.6 |
| Paper: An evaluation of the Graphical Modeling Framework GMF      |         |       |  1:12 |   1.5 |
| Problems starting clangd                                          |         |       |  1:25 |   1.7 |
| Add relations between archetypes in the PMM                       |         |       | 13:50 |  17.0 |
| Improve org-mode converter                                        |         |       |  5:35 |   6.8 |
| Analysis on implementing containment with configuration           |         |       |  1:52 |   2.3 |
| Create an archetype repository in physical model                  |         |       |  2:00 |   2.5 |
...
- create a factory that makes archetype repositories from a PMM and a
  logical model.
- run the archetype repository chain from the
  =logical_model_to_text_model_transform= chain.
- create an adapter that converts archetype repository
