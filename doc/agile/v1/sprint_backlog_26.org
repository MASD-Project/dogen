...
#+CAPTION: Clock summary at [2020-06-07 Sun 16:39]
| <75>                                                  |         |       |      |       |
| Headline                                              | Time    |       |      |     % |
|-------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                               | 20:28   |       |      | 100.0 |
| Active                                                |         | 20:28 |      | 100.0 |
| Edit release notes for previous sprint                |         |       | 7:42 |  37.6 |
| Create a demo and presentation for previous sprint    |         |       | 1:11 |   5.8 |
| Sprint and product backlog grooming                   |         |       | 1:44 |   8.5 |
| Nightly nursing                                       |         |       | 0:11 |   0.9 |
| Merge kernel with physical meta-model                 |         |       | 1:31 |   7.4 |
| Convert =wale_template_reference= to meta-data        |         |       | 0:37 |   3.0 |
| Create an emacs mode for wale                         |         |       | 0:14 |   1.1 |
| Create a TS agnostic representation of inclusion      |         |       | 3:04 |  15.0 |
| Analysis on reducing the number of required wale keys |         |       | 1:11 |   5.8 |
| Use PMM to compute =meta_name_indices=                |         |       | 3:03 |  14.9 |
