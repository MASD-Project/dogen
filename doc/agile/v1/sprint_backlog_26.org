...
#+CAPTION: Clock summary at [2020-06-27 Sat 21:16]
| <75>                                                              |         |       |       |       |
| Headline                                                          | Time    |       |       |     % |
|-------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                      | *58:33* |       |       | 100.0 |
|-------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                           | 58:33   |       |       | 100.0 |
| Active                                                            |         | 58:33 |       | 100.0 |
| Edit release notes for previous sprint                            |         |       |  7:42 |  13.2 |
| Create a demo and presentation for previous sprint                |         |       |  1:11 |   2.0 |
| Sprint and product backlog grooming                               |         |       |  4:35 |   7.8 |
| Nightly nursing                                                   |         |       |  0:11 |   0.3 |
| Merge kernel with physical meta-model                             |         |       |  1:31 |   2.6 |
| Convert =wale_template_reference= to meta-data                    |         |       |  0:37 |   1.1 |
| Create an emacs mode for wale                                     |         |       |  0:14 |   0.4 |
| Create a TS agnostic representation of inclusion                  |         |       |  3:04 |   5.2 |
| Analysis on reducing the number of required wale keys             |         |       |  1:11 |   2.0 |
| Use PMM to compute =meta_name_indices=                            |         |       |  3:03 |   5.2 |
| Split archetype factory from transform                            |         |       | 10:57 |  18.7 |
| Paper: Using Aspects to Model Product Line Variability            |         |       |  1:11 |   2.0 |
| Remove traits for archetypes                                      |         |       |  0:44 |   1.3 |
| Analysis on solving relationship problems                         |         |       |  4:45 |   8.1 |
| Archetype kind and postfix as parts of a larger pattern           |         |       |  0:36 |   1.0 |
| Paper: A flexible code generator for MOF-based modeling languages |         |       |  1:08 |   1.9 |
| Add labels to archetypes                                          |         |       |  2:22 |   4.0 |
| Improve org-mode converter                                        |         |       |  5:15 |   9.0 |
| Add relations between archetypes in the PMM                       |         |       |  6:21 |  10.8 |
| Analysis on implementing containment with configuration           |         |       |  1:52 |   3.2 |
| Add support for CSV values in variability                         |         |       |  0:03 |   0.1 |
...
*** STARTED Add support for CSV values in variability                 :story:
    :LOGBOOK:
