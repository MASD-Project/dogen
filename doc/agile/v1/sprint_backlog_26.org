...
#+CAPTION: Clock summary at [2020-06-13 Sat 00:30]
| <75>                                                       |         |       |      |       |
| Headline                                                   | Time    |       |      |     % |
|------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                    | 30:10   |       |      | 100.0 |
| Active                                                     |         | 30:10 |      | 100.0 |
| Edit release notes for previous sprint                     |         |       | 7:42 |  25.5 |
| Create a demo and presentation for previous sprint         |         |       | 1:11 |   3.9 |
| Sprint and product backlog grooming                        |         |       | 2:10 |   7.2 |
| Nightly nursing                                            |         |       | 0:11 |   0.6 |
| Merge kernel with physical meta-model                      |         |       | 1:31 |   5.0 |
| Convert =wale_template_reference= to meta-data             |         |       | 0:37 |   2.0 |
| Create an emacs mode for wale                              |         |       | 0:14 |   0.8 |
| Create a TS agnostic representation of inclusion           |         |       | 3:04 |  10.2 |
| Analysis on reducing the number of required wale keys      |         |       | 1:11 |   3.9 |
| Use PMM to compute =meta_name_indices=                     |         |       | 3:03 |  10.1 |
| Split archetype factory from transform                     |         |       | 8:40 |  28.7 |
| Archetype kind and postfix as symptoms of a larger pattern |         |       | 0:36 |   2.0 |
