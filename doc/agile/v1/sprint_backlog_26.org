...
#+CAPTION: Clock summary at [2020-06-07 Sun 12:24]
| <75>                                                  |         |       |      |       |
| Headline                                              | Time    |       |      |     % |
|-------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                          | *17:40* |       |      | 100.0 |
|-------------------------------------------------------+---------+-------+------+-------|
| Stories                                               | 17:40   |       |      | 100.0 |
| Active                                                |         | 17:40 |      | 100.0 |
| Edit release notes for previous sprint                |         |       | 7:42 |  43.6 |
| Create a demo and presentation for previous sprint    |         |       | 1:11 |   6.7 |
| Sprint and product backlog grooming                   |         |       | 1:34 |   8.9 |
| Nightly nursing                                       |         |       | 0:11 |   1.0 |
| Merge kernel with physical meta-model                 |         |       | 1:31 |   8.6 |
| Convert =wale_template_reference= to meta-data        |         |       | 0:37 |   3.5 |
| Create an emacs mode for wale                         |         |       | 0:14 |   1.3 |
| Create a TS agnostic representation of inclusion      |         |       | 3:04 |  17.4 |
| Use PMM to compute =meta_name_indices=                |         |       | 0:25 |   2.4 |
| Analysis on reducing the number of required wale keys |         |       | 1:11 |   6.7 |
