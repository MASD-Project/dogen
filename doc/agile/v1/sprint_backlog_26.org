...
#+CAPTION: Clock summary at [2020-06-12 Fri 23:15]
| <75>                                                       |         |       |      |       |
| Headline                                                   | Time    |       |      |     % |
|------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                               | *28:57* |       |      | 100.0 |
|------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                    | 28:57   |       |      | 100.0 |
| Active                                                     |         | 28:57 |      | 100.0 |
| Edit release notes for previous sprint                     |         |       | 7:42 |  26.6 |
| Create a demo and presentation for previous sprint         |         |       | 1:11 |   4.1 |
| Sprint and product backlog grooming                        |         |       | 2:10 |   7.5 |
| Nightly nursing                                            |         |       | 0:11 |   0.6 |
| Merge kernel with physical meta-model                      |         |       | 1:31 |   5.2 |
| Convert =wale_template_reference= to meta-data             |         |       | 0:37 |   2.1 |
| Create an emacs mode for wale                              |         |       | 0:14 |   0.8 |
| Create a TS agnostic representation of inclusion           |         |       | 3:04 |  10.6 |
| Analysis on reducing the number of required wale keys      |         |       | 1:11 |   4.1 |
| Use PMM to compute =meta_name_indices=                     |         |       | 3:03 |  10.5 |
| Split archetype factory from transform                     |         |       | 7:27 |  25.7 |
| Archetype kind and postfix as symptoms of a larger pattern |         |       | 0:36 |   2.1 |
