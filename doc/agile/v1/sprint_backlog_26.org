...
#+CAPTION: Clock summary at [2020-06-26 Fri 13:17]
| <75>                                                              |         |       |       |       |
| Headline                                                          | Time    |       |       |     % |
|-------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                      | *51:34* |       |       | 100.0 |
|-------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                           | 51:34   |       |       | 100.0 |
| Active                                                            |         | 51:34 |       | 100.0 |
| Edit release notes for previous sprint                            |         |       |  7:42 |  14.9 |
| Create a demo and presentation for previous sprint                |         |       |  1:11 |   2.3 |
| Sprint and product backlog grooming                               |         |       |  4:35 |   8.9 |
| Nightly nursing                                                   |         |       |  0:11 |   0.4 |
| Merge kernel with physical meta-model                             |         |       |  1:31 |   2.9 |
| Convert =wale_template_reference= to meta-data                    |         |       |  0:37 |   1.2 |
| Create an emacs mode for wale                                     |         |       |  0:14 |   0.5 |
| Create a TS agnostic representation of inclusion                  |         |       |  3:04 |   5.9 |
| Analysis on reducing the number of required wale keys             |         |       |  1:11 |   2.3 |
| Use PMM to compute =meta_name_indices=                            |         |       |  3:03 |   5.9 |
| Split archetype factory from transform                            |         |       | 10:57 |  21.2 |
| Paper: Using Aspects to Model Product Line Variability            |         |       |  1:11 |   2.3 |
| Remove traits for archetypes                                      |         |       |  0:44 |   1.4 |
| Analysis on solving relationship problems                         |         |       |  4:45 |   9.2 |
| Archetype kind and postfix as parts of a larger pattern           |         |       |  0:36 |   1.2 |
| Paper: A flexible code generator for MOF-based modeling languages |         |       |  1:08 |   2.2 |
| Add labels to archetypes                                          |         |       |  2:22 |   4.6 |
| Improve org-mode converter                                        |         |       |  5:15 |  10.2 |
| Add relations between archetypes in the PMM                       |         |       |  1:17 |   2.5 |
