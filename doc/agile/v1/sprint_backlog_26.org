...
#+CAPTION: Clock summary at [2020-06-13 Sat 19:46]
| <75>                                                       |         |       |       |       |
| Headline                                                   | Time    |       |       |     % |
|------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                               | *32:29* |       |       | 100.0 |
|------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                    | 32:29   |       |       | 100.0 |
| Active                                                     |         | 32:29 |       | 100.0 |
| Edit release notes for previous sprint                     |         |       |  7:42 |  23.7 |
| Create a demo and presentation for previous sprint         |         |       |  1:11 |   3.6 |
| Sprint and product backlog grooming                        |         |       |  2:12 |   6.8 |
| Nightly nursing                                            |         |       |  0:11 |   0.6 |
| Merge kernel with physical meta-model                      |         |       |  1:31 |   4.7 |
| Convert =wale_template_reference= to meta-data             |         |       |  0:37 |   1.9 |
| Create an emacs mode for wale                              |         |       |  0:14 |   0.7 |
| Create a TS agnostic representation of inclusion           |         |       |  3:04 |   9.4 |
| Analysis on reducing the number of required wale keys      |         |       |  1:11 |   3.6 |
| Use PMM to compute =meta_name_indices=                     |         |       |  3:03 |   9.4 |
| Split archetype factory from transform                     |         |       | 10:57 |  33.7 |
| Archetype kind and postfix as symptoms of a larger pattern |         |       |  0:36 |   1.8 |
...
*** Remove traits for archetypes                                      :story:
