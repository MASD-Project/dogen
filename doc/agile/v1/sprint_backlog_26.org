...
#+CAPTION: Clock summary at [2020-06-26 Fri 19:34]
| <75>                                                              |         |       |       |       |
| Headline                                                          | Time    |       |       |     % |
|-------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                      | *53:37* |       |       | 100.0 |
|-------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                           | 53:37   |       |       | 100.0 |
| Active                                                            |         | 53:37 |       | 100.0 |
| Edit release notes for previous sprint                            |         |       |  7:42 |  14.4 |
| Create a demo and presentation for previous sprint                |         |       |  1:11 |   2.2 |
| Sprint and product backlog grooming                               |         |       |  4:35 |   8.5 |
| Nightly nursing                                                   |         |       |  0:11 |   0.3 |
| Merge kernel with physical meta-model                             |         |       |  1:31 |   2.8 |
| Convert =wale_template_reference= to meta-data                    |         |       |  0:37 |   1.2 |
| Create an emacs mode for wale                                     |         |       |  0:14 |   0.4 |
| Create a TS agnostic representation of inclusion                  |         |       |  3:04 |   5.7 |
| Analysis on reducing the number of required wale keys             |         |       |  1:11 |   2.2 |
| Use PMM to compute =meta_name_indices=                            |         |       |  3:03 |   5.7 |
| Split archetype factory from transform                            |         |       | 10:57 |  20.4 |
| Paper: Using Aspects to Model Product Line Variability            |         |       |  1:11 |   2.2 |
| Remove traits for archetypes                                      |         |       |  0:44 |   1.4 |
| Analysis on solving relationship problems                         |         |       |  4:45 |   8.9 |
| Archetype kind and postfix as parts of a larger pattern           |         |       |  0:36 |   1.1 |
| Paper: A flexible code generator for MOF-based modeling languages |         |       |  1:08 |   2.1 |
| Add labels to archetypes                                          |         |       |  2:22 |   4.4 |
| Improve org-mode converter                                        |         |       |  5:15 |   9.8 |
| Add relations between archetypes in the PMM                       |         |       |  3:20 |   6.2 |
