...
#+CAPTION: Clock summary at [2020-06-06 Sat 13:33]
| <75>                                               |         |       |      |       |
| Headline                                           | Time    |       |      |     % |
|----------------------------------------------------+---------+-------+------+-------|
...
| Stories                                            | 15:35   |       |      | 100.0 |
| Active                                             |         | 15:35 |      | 100.0 |
| Edit release notes for previous sprint             |         |       | 7:42 |  49.4 |
| Create a demo and presentation for previous sprint |         |       | 1:11 |   7.6 |
| Sprint and product backlog grooming                |         |       | 0:47 |   5.0 |
| Nightly nursing                                    |         |       | 0:11 |   1.2 |
| Merge kernel with physical meta-model              |         |       | 1:31 |   9.7 |
| Convert =wale_template_reference= to meta-data     |         |       | 0:37 |   4.0 |
| Create an emacs mode for wale                      |         |       | 0:14 |   1.5 |
| Use PMM to compute =meta_name_indices=             |         |       | 0:25 |   2.7 |
| Create a TS agnostic representation of inclusion   |         |       | 2:19 |  14.9 |
| Reduce number of required wale keys                |         |       | 0:38 |   4.1 |
