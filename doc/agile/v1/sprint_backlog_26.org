...
#+CAPTION: Clock summary at [2020-07-12 Sun 02:13]
| <75>                                                              |         |       |       |       |
| Headline                                                          | Time    |       |       |     % |
|-------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                      | *90:00* |       |       | 100.0 |
|-------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                           | 90:00   |       |       | 100.0 |
| Active                                                            |         | 90:00 |       | 100.0 |
| Edit release notes for previous sprint                            |         |       |  8:00 |   8.9 |
| Create a demo and presentation for previous sprint                |         |       |  1:11 |   1.3 |
| Sprint and product backlog grooming                               |         |       |  5:49 |   6.5 |
| Build nursing                                                     |         |       |  0:54 |   1.0 |
| Merge kernel with physical meta-model                             |         |       |  1:31 |   1.7 |
| Convert =wale_template_reference= to meta-data                    |         |       |  0:37 |   0.7 |
| Create an emacs mode for wale                                     |         |       |  0:14 |   0.3 |
| Create a TS agnostic representation of inclusion                  |         |       |  3:04 |   3.4 |
| Analysis on reducing the number of required wale keys             |         |       |  1:11 |   1.3 |
| Use PMM to compute =meta_name_indices=                            |         |       |  3:03 |   3.4 |
| Split archetype factory from transform                            |         |       | 10:57 |  12.2 |
| Paper: Using Aspects to Model Product Line Variability            |         |       |  1:11 |   1.3 |
| Remove traits for archetypes                                      |         |       |  0:44 |   0.8 |
| Analysis on solving relationship problems                         |         |       |  4:45 |   5.3 |
...
| Add labels to archetypes                                          |         |       |  2:22 |   2.6 |
| Add support for CSV values in variability                         |         |       |  0:56 |   1.0 |
| Add hash map of artefacts in physical model                       |         |       |  2:59 |   3.3 |
| Analysis on archetype relations for stitch templates              |         |       |  2:07 |   2.4 |
...
| Add relations between archetypes in the PMM                       |         |       | 13:50 |  15.4 |
| Improve org-mode converter                                        |         |       |  5:35 |   6.2 |
| Analysis on implementing containment with configuration           |         |       |  1:52 |   2.1 |
| Create an archetype repository in physical model                  |         |       |  9:43 |  10.8 |
