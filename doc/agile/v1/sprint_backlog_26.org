...
#+CAPTION: Clock summary at [2020-07-04 Sat 18:16]
| <75>                                                              |         |       |       |       |
| Headline                                                          | Time    |       |       |     % |
|-------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                      | *65:32* |       |       | 100.0 |
|-------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                           | 65:32   |       |       | 100.0 |
| Active                                                            |         | 65:32 |       | 100.0 |
| Edit release notes for previous sprint                            |         |       |  7:42 |  11.7 |
| Create a demo and presentation for previous sprint                |         |       |  1:11 |   1.8 |
| Sprint and product backlog grooming                               |         |       |  5:00 |   7.6 |
| Nightly nursing                                                   |         |       |  0:11 |   0.3 |
| Merge kernel with physical meta-model                             |         |       |  1:31 |   2.3 |
| Convert =wale_template_reference= to meta-data                    |         |       |  0:37 |   0.9 |
| Create an emacs mode for wale                                     |         |       |  0:14 |   0.4 |
| Create a TS agnostic representation of inclusion                  |         |       |  3:04 |   4.7 |
| Analysis on reducing the number of required wale keys             |         |       |  1:11 |   1.8 |
| Use PMM to compute =meta_name_indices=                            |         |       |  3:03 |   4.7 |
| Split archetype factory from transform                            |         |       | 10:57 |  16.7 |
| Paper: Using Aspects to Model Product Line Variability            |         |       |  1:11 |   1.8 |
| Remove traits for archetypes                                      |         |       |  0:44 |   1.1 |
| Analysis on solving relationship problems                         |         |       |  4:45 |   7.2 |
...
| Add labels to archetypes                                          |         |       |  2:22 |   3.6 |
| Add support for CSV values in variability                         |         |       |  0:56 |   1.4 |
| Improve org-mode converter                                        |         |       |  5:15 |   8.0 |
| Add relations between archetypes in the PMM                       |         |       | 10:38 |  16.2 |
| Analysis on implementing containment with configuration           |         |       |  1:52 |   2.8 |
| Add hash map of artefacts in physical model                       |         |       |  1:24 |   2.1 |
