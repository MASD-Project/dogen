...
#+CAPTION: Clock summary at [2020-06-10 Wed 22:11]
| <75>                                                  |         |       |      |       |
| Headline                                              | Time    |       |      |     % |
|-------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                          | *21:09* |       |      | 100.0 |
|-------------------------------------------------------+---------+-------+------+-------|
| Stories                                               | 21:09   |       |      | 100.0 |
| Active                                                |         | 21:09 |      | 100.0 |
| Edit release notes for previous sprint                |         |       | 7:42 |  36.4 |
| Create a demo and presentation for previous sprint    |         |       | 1:11 |   5.6 |
| Sprint and product backlog grooming                   |         |       | 2:10 |  10.2 |
| Nightly nursing                                       |         |       | 0:11 |   0.9 |
| Merge kernel with physical meta-model                 |         |       | 1:31 |   7.2 |
| Convert =wale_template_reference= to meta-data        |         |       | 0:37 |   2.9 |
| Create an emacs mode for wale                         |         |       | 0:14 |   1.1 |
| Create a TS agnostic representation of inclusion      |         |       | 3:04 |  14.5 |
| Analysis on reducing the number of required wale keys |         |       | 1:11 |   5.6 |
| Use PMM to compute =meta_name_indices=                |         |       | 3:03 |  14.4 |
| Split archetype factory from transform                |         |       | 0:15 |   1.2 |
