...
#+CAPTION: Clock summary at [2020-07-07 Tue 22:42]
| <75>                                                              |         |       |       |       |
| Headline                                                          | Time    |       |       |     % |
|-------------------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                           | 74:21   |       |       | 100.0 |
| Active                                                            |         | 74:21 |       | 100.0 |
| Edit release notes for previous sprint                            |         |       |  7:42 |  10.4 |
| Create a demo and presentation for previous sprint                |         |       |  1:11 |   1.6 |
| Sprint and product backlog grooming                               |         |       |  5:25 |   7.3 |
| Nightly nursing                                                   |         |       |  0:11 |   0.2 |
| Merge kernel with physical meta-model                             |         |       |  1:31 |   2.0 |
| Convert =wale_template_reference= to meta-data                    |         |       |  0:37 |   0.8 |
| Create an emacs mode for wale                                     |         |       |  0:14 |   0.3 |
| Create a TS agnostic representation of inclusion                  |         |       |  3:04 |   4.1 |
| Analysis on reducing the number of required wale keys             |         |       |  1:11 |   1.6 |
| Use PMM to compute =meta_name_indices=                            |         |       |  3:03 |   4.1 |
| Split archetype factory from transform                            |         |       | 10:57 |  14.7 |
| Paper: Using Aspects to Model Product Line Variability            |         |       |  1:11 |   1.6 |
| Remove traits for archetypes                                      |         |       |  0:44 |   1.0 |
| Analysis on solving relationship problems                         |         |       |  4:45 |   6.4 |
| Archetype kind and postfix as parts of a larger pattern           |         |       |  0:36 |   0.8 |
| Paper: A flexible code generator for MOF-based modeling languages |         |       |  1:08 |   1.5 |
| Add labels to archetypes                                          |         |       |  2:22 |   3.2 |
| Add support for CSV values in variability                         |         |       |  0:56 |   1.3 |
| Add hash map of artefacts in physical model                       |         |       |  2:59 |   4.0 |
| Analysis on archetype relations for stitch templates              |         |       |  2:07 |   2.8 |
| Move templating aspects of archetype into a generator type        |         |       |  0:56 |   1.3 |
| Split physical relation properties                                |         |       |  0:29 |   0.7 |
| Rename archetype generator                                        |         |       |  0:19 |   0.4 |
| Paper: A Comparison of Generative Approaches: XVCL and GenVoca    |         |       |  1:20 |   1.8 |
| Paper: An evaluation of the Graphical Modeling Framework GMF      |         |       |  1:12 |   1.6 |
| Improve org-mode converter                                        |         |       |  5:15 |   7.1 |
| Add relations between archetypes in the PMM                       |         |       | 11:04 |  14.9 |
| Analysis on implementing containment with configuration           |         |       |  1:52 |   2.5 |
...
- rename =formatter_names_by_backend_name=.
