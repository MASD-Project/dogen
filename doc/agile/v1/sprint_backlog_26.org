...
#+CAPTION: Clock summary at [2020-06-07 Sun 16:27]
| <75>                                                  |         |       |      |       |
| Headline                                              | Time    |       |      |     % |
|-------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                               | 20:18   |       |      | 100.0 |
| Active                                                |         | 20:18 |      | 100.0 |
| Edit release notes for previous sprint                |         |       | 7:42 |  37.9 |
| Create a demo and presentation for previous sprint    |         |       | 1:11 |   5.8 |
| Sprint and product backlog grooming                   |         |       | 1:34 |   7.7 |
| Nightly nursing                                       |         |       | 0:11 |   0.9 |
| Merge kernel with physical meta-model                 |         |       | 1:31 |   7.5 |
| Convert =wale_template_reference= to meta-data        |         |       | 0:37 |   3.0 |
| Create an emacs mode for wale                         |         |       | 0:14 |   1.1 |
| Create a TS agnostic representation of inclusion      |         |       | 3:04 |  15.1 |
| Analysis on reducing the number of required wale keys |         |       | 1:11 |   5.8 |
| Use PMM to compute =meta_name_indices=                |         |       | 3:03 |  15.0 |
