...
#+CAPTION: Clock summary at [2020-06-07 Sun 11:36]
| <75>                                                  |         |       |      |       |
| Headline                                              | Time    |       |      |     % |
|-------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                               | 16:55   |       |      | 100.0 |
| Active                                                |         | 16:55 |      | 100.0 |
| Edit release notes for previous sprint                |         |       | 7:42 |  45.5 |
| Create a demo and presentation for previous sprint    |         |       | 1:11 |   7.0 |
| Sprint and product backlog grooming                   |         |       | 1:13 |   7.2 |
| Nightly nursing                                       |         |       | 0:32 |   3.2 |
| Merge kernel with physical meta-model                 |         |       | 1:31 |   9.0 |
| Convert =wale_template_reference= to meta-data        |         |       | 0:37 |   3.6 |
| Create an emacs mode for wale                         |         |       | 0:14 |   1.4 |
| Create a TS agnostic representation of inclusion      |         |       | 2:19 |  13.7 |
| Use PMM to compute =meta_name_indices=                |         |       | 0:25 |   2.5 |
| Analysis on reducing the number of required wale keys |         |       | 1:11 |   7.0 |
