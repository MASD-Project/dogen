...
#+CAPTION: Clock summary at [2020-07-06 Mon 23:37]
| <75>                                                              |         |       |       |       |
| Headline                                                          | Time    |       |       |     % |
|-------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                      | *73:01* |       |       | 100.0 |
|-------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                           | 73:01   |       |       | 100.0 |
| Active                                                            |         | 73:01 |       | 100.0 |
| Edit release notes for previous sprint                            |         |       |  7:42 |  10.5 |
| Create a demo and presentation for previous sprint                |         |       |  1:11 |   1.6 |
| Sprint and product backlog grooming                               |         |       |  5:17 |   7.2 |
| Nightly nursing                                                   |         |       |  0:11 |   0.3 |
| Merge kernel with physical meta-model                             |         |       |  1:31 |   2.1 |
| Convert =wale_template_reference= to meta-data                    |         |       |  0:37 |   0.8 |
| Create an emacs mode for wale                                     |         |       |  0:14 |   0.3 |
| Create a TS agnostic representation of inclusion                  |         |       |  3:04 |   4.2 |
| Analysis on reducing the number of required wale keys             |         |       |  1:11 |   1.6 |
| Use PMM to compute =meta_name_indices=                            |         |       |  3:03 |   4.2 |
| Split archetype factory from transform                            |         |       | 10:57 |  15.0 |
| Paper: Using Aspects to Model Product Line Variability            |         |       |  1:11 |   1.6 |
| Remove traits for archetypes                                      |         |       |  0:44 |   1.0 |
| Analysis on solving relationship problems                         |         |       |  4:45 |   6.5 |
| Archetype kind and postfix as parts of a larger pattern           |         |       |  0:36 |   0.8 |
| Paper: A flexible code generator for MOF-based modeling languages |         |       |  1:08 |   1.6 |
| Add labels to archetypes                                          |         |       |  2:22 |   3.2 |
| Add support for CSV values in variability                         |         |       |  0:56 |   1.3 |
| Add hash map of artefacts in physical model                       |         |       |  2:59 |   4.1 |
| Analysis on archetype relations for stitch templates              |         |       |  2:07 |   2.9 |
...
| Improve org-mode converter                                        |         |       |  5:15 |   7.2 |
| Add relations between archetypes in the PMM                       |         |       | 11:04 |  15.2 |
| Analysis on implementing containment with configuration           |         |       |  1:52 |   2.6 |
