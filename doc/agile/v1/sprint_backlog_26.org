...
#+CAPTION: Clock summary at [2020-06-25 Thu 22:59]
| <75>                                                              |         |       |       |       |
| Headline                                                          | Time    |       |       |     % |
|-------------------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                           | 48:43   |       |       | 100.0 |
| Active                                                            |         | 48:43 |       | 100.0 |
| Edit release notes for previous sprint                            |         |       |  7:42 |  15.8 |
| Create a demo and presentation for previous sprint                |         |       |  1:11 |   2.4 |
| Sprint and product backlog grooming                               |         |       |  4:35 |   9.4 |
| Nightly nursing                                                   |         |       |  0:11 |   0.4 |
| Merge kernel with physical meta-model                             |         |       |  1:31 |   3.1 |
| Convert =wale_template_reference= to meta-data                    |         |       |  0:37 |   1.3 |
| Create an emacs mode for wale                                     |         |       |  0:14 |   0.5 |
| Create a TS agnostic representation of inclusion                  |         |       |  3:04 |   6.3 |
| Analysis on reducing the number of required wale keys             |         |       |  1:11 |   2.4 |
| Use PMM to compute =meta_name_indices=                            |         |       |  3:03 |   6.3 |
| Split archetype factory from transform                            |         |       | 10:57 |  22.5 |
| Paper: Using Aspects to Model Product Line Variability            |         |       |  1:11 |   2.4 |
| Remove traits for archetypes                                      |         |       |  0:44 |   1.5 |
| Analysis on solving relationship problems                         |         |       |  4:45 |   9.8 |
| Archetype kind and postfix as parts of a larger pattern           |         |       |  0:36 |   1.2 |
| Paper: A flexible code generator for MOF-based modeling languages |         |       |  1:08 |   2.3 |
| Add labels to archetypes                                          |         |       |  2:22 |   4.9 |
| Improve org-mode converter                                        |         |       |  3:41 |   7.6 |
