...
#+CAPTION: Clock summary at [2020-06-28 Sun 00:10]
| <75>                                                              |         |       |       |       |
| Headline                                                          | Time    |       |       |     % |
|-------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                      | *60:23* |       |       | 100.0 |
|-------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                           | 60:23   |       |       | 100.0 |
| Active                                                            |         | 60:23 |       | 100.0 |
| Edit release notes for previous sprint                            |         |       |  7:42 |  12.8 |
| Create a demo and presentation for previous sprint                |         |       |  1:11 |   2.0 |
| Sprint and product backlog grooming                               |         |       |  4:35 |   7.6 |
| Nightly nursing                                                   |         |       |  0:11 |   0.3 |
| Merge kernel with physical meta-model                             |         |       |  1:31 |   2.5 |
| Convert =wale_template_reference= to meta-data                    |         |       |  0:37 |   1.0 |
| Create an emacs mode for wale                                     |         |       |  0:14 |   0.4 |
| Create a TS agnostic representation of inclusion                  |         |       |  3:04 |   5.1 |
| Analysis on reducing the number of required wale keys             |         |       |  1:11 |   2.0 |
| Use PMM to compute =meta_name_indices=                            |         |       |  3:03 |   5.1 |
| Split archetype factory from transform                            |         |       | 10:57 |  18.1 |
| Paper: Using Aspects to Model Product Line Variability            |         |       |  1:11 |   2.0 |
| Remove traits for archetypes                                      |         |       |  0:44 |   1.2 |
| Analysis on solving relationship problems                         |         |       |  4:45 |   7.9 |
...
| Add labels to archetypes                                          |         |       |  2:22 |   3.9 |
| Add support for CSV values in variability                         |         |       |  0:25 |   0.7 |
| Improve org-mode converter                                        |         |       |  5:15 |   8.7 |
| Add relations between archetypes in the PMM                       |         |       |  7:49 |  12.9 |
| Analysis on implementing containment with configuration           |         |       |  1:52 |   3.1 |
