...
#+CAPTION: Clock summary at [2020-06-21 Sun 12:50]
| <75>                                                       |         |       |       |       |
| Headline                                                   | Time    |       |       |     % |
|------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                               | *39:52* |       |       | 100.0 |
|------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                    | 39:52   |       |       | 100.0 |
| Active                                                     |         | 39:52 |       | 100.0 |
| Edit release notes for previous sprint                     |         |       |  7:42 |  19.3 |
| Create a demo and presentation for previous sprint         |         |       |  1:11 |   3.0 |
| Sprint and product backlog grooming                        |         |       |  2:55 |   7.3 |
| Nightly nursing                                            |         |       |  0:11 |   0.5 |
| Merge kernel with physical meta-model                      |         |       |  1:31 |   3.8 |
| Convert =wale_template_reference= to meta-data             |         |       |  0:37 |   1.5 |
| Create an emacs mode for wale                              |         |       |  0:14 |   0.6 |
| Create a TS agnostic representation of inclusion           |         |       |  3:04 |   7.7 |
| Analysis on reducing the number of required wale keys      |         |       |  1:11 |   3.0 |
| Use PMM to compute =meta_name_indices=                     |         |       |  3:03 |   7.7 |
| Split archetype factory from transform                     |         |       | 10:57 |  27.5 |
| Paper: Using Aspects to Model Product Line Variability     |         |       |  1:11 |   3.0 |
| Remove traits for archetypes                               |         |       |  0:44 |   1.8 |
| Analysis on solving relationship problems                  |         |       |  4:45 |  11.9 |
