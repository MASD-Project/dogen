...
#+CAPTION: Clock summary at [2020-06-06 Sat 18:22]
| <75>                                               |         |       |      |       |
| Headline                                           | Time    |       |      |     % |
|----------------------------------------------------+---------+-------+------+-------|
| *Total time*                                       | *15:56* |       |      | 100.0 |
|----------------------------------------------------+---------+-------+------+-------|
| Stories                                            | 15:56   |       |      | 100.0 |
| Active                                             |         | 15:56 |      | 100.0 |
| Edit release notes for previous sprint             |         |       | 7:42 |  48.3 |
| Create a demo and presentation for previous sprint |         |       | 1:11 |   7.4 |
| Sprint and product backlog grooming                |         |       | 1:08 |   7.1 |
| Nightly nursing                                    |         |       | 0:11 |   1.2 |
| Merge kernel with physical meta-model              |         |       | 1:31 |   9.5 |
| Convert =wale_template_reference= to meta-data     |         |       | 0:37 |   3.9 |
| Create an emacs mode for wale                      |         |       | 0:14 |   1.5 |
| Use PMM to compute =meta_name_indices=             |         |       | 0:25 |   2.6 |
| Create a TS agnostic representation of inclusion   |         |       | 2:19 |  14.5 |
| Reduce number of required wale keys                |         |       | 0:38 |   4.0 |
...
*** STARTED Reduce number of required wale keys                       :story:
    :LOGBOOK:
