...
#+CAPTION: Clock summary at [2020-06-05 Fri 17:40]
| <75>                                               |         |       |      |       |
| Headline                                           | Time    |       |      |     % |
|----------------------------------------------------+---------+-------+------+-------|
| *Total time*                                       | *13:36* |       |      | 100.0 |
|----------------------------------------------------+---------+-------+------+-------|
| Stories                                            | 13:36   |       |      | 100.0 |
| Active                                             |         | 13:36 |      | 100.0 |
| Edit release notes for previous sprint             |         |       | 7:42 |  56.6 |
| Create a demo and presentation for previous sprint |         |       | 1:11 |   8.7 |
| Sprint and product backlog grooming                |         |       | 0:47 |   5.8 |
| Nightly nursing                                    |         |       | 0:11 |   1.3 |
| Merge kernel with physical meta-model              |         |       | 1:31 |  11.2 |
| Use PMM to compute =meta_name_indices=             |         |       | 0:25 |   3.1 |
| Create a TS agnostic representation of inclusion   |         |       | 1:32 |  11.3 |
| Convert =wale_template_reference= to meta-data     |         |       | 0:17 |   2.1 |
...
*** STARTED Convert =wale_template_reference= to meta-data            :story:
    :LOGBOOK:
