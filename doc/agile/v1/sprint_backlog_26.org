...
#+CAPTION: Clock summary at [2020-06-06 Sat 19:29]
| <75>                                                  |         |       |      |       |
| Headline                                              | Time    |       |      |     % |
|-------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                          | *16:34* |       |      | 100.0 |
|-------------------------------------------------------+---------+-------+------+-------|
| Stories                                               | 16:34   |       |      | 100.0 |
| Active                                                |         | 16:34 |      | 100.0 |
| Edit release notes for previous sprint                |         |       | 7:42 |  46.5 |
| Create a demo and presentation for previous sprint    |         |       | 1:11 |   7.1 |
| Sprint and product backlog grooming                   |         |       | 1:13 |   7.3 |
| Nightly nursing                                       |         |       | 0:11 |   1.1 |
| Merge kernel with physical meta-model                 |         |       | 1:31 |   9.2 |
| Convert =wale_template_reference= to meta-data        |         |       | 0:37 |   3.7 |
| Create an emacs mode for wale                         |         |       | 0:14 |   1.4 |
| Create a TS agnostic representation of inclusion      |         |       | 2:19 |  14.0 |
| Use PMM to compute =meta_name_indices=                |         |       | 0:25 |   2.5 |
| Analysis on reducing the number of required wale keys |         |       | 1:11 |   7.1 |
...
*** STARTED Analysis on reducing the number of required wale keys     :story:
    :LOGBOOK:
...
*** Split archetype factory from transform                            :story:
