...
#+CAPTION: Clock summary at [2020-06-23 Tue 23:49]
| <75>                                                              |         |       |       |       |
| Headline                                                          | Time    |       |       |     % |
|-------------------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                           | 46:26   |       |       | 100.0 |
| Active                                                            |         | 46:26 |       | 100.0 |
| Edit release notes for previous sprint                            |         |       |  7:42 |  16.6 |
| Create a demo and presentation for previous sprint                |         |       |  1:11 |   2.5 |
| Sprint and product backlog grooming                               |         |       |  4:07 |   8.9 |
| Nightly nursing                                                   |         |       |  0:11 |   0.4 |
| Merge kernel with physical meta-model                             |         |       |  1:31 |   3.3 |
| Convert =wale_template_reference= to meta-data                    |         |       |  0:37 |   1.3 |
| Create an emacs mode for wale                                     |         |       |  0:14 |   0.5 |
| Create a TS agnostic representation of inclusion                  |         |       |  3:04 |   6.6 |
| Analysis on reducing the number of required wale keys             |         |       |  1:11 |   2.5 |
| Use PMM to compute =meta_name_indices=                            |         |       |  3:03 |   6.6 |
| Split archetype factory from transform                            |         |       | 10:57 |  23.6 |
| Paper: Using Aspects to Model Product Line Variability            |         |       |  1:11 |   2.5 |
| Remove traits for archetypes                                      |         |       |  0:44 |   1.6 |
| Analysis on solving relationship problems                         |         |       |  4:45 |  10.2 |
...
| Add labels to archetypes                                          |         |       |  2:22 |   5.1 |
| Improve org-mode converter                                        |         |       |  1:52 |   4.0 |
