...
#+CAPTION: Clock summary at [2020-06-09 Tue 21:54]
| <75>                                                  |         |       |      |       |
| Headline                                              | Time    |       |      |     % |
|-------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                          | *20:54* |       |      | 100.0 |
|-------------------------------------------------------+---------+-------+------+-------|
| Stories                                               | 20:54   |       |      | 100.0 |
| Active                                                |         | 20:54 |      | 100.0 |
| Edit release notes for previous sprint                |         |       | 7:42 |  36.8 |
| Create a demo and presentation for previous sprint    |         |       | 1:11 |   5.7 |
| Sprint and product backlog grooming                   |         |       | 2:10 |  10.4 |
| Nightly nursing                                       |         |       | 0:11 |   0.9 |
| Merge kernel with physical meta-model                 |         |       | 1:31 |   7.3 |
| Convert =wale_template_reference= to meta-data        |         |       | 0:37 |   3.0 |
| Create an emacs mode for wale                         |         |       | 0:14 |   1.1 |
| Create a TS agnostic representation of inclusion      |         |       | 3:04 |  14.7 |
| Analysis on reducing the number of required wale keys |         |       | 1:11 |   5.7 |
| Use PMM to compute =meta_name_indices=                |         |       | 3:03 |  14.6 |
