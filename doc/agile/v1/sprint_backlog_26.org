...
#+CAPTION: Clock summary at [2020-07-06 Mon 22:04]
| <75>                                                              |         |       |       |       |
| Headline                                                          | Time    |       |       |     % |
|-------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                      | *71:41* |       |       | 100.0 |
|-------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                           | 71:41   |       |       | 100.0 |
| Active                                                            |         | 71:41 |       | 100.0 |
| Edit release notes for previous sprint                            |         |       |  7:42 |  10.7 |
| Create a demo and presentation for previous sprint                |         |       |  1:11 |   1.7 |
| Sprint and product backlog grooming                               |         |       |  5:17 |   7.4 |
...
| Create a TS agnostic representation of inclusion                  |         |       |  3:04 |   4.3 |
| Analysis on reducing the number of required wale keys             |         |       |  1:11 |   1.7 |
| Use PMM to compute =meta_name_indices=                            |         |       |  3:03 |   4.3 |
| Split archetype factory from transform                            |         |       | 10:57 |  15.3 |
| Paper: Using Aspects to Model Product Line Variability            |         |       |  1:11 |   1.7 |
| Remove traits for archetypes                                      |         |       |  0:44 |   1.0 |
| Analysis on solving relationship problems                         |         |       |  4:45 |   6.6 |
...
| Add labels to archetypes                                          |         |       |  2:22 |   3.3 |
| Add support for CSV values in variability                         |         |       |  0:56 |   1.3 |
| Add hash map of artefacts in physical model                       |         |       |  2:59 |   4.2 |
| Analysis on archetype relations for stitch templates              |         |       |  2:07 |   3.0 |
...
| Improve org-mode converter                                        |         |       |  5:15 |   7.3 |
| Add relations between archetypes in the PMM                       |         |       | 11:04 |  15.4 |
