...
#+CAPTION: Clock summary at [2020-06-21 Sun 16:05]
| <75>                                                       |         |       |       |       |
| Headline                                                   | Time    |       |       |     % |
|------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                               | *41:04* |       |       | 100.0 |
|------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                    | 41:04   |       |       | 100.0 |
| Active                                                     |         | 41:04 |       | 100.0 |
| Edit release notes for previous sprint                     |         |       |  7:42 |  18.8 |
| Create a demo and presentation for previous sprint         |         |       |  1:11 |   2.9 |
| Sprint and product backlog grooming                        |         |       |  4:07 |  10.0 |
| Nightly nursing                                            |         |       |  0:11 |   0.4 |
| Merge kernel with physical meta-model                      |         |       |  1:31 |   3.7 |
| Convert =wale_template_reference= to meta-data             |         |       |  0:37 |   1.5 |
| Create an emacs mode for wale                              |         |       |  0:14 |   0.6 |
| Create a TS agnostic representation of inclusion           |         |       |  3:04 |   7.5 |
| Analysis on reducing the number of required wale keys      |         |       |  1:11 |   2.9 |
| Use PMM to compute =meta_name_indices=                     |         |       |  3:03 |   7.4 |
| Split archetype factory from transform                     |         |       | 10:57 |  26.7 |
| Paper: Using Aspects to Model Product Line Variability     |         |       |  1:11 |   2.9 |
| Remove traits for archetypes                               |         |       |  0:44 |   1.8 |
| Analysis on solving relationship problems                  |         |       |  4:45 |  11.6 |
| Archetype kind and postfix as symptoms of a larger pattern |         |       |  0:36 |   1.5 |
...
*** COMPLETED Archetype kind and postfix as symptoms of a larger pattern :story:
...
*** Add labels to archetypes                                          :story:
