...
#+CAPTION: Clock summary at [2020-06-14 Sun 21:44]
| <75>                                                       |         |       |       |       |
| Headline                                                   | Time    |       |       |     % |
|------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                               | *34:20* |       |       | 100.0 |
|------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                    | 34:20   |       |       | 100.0 |
| Active                                                     |         | 34:20 |       | 100.0 |
| Edit release notes for previous sprint                     |         |       |  7:42 |  22.4 |
| Create a demo and presentation for previous sprint         |         |       |  1:11 |   3.4 |
| Sprint and product backlog grooming                        |         |       |  2:12 |   6.4 |
| Nightly nursing                                            |         |       |  0:11 |   0.5 |
| Merge kernel with physical meta-model                      |         |       |  1:31 |   4.4 |
| Convert =wale_template_reference= to meta-data             |         |       |  0:37 |   1.8 |
| Create an emacs mode for wale                              |         |       |  0:14 |   0.7 |
| Create a TS agnostic representation of inclusion           |         |       |  3:04 |   8.9 |
| Analysis on reducing the number of required wale keys      |         |       |  1:11 |   3.4 |
| Use PMM to compute =meta_name_indices=                     |         |       |  3:03 |   8.9 |
| Split archetype factory from transform                     |         |       | 10:57 |  31.9 |
| Paper: Using Aspects to Model Product Line Variability     |         |       |  1:11 |   3.4 |
| Archetype kind and postfix as symptoms of a larger pattern |         |       |  0:36 |   1.7 |
| Remove traits for archetypes                               |         |       |  0:40 |   1.9 |
...
*** STARTED Model =inclusion_support_types= in the physical model     :story:
...
*** STARTED Remove traits for archetypes                              :story:
    :LOGBOOK:
