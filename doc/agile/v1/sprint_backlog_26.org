...
#+CAPTION: Clock summary at [2020-06-21 Sun 23:26]
| <75>                                                              |         |       |       |       |
| Headline                                                          | Time    |       |       |     % |
|-------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                      | *44:04* |       |       | 100.0 |
|-------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                           | 44:04   |       |       | 100.0 |
| Active                                                            |         | 44:04 |       | 100.0 |
| Edit release notes for previous sprint                            |         |       |  7:42 |  17.5 |
| Create a demo and presentation for previous sprint                |         |       |  1:11 |   2.7 |
| Sprint and product backlog grooming                               |         |       |  4:07 |   9.3 |
| Nightly nursing                                                   |         |       |  0:11 |   0.4 |
| Merge kernel with physical meta-model                             |         |       |  1:31 |   3.4 |
| Convert =wale_template_reference= to meta-data                    |         |       |  0:37 |   1.4 |
| Create an emacs mode for wale                                     |         |       |  0:14 |   0.5 |
| Create a TS agnostic representation of inclusion                  |         |       |  3:04 |   7.0 |
| Analysis on reducing the number of required wale keys             |         |       |  1:11 |   2.7 |
| Use PMM to compute =meta_name_indices=                            |         |       |  3:03 |   6.9 |
| Split archetype factory from transform                            |         |       | 10:57 |  24.8 |
| Paper: Using Aspects to Model Product Line Variability            |         |       |  1:11 |   2.7 |
| Remove traits for archetypes                                      |         |       |  0:44 |   1.7 |
| Analysis on solving relationship problems                         |         |       |  4:45 |  10.8 |
| Archetype kind and postfix as parts of a larger pattern           |         |       |  0:36 |   1.4 |
| Paper: A flexible code generator for MOF-based modeling languages |         |       |  1:08 |   2.6 |
| Improve org-mode converter                                        |         |       |  1:52 |   4.2 |
