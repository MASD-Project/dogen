...
#+CAPTION: Clock summary at [2020-07-12 Sun 13:48]
| <75>                                                              |         |       |       |       |
| Headline                                                          | Time    |       |       |     % |
|-------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                      | *93:07* |       |       | 100.0 |
|-------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                           | 93:07   |       |       | 100.0 |
| Active                                                            |         | 93:07 |       | 100.0 |
| Edit release notes for previous sprint                            |         |       |  8:00 |   8.6 |
| Create a demo and presentation for previous sprint                |         |       |  1:11 |   1.3 |
| Sprint and product backlog grooming                               |         |       |  5:49 |   6.2 |
...
| Create a TS agnostic representation of inclusion                  |         |       |  3:04 |   3.3 |
| Analysis on reducing the number of required wale keys             |         |       |  1:11 |   1.3 |
| Use PMM to compute =meta_name_indices=                            |         |       |  3:03 |   3.3 |
| Split archetype factory from transform                            |         |       | 10:57 |  11.8 |
| Paper: Using Aspects to Model Product Line Variability            |         |       |  1:11 |   1.3 |
| Remove traits for archetypes                                      |         |       |  0:44 |   0.8 |
| Analysis on solving relationship problems                         |         |       |  4:45 |   5.1 |
...
| Add hash map of artefacts in physical model                       |         |       |  2:59 |   3.2 |
| Analysis on archetype relations for stitch templates              |         |       |  2:07 |   2.3 |
...
| Add relations between archetypes in the PMM                       |         |       | 13:50 |  14.9 |
| Improve org-mode converter                                        |         |       |  5:35 |   6.0 |
| Analysis on implementing containment with configuration           |         |       |  1:52 |   2.0 |
| Create an archetype repository in physical model                  |         |       | 12:27 |  13.4 |
