...
#+CAPTION: Clock summary at [2020-07-10 Fri 12:49]
| <75>                                                              |         |       |       |       |
| Headline                                                          | Time    |       |       |     % |
|-------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                      | *76:57* |       |       | 100.0 |
|-------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                           | 76:57   |       |       | 100.0 |
| Active                                                            |         | 76:57 |       | 100.0 |
| Edit release notes for previous sprint                            |         |       |  7:42 |  10.0 |
| Create a demo and presentation for previous sprint                |         |       |  1:11 |   1.5 |
| Sprint and product backlog grooming                               |         |       |  5:49 |   7.6 |
...
| Create a TS agnostic representation of inclusion                  |         |       |  3:04 |   4.0 |
| Analysis on reducing the number of required wale keys             |         |       |  1:11 |   1.5 |
| Use PMM to compute =meta_name_indices=                            |         |       |  3:03 |   4.0 |
| Split archetype factory from transform                            |         |       | 10:57 |  14.2 |
| Paper: Using Aspects to Model Product Line Variability            |         |       |  1:11 |   1.5 |
| Remove traits for archetypes                                      |         |       |  0:44 |   1.0 |
| Analysis on solving relationship problems                         |         |       |  4:45 |   6.2 |
...
| Add labels to archetypes                                          |         |       |  2:22 |   3.1 |
| Add support for CSV values in variability                         |         |       |  0:56 |   1.2 |
| Add hash map of artefacts in physical model                       |         |       |  2:59 |   3.9 |
| Analysis on archetype relations for stitch templates              |         |       |  2:07 |   2.8 |
| Move templating aspects of archetype into a generator type        |         |       |  0:56 |   1.2 |
| Split physical relation properties                                |         |       |  0:29 |   0.6 |
| Rename archetype generator                                        |         |       |  0:19 |   0.4 |
| Paper: A Comparison of Generative Approaches: XVCL and GenVoca    |         |       |  1:20 |   1.7 |
| Paper: An evaluation of the Graphical Modeling Framework GMF      |         |       |  1:12 |   1.6 |
| Problems starting clangd                                          |         |       |  0:50 |   1.1 |
| Improve org-mode converter                                        |         |       |  5:35 |   7.3 |
| Add relations between archetypes in the PMM                       |         |       | 12:06 |  15.7 |
| Analysis on implementing containment with configuration           |         |       |  1:52 |   2.4 |
