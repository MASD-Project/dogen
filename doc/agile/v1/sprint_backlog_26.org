...
#+CAPTION: Clock summary at [2020-06-22 Mon 23:53]
| <75>                                                              |         |       |       |       |
| Headline                                                          | Time    |       |       |     % |
|-------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                      | *45:12* |       |       | 100.0 |
|-------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                           | 45:12   |       |       | 100.0 |
| Active                                                            |         | 45:12 |       | 100.0 |
| Edit release notes for previous sprint                            |         |       |  7:42 |  17.0 |
| Create a demo and presentation for previous sprint                |         |       |  1:11 |   2.6 |
| Sprint and product backlog grooming                               |         |       |  4:07 |   9.1 |
...
| Create a TS agnostic representation of inclusion                  |         |       |  3:04 |   6.8 |
| Analysis on reducing the number of required wale keys             |         |       |  1:11 |   2.6 |
| Use PMM to compute =meta_name_indices=                            |         |       |  3:03 |   6.7 |
| Split archetype factory from transform                            |         |       | 10:57 |  24.2 |
| Paper: Using Aspects to Model Product Line Variability            |         |       |  1:11 |   2.6 |
| Remove traits for archetypes                                      |         |       |  0:44 |   1.6 |
| Analysis on solving relationship problems                         |         |       |  4:45 |  10.5 |
| Archetype kind and postfix as parts of a larger pattern           |         |       |  0:36 |   1.3 |
| Paper: A flexible code generator for MOF-based modeling languages |         |       |  1:08 |   2.5 |
| Improve org-mode converter                                        |         |       |  1:52 |   4.1 |
| Add labels to archetypes                                          |         |       |  1:08 |   2.5 |
...
*** STARTED Add labels to archetypes                                  :story:
    :LOGBOOK:
