...
#+CAPTION: Clock summary at [2019-04-01 Mon 11:53]
| <75>                                                      |         |       |      |       |
| Headline                                                  | Time    |       |      |     % |
|-----------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                              | *36:22* |       |      | 100.0 |
|-----------------------------------------------------------+---------+-------+------+-------|
| Stories                                                   | 36:22   |       |      | 100.0 |
| Active                                                    |         | 36:22 |      | 100.0 |
| Edit release notes for previous sprint                    |         |       | 1:47 |   4.9 |
| Sprint and product backlog grooming                       |         |       | 6:11 |  17.0 |
| Create a video demo for the previous sprint's features    |         |       | 3:11 |   8.8 |
| Fix issues with emacs                                     |         |       | 2:42 |   7.4 |
| Create a basic "project plan"                             |         |       | 2:08 |   5.9 |
| Simplify qualified name                                   |         |       | 3:39 |  10.0 |
| Rename "language" to "technical space"                    |         |       | 7:22 |  20.3 |
| Add intrinsic technical space ownership                   |         |       | 1:12 |   3.3 |
| Promote extraction entities to meta-model elements        |         |       | 7:43 |  21.2 |
| Move all utility formatters from extraction to generation |         |       | 0:27 |   1.2 |
