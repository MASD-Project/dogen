...
#+CAPTION: Clock summary at [2019-04-01 Mon 15:26]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
...
| Sprint and product backlog grooming                       |         |       |  6:11 |  15.9 |
| Create a video demo for the previous sprint's features    |         |       |  3:11 |   8.2 |
| Fix issues with emacs                                     |         |       |  2:42 |   6.9 |
| Create a basic "project plan"                             |         |       |  2:08 |   5.5 |
| Simplify qualified name                                   |         |       |  3:39 |   9.4 |
| Rename "language" to "technical space"                    |         |       |  7:22 |  18.9 |
| Add intrinsic technical space ownership                   |         |       |  1:12 |   3.1 |
| Promote extraction entities to meta-model elements        |         |       | 10:18 |  26.4 |
