...
#+CAPTION: Clock summary at [2019-04-01 Mon 17:51]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *41:18* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 41:18   |       |       | 100.0 |
| Active                                                    |         | 41:18 |       | 100.0 |
| Edit release notes for previous sprint                    |         |       |  1:47 |   4.3 |
| Sprint and product backlog grooming                       |         |       |  6:11 |  15.0 |
| Create a video demo for the previous sprint's features    |         |       |  3:11 |   7.7 |
| Fix issues with emacs                                     |         |       |  2:42 |   6.5 |
| Create a basic "project plan"                             |         |       |  2:08 |   5.2 |
| Simplify qualified name                                   |         |       |  3:39 |   8.8 |
| Rename "language" to "technical space"                    |         |       |  7:22 |  17.8 |
| Add intrinsic technical space ownership                   |         |       |  1:12 |   2.9 |
| Promote extraction entities to meta-model elements        |         |       | 12:39 |  30.6 |
| Move all utility formatters from extraction to generation |         |       |  0:27 |   1.1 |
