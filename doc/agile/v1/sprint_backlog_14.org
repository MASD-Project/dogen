...
#+CAPTION: Clock summary at [2019-04-06 Sat 16:52]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *79:03* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 79:03   |       |       | 100.0 |
| Active                                                    |         | 79:03 |       | 100.0 |
| Edit release notes for previous sprint                    |         |       |  1:47 |   2.3 |
| Sprint and product backlog grooming                       |         |       |  7:14 |   9.2 |
| Create a video demo for the previous sprint's features    |         |       |  3:11 |   4.0 |
| Fix issues with emacs                                     |         |       |  2:42 |   3.4 |
| Create a basic "project plan"                             |         |       |  2:08 |   2.7 |
| Simplify qualified name                                   |         |       |  3:39 |   4.6 |
| Rename "language" to "technical space"                    |         |       |  7:22 |   9.3 |
| Add intrinsic technical space ownership                   |         |       |  1:12 |   1.5 |
| Promote extraction entities to meta-model elements        |         |       | 37:25 |  47.3 |
| Integrate report-ci with dogen                            |         |       |  2:09 |   2.7 |
| Move all utility formatters from extraction to generation |         |       |  4:28 |   5.7 |
| Remove annotations from stitch templates                  |         |       |  1:17 |   1.6 |
| Supply decorations as a stitch parameter                  |         |       |  4:29 |   5.7 |
