...
#+CAPTION: Clock summary at [2019-04-01 Mon 12:07]
| <75>                                                      |         |       |      |       |
| Headline                                                  | Time    |       |      |     % |
|-----------------------------------------------------------+---------+-------+------+-------|
...
| Sprint and product backlog grooming                       |         |       | 6:11 |  16.9 |
| Create a video demo for the previous sprint's features    |         |       | 3:11 |   8.7 |
| Fix issues with emacs                                     |         |       | 2:42 |   7.4 |
| Create a basic "project plan"                             |         |       | 2:08 |   5.8 |
| Simplify qualified name                                   |         |       | 3:39 |  10.0 |
| Rename "language" to "technical space"                    |         |       | 7:22 |  20.1 |
| Add intrinsic technical space ownership                   |         |       | 1:12 |   3.3 |
| Promote extraction entities to meta-model elements        |         |       | 7:55 |  21.6 |
