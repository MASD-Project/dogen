...
#+CAPTION: Clock summary at [2019-03-29 Fri 10:54]
| <75>                                                   |         |       |      |       |
| Headline                                               | Time    |       |      |     % |
|--------------------------------------------------------+---------+-------+------+-------|
...
| Sprint and product backlog grooming                    |         |       | 2:39 |   9.8 |
| Create a video demo for the previous sprint's features |         |       | 3:11 |  11.8 |
| Fix issues with emacs                                  |         |       | 2:42 |  10.0 |
| Create a basic "project plan"                          |         |       | 2:08 |   7.9 |
| Simplify qualified name                                |         |       | 3:39 |  13.5 |
| Rename "language" to "technical space"                 |         |       | 7:22 |  27.3 |
| Add intrinsic technical space ownership                |         |       | 0:31 |   1.9 |
| Promote extraction entities to meta-model elements     |         |       | 3:01 |  11.2 |
