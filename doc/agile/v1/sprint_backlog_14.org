...
#+CAPTION: Clock summary at [2019-04-01 Mon 11:06]
| <75>                                                      |         |       |      |       |
| Headline                                                  | Time    |       |      |     % |
|-----------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                              | *35:36* |       |      | 100.0 |
|-----------------------------------------------------------+---------+-------+------+-------|
| Stories                                                   | 35:36   |       |      | 100.0 |
| Active                                                    |         | 35:36 |      | 100.0 |
| Edit release notes for previous sprint                    |         |       | 1:47 |   5.0 |
| Sprint and product backlog grooming                       |         |       | 6:11 |  17.4 |
| Create a video demo for the previous sprint's features    |         |       | 3:11 |   8.9 |
| Fix issues with emacs                                     |         |       | 2:42 |   7.6 |
| Create a basic "project plan"                             |         |       | 2:08 |   6.0 |
| Simplify qualified name                                   |         |       | 3:39 |  10.3 |
| Rename "language" to "technical space"                    |         |       | 7:22 |  20.7 |
| Add intrinsic technical space ownership                   |         |       | 1:12 |   3.4 |
| Promote extraction entities to meta-model elements        |         |       | 6:57 |  19.5 |
| Move all utility formatters from extraction to generation |         |       | 0:27 |   1.3 |
