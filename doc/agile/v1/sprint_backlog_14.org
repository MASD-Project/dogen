...
#+CAPTION: Clock summary at [2019-04-02 Tue 17:25]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *48:23* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 48:23   |       |       | 100.0 |
| Active                                                    |         | 48:23 |       | 100.0 |
| Edit release notes for previous sprint                    |         |       |  1:47 |   3.7 |
| Sprint and product backlog grooming                       |         |       |  6:34 |  13.6 |
| Create a video demo for the previous sprint's features    |         |       |  3:11 |   6.6 |
| Fix issues with emacs                                     |         |       |  2:42 |   5.6 |
| Create a basic "project plan"                             |         |       |  2:08 |   4.4 |
| Simplify qualified name                                   |         |       |  3:39 |   7.5 |
| Rename "language" to "technical space"                    |         |       |  7:22 |  15.2 |
| Add intrinsic technical space ownership                   |         |       |  1:12 |   2.5 |
| Integrate report-ci with dogen                            |         |       |  2:09 |   4.4 |
| Promote extraction entities to meta-model elements        |         |       | 17:12 |  35.5 |
| Move all utility formatters from extraction to generation |         |       |  0:27 |   0.9 |
