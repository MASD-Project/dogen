...
#+CAPTION: Clock summary at [2019-04-01 Mon 10:48]
| <75>                                                      |         |       |      |       |
| Headline                                                  | Time    |       |      |     % |
|-----------------------------------------------------------+---------+-------+------+-------|
...
| Sprint and product backlog grooming                       |         |       | 6:11 |  17.5 |
| Create a video demo for the previous sprint's features    |         |       | 3:11 |   9.0 |
| Fix issues with emacs                                     |         |       | 2:42 |   7.6 |
| Create a basic "project plan"                             |         |       | 2:08 |   6.0 |
| Simplify qualified name                                   |         |       | 3:39 |  10.3 |
| Rename "language" to "technical space"                    |         |       | 7:22 |  20.9 |
| Add intrinsic technical space ownership                   |         |       | 1:12 |   3.4 |
| Promote extraction entities to meta-model elements        |         |       | 6:40 |  18.9 |
