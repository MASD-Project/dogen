...
#+CAPTION: Clock summary at [2019-03-30 Sat 07:47]
| <75>                                                   |         |       |      |       |
| Headline                                               | Time    |       |      |     % |
|--------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                           | *33:21* |       |      | 100.0 |
|--------------------------------------------------------+---------+-------+------+-------|
| Stories                                                | 33:21   |       |      | 100.0 |
| Active                                                 |         | 33:21 |      | 100.0 |
| Edit release notes for previous sprint                 |         |       | 1:47 |   5.3 |
| Sprint and product backlog grooming                    |         |       | 5:38 |  16.9 |
| Create a video demo for the previous sprint's features |         |       | 3:11 |   9.5 |
| Fix issues with emacs                                  |         |       | 2:42 |   8.1 |
| Create a basic "project plan"                          |         |       | 2:08 |   6.4 |
| Simplify qualified name                                |         |       | 3:39 |  10.9 |
| Rename "language" to "technical space"                 |         |       | 7:22 |  22.1 |
| Add intrinsic technical space ownership                |         |       | 1:12 |   3.6 |
| Promote extraction entities to meta-model elements     |         |       | 5:42 |  17.1 |
...
*** Move all utility formatters from extraction to generation         :story:
