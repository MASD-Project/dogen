...
#+CAPTION: Clock summary at [2019-04-05 Fri 11:44]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *66:15* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 66:15   |       |       | 100.0 |
| Active                                                    |         | 66:15 |       | 100.0 |
| Edit release notes for previous sprint                    |         |       |  1:47 |   2.7 |
| Sprint and product backlog grooming                       |         |       |  7:07 |  10.7 |
| Create a video demo for the previous sprint's features    |         |       |  3:11 |   4.8 |
| Fix issues with emacs                                     |         |       |  2:42 |   4.1 |
| Create a basic "project plan"                             |         |       |  2:08 |   3.2 |
| Simplify qualified name                                   |         |       |  3:39 |   5.5 |
| Rename "language" to "technical space"                    |         |       |  7:22 |  11.1 |
| Add intrinsic technical space ownership                   |         |       |  1:12 |   1.8 |
| Integrate report-ci with dogen                            |         |       |  2:09 |   3.2 |
| Promote extraction entities to meta-model elements        |         |       | 30:56 |  46.7 |
| Move all utility formatters from extraction to generation |         |       |  0:27 |   0.7 |
| Remove annotations from stitch templates                  |         |       |  1:17 |   1.9 |
| Supply decorations as a stitch parameter                  |         |       |  2:18 |   3.5 |
