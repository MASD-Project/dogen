...
#+CAPTION: Clock summary at [2019-04-06 Sat 06:47]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *75:21* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 75:21   |       |       | 100.0 |
| Active                                                    |         | 75:21 |       | 100.0 |
| Edit release notes for previous sprint                    |         |       |  1:47 |   2.4 |
| Sprint and product backlog grooming                       |         |       |  7:14 |   9.6 |
| Create a video demo for the previous sprint's features    |         |       |  3:11 |   4.2 |
| Fix issues with emacs                                     |         |       |  2:42 |   3.6 |
| Create a basic "project plan"                             |         |       |  2:08 |   2.8 |
| Simplify qualified name                                   |         |       |  3:39 |   4.8 |
| Rename "language" to "technical space"                    |         |       |  7:22 |   9.8 |
| Add intrinsic technical space ownership                   |         |       |  1:12 |   1.6 |
| Promote extraction entities to meta-model elements        |         |       | 37:25 |  49.7 |
| Integrate report-ci with dogen                            |         |       |  2:09 |   2.9 |
| Move all utility formatters from extraction to generation |         |       |  0:46 |   1.0 |
| Remove annotations from stitch templates                  |         |       |  1:17 |   1.7 |
| Supply decorations as a stitch parameter                  |         |       |  4:29 |   6.0 |
