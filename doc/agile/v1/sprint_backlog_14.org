...
#+CAPTION: Clock summary at [2019-04-02 Tue 10:54]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *44:16* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 44:16   |       |       | 100.0 |
| Active                                                    |         | 44:16 |       | 100.0 |
| Edit release notes for previous sprint                    |         |       |  1:47 |   4.0 |
| Sprint and product backlog grooming                       |         |       |  6:34 |  14.8 |
| Create a video demo for the previous sprint's features    |         |       |  3:11 |   7.2 |
| Fix issues with emacs                                     |         |       |  2:42 |   6.1 |
| Create a basic "project plan"                             |         |       |  2:08 |   4.8 |
| Simplify qualified name                                   |         |       |  3:39 |   8.2 |
| Rename "language" to "technical space"                    |         |       |  7:22 |  16.6 |
| Add intrinsic technical space ownership                   |         |       |  1:12 |   2.7 |
| Integrate report-ci with dogen                            |         |       |  2:00 |   4.5 |
| Promote extraction entities to meta-model elements        |         |       | 13:14 |  29.9 |
| Move all utility formatters from extraction to generation |         |       |  0:27 |   1.0 |
