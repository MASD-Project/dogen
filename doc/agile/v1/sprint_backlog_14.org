...
#+CAPTION: Clock summary at [2019-04-06 Sat 07:33]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *76:07* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 76:07   |       |       | 100.0 |
| Active                                                    |         | 76:07 |       | 100.0 |
| Edit release notes for previous sprint                    |         |       |  1:47 |   2.3 |
| Sprint and product backlog grooming                       |         |       |  7:14 |   9.5 |
| Create a video demo for the previous sprint's features    |         |       |  3:11 |   4.2 |
| Fix issues with emacs                                     |         |       |  2:42 |   3.5 |
| Create a basic "project plan"                             |         |       |  2:08 |   2.8 |
| Simplify qualified name                                   |         |       |  3:39 |   4.8 |
| Rename "language" to "technical space"                    |         |       |  7:22 |   9.7 |
| Add intrinsic technical space ownership                   |         |       |  1:12 |   1.6 |
| Promote extraction entities to meta-model elements        |         |       | 37:25 |  49.2 |
| Integrate report-ci with dogen                            |         |       |  2:09 |   2.8 |
| Move all utility formatters from extraction to generation |         |       |  1:32 |   2.0 |
| Remove annotations from stitch templates                  |         |       |  1:17 |   1.7 |
| Supply decorations as a stitch parameter                  |         |       |  4:29 |   5.9 |
