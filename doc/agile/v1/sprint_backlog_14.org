...
#+CAPTION: Clock summary at [2019-04-05 Fri 17:57]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *71:31* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 71:31   |       |       | 100.0 |
| Active                                                    |         | 71:31 |       | 100.0 |
| Edit release notes for previous sprint                    |         |       |  1:47 |   2.5 |
| Sprint and product backlog grooming                       |         |       |  7:07 |  10.0 |
| Create a video demo for the previous sprint's features    |         |       |  3:11 |   4.5 |
| Fix issues with emacs                                     |         |       |  2:42 |   3.8 |
| Create a basic "project plan"                             |         |       |  2:08 |   3.0 |
| Simplify qualified name                                   |         |       |  3:39 |   5.1 |
| Rename "language" to "technical space"                    |         |       |  7:22 |  10.3 |
| Add intrinsic technical space ownership                   |         |       |  1:12 |   1.7 |
| Integrate report-ci with dogen                            |         |       |  2:09 |   3.0 |
| Promote extraction entities to meta-model elements        |         |       | 34:01 |  47.6 |
| Move all utility formatters from extraction to generation |         |       |  0:27 |   0.6 |
| Remove annotations from stitch templates                  |         |       |  1:17 |   1.8 |
| Supply decorations as a stitch parameter                  |         |       |  4:29 |   6.3 |
...
*** STARTED Remove annotations from stitch templates                  :story:
    :LOGBOOK:
...
*** STARTED Supply decorations as a stitch parameter                  :story:
     :LOGBOOK:
