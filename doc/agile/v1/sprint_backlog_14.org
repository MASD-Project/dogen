...
#+CAPTION: Clock summary at [2019-04-06 Sat 12:23]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
...
| Sprint and product backlog grooming                       |         |       |  7:14 |   9.3 |
| Create a video demo for the previous sprint's features    |         |       |  3:11 |   4.1 |
| Fix issues with emacs                                     |         |       |  2:42 |   3.5 |
| Create a basic "project plan"                             |         |       |  2:08 |   2.7 |
| Simplify qualified name                                   |         |       |  3:39 |   4.7 |
| Rename "language" to "technical space"                    |         |       |  7:22 |   9.5 |
| Add intrinsic technical space ownership                   |         |       |  1:12 |   1.5 |
| Promote extraction entities to meta-model elements        |         |       | 37:25 |  48.1 |
| Integrate report-ci with dogen                            |         |       |  2:09 |   2.8 |
| Move all utility formatters from extraction to generation |         |       |  3:09 |   4.1 |
