...
#+CAPTION: Clock summary at [2019-04-05 Fri 10:23]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *64:58* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 64:58   |       |       | 100.0 |
| Active                                                    |         | 64:58 |       | 100.0 |
| Edit release notes for previous sprint                    |         |       |  1:47 |   2.7 |
| Sprint and product backlog grooming                       |         |       |  7:07 |  11.0 |
| Create a video demo for the previous sprint's features    |         |       |  3:11 |   4.9 |
| Fix issues with emacs                                     |         |       |  2:42 |   4.2 |
| Create a basic "project plan"                             |         |       |  2:08 |   3.3 |
| Simplify qualified name                                   |         |       |  3:39 |   5.6 |
| Rename "language" to "technical space"                    |         |       |  7:22 |  11.3 |
| Add intrinsic technical space ownership                   |         |       |  1:12 |   1.8 |
| Integrate report-ci with dogen                            |         |       |  2:09 |   3.3 |
| Promote extraction entities to meta-model elements        |         |       | 30:56 |  47.6 |
| Move all utility formatters from extraction to generation |         |       |  0:27 |   0.7 |
| Remove annotations from stitch templates                  |         |       |  1:17 |   2.0 |
| Supply decorations as a sttich parameter                  |         |       |  1:01 |   1.6 |
...
*** STARTED Supply decorations as a sttich parameter                  :story:
     :LOGBOOK:
