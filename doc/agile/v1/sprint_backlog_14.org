...
#+CAPTION: Clock summary at [2019-04-05 Fri 10:01]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *64:38* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 64:38   |       |       | 100.0 |
| Active                                                    |         | 64:38 |       | 100.0 |
| Edit release notes for previous sprint                    |         |       |  1:47 |   2.8 |
...
| Rename "language" to "technical space"                    |         |       |  7:22 |  11.4 |
| Add intrinsic technical space ownership                   |         |       |  1:12 |   1.9 |
| Integrate report-ci with dogen                            |         |       |  2:09 |   3.3 |
| Promote extraction entities to meta-model elements        |         |       | 30:56 |  47.9 |
| Move all utility formatters from extraction to generation |         |       |  0:27 |   0.7 |
| Remove annotations from stitch templates                  |         |       |  1:17 |   2.0 |
| Supply decorations as a sttich parameter                  |         |       |  0:41 |   1.1 |
