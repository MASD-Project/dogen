...
#+CAPTION: Clock summary at [2022-09-30 Fri 21:14]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *40:21* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 40:21   |       |       | 100.0 |
| Active                                                    |         | 40:21 |       | 100.0 |
| Edit release notes for previous sprint                    |         |       | 10:13 |  25.3 |
| Create a demo and presentation for previous sprint        |         |       |  2:06 |   5.2 |
| Update boost to latest in vcpg                            |         |       |  0:20 |   0.8 |
| Improve diffing output in tests                           |         |       |  0:19 |   0.8 |
| Sprint and product backlog grooming                       |         |       |  2:55 |   7.2 |
| Nightly builds are failing due to missing environment var |         |       |  1:07 |   2.8 |
| Remove deprecated uses of boost bind                      |         |       |  0:09 |   0.4 |
| Full generation support in tests is incorrect             |         |       |  3:18 |   8.2 |
| Tests failing with filesystem errors                      |         |       |  2:10 |   5.4 |
| Remove uses of mock configuration factory                 |         |       |  0:54 |   2.2 |
| Add continuous builds to C++ reference product            |         |       |  2:13 |   5.5 |
| Add continuous builds to C# reference product             |         |       |  1:50 |   4.5 |
| Remove ODB support from Dogen                             |         |       |  0:45 |   1.9 |
| Model significant relations at a higher level             |         |       |  1:05 |   2.7 |
| Create a mock configuration builder                       |         |       |  1:58 |   4.9 |
| Enable CodeQL                                             |         |       |  0:21 |   0.9 |
| Gitter notifications for builds are not showing up        |         |       |  0:38 |   1.6 |
| Ignore vcpkg path length warning                          |         |       |  0:12 |   0.5 |
| Windows package is broken                                 |         |       |  0:20 |   0.8 |
| Warning on OSX build                                      |         |       |  2:23 |   5.9 |
| Add PlantUML relationships to diagrams                    |         |       |  5:05 |  12.6 |
#+end:
