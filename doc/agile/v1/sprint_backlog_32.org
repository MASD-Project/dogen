...
#+CAPTION: Clock summary at [2022-09-21 Wed 23:53]
| <75>                                                      |         |       |      |       |
| Headline                                                  | Time    |       |      |     % |
|-----------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                              | *20:43* |       |      | 100.0 |
|-----------------------------------------------------------+---------+-------+------+-------|
| Stories                                                   | 20:43   |       |      | 100.0 |
| Active                                                    |         | 20:43 |      | 100.0 |
| Edit release notes for previous sprint                    |         |       | 9:44 |  47.0 |
| Create a demo and presentation for previous sprint        |         |       | 2:06 |  10.1 |
| Update boost to latest in vcpg                            |         |       | 0:20 |   1.6 |
| Improve diffing output in tests                           |         |       | 0:19 |   1.5 |
| Sprint and product backlog grooming                       |         |       | 1:15 |   6.0 |
| Nightly builds are failing due to missing environment var |         |       | 1:07 |   5.4 |
| Remove deprecated uses of boost bind                      |         |       | 0:09 |   0.7 |
| Gitter notifications for builds are not showing up        |         |       | 0:38 |   3.1 |
| Windows package is broken                                 |         |       | 0:20 |   1.6 |
| Full generation support in tests is incorrect             |         |       | 2:43 |  13.1 |
| Create a mock configuration builder                       |         |       | 1:58 |   9.5 |
