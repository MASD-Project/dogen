...
#+CAPTION: Clock summary at [2022-10-14 Fri 08:09]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *60:07* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 60:07   |       |       | 100.0 |
| Active                                                    |         | 60:07 |       | 100.0 |
| Edit release notes for previous sprint                    |         |       | 10:13 |  17.0 |
...
| Nightly builds are failing due to missing environment var |         |       |  1:07 |   1.9 |
| Remove deprecated uses of boost bind                      |         |       |  0:09 |   0.2 |
| Full generation support in tests is incorrect             |         |       |  3:18 |   5.5 |
...
| Create a mock configuration builder                       |         |       |  1:58 |   3.3 |
...
| Warning on OSX build                                      |         |       |  2:23 |   4.0 |
| Use clang format to format the code base                  |         |       |  0:58 |   1.6 |
| Add PlantUML relationships to diagrams                    |         |       | 15:50 |  26.3 |
| Create a nightly github workflow                          |         |       |  2:29 |   4.1 |
#+end:
