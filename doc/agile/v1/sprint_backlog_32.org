...
#+CAPTION: Clock summary at [2022-10-01 Sat 11:43]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                   | 41:03   |       |       | 100.0 |
| Active                                                    |         | 41:03 |       | 100.0 |
| Edit release notes for previous sprint                    |         |       | 10:13 |  24.9 |
...
| Sprint and product backlog grooming                       |         |       |  2:55 |   7.1 |
...
| Tests failing with filesystem errors                      |         |       |  2:10 |   5.3 |
| Remove uses of mock configuration factory                 |         |       |  0:54 |   2.2 |
| Add continuous builds to C++ reference product            |         |       |  2:13 |   5.4 |
...
| Create a mock configuration builder                       |         |       |  1:58 |   4.8 |
...
| Warning on OSX build                                      |         |       |  2:23 |   5.8 |
| Add PlantUML relationships to diagrams                    |         |       |  5:47 |  14.1 |
#+end:
