...
#+CAPTION: Clock summary at [2022-09-30 Fri 12:10]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *37:02* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 37:02   |       |       | 100.0 |
| Active                                                    |         | 37:02 |       | 100.0 |
| Edit release notes for previous sprint                    |         |       | 10:13 |  27.6 |
| Create a demo and presentation for previous sprint        |         |       |  2:06 |   5.7 |
| Update boost to latest in vcpg                            |         |       |  0:20 |   0.9 |
| Improve diffing output in tests                           |         |       |  0:19 |   0.9 |
| Sprint and product backlog grooming                       |         |       |  2:55 |   7.9 |
| Nightly builds are failing due to missing environment var |         |       |  1:07 |   3.0 |
| Remove deprecated uses of boost bind                      |         |       |  0:09 |   0.4 |
| Full generation support in tests is incorrect             |         |       |  3:18 |   8.9 |
| Tests failing with filesystem errors                      |         |       |  2:10 |   5.9 |
| Remove uses of mock configuration factory                 |         |       |  0:54 |   2.4 |
| Add continuous builds to C++ reference product            |         |       |  2:13 |   6.0 |
| Add continuous builds to C# reference product             |         |       |  1:50 |   5.0 |
| Remove ODB support from Dogen                             |         |       |  0:45 |   2.0 |
| Model significant relations at a higher level             |         |       |  1:05 |   2.9 |
| Create a mock configuration builder                       |         |       |  1:58 |   5.3 |
| Enable CodeQL                                             |         |       |  0:21 |   0.9 |
| Gitter notifications for builds are not showing up        |         |       |  0:38 |   1.7 |
| Ignore vcpkg path length warning                          |         |       |  0:12 |   0.5 |
| Windows package is broken                                 |         |       |  0:20 |   0.9 |
| Warning on OSX build                                      |         |       |  2:23 |   6.4 |
| Add PlantUML relationships to diagrams                    |         |       |  1:46 |   4.8 |
#+end:
