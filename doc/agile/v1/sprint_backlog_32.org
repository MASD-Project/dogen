...
#+CAPTION: Clock summary at [2022-09-19 Mon 18:40]
| <75>                                                      |         |       |      |       |
| Headline                                                  | Time    |       |      |     % |
|-----------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                   | 18:33   |       |      | 100.0 |
| Active                                                    |         | 18:33 |      | 100.0 |
| Edit release notes for previous sprint                    |         |       | 9:44 |  52.5 |
| Create a demo and presentation for previous sprint        |         |       | 2:06 |  11.3 |
| Update boost to latest in vcpg                            |         |       | 0:20 |   1.8 |
| Improve diffing output in tests                           |         |       | 0:19 |   1.7 |
| Sprint and product backlog grooming                       |         |       | 1:09 |   6.2 |
| Nightly builds are failing due to missing environment var |         |       | 1:07 |   6.0 |
| Remove deprecated uses of boost bind                      |         |       | 0:09 |   0.8 |
| Gitter notifications for builds are not showing up        |         |       | 0:38 |   3.4 |
| Windows package is broken                                 |         |       | 0:08 |   0.7 |
| Full generation support in tests is incorrect             |         |       | 1:00 |   5.4 |
| Create a mock configuration builder                       |         |       | 1:49 |   9.8 |
| Add PlantUML relationships to diagrams                    |         |       | 0:04 |   0.4 |
#+end:
