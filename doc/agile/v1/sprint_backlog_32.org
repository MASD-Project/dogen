...
#+CAPTION: Clock summary at [2022-10-08 Sat 11:06]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *50:05* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 50:05   |       |       | 100.0 |
| Active                                                    |         | 50:05 |       | 100.0 |
| Edit release notes for previous sprint                    |         |       | 10:13 |  20.4 |
...
| Add continuous builds to C# reference product             |         |       |  1:50 |   3.7 |
...
| Warning on OSX build                                      |         |       |  2:23 |   4.8 |
| Add PlantUML relationships to diagrams                    |         |       | 10:16 |  20.5 |
| Consider using a different layout engine in PlantUML      |         |       |  0:35 |   1.2 |
| Use clang format to format the code base                  |         |       |  0:58 |   1.9 |
| Upgrade PlantUML to latest                                |         |       |  0:31 |   1.0 |
#+end:
...
*** STARTED Upgrade PlantUML to latest                                :story:
    :LOGBOOK:
