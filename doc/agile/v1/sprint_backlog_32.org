...
#+CAPTION: Clock summary at [2022-09-30 Fri 08:27]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *34:51* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 34:51   |       |       | 100.0 |
| Active                                                    |         | 34:51 |       | 100.0 |
| Edit release notes for previous sprint                    |         |       | 10:13 |  29.3 |
| Create a demo and presentation for previous sprint        |         |       |  2:06 |   6.0 |
| Update boost to latest in vcpg                            |         |       |  0:20 |   1.0 |
| Improve diffing output in tests                           |         |       |  0:19 |   0.9 |
| Sprint and product backlog grooming                       |         |       |  2:50 |   8.1 |
| Nightly builds are failing due to missing environment var |         |       |  1:07 |   3.2 |
| Remove deprecated uses of boost bind                      |         |       |  0:09 |   0.4 |
| Full generation support in tests is incorrect             |         |       |  3:18 |   9.5 |
| Tests failing with filesystem errors                      |         |       |  2:10 |   6.2 |
| Remove uses of mock configuration factory                 |         |       |  0:54 |   2.6 |
| Add continuous builds to C++ reference product            |         |       |  2:13 |   6.4 |
| Add continuous builds to C# reference product             |         |       |  1:50 |   5.3 |
| Remove ODB support from Dogen                             |         |       |  0:45 |   2.2 |
| Model significant relations at a higher level             |         |       |  1:05 |   3.1 |
| Create a mock configuration builder                       |         |       |  1:58 |   5.6 |
| Enable CodeQL                                             |         |       |  0:21 |   1.0 |
| Gitter notifications for builds are not showing up        |         |       |  0:38 |   1.8 |
| Windows package is broken                                 |         |       |  0:20 |   1.0 |
| Warning on OSX build                                      |         |       |  1:59 |   5.7 |
