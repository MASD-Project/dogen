...
#+CAPTION: Clock summary at [2022-10-03 Mon 19:51]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *43:27* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 43:27   |       |       | 100.0 |
| Active                                                    |         | 43:27 |       | 100.0 |
| Edit release notes for previous sprint                    |         |       | 10:13 |  23.5 |
| Create a demo and presentation for previous sprint        |         |       |  2:06 |   4.8 |
| Update boost to latest in vcpg                            |         |       |  0:20 |   0.8 |
| Improve diffing output in tests                           |         |       |  0:19 |   0.7 |
| Sprint and product backlog grooming                       |         |       |  3:28 |   8.0 |
| Nightly builds are failing due to missing environment var |         |       |  1:07 |   2.6 |
| Remove deprecated uses of boost bind                      |         |       |  0:09 |   0.3 |
| Full generation support in tests is incorrect             |         |       |  3:18 |   7.6 |
| Tests failing with filesystem errors                      |         |       |  2:10 |   5.0 |
| Remove uses of mock configuration factory                 |         |       |  0:54 |   2.1 |
| Add continuous builds to C++ reference product            |         |       |  2:13 |   5.1 |
| Add continuous builds to C# reference product             |         |       |  1:50 |   4.2 |
| Remove ODB support from Dogen                             |         |       |  0:45 |   1.7 |
| Model significant relations at a higher level             |         |       |  1:05 |   2.5 |
| Create a mock configuration builder                       |         |       |  1:58 |   4.5 |
...
| Add PlantUML relationships to diagrams                    |         |       |  7:03 |  16.2 |
| Change namespaces note implementation in PlantUML         |         |       |  0:35 |   1.3 |
#+end:
