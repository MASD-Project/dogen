...
#+CAPTION: Clock summary at [2022-09-19 Mon 09:19]
| <75>                                                      |         |       |      |       |
| Headline                                                  | Time    |       |      |     % |
|-----------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                              | *16:22* |       |      | 100.0 |
|-----------------------------------------------------------+---------+-------+------+-------|
| Stories                                                   | 16:22   |       |      | 100.0 |
| Active                                                    |         | 16:22 |      | 100.0 |
| Edit release notes for previous sprint                    |         |       | 9:44 |  59.5 |
| Create a demo and presentation for previous sprint        |         |       | 2:06 |  12.8 |
| Update boost to latest in vcpg                            |         |       | 0:20 |   2.0 |
| Improve diffing output in tests                           |         |       | 0:19 |   1.9 |
| Sprint and product backlog grooming                       |         |       | 1:01 |   6.2 |
| Nightly builds are failing due to missing environment var |         |       | 1:07 |   6.8 |
| Remove deprecated uses of boost bind                      |         |       | 0:09 |   0.9 |
| Gitter notifications for builds are not showing up        |         |       | 0:38 |   3.9 |
| Windows package is broken                                 |         |       | 0:08 |   0.8 |
| Full generation support in tests is incorrect             |         |       | 0:50 |   5.1 |
#+end:
...
*** STARTED Nightly builds are failing due to missing environment var :story:
    :LOGBOOK:
...
*** STARTED Remove deprecated uses of boost bind                      :story:
   :LOGBOOK:
...
*** STARTED Full generation support in tests is incorrect             :story:
    :LOGBOOK:
