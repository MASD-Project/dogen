...
#+CAPTION: Clock summary at [2022-11-12 Sat 18:42]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *64:01* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 64:01   |       |       | 100.0 |
| Active                                                    |         | 64:01 |       | 100.0 |
| Edit release notes for previous sprint                    |         |       | 10:13 |  16.0 |
| Create a demo and presentation for previous sprint        |         |       |  2:06 |   3.3 |
| Update boost to latest in vcpg                            |         |       |  0:20 |   0.5 |
| Improve diffing output in tests                           |         |       |  0:19 |   0.5 |
| Sprint and product backlog grooming                       |         |       |  3:48 |   5.9 |
| Nightly builds are failing due to missing environment var |         |       |  1:07 |   1.7 |
| Remove deprecated uses of boost bind                      |         |       |  0:09 |   0.2 |
| Full generation support in tests is incorrect             |         |       |  3:18 |   5.2 |
| Tests failing with filesystem errors                      |         |       |  2:10 |   3.4 |
...
| Change namespaces note implementation in PlantUML         |         |       |  1:48 |   2.8 |
...
| Warning on OSX build                                      |         |       |  2:23 |   3.7 |
| Use clang format to format the code base                  |         |       |  0:58 |   1.5 |
| Add PlantUML relationships to diagrams                    |         |       | 17:19 |  27.1 |
| Create a nightly github workflow                          |         |       |  4:54 |   7.7 |
#+end:
