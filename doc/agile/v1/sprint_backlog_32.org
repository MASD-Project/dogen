...
#+CAPTION: Clock summary at [2022-10-08 Sat 10:01]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *49:30* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 49:30   |       |       | 100.0 |
| Active                                                    |         | 49:30 |       | 100.0 |
| Edit release notes for previous sprint                    |         |       | 10:13 |  20.6 |
...
| Sprint and product backlog grooming                       |         |       |  3:36 |   7.3 |
| Nightly builds are failing due to missing environment var |         |       |  1:07 |   2.3 |
| Remove deprecated uses of boost bind                      |         |       |  0:09 |   0.3 |
| Full generation support in tests is incorrect             |         |       |  3:18 |   6.7 |
| Tests failing with filesystem errors                      |         |       |  2:10 |   4.4 |
| Remove uses of mock configuration factory                 |         |       |  0:54 |   1.8 |
| Add continuous builds to C++ reference product            |         |       |  2:13 |   4.5 |
...
| Create a mock configuration builder                       |         |       |  1:58 |   4.0 |
...
| Add PlantUML relationships to diagrams                    |         |       | 10:16 |  20.7 |
| Use clang format to format the code base                  |         |       |  0:58 |   2.0 |
