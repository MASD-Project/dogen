...
#+CAPTION: Clock summary at [2022-09-17 Sat 21:48]
| <75>                                                      |         |       |      |       |
| Headline                                                  | Time    |       |      |     % |
|-----------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                   | 13:49   |       |      | 100.0 |
| Active                                                    |         | 13:49 |      | 100.0 |
| Edit release notes for previous sprint                    |         |       | 9:44 |  70.4 |
| Create a demo and presentation for previous sprint        |         |       | 2:06 |  15.2 |
| Update boost to latest in vcpg                            |         |       | 0:20 |   2.4 |
| Sprint and product backlog grooming                       |         |       | 0:55 |   6.6 |
| Nightly builds are failing due to missing environment var |         |       | 0:16 |   1.9 |
| Remove deprecated uses of boost bind                      |         |       | 0:09 |   1.1 |
| Gitter notifications for builds are not showing up        |         |       | 0:19 |   2.3 |
#+end:
