...
#+CAPTION: Clock summary at [2022-09-22 Thu 20:00]
| <75>                                                      |         |       |      |       |
| Headline                                                  | Time    |       |      |     % |
|-----------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                              | *21:47* |       |      | 100.0 |
|-----------------------------------------------------------+---------+-------+------+-------|
| Stories                                                   | 21:47   |       |      | 100.0 |
| Active                                                    |         | 21:47 |      | 100.0 |
| Edit release notes for previous sprint                    |         |       | 9:44 |  44.7 |
| Create a demo and presentation for previous sprint        |         |       | 2:06 |   9.6 |
| Update boost to latest in vcpg                            |         |       | 0:20 |   1.5 |
| Improve diffing output in tests                           |         |       | 0:19 |   1.5 |
| Sprint and product backlog grooming                       |         |       | 1:24 |   6.4 |
| Nightly builds are failing due to missing environment var |         |       | 1:07 |   5.1 |
| Remove deprecated uses of boost bind                      |         |       | 0:09 |   0.7 |
| Full generation support in tests is incorrect             |         |       | 2:52 |  13.2 |
| Gitter notifications for builds are not showing up        |         |       | 0:38 |   2.9 |
| Windows package is broken                                 |         |       | 0:20 |   1.5 |
| Tests failing with filesystem errors                      |         |       | 0:46 |   3.5 |
| Create a mock configuration builder                       |         |       | 1:58 |   9.0 |
| Add PlantUML relationships to diagrams                    |         |       | 0:04 |   0.3 |
#+end:
...
*** STARTED Tests failing with filesystem errors                      :story:
    :LOGBOOK:
