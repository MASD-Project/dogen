...
#+CAPTION: Clock summary at [2022-11-19 Sat 15:00]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *70:14* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 70:14   |       |       | 100.0 |
| Active                                                    |         | 70:14 |       | 100.0 |
| Edit release notes for previous sprint                    |         |       | 10:13 |  14.5 |
| Create a demo and presentation for previous sprint        |         |       |  2:06 |   3.0 |
| Update boost to latest in vcpg                            |         |       |  0:20 |   0.5 |
| Improve diffing output in tests                           |         |       |  0:19 |   0.5 |
| Sprint and product backlog grooming                       |         |       |  5:11 |   7.4 |
| Nightly builds are failing due to missing environment var |         |       |  1:07 |   1.6 |
| Remove deprecated uses of boost bind                      |         |       |  0:09 |   0.2 |
| Full generation support in tests is incorrect             |         |       |  3:18 |   4.7 |
| Tests failing with filesystem errors                      |         |       |  2:10 |   3.1 |
| Remove uses of mock configuration factory                 |         |       |  0:54 |   1.3 |
| Add continuous builds to C++ reference product            |         |       |  2:13 |   3.2 |
| Add continuous builds to C# reference product             |         |       |  1:50 |   2.6 |
| Remove ODB support from Dogen                             |         |       |  0:45 |   1.1 |
| Model significant relations at a higher level             |         |       |  1:05 |   1.5 |
| Create a mock configuration builder                       |         |       |  1:58 |   2.8 |
| Enable CodeQL                                             |         |       |  0:21 |   0.5 |
| Change namespaces note implementation in PlantUML         |         |       |  1:48 |   2.6 |
| Consider using a different layout engine in PlantUML      |         |       |  1:31 |   2.2 |
| Upgrade PlantUML to latest                                |         |       |  0:44 |   1.0 |
| Code coverage in CDash has disappeared                    |         |       |  0:23 |   0.5 |
| Investigate nightly issues                                |         |       |  0:15 |   0.4 |
| Gitter notifications for builds are not showing up        |         |       |  2:07 |   3.0 |
| Create a nightly github workflow                          |         |       |  5:21 |   7.6 |
| Ignore vcpkg path length warning                          |         |       |  0:12 |   0.3 |
| Windows package is broken                                 |         |       |  0:20 |   0.5 |
| Warning on OSX build                                      |         |       |  2:23 |   3.4 |
| Use clang format to format the code base                  |         |       |  0:58 |   1.4 |
| Add PlantUML relationships to diagrams                    |         |       | 17:19 |  24.7 |
| Configuration as stereotype causes noise                  |         |       |  2:09 |   3.1 |
| Update CMakeLists to match latest                         |         |       |  0:45 |   1.1 |
#+end:
