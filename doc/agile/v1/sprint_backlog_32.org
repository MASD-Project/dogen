...
| Create a nightly github workflow                          |         |       |  5:39 |   6.9 |
...
*** COMPLETED Update boost to latest in vcpkg                         :story:
    :LOGBOOK:
