...
#+CAPTION: Clock summary at [2022-09-18 Sun 07:47]
| <75>                                                      |         |       |      |       |
| Headline                                                  | Time    |       |      |     % |
|-----------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                              | *14:13* |       |      | 100.0 |
|-----------------------------------------------------------+---------+-------+------+-------|
| Stories                                                   | 14:13   |       |      | 100.0 |
| Active                                                    |         | 14:13 |      | 100.0 |
| Edit release notes for previous sprint                    |         |       | 9:44 |  68.5 |
| Create a demo and presentation for previous sprint        |         |       | 2:06 |  14.8 |
| Update boost to latest in vcpg                            |         |       | 0:20 |   2.3 |
| Sprint and product backlog grooming                       |         |       | 0:57 |   6.7 |
| Nightly builds are failing due to missing environment var |         |       | 0:21 |   2.5 |
| Remove deprecated uses of boost bind                      |         |       | 0:09 |   1.1 |
| Gitter notifications for builds are not showing up        |         |       | 0:28 |   3.3 |
| Windows package is broken                                 |         |       | 0:08 |   0.9 |
#+end:
