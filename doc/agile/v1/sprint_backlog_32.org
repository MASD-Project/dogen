...
#+CAPTION: Clock summary at [2022-11-18 Fri 19:15]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *68:51* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 68:51   |       |       | 100.0 |
| Active                                                    |         | 68:51 |       | 100.0 |
| Edit release notes for previous sprint                    |         |       | 10:13 |  14.8 |
| Create a demo and presentation for previous sprint        |         |       |  2:06 |   3.1 |
| Update boost to latest in vcpg                            |         |       |  0:20 |   0.5 |
| Improve diffing output in tests                           |         |       |  0:19 |   0.5 |
| Sprint and product backlog grooming                       |         |       |  4:33 |   6.6 |
| Nightly builds are failing due to missing environment var |         |       |  1:07 |   1.6 |
| Remove deprecated uses of boost bind                      |         |       |  0:09 |   0.2 |
| Full generation support in tests is incorrect             |         |       |  3:18 |   4.8 |
...
| Add continuous builds to C# reference product             |         |       |  1:50 |   2.7 |
| Remove ODB support from Dogen                             |         |       |  0:45 |   1.1 |
| Model significant relations at a higher level             |         |       |  1:05 |   1.6 |
| Create a mock configuration builder                       |         |       |  1:58 |   2.9 |
...
| Gitter notifications for builds are not showing up        |         |       |  2:07 |   3.1 |
| Ignore vcpkg path length warning                          |         |       |  0:12 |   0.3 |
| Windows package is broken                                 |         |       |  0:20 |   0.5 |
| Warning on OSX build                                      |         |       |  2:23 |   3.5 |
| Use clang format to format the code base                  |         |       |  0:58 |   1.4 |
| Add PlantUML relationships to diagrams                    |         |       | 17:19 |  25.2 |
| Create a nightly github workflow                          |         |       |  5:21 |   7.8 |
