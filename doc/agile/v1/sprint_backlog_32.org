...
#+CAPTION: Clock summary at [2022-10-11 Tue 22:17]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *57:58* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 57:58   |       |       | 100.0 |
| Active                                                    |         | 57:58 |       | 100.0 |
| Edit release notes for previous sprint                    |         |       | 10:13 |  17.6 |
...
| Add continuous builds to C# reference product             |         |       |  1:50 |   3.2 |
| Remove ODB support from Dogen                             |         |       |  0:45 |   1.3 |
| Model significant relations at a higher level             |         |       |  1:05 |   1.9 |
| Create a mock configuration builder                       |         |       |  1:58 |   3.4 |
...
| Warning on OSX build                                      |         |       |  2:23 |   4.1 |
| Use clang format to format the code base                  |         |       |  0:58 |   1.7 |
| Add PlantUML relationships to diagrams                    |         |       | 14:45 |  25.4 |
| Create a nightly github workflow                          |         |       |  1:25 |   2.4 |
#+end:
