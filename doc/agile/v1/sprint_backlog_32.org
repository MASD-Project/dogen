...
#+CAPTION: Clock summary at [2022-09-12 Mon 22:42]
| <75>                                   |        |      |      |       |
| Headline                               | Time   |      |      |     % |
|----------------------------------------+--------+------+------+-------|
...
| Stories                                | 6:58   |      |      | 100.0 |
| Active                                 |        | 6:58 |      | 100.0 |
| Edit release notes for previous sprint |        |      | 6:15 |  89.7 |
| Sprint and product backlog grooming    |        |      | 0:43 |  10.3 |
#+end:
...
#+begin_src markdown
**_DRAFT RELEASE NOTES - Please come back soon._**
...
Some of the work on this epic was captured on a video series called "MASD - Dogen Coding: Move to GitHub CI". It is available as a playlist.
