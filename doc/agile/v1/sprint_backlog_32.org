...
#+CAPTION: Clock summary at [2022-10-01 Sat 18:53]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *42:44* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 42:44   |       |       | 100.0 |
| Active                                                    |         | 42:44 |       | 100.0 |
| Edit release notes for previous sprint                    |         |       | 10:13 |  23.9 |
| Create a demo and presentation for previous sprint        |         |       |  2:06 |   4.9 |
| Update boost to latest in vcpg                            |         |       |  0:20 |   0.8 |
| Improve diffing output in tests                           |         |       |  0:19 |   0.7 |
| Sprint and product backlog grooming                       |         |       |  3:01 |   7.1 |
| Nightly builds are failing due to missing environment var |         |       |  1:07 |   2.6 |
| Remove deprecated uses of boost bind                      |         |       |  0:09 |   0.4 |
| Full generation support in tests is incorrect             |         |       |  3:18 |   7.7 |
| Tests failing with filesystem errors                      |         |       |  2:10 |   5.1 |
| Remove uses of mock configuration factory                 |         |       |  0:54 |   2.1 |
| Add continuous builds to C++ reference product            |         |       |  2:13 |   5.2 |
| Add continuous builds to C# reference product             |         |       |  1:50 |   4.3 |
| Remove ODB support from Dogen                             |         |       |  0:45 |   1.8 |
| Model significant relations at a higher level             |         |       |  1:05 |   2.5 |
| Create a mock configuration builder                       |         |       |  1:58 |   4.6 |
| Enable CodeQL                                             |         |       |  0:21 |   0.8 |
| Gitter notifications for builds are not showing up        |         |       |  0:38 |   1.5 |
| Ignore vcpkg path length warning                          |         |       |  0:12 |   0.5 |
| Windows package is broken                                 |         |       |  0:20 |   0.8 |
| Warning on OSX build                                      |         |       |  2:23 |   5.6 |
| Add PlantUML relationships to diagrams                    |         |       |  7:03 |  16.5 |
| Change namespaces note implementation in PlantUML         |         |       |  0:19 |   0.7 |
#+end:
...
*** STARTED Change namespaces note implementation in PlantUML         :story:
    :LOGBOOK:
