...
#+CAPTION: Clock summary at [2022-11-29 Tue 18:34]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *79:26* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 79:26   |       |       | 100.0 |
| Active                                                    |         | 79:26 |       | 100.0 |
| Edit release notes for previous sprint                    |         |       | 10:13 |  12.9 |
...
| Sprint and product backlog grooming                       |         |       |  5:16 |   6.6 |
...
| Create a nightly github workflow                          |         |       |  5:39 |   7.1 |
| Nightly builds are taking too long                        |         |       |  4:43 |   5.9 |
| Ignore vcpkg path length warning                          |         |       |  0:12 |   0.3 |
| Windows package is broken                                 |         |       |  0:20 |   0.4 |
| Warning on OSX build                                      |         |       |  2:23 |   3.0 |
| Use clang format to format the code base                  |         |       |  0:58 |   1.2 |
| Add PlantUML relationships to diagrams                    |         |       | 17:19 |  21.8 |
| Configuration as stereotype causes noise                  |         |       |  2:09 |   2.7 |
| Update CMakeLists to match latest                         |         |       |  0:45 |   0.9 |
| Thoughts on refactoring variability                       |         |       |  4:06 |   5.2 |
#+end:
