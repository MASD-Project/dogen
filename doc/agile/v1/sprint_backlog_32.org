...
#+CAPTION: Clock summary at [2022-10-06 Thu 20:12]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                   | 48:06   |       |       | 100.0 |
| Active                                                    |         | 48:06 |       | 100.0 |
| Edit release notes for previous sprint                    |         |       | 10:13 |  21.2 |
| Create a demo and presentation for previous sprint        |         |       |  2:06 |   4.4 |
| Update boost to latest in vcpg                            |         |       |  0:20 |   0.7 |
| Improve diffing output in tests                           |         |       |  0:19 |   0.7 |
| Sprint and product backlog grooming                       |         |       |  3:36 |   7.5 |
| Nightly builds are failing due to missing environment var |         |       |  1:07 |   2.3 |
| Remove deprecated uses of boost bind                      |         |       |  0:09 |   0.3 |
| Full generation support in tests is incorrect             |         |       |  3:18 |   6.9 |
| Tests failing with filesystem errors                      |         |       |  2:10 |   4.5 |
| Remove uses of mock configuration factory                 |         |       |  0:54 |   1.9 |
| Add continuous builds to C++ reference product            |         |       |  2:13 |   4.6 |
| Add continuous builds to C# reference product             |         |       |  1:50 |   3.8 |
| Remove ODB support from Dogen                             |         |       |  0:45 |   1.6 |
| Model significant relations at a higher level             |         |       |  1:05 |   2.3 |
| Create a mock configuration builder                       |         |       |  1:58 |   4.1 |
| Enable CodeQL                                             |         |       |  0:21 |   0.7 |
| Change namespaces note implementation in PlantUML         |         |       |  1:48 |   3.7 |
...
| Warning on OSX build                                      |         |       |  2:23 |   5.0 |
| Add PlantUML relationships to diagrams                    |         |       | 10:16 |  21.3 |
| Use clang format to format the code base                  |         |       |  0:05 |   0.2 |
#+end:
