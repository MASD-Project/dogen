...
#+CAPTION: Clock summary at [2022-11-12 Sat 14:42]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                   | 62:32   |       |       | 100.0 |
| Active                                                    |         | 62:32 |       | 100.0 |
| Edit release notes for previous sprint                    |         |       | 10:13 |  16.3 |
...
| Sprint and product backlog grooming                       |         |       |  3:48 |   6.1 |
| Nightly builds are failing due to missing environment var |         |       |  1:07 |   1.8 |
| Remove deprecated uses of boost bind                      |         |       |  0:09 |   0.2 |
| Full generation support in tests is incorrect             |         |       |  3:18 |   5.3 |
| Tests failing with filesystem errors                      |         |       |  2:10 |   3.5 |
| Remove uses of mock configuration factory                 |         |       |  0:54 |   1.4 |
| Add continuous builds to C++ reference product            |         |       |  2:13 |   3.5 |
| Add continuous builds to C# reference product             |         |       |  1:50 |   2.9 |
| Remove ODB support from Dogen                             |         |       |  0:45 |   1.2 |
| Model significant relations at a higher level             |         |       |  1:05 |   1.7 |
| Create a mock configuration builder                       |         |       |  1:58 |   3.1 |
| Enable CodeQL                                             |         |       |  0:21 |   0.6 |
| Change namespaces note implementation in PlantUML         |         |       |  1:48 |   2.9 |
| Consider using a different layout engine in PlantUML      |         |       |  1:31 |   2.4 |
...
| Warning on OSX build                                      |         |       |  2:23 |   3.8 |
| Use clang format to format the code base                  |         |       |  0:58 |   1.5 |
| Add PlantUML relationships to diagrams                    |         |       | 15:50 |  25.3 |
| Create a nightly github workflow                          |         |       |  4:54 |   7.8 |
#+end:
