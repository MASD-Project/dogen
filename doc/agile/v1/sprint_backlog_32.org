...
#+CAPTION: Clock summary at [2022-10-16 Sun 18:44]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                   | 60:56   |       |       | 100.0 |
| Active                                                    |         | 60:56 |       | 100.0 |
| Edit release notes for previous sprint                    |         |       | 10:13 |  16.8 |
| Create a demo and presentation for previous sprint        |         |       |  2:06 |   3.4 |
| Update boost to latest in vcpg                            |         |       |  0:20 |   0.5 |
| Improve diffing output in tests                           |         |       |  0:19 |   0.5 |
| Sprint and product backlog grooming                       |         |       |  3:48 |   6.2 |
| Nightly builds are failing due to missing environment var |         |       |  1:07 |   1.8 |
| Remove deprecated uses of boost bind                      |         |       |  0:09 |   0.2 |
| Full generation support in tests is incorrect             |         |       |  3:18 |   5.4 |
| Tests failing with filesystem errors                      |         |       |  2:10 |   3.6 |
| Remove uses of mock configuration factory                 |         |       |  0:54 |   1.5 |
| Add continuous builds to C++ reference product            |         |       |  2:13 |   3.6 |
| Add continuous builds to C# reference product             |         |       |  1:50 |   3.0 |
| Remove ODB support from Dogen                             |         |       |  0:45 |   1.2 |
| Model significant relations at a higher level             |         |       |  1:05 |   1.8 |
| Create a mock configuration builder                       |         |       |  1:58 |   3.2 |
| Enable CodeQL                                             |         |       |  0:21 |   0.6 |
| Change namespaces note implementation in PlantUML         |         |       |  1:48 |   3.0 |
| Consider using a different layout engine in PlantUML      |         |       |  1:31 |   2.5 |
| Upgrade PlantUML to latest                                |         |       |  0:44 |   1.2 |
| Code coverage in CDash has disappeared                    |         |       |  0:23 |   0.6 |
| Investigate nightly issues                                |         |       |  0:15 |   0.4 |
| Gitter notifications for builds are not showing up        |         |       |  0:38 |   1.0 |
| Ignore vcpkg path length warning                          |         |       |  0:12 |   0.3 |
| Windows package is broken                                 |         |       |  0:20 |   0.5 |
| Warning on OSX build                                      |         |       |  2:23 |   3.9 |
| Use clang format to format the code base                  |         |       |  0:58 |   1.6 |
| Add PlantUML relationships to diagrams                    |         |       | 15:50 |  26.0 |
| Create a nightly github workflow                          |         |       |  3:18 |   5.4 |
#+end:
...
*** Consider creating nightly branches                                :story:
...
*** Consider replacing assembly with weaving                          :story:

Weaving is the MDE term.
