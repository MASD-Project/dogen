...
#+CAPTION: Clock summary at [2022-12-01 Thu 08:44]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *76:41* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 76:41   |       |       | 100.0 |
| Active                                                    |         | 76:41 |       | 100.0 |
| Edit release notes for previous sprint                    |         |       | 10:13 |  13.3 |
...
| Create a nightly github workflow                          |         |       |  5:39 |   7.4 |
| Run nightlies only when there are changes                 |         |       |  0:09 |   0.2 |
| Nightly builds are taking too long                        |         |       |  5:04 |   6.6 |
...
| Add PlantUML relationships to diagrams                    |         |       | 17:19 |  22.6 |
| Configuration as stereotype causes noise                  |         |       |  2:09 |   2.8 |
| Update CMakeLists to match latest                         |         |       |  0:45 |   1.0 |
| Thoughts on refactoring variability                       |         |       |  0:08 |   0.2 |
