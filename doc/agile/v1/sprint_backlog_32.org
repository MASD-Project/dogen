...
#+CAPTION: Clock summary at [2022-10-12 Wed 08:59]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                   | 58:53   |       |       | 100.0 |
| Active                                                    |         | 58:53 |       | 100.0 |
| Edit release notes for previous sprint                    |         |       | 10:13 |  17.4 |
| Create a demo and presentation for previous sprint        |         |       |  2:06 |   3.6 |
| Update boost to latest in vcpg                            |         |       |  0:20 |   0.6 |
| Improve diffing output in tests                           |         |       |  0:19 |   0.5 |
| Sprint and product backlog grooming                       |         |       |  3:48 |   6.5 |
| Nightly builds are failing due to missing environment var |         |       |  1:07 |   1.9 |
| Remove deprecated uses of boost bind                      |         |       |  0:09 |   0.3 |
| Full generation support in tests is incorrect             |         |       |  3:18 |   5.6 |
| Tests failing with filesystem errors                      |         |       |  2:10 |   3.7 |
| Remove uses of mock configuration factory                 |         |       |  0:54 |   1.5 |
| Add continuous builds to C++ reference product            |         |       |  2:13 |   3.8 |
...
| Change namespaces note implementation in PlantUML         |         |       |  1:48 |   3.1 |
| Consider using a different layout engine in PlantUML      |         |       |  1:31 |   2.6 |
...
| Add PlantUML relationships to diagrams                    |         |       | 14:45 |  25.0 |
| Create a nightly github workflow                          |         |       |  2:20 |   4.0 |
#+end:
