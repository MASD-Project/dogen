...
#+CAPTION: Clock summary at [2022-10-08 Sat 14:41]
| <75>                                                      |           |         |       |       |
| Headline                                                  | Time      |         |       |     % |
|-----------------------------------------------------------+-----------+---------+-------+-------|
| *Total time*                                              | *2d 2:18* |         |       | 100.0 |
|-----------------------------------------------------------+-----------+---------+-------+-------|
| Stories                                                   | 2d 2:18   |         |       | 100.0 |
| Active                                                    |           | 2d 2:18 |       | 100.0 |
| Edit release notes for previous sprint                    |           |         | 10:13 |  20.3 |
| Create a demo and presentation for previous sprint        |           |         |  2:06 |   4.2 |
| Update boost to latest in vcpg                            |           |         |  0:20 |   0.7 |
| Improve diffing output in tests                           |           |         |  0:19 |   0.6 |
| Sprint and product backlog grooming                       |           |         |  3:36 |   7.2 |
| Nightly builds are failing due to missing environment var |           |         |  1:07 |   2.2 |
| Remove deprecated uses of boost bind                      |           |         |  0:09 |   0.3 |
| Full generation support in tests is incorrect             |           |         |  3:18 |   6.6 |
| Tests failing with filesystem errors                      |           |         |  2:10 |   4.3 |
| Remove uses of mock configuration factory                 |           |         |  0:54 |   1.8 |
| Add continuous builds to C++ reference product            |           |         |  2:13 |   4.4 |
| Add continuous builds to C# reference product             |           |         |  1:50 |   3.6 |
| Remove ODB support from Dogen                             |           |         |  0:45 |   1.5 |
| Model significant relations at a higher level             |           |         |  1:05 |   2.2 |
| Create a mock configuration builder                       |           |         |  1:58 |   3.9 |
| Enable CodeQL                                             |           |         |  0:21 |   0.7 |
| Change namespaces note implementation in PlantUML         |           |         |  1:48 |   3.6 |
| Consider using a different layout engine in PlantUML      |           |         |  0:35 |   1.2 |
| Upgrade PlantUML to latest                                |           |         |  0:44 |   1.5 |
| Gitter notifications for builds are not showing up        |           |         |  0:38 |   1.3 |
| Ignore vcpkg path length warning                          |           |         |  0:12 |   0.4 |
| Windows package is broken                                 |           |         |  0:20 |   0.7 |
| Warning on OSX build                                      |           |         |  2:23 |   4.7 |
| Add PlantUML relationships to diagrams                    |           |         | 10:16 |  20.4 |
