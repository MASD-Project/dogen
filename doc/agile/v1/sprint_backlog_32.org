...
#+CAPTION: Clock summary at [2022-09-23 Fri 10:13]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                   | 23:37   |       |       | 100.0 |
| Active                                                    |         | 23:37 |       | 100.0 |
| Edit release notes for previous sprint                    |         |       | 10:13 |  43.3 |
| Create a demo and presentation for previous sprint        |         |       |  2:06 |   8.9 |
| Update boost to latest in vcpg                            |         |       |  0:20 |   1.4 |
| Improve diffing output in tests                           |         |       |  0:19 |   1.3 |
| Sprint and product backlog grooming                       |         |       |  1:24 |   5.9 |
| Nightly builds are failing due to missing environment var |         |       |  1:07 |   4.7 |
| Remove deprecated uses of boost bind                      |         |       |  0:09 |   0.6 |
| Full generation support in tests is incorrect             |         |       |  3:03 |  12.9 |
| Tests failing with filesystem errors                      |         |       |  1:56 |   8.2 |
| Gitter notifications for builds are not showing up        |         |       |  0:38 |   2.7 |
| Windows package is broken                                 |         |       |  0:20 |   1.4 |
| Create a mock configuration builder                       |         |       |  1:58 |   8.3 |
