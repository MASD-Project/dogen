...
#+CAPTION: Clock summary at [2022-09-25 Sun 17:41]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *30:10* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 30:10   |       |       | 100.0 |
| Active                                                    |         | 30:10 |       | 100.0 |
| Edit release notes for previous sprint                    |         |       | 10:13 |  33.9 |
| Create a demo and presentation for previous sprint        |         |       |  2:06 |   7.0 |
| Update boost to latest in vcpg                            |         |       |  0:20 |   1.1 |
| Improve diffing output in tests                           |         |       |  0:19 |   1.0 |
| Sprint and product backlog grooming                       |         |       |  1:48 |   6.0 |
| Nightly builds are failing due to missing environment var |         |       |  1:07 |   3.7 |
| Remove deprecated uses of boost bind                      |         |       |  0:09 |   0.5 |
| Full generation support in tests is incorrect             |         |       |  3:18 |  10.9 |
| Tests failing with filesystem errors                      |         |       |  2:10 |   7.2 |
| Remove uses of mock configuration factory                 |         |       |  0:54 |   3.0 |
| Add continuous builds to C++ reference product            |         |       |  2:13 |   7.3 |
| Add continuous builds to C# reference product             |         |       |  1:38 |   5.4 |
| Remove ODB support from Dogen                             |         |       |  0:45 |   2.5 |
| Gitter notifications for builds are not showing up        |         |       |  0:38 |   2.1 |
| Windows package is broken                                 |         |       |  0:20 |   1.1 |
| Create a mock configuration builder                       |         |       |  1:58 |   6.5 |
| Add PlantUML relationships to diagrams                    |         |       |  0:04 |   0.2 |
| Enable CodeQL                                             |         |       |  0:10 |   0.6 |
#+end:
...
*** Improvements to PlantUML output                                   :story:

This story collects paper-cuts in the PlantUML output.
