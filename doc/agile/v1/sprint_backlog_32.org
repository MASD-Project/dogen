...
#+CAPTION: Clock summary at [2022-10-09 Sun 09:17]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                   | 52:10   |       |       | 100.0 |
| Active                                                    |         | 52:10 |       | 100.0 |
| Edit release notes for previous sprint                    |         |       | 10:13 |  19.6 |
| Create a demo and presentation for previous sprint        |         |       |  2:06 |   4.0 |
| Update boost to latest in vcpg                            |         |       |  0:20 |   0.6 |
| Improve diffing output in tests                           |         |       |  0:19 |   0.6 |
| Sprint and product backlog grooming                       |         |       |  3:36 |   6.9 |
| Nightly builds are failing due to missing environment var |         |       |  1:07 |   2.1 |
| Remove deprecated uses of boost bind                      |         |       |  0:09 |   0.3 |
| Full generation support in tests is incorrect             |         |       |  3:18 |   6.3 |
...
| Add continuous builds to C# reference product             |         |       |  1:50 |   3.5 |
...
| Warning on OSX build                                      |         |       |  2:23 |   4.6 |
| Add PlantUML relationships to diagrams                    |         |       | 10:57 |  21.0 |
...
*** Code coverage in CDash has disappeared                            :story:
