...
#+CAPTION: Clock summary at [2022-10-09 Sun 23:36]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *54:24* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 54:24   |       |       | 100.0 |
| Active                                                    |         | 54:24 |       | 100.0 |
| Edit release notes for previous sprint                    |         |       | 10:13 |  18.8 |
...
| Sprint and product backlog grooming                       |         |       |  3:48 |   7.0 |
| Nightly builds are failing due to missing environment var |         |       |  1:07 |   2.1 |
| Remove deprecated uses of boost bind                      |         |       |  0:09 |   0.3 |
| Full generation support in tests is incorrect             |         |       |  3:18 |   6.1 |
| Tests failing with filesystem errors                      |         |       |  2:10 |   4.0 |
| Remove uses of mock configuration factory                 |         |       |  0:54 |   1.7 |
| Add continuous builds to C++ reference product            |         |       |  2:13 |   4.1 |
...
| Warning on OSX build                                      |         |       |  2:23 |   4.4 |
| Add PlantUML relationships to diagrams                    |         |       | 12:09 |  22.3 |
