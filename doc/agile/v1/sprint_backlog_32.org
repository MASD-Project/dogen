...
#+CAPTION: Clock summary at [2022-09-25 Sun 20:00]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *31:30* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 31:30   |       |       | 100.0 |
| Active                                                    |         | 31:30 |       | 100.0 |
| Edit release notes for previous sprint                    |         |       | 10:13 |  32.4 |
| Create a demo and presentation for previous sprint        |         |       |  2:06 |   6.7 |
| Update boost to latest in vcpg                            |         |       |  0:20 |   1.1 |
| Improve diffing output in tests                           |         |       |  0:19 |   1.0 |
| Sprint and product backlog grooming                       |         |       |  2:09 |   6.8 |
| Nightly builds are failing due to missing environment var |         |       |  1:07 |   3.5 |
| Remove deprecated uses of boost bind                      |         |       |  0:09 |   0.5 |
| Full generation support in tests is incorrect             |         |       |  3:18 |  10.5 |
| Tests failing with filesystem errors                      |         |       |  2:10 |   6.9 |
| Remove uses of mock configuration factory                 |         |       |  0:54 |   2.9 |
| Add continuous builds to C++ reference product            |         |       |  2:13 |   7.0 |
| Add continuous builds to C# reference product             |         |       |  1:38 |   5.2 |
| Remove ODB support from Dogen                             |         |       |  0:45 |   2.4 |
| Gitter notifications for builds are not showing up        |         |       |  0:38 |   2.0 |
| Windows package is broken                                 |         |       |  0:20 |   1.1 |
| Create a mock configuration builder                       |         |       |  1:58 |   6.2 |
