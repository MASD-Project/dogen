...
#+CAPTION: Clock summary at [2022-10-09 Sun 21:44]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *53:11* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 53:11   |       |       | 100.0 |
| Active                                                    |         | 53:11 |       | 100.0 |
| Edit release notes for previous sprint                    |         |       | 10:13 |  19.2 |
| Create a demo and presentation for previous sprint        |         |       |  2:06 |   3.9 |
| Update boost to latest in vcpg                            |         |       |  0:20 |   0.6 |
| Improve diffing output in tests                           |         |       |  0:19 |   0.6 |
| Sprint and product backlog grooming                       |         |       |  3:48 |   7.1 |
| Nightly builds are failing due to missing environment var |         |       |  1:07 |   2.1 |
| Remove deprecated uses of boost bind                      |         |       |  0:09 |   0.3 |
| Full generation support in tests is incorrect             |         |       |  3:18 |   6.2 |
| Tests failing with filesystem errors                      |         |       |  2:10 |   4.1 |
| Remove uses of mock configuration factory                 |         |       |  0:54 |   1.7 |
| Add continuous builds to C++ reference product            |         |       |  2:13 |   4.2 |
| Add continuous builds to C# reference product             |         |       |  1:50 |   3.4 |
| Remove ODB support from Dogen                             |         |       |  0:45 |   1.4 |
| Model significant relations at a higher level             |         |       |  1:05 |   2.0 |
| Create a mock configuration builder                       |         |       |  1:58 |   3.7 |
| Enable CodeQL                                             |         |       |  0:21 |   0.7 |
| Change namespaces note implementation in PlantUML         |         |       |  1:48 |   3.4 |
| Consider using a different layout engine in PlantUML      |         |       |  1:31 |   2.9 |
...
| Warning on OSX build                                      |         |       |  2:23 |   4.5 |
| Add PlantUML relationships to diagrams                    |         |       | 11:05 |  20.8 |
| Use clang format to format the code base                  |         |       |  0:58 |   1.8 |
| Investigate nightly issues                                |         |       |  0:15 |   0.5 |
| Create a nightly github workflow                          |         |       |  0:27 |   0.8 |
| Code coverage in CDash has disappeared                    |         |       |  0:14 |   0.4 |
#+end:
...
*** STARTED Investigate nightly issues                                :story:
    :LOGBOOK:
...
*** STARTED Code coverage in CDash has disappeared                    :story:
    :LOGBOOK:
