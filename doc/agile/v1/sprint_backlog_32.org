...
#+CAPTION: Clock summary at [2022-12-29 Thu 16:03]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *78:00* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 78:00   |       |       | 100.0 |
| Active                                                    |         | 78:00 |       | 100.0 |
| Edit release notes for previous sprint                    |         |       | 10:13 |  13.1 |
| Create a demo and presentation for previous sprint        |         |       |  2:06 |   2.7 |
| Update boost to latest in vcpg                            |         |       |  0:20 |   0.4 |
| Improve diffing output in tests                           |         |       |  0:19 |   0.4 |
| Sprint and product backlog grooming                       |         |       |  6:10 |   7.9 |
| Nightly builds are failing due to missing environment var |         |       |  1:07 |   1.4 |
| Remove deprecated uses of boost bind                      |         |       |  0:09 |   0.2 |
| Full generation support in tests is incorrect             |         |       |  3:18 |   4.2 |
| Tests failing with filesystem errors                      |         |       |  2:10 |   2.8 |
| Remove uses of mock configuration factory                 |         |       |  0:54 |   1.2 |
| Add continuous builds to C++ reference product            |         |       |  2:13 |   2.8 |
...
| Create a mock configuration builder                       |         |       |  1:58 |   2.5 |
| Enable CodeQL                                             |         |       |  0:21 |   0.4 |
| Change namespaces note implementation in PlantUML         |         |       |  1:48 |   2.3 |
...
| Gitter notifications for builds are not showing up        |         |       |  2:07 |   2.7 |
| Create a nightly github workflow                          |         |       |  5:39 |   7.2 |
| Run nightlies only when there are changes                 |         |       |  0:09 |   0.2 |
| Nightly builds are taking too long                        |         |       |  5:04 |   6.5 |
| Add support for UML profiles and XMI                      |         |       |  0:11 |   0.2 |
| Ignore vcpkg path length warning                          |         |       |  0:12 |   0.3 |
| Windows package is broken                                 |         |       |  0:20 |   0.4 |
| Warning on OSX build                                      |         |       |  2:23 |   3.1 |
| Use clang format to format the code base                  |         |       |  0:58 |   1.2 |
| Add PlantUML relationships to diagrams                    |         |       | 17:19 |  22.2 |
| Configuration as stereotype causes noise                  |         |       |  2:09 |   2.8 |
...
| Remove Dia and JSON support from Dogen                    |         |       |  0:14 |   0.3 |
#+end:
...
*** STARTED Remove Dia and JSON support from Dogen                    :story:
    :LOGBOOK:
    CLOCK: [2022-12-29 Thu 16:04]
