...
#+CAPTION: Clock summary at [2022-09-30 Fri 09:58]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *35:49* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 35:49   |       |       | 100.0 |
| Active                                                    |         | 35:49 |       | 100.0 |
| Edit release notes for previous sprint                    |         |       | 10:13 |  28.5 |
| Create a demo and presentation for previous sprint        |         |       |  2:06 |   5.9 |
| Update boost to latest in vcpg                            |         |       |  0:20 |   0.9 |
| Improve diffing output in tests                           |         |       |  0:19 |   0.9 |
| Sprint and product backlog grooming                       |         |       |  2:50 |   7.9 |
| Nightly builds are failing due to missing environment var |         |       |  1:07 |   3.1 |
| Remove deprecated uses of boost bind                      |         |       |  0:09 |   0.4 |
| Full generation support in tests is incorrect             |         |       |  3:18 |   9.2 |
| Tests failing with filesystem errors                      |         |       |  2:10 |   6.0 |
| Remove uses of mock configuration factory                 |         |       |  0:54 |   2.5 |
| Add continuous builds to C++ reference product            |         |       |  2:13 |   6.2 |
| Add continuous builds to C# reference product             |         |       |  1:50 |   5.1 |
| Remove ODB support from Dogen                             |         |       |  0:45 |   2.1 |
| Model significant relations at a higher level             |         |       |  1:05 |   3.0 |
| Create a mock configuration builder                       |         |       |  1:58 |   5.5 |
| Enable CodeQL                                             |         |       |  0:21 |   1.0 |
| Gitter notifications for builds are not showing up        |         |       |  0:38 |   1.8 |
| Windows package is broken                                 |         |       |  0:20 |   0.9 |
| Warning on OSX build                                      |         |       |  1:59 |   5.5 |
| Add PlantUML relationships to diagrams                    |         |       |  1:02 |   2.9 |
| Ignore vcpkg path length warning                          |         |       |  0:12 |   0.6 |
#+end:
