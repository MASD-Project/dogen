...
#+CAPTION: Clock summary at [2022-10-01 Sat 12:10]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *41:28* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 41:28   |       |       | 100.0 |
| Active                                                    |         | 41:28 |       | 100.0 |
| Edit release notes for previous sprint                    |         |       | 10:13 |  24.6 |
| Create a demo and presentation for previous sprint        |         |       |  2:06 |   5.1 |
| Update boost to latest in vcpg                            |         |       |  0:20 |   0.8 |
| Improve diffing output in tests                           |         |       |  0:19 |   0.8 |
| Sprint and product backlog grooming                       |         |       |  2:55 |   7.0 |
| Nightly builds are failing due to missing environment var |         |       |  1:07 |   2.7 |
| Remove deprecated uses of boost bind                      |         |       |  0:09 |   0.4 |
| Full generation support in tests is incorrect             |         |       |  3:18 |   8.0 |
| Tests failing with filesystem errors                      |         |       |  2:10 |   5.2 |
| Remove uses of mock configuration factory                 |         |       |  0:54 |   2.2 |
| Add continuous builds to C++ reference product            |         |       |  2:13 |   5.3 |
| Add continuous builds to C# reference product             |         |       |  1:50 |   4.4 |
| Remove ODB support from Dogen                             |         |       |  0:45 |   1.8 |
| Model significant relations at a higher level             |         |       |  1:05 |   2.6 |
| Create a mock configuration builder                       |         |       |  1:58 |   4.7 |
...
| Warning on OSX build                                      |         |       |  2:23 |   5.7 |
| Add PlantUML relationships to diagrams                    |         |       |  6:12 |  15.0 |
#+end:
