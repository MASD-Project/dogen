...
#+CAPTION: Clock summary at [2022-09-16 Fri 11:07]
| <75>                                               |         |       |      |       |
| Headline                                           | Time    |       |      |     % |
|----------------------------------------------------+---------+-------+------+-------|
| *Total time*                                       | *10:46* |       |      | 100.0 |
|----------------------------------------------------+---------+-------+------+-------|
| Stories                                            | 10:46   |       |      | 100.0 |
| Active                                             |         | 10:46 |      | 100.0 |
| Edit release notes for previous sprint             |         |       | 9:44 |  90.4 |
| Create a demo and presentation for previous sprint |         |       | 0:10 |   1.5 |
| Sprint and product backlog grooming                |         |       | 0:52 |   8.0 |
#+end:
...
*** Nightly builds are failing due to missing variable                :story:
