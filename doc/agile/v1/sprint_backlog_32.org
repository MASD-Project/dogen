...
#+CAPTION: Clock summary at [2022-09-20 Tue 19:05]
| <75>                                                      |         |       |      |       |
| Headline                                                  | Time    |       |      |     % |
|-----------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                              | *19:30* |       |      | 100.0 |
|-----------------------------------------------------------+---------+-------+------+-------|
| Stories                                                   | 19:30   |       |      | 100.0 |
| Active                                                    |         | 19:30 |      | 100.0 |
| Edit release notes for previous sprint                    |         |       | 9:44 |  49.9 |
| Create a demo and presentation for previous sprint        |         |       | 2:06 |  10.8 |
| Update boost to latest in vcpg                            |         |       | 0:20 |   1.7 |
| Improve diffing output in tests                           |         |       | 0:19 |   1.6 |
| Sprint and product backlog grooming                       |         |       | 1:15 |   6.4 |
| Nightly builds are failing due to missing environment var |         |       | 1:07 |   5.7 |
| Remove deprecated uses of boost bind                      |         |       | 0:09 |   0.8 |
| Gitter notifications for builds are not showing up        |         |       | 0:38 |   3.2 |
| Windows package is broken                                 |         |       | 0:20 |   1.7 |
| Full generation support in tests is incorrect             |         |       | 1:39 |   8.5 |
| Create a mock configuration builder                       |         |       | 1:49 |   9.3 |
