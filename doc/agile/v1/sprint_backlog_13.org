...
#+CAPTION: Clock summary at [2019-03-15 Fri 17:45]
| <75>                                                     |         |       |      |       |
| Headline                                                 | Time    |       |      |     % |
|----------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                             | *39:20* |       |      | 100.0 |
|----------------------------------------------------------+---------+-------+------+-------|
| Stories                                                  | 39:20   |       |      | 100.0 |
| Active                                                   |         | 39:20 |      | 100.0 |
| Edit release notes for previous sprint                   |         |       | 2:22 |   6.0 |
| Sprint and product backlog grooming                      |         |       | 4:41 |  11.9 |
| Create a video demo for the sprint's features            |         |       | 3:47 |   9.6 |
| Make projects directory env optional                     |         |       | 0:10 |   0.4 |
| Clang-cl builds are failing due to memory leak reporting |         |       | 0:45 |   1.9 |
| Add tests for tracing, reporting and diffing             |         |       | 5:46 |  14.7 |
| Delete extra files appears broken at present             |         |       | 6:26 |  16.4 |
| Empty directories should be deleted                      |         |       | 5:37 |  14.3 |
| Changes to stitch templates are not reported correctly   |         |       | 1:09 |   2.9 |
| Code generation of tests for dogen models                |         |       | 8:37 |  21.9 |
