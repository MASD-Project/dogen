...
#+CAPTION: Clock summary at [2019-03-14 Thu 19:00]
| <75>                                                     |         |       |      |       |
| Headline                                                 | Time    |       |      |     % |
|----------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                  | 31:46   |       |      | 100.0 |
| Active                                                   |         | 31:46 |      | 100.0 |
| Edit release notes for previous sprint                   |         |       | 2:22 |   7.5 |
| Sprint and product backlog grooming                      |         |       | 2:50 |   8.9 |
| Create a video demo for the sprint's features            |         |       | 3:47 |  11.9 |
| Make projects directory env optional                     |         |       | 0:10 |   0.5 |
| Clang-cl builds are failing due to memory leak reporting |         |       | 0:45 |   2.4 |
| Add tests for tracing, reporting and diffing             |         |       | 5:46 |  18.2 |
| Delete extra files appears broken at present             |         |       | 6:26 |  20.3 |
| Empty directories should be deleted                      |         |       | 5:37 |  17.7 |
| Code generation of tests for dogen models                |         |       | 4:03 |  12.7 |
...
- if an object has no attributes, we need to disable testing for it.
