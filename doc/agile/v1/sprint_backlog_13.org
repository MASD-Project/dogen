...
#+CAPTION: Clock summary at [2019-03-14 Thu 09:10]
| <75>                                                     |         |       |      |       |
| Headline                                                 | Time    |       |      |     % |
|----------------------------------------------------------+---------+-------+------+-------|
...
| Sprint and product backlog grooming                      |         |       | 2:16 |   8.4 |
| Create a video demo for the sprint's features            |         |       | 3:47 |  14.0 |
| Make projects directory env optional                     |         |       | 0:10 |   0.6 |
| Clang-cl builds are failing due to memory leak reporting |         |       | 0:45 |   2.8 |
| Add tests for tracing, reporting and diffing             |         |       | 5:46 |  21.4 |
| Delete extra files appears broken at present             |         |       | 6:26 |  23.8 |
| Code generation of tests for dogen models                |         |       | 3:33 |  13.1 |
| Empty directories should be deleted                      |         |       | 1:55 |   7.1 |
...
- update extraction_properties in coding model.
