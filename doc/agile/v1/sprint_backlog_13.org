...
#+CAPTION: Clock summary at [2019-03-18 Mon 13:05]
| <75>                                                     |         |       |       |       |
| Headline                                                 | Time    |       |       |     % |
|----------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                  | 47:22   |       |       | 100.0 |
| Active                                                   |         | 47:22 |       | 100.0 |
| Edit release notes for previous sprint                   |         |       |  2:22 |   5.0 |
| Sprint and product backlog grooming                      |         |       |  5:21 |  11.3 |
| Create a video demo for the sprint's features            |         |       |  3:47 |   8.0 |
| Make projects directory env optional                     |         |       |  0:10 |   0.4 |
| Clang-cl builds are failing due to memory leak reporting |         |       |  0:45 |   1.6 |
| Add tests for tracing, reporting and diffing             |         |       |  5:46 |  12.2 |
| Delete extra files appears broken at present             |         |       |  6:26 |  13.6 |
| Empty directories should be deleted                      |         |       |  5:37 |  11.9 |
| Changes to stitch templates are not reported correctly   |         |       |  1:09 |   2.4 |
| Code generation of tests for dogen models                |         |       | 13:57 |  29.5 |
| Orchestration test is broken on Windows                  |         |       |  2:02 |   4.3 |
