...
#+CAPTION: Clock summary at [2019-03-12 Tue 18:39]
| <75>                                                     |         |       |      |       |
| Headline                                                 | Time    |       |      |     % |
|----------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                             | *15:53* |       |      | 100.0 |
|----------------------------------------------------------+---------+-------+------+-------|
| Stories                                                  | 15:53   |       |      | 100.0 |
| Active                                                   |         | 15:53 |      | 100.0 |
| Edit release notes for previous sprint                   |         |       | 2:22 |  14.9 |
| Sprint and product backlog grooming                      |         |       | 2:16 |  14.3 |
| Create a video demo for the sprint's features            |         |       | 3:47 |  23.8 |
| Make projects directory env optional                     |         |       | 0:10 |   1.0 |
| Clang-cl builds are failing due to memory leak reporting |         |       | 0:45 |   4.7 |
| Code generation of tests for dogen models                |         |       | 3:33 |  22.4 |
| Delete extra files appears broken at present             |         |       | 0:34 |   3.6 |
| Add tests for tracing, reporting and logging             |         |       | 2:26 |  15.3 |
...
*** STARTED Delete extra files appears broken at present              :story:
    :LOGBOOK:
...
*** STARTED Add tests for tracing, reporting and logging              :story:
