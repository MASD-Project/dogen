...
#+CAPTION: Clock summary at [2019-03-16 Sat 07:30]
| <75>                                                     |         |       |       |       |
| Headline                                                 | Time    |       |       |     % |
|----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                             | *41:16* |       |       | 100.0 |
|----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                  | 41:16   |       |       | 100.0 |
| Active                                                   |         | 41:16 |       | 100.0 |
| Edit release notes for previous sprint                   |         |       |  2:22 |   5.7 |
| Sprint and product backlog grooming                      |         |       |  4:41 |  11.3 |
| Create a video demo for the sprint's features            |         |       |  3:47 |   9.2 |
| Make projects directory env optional                     |         |       |  0:10 |   0.4 |
| Clang-cl builds are failing due to memory leak reporting |         |       |  0:45 |   1.8 |
| Add tests for tracing, reporting and diffing             |         |       |  5:46 |  14.0 |
| Delete extra files appears broken at present             |         |       |  6:26 |  15.6 |
| Empty directories should be deleted                      |         |       |  5:37 |  13.6 |
| Changes to stitch templates are not reported correctly   |         |       |  1:09 |   2.8 |
| Code generation of tests for dogen models                |         |       | 10:33 |  25.6 |
...
We could just have these two as simple strings.
