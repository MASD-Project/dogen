...
#+CAPTION: Clock summary at [2019-03-19 Tue 11:22]
| <75>                                                     |         |       |       |       |
| Headline                                                 | Time    |       |       |     % |
|----------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                  | 56:20   |       |       | 100.0 |
| Active                                                   |         | 56:20 |       | 100.0 |
| Edit release notes for previous sprint                   |         |       |  2:22 |   4.2 |
| Sprint and product backlog grooming                      |         |       |  6:43 |  11.9 |
| Create a video demo for the sprint's features            |         |       |  3:47 |   6.7 |
| Make projects directory env optional                     |         |       |  0:10 |   0.3 |
| Clang-cl builds are failing due to memory leak reporting |         |       |  0:45 |   1.3 |
| Add tests for tracing, reporting and diffing             |         |       |  5:46 |  10.2 |
| Delete extra files appears broken at present             |         |       |  6:26 |  11.4 |
| Empty directories should be deleted                      |         |       |  5:37 |  10.0 |
| Changes to stitch templates are not reported correctly   |         |       |  1:09 |   2.0 |
| Orchestration test is broken on Windows                  |         |       |  2:40 |   4.7 |
| Code generation of tests for dogen models                |         |       | 20:55 |  37.1 |
