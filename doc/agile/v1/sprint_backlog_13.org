...
#+CAPTION: Clock summary at [2019-03-14 Thu 11:23]
| <75>                                                     |         |       |      |       |
| Headline                                                 | Time    |       |      |     % |
|----------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                             | *29:10* |       |      | 100.0 |
|----------------------------------------------------------+---------+-------+------+-------|
| Stories                                                  | 29:10   |       |      | 100.0 |
| Active                                                   |         | 29:10 |      | 100.0 |
| Edit release notes for previous sprint                   |         |       | 2:22 |   8.1 |
| Sprint and product backlog grooming                      |         |       | 2:16 |   7.8 |
| Create a video demo for the sprint's features            |         |       | 3:47 |  13.0 |
| Make projects directory env optional                     |         |       | 0:10 |   0.6 |
| Clang-cl builds are failing due to memory leak reporting |         |       | 0:45 |   2.6 |
| Add tests for tracing, reporting and diffing             |         |       | 5:46 |  19.8 |
| Delete extra files appears broken at present             |         |       | 6:26 |  22.1 |
| Code generation of tests for dogen models                |         |       | 3:33 |  12.2 |
| Empty directories should be deleted                      |         |       | 4:05 |  14.0 |
