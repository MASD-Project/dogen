...
#+CAPTION: Clock summary at [2019-03-14 Thu 07:20]
| <75>                                                     |         |       |      |       |
| Headline                                                 | Time    |       |      |     % |
|----------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                             | *25:54* |       |      | 100.0 |
|----------------------------------------------------------+---------+-------+------+-------|
| Stories                                                  | 25:54   |       |      | 100.0 |
| Active                                                   |         | 25:54 |      | 100.0 |
| Edit release notes for previous sprint                   |         |       | 2:22 |   9.1 |
| Sprint and product backlog grooming                      |         |       | 2:16 |   8.8 |
| Create a video demo for the sprint's features            |         |       | 3:47 |  14.6 |
| Make projects directory env optional                     |         |       | 0:10 |   0.6 |
| Clang-cl builds are failing due to memory leak reporting |         |       | 0:45 |   2.9 |
| Add tests for tracing, reporting and diffing             |         |       | 5:46 |  22.3 |
| Delete extra files appears broken at present             |         |       | 6:26 |  24.8 |
| Code generation of tests for dogen models                |         |       | 3:33 |  13.7 |
| Empty directories should be deleted                      |         |       | 0:49 |   3.2 |
