...
#+CAPTION: Clock summary at [2019-03-20 Wed 14:23]
| <75>                                                     |         |       |       |       |
| Headline                                                 | Time    |       |       |     % |
|----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                             | *65:58* |       |       | 100.0 |
|----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                  | 65:58   |       |       | 100.0 |
| Active                                                   |         | 65:58 |       | 100.0 |
| Edit release notes for previous sprint                   |         |       |  2:22 |   3.6 |
| Sprint and product backlog grooming                      |         |       |  7:46 |  11.8 |
| Create a video demo for the sprint's features            |         |       |  3:47 |   5.7 |
| Make projects directory env optional                     |         |       |  0:10 |   0.3 |
| Clang-cl builds are failing due to memory leak reporting |         |       |  0:45 |   1.1 |
| Add tests for tracing, reporting and diffing             |         |       |  5:46 |   8.7 |
| Delete extra files appears broken at present             |         |       |  6:26 |   9.8 |
| Empty directories should be deleted                      |         |       |  5:37 |   8.5 |
| Changes to stitch templates are not reported correctly   |         |       |  1:09 |   1.7 |
| Orchestration test is broken on Windows                  |         |       |  2:40 |   4.0 |
| Code generation of tests for dogen models                |         |       | 23:22 |  35.4 |
| Formatters have been incorrectly placed under extraction |         |       |  0:23 |   0.6 |
| Modeline groups as meta-model elements                   |         |       |  5:45 |   8.7 |
