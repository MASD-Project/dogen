...
#+CAPTION: Clock summary at [2019-03-17 Sun 18:04]
| <75>                                                     |         |       |       |       |
| Headline                                                 | Time    |       |       |     % |
|----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                             | *43:43* |       |       | 100.0 |
|----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                  | 43:43   |       |       | 100.0 |
| Active                                                   |         | 43:43 |       | 100.0 |
| Edit release notes for previous sprint                   |         |       |  2:22 |   5.4 |
| Sprint and product backlog grooming                      |         |       |  5:13 |  11.9 |
| Create a video demo for the sprint's features            |         |       |  3:47 |   8.7 |
| Make projects directory env optional                     |         |       |  0:10 |   0.4 |
| Clang-cl builds are failing due to memory leak reporting |         |       |  0:45 |   1.7 |
| Add tests for tracing, reporting and diffing             |         |       |  5:46 |  13.2 |
| Delete extra files appears broken at present             |         |       |  6:26 |  14.7 |
| Empty directories should be deleted                      |         |       |  5:37 |  12.8 |
| Changes to stitch templates are not reported correctly   |         |       |  1:09 |   2.6 |
| Code generation of tests for dogen models                |         |       | 12:28 |  28.5 |
