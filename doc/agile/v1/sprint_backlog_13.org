...
#+CAPTION: Clock summary at [2019-03-19 Tue 09:53]
| <75>                                                     |         |       |       |       |
| Headline                                                 | Time    |       |       |     % |
|----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                             | *54:54* |       |       | 100.0 |
|----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                  | 54:54   |       |       | 100.0 |
| Active                                                   |         | 54:54 |       | 100.0 |
| Edit release notes for previous sprint                   |         |       |  2:22 |   4.3 |
| Sprint and product backlog grooming                      |         |       |  6:43 |  12.2 |
| Create a video demo for the sprint's features            |         |       |  3:47 |   6.9 |
| Make projects directory env optional                     |         |       |  0:10 |   0.3 |
| Clang-cl builds are failing due to memory leak reporting |         |       |  0:45 |   1.4 |
| Add tests for tracing, reporting and diffing             |         |       |  5:46 |  10.5 |
| Delete extra files appears broken at present             |         |       |  6:26 |  11.7 |
| Empty directories should be deleted                      |         |       |  5:37 |  10.2 |
| Changes to stitch templates are not reported correctly   |         |       |  1:09 |   2.1 |
| Orchestration test is broken on Windows                  |         |       |  2:40 |   4.9 |
| Code generation of tests for dogen models                |         |       | 19:29 |  35.5 |
