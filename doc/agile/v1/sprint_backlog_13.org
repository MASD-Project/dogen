...
#+CAPTION: Clock summary at [2019-03-21 Thu 14:54]
| <75>                                                     |         |       |       |       |
| Headline                                                 | Time    |       |       |     % |
|----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                             | *73:08* |       |       | 100.0 |
|----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                  | 73:08   |       |       | 100.0 |
| Active                                                   |         | 73:08 |       | 100.0 |
| Edit release notes for previous sprint                   |         |       |  2:22 |   3.2 |
| Sprint and product backlog grooming                      |         |       |  9:57 |  13.6 |
| Create a video demo for the sprint's features            |         |       |  3:47 |   5.2 |
| Make projects directory env optional                     |         |       |  0:10 |   0.2 |
| Clang-cl builds are failing due to memory leak reporting |         |       |  0:45 |   1.0 |
| Add tests for tracing, reporting and diffing             |         |       |  5:46 |   7.9 |
| Delete extra files appears broken at present             |         |       |  6:26 |   8.8 |
| Empty directories should be deleted                      |         |       |  5:37 |   7.7 |
| Changes to stitch templates are not reported correctly   |         |       |  1:09 |   1.6 |
| Orchestration test is broken on Windows                  |         |       |  2:40 |   3.6 |
| Code generation of tests for dogen models                |         |       | 23:22 |  32.0 |
| Formatters have been incorrectly placed under extraction |         |       |  0:23 |   0.5 |
| Promote extraction entities to meta-model elements       |         |       | 10:44 |  14.7 |
