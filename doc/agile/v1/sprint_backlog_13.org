...
#+CAPTION: Clock summary at [2019-03-18 Mon 19:00]
| <75>                                                     |         |       |       |       |
| Headline                                                 | Time    |       |       |     % |
|----------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                  | 51:42   |       |       | 100.0 |
| Active                                                   |         | 51:42 |       | 100.0 |
| Edit release notes for previous sprint                   |         |       |  2:22 |   4.6 |
| Sprint and product backlog grooming                      |         |       |  5:21 |  10.3 |
| Create a video demo for the sprint's features            |         |       |  3:47 |   7.3 |
| Make projects directory env optional                     |         |       |  0:10 |   0.3 |
| Clang-cl builds are failing due to memory leak reporting |         |       |  0:45 |   1.5 |
| Add tests for tracing, reporting and diffing             |         |       |  5:46 |  11.2 |
| Delete extra files appears broken at present             |         |       |  6:26 |  12.4 |
| Empty directories should be deleted                      |         |       |  5:37 |  10.9 |
| Changes to stitch templates are not reported correctly   |         |       |  1:09 |   2.2 |
| Orchestration test is broken on Windows                  |         |       |  2:40 |   5.2 |
| Code generation of tests for dogen models                |         |       | 17:39 |  34.1 |
