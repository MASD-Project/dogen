...
#+CAPTION: Clock summary at [2019-03-19 Tue 09:03]
| <75>                                                     |         |       |       |       |
| Headline                                                 | Time    |       |       |     % |
|----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                             | *54:07* |       |       | 100.0 |
|----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                  | 54:07   |       |       | 100.0 |
| Active                                                   |         | 54:07 |       | 100.0 |
| Edit release notes for previous sprint                   |         |       |  2:22 |   4.4 |
| Sprint and product backlog grooming                      |         |       |  6:43 |  12.4 |
| Create a video demo for the sprint's features            |         |       |  3:47 |   7.0 |
| Make projects directory env optional                     |         |       |  0:10 |   0.3 |
| Clang-cl builds are failing due to memory leak reporting |         |       |  0:45 |   1.4 |
| Add tests for tracing, reporting and diffing             |         |       |  5:46 |  10.7 |
| Delete extra files appears broken at present             |         |       |  6:26 |  11.9 |
| Empty directories should be deleted                      |         |       |  5:37 |  10.4 |
| Changes to stitch templates are not reported correctly   |         |       |  1:09 |   2.1 |
| Orchestration test is broken on Windows                  |         |       |  2:40 |   4.9 |
| Code generation of tests for dogen models                |         |       | 18:42 |  34.6 |
