...
#+CAPTION: Clock summary at [2019-03-11 Mon 18:46]
| <75>                                                     |        |      |      |       |
| Headline                                                 | Time   |      |      |     % |
|----------------------------------------------------------+--------+------+------+-------|
| *Total time*                                             | *8:35* |      |      | 100.0 |
|----------------------------------------------------------+--------+------+------+-------|
| Stories                                                  | 8:35   |      |      | 100.0 |
| Active                                                   |        | 8:35 |      | 100.0 |
| Edit release notes for previous sprint                   |        |      | 1:51 |  21.6 |
| Sprint and product backlog grooming                      |        |      | 1:42 |  19.8 |
| Create a video demo for the sprint's features            |        |      | 3:47 |  44.1 |
| Clang-cl builds are failing due to memory leak reporting |        |      | 0:45 |   8.7 |
| Code generation of tests for dogen models                |        |      | 0:30 |   5.8 |
