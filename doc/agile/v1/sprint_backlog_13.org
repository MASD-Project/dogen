...
#+CAPTION: Clock summary at [2019-03-18 Mon 13:45]
| <75>                                                     |         |       |       |       |
| Headline                                                 | Time    |       |       |     % |
|----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                             | *48:00* |       |       | 100.0 |
|----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                  | 48:00   |       |       | 100.0 |
| Active                                                   |         | 48:00 |       | 100.0 |
| Edit release notes for previous sprint                   |         |       |  2:22 |   4.9 |
| Sprint and product backlog grooming                      |         |       |  5:21 |  11.1 |
| Create a video demo for the sprint's features            |         |       |  3:47 |   7.9 |
| Make projects directory env optional                     |         |       |  0:10 |   0.3 |
| Clang-cl builds are failing due to memory leak reporting |         |       |  0:45 |   1.6 |
| Add tests for tracing, reporting and diffing             |         |       |  5:46 |  12.0 |
| Delete extra files appears broken at present             |         |       |  6:26 |  13.4 |
| Empty directories should be deleted                      |         |       |  5:37 |  11.7 |
| Changes to stitch templates are not reported correctly   |         |       |  1:09 |   2.4 |
| Orchestration test is broken on Windows                  |         |       |  2:40 |   5.6 |
| Code generation of tests for dogen models                |         |       | 13:57 |  29.1 |
