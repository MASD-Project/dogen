...
#+CAPTION: Clock summary at [2019-03-13 Wed 10:04]
| <75>                                                     |         |       |      |       |
| Headline                                                 | Time    |       |      |     % |
|----------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                  | 18:33   |       |      | 100.0 |
| Active                                                   |         | 18:33 |      | 100.0 |
| Edit release notes for previous sprint                   |         |       | 2:22 |  12.8 |
| Sprint and product backlog grooming                      |         |       | 2:16 |  12.2 |
| Create a video demo for the sprint's features            |         |       | 3:47 |  20.4 |
| Make projects directory env optional                     |         |       | 0:10 |   0.9 |
| Clang-cl builds are failing due to memory leak reporting |         |       | 0:45 |   4.0 |
| Add tests for tracing, reporting and diffing             |         |       | 5:06 |  27.5 |
| Code generation of tests for dogen models                |         |       | 3:33 |  19.1 |
| Delete extra files appears broken at present             |         |       | 0:34 |   3.1 |
...
*** Extraction model name is the simple name                          :story:
