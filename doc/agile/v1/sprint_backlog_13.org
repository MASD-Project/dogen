...
#+CAPTION: Clock summary at [2019-03-14 Thu 15:52]
| <75>                                                     |         |       |      |       |
| Headline                                                 | Time    |       |      |     % |
|----------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                             | *31:16* |       |      | 100.0 |
|----------------------------------------------------------+---------+-------+------+-------|
| Stories                                                  | 31:16   |       |      | 100.0 |
| Active                                                   |         | 31:16 |      | 100.0 |
| Edit release notes for previous sprint                   |         |       | 2:22 |   7.6 |
| Sprint and product backlog grooming                      |         |       | 2:50 |   9.1 |
| Create a video demo for the sprint's features            |         |       | 3:47 |  12.1 |
| Make projects directory env optional                     |         |       | 0:10 |   0.5 |
| Clang-cl builds are failing due to memory leak reporting |         |       | 0:45 |   2.4 |
| Add tests for tracing, reporting and diffing             |         |       | 5:46 |  18.4 |
| Delete extra files appears broken at present             |         |       | 6:26 |  20.6 |
| Empty directories should be deleted                      |         |       | 5:37 |  18.0 |
| Code generation of tests for dogen models                |         |       | 3:33 |  11.4 |
