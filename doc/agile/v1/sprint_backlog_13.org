...
#+CAPTION: Clock summary at [2019-03-20 Wed 18:10]
| <75>                                                     |         |       |       |       |
| Headline                                                 | Time    |       |       |     % |
|----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                             | *67:32* |       |       | 100.0 |
|----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                  | 67:32   |       |       | 100.0 |
| Active                                                   |         | 67:32 |       | 100.0 |
| Edit release notes for previous sprint                   |         |       |  2:22 |   3.5 |
| Sprint and product backlog grooming                      |         |       |  7:46 |  11.5 |
| Create a video demo for the sprint's features            |         |       |  3:47 |   5.6 |
| Make projects directory env optional                     |         |       |  0:10 |   0.2 |
| Clang-cl builds are failing due to memory leak reporting |         |       |  0:45 |   1.1 |
| Add tests for tracing, reporting and diffing             |         |       |  5:46 |   8.5 |
| Delete extra files appears broken at present             |         |       |  6:26 |   9.5 |
| Empty directories should be deleted                      |         |       |  5:37 |   8.3 |
| Changes to stitch templates are not reported correctly   |         |       |  1:09 |   1.7 |
| Orchestration test is broken on Windows                  |         |       |  2:40 |   3.9 |
| Code generation of tests for dogen models                |         |       | 23:22 |  34.6 |
| Formatters have been incorrectly placed under extraction |         |       |  0:23 |   0.6 |
| Modeline groups as meta-model elements                   |         |       |  7:19 |  10.8 |
...
*** STARTED Modeline groups as meta-model elements                    :story:
    :LOGBOOK:
...
to make sure that all functionality is available on both.
