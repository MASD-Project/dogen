...
#+CAPTION: Clock summary at [2019-03-19 Tue 15:25]
| <75>                                                     |         |       |       |       |
| Headline                                                 | Time    |       |       |     % |
|----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                             | *58:52* |       |       | 100.0 |
|----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                  | 58:52   |       |       | 100.0 |
| Active                                                   |         | 58:52 |       | 100.0 |
| Edit release notes for previous sprint                   |         |       |  2:22 |   4.0 |
| Sprint and product backlog grooming                      |         |       |  6:43 |  11.4 |
| Create a video demo for the sprint's features            |         |       |  3:47 |   6.4 |
| Make projects directory env optional                     |         |       |  0:10 |   0.3 |
| Clang-cl builds are failing due to memory leak reporting |         |       |  0:45 |   1.3 |
| Add tests for tracing, reporting and diffing             |         |       |  5:46 |   9.8 |
| Delete extra files appears broken at present             |         |       |  6:26 |  10.9 |
| Empty directories should be deleted                      |         |       |  5:37 |   9.5 |
| Changes to stitch templates are not reported correctly   |         |       |  1:09 |   2.0 |
| Orchestration test is broken on Windows                  |         |       |  2:40 |   4.5 |
| Code generation of tests for dogen models                |         |       | 23:08 |  39.3 |
| Formatters have been incorrectly placed under extraction |         |       |  0:19 |   0.5 |
...
*** STARTED Formatters have been incorrectly placed under extraction  :story:
    :LOGBOOK:
