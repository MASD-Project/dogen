...
#+CAPTION: Clock summary at [2019-03-18 Mon 15:10]
| <75>                                                     |         |       |       |       |
| Headline                                                 | Time    |       |       |     % |
|----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                             | *49:23* |       |       | 100.0 |
|----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                  | 49:23   |       |       | 100.0 |
| Active                                                   |         | 49:23 |       | 100.0 |
| Edit release notes for previous sprint                   |         |       |  2:22 |   4.8 |
| Sprint and product backlog grooming                      |         |       |  5:21 |  10.8 |
| Create a video demo for the sprint's features            |         |       |  3:47 |   7.7 |
| Make projects directory env optional                     |         |       |  0:10 |   0.3 |
| Clang-cl builds are failing due to memory leak reporting |         |       |  0:45 |   1.5 |
| Add tests for tracing, reporting and diffing             |         |       |  5:46 |  11.7 |
| Delete extra files appears broken at present             |         |       |  6:26 |  13.0 |
| Empty directories should be deleted                      |         |       |  5:37 |  11.4 |
| Changes to stitch templates are not reported correctly   |         |       |  1:09 |   2.3 |
| Orchestration test is broken on Windows                  |         |       |  2:40 |   5.4 |
| Code generation of tests for dogen models                |         |       | 15:20 |  31.0 |
