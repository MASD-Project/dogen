...
#+CAPTION: Clock summary at [2019-03-12 Tue 11:55]
| <75>                                                     |         |       |      |       |
| Headline                                                 | Time    |       |      |     % |
|----------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                  | 12:45   |       |      | 100.0 |
| Active                                                   |         | 12:45 |      | 100.0 |
| Edit release notes for previous sprint                   |         |       | 2:22 |  18.6 |
| Sprint and product backlog grooming                      |         |       | 2:16 |  17.8 |
| Create a video demo for the sprint's features            |         |       | 3:47 |  29.7 |
| Make projects directory env optional                     |         |       | 0:10 |   1.3 |
| Clang-cl builds are failing due to memory leak reporting |         |       | 0:45 |   5.9 |
| Code generation of tests for dogen models                |         |       | 3:25 |  26.8 |
...
*** STARTED Clang-cl builds are failing due to memory leak reporting  :story:
    :LOGBOOK:
...
*** Delete extra files appears broken at present                      :story:
