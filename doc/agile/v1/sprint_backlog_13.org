...
#+CAPTION: Clock summary at [2019-03-17 Sun 07:25]
| <75>                                                     |         |       |       |       |
| Headline                                                 | Time    |       |       |     % |
|----------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                  | 42:42   |       |       | 100.0 |
| Active                                                   |         | 42:42 |       | 100.0 |
| Edit release notes for previous sprint                   |         |       |  2:22 |   5.5 |
| Sprint and product backlog grooming                      |         |       |  5:13 |  12.2 |
| Create a video demo for the sprint's features            |         |       |  3:47 |   8.9 |
| Make projects directory env optional                     |         |       |  0:10 |   0.4 |
| Clang-cl builds are failing due to memory leak reporting |         |       |  0:45 |   1.8 |
| Add tests for tracing, reporting and diffing             |         |       |  5:46 |  13.5 |
| Delete extra files appears broken at present             |         |       |  6:26 |  15.1 |
| Empty directories should be deleted                      |         |       |  5:37 |  13.2 |
| Changes to stitch templates are not reported correctly   |         |       |  1:09 |   2.7 |
| Code generation of tests for dogen models                |         |       | 11:27 |  26.8 |
