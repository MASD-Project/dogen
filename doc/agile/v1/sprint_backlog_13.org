...
#+CAPTION: Clock summary at [2019-03-18 Mon 10:44]
| <75>                                                     |         |       |       |       |
| Headline                                                 | Time    |       |       |     % |
|----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                             | *45:24* |       |       | 100.0 |
|----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                  | 45:24   |       |       | 100.0 |
| Active                                                   |         | 45:24 |       | 100.0 |
| Edit release notes for previous sprint                   |         |       |  2:22 |   5.2 |
| Sprint and product backlog grooming                      |         |       |  5:21 |  11.8 |
| Create a video demo for the sprint's features            |         |       |  3:47 |   8.3 |
| Make projects directory env optional                     |         |       |  0:10 |   0.4 |
| Clang-cl builds are failing due to memory leak reporting |         |       |  0:45 |   1.7 |
| Add tests for tracing, reporting and diffing             |         |       |  5:46 |  12.7 |
| Delete extra files appears broken at present             |         |       |  6:26 |  14.2 |
| Empty directories should be deleted                      |         |       |  5:37 |  12.4 |
| Changes to stitch templates are not reported correctly   |         |       |  1:09 |   2.5 |
| Code generation of tests for dogen models                |         |       | 12:28 |  27.5 |
| Orchestration test is broken on Windows                  |         |       |  1:33 |   3.4 |
...
*** STARTED Orchestration test is broken on Windows                   :story:
    :LOGBOOK:
...
all generated files will get rewritten with windows line endings. We
...
generation tests are green, implying we do not see any diffs.
