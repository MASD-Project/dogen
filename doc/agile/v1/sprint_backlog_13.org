...
#+CAPTION: Clock summary at [2019-03-16 Sat 21:30]
| <75>                                                     |         |       |       |       |
| Headline                                                 | Time    |       |       |     % |
|----------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                  | 42:12   |       |       | 100.0 |
| Active                                                   |         | 42:12 |       | 100.0 |
| Edit release notes for previous sprint                   |         |       |  2:22 |   5.6 |
| Sprint and product backlog grooming                      |         |       |  5:13 |  12.4 |
| Create a video demo for the sprint's features            |         |       |  3:47 |   9.0 |
| Make projects directory env optional                     |         |       |  0:10 |   0.4 |
| Clang-cl builds are failing due to memory leak reporting |         |       |  0:45 |   1.8 |
| Add tests for tracing, reporting and diffing             |         |       |  5:46 |  13.7 |
| Delete extra files appears broken at present             |         |       |  6:26 |  15.2 |
| Empty directories should be deleted                      |         |       |  5:37 |  13.3 |
| Changes to stitch templates are not reported correctly   |         |       |  1:09 |   2.7 |
| Code generation of tests for dogen models                |         |       | 10:57 |  25.9 |
