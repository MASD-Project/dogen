...
#+CAPTION: Clock summary at [2019-05-12 Sun 09:29]
| <75>                                                       |         |       |       |       |
| Headline                                                   | Time    |       |       |     % |
|------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                               | *39:49* |       |       | 100.0 |
|------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                    | 39:49   |       |       | 100.0 |
| Active                                                     |         | 39:49 |       | 100.0 |
| Edit release notes for previous sprint                     |         |       |  2:41 |   6.7 |
| Create a video demo for the previous sprint's features     |         |       |  2:11 |   5.5 |
...
| Create namespaces for model elements                       |         |       |  8:59 |  22.6 |
| Leaves in internal modules are not captured correctly      |         |       |  1:33 |   3.9 |
| Try to add relational tracing support                      |         |       |  2:51 |   7.2 |
| Linux and OSX binaries are not stripped                    |         |       |  1:23 |   3.5 |
| Initial analysis to code generate feature infrastructure   |         |       |  7:13 |  18.1 |
| Replace JSON based feature templates with generated code   |         |       | 11:05 |  27.8 |
