...
#+CAPTION: Clock summary at [2019-05-16 Thu 18:26]
| <75>                                                       |         |       |       |       |
| Headline                                                   | Time    |       |       |     % |
|------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                               | *71:35* |       |       | 100.0 |
|------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                    | 71:35   |       |       | 100.0 |
| Active                                                     |         | 71:35 |       | 100.0 |
| Edit release notes for previous sprint                     |         |       |  2:41 |   3.7 |
| Create a video demo for the previous sprint's features     |         |       |  2:11 |   3.1 |
| Sprint and product backlog grooming                        |         |       |  2:24 |   3.4 |
| Defining profiles directly on a target model does not work |         |       |  0:30 |   0.7 |
| Inner modules need to be qualified                         |         |       |  0:22 |   0.5 |
| Create namespaces for model elements                       |         |       |  8:59 |  12.5 |
| Leaves in internal modules are not captured correctly      |         |       |  1:33 |   2.2 |
| Try to add relational tracing support                      |         |       |  2:51 |   4.0 |
| Linux and OSX binaries are not stripped                    |         |       |  1:23 |   1.9 |
| Fix issues with nightly build and CI                       |         |       |  0:05 |   0.1 |
| Emacs maintenance and exploration work                     |         |       |  0:40 |   0.9 |
| Initial analysis to code generate feature infrastructure   |         |       |  7:13 |  10.1 |
| Replace JSON based feature templates with generated code   |         |       | 16:15 |  22.7 |
| Make a clear separation between dogen and masd             |         |       |  5:17 |   7.4 |
| Add a method in enumeration that converts it from strings  |         |       |  7:49 |  10.9 |
| Update palettes and colour script with new elements        |         |       |  1:09 |   1.6 |
| Update the MASD UML profile to reflect the latest changes  |         |       |  0:05 |   0.1 |
| Mappings as meta-model elements                            |         |       | 10:08 |  14.2 |
...
*** Make wale templates meta-model elements                           :story:
