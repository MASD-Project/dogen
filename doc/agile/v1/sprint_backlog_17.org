...
#+CAPTION: Clock summary at [2019-05-10 Fri 14:46]
| <75>                                                       |         |       |      |       |
| Headline                                                   | Time    |       |      |     % |
|------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                    | 30:25   |       |      | 100.0 |
| Active                                                     |         | 30:25 |      | 100.0 |
| Edit release notes for previous sprint                     |         |       | 2:41 |   8.8 |
| Create a video demo for the previous sprint's features     |         |       | 2:11 |   7.2 |
| Sprint and product backlog grooming                        |         |       | 0:55 |   3.0 |
| Defining profiles directly on a target model does not work |         |       | 0:30 |   1.6 |
| Inner modules need to be qualified                         |         |       | 0:22 |   1.2 |
| Create namespaces for model elements                       |         |       | 8:59 |  29.5 |
| Leaves in internal modules are not captured correctly      |         |       | 1:33 |   5.1 |
| Try to add relational tracing support                      |         |       | 2:51 |   9.4 |
| Linux and OSX binaries are not stripped                    |         |       | 1:23 |   4.5 |
| Initial analysis to code generate feature infrastructure   |         |       | 7:13 |  23.7 |
| Replace JSON based feature templates with generated code   |         |       | 1:47 |   5.9 |
