...
#+CAPTION: Clock summary at [2019-05-14 Tue 22:40]
| <75>                                                       |         |       |       |       |
| Headline                                                   | Time    |       |       |     % |
|------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                               | *59:34* |       |       | 100.0 |
|------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                    | 59:34   |       |       | 100.0 |
| Active                                                     |         | 59:34 |       | 100.0 |
| Edit release notes for previous sprint                     |         |       |  2:41 |   4.5 |
| Create a video demo for the previous sprint's features     |         |       |  2:11 |   3.7 |
| Sprint and product backlog grooming                        |         |       |  1:26 |   2.4 |
| Defining profiles directly on a target model does not work |         |       |  0:30 |   0.8 |
| Inner modules need to be qualified                         |         |       |  0:22 |   0.6 |
| Create namespaces for model elements                       |         |       |  8:59 |  15.1 |
| Leaves in internal modules are not captured correctly      |         |       |  1:33 |   2.6 |
| Try to add relational tracing support                      |         |       |  2:51 |   4.8 |
| Linux and OSX binaries are not stripped                    |         |       |  1:23 |   2.3 |
| Fix issues with nightly build and CI                       |         |       |  0:05 |   0.1 |
| Initial analysis to code generate feature infrastructure   |         |       |  7:13 |  12.1 |
| Replace JSON based feature templates with generated code   |         |       | 16:15 |  27.3 |
| Make a clear separation between dogen and masd             |         |       |  5:17 |   8.9 |
| Add a method in enumeration that converts it from strings  |         |       |  7:49 |  13.1 |
| Update the MASD UML profile to reflect the latest changes  |         |       |  0:05 |   0.1 |
| Mappings as meta-model elements                            |         |       |  0:54 |   1.5 |
