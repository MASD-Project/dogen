...
#+CAPTION: Clock summary at [2019-05-10 Fri 20:41]
| <75>                                                       |         |       |      |       |
| Headline                                                   | Time    |       |      |     % |
|------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                               | *35:22* |       |      | 100.0 |
|------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                    | 35:22   |       |      | 100.0 |
| Active                                                     |         | 35:22 |      | 100.0 |
| Edit release notes for previous sprint                     |         |       | 2:41 |   7.6 |
| Create a video demo for the previous sprint's features     |         |       | 2:11 |   6.2 |
| Sprint and product backlog grooming                        |         |       | 0:55 |   2.6 |
| Defining profiles directly on a target model does not work |         |       | 0:30 |   1.4 |
| Inner modules need to be qualified                         |         |       | 0:22 |   1.0 |
| Create namespaces for model elements                       |         |       | 8:59 |  25.4 |
| Leaves in internal modules are not captured correctly      |         |       | 1:33 |   4.4 |
| Try to add relational tracing support                      |         |       | 2:51 |   8.1 |
| Linux and OSX binaries are not stripped                    |         |       | 1:23 |   3.9 |
| Initial analysis to code generate feature infrastructure   |         |       | 7:13 |  20.4 |
| Replace JSON based feature templates with generated code   |         |       | 6:44 |  19.0 |
