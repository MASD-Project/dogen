...
#+CAPTION: Clock summary at [2019-05-16 Thu 14:06]
| <75>                                                       |         |       |       |       |
| Headline                                                   | Time    |       |       |     % |
|------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                               | *68:06* |       |       | 100.0 |
|------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                    | 68:06   |       |       | 100.0 |
| Active                                                     |         | 68:06 |       | 100.0 |
| Edit release notes for previous sprint                     |         |       |  2:41 |   3.9 |
| Create a video demo for the previous sprint's features     |         |       |  2:11 |   3.2 |
| Sprint and product backlog grooming                        |         |       |  2:24 |   3.5 |
| Defining profiles directly on a target model does not work |         |       |  0:30 |   0.7 |
| Inner modules need to be qualified                         |         |       |  0:22 |   0.5 |
| Create namespaces for model elements                       |         |       |  8:59 |  13.2 |
| Leaves in internal modules are not captured correctly      |         |       |  1:33 |   2.3 |
| Try to add relational tracing support                      |         |       |  2:51 |   4.2 |
...
| Initial analysis to code generate feature infrastructure   |         |       |  7:13 |  10.6 |
| Replace JSON based feature templates with generated code   |         |       | 16:15 |  23.9 |
| Make a clear separation between dogen and masd             |         |       |  5:17 |   7.8 |
| Add a method in enumeration that converts it from strings  |         |       |  7:49 |  11.5 |
| Update palettes and colour script with new elements        |         |       |  1:09 |   1.7 |
| Update the MASD UML profile to reflect the latest changes  |         |       |  0:05 |   0.1 |
| Mappings as meta-model elements                            |         |       |  6:56 |  10.2 |
