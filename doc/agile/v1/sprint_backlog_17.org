...
#+CAPTION: Clock summary at [2019-05-13 Mon 11:53]
| <75>                                                       |         |       |       |       |
| Headline                                                   | Time    |       |       |     % |
|------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                               | *46:43* |       |       | 100.0 |
|------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                    | 46:43   |       |       | 100.0 |
| Active                                                     |         | 46:43 |       | 100.0 |
| Edit release notes for previous sprint                     |         |       |  2:41 |   5.7 |
| Create a video demo for the previous sprint's features     |         |       |  2:11 |   4.7 |
| Sprint and product backlog grooming                        |         |       |  1:10 |   2.5 |
| Defining profiles directly on a target model does not work |         |       |  0:30 |   1.1 |
| Inner modules need to be qualified                         |         |       |  0:22 |   0.8 |
| Create namespaces for model elements                       |         |       |  8:59 |  19.2 |
| Leaves in internal modules are not captured correctly      |         |       |  1:33 |   3.3 |
| Try to add relational tracing support                      |         |       |  2:51 |   6.1 |
| Linux and OSX binaries are not stripped                    |         |       |  1:23 |   3.0 |
| Fix issues with nightly build and CI                       |         |       |  0:05 |   0.2 |
| Initial analysis to code generate feature infrastructure   |         |       |  7:13 |  15.4 |
| Replace JSON based feature templates with generated code   |         |       | 16:15 |  34.8 |
| Make a clear separation between dogen and masd             |         |       |  1:25 |   3.0 |
...
*** STARTED Make a clear separation between dogen and masd            :story:
    :LOGBOOK:
    CLOCK: [2019-05-13 Mon 12:45]
