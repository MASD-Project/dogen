...
#+CAPTION: Clock summary at [2019-05-17 Fri 10:02]
| <75>                                                       |         |       |       |       |
| Headline                                                   | Time    |       |       |     % |
|------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                               | *74:55* |       |       | 100.0 |
|------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                    | 74:55   |       |       | 100.0 |
| Active                                                     |         | 74:55 |       | 100.0 |
| Edit release notes for previous sprint                     |         |       |  2:41 |   3.6 |
| Create a video demo for the previous sprint's features     |         |       |  2:11 |   2.9 |
| Sprint and product backlog grooming                        |         |       |  2:24 |   3.2 |
| Defining profiles directly on a target model does not work |         |       |  0:30 |   0.7 |
| Inner modules need to be qualified                         |         |       |  0:22 |   0.5 |
| Create namespaces for model elements                       |         |       |  8:59 |  12.0 |
| Leaves in internal modules are not captured correctly      |         |       |  1:33 |   2.1 |
| Try to add relational tracing support                      |         |       |  2:51 |   3.8 |
...
| Initial analysis to code generate feature infrastructure   |         |       |  7:13 |   9.6 |
| Replace JSON based feature templates with generated code   |         |       | 16:15 |  21.7 |
| Make a clear separation between dogen and masd             |         |       |  5:17 |   7.1 |
| Add a method in enumeration that converts it from strings  |         |       |  7:49 |  10.4 |
...
| Mappings as meta-model elements                            |         |       | 13:28 |  18.0 |
