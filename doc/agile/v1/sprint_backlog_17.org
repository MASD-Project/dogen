...
#+CAPTION: Clock summary at [2019-05-13 Mon 08:18]
| <75>                                                       |         |       |       |       |
| Headline                                                   | Time    |       |       |     % |
|------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                               | *43:54* |       |       | 100.0 |
|------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                    | 43:54   |       |       | 100.0 |
| Active                                                     |         | 43:54 |       | 100.0 |
| Edit release notes for previous sprint                     |         |       |  2:41 |   6.1 |
| Create a video demo for the previous sprint's features     |         |       |  2:11 |   5.0 |
| Sprint and product backlog grooming                        |         |       |  1:10 |   2.7 |
| Defining profiles directly on a target model does not work |         |       |  0:30 |   1.1 |
| Inner modules need to be qualified                         |         |       |  0:22 |   0.8 |
| Create namespaces for model elements                       |         |       |  8:59 |  20.5 |
| Leaves in internal modules are not captured correctly      |         |       |  1:33 |   3.5 |
| Try to add relational tracing support                      |         |       |  2:51 |   6.5 |
| Linux and OSX binaries are not stripped                    |         |       |  1:23 |   3.2 |
| Fix issues with nightly build and CI                       |         |       |  0:05 |   0.2 |
| Initial analysis to code generate feature infrastructure   |         |       |  7:13 |  16.4 |
| Replace JSON based feature templates with generated code   |         |       | 14:56 |  34.0 |
