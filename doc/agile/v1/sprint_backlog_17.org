...
#+CAPTION: Clock summary at [2019-05-12 Sun 13:36]
| <75>                                                       |         |       |       |       |
| Headline                                                   | Time    |       |       |     % |
|------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                               | *41:11* |       |       | 100.0 |
|------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                    | 41:11   |       |       | 100.0 |
| Active                                                     |         | 41:11 |       | 100.0 |
| Edit release notes for previous sprint                     |         |       |  2:41 |   6.5 |
...
| Create namespaces for model elements                       |         |       |  8:59 |  21.8 |
| Leaves in internal modules are not captured correctly      |         |       |  1:33 |   3.8 |
| Try to add relational tracing support                      |         |       |  2:51 |   6.9 |
| Linux and OSX binaries are not stripped                    |         |       |  1:23 |   3.4 |
| Initial analysis to code generate feature infrastructure   |         |       |  7:13 |  17.5 |
| Replace JSON based feature templates with generated code   |         |       | 12:27 |  30.2 |
