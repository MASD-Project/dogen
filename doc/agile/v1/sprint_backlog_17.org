...
#+CAPTION: Clock summary at [2019-05-10 Fri 11:34]
| <75>                                                       |         |       |      |       |
| Headline                                                   | Time    |       |      |     % |
|------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                               | *28:28* |       |      | 100.0 |
|------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                    | 28:28   |       |      | 100.0 |
| Active                                                     |         | 28:28 |      | 100.0 |
| Edit release notes for previous sprint                     |         |       | 2:41 |   9.4 |
| Create a video demo for the previous sprint's features     |         |       | 2:11 |   7.7 |
| Sprint and product backlog grooming                        |         |       | 0:45 |   2.6 |
| Defining profiles directly on a target model does not work |         |       | 0:30 |   1.8 |
| Inner modules need to be qualified                         |         |       | 0:22 |   1.3 |
| Create namespaces for model elements                       |         |       | 8:59 |  31.6 |
| Leaves in internal modules are not captured correctly      |         |       | 1:33 |   5.4 |
| Try to add relational tracing support                      |         |       | 2:51 |  10.0 |
| Linux and OSX binaries are not stripped                    |         |       | 1:23 |   4.9 |
| Initial analysis to code generate feature infrastructure   |         |       | 7:13 |  25.4 |
...
*** Replace JSON based feature templates with generated code          :story:
