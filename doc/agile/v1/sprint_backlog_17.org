...
#+CAPTION: Clock summary at [2019-05-16 Thu 08:44]
| <75>                                                       |         |       |       |       |
| Headline                                                   | Time    |       |       |     % |
|------------------------------------------------------------+---------+-------+-------+-------|
...
| Create namespaces for model elements                       |         |       |  8:59 |  13.6 |
| Leaves in internal modules are not captured correctly      |         |       |  1:33 |   2.3 |
| Try to add relational tracing support                      |         |       |  2:51 |   4.3 |
| Linux and OSX binaries are not stripped                    |         |       |  1:23 |   2.1 |
| Fix issues with nightly build and CI                       |         |       |  0:05 |   0.1 |
| Initial analysis to code generate feature infrastructure   |         |       |  7:13 |  10.9 |
| Replace JSON based feature templates with generated code   |         |       | 16:15 |  24.6 |
| Make a clear separation between dogen and masd             |         |       |  5:17 |   8.0 |
| Add a method in enumeration that converts it from strings  |         |       |  7:49 |  11.8 |
| Update the MASD UML profile to reflect the latest changes  |         |       |  0:05 |   0.1 |
| Mappings as meta-model elements                            |         |       |  5:58 |   9.0 |
