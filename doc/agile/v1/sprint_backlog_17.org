...
#+CAPTION: Clock summary at [2019-05-14 Tue 12:05]
| <75>                                                       |         |       |       |       |
| Headline                                                   | Time    |       |       |     % |
|------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                               | *55:17* |       |       | 100.0 |
|------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                    | 55:17   |       |       | 100.0 |
| Active                                                     |         | 55:17 |       | 100.0 |
| Edit release notes for previous sprint                     |         |       |  2:41 |   4.9 |
| Create a video demo for the previous sprint's features     |         |       |  2:11 |   3.9 |
| Sprint and product backlog grooming                        |         |       |  1:26 |   2.6 |
| Defining profiles directly on a target model does not work |         |       |  0:30 |   0.9 |
| Inner modules need to be qualified                         |         |       |  0:22 |   0.7 |
| Create namespaces for model elements                       |         |       |  8:59 |  16.2 |
| Leaves in internal modules are not captured correctly      |         |       |  1:33 |   2.8 |
| Try to add relational tracing support                      |         |       |  2:51 |   5.2 |
| Linux and OSX binaries are not stripped                    |         |       |  1:23 |   2.5 |
| Fix issues with nightly build and CI                       |         |       |  0:05 |   0.2 |
| Initial analysis to code generate feature infrastructure   |         |       |  7:13 |  13.1 |
| Replace JSON based feature templates with generated code   |         |       | 16:15 |  29.4 |
| Make a clear separation between dogen and masd             |         |       |  5:17 |   9.6 |
| Update the MASD UML profile to reflect the latest changes  |         |       |  0:05 |   0.2 |
| Add a method in enumeration that converts it from strings  |         |       |  4:26 |   8.0 |
