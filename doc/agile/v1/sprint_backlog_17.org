...
#+CAPTION: Clock summary at [2019-05-10 Fri 18:58]
| <75>                                                       |         |       |      |       |
| Headline                                                   | Time    |       |      |     % |
|------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                               | *34:29* |       |      | 100.0 |
|------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                    | 34:29   |       |      | 100.0 |
| Active                                                     |         | 34:29 |      | 100.0 |
| Edit release notes for previous sprint                     |         |       | 2:41 |   7.8 |
| Create a video demo for the previous sprint's features     |         |       | 2:11 |   6.3 |
| Sprint and product backlog grooming                        |         |       | 0:55 |   2.7 |
| Defining profiles directly on a target model does not work |         |       | 0:30 |   1.4 |
| Inner modules need to be qualified                         |         |       | 0:22 |   1.1 |
| Create namespaces for model elements                       |         |       | 8:59 |  26.1 |
| Leaves in internal modules are not captured correctly      |         |       | 1:33 |   4.5 |
| Try to add relational tracing support                      |         |       | 2:51 |   8.3 |
| Linux and OSX binaries are not stripped                    |         |       | 1:23 |   4.0 |
| Initial analysis to code generate feature infrastructure   |         |       | 7:13 |  20.9 |
| Replace JSON based feature templates with generated code   |         |       | 5:51 |  17.0 |
