...
#+CAPTION: Clock summary at [2019-05-09 Thu 11:55]
| <75>                                                       |         |       |      |       |
| Headline                                                   | Time    |       |      |     % |
|------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                               | *22:45* |       |      | 100.0 |
|------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                    | 22:45   |       |      | 100.0 |
| Active                                                     |         | 22:45 |      | 100.0 |
| Edit release notes for previous sprint                     |         |       | 2:41 |  11.8 |
| Create a video demo for the previous sprint's features     |         |       | 2:11 |   9.6 |
| Sprint and product backlog grooming                        |         |       | 0:28 |   2.1 |
| Defining profiles directly on a target model does not work |         |       | 0:30 |   2.2 |
| Inner modules need to be qualified                         |         |       | 0:22 |   1.6 |
| Create namespaces for model elements                       |         |       | 8:59 |  39.5 |
| Leaves in internal modules are not captured correctly      |         |       | 1:33 |   6.8 |
| Code generate feature infrastructure                       |         |       | 3:10 |  13.9 |
| Try to add relational tracing support                      |         |       | 2:51 |  12.5 |
...
*** Add type mapping support to primitives                            :story:
