...
#+CAPTION: Clock summary at [2019-05-15 Wed 11:43]
| <75>                                                       |         |       |       |       |
| Headline                                                   | Time    |       |       |     % |
|------------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                    | 61:49   |       |       | 100.0 |
| Active                                                     |         | 61:49 |       | 100.0 |
| Edit release notes for previous sprint                     |         |       |  2:41 |   4.3 |
| Create a video demo for the previous sprint's features     |         |       |  2:11 |   3.5 |
| Sprint and product backlog grooming                        |         |       |  1:42 |   2.8 |
| Defining profiles directly on a target model does not work |         |       |  0:30 |   0.8 |
| Inner modules need to be qualified                         |         |       |  0:22 |   0.6 |
| Create namespaces for model elements                       |         |       |  8:59 |  14.5 |
| Leaves in internal modules are not captured correctly      |         |       |  1:33 |   2.5 |
| Try to add relational tracing support                      |         |       |  2:51 |   4.6 |
| Linux and OSX binaries are not stripped                    |         |       |  1:23 |   2.2 |
| Fix issues with nightly build and CI                       |         |       |  0:05 |   0.1 |
| Initial analysis to code generate feature infrastructure   |         |       |  7:13 |  11.7 |
| Replace JSON based feature templates with generated code   |         |       | 16:15 |  26.3 |
| Make a clear separation between dogen and masd             |         |       |  5:17 |   8.5 |
| Add a method in enumeration that converts it from strings  |         |       |  7:49 |  12.6 |
| Update the MASD UML profile to reflect the latest changes  |         |       |  0:05 |   0.1 |
| Mappings as meta-model elements                            |         |       |  2:30 |   4.0 |
