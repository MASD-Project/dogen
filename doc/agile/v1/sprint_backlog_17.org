...
#+CAPTION: Clock summary at [2019-05-11 Sat 07:41]
| <75>                                                       |         |       |      |       |
| Headline                                                   | Time    |       |      |     % |
|------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                    | 36:56   |       |      | 100.0 |
| Active                                                     |         | 36:56 |      | 100.0 |
| Edit release notes for previous sprint                     |         |       | 2:41 |   7.3 |
| Create a video demo for the previous sprint's features     |         |       | 2:11 |   5.9 |
...
| Create namespaces for model elements                       |         |       | 8:59 |  24.3 |
| Leaves in internal modules are not captured correctly      |         |       | 1:33 |   4.2 |
| Try to add relational tracing support                      |         |       | 2:51 |   7.7 |
| Linux and OSX binaries are not stripped                    |         |       | 1:23 |   3.7 |
| Initial analysis to code generate feature infrastructure   |         |       | 7:13 |  19.5 |
| Replace JSON based feature templates with generated code   |         |       | 8:12 |  22.2 |
