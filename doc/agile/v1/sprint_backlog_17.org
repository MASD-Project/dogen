...
#+CAPTION: Clock summary at [2019-05-10 Fri 14:05]
| <75>                                                       |         |       |      |       |
| Headline                                                   | Time    |       |      |     % |
|------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                    | 29:46   |       |      | 100.0 |
| Active                                                     |         | 29:46 |      | 100.0 |
| Edit release notes for previous sprint                     |         |       | 2:41 |   9.0 |
| Create a video demo for the previous sprint's features     |         |       | 2:11 |   7.3 |
| Sprint and product backlog grooming                        |         |       | 0:55 |   3.1 |
| Defining profiles directly on a target model does not work |         |       | 0:30 |   1.7 |
| Inner modules need to be qualified                         |         |       | 0:22 |   1.2 |
| Create namespaces for model elements                       |         |       | 8:59 |  30.2 |
| Leaves in internal modules are not captured correctly      |         |       | 1:33 |   5.2 |
| Try to add relational tracing support                      |         |       | 2:51 |   9.6 |
| Linux and OSX binaries are not stripped                    |         |       | 1:23 |   4.6 |
| Initial analysis to code generate feature infrastructure   |         |       | 7:13 |  24.2 |
| Replace JSON based feature templates with generated code   |         |       | 1:08 |   3.8 |
