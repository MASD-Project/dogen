...
#+CAPTION: Clock summary at [2019-05-12 Sun 19:07]
| <75>                                                       |         |       |       |       |
| Headline                                                   | Time    |       |       |     % |
|------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                               | *42:58* |       |       | 100.0 |
|------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                    | 42:58   |       |       | 100.0 |
| Active                                                     |         | 42:58 |       | 100.0 |
| Edit release notes for previous sprint                     |         |       |  2:41 |   6.2 |
...
| Create namespaces for model elements                       |         |       |  8:59 |  20.9 |
| Leaves in internal modules are not captured correctly      |         |       |  1:33 |   3.6 |
| Try to add relational tracing support                      |         |       |  2:51 |   6.6 |
| Linux and OSX binaries are not stripped                    |         |       |  1:23 |   3.2 |
| Initial analysis to code generate feature infrastructure   |         |       |  7:13 |  16.8 |
| Replace JSON based feature templates with generated code   |         |       | 14:14 |  33.1 |
