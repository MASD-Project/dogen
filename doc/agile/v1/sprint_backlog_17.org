...
#+CAPTION: Clock summary at [2019-05-11 Sat 06:51]
| <75>                                                       |         |       |      |       |
| Headline                                                   | Time    |       |      |     % |
|------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                               | *36:08* |       |      | 100.0 |
|------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                    | 36:08   |       |      | 100.0 |
| Active                                                     |         | 36:08 |      | 100.0 |
| Edit release notes for previous sprint                     |         |       | 2:41 |   7.4 |
| Create a video demo for the previous sprint's features     |         |       | 2:11 |   6.0 |
| Sprint and product backlog grooming                        |         |       | 1:01 |   2.8 |
| Defining profiles directly on a target model does not work |         |       | 0:30 |   1.4 |
| Inner modules need to be qualified                         |         |       | 0:22 |   1.0 |
| Create namespaces for model elements                       |         |       | 8:59 |  24.9 |
| Leaves in internal modules are not captured correctly      |         |       | 1:33 |   4.3 |
| Try to add relational tracing support                      |         |       | 2:51 |   7.9 |
| Linux and OSX binaries are not stripped                    |         |       | 1:23 |   3.8 |
| Initial analysis to code generate feature infrastructure   |         |       | 7:13 |  20.0 |
| Replace JSON based feature templates with generated code   |         |       | 7:24 |  20.5 |
