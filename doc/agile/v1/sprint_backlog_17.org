...
#+CAPTION: Clock summary at [2019-05-13 Mon 10:18]
| <75>                                                       |         |       |       |       |
| Headline                                                   | Time    |       |       |     % |
|------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                               | *45:13* |       |       | 100.0 |
|------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                    | 45:13   |       |       | 100.0 |
| Active                                                     |         | 45:13 |       | 100.0 |
| Edit release notes for previous sprint                     |         |       |  2:41 |   5.9 |
| Create a video demo for the previous sprint's features     |         |       |  2:11 |   4.8 |
...
| Create namespaces for model elements                       |         |       |  8:59 |  19.9 |
| Leaves in internal modules are not captured correctly      |         |       |  1:33 |   3.4 |
| Try to add relational tracing support                      |         |       |  2:51 |   6.3 |
| Linux and OSX binaries are not stripped                    |         |       |  1:23 |   3.1 |
| Fix issues with nightly build and CI                       |         |       |  0:05 |   0.2 |
| Initial analysis to code generate feature infrastructure   |         |       |  7:13 |  16.0 |
| Replace JSON based feature templates with generated code   |         |       | 16:15 |  35.9 |
