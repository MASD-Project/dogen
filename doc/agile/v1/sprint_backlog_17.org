...
#+CAPTION: Clock summary at [2019-05-07 Tue 11:57]
| <75>                                                       |        |      |      |       |
| Headline                                                   | Time   |      |      |     % |
|------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                               | *7:42* |      |      | 100.0 |
|------------------------------------------------------------+--------+------+------+-------|
| Stories                                                    | 7:42   |      |      | 100.0 |
| Active                                                     |        | 7:42 |      | 100.0 |
| Edit release notes for previous sprint                     |        |      | 2:41 |  34.8 |
| Create a video demo for the previous sprint's features     |        |      | 2:11 |  28.4 |
| Sprint and product backlog grooming                        |        |      | 0:19 |   4.1 |
| Defining profiles directly on a target model does not work |        |      | 0:30 |   6.5 |
| Create namespaces for model elements                       |        |      | 2:01 |  26.2 |
