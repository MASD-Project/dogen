...
#+CAPTION: Clock summary at [2019-05-11 Sat 13:24]
| <75>                                                       |         |       |      |       |
| Headline                                                   | Time    |       |      |     % |
|------------------------------------------------------------+---------+-------+------+-------|
...
| Create namespaces for model elements                       |         |       | 8:59 |  23.9 |
| Leaves in internal modules are not captured correctly      |         |       | 1:33 |   4.1 |
| Try to add relational tracing support                      |         |       | 2:51 |   7.6 |
| Linux and OSX binaries are not stripped                    |         |       | 1:23 |   3.7 |
| Initial analysis to code generate feature infrastructure   |         |       | 7:13 |  19.2 |
| Replace JSON based feature templates with generated code   |         |       | 8:51 |  23.5 |
