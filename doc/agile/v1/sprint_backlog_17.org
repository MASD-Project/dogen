...
#+CAPTION: Clock summary at [2019-05-10 Fri 20:05]
| <75>                                                       |         |       |      |       |
| Headline                                                   | Time    |       |      |     % |
|------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                               | *34:49* |       |      | 100.0 |
|------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                    | 34:49   |       |      | 100.0 |
| Active                                                     |         | 34:49 |      | 100.0 |
| Edit release notes for previous sprint                     |         |       | 2:41 |   7.7 |
...
| Create namespaces for model elements                       |         |       | 8:59 |  25.8 |
| Leaves in internal modules are not captured correctly      |         |       | 1:33 |   4.5 |
| Try to add relational tracing support                      |         |       | 2:51 |   8.2 |
| Linux and OSX binaries are not stripped                    |         |       | 1:23 |   4.0 |
| Initial analysis to code generate feature infrastructure   |         |       | 7:13 |  20.7 |
| Replace JSON based feature templates with generated code   |         |       | 6:11 |  17.8 |
