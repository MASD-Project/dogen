...
#+CAPTION: Clock summary at [2019-05-10 Fri 13:39]
| <75>                                                       |         |       |      |       |
| Headline                                                   | Time    |       |      |     % |
|------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                    | 29:21   |       |      | 100.0 |
| Active                                                     |         | 29:21 |      | 100.0 |
| Edit release notes for previous sprint                     |         |       | 2:41 |   9.1 |
| Create a video demo for the previous sprint's features     |         |       | 2:11 |   7.4 |
...
| Create namespaces for model elements                       |         |       | 8:59 |  30.6 |
| Leaves in internal modules are not captured correctly      |         |       | 1:33 |   5.3 |
| Try to add relational tracing support                      |         |       | 2:51 |   9.7 |
| Linux and OSX binaries are not stripped                    |         |       | 1:23 |   4.7 |
| Initial analysis to code generate feature infrastructure   |         |       | 7:13 |  24.6 |
| Replace JSON based feature templates with generated code   |         |       | 0:43 |   2.4 |
