...
#+CAPTION: Clock summary at [2019-05-10 Fri 15:22]
| <75>                                                       |         |       |      |       |
| Headline                                                   | Time    |       |      |     % |
|------------------------------------------------------------+---------+-------+------+-------|
...
| Create a video demo for the previous sprint's features     |         |       | 2:11 |   7.0 |
...
| Create namespaces for model elements                       |         |       | 8:59 |  29.0 |
| Leaves in internal modules are not captured correctly      |         |       | 1:33 |   5.0 |
| Try to add relational tracing support                      |         |       | 2:51 |   9.2 |
| Linux and OSX binaries are not stripped                    |         |       | 1:23 |   4.5 |
| Initial analysis to code generate feature infrastructure   |         |       | 7:13 |  23.3 |
| Replace JSON based feature templates with generated code   |         |       | 2:21 |   7.6 |
