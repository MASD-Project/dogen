...
#+CAPTION: Clock summary at [2019-05-10 Fri 10:23]
| <75>                                                       |         |       |      |       |
| Headline                                                   | Time    |       |      |     % |
|------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                               | *27:19* |       |      | 100.0 |
|------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                    | 27:19   |       |      | 100.0 |
| Active                                                     |         | 27:19 |      | 100.0 |
| Edit release notes for previous sprint                     |         |       | 2:41 |   9.8 |
| Create a video demo for the previous sprint's features     |         |       | 2:11 |   8.0 |
| Sprint and product backlog grooming                        |         |       | 0:28 |   1.7 |
| Defining profiles directly on a target model does not work |         |       | 0:30 |   1.8 |
| Inner modules need to be qualified                         |         |       | 0:22 |   1.3 |
| Create namespaces for model elements                       |         |       | 8:59 |  32.9 |
| Leaves in internal modules are not captured correctly      |         |       | 1:33 |   5.7 |
| Try to add relational tracing support                      |         |       | 2:51 |  10.4 |
| Linux and OSX binaries are not stripped                    |         |       | 1:23 |   5.1 |
| Code generate feature infrastructure                       |         |       | 6:21 |  23.2 |
