...
#+CAPTION: Clock summary at [2019-05-13 Mon 14:38]
| <75>                                                       |         |       |       |       |
| Headline                                                   | Time    |       |       |     % |
|------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                               | *48:48* |       |       | 100.0 |
|------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                    | 48:48   |       |       | 100.0 |
| Active                                                     |         | 48:48 |       | 100.0 |
| Edit release notes for previous sprint                     |         |       |  2:41 |   5.5 |
| Create a video demo for the previous sprint's features     |         |       |  2:11 |   4.5 |
...
| Create namespaces for model elements                       |         |       |  8:59 |  18.4 |
| Leaves in internal modules are not captured correctly      |         |       |  1:33 |   3.2 |
| Try to add relational tracing support                      |         |       |  2:51 |   5.8 |
| Linux and OSX binaries are not stripped                    |         |       |  1:23 |   2.8 |
| Fix issues with nightly build and CI                       |         |       |  0:05 |   0.2 |
| Initial analysis to code generate feature infrastructure   |         |       |  7:13 |  14.8 |
| Replace JSON based feature templates with generated code   |         |       | 16:15 |  33.3 |
| Make a clear separation between dogen and masd             |         |       |  3:30 |   7.2 |
