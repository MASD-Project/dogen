...
#+CAPTION: Clock summary at [2019-05-09 Thu 17:33]
| <75>                                                       |         |       |      |       |
| Headline                                                   | Time    |       |      |     % |
|------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                               | *25:09* |       |      | 100.0 |
|------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                    | 25:09   |       |      | 100.0 |
| Active                                                     |         | 25:09 |      | 100.0 |
| Edit release notes for previous sprint                     |         |       | 2:41 |  10.7 |
| Create a video demo for the previous sprint's features     |         |       | 2:11 |   8.7 |
| Sprint and product backlog grooming                        |         |       | 0:28 |   1.9 |
| Defining profiles directly on a target model does not work |         |       | 0:30 |   2.0 |
| Inner modules need to be qualified                         |         |       | 0:22 |   1.5 |
| Create namespaces for model elements                       |         |       | 8:59 |  35.7 |
| Leaves in internal modules are not captured correctly      |         |       | 1:33 |   6.2 |
| Try to add relational tracing support                      |         |       | 2:51 |  11.3 |
| Linux and OSX binaries are not stripped                    |         |       | 1:23 |   5.5 |
| Code generate feature infrastructure                       |         |       | 4:11 |  16.6 |
