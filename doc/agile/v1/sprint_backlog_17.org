...
#+CAPTION: Clock summary at [2019-05-16 Thu 19:46]
| <75>                                                       |         |       |       |       |
| Headline                                                   | Time    |       |       |     % |
|------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                               | *72:25* |       |       | 100.0 |
|------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                    | 72:25   |       |       | 100.0 |
| Active                                                     |         | 72:25 |       | 100.0 |
| Edit release notes for previous sprint                     |         |       |  2:41 |   3.7 |
| Create a video demo for the previous sprint's features     |         |       |  2:11 |   3.0 |
| Sprint and product backlog grooming                        |         |       |  2:24 |   3.3 |
| Defining profiles directly on a target model does not work |         |       |  0:30 |   0.7 |
| Inner modules need to be qualified                         |         |       |  0:22 |   0.5 |
| Create namespaces for model elements                       |         |       |  8:59 |  12.4 |
| Leaves in internal modules are not captured correctly      |         |       |  1:33 |   2.1 |
| Try to add relational tracing support                      |         |       |  2:51 |   3.9 |
...
| Initial analysis to code generate feature infrastructure   |         |       |  7:13 |  10.0 |
| Replace JSON based feature templates with generated code   |         |       | 16:15 |  22.4 |
| Make a clear separation between dogen and masd             |         |       |  5:17 |   7.3 |
| Add a method in enumeration that converts it from strings  |         |       |  7:49 |  10.8 |
...
| Mappings as meta-model elements                            |         |       | 10:58 |  15.1 |
