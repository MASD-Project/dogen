...
#+CAPTION: Clock summary at [2019-05-10 Fri 17:32]
| <75>                                                       |         |       |      |       |
| Headline                                                   | Time    |       |      |     % |
|------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                               | *33:05* |       |      | 100.0 |
|------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                    | 33:05   |       |      | 100.0 |
| Active                                                     |         | 33:05 |      | 100.0 |
| Edit release notes for previous sprint                     |         |       | 2:41 |   8.1 |
| Create a video demo for the previous sprint's features     |         |       | 2:11 |   6.6 |
| Sprint and product backlog grooming                        |         |       | 0:55 |   2.8 |
| Defining profiles directly on a target model does not work |         |       | 0:30 |   1.5 |
| Inner modules need to be qualified                         |         |       | 0:22 |   1.1 |
| Create namespaces for model elements                       |         |       | 8:59 |  27.2 |
| Leaves in internal modules are not captured correctly      |         |       | 1:33 |   4.7 |
| Try to add relational tracing support                      |         |       | 2:51 |   8.6 |
| Linux and OSX binaries are not stripped                    |         |       | 1:23 |   4.2 |
| Initial analysis to code generate feature infrastructure   |         |       | 7:13 |  21.8 |
| Replace JSON based feature templates with generated code   |         |       | 4:27 |  13.5 |
