...
#+CAPTION: Clock summary at [2019-05-16 Thu 11:51]
| <75>                                                       |         |       |       |       |
| Headline                                                   | Time    |       |       |     % |
|------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                               | *67:08* |       |       | 100.0 |
|------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                    | 67:08   |       |       | 100.0 |
| Active                                                     |         | 67:08 |       | 100.0 |
| Edit release notes for previous sprint                     |         |       |  2:41 |   4.0 |
| Create a video demo for the previous sprint's features     |         |       |  2:11 |   3.3 |
| Sprint and product backlog grooming                        |         |       |  2:24 |   3.6 |
| Defining profiles directly on a target model does not work |         |       |  0:30 |   0.7 |
| Inner modules need to be qualified                         |         |       |  0:22 |   0.5 |
| Create namespaces for model elements                       |         |       |  8:59 |  13.4 |
...
| Initial analysis to code generate feature infrastructure   |         |       |  7:13 |  10.7 |
| Replace JSON based feature templates with generated code   |         |       | 16:15 |  24.2 |
| Make a clear separation between dogen and masd             |         |       |  5:17 |   7.9 |
| Add a method in enumeration that converts it from strings  |         |       |  7:49 |  11.6 |
...
| Mappings as meta-model elements                            |         |       |  5:58 |   8.9 |
