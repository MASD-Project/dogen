...
#+CAPTION: Clock summary at [2019-05-16 Thu 17:00]
| <75>                                                       |         |       |       |       |
| Headline                                                   | Time    |       |       |     % |
|------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                               | *70:26* |       |       | 100.0 |
|------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                    | 70:26   |       |       | 100.0 |
| Active                                                     |         | 70:26 |       | 100.0 |
...
| Create namespaces for model elements                       |         |       |  8:59 |  12.8 |
| Leaves in internal modules are not captured correctly      |         |       |  1:33 |   2.2 |
| Try to add relational tracing support                      |         |       |  2:51 |   4.0 |
| Linux and OSX binaries are not stripped                    |         |       |  1:23 |   2.0 |
| Fix issues with nightly build and CI                       |         |       |  0:05 |   0.1 |
| Emacs maintenance and exploration work                     |         |       |  0:40 |   0.9 |
| Initial analysis to code generate feature infrastructure   |         |       |  7:13 |  10.2 |
| Replace JSON based feature templates with generated code   |         |       | 16:15 |  23.1 |
| Make a clear separation between dogen and masd             |         |       |  5:17 |   7.5 |
| Add a method in enumeration that converts it from strings  |         |       |  7:49 |  11.1 |
...
| Mappings as meta-model elements                            |         |       |  8:59 |  12.8 |
