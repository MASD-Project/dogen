...
#+CAPTION: Clock summary at [2019-05-07 Tue 18:01]
| <75>                                                       |         |       |      |       |
| Headline                                                   | Time    |       |      |     % |
|------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                               | *11:55* |       |      | 100.0 |
|------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                    | 11:55   |       |      | 100.0 |
| Active                                                     |         | 11:55 |      | 100.0 |
| Edit release notes for previous sprint                     |         |       | 2:41 |  22.5 |
| Create a video demo for the previous sprint's features     |         |       | 2:11 |  18.3 |
| Sprint and product backlog grooming                        |         |       | 0:19 |   2.7 |
| Defining profiles directly on a target model does not work |         |       | 0:30 |   4.2 |
| Inner modules need to be qualified                         |         |       | 0:22 |   3.1 |
| Create namespaces for model elements                       |         |       | 4:11 |  35.1 |
| Code generate feature infrastructure                       |         |       | 1:41 |  14.1 |
