...
#+CAPTION: Clock summary at [2019-05-09 Thu 06:34]
| <75>                                                       |         |       |      |       |
| Headline                                                   | Time    |       |      |     % |
|------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                               | *19:00* |       |      | 100.0 |
|------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                    | 19:00   |       |      | 100.0 |
| Active                                                     |         | 19:00 |      | 100.0 |
| Edit release notes for previous sprint                     |         |       | 2:41 |  14.1 |
| Create a video demo for the previous sprint's features     |         |       | 2:11 |  11.5 |
| Sprint and product backlog grooming                        |         |       | 0:28 |   2.5 |
| Defining profiles directly on a target model does not work |         |       | 0:30 |   2.6 |
| Inner modules need to be qualified                         |         |       | 0:22 |   1.9 |
| Create namespaces for model elements                       |         |       | 8:59 |  47.3 |
| Leaves in internal modules are not captured correctly      |         |       | 1:33 |   8.2 |
| Code generate feature infrastructure                       |         |       | 2:16 |  11.9 |
