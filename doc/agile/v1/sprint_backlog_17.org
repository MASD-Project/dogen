...
#+CAPTION: Clock summary at [2019-05-13 Mon 09:21]
| <75>                                                       |         |       |       |       |
| Headline                                                   | Time    |       |       |     % |
|------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                               | *44:21* |       |       | 100.0 |
|------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                    | 44:21   |       |       | 100.0 |
| Active                                                     |         | 44:21 |       | 100.0 |
| Edit release notes for previous sprint                     |         |       |  2:41 |   6.1 |
| Create a video demo for the previous sprint's features     |         |       |  2:11 |   4.9 |
| Sprint and product backlog grooming                        |         |       |  1:10 |   2.6 |
| Defining profiles directly on a target model does not work |         |       |  0:30 |   1.1 |
| Inner modules need to be qualified                         |         |       |  0:22 |   0.8 |
| Create namespaces for model elements                       |         |       |  8:59 |  20.3 |
| Leaves in internal modules are not captured correctly      |         |       |  1:33 |   3.5 |
| Try to add relational tracing support                      |         |       |  2:51 |   6.4 |
| Linux and OSX binaries are not stripped                    |         |       |  1:23 |   3.1 |
| Fix issues with nightly build and CI                       |         |       |  0:05 |   0.2 |
| Initial analysis to code generate feature infrastructure   |         |       |  7:13 |  16.3 |
| Replace JSON based feature templates with generated code   |         |       | 15:23 |  34.7 |
