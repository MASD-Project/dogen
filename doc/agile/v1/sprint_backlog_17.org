...
#+CAPTION: Clock summary at [2019-05-14 Tue 17:12]
| <75>                                                       |         |       |       |       |
| Headline                                                   | Time    |       |       |     % |
|------------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                    | 57:25   |       |       | 100.0 |
| Active                                                     |         | 57:25 |       | 100.0 |
| Edit release notes for previous sprint                     |         |       |  2:41 |   4.7 |
...
| Create namespaces for model elements                       |         |       |  8:59 |  15.6 |
| Leaves in internal modules are not captured correctly      |         |       |  1:33 |   2.7 |
| Try to add relational tracing support                      |         |       |  2:51 |   5.0 |
| Linux and OSX binaries are not stripped                    |         |       |  1:23 |   2.4 |
| Fix issues with nightly build and CI                       |         |       |  0:05 |   0.1 |
| Initial analysis to code generate feature infrastructure   |         |       |  7:13 |  12.6 |
| Replace JSON based feature templates with generated code   |         |       | 16:15 |  28.3 |
| Make a clear separation between dogen and masd             |         |       |  5:17 |   9.2 |
| Update the MASD UML profile to reflect the latest changes  |         |       |  0:05 |   0.1 |
| Add a method in enumeration that converts it from strings  |         |       |  6:34 |  11.4 |
