...
#+CAPTION: Clock summary at [2019-05-10 Fri 18:27]
| <75>                                                       |         |       |      |       |
| Headline                                                   | Time    |       |      |     % |
|------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                    | 33:59   |       |      | 100.0 |
| Active                                                     |         | 33:59 |      | 100.0 |
| Edit release notes for previous sprint                     |         |       | 2:41 |   7.9 |
| Create a video demo for the previous sprint's features     |         |       | 2:11 |   6.4 |
...
| Create namespaces for model elements                       |         |       | 8:59 |  26.4 |
| Leaves in internal modules are not captured correctly      |         |       | 1:33 |   4.6 |
| Try to add relational tracing support                      |         |       | 2:51 |   8.4 |
| Linux and OSX binaries are not stripped                    |         |       | 1:23 |   4.1 |
| Initial analysis to code generate feature infrastructure   |         |       | 7:13 |  21.2 |
| Replace JSON based feature templates with generated code   |         |       | 5:21 |  15.7 |
