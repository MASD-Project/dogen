...
#+CAPTION: Clock summary at [2019-05-14 Tue 16:00]
| <75>                                                       |         |       |       |       |
| Headline                                                   | Time    |       |       |     % |
|------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                               | *56:14* |       |       | 100.0 |
|------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                    | 56:14   |       |       | 100.0 |
| Active                                                     |         | 56:14 |       | 100.0 |
| Edit release notes for previous sprint                     |         |       |  2:41 |   4.8 |
...
| Create namespaces for model elements                       |         |       |  8:59 |  16.0 |
| Leaves in internal modules are not captured correctly      |         |       |  1:33 |   2.8 |
| Try to add relational tracing support                      |         |       |  2:51 |   5.1 |
| Linux and OSX binaries are not stripped                    |         |       |  1:23 |   2.5 |
| Fix issues with nightly build and CI                       |         |       |  0:05 |   0.1 |
| Initial analysis to code generate feature infrastructure   |         |       |  7:13 |  12.8 |
| Replace JSON based feature templates with generated code   |         |       | 16:15 |  28.9 |
| Make a clear separation between dogen and masd             |         |       |  5:17 |   9.4 |
| Update the MASD UML profile to reflect the latest changes  |         |       |  0:05 |   0.1 |
| Add a method in enumeration that converts it from strings  |         |       |  5:23 |   9.6 |
