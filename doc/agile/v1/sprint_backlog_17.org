...
#+CAPTION: Clock summary at [2019-05-12 Sun 18:37]
| <75>                                                       |         |       |       |       |
| Headline                                                   | Time    |       |       |     % |
|------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                               | *42:31* |       |       | 100.0 |
|------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                    | 42:31   |       |       | 100.0 |
| Active                                                     |         | 42:31 |       | 100.0 |
| Edit release notes for previous sprint                     |         |       |  2:41 |   6.3 |
| Create a video demo for the previous sprint's features     |         |       |  2:11 |   5.1 |
| Sprint and product backlog grooming                        |         |       |  1:01 |   2.4 |
| Defining profiles directly on a target model does not work |         |       |  0:30 |   1.2 |
| Inner modules need to be qualified                         |         |       |  0:22 |   0.9 |
| Create namespaces for model elements                       |         |       |  8:59 |  21.1 |
| Leaves in internal modules are not captured correctly      |         |       |  1:33 |   3.6 |
| Try to add relational tracing support                      |         |       |  2:51 |   6.7 |
| Linux and OSX binaries are not stripped                    |         |       |  1:23 |   3.3 |
| Initial analysis to code generate feature infrastructure   |         |       |  7:13 |  17.0 |
| Replace JSON based feature templates with generated code   |         |       | 13:47 |  32.4 |
...
- archetype location properties are not useful for instance templates.
  We should not require them in this case.
