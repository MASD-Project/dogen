...
#+CAPTION: Clock summary at [2019-05-10 Fri 14:20]
| <75>                                                       |         |       |      |       |
| Headline                                                   | Time    |       |      |     % |
|------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                               | *30:00* |       |      | 100.0 |
|------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                    | 30:00   |       |      | 100.0 |
| Active                                                     |         | 30:00 |      | 100.0 |
| Edit release notes for previous sprint                     |         |       | 2:41 |   8.9 |
...
| Create namespaces for model elements                       |         |       | 8:59 |  29.9 |
| Leaves in internal modules are not captured correctly      |         |       | 1:33 |   5.2 |
| Try to add relational tracing support                      |         |       | 2:51 |   9.5 |
| Linux and OSX binaries are not stripped                    |         |       | 1:23 |   4.6 |
| Initial analysis to code generate feature infrastructure   |         |       | 7:13 |  24.1 |
| Replace JSON based feature templates with generated code   |         |       | 1:22 |   4.6 |
