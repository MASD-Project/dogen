...
#+CAPTION: Clock summary at [2019-05-13 Mon 16:15]
| <75>                                                       |         |       |       |       |
| Headline                                                   | Time    |       |       |     % |
|------------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                    | 50:23   |       |       | 100.0 |
| Active                                                     |         | 50:23 |       | 100.0 |
| Edit release notes for previous sprint                     |         |       |  2:41 |   5.3 |
| Create a video demo for the previous sprint's features     |         |       |  2:11 |   4.3 |
...
| Create namespaces for model elements                       |         |       |  8:59 |  17.8 |
| Leaves in internal modules are not captured correctly      |         |       |  1:33 |   3.1 |
| Try to add relational tracing support                      |         |       |  2:51 |   5.7 |
| Linux and OSX binaries are not stripped                    |         |       |  1:23 |   2.7 |
| Fix issues with nightly build and CI                       |         |       |  0:05 |   0.2 |
| Initial analysis to code generate feature infrastructure   |         |       |  7:13 |  14.3 |
| Replace JSON based feature templates with generated code   |         |       | 16:15 |  32.3 |
| Make a clear separation between dogen and masd             |         |       |  5:05 |  10.1 |
