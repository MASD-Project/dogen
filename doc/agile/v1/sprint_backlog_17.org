...
#+CAPTION: Clock summary at [2019-05-08 Wed 10:29]
| <75>                                                       |         |       |      |       |
| Headline                                                   | Time    |       |      |     % |
|------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                               | *12:56* |       |      | 100.0 |
|------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                    | 12:56   |       |      | 100.0 |
| Active                                                     |         | 12:56 |      | 100.0 |
| Edit release notes for previous sprint                     |         |       | 2:41 |  20.7 |
| Create a video demo for the previous sprint's features     |         |       | 2:11 |  16.9 |
| Sprint and product backlog grooming                        |         |       | 0:19 |   2.4 |
| Defining profiles directly on a target model does not work |         |       | 0:30 |   3.9 |
| Inner modules need to be qualified                         |         |       | 0:22 |   2.8 |
| Create namespaces for model elements                       |         |       | 5:08 |  39.7 |
| Code generate feature infrastructure                       |         |       | 1:45 |  13.5 |
...
*** Leaves in internal modules are not captured                       :story:
