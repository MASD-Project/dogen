...
#+CAPTION: Clock summary at [2019-05-13 Mon 18:03]
| <75>                                                       |         |       |       |       |
| Headline                                                   | Time    |       |       |     % |
|------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                               | *51:38* |       |       | 100.0 |
|------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                    | 51:38   |       |       | 100.0 |
| Active                                                     |         | 51:38 |       | 100.0 |
| Edit release notes for previous sprint                     |         |       |  2:41 |   5.2 |
...
| Create namespaces for model elements                       |         |       |  8:59 |  17.4 |
| Leaves in internal modules are not captured correctly      |         |       |  1:33 |   3.0 |
| Try to add relational tracing support                      |         |       |  2:51 |   5.5 |
| Linux and OSX binaries are not stripped                    |         |       |  1:23 |   2.7 |
| Fix issues with nightly build and CI                       |         |       |  0:05 |   0.2 |
| Initial analysis to code generate feature infrastructure   |         |       |  7:13 |  14.0 |
| Replace JSON based feature templates with generated code   |         |       | 16:15 |  31.5 |
| Make a clear separation between dogen and masd             |         |       |  5:17 |  10.2 |
| Update the MASD UML profile to reflect the latest changes  |         |       |  0:05 |   0.2 |
| Add a method in enumeration that converts it from strings  |         |       |  1:03 |   2.0 |
