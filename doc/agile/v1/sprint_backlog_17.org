...
#+CAPTION: Clock summary at [2019-05-11 Sat 07:07]
| <75>                                                       |         |       |      |       |
| Headline                                                   | Time    |       |      |     % |
|------------------------------------------------------------+---------+-------+------+-------|
...
| Create namespaces for model elements                       |         |       | 8:59 |  24.7 |
| Leaves in internal modules are not captured correctly      |         |       | 1:33 |   4.3 |
| Try to add relational tracing support                      |         |       | 2:51 |   7.8 |
| Linux and OSX binaries are not stripped                    |         |       | 1:23 |   3.8 |
| Initial analysis to code generate feature infrastructure   |         |       | 7:13 |  19.8 |
| Replace JSON based feature templates with generated code   |         |       | 7:39 |  21.0 |
