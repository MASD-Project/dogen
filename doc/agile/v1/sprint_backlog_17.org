...
#+CAPTION: Clock summary at [2019-05-12 Sun 10:27]
| <75>                                                       |         |       |       |       |
| Headline                                                   | Time    |       |       |     % |
|------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                               | *40:10* |       |       | 100.0 |
|------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                    | 40:10   |       |       | 100.0 |
| Active                                                     |         | 40:10 |       | 100.0 |
| Edit release notes for previous sprint                     |         |       |  2:41 |   6.7 |
| Create a video demo for the previous sprint's features     |         |       |  2:11 |   5.4 |
| Sprint and product backlog grooming                        |         |       |  1:01 |   2.5 |
| Defining profiles directly on a target model does not work |         |       |  0:30 |   1.2 |
| Inner modules need to be qualified                         |         |       |  0:22 |   0.9 |
| Create namespaces for model elements                       |         |       |  8:59 |  22.4 |
| Leaves in internal modules are not captured correctly      |         |       |  1:33 |   3.9 |
| Try to add relational tracing support                      |         |       |  2:51 |   7.1 |
| Linux and OSX binaries are not stripped                    |         |       |  1:23 |   3.4 |
| Initial analysis to code generate feature infrastructure   |         |       |  7:13 |  18.0 |
| Replace JSON based feature templates with generated code   |         |       | 11:26 |  28.5 |
