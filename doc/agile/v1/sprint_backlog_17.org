...
#+CAPTION: Clock summary at [2019-05-07 Tue 16:54]
| <75>                                                       |         |       |      |       |
| Headline                                                   | Time    |       |      |     % |
|------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                               | *10:48* |       |      | 100.0 |
|------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                    | 10:48   |       |      | 100.0 |
| Active                                                     |         | 10:48 |      | 100.0 |
| Edit release notes for previous sprint                     |         |       | 2:41 |  24.8 |
| Create a video demo for the previous sprint's features     |         |       | 2:11 |  20.2 |
| Sprint and product backlog grooming                        |         |       | 0:19 |   2.9 |
| Defining profiles directly on a target model does not work |         |       | 0:30 |   4.6 |
| Inner modules need to be qualified                         |         |       | 0:22 |   3.4 |
| Create namespaces for model elements                       |         |       | 4:11 |  38.7 |
| Code generate feature infrastructure                       |         |       | 0:34 |   5.2 |
