...
#+CAPTION: Clock summary at [2019-05-11 Sat 21:28]
| <75>                                                       |         |       |      |       |
| Headline                                                   | Time    |       |      |     % |
|------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                    | 38:06   |       |      | 100.0 |
| Active                                                     |         | 38:06 |      | 100.0 |
| Edit release notes for previous sprint                     |         |       | 2:41 |   7.0 |
| Create a video demo for the previous sprint's features     |         |       | 2:11 |   5.7 |
| Sprint and product backlog grooming                        |         |       | 1:01 |   2.7 |
| Defining profiles directly on a target model does not work |         |       | 0:30 |   1.3 |
| Inner modules need to be qualified                         |         |       | 0:22 |   1.0 |
| Create namespaces for model elements                       |         |       | 8:59 |  23.6 |
| Leaves in internal modules are not captured correctly      |         |       | 1:33 |   4.1 |
| Try to add relational tracing support                      |         |       | 2:51 |   7.5 |
| Linux and OSX binaries are not stripped                    |         |       | 1:23 |   3.6 |
| Initial analysis to code generate feature infrastructure   |         |       | 7:13 |  18.9 |
| Replace JSON based feature templates with generated code   |         |       | 9:22 |  24.6 |
