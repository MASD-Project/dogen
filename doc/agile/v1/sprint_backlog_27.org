...
#+CAPTION: Clock summary at [2020-09-19 Sat 08:23]
| <75>                                               |         |       |       |       |
| Headline                                           | Time    |       |       |     % |
|----------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                            | 77:44   |       |       | 100.0 |
| Active                                             |         | 77:44 |       | 100.0 |
| Edit release notes for previous sprint             |         |       |  7:15 |   9.3 |
| Create a demo and presentation for previous sprint |         |       |  0:41 |   0.9 |
| Sprint and product backlog grooming                |         |       |  2:26 |   3.1 |
| Nightly nursing and other spikes                   |         |       |  4:22 |   5.6 |
| Create an =ident= model                            |         |       | 42:02 |  54.1 |
...
| Add dependencies to artefacts                      |         |       |  2:28 |   3.2 |
| Add instances of physical meta-model elements      |         |       |  8:48 |  11.3 |
| Add full and relative path processing to PM        |         |       |  5:32 |   7.1 |
| Logical-physical model                             |         |       |  2:51 |   3.7 |
...
*** STARTED Logical-physical model                                    :story:
    :LOGBOOK:
