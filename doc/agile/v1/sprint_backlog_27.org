...
#+CAPTION: Clock summary at [2020-07-25 Sat 01:45]
| <75>                                               |         |       |       |       |
| Headline                                           | Time    |       |       |     % |
|----------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                            | 23:59   |       |       | 100.0 |
| Active                                             |         | 23:59 |       | 100.0 |
| Edit release notes for previous sprint             |         |       |  7:15 |  30.2 |
| Create a demo and presentation for previous sprint |         |       |  0:41 |   2.8 |
| Sprint and product backlog grooming                |         |       |  1:23 |   5.8 |
| Nightly nursing and other spikes                   |         |       |  0:59 |   4.1 |
| Create an =ident= model                            |         |       | 13:41 |  57.1 |
...
- rename compute SHA1 hash transform in injection to provenance transform.
