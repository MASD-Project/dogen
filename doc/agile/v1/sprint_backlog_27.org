...
#+CAPTION: Clock summary at [2020-09-14 Mon 12:11]
| <75>                                               |         |       |       |       |
| Headline                                           | Time    |       |       |     % |
|----------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                       | *64:48* |       |       | 100.0 |
|----------------------------------------------------+---------+-------+-------+-------|
| Stories                                            | 64:48   |       |       | 100.0 |
| Active                                             |         | 64:48 |       | 100.0 |
| Edit release notes for previous sprint             |         |       |  7:15 |  11.2 |
| Create a demo and presentation for previous sprint |         |       |  0:41 |   1.1 |
| Sprint and product backlog grooming                |         |       |  2:26 |   3.8 |
| Nightly nursing and other spikes                   |         |       |  4:22 |   6.7 |
| Create an =ident= model                            |         |       | 42:02 |  64.9 |
...
| Add dependencies to artefacts                      |         |       |  2:28 |   3.8 |
| Add instances of physical meta-model elements      |         |       |  4:15 |   6.6 |
