...
#+CAPTION: Clock summary at [2020-09-18 Fri 18:08]
| <75>                                               |         |       |       |       |
| Headline                                           | Time    |       |       |     % |
|----------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                       | *76:18* |       |       | 100.0 |
|----------------------------------------------------+---------+-------+-------+-------|
| Stories                                            | 76:18   |       |       | 100.0 |
| Active                                             |         | 76:18 |       | 100.0 |
| Edit release notes for previous sprint             |         |       |  7:15 |   9.5 |
| Create a demo and presentation for previous sprint |         |       |  0:41 |   0.9 |
| Sprint and product backlog grooming                |         |       |  2:26 |   3.2 |
| Nightly nursing and other spikes                   |         |       |  4:22 |   5.7 |
| Create an =ident= model                            |         |       | 42:02 |  55.1 |
...
| Add instances of physical meta-model elements      |         |       |  8:48 |  11.5 |
| Add full and relative path processing to PM        |         |       |  5:32 |   7.3 |
| Logical-physical model                             |         |       |  1:25 |   1.9 |
