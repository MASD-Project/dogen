...
#+CAPTION: Clock summary at [2020-09-11 Fri 17:18]
| <75>                                               |         |       |       |       |
| Headline                                           | Time    |       |       |     % |
|----------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                       | *61:20* |       |       | 100.0 |
|----------------------------------------------------+---------+-------+-------+-------|
| Stories                                            | 61:20   |       |       | 100.0 |
| Active                                             |         | 61:20 |       | 100.0 |
| Edit release notes for previous sprint             |         |       |  7:15 |  11.8 |
| Create a demo and presentation for previous sprint |         |       |  0:41 |   1.1 |
| Sprint and product backlog grooming                |         |       |  2:26 |   4.0 |
| Nightly nursing and other spikes                   |         |       |  4:22 |   7.1 |
| Create an =ident= model                            |         |       | 42:02 |  68.5 |
| Rename injection to codec                          |         |       |  0:48 |   1.3 |
| Add artefact's archetype to artefact class         |         |       |  0:07 |   0.2 |
| Remove support for split projects                  |         |       |  0:07 |   0.2 |
| Implement meta-name validator correctly            |         |       |  0:17 |   0.5 |
| Add dependencies to artefacts                      |         |       |  2:28 |   4.0 |
| Add instances of physical meta-model elements      |         |       |  0:47 |   1.3 |
...
a more neutral name like =_properties=, =_configuration=...
