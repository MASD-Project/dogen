...
#+CAPTION: Clock summary at [2017-03-28 Tue 20:55]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *41:45* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 41:45   |       |       | 100.0 |
| Active                                                                      |         | 41:45 |       | 100.0 |
...
| COMPLETED Concepts cannot be placed inside of packages                      |         |       |  8:26 |  20.2 |
| COMPLETED Use =cxx= extension with ODB files                                |         |       |  0:32 |   1.3 |
| COMPLETED Implement the database model using Northwind                      |         |       |  6:11 |  14.8 |
| COMPLETED ODB options does not cater for types placed in namespaces         |         |       |  0:16 |   0.6 |
| COMPLETED Improve ODB implementation                                        |         |       | 14:26 |  34.6 |
| COMPLETED Do not use underscores in ORM stereotypes                         |         |       |  0:13 |   0.5 |
| COMPLETED Add msbuild targets for ODB                                       |         |       |  3:49 |   9.1 |
| STARTED Allow users to override string prefixes in test data                |         |       |  1:52 |   4.5 |
| STARTED Ignore ODB files automatically                                      |         |       |  1:55 |   4.6 |
| STARTED Add boilerplate for XML files                                       |         |       |  1:22 |   3.3 |
...
*** STARTED Add boilerplate for XML files                             :story:
    CLOCK: [2017-03-28 Tue 20:39]--[2017-03-28 Tue 20:55] =>  0:16
