...
#+CAPTION: Clock summary at [2017-03-26 Sun 11:30]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                                     | 36:34   |       |       | 100.0 |
| Active                                                                      |         | 36:34 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:16 |   3.5 |
...
| COMPLETED Concepts cannot be placed inside of packages                      |         |       |  8:26 |  23.1 |
| COMPLETED Use =cxx= extension with ODB files                                |         |       |  0:32 |   1.5 |
| COMPLETED Implement the database model using Northwind                      |         |       |  6:11 |  16.9 |
| COMPLETED ODB options does not cater for types placed in namespaces         |         |       |  0:16 |   0.7 |
| COMPLETED Improve ODB implementation                                        |         |       | 14:26 |  39.5 |
| COMPLETED Do not use underscores in ORM stereotypes                         |         |       |  0:13 |   0.6 |
| STARTED Allow users to override string prefixes in test data                |         |       |  1:52 |   5.1 |
| STARTED Ignore ODB files automatically                                      |         |       |  1:55 |   5.2 |
