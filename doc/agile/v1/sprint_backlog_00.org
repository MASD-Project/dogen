...
#+CAPTION: Clock summary at [2017-03-29 Wed 22:50]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *44:12* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 44:12   |       |       | 100.0 |
| Active                                                                      |         | 44:12 |       | 100.0 |
...
| COMPLETED Concepts cannot be placed inside of packages                      |         |       |  8:26 |  19.1 |
| COMPLETED Use =cxx= extension with ODB files                                |         |       |  0:32 |   1.2 |
| COMPLETED Implement the database model using Northwind                      |         |       |  6:11 |  14.0 |
| COMPLETED ODB options does not cater for types placed in namespaces         |         |       |  0:16 |   0.6 |
| COMPLETED Improve ODB implementation                                        |         |       | 14:26 |  32.7 |
| COMPLETED Do not use underscores in ORM stereotypes                         |         |       |  0:13 |   0.5 |
| COMPLETED Add msbuild targets for ODB                                       |         |       |  3:49 |   8.6 |
| COMPLETED Add boilerplate for XML files                                     |         |       |  1:27 |   3.3 |
| COMPLETED Exceptions in C++ 98 have C++ 14 keywords                         |         |       |  0:32 |   1.2 |
| STARTED Allow users to override string prefixes in test data                |         |       |  1:52 |   4.2 |
| STARTED Ignore ODB files automatically                                      |         |       |  1:55 |   4.3 |
| STARTED Add a top-level "Visual Studio" knob                                |         |       |  0:33 |   1.2 |
| STARTED Add support for Visual Studio C++ projects                          |         |       |  1:17 |   2.9 |
