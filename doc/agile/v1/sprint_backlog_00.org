...
#+CAPTION: Clock summary at [2017-03-28 Tue 12:08]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *38:06* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 38:06   |       |       | 100.0 |
| Active                                                                      |         | 38:06 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:16 |   3.3 |
...
| COMPLETED Concepts cannot be placed inside of packages                      |         |       |  8:26 |  22.1 |
| COMPLETED Use =cxx= extension with ODB files                                |         |       |  0:32 |   1.4 |
| COMPLETED Implement the database model using Northwind                      |         |       |  6:11 |  16.2 |
| COMPLETED ODB options does not cater for types placed in namespaces         |         |       |  0:16 |   0.7 |
| COMPLETED Improve ODB implementation                                        |         |       | 14:26 |  37.9 |
| COMPLETED Do not use underscores in ORM stereotypes                         |         |       |  0:13 |   0.6 |
| STARTED Allow users to override string prefixes in test data                |         |       |  1:52 |   4.9 |
| STARTED Ignore ODB files automatically                                      |         |       |  1:55 |   5.0 |
| STARTED Add msbuild targets for ODB                                         |         |       |  1:32 |   4.0 |
