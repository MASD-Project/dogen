...
#+CAPTION: Clock summary at [2017-03-26 Sun 10:14]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                                     | 35:19   |       |       | 100.0 |
| Active                                                                      |         | 35:19 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:16 |   3.6 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:30 |   1.4 |
| COMPLETED Header directory is not part of housekeeping                      |         |       |  0:49 |   2.3 |
| COMPLETED Disable common support on ODB for a single database               |         |       |  0:08 |   0.4 |
| COMPLETED Concepts cannot be placed inside of packages                      |         |       |  8:26 |  23.9 |
| COMPLETED Use =cxx= extension with ODB files                                |         |       |  0:32 |   1.5 |
| COMPLETED Implement the database model using Northwind                      |         |       |  6:11 |  17.5 |
| COMPLETED ODB options does not cater for types placed in namespaces         |         |       |  0:16 |   0.8 |
| COMPLETED Improve ODB implementation                                        |         |       | 14:26 |  40.9 |
| COMPLETED Do not use underscores in ORM stereotypes                         |         |       |  0:13 |   0.6 |
| STARTED Allow users to override string prefixes in test data                |         |       |  0:37 |   1.7 |
| STARTED Ignore ODB files automatically                                      |         |       |  1:55 |   5.4 |
