...
#+CAPTION: Clock summary at [2017-03-30 Thu 06:57]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *44:38* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 44:38   |       |       | 100.0 |
| Active                                                                      |         | 44:38 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:16 |   2.8 |
...
| COMPLETED Concepts cannot be placed inside of packages                      |         |       |  8:26 |  18.9 |
| COMPLETED Use =cxx= extension with ODB files                                |         |       |  0:32 |   1.2 |
| COMPLETED Implement the database model using Northwind                      |         |       |  6:11 |  13.9 |
| COMPLETED ODB options does not cater for types placed in namespaces         |         |       |  0:16 |   0.6 |
| COMPLETED Improve ODB implementation                                        |         |       | 14:26 |  32.3 |
...
| STARTED Add support for Visual Studio C++ projects                          |         |       |  1:43 |   3.8 |
