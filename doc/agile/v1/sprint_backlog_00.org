...
#+CAPTION: Clock summary at [2017-03-29 Wed 22:17]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *43:40* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 43:40   |       |       | 100.0 |
| Active                                                                      |         | 43:40 |       | 100.0 |
...
| COMPLETED Concepts cannot be placed inside of packages                      |         |       |  8:26 |  19.3 |
| COMPLETED Use =cxx= extension with ODB files                                |         |       |  0:32 |   1.2 |
| COMPLETED Implement the database model using Northwind                      |         |       |  6:11 |  14.2 |
| COMPLETED ODB options does not cater for types placed in namespaces         |         |       |  0:16 |   0.6 |
| COMPLETED Improve ODB implementation                                        |         |       | 14:26 |  33.1 |
| COMPLETED Do not use underscores in ORM stereotypes                         |         |       |  0:13 |   0.5 |
| COMPLETED Add msbuild targets for ODB                                       |         |       |  3:49 |   8.7 |
| COMPLETED Add boilerplate for XML files                                     |         |       |  1:27 |   3.3 |
...
| STARTED Ignore ODB files automatically                                      |         |       |  1:55 |   4.4 |
| STARTED Add a top-level "Visual Studio" knob                                |         |       |  0:33 |   1.3 |
| STARTED Add support for Visual Studio C++ projects                          |         |       |  0:45 |   1.7 |
