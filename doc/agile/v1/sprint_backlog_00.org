...
#+CAPTION: Clock summary at [2017-03-25 Sat 20:28]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| COMPLETED Concepts cannot be placed inside of packages                      |         |       |  8:26 |  24.5 |
| COMPLETED Use =cxx= extension with ODB files                                |         |       |  0:32 |   1.5 |
| COMPLETED Implement the database model using Northwind                      |         |       |  6:11 |  18.0 |
| STARTED Allow users to override string prefixes in test data                |         |       |  0:37 |   1.8 |
| STARTED Ignore ODB files automatically                                      |         |       |  1:55 |   5.6 |
| STARTED Improve ODB implementation                                          |         |       | 14:26 |  41.9 |
