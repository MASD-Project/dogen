...
#+CAPTION: Clock summary at [2017-03-25 Sat 19:49]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| COMPLETED Concepts cannot be placed inside of packages                      |         |       |  8:26 |  25.0 |
| COMPLETED Use =cxx= extension with ODB files                                |         |       |  0:32 |   1.6 |
| COMPLETED Implement the database model using Northwind                      |         |       |  5:33 |  16.4 |
| STARTED Allow users to override string prefixes in test data                |         |       |  0:37 |   1.8 |
| STARTED Ignore ODB files automatically                                      |         |       |  1:55 |   5.7 |
| STARTED Improve ODB implementation                                          |         |       | 14:26 |  42.7 |
