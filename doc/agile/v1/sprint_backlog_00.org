...
#+CAPTION: Clock summary at [2017-03-28 Tue 13:15]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *39:11* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 39:11   |       |       | 100.0 |
| Active                                                                      |         | 39:11 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:16 |   3.2 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:30 |   1.3 |
| COMPLETED Header directory is not part of housekeeping                      |         |       |  0:49 |   2.1 |
| COMPLETED Disable common support on ODB for a single database               |         |       |  0:08 |   0.3 |
| COMPLETED Concepts cannot be placed inside of packages                      |         |       |  8:26 |  21.5 |
| COMPLETED Use =cxx= extension with ODB files                                |         |       |  0:32 |   1.4 |
| COMPLETED Implement the database model using Northwind                      |         |       |  6:11 |  15.8 |
| COMPLETED ODB options does not cater for types placed in namespaces         |         |       |  0:16 |   0.7 |
| COMPLETED Improve ODB implementation                                        |         |       | 14:26 |  36.8 |
| COMPLETED Do not use underscores in ORM stereotypes                         |         |       |  0:13 |   0.6 |
| STARTED Allow users to override string prefixes in test data                |         |       |  1:52 |   4.8 |
| STARTED Ignore ODB files automatically                                      |         |       |  1:55 |   4.9 |
| STARTED Add msbuild targets for ODB                                         |         |       |  2:37 |   6.7 |
