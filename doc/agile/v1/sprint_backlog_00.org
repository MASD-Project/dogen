...
#+CAPTION: Clock summary at [2017-03-29 Wed 06:57]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                                     | 42:23   |       |       | 100.0 |
| Active                                                                      |         | 42:23 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:49 |   4.3 |
...
| COMPLETED Concepts cannot be placed inside of packages                      |         |       |  8:26 |  19.9 |
| COMPLETED Use =cxx= extension with ODB files                                |         |       |  0:32 |   1.3 |
| COMPLETED Implement the database model using Northwind                      |         |       |  6:11 |  14.6 |
| COMPLETED ODB options does not cater for types placed in namespaces         |         |       |  0:16 |   0.6 |
| COMPLETED Improve ODB implementation                                        |         |       | 14:26 |  34.1 |
| COMPLETED Do not use underscores in ORM stereotypes                         |         |       |  0:13 |   0.5 |
| COMPLETED Add msbuild targets for ODB                                       |         |       |  3:49 |   9.0 |
| COMPLETED Add boilerplate for XML files                                     |         |       |  1:27 |   3.4 |
| STARTED Allow users to override string prefixes in test data                |         |       |  1:52 |   4.4 |
