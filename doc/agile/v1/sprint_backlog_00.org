...
#+CAPTION: Clock summary at [2017-03-25 Sat 22:52]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *35:06* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 35:06   |       |       | 100.0 |
| Active                                                                      |         | 35:06 |       | 100.0 |
...
| COMPLETED Concepts cannot be placed inside of packages                      |         |       |  8:26 |  24.0 |
| COMPLETED Use =cxx= extension with ODB files                                |         |       |  0:32 |   1.5 |
| COMPLETED Implement the database model using Northwind                      |         |       |  6:11 |  17.6 |
| COMPLETED ODB options does not cater for types placed in namespaces         |         |       |  0:16 |   0.8 |
| COMPLETED Improve ODB implementation                                        |         |       | 14:26 |  41.1 |
