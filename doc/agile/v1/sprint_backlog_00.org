...
#+CAPTION: Clock summary at [2017-03-28 Tue 11:19]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *37:18* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 37:18   |       |       | 100.0 |
| Active                                                                      |         | 37:18 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:16 |   3.4 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:30 |   1.3 |
| COMPLETED Header directory is not part of housekeeping                      |         |       |  0:49 |   2.2 |
| COMPLETED Disable common support on ODB for a single database               |         |       |  0:08 |   0.4 |
| COMPLETED Concepts cannot be placed inside of packages                      |         |       |  8:26 |  22.6 |
| COMPLETED Use =cxx= extension with ODB files                                |         |       |  0:32 |   1.4 |
| COMPLETED Implement the database model using Northwind                      |         |       |  6:11 |  16.6 |
| COMPLETED ODB options does not cater for types placed in namespaces         |         |       |  0:16 |   0.7 |
| COMPLETED Improve ODB implementation                                        |         |       | 14:26 |  38.7 |
| COMPLETED Do not use underscores in ORM stereotypes                         |         |       |  0:13 |   0.6 |
| STARTED Allow users to override string prefixes in test data                |         |       |  1:52 |   5.0 |
| STARTED Ignore ODB files automatically                                      |         |       |  1:55 |   5.1 |
| STARTED Add msbuild targets for ODB                                         |         |       |  0:44 |   2.0 |
...
*** STARTED Add msbuild targets for ODB                               :story:
