...
#+CAPTION: Clock summary at [2017-03-25 Sat 22:49]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *34:42* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 34:42   |       |       | 100.0 |
| Active                                                                      |         | 34:42 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:52 |   2.5 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:30 |   1.4 |
| COMPLETED Header directory is not part of housekeeping                      |         |       |  0:49 |   2.4 |
| COMPLETED Disable common support on ODB for a single database               |         |       |  0:08 |   0.4 |
| COMPLETED Concepts cannot be placed inside of packages                      |         |       |  8:26 |  24.3 |
| COMPLETED Use =cxx= extension with ODB files                                |         |       |  0:32 |   1.5 |
| COMPLETED Implement the database model using Northwind                      |         |       |  6:11 |  17.8 |
| COMPLETED ODB options does not cater for types placed in namespaces         |         |       |  0:16 |   0.8 |
| COMPLETED Improve ODB implementation                                        |         |       | 14:26 |  41.6 |
| STARTED Allow users to override string prefixes in test data                |         |       |  0:37 |   1.8 |
| STARTED Ignore ODB files automatically                                      |         |       |  1:55 |   5.5 |
