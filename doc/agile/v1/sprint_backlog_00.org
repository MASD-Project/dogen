...
#+CAPTION: Clock summary at [2017-03-29 Wed 18:20]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *43:04* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 43:04   |       |       | 100.0 |
| Active                                                                      |         | 43:04 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:16 |   2.9 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:30 |   1.2 |
| COMPLETED Header directory is not part of housekeeping                      |         |       |  0:49 |   1.9 |
| COMPLETED Disable common support on ODB for a single database               |         |       |  0:08 |   0.3 |
| COMPLETED Concepts cannot be placed inside of packages                      |         |       |  8:26 |  19.6 |
| COMPLETED Use =cxx= extension with ODB files                                |         |       |  0:32 |   1.2 |
| COMPLETED Implement the database model using Northwind                      |         |       |  6:11 |  14.4 |
| COMPLETED ODB options does not cater for types placed in namespaces         |         |       |  0:16 |   0.6 |
| COMPLETED Improve ODB implementation                                        |         |       | 14:26 |  33.5 |
| COMPLETED Do not use underscores in ORM stereotypes                         |         |       |  0:13 |   0.5 |
| COMPLETED Add msbuild targets for ODB                                       |         |       |  3:49 |   8.9 |
| COMPLETED Add boilerplate for XML files                                     |         |       |  1:27 |   3.4 |
| COMPLETED Exceptions in C++ 98 have C++ 14 keywords                         |         |       |  0:32 |   1.2 |
| STARTED Allow users to override string prefixes in test data                |         |       |  1:52 |   4.3 |
| STARTED Ignore ODB files automatically                                      |         |       |  1:55 |   4.5 |
| STARTED Add a top-level "Visual Studio" knob                                |         |       |  0:33 |   1.3 |
| STARTED Add support for Visual Studio C++ projects                          |         |       |  0:09 |   0.3 |
...
*** STARTED Add a top-level "Visual Studio" knob                      :story:
...
*** STARTED Add support for Visual Studio C++ projects                :story:
