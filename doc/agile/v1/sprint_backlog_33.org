...
#+CAPTION: Clock summary at [2023-01-06 Fri 23:06]
| <75>                                   |         |       |      |       |
| Headline                               | Time    |       |      |     % |
|----------------------------------------+---------+-------+------+-------|
...
| Stories                                | 12:26   |       |      | 100.0 |
| Active                                 |         | 12:26 |      | 100.0 |
| Edit release notes for previous sprint |         |       | 8:12 |  66.0 |
| Sprint and product backlog refinement  |         |       | 0:10 |   1.3 |
| Fullgen build is not running           |         |       | 0:43 |   5.8 |
| Update vcpkg to latest                 |         |       | 0:11 |   1.5 |
| OSX build is failing                   |         |       | 0:19 |   2.5 |
| Update emacs to latest                 |         |       | 0:54 |   7.2 |
| Nightlies failing with valgrind errors |         |       | 0:45 |   6.0 |
| Check last commit is broken            |         |       | 1:12 |   9.7 |
#+end:
