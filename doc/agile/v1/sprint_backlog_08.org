...
#+CAPTION: Clock summary at [2018-01-03 Wed 16:20]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *8:28* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 8:28   |      |      | 100.0 |
| Active                                                                      |        | 8:28 |      | 100.0 |
| STARTED Edit release notes for previous sprint                              |        |      | 4:32 |  53.5 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:11 |   2.2 |
| COMPLETED Write a blog post on previous sprint                              |        |      | 3:35 |  42.3 |
| COMPLETED Update Readme with links to blog posts                            |        |      | 0:10 |   2.0 |
...
The bulk of the work this sprint was yet again spent on
refactoring. Many a lesson was learned, as described in the brand new
section ```Commentary```. Think of this section as a blog post-like
format, reflecting on the lessons learned on the sprint.

The remainder was spent on infrastructural tasks such as fixing
travis, tests, rtags and so forth.
