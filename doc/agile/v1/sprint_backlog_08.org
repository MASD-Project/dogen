...
#+CAPTION: Clock summary at [2018-01-03 Wed 16:44]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *8:51* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 8:51   |      |      | 100.0 |
| Active                                                                      |        | 8:51 |      | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 4:55 |  55.6 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:11 |   2.1 |
| COMPLETED Write a blog post on previous sprint                              |        |      | 3:35 |  40.5 |
| COMPLETED Update Readme with links to blog posts                            |        |      | 0:10 |   1.9 |
