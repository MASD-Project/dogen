...
#+CAPTION: Clock summary at [2018-02-25 Sun 17:58]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *12:15* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 12:15   |       |      | 100.0 |
| Active                                                                      |         | 12:15 |      | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 4:55 |  40.1 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:11 |   1.5 |
| COMPLETED Write a blog post on previous sprint                              |         |       | 3:35 |  29.3 |
| COMPLETED Update Readme with links to blog posts                            |         |       | 0:10 |   1.4 |
| COMPLETED Rename stereotypes                                                |         |       | 0:35 |   4.8 |
| STARTED Create the =generation= model                                       |         |       | 2:49 |  23.0 |
...
*** Dogen does not generate ODB targets for primitives                :story:
