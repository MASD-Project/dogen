...
#+CAPTION: Clock summary at [2018-02-25 Sun 18:32]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *12:51* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 12:51   |       |      | 100.0 |
| Active                                                                      |         | 12:51 |      | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 4:55 |  38.3 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:11 |   1.4 |
| COMPLETED Write a blog post on previous sprint                              |         |       | 3:35 |  27.9 |
| COMPLETED Update Readme with links to blog posts                            |         |       | 0:10 |   1.3 |
| COMPLETED Rename stereotypes                                                |         |       | 0:35 |   4.5 |
| STARTED Create the =generation= model                                       |         |       | 2:49 |  21.9 |
| STARTED Dogen does not generate ODB targets for primitives                  |         |       | 0:36 |   4.7 |
...
*** STARTED Dogen does not generate ODB targets for primitives        :story:
