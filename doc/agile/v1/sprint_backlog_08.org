...
#+CAPTION: Clock summary at [2018-03-06 Tue 14:58]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *26:03* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 26:03   |       |       | 100.0 |
| Active                                                                      |         | 26:03 |       | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  4:55 |  18.9 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:11 |   0.7 |
| COMPLETED Write a blog post on previous sprint                              |         |       |  3:35 |  13.8 |
| COMPLETED Update Readme with links to blog posts                            |         |       |  0:10 |   0.6 |
| COMPLETED Rename stereotypes                                                |         |       |  0:35 |   2.2 |
| COMPLETED Dogen does not generate ODB targets for primitives                |         |       |  0:36 |   2.3 |
| STARTED Create the =generation= model                                       |         |       |  2:49 |  10.8 |
| STARTED Create a presentation on variability                                |         |       | 13:12 |  50.7 |
...
*** STARTED Create a presentation on variability                      :story:
    CLOCK: [2018-03-06 Tue 14:58]
...
*** Boost path serialisation errors                                   :story:
...
*** Fix typo in ODB error message                                     :story:
