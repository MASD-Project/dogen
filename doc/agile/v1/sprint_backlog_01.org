...
#+CAPTION: Clock summary at [2017-06-03 Sat 16:27]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *30:05* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 30:05   |       |       | 100.0 |
| Active                                                                      |         | 30:05 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  6:42 |  22.3 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:49 |   2.7 |
| COMPLETED Create a simple Emacs mode for stitch                             |         |       |  4:25 |  14.7 |
| COMPLETED WIX Path has changed on appveyor                                  |         |       |  0:09 |   0.5 |
| STARTED Add support for proper JSON serialisation in C++                    |         |       |  2:18 |   7.6 |
| STARTED Start documenting the theoretical aspects of Dogen                  |         |       | 10:49 |  36.0 |
| STARTED Move element segmentation into yarn                                 |         |       |  0:40 |   2.2 |
| STARTED Move decoration into yarn                                           |         |       |  4:13 |  14.0 |
