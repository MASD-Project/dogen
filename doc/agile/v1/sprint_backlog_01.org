...
#+CAPTION: Clock summary at [2017-06-02 Fri 17:37]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *28:41* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 28:41   |       |       | 100.0 |
| Active                                                                      |         | 28:41 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  6:42 |  23.4 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:49 |   2.8 |
| COMPLETED Create a simple Emacs mode for stitch                             |         |       |  4:25 |  15.4 |
| STARTED Add support for proper JSON serialisation in C++                    |         |       |  2:18 |   8.0 |
| STARTED Start documenting the theoretical aspects of Dogen                  |         |       | 10:49 |  37.7 |
| STARTED WIX Path has changed on appveyor                                    |         |       |  0:09 |   0.5 |
| STARTED Move element segmentation into yarn                                 |         |       |  0:40 |   2.3 |
| STARTED Move decoration into yarn                                           |         |       |  2:49 |   9.8 |
...
*** STARTED WIX Path has changed on appveyor                          :story:
...
*** STARTED Move decoration into yarn                                 :story:
...
- create a decoration expander based on external expansion
  interface. Add decoration element properties, etc.
