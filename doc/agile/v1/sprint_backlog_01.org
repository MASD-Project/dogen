...
#+CAPTION: Clock summary at [2017-06-04 Sun 17:38]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *33:34* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 33:34   |       |       | 100.0 |
| Active                                                                      |         | 33:34 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  6:42 |  20.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:49 |   2.4 |
| COMPLETED Create a simple Emacs mode for stitch                             |         |       |  4:25 |  13.2 |
| COMPLETED WIX Path has changed on appveyor                                  |         |       |  0:09 |   0.4 |
| STARTED Add support for proper JSON serialisation in C++                    |         |       |  2:18 |   6.9 |
| STARTED Start documenting the theoretical aspects of Dogen                  |         |       | 10:49 |  32.2 |
| STARTED Move element segmentation into yarn                                 |         |       |  0:40 |   2.0 |
| STARTED Move decoration into yarn                                           |         |       |  7:42 |  22.9 |
