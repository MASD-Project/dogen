...
#+CAPTION: Clock summary at [2017-06-02 Fri 11:56]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *25:52* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 25:52   |       |       | 100.0 |
| Active                                                                      |         | 25:52 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  6:42 |  25.9 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:49 |   3.2 |
| COMPLETED Create a simple Emacs mode for stitch                             |         |       |  4:25 |  17.1 |
| STARTED Add support for proper JSON serialisation in C++                    |         |       |  2:18 |   8.9 |
| STARTED Start documenting the theoretical aspects of Dogen                  |         |       | 10:49 |  41.8 |
| STARTED WIX Path has changed on appveyor                                    |         |       |  0:09 |   0.6 |
| STARTED Move element segmentation into yarn                                 |         |       |  0:40 |   2.6 |
...
*** Move decoration into yarn                                         :story:
