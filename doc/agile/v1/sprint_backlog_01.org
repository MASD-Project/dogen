...
#+CAPTION: Clock summary at [2017-06-30 Fri 13:33]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *44:01* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 44:01   |       |       | 100.0 |
| Active                                                                      |         | 44:01 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  6:42 |  15.2 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:49 |   1.9 |
| COMPLETED Create a simple Emacs mode for stitch                             |         |       |  4:25 |  10.0 |
| COMPLETED WIX Path has changed on appveyor                                  |         |       |  0:09 |   0.3 |
| COMPLETED Move decoration into yarn                                         |         |       |  8:38 |  19.6 |
| STARTED Add support for proper JSON serialisation in C++                    |         |       |  2:18 |   5.2 |
| STARTED Start documenting the theoretical aspects of Dogen                  |         |       | 10:49 |  24.6 |
| STARTED Move element segmentation into yarn                                 |         |       |  1:32 |   3.5 |
| STARTED Clean up yarn                                                       |         |       |  8:39 |  19.7 |
