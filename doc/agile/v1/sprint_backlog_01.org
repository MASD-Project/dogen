...
#+CAPTION: Clock summary at [2017-06-07 Wed 22:41]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *39:38* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 39:38   |       |       | 100.0 |
| Active                                                                      |         | 39:38 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  6:42 |  16.9 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:49 |   2.1 |
| COMPLETED Create a simple Emacs mode for stitch                             |         |       |  4:25 |  11.1 |
| COMPLETED WIX Path has changed on appveyor                                  |         |       |  0:09 |   0.4 |
| COMPLETED Move decoration into yarn                                         |         |       |  8:38 |  21.8 |
| STARTED Add support for proper JSON serialisation in C++                    |         |       |  2:18 |   5.8 |
| STARTED Start documenting the theoretical aspects of Dogen                  |         |       | 10:49 |  27.3 |
| STARTED Move element segmentation into yarn                                 |         |       |  1:32 |   3.9 |
| STARTED Clean up yarn                                                       |         |       |  4:16 |  10.8 |
