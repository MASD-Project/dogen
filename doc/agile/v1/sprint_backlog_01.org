...
#+CAPTION: Clock summary at [2017-06-04 Sun 17:19]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *33:04* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 33:04   |       |       | 100.0 |
| Active                                                                      |         | 33:04 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  6:42 |  20.3 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:49 |   2.5 |
| COMPLETED Create a simple Emacs mode for stitch                             |         |       |  4:25 |  13.4 |
| COMPLETED WIX Path has changed on appveyor                                  |         |       |  0:09 |   0.5 |
| STARTED Add support for proper JSON serialisation in C++                    |         |       |  2:18 |   7.0 |
| STARTED Start documenting the theoretical aspects of Dogen                  |         |       | 10:49 |  32.7 |
| STARTED Move element segmentation into yarn                                 |         |       |  0:40 |   2.0 |
| STARTED Move decoration into yarn                                           |         |       |  7:12 |  21.8 |
