...
#+CAPTION: Clock summary at [2017-06-02 Fri 14:11]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *26:52* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 26:52   |       |       | 100.0 |
| Active                                                                      |         | 26:52 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  6:42 |  24.9 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:49 |   3.0 |
| COMPLETED Create a simple Emacs mode for stitch                             |         |       |  4:25 |  16.4 |
| STARTED Add support for proper JSON serialisation in C++                    |         |       |  2:18 |   8.6 |
| STARTED Start documenting the theoretical aspects of Dogen                  |         |       | 10:49 |  40.3 |
| STARTED WIX Path has changed on appveyor                                    |         |       |  0:09 |   0.6 |
| STARTED Move element segmentation into yarn                                 |         |       |  0:40 |   2.5 |
| STARTED Move decoration into yarn                                           |         |       |  1:00 |   3.7 |
