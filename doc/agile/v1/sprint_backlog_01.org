...
#+CAPTION: Clock summary at [2017-06-04 Sun 17:45]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *33:44* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 33:44   |       |       | 100.0 |
| Active                                                                      |         | 33:44 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  6:42 |  19.9 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:49 |   2.4 |
| COMPLETED Create a simple Emacs mode for stitch                             |         |       |  4:25 |  13.1 |
| COMPLETED WIX Path has changed on appveyor                                  |         |       |  0:09 |   0.4 |
| STARTED Add support for proper JSON serialisation in C++                    |         |       |  2:18 |   6.8 |
| STARTED Start documenting the theoretical aspects of Dogen                  |         |       | 10:49 |  32.1 |
| STARTED Move element segmentation into yarn                                 |         |       |  0:40 |   2.0 |
| STARTED Move decoration into yarn                                           |         |       |  7:52 |  23.3 |
