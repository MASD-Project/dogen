...
#+CAPTION: Clock summary at [2017-04-26 Wed 21:53]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 12:09   |       |      | 100.0 |
| Active                                                                      |         | 12:09 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 5:17 |  43.5 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:49 |   6.7 |
| STARTED Add support for proper JSON serialisation in C++                    |         |       | 2:18 |  18.9 |
| STARTED Create a simple Emacs mode for stitch                               |         |       | 3:45 |  30.9 |
...
*** STARTED Create a simple Emacs mode for stitch                     :story:
