...
#+CAPTION: Clock summary at [2017-07-01 Sat 16:12]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *46:27* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 46:27   |       |       | 100.0 |
| Active                                                                      |         | 46:27 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  6:42 |  14.4 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:49 |   1.8 |
| COMPLETED Create a simple Emacs mode for stitch                             |         |       |  4:25 |   9.5 |
| COMPLETED WIX Path has changed on appveyor                                  |         |       |  0:09 |   0.3 |
| COMPLETED Move decoration into yarn                                         |         |       |  8:38 |  18.6 |
| COMPLETED Fix broken builds due to disk space                               |         |       |  1:32 |   3.3 |
| STARTED Add support for proper JSON serialisation in C++                    |         |       |  2:18 |   5.0 |
| STARTED Start documenting the theoretical aspects of Dogen                  |         |       | 10:49 |  23.3 |
| STARTED Move element segmentation into yarn                                 |         |       |  1:32 |   3.3 |
| STARTED Remove =is_target= from frontends                                   |         |       |  0:54 |   1.9 |
| STARTED Clean up yarn                                                       |         |       |  8:39 |  18.6 |
...
*** STARTED Remove =is_target= from frontends                         :story:
