...
#+CAPTION: Clock summary at [2017-07-28 Fri 13:03]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *22:07* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 22:07   |       |      | 100.0 |
| Active                                                                      |         | 22:07 |      | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:19 |   1.4 |
| STARTED Sprint and product backlog grooming                                 |         |       | 3:06 |  14.0 |
| COMPLETED Create a tagging checklist                                        |         |       | 0:07 |   0.5 |
| COMPLETED Tidy-up post-processing validation                                |         |       | 3:41 |  16.7 |
| COMPLETED Allow logging during initialisation                               |         |       | 1:16 |   5.7 |
| COMPLETED Refactor =yarn.dia=                                               |         |       | 1:39 |   7.5 |
| COMPLETED Add meta-type support to yarn                                     |         |       | 9:34 |  43.3 |
| STARTED Rename =meta_type= in JSON                                          |         |       | 0:19 |   1.4 |
| STARTED Add canonical archetype support to yarn                             |         |       | 0:47 |   3.5 |
| STARTED Move external module processing into yarn                           |         |       | 0:55 |   4.1 |
| STARTED Use the archetype locations repository in yarn                      |         |       | 0:24 |   1.8 |
...
*** STARTED Use the archetype locations repository in yarn            :story:
