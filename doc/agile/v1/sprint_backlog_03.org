...
#+CAPTION: Clock summary at [2017-07-28 Fri 10:33]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| STARTED Sprint and product backlog grooming                                 |         |       | 2:51 |  14.4 |
| COMPLETED Create a tagging checklist                                        |         |       | 0:07 |   0.6 |
| COMPLETED Tidy-up post-processing validation                                |         |       | 3:41 |  18.6 |
| COMPLETED Allow logging during initialisation                               |         |       | 1:16 |   6.4 |
| STARTED Rename =meta_type= in JSON                                          |         |       | 0:19 |   1.6 |
| STARTED Add canonical archetype support to yarn                             |         |       | 0:47 |   4.0 |
| STARTED Add meta-type support to yarn                                       |         |       | 9:34 |  48.3 |
| STARTED Move external module processing into yarn                           |         |       | 0:55 |   4.6 |
...
*** Remove reducer in yarn.dia                                        :story:

Use =std::remove_if= instead.
