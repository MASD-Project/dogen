...
#+CAPTION: Clock summary at [2017-07-30 Sun 20:39]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| COMPLETED Tidy-up post-processing validation                                |         |       | 3:41 |  12.8 |
| COMPLETED Allow logging during initialisation                               |         |       | 1:16 |   4.4 |
| COMPLETED Refactor =yarn.dia=                                               |         |       | 1:39 |   5.7 |
| COMPLETED Add meta-type support to yarn                                     |         |       | 9:34 |  33.2 |
...
| STARTED Create an exogenous model                                           |         |       | 5:24 |  18.8 |
