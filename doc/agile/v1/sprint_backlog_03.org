...
#+CAPTION: Clock summary at [2017-07-30 Sun 11:12]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| STARTED Sprint and product backlog grooming                                 |         |       | 3:06 |  11.7 |
| COMPLETED Create a tagging checklist                                        |         |       | 0:07 |   0.4 |
| COMPLETED Tidy-up post-processing validation                                |         |       | 3:41 |  13.9 |
| COMPLETED Allow logging during initialisation                               |         |       | 1:16 |   4.8 |
| COMPLETED Refactor =yarn.dia=                                               |         |       | 1:39 |   6.2 |
| COMPLETED Add meta-type support to yarn                                     |         |       | 9:34 |  36.0 |
| COMPLETED Use the archetype locations repository in yarn                    |         |       | 1:16 |   4.8 |
| STARTED Rename =meta_type= in JSON                                          |         |       | 0:19 |   1.2 |
| STARTED Add canonical archetype support to yarn                             |         |       | 1:11 |   4.5 |
| STARTED Move external module processing into yarn                           |         |       | 0:55 |   3.4 |
| STARTED Create an exogenous model                                           |         |       | 3:12 |  12.0 |
