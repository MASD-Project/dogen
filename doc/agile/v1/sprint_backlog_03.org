...
#+CAPTION: Clock summary at [2017-07-28 Fri 16:43]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| STARTED Sprint and product backlog grooming                                 |         |       | 3:06 |  13.3 |
| COMPLETED Create a tagging checklist                                        |         |       | 0:07 |   0.5 |
| COMPLETED Tidy-up post-processing validation                                |         |       | 3:41 |  15.8 |
| COMPLETED Allow logging during initialisation                               |         |       | 1:16 |   5.4 |
| COMPLETED Refactor =yarn.dia=                                               |         |       | 1:39 |   7.1 |
| COMPLETED Add meta-type support to yarn                                     |         |       | 9:34 |  40.9 |
| COMPLETED Use the archetype locations repository in yarn                    |         |       | 1:16 |   5.4 |
| STARTED Rename =meta_type= in JSON                                          |         |       | 0:19 |   1.4 |
| STARTED Add canonical archetype support to yarn                             |         |       | 1:11 |   5.1 |
