...
#+CAPTION: Clock summary at [2017-07-23 Sun 12:17]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
...
| STARTED Sprint and product backlog grooming                                 |        |      | 1:05 |  14.5 |
| COMPLETED Create a tagging checklist                                        |        |      | 0:07 |   1.6 |
| STARTED Add meta-type support to yarn                                       |        |      | 4:30 |  60.3 |
| STARTED Add canonical archetype support to yarn                             |        |      | 0:47 |  10.5 |
| STARTED Tidy-up post-processing validation                                  |        |      | 0:40 |   8.9 |
