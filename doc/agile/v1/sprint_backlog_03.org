...
#+CAPTION: Clock summary at [2017-07-28 Fri 16:19]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| STARTED Sprint and product backlog grooming                                 |         |       | 3:06 |  13.5 |
| COMPLETED Create a tagging checklist                                        |         |       | 0:07 |   0.5 |
| COMPLETED Tidy-up post-processing validation                                |         |       | 3:41 |  16.0 |
| COMPLETED Allow logging during initialisation                               |         |       | 1:16 |   5.5 |
| COMPLETED Refactor =yarn.dia=                                               |         |       | 1:39 |   7.2 |
| COMPLETED Add meta-type support to yarn                                     |         |       | 9:34 |  41.6 |
| COMPLETED Use the archetype locations repository in yarn                    |         |       | 1:16 |   5.5 |
| STARTED Rename =meta_type= in JSON                                          |         |       | 0:19 |   1.4 |
| STARTED Add canonical archetype support to yarn                             |         |       | 0:47 |   3.4 |
| STARTED Move external module processing into yarn                           |         |       | 0:55 |   4.0 |
