...
#+CAPTION: Clock summary at [2017-07-19 Wed 21:07]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *5:33* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 5:33   |      |      | 100.0 |
| Active                                                                      |        | 5:33 |      | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 0:19 |   5.7 |
| STARTED Sprint and product backlog grooming                                 |        |      | 1:05 |  19.5 |
| COMPLETED Create a tagging checklist                                        |        |      | 0:07 |   2.1 |
| STARTED Add meta-type support to yarn                                       |        |      | 3:15 |  58.6 |
| STARTED Add canonical archetype support to yarn                             |        |      | 0:47 |  14.1 |
