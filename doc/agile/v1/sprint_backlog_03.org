...
#+CAPTION: Clock summary at [2017-08-01 Tue 20:34]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| STARTED Sprint and product backlog grooming                                 |         |       | 3:06 |  10.2 |
...
| STARTED Rename =meta_type= in JSON                                          |         |       | 0:19 |   1.0 |
| STARTED Add canonical archetype support to yarn                             |         |       | 1:11 |   3.9 |
| STARTED Move external module processing into yarn                           |         |       | 0:55 |   3.0 |
| STARTED Create an exogenous model                                           |         |       | 6:55 |  22.8 |
