...
#+CAPTION: Clock summary at [2017-07-19 Wed 20:04]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *4:33* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 4:33   |      |      | 100.0 |
| Active                                                                      |        | 4:33 |      | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 0:19 |   7.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 1:05 |  23.8 |
| COMPLETED Create a tagging checklist                                        |        |      | 0:07 |   2.6 |
| STARTED Add meta-type support to yarn                                       |        |      | 2:15 |  49.5 |
| STARTED Add canonical archetype support to yarn                             |        |      | 0:47 |  17.2 |
