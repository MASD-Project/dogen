...
#+CAPTION: Clock summary at [2017-07-28 Fri 12:06]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| STARTED Sprint and product backlog grooming                                 |         |       | 2:51 |  13.4 |
| COMPLETED Create a tagging checklist                                        |         |       | 0:07 |   0.5 |
| COMPLETED Tidy-up post-processing validation                                |         |       | 3:41 |  17.3 |
| COMPLETED Allow logging during initialisation                               |         |       | 1:16 |   6.0 |
| COMPLETED Refactor =yarn.dia=                                               |         |       | 1:25 |   6.7 |
| STARTED Rename =meta_type= in JSON                                          |         |       | 0:19 |   1.5 |
| STARTED Add canonical archetype support to yarn                             |         |       | 0:47 |   3.7 |
| STARTED Add meta-type support to yarn                                       |         |       | 9:34 |  45.1 |
