...
#+CAPTION: Clock summary at [2017-07-30 Sun 11:30]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *27:00* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 27:00   |       |      | 100.0 |
| Active                                                                      |         | 27:00 |      | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:19 |   1.2 |
| STARTED Sprint and product backlog grooming                                 |         |       | 3:06 |  11.5 |
| COMPLETED Create a tagging checklist                                        |         |       | 0:07 |   0.4 |
| COMPLETED Tidy-up post-processing validation                                |         |       | 3:41 |  13.6 |
| COMPLETED Allow logging during initialisation                               |         |       | 1:16 |   4.7 |
| COMPLETED Refactor =yarn.dia=                                               |         |       | 1:39 |   6.1 |
| COMPLETED Add meta-type support to yarn                                     |         |       | 9:34 |  35.4 |
| COMPLETED Use the archetype locations repository in yarn                    |         |       | 1:16 |   4.7 |
| STARTED Rename =meta_type= in JSON                                          |         |       | 0:19 |   1.2 |
| STARTED Add canonical archetype support to yarn                             |         |       | 1:11 |   4.4 |
| STARTED Move external module processing into yarn                           |         |       | 0:55 |   3.4 |
| STARTED Create an exogenous model                                           |         |       | 3:37 |  13.4 |
