...
#+CAPTION: Clock summary at [2017-07-30 Sun 18:52]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *27:49* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 27:49   |       |      | 100.0 |
| Active                                                                      |         | 27:49 |      | 100.0 |
...
| COMPLETED Allow logging during initialisation                               |         |       | 1:16 |   4.6 |
| COMPLETED Refactor =yarn.dia=                                               |         |       | 1:39 |   5.9 |
| COMPLETED Add meta-type support to yarn                                     |         |       | 9:34 |  34.4 |
| COMPLETED Use the archetype locations repository in yarn                    |         |       | 1:16 |   4.6 |
| STARTED Rename =meta_type= in JSON                                          |         |       | 0:19 |   1.1 |
| STARTED Add canonical archetype support to yarn                             |         |       | 1:11 |   4.3 |
| STARTED Move external module processing into yarn                           |         |       | 0:55 |   3.3 |
| STARTED Create an exogenous model                                           |         |       | 4:26 |  15.9 |
