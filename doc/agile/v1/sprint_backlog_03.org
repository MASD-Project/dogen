...
#+CAPTION: Clock summary at [2017-07-29 Sat 18:01]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| STARTED Sprint and product backlog grooming                                 |         |       | 3:06 |  12.1 |
| COMPLETED Create a tagging checklist                                        |         |       | 0:07 |   0.5 |
| COMPLETED Tidy-up post-processing validation                                |         |       | 3:41 |  14.4 |
| COMPLETED Allow logging during initialisation                               |         |       | 1:16 |   4.9 |
| COMPLETED Refactor =yarn.dia=                                               |         |       | 1:39 |   6.4 |
| COMPLETED Add meta-type support to yarn                                     |         |       | 9:34 |  37.4 |
...
| STARTED Create an exogenous model                                           |         |       | 2:13 |   8.7 |
