...
#+CAPTION: Clock summary at [2017-07-27 Thu 07:32]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *19:17* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 19:17   |       |      | 100.0 |
| Active                                                                      |         | 19:17 |      | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:19 |   1.6 |
| STARTED Sprint and product backlog grooming                                 |         |       | 2:19 |  12.0 |
| COMPLETED Create a tagging checklist                                        |         |       | 0:07 |   0.6 |
| COMPLETED Tidy-up post-processing validation                                |         |       | 3:41 |  19.1 |
| COMPLETED Allow logging during initialisation                               |         |       | 1:16 |   6.6 |
| STARTED Rename =meta_type= in JSON                                          |         |       | 0:19 |   1.6 |
| STARTED Add canonical archetype support to yarn                             |         |       | 0:47 |   4.1 |
| STARTED Add meta-type support to yarn                                       |         |       | 9:34 |  49.6 |
| STARTED Move external module processing into yarn                           |         |       | 0:55 |   4.8 |
