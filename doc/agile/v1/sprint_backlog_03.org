...
#+CAPTION: Clock summary at [2017-07-19 Wed 19:20]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *3:54* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 3:54   |      |      | 100.0 |
| Active                                                                      |        | 3:54 |      | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 0:19 |   8.1 |
| STARTED Sprint and product backlog grooming                                 |        |      | 1:05 |  27.8 |
| COMPLETED Create a tagging checklist                                        |        |      | 0:07 |   3.0 |
| STARTED Add meta-type support to yarn                                       |        |      | 1:36 |  41.0 |
| STARTED Add canonical archetype support to yarn                             |        |      | 0:47 |  20.1 |
