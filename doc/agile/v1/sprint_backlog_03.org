...
#+CAPTION: Clock summary at [2017-07-28 Fri 12:37]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *21:43* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 21:43   |       |      | 100.0 |
| Active                                                                      |         | 21:43 |      | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:19 |   1.5 |
| STARTED Sprint and product backlog grooming                                 |         |       | 3:06 |  14.3 |
| COMPLETED Create a tagging checklist                                        |         |       | 0:07 |   0.5 |
| COMPLETED Tidy-up post-processing validation                                |         |       | 3:41 |  17.0 |
| COMPLETED Allow logging during initialisation                               |         |       | 1:16 |   5.8 |
| COMPLETED Refactor =yarn.dia=                                               |         |       | 1:39 |   7.6 |
| COMPLETED Add meta-type support to yarn                                     |         |       | 9:34 |  44.1 |
| STARTED Rename =meta_type= in JSON                                          |         |       | 0:19 |   1.5 |
| STARTED Add canonical archetype support to yarn                             |         |       | 0:47 |   3.6 |
| STARTED Move external module processing into yarn                           |         |       | 0:55 |   4.2 |
...
*** Use the archetype locations repository in yarn                    :story:
