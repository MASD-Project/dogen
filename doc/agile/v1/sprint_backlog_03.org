...
#+CAPTION: Clock summary at [2017-07-29 Sat 18:26]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| STARTED Sprint and product backlog grooming                                 |         |       | 3:06 |  12.0 |
| COMPLETED Create a tagging checklist                                        |         |       | 0:07 |   0.5 |
| COMPLETED Tidy-up post-processing validation                                |         |       | 3:41 |  14.3 |
| COMPLETED Allow logging during initialisation                               |         |       | 1:16 |   4.9 |
| COMPLETED Refactor =yarn.dia=                                               |         |       | 1:39 |   6.4 |
| COMPLETED Add meta-type support to yarn                                     |         |       | 9:34 |  37.1 |
| COMPLETED Use the archetype locations repository in yarn                    |         |       | 1:16 |   4.9 |
| STARTED Rename =meta_type= in JSON                                          |         |       | 0:19 |   1.2 |
| STARTED Add canonical archetype support to yarn                             |         |       | 1:11 |   4.6 |
| STARTED Move external module processing into yarn                           |         |       | 0:55 |   3.6 |
| STARTED Create an exogenous model                                           |         |       | 2:23 |   9.2 |
