...
#+CAPTION: Clock summary at [2017-07-25 Tue 18:31]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| STARTED Sprint and product backlog grooming                                 |         |       | 1:18 |   9.5 |
| COMPLETED Create a tagging checklist                                        |         |       | 0:07 |   0.8 |
| COMPLETED Tidy-up post-processing validation                                |         |       | 3:41 |  26.8 |
| COMPLETED Allow logging during initialisation                               |         |       | 1:16 |   9.2 |
| STARTED Add meta-type support to yarn                                       |         |       | 6:17 |  45.7 |
| STARTED Add canonical archetype support to yarn                             |         |       | 0:47 |   5.7 |
