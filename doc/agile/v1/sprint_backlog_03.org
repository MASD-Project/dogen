...
#+CAPTION: Clock summary at [2017-07-20 Thu 07:19]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *6:15* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 6:15   |      |      | 100.0 |
| Active                                                                      |        | 6:15 |      | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 0:19 |   5.1 |
| STARTED Sprint and product backlog grooming                                 |        |      | 1:05 |  17.3 |
| COMPLETED Create a tagging checklist                                        |        |      | 0:07 |   1.9 |
| STARTED Add meta-type support to yarn                                       |        |      | 3:29 |  55.7 |
| STARTED Add canonical archetype support to yarn                             |        |      | 0:47 |  12.5 |
| STARTED Tidy-up post-processing validation                                  |        |      | 0:28 |   7.5 |
