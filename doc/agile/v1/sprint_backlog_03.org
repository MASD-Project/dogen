...
#+CAPTION: Clock summary at [2017-07-23 Sun 17:34]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| STARTED Sprint and product backlog grooming                                 |         |       | 1:18 |  11.3 |
| COMPLETED Create a tagging checklist                                        |         |       | 0:07 |   1.0 |
| COMPLETED Tidy-up post-processing validation                                |         |       | 3:41 |  32.1 |
| STARTED Add meta-type support to yarn                                       |         |       | 5:17 |  46.0 |
| STARTED Add canonical archetype support to yarn                             |         |       | 0:47 |   6.8 |
