...
#+CAPTION: Clock summary at [2017-07-23 Sun 12:48]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *7:57* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 7:57   |      |      | 100.0 |
| Active                                                                      |        | 7:57 |      | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 0:19 |   4.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 1:05 |  13.6 |
| COMPLETED Create a tagging checklist                                        |        |      | 0:07 |   1.5 |
| STARTED Add meta-type support to yarn                                       |        |      | 3:29 |  43.8 |
| STARTED Add canonical archetype support to yarn                             |        |      | 0:47 |   9.9 |
| STARTED Tidy-up post-processing validation                                  |        |      | 2:10 |  27.3 |
