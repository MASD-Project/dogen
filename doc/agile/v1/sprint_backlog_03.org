...
#+CAPTION: Clock summary at [2017-07-20 Thu 07:32]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
...
| STARTED Sprint and product backlog grooming                                 |        |      | 1:05 |  16.8 |
| COMPLETED Create a tagging checklist                                        |        |      | 0:07 |   1.8 |
| STARTED Add meta-type support to yarn                                       |        |      | 3:29 |  54.0 |
| STARTED Add canonical archetype support to yarn                             |        |      | 0:47 |  12.1 |
| STARTED Tidy-up post-processing validation                                  |        |      | 0:40 |  10.3 |
