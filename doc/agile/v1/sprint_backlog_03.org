...
#+CAPTION: Clock summary at [2017-07-28 Fri 23:40]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *23:42* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 23:42   |       |      | 100.0 |
| Active                                                                      |         | 23:42 |      | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:19 |   1.3 |
| STARTED Sprint and product backlog grooming                                 |         |       | 3:06 |  13.1 |
| COMPLETED Create a tagging checklist                                        |         |       | 0:07 |   0.5 |
| COMPLETED Tidy-up post-processing validation                                |         |       | 3:41 |  15.5 |
| COMPLETED Allow logging during initialisation                               |         |       | 1:16 |   5.3 |
| COMPLETED Refactor =yarn.dia=                                               |         |       | 1:39 |   7.0 |
| COMPLETED Add meta-type support to yarn                                     |         |       | 9:34 |  40.4 |
| COMPLETED Use the archetype locations repository in yarn                    |         |       | 1:16 |   5.3 |
| STARTED Rename =meta_type= in JSON                                          |         |       | 0:19 |   1.3 |
| STARTED Add canonical archetype support to yarn                             |         |       | 1:11 |   5.0 |
| STARTED Move external module processing into yarn                           |         |       | 0:55 |   3.9 |
| STARTED Create an exogenous model                                           |         |       | 0:19 |   1.3 |
