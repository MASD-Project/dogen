...
#+CAPTION: Clock summary at [2017-07-30 Sun 20:27]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *28:36* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 28:36   |       |      | 100.0 |
| Active                                                                      |         | 28:36 |      | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:19 |   1.1 |
| STARTED Sprint and product backlog grooming                                 |         |       | 3:06 |  10.8 |
| COMPLETED Create a tagging checklist                                        |         |       | 0:07 |   0.4 |
| COMPLETED Tidy-up post-processing validation                                |         |       | 3:41 |  12.9 |
| COMPLETED Allow logging during initialisation                               |         |       | 1:16 |   4.4 |
| COMPLETED Refactor =yarn.dia=                                               |         |       | 1:39 |   5.8 |
| COMPLETED Add meta-type support to yarn                                     |         |       | 9:34 |  33.4 |
| COMPLETED Use the archetype locations repository in yarn                    |         |       | 1:16 |   4.4 |
| STARTED Rename =meta_type= in JSON                                          |         |       | 0:19 |   1.1 |
| STARTED Add canonical archetype support to yarn                             |         |       | 1:11 |   4.1 |
| STARTED Move external module processing into yarn                           |         |       | 0:55 |   3.2 |
| STARTED Create an exogenous model                                           |         |       | 5:13 |  18.2 |
