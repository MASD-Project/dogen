...
#+CAPTION: Clock summary at [2017-07-23 Sun 15:45]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *9:41* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 9:41   |      |      | 100.0 |
| Active                                                                      |        | 9:41 |      | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 0:19 |   3.3 |
| STARTED Sprint and product backlog grooming                                 |        |      | 1:18 |  13.4 |
| COMPLETED Create a tagging checklist                                        |        |      | 0:07 |   1.2 |
| COMPLETED Tidy-up post-processing validation                                |        |      | 3:41 |  38.0 |
| STARTED Add meta-type support to yarn                                       |        |      | 3:29 |  36.0 |
| STARTED Add canonical archetype support to yarn                             |        |      | 0:47 |   8.1 |
