...
#+CAPTION: Clock summary at [2017-07-25 Tue 23:59]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| STARTED Sprint and product backlog grooming                                 |         |       | 1:18 |   7.9 |
| COMPLETED Create a tagging checklist                                        |         |       | 0:07 |   0.7 |
| COMPLETED Tidy-up post-processing validation                                |         |       | 3:41 |  22.3 |
| COMPLETED Allow logging during initialisation                               |         |       | 1:16 |   7.7 |
| STARTED Add canonical archetype support to yarn                             |         |       | 0:47 |   4.7 |
| STARTED Add meta-type support to yarn                                       |         |       | 9:03 |  54.8 |
