...
#+CAPTION: Clock summary at [2017-07-26 Wed 22:16]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| STARTED Sprint and product backlog grooming                                 |         |       | 1:34 |   9.1 |
| COMPLETED Create a tagging checklist                                        |         |       | 0:07 |   0.7 |
| COMPLETED Tidy-up post-processing validation                                |         |       | 3:41 |  21.3 |
| COMPLETED Allow logging during initialisation                               |         |       | 1:16 |   7.3 |
| STARTED Add canonical archetype support to yarn                             |         |       | 0:47 |   4.5 |
| STARTED Add meta-type support to yarn                                       |         |       | 9:34 |  55.3 |
