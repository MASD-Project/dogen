...
#+CAPTION: Clock summary at [2017-07-17 Mon 21:05]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
...
| Stories                                                                     | 0:32   |      |      | 100.0 |
| Active                                                                      |        | 0:32 |      | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 0:19 |  59.4 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:13 |  40.6 |
...
*** Create a tagging checklist                                        :story:
...
- sign tag with key.
- write release notes.
- open new sprint, updating CMake version, appveyor version
