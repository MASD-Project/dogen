...
#+CAPTION: Clock summary at [2019-04-19 Fri 16:14]
| <75>                                                              |         |       |       |       |
| Headline                                                          | Time    |       |       |     % |
|-------------------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                           | 70:21   |       |       | 100.0 |
| Active                                                            |         | 70:21 |       | 100.0 |
| Edit release notes for previous sprint                            |         |       |  4:21 |   6.2 |
| Sprint and product backlog grooming                               |         |       |  7:06 |  10.1 |
| Create a video demo for the previous sprint's features            |         |       |  1:35 |   2.3 |
| Fix issues with emacs                                             |         |       |  2:01 |   2.9 |
| Fix issues with nightly build                                     |         |       |  0:08 |   0.2 |
| Add diffing support to string asserter                            |         |       |  1:00 |   1.4 |
| C# generation is borked                                           |         |       |  4:12 |   6.0 |
| Reactivate the boilerplate tests                                  |         |       |  5:58 |   8.5 |
| Update to clang8                                                  |         |       |  0:11 |   0.3 |
| Do not hard-code static library generation                        |         |       |  1:01 |   1.4 |
| Nursing nightlies                                                 |         |       |  0:49 |   1.2 |
| Fix snags with emacs                                              |         |       |  6:00 |   8.5 |
| Profiles as meta-model elements                                   |         |       |  8:01 |  11.4 |
| Redesign annotations model                                        |         |       | 27:55 |  39.7 |
| Generated models should support both static and dynamic libraries |         |       |  0:03 |   0.1 |
...
*** STARTED Generated models should support both static and dynamic libraries :story:
    :LOGBOOK:
