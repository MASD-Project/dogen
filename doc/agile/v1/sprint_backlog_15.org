...
#+CAPTION: Clock summary at [2019-04-19 Fri 17:01]
| <75>                                                              |         |       |       |       |
| Headline                                                          | Time    |       |       |     % |
|-------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                      | *71:05* |       |       | 100.0 |
|-------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                           | 71:05   |       |       | 100.0 |
| Active                                                            |         | 71:05 |       | 100.0 |
| Edit release notes for previous sprint                            |         |       |  4:21 |   6.1 |
| Sprint and product backlog grooming                               |         |       |  7:06 |  10.0 |
| Create a video demo for the previous sprint's features            |         |       |  1:35 |   2.2 |
| Fix issues with emacs                                             |         |       |  2:01 |   2.8 |
| Fix issues with nightly build                                     |         |       |  0:08 |   0.2 |
| Add diffing support to string asserter                            |         |       |  1:00 |   1.4 |
| C# generation is borked                                           |         |       |  4:12 |   5.9 |
| Reactivate the boilerplate tests                                  |         |       |  5:58 |   8.4 |
...
| Fix cmake emacs variable for tab width                            |         |       |  0:38 |   0.9 |
| Nursing nightlies                                                 |         |       |  0:49 |   1.1 |
| Fix snags with emacs                                              |         |       |  6:00 |   8.4 |
| Profiles as meta-model elements                                   |         |       |  8:01 |  11.3 |
| Redesign annotations model                                        |         |       | 27:55 |  39.3 |
