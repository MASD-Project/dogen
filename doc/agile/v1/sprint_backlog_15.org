...
#+CAPTION: Clock summary at [2019-04-19 Fri 20:32]
| <75>                                                              |         |       |       |       |
| Headline                                                          | Time    |       |       |     % |
|-------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                      | *73:50* |       |       | 100.0 |
|-------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                           | 73:50   |       |       | 100.0 |
| Active                                                            |         | 73:50 |       | 100.0 |
| Edit release notes for previous sprint                            |         |       |  4:21 |   5.9 |
| Sprint and product backlog grooming                               |         |       |  7:06 |   9.6 |
| Create a video demo for the previous sprint's features            |         |       |  1:35 |   2.1 |
| Fix issues with emacs                                             |         |       |  2:01 |   2.7 |
| Fix issues with nightly build                                     |         |       |  0:08 |   0.2 |
| Add diffing support to string asserter                            |         |       |  1:00 |   1.4 |
| C# generation is borked                                           |         |       |  4:12 |   5.7 |
| Reactivate the boilerplate tests                                  |         |       |  5:58 |   8.1 |
...
| Fix snags with emacs                                              |         |       |  6:00 |   8.1 |
| Profiles as meta-model elements                                   |         |       |  8:01 |  10.9 |
| Redesign annotations model                                        |         |       | 30:40 |  41.5 |
