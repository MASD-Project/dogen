...
#+CAPTION: Clock summary at [2020-03-10 Tue 12:04]
| <75>                                                    |         |       |      |       |
| Headline                                                | Time    |       |      |     % |
|---------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                            | *36:56* |       |      | 100.0 |
|---------------------------------------------------------+---------+-------+------+-------|
| Stories                                                 | 36:56   |       |      | 100.0 |
| Active                                                  |         | 36:56 |      | 100.0 |
| Edit release notes for previous sprint                  |         |       | 4:11 |  11.3 |
| Create a demo and presentation for previous sprint      |         |       | 0:25 |   1.1 |
| Sprint and product backlog grooming                     |         |       | 4:56 |  13.4 |
| Analysis on defining a combined logical-physical space  |         |       | 5:55 |  16.0 |
| Analysis on removing physical references in variability |         |       | 5:27 |  14.8 |
| Remove =rapidjson= formatters                           |         |       | 0:03 |   0.1 |
| Separate feature templates from bundles                 |         |       | 9:28 |  25.6 |
| Move enabled to generation                              |         |       | 0:04 |   0.2 |
| Create a chain to encapsulate variability transforms    |         |       | 0:37 |   1.7 |
| Split profiles and profile templates in variability     |         |       | 2:01 |   5.5 |
| Move profile meta-data into profile element             |         |       | 3:06 |   8.4 |
| Add location and modules to variability                 |         |       | 0:43 |   1.9 |
