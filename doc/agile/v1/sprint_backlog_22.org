...
#+CAPTION: Clock summary at [2020-03-02 Mon 18:02]
| <75>                                               |         |       |      |       |
| Headline                                           | Time    |       |      |     % |
|----------------------------------------------------+---------+-------+------+-------|
| *Total time*                                       | *11:58* |       |      | 100.0 |
|----------------------------------------------------+---------+-------+------+-------|
| Stories                                            | 11:58   |       |      | 100.0 |
| Active                                             |         | 11:58 |      | 100.0 |
| Edit release notes for previous sprint             |         |       | 4:11 |  35.0 |
| Create a demo and presentation for previous sprint |         |       | 0:25 |   3.5 |
| Sprint and product backlog grooming                |         |       | 2:50 |  23.7 |
| Define a combined logical-physical space           |         |       | 4:14 |  35.4 |
| Create meta-model elements for location            |         |       | 0:18 |   2.5 |
...
*** STARTED Create meta-model elements for location                   :story:
    :LOGBOOK:
