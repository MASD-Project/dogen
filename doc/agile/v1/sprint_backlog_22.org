...
#+CAPTION: Clock summary at [2020-03-12 Thu 09:13]
| <75>                                                    |         |       |      |       |
| Headline                                                | Time    |       |      |     % |
|---------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                            | *51:19* |       |      | 100.0 |
|---------------------------------------------------------+---------+-------+------+-------|
| Stories                                                 | 51:19   |       |      | 100.0 |
| Active                                                  |         | 51:19 |      | 100.0 |
| Edit release notes for previous sprint                  |         |       | 4:11 |   8.2 |
| Create a demo and presentation for previous sprint      |         |       | 0:25 |   0.8 |
| Sprint and product backlog grooming                     |         |       | 6:38 |  12.9 |
| Analysis on defining a combined logical-physical space  |         |       | 5:55 |  11.5 |
| Analysis on removing physical references in variability |         |       | 5:27 |  10.6 |
| Remove =rapidjson= formatters                           |         |       | 0:03 |   0.1 |
| Separate feature templates from bundles                 |         |       | 9:28 |  18.4 |
| Move enabled to generation                              |         |       | 0:04 |   0.1 |
| Create a chain to encapsulate variability transforms    |         |       | 0:37 |   1.2 |
| Move variability chain into assets                      |         |       | 2:22 |   4.6 |
| Move profile meta-data into profile element             |         |       | 7:12 |  14.0 |
| Add handcrafted stereotype to C# models                 |         |       | 0:04 |   0.1 |
| Split profiles and profile templates in variability     |         |       | 4:31 |   8.8 |
| Consider renaming labels to stereotypes in variability  |         |       | 1:07 |   2.2 |
| Add location and modules to variability                 |         |       | 0:43 |   1.4 |
| Implement template instantiation in terms of tags       |         |       | 2:32 |   4.9 |
