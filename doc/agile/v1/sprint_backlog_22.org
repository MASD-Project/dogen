...
#+CAPTION: Clock summary at [2020-03-11 Wed 17:56]
| <75>                                                    |         |       |      |       |
| Headline                                                | Time    |       |      |     % |
|---------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                            | *50:17* |       |      | 100.0 |
|---------------------------------------------------------+---------+-------+------+-------|
| Stories                                                 | 50:17   |       |      | 100.0 |
| Active                                                  |         | 50:17 |      | 100.0 |
| Edit release notes for previous sprint                  |         |       | 4:11 |   8.3 |
| Create a demo and presentation for previous sprint      |         |       | 0:25 |   0.8 |
| Sprint and product backlog grooming                     |         |       | 5:54 |  11.7 |
| Analysis on defining a combined logical-physical space  |         |       | 5:55 |  11.8 |
| Analysis on removing physical references in variability |         |       | 5:27 |  10.8 |
| Remove =rapidjson= formatters                           |         |       | 0:03 |   0.1 |
| Separate feature templates from bundles                 |         |       | 9:28 |  18.8 |
| Move enabled to generation                              |         |       | 0:04 |   0.1 |
| Create a chain to encapsulate variability transforms    |         |       | 0:37 |   1.2 |
| Move variability chain into assets                      |         |       | 2:22 |   4.7 |
| Move profile meta-data into profile element             |         |       | 7:12 |  14.3 |
| Add handcrafted stereotype to C# models                 |         |       | 0:04 |   0.1 |
| Split profiles and profile templates in variability     |         |       | 4:31 |   9.0 |
| Consider renaming labels to stereotypes in variability  |         |       | 1:07 |   2.2 |
| Add location and modules to variability                 |         |       | 0:43 |   1.4 |
| Implement template instantiation in terms of tags       |         |       | 2:14 |   4.4 |
...
*** STARTED Implement template instantiation in terms of tags         :story:
    :LOGBOOK:
    CLOCK: [2020-03-11 Wed 15:42]--[2020-03-11 Wed 17:56] =>  2:14
    :END:
