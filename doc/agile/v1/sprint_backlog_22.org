...
#+CAPTION: Clock summary at [2020-03-10 Tue 18:33]
| <75>                                                    |         |       |      |       |
| Headline                                                | Time    |       |      |     % |
|---------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                 | 41:10   |       |      | 100.0 |
| Active                                                  |         | 41:10 |      | 100.0 |
| Edit release notes for previous sprint                  |         |       | 4:11 |  10.2 |
| Create a demo and presentation for previous sprint      |         |       | 0:25 |   1.0 |
| Sprint and product backlog grooming                     |         |       | 4:56 |  12.0 |
| Analysis on defining a combined logical-physical space  |         |       | 5:55 |  14.4 |
| Analysis on removing physical references in variability |         |       | 5:27 |  13.2 |
| Remove =rapidjson= formatters                           |         |       | 0:03 |   0.1 |
| Separate feature templates from bundles                 |         |       | 9:28 |  23.0 |
| Move enabled to generation                              |         |       | 0:04 |   0.2 |
| Create a chain to encapsulate variability transforms    |         |       | 0:37 |   1.5 |
| Move variability chain into assets                      |         |       | 2:22 |   5.7 |
| Split profiles and profile templates in variability     |         |       | 2:01 |   4.9 |
| Move profile meta-data into profile element             |         |       | 4:58 |  12.1 |
| Add location and modules to variability                 |         |       | 0:43 |   1.7 |
...
*** STARTED Move profile meta-data into profile element               :story:
    :LOGBOOK:
