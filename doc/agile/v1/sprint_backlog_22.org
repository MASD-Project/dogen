...
#+CAPTION: Clock summary at [2020-03-13 Fri 08:21]
| <75>                                                    |         |       |      |       |
| Headline                                                | Time    |       |      |     % |
|---------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                 | 60:02   |       |      | 100.0 |
| Active                                                  |         | 60:02 |      | 100.0 |
| Edit release notes for previous sprint                  |         |       | 4:11 |   7.0 |
| Create a demo and presentation for previous sprint      |         |       | 0:25 |   0.7 |
| Sprint and product backlog grooming                     |         |       | 7:49 |  13.0 |
| Emacs configuration and issues                          |         |       | 1:02 |   1.7 |
| Analysis on defining a combined logical-physical space  |         |       | 5:55 |   9.9 |
| Analysis on removing physical references in variability |         |       | 5:27 |   9.1 |
| Remove =rapidjson= formatters                           |         |       | 0:03 |   0.1 |
| Separate feature templates from bundles                 |         |       | 9:28 |  15.8 |
| Move enabled to generation                              |         |       | 0:04 |   0.1 |
| Create a chain to encapsulate variability transforms    |         |       | 0:37 |   1.0 |
| Move variability chain into assets                      |         |       | 2:22 |   3.9 |
| Move profile meta-data into profile element             |         |       | 7:12 |  12.0 |
| Add handcrafted stereotype to C# models                 |         |       | 0:04 |   0.1 |
| Split profiles and profile templates in variability     |         |       | 4:31 |   7.5 |
...
| Implement template instantiation in terms of tags       |         |       | 8:31 |  14.2 |
