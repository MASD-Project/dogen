...
#+CAPTION: Clock summary at [2020-03-13 Fri 18:27]
| <75>                                                    |         |       |      |       |
| Headline                                                | Time    |       |      |     % |
|---------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                            | *69:10* |       |      | 100.0 |
|---------------------------------------------------------+---------+-------+------+-------|
| Stories                                                 | 69:10   |       |      | 100.0 |
| Active                                                  |         | 69:10 |      | 100.0 |
| Edit release notes for previous sprint                  |         |       | 4:11 |   6.0 |
| Create a demo and presentation for previous sprint      |         |       | 0:25 |   0.6 |
| Sprint and product backlog grooming                     |         |       | 8:00 |  11.6 |
| Emacs configuration and issues                          |         |       | 1:02 |   1.5 |
| Analysis on defining a combined logical-physical space  |         |       | 5:55 |   8.6 |
| Analysis on removing physical references in variability |         |       | 5:27 |   7.9 |
| Remove =rapidjson= formatters                           |         |       | 0:03 |   0.1 |
| Separate feature templates from bundles                 |         |       | 9:28 |  13.7 |
...
| Move profile meta-data into profile element             |         |       | 7:12 |  10.4 |
| Add handcrafted stereotype to C# models                 |         |       | 0:04 |   0.1 |
| Split profiles and profile templates in variability     |         |       | 4:31 |   6.5 |
...
| Implement template instantiation in terms of tags       |         |       | 8:31 |  12.3 |
| Remove duplication from feature bundles and profiles    |         |       | 4:29 |   6.5 |
| Postfix and directory fields should be templates        |         |       | 3:55 |   5.7 |
| Add command line option to dump all features            |         |       | 0:54 |   1.3 |
