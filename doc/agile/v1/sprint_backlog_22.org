...
#+CAPTION: Clock summary at [2020-03-12 Thu 12:05]
| <75>                                                    |         |       |      |       |
| Headline                                                | Time    |       |      |     % |
|---------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                            | *54:05* |       |      | 100.0 |
|---------------------------------------------------------+---------+-------+------+-------|
| Stories                                                 | 54:05   |       |      | 100.0 |
| Active                                                  |         | 54:05 |      | 100.0 |
| Edit release notes for previous sprint                  |         |       | 4:11 |   7.7 |
| Create a demo and presentation for previous sprint      |         |       | 0:25 |   0.8 |
| Sprint and product backlog grooming                     |         |       | 6:38 |  12.3 |
| Emacs configuration and issues                          |         |       | 0:38 |   1.2 |
| Analysis on defining a combined logical-physical space  |         |       | 5:55 |  10.9 |
| Analysis on removing physical references in variability |         |       | 5:27 |  10.1 |
| Remove =rapidjson= formatters                           |         |       | 0:03 |   0.1 |
| Separate feature templates from bundles                 |         |       | 9:28 |  17.5 |
| Move enabled to generation                              |         |       | 0:04 |   0.1 |
| Create a chain to encapsulate variability transforms    |         |       | 0:37 |   1.1 |
| Move variability chain into assets                      |         |       | 2:22 |   4.4 |
| Move profile meta-data into profile element             |         |       | 7:12 |  13.3 |
| Add handcrafted stereotype to C# models                 |         |       | 0:04 |   0.1 |
| Split profiles and profile templates in variability     |         |       | 4:31 |   8.4 |
| Consider renaming labels to stereotypes in variability  |         |       | 1:07 |   2.1 |
| Declaring a =std::list= without parameters segfaults    |         |       | 0:10 |   0.3 |
| Add location and modules to variability                 |         |       | 0:43 |   1.3 |
| Implement template instantiation in terms of tags       |         |       | 4:30 |   8.3 |
...
*** STARTED Implement template instantiation in terms of tags         :story:
    :LOGBOOK:
...
- remove archetype location from context and context factory for
  variability.
- remove references to archetypes model from variability model.
- add prefixes to feature bundles and profiles. Compute qualified
  names based on prefixes plus attribute names.
