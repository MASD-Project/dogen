...
#+CAPTION: Clock summary at [2020-03-14 Sat 09:12]
| <75>                                                    |         |       |      |       |
| Headline                                                | Time    |       |      |     % |
|---------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                            | *71:34* |       |      | 100.0 |
|---------------------------------------------------------+---------+-------+------+-------|
| Stories                                                 | 71:34   |       |      | 100.0 |
| Active                                                  |         | 71:34 |      | 100.0 |
| Edit release notes for previous sprint                  |         |       | 4:11 |   5.8 |
| Create a demo and presentation for previous sprint      |         |       | 0:25 |   0.6 |
| Sprint and product backlog grooming                     |         |       | 8:00 |  11.2 |
| Emacs configuration and issues                          |         |       | 1:02 |   1.4 |
| Analysis on defining a combined logical-physical space  |         |       | 5:55 |   8.3 |
| Analysis on removing physical references in variability |         |       | 5:27 |   7.6 |
| Remove =rapidjson= formatters                           |         |       | 0:03 |   0.1 |
| Separate feature templates from bundles                 |         |       | 9:28 |  13.2 |
| Move enabled to generation                              |         |       | 0:04 |   0.1 |
| Create a chain to encapsulate variability transforms    |         |       | 0:37 |   0.9 |
| Move variability chain into assets                      |         |       | 2:22 |   3.3 |
| Move profile meta-data into profile element             |         |       | 7:12 |  10.1 |
| Add handcrafted stereotype to C# models                 |         |       | 0:04 |   0.1 |
| Split profiles and profile templates in variability     |         |       | 4:31 |   6.3 |
...
| Implement template instantiation in terms of tags       |         |       | 8:31 |  11.9 |
| Remove duplication from feature bundles and profiles    |         |       | 4:29 |   6.3 |
| Postfix and directory fields should be templates        |         |       | 3:55 |   5.5 |
| Default value overrides are not stable                  |         |       | 1:11 |   1.7 |
