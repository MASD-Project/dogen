...
#+CAPTION: Clock summary at [2020-03-09 Mon 20:14]
| <75>                                                    |         |       |      |       |
| Headline                                                | Time    |       |      |     % |
|---------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                            | *33:26* |       |      | 100.0 |
|---------------------------------------------------------+---------+-------+------+-------|
| Stories                                                 | 33:26   |       |      | 100.0 |
| Active                                                  |         | 33:26 |      | 100.0 |
| Edit release notes for previous sprint                  |         |       | 4:11 |  12.5 |
| Create a demo and presentation for previous sprint      |         |       | 0:25 |   1.2 |
| Sprint and product backlog grooming                     |         |       | 4:56 |  14.8 |
| Analysis on defining a combined logical-physical space  |         |       | 5:55 |  17.7 |
| Analysis on removing physical references in variability |         |       | 5:27 |  16.3 |
| Remove =rapidjson= formatters                           |         |       | 0:03 |   0.1 |
| Separate feature templates from bundles                 |         |       | 9:28 |  28.3 |
| Move enabled to generation                              |         |       | 0:04 |   0.2 |
| Split profiles and profile templates in variability     |         |       | 2:01 |   6.0 |
| Create a chain to encapsulate variability transforms    |         |       | 0:13 |   0.6 |
| Add location and modules to variability                 |         |       | 0:43 |   2.1 |
...
*** STARTED Create a chain to encapsulate variability transforms      :story:
    :LOGBOOK:
