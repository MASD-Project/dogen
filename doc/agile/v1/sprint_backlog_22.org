...
#+CAPTION: Clock summary at [2020-03-14 Sat 21:09]
| <75>                                                    |         |       |      |       |
| Headline                                                | Time    |       |      |     % |
|---------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                 | 73:35   |       |      | 100.0 |
| Active                                                  |         | 73:35 |      | 100.0 |
| Edit release notes for previous sprint                  |         |       | 4:11 |   5.7 |
| Create a demo and presentation for previous sprint      |         |       | 0:25 |   0.6 |
| Sprint and product backlog grooming                     |         |       | 8:00 |  10.9 |
| Emacs configuration and issues                          |         |       | 1:02 |   1.4 |
| Analysis on defining a combined logical-physical space  |         |       | 5:55 |   8.0 |
| Analysis on removing physical references in variability |         |       | 5:27 |   7.4 |
| Remove =rapidjson= formatters                           |         |       | 0:03 |   0.1 |
| Separate feature templates from bundles                 |         |       | 9:28 |  12.9 |
| Move enabled to generation                              |         |       | 0:04 |   0.1 |
| Create a chain to encapsulate variability transforms    |         |       | 0:37 |   0.8 |
| Move variability chain into assets                      |         |       | 2:22 |   3.2 |
| Move profile meta-data into profile element             |         |       | 7:12 |   9.8 |
| Add handcrafted stereotype to C# models                 |         |       | 0:04 |   0.1 |
| Split profiles and profile templates in variability     |         |       | 4:31 |   6.1 |
| Consider renaming labels to stereotypes in variability  |         |       | 1:07 |   1.5 |
| Declaring a =std::list= without parameters segfaults    |         |       | 0:10 |   0.2 |
| Add location and modules to variability                 |         |       | 0:43 |   1.0 |
| Implement template instantiation in terms of tags       |         |       | 8:31 |  11.6 |
| Remove duplication from feature bundles and profiles    |         |       | 4:29 |   6.1 |
| Postfix and directory fields should be templates        |         |       | 3:55 |   5.3 |
| Default value overrides are not stable                  |         |       | 3:12 |   4.3 |
| Add command line option to dump all features            |         |       | 2:07 |   2.9 |
...
*** STARTED Default value overrides are not stable                    :story:
    :LOGBOOK:
...
: some.key.c=d
  ...
  entries.
- we seem to be reverting the keys in JSON.
