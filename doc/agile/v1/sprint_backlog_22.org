...
#+CAPTION: Clock summary at [2020-03-11 Wed 14:34]
| <75>                                                    |         |       |      |       |
| Headline                                                | Time    |       |      |     % |
|---------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                 | 46:56   |       |      | 100.0 |
| Active                                                  |         | 46:56 |      | 100.0 |
| Edit release notes for previous sprint                  |         |       | 4:11 |   8.9 |
| Create a demo and presentation for previous sprint      |         |       | 0:25 |   0.9 |
| Sprint and product backlog grooming                     |         |       | 5:54 |  12.6 |
| Analysis on defining a combined logical-physical space  |         |       | 5:55 |  12.6 |
| Analysis on removing physical references in variability |         |       | 5:27 |  11.6 |
| Remove =rapidjson= formatters                           |         |       | 0:03 |   0.1 |
| Separate feature templates from bundles                 |         |       | 9:28 |  20.2 |
| Move enabled to generation                              |         |       | 0:04 |   0.1 |
| Create a chain to encapsulate variability transforms    |         |       | 0:37 |   1.3 |
| Move variability chain into assets                      |         |       | 2:22 |   5.0 |
| Move profile meta-data into profile element             |         |       | 7:12 |  15.3 |
| Add handcrafted stereotype to C# models                 |         |       | 0:04 |   0.1 |
| Split profiles and profile templates in variability     |         |       | 4:31 |   9.6 |
| Add location and modules to variability                 |         |       | 0:43 |   1.5 |
