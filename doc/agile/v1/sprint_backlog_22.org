...
#+CAPTION: Clock summary at [2020-03-13 Fri 12:14]
| <75>                                                    |         |       |      |       |
| Headline                                                | Time    |       |      |     % |
|---------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                            | *63:33* |       |      | 100.0 |
|---------------------------------------------------------+---------+-------+------+-------|
| Stories                                                 | 63:33   |       |      | 100.0 |
| Active                                                  |         | 63:33 |      | 100.0 |
| Edit release notes for previous sprint                  |         |       | 4:11 |   6.6 |
| Create a demo and presentation for previous sprint      |         |       | 0:25 |   0.7 |
| Sprint and product backlog grooming                     |         |       | 7:49 |  12.3 |
| Emacs configuration and issues                          |         |       | 1:02 |   1.6 |
| Analysis on defining a combined logical-physical space  |         |       | 5:55 |   9.3 |
| Analysis on removing physical references in variability |         |       | 5:27 |   8.6 |
| Remove =rapidjson= formatters                           |         |       | 0:03 |   0.1 |
| Separate feature templates from bundles                 |         |       | 9:28 |  14.9 |
| Move enabled to generation                              |         |       | 0:04 |   0.1 |
| Create a chain to encapsulate variability transforms    |         |       | 0:37 |   1.0 |
| Move variability chain into assets                      |         |       | 2:22 |   3.7 |
| Move profile meta-data into profile element             |         |       | 7:12 |  11.3 |
| Add handcrafted stereotype to C# models                 |         |       | 0:04 |   0.1 |
| Split profiles and profile templates in variability     |         |       | 4:31 |   7.1 |
| Consider renaming labels to stereotypes in variability  |         |       | 1:07 |   1.8 |
| Declaring a =std::list= without parameters segfaults    |         |       | 0:10 |   0.3 |
| Add location and modules to variability                 |         |       | 0:43 |   1.1 |
| Implement template instantiation in terms of tags       |         |       | 8:31 |  13.4 |
| Remove duplication from feature bundles and profiles    |         |       | 3:31 |   5.5 |
| Add command line option to dump all features            |         |       | 0:21 |   0.6 |
...
*** STARTED Remove duplication from feature bundles and profiles      :story:
    :LOGBOOK:
