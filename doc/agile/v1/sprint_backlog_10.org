...
#+CAPTION: Clock summary at [2018-10-18 Thu 14:51]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *29:23* |       |       |   0.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 29:23   |       |       |   0.0 |
| Active                                                                      |         | 29:23 |       |   0.0 |
| Edit release notes for previous sprint                                      |         |       |  1:10 |   0.0 |
| Sprint and product backlog grooming                                         |         |       |  0:46 |   0.0 |
...
| Fix warnings on windows                                                     |         |       |  0:17 |   0.0 |
| Fix warnings on OSX                                                         |         |       |  0:19 |   0.0 |
| Read up on framework and API design                                         |         |       |  1:23 |   0.0 |
| Design a top-level Dogen API                                                |         |       | 10:52 |   0.0 |
| Update vcpkg with boost.di and visibility settings                          |         |       |  0:02 |   0.0 |
| Check that C++ 17 is enabled on MSVC                                        |         |       |  0:05 |   0.0 |
...
*** STARTED Fix warnings on OSX                                       :story:
    :LOGBOOK:
...
*** STARTED Update vcpkg with boost.di and visibility settings        :story:
    :LOGBOOK:
...
*** STARTED Check that C++ 17 is enabled on MSVC                      :story:
    :LOGBOOK:
