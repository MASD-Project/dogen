...
#+CAPTION: Clock summary at [2018-10-23 Tue 12:10]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *58:19* |       |       |   0.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 58:19   |       |       |   0.0 |
| Active                                                                      |         | 58:19 |       |   0.0 |
...
| Read up on framework and API design                                         |         |       |  3:39 |   0.0 |
| Update dogen namespaces to match the new specification                      |         |       |  0:15 |   0.0 |
| Add support for nested namespaces                                           |         |       |  2:54 |   0.0 |
