...
#+CAPTION: Clock summary at [2018-10-25 Thu 16:50]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *79:10* |       |       |   0.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 79:10   |       |       |   0.0 |
| Active                                                                      |         | 79:10 |       |   0.0 |
| Edit release notes for previous sprint                                      |         |       |  1:10 |   0.0 |
| Sprint and product backlog grooming                                         |         |       |  2:52 |   0.0 |
...
| Read up on framework and API design                                         |         |       |  5:30 |   0.0 |
| Create a single binary for all of dogen                                     |         |       |  2:35 |   0.0 |
| Implement the new dogen product API                                         |         |       |  0:32 |   0.0 |
