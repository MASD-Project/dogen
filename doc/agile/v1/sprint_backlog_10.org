...
#+CAPTION: Clock summary at [2018-10-22 Mon 13:01]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *50:41* |       |       |   0.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 50:41   |       |       |   0.0 |
| Active                                                                      |         | 50:41 |       |   0.0 |
...
| Read up on framework and API design                                         |         |       |  2:37 |   0.0 |
| Design a top-level Dogen API                                                |         |       | 12:46 |   0.0 |
| Remove facets that are not being used                                       |         |       |  7:04 |   0.0 |
...
*** STARTED Remove facets that are not being used                     :story:
    :LOGBOOK:
