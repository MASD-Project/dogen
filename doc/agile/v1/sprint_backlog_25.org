...
#+CAPTION: Clock summary at [2020-05-29 Fri 17:27]
| <75>                                                     |         |       |       |       |
| Headline                                                 | Time    |       |       |     % |
|----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                             | *74:00* |       |       | 100.0 |
|----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                  | 74:00   |       |       | 100.0 |
| Active                                                   |         | 74:00 |       | 100.0 |
| Edit release notes for previous sprint                   |         |       |  5:57 |   8.0 |
| Create a demo and presentation for previous sprint       |         |       |  0:47 |   1.1 |
| Sprint and product backlog grooming                      |         |       |  3:31 |   4.8 |
| Nightly nursing                                          |         |       |  0:24 |   0.5 |
...
| Add template related attributes to physical elements     |         |       |  1:38 |   2.2 |
| Resolve references to wale templates in logical model    |         |       |  1:39 |   2.2 |
| =templating= should not depend on =physical=             |         |       |  1:09 |   1.6 |
| Move decoration transform into logical model             |         |       |  5:33 |   7.5 |
| Split wale out of stitch templates                       |         |       |  3:31 |   4.8 |
| Paper: An EMF-like UML generator for C++                 |         |       |  1:02 |   1.4 |
...
| Profiles do not support collection types                 |         |       |  4:13 |   5.7 |
| Promote all formatters to archetypes                     |         |       | 17:31 |  23.7 |
| Create archetypes for all physical elements              |         |       |  0:39 |   0.9 |
| Analysis on how to build PMM from archetypes in text     |         |       |  1:06 |   1.5 |
| Create a bootstrapping chain for context                 |         |       |  3:20 |   4.5 |
| Facet and backend files are in the wrong folder          |         |       |  0:48 |   1.1 |
| Fix =static_archetype= method in archetypes              |         |       |  1:25 |   1.9 |
| Extend tracing to M2T transforms                         |         |       |  3:51 |   5.2 |
| Add "scoped tracing" via regexes                         |         |       |  1:04 |   1.4 |
| Fix borked dist-upgrade                                  |         |       |  0:49 |   1.1 |
| Update stitch mode for emacs                             |         |       |  1:19 |   1.8 |
| Create an encoder for org-mode                           |         |       |  1:31 |   2.0 |
| Create a PMM chain in physical model                     |         |       |  6:31 |   8.8 |
...
*** STARTED Namespace documentation is incorrect                      :story:
    :LOGBOOK:
