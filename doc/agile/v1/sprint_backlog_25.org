...
#+CAPTION: Clock summary at [2020-05-17 Sun 22:48]
| <75>                                                  |         |       |       |       |
| Headline                                              | Time    |       |       |     % |
|-------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                          | *47:06* |       |       | 100.0 |
|-------------------------------------------------------+---------+-------+-------+-------|
| Stories                                               | 47:06   |       |       | 100.0 |
| Active                                                |         | 47:06 |       | 100.0 |
| Edit release notes for previous sprint                |         |       |  5:57 |  12.6 |
| Create a demo and presentation for previous sprint    |         |       |  0:47 |   1.7 |
...
| Add template related attributes to physical elements  |         |       |  1:38 |   3.5 |
| Resolve references to wale templates in logical model |         |       |  1:39 |   3.5 |
| =templating= should not depend on =physical=          |         |       |  1:09 |   2.4 |
| Move decoration transform into logical model          |         |       |  5:33 |  11.8 |
| Split wale out of stitch templates                    |         |       |  3:31 |   7.5 |
| Paper: An EMF-like UML generator for C++              |         |       |  1:02 |   2.2 |
| Paper: An Abstraction for Reusable MDD Components     |         |       |  0:56 |   2.0 |
| Profiles do not support collection types              |         |       |  4:13 |   9.0 |
| Promote all formatters to archetypes                  |         |       | 15:55 |  33.8 |
