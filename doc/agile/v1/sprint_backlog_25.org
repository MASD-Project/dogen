...
#+CAPTION: Clock summary at [2020-05-08 Fri 21:36]
| <75>                                                  |         |       |      |       |
| Headline                                              | Time    |       |      |     % |
|-------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                          | *13:44* |       |      | 100.0 |
|-------------------------------------------------------+---------+-------+------+-------|
| Stories                                               | 13:44   |       |      | 100.0 |
| Active                                                |         | 13:44 |      | 100.0 |
| Edit release notes for previous sprint                |         |       | 5:57 |  43.3 |
| Create a demo and presentation for previous sprint    |         |       | 0:47 |   5.7 |
| Sprint and product backlog grooming                   |         |       | 0:40 |   4.9 |
| Check name of model for variability transform         |         |       | 0:19 |   2.3 |
| Analysis on templating and logical model              |         |       | 1:09 |   8.4 |
| Ensure stitch templates result in valid JSON          |         |       | 0:27 |   3.3 |
| Remove stitch template builder                        |         |       | 0:09 |   1.1 |
| Add template related attributes to physical elements  |         |       | 1:38 |  11.9 |
| Resolve references to wale templates in logical model |         |       | 1:39 |  12.0 |
| =templating= should not depend on =physical=          |         |       | 0:59 |   7.2 |
...
*** STARTED =templating= should not depend on =physical=              :story:
    :LOGBOOK:
