...
#+CAPTION: Clock summary at [2020-05-30 Sat 13:44]
| <75>                                                     |         |       |       |       |
| Headline                                                 | Time    |       |       |     % |
|----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                             | *75:24* |       |       | 100.0 |
|----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                  | 75:24   |       |       | 100.0 |
| Active                                                   |         | 75:24 |       | 100.0 |
| Edit release notes for previous sprint                   |         |       |  5:57 |   7.9 |
| Create a demo and presentation for previous sprint       |         |       |  0:47 |   1.0 |
| Sprint and product backlog grooming                      |         |       |  3:31 |   4.7 |
...
| Move decoration transform into logical model             |         |       |  5:33 |   7.4 |
| Split wale out of stitch templates                       |         |       |  3:31 |   4.7 |
...
| Create a PMM chain in physical model                     |         |       |  6:31 |   8.6 |
| Namespace documentation is incorrect                     |         |       |  0:33 |   0.7 |
| Handling of container names is incorrect                 |         |       |  1:24 |   1.9 |
...
*** STARTED Handling of container names is incorrect                  :story:
    :LOGBOOK:
