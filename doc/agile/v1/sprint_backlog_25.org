...
#+CAPTION: Clock summary at [2020-05-23 Sat 13:06]
| <75>                                                  |         |       |       |       |
| Headline                                              | Time    |       |       |     % |
|-------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                          | *54:51* |       |       | 100.0 |
|-------------------------------------------------------+---------+-------+-------+-------|
| Stories                                               | 54:51   |       |       | 100.0 |
| Active                                                |         | 54:51 |       | 100.0 |
| Edit release notes for previous sprint                |         |       |  5:57 |  10.8 |
...
| Analysis on templating and logical model              |         |       |  1:09 |   2.1 |
| Ensure stitch templates result in valid JSON          |         |       |  0:27 |   0.8 |
| Remove stitch template builder                        |         |       |  0:09 |   0.3 |
| Add template related attributes to physical elements  |         |       |  1:38 |   3.0 |
| Resolve references to wale templates in logical model |         |       |  1:39 |   3.0 |
| =templating= should not depend on =physical=          |         |       |  1:09 |   2.1 |
| Move decoration transform into logical model          |         |       |  5:33 |  10.1 |
| Split wale out of stitch templates                    |         |       |  3:31 |   6.4 |
| Paper: An EMF-like UML generator for C++              |         |       |  1:02 |   1.9 |
| Paper: An Abstraction for Reusable MDD Components     |         |       |  0:56 |   1.7 |
| Profiles do not support collection types              |         |       |  4:13 |   7.7 |
| Promote all formatters to archetypes                  |         |       | 17:31 |  31.9 |
| Create archetypes for all physical elements           |         |       |  0:39 |   1.2 |
| Analysis on how to build PMM from archetypes in text  |         |       |  1:06 |   2.0 |
| Create an encoder for org-mode                        |         |       |  1:31 |   2.8 |
| Create a PMM chain in physical model                  |         |       |  4:01 |   7.3 |
