...
#+CAPTION: Clock summary at [2020-05-11 Mon 22:41]
| <75>                                                  |         |       |      |       |
| Headline                                              | Time    |       |      |     % |
|-------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                          | *27:46* |       |      | 100.0 |
|-------------------------------------------------------+---------+-------+------+-------|
| Stories                                               | 27:46   |       |      | 100.0 |
| Active                                                |         | 27:46 |      | 100.0 |
| Edit release notes for previous sprint                |         |       | 5:57 |  21.4 |
| Create a demo and presentation for previous sprint    |         |       | 0:47 |   2.8 |
| Sprint and product backlog grooming                   |         |       | 1:00 |   3.6 |
| Check name of model for variability transform         |         |       | 0:19 |   1.1 |
| Analysis on templating and logical model              |         |       | 1:09 |   4.1 |
| Ensure stitch templates result in valid JSON          |         |       | 0:27 |   1.6 |
| Remove stitch template builder                        |         |       | 0:09 |   0.5 |
| Add template related attributes to physical elements  |         |       | 1:38 |   5.9 |
| Resolve references to wale templates in logical model |         |       | 1:39 |   5.9 |
| =templating= should not depend on =physical=          |         |       | 1:09 |   4.1 |
| Move decoration transform into logical model          |         |       | 5:33 |  20.0 |
| Split wale out of stitch templates                    |         |       | 3:31 |  12.7 |
| Paper: An EMF-like UML generator for C++              |         |       | 1:02 |   3.7 |
| Promote all formatters to archetypes                  |         |       | 2:18 |   8.3 |
| Create an encoder for org-mode                        |         |       | 1:08 |   4.1 |
