...
#+CAPTION: Clock summary at [2020-05-10 Sun 20:06]
| <75>                                                  |         |       |      |       |
| Headline                                              | Time    |       |      |     % |
|-------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                          | *26:38* |       |      | 100.0 |
|-------------------------------------------------------+---------+-------+------+-------|
| Stories                                               | 26:38   |       |      | 100.0 |
| Active                                                |         | 26:38 |      | 100.0 |
| Edit release notes for previous sprint                |         |       | 5:57 |  22.3 |
| Create a demo and presentation for previous sprint    |         |       | 0:47 |   2.9 |
| Sprint and product backlog grooming                   |         |       | 1:00 |   3.8 |
| Check name of model for variability transform         |         |       | 0:19 |   1.2 |
| Analysis on templating and logical model              |         |       | 1:09 |   4.3 |
| Ensure stitch templates result in valid JSON          |         |       | 0:27 |   1.7 |
| Remove stitch template builder                        |         |       | 0:09 |   0.6 |
| Add template related attributes to physical elements  |         |       | 1:38 |   6.1 |
| Resolve references to wale templates in logical model |         |       | 1:39 |   6.2 |
| =templating= should not depend on =physical=          |         |       | 1:09 |   4.3 |
| Move decoration transform into logical model          |         |       | 5:33 |  20.8 |
| Split wale out of stitch templates                    |         |       | 3:31 |  13.2 |
| Paper: An EMF-like UML generator for C++              |         |       | 1:02 |   3.9 |
| Promote all formatters to archetypes                  |         |       | 2:18 |   8.6 |
