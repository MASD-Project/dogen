...
#+CAPTION: Clock summary at [2020-05-14 Thu 22:24]
| <75>                                                  |         |       |      |       |
| Headline                                              | Time    |       |      |     % |
|-------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                               | 30:09   |       |      | 100.0 |
| Active                                                |         | 30:09 |      | 100.0 |
| Edit release notes for previous sprint                |         |       | 5:57 |  19.7 |
| Create a demo and presentation for previous sprint    |         |       | 0:47 |   2.6 |
| Sprint and product backlog grooming                   |         |       | 1:00 |   3.3 |
| Check name of model for variability transform         |         |       | 0:19 |   1.1 |
| Analysis on templating and logical model              |         |       | 1:09 |   3.8 |
| Ensure stitch templates result in valid JSON          |         |       | 0:27 |   1.5 |
| Remove stitch template builder                        |         |       | 0:09 |   0.5 |
| Add template related attributes to physical elements  |         |       | 1:38 |   5.4 |
| Resolve references to wale templates in logical model |         |       | 1:39 |   5.5 |
| =templating= should not depend on =physical=          |         |       | 1:09 |   3.8 |
| Move decoration transform into logical model          |         |       | 5:33 |  18.4 |
| Split wale out of stitch templates                    |         |       | 3:31 |  11.7 |
| Paper: An EMF-like UML generator for C++              |         |       | 1:02 |   3.4 |
| Promote all formatters to archetypes                  |         |       | 4:18 |  14.3 |
| Create an encoder for org-mode                        |         |       | 1:31 |   5.0 |
