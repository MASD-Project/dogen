...
#+CAPTION: Clock summary at [2020-05-10 Sun 09:43]
| <75>                                                  |         |       |      |       |
| Headline                                              | Time    |       |      |     % |
|-------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                          | *20:23* |       |      | 100.0 |
|-------------------------------------------------------+---------+-------+------+-------|
| Stories                                               | 20:23   |       |      | 100.0 |
| Active                                                |         | 20:23 |      | 100.0 |
| Edit release notes for previous sprint                |         |       | 5:57 |  29.2 |
| Create a demo and presentation for previous sprint    |         |       | 0:47 |   3.8 |
| Sprint and product backlog grooming                   |         |       | 1:00 |   4.9 |
| Check name of model for variability transform         |         |       | 0:19 |   1.6 |
| Analysis on templating and logical model              |         |       | 1:09 |   5.6 |
| Ensure stitch templates result in valid JSON          |         |       | 0:27 |   2.2 |
| Remove stitch template builder                        |         |       | 0:09 |   0.7 |
| Add template related attributes to physical elements  |         |       | 1:38 |   8.0 |
| Resolve references to wale templates in logical model |         |       | 1:39 |   8.1 |
| =templating= should not depend on =physical=          |         |       | 1:09 |   5.6 |
| Split wale out of stitch templates                    |         |       | 4:52 |  23.9 |
| Move decoration transform into logical model          |         |       | 1:17 |   6.3 |
