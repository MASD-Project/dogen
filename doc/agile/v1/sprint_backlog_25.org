...
#+CAPTION: Clock summary at [2020-05-17 Sun 13:27]
| <75>                                                  |         |       |       |       |
| Headline                                              | Time    |       |       |     % |
|-------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                          | *45:08* |       |       | 100.0 |
|-------------------------------------------------------+---------+-------+-------+-------|
| Stories                                               | 45:08   |       |       | 100.0 |
| Active                                                |         | 45:08 |       | 100.0 |
| Edit release notes for previous sprint                |         |       |  5:57 |  13.2 |
| Create a demo and presentation for previous sprint    |         |       |  0:47 |   1.7 |
| Sprint and product backlog grooming                   |         |       |  1:00 |   2.2 |
| Nightly nursing                                       |         |       |  0:11 |   0.4 |
| Check name of model for variability transform         |         |       |  0:19 |   0.7 |
| Analysis on templating and logical model              |         |       |  1:09 |   2.5 |
| Ensure stitch templates result in valid JSON          |         |       |  0:27 |   1.0 |
| Remove stitch template builder                        |         |       |  0:09 |   0.3 |
| Add template related attributes to physical elements  |         |       |  1:38 |   3.6 |
| Resolve references to wale templates in logical model |         |       |  1:39 |   3.7 |
| =templating= should not depend on =physical=          |         |       |  1:09 |   2.5 |
| Move decoration transform into logical model          |         |       |  5:33 |  12.3 |
| Split wale out of stitch templates                    |         |       |  3:31 |   7.8 |
| Paper: An EMF-like UML generator for C++              |         |       |  1:02 |   2.3 |
| Profiles do not support collection types              |         |       |  4:13 |   9.3 |
| Promote all formatters to archetypes                  |         |       | 14:53 |  33.0 |
| Create an encoder for org-mode                        |         |       |  1:31 |   3.4 |
