...
#+CAPTION: Clock summary at [2020-05-23 Sat 23:24]
| <75>                                                  |         |       |       |       |
| Headline                                              | Time    |       |       |     % |
|-------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                               | 57:25   |       |       | 100.0 |
| Active                                                |         | 57:25 |       | 100.0 |
| Edit release notes for previous sprint                |         |       |  5:57 |  10.4 |
...
| Move decoration transform into logical model          |         |       |  5:33 |   9.7 |
| Split wale out of stitch templates                    |         |       |  3:31 |   6.1 |
| Paper: An EMF-like UML generator for C++              |         |       |  1:02 |   1.8 |
| Paper: An Abstraction for Reusable MDD Components     |         |       |  0:56 |   1.6 |
| Profiles do not support collection types              |         |       |  4:13 |   7.3 |
| Promote all formatters to archetypes                  |         |       | 17:31 |  30.5 |
| Create archetypes for all physical elements           |         |       |  0:39 |   1.1 |
| Analysis on how to build PMM from archetypes in text  |         |       |  1:06 |   1.9 |
| Create a bootstrapping chain for context              |         |       |  3:20 |   5.8 |
| Create an encoder for org-mode                        |         |       |  1:31 |   2.6 |
| Create a PMM chain in physical model                  |         |       |  2:55 |   5.1 |
...
*** Facet and backend files are in the wrong folder                   :story:
