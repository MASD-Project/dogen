...
#+CAPTION: Clock summary at [2020-05-09 Sat 17:36]
| <75>                                                  |         |       |      |       |
| Headline                                              | Time    |       |      |     % |
|-------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                               | 19:06   |       |      | 100.0 |
| Active                                                |         | 19:06 |      | 100.0 |
| Edit release notes for previous sprint                |         |       | 5:57 |  31.2 |
| Create a demo and presentation for previous sprint    |         |       | 0:47 |   4.1 |
| Sprint and product backlog grooming                   |         |       | 1:00 |   5.2 |
| Check name of model for variability transform         |         |       | 0:19 |   1.7 |
| Analysis on templating and logical model              |         |       | 1:09 |   6.0 |
| Ensure stitch templates result in valid JSON          |         |       | 0:27 |   2.4 |
| Remove stitch template builder                        |         |       | 0:09 |   0.8 |
| Add template related attributes to physical elements  |         |       | 1:38 |   8.6 |
| Resolve references to wale templates in logical model |         |       | 1:39 |   8.6 |
| =templating= should not depend on =physical=          |         |       | 1:09 |   6.0 |
| Split wale out of stitch templates                    |         |       | 4:52 |  25.5 |
...
*** Move decoration transform into logical model                      :story:
