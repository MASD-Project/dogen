...
#+CAPTION: Clock summary at [2020-05-09 Sat 13:39]
| <75>                                                  |         |       |      |       |
| Headline                                              | Time    |       |      |     % |
|-------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                          | *17:45* |       |      | 100.0 |
|-------------------------------------------------------+---------+-------+------+-------|
| Stories                                               | 17:45   |       |      | 100.0 |
| Active                                                |         | 17:45 |      | 100.0 |
| Edit release notes for previous sprint                |         |       | 5:57 |  33.5 |
| Create a demo and presentation for previous sprint    |         |       | 0:47 |   4.4 |
| Sprint and product backlog grooming                   |         |       | 1:00 |   5.6 |
| Check name of model for variability transform         |         |       | 0:19 |   1.8 |
| Analysis on templating and logical model              |         |       | 1:09 |   6.5 |
| Ensure stitch templates result in valid JSON          |         |       | 0:27 |   2.5 |
| Remove stitch template builder                        |         |       | 0:09 |   0.8 |
| Add template related attributes to physical elements  |         |       | 1:38 |   9.2 |
| Resolve references to wale templates in logical model |         |       | 1:39 |   9.3 |
| =templating= should not depend on =physical=          |         |       | 1:09 |   6.5 |
| Split wale out of stitch templates                    |         |       | 3:31 |  19.8 |
