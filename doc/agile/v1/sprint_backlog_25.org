...
#+CAPTION: Clock summary at [2020-05-25 Mon 01:12]
| <75>                                                  |         |       |       |       |
| Headline                                              | Time    |       |       |     % |
|-------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                          | *63:15* |       |       | 100.0 |
|-------------------------------------------------------+---------+-------+-------+-------|
| Stories                                               | 63:15   |       |       | 100.0 |
| Active                                                |         | 63:15 |       | 100.0 |
| Edit release notes for previous sprint                |         |       |  5:57 |   9.4 |
| Create a demo and presentation for previous sprint    |         |       |  0:47 |   1.2 |
| Sprint and product backlog grooming                   |         |       |  2:20 |   3.7 |
...
| Move decoration transform into logical model          |         |       |  5:33 |   8.8 |
| Split wale out of stitch templates                    |         |       |  3:31 |   5.6 |
| Paper: An EMF-like UML generator for C++              |         |       |  1:02 |   1.6 |
| Paper: An Abstraction for Reusable MDD Components     |         |       |  0:56 |   1.5 |
| Profiles do not support collection types              |         |       |  4:13 |   6.7 |
| Promote all formatters to archetypes                  |         |       | 17:31 |  27.7 |
| Create archetypes for all physical elements           |         |       |  0:39 |   1.0 |
| Analysis on how to build PMM from archetypes in text  |         |       |  1:06 |   1.7 |
| Create a bootstrapping chain for context              |         |       |  3:20 |   5.3 |
...
| Create a PMM chain in physical model                  |         |       |  4:25 |   7.0 |
...
*** STARTED Extend tracing to M2T transforms
    :LOGBOOK:
