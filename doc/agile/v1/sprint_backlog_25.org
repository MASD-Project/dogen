...
#+CAPTION: Clock summary at [2020-05-24 Sun 21:06]
| <75>                                                  |         |       |       |       |
| Headline                                              | Time    |       |       |     % |
|-------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                          | *61:58* |       |       | 100.0 |
|-------------------------------------------------------+---------+-------+-------+-------|
| Stories                                               | 61:58   |       |       | 100.0 |
| Active                                                |         | 61:58 |       | 100.0 |
| Edit release notes for previous sprint                |         |       |  5:57 |   9.6 |
...
| Move decoration transform into logical model          |         |       |  5:33 |   9.0 |
| Split wale out of stitch templates                    |         |       |  3:31 |   5.7 |
| Paper: An EMF-like UML generator for C++              |         |       |  1:02 |   1.7 |
| Paper: An Abstraction for Reusable MDD Components     |         |       |  0:56 |   1.5 |
| Profiles do not support collection types              |         |       |  4:13 |   6.8 |
| Promote all formatters to archetypes                  |         |       | 17:31 |  28.3 |
| Create archetypes for all physical elements           |         |       |  0:39 |   1.0 |
| Analysis on how to build PMM from archetypes in text  |         |       |  1:06 |   1.8 |
| Create a bootstrapping chain for context              |         |       |  3:20 |   5.4 |
| Facet and backend files are in the wrong folder       |         |       |  0:48 |   1.3 |
| Fix =static_archetype= method in archetypes           |         |       |  1:25 |   2.3 |
| Create an encoder for org-mode                        |         |       |  1:31 |   2.4 |
| Create a PMM chain in physical model                  |         |       |  4:25 |   7.1 |
