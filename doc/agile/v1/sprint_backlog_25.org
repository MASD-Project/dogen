...
#+CAPTION: Clock summary at [2020-05-15 Fri 16:14]
| <75>                                                  |         |       |      |       |
| Headline                                              | Time    |       |      |     % |
|-------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                          | *36:31* |       |      | 100.0 |
|-------------------------------------------------------+---------+-------+------+-------|
| Stories                                               | 36:31   |       |      | 100.0 |
| Active                                                |         | 36:31 |      | 100.0 |
| Edit release notes for previous sprint                |         |       | 5:57 |  16.3 |
| Create a demo and presentation for previous sprint    |         |       | 0:47 |   2.1 |
| Sprint and product backlog grooming                   |         |       | 1:00 |   2.7 |
| Check name of model for variability transform         |         |       | 0:19 |   0.9 |
| Analysis on templating and logical model              |         |       | 1:09 |   3.1 |
| Ensure stitch templates result in valid JSON          |         |       | 0:27 |   1.2 |
| Remove stitch template builder                        |         |       | 0:09 |   0.4 |
| Add template related attributes to physical elements  |         |       | 1:38 |   4.5 |
| Resolve references to wale templates in logical model |         |       | 1:39 |   4.5 |
| =templating= should not depend on =physical=          |         |       | 1:09 |   3.1 |
| Move decoration transform into logical model          |         |       | 5:33 |  15.2 |
| Split wale out of stitch templates                    |         |       | 3:31 |   9.6 |
| Paper: An EMF-like UML generator for C++              |         |       | 1:02 |   2.8 |
| Profiles do not support collection types              |         |       | 4:13 |  11.5 |
| Promote all formatters to archetypes                  |         |       | 6:27 |  17.7 |
| Create an encoder for org-mode                        |         |       | 1:31 |   4.2 |
