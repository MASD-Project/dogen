...
#+CAPTION: Clock summary at [2020-05-24 Sun 11:58]
| <75>                                                  |         |       |       |       |
| Headline                                              | Time    |       |       |     % |
|-------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                          | *58:18* |       |       | 100.0 |
|-------------------------------------------------------+---------+-------+-------+-------|
| Stories                                               | 58:18   |       |       | 100.0 |
| Active                                                |         | 58:18 |       | 100.0 |
| Edit release notes for previous sprint                |         |       |  5:57 |  10.2 |
| Create a demo and presentation for previous sprint    |         |       |  0:47 |   1.3 |
| Sprint and product backlog grooming                   |         |       |  1:30 |   2.6 |
...
| Move decoration transform into logical model          |         |       |  5:33 |   9.5 |
| Split wale out of stitch templates                    |         |       |  3:31 |   6.0 |
| Paper: An EMF-like UML generator for C++              |         |       |  1:02 |   1.8 |
| Paper: An Abstraction for Reusable MDD Components     |         |       |  0:56 |   1.6 |
| Profiles do not support collection types              |         |       |  4:13 |   7.2 |
| Promote all formatters to archetypes                  |         |       | 17:31 |  30.0 |
| Create archetypes for all physical elements           |         |       |  0:39 |   1.1 |
| Analysis on how to build PMM from archetypes in text  |         |       |  1:06 |   1.9 |
| Create a bootstrapping chain for context              |         |       |  3:20 |   5.7 |
| Facet and backend files are in the wrong folder       |         |       |  0:48 |   1.4 |
| Create an encoder for org-mode                        |         |       |  1:31 |   2.6 |
| Create a PMM chain in physical model                  |         |       |  3:00 |   5.1 |
