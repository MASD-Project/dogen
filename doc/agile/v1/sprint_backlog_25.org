...
#+CAPTION: Clock summary at [2020-05-12 Tue 22:29]
| <75>                                                  |         |       |      |       |
| Headline                                              | Time    |       |      |     % |
|-------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                               | 28:27   |       |      | 100.0 |
| Active                                                |         | 28:27 |      | 100.0 |
| Edit release notes for previous sprint                |         |       | 5:57 |  20.9 |
| Create a demo and presentation for previous sprint    |         |       | 0:47 |   2.8 |
| Sprint and product backlog grooming                   |         |       | 1:00 |   3.5 |
| Check name of model for variability transform         |         |       | 0:19 |   1.1 |
| Analysis on templating and logical model              |         |       | 1:09 |   4.0 |
| Ensure stitch templates result in valid JSON          |         |       | 0:27 |   1.6 |
| Remove stitch template builder                        |         |       | 0:09 |   0.5 |
| Add template related attributes to physical elements  |         |       | 1:38 |   5.7 |
| Resolve references to wale templates in logical model |         |       | 1:39 |   5.8 |
| =templating= should not depend on =physical=          |         |       | 1:09 |   4.0 |
| Move decoration transform into logical model          |         |       | 5:33 |  19.5 |
| Split wale out of stitch templates                    |         |       | 3:31 |  12.4 |
| Paper: An EMF-like UML generator for C++              |         |       | 1:02 |   3.6 |
| Promote all formatters to archetypes                  |         |       | 2:59 |  10.5 |
| Create an encoder for org-mode                        |         |       | 1:08 |   4.0 |
