...
#+CAPTION: Clock summary at [2020-05-09 Sat 08:23]
| <75>                                                  |         |       |      |       |
| Headline                                              | Time    |       |      |     % |
|-------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                          | *13:54* |       |      | 100.0 |
|-------------------------------------------------------+---------+-------+------+-------|
| Stories                                               | 13:54   |       |      | 100.0 |
| Active                                                |         | 13:54 |      | 100.0 |
| Edit release notes for previous sprint                |         |       | 5:57 |  42.8 |
| Create a demo and presentation for previous sprint    |         |       | 0:47 |   5.6 |
| Sprint and product backlog grooming                   |         |       | 0:40 |   4.8 |
| Check name of model for variability transform         |         |       | 0:19 |   2.3 |
| Analysis on templating and logical model              |         |       | 1:09 |   8.3 |
| Ensure stitch templates result in valid JSON          |         |       | 0:27 |   3.2 |
| Remove stitch template builder                        |         |       | 0:09 |   1.1 |
| Add template related attributes to physical elements  |         |       | 1:38 |  11.8 |
| Resolve references to wale templates in logical model |         |       | 1:39 |  11.9 |
| =templating= should not depend on =physical=          |         |       | 1:09 |   8.3 |
