...
#+CAPTION: Clock summary at [2020-05-16 Sat 13:03]
| <75>                                                  |         |       |       |       |
| Headline                                              | Time    |       |       |     % |
|-------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                          | *40:56* |       |       | 100.0 |
|-------------------------------------------------------+---------+-------+-------+-------|
| Stories                                               | 40:56   |       |       | 100.0 |
| Active                                                |         | 40:56 |       | 100.0 |
| Edit release notes for previous sprint                |         |       |  5:57 |  14.5 |
| Create a demo and presentation for previous sprint    |         |       |  0:47 |   1.9 |
| Sprint and product backlog grooming                   |         |       |  1:00 |   2.4 |
| Check name of model for variability transform         |         |       |  0:19 |   0.8 |
| Analysis on templating and logical model              |         |       |  1:09 |   2.8 |
| Ensure stitch templates result in valid JSON          |         |       |  0:27 |   1.1 |
| Remove stitch template builder                        |         |       |  0:09 |   0.4 |
| Add template related attributes to physical elements  |         |       |  1:38 |   4.0 |
| Resolve references to wale templates in logical model |         |       |  1:39 |   4.0 |
| =templating= should not depend on =physical=          |         |       |  1:09 |   2.8 |
| Move decoration transform into logical model          |         |       |  5:33 |  13.6 |
| Split wale out of stitch templates                    |         |       |  3:31 |   8.6 |
| Paper: An EMF-like UML generator for C++              |         |       |  1:02 |   2.5 |
| Profiles do not support collection types              |         |       |  4:13 |  10.3 |
| Promote all formatters to archetypes                  |         |       | 10:52 |  26.5 |
| Create an encoder for org-mode                        |         |       |  1:31 |   3.7 |
