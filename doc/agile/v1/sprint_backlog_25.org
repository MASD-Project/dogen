...
#+CAPTION: Clock summary at [2020-05-13 Wed 22:21]
| <75>                                                  |         |       |      |       |
| Headline                                              | Time    |       |      |     % |
|-------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                          | *29:46* |       |      | 100.0 |
|-------------------------------------------------------+---------+-------+------+-------|
| Stories                                               | 29:46   |       |      | 100.0 |
| Active                                                |         | 29:46 |      | 100.0 |
| Edit release notes for previous sprint                |         |       | 5:57 |  20.0 |
| Create a demo and presentation for previous sprint    |         |       | 0:47 |   2.6 |
| Sprint and product backlog grooming                   |         |       | 1:00 |   3.4 |
| Check name of model for variability transform         |         |       | 0:19 |   1.1 |
| Analysis on templating and logical model              |         |       | 1:09 |   3.9 |
| Ensure stitch templates result in valid JSON          |         |       | 0:27 |   1.5 |
| Remove stitch template builder                        |         |       | 0:09 |   0.5 |
| Add template related attributes to physical elements  |         |       | 1:38 |   5.5 |
| Resolve references to wale templates in logical model |         |       | 1:39 |   5.5 |
| =templating= should not depend on =physical=          |         |       | 1:09 |   3.9 |
| Move decoration transform into logical model          |         |       | 5:33 |  18.6 |
| Split wale out of stitch templates                    |         |       | 3:31 |  11.8 |
| Paper: An EMF-like UML generator for C++              |         |       | 1:02 |   3.5 |
| Promote all formatters to archetypes                  |         |       | 4:18 |  14.4 |
| Create an encoder for org-mode                        |         |       | 1:08 |   3.8 |
