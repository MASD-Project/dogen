...
#+CAPTION: Clock summary at [2020-05-25 Mon 19:14]
| <75>                                                  |         |       |       |       |
| Headline                                              | Time    |       |       |     % |
|-------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                          | *67:37* |       |       | 100.0 |
|-------------------------------------------------------+---------+-------+-------+-------|
| Stories                                               | 67:37   |       |       | 100.0 |
| Active                                                |         | 67:37 |       | 100.0 |
| Edit release notes for previous sprint                |         |       |  5:57 |   8.8 |
| Create a demo and presentation for previous sprint    |         |       |  0:47 |   1.2 |
| Sprint and product backlog grooming                   |         |       |  3:19 |   4.9 |
...
| Move decoration transform into logical model          |         |       |  5:33 |   8.2 |
| Split wale out of stitch templates                    |         |       |  3:31 |   5.2 |
| Paper: An EMF-like UML generator for C++              |         |       |  1:02 |   1.5 |
| Paper: An Abstraction for Reusable MDD Components     |         |       |  0:56 |   1.4 |
| Profiles do not support collection types              |         |       |  4:13 |   6.2 |
| Promote all formatters to archetypes                  |         |       | 17:31 |  25.9 |
| Create archetypes for all physical elements           |         |       |  0:39 |   1.0 |
| Analysis on how to build PMM from archetypes in text  |         |       |  1:06 |   1.6 |
| Create a bootstrapping chain for context              |         |       |  3:20 |   4.9 |
| Facet and backend files are in the wrong folder       |         |       |  0:48 |   1.2 |
| Fix =static_archetype= method in archetypes           |         |       |  1:25 |   2.1 |
| Extend tracing to M2T transforms                      |         |       |  3:51 |   5.7 |
| Create an encoder for org-mode                        |         |       |  1:31 |   2.2 |
| Create a PMM chain in physical model                  |         |       |  4:25 |   6.5 |
| Add "scoped tracing" via regexes                      |         |       |  0:49 |   1.2 |
...
*** STARTED Add "scoped tracing" via regexes                          :story:
    :LOGBOOK:
