...
#+CAPTION: Clock summary at [2020-05-25 Mon 12:40]
| <75>                                                  |         |       |       |       |
| Headline                                              | Time    |       |       |     % |
|-------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                          | *65:41* |       |       | 100.0 |
|-------------------------------------------------------+---------+-------+-------+-------|
| Stories                                               | 65:41   |       |       | 100.0 |
| Active                                                |         | 65:41 |       | 100.0 |
| Edit release notes for previous sprint                |         |       |  5:57 |   9.1 |
| Create a demo and presentation for previous sprint    |         |       |  0:47 |   1.2 |
| Sprint and product backlog grooming                   |         |       |  3:19 |   5.0 |
...
| Add template related attributes to physical elements  |         |       |  1:38 |   2.5 |
| Resolve references to wale templates in logical model |         |       |  1:39 |   2.5 |
| =templating= should not depend on =physical=          |         |       |  1:09 |   1.8 |
| Move decoration transform into logical model          |         |       |  5:33 |   8.4 |
| Split wale out of stitch templates                    |         |       |  3:31 |   5.4 |
| Paper: An EMF-like UML generator for C++              |         |       |  1:02 |   1.6 |
| Paper: An Abstraction for Reusable MDD Components     |         |       |  0:56 |   1.4 |
| Profiles do not support collection types              |         |       |  4:13 |   6.4 |
| Promote all formatters to archetypes                  |         |       | 17:31 |  26.7 |
| Create archetypes for all physical elements           |         |       |  0:39 |   1.0 |
| Analysis on how to build PMM from archetypes in text  |         |       |  1:06 |   1.7 |
| Create a bootstrapping chain for context              |         |       |  3:20 |   5.1 |
| Facet and backend files are in the wrong folder       |         |       |  0:48 |   1.2 |
| Fix =static_archetype= method in archetypes           |         |       |  1:25 |   2.2 |
| Create an encoder for org-mode                        |         |       |  1:31 |   2.3 |
| Create a PMM chain in physical model                  |         |       |  4:25 |   6.7 |
| Extend tracing to M2T transforms                      |         |       |  2:44 |   4.2 |
