...
#+CAPTION: Clock summary at [2020-05-08 Fri 11:34]
| <75>                                               |        |      |      |       |
| Headline                                           | Time   |      |      |     % |
|----------------------------------------------------+--------+------+------+-------|
...
| Stories                                            | 9:01   |      |      | 100.0 |
| Active                                             |        | 9:01 |      | 100.0 |
| Edit release notes for previous sprint             |        |      | 5:57 |  66.0 |
| Create a demo and presentation for previous sprint |        |      | 0:47 |   8.7 |
| Sprint and product backlog grooming                |        |      | 0:40 |   7.4 |
| Check name of model for variability transform      |        |      | 0:19 |   3.5 |
| Analysis on templating and logical model           |        |      | 1:09 |  12.8 |
| Ensure stitch templates result in valid JSON       |        |      | 0:09 |   1.7 |
...
*** STARTED Ensure stitch templates result in valid JSON              :story:
    :LOGBOOK:
...
*** Add template related attributes to physical elements              :story:
