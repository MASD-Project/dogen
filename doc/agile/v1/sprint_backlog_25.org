...
#+CAPTION: Clock summary at [2020-05-24 Sun 15:28]
| <75>                                                  |         |       |       |       |
| Headline                                              | Time    |       |       |     % |
|-------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                          | *60:41* |       |       | 100.0 |
|-------------------------------------------------------+---------+-------+-------+-------|
| Stories                                               | 60:41   |       |       | 100.0 |
| Active                                                |         | 60:41 |       | 100.0 |
| Edit release notes for previous sprint                |         |       |  5:57 |   9.8 |
| Create a demo and presentation for previous sprint    |         |       |  0:47 |   1.3 |
| Sprint and product backlog grooming                   |         |       |  2:20 |   3.8 |
| Nightly nursing                                       |         |       |  0:24 |   0.7 |
| Check name of model for variability transform         |         |       |  0:19 |   0.5 |
| Analysis on templating and logical model              |         |       |  1:09 |   1.9 |
| Ensure stitch templates result in valid JSON          |         |       |  0:27 |   0.7 |
| Remove stitch template builder                        |         |       |  0:09 |   0.2 |
| Add template related attributes to physical elements  |         |       |  1:38 |   2.7 |
| Resolve references to wale templates in logical model |         |       |  1:39 |   2.7 |
| =templating= should not depend on =physical=          |         |       |  1:09 |   1.9 |
| Move decoration transform into logical model          |         |       |  5:33 |   9.1 |
| Split wale out of stitch templates                    |         |       |  3:31 |   5.8 |
| Paper: An EMF-like UML generator for C++              |         |       |  1:02 |   1.7 |
| Paper: An Abstraction for Reusable MDD Components     |         |       |  0:56 |   1.5 |
| Profiles do not support collection types              |         |       |  4:13 |   6.9 |
| Promote all formatters to archetypes                  |         |       | 17:31 |  28.9 |
| Create archetypes for all physical elements           |         |       |  0:39 |   1.1 |
| Analysis on how to build PMM from archetypes in text  |         |       |  1:06 |   1.8 |
| Create a bootstrapping chain for context              |         |       |  3:20 |   5.5 |
| Facet and backend files are in the wrong folder       |         |       |  0:48 |   1.3 |
| Create an encoder for org-mode                        |         |       |  1:31 |   2.5 |
| Create a PMM chain in physical model                  |         |       |  4:25 |   7.3 |
| Fix =static_archetype= method in archetypes           |         |       |  0:08 |   0.2 |
...
*** STARTED Fix =static_archetype= method in archetypes               :story:
    :LOGBOOK:
...
- add logging includes and setup to transforms.
- add scoped tracer to all transforms.
- add io for archertypes and elements to all transforms.
