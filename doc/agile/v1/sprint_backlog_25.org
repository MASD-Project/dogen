...
#+CAPTION: Clock summary at [2020-05-09 Sat 17:55]
| <75>                                                  |         |       |      |       |
| Headline                                              | Time    |       |      |     % |
|-------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                          | *19:22* |       |      | 100.0 |
|-------------------------------------------------------+---------+-------+------+-------|
| Stories                                               | 19:22   |       |      | 100.0 |
| Active                                                |         | 19:22 |      | 100.0 |
| Edit release notes for previous sprint                |         |       | 5:57 |  30.7 |
| Create a demo and presentation for previous sprint    |         |       | 0:47 |   4.0 |
| Sprint and product backlog grooming                   |         |       | 1:00 |   5.2 |
| Check name of model for variability transform         |         |       | 0:19 |   1.6 |
| Analysis on templating and logical model              |         |       | 1:09 |   5.9 |
| Ensure stitch templates result in valid JSON          |         |       | 0:27 |   2.3 |
| Remove stitch template builder                        |         |       | 0:09 |   0.8 |
| Add template related attributes to physical elements  |         |       | 1:38 |   8.4 |
| Resolve references to wale templates in logical model |         |       | 1:39 |   8.5 |
| =templating= should not depend on =physical=          |         |       | 1:09 |   5.9 |
| Split wale out of stitch templates                    |         |       | 4:52 |  25.1 |
| Move decoration transform into logical model          |         |       | 0:16 |   1.4 |
