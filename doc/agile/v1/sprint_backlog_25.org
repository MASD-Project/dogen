...
#+CAPTION: Clock summary at [2020-05-10 Sun 15:55]
| <75>                                                  |         |       |      |       |
| Headline                                              | Time    |       |      |     % |
|-------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                          | *24:39* |       |      | 100.0 |
|-------------------------------------------------------+---------+-------+------+-------|
| Stories                                               | 24:39   |       |      | 100.0 |
| Active                                                |         | 24:39 |      | 100.0 |
| Edit release notes for previous sprint                |         |       | 5:57 |  24.1 |
| Create a demo and presentation for previous sprint    |         |       | 0:47 |   3.2 |
| Sprint and product backlog grooming                   |         |       | 1:00 |   4.1 |
| Check name of model for variability transform         |         |       | 0:19 |   1.3 |
| Analysis on templating and logical model              |         |       | 1:09 |   4.7 |
| Ensure stitch templates result in valid JSON          |         |       | 0:27 |   1.8 |
| Remove stitch template builder                        |         |       | 0:09 |   0.6 |
| Add template related attributes to physical elements  |         |       | 1:38 |   6.6 |
| Resolve references to wale templates in logical model |         |       | 1:39 |   6.7 |
| =templating= should not depend on =physical=          |         |       | 1:09 |   4.7 |
| Move decoration transform into logical model          |         |       | 5:33 |  22.5 |
| Split wale out of stitch templates                    |         |       | 4:52 |  19.7 |
