...
#+CAPTION: Clock summary at [2020-05-15 Fri 12:52]
| <75>                                                  |         |       |      |       |
| Headline                                              | Time    |       |      |     % |
|-------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                          | *33:36* |       |      | 100.0 |
|-------------------------------------------------------+---------+-------+------+-------|
| Stories                                               | 33:36   |       |      | 100.0 |
| Active                                                |         | 33:36 |      | 100.0 |
| Edit release notes for previous sprint                |         |       | 5:57 |  17.7 |
| Create a demo and presentation for previous sprint    |         |       | 0:47 |   2.3 |
| Sprint and product backlog grooming                   |         |       | 1:00 |   3.0 |
| Check name of model for variability transform         |         |       | 0:19 |   0.9 |
| Analysis on templating and logical model              |         |       | 1:09 |   3.4 |
| Ensure stitch templates result in valid JSON          |         |       | 0:27 |   1.3 |
| Remove stitch template builder                        |         |       | 0:09 |   0.4 |
| Add template related attributes to physical elements  |         |       | 1:38 |   4.9 |
| Resolve references to wale templates in logical model |         |       | 1:39 |   4.9 |
| =templating= should not depend on =physical=          |         |       | 1:09 |   3.4 |
| Move decoration transform into logical model          |         |       | 5:33 |  16.5 |
| Split wale out of stitch templates                    |         |       | 3:31 |  10.5 |
| Paper: An EMF-like UML generator for C++              |         |       | 1:02 |   3.1 |
| Promote all formatters to archetypes                  |         |       | 6:27 |  19.2 |
| Create an encoder for org-mode                        |         |       | 1:31 |   4.5 |
| Profiles do not support collection types              |         |       | 1:18 |   3.9 |
...
*** STARTED Profiles do not support collection types                  :story:
    :LOGBOOK:
