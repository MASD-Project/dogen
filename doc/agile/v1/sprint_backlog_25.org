...
#+CAPTION: Clock summary at [2020-05-21 Thu 22:51]
| <75>                                                  |         |       |       |       |
| Headline                                              | Time    |       |       |     % |
|-------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                          | *49:31* |       |       | 100.0 |
|-------------------------------------------------------+---------+-------+-------+-------|
| Stories                                               | 49:31   |       |       | 100.0 |
| Active                                                |         | 49:31 |       | 100.0 |
| Edit release notes for previous sprint                |         |       |  5:57 |  12.0 |
| Create a demo and presentation for previous sprint    |         |       |  0:47 |   1.6 |
| Sprint and product backlog grooming                   |         |       |  1:10 |   2.4 |
| Nightly nursing                                       |         |       |  0:11 |   0.4 |
| Check name of model for variability transform         |         |       |  0:19 |   0.6 |
| Analysis on templating and logical model              |         |       |  1:09 |   2.3 |
| Ensure stitch templates result in valid JSON          |         |       |  0:27 |   0.9 |
| Remove stitch template builder                        |         |       |  0:09 |   0.3 |
| Add template related attributes to physical elements  |         |       |  1:38 |   3.3 |
| Resolve references to wale templates in logical model |         |       |  1:39 |   3.3 |
| =templating= should not depend on =physical=          |         |       |  1:09 |   2.3 |
| Move decoration transform into logical model          |         |       |  5:33 |  11.2 |
| Split wale out of stitch templates                    |         |       |  3:31 |   7.1 |
| Paper: An EMF-like UML generator for C++              |         |       |  1:02 |   2.1 |
| Paper: An Abstraction for Reusable MDD Components     |         |       |  0:56 |   1.9 |
| Profiles do not support collection types              |         |       |  4:13 |   8.5 |
| Promote all formatters to archetypes                  |         |       | 17:31 |  35.4 |
| Create an encoder for org-mode                        |         |       |  1:31 |   3.1 |
...
*** STARTED Create archetypes for all physical elements               :story:
    :LOGBOOK:
