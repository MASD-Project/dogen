...
#+CAPTION: Clock summary at [2020-05-25 Mon 10:43]
| <75>                                                  |         |       |       |       |
| Headline                                              | Time    |       |       |     % |
|-------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                          | *63:48* |       |       | 100.0 |
|-------------------------------------------------------+---------+-------+-------+-------|
| Stories                                               | 63:48   |       |       | 100.0 |
| Active                                                |         | 63:48 |       | 100.0 |
| Edit release notes for previous sprint                |         |       |  5:57 |   9.3 |
| Create a demo and presentation for previous sprint    |         |       |  0:47 |   1.2 |
| Sprint and product backlog grooming                   |         |       |  2:53 |   4.5 |
| Nightly nursing                                       |         |       |  0:24 |   0.6 |
| Check name of model for variability transform         |         |       |  0:19 |   0.5 |
| Analysis on templating and logical model              |         |       |  1:09 |   1.8 |
| Ensure stitch templates result in valid JSON          |         |       |  0:27 |   0.7 |
| Remove stitch template builder                        |         |       |  0:09 |   0.2 |
| Add template related attributes to physical elements  |         |       |  1:38 |   2.6 |
| Resolve references to wale templates in logical model |         |       |  1:39 |   2.6 |
| =templating= should not depend on =physical=          |         |       |  1:09 |   1.8 |
| Move decoration transform into logical model          |         |       |  5:33 |   8.7 |
| Split wale out of stitch templates                    |         |       |  3:31 |   5.5 |
| Paper: An EMF-like UML generator for C++              |         |       |  1:02 |   1.6 |
| Paper: An Abstraction for Reusable MDD Components     |         |       |  0:56 |   1.5 |
| Profiles do not support collection types              |         |       |  4:13 |   6.6 |
| Promote all formatters to archetypes                  |         |       | 17:31 |  27.5 |
| Create archetypes for all physical elements           |         |       |  0:39 |   1.0 |
| Analysis on how to build PMM from archetypes in text  |         |       |  1:06 |   1.7 |
| Create a bootstrapping chain for context              |         |       |  3:20 |   5.2 |
| Facet and backend files are in the wrong folder       |         |       |  0:48 |   1.3 |
| Fix =static_archetype= method in archetypes           |         |       |  1:25 |   2.2 |
| Create an encoder for org-mode                        |         |       |  1:31 |   2.4 |
| Create a PMM chain in physical model                  |         |       |  4:25 |   6.9 |
| Extend tracing to M2T transforms                      |         |       |  1:17 |   2.0 |
...
*** STARTED Extend tracing to M2T transforms                          :story:
    :LOGBOOK:
...
*** Add "scoped tracing" via regexes                                  :story:
