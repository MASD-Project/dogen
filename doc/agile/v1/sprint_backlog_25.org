...
#+CAPTION: Clock summary at [2020-05-22 Fri 12:41]
| <75>                                                  |         |       |       |       |
| Headline                                              | Time    |       |       |     % |
|-------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                          | *51:36* |       |       | 100.0 |
|-------------------------------------------------------+---------+-------+-------+-------|
| Stories                                               | 51:36   |       |       | 100.0 |
| Active                                                |         | 51:36 |       | 100.0 |
| Edit release notes for previous sprint                |         |       |  5:57 |  11.5 |
| Create a demo and presentation for previous sprint    |         |       |  0:47 |   1.5 |
| Sprint and product backlog grooming                   |         |       |  1:10 |   2.3 |
| Nightly nursing                                       |         |       |  0:11 |   0.4 |
| Check name of model for variability transform         |         |       |  0:19 |   0.6 |
| Analysis on templating and logical model              |         |       |  1:09 |   2.2 |
| Ensure stitch templates result in valid JSON          |         |       |  0:27 |   0.9 |
| Remove stitch template builder                        |         |       |  0:09 |   0.3 |
| Add template related attributes to physical elements  |         |       |  1:38 |   3.2 |
| Resolve references to wale templates in logical model |         |       |  1:39 |   3.2 |
| =templating= should not depend on =physical=          |         |       |  1:09 |   2.2 |
| Move decoration transform into logical model          |         |       |  5:33 |  10.8 |
| Split wale out of stitch templates                    |         |       |  3:31 |   6.8 |
| Paper: An EMF-like UML generator for C++              |         |       |  1:02 |   2.0 |
| Paper: An Abstraction for Reusable MDD Components     |         |       |  0:56 |   1.8 |
| Profiles do not support collection types              |         |       |  4:13 |   8.2 |
| Promote all formatters to archetypes                  |         |       | 17:31 |  33.9 |
| Create archetypes for all physical elements           |         |       |  0:39 |   1.3 |
| Analysis on how to build PMM from archetypes in text  |         |       |  1:06 |   2.1 |
| Create an encoder for org-mode                        |         |       |  1:31 |   2.9 |
| Create a PMM chain in physical model                  |         |       |  0:59 |   1.9 |
