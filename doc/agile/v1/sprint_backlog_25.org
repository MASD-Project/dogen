...
#+CAPTION: Clock summary at [2020-05-10 Sun 18:25]
| <75>                                                  |         |       |      |       |
| Headline                                              | Time    |       |      |     % |
|-------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                          | *25:36* |       |      | 100.0 |
|-------------------------------------------------------+---------+-------+------+-------|
| Stories                                               | 25:36   |       |      | 100.0 |
| Active                                                |         | 25:36 |      | 100.0 |
| Edit release notes for previous sprint                |         |       | 5:57 |  23.2 |
| Create a demo and presentation for previous sprint    |         |       | 0:47 |   3.1 |
| Sprint and product backlog grooming                   |         |       | 1:00 |   3.9 |
| Check name of model for variability transform         |         |       | 0:19 |   1.2 |
| Analysis on templating and logical model              |         |       | 1:09 |   4.5 |
| Ensure stitch templates result in valid JSON          |         |       | 0:27 |   1.8 |
| Remove stitch template builder                        |         |       | 0:09 |   0.6 |
| Add template related attributes to physical elements  |         |       | 1:38 |   6.4 |
| Resolve references to wale templates in logical model |         |       | 1:39 |   6.4 |
| =templating= should not depend on =physical=          |         |       | 1:09 |   4.5 |
| Move decoration transform into logical model          |         |       | 5:33 |  21.7 |
| Split wale out of stitch templates                    |         |       | 3:31 |  13.7 |
| Promote all formatters to archetypes                  |         |       | 2:18 |   9.0 |
