...
#+CAPTION: Clock summary at [2020-05-10 Sun 13:44]
| <75>                                                  |         |       |      |       |
| Headline                                              | Time    |       |      |     % |
|-------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                          | *23:23* |       |      | 100.0 |
|-------------------------------------------------------+---------+-------+------+-------|
| Stories                                               | 23:23   |       |      | 100.0 |
| Active                                                |         | 23:23 |      | 100.0 |
| Edit release notes for previous sprint                |         |       | 5:57 |  25.4 |
| Create a demo and presentation for previous sprint    |         |       | 0:47 |   3.3 |
| Sprint and product backlog grooming                   |         |       | 1:00 |   4.3 |
| Check name of model for variability transform         |         |       | 0:19 |   1.4 |
| Analysis on templating and logical model              |         |       | 1:09 |   4.9 |
| Ensure stitch templates result in valid JSON          |         |       | 0:27 |   1.9 |
| Remove stitch template builder                        |         |       | 0:09 |   0.6 |
| Add template related attributes to physical elements  |         |       | 1:38 |   7.0 |
| Resolve references to wale templates in logical model |         |       | 1:39 |   7.1 |
| =templating= should not depend on =physical=          |         |       | 1:09 |   4.9 |
| Split wale out of stitch templates                    |         |       | 4:52 |  20.8 |
| Move decoration transform into logical model          |         |       | 4:17 |  18.3 |
...
*** STARTED Split wale out of stitch templates                        :story:
    :LOGBOOK:
...
*** STARTED Move decoration transform into logical model              :story:
    :LOGBOOK:
