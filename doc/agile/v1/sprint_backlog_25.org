...
#+CAPTION: Clock summary at [2020-05-24 Sun 13:02]
| <75>                                                  |         |       |       |       |
| Headline                                              | Time    |       |       |     % |
|-------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                          | *59:19* |       |       | 100.0 |
|-------------------------------------------------------+---------+-------+-------+-------|
| Stories                                               | 59:19   |       |       | 100.0 |
| Active                                                |         | 59:19 |       | 100.0 |
| Edit release notes for previous sprint                |         |       |  5:57 |  10.0 |
| Create a demo and presentation for previous sprint    |         |       |  0:47 |   1.3 |
| Sprint and product backlog grooming                   |         |       |  1:30 |   2.5 |
...
| Add template related attributes to physical elements  |         |       |  1:38 |   2.8 |
| Resolve references to wale templates in logical model |         |       |  1:39 |   2.8 |
| =templating= should not depend on =physical=          |         |       |  1:09 |   1.9 |
| Move decoration transform into logical model          |         |       |  5:33 |   9.4 |
| Split wale out of stitch templates                    |         |       |  3:31 |   5.9 |
| Paper: An EMF-like UML generator for C++              |         |       |  1:02 |   1.7 |
| Paper: An Abstraction for Reusable MDD Components     |         |       |  0:56 |   1.6 |
| Profiles do not support collection types              |         |       |  4:13 |   7.1 |
| Promote all formatters to archetypes                  |         |       | 17:31 |  29.5 |
| Create archetypes for all physical elements           |         |       |  0:39 |   1.1 |
| Analysis on how to build PMM from archetypes in text  |         |       |  1:06 |   1.9 |
| Create a bootstrapping chain for context              |         |       |  3:20 |   5.6 |
| Facet and backend files are in the wrong folder       |         |       |  0:48 |   1.3 |
| Create an encoder for org-mode                        |         |       |  1:31 |   2.6 |
| Create a PMM chain in physical model                  |         |       |  4:01 |   6.8 |
