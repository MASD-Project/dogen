...
#+CAPTION: Clock summary at [2020-05-22 Fri 18:27]
| <75>                                                  |         |       |       |       |
| Headline                                              | Time    |       |       |     % |
|-------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                               | 53:16   |       |       | 100.0 |
| Active                                                |         | 53:16 |       | 100.0 |
| Edit release notes for previous sprint                |         |       |  5:57 |  11.2 |
| Create a demo and presentation for previous sprint    |         |       |  0:47 |   1.5 |
| Sprint and product backlog grooming                   |         |       |  1:10 |   2.2 |
...
| Add template related attributes to physical elements  |         |       |  1:38 |   3.1 |
| Resolve references to wale templates in logical model |         |       |  1:39 |   3.1 |
| =templating= should not depend on =physical=          |         |       |  1:09 |   2.2 |
| Move decoration transform into logical model          |         |       |  5:33 |  10.4 |
| Split wale out of stitch templates                    |         |       |  3:31 |   6.6 |
| Paper: An EMF-like UML generator for C++              |         |       |  1:02 |   1.9 |
| Paper: An Abstraction for Reusable MDD Components     |         |       |  0:56 |   1.8 |
| Profiles do not support collection types              |         |       |  4:13 |   7.9 |
| Promote all formatters to archetypes                  |         |       | 17:31 |  32.9 |
| Create archetypes for all physical elements           |         |       |  0:39 |   1.2 |
| Analysis on how to build PMM from archetypes in text  |         |       |  1:06 |   2.1 |
| Create an encoder for org-mode                        |         |       |  1:31 |   2.8 |
| Create a PMM chain in physical model                  |         |       |  2:39 |   5.0 |
