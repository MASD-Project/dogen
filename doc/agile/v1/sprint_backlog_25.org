...
#+CAPTION: Clock summary at [2020-05-15 Fri 19:30]
| <75>                                                  |         |       |      |       |
| Headline                                              | Time    |       |      |     % |
|-------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                               | 38:55   |       |      | 100.0 |
| Active                                                |         | 38:55 |      | 100.0 |
| Edit release notes for previous sprint                |         |       | 5:57 |  15.3 |
...
| Add template related attributes to physical elements  |         |       | 1:38 |   4.2 |
| Resolve references to wale templates in logical model |         |       | 1:39 |   4.2 |
| =templating= should not depend on =physical=          |         |       | 1:09 |   3.0 |
| Move decoration transform into logical model          |         |       | 5:33 |  14.3 |
| Split wale out of stitch templates                    |         |       | 3:31 |   9.0 |
| Paper: An EMF-like UML generator for C++              |         |       | 1:02 |   2.7 |
| Profiles do not support collection types              |         |       | 4:13 |  10.8 |
| Promote all formatters to archetypes                  |         |       | 8:51 |  22.7 |
| Create an encoder for org-mode                        |         |       | 1:31 |   3.9 |
