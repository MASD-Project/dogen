...
#+CAPTION: Clock summary at [2020-05-15 Fri 22:12]
| <75>                                                  |         |       |      |       |
| Headline                                              | Time    |       |      |     % |
|-------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                          | *39:33* |       |      | 100.0 |
|-------------------------------------------------------+---------+-------+------+-------|
| Stories                                               | 39:33   |       |      | 100.0 |
| Active                                                |         | 39:33 |      | 100.0 |
| Edit release notes for previous sprint                |         |       | 5:57 |  15.0 |
...
| Analysis on templating and logical model              |         |       | 1:09 |   2.9 |
| Ensure stitch templates result in valid JSON          |         |       | 0:27 |   1.1 |
| Remove stitch template builder                        |         |       | 0:09 |   0.4 |
| Add template related attributes to physical elements  |         |       | 1:38 |   4.1 |
| Resolve references to wale templates in logical model |         |       | 1:39 |   4.2 |
| =templating= should not depend on =physical=          |         |       | 1:09 |   2.9 |
| Move decoration transform into logical model          |         |       | 5:33 |  14.0 |
| Split wale out of stitch templates                    |         |       | 3:31 |   8.9 |
| Paper: An EMF-like UML generator for C++              |         |       | 1:02 |   2.6 |
| Profiles do not support collection types              |         |       | 4:13 |  10.7 |
| Promote all formatters to archetypes                  |         |       | 9:29 |  24.0 |
| Create an encoder for org-mode                        |         |       | 1:31 |   3.8 |
