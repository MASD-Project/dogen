...
#+CAPTION: Clock summary at [2020-05-18 Mon 22:01]
| <75>                                                  |         |       |       |       |
| Headline                                              | Time    |       |       |     % |
|-------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                          | *47:48* |       |       | 100.0 |
|-------------------------------------------------------+---------+-------+-------+-------|
| Stories                                               | 47:48   |       |       | 100.0 |
| Active                                                |         | 47:48 |       | 100.0 |
| Edit release notes for previous sprint                |         |       |  5:57 |  12.4 |
| Create a demo and presentation for previous sprint    |         |       |  0:47 |   1.6 |
| Sprint and product backlog grooming                   |         |       |  1:00 |   2.1 |
| Nightly nursing                                       |         |       |  0:11 |   0.4 |
| Check name of model for variability transform         |         |       |  0:19 |   0.7 |
| Analysis on templating and logical model              |         |       |  1:09 |   2.4 |
| Ensure stitch templates result in valid JSON          |         |       |  0:27 |   0.9 |
| Remove stitch template builder                        |         |       |  0:09 |   0.3 |
| Add template related attributes to physical elements  |         |       |  1:38 |   3.4 |
| Resolve references to wale templates in logical model |         |       |  1:39 |   3.5 |
| =templating= should not depend on =physical=          |         |       |  1:09 |   2.4 |
| Move decoration transform into logical model          |         |       |  5:33 |  11.6 |
| Split wale out of stitch templates                    |         |       |  3:31 |   7.4 |
| Paper: An EMF-like UML generator for C++              |         |       |  1:02 |   2.2 |
| Paper: An Abstraction for Reusable MDD Components     |         |       |  0:56 |   2.0 |
| Profiles do not support collection types              |         |       |  4:13 |   8.8 |
| Promote all formatters to archetypes                  |         |       | 16:37 |  34.8 |
| Create an encoder for org-mode                        |         |       |  1:31 |   3.2 |
...
- give the "MASD kernel" a name, so that we future proof ourselves
  ...
  =vanilla= or any such bland names. It would be nice to have a name
  that reflects the purpose. The purpose of this kernel is to provide
  a "native" programming language implementation. Perhaps =native=? Or
  we could say its not an MDE kernel.
