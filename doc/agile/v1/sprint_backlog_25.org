...
#+CAPTION: Clock summary at [2020-05-08 Fri 17:30]
| <75>                                                  |         |       |      |       |
| Headline                                              | Time    |       |      |     % |
|-------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                          | *13:22* |       |      | 100.0 |
|-------------------------------------------------------+---------+-------+------+-------|
| Stories                                               | 13:22   |       |      | 100.0 |
| Active                                                |         | 13:22 |      | 100.0 |
| Edit release notes for previous sprint                |         |       | 5:57 |  44.5 |
| Create a demo and presentation for previous sprint    |         |       | 0:47 |   5.9 |
| Sprint and product backlog grooming                   |         |       | 0:40 |   5.0 |
| Check name of model for variability transform         |         |       | 0:19 |   2.4 |
| Analysis on templating and logical model              |         |       | 1:09 |   8.6 |
| Ensure stitch templates result in valid JSON          |         |       | 0:27 |   3.4 |
| Remove stitch template builder                        |         |       | 0:09 |   1.1 |
| Add template related attributes to physical elements  |         |       | 1:38 |  12.2 |
| Resolve references to wale templates in logical model |         |       | 1:39 |  12.3 |
| =templating= should not depend on =physical=          |         |       | 0:37 |   4.6 |
