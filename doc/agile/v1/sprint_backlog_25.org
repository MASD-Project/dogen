...
#+CAPTION: Clock summary at [2020-05-16 Sat 18:23]
| <75>                                                  |         |       |       |       |
| Headline                                              | Time    |       |       |     % |
|-------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                          | *41:50* |       |       | 100.0 |
|-------------------------------------------------------+---------+-------+-------+-------|
| Stories                                               | 41:50   |       |       | 100.0 |
| Active                                                |         | 41:50 |       | 100.0 |
| Edit release notes for previous sprint                |         |       |  5:57 |  14.2 |
...
| Analysis on templating and logical model              |         |       |  1:09 |   2.7 |
| Ensure stitch templates result in valid JSON          |         |       |  0:27 |   1.1 |
| Remove stitch template builder                        |         |       |  0:09 |   0.4 |
| Add template related attributes to physical elements  |         |       |  1:38 |   3.9 |
| Resolve references to wale templates in logical model |         |       |  1:39 |   3.9 |
| =templating= should not depend on =physical=          |         |       |  1:09 |   2.7 |
| Move decoration transform into logical model          |         |       |  5:33 |  13.3 |
| Split wale out of stitch templates                    |         |       |  3:31 |   8.4 |
| Paper: An EMF-like UML generator for C++              |         |       |  1:02 |   2.5 |
| Profiles do not support collection types              |         |       |  4:13 |  10.1 |
| Promote all formatters to archetypes                  |         |       | 11:46 |  28.1 |
| Create an encoder for org-mode                        |         |       |  1:31 |   3.6 |
