...
#+CAPTION: Clock summary at [2017-10-31 Tue 19:33]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *46:11* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 46:11   |       |       | 100.0 |
| Active                                                                      |         | 46:11 |       | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  2:19 |   5.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:25 |   3.1 |
| CANCELLED Add an "at" field to transform stats                              |         |       |  0:10 |   0.4 |
| COMPLETED Move enablement into yarn                                         |         |       |  1:01 |   2.2 |
| COMPLETED Consider revamping the project logo                               |         |       |  2:02 |   4.4 |
| COMPLETED Rename top-level transformations                                  |         |       |  1:33 |   3.4 |
| COMPLETED Clean-up context usage                                            |         |       |  0:38 |   1.4 |
| COMPLETED Housekeeper should know of text models                            |         |       |  2:05 |   4.5 |
| COMPLETED Rename the model to text transforms                               |         |       |  0:29 |   1.0 |
| COMPLETED Rename kernel and family                                          |         |       |  2:44 |   5.9 |
| COMPLETED Clean up formatter names                                          |         |       |  1:00 |   2.2 |
| COMPLETED Caching in travis                                                 |         |       |  0:59 |   2.1 |
| COMPLETED Consider collapsing element properties into element               |         |       |  1:08 |   2.5 |
| COMPLETED Create the archetype location properties                          |         |       | 13:58 |  30.2 |
| COMPLETED Analysis work on moving to c++ 17                                 |         |       |  0:32 |   1.2 |
| COMPLETED Upgrade rtags to latest                                           |         |       |  0:36 |   1.3 |
| COMPLETED Experiment with adding colour to dia diagrams                     |         |       |  3:01 |   6.5 |
| STARTED Generate file paths as a transform                                  |         |       |  9:01 |  19.5 |
| STARTED Experiment with a database model                                    |         |       |  1:20 |   2.9 |
| STARTED Move artefact into yarn                                             |         |       |  0:10 |   0.4 |
...
*** STARTED Move artefact into yarn                                   :story:
