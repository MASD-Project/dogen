...
#+CAPTION: Clock summary at [2017-10-17 Tue 19:07]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                                     | 35:15   |       |       | 100.0 |
| Active                                                                      |         | 35:15 |       | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  2:19 |   6.6 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:45 |   2.1 |
| CANCELLED Add an "at" field to transform stats                              |         |       |  0:10 |   0.5 |
| COMPLETED Move enablement into yarn                                         |         |       |  1:01 |   2.9 |
| COMPLETED Consider revamping the project logo                               |         |       |  2:02 |   5.8 |
| COMPLETED Rename top-level transformations                                  |         |       |  1:33 |   4.4 |
| COMPLETED Clean-up context usage                                            |         |       |  0:38 |   1.8 |
| COMPLETED Housekeeper should know of text models                            |         |       |  2:05 |   5.9 |
| COMPLETED Rename the model to text transforms                               |         |       |  0:29 |   1.4 |
| COMPLETED Rename kernel and family                                          |         |       |  2:44 |   7.8 |
| COMPLETED Clean up formatter names                                          |         |       |  1:00 |   2.8 |
| COMPLETED Caching in travis                                                 |         |       |  0:59 |   2.8 |
| COMPLETED Consider collapsing element properties into element               |         |       |  1:08 |   3.2 |
| STARTED Create the archetype location properties                            |         |       | 11:53 |  33.7 |
| STARTED Generate file paths as a transform                                  |         |       |  6:29 |  18.4 |
