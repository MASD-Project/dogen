...
#+CAPTION: Clock summary at [2017-10-08 Sun 16:19]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *25:42* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 25:42   |       |      | 100.0 |
| Active                                                                      |         | 25:42 |      | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 2:19 |   9.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:45 |   2.9 |
| CANCELLED Add an "at" field to transform stats                              |         |       | 0:10 |   0.6 |
| COMPLETED Move enablement into yarn                                         |         |       | 1:01 |   4.0 |
| COMPLETED Consider revamping the project logo                               |         |       | 2:02 |   7.9 |
| COMPLETED Rename top-level transformations                                  |         |       | 1:33 |   6.0 |
| COMPLETED Clean-up context usage                                            |         |       | 0:38 |   2.5 |
| COMPLETED Housekeeper should know of text models                            |         |       | 2:05 |   8.1 |
| COMPLETED Rename the model to text transforms                               |         |       | 0:29 |   1.9 |
| COMPLETED Rename kernel and family                                          |         |       | 2:44 |  10.6 |
| STARTED Clean up formatter names                                            |         |       | 0:37 |   2.4 |
| STARTED Create the archetype location properties                            |         |       | 4:50 |  18.8 |
| STARTED Generate file paths as a transform                                  |         |       | 6:29 |  25.2 |
