...
#+CAPTION: Clock summary at [2017-10-21 Sat 11:48]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *40:12* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 40:12   |       |       | 100.0 |
| Active                                                                      |         | 40:12 |       | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  2:19 |   5.8 |
...
| COMPLETED Consider revamping the project logo                               |         |       |  2:02 |   5.1 |
| COMPLETED Rename top-level transformations                                  |         |       |  1:33 |   3.9 |
| COMPLETED Clean-up context usage                                            |         |       |  0:38 |   1.6 |
| COMPLETED Housekeeper should know of text models                            |         |       |  2:05 |   5.2 |
| COMPLETED Rename the model to text transforms                               |         |       |  0:29 |   1.2 |
| COMPLETED Rename kernel and family                                          |         |       |  2:44 |   6.8 |
...
| COMPLETED Create the archetype location properties                          |         |       | 13:58 |  34.7 |
| STARTED Generate file paths as a transform                                  |         |       |  9:01 |  22.4 |
