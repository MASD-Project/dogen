...
#+CAPTION: Clock summary at [2017-10-20 Fri 10:55]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *37:20* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 37:20   |       |       | 100.0 |
| Active                                                                      |         | 37:20 |       | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  2:19 |   6.2 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:45 |   2.0 |
| CANCELLED Add an "at" field to transform stats                              |         |       |  0:10 |   0.4 |
| COMPLETED Move enablement into yarn                                         |         |       |  1:01 |   2.7 |
| COMPLETED Consider revamping the project logo                               |         |       |  2:02 |   5.4 |
| COMPLETED Rename top-level transformations                                  |         |       |  1:33 |   4.2 |
| COMPLETED Clean-up context usage                                            |         |       |  0:38 |   1.7 |
| COMPLETED Housekeeper should know of text models                            |         |       |  2:05 |   5.6 |
| COMPLETED Rename the model to text transforms                               |         |       |  0:29 |   1.3 |
| COMPLETED Rename kernel and family                                          |         |       |  2:44 |   7.3 |
| COMPLETED Clean up formatter names                                          |         |       |  1:00 |   2.7 |
| COMPLETED Caching in travis                                                 |         |       |  0:59 |   2.6 |
| COMPLETED Consider collapsing element properties into element               |         |       |  1:08 |   3.0 |
| STARTED Create the archetype location properties                            |         |       | 13:58 |  37.4 |
| STARTED Generate file paths as a transform                                  |         |       |  6:29 |  17.4 |
