...
#+CAPTION: Clock summary at [2017-10-10 Tue 19:13]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *28:21* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 28:21   |       |      | 100.0 |
| Active                                                                      |         | 28:21 |      | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 2:19 |   8.2 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:45 |   2.6 |
| CANCELLED Add an "at" field to transform stats                              |         |       | 0:10 |   0.6 |
| COMPLETED Move enablement into yarn                                         |         |       | 1:01 |   3.6 |
| COMPLETED Consider revamping the project logo                               |         |       | 2:02 |   7.2 |
| COMPLETED Rename top-level transformations                                  |         |       | 1:33 |   5.5 |
| COMPLETED Clean-up context usage                                            |         |       | 0:38 |   2.2 |
| COMPLETED Housekeeper should know of text models                            |         |       | 2:05 |   7.3 |
| COMPLETED Rename the model to text transforms                               |         |       | 0:29 |   1.7 |
| COMPLETED Rename kernel and family                                          |         |       | 2:44 |   9.6 |
| COMPLETED Clean up formatter names                                          |         |       | 1:00 |   3.5 |
| STARTED Create the archetype location properties                            |         |       | 7:06 |  25.0 |
| STARTED Generate file paths as a transform                                  |         |       | 6:29 |  22.9 |
