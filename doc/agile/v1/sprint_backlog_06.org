...
#+CAPTION: Clock summary at [2017-10-15 Sun 18:44]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| COMPLETED Housekeeper should know of text models                            |         |       | 2:05 |   6.4 |
| COMPLETED Rename the model to text transforms                               |         |       | 0:29 |   1.5 |
| COMPLETED Rename kernel and family                                          |         |       | 2:44 |   8.3 |
| COMPLETED Clean up formatter names                                          |         |       | 1:00 |   3.1 |
| COMPLETED Caching in travis                                                 |         |       | 0:59 |   3.0 |
| COMPLETED Consider collapsing element properties into element               |         |       | 1:04 |   3.3 |
| STARTED Create the archetype location properties                            |         |       | 9:29 |  28.9 |
| STARTED Generate file paths as a transform                                  |         |       | 6:29 |  19.8 |
