...
#+CAPTION: Clock summary at [2017-09-18 Mon 22:56]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
...
| Stories                                                                     | 3:58   |      |      | 100.0 |
| Active                                                                      |        | 3:58 |      | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 2:19 |  58.4 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:14 |   5.9 |
| COMPLETED Rename top-level transformations                                  |        |      | 0:30 |  12.6 |
| CANCELLED Add an "at" field to transform stats                              |        |      | 0:10 |   4.2 |
| STARTED Consider revamping the project logo                                 |        |      | 0:45 |  18.9 |
...
*** Create a code generation chain                                    :story:
