...
#+CAPTION: Clock summary at [2017-10-15 Sun 19:19]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *33:35* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 33:35   |       |       | 100.0 |
| Active                                                                      |         | 33:35 |       | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  2:19 |   6.9 |
...
| COMPLETED Consider revamping the project logo                               |         |       |  2:02 |   6.1 |
| COMPLETED Rename top-level transformations                                  |         |       |  1:33 |   4.6 |
| COMPLETED Clean-up context usage                                            |         |       |  0:38 |   1.9 |
| COMPLETED Housekeeper should know of text models                            |         |       |  2:05 |   6.2 |
| COMPLETED Rename the model to text transforms                               |         |       |  0:29 |   1.4 |
| COMPLETED Rename kernel and family                                          |         |       |  2:44 |   8.1 |
| COMPLETED Clean up formatter names                                          |         |       |  1:00 |   3.0 |
| COMPLETED Caching in travis                                                 |         |       |  0:59 |   2.9 |
| COMPLETED Consider collapsing element properties into element               |         |       |  1:08 |   3.4 |
| STARTED Create the archetype location properties                            |         |       | 10:13 |  30.4 |
| STARTED Generate file paths as a transform                                  |         |       |  6:29 |  19.3 |
