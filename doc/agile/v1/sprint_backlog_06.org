...
#+CAPTION: Clock summary at [2017-10-06 Fri 12:45]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *22:24* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 22:24   |       |      | 100.0 |
| Active                                                                      |         | 22:24 |      | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 2:19 |  10.3 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:45 |   3.3 |
| CANCELLED Add an "at" field to transform stats                              |         |       | 0:10 |   0.7 |
| COMPLETED Move enablement into yarn                                         |         |       | 1:01 |   4.5 |
| COMPLETED Consider revamping the project logo                               |         |       | 2:02 |   9.1 |
| COMPLETED Rename top-level transformations                                  |         |       | 1:33 |   6.9 |
| COMPLETED Clean-up context usage                                            |         |       | 0:38 |   2.8 |
| COMPLETED Housekeeper should know of text models                            |         |       | 2:05 |   9.3 |
| COMPLETED Rename the model to text transforms                               |         |       | 0:29 |   2.2 |
| STARTED Create the archetype location properties                            |         |       | 3:25 |  15.3 |
| STARTED Generate file paths as a transform                                  |         |       | 6:29 |  28.9 |
| STARTED Rename kernel and family                                            |         |       | 1:28 |   6.5 |
...
*** STARTED Rename kernel and family                                  :story:
