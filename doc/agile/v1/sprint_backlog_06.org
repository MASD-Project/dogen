...
#+CAPTION: Clock summary at [2017-10-13 Fri 14:26]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *30:25* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 30:25   |       |      | 100.0 |
| Active                                                                      |         | 30:25 |      | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 2:19 |   7.6 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:45 |   2.5 |
| CANCELLED Add an "at" field to transform stats                              |         |       | 0:10 |   0.5 |
| COMPLETED Move enablement into yarn                                         |         |       | 1:01 |   3.3 |
| COMPLETED Consider revamping the project logo                               |         |       | 2:02 |   6.7 |
| COMPLETED Rename top-level transformations                                  |         |       | 1:33 |   5.1 |
| COMPLETED Clean-up context usage                                            |         |       | 0:38 |   2.1 |
| COMPLETED Housekeeper should know of text models                            |         |       | 2:05 |   6.8 |
| COMPLETED Rename the model to text transforms                               |         |       | 0:29 |   1.6 |
| COMPLETED Rename kernel and family                                          |         |       | 2:44 |   9.0 |
| COMPLETED Clean up formatter names                                          |         |       | 1:00 |   3.3 |
| STARTED Create the archetype location properties                            |         |       | 9:10 |  30.1 |
| STARTED Generate file paths as a transform                                  |         |       | 6:29 |  21.3 |
...
*** Consider collapsing element properties into element
