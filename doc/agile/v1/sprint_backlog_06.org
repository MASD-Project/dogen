...
#+CAPTION: Clock summary at [2017-10-15 Sun 18:49]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *32:51* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 32:51   |       |      | 100.0 |
| Active                                                                      |         | 32:51 |      | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 2:19 |   7.1 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:45 |   2.3 |
| CANCELLED Add an "at" field to transform stats                              |         |       | 0:10 |   0.5 |
| COMPLETED Move enablement into yarn                                         |         |       | 1:01 |   3.1 |
| COMPLETED Consider revamping the project logo                               |         |       | 2:02 |   6.2 |
| COMPLETED Rename top-level transformations                                  |         |       | 1:33 |   4.7 |
| COMPLETED Clean-up context usage                                            |         |       | 0:38 |   1.9 |
| COMPLETED Housekeeper should know of text models                            |         |       | 2:05 |   6.3 |
| COMPLETED Rename the model to text transforms                               |         |       | 0:29 |   1.5 |
| COMPLETED Rename kernel and family                                          |         |       | 2:44 |   8.3 |
| COMPLETED Clean up formatter names                                          |         |       | 1:00 |   3.0 |
| COMPLETED Caching in travis                                                 |         |       | 0:59 |   3.0 |
| COMPLETED Consider collapsing element properties into element               |         |       | 1:08 |   3.5 |
| STARTED Create the archetype location properties                            |         |       | 9:29 |  28.9 |
| STARTED Generate file paths as a transform                                  |         |       | 6:29 |  19.7 |
