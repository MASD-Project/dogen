...
#+CAPTION: Clock summary at [2017-10-08 Sun 17:12]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *26:35* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 26:35   |       |      | 100.0 |
| Active                                                                      |         | 26:35 |      | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 2:19 |   8.7 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:45 |   2.8 |
| CANCELLED Add an "at" field to transform stats                              |         |       | 0:10 |   0.6 |
| COMPLETED Move enablement into yarn                                         |         |       | 1:01 |   3.8 |
| COMPLETED Consider revamping the project logo                               |         |       | 2:02 |   7.6 |
| COMPLETED Rename top-level transformations                                  |         |       | 1:33 |   5.8 |
| COMPLETED Clean-up context usage                                            |         |       | 0:38 |   2.4 |
| COMPLETED Housekeeper should know of text models                            |         |       | 2:05 |   7.8 |
| COMPLETED Rename the model to text transforms                               |         |       | 0:29 |   1.8 |
| COMPLETED Rename kernel and family                                          |         |       | 2:44 |  10.3 |
| COMPLETED Clean up formatter names                                          |         |       | 1:00 |   3.8 |
| STARTED Create the archetype location properties                            |         |       | 5:20 |  20.1 |
| STARTED Generate file paths as a transform                                  |         |       | 6:29 |  24.4 |
