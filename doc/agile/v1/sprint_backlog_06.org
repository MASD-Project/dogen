...
#+CAPTION: Clock summary at [2017-10-21 Sat 12:21]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *40:44* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 40:44   |       |       | 100.0 |
| Active                                                                      |         | 40:44 |       | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  2:19 |   5.7 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:05 |   2.7 |
| CANCELLED Add an "at" field to transform stats                              |         |       |  0:10 |   0.4 |
| COMPLETED Move enablement into yarn                                         |         |       |  1:01 |   2.5 |
| COMPLETED Consider revamping the project logo                               |         |       |  2:02 |   5.0 |
| COMPLETED Rename top-level transformations                                  |         |       |  1:33 |   3.8 |
| COMPLETED Clean-up context usage                                            |         |       |  0:38 |   1.6 |
| COMPLETED Housekeeper should know of text models                            |         |       |  2:05 |   5.1 |
| COMPLETED Rename the model to text transforms                               |         |       |  0:29 |   1.2 |
| COMPLETED Rename kernel and family                                          |         |       |  2:44 |   6.7 |
| COMPLETED Clean up formatter names                                          |         |       |  1:00 |   2.5 |
| COMPLETED Caching in travis                                                 |         |       |  0:59 |   2.4 |
| COMPLETED Consider collapsing element properties into element               |         |       |  1:08 |   2.8 |
| COMPLETED Create the archetype location properties                          |         |       | 13:58 |  34.3 |
| COMPLETED Analysis work on moving to c++ 17                                 |         |       |  0:32 |   1.3 |
| STARTED Generate file paths as a transform                                  |         |       |  9:01 |  22.1 |
