...
#+CAPTION: Clock summary at [2017-10-20 Fri 09:53]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *36:23* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 36:23   |       |       | 100.0 |
| Active                                                                      |         | 36:23 |       | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  2:19 |   6.4 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:45 |   2.1 |
| CANCELLED Add an "at" field to transform stats                              |         |       |  0:10 |   0.5 |
| COMPLETED Move enablement into yarn                                         |         |       |  1:01 |   2.8 |
| COMPLETED Consider revamping the project logo                               |         |       |  2:02 |   5.6 |
| COMPLETED Rename top-level transformations                                  |         |       |  1:33 |   4.3 |
| COMPLETED Clean-up context usage                                            |         |       |  0:38 |   1.7 |
| COMPLETED Housekeeper should know of text models                            |         |       |  2:05 |   5.7 |
| COMPLETED Rename the model to text transforms                               |         |       |  0:29 |   1.3 |
| COMPLETED Rename kernel and family                                          |         |       |  2:44 |   7.5 |
...
| STARTED Create the archetype location properties                            |         |       | 13:01 |  35.8 |
| STARTED Generate file paths as a transform                                  |         |       |  6:29 |  17.8 |
