...
#+CAPTION: Clock summary at [2017-10-08 Sun 14:51]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *24:19* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 24:19   |       |      | 100.0 |
| Active                                                                      |         | 24:19 |      | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 2:19 |   9.5 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:45 |   3.1 |
| CANCELLED Add an "at" field to transform stats                              |         |       | 0:10 |   0.7 |
| COMPLETED Move enablement into yarn                                         |         |       | 1:01 |   4.2 |
| COMPLETED Consider revamping the project logo                               |         |       | 2:02 |   8.4 |
| COMPLETED Rename top-level transformations                                  |         |       | 1:33 |   6.4 |
| COMPLETED Clean-up context usage                                            |         |       | 0:38 |   2.6 |
| COMPLETED Housekeeper should know of text models                            |         |       | 2:05 |   8.6 |
| COMPLETED Rename the model to text transforms                               |         |       | 0:29 |   2.0 |
| COMPLETED Rename kernel and family                                          |         |       | 2:44 |  11.2 |
| STARTED Create the archetype location properties                            |         |       | 4:04 |  16.7 |
| STARTED Generate file paths as a transform                                  |         |       | 6:29 |  26.7 |
