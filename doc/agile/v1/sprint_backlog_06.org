...
#+CAPTION: Clock summary at [2017-11-02 Thu 09:00]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *46:48* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 46:48   |       |       | 100.0 |
| Active                                                                      |         | 46:48 |       | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  2:19 |   5.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:49 |   3.9 |
| CANCELLED Add an "at" field to transform stats                              |         |       |  0:10 |   0.4 |
| COMPLETED Move enablement into yarn                                         |         |       |  1:01 |   2.2 |
| COMPLETED Consider revamping the project logo                               |         |       |  2:02 |   4.3 |
| COMPLETED Rename top-level transformations                                  |         |       |  1:33 |   3.3 |
...
| COMPLETED Rename kernel and family                                          |         |       |  2:44 |   5.8 |
| COMPLETED Clean up formatter names                                          |         |       |  1:00 |   2.1 |
| COMPLETED Caching in travis                                                 |         |       |  0:59 |   2.1 |
| COMPLETED Consider collapsing element properties into element               |         |       |  1:08 |   2.4 |
| COMPLETED Create the archetype location properties                          |         |       | 13:58 |  29.8 |
| COMPLETED Analysis work on moving to c++ 17                                 |         |       |  0:32 |   1.1 |
| COMPLETED Upgrade rtags to latest                                           |         |       |  0:36 |   1.3 |
| COMPLETED Experiment with adding colour to dia diagrams                     |         |       |  3:01 |   6.4 |
| STARTED Generate file paths as a transform                                  |         |       |  9:01 |  19.3 |
| STARTED Experiment with a database model                                    |         |       |  1:20 |   2.8 |
| STARTED Move artefact into yarn                                             |         |       |  0:23 |   0.8 |
