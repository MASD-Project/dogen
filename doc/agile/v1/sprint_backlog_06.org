...
#+CAPTION: Clock summary at [2017-10-06 Fri 14:05]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *23:36* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 23:36   |       |      | 100.0 |
| Active                                                                      |         | 23:36 |      | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 2:19 |   9.8 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:45 |   3.2 |
| CANCELLED Add an "at" field to transform stats                              |         |       | 0:10 |   0.7 |
| COMPLETED Move enablement into yarn                                         |         |       | 1:01 |   4.3 |
| COMPLETED Consider revamping the project logo                               |         |       | 2:02 |   8.6 |
| COMPLETED Rename top-level transformations                                  |         |       | 1:33 |   6.6 |
| COMPLETED Clean-up context usage                                            |         |       | 0:38 |   2.7 |
| COMPLETED Housekeeper should know of text models                            |         |       | 2:05 |   8.8 |
| COMPLETED Rename the model to text transforms                               |         |       | 0:29 |   2.0 |
| STARTED Create the archetype location properties                            |         |       | 3:25 |  14.5 |
| STARTED Generate file paths as a transform                                  |         |       | 6:29 |  27.5 |
| STARTED Rename kernel and family                                            |         |       | 2:40 |  11.3 |
