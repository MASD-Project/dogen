...
#+CAPTION: Clock summary at [2017-10-06 Fri 10:08]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| COMPLETED Move enablement into yarn                                         |         |       | 1:01 |   5.0 |
| COMPLETED Consider revamping the project logo                               |         |       | 2:02 |  10.1 |
| COMPLETED Rename top-level transformations                                  |         |       | 1:33 |   7.7 |
| COMPLETED Clean-up context usage                                            |         |       | 0:38 |   3.1 |
| COMPLETED Housekeeper should know of text models                            |         |       | 2:05 |  10.3 |
| COMPLETED Rename the model to text transforms                               |         |       | 0:29 |   2.4 |
| STARTED Create the archetype location properties                            |         |       | 2:42 |  13.4 |
| STARTED Generate file paths as a transform                                  |         |       | 6:29 |  32.1 |
