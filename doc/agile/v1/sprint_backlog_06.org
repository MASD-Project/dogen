...
#+CAPTION: Clock summary at [2017-10-06 Fri 12:56]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| COMPLETED Consider revamping the project logo                               |         |       | 2:02 |   9.0 |
...
| COMPLETED Rename the model to text transforms                               |         |       | 0:29 |   2.1 |
| STARTED Create the archetype location properties                            |         |       | 3:25 |  15.2 |
| STARTED Generate file paths as a transform                                  |         |       | 6:29 |  28.8 |
| STARTED Rename kernel and family                                            |         |       | 1:35 |   7.0 |
