...
#+CAPTION: Clock summary at [2017-10-06 Fri 11:32]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *21:34* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 21:34   |       |      | 100.0 |
| Active                                                                      |         | 21:34 |      | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 2:19 |  10.7 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:45 |   3.5 |
| CANCELLED Add an "at" field to transform stats                              |         |       | 0:10 |   0.8 |
| COMPLETED Move enablement into yarn                                         |         |       | 1:01 |   4.7 |
| COMPLETED Consider revamping the project logo                               |         |       | 2:02 |   9.4 |
| COMPLETED Rename top-level transformations                                  |         |       | 1:33 |   7.2 |
| COMPLETED Clean-up context usage                                            |         |       | 0:38 |   2.9 |
| COMPLETED Housekeeper should know of text models                            |         |       | 2:05 |   9.7 |
| COMPLETED Rename the model to text transforms                               |         |       | 0:29 |   2.2 |
| STARTED Create the archetype location properties                            |         |       | 3:25 |  15.8 |
| STARTED Generate file paths as a transform                                  |         |       | 6:29 |  30.1 |
| STARTED Rename kernel and family                                            |         |       | 0:38 |   2.9 |
