...
#+CAPTION: Clock summary at [2017-10-27 Fri 13:10]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *44:41* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 44:41   |       |       | 100.0 |
| Active                                                                      |         | 44:41 |       | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  2:19 |   5.2 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:25 |   3.2 |
| CANCELLED Add an "at" field to transform stats                              |         |       |  0:10 |   0.4 |
| COMPLETED Move enablement into yarn                                         |         |       |  1:01 |   2.3 |
| COMPLETED Consider revamping the project logo                               |         |       |  2:02 |   4.6 |
| COMPLETED Rename top-level transformations                                  |         |       |  1:33 |   3.5 |
| COMPLETED Clean-up context usage                                            |         |       |  0:38 |   1.4 |
| COMPLETED Housekeeper should know of text models                            |         |       |  2:05 |   4.7 |
| COMPLETED Rename the model to text transforms                               |         |       |  0:29 |   1.1 |
| COMPLETED Rename kernel and family                                          |         |       |  2:44 |   6.1 |
| COMPLETED Clean up formatter names                                          |         |       |  1:00 |   2.2 |
| COMPLETED Caching in travis                                                 |         |       |  0:59 |   2.2 |
| COMPLETED Consider collapsing element properties into element               |         |       |  1:08 |   2.5 |
| COMPLETED Create the archetype location properties                          |         |       | 13:58 |  31.3 |
| COMPLETED Analysis work on moving to c++ 17                                 |         |       |  0:32 |   1.2 |
| COMPLETED Upgrade rtags to latest                                           |         |       |  0:36 |   1.3 |
| COMPLETED Experiment with adding colour to dia diagrams                     |         |       |  3:01 |   6.8 |
| STARTED Generate file paths as a transform                                  |         |       |  9:01 |  20.2 |
