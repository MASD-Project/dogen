...
#+CAPTION: Clock summary at [2017-11-02 Thu 19:39]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| STARTED Sprint and product backlog grooming                                 |         |       |  1:49 |   3.8 |
...
| COMPLETED Rename kernel and family                                          |         |       |  2:44 |   5.7 |
...
| COMPLETED Create the archetype location properties                          |         |       | 13:58 |  29.1 |
| COMPLETED Analysis work on moving to c++ 17                                 |         |       |  0:32 |   1.1 |
| COMPLETED Upgrade rtags to latest                                           |         |       |  0:36 |   1.2 |
| COMPLETED Experiment with adding colour to dia diagrams                     |         |       |  3:01 |   6.3 |
| COMPLETED Move artefact into yarn                                           |         |       |  1:36 |   3.3 |
| STARTED Generate file paths as a transform                                  |         |       |  9:01 |  18.8 |
