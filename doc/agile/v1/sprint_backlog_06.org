...
#+CAPTION: Clock summary at [2017-09-29 Fri 12:13]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 16:22   |       |      | 100.0 |
| Active                                                                      |         | 16:22 |      | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 2:19 |  14.2 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:38 |   3.9 |
| CANCELLED Add an "at" field to transform stats                              |         |       | 0:10 |   1.0 |
| COMPLETED Move enablement into yarn                                         |         |       | 1:01 |   6.2 |
| COMPLETED Consider revamping the project logo                               |         |       | 2:02 |  12.4 |
| STARTED Rename top-level transformations                                    |         |       | 1:17 |   7.8 |
| STARTED Create the archetype location properties                            |         |       | 2:26 |  14.9 |
| STARTED Generate file paths as a transform                                  |         |       | 6:29 |  39.6 |
...
*** STARTED Rename top-level transformations                          :story:
...
*** Housekeeper should know of text models                            :story:
