...
#+CAPTION: Clock summary at [2017-08-17 Thu 10:32]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *18:12* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 18:12   |       |      | 100.0 |
| Active                                                                      |         | 18:12 |      | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:35 |   3.2 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:25 |   2.3 |
| COMPLETED Use shared pointers in all models                                 |         |       | 6:22 |  35.0 |
| COMPLETED Update repository in yarn.dia to use pointers                     |         |       | 2:50 |  15.6 |
| COMPLETED Remove support for upsilon                                        |         |       | 1:10 |   6.4 |
| STARTED Create an exogenous model                                           |         |       | 6:33 |  36.0 |
| STARTED Add a backwards compatible flag                                     |         |       | 0:17 |   1.6 |
...
*** STARTED Add a backwards compatible flag                           :story:
