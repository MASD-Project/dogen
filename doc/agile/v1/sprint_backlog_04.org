...
#+CAPTION: Clock summary at [2017-08-21 Mon 17:12]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *29:47* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 29:47   |       |       | 100.0 |
| Active                                                                      |         | 29:47 |       | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:35 |   2.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:56 |   3.1 |
| COMPLETED Use shared pointers in all models                                 |         |       |  6:22 |  21.4 |
| COMPLETED Update repository in yarn.dia to use pointers                     |         |       |  2:50 |   9.5 |
| COMPLETED Remove support for upsilon                                        |         |       |  1:10 |   3.9 |
| COMPLETED Add a backwards compatible flag                                   |         |       |  1:27 |   4.9 |
| COMPLETED Create an exogenous model                                         |         |       | 12:20 |  41.4 |
| COMPLETED Tailor should rely only on exogenous models                       |         |       |  2:12 |   7.4 |
| COMPLETED Remove scribble group from intermediate model                     |         |       |  0:39 |   2.2 |
| COMPLETED Tailor is not handling initialisation correctly                   |         |       |  0:15 |   0.8 |
| COMPLETED Rename exogenous model to exomodel                                |         |       |  1:01 |   3.4 |
...
*** Rename intermediate model to endomodel                            :story:
