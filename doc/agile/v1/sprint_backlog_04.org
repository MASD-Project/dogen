...
#+CAPTION: Clock summary at [2017-08-20 Sun 23:43]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *26:04* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 26:04   |       |       | 100.0 |
| Active                                                                      |         | 26:04 |       | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:35 |   2.2 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:45 |   2.9 |
| COMPLETED Use shared pointers in all models                                 |         |       |  6:22 |  24.4 |
| COMPLETED Update repository in yarn.dia to use pointers                     |         |       |  2:50 |  10.9 |
| COMPLETED Remove support for upsilon                                        |         |       |  1:10 |   4.5 |
| COMPLETED Add a backwards compatible flag                                   |         |       |  1:27 |   5.6 |
| COMPLETED Create an exogenous model                                         |         |       | 12:20 |  47.3 |
| STARTED Remove scribble group from intermediate model                       |         |       |  0:17 |   1.1 |
| STARTED Tailor should rely only on exogenous models                         |         |       |  0:18 |   1.2 |
...
*** STARTED Remove scribble group from intermediate model             :story:
...
*** STARTED Tailor should rely only on exogenous models               :story:
...
*** Use a consistent approach to model naming                         :story:
