...
#+CAPTION: Clock summary at [2017-08-21 Mon 15:27]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *28:46* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 28:46   |       |       | 100.0 |
| Active                                                                      |         | 28:46 |       | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:35 |   2.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:56 |   3.2 |
| COMPLETED Use shared pointers in all models                                 |         |       |  6:22 |  22.1 |
| COMPLETED Update repository in yarn.dia to use pointers                     |         |       |  2:50 |   9.8 |
| COMPLETED Remove support for upsilon                                        |         |       |  1:10 |   4.1 |
| COMPLETED Add a backwards compatible flag                                   |         |       |  1:27 |   5.0 |
| COMPLETED Create an exogenous model                                         |         |       | 12:20 |  42.9 |
| COMPLETED Tailor should rely only on exogenous models                       |         |       |  2:12 |   7.6 |
