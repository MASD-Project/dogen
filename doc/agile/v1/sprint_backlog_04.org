...
#+CAPTION: Clock summary at [2017-08-04 Fri 17:37]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *10:00* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 10:00   |       |      | 100.0 |
| Active                                                                      |         | 10:00 |      | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:35 |   5.8 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:13 |   2.2 |
| COMPLETED Use shared pointers in all models                                 |         |       | 6:22 |  63.7 |
| COMPLETED Update repository in yarn.dia to use pointers                     |         |       | 2:50 |  28.3 |
