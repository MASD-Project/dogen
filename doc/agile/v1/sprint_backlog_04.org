...
#+CAPTION: Clock summary at [2017-08-06 Sun 22:34]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 13:44   |       |      | 100.0 |
| Active                                                                      |         | 13:44 |      | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:35 |   4.2 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:13 |   1.6 |
| COMPLETED Use shared pointers in all models                                 |         |       | 6:22 |  46.4 |
| COMPLETED Update repository in yarn.dia to use pointers                     |         |       | 2:50 |  20.6 |
| STARTED Create an exogenous model                                           |         |       | 3:44 |  27.2 |
...
*** Remove support for upsilon                                        :story:
