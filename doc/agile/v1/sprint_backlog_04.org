...
#+CAPTION: Clock summary at [2017-08-24 Thu 20:18]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *37:39* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 37:39   |       |       | 100.0 |
| Active                                                                      |         | 37:39 |       | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:35 |   1.5 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:56 |   2.5 |
| COMPLETED Use shared pointers in all models                                 |         |       |  6:22 |  16.9 |
| COMPLETED Update repository in yarn.dia to use pointers                     |         |       |  2:50 |   7.5 |
| COMPLETED Remove support for upsilon                                        |         |       |  1:10 |   3.1 |
| COMPLETED Add a backwards compatible flag                                   |         |       |  1:27 |   3.9 |
| COMPLETED Create an exogenous model                                         |         |       | 12:20 |  32.8 |
| COMPLETED Tailor should rely only on exogenous models                       |         |       |  2:12 |   5.8 |
...
| COMPLETED Rename exogenous model to exomodel                                |         |       |  1:01 |   2.7 |
| COMPLETED Rename intermediate model to endomodel                            |         |       |  1:49 |   4.8 |
| COMPLETED Fix broken build due to JSON tests                                |         |       |  0:26 |   1.2 |
| COMPLETED Clean up transforms to match exogenous/endogenous models          |         |       |  1:48 |   4.8 |
| COMPLETED Add validation to tailor transforms                               |         |       |  0:20 |   0.9 |
| COMPLETED Rename =meta_type= in JSON                                        |         |       |  3:29 |   9.3 |
