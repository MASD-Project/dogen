...
#+CAPTION: Clock summary at [2017-08-22 Tue 00:39]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *32:54* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 32:54   |       |       | 100.0 |
| Active                                                                      |         | 32:54 |       | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:35 |   1.8 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:56 |   2.8 |
| COMPLETED Use shared pointers in all models                                 |         |       |  6:22 |  19.4 |
| COMPLETED Update repository in yarn.dia to use pointers                     |         |       |  2:50 |   8.6 |
| COMPLETED Remove support for upsilon                                        |         |       |  1:10 |   3.5 |
| COMPLETED Add a backwards compatible flag                                   |         |       |  1:27 |   4.4 |
| COMPLETED Create an exogenous model                                         |         |       | 12:20 |  37.5 |
| COMPLETED Tailor should rely only on exogenous models                       |         |       |  2:12 |   6.7 |
| COMPLETED Remove scribble group from intermediate model                     |         |       |  0:39 |   2.0 |
| COMPLETED Tailor is not handling initialisation correctly                   |         |       |  0:15 |   0.8 |
| COMPLETED Rename exogenous model to exomodel                                |         |       |  1:01 |   3.1 |
| COMPLETED Rename intermediate model to endomodel                            |         |       |  1:49 |   5.5 |
| COMPLETED Fix broken build due to JSON tests                                |         |       |  0:26 |   1.3 |
| STARTED Clean up transforms to match exogenous/endogenous models            |         |       |  0:52 |   2.6 |
...
*** STARTED Clean up transforms to match exogenous/endogenous models  :story:
...
*** Add validation to tailor transforms                               :story:
