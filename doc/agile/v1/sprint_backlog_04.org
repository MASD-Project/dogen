...
| COMPLETED Clean up transforms to match exogenous/endogenous models          |         |       |  1:48 |   4.7 |
| COMPLETED Add validation to tailor transforms                               |         |       |  0:20 |   0.9 |
| COMPLETED Rename =meta_type= in JSON                                        |         |       |  3:29 |   9.2 |
