...
#+CAPTION: Clock summary at [2017-08-20 Sun 22:06]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *25:29* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 25:29   |       |       | 100.0 |
| Active                                                                      |         | 25:29 |       | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:35 |   2.3 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:45 |   2.9 |
| COMPLETED Use shared pointers in all models                                 |         |       |  6:22 |  25.0 |
| COMPLETED Update repository in yarn.dia to use pointers                     |         |       |  2:50 |  11.1 |
| COMPLETED Remove support for upsilon                                        |         |       |  1:10 |   4.6 |
| COMPLETED Add a backwards compatible flag                                   |         |       |  1:27 |   5.7 |
| COMPLETED Create an exogenous model                                         |         |       | 12:20 |  48.4 |
...
*** Tailor should rely only on exogenous models                       :story:
