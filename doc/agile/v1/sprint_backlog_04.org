...
#+CAPTION: Clock summary at [2017-08-24 Thu 16:05]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| COMPLETED Use shared pointers in all models                                 |         |       |  6:22 |  17.5 |
...
| COMPLETED Create an exogenous model                                         |         |       | 12:20 |  33.9 |
...
| STARTED Rename =meta_type= in JSON                                          |         |       |  2:13 |   6.1 |
