...
#+CAPTION: Clock summary at [2017-08-18 Fri 00:15]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| STARTED Sprint and product backlog grooming                                 |         |       | 0:25 |   2.0 |
| COMPLETED Use shared pointers in all models                                 |         |       | 6:22 |  30.2 |
| COMPLETED Update repository in yarn.dia to use pointers                     |         |       | 2:50 |  13.4 |
| COMPLETED Remove support for upsilon                                        |         |       | 1:10 |   5.5 |
| COMPLETED Add a backwards compatible flag                                   |         |       | 1:27 |   6.9 |
| STARTED Create an exogenous model                                           |         |       | 8:16 |  39.2 |
