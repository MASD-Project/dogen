...
#+CAPTION: Clock summary at [2017-08-17 Thu 14:37]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 19:22   |       |      | 100.0 |
| Active                                                                      |         | 19:22 |      | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:35 |   3.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:25 |   2.2 |
| COMPLETED Use shared pointers in all models                                 |         |       | 6:22 |  32.9 |
| COMPLETED Update repository in yarn.dia to use pointers                     |         |       | 2:50 |  14.6 |
| COMPLETED Remove support for upsilon                                        |         |       | 1:10 |   6.0 |
| COMPLETED Add a backwards compatible flag                                   |         |       | 1:27 |   7.5 |
| STARTED Create an exogenous model                                           |         |       | 6:33 |  33.8 |
