...
#+CAPTION: Clock summary at [2017-08-08 Tue 06:53]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| STARTED Sprint and product backlog grooming                                 |         |       | 0:25 |   3.0 |
| COMPLETED Use shared pointers in all models                                 |         |       | 6:22 |  45.7 |
| COMPLETED Update repository in yarn.dia to use pointers                     |         |       | 2:50 |  20.3 |
| STARTED Create an exogenous model                                           |         |       | 3:44 |  26.8 |
