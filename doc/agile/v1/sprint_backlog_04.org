...
#+CAPTION: Clock summary at [2017-08-04 Fri 17:14]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
...
| Stories                                                                     | 9:38   |      |      | 100.0 |
| Active                                                                      |        | 9:38 |      | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 0:35 |   6.1 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:13 |   2.2 |
| COMPLETED Use shared pointers in all models                                 |        |      | 6:22 |  66.1 |
| COMPLETED Update repository in yarn.dia to use pointers                     |        |      | 2:28 |  25.6 |
