...
#+CAPTION: Clock summary at [2017-08-22 Tue 02:04]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *34:10* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 34:10   |       |       | 100.0 |
| Active                                                                      |         | 34:10 |       | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:35 |   1.7 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:56 |   2.7 |
| COMPLETED Use shared pointers in all models                                 |         |       |  6:22 |  18.6 |
| COMPLETED Update repository in yarn.dia to use pointers                     |         |       |  2:50 |   8.3 |
| COMPLETED Remove support for upsilon                                        |         |       |  1:10 |   3.4 |
| COMPLETED Add a backwards compatible flag                                   |         |       |  1:27 |   4.2 |
| COMPLETED Create an exogenous model                                         |         |       | 12:20 |  36.1 |
| COMPLETED Tailor should rely only on exogenous models                       |         |       |  2:12 |   6.4 |
...
| COMPLETED Rename intermediate model to endomodel                            |         |       |  1:49 |   5.3 |
| COMPLETED Fix broken build due to JSON tests                                |         |       |  0:26 |   1.3 |
| COMPLETED Clean up transforms to match exogenous/endogenous models          |         |       |  1:48 |   5.3 |
| COMPLETED Add validation to tailor transforms                               |         |       |  0:20 |   1.0 |
