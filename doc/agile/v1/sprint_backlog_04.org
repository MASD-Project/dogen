...
#+CAPTION: Clock summary at [2017-08-24 Thu 19:01]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *36:48* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 36:48   |       |       | 100.0 |
| Active                                                                      |         | 36:48 |       | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:35 |   1.6 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:56 |   2.5 |
| COMPLETED Use shared pointers in all models                                 |         |       |  6:22 |  17.3 |
...
| COMPLETED Create an exogenous model                                         |         |       | 12:20 |  33.5 |
...
| COMPLETED Rename intermediate model to endomodel                            |         |       |  1:49 |   4.9 |
...
| STARTED Rename =meta_type= in JSON                                          |         |       |  2:38 |   7.2 |
