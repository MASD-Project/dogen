...
#+CAPTION: Clock summary at [2017-08-22 Tue 01:18]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *33:28* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 33:28   |       |       | 100.0 |
| Active                                                                      |         | 33:28 |       | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:35 |   1.7 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:56 |   2.8 |
| COMPLETED Use shared pointers in all models                                 |         |       |  6:22 |  19.0 |
| COMPLETED Update repository in yarn.dia to use pointers                     |         |       |  2:50 |   8.5 |
| COMPLETED Remove support for upsilon                                        |         |       |  1:10 |   3.5 |
| COMPLETED Add a backwards compatible flag                                   |         |       |  1:27 |   4.3 |
| COMPLETED Create an exogenous model                                         |         |       | 12:20 |  36.9 |
| COMPLETED Tailor should rely only on exogenous models                       |         |       |  2:12 |   6.6 |
| COMPLETED Remove scribble group from intermediate model                     |         |       |  0:39 |   1.9 |
| COMPLETED Tailor is not handling initialisation correctly                   |         |       |  0:15 |   0.7 |
| COMPLETED Rename exogenous model to exomodel                                |         |       |  1:01 |   3.0 |
| COMPLETED Rename intermediate model to endomodel                            |         |       |  1:49 |   5.4 |
| COMPLETED Fix broken build due to JSON tests                                |         |       |  0:26 |   1.3 |
| STARTED Clean up transforms to match exogenous/endogenous models            |         |       |  1:26 |   4.3 |
