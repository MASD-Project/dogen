...
#+CAPTION: Clock summary at [2017-08-20 Sun 21:41]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *25:21* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 25:21   |       |       | 100.0 |
| Active                                                                      |         | 25:21 |       | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:35 |   2.3 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:45 |   3.0 |
| COMPLETED Use shared pointers in all models                                 |         |       |  6:22 |  25.1 |
| COMPLETED Update repository in yarn.dia to use pointers                     |         |       |  2:50 |  11.2 |
| COMPLETED Remove support for upsilon                                        |         |       |  1:10 |   4.6 |
| COMPLETED Add a backwards compatible flag                                   |         |       |  1:27 |   5.7 |
| STARTED Create an exogenous model                                           |         |       | 12:12 |  48.1 |
