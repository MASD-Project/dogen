...
#+CAPTION: Clock summary at [2017-08-21 Mon 11:18]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *27:58* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 27:58   |       |       | 100.0 |
| Active                                                                      |         | 27:58 |       | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:35 |   2.1 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:45 |   2.7 |
| COMPLETED Use shared pointers in all models                                 |         |       |  6:22 |  22.8 |
| COMPLETED Update repository in yarn.dia to use pointers                     |         |       |  2:50 |  10.1 |
| COMPLETED Remove support for upsilon                                        |         |       |  1:10 |   4.2 |
| COMPLETED Add a backwards compatible flag                                   |         |       |  1:27 |   5.2 |
| COMPLETED Create an exogenous model                                         |         |       | 12:20 |  44.1 |
| COMPLETED Tailor should rely only on exogenous models                       |         |       |  2:12 |   7.9 |
| STARTED Remove scribble group from intermediate model                       |         |       |  0:17 |   1.0 |
