...
#+CAPTION: Clock summary at [2017-08-21 Mon 23:48]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| STARTED Sprint and product backlog grooming                                 |         |       |  0:56 |   2.9 |
| COMPLETED Use shared pointers in all models                                 |         |       |  6:22 |  19.9 |
| COMPLETED Update repository in yarn.dia to use pointers                     |         |       |  2:50 |   8.8 |
| COMPLETED Remove support for upsilon                                        |         |       |  1:10 |   3.6 |
| COMPLETED Add a backwards compatible flag                                   |         |       |  1:27 |   4.5 |
| COMPLETED Create an exogenous model                                         |         |       | 12:20 |  38.5 |
| COMPLETED Tailor should rely only on exogenous models                       |         |       |  2:12 |   6.9 |
...
| COMPLETED Rename exogenous model to exomodel                                |         |       |  1:01 |   3.2 |
| COMPLETED Rename intermediate model to endomodel                            |         |       |  1:49 |   5.7 |
| COMPLETED Fix broken build due to JSON tests                                |         |       |  0:26 |   1.4 |
