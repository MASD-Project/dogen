...
#+CAPTION: Clock summary at [2017-08-21 Mon 21:37]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *31:36* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 31:36   |       |       | 100.0 |
| Active                                                                      |         | 31:36 |       | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:35 |   1.8 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:56 |   3.0 |
| COMPLETED Use shared pointers in all models                                 |         |       |  6:22 |  20.1 |
| COMPLETED Update repository in yarn.dia to use pointers                     |         |       |  2:50 |   9.0 |
| COMPLETED Remove support for upsilon                                        |         |       |  1:10 |   3.7 |
| COMPLETED Add a backwards compatible flag                                   |         |       |  1:27 |   4.6 |
| COMPLETED Create an exogenous model                                         |         |       | 12:20 |  39.0 |
| COMPLETED Tailor should rely only on exogenous models                       |         |       |  2:12 |   7.0 |
| COMPLETED Remove scribble group from intermediate model                     |         |       |  0:39 |   2.1 |
