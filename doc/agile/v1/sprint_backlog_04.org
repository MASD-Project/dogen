...
#+CAPTION: Clock summary at [2017-08-22 Tue 01:32]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *33:40* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 33:40   |       |       | 100.0 |
| Active                                                                      |         | 33:40 |       | 100.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:35 |   1.7 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:56 |   2.8 |
| COMPLETED Use shared pointers in all models                                 |         |       |  6:22 |  18.9 |
| COMPLETED Update repository in yarn.dia to use pointers                     |         |       |  2:50 |   8.4 |
| COMPLETED Remove support for upsilon                                        |         |       |  1:10 |   3.5 |
| COMPLETED Add a backwards compatible flag                                   |         |       |  1:27 |   4.3 |
| COMPLETED Create an exogenous model                                         |         |       | 12:20 |  36.6 |
| COMPLETED Tailor should rely only on exogenous models                       |         |       |  2:12 |   6.5 |
...
| STARTED Clean up transforms to match exogenous/endogenous models            |         |       |  1:38 |   4.9 |
