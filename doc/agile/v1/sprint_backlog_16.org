...
#+CAPTION: Clock summary at [2019-04-30 Tue 11:11]
| <75>                                                   |         |       |       |       |
| Headline                                               | Time    |       |       |     % |
|--------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                           | *55:14* |       |       | 100.0 |
|--------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                | 55:14   |       |       | 100.0 |
| Active                                                 |         | 55:14 |       | 100.0 |
| Edit release notes for previous sprint                 |         |       |  2:40 |   4.8 |
...
| Finish implementing the variability model              |         |       | 10:49 |  19.6 |
| Trim down stitch's use of annotations                  |         |       |  1:30 |   2.7 |
| Read meta-data using configurations                    |         |       | 24:24 |  44.2 |
| Remove uses of annotations                             |         |       |  7:44 |  14.0 |
| Stitch is still using artefact writer                  |         |       |  0:04 |   0.1 |
| Profiles as meta-model elements                        |         |       |  1:45 |   3.2 |
