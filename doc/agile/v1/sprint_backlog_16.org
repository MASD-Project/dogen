...
#+CAPTION: Clock summary at [2019-05-02 Thu 14:28]
| <75>                                                   |         |       |       |       |
| Headline                                               | Time    |       |       |     % |
|--------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                | 71:34   |       |       | 100.0 |
| Active                                                 |         | 71:34 |       | 100.0 |
| Edit release notes for previous sprint                 |         |       |  2:40 |   3.7 |
| Sprint and product backlog grooming                    |         |       |  3:22 |   4.7 |
...
| Finish implementing the variability model              |         |       | 10:49 |  15.1 |
| Trim down stitch's use of annotations                  |         |       |  1:30 |   2.1 |
| Read meta-data using configurations                    |         |       | 24:24 |  34.1 |
| Remove uses of annotations                             |         |       |  7:44 |  10.8 |
| Stitch is still using artefact writer                  |         |       |  0:04 |   0.1 |
| Exclude profiles from stereotypes processing           |         |       |  2:41 |   3.7 |
| Profiles as meta-model elements                        |         |       | 13:54 |  19.4 |
| Add support for composable stereotypes                 |         |       |  0:28 |   0.7 |
