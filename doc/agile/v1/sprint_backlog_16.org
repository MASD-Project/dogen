...
#+CAPTION: Clock summary at [2019-05-02 Thu 16:16]
| <75>                                                   |         |       |       |       |
| Headline                                               | Time    |       |       |     % |
|--------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                           | *73:21* |       |       | 100.0 |
|--------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                | 73:21   |       |       | 100.0 |
| Active                                                 |         | 73:21 |       | 100.0 |
| Edit release notes for previous sprint                 |         |       |  2:40 |   3.6 |
| Sprint and product backlog grooming                    |         |       |  3:22 |   4.6 |
| Create a video demo for the previous sprint's features |         |       |  1:55 |   2.6 |
...
| Finish implementing the variability model              |         |       | 10:49 |  14.7 |
| Trim down stitch's use of annotations                  |         |       |  1:30 |   2.0 |
| Read meta-data using configurations                    |         |       | 24:24 |  33.3 |
| Remove uses of annotations                             |         |       |  7:44 |  10.5 |
| Stitch is still using artefact writer                  |         |       |  0:04 |   0.1 |
| Exclude profiles from stereotypes processing           |         |       |  2:41 |   3.7 |
| Profiles as meta-model elements                        |         |       | 13:54 |  19.0 |
| Add support for composable stereotypes                 |         |       |  2:15 |   3.1 |
