...
#+CAPTION: Clock summary at [2019-05-03 Fri 12:50]
| <75>                                                   |         |       |       |       |
| Headline                                               | Time    |       |       |     % |
|--------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                           | *77:17* |       |       | 100.0 |
|--------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                | 77:17   |       |       | 100.0 |
| Active                                                 |         | 77:17 |       | 100.0 |
...
| Finish implementing the variability model              |         |       | 10:49 |  14.0 |
| Trim down stitch's use of annotations                  |         |       |  1:30 |   1.9 |
| Read meta-data using configurations                    |         |       | 24:24 |  31.6 |
| Remove uses of annotations                             |         |       |  7:44 |  10.0 |
| Stitch is still using artefact writer                  |         |       |  0:04 |   0.1 |
| Exclude profiles from stereotypes processing           |         |       |  2:41 |   3.5 |
| Profiles as meta-model elements                        |         |       | 13:54 |  18.0 |
| Add support for composable stereotypes                 |         |       |  6:06 |   7.9 |
