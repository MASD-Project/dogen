...
#+CAPTION: Clock summary at [2019-04-28 Sun 17:22]
| <75>                                                   |         |       |       |       |
| Headline                                               | Time    |       |       |     % |
|--------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                | 43:35   |       |       | 100.0 |
| Active                                                 |         | 43:35 |       | 100.0 |
| Edit release notes for previous sprint                 |         |       |  2:40 |   6.1 |
| Sprint and product backlog grooming                    |         |       |  1:13 |   2.8 |
| Create a video demo for the previous sprint's features |         |       |  1:55 |   4.4 |
| Read variability papers                                |         |       |  1:04 |   2.4 |
| Finish implementing the variability model              |         |       | 10:49 |  24.8 |
| Trim down stitch's use of annotations                  |         |       |  1:30 |   3.4 |
| Read meta-data using configurations                    |         |       | 24:24 |  56.0 |
...
*** Remove uses of annotations                                        :story:
