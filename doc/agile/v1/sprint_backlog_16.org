...
#+CAPTION: Clock summary at [2019-04-28 Sun 15:19]
| <75>                                                   |         |       |       |       |
| Headline                                               | Time    |       |       |     % |
|--------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                           | *41:38* |       |       | 100.0 |
|--------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                | 41:38   |       |       | 100.0 |
| Active                                                 |         | 41:38 |       | 100.0 |
| Edit release notes for previous sprint                 |         |       |  2:40 |   6.4 |
| Sprint and product backlog grooming                    |         |       |  1:13 |   2.9 |
| Create a video demo for the previous sprint's features |         |       |  1:55 |   4.6 |
| Read variability papers                                |         |       |  1:04 |   2.6 |
| Finish implementing the variability model              |         |       | 10:49 |  26.0 |
| Read meta-data using configurations                    |         |       | 23:36 |  56.7 |
| Trim down stitch's use of annotations                  |         |       |  0:21 |   0.8 |
...
- remove profile field from stitch templates. Should not break
  anything.
- remove annotations expander from workflow
