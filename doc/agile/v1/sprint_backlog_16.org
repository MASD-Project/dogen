...
#+CAPTION: Clock summary at [2019-05-01 Wed 16:52]
| <75>                                                   |         |       |       |       |
| Headline                                               | Time    |       |       |     % |
|--------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                           | *65:42* |       |       | 100.0 |
|--------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                | 65:42   |       |       | 100.0 |
| Active                                                 |         | 65:42 |       | 100.0 |
| Edit release notes for previous sprint                 |         |       |  2:40 |   4.1 |
| Sprint and product backlog grooming                    |         |       |  2:59 |   4.5 |
...
| Read meta-data using configurations                    |         |       | 24:24 |  37.1 |
| Remove uses of annotations                             |         |       |  7:44 |  11.8 |
| Stitch is still using artefact writer                  |         |       |  0:04 |   0.1 |
| Exclude profiles from stereotypes processing           |         |       |  2:41 |   4.1 |
| Profiles as meta-model elements                        |         |       |  9:32 |  14.5 |
