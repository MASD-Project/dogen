...
#+CAPTION: Clock summary at [2019-05-02 Thu 07:10]
| <75>                                                   |         |       |       |       |
| Headline                                               | Time    |       |       |     % |
|--------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                           | *67:56* |       |       | 100.0 |
|--------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                | 67:56   |       |       | 100.0 |
| Active                                                 |         | 67:56 |       | 100.0 |
| Edit release notes for previous sprint                 |         |       |  2:40 |   3.9 |
...
| Fix issues with nightly build and CI                   |         |       |  0:39 |   1.0 |
| Finish implementing the variability model              |         |       | 10:49 |  15.9 |
| Trim down stitch's use of annotations                  |         |       |  1:30 |   2.2 |
| Read meta-data using configurations                    |         |       | 24:24 |  35.9 |
| Remove uses of annotations                             |         |       |  7:44 |  11.4 |
| Stitch is still using artefact writer                  |         |       |  0:04 |   0.1 |
| Exclude profiles from stereotypes processing           |         |       |  2:41 |   3.9 |
| Profiles as meta-model elements                        |         |       | 11:07 |  16.4 |
