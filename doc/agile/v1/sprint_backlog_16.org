...
#+CAPTION: Clock summary at [2019-05-03 Fri 16:59]
| <75>                                                   |         |       |       |       |
| Headline                                               | Time    |       |       |     % |
|--------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                           | *80:10* |       |       | 100.0 |
|--------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                | 80:10   |       |       | 100.0 |
| Active                                                 |         | 80:10 |       | 100.0 |
| Edit release notes for previous sprint                 |         |       |  2:40 |   3.3 |
| Sprint and product backlog grooming                    |         |       |  3:27 |   4.3 |
...
| Finish implementing the variability model              |         |       | 10:49 |  13.5 |
| Trim down stitch's use of annotations                  |         |       |  1:30 |   1.9 |
| Read meta-data using configurations                    |         |       | 24:24 |  30.4 |
| Remove uses of annotations                             |         |       |  7:44 |   9.6 |
| Stitch is still using artefact writer                  |         |       |  0:04 |   0.1 |
| Exclude profiles from stereotypes processing           |         |       |  2:41 |   3.3 |
| Profiles as meta-model elements                        |         |       | 13:54 |  17.3 |
| Add support for composable stereotypes                 |         |       |  6:06 |   7.6 |
| Code generate all contexts                             |         |       |  0:38 |   0.8 |
| Consider renaming orchestration to "engine"            |         |       |  0:38 |   0.8 |
| Code generate feature infrastructure                   |         |       |  1:37 |   2.0 |
