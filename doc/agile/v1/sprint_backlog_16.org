...
#+CAPTION: Clock summary at [2019-05-01 Wed 11:39]
| <75>                                                   |         |       |       |       |
| Headline                                               | Time    |       |       |     % |
|--------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                           | *61:45* |       |       | 100.0 |
|--------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                | 61:45   |       |       | 100.0 |
| Active                                                 |         | 61:45 |       | 100.0 |
...
| Finish implementing the variability model              |         |       | 10:49 |  17.5 |
| Trim down stitch's use of annotations                  |         |       |  1:30 |   2.4 |
| Read meta-data using configurations                    |         |       | 24:24 |  39.5 |
| Remove uses of annotations                             |         |       |  7:44 |  12.5 |
| Stitch is still using artefact writer                  |         |       |  0:04 |   0.1 |
| Profiles as meta-model elements                        |         |       |  8:16 |  13.4 |
