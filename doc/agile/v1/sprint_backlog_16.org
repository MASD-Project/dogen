...
#+CAPTION: Clock summary at [2019-04-30 Tue 18:49]
| <75>                                                   |         |       |       |       |
| Headline                                               | Time    |       |       |     % |
|--------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                | 60:05   |       |       | 100.0 |
| Active                                                 |         | 60:05 |       | 100.0 |
| Edit release notes for previous sprint                 |         |       |  2:40 |   4.4 |
| Sprint and product backlog grooming                    |         |       |  2:59 |   5.0 |
| Create a video demo for the previous sprint's features |         |       |  1:55 |   3.2 |
| Read variability papers                                |         |       |  1:04 |   1.8 |
| Emacs maintenance and exploration work                 |         |       |  0:20 |   0.6 |
| Finish implementing the variability model              |         |       | 10:49 |  18.0 |
| Trim down stitch's use of annotations                  |         |       |  1:30 |   2.5 |
| Read meta-data using configurations                    |         |       | 24:24 |  40.6 |
| Remove uses of annotations                             |         |       |  7:44 |  12.9 |
| Stitch is still using artefact writer                  |         |       |  0:04 |   0.1 |
| Profiles as meta-model elements                        |         |       |  6:36 |  11.0 |
...
- move test profiles into test projects using a top-level
  model. Create separate ones for C++ and C#.
- tidy-up profile names.
- reference profiles by name rather than by label.
- remove labels.
