...
#+CAPTION: Clock summary at [2019-05-01 Wed 16:35]
| <75>                                                   |         |       |       |       |
| Headline                                               | Time    |       |       |     % |
|--------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                           | *65:26* |       |       | 100.0 |
|--------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                | 65:26   |       |       | 100.0 |
| Active                                                 |         | 65:26 |       | 100.0 |
| Edit release notes for previous sprint                 |         |       |  2:40 |   4.1 |
| Sprint and product backlog grooming                    |         |       |  2:59 |   4.6 |
| Create a video demo for the previous sprint's features |         |       |  1:55 |   2.9 |
| Read variability papers                                |         |       |  1:04 |   1.6 |
| Emacs maintenance and exploration work                 |         |       |  0:20 |   0.5 |
| Finish implementing the variability model              |         |       | 10:49 |  16.5 |
| Trim down stitch's use of annotations                  |         |       |  1:30 |   2.3 |
| Read meta-data using configurations                    |         |       | 24:24 |  37.3 |
| Remove uses of annotations                             |         |       |  7:44 |  11.8 |
| Stitch is still using artefact writer                  |         |       |  0:04 |   0.1 |
| Profiles as meta-model elements                        |         |       |  9:32 |  14.6 |
| Exclude profiles from stereotypes processing           |         |       |  2:25 |   3.7 |
...
*** STARTED Exclude profiles from stereotypes processing              :story:
    :LOGBOOK:
