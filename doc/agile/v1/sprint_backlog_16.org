...
#+CAPTION: Clock summary at [2019-05-03 Fri 14:41]
| <75>                                                   |         |       |       |       |
| Headline                                               | Time    |       |       |     % |
|--------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                           | *77:55* |       |       | 100.0 |
|--------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                | 77:55   |       |       | 100.0 |
| Active                                                 |         | 77:55 |       | 100.0 |
| Edit release notes for previous sprint                 |         |       |  2:40 |   3.4 |
| Sprint and product backlog grooming                    |         |       |  3:27 |   4.4 |
...
| Finish implementing the variability model              |         |       | 10:49 |  13.9 |
| Trim down stitch's use of annotations                  |         |       |  1:30 |   1.9 |
| Read meta-data using configurations                    |         |       | 24:24 |  31.3 |
| Remove uses of annotations                             |         |       |  7:44 |   9.9 |
| Stitch is still using artefact writer                  |         |       |  0:04 |   0.1 |
| Exclude profiles from stereotypes processing           |         |       |  2:41 |   3.4 |
| Profiles as meta-model elements                        |         |       | 13:54 |  17.8 |
| Add support for composable stereotypes                 |         |       |  6:06 |   7.8 |
