...
#+CAPTION: Clock summary at [2019-04-29 Mon 17:58]
| <75>                                                   |         |       |       |       |
| Headline                                               | Time    |       |       |     % |
|--------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                           | *52:42* |       |       | 100.0 |
|--------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                | 52:42   |       |       | 100.0 |
| Active                                                 |         | 52:42 |       | 100.0 |
| Edit release notes for previous sprint                 |         |       |  2:40 |   5.1 |
| Sprint and product backlog grooming                    |         |       |  1:40 |   3.2 |
| Create a video demo for the previous sprint's features |         |       |  1:55 |   3.6 |
| Read variability papers                                |         |       |  1:04 |   2.0 |
| Finish implementing the variability model              |         |       | 10:49 |  20.5 |
| Trim down stitch's use of annotations                  |         |       |  1:30 |   2.8 |
| Read meta-data using configurations                    |         |       | 24:24 |  46.3 |
| Remove uses of annotations                             |         |       |  7:44 |  14.7 |
| Stitch is still using artefact writer                  |         |       |  0:04 |   0.1 |
| Profiles as meta-model elements                        |         |       |  0:52 |   1.6 |
