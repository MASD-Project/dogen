...
#+CAPTION: Clock summary at [2019-05-03 Fri 11:54]
| <75>                                                   |         |       |       |       |
| Headline                                               | Time    |       |       |     % |
|--------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                           | *76:23* |       |       | 100.0 |
|--------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                | 76:23   |       |       | 100.0 |
| Active                                                 |         | 76:23 |       | 100.0 |
| Edit release notes for previous sprint                 |         |       |  2:40 |   3.5 |
| Sprint and product backlog grooming                    |         |       |  3:27 |   4.5 |
| Create a video demo for the previous sprint's features |         |       |  1:55 |   2.5 |
| Read variability papers                                |         |       |  1:04 |   1.4 |
| Emacs maintenance and exploration work                 |         |       |  0:20 |   0.4 |
| Fix issues with nightly build and CI                   |         |       |  0:39 |   0.9 |
| Finish implementing the variability model              |         |       | 10:49 |  14.2 |
| Trim down stitch's use of annotations                  |         |       |  1:30 |   2.0 |
| Read meta-data using configurations                    |         |       | 24:24 |  31.9 |
| Remove uses of annotations                             |         |       |  7:44 |  10.1 |
| Stitch is still using artefact writer                  |         |       |  0:04 |   0.1 |
| Exclude profiles from stereotypes processing           |         |       |  2:41 |   3.5 |
| Profiles as meta-model elements                        |         |       | 13:54 |  18.2 |
| Add support for composable stereotypes                 |         |       |  5:12 |   6.8 |
