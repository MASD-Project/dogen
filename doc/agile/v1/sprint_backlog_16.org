...
#+CAPTION: Clock summary at [2019-04-30 Tue 10:07]
| <75>                                                   |         |       |       |       |
| Headline                                               | Time    |       |       |     % |
|--------------------------------------------------------+---------+-------+-------+-------|
...
| Sprint and product backlog grooming                    |         |       |  2:26 |   4.5 |
| Create a video demo for the previous sprint's features |         |       |  1:55 |   3.5 |
| Read variability papers                                |         |       |  1:04 |   2.0 |
| Emacs maintenance and exploration work                 |         |       |  0:20 |   0.6 |
| Finish implementing the variability model              |         |       | 10:49 |  19.9 |
| Trim down stitch's use of annotations                  |         |       |  1:30 |   2.8 |
| Read meta-data using configurations                    |         |       | 24:24 |  45.0 |
| Remove uses of annotations                             |         |       |  7:44 |  14.3 |
| Stitch is still using artefact writer                  |         |       |  0:04 |   0.1 |
| Profiles as meta-model elements                        |         |       |  1:20 |   2.5 |
