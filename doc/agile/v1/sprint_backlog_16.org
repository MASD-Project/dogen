...
#+CAPTION: Clock summary at [2019-04-30 Tue 09:59]
| <75>                                                   |         |       |       |       |
| Headline                                               | Time    |       |       |     % |
|--------------------------------------------------------+---------+-------+-------+-------|
...
| Finish implementing the variability model              |         |       | 10:49 |  20.0 |
| Trim down stitch's use of annotations                  |         |       |  1:30 |   2.8 |
| Read meta-data using configurations                    |         |       | 24:24 |  45.1 |
| Remove uses of annotations                             |         |       |  7:44 |  14.3 |
| Stitch is still using artefact writer                  |         |       |  0:04 |   0.1 |
| Profiles as meta-model elements                        |         |       |  1:11 |   2.2 |
