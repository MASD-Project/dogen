...
#+CAPTION: Clock summary at [2019-04-22 Mon 17:55]
| <75>                                                   |        |      |      |       |
| Headline                                               | Time   |      |      |     % |
|--------------------------------------------------------+--------+------+------+-------|
| *Total time*                                           | *6:01* |      |      | 100.0 |
|--------------------------------------------------------+--------+------+------+-------|
| Stories                                                | 6:01   |      |      | 100.0 |
| Active                                                 |        | 6:01 |      | 100.0 |
| Edit release notes for previous sprint                 |        |      | 2:40 |  44.3 |
| Sprint and product backlog grooming                    |        |      | 0:22 |   6.1 |
| Create a video demo for the previous sprint's features |        |      | 1:55 |  31.9 |
| Read variability papers                                |        |      | 1:04 |  17.7 |
...
*** Redesign annotations model                                        :story:
