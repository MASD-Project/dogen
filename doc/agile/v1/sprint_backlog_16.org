...
#+CAPTION: Clock summary at [2019-05-01 Wed 12:03]
| <75>                                                   |         |       |       |       |
| Headline                                               | Time    |       |       |     % |
|--------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                           | *62:09* |       |       | 100.0 |
|--------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                | 62:09   |       |       | 100.0 |
| Active                                                 |         | 62:09 |       | 100.0 |
...
| Finish implementing the variability model              |         |       | 10:49 |  17.4 |
| Trim down stitch's use of annotations                  |         |       |  1:30 |   2.4 |
| Read meta-data using configurations                    |         |       | 24:24 |  39.3 |
| Remove uses of annotations                             |         |       |  7:44 |  12.4 |
| Stitch is still using artefact writer                  |         |       |  0:04 |   0.1 |
| Profiles as meta-model elements                        |         |       |  8:40 |  13.9 |
