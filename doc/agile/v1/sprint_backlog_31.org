...
#+CAPTION: Clock summary at [2021-04-03 Sat 09:29]
| <75>                                               |         |       |      |       |
| Headline                                           | Time    |       |      |     % |
|----------------------------------------------------+---------+-------+------+-------|
| *Total time*                                       | *11:20* |       |      | 100.0 |
|----------------------------------------------------+---------+-------+------+-------|
| Stories                                            | 11:20   |       |      | 100.0 |
| Active                                             |         | 11:20 |      | 100.0 |
| Edit release notes for previous sprint             |         |       | 6:06 |  53.8 |
| Create a demo and presentation for previous sprint |         |       | 0:27 |   4.0 |
| Sprint and product backlog grooming                |         |       | 2:56 |  25.9 |
| Generate doxygen docs and add to site              |         |       | 1:51 |  16.3 |
...
*** STARTED Fix broken org-mode tests                                 :story:
    :LOGBOOK:
    CLOCK: [2021-09-25 Sat 14:52]
...
(setq org-agenda-files '("/work/DomainDrivenConsulting/masd/dogen/integration/doc/agile/v1/sprint_backlog_31.org"))
