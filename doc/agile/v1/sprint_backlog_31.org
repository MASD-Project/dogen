...
#+CAPTION: Clock summary at [2022-03-21 Mon 23:33]
| <75>                                                       |         |       |      |       |
| Headline                                                   | Time    |       |      |     % |
|------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                               | *26:34* |       |      |   0.0 |
|------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                    | 26:34   |       |      |   0.0 |
| Active                                                     |         | 26:34 |      |   0.0 |
...
| Fix clang build in github                                  |         |       | 0:36 |   0.0 |
| Add testing step to github actions                         |         |       | 1:00 |   0.0 |
...
*** STARTED Fix clang build in github                                 :story:
    :LOGBOOK:
...
*** STARTED Add testing step to github actions                        :story:
    :LOGBOOK:
...
*** Add packaging step to github actions                              :story:
...
*** Remove deprecated travis and appveyor config files                :story:
