...
#+CAPTION: Clock summary at [2022-04-07 Thu 16:00]
| <75>                                                       |         |       |       |       |
| Headline                                                   | Time    |       |       |     % |
|------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                               | *46:30* |       |       |   0.0 |
|------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                    | 46:30   |       |       |   0.0 |
| Active                                                     |         | 46:30 |       |   0.0 |
...
| Sprint and product backlog grooming                        |         |       |  4:58 |   0.0 |
...
| Add code coverage on continuous builds                     |         |       |  0:53 |   0.0 |
| Remove existing benchmark infrastructure                   |         |       |  0:24 |   0.0 |
| Update nightly builds to use new vcpkg setup               |         |       |  0:15 |   0.0 |
| Assorted improvements to CMake files                       |         |       |  0:39 |   0.0 |
...
*** COMPLETED Add code coverage on continuous builds                  :story:
    :LOGBOOK:
    CLOCK: [2022-04-03 Sun 22:00]--[2022-04-03 Sun 22:21] =>  0:21
    CLOCK: [2022-04-03 Sun 20:50]--[2022-04-03 Sun 21:22] =>  0:32
    :END:

At present code coverage is not kicking in.

*** COMPLETED Remove existing benchmark infrastructure                :story:
    :LOGBOOK:
    CLOCK: [2022-04-07 Thu 15:44]--[2022-04-07 Thu 16:00] =>  0:16
    CLOCK: [2022-04-07 Thu 15:27]--[2022-04-07 Thu 15:35] =>  0:08
    :END:
...
- removed from dogen CMake files.
- need to remove from text template, and regenerate c++ ref impl. Done.
...
target_include_directories(main PRIVATE ${DTL_INCLUDE_DIRS})
...
*** Update the test package scripts for the GitHub CI                 :story:

We can probably install debian packages in GitHub CI. Try to see if we can run
the old package test scripts in GitHub.

*** Update C++ reference implementation to use GitHub CI              :story:

We need to move over from travis and appveyor.

*** Build =linux-clang-debug= fails in CTest step                     :story:
