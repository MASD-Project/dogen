...
#+CAPTION: Clock summary at [2022-05-15 Sun 12:51]
| <75>                                                       |         |       |       |       |
| Headline                                                   | Time    |       |       |     % |
|------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                               | *62:57* |       |       |   0.0 |
|------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                    | 62:57   |       |       |   0.0 |
| Active                                                     |         | 62:57 |       |   0.0 |
...
| Sprint and product backlog grooming                        |         |       |  8:11 |   0.0 |
...
| Setup the laptop for development                           |         |       |  0:17 |   0.0 |
| Update nightly builds to use new vcpkg setup               |         |       |  1:09 |   0.0 |
...
*** STARTED Updates to the readme                                     :story:
    :LOGBOOK:
...
*** STARTED Setup the laptop for development                          :story:
    :LOGBOOK:
...
*** STARTED Create a series of lectures on MDE and MASD               :story:
    :LOGBOOK:
...
*** STARTED Add support for relations in codec model                  :story:
    :PROPERTIES:
...
*** STARTED Consider standardising all templates as mustache templates :story:
    :LOGBOOK:
...
*** CANCELLED Consider handling "dia comments" in a general manner    :story:

*Rationale*: The core codec is now org-mode and it does not suffer from this
problem. We should just leave it as is.
...
*** CANCELLED Move wale templates to TS namespaces                    :story:

*Rationale*: this story is superseded by the new understanding of templates,
where all templates will eventually become mustache templates.
