...
#+CAPTION: Clock summary at [2020-11-15 Sun 22:34]
| <75>                                                 |         |       |       |       |
| Headline                                             | Time    |       |       |     % |
|------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                         | *35:02* |       |       | 100.0 |
|------------------------------------------------------+---------+-------+-------+-------|
| Stories                                              | 35:02   |       |       | 100.0 |
| Active                                               |         | 35:02 |       | 100.0 |
| edit release notes for previous sprint               |         |       |  5:04 |  14.5 |
| Create a demo and presentation for previous sprint   |         |       |  0:28 |   1.3 |
| Sprint and product backlog grooming                  |         |       |  1:30 |   4.3 |
| Improvements to template processing in logical model |         |       |  0:26 |   1.2 |
| Convert legacy helpers into new style helpers in C++ |         |       |  6:59 |  19.9 |
| Add C++ helpers to the PMM                           |         |       | 13:36 |  38.8 |
...
| Add C# helpers to the PMM                            |         |       |  2:10 |   6.2 |
| Move assorted formattable properties in C#           |         |       |  3:47 |  10.8 |
