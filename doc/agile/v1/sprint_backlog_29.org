...
#+CAPTION: Clock summary at [2020-12-05 Sat 18:51]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *64:02* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 64:02   |       |       | 100.0 |
| Active                                                    |         | 64:02 |       | 100.0 |
| edit release notes for previous sprint                    |         |       |  5:04 |   7.9 |
| Create a demo and presentation for previous sprint        |         |       |  0:28 |   0.7 |
| Sprint and product backlog grooming                       |         |       |  2:37 |   4.1 |
| Improvements to template processing in logical model      |         |       |  0:26 |   0.7 |
| Convert legacy helpers into new style helpers in C++      |         |       |  6:59 |  10.9 |
| Add C++ helpers to the PMM                                |         |       | 13:36 |  21.2 |
...
| Add C# helpers to the PMM                                 |         |       |  3:53 |   6.1 |
| Move assorted formattable properties in C#                |         |       |  4:48 |   7.5 |
| Orchestration should have an initialiser                  |         |       |  0:09 |   0.2 |
| Move helpers to =text= model                              |         |       | 21:38 |  33.8 |
| Add namespaces to "dummy function"                        |         |       |  0:10 |   0.3 |
| Remove JSON models from Dogen                             |         |       |  0:19 |   0.5 |
| Issues with emacs                                         |         |       |  1:32 |   2.4 |
