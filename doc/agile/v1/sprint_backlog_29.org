...
#+CAPTION: Clock summary at [2020-11-14 Sat 19:46]
| <75>                                                 |         |       |       |       |
| Headline                                             | Time    |       |       |     % |
|------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                         | *28:22* |       |       | 100.0 |
|------------------------------------------------------+---------+-------+-------+-------|
| Stories                                              | 28:22   |       |       | 100.0 |
| Active                                               |         | 28:22 |       | 100.0 |
| edit release notes for previous sprint               |         |       |  5:04 |  17.9 |
| Create a demo and presentation for previous sprint   |         |       |  0:28 |   1.6 |
| Sprint and product backlog grooming                  |         |       |  1:30 |   5.3 |
| Improvements to template processing in logical model |         |       |  0:26 |   1.5 |
| Convert legacy helpers into new style helpers in C++ |         |       |  6:59 |  24.6 |
| Add C++ helpers to the PMM                           |         |       | 13:36 |  47.9 |
| Remove JSON models from Dogen                        |         |       |  0:19 |   1.1 |
