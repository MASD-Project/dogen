...
#+CAPTION: Clock summary at [2020-11-13 Fri 21:47]
| <75>                                                 |         |       |      |       |
| Headline                                             | Time    |       |      |     % |
|------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                              | 22:41   |       |      | 100.0 |
| Active                                               |         | 22:41 |      | 100.0 |
| edit release notes for previous sprint               |         |       | 5:04 |  22.3 |
| Create a demo and presentation for previous sprint   |         |       | 0:28 |   2.1 |
| Sprint and product backlog grooming                  |         |       | 1:29 |   6.5 |
| Improvements to template processing in logical model |         |       | 0:26 |   1.9 |
| Convert legacy helpers into new style helpers in C++ |         |       | 6:59 |  30.8 |
| Add C++ helpers to the PMM                           |         |       | 8:15 |  36.4 |
