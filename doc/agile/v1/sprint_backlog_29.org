...
#+CAPTION: Clock summary at [2020-12-04 Fri 11:54]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *57:53* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 57:53   |       |       | 100.0 |
| Active                                                    |         | 57:53 |       | 100.0 |
| edit release notes for previous sprint                    |         |       |  5:04 |   8.8 |
| Create a demo and presentation for previous sprint        |         |       |  0:28 |   0.8 |
| Sprint and product backlog grooming                       |         |       |  2:21 |   4.1 |
| Improvements to template processing in logical model      |         |       |  0:26 |   0.7 |
| Convert legacy helpers into new style helpers in C++      |         |       |  6:59 |  12.1 |
| Add C++ helpers to the PMM                                |         |       | 13:36 |  23.5 |
| Remove unused wale keys in =text.cpp=                     |         |       |  0:34 |   1.0 |
| Merge =cpp_artefact_transform*= wale templates            |         |       |  0:09 |   0.3 |
| Fix some problems with c++ visual studio problems         |         |       |  0:59 |   1.7 |
| Add C# helpers to the PMM                                 |         |       |  3:53 |   6.7 |
| Move assorted formattable properties in C#                |         |       |  4:48 |   8.3 |
| Orchestration should have an initialiser                  |         |       |  0:09 |   0.3 |
| Remove JSON models from Dogen                             |         |       |  0:19 |   0.5 |
| Issues with emacs                                         |         |       |  1:32 |   2.6 |
| Move text transforms in c++ and c# models into text model |         |       |  0:41 |   1.2 |
| Move context, helper and M2T interface to =text= model    |         |       | 15:55 |  27.5 |
...
*** STARTED Move context, helper and M2T interface to =text= model    :story:
    :LOGBOOK:
