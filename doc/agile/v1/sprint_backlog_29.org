...
#+CAPTION: Clock summary at [2020-11-09 Mon 21:01]
| <75>                                                 |         |       |      |       |
| Headline                                             | Time    |       |      |     % |
|------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                              | 16:05   |       |      | 100.0 |
| Active                                               |         | 16:05 |      | 100.0 |
| edit release notes for previous sprint               |         |       | 5:04 |  31.5 |
| Create a demo and presentation for previous sprint   |         |       | 0:28 |   2.9 |
| Sprint and product backlog grooming                  |         |       | 1:29 |   9.2 |
| Improvements to template processing in logical model |         |       | 0:26 |   2.7 |
| Add C++ helpers to the PMM                           |         |       | 8:38 |  53.7 |
...
- cpp has a dummy function for transform. Need to update rendering transform.
