...
#+CAPTION: Clock summary at [2020-11-13 Fri 15:01]
| <75>                                                 |         |       |       |       |
| Headline                                             | Time    |       |       |     % |
|------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                         | *20:01* |       |       | 100.0 |
|------------------------------------------------------+---------+-------+-------+-------|
| Stories                                              | 20:01   |       |       | 100.0 |
| Active                                               |         | 20:01 |       | 100.0 |
| edit release notes for previous sprint               |         |       |  5:04 |  25.3 |
| Create a demo and presentation for previous sprint   |         |       |  0:28 |   2.3 |
| Sprint and product backlog grooming                  |         |       |  1:29 |   7.4 |
| Improvements to template processing in logical model |         |       |  0:26 |   2.2 |
| Add C++ helpers to the PMM                           |         |       | 12:34 |  62.8 |
