...
#+CAPTION: Clock summary at [2020-11-30 Mon 12:16]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *46:56* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 46:56   |       |       | 100.0 |
| Active                                                    |         | 46:56 |       | 100.0 |
| edit release notes for previous sprint                    |         |       |  5:04 |  10.8 |
| Create a demo and presentation for previous sprint        |         |       |  0:28 |   1.0 |
| Sprint and product backlog grooming                       |         |       |  1:52 |   4.0 |
| Improvements to template processing in logical model      |         |       |  0:26 |   0.9 |
| Convert legacy helpers into new style helpers in C++      |         |       |  6:59 |  14.9 |
| Add C++ helpers to the PMM                                |         |       | 13:36 |  29.0 |
| Remove unused wale keys in =text.cpp=                     |         |       |  0:34 |   1.2 |
| Merge =cpp_artefact_transform*= wale templates            |         |       |  0:09 |   0.3 |
| Fix some problems with c++ visual studio problems         |         |       |  0:59 |   2.1 |
| Add C# helpers to the PMM                                 |         |       |  3:53 |   8.3 |
| Move assorted formattable properties in C#                |         |       |  4:48 |  10.2 |
...
| Move context, helper and M2T interface to =text= model    |         |       |  6:46 |  14.4 |
