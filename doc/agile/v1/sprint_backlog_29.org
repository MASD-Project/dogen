...
#+CAPTION: Clock summary at [2020-12-11 Fri 20:28]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *80:00* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 80:00   |       |       | 100.0 |
| Active                                                    |         | 80:00 |       | 100.0 |
| edit release notes for previous sprint                    |         |       |  5:04 |   6.3 |
| Create a demo and presentation for previous sprint        |         |       |  0:28 |   0.6 |
| Sprint and product backlog grooming                       |         |       |  2:50 |   3.5 |
| Improvements to template processing in logical model      |         |       |  0:26 |   0.5 |
| Convert legacy helpers into new style helpers in C++      |         |       |  6:59 |   8.7 |
| Add C++ helpers to the PMM                                |         |       | 13:36 |  17.0 |
...
| Add C# helpers to the PMM                                 |         |       |  3:53 |   4.9 |
| Move assorted formattable properties in C#                |         |       |  4:48 |   6.0 |
| Orchestration should have an initialiser                  |         |       |  0:09 |   0.2 |
| Move helpers to =text= model                              |         |       | 21:38 |  27.0 |
| Add namespaces to "dummy function"                        |         |       |  0:10 |   0.2 |
| Remove disabled files from project items                  |         |       |  0:30 |   0.6 |
| Move text transforms in c++ and c# models into text model |         |       | 15:56 |  19.9 |
| Remove JSON models from Dogen                             |         |       |  0:19 |   0.4 |
| Issues with emacs                                         |         |       |  1:32 |   1.9 |
