...
#+CAPTION: Clock summary at [2020-11-25 Wed 22:15]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *45:30* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 45:30   |       |       | 100.0 |
| Active                                                    |         | 45:30 |       | 100.0 |
| edit release notes for previous sprint                    |         |       |  5:04 |  11.1 |
| Create a demo and presentation for previous sprint        |         |       |  0:28 |   1.0 |
| Sprint and product backlog grooming                       |         |       |  1:52 |   4.1 |
| Improvements to template processing in logical model      |         |       |  0:26 |   1.0 |
| Convert legacy helpers into new style helpers in C++      |         |       |  6:59 |  15.3 |
| Add C++ helpers to the PMM                                |         |       | 13:36 |  29.9 |
| Remove unused wale keys in =text.cpp=                     |         |       |  0:34 |   1.2 |
| Merge =cpp_artefact_transform*= wale templates            |         |       |  0:09 |   0.3 |
| Fix some problems with c++ visual studio problems         |         |       |  0:59 |   2.2 |
| Add C# helpers to the PMM                                 |         |       |  3:53 |   8.5 |
| Move assorted formattable properties in C#                |         |       |  4:48 |  10.5 |
| Remove JSON models from Dogen                             |         |       |  0:19 |   0.7 |
| Issues with emacs                                         |         |       |  0:22 |   0.8 |
| Move text transforms in c++ and c# models into text model |         |       |  0:41 |   1.5 |
| Move context, helper and M2T interface to =text= model    |         |       |  5:20 |  11.7 |
