...
#+CAPTION: Clock summary at [2020-12-13 Sun 13:34]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *86:28* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 86:28   |       |       | 100.0 |
| Active                                                    |         | 86:28 |       | 100.0 |
| edit release notes for previous sprint                    |         |       |  5:04 |   5.9 |
| Create a demo and presentation for previous sprint        |         |       |  0:28 |   0.5 |
| Sprint and product backlog grooming                       |         |       |  3:09 |   3.6 |
| Improvements to template processing in logical model      |         |       |  0:26 |   0.5 |
| Convert legacy helpers into new style helpers in C++      |         |       |  6:59 |   8.1 |
| Add C++ helpers to the PMM                                |         |       | 13:36 |  15.7 |
| Remove unused wale keys in =text.cpp=                     |         |       |  0:34 |   0.7 |
| Merge =cpp_artefact_transform*= wale templates            |         |       |  0:09 |   0.2 |
| Fix some problems with c++ visual studio problems         |         |       |  0:59 |   1.1 |
| Add C# helpers to the PMM                                 |         |       |  3:53 |   4.5 |
| Move assorted formattable properties in C#                |         |       |  4:48 |   5.6 |
| Orchestration should have an initialiser                  |         |       |  0:09 |   0.2 |
| Move helpers to =text= model                              |         |       | 21:38 |  25.0 |
| Add namespaces to "dummy function"                        |         |       |  0:10 |   0.2 |
| Remove disabled files from project items                  |         |       |  0:30 |   0.6 |
| Move text transforms in c++ and c# models into text model |         |       | 15:56 |  18.4 |
| Use MDE terminology in Dia model                          |         |       |  1:47 |   2.1 |
| Remove JSON models from Dogen                             |         |       |  0:19 |   0.4 |
| Issues with emacs                                         |         |       |  1:32 |   1.8 |
| Merge codec models                                        |         |       |  4:22 |   5.1 |
