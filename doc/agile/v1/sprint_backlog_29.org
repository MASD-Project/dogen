...
#+CAPTION: Clock summary at [2020-12-06 Sun 11:16]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *65:17* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 65:17   |       |       | 100.0 |
| Active                                                    |         | 65:17 |       | 100.0 |
| edit release notes for previous sprint                    |         |       |  5:04 |   7.8 |
| Create a demo and presentation for previous sprint        |         |       |  0:28 |   0.7 |
| Sprint and product backlog grooming                       |         |       |  2:37 |   4.0 |
| Improvements to template processing in logical model      |         |       |  0:26 |   0.7 |
| Convert legacy helpers into new style helpers in C++      |         |       |  6:59 |  10.7 |
| Add C++ helpers to the PMM                                |         |       | 13:36 |  20.8 |
| Remove unused wale keys in =text.cpp=                     |         |       |  0:34 |   0.9 |
| Merge =cpp_artefact_transform*= wale templates            |         |       |  0:09 |   0.2 |
| Fix some problems with c++ visual studio problems         |         |       |  0:59 |   1.5 |
| Add C# helpers to the PMM                                 |         |       |  3:53 |   5.9 |
| Move assorted formattable properties in C#                |         |       |  4:48 |   7.4 |
| Orchestration should have an initialiser                  |         |       |  0:09 |   0.2 |
| Move helpers to =text= model                              |         |       | 21:38 |  33.1 |
| Add namespaces to "dummy function"                        |         |       |  0:10 |   0.3 |
| Remove JSON models from Dogen                             |         |       |  0:19 |   0.5 |
| Issues with emacs                                         |         |       |  1:32 |   2.3 |
| Move text transforms in c++ and c# models into text model |         |       |  1:56 |   3.0 |
