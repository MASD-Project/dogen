...
#+CAPTION: Clock summary at [2020-12-03 Thu 17:14]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *53:43* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 53:43   |       |       | 100.0 |
| Active                                                    |         | 53:43 |       | 100.0 |
| edit release notes for previous sprint                    |         |       |  5:04 |   9.4 |
| Create a demo and presentation for previous sprint        |         |       |  0:28 |   0.9 |
| Sprint and product backlog grooming                       |         |       |  2:11 |   4.1 |
| Improvements to template processing in logical model      |         |       |  0:26 |   0.8 |
| Convert legacy helpers into new style helpers in C++      |         |       |  6:59 |  13.0 |
| Add C++ helpers to the PMM                                |         |       | 13:36 |  25.3 |
| Remove unused wale keys in =text.cpp=                     |         |       |  0:34 |   1.1 |
| Merge =cpp_artefact_transform*= wale templates            |         |       |  0:09 |   0.3 |
| Fix some problems with c++ visual studio problems         |         |       |  0:59 |   1.8 |
| Add C# helpers to the PMM                                 |         |       |  3:53 |   7.2 |
| Move assorted formattable properties in C#                |         |       |  4:48 |   8.9 |
| Remove JSON models from Dogen                             |         |       |  0:19 |   0.6 |
| Issues with emacs                                         |         |       |  1:32 |   2.9 |
| Move text transforms in c++ and c# models into text model |         |       |  0:41 |   1.3 |
| Move context, helper and M2T interface to =text= model    |         |       | 12:04 |  22.5 |
