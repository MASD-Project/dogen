...
#+CAPTION: Clock summary at [2020-12-03 Thu 19:53]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *55:00* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 55:00   |       |       | 100.0 |
| Active                                                    |         | 55:00 |       | 100.0 |
| edit release notes for previous sprint                    |         |       |  5:04 |   9.2 |
| Create a demo and presentation for previous sprint        |         |       |  0:28 |   0.8 |
| Sprint and product backlog grooming                       |         |       |  2:21 |   4.3 |
| Improvements to template processing in logical model      |         |       |  0:26 |   0.8 |
| Convert legacy helpers into new style helpers in C++      |         |       |  6:59 |  12.7 |
| Add C++ helpers to the PMM                                |         |       | 13:36 |  24.7 |
| Remove unused wale keys in =text.cpp=                     |         |       |  0:34 |   1.0 |
| Merge =cpp_artefact_transform*= wale templates            |         |       |  0:09 |   0.3 |
| Fix some problems with c++ visual studio problems         |         |       |  0:59 |   1.8 |
| Add C# helpers to the PMM                                 |         |       |  3:53 |   7.1 |
| Move assorted formattable properties in C#                |         |       |  4:48 |   8.7 |
| Remove JSON models from Dogen                             |         |       |  0:19 |   0.6 |
| Issues with emacs                                         |         |       |  1:32 |   2.8 |
| Move text transforms in c++ and c# models into text model |         |       |  0:41 |   1.2 |
| Move context, helper and M2T interface to =text= model    |         |       | 13:11 |  24.0 |
