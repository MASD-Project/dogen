...
#+CAPTION: Clock summary at [2020-11-15 Sun 22:04]
| <75>                                                 |         |       |       |       |
| Headline                                             | Time    |       |       |     % |
|------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                         | *34:33* |       |       | 100.0 |
|------------------------------------------------------+---------+-------+-------+-------|
| Stories                                              | 34:33   |       |       | 100.0 |
| Active                                               |         | 34:33 |       | 100.0 |
| edit release notes for previous sprint               |         |       |  5:04 |  14.7 |
| Create a demo and presentation for previous sprint   |         |       |  0:28 |   1.4 |
| Sprint and product backlog grooming                  |         |       |  1:30 |   4.3 |
| Improvements to template processing in logical model |         |       |  0:26 |   1.3 |
| Convert legacy helpers into new style helpers in C++ |         |       |  6:59 |  20.2 |
| Add C++ helpers to the PMM                           |         |       | 13:36 |  39.4 |
| Remove unused wale keys in =text.cpp=                |         |       |  0:34 |   1.6 |
| Merge =cpp_artefact_transform*= wale templates       |         |       |  0:09 |   0.4 |
| Remove JSON models from Dogen                        |         |       |  0:19 |   0.9 |
| Add C# helpers to the PMM                            |         |       |  1:41 |   4.9 |
| Move assorted formattable properties in C#           |         |       |  3:47 |  11.0 |
...
*** STARTED Move assorted formattable properties in C#                :story:
    :LOGBOOK:
