...
#+CAPTION: Clock summary at [2020-11-22 Sun 18:37]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                   | 45:08   |       |       | 100.0 |
| Active                                                    |         | 45:08 |       | 100.0 |
| edit release notes for previous sprint                    |         |       |  5:04 |  11.2 |
| Create a demo and presentation for previous sprint        |         |       |  0:28 |   1.0 |
| Sprint and product backlog grooming                       |         |       |  1:30 |   3.3 |
| Improvements to template processing in logical model      |         |       |  0:26 |   1.0 |
| Convert legacy helpers into new style helpers in C++      |         |       |  6:59 |  15.5 |
| Add C++ helpers to the PMM                                |         |       | 13:36 |  30.1 |
| Remove unused wale keys in =text.cpp=                     |         |       |  0:34 |   1.3 |
| Merge =cpp_artefact_transform*= wale templates            |         |       |  0:09 |   0.3 |
| Fix some problems with c++ visual studio problems         |         |       |  0:59 |   2.2 |
| Add C# helpers to the PMM                                 |         |       |  3:53 |   8.6 |
| Move assorted formattable properties in C#                |         |       |  4:48 |  10.6 |
...
| Move context, helper and M2T interface to =text= model    |         |       |  5:20 |  11.8 |
