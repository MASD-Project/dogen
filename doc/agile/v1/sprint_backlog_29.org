...
#+CAPTION: Clock summary at [2020-11-13 Fri 18:06]
| <75>                                                 |         |       |      |       |
| Headline                                             | Time    |       |      |     % |
|------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                         | *22:16* |       |      | 100.0 |
|------------------------------------------------------+---------+-------+------+-------|
| Stories                                              | 22:16   |       |      | 100.0 |
| Active                                               |         | 22:16 |      | 100.0 |
| edit release notes for previous sprint               |         |       | 5:04 |  22.8 |
| Create a demo and presentation for previous sprint   |         |       | 0:28 |   2.1 |
| Sprint and product backlog grooming                  |         |       | 1:29 |   6.7 |
| Improvements to template processing in logical model |         |       | 0:26 |   1.9 |
| Add C++ helpers to the PMM                           |         |       | 8:08 |  36.5 |
| Convert legacy helpers into new style helpers in C++ |         |       | 6:41 |  30.0 |
...
*** STARTED Convert legacy helpers into new style helpers in C++      :story:
    :LOGBOOK:
...
- inserter helper does not follow the existing patterns. We nee to
  ...
  changes needed for the helper expander via PMM.
