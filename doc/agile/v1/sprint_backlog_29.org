...
#+CAPTION: Clock summary at [2020-12-04 Fri 17:54]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *60:00* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 60:00   |       |       | 100.0 |
| Active                                                    |         | 60:00 |       | 100.0 |
| edit release notes for previous sprint                    |         |       |  5:04 |   8.4 |
| Create a demo and presentation for previous sprint        |         |       |  0:28 |   0.8 |
| Sprint and product backlog grooming                       |         |       |  2:37 |   4.4 |
| Improvements to template processing in logical model      |         |       |  0:26 |   0.7 |
| Convert legacy helpers into new style helpers in C++      |         |       |  6:59 |  11.6 |
| Add C++ helpers to the PMM                                |         |       | 13:36 |  22.7 |
...
| Add C# helpers to the PMM                                 |         |       |  3:53 |   6.5 |
| Move assorted formattable properties in C#                |         |       |  4:48 |   8.0 |
...
| Move helpers to =text= model                              |         |       | 17:46 |  29.6 |
