...
#+CAPTION: Clock summary at [2020-11-20 Fri 12:46]
| <75>                                                 |         |       |       |       |
| Headline                                             | Time    |       |       |     % |
|------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                         | *37:41* |       |       | 100.0 |
|------------------------------------------------------+---------+-------+-------+-------|
| Stories                                              | 37:41   |       |       | 100.0 |
| Active                                               |         | 37:41 |       | 100.0 |
| edit release notes for previous sprint               |         |       |  5:04 |  13.4 |
| Create a demo and presentation for previous sprint   |         |       |  0:28 |   1.2 |
| Sprint and product backlog grooming                  |         |       |  1:30 |   4.0 |
| Improvements to template processing in logical model |         |       |  0:26 |   1.1 |
| Convert legacy helpers into new style helpers in C++ |         |       |  6:59 |  18.5 |
| Add C++ helpers to the PMM                           |         |       | 13:36 |  36.1 |
| Remove unused wale keys in =text.cpp=                |         |       |  0:34 |   1.5 |
| Merge =cpp_artefact_transform*= wale templates       |         |       |  0:09 |   0.4 |
| Fix some problems with c++ visual studio problems    |         |       |  0:59 |   2.6 |
| Remove JSON models from Dogen                        |         |       |  0:19 |   0.8 |
| Add C# helpers to the PMM                            |         |       |  3:50 |  10.2 |
| Move assorted formattable properties in C#           |         |       |  3:47 |  10.0 |
