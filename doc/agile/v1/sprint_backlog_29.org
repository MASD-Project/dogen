...
#+CAPTION: Clock summary at [2020-12-07 Mon 18:45]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *72:39* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 72:39   |       |       | 100.0 |
| Active                                                    |         | 72:39 |       | 100.0 |
| edit release notes for previous sprint                    |         |       |  5:04 |   7.0 |
...
| Convert legacy helpers into new style helpers in C++      |         |       |  6:59 |   9.6 |
| Add C++ helpers to the PMM                                |         |       | 13:36 |  18.7 |
...
| Move assorted formattable properties in C#                |         |       |  4:48 |   6.6 |
| Orchestration should have an initialiser                  |         |       |  0:09 |   0.2 |
| Move helpers to =text= model                              |         |       | 21:38 |  29.8 |
...
| Move text transforms in c++ and c# models into text model |         |       |  8:48 |  12.1 |
