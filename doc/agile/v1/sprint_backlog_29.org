...
#+CAPTION: Clock summary at [2020-11-08 Sun 13:24]
| <75>                                                 |         |       |      |       |
| Headline                                             | Time    |       |      |     % |
|------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                         | *13:34* |       |      | 100.0 |
|------------------------------------------------------+---------+-------+------+-------|
| Stories                                              | 13:34   |       |      | 100.0 |
| Active                                               |         | 13:34 |      | 100.0 |
| edit release notes for previous sprint               |         |       | 5:04 |  37.3 |
| Create a demo and presentation for previous sprint   |         |       | 0:28 |   3.4 |
| Sprint and product backlog grooming                  |         |       | 1:29 |  10.9 |
| Improvements to template processing in logical model |         |       | 0:26 |   3.2 |
| Add C++ helpers to the PMM                           |         |       | 6:07 |  45.1 |
