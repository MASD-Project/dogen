...
#+CAPTION: Clock summary at [2020-12-05 Sat 13:22]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *61:52* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 61:52   |       |       | 100.0 |
| Active                                                    |         | 61:52 |       | 100.0 |
| edit release notes for previous sprint                    |         |       |  5:04 |   8.2 |
| Create a demo and presentation for previous sprint        |         |       |  0:28 |   0.8 |
| Sprint and product backlog grooming                       |         |       |  2:37 |   4.2 |
| Improvements to template processing in logical model      |         |       |  0:26 |   0.7 |
| Convert legacy helpers into new style helpers in C++      |         |       |  6:59 |  11.3 |
| Add C++ helpers to the PMM                                |         |       | 13:36 |  22.0 |
| Remove unused wale keys in =text.cpp=                     |         |       |  0:34 |   0.9 |
| Merge =cpp_artefact_transform*= wale templates            |         |       |  0:09 |   0.2 |
| Fix some problems with c++ visual studio problems         |         |       |  0:59 |   1.6 |
| Add C# helpers to the PMM                                 |         |       |  3:53 |   6.3 |
| Move assorted formattable properties in C#                |         |       |  4:48 |   7.8 |
| Orchestration should have an initialiser                  |         |       |  0:09 |   0.2 |
| Remove JSON models from Dogen                             |         |       |  0:19 |   0.5 |
| Issues with emacs                                         |         |       |  1:32 |   2.5 |
| Move text transforms in c++ and c# models into text model |         |       |  0:41 |   1.1 |
| Move helpers to =text= model                              |         |       | 19:38 |  31.7 |
...
*** STARTED Move helpers to =text= model                              :story:
    :LOGBOOK:
