...
#+CAPTION: Clock summary at [2020-10-10 Sat 12:34]
| <75>                                                        |         |       |      |       |
| Headline                                                    | Time    |       |      |     % |
|-------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                | *40:00* |       |      | 100.0 |
|-------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                     | 40:00   |       |      | 100.0 |
| Active                                                      |         | 40:00 |      | 100.0 |
| edit release notes for previous sprint                      |         |       | 3:44 |   9.3 |
| Create a demo and presentation for previous sprint          |         |       | 0:39 |   1.6 |
| Sprint and product backlog grooming                         |         |       | 3:33 |   8.9 |
| Directory names and postfixes are PMM properties            |         |       | 5:27 |  13.6 |
| Move =enabled= and =overwrite= into =enablement_properties= |         |       | 0:19 |   0.8 |
| Analysis on a formatables refactor                          |         |       | 0:31 |   1.3 |
| Tracing of orchestration chains is incorrect                |         |       | 1:00 |   2.5 |
| Presentation for APA                                        |         |       | 5:11 |  13.0 |
| Issues with emacs                                           |         |       | 1:09 |   2.9 |
| Rename =name= to =codec= name                               |         |       | 0:20 |   0.8 |
| Add full and relative path processing to PM                 |         |       | 2:27 |   6.1 |
| Create a factory transform for parts and archetype kinds    |         |       | 5:30 |  13.8 |
| Create a video series on the formatables refactor           |         |       | 0:15 |   0.6 |
| Move C++ locator into physical model                        |         |       | 9:55 |  24.8 |
