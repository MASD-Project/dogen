...
#+CAPTION: Clock summary at [2020-10-02 Fri 18:08]
| <75>                                                        |         |       |      |       |
| Headline                                                    | Time    |       |      |     % |
|-------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                | *32:44* |       |      | 100.0 |
|-------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                     | 32:44   |       |      | 100.0 |
| Active                                                      |         | 32:44 |      | 100.0 |
| edit release notes for previous sprint                      |         |       | 3:44 |  11.4 |
| Create a demo and presentation for previous sprint          |         |       | 0:39 |   2.0 |
| Sprint and product backlog grooming                         |         |       | 3:09 |   9.6 |
| Directory names and postfixes are PMM properties            |         |       | 5:27 |  16.6 |
| Move =enabled= and =overwrite= into =enablement_properties= |         |       | 0:19 |   1.0 |
| Analysis on a formatables refactor                          |         |       | 0:31 |   1.6 |
| Tracing of orchestration chains is incorrect                |         |       | 1:00 |   3.1 |
| Issues with emacs                                           |         |       | 1:09 |   3.5 |
| Rename =name= to =codec= name                               |         |       | 0:20 |   1.0 |
| Add full and relative path processing to PM                 |         |       | 2:27 |   7.5 |
| Create a factory transform for parts and archetype kinds    |         |       | 5:30 |  16.8 |
| Create a video series on the formatables refactor           |         |       | 0:15 |   0.8 |
| Move C++ locator into physical model                        |         |       | 8:14 |  25.2 |
