...
#+CAPTION: Clock summary at [2020-10-16 Fri 13:00]
| <75>                                                        |         |       |       |       |
| Headline                                                    | Time    |       |       |     % |
|-------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                | *43:59* |       |       | 100.0 |
|-------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                     | 43:59   |       |       | 100.0 |
| Active                                                      |         | 43:59 |       | 100.0 |
| edit release notes for previous sprint                      |         |       |  3:44 |   8.5 |
| Create a demo and presentation for previous sprint          |         |       |  0:39 |   1.5 |
| Sprint and product backlog grooming                         |         |       |  3:33 |   8.1 |
| Directory names and postfixes are PMM properties            |         |       |  5:27 |  12.4 |
| Move =enabled= and =overwrite= into =enablement_properties= |         |       |  0:19 |   0.7 |
| Analysis on a formatables refactor                          |         |       |  0:31 |   1.2 |
| Tracing of orchestration chains is incorrect                |         |       |  1:00 |   2.3 |
| Presentation for APA                                        |         |       |  5:11 |  11.8 |
| Issues with emacs                                           |         |       |  1:09 |   2.6 |
| Rename =name= to =codec= name                               |         |       |  0:20 |   0.8 |
| Add full and relative path processing to PM                 |         |       |  2:27 |   5.6 |
| Create a factory transform for parts and archetype kinds    |         |       |  5:30 |  12.5 |
| Create a video series on the formatables refactor           |         |       |  0:15 |   0.6 |
| Move C++ locator into physical model                        |         |       | 13:54 |  31.6 |
...
*** STARTED Move C++ locator into physical model                      :story:
    ...
    CLOCK: [2020-10-02 Fri 14:30]--[2020-10-02 Fri 14:50] =>  0:20
