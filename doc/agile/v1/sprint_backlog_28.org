...
#+CAPTION: Clock summary at [2020-10-25 Sun 19:40]
| <75>                                                        |         |       |       |       |
| Headline                                                    | Time    |       |       |     % |
|-------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                | *64:22* |       |       | 100.0 |
|-------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                     | 64:22   |       |       | 100.0 |
| Active                                                      |         | 64:22 |       | 100.0 |
| edit release notes for previous sprint                      |         |       |  3:44 |   5.8 |
| Create a demo and presentation for previous sprint          |         |       |  0:39 |   1.0 |
| Sprint and product backlog grooming                         |         |       |  4:23 |   6.8 |
| Directory names and postfixes are PMM properties            |         |       |  5:27 |   8.5 |
...
| Create a factory transform for parts and archetype kinds    |         |       |  5:30 |   8.5 |
| Create a video series on the formatables refactor           |         |       |  0:37 |   1.0 |
| Move C++ locator into physical model                        |         |       | 33:05 |  51.4 |
