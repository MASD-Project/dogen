...
#+CAPTION: Clock summary at [2020-10-01 Thu 12:36]
| <75>                                                        |         |       |      |       |
| Headline                                                    | Time    |       |      |     % |
|-------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                | *22:19* |       |      | 100.0 |
|-------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                     | 22:19   |       |      | 100.0 |
| Active                                                      |         | 22:19 |      | 100.0 |
| edit release notes for previous sprint                      |         |       | 3:44 |  16.7 |
| Create a demo and presentation for previous sprint          |         |       | 0:39 |   2.9 |
| Sprint and product backlog grooming                         |         |       | 3:09 |  14.1 |
| Directory names and postfixes are PMM properties            |         |       | 5:27 |  24.4 |
| Move =enabled= and =overwrite= into =enablement_properties= |         |       | 0:19 |   1.4 |
| Analysis on a formatables refactor                          |         |       | 0:31 |   2.3 |
| Rename =name= to =codec= name                               |         |       | 0:20 |   1.5 |
| Add full and relative path processing to PM                 |         |       | 2:27 |  11.0 |
| Create a factory transform for parts and archetype kinds    |         |       | 3:45 |  16.8 |
| Create a video series on the formatables refactor           |         |       | 0:15 |   1.1 |
| Move C++ locator into physical model                        |         |       | 1:43 |   7.7 |
