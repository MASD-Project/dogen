...
#+CAPTION: Clock summary at [2020-10-25 Sun 18:42]
| <75>                                                        |         |       |       |       |
| Headline                                                    | Time    |       |       |     % |
|-------------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                     | 63:43   |       |       | 100.0 |
| Active                                                      |         | 63:43 |       | 100.0 |
| edit release notes for previous sprint                      |         |       |  3:44 |   5.9 |
| Create a demo and presentation for previous sprint          |         |       |  0:39 |   1.0 |
| Sprint and product backlog grooming                         |         |       |  4:23 |   6.9 |
| Directory names and postfixes are PMM properties            |         |       |  5:27 |   8.6 |
| Move =enabled= and =overwrite= into =enablement_properties= |         |       |  0:19 |   0.5 |
| Analysis on a formatables refactor                          |         |       |  0:31 |   0.8 |
| Tracing of orchestration chains is incorrect                |         |       |  1:00 |   1.6 |
| Presentation for APA                                        |         |       |  5:11 |   8.1 |
| Issues with emacs                                           |         |       |  1:09 |   1.8 |
| Rename =name= to =codec= name                               |         |       |  0:20 |   0.5 |
| Add full and relative path processing to PM                 |         |       |  2:27 |   3.8 |
| Create a factory transform for parts and archetype kinds    |         |       |  5:30 |   8.6 |
| Create a video series on the formatables refactor           |         |       |  0:37 |   1.0 |
| Move C++ locator into physical model                        |         |       | 32:26 |  50.9 |
