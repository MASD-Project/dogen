...
#+CAPTION: Clock summary at [2020-10-03 Sat 17:52]
| <75>                                                        |         |       |      |       |
| Headline                                                    | Time    |       |      |     % |
|-------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                | *34:25* |       |      | 100.0 |
|-------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                     | 34:25   |       |      | 100.0 |
| Active                                                      |         | 34:25 |      | 100.0 |
| edit release notes for previous sprint                      |         |       | 3:44 |  10.8 |
| Create a demo and presentation for previous sprint          |         |       | 0:39 |   1.9 |
| Sprint and product backlog grooming                         |         |       | 3:09 |   9.2 |
| Directory names and postfixes are PMM properties            |         |       | 5:27 |  15.8 |
| Move =enabled= and =overwrite= into =enablement_properties= |         |       | 0:19 |   0.9 |
| Analysis on a formatables refactor                          |         |       | 0:31 |   1.5 |
| Tracing of orchestration chains is incorrect                |         |       | 1:00 |   2.9 |
| Issues with emacs                                           |         |       | 1:09 |   3.3 |
| Rename =name= to =codec= name                               |         |       | 0:20 |   1.0 |
| Add full and relative path processing to PM                 |         |       | 2:27 |   7.1 |
| Create a factory transform for parts and archetype kinds    |         |       | 5:30 |  16.0 |
| Create a video series on the formatables refactor           |         |       | 0:15 |   0.7 |
| Move C++ locator into physical model                        |         |       | 9:55 |  28.8 |
