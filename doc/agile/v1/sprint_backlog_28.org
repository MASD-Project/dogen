...
#+CAPTION: Clock summary at [2020-10-23 Fri 12:34]
| <75>                                                        |         |       |       |       |
| Headline                                                    | Time    |       |       |     % |
|-------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                | *53:56* |       |       | 100.0 |
|-------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                     | 53:56   |       |       | 100.0 |
| Active                                                      |         | 53:56 |       | 100.0 |
| edit release notes for previous sprint                      |         |       |  3:44 |   6.9 |
| Create a demo and presentation for previous sprint          |         |       |  0:39 |   1.2 |
| Sprint and product backlog grooming                         |         |       |  4:23 |   8.1 |
| Directory names and postfixes are PMM properties            |         |       |  5:27 |  10.1 |
| Move =enabled= and =overwrite= into =enablement_properties= |         |       |  0:19 |   0.6 |
| Analysis on a formatables refactor                          |         |       |  0:31 |   1.0 |
| Tracing of orchestration chains is incorrect                |         |       |  1:00 |   1.9 |
| Presentation for APA                                        |         |       |  5:11 |   9.6 |
| Issues with emacs                                           |         |       |  1:09 |   2.1 |
| Rename =name= to =codec= name                               |         |       |  0:20 |   0.6 |
| Add full and relative path processing to PM                 |         |       |  2:27 |   4.5 |
| Create a factory transform for parts and archetype kinds    |         |       |  5:30 |  10.2 |
| Create a video series on the formatables refactor           |         |       |  0:37 |   1.1 |
| Move C++ locator into physical model                        |         |       | 22:39 |  42.0 |
