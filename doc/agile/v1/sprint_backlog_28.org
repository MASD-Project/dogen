...
#+CAPTION: Clock summary at [2020-10-31 Sat 16:31]
| <75>                                                        |         |       |       |       |
| Headline                                                    | Time    |       |       |     % |
|-------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                | *75:49* |       |       | 100.0 |
|-------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                     | 75:49   |       |       | 100.0 |
| Active                                                      |         | 75:49 |       | 100.0 |
| edit release notes for previous sprint                      |         |       |  3:44 |   4.9 |
| Create a demo and presentation for previous sprint          |         |       |  0:39 |   0.9 |
| Sprint and product backlog grooming                         |         |       |  4:23 |   5.8 |
| Directory names and postfixes are PMM properties            |         |       |  5:27 |   7.2 |
...
| Presentation for APA                                        |         |       |  5:11 |   6.8 |
| Move C++ locator into physical model                        |         |       | 40:15 |  53.1 |
| Create a video series on the formatables refactor           |         |       |  0:37 |   0.8 |
| Add full and relative path processing to PM                 |         |       |  2:27 |   3.2 |
| Create a factory transform for parts and archetype kinds    |         |       |  5:30 |   7.3 |
| Issues with emacs                                           |         |       |  1:09 |   1.5 |
| Rename =name= to =codec= name                               |         |       |  0:20 |   0.4 |
| Move stand-alone formatables to physical/logical models     |         |       |  4:17 |   5.6 |
