...
#+CAPTION: Clock summary at [2020-09-25 Fri 11:59]
| <75>                                               |        |      |      |       |
| Headline                                           | Time   |      |      |     % |
|----------------------------------------------------+--------+------+------+-------|
| *Total time*                                       | *8:42* |      |      | 100.0 |
|----------------------------------------------------+--------+------+------+-------|
| Stories                                            | 8:42   |      |      | 100.0 |
| Active                                             |        | 8:42 |      | 100.0 |
| edit release notes for previous sprint             |        |      | 3:44 |  42.9 |
| Create a demo and presentation for previous sprint |        |      | 0:39 |   7.5 |
| Sprint and product backlog grooming                |        |      | 1:11 |  13.6 |
| Rename =name= to =codec= name                      |        |      | 0:20 |   3.8 |
| Directory names and postfixes are PMM properties   |        |      | 2:14 |  25.7 |
| Add full and relative path processing to PM        |        |      | 0:34 |   6.5 |
...
*** STARTED Directory names and postfixes are PMM properties          :story:
    :LOGBOOK:
