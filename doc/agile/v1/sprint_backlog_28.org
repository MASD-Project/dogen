...
#+CAPTION: Clock summary at [2020-10-25 Sun 12:56]
| <75>                                                        |         |       |       |       |
| Headline                                                    | Time    |       |       |     % |
|-------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                | *59:45* |       |       | 100.0 |
|-------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                     | 59:45   |       |       | 100.0 |
| Active                                                      |         | 59:45 |       | 100.0 |
| edit release notes for previous sprint                      |         |       |  3:44 |   6.2 |
| Create a demo and presentation for previous sprint          |         |       |  0:39 |   1.1 |
| Sprint and product backlog grooming                         |         |       |  4:23 |   7.3 |
| Directory names and postfixes are PMM properties            |         |       |  5:27 |   9.1 |
...
| Presentation for APA                                        |         |       |  5:11 |   8.7 |
| Issues with emacs                                           |         |       |  1:09 |   1.9 |
| Rename =name= to =codec= name                               |         |       |  0:20 |   0.6 |
| Add full and relative path processing to PM                 |         |       |  2:27 |   4.1 |
| Create a factory transform for parts and archetype kinds    |         |       |  5:30 |   9.2 |
| Create a video series on the formatables refactor           |         |       |  0:37 |   1.0 |
| Move C++ locator into physical model                        |         |       | 28:28 |  47.6 |
