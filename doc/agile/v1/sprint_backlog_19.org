...
#+CAPTION: Clock summary at [2019-11-06 Wed 23:58]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *63:43* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 63:43   |       |       | 100.0 |
| Active                                                    |         | 63:43 |       | 100.0 |
| Edit release notes for previous sprint                    |         |       |  3:36 |   5.7 |
| Create a demo and presentation for previous sprint        |         |       |  1:39 |   2.6 |
| Time spent producing coding videos                        |         |       |  0:53 |   1.4 |
| Sprint and product backlog grooming                       |         |       |  5:06 |   8.0 |
| Remove test model sanitizer                               |         |       |  0:20 |   0.5 |
| Remove master headers                                     |         |       |  1:12 |   1.9 |
| Fix the issues with tests in reference model              |         |       |  3:53 |   6.1 |
| Update static strings to string views                     |         |       |  1:15 |   2.0 |
| ODB include directories is incorrect                      |         |       |  1:43 |   2.7 |
| Create a "modeling" report                                |         |       |  4:56 |   7.7 |
...
| Creating reference cycles produces strange errors         |         |       |  5:32 |   8.7 |
| Error on duplicate references                             |         |       |  0:26 |   0.7 |
| Generate model dependency graph                           |         |       |  1:55 |   3.0 |
| Make the building of the relational model conditional     |         |       |  0:23 |   0.6 |
| Make all transform contexts code-generated                |         |       |  0:08 |   0.2 |
| Move registrar into assets                                |         |       |  5:29 |   8.6 |
| Fix compilation errors in nightly                         |         |       |  0:24 |   0.6 |
| Upgrade to boost 1.70                                     |         |       | 10:00 |  15.7 |
| Setup laptop to work on dogen                             |         |       |  0:45 |   1.2 |
| Org-mode as a carrier format for modeling                 |         |       |  5:37 |   8.8 |
| Add relational tracing support                            |         |       |  4:48 |   7.5 |
| Consider creating a test build for all facets             |         |       |  2:18 |   3.6 |
