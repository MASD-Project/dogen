...
#+CAPTION: Clock summary at [2019-06-03 Mon 18:48]
| <75>                                               |        |      |      |       |
| Headline                                           | Time   |      |      |     % |
|----------------------------------------------------+--------+------+------+-------|
| *Total time*                                       | *6:49* |      |      | 100.0 |
|----------------------------------------------------+--------+------+------+-------|
| Stories                                            | 6:49   |      |      | 100.0 |
| Active                                             |        | 6:49 |      | 100.0 |
| Edit release notes for previous sprint             |        |      | 3:36 |  52.8 |
| Create a demo and presentation for previous sprint |        |      | 1:39 |  24.2 |
| Sprint and product backlog grooming                |        |      | 0:24 |   5.9 |
| Remove test model sanitizer                        |        |      | 0:20 |   4.9 |
| Remove master headers                              |        |      | 0:50 |  12.2 |
...
*** STARTED Remove master headers                                     :story:
    :LOGBOOK:
