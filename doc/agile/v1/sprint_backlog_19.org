...
#+CAPTION: Clock summary at [2019-11-05 Tue 22:17]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *60:05* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 60:05   |       |       | 100.0 |
| Active                                                    |         | 60:05 |       | 100.0 |
...
| Sprint and product backlog grooming                       |         |       |  4:23 |   7.3 |
| Remove test model sanitizer                               |         |       |  0:20 |   0.6 |
| Remove master headers                                     |         |       |  1:12 |   2.0 |
| Fix the issues with tests in reference model              |         |       |  3:53 |   6.5 |
| Update static strings to string views                     |         |       |  1:15 |   2.1 |
| ODB include directories is incorrect                      |         |       |  1:43 |   2.9 |
...
| Upgrade to boost 1.70                                     |         |       | 10:00 |  16.6 |
| Setup laptop to work on dogen                             |         |       |  0:45 |   1.2 |
| Org-mode as a carrier format for modeling                 |         |       |  5:37 |   9.3 |
| Add relational tracing support                            |         |       |  4:48 |   8.0 |
| Make the building of the relational model conditional     |         |       |  0:17 |   0.5 |
...
*** STARTED Make the building of the relational model conditional     :story:
    :LOGBOOK:
