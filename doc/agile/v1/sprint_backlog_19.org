...
#+CAPTION: Clock summary at [2019-10-26 Sat 18:24]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *45:05* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 45:05   |       |       | 100.0 |
| Active                                                    |         | 45:05 |       | 100.0 |
| Edit release notes for previous sprint                    |         |       |  3:36 |   8.0 |
| Create a demo and presentation for previous sprint        |         |       |  1:39 |   3.7 |
| Sprint and product backlog grooming                       |         |       |  3:06 |   6.9 |
| Remove test model sanitizer                               |         |       |  0:20 |   0.7 |
| Remove master headers                                     |         |       |  1:12 |   2.7 |
| Fix the issues with tests in reference model              |         |       |  3:53 |   8.6 |
| Update static strings to string views                     |         |       |  1:15 |   2.8 |
| ODB include directories is incorrect                      |         |       |  1:43 |   3.8 |
| Create a "modeling" report                                |         |       |  4:56 |  10.9 |
| Move visual studio related options to top profile         |         |       |  0:17 |   0.6 |
| Move registrar into assets                                |         |       |  5:29 |  12.2 |
| Fix compilation errors in nightly                         |         |       |  0:24 |   0.9 |
| Upgrade to boost 1.70                                     |         |       | 10:00 |  22.2 |
| Setup laptop to work on dogen                             |         |       |  0:17 |   0.6 |
| Org-mode as a carrier format for modeling                 |         |       |  5:37 |  12.5 |
| Try to add relational tracing support                     |         |       |  0:58 |   2.1 |
| Fix incorrect message keyword when detecting ODB includes |         |       |  0:23 |   0.9 |
