...
#+CAPTION: Clock summary at [2019-11-05 Tue 22:42]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *60:28* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 60:28   |       |       | 100.0 |
| Active                                                    |         | 60:28 |       | 100.0 |
| Edit release notes for previous sprint                    |         |       |  3:36 |   6.0 |
| Create a demo and presentation for previous sprint        |         |       |  1:39 |   2.7 |
| Time spent producing coding videos                        |         |       |  0:30 |   0.8 |
| Sprint and product backlog grooming                       |         |       |  4:40 |   7.7 |
| Remove test model sanitizer                               |         |       |  0:20 |   0.6 |
| Remove master headers                                     |         |       |  1:12 |   2.0 |
| Fix the issues with tests in reference model              |         |       |  3:53 |   6.4 |
| Update static strings to string views                     |         |       |  1:15 |   2.1 |
| ODB include directories is incorrect                      |         |       |  1:43 |   2.8 |
| Create a "modeling" report                                |         |       |  4:56 |   8.2 |
...
| Creating reference cycles produces strange errors         |         |       |  5:32 |   9.2 |
| Error on duplicate references                             |         |       |  0:26 |   0.7 |
| Generate model dependency graph                           |         |       |  1:55 |   3.2 |
| Make the building of the relational model conditional     |         |       |  0:23 |   0.6 |
| Move registrar into assets                                |         |       |  5:29 |   9.1 |
| Fix compilation errors in nightly                         |         |       |  0:24 |   0.7 |
| Upgrade to boost 1.70                                     |         |       | 10:00 |  16.5 |
| Setup laptop to work on dogen                             |         |       |  0:45 |   1.2 |
| Org-mode as a carrier format for modeling                 |         |       |  5:37 |   9.3 |
| Add relational tracing support                            |         |       |  4:48 |   7.9 |
