...
#+CAPTION: Clock summary at [2019-11-12 Tue 19:55]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *73:23* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 73:23   |       |       | 100.0 |
| Active                                                    |         | 73:23 |       | 100.0 |
| Edit release notes for previous sprint                    |         |       |  3:36 |   4.9 |
| Create a demo and presentation for previous sprint        |         |       |  1:39 |   2.2 |
| Time spent producing coding videos                        |         |       |  1:52 |   2.5 |
| Sprint and product backlog grooming                       |         |       |  5:40 |   7.7 |
| Remove test model sanitizer                               |         |       |  0:20 |   0.5 |
| Remove master headers                                     |         |       |  1:12 |   1.6 |
| Fix the issues with tests in reference model              |         |       |  3:53 |   5.3 |
| Update static strings to string views                     |         |       |  1:15 |   1.7 |
| ODB include directories is incorrect                      |         |       |  1:43 |   2.3 |
| Create a "modeling" report                                |         |       |  4:56 |   6.7 |
...
| Creating reference cycles produces strange errors         |         |       |  5:32 |   7.5 |
...
| Add support for meta-data overrides in Dogen              |         |       |  5:16 |   7.2 |
| Time spent fixing emacs issues                            |         |       |  1:44 |   2.4 |
| Move registrar into assets                                |         |       |  5:29 |   7.5 |
| Upgrade to boost 1.70                                     |         |       | 10:00 |  13.6 |
| Setup laptop to work on dogen                             |         |       |  0:45 |   1.0 |
| Org-mode as a carrier format for modeling                 |         |       |  5:37 |   7.7 |
| Add relational tracing support                            |         |       |  6:52 |   9.4 |
| Split generated tests from manual tests                   |         |       |  0:55 |   1.2 |
