...
#+CAPTION: Clock summary at [2019-11-08 Fri 00:02]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *68:33* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 68:33   |       |       | 100.0 |
| Active                                                    |         | 68:33 |       | 100.0 |
| Edit release notes for previous sprint                    |         |       |  3:36 |   5.3 |
| Create a demo and presentation for previous sprint        |         |       |  1:39 |   2.4 |
| Time spent producing coding videos                        |         |       |  0:53 |   1.3 |
| Sprint and product backlog grooming                       |         |       |  5:06 |   7.4 |
| Remove test model sanitizer                               |         |       |  0:20 |   0.5 |
| Remove master headers                                     |         |       |  1:12 |   1.8 |
| Fix the issues with tests in reference model              |         |       |  3:53 |   5.7 |
| Update static strings to string views                     |         |       |  1:15 |   1.8 |
| ODB include directories is incorrect                      |         |       |  1:43 |   2.5 |
| Create a "modeling" report                                |         |       |  4:56 |   7.2 |
...
| Meta-data keys are in the inverse order                   |         |       |  0:39 |   0.9 |
| Creating reference cycles produces strange errors         |         |       |  5:32 |   8.1 |
| Error on duplicate references                             |         |       |  0:26 |   0.6 |
| Generate model dependency graph                           |         |       |  1:55 |   2.8 |
| Make the building of the relational model conditional     |         |       |  0:23 |   0.6 |
| Make all transform contexts code-generated                |         |       |  0:08 |   0.2 |
| Fix issue with smartparens                                |         |       |  1:19 |   1.9 |
| Move registrar into assets                                |         |       |  5:29 |   8.0 |
| Fix compilation errors in nightly                         |         |       |  0:24 |   0.6 |
| Upgrade to boost 1.70                                     |         |       | 10:00 |  14.6 |
| Setup laptop to work on dogen                             |         |       |  0:45 |   1.1 |
| Org-mode as a carrier format for modeling                 |         |       |  5:37 |   8.2 |
| Add relational tracing support                            |         |       |  6:52 |  10.0 |
| Consider creating a test build for all facets             |         |       |  3:45 |   5.5 |
...
*** COMPLETED Fix issue with smartparens                              :story:
    CLOSED: [2019-11-07 Thu 22:34]
    :LOGBOOK:
    CLOCK: [2019-11-07 Thu 21:15]--[2019-11-07 Thu 22:34] =>  1:19
    :END:

For some random reason emacs on our desktop PC is behaving very
strangely. It seems that the problems stem from smartparens. Try to
disable this in prelude.
...
*** Tracer numbering of dumped models is incorrect                    :story:
