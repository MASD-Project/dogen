...
#+CAPTION: Clock summary at [2019-10-28 Mon 19:10]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *48:16* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 48:16   |       |       | 100.0 |
| Active                                                    |         | 48:16 |       | 100.0 |
| Edit release notes for previous sprint                    |         |       |  3:36 |   7.5 |
| Create a demo and presentation for previous sprint        |         |       |  1:39 |   3.4 |
| Sprint and product backlog grooming                       |         |       |  3:30 |   7.3 |
| Remove test model sanitizer                               |         |       |  0:20 |   0.7 |
| Remove master headers                                     |         |       |  1:12 |   2.5 |
| Fix the issues with tests in reference model              |         |       |  3:53 |   8.0 |
| Update static strings to string views                     |         |       |  1:15 |   2.6 |
| ODB include directories is incorrect                      |         |       |  1:43 |   3.6 |
| Create a "modeling" report                                |         |       |  4:56 |  10.2 |
...
| Move registrar into assets                                |         |       |  5:29 |  11.4 |
| Fix compilation errors in nightly                         |         |       |  0:24 |   0.8 |
| Upgrade to boost 1.70                                     |         |       | 10:00 |  20.7 |
| Setup laptop to work on dogen                             |         |       |  0:45 |   1.6 |
| Org-mode as a carrier format for modeling                 |         |       |  5:37 |  11.6 |
| Add relational tracing support                            |         |       |  3:11 |   6.6 |
