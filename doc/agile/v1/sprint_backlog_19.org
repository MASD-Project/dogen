...
#+CAPTION: Clock summary at [2019-11-08 Fri 16:01]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *72:28* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 72:28   |       |       | 100.0 |
| Active                                                    |         | 72:28 |       | 100.0 |
| Edit release notes for previous sprint                    |         |       |  3:36 |   5.0 |
| Create a demo and presentation for previous sprint        |         |       |  1:39 |   2.3 |
| Time spent producing coding videos                        |         |       |  1:52 |   2.6 |
| Sprint and product backlog grooming                       |         |       |  5:40 |   7.8 |
| Remove test model sanitizer                               |         |       |  0:20 |   0.5 |
| Remove master headers                                     |         |       |  1:12 |   1.7 |
| Fix the issues with tests in reference model              |         |       |  3:53 |   5.4 |
| Update static strings to string views                     |         |       |  1:15 |   1.7 |
| ODB include directories is incorrect                      |         |       |  1:43 |   2.4 |
| Create a "modeling" report                                |         |       |  4:56 |   6.8 |
...
| Creating reference cycles produces strange errors         |         |       |  5:32 |   7.6 |
| Error on duplicate references                             |         |       |  0:26 |   0.6 |
| Generate model dependency graph                           |         |       |  1:55 |   2.6 |
...
| Fix compilation errors in c++ impl nightly                |         |       |  0:24 |   0.6 |
| Add support for meta-data overrides in Dogen              |         |       |  5:16 |   7.3 |
| Time spent fixing emacs issues                            |         |       |  1:44 |   2.4 |
| Move registrar into assets                                |         |       |  5:29 |   7.6 |
| Upgrade to boost 1.70                                     |         |       | 10:00 |  13.8 |
| Setup laptop to work on dogen                             |         |       |  0:45 |   1.0 |
| Org-mode as a carrier format for modeling                 |         |       |  5:37 |   7.8 |
| Add relational tracing support                            |         |       |  6:52 |   9.5 |
...
*** Split generated tests from manual tests                           :story:
...
*** CANCELLED Create a "tests" stereotype with profiles               :story:
    CLOSED: [2019-11-08 Fri 15:37]
