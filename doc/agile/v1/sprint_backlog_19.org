...
#+CAPTION: Clock summary at [2019-11-15 Fri 16:26]
| <75>                                                       |         |       |       |       |
| Headline                                                   | Time    |       |       |     % |
|------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                               | *82:51* |       |       | 100.0 |
|------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                    | 82:51   |       |       | 100.0 |
| Active                                                     |         | 82:51 |       | 100.0 |
| Edit release notes for previous sprint                     |         |       |  3:36 |   4.3 |
| Create a demo and presentation for previous sprint         |         |       |  1:39 |   2.0 |
| Time spent producing coding videos                         |         |       |  2:27 |   3.0 |
| Sprint and product backlog grooming                        |         |       |  6:09 |   7.4 |
| Remove test model sanitizer                                |         |       |  0:20 |   0.4 |
| Remove master headers                                      |         |       |  1:12 |   1.4 |
| Fix the issues with tests in reference model               |         |       |  3:53 |   4.7 |
...
| Creating reference cycles produces strange errors          |         |       |  5:32 |   6.7 |
...
| Add support for meta-data overrides in Dogen               |         |       |  5:16 |   6.4 |
...
| Split generated tests from manual tests                    |         |       |  5:51 |   7.1 |
...
| Move registrar into assets                                 |         |       |  5:29 |   6.6 |
| Upgrade to boost 1.70                                      |         |       | 10:00 |  12.1 |
| Setup laptop to work on dogen                              |         |       |  0:45 |   0.9 |
| Org-mode as a carrier format for modeling                  |         |       |  5:37 |   6.8 |
| Add relational tracing support                             |         |       |  6:52 |   8.3 |
| Consider creating a test build for all facets              |         |       |  0:52 |   1.0 |
| Code coverage has not been updated since September         |         |       |  1:04 |   1.3 |
