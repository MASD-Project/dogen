...
#+CAPTION: Clock summary at [2019-06-03 Mon 12:59]
| <75>                                               |        |      |      |       |
| Headline                                           | Time   |      |      |     % |
|----------------------------------------------------+--------+------+------+-------|
| *Total time*                                       | *5:10* |      |      | 100.0 |
|----------------------------------------------------+--------+------+------+-------|
| Stories                                            | 5:10   |      |      | 100.0 |
| Active                                             |        | 5:10 |      | 100.0 |
| Edit release notes for previous sprint             |        |      | 3:07 |  60.3 |
| Create a demo and presentation for previous sprint |        |      | 1:39 |  31.9 |
| Sprint and product backlog grooming                |        |      | 0:24 |   7.7 |
...
*** Remove test model sanitizer                                       :story:
