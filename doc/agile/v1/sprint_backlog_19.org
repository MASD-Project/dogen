...
#+CAPTION: Clock summary at [2019-11-15 Fri 11:24]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                   | 79:55   |       |       | 100.0 |
| Active                                                    |         | 79:55 |       | 100.0 |
| Edit release notes for previous sprint                    |         |       |  3:36 |   4.5 |
| Create a demo and presentation for previous sprint        |         |       |  1:39 |   2.1 |
| Time spent producing coding videos                        |         |       |  2:22 |   3.0 |
| Sprint and product backlog grooming                       |         |       |  6:09 |   7.7 |
| Remove test model sanitizer                               |         |       |  0:20 |   0.4 |
| Remove master headers                                     |         |       |  1:12 |   1.5 |
| Fix the issues with tests in reference model              |         |       |  3:53 |   4.9 |
| Update static strings to string views                     |         |       |  1:15 |   1.6 |
| ODB include directories is incorrect                      |         |       |  1:43 |   2.1 |
| Create a "modeling" report                                |         |       |  4:56 |   6.2 |
...
| Creating reference cycles produces strange errors         |         |       |  5:32 |   6.9 |
...
| Add support for meta-data overrides in Dogen              |         |       |  5:16 |   6.6 |
| Some model names are too long for windows                 |         |       |  0:28 |   0.6 |
| Fake type in injection.json model                         |         |       |  0:09 |   0.2 |
| Time spent fixing emacs issues                            |         |       |  1:44 |   2.2 |
| Move registrar into assets                                |         |       |  5:29 |   6.9 |
| Upgrade to boost 1.70                                     |         |       | 10:00 |  12.5 |
| Setup laptop to work on dogen                             |         |       |  0:45 |   0.9 |
| Org-mode as a carrier format for modeling                 |         |       |  5:37 |   7.0 |
| Add relational tracing support                            |         |       |  6:52 |   8.6 |
| Split generated tests from manual tests                   |         |       |  5:51 |   7.3 |
...
*** Add conditional logic for the inclusion of generated tests        :story:
