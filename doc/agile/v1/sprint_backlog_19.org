...
#+CAPTION: Clock summary at [2019-11-05 Tue 08:32]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *58:17* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 58:17   |       |       | 100.0 |
| Active                                                    |         | 58:17 |       | 100.0 |
| Edit release notes for previous sprint                    |         |       |  3:36 |   6.2 |
| Create a demo and presentation for previous sprint        |         |       |  1:39 |   2.8 |
| Sprint and product backlog grooming                       |         |       |  4:23 |   7.5 |
| Remove test model sanitizer                               |         |       |  0:20 |   0.6 |
| Remove master headers                                     |         |       |  1:12 |   2.1 |
| Fix the issues with tests in reference model              |         |       |  3:53 |   6.7 |
| Update static strings to string views                     |         |       |  1:15 |   2.1 |
| ODB include directories is incorrect                      |         |       |  1:43 |   2.9 |
| Create a "modeling" report                                |         |       |  4:56 |   8.5 |
...
| Creating reference cycles produces strange errors         |         |       |  5:32 |   9.5 |
| Error on duplicate references                             |         |       |  0:26 |   0.7 |
| Move registrar into assets                                |         |       |  5:29 |   9.4 |
| Fix compilation errors in nightly                         |         |       |  0:24 |   0.7 |
| Upgrade to boost 1.70                                     |         |       | 10:00 |  17.2 |
| Setup laptop to work on dogen                             |         |       |  0:45 |   1.3 |
| Org-mode as a carrier format for modeling                 |         |       |  5:37 |   9.6 |
| Add relational tracing support                            |         |       |  4:48 |   8.2 |
| Generate model dependency graph                           |         |       |  0:54 |   1.5 |
...
*** STARTED Generate model dependency graph                           :story:
    :LOGBOOK:
