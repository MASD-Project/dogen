...
#+CAPTION: Clock summary at [2019-11-05 Tue 18:30]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                   | 59:18   |       |       | 100.0 |
| Active                                                    |         | 59:18 |       | 100.0 |
| Edit release notes for previous sprint                    |         |       |  3:36 |   6.1 |
| Create a demo and presentation for previous sprint        |         |       |  1:39 |   2.8 |
| Sprint and product backlog grooming                       |         |       |  4:23 |   7.4 |
...
| Create a "modeling" report                                |         |       |  4:56 |   8.3 |
...
| Creating reference cycles produces strange errors         |         |       |  5:32 |   9.3 |
| Error on duplicate references                             |         |       |  0:26 |   0.7 |
| Generate model dependency graph                           |         |       |  1:55 |   3.2 |
| Move registrar into assets                                |         |       |  5:29 |   9.2 |
| Fix compilation errors in nightly                         |         |       |  0:24 |   0.7 |
| Upgrade to boost 1.70                                     |         |       | 10:00 |  16.9 |
| Setup laptop to work on dogen                             |         |       |  0:45 |   1.3 |
| Org-mode as a carrier format for modeling                 |         |       |  5:37 |   9.5 |
| Add relational tracing support                            |         |       |  4:48 |   8.1 |
