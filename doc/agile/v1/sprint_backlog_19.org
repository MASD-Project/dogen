...
#+CAPTION: Clock summary at [2019-09-10 Tue 12:39]
| <75>                                               |         |       |      |       |
| Headline                                           | Time    |       |      |     % |
|----------------------------------------------------+---------+-------+------+-------|
| *Total time*                                       | *31:44* |       |      | 100.0 |
|----------------------------------------------------+---------+-------+------+-------|
| Stories                                            | 31:44   |       |      | 100.0 |
| Active                                             |         | 31:44 |      | 100.0 |
| Edit release notes for previous sprint             |         |       | 3:36 |  11.3 |
| Create a demo and presentation for previous sprint |         |       | 1:39 |   5.2 |
| Sprint and product backlog grooming                |         |       | 2:30 |   7.9 |
| Remove test model sanitizer                        |         |       | 0:20 |   1.1 |
| Remove master headers                              |         |       | 1:12 |   3.8 |
| Fix the issues with tests in reference model       |         |       | 3:53 |  12.2 |
| Update static strings to string views              |         |       | 1:15 |   3.9 |
| Move registrar into assets                         |         |       | 5:06 |  16.1 |
| Fix compilation errors in nightly                  |         |       | 0:24 |   1.3 |
| Upgrade to boost 1.70                              |         |       | 6:12 |  19.5 |
| Org-mode as a carrier format for modeling          |         |       | 5:37 |  17.7 |
