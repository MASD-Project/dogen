...
#+CAPTION: Clock summary at [2019-11-15 Fri 15:09]
| <75>                                                       |         |       |       |       |
| Headline                                                   | Time    |       |       |     % |
|------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                               | *81:37* |       |       | 100.0 |
|------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                    | 81:37   |       |       | 100.0 |
| Active                                                     |         | 81:37 |       | 100.0 |
| Edit release notes for previous sprint                     |         |       |  3:36 |   4.4 |
| Create a demo and presentation for previous sprint         |         |       |  1:39 |   2.0 |
| Time spent producing coding videos                         |         |       |  2:22 |   2.9 |
| Sprint and product backlog grooming                        |         |       |  6:09 |   7.5 |
| Remove test model sanitizer                                |         |       |  0:20 |   0.4 |
| Remove master headers                                      |         |       |  1:12 |   1.5 |
| Fix the issues with tests in reference model               |         |       |  3:53 |   4.8 |
| Update static strings to string views                      |         |       |  1:15 |   1.5 |
| ODB include directories is incorrect                       |         |       |  1:43 |   2.1 |
| Create a "modeling" report                                 |         |       |  4:56 |   6.0 |
...
| Creating reference cycles produces strange errors          |         |       |  5:32 |   6.8 |
...
| Add support for meta-data overrides in Dogen               |         |       |  5:16 |   6.5 |
...
| Split generated tests from manual tests                    |         |       |  5:51 |   7.2 |
| Use clang9 and GCC 9 in nightly and CI                     |         |       |  0:01 |   0.0 |
| Time spent fixing emacs issues                             |         |       |  1:44 |   2.1 |
| Move registrar into assets                                 |         |       |  5:29 |   6.7 |
| Upgrade to boost 1.70                                      |         |       | 10:00 |  12.3 |
| Setup laptop to work on dogen                              |         |       |  0:45 |   0.9 |
| Org-mode as a carrier format for modeling                  |         |       |  5:37 |   6.9 |
| Add relational tracing support                             |         |       |  6:52 |   8.4 |
| Consider creating a test build for all facets              |         |       |  0:52 |   1.1 |
| Code coverage has not been updated since September         |         |       |  0:33 |   0.7 |
...
*** STARTED Code coverage has not been updated since September        :story:
    :LOGBOOK:
...
*** Serialisation forward declarations are cyclical                   :story:
