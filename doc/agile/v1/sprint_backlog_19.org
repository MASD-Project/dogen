...
#+CAPTION: Clock summary at [2019-11-12 Tue 22:39]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
...
| Creating reference cycles produces strange errors         |         |       |  5:32 |   7.4 |
...
| Add support for meta-data overrides in Dogen              |         |       |  5:16 |   7.0 |
| Time spent fixing emacs issues                            |         |       |  1:44 |   2.3 |
| Move registrar into assets                                |         |       |  5:29 |   7.3 |
| Upgrade to boost 1.70                                     |         |       | 10:00 |  13.3 |
| Setup laptop to work on dogen                             |         |       |  0:45 |   1.0 |
| Org-mode as a carrier format for modeling                 |         |       |  5:37 |   7.5 |
| Add relational tracing support                            |         |       |  6:52 |   9.2 |
| Split generated tests from manual tests                   |         |       |  2:11 |   2.9 |
