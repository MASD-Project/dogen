...
#+CAPTION: Clock summary at [2019-10-27 Sun 12:56]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *46:29* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 46:29   |       |       | 100.0 |
| Active                                                    |         | 46:29 |       | 100.0 |
| Edit release notes for previous sprint                    |         |       |  3:36 |   7.7 |
| Create a demo and presentation for previous sprint        |         |       |  1:39 |   3.5 |
| Sprint and product backlog grooming                       |         |       |  3:21 |   7.2 |
| Remove test model sanitizer                               |         |       |  0:20 |   0.7 |
| Remove master headers                                     |         |       |  1:12 |   2.6 |
| Fix the issues with tests in reference model              |         |       |  3:53 |   8.4 |
| Update static strings to string views                     |         |       |  1:15 |   2.7 |
| ODB include directories is incorrect                      |         |       |  1:43 |   3.7 |
| Create a "modeling" report                                |         |       |  4:56 |  10.6 |
| Move visual studio related options to top profile         |         |       |  0:17 |   0.6 |
| Move registrar into assets                                |         |       |  5:29 |  11.8 |
| Fix compilation errors in nightly                         |         |       |  0:24 |   0.9 |
| Upgrade to boost 1.70                                     |         |       | 10:00 |  21.5 |
| Setup laptop to work on dogen                             |         |       |  0:17 |   0.6 |
| Org-mode as a carrier format for modeling                 |         |       |  5:37 |  12.1 |
| Try to add relational tracing support                     |         |       |  2:07 |   4.6 |
| Fix incorrect message keyword when detecting ODB includes |         |       |  0:23 |   0.8 |
...
*** STARTED Try to add relational tracing support                     :story:
    :LOGBOOK:
...
*** STARTED Fix incorrect message keyword when detecting ODB includes :story:
    :LOGBOOK:
