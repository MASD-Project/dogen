...
| Creating reference cycles produces strange errors         |         |       |  5:32 |   8.9 |
...
| Move registrar into assets                                |         |       |  5:29 |   8.8 |
| Fix compilation errors in nightly                         |         |       |  0:24 |   0.6 |
| Upgrade to boost 1.70                                     |         |       | 10:00 |  16.1 |
| Setup laptop to work on dogen                             |         |       |  0:45 |   1.2 |
| Org-mode as a carrier format for modeling                 |         |       |  5:37 |   9.0 |
| Add relational tracing support                            |         |       |  4:48 |   7.7 |
| Consider creating a test build for all facets             |         |       |  0:45 |   1.2 |
