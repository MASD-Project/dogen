...
#+CAPTION: Clock summary at [2019-10-24 Thu 18:13]
| <75>                                               |         |       |       |       |
| Headline                                           | Time    |       |       |     % |
|----------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                       | *38:36* |       |       | 100.0 |
|----------------------------------------------------+---------+-------+-------+-------|
| Stories                                            | 38:36   |       |       | 100.0 |
| Active                                             |         | 38:36 |       | 100.0 |
| Edit release notes for previous sprint             |         |       |  3:36 |   9.3 |
| Create a demo and presentation for previous sprint |         |       |  1:39 |   4.3 |
| Sprint and product backlog grooming                |         |       |  2:35 |   6.7 |
| Remove test model sanitizer                        |         |       |  0:20 |   0.9 |
| Remove master headers                              |         |       |  1:12 |   3.1 |
| Fix the issues with tests in reference model       |         |       |  3:53 |  10.1 |
| Update static strings to string views              |         |       |  1:15 |   3.2 |
| ODB include directories is incorrect               |         |       |  1:43 |   4.4 |
| Move registrar into assets                         |         |       |  5:29 |  14.2 |
| Fix compilation errors in nightly                  |         |       |  0:24 |   1.0 |
| Upgrade to boost 1.70                              |         |       | 10:00 |  25.9 |
| Setup laptop to work on dogen                      |         |       |  0:17 |   0.7 |
| Org-mode as a carrier format for modeling          |         |       |  5:37 |  14.6 |
| Create a "modeling" report                         |         |       |  0:36 |   1.6 |
...
*** STARTED Create a "modeling" report                                :story:
    :LOGBOOK:
