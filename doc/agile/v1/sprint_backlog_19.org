...
#+CAPTION: Clock summary at [2019-11-06 Wed 22:57]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *62:46* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 62:46   |       |       | 100.0 |
| Active                                                    |         | 62:46 |       | 100.0 |
...
| Sprint and product backlog grooming                       |         |       |  5:06 |   8.1 |
...
| Creating reference cycles produces strange errors         |         |       |  5:32 |   8.8 |
...
| Move registrar into assets                                |         |       |  5:29 |   8.7 |
| Fix compilation errors in nightly                         |         |       |  0:24 |   0.6 |
| Upgrade to boost 1.70                                     |         |       | 10:00 |  15.9 |
| Setup laptop to work on dogen                             |         |       |  0:45 |   1.2 |
| Org-mode as a carrier format for modeling                 |         |       |  5:37 |   8.9 |
| Add relational tracing support                            |         |       |  4:48 |   7.6 |
| Consider creating a test build for all facets             |         |       |  1:21 |   2.2 |
