...
#+CAPTION: Clock summary at [2019-10-26 Sat 16:41]
| <75>                                               |         |       |       |       |
| Headline                                           | Time    |       |       |     % |
|----------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                       | *44:07* |       |       | 100.0 |
|----------------------------------------------------+---------+-------+-------+-------|
| Stories                                            | 44:07   |       |       | 100.0 |
| Active                                             |         | 44:07 |       | 100.0 |
| Edit release notes for previous sprint             |         |       |  3:36 |   8.2 |
...
| Fix the issues with tests in reference model       |         |       |  3:53 |   8.8 |
| Update static strings to string views              |         |       |  1:15 |   2.8 |
| ODB include directories is incorrect               |         |       |  1:43 |   3.9 |
| Create a "modeling" report                         |         |       |  4:56 |  11.2 |
| Move registrar into assets                         |         |       |  5:29 |  12.4 |
| Fix compilation errors in nightly                  |         |       |  0:24 |   0.9 |
| Upgrade to boost 1.70                              |         |       | 10:00 |  22.7 |
