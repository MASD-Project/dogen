...
#+CAPTION: Clock summary at [2019-07-14 Sun 16:33]
| <75>                                               |         |       |      |       |
| Headline                                           | Time    |       |      |     % |
|----------------------------------------------------+---------+-------+------+-------|
| *Total time*                                       | *26:21* |       |      | 100.0 |
|----------------------------------------------------+---------+-------+------+-------|
| Stories                                            | 26:21   |       |      | 100.0 |
| Active                                             |         | 26:21 |      | 100.0 |
| Edit release notes for previous sprint             |         |       | 3:36 |  13.7 |
| Create a demo and presentation for previous sprint |         |       | 1:39 |   6.3 |
| Sprint and product backlog grooming                |         |       | 2:30 |   9.5 |
| Remove test model sanitizer                        |         |       | 0:20 |   1.3 |
| Remove master headers                              |         |       | 1:12 |   4.6 |
| Fix the issues with tests in reference model       |         |       | 3:53 |  14.7 |
| Move registrar into assets                         |         |       | 5:06 |  19.4 |
| Fix compilation errors in nightly                  |         |       | 0:24 |   1.5 |
| Upgrade to boost 1.70                              |         |       | 2:04 |   7.8 |
| Org-mode as a carrier format for modeling          |         |       | 5:37 |  21.3 |
...
*** STARTED Update static strings to string views                     :story:
    :LOGBOOK:
