...
#+CAPTION: Clock summary at [2019-06-11 Tue 12:20]
| <75>                                               |         |       |      |       |
| Headline                                           | Time    |       |      |     % |
|----------------------------------------------------+---------+-------+------+-------|
| *Total time*                                       | *16:38* |       |      | 100.0 |
|----------------------------------------------------+---------+-------+------+-------|
| Stories                                            | 16:38   |       |      | 100.0 |
| Active                                             |         | 16:38 |      | 100.0 |
| Edit release notes for previous sprint             |         |       | 3:36 |  21.6 |
| Create a demo and presentation for previous sprint |         |       | 1:39 |   9.9 |
| Sprint and product backlog grooming                |         |       | 2:30 |  15.0 |
| Remove test model sanitizer                        |         |       | 0:20 |   2.0 |
| Remove master headers                              |         |       | 1:12 |   7.2 |
| Move registrar into assets                         |         |       | 1:44 |  10.4 |
| Org-mode as a carrier format for modeling          |         |       | 5:37 |  33.8 |
...
- we need to keep track of all type registrars on referenced models,
  not on the referenced models themselves.
