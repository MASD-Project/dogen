...
#+CAPTION: Clock summary at [2019-11-06 Wed 08:06]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *61:17* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 61:17   |       |       | 100.0 |
| Active                                                    |         | 61:17 |       | 100.0 |
| Edit release notes for previous sprint                    |         |       |  3:36 |   5.9 |
| Create a demo and presentation for previous sprint        |         |       |  1:39 |   2.7 |
| Time spent producing coding videos                        |         |       |  0:53 |   1.4 |
| Sprint and product backlog grooming                       |         |       |  5:06 |   8.3 |
| Remove test model sanitizer                               |         |       |  0:20 |   0.5 |
| Remove master headers                                     |         |       |  1:12 |   2.0 |
| Fix the issues with tests in reference model              |         |       |  3:53 |   6.3 |
| Update static strings to string views                     |         |       |  1:15 |   2.0 |
| ODB include directories is incorrect                      |         |       |  1:43 |   2.8 |
| Create a "modeling" report                                |         |       |  4:56 |   8.1 |
...
| Creating reference cycles produces strange errors         |         |       |  5:32 |   9.0 |
| Error on duplicate references                             |         |       |  0:26 |   0.7 |
| Generate model dependency graph                           |         |       |  1:55 |   3.1 |
| Make the building of the relational model conditional     |         |       |  0:23 |   0.6 |
| Move registrar into assets                                |         |       |  5:29 |   8.9 |
| Fix compilation errors in nightly                         |         |       |  0:24 |   0.7 |
| Upgrade to boost 1.70                                     |         |       | 10:00 |  16.3 |
| Setup laptop to work on dogen                             |         |       |  0:45 |   1.2 |
| Org-mode as a carrier format for modeling                 |         |       |  5:37 |   9.2 |
| Add relational tracing support                            |         |       |  4:48 |   7.8 |
