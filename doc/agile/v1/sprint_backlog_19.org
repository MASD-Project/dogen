...
#+CAPTION: Clock summary at [2019-11-07 Thu 20:40]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
...
| Create a "modeling" report                                |         |       |  4:56 |   7.5 |
...
| Creating reference cycles produces strange errors         |         |       |  5:32 |   8.4 |
...
| Move registrar into assets                                |         |       |  5:29 |   8.3 |
| Fix compilation errors in nightly                         |         |       |  0:24 |   0.6 |
| Upgrade to boost 1.70                                     |         |       | 10:00 |  15.2 |
| Setup laptop to work on dogen                             |         |       |  0:45 |   1.1 |
| Org-mode as a carrier format for modeling                 |         |       |  5:37 |   8.5 |
| Add relational tracing support                            |         |       |  6:52 |  10.4 |
