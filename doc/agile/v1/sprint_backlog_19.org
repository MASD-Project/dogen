...
#+CAPTION: Clock summary at [2019-10-28 Mon 08:47]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
...
| Sprint and product backlog grooming                       |         |       |  3:21 |   7.1 |
| Remove test model sanitizer                               |         |       |  0:20 |   0.7 |
| Remove master headers                                     |         |       |  1:12 |   2.6 |
| Fix the issues with tests in reference model              |         |       |  3:53 |   8.3 |
| Update static strings to string views                     |         |       |  1:15 |   2.7 |
| ODB include directories is incorrect                      |         |       |  1:43 |   3.6 |
| Create a "modeling" report                                |         |       |  4:56 |  10.5 |
...
| Move registrar into assets                                |         |       |  5:29 |  11.7 |
| Fix compilation errors in nightly                         |         |       |  0:24 |   0.9 |
| Upgrade to boost 1.70                                     |         |       | 10:00 |  21.3 |
| Setup laptop to work on dogen                             |         |       |  0:45 |   1.6 |
| Org-mode as a carrier format for modeling                 |         |       |  5:37 |  11.9 |
| Try to add relational tracing support                     |         |       |  2:07 |   4.5 |
