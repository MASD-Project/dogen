...
#+CAPTION: Clock summary at [2019-11-04 Mon 23:40]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *57:32* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 57:32   |       |       | 100.0 |
| Active                                                    |         | 57:32 |       | 100.0 |
...
| Creating reference cycles produces strange errors         |         |       |  5:32 |   9.6 |
| Error on duplicate references                             |         |       |  0:26 |   0.8 |
| Move registrar into assets                                |         |       |  5:29 |   9.5 |
| Fix compilation errors in nightly                         |         |       |  0:24 |   0.7 |
| Upgrade to boost 1.70                                     |         |       | 10:00 |  17.4 |
| Setup laptop to work on dogen                             |         |       |  0:45 |   1.3 |
| Org-mode as a carrier format for modeling                 |         |       |  5:37 |   9.8 |
| Add relational tracing support                            |         |       |  4:48 |   8.3 |
| Generate model dependency graph                           |         |       |  0:09 |   0.3 |
