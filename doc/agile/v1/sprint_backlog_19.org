...
#+CAPTION: Clock summary at [2019-06-03 Mon 19:05]
| <75>                                               |        |      |      |       |
| Headline                                           | Time   |      |      |     % |
|----------------------------------------------------+--------+------+------+-------|
| *Total time*                                       | *7:01* |      |      | 100.0 |
|----------------------------------------------------+--------+------+------+-------|
| Stories                                            | 7:01   |      |      | 100.0 |
| Active                                             |        | 7:01 |      | 100.0 |
| Edit release notes for previous sprint             |        |      | 3:36 |  51.3 |
| Create a demo and presentation for previous sprint |        |      | 1:39 |  23.5 |
| Sprint and product backlog grooming                |        |      | 0:24 |   5.7 |
| Remove test model sanitizer                        |        |      | 0:20 |   4.8 |
| Remove master headers                              |        |      | 1:02 |  14.7 |
