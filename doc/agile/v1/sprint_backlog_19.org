...
#+CAPTION: Clock summary at [2019-11-04 Mon 22:12]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
...
| Move registrar into assets                                |         |       |  5:29 |   9.8 |
| Fix compilation errors in nightly                         |         |       |  0:24 |   0.7 |
| Upgrade to boost 1.70                                     |         |       | 10:00 |  17.8 |
| Setup laptop to work on dogen                             |         |       |  0:45 |   1.3 |
| Org-mode as a carrier format for modeling                 |         |       |  5:37 |  10.0 |
| Add relational tracing support                            |         |       |  4:48 |   8.5 |
| Creating reference cycles produces strange errors         |         |       |  4:47 |   8.5 |
| Meta-data keys are in the inverse order                   |         |       |  0:36 |   1.1 |
...
*** STARTED Meta-data keys are in the inverse order                   :story:
    :LOGBOOK:
    CLOCK: [2019-11-04 Mon 22:11]
