...
#+CAPTION: Clock summary at [2019-11-08 Fri 12:22]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                   | 70:56   |       |       | 100.0 |
| Active                                                    |         | 70:56 |       | 100.0 |
| Edit release notes for previous sprint                    |         |       |  3:36 |   5.1 |
| Create a demo and presentation for previous sprint        |         |       |  1:39 |   2.3 |
| Time spent producing coding videos                        |         |       |  1:20 |   1.9 |
| Sprint and product backlog grooming                       |         |       |  5:18 |   7.5 |
| Remove test model sanitizer                               |         |       |  0:20 |   0.5 |
| Remove master headers                                     |         |       |  1:12 |   1.7 |
| Fix the issues with tests in reference model              |         |       |  3:53 |   5.5 |
| Update static strings to string views                     |         |       |  1:15 |   1.8 |
| ODB include directories is incorrect                      |         |       |  1:43 |   2.4 |
| Create a "modeling" report                                |         |       |  4:56 |   7.0 |
...
| Creating reference cycles produces strange errors         |         |       |  5:32 |   7.8 |
| Error on duplicate references                             |         |       |  0:26 |   0.6 |
| Generate model dependency graph                           |         |       |  1:55 |   2.7 |
...
| Move registrar into assets                                |         |       |  5:29 |   7.7 |
| Upgrade to boost 1.70                                     |         |       | 10:00 |  14.1 |
| Setup laptop to work on dogen                             |         |       |  0:45 |   1.1 |
| Org-mode as a carrier format for modeling                 |         |       |  5:37 |   7.9 |
| Add relational tracing support                            |         |       |  6:52 |   9.7 |
| Consider creating a test build for all facets             |         |       |  4:38 |   6.5 |
