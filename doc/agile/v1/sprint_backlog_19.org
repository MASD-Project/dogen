...
#+CAPTION: Clock summary at [2019-10-29 Tue 19:02]
| <75>                                                      |         |       |       |       |
| Headline                                                  | Time    |       |       |     % |
|-----------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                              | *49:53* |       |       | 100.0 |
|-----------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                   | 49:53   |       |       | 100.0 |
| Active                                                    |         | 49:53 |       | 100.0 |
| Edit release notes for previous sprint                    |         |       |  3:36 |   7.2 |
| Create a demo and presentation for previous sprint        |         |       |  1:39 |   3.3 |
| Sprint and product backlog grooming                       |         |       |  4:06 |   8.2 |
| Remove test model sanitizer                               |         |       |  0:20 |   0.7 |
| Remove master headers                                     |         |       |  1:12 |   2.4 |
| Fix the issues with tests in reference model              |         |       |  3:53 |   7.8 |
| Update static strings to string views                     |         |       |  1:15 |   2.5 |
| ODB include directories is incorrect                      |         |       |  1:43 |   3.4 |
| Create a "modeling" report                                |         |       |  4:56 |   9.9 |
...
| Move registrar into assets                                |         |       |  5:29 |  11.0 |
| Fix compilation errors in nightly                         |         |       |  0:24 |   0.8 |
| Upgrade to boost 1.70                                     |         |       | 10:00 |  20.0 |
| Setup laptop to work on dogen                             |         |       |  0:45 |   1.5 |
| Org-mode as a carrier format for modeling                 |         |       |  5:37 |  11.3 |
| Add relational tracing support                            |         |       |  4:12 |   8.4 |
