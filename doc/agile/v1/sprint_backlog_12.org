...
#+CAPTION: Clock summary at [2019-03-05 Tue 08:47]
| <75>                                                     |         |       |       |       |
| Headline                                                 | Time    |       |       |     % |
|----------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                  | 37:47   |       |       | 100.0 |
| Active                                                   |         | 37:47 |       | 100.0 |
| Edit release notes for previous sprint                   |         |       |  1:27 |   3.8 |
| Sprint and product backlog grooming                      |         |       |  1:03 |   2.8 |
| Implement text model generation chain in generation      |         |       |  3:45 |   9.9 |
| Move generation model out of coding                      |         |       |  4:22 |  11.6 |
| Rename endomodel to just model                           |         |       |  2:11 |   5.8 |
| Remove exomodel remnants                                 |         |       |  0:03 |   0.1 |
| Consider adding a dot graph of the transforms to probing |         |       |  1:47 |   4.7 |
| Split annotations processing into two phases             |         |       |  3:10 |   8.4 |
| Move injection processing out of coding                  |         |       | 18:39 |  49.4 |
| Try to fix valgrind warning on =find_files=              |         |       |  0:20 |   0.9 |
| Rename the =transform= method to =apply=                 |         |       |  0:05 |   0.2 |
| Add basic "diff mode"                                    |         |       |  0:46 |   2.0 |
| Create a extraction model post-processing chain          |         |       |  0:09 |   0.4 |
...
*** STARTED Create a extraction model post-processing chain           :story:
    :LOGBOOK:
...
*** Move coding to generation model transform into orchestration      :story:
