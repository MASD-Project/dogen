...
#+CAPTION: Clock summary at [2019-03-10 Sun 21:41]
| <75>                                                         |         |       |       |       |
| Headline                                                     | Time    |       |       |     % |
|--------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                 | *85:56* |       |       | 100.0 |
|--------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                      | 85:56   |       |       | 100.0 |
| Active                                                       |         | 85:56 |       | 100.0 |
| Edit release notes for previous sprint                       |         |       |  1:27 |   1.7 |
| Sprint and product backlog grooming                          |         |       |  2:16 |   2.6 |
| Implement text model generation chain in generation          |         |       |  3:45 |   4.4 |
| Move generation model out of coding                          |         |       |  4:22 |   5.1 |
...
| Move injection processing out of coding                      |         |       | 18:39 |  21.7 |
...
| Add DTL to vcpkg                                             |         |       |  5:15 |   6.1 |
| Remove coding options                                        |         |       |  3:59 |   4.6 |
| Add basic "diff mode"                                        |         |       | 12:02 |  14.0 |
...
| Rework the system tests using diff mode                      |         |       | 14:57 |  17.4 |
| Try to fix valgrind warning on =find_files=                  |         |       |  0:20 |   0.4 |
| Rename the =transform= method to =apply=                     |         |       |  2:39 |   3.1 |
