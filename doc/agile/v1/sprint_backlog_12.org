...
#+CAPTION: Clock summary at [2019-03-08 Fri 17:51]
| <75>                                                         |         |       |       |       |
| Headline                                                     | Time    |       |       |     % |
|--------------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                      | 76:17   |       |       | 100.0 |
| Active                                                       |         | 76:17 |       | 100.0 |
| Edit release notes for previous sprint                       |         |       |  1:27 |   1.9 |
| Sprint and product backlog grooming                          |         |       |  1:32 |   2.0 |
| Implement text model generation chain in generation          |         |       |  3:45 |   4.9 |
| Move generation model out of coding                          |         |       |  4:22 |   5.7 |
| Rename endomodel to just model                               |         |       |  2:11 |   2.9 |
| Remove exomodel remnants                                     |         |       |  0:03 |   0.1 |
| Consider adding a dot graph of the transforms to probing     |         |       |  1:47 |   2.3 |
| Split annotations processing into two phases                 |         |       |  3:10 |   4.2 |
| Move injection processing out of coding                      |         |       | 18:39 |  24.4 |
| Create a extraction model post-processing chain              |         |       |  0:56 |   1.2 |
| Move coding to generation model transform into orchestration |         |       |  0:33 |   0.7 |
| Add option for northwind tests                               |         |       |  0:54 |   1.2 |
| Add DTL to vcpkg                                             |         |       |  5:15 |   6.9 |
| Remove coding options                                        |         |       |  3:59 |   5.2 |
| Add basic "diff mode"                                        |         |       | 12:02 |  15.8 |
| Create a "run byproducts" directory                          |         |       |  1:01 |   1.3 |
| Logging impact in tracing is blank                           |         |       |  0:50 |   1.1 |
| Split operation reports from patches                         |         |       |  1:19 |   1.7 |
...
| Rework the system tests using diff mode                      |         |       |  8:36 |  11.3 |
