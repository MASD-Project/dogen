...
#+CAPTION: Clock summary at [2019-03-08 Fri 07:20]
| <75>                                                         |         |       |       |       |
| Headline                                                     | Time    |       |       |     % |
|--------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                 | *68:19* |       |       | 100.0 |
|--------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                      | 68:19   |       |       | 100.0 |
| Active                                                       |         | 68:19 |       | 100.0 |
| Edit release notes for previous sprint                       |         |       |  1:27 |   2.1 |
| Sprint and product backlog grooming                          |         |       |  1:32 |   2.2 |
| Implement text model generation chain in generation          |         |       |  3:45 |   5.5 |
| Move generation model out of coding                          |         |       |  4:22 |   6.4 |
| Rename endomodel to just model                               |         |       |  2:11 |   3.2 |
| Remove exomodel remnants                                     |         |       |  0:03 |   0.1 |
| Consider adding a dot graph of the transforms to probing     |         |       |  1:47 |   2.6 |
| Split annotations processing into two phases                 |         |       |  3:10 |   4.6 |
| Move injection processing out of coding                      |         |       | 18:39 |  27.3 |
...
| Add DTL to vcpkg                                             |         |       |  5:15 |   7.7 |
| Remove coding options                                        |         |       |  3:59 |   5.8 |
| Add basic "diff mode"                                        |         |       | 12:02 |  17.6 |
| Create a "run byproducts" directory                          |         |       |  1:01 |   1.5 |
| Logging impact in tracing is blank                           |         |       |  0:50 |   1.2 |
| Split operation reports from patches                         |         |       |  1:19 |   1.9 |
| Add org mode support to diff reports                         |         |       |  1:13 |   1.8 |
| Add dry mode                                                 |         |       |  0:27 |   0.7 |
...
| Rework the system tests using diff mode                      |         |       |  1:07 |   1.6 |
