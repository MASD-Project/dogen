...
#+CAPTION: Clock summary at [2019-03-01 Fri 18:02]
| <75>                                                |         |       |      |       |
| Headline                                            | Time    |       |      |     % |
|-----------------------------------------------------+---------+-------+------+-------|
| *Total time*                                        | *18:15* |       |      | 100.0 |
|-----------------------------------------------------+---------+-------+------+-------|
| Stories                                             | 18:15   |       |      | 100.0 |
| Active                                              |         | 18:15 |      | 100.0 |
| Edit release notes for previous sprint              |         |       | 1:27 |   7.9 |
| Sprint and product backlog grooming                 |         |       | 0:42 |   3.8 |
| Implement text model generation chain in generation |         |       | 3:45 |  20.5 |
| Move generation model out of coding                 |         |       | 4:22 |  23.9 |
| Rename endomodel to just model                      |         |       | 2:11 |  12.0 |
| Remove exomodel remnants                            |         |       | 0:03 |   0.3 |
| Try to fix valgrind warning on =find_files=         |         |       | 0:20 |   1.8 |
| Move injection processing out of coding             |         |       | 5:05 |  27.9 |
| Split annotations processing into two phases        |         |       | 0:20 |   1.8 |
...
*** Consider adding a dot graph of the transforms to probing          :story:
