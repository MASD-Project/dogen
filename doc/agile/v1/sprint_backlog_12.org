...
#+CAPTION: Clock summary at [2019-03-05 Tue 15:19]
| <75>                                                         |         |       |       |       |
| Headline                                                     | Time    |       |       |     % |
|--------------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                      | 43:36   |       |       | 100.0 |
| Active                                                       |         | 43:36 |       | 100.0 |
| Edit release notes for previous sprint                       |         |       |  1:27 |   3.3 |
| Sprint and product backlog grooming                          |         |       |  1:03 |   2.4 |
| Implement text model generation chain in generation          |         |       |  3:45 |   8.6 |
| Move generation model out of coding                          |         |       |  4:22 |  10.0 |
| Rename endomodel to just model                               |         |       |  2:11 |   5.0 |
| Remove exomodel remnants                                     |         |       |  0:03 |   0.1 |
| Consider adding a dot graph of the transforms to probing     |         |       |  1:47 |   4.1 |
| Split annotations processing into two phases                 |         |       |  3:10 |   7.3 |
| Move injection processing out of coding                      |         |       | 18:39 |  42.8 |
| Create a extraction model post-processing chain              |         |       |  0:56 |   2.1 |
| Move coding to generation model transform into orchestration |         |       |  0:33 |   1.3 |
| Try to fix valgrind warning on =find_files=                  |         |       |  0:20 |   0.8 |
| Rename the =transform= method to =apply=                     |         |       |  0:05 |   0.2 |
| Add basic "diff mode"                                        |         |       |  1:23 |   3.2 |
| Add DTL to vcpkg                                             |         |       |  3:52 |   8.9 |
...
*** STARTED Add DTL to vcpkg                                          :story:
    :LOGBOOK:
