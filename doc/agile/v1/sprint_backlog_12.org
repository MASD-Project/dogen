...
#+CAPTION: Clock summary at [2019-03-07 Thu 14:02]
| <75>                                                         |         |       |       |       |
| Headline                                                     | Time    |       |       |     % |
|--------------------------------------------------------------+---------+-------+-------+-------|
...
| Sprint and product backlog grooming                          |         |       |  1:17 |   2.1 |
| Implement text model generation chain in generation          |         |       |  3:45 |   6.0 |
| Move generation model out of coding                          |         |       |  4:22 |   7.0 |
| Rename endomodel to just model                               |         |       |  2:11 |   3.5 |
| Remove exomodel remnants                                     |         |       |  0:03 |   0.1 |
| Consider adding a dot graph of the transforms to probing     |         |       |  1:47 |   2.9 |
| Split annotations processing into two phases                 |         |       |  3:10 |   5.1 |
| Move injection processing out of coding                      |         |       | 18:39 |  30.0 |
...
| Add DTL to vcpkg                                             |         |       |  5:15 |   8.5 |
| Remove coding options                                        |         |       |  3:59 |   6.4 |
| Add basic "diff mode"                                        |         |       | 12:02 |  19.4 |
...
*** Create a "run byproducts" directory                               :story:
