...
#+CAPTION: Clock summary at [2019-03-06 Wed 15:05]
| <75>                                                         |         |       |       |       |
| Headline                                                     | Time    |       |       |     % |
|--------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                 | *53:32* |       |       | 100.0 |
|--------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                      | 53:32   |       |       | 100.0 |
| Active                                                       |         | 53:32 |       | 100.0 |
| Edit release notes for previous sprint                       |         |       |  1:27 |   2.7 |
| Sprint and product backlog grooming                          |         |       |  1:03 |   2.0 |
| Implement text model generation chain in generation          |         |       |  3:45 |   7.0 |
| Move generation model out of coding                          |         |       |  4:22 |   8.2 |
| Rename endomodel to just model                               |         |       |  2:11 |   4.1 |
| Remove exomodel remnants                                     |         |       |  0:03 |   0.1 |
| Consider adding a dot graph of the transforms to probing     |         |       |  1:47 |   3.3 |
| Split annotations processing into two phases                 |         |       |  3:10 |   5.9 |
| Move injection processing out of coding                      |         |       | 18:39 |  34.8 |
...
| Add option for northwind tests                               |         |       |  0:54 |   1.7 |
| Add DTL to vcpkg                                             |         |       |  5:15 |   9.8 |
| Remove coding options                                        |         |       |  3:59 |   7.4 |
| Rename the =transform= method to =apply=                     |         |       |  0:05 |   0.2 |
| Try to fix valgrind warning on =find_files=                  |         |       |  0:20 |   0.6 |
| Add basic "diff mode"                                        |         |       |  1:57 |   3.6 |
| Fix northwind tests on OSX and Windows                       |         |       |  3:06 |   5.8 |
