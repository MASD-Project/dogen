...
#+CAPTION: Clock summary at [2019-02-28 Thu 14:02]
| <75>                                                |        |      |      |       |
| Headline                                            | Time   |      |      |     % |
|-----------------------------------------------------+--------+------+------+-------|
| *Total time*                                        | *5:50* |      |      | 100.0 |
|-----------------------------------------------------+--------+------+------+-------|
| Stories                                             | 5:50   |      |      | 100.0 |
| Active                                              |        | 5:50 |      | 100.0 |
| Edit release notes for previous sprint              |        |      | 1:27 |  24.9 |
| Sprint and product backlog grooming                 |        |      | 0:18 |   5.1 |
| Implement text model generation chain in generation |        |      | 3:45 |  64.3 |
| Try to fix valgrind warning on =find_files=         |        |      | 0:20 |   5.7 |
...
*** STARTED Move generation model out of coding                       :story:
    :LOGBOOK:
