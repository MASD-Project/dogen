...
#+CAPTION: Clock summary at [2019-03-08 Fri 18:42]
| <75>                                                         |         |       |       |       |
| Headline                                                     | Time    |       |       |     % |
|--------------------------------------------------------------+---------+-------+-------+-------|
...
| Rename endomodel to just model                               |         |       |  2:11 |   2.8 |
| Remove exomodel remnants                                     |         |       |  0:03 |   0.1 |
| Consider adding a dot graph of the transforms to probing     |         |       |  1:47 |   2.3 |
| Split annotations processing into two phases                 |         |       |  3:10 |   4.1 |
| Move injection processing out of coding                      |         |       | 18:39 |  24.2 |
...
| Add DTL to vcpkg                                             |         |       |  5:15 |   6.8 |
| Remove coding options                                        |         |       |  3:59 |   5.2 |
| Add basic "diff mode"                                        |         |       | 12:02 |  15.6 |
...
| Rework the system tests using diff mode                      |         |       |  9:25 |  12.2 |
