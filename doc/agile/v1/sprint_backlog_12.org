...
#+CAPTION: Clock summary at [2019-03-04 Mon 18:31]
| <75>                                                     |         |       |       |       |
| Headline                                                 | Time    |       |       |     % |
|----------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                  | 36:42   |       |       | 100.0 |
| Active                                                   |         | 36:42 |       | 100.0 |
| Edit release notes for previous sprint                   |         |       |  1:27 |   4.0 |
| Sprint and product backlog grooming                      |         |       |  0:53 |   2.4 |
| Implement text model generation chain in generation      |         |       |  3:45 |  10.2 |
| Move generation model out of coding                      |         |       |  4:22 |  11.9 |
| Rename endomodel to just model                           |         |       |  2:11 |   5.9 |
| Remove exomodel remnants                                 |         |       |  0:03 |   0.1 |
| Consider adding a dot graph of the transforms to probing |         |       |  1:47 |   4.9 |
| Split annotations processing into two phases             |         |       |  3:10 |   8.6 |
| Move injection processing out of coding                  |         |       | 18:39 |  50.8 |
...
*** Create a extraction model post-processing chain                   :story:
