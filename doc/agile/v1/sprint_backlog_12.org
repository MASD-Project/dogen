...
#+CAPTION: Clock summary at [2019-03-07 Thu 10:36]
| <75>                                                         |         |       |       |       |
| Headline                                                     | Time    |       |       |     % |
|--------------------------------------------------------------+---------+-------+-------+-------|
...
| Implement text model generation chain in generation          |         |       |  3:45 |   6.3 |
| Move generation model out of coding                          |         |       |  4:22 |   7.4 |
| Rename endomodel to just model                               |         |       |  2:11 |   3.7 |
| Remove exomodel remnants                                     |         |       |  0:03 |   0.1 |
| Consider adding a dot graph of the transforms to probing     |         |       |  1:47 |   3.0 |
| Split annotations processing into two phases                 |         |       |  3:10 |   5.3 |
| Move injection processing out of coding                      |         |       | 18:39 |  31.5 |
