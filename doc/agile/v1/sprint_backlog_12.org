...
#+CAPTION: Clock summary at [2019-03-10 Sun 14:12]
| <75>                                                         |         |       |       |       |
| Headline                                                     | Time    |       |       |     % |
|--------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                 | *84:42* |       |       | 100.0 |
|--------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                      | 84:42   |       |       | 100.0 |
| Active                                                       |         | 84:42 |       | 100.0 |
| Edit release notes for previous sprint                       |         |       |  1:27 |   1.7 |
| Sprint and product backlog grooming                          |         |       |  2:16 |   2.7 |
| Implement text model generation chain in generation          |         |       |  3:45 |   4.4 |
| Move generation model out of coding                          |         |       |  4:22 |   5.2 |
| Rename endomodel to just model                               |         |       |  2:11 |   2.6 |
| Remove exomodel remnants                                     |         |       |  0:03 |   0.1 |
| Consider adding a dot graph of the transforms to probing     |         |       |  1:47 |   2.1 |
| Split annotations processing into two phases                 |         |       |  3:10 |   3.7 |
| Move injection processing out of coding                      |         |       | 18:39 |  22.0 |
...
| Add DTL to vcpkg                                             |         |       |  5:15 |   6.2 |
| Remove coding options                                        |         |       |  3:59 |   4.7 |
| Add basic "diff mode"                                        |         |       | 12:02 |  14.2 |
...
| Rework the system tests using diff mode                      |         |       | 14:57 |  17.7 |
| Try to fix valgrind warning on =find_files=                  |         |       |  0:20 |   0.4 |
| Rename the =transform= method to =apply=                     |         |       |  1:25 |   1.7 |
...
*** Create a video demo for the sprint's features                     :story:
