...
#+CAPTION: Clock summary at [2019-03-07 Thu 15:22]
| <75>                                                         |         |       |       |       |
| Headline                                                     | Time    |       |       |     % |
|--------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                 | *63:29* |       |       | 100.0 |
|--------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                      | 63:29   |       |       | 100.0 |
| Active                                                       |         | 63:29 |       | 100.0 |
| Edit release notes for previous sprint                       |         |       |  1:27 |   2.3 |
| Sprint and product backlog grooming                          |         |       |  1:32 |   2.4 |
| Implement text model generation chain in generation          |         |       |  3:45 |   5.9 |
| Move generation model out of coding                          |         |       |  4:22 |   6.9 |
...
| Split annotations processing into two phases                 |         |       |  3:10 |   5.0 |
| Move injection processing out of coding                      |         |       | 18:39 |  29.4 |
...
| Add DTL to vcpkg                                             |         |       |  5:15 |   8.3 |
| Remove coding options                                        |         |       |  3:59 |   6.3 |
| Add basic "diff mode"                                        |         |       | 12:02 |  19.0 |
...
*** Logging impact in tracing is blank                                :story:
