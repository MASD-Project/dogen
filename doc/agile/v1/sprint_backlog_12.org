...
#+CAPTION: Clock summary at [2019-03-06 Wed 18:02]
| <75>                                                         |         |       |       |       |
| Headline                                                     | Time    |       |       |     % |
|--------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                 | *56:26* |       |       | 100.0 |
|--------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                      | 56:26   |       |       | 100.0 |
| Active                                                       |         | 56:26 |       | 100.0 |
| Edit release notes for previous sprint                       |         |       |  1:27 |   2.6 |
| Sprint and product backlog grooming                          |         |       |  1:03 |   1.9 |
| Implement text model generation chain in generation          |         |       |  3:45 |   6.6 |
| Move generation model out of coding                          |         |       |  4:22 |   7.7 |
| Rename endomodel to just model                               |         |       |  2:11 |   3.9 |
| Remove exomodel remnants                                     |         |       |  0:03 |   0.1 |
| Consider adding a dot graph of the transforms to probing     |         |       |  1:47 |   3.2 |
| Split annotations processing into two phases                 |         |       |  3:10 |   5.6 |
| Move injection processing out of coding                      |         |       | 18:39 |  33.0 |
| Create a extraction model post-processing chain              |         |       |  0:56 |   1.7 |
| Move coding to generation model transform into orchestration |         |       |  0:33 |   1.0 |
| Add option for northwind tests                               |         |       |  0:54 |   1.6 |
| Add DTL to vcpkg                                             |         |       |  5:15 |   9.3 |
| Remove coding options                                        |         |       |  3:59 |   7.1 |
| Rename the =transform= method to =apply=                     |         |       |  0:05 |   0.1 |
| Try to fix valgrind warning on =find_files=                  |         |       |  0:20 |   0.6 |
| Add basic "diff mode"                                        |         |       |  6:53 |  12.2 |
| Fix northwind tests on OSX and Windows                       |         |       |  1:04 |   1.9 |
