...
#+CAPTION: Clock summary at [2019-02-28 Thu 10:03]
| <75>                                                |        |      |      |       |
| Headline                                            | Time   |      |      |     % |
|-----------------------------------------------------+--------+------+------+-------|
| *Total time*                                        | *2:47* |      |      | 100.0 |
|-----------------------------------------------------+--------+------+------+-------|
| Stories                                             | 2:47   |      |      | 100.0 |
| Active                                              |        | 2:47 |      | 100.0 |
| Edit release notes for previous sprint              |        |      | 1:27 |  52.1 |
| Sprint and product backlog grooming                 |        |      | 0:18 |  10.8 |
| Try to fix valgrind warning on =find_files=         |        |      | 0:20 |  12.0 |
| Implement text model generation chain in generation |        |      | 0:42 |  25.1 |
...
*** STARTED Implement text model generation chain in generation       :story:
    :LOGBOOK:
