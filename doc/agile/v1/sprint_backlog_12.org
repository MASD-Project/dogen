...
#+CAPTION: Clock summary at [2019-03-08 Fri 11:50]
| <75>                                                         |         |       |       |       |
| Headline                                                     | Time    |       |       |     % |
|--------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                 | *71:32* |       |       | 100.0 |
|--------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                      | 71:32   |       |       | 100.0 |
| Active                                                       |         | 71:32 |       | 100.0 |
| Edit release notes for previous sprint                       |         |       |  1:27 |   2.0 |
| Sprint and product backlog grooming                          |         |       |  1:32 |   2.1 |
| Implement text model generation chain in generation          |         |       |  3:45 |   5.2 |
| Move generation model out of coding                          |         |       |  4:22 |   6.1 |
| Rename endomodel to just model                               |         |       |  2:11 |   3.1 |
| Remove exomodel remnants                                     |         |       |  0:03 |   0.1 |
| Consider adding a dot graph of the transforms to probing     |         |       |  1:47 |   2.5 |
| Split annotations processing into two phases                 |         |       |  3:10 |   4.4 |
| Move injection processing out of coding                      |         |       | 18:39 |  26.1 |
...
| Add DTL to vcpkg                                             |         |       |  5:15 |   7.3 |
| Remove coding options                                        |         |       |  3:59 |   5.6 |
| Add basic "diff mode"                                        |         |       | 12:02 |  16.8 |
...
| Add org mode support to diff reports                         |         |       |  1:13 |   1.7 |
| Add dry mode                                                 |         |       |  0:27 |   0.6 |
| Rename the =transform= method to =apply=                     |         |       |  0:05 |   0.1 |
| Try to fix valgrind warning on =find_files=                  |         |       |  0:20 |   0.5 |
| Fix northwind tests on OSX and Windows                       |         |       |  1:04 |   1.5 |
| Update metrics in OpenHub                                    |         |       |  0:18 |   0.4 |
| Rework the system tests using diff mode                      |         |       |  4:10 |   5.8 |
| Split extraction model generation from code generation       |         |       |  0:10 |   0.2 |
...
*** STARTED Split extraction model generation from code generation    :story:
    :LOGBOOK:
