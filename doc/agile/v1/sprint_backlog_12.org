...
#+CAPTION: Clock summary at [2019-03-07 Thu 17:24]
| <75>                                                         |         |       |       |       |
| Headline                                                     | Time    |       |       |     % |
|--------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                 | *65:27* |       |       | 100.0 |
|--------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                      | 65:27   |       |       | 100.0 |
| Active                                                       |         | 65:27 |       | 100.0 |
| Edit release notes for previous sprint                       |         |       |  1:27 |   2.2 |
| Sprint and product backlog grooming                          |         |       |  1:32 |   2.3 |
| Implement text model generation chain in generation          |         |       |  3:45 |   5.7 |
| Move generation model out of coding                          |         |       |  4:22 |   6.7 |
...
| Split annotations processing into two phases                 |         |       |  3:10 |   4.8 |
| Move injection processing out of coding                      |         |       | 18:39 |  28.5 |
...
| Add DTL to vcpkg                                             |         |       |  5:15 |   8.0 |
| Remove coding options                                        |         |       |  3:59 |   6.1 |
| Add basic "diff mode"                                        |         |       | 12:02 |  18.4 |
...
| Split operation reports from patches                         |         |       |  1:14 |   1.9 |
