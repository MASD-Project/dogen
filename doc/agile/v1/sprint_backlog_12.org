...
#+CAPTION: Clock summary at [2019-03-08 Fri 15:03]
| <75>                                                         |         |       |       |       |
| Headline                                                     | Time    |       |       |     % |
|--------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                 | *73:49* |       |       | 100.0 |
|--------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                      | 73:49   |       |       | 100.0 |
| Active                                                       |         | 73:49 |       | 100.0 |
| Edit release notes for previous sprint                       |         |       |  1:27 |   2.0 |
| Sprint and product backlog grooming                          |         |       |  1:32 |   2.1 |
| Implement text model generation chain in generation          |         |       |  3:45 |   5.1 |
| Move generation model out of coding                          |         |       |  4:22 |   5.9 |
| Rename endomodel to just model                               |         |       |  2:11 |   3.0 |
| Remove exomodel remnants                                     |         |       |  0:03 |   0.1 |
| Consider adding a dot graph of the transforms to probing     |         |       |  1:47 |   2.4 |
| Split annotations processing into two phases                 |         |       |  3:10 |   4.3 |
| Move injection processing out of coding                      |         |       | 18:39 |  25.3 |
| Create a extraction model post-processing chain              |         |       |  0:56 |   1.3 |
| Move coding to generation model transform into orchestration |         |       |  0:33 |   0.7 |
| Add option for northwind tests                               |         |       |  0:54 |   1.2 |
| Add DTL to vcpkg                                             |         |       |  5:15 |   7.1 |
| Remove coding options                                        |         |       |  3:59 |   5.4 |
| Add basic "diff mode"                                        |         |       | 12:02 |  16.3 |
| Create a "run byproducts" directory                          |         |       |  1:01 |   1.4 |
| Logging impact in tracing is blank                           |         |       |  0:50 |   1.1 |
| Split operation reports from patches                         |         |       |  1:19 |   1.8 |
| Add org mode support to diff reports                         |         |       |  1:13 |   1.6 |
| Add dry mode                                                 |         |       |  0:27 |   0.6 |
| Split extraction model generation from code generation       |         |       |  0:29 |   0.7 |
| Rename the =transform= method to =apply=                     |         |       |  0:05 |   0.1 |
| Try to fix valgrind warning on =find_files=                  |         |       |  0:20 |   0.5 |
| Fix northwind tests on OSX and Windows                       |         |       |  1:04 |   1.4 |
| Update metrics in OpenHub                                    |         |       |  0:18 |   0.4 |
| Rework the system tests using diff mode                      |         |       |  6:08 |   8.3 |
