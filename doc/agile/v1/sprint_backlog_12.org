...
#+CAPTION: Clock summary at [2019-03-05 Tue 10:10]
| <75>                                                         |         |       |       |       |
| Headline                                                     | Time    |       |       |     % |
|--------------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                      | 39:07   |       |       | 100.0 |
| Active                                                       |         | 39:07 |       | 100.0 |
| Edit release notes for previous sprint                       |         |       |  1:27 |   3.7 |
| Sprint and product backlog grooming                          |         |       |  1:03 |   2.7 |
| Implement text model generation chain in generation          |         |       |  3:45 |   9.6 |
| Move generation model out of coding                          |         |       |  4:22 |  11.2 |
| Rename endomodel to just model                               |         |       |  2:11 |   5.6 |
| Remove exomodel remnants                                     |         |       |  0:03 |   0.1 |
| Consider adding a dot graph of the transforms to probing     |         |       |  1:47 |   4.6 |
| Split annotations processing into two phases                 |         |       |  3:10 |   8.1 |
| Move injection processing out of coding                      |         |       | 18:39 |  47.7 |
| Create a extraction model post-processing chain              |         |       |  0:56 |   2.4 |
| Move coding to generation model transform into orchestration |         |       |  0:33 |   1.4 |
