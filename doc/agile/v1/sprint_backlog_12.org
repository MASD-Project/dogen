...
#+CAPTION: Clock summary at [2019-03-09 Sat 07:23]
| <75>                                                         |         |       |       |       |
| Headline                                                     | Time    |       |       |     % |
|--------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                 | *79:27* |       |       | 100.0 |
|--------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                      | 79:27   |       |       | 100.0 |
| Active                                                       |         | 79:27 |       | 100.0 |
| Edit release notes for previous sprint                       |         |       |  1:27 |   1.8 |
| Sprint and product backlog grooming                          |         |       |  1:32 |   1.9 |
| Implement text model generation chain in generation          |         |       |  3:45 |   4.7 |
| Move generation model out of coding                          |         |       |  4:22 |   5.5 |
...
| Split annotations processing into two phases                 |         |       |  3:10 |   4.0 |
| Move injection processing out of coding                      |         |       | 18:39 |  23.5 |
...
| Add DTL to vcpkg                                             |         |       |  5:15 |   6.6 |
| Remove coding options                                        |         |       |  3:59 |   5.0 |
| Add basic "diff mode"                                        |         |       | 12:02 |  15.1 |
...
| Rework the system tests using diff mode                      |         |       | 11:46 |  14.8 |
