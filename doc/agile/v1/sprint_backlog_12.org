...
#+CAPTION: Clock summary at [2019-03-07 Thu 16:15]
| <75>                                                         |         |       |       |       |
| Headline                                                     | Time    |       |       |     % |
|--------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                 | *64:19* |       |       | 100.0 |
|--------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                      | 64:19   |       |       | 100.0 |
| Active                                                       |         | 64:19 |       | 100.0 |
| Edit release notes for previous sprint                       |         |       |  1:27 |   2.3 |
| Sprint and product backlog grooming                          |         |       |  1:32 |   2.4 |
| Implement text model generation chain in generation          |         |       |  3:45 |   5.8 |
| Move generation model out of coding                          |         |       |  4:22 |   6.8 |
| Rename endomodel to just model                               |         |       |  2:11 |   3.4 |
| Remove exomodel remnants                                     |         |       |  0:03 |   0.1 |
| Consider adding a dot graph of the transforms to probing     |         |       |  1:47 |   2.8 |
| Split annotations processing into two phases                 |         |       |  3:10 |   4.9 |
| Move injection processing out of coding                      |         |       | 18:39 |  29.0 |
...
| Add option for northwind tests                               |         |       |  0:54 |   1.4 |
| Add DTL to vcpkg                                             |         |       |  5:15 |   8.2 |
| Remove coding options                                        |         |       |  3:59 |   6.2 |
| Add basic "diff mode"                                        |         |       | 12:02 |  18.7 |
| Create a "run byproducts" directory                          |         |       |  1:01 |   1.6 |
| Logging impact in tracing is blank                           |         |       |  0:50 |   1.3 |
| Rename the =transform= method to =apply=                     |         |       |  0:05 |   0.1 |
| Try to fix valgrind warning on =find_files=                  |         |       |  0:20 |   0.5 |
| Fix northwind tests on OSX and Windows                       |         |       |  1:04 |   1.7 |
| Update metrics in OpenHub                                    |         |       |  0:18 |   0.5 |
| Split operation reports from patches                         |         |       |  0:06 |   0.2 |
...
*** STARTED Split operation reports from patches                      :story:
    :LOGBOOK:
...
*** Add org mode support to diff reports                              :story:
