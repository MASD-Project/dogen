...
#+CAPTION: Clock summary at [2017-07-09 Sun 17:12]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 21:32   |       |      | 100.0 |
| Active                                                                      |         | 21:32 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:48 |   3.7 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:24 |   1.9 |
| COMPLETED Implement the context class                                       |         |       | 1:12 |   5.6 |
| COMPLETED Implement the exogenous transformation chain                      |         |       | 4:11 |  19.4 |
| COMPLETED Implement the pre-processing chain                                |         |       | 1:35 |   7.4 |
...
| COMPLETED Implement the references chain                                    |         |       | 2:43 |  12.6 |
| COMPLETED Implement the merge transform                                     |         |       | 0:40 |   3.1 |
| COMPLETED Implement the model generation chain                              |         |       | 0:13 |   1.0 |
| COMPLETED Implement the model assembly chain                                |         |       | 0:50 |   3.9 |
| COMPLETED Implement the post-processing chain                               |         |       | 3:31 |  16.3 |
| COMPLETED Move helpers from =transforms= namespace                          |         |       | 0:45 |   3.5 |
| COMPLETED Replace expanders with transforms                                 |         |       | 0:03 |   0.2 |
| COMPLETED Port all expander unit tests to transforms                        |         |       | 0:42 |   3.3 |
| COMPLETED Remove all legacy classes from yarn                               |         |       | 0:55 |   4.3 |
| COMPLETED Implement the mapper as a transform                               |         |       | 0:46 |   3.6 |
| STARTED Move helpers from main yarn namespace                               |         |       | 1:05 |   5.0 |
