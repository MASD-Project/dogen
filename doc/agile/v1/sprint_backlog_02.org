...
#+CAPTION: Clock summary at [2017-07-08 Sat 19:25]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *14:02* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 14:02   |       |      | 100.0 |
| Active                                                                      |         | 14:02 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:48 |   5.7 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:24 |   2.9 |
| COMPLETED Implement the context class                                       |         |       | 1:12 |   8.6 |
| COMPLETED Implement the exogenous transformation chain                      |         |       | 4:11 |  29.8 |
| COMPLETED Implement the pre-processing chain                                |         |       | 1:35 |  11.3 |
| COMPLETED Refactor mapping repository factory                               |         |       | 0:12 |   1.4 |
| COMPLETED Implement the output languages transform                          |         |       | 0:37 |   4.4 |
| COMPLETED Use forward declaration for context                               |         |       | 0:20 |   2.4 |
| COMPLETED Implement the references chain                                    |         |       | 2:43 |  19.4 |
| COMPLETED Implement the merge transform                                     |         |       | 0:40 |   4.8 |
| COMPLETED Implement the model generation chain                              |         |       | 0:13 |   1.5 |
| COMPLETED Implement the model assembly chain                                |         |       | 0:50 |   5.9 |
| STARTED Implement the post-processing chain                                 |         |       | 0:17 |   2.0 |
