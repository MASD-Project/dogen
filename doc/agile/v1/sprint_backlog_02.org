...
#+CAPTION: Clock summary at [2017-07-08 Sat 20:20]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 14:21   |       |      | 100.0 |
| Active                                                                      |         | 14:21 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:48 |   5.6 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:24 |   2.8 |
| COMPLETED Implement the context class                                       |         |       | 1:12 |   8.4 |
| COMPLETED Implement the exogenous transformation chain                      |         |       | 4:11 |  29.2 |
| COMPLETED Implement the pre-processing chain                                |         |       | 1:35 |  11.0 |
| COMPLETED Refactor mapping repository factory                               |         |       | 0:12 |   1.4 |
| COMPLETED Implement the output languages transform                          |         |       | 0:37 |   4.3 |
| COMPLETED Use forward declaration for context                               |         |       | 0:20 |   2.3 |
| COMPLETED Implement the references chain                                    |         |       | 2:43 |  18.9 |
| COMPLETED Implement the merge transform                                     |         |       | 0:40 |   4.6 |
| COMPLETED Implement the model generation chain                              |         |       | 0:13 |   1.5 |
| COMPLETED Implement the model assembly chain                                |         |       | 0:50 |   5.8 |
| STARTED Implement the post-processing chain                                 |         |       | 0:36 |   4.2 |
