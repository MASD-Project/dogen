...
#+CAPTION: Clock summary at [2017-07-09 Sun 13:38]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *18:26* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 18:26   |       |      | 100.0 |
| Active                                                                      |         | 18:26 |      | 100.0 |
...
| COMPLETED Implement the exogenous transformation chain                      |         |       | 4:11 |  22.7 |
| COMPLETED Implement the pre-processing chain                                |         |       | 1:35 |   8.6 |
...
| COMPLETED Implement the references chain                                    |         |       | 2:43 |  14.7 |
...
| COMPLETED Implement the post-processing chain                               |         |       | 3:31 |  19.1 |
| COMPLETED Move helpers from =transforms= namespace                          |         |       | 0:45 |   4.1 |
| COMPLETED Replace expanders with transforms                                 |         |       | 0:03 |   0.3 |
| STARTED Remove all legacy classes from yarn                                 |         |       | 0:22 |   2.0 |
