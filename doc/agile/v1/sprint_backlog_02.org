...
#+CAPTION: Clock summary at [2017-07-14 Fri 14:50]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *39:26* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 39:26   |       |      | 100.0 |
| Active                                                                      |         | 39:26 |      | 100.0 |
...
| COMPLETED Implement the exogenous transformation chain                      |         |       | 4:11 |  10.6 |
| COMPLETED Implement the pre-processing chain                                |         |       | 1:35 |   4.0 |
...
| COMPLETED Implement the references chain                                    |         |       | 2:43 |   6.9 |
...
| COMPLETED Implement the post-processing chain                               |         |       | 3:31 |   8.9 |
...
| COMPLETED Move helpers from main yarn namespace                             |         |       | 1:29 |   3.8 |
| COMPLETED Move all data types into its own namespace                        |         |       | 9:00 |  22.8 |
| CANCELLED Move artefacts from formatters into meta-model                    |         |       | 0:54 |   2.3 |
| CANCELLED Use transformation context in quilt                               |         |       | 0:20 |   0.8 |
| COMPLETED Create an options validator                                       |         |       | 0:39 |   1.6 |
| COMPLETED Implement the code-generation chain                               |         |       | 4:33 |  11.5 |
| COMPLETED Fix options test break on windows                                 |         |       | 0:10 |   0.4 |
| STARTED Move enablement into yarn                                           |         |       | 1:35 |   4.0 |
