...
#+CAPTION: Clock summary at [2017-07-07 Fri 22:03]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *9:59* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 9:59   |      |      | 100.0 |
| Active                                                                      |        | 9:59 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:45 |   7.5 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 0:24 |   4.0 |
| COMPLETED Implement the context class                                       |        |      | 1:12 |  12.0 |
| COMPLETED Implement the exogenous transformation chain                      |        |      | 4:11 |  41.9 |
| COMPLETED Implement the pre-processing chain                                |        |      | 1:35 |  15.9 |
| COMPLETED Refactor mapping repository factory                               |        |      | 0:12 |   2.0 |
| COMPLETED Implement the output languages transform                          |        |      | 0:37 |   6.2 |
| COMPLETED Use forward declaration for context                               |        |      | 0:20 |   3.3 |
| STARTED Implement the references chain                                      |        |      | 0:43 |   7.2 |
...
*** STARTED Implement the references chain                            :story:
