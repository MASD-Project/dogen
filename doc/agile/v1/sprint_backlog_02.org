...
#+CAPTION: Clock summary at [2017-07-08 Sat 20:59]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *14:57* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 14:57   |       |      | 100.0 |
| Active                                                                      |         | 14:57 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:48 |   5.4 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:24 |   2.7 |
| COMPLETED Implement the context class                                       |         |       | 1:12 |   8.0 |
| COMPLETED Implement the exogenous transformation chain                      |         |       | 4:11 |  28.0 |
| COMPLETED Implement the pre-processing chain                                |         |       | 1:35 |  10.6 |
...
| COMPLETED Implement the references chain                                    |         |       | 2:43 |  18.2 |
...
| STARTED Implement the post-processing chain                                 |         |       | 1:12 |   8.0 |
