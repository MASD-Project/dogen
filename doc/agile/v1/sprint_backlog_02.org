...
#+CAPTION: Clock summary at [2017-07-07 Fri 15:41]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *8:56* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 8:56   |      |      | 100.0 |
| Active                                                                      |        | 8:56 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:45 |   8.4 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 0:24 |   4.5 |
| COMPLETED Implement the context class                                       |        |      | 1:12 |  13.4 |
| COMPLETED Implement the exogenous transformation chain                      |        |      | 4:11 |  46.8 |
| COMPLETED Implement the pre-processing chain                                |        |      | 1:35 |  17.7 |
| COMPLETED Refactor mapping repository factory                               |        |      | 0:12 |   2.2 |
| COMPLETED Implement the output languages transform                          |        |      | 0:37 |   6.9 |
...
*** Use forward declaration for context                               :story:
