...
#+CAPTION: Clock summary at [2017-07-15 Sat 23:53]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| COMPLETED Implement the exogenous transformation chain                      |         |       | 4:11 |   9.3 |
...
| COMPLETED Implement the post-processing chain                               |         |       | 3:31 |   7.8 |
...
| COMPLETED Move all data types into its own namespace                        |         |       | 9:00 |  20.1 |
