...
#+CAPTION: Clock summary at [2017-07-09 Sun 15:39]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *20:08* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 20:08   |       |      | 100.0 |
| Active                                                                      |         | 20:08 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:48 |   4.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:24 |   2.0 |
| COMPLETED Implement the context class                                       |         |       | 1:12 |   6.0 |
| COMPLETED Implement the exogenous transformation chain                      |         |       | 4:11 |  20.8 |
| COMPLETED Implement the pre-processing chain                                |         |       | 1:35 |   7.9 |
...
| COMPLETED Implement the references chain                                    |         |       | 2:43 |  13.5 |
...
| COMPLETED Implement the post-processing chain                               |         |       | 3:31 |  17.5 |
| COMPLETED Move helpers from =transforms= namespace                          |         |       | 0:45 |   3.7 |
| COMPLETED Replace expanders with transforms                                 |         |       | 0:03 |   0.2 |
| COMPLETED Port all expander unit tests to transforms                        |         |       | 0:42 |   3.5 |
| COMPLETED Remove all legacy classes from yarn                               |         |       | 0:55 |   4.6 |
| STARTED Move helpers from main namespace                                    |         |       | 0:27 |   2.2 |
...
*** STARTED Move helpers from main namespace                          :story:
