...
#+CAPTION: Clock summary at [2017-07-14 Fri 10:38]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *35:45* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 35:45   |       |      | 100.0 |
| Active                                                                      |         | 35:45 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:48 |   2.2 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:24 |   1.1 |
| COMPLETED Implement the context class                                       |         |       | 1:12 |   3.4 |
| COMPLETED Implement the exogenous transformation chain                      |         |       | 4:11 |  11.7 |
| COMPLETED Implement the pre-processing chain                                |         |       | 1:35 |   4.4 |
...
| COMPLETED Implement the references chain                                    |         |       | 2:43 |   7.6 |
...
| COMPLETED Implement the post-processing chain                               |         |       | 3:31 |   9.8 |
| COMPLETED Move helpers from =transforms= namespace                          |         |       | 0:45 |   2.1 |
...
| COMPLETED Move helpers from main yarn namespace                             |         |       | 1:29 |   4.1 |
| COMPLETED Move all data types into its own namespace                        |         |       | 9:00 |  25.2 |
| CANCELLED Move artefacts from formatters into meta-model                    |         |       | 0:54 |   2.5 |
| CANCELLED Use transformation context in quilt                               |         |       | 0:20 |   0.9 |
| COMPLETED Create an options validator                                       |         |       | 0:39 |   1.8 |
| STARTED Implement the code-generation chain                                 |         |       | 2:56 |   8.2 |
