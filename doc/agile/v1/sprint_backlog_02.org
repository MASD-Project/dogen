...
#+CAPTION: Clock summary at [2017-07-08 Sat 22:57]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *16:03* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 16:03   |       |      | 100.0 |
| Active                                                                      |         | 16:03 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:48 |   5.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:24 |   2.5 |
| COMPLETED Implement the context class                                       |         |       | 1:12 |   7.5 |
| COMPLETED Implement the exogenous transformation chain                      |         |       | 4:11 |  26.1 |
| COMPLETED Implement the pre-processing chain                                |         |       | 1:35 |   9.9 |
| COMPLETED Refactor mapping repository factory                               |         |       | 0:12 |   1.2 |
| COMPLETED Implement the output languages transform                          |         |       | 0:37 |   3.8 |
| COMPLETED Use forward declaration for context                               |         |       | 0:20 |   2.1 |
| COMPLETED Implement the references chain                                    |         |       | 2:43 |  16.9 |
| COMPLETED Implement the merge transform                                     |         |       | 0:40 |   4.2 |
| COMPLETED Implement the model generation chain                              |         |       | 0:13 |   1.3 |
| COMPLETED Implement the model assembly chain                                |         |       | 0:50 |   5.2 |
| STARTED Implement the post-processing chain                                 |         |       | 2:18 |  14.3 |
