...
#+CAPTION: Clock summary at [2017-07-07 Fri 14:50]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *8:07* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 8:07   |      |      | 100.0 |
| Active                                                                      |        | 8:07 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:45 |   9.2 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 0:24 |   4.9 |
| COMPLETED Implement the context class                                       |        |      | 1:12 |  14.8 |
| COMPLETED Implement the exogenous transformation chain                      |        |      | 4:11 |  51.5 |
| COMPLETED Implement the pre-processing chain                                |        |      | 1:35 |  19.5 |
