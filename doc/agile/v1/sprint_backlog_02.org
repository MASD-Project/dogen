...
#+CAPTION: Clock summary at [2017-07-09 Sun 13:52]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *18:36* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 18:36   |       |      | 100.0 |
| Active                                                                      |         | 18:36 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:48 |   4.3 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:24 |   2.2 |
| COMPLETED Implement the context class                                       |         |       | 1:12 |   6.5 |
| COMPLETED Implement the exogenous transformation chain                      |         |       | 4:11 |  22.5 |
...
| COMPLETED Implement the references chain                                    |         |       | 2:43 |  14.6 |
...
| COMPLETED Implement the post-processing chain                               |         |       | 3:31 |  18.9 |
| COMPLETED Move helpers from =transforms= namespace                          |         |       | 0:45 |   4.0 |
| COMPLETED Replace expanders with transforms                                 |         |       | 0:03 |   0.3 |
| STARTED Port all expander unit tests to transforms                          |         |       | 0:12 |   1.1 |
