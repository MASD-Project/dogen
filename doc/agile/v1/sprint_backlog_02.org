...
#+CAPTION: Clock summary at [2017-07-09 Sun 16:21]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *20:44* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 20:44   |       |      | 100.0 |
| Active                                                                      |         | 20:44 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:48 |   3.9 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:24 |   1.9 |
| COMPLETED Implement the context class                                       |         |       | 1:12 |   5.8 |
| COMPLETED Implement the exogenous transformation chain                      |         |       | 4:11 |  20.2 |
| COMPLETED Implement the pre-processing chain                                |         |       | 1:35 |   7.6 |
...
| COMPLETED Implement the references chain                                    |         |       | 2:43 |  13.1 |
...
| COMPLETED Implement the post-processing chain                               |         |       | 3:31 |  17.0 |
...
| STARTED Move helpers from main namespace                                    |         |       | 0:17 |   1.4 |
