...
#+CAPTION: Clock summary at [2017-07-14 Fri 22:29]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *42:38* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 42:38   |       |      | 100.0 |
| Active                                                                      |         | 42:38 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:07 |   2.6 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:24 |   0.9 |
| COMPLETED Implement the context class                                       |         |       | 1:12 |   2.8 |
| COMPLETED Implement the exogenous transformation chain                      |         |       | 4:11 |   9.8 |
| COMPLETED Implement the pre-processing chain                                |         |       | 1:35 |   3.7 |
...
| COMPLETED Implement the references chain                                    |         |       | 2:43 |   6.4 |
...
| COMPLETED Implement the post-processing chain                               |         |       | 3:31 |   8.2 |
...
| COMPLETED Move all data types into its own namespace                        |         |       | 9:00 |  21.1 |
