...
#+CAPTION: Clock summary at [2017-07-09 Sun 11:17]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *16:52* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 16:52   |       |      | 100.0 |
| Active                                                                      |         | 16:52 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:48 |   4.7 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:24 |   2.4 |
| COMPLETED Implement the context class                                       |         |       | 1:12 |   7.1 |
| COMPLETED Implement the exogenous transformation chain                      |         |       | 4:11 |  24.8 |
| COMPLETED Implement the pre-processing chain                                |         |       | 1:35 |   9.4 |
| COMPLETED Refactor mapping repository factory                               |         |       | 0:12 |   1.2 |
| COMPLETED Implement the output languages transform                          |         |       | 0:37 |   3.7 |
| COMPLETED Use forward declaration for context                               |         |       | 0:20 |   2.0 |
| COMPLETED Implement the references chain                                    |         |       | 2:43 |  16.1 |
| COMPLETED Implement the merge transform                                     |         |       | 0:40 |   4.0 |
| COMPLETED Implement the model generation chain                              |         |       | 0:13 |   1.3 |
| COMPLETED Implement the model assembly chain                                |         |       | 0:50 |   4.9 |
| STARTED Implement the post-processing chain                                 |         |       | 3:07 |  18.5 |
...
*** STARTED Implement the post-processing chain                       :story:
...
*** Replace expanders with transforms                                 :story:
...
transforms namespace and clean it up.

*** Remove all legacy classes from yarn                               :story:
