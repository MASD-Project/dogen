...
#+CAPTION: Clock summary at [2017-07-14 Fri 21:41]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *41:54* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 41:54   |       |      | 100.0 |
| Active                                                                      |         | 41:54 |      | 100.0 |
...
| COMPLETED Implement the exogenous transformation chain                      |         |       | 4:11 |  10.0 |
...
| COMPLETED Implement the post-processing chain                               |         |       | 3:31 |   8.4 |
...
| COMPLETED Move helpers from main yarn namespace                             |         |       | 1:29 |   3.5 |
| COMPLETED Move all data types into its own namespace                        |         |       | 9:00 |  21.5 |
| CANCELLED Move artefacts from formatters into meta-model                    |         |       | 0:54 |   2.1 |
| CANCELLED Use transformation context in quilt                               |         |       | 0:20 |   0.8 |
| COMPLETED Create an options validator                                       |         |       | 0:39 |   1.6 |
| COMPLETED Implement the code-generation chain                               |         |       | 4:33 |  10.9 |
| COMPLETED Fix options test break on windows                                 |         |       | 0:10 |   0.4 |
| COMPLETED Investigate why gcc builds are slower than clang                  |         |       | 1:03 |   2.5 |
