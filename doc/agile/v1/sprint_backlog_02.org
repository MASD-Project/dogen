...
#+CAPTION: Clock summary at [2017-07-09 Sun 16:40]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *21:02* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 21:02   |       |      | 100.0 |
| Active                                                                      |         | 21:02 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:48 |   3.8 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:24 |   1.9 |
| COMPLETED Implement the context class                                       |         |       | 1:12 |   5.7 |
| COMPLETED Implement the exogenous transformation chain                      |         |       | 4:11 |  19.9 |
| COMPLETED Implement the pre-processing chain                                |         |       | 1:35 |   7.5 |
| COMPLETED Refactor mapping repository factory                               |         |       | 0:12 |   1.0 |
| COMPLETED Implement the output languages transform                          |         |       | 0:37 |   2.9 |
| COMPLETED Use forward declaration for context                               |         |       | 0:20 |   1.6 |
| COMPLETED Implement the references chain                                    |         |       | 2:43 |  12.9 |
| COMPLETED Implement the merge transform                                     |         |       | 0:40 |   3.2 |
| COMPLETED Implement the model generation chain                              |         |       | 0:13 |   1.0 |
| COMPLETED Implement the model assembly chain                                |         |       | 0:50 |   4.0 |
| COMPLETED Implement the post-processing chain                               |         |       | 3:31 |  16.7 |
| COMPLETED Move helpers from =transforms= namespace                          |         |       | 0:45 |   3.6 |
| COMPLETED Replace expanders with transforms                                 |         |       | 0:03 |   0.2 |
| COMPLETED Port all expander unit tests to transforms                        |         |       | 0:42 |   3.3 |
| COMPLETED Remove all legacy classes from yarn                               |         |       | 0:55 |   4.4 |
| COMPLETED Implement the mapper as a transform                               |         |       | 0:46 |   3.6 |
| STARTED Move helpers from main yarn namespace                               |         |       | 0:35 |   2.8 |
...
*** STARTED Move helpers from main yarn namespace                     :story:
