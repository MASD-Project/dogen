...
#+CAPTION: Clock summary at [2017-07-08 Sat 21:30]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *15:23* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 15:23   |       |      | 100.0 |
| Active                                                                      |         | 15:23 |      | 100.0 |
...
| COMPLETED Implement the exogenous transformation chain                      |         |       | 4:11 |  27.2 |
| COMPLETED Implement the pre-processing chain                                |         |       | 1:35 |  10.3 |
...
| COMPLETED Implement the references chain                                    |         |       | 2:43 |  17.7 |
...
| STARTED Implement the post-processing chain                                 |         |       | 1:38 |  10.6 |
