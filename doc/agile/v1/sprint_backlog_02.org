...
#+CAPTION: Clock summary at [2017-07-09 Sun 11:00]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *16:37* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 16:37   |       |      | 100.0 |
| Active                                                                      |         | 16:37 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:48 |   4.8 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:24 |   2.4 |
| COMPLETED Implement the context class                                       |         |       | 1:12 |   7.2 |
| COMPLETED Implement the exogenous transformation chain                      |         |       | 4:11 |  25.2 |
| COMPLETED Implement the pre-processing chain                                |         |       | 1:35 |   9.5 |
...
| COMPLETED Implement the references chain                                    |         |       | 2:43 |  16.3 |
| COMPLETED Implement the merge transform                                     |         |       | 0:40 |   4.0 |
| COMPLETED Implement the model generation chain                              |         |       | 0:13 |   1.3 |
| COMPLETED Implement the model assembly chain                                |         |       | 0:50 |   5.0 |
| STARTED Implement the post-processing chain                                 |         |       | 2:52 |  17.3 |
