...
#+CAPTION: Clock summary at [2017-07-07 Fri 12:08]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *6:02* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 6:02   |      |      | 100.0 |
| Active                                                                      |        | 6:02 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:45 |  12.4 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 0:24 |   6.6 |
| COMPLETED Implement the context class                                       |        |      | 1:12 |  19.9 |
| STARTED Implement the exogenous transformation chain                        |        |      | 3:41 |  61.0 |
...
*** STARTED Implement the exogenous transformation chain              :story:
