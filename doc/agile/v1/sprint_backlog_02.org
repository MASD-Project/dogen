...
#+CAPTION: Clock summary at [2017-07-07 Fri 13:27]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *6:59* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 6:59   |      |      | 100.0 |
| Active                                                                      |        | 6:59 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:45 |  10.7 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 0:24 |   5.7 |
| COMPLETED Implement the context class                                       |        |      | 1:12 |  17.2 |
| COMPLETED Implement the exogenous transformation chain                      |        |      | 4:11 |  59.9 |
| STARTED Implement the pre-processing chain                                  |        |      | 0:27 |   6.4 |
