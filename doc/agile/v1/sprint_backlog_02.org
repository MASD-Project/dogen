...
#+CAPTION: Clock summary at [2017-07-09 Sun 11:41]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *17:16* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 17:16   |       |      | 100.0 |
| Active                                                                      |         | 17:16 |      | 100.0 |
...
| COMPLETED Implement the exogenous transformation chain                      |         |       | 4:11 |  24.2 |
| COMPLETED Implement the pre-processing chain                                |         |       | 1:35 |   9.2 |
...
| COMPLETED Implement the references chain                                    |         |       | 2:43 |  15.7 |
| COMPLETED Implement the merge transform                                     |         |       | 0:40 |   3.9 |
| COMPLETED Implement the model generation chain                              |         |       | 0:13 |   1.3 |
| COMPLETED Implement the model assembly chain                                |         |       | 0:50 |   4.8 |
| COMPLETED Implement the post-processing chain                               |         |       | 3:31 |  20.4 |
...
*** Move helpers from =transforms= namespace                          :story:
