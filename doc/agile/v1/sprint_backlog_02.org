...
#+CAPTION: Clock summary at [2017-07-14 Fri 09:56]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| COMPLETED Implement the exogenous transformation chain                      |         |       | 4:11 |  11.9 |
| COMPLETED Implement the pre-processing chain                                |         |       | 1:35 |   4.5 |
...
| COMPLETED Implement the references chain                                    |         |       | 2:43 |   7.7 |
...
| COMPLETED Implement the post-processing chain                               |         |       | 3:31 |  10.0 |
...
| COMPLETED Move helpers from main yarn namespace                             |         |       | 1:29 |   4.2 |
| COMPLETED Move all data types into its own namespace                        |         |       | 9:00 |  25.6 |
| CANCELLED Move artefacts from formatters into meta-model                    |         |       | 0:54 |   2.6 |
| CANCELLED Use transformation context in quilt                               |         |       | 0:20 |   0.9 |
| STARTED Implement the code-generation chain                                 |         |       | 2:56 |   8.4 |
