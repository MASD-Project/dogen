...
#+CAPTION: Clock summary at [2017-07-09 Sun 14:07]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *18:50* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 18:50   |       |      | 100.0 |
| Active                                                                      |         | 18:50 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:48 |   4.2 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:24 |   2.1 |
| COMPLETED Implement the context class                                       |         |       | 1:12 |   6.4 |
| COMPLETED Implement the exogenous transformation chain                      |         |       | 4:11 |  22.2 |
| COMPLETED Implement the pre-processing chain                                |         |       | 1:35 |   8.4 |
| COMPLETED Refactor mapping repository factory                               |         |       | 0:12 |   1.1 |
| COMPLETED Implement the output languages transform                          |         |       | 0:37 |   3.3 |
| COMPLETED Use forward declaration for context                               |         |       | 0:20 |   1.8 |
| COMPLETED Implement the references chain                                    |         |       | 2:43 |  14.4 |
...
| COMPLETED Implement the post-processing chain                               |         |       | 3:31 |  18.7 |
| COMPLETED Move helpers from =transforms= namespace                          |         |       | 0:45 |   4.0 |
| COMPLETED Replace expanders with transforms                                 |         |       | 0:03 |   0.3 |
| STARTED Port all expander unit tests to transforms                          |         |       | 0:26 |   2.3 |
| STARTED Remove all legacy classes from yarn                                 |         |       | 0:20 |   1.8 |
