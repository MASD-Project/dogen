...
#+CAPTION: Clock summary at [2017-07-08 Sat 17:19]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 12:02   |       |      | 100.0 |
| Active                                                                      |         | 12:02 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:48 |   6.6 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:24 |   3.3 |
| COMPLETED Implement the context class                                       |         |       | 1:12 |  10.0 |
| COMPLETED Implement the exogenous transformation chain                      |         |       | 4:11 |  34.8 |
| COMPLETED Implement the pre-processing chain                                |         |       | 1:35 |  13.2 |
| COMPLETED Refactor mapping repository factory                               |         |       | 0:12 |   1.7 |
| COMPLETED Implement the output languages transform                          |         |       | 0:37 |   5.1 |
| COMPLETED Use forward declaration for context                               |         |       | 0:20 |   2.8 |
| COMPLETED Implement the references chain                                    |         |       | 2:43 |  22.6 |
...
*** Implement the model assembly chain                                :story:
