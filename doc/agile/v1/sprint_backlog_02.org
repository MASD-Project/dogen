...
#+CAPTION: Clock summary at [2017-07-14 Fri 15:45]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *40:18* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 40:18   |       |      | 100.0 |
| Active                                                                      |         | 40:18 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:07 |   2.8 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:24 |   1.0 |
| COMPLETED Implement the context class                                       |         |       | 1:12 |   3.0 |
| COMPLETED Implement the exogenous transformation chain                      |         |       | 4:11 |  10.4 |
...
| COMPLETED Implement the merge transform                                     |         |       | 0:40 |   1.7 |
| COMPLETED Implement the model generation chain                              |         |       | 0:13 |   0.5 |
| COMPLETED Implement the model assembly chain                                |         |       | 0:50 |   2.1 |
| COMPLETED Implement the post-processing chain                               |         |       | 3:31 |   8.7 |
| COMPLETED Move helpers from =transforms= namespace                          |         |       | 0:45 |   1.9 |
| COMPLETED Replace expanders with transforms                                 |         |       | 0:03 |   0.1 |
| COMPLETED Port all expander unit tests to transforms                        |         |       | 0:42 |   1.7 |
| COMPLETED Remove all legacy classes from yarn                               |         |       | 0:55 |   2.3 |
| COMPLETED Implement the mapper as a transform                               |         |       | 0:46 |   1.9 |
| COMPLETED Move helpers from main yarn namespace                             |         |       | 1:29 |   3.7 |
| COMPLETED Move all data types into its own namespace                        |         |       | 9:00 |  22.3 |
...
| COMPLETED Implement the code-generation chain                               |         |       | 4:33 |  11.3 |
| COMPLETED Fix options test break on windows                                 |         |       | 0:10 |   0.4 |
| STARTED Move enablement into yarn                                           |         |       | 2:27 |   6.1 |
