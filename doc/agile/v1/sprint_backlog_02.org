...
#+CAPTION: Clock summary at [2017-07-08 Sat 21:11]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *15:08* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 15:08   |       |      | 100.0 |
| Active                                                                      |         | 15:08 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:48 |   5.3 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:24 |   2.6 |
| COMPLETED Implement the context class                                       |         |       | 1:12 |   7.9 |
| COMPLETED Implement the exogenous transformation chain                      |         |       | 4:11 |  27.6 |
| COMPLETED Implement the pre-processing chain                                |         |       | 1:35 |  10.5 |
| COMPLETED Refactor mapping repository factory                               |         |       | 0:12 |   1.3 |
| COMPLETED Implement the output languages transform                          |         |       | 0:37 |   4.1 |
| COMPLETED Use forward declaration for context                               |         |       | 0:20 |   2.2 |
| COMPLETED Implement the references chain                                    |         |       | 2:43 |  18.0 |
| COMPLETED Implement the merge transform                                     |         |       | 0:40 |   4.4 |
| COMPLETED Implement the model generation chain                              |         |       | 0:13 |   1.4 |
| COMPLETED Implement the model assembly chain                                |         |       | 0:50 |   5.5 |
| STARTED Implement the post-processing chain                                 |         |       | 1:23 |   9.1 |
