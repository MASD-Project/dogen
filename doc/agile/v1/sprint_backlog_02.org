...
#+CAPTION: Clock summary at [2017-07-09 Sun 12:24]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *17:55* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 17:55   |       |      | 100.0 |
| Active                                                                      |         | 17:55 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:48 |   4.5 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:24 |   2.2 |
| COMPLETED Implement the context class                                       |         |       | 1:12 |   6.7 |
| COMPLETED Implement the exogenous transformation chain                      |         |       | 4:11 |  23.3 |
...
| COMPLETED Implement the references chain                                    |         |       | 2:43 |  15.2 |
...
| COMPLETED Implement the post-processing chain                               |         |       | 3:31 |  19.6 |
| STARTED Move helpers from =transforms= namespace                            |         |       | 0:39 |   3.6 |
