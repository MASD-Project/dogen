...
#+CAPTION: Clock summary at [2017-07-14 Fri 13:43]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *38:22* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 38:22   |       |      | 100.0 |
| Active                                                                      |         | 38:22 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:07 |   2.9 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:24 |   1.0 |
| COMPLETED Implement the context class                                       |         |       | 1:12 |   3.1 |
| COMPLETED Implement the exogenous transformation chain                      |         |       | 4:11 |  10.9 |
| COMPLETED Implement the pre-processing chain                                |         |       | 1:35 |   4.1 |
...
| COMPLETED Implement the references chain                                    |         |       | 2:43 |   7.1 |
...
| COMPLETED Implement the post-processing chain                               |         |       | 3:31 |   9.2 |
...
| COMPLETED Move all data types into its own namespace                        |         |       | 9:00 |  23.5 |
...
| COMPLETED Implement the code-generation chain                               |         |       | 4:33 |  11.9 |
| COMPLETED Fix options test break on windows                                 |         |       | 0:10 |   0.4 |
| STARTED Move enablement into yarn                                           |         |       | 0:31 |   1.3 |
