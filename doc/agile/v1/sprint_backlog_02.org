...
#+CAPTION: Clock summary at [2017-07-09 Sun 15:10]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 19:41   |       |      | 100.0 |
| Active                                                                      |         | 19:41 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:48 |   4.1 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:24 |   2.0 |
| COMPLETED Implement the context class                                       |         |       | 1:12 |   6.1 |
| COMPLETED Implement the exogenous transformation chain                      |         |       | 4:11 |  21.3 |
| COMPLETED Implement the pre-processing chain                                |         |       | 1:35 |   8.0 |
| COMPLETED Refactor mapping repository factory                               |         |       | 0:12 |   1.0 |
| COMPLETED Implement the output languages transform                          |         |       | 0:37 |   3.1 |
| COMPLETED Use forward declaration for context                               |         |       | 0:20 |   1.7 |
| COMPLETED Implement the references chain                                    |         |       | 2:43 |  13.8 |
| COMPLETED Implement the merge transform                                     |         |       | 0:40 |   3.4 |
| COMPLETED Implement the model generation chain                              |         |       | 0:13 |   1.1 |
| COMPLETED Implement the model assembly chain                                |         |       | 0:50 |   4.2 |
| COMPLETED Implement the post-processing chain                               |         |       | 3:31 |  17.9 |
| COMPLETED Move helpers from =transforms= namespace                          |         |       | 0:45 |   3.8 |
| COMPLETED Replace expanders with transforms                                 |         |       | 0:03 |   0.3 |
| COMPLETED Port all expander unit tests to transforms                        |         |       | 0:42 |   3.6 |
| COMPLETED Remove all legacy classes from yarn                               |         |       | 0:55 |   4.7 |
