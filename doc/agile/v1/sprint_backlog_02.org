...
#+CAPTION: Clock summary at [2017-07-08 Sat 20:53]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *14:52* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 14:52   |       |      | 100.0 |
| Active                                                                      |         | 14:52 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:48 |   5.4 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:24 |   2.7 |
| COMPLETED Implement the context class                                       |         |       | 1:12 |   8.1 |
| COMPLETED Implement the exogenous transformation chain                      |         |       | 4:11 |  28.1 |
| COMPLETED Implement the pre-processing chain                                |         |       | 1:35 |  10.7 |
...
| COMPLETED Implement the references chain                                    |         |       | 2:43 |  18.3 |
| COMPLETED Implement the merge transform                                     |         |       | 0:40 |   4.5 |
| COMPLETED Implement the model generation chain                              |         |       | 0:13 |   1.5 |
| COMPLETED Implement the model assembly chain                                |         |       | 0:50 |   5.6 |
| STARTED Implement the post-processing chain                                 |         |       | 1:07 |   7.5 |
