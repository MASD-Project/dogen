...
#+CAPTION: Clock summary at [2017-07-15 Sat 20:58]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| COMPLETED Implement the exogenous transformation chain                      |         |       | 4:11 |   9.6 |
...
| COMPLETED Implement the references chain                                    |         |       | 2:43 |   6.2 |
...
| COMPLETED Implement the post-processing chain                               |         |       | 3:31 |   8.1 |
...
| COMPLETED Move helpers from main yarn namespace                             |         |       | 1:29 |   3.4 |
| COMPLETED Move all data types into its own namespace                        |         |       | 9:00 |  20.6 |
