...
#+CAPTION: Clock summary at [2017-07-09 Sun 15:45]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *20:12* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 20:12   |       |      | 100.0 |
| Active                                                                      |         | 20:12 |      | 100.0 |
...
| COMPLETED Implement the exogenous transformation chain                      |         |       | 4:11 |  20.7 |
| COMPLETED Implement the pre-processing chain                                |         |       | 1:35 |   7.8 |
...
| COMPLETED Implement the references chain                                    |         |       | 2:43 |  13.4 |
...
| COMPLETED Implement the post-processing chain                               |         |       | 3:31 |  17.4 |
...
| STARTED Move helpers from main namespace                                    |         |       | 0:31 |   2.6 |
