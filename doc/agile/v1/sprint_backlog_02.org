...
#+CAPTION: Clock summary at [2017-07-14 Fri 17:47]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *40:51* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 40:51   |       |      | 100.0 |
| Active                                                                      |         | 40:51 |      | 100.0 |
...
| COMPLETED Implement the exogenous transformation chain                      |         |       | 4:11 |  10.2 |
| COMPLETED Implement the pre-processing chain                                |         |       | 1:35 |   3.9 |
...
| COMPLETED Implement the references chain                                    |         |       | 2:43 |   6.7 |
...
| COMPLETED Implement the post-processing chain                               |         |       | 3:31 |   8.6 |
...
| COMPLETED Implement the mapper as a transform                               |         |       | 0:46 |   1.9 |
| COMPLETED Move helpers from main yarn namespace                             |         |       | 1:29 |   3.6 |
| COMPLETED Move all data types into its own namespace                        |         |       | 9:00 |  22.0 |
...
| COMPLETED Implement the code-generation chain                               |         |       | 4:33 |  11.1 |
| COMPLETED Fix options test break on windows                                 |         |       | 0:10 |   0.4 |
| STARTED Move enablement into yarn                                           |         |       | 3:00 |   7.3 |
