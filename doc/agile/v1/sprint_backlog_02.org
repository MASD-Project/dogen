...
#+CAPTION: Clock summary at [2017-07-09 Sun 12:11]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 17:43   |       |      | 100.0 |
| Active                                                                      |         | 17:43 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:48 |   4.5 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:24 |   2.3 |
| COMPLETED Implement the context class                                       |         |       | 1:12 |   6.8 |
| COMPLETED Implement the exogenous transformation chain                      |         |       | 4:11 |  23.6 |
| COMPLETED Implement the pre-processing chain                                |         |       | 1:35 |   8.9 |
...
| COMPLETED Implement the references chain                                    |         |       | 2:43 |  15.3 |
| COMPLETED Implement the merge transform                                     |         |       | 0:40 |   3.8 |
| COMPLETED Implement the model generation chain                              |         |       | 0:13 |   1.2 |
| COMPLETED Implement the model assembly chain                                |         |       | 0:50 |   4.7 |
| COMPLETED Implement the post-processing chain                               |         |       | 3:31 |  19.8 |
| STARTED Move helpers from =transforms= namespace                            |         |       | 0:27 |   2.5 |
