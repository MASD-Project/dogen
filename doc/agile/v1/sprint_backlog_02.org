...
#+CAPTION: Clock summary at [2017-07-07 Fri 14:15]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *7:34* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 7:34   |      |      | 100.0 |
| Active                                                                      |        | 7:34 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:45 |   9.9 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 0:24 |   5.3 |
| COMPLETED Implement the context class                                       |        |      | 1:12 |  15.9 |
| COMPLETED Implement the exogenous transformation chain                      |        |      | 4:11 |  55.3 |
| STARTED Implement the pre-processing chain                                  |        |      | 1:02 |  13.7 |
...
*** STARTED Implement the pre-processing chain                        :story:
