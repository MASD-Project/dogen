...
#+CAPTION: Clock summary at [2017-07-08 Sat 21:17]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *15:13* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 15:13   |       |      | 100.0 |
| Active                                                                      |         | 15:13 |      | 100.0 |
...
| COMPLETED Implement the exogenous transformation chain                      |         |       | 4:11 |  27.5 |
| COMPLETED Implement the pre-processing chain                                |         |       | 1:35 |  10.4 |
...
| COMPLETED Implement the references chain                                    |         |       | 2:43 |  17.9 |
...
| STARTED Implement the post-processing chain                                 |         |       | 1:28 |   9.6 |
