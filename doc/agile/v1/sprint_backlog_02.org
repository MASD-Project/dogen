...
#+CAPTION: Clock summary at [2017-07-16 Sun 11:32]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| COMPLETED Move all data types into its own namespace                        |         |       | 9:00 |  19.4 |
...
| STARTED Move enablement into yarn                                           |         |       | 6:34 |  14.1 |
