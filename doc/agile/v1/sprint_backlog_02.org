...
#+CAPTION: Clock summary at [2017-07-09 Sun 13:57]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 18:41   |       |      | 100.0 |
| Active                                                                      |         | 18:41 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:48 |   4.3 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:24 |   2.1 |
| COMPLETED Implement the context class                                       |         |       | 1:12 |   6.4 |
| COMPLETED Implement the exogenous transformation chain                      |         |       | 4:11 |  22.4 |
| COMPLETED Implement the pre-processing chain                                |         |       | 1:35 |   8.5 |
...
| COMPLETED Implement the references chain                                    |         |       | 2:43 |  14.5 |
| COMPLETED Implement the merge transform                                     |         |       | 0:40 |   3.6 |
| COMPLETED Implement the model generation chain                              |         |       | 0:13 |   1.2 |
| COMPLETED Implement the model assembly chain                                |         |       | 0:50 |   4.5 |
| COMPLETED Implement the post-processing chain                               |         |       | 3:31 |  18.8 |
| COMPLETED Move helpers from =transforms= namespace                          |         |       | 0:45 |   4.0 |
| COMPLETED Replace expanders with transforms                                 |         |       | 0:03 |   0.3 |
| STARTED Port all expander unit tests to transforms                          |         |       | 0:17 |   1.5 |
