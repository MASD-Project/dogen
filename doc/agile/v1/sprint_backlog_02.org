...
#+CAPTION: Clock summary at [2017-07-09 Sun 11:57]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *17:30* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 17:30   |       |      | 100.0 |
| Active                                                                      |         | 17:30 |      | 100.0 |
...
| COMPLETED Implement the exogenous transformation chain                      |         |       | 4:11 |  23.9 |
| COMPLETED Implement the pre-processing chain                                |         |       | 1:35 |   9.0 |
| COMPLETED Refactor mapping repository factory                               |         |       | 0:12 |   1.1 |
| COMPLETED Implement the output languages transform                          |         |       | 0:37 |   3.5 |
| COMPLETED Use forward declaration for context                               |         |       | 0:20 |   1.9 |
| COMPLETED Implement the references chain                                    |         |       | 2:43 |  15.5 |
...
| COMPLETED Implement the post-processing chain                               |         |       | 3:31 |  20.1 |
| STARTED Move helpers from =transforms= namespace                            |         |       | 0:14 |   1.3 |
