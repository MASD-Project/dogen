...
#+CAPTION: Clock summary at [2017-07-16 Sun 11:19]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| COMPLETED Implement the references chain                                    |         |       | 2:43 |   5.9 |
...
| COMPLETED Move all data types into its own namespace                        |         |       | 9:00 |  19.5 |
...
| COMPLETED Create a transformation that expands artefact properties          |         |       | 0:37 |   1.3 |
| STARTED Move enablement into yarn                                           |         |       | 6:31 |  14.1 |
