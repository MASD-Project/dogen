...
#+CAPTION: Clock summary at [2017-07-07 Fri 21:19]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *9:16* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 9:16   |      |      | 100.0 |
| Active                                                                      |        | 9:16 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:45 |   8.1 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 0:24 |   4.3 |
| COMPLETED Implement the context class                                       |        |      | 1:12 |  12.9 |
| COMPLETED Implement the exogenous transformation chain                      |        |      | 4:11 |  45.1 |
| COMPLETED Implement the pre-processing chain                                |        |      | 1:35 |  17.1 |
| COMPLETED Refactor mapping repository factory                               |        |      | 0:12 |   2.2 |
| COMPLETED Implement the output languages transform                          |        |      | 0:37 |   6.7 |
| COMPLETED Use forward declaration for context                               |        |      | 0:20 |   3.6 |
