...
#+CAPTION: Clock summary at [2017-07-08 Sat 17:44]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 12:26   |       |      | 100.0 |
| Active                                                                      |         | 12:26 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:48 |   6.4 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:24 |   3.2 |
| COMPLETED Implement the context class                                       |         |       | 1:12 |   9.7 |
| COMPLETED Implement the exogenous transformation chain                      |         |       | 4:11 |  33.6 |
| COMPLETED Implement the pre-processing chain                                |         |       | 1:35 |  12.7 |
| COMPLETED Refactor mapping repository factory                               |         |       | 0:12 |   1.6 |
| COMPLETED Implement the output languages transform                          |         |       | 0:37 |   5.0 |
| COMPLETED Use forward declaration for context                               |         |       | 0:20 |   2.7 |
| COMPLETED Implement the references chain                                    |         |       | 2:43 |  21.8 |
| STARTED Implement the model assembly chain                                  |         |       | 0:11 |   1.5 |
...
*** Implement the merge transform                                     :story:
