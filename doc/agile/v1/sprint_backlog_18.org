...
#+CAPTION: Clock summary at [2019-05-21 Tue 13:46]
| <75>                                                   |         |       |      |       |
| Headline                                               | Time    |       |      |     % |
|--------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                           | *13:05* |       |      | 100.0 |
|--------------------------------------------------------+---------+-------+------+-------|
| Stories                                                | 13:05   |       |      | 100.0 |
| Active                                                 |         | 13:05 |      | 100.0 |
| Edit release notes for previous sprint                 |         |       | 3:37 |  27.6 |
| Create a video demo for the previous sprint's features |         |       | 3:46 |  28.8 |
| Sprint and product backlog grooming                    |         |       | 0:22 |   2.8 |
| Make wale templates meta-model elements                |         |       | 2:45 |  21.0 |
| Flatten the data directory                             |         |       | 1:11 |   9.0 |
| Rename =dogen::cpp::header_only= stereotypes           |         |       | 0:15 |   1.9 |
| Add code generation support to static configurations   |         |       | 1:09 |   8.8 |
