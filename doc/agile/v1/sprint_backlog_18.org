...
#+CAPTION: Clock summary at [2019-05-25 Sat 13:47]
| <75>                                                   |         |       |       |       |
| Headline                                               | Time    |       |       |     % |
|--------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                | 28:15   |       |       | 100.0 |
| Active                                                 |         | 28:15 |       | 100.0 |
| Edit release notes for previous sprint                 |         |       |  3:37 |  12.8 |
| Create a video demo for the previous sprint's features |         |       |  3:46 |  13.3 |
| Sprint and product backlog grooming                    |         |       |  1:18 |   4.6 |
| Make wale templates meta-model elements                |         |       |  2:45 |   9.7 |
| Flatten the data directory                             |         |       |  1:11 |   4.2 |
| Rename =dogen::cpp::header_only= stereotypes           |         |       |  0:15 |   0.9 |
| Rename coding model                                    |         |       |  2:17 |   8.1 |
| Windows build is failing on a number of tests          |         |       |  0:30 |   1.8 |
| Read variability papers                                |         |       |  0:56 |   3.3 |
| Add code generation support to static configurations   |         |       | 11:40 |  41.3 |
