...
#+CAPTION: Clock summary at [2019-05-25 Sat 11:35]
| <75>                                                   |         |       |       |       |
| Headline                                               | Time    |       |       |     % |
|--------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                           | *26:59* |       |       | 100.0 |
|--------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                | 26:59   |       |       | 100.0 |
| Active                                                 |         | 26:59 |       | 100.0 |
| Edit release notes for previous sprint                 |         |       |  3:37 |  13.4 |
| Create a video demo for the previous sprint's features |         |       |  3:46 |  14.0 |
| Sprint and product backlog grooming                    |         |       |  1:18 |   4.8 |
| Make wale templates meta-model elements                |         |       |  2:45 |  10.2 |
| Flatten the data directory                             |         |       |  1:11 |   4.4 |
| Rename =dogen::cpp::header_only= stereotypes           |         |       |  0:15 |   0.9 |
| Rename coding model                                    |         |       |  2:17 |   8.5 |
| Windows build is failing on a number of tests          |         |       |  0:30 |   1.9 |
| Read variability papers                                |         |       |  0:56 |   3.5 |
| Add code generation support to static configurations   |         |       | 10:24 |  38.5 |
