...
#+CAPTION: Clock summary at [2019-05-21 Tue 13:23]
| <75>                                                   |         |       |      |       |
| Headline                                               | Time    |       |      |     % |
|--------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                           | *12:44* |       |      | 100.0 |
|--------------------------------------------------------+---------+-------+------+-------|
| Stories                                                | 12:44   |       |      | 100.0 |
| Active                                                 |         | 12:44 |      | 100.0 |
| Edit release notes for previous sprint                 |         |       | 3:37 |  28.4 |
| Create a video demo for the previous sprint's features |         |       | 3:46 |  29.6 |
| Sprint and product backlog grooming                    |         |       | 0:22 |   2.9 |
| Make wale templates meta-model elements                |         |       | 2:45 |  21.6 |
| Flatten the data directory                             |         |       | 1:11 |   9.3 |
| Rename =dogen::cpp::header_only= stereotypes           |         |       | 0:15 |   2.0 |
| Add code generation support to static configurations   |         |       | 0:48 |   6.3 |
...
*** Add code generation support to static configurations              :story:
    :LOGBOOK:
