...
#+CAPTION: Clock summary at [2019-05-24 Fri 16:28]
| <75>                                                   |         |       |      |       |
| Headline                                               | Time    |       |      |     % |
|--------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                | 26:12   |       |      | 100.0 |
| Active                                                 |         | 26:12 |      | 100.0 |
| Edit release notes for previous sprint                 |         |       | 3:37 |  13.8 |
| Create a video demo for the previous sprint's features |         |       | 3:46 |  14.4 |
| Sprint and product backlog grooming                    |         |       | 1:08 |   4.3 |
| Make wale templates meta-model elements                |         |       | 2:45 |  10.5 |
| Flatten the data directory                             |         |       | 1:11 |   4.5 |
| Rename =dogen::cpp::header_only= stereotypes           |         |       | 0:15 |   1.0 |
| Rename coding model                                    |         |       | 2:17 |   8.7 |
| Windows build is failing on a number of tests          |         |       | 0:30 |   1.9 |
| Read variability papers                                |         |       | 0:56 |   3.6 |
| Add code generation support to static configurations   |         |       | 9:47 |  37.3 |
