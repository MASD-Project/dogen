...
#+CAPTION: Clock summary at [2019-05-31 Fri 14:08]
| <75>                                                   |         |       |       |       |
| Headline                                               | Time    |       |       |     % |
|--------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                           | *48:45* |       |       | 100.0 |
|--------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                | 48:45   |       |       | 100.0 |
| Active                                                 |         | 48:45 |       | 100.0 |
| Edit release notes for previous sprint                 |         |       |  3:37 |   7.4 |
| Create a video demo for the previous sprint's features |         |       |  3:46 |   7.7 |
| Sprint and product backlog grooming                    |         |       |  3:02 |   6.2 |
| Make wale templates meta-model elements                |         |       |  2:45 |   5.6 |
| Flatten the data directory                             |         |       |  1:11 |   2.4 |
| Rename =dogen::cpp::header_only= stereotypes           |         |       |  0:15 |   0.5 |
| Rename coding model                                    |         |       |  2:17 |   4.7 |
| Windows build is failing on a number of tests          |         |       |  0:30 |   1.0 |
| Consider a test suite level logging flag               |         |       |  1:40 |   3.4 |
| Move parent processing to injection                    |         |       |  2:06 |   4.3 |
| Windows clang-cl release build is failing 4 tests      |         |       |  2:16 |   4.6 |
| Fix issues with nightly build and CI                   |         |       |  0:04 |   0.1 |
| Read variability papers                                |         |       |  0:56 |   1.9 |
| Add code generation support to static configurations   |         |       | 24:20 |  49.9 |
