...
#+CAPTION: Clock summary at [2019-05-21 Tue 13:55]
| <75>                                                   |         |       |      |       |
| Headline                                               | Time    |       |      |     % |
|--------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                | 13:13   |       |      | 100.0 |
| Active                                                 |         | 13:13 |      | 100.0 |
| Edit release notes for previous sprint                 |         |       | 3:37 |  27.4 |
| Create a video demo for the previous sprint's features |         |       | 3:46 |  28.5 |
| Sprint and product backlog grooming                    |         |       | 0:22 |   2.8 |
| Make wale templates meta-model elements                |         |       | 2:45 |  20.8 |
| Flatten the data directory                             |         |       | 1:11 |   9.0 |
| Rename =dogen::cpp::header_only= stereotypes           |         |       | 0:15 |   1.9 |
| Add code generation support to static configurations   |         |       | 1:17 |   9.7 |
