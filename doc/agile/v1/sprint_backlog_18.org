...
#+CAPTION: Clock summary at [2019-05-25 Sat 15:18]
| <75>                                                   |         |       |       |       |
| Headline                                               | Time    |       |       |     % |
|--------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                           | *29:44* |       |       | 100.0 |
|--------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                | 29:44   |       |       | 100.0 |
| Active                                                 |         | 29:44 |       | 100.0 |
| Edit release notes for previous sprint                 |         |       |  3:37 |  12.2 |
| Create a video demo for the previous sprint's features |         |       |  3:46 |  12.7 |
| Sprint and product backlog grooming                    |         |       |  1:18 |   4.4 |
| Make wale templates meta-model elements                |         |       |  2:45 |   9.2 |
| Flatten the data directory                             |         |       |  1:11 |   4.0 |
| Rename =dogen::cpp::header_only= stereotypes           |         |       |  0:15 |   0.8 |
| Rename coding model                                    |         |       |  2:17 |   7.7 |
| Windows build is failing on a number of tests          |         |       |  0:30 |   1.7 |
| Read variability papers                                |         |       |  0:56 |   3.1 |
| Add code generation support to static configurations   |         |       | 13:09 |  44.2 |
