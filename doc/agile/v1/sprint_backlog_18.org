...
#+CAPTION: Clock summary at [2019-05-30 Thu 22:05]
| <75>                                                   |         |       |       |       |
| Headline                                               | Time    |       |       |     % |
|--------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                           | *45:01* |       |       | 100.0 |
|--------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                | 45:01   |       |       | 100.0 |
| Active                                                 |         | 45:01 |       | 100.0 |
| Edit release notes for previous sprint                 |         |       |  3:37 |   8.0 |
| Create a video demo for the previous sprint's features |         |       |  3:46 |   8.4 |
| Sprint and product backlog grooming                    |         |       |  2:07 |   4.7 |
| Make wale templates meta-model elements                |         |       |  2:45 |   6.1 |
| Flatten the data directory                             |         |       |  1:11 |   2.6 |
| Rename =dogen::cpp::header_only= stereotypes           |         |       |  0:15 |   0.6 |
| Rename coding model                                    |         |       |  2:17 |   5.1 |
| Windows build is failing on a number of tests          |         |       |  0:30 |   1.1 |
| Consider a test suite level logging flag               |         |       |  1:40 |   3.7 |
| Move parent processing to injection                    |         |       |  2:06 |   4.7 |
| Read variability papers                                |         |       |  0:56 |   2.1 |
| Add code generation support to static configurations   |         |       | 21:56 |  48.7 |
| Windows clang-cl release build is failing 4 tests      |         |       |  1:55 |   4.3 |
