...
#+CAPTION: Clock summary at [2019-05-29 Wed 11:17]
| <75>                                                   |         |       |       |       |
| Headline                                               | Time    |       |       |     % |
|--------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                           | *33:09* |       |       | 100.0 |
|--------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                | 33:09   |       |       | 100.0 |
| Active                                                 |         | 33:09 |       | 100.0 |
| Edit release notes for previous sprint                 |         |       |  3:37 |  10.9 |
| Create a video demo for the previous sprint's features |         |       |  3:46 |  11.4 |
| Sprint and product backlog grooming                    |         |       |  2:07 |   6.4 |
| Make wale templates meta-model elements                |         |       |  2:45 |   8.3 |
| Flatten the data directory                             |         |       |  1:11 |   3.6 |
| Rename =dogen::cpp::header_only= stereotypes           |         |       |  0:15 |   0.8 |
| Rename coding model                                    |         |       |  2:17 |   6.9 |
| Windows build is failing on a number of tests          |         |       |  0:30 |   1.5 |
| Read variability papers                                |         |       |  0:56 |   2.8 |
| Add code generation support to static configurations   |         |       | 13:09 |  39.7 |
| Move parent processing to injection                    |         |       |  0:41 |   2.1 |
| Windows clang-cl release build is failing 4 tests      |         |       |  1:55 |   5.8 |
