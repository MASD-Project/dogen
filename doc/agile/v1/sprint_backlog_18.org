...
#+CAPTION: Clock summary at [2019-05-31 Fri 10:53]
| <75>                                                   |         |       |       |       |
| Headline                                               | Time    |       |       |     % |
|--------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                           | *46:41* |       |       | 100.0 |
|--------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                | 46:41   |       |       | 100.0 |
| Active                                                 |         | 46:41 |       | 100.0 |
| Edit release notes for previous sprint                 |         |       |  3:37 |   7.7 |
| Create a video demo for the previous sprint's features |         |       |  3:46 |   8.1 |
| Sprint and product backlog grooming                    |         |       |  3:02 |   6.5 |
| Make wale templates meta-model elements                |         |       |  2:45 |   5.9 |
| Flatten the data directory                             |         |       |  1:11 |   2.5 |
| Rename =dogen::cpp::header_only= stereotypes           |         |       |  0:15 |   0.5 |
| Rename coding model                                    |         |       |  2:17 |   4.9 |
| Windows build is failing on a number of tests          |         |       |  0:30 |   1.1 |
| Consider a test suite level logging flag               |         |       |  1:40 |   3.6 |
| Move parent processing to injection                    |         |       |  2:06 |   4.5 |
| Windows clang-cl release build is failing 4 tests      |         |       |  2:16 |   4.9 |
| Fix issues with nightly build and CI                   |         |       |  0:04 |   0.1 |
| Read variability papers                                |         |       |  0:56 |   2.0 |
| Add code generation support to static configurations   |         |       | 22:16 |  47.7 |
