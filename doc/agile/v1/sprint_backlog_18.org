...
#+CAPTION: Clock summary at [2019-05-25 Sat 11:48]
| <75>                                                   |         |       |       |       |
| Headline                                               | Time    |       |       |     % |
|--------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                | 27:12   |       |       | 100.0 |
| Active                                                 |         | 27:12 |       | 100.0 |
| Edit release notes for previous sprint                 |         |       |  3:37 |  13.3 |
| Create a video demo for the previous sprint's features |         |       |  3:46 |  13.8 |
| Sprint and product backlog grooming                    |         |       |  1:18 |   4.8 |
| Make wale templates meta-model elements                |         |       |  2:45 |  10.1 |
| Flatten the data directory                             |         |       |  1:11 |   4.4 |
| Rename =dogen::cpp::header_only= stereotypes           |         |       |  0:15 |   0.9 |
| Rename coding model                                    |         |       |  2:17 |   8.4 |
| Windows build is failing on a number of tests          |         |       |  0:30 |   1.8 |
| Read variability papers                                |         |       |  0:56 |   3.4 |
| Add code generation support to static configurations   |         |       | 10:37 |  39.0 |
