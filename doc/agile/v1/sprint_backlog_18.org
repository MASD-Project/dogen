...
#+CAPTION: Clock summary at [2019-06-01 Sat 12:34]
| <75>                                                   |         |       |       |       |
| Headline                                               | Time    |       |       |     % |
|--------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                           | *51:59* |       |       | 100.0 |
|--------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                | 51:59   |       |       | 100.0 |
| Active                                                 |         | 51:59 |       | 100.0 |
| Edit release notes for previous sprint                 |         |       |  3:37 |   7.0 |
| Create a video demo for the previous sprint's features |         |       |  3:46 |   7.2 |
| Sprint and product backlog grooming                    |         |       |  3:32 |   6.8 |
| Make wale templates meta-model elements                |         |       |  2:45 |   5.3 |
| Flatten the data directory                             |         |       |  1:11 |   2.3 |
| Rename =dogen::cpp::header_only= stereotypes           |         |       |  0:15 |   0.5 |
| Rename coding model                                    |         |       |  2:17 |   4.4 |
| Windows build is failing on a number of tests          |         |       |  0:30 |   1.0 |
| Consider a test suite level logging flag               |         |       |  1:40 |   3.2 |
| Move parent processing to injection                    |         |       |  2:06 |   4.0 |
| Windows clang-cl release build is failing 4 tests      |         |       |  2:16 |   4.4 |
| Fix issues with nightly build and CI                   |         |       |  0:04 |   0.1 |
| Read variability papers                                |         |       |  0:56 |   1.8 |
| Use generated static configurations in transforms      |         |       | 27:04 |  52.1 |
