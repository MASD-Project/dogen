...
#+CAPTION: Clock summary at [2019-05-31 Fri 12:03]
| <75>                                                   |         |       |       |       |
| Headline                                               | Time    |       |       |     % |
|--------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                           | *47:49* |       |       | 100.0 |
|--------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                | 47:49   |       |       | 100.0 |
| Active                                                 |         | 47:49 |       | 100.0 |
| Edit release notes for previous sprint                 |         |       |  3:37 |   7.6 |
| Create a video demo for the previous sprint's features |         |       |  3:46 |   7.9 |
| Sprint and product backlog grooming                    |         |       |  3:02 |   6.3 |
...
| Windows clang-cl release build is failing 4 tests      |         |       |  2:16 |   4.7 |
| Fix issues with nightly build and CI                   |         |       |  0:04 |   0.1 |
| Read variability papers                                |         |       |  0:56 |   2.0 |
| Add code generation support to static configurations   |         |       | 23:24 |  48.9 |
