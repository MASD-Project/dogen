...
#+CAPTION: Clock summary at [2019-05-30 Thu 12:06]
| <75>                                                   |         |       |       |       |
| Headline                                               | Time    |       |       |     % |
|--------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                | 37:59   |       |       | 100.0 |
| Active                                                 |         | 37:59 |       | 100.0 |
| Edit release notes for previous sprint                 |         |       |  3:37 |   9.5 |
| Create a video demo for the previous sprint's features |         |       |  3:46 |   9.9 |
| Sprint and product backlog grooming                    |         |       |  2:07 |   5.6 |
| Make wale templates meta-model elements                |         |       |  2:45 |   7.2 |
| Flatten the data directory                             |         |       |  1:11 |   3.1 |
| Rename =dogen::cpp::header_only= stereotypes           |         |       |  0:15 |   0.7 |
| Rename coding model                                    |         |       |  2:17 |   6.0 |
| Windows build is failing on a number of tests          |         |       |  0:30 |   1.3 |
| Consider a test suite level logging flag               |         |       |  1:40 |   4.4 |
| Move parent processing to injection                    |         |       |  2:06 |   5.5 |
| Read variability papers                                |         |       |  0:56 |   2.5 |
| Add code generation support to static configurations   |         |       | 14:54 |  39.2 |
| Windows clang-cl release build is failing 4 tests      |         |       |  1:55 |   5.0 |
