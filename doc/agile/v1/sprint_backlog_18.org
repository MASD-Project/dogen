...
#+CAPTION: Clock summary at [2019-05-24 Fri 09:31]
| <75>                                                   |         |       |      |       |
| Headline                                               | Time    |       |      |     % |
|--------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                | 21:07   |       |      | 100.0 |
| Active                                                 |         | 21:07 |      | 100.0 |
| Edit release notes for previous sprint                 |         |       | 3:37 |  17.1 |
| Create a video demo for the previous sprint's features |         |       | 3:46 |  17.8 |
| Sprint and product backlog grooming                    |         |       | 1:08 |   5.4 |
| Make wale templates meta-model elements                |         |       | 2:45 |  13.0 |
| Flatten the data directory                             |         |       | 1:11 |   5.6 |
| Rename =dogen::cpp::header_only= stereotypes           |         |       | 0:15 |   1.2 |
| Rename coding model                                    |         |       | 2:17 |  10.8 |
| Windows build is failing on a number of tests          |         |       | 0:30 |   2.4 |
| Read variability papers                                |         |       | 0:56 |   4.4 |
| Add code generation support to static configurations   |         |       | 4:42 |  22.3 |
