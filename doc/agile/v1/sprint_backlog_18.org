...
#+CAPTION: Clock summary at [2019-05-30 Thu 18:31]
| <75>                                                   |         |       |       |       |
| Headline                                               | Time    |       |       |     % |
|--------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                           | *42:08* |       |       | 100.0 |
|--------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                | 42:08   |       |       | 100.0 |
| Active                                                 |         | 42:08 |       | 100.0 |
| Edit release notes for previous sprint                 |         |       |  3:37 |   8.6 |
| Create a video demo for the previous sprint's features |         |       |  3:46 |   8.9 |
| Sprint and product backlog grooming                    |         |       |  2:07 |   5.0 |
| Make wale templates meta-model elements                |         |       |  2:45 |   6.5 |
| Flatten the data directory                             |         |       |  1:11 |   2.8 |
| Rename =dogen::cpp::header_only= stereotypes           |         |       |  0:15 |   0.6 |
| Rename coding model                                    |         |       |  2:17 |   5.4 |
| Windows build is failing on a number of tests          |         |       |  0:30 |   1.2 |
| Consider a test suite level logging flag               |         |       |  1:40 |   4.0 |
| Move parent processing to injection                    |         |       |  2:06 |   5.0 |
| Read variability papers                                |         |       |  0:56 |   2.2 |
| Add code generation support to static configurations   |         |       | 19:03 |  45.2 |
| Windows clang-cl release build is failing 4 tests      |         |       |  1:55 |   4.5 |
