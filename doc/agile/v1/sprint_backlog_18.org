...
#+CAPTION: Clock summary at [2019-05-24 Fri 15:41]
| <75>                                                   |         |       |      |       |
| Headline                                               | Time    |       |      |     % |
|--------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                | 25:27   |       |      | 100.0 |
| Active                                                 |         | 25:27 |      | 100.0 |
| Edit release notes for previous sprint                 |         |       | 3:37 |  14.2 |
| Create a video demo for the previous sprint's features |         |       | 3:46 |  14.8 |
| Sprint and product backlog grooming                    |         |       | 1:08 |   4.5 |
| Make wale templates meta-model elements                |         |       | 2:45 |  10.8 |
| Flatten the data directory                             |         |       | 1:11 |   4.6 |
| Rename =dogen::cpp::header_only= stereotypes           |         |       | 0:15 |   1.0 |
| Rename coding model                                    |         |       | 2:17 |   9.0 |
| Windows build is failing on a number of tests          |         |       | 0:30 |   2.0 |
| Read variability papers                                |         |       | 0:56 |   3.7 |
| Add code generation support to static configurations   |         |       | 9:02 |  35.5 |
...
*** STARTED Rename =masd.stitch.wale.text_template=                   :story:
