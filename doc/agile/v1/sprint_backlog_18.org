...
#+CAPTION: Clock summary at [2019-05-21 Tue 14:59]
| <75>                                                   |         |       |      |       |
| Headline                                               | Time    |       |      |     % |
|--------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                           | *14:10* |       |      | 100.0 |
|--------------------------------------------------------+---------+-------+------+-------|
| Stories                                                | 14:10   |       |      | 100.0 |
| Active                                                 |         | 14:10 |      | 100.0 |
| Edit release notes for previous sprint                 |         |       | 3:37 |  25.5 |
| Create a video demo for the previous sprint's features |         |       | 3:46 |  26.6 |
| Sprint and product backlog grooming                    |         |       | 0:22 |   2.6 |
| Make wale templates meta-model elements                |         |       | 2:45 |  19.4 |
| Flatten the data directory                             |         |       | 1:11 |   8.4 |
| Rename =dogen::cpp::header_only= stereotypes           |         |       | 0:15 |   1.8 |
| Add code generation support to static configurations   |         |       | 2:14 |  15.8 |
