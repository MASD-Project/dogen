...
#+CAPTION: Clock summary at [2019-05-21 Tue 08:47]
| <75>                                                   |        |      |      |       |
| Headline                                               | Time   |      |      |     % |
|--------------------------------------------------------+--------+------+------+-------|
| *Total time*                                           | *8:53* |      |      | 100.0 |
|--------------------------------------------------------+--------+------+------+-------|
| Stories                                                | 8:53   |      |      | 100.0 |
| Active                                                 |        | 8:53 |      | 100.0 |
| Edit release notes for previous sprint                 |        |      | 3:37 |  40.7 |
| Create a video demo for the previous sprint's features |        |      | 3:46 |  42.4 |
| Sprint and product backlog grooming                    |        |      | 0:16 |   3.0 |
| Make wale templates meta-model elements                |        |      | 1:14 |  13.9 |
