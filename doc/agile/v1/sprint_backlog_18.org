...
#+CAPTION: Clock summary at [2019-05-23 Thu 14:18]
| <75>                                                   |         |       |      |       |
| Headline                                               | Time    |       |      |     % |
|--------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                           | *20:21* |       |      | 100.0 |
|--------------------------------------------------------+---------+-------+------+-------|
| Stories                                                | 20:21   |       |      | 100.0 |
| Active                                                 |         | 20:21 |      | 100.0 |
| Edit release notes for previous sprint                 |         |       | 3:37 |  17.8 |
| Create a video demo for the previous sprint's features |         |       | 3:46 |  18.5 |
| Sprint and product backlog grooming                    |         |       | 0:54 |   4.4 |
| Make wale templates meta-model elements                |         |       | 2:45 |  13.5 |
| Flatten the data directory                             |         |       | 1:11 |   5.8 |
| Rename =dogen::cpp::header_only= stereotypes           |         |       | 0:15 |   1.2 |
| Rename coding model                                    |         |       | 2:17 |  11.2 |
| Read variability papers                                |         |       | 0:56 |   4.6 |
| Add code generation support to static configurations   |         |       | 4:40 |  22.9 |
