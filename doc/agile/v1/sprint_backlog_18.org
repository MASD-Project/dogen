...
#+CAPTION: Clock summary at [2019-05-21 Tue 13:33]
| <75>                                                   |         |       |      |       |
| Headline                                               | Time    |       |      |     % |
|--------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                | 12:53   |       |      | 100.0 |
| Active                                                 |         | 12:53 |      | 100.0 |
| Edit release notes for previous sprint                 |         |       | 3:37 |  28.1 |
| Create a video demo for the previous sprint's features |         |       | 3:46 |  29.2 |
| Sprint and product backlog grooming                    |         |       | 0:22 |   2.8 |
| Make wale templates meta-model elements                |         |       | 2:45 |  21.3 |
| Flatten the data directory                             |         |       | 1:11 |   9.2 |
| Rename =dogen::cpp::header_only= stereotypes           |         |       | 0:15 |   1.9 |
| Add code generation support to static configurations   |         |       | 0:57 |   7.4 |
