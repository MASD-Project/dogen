...
#+CAPTION: Clock summary at [2019-05-25 Sat 17:54]
| <75>                                                   |         |       |       |       |
| Headline                                               | Time    |       |       |     % |
|--------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                           | *32:03* |       |       | 100.0 |
|--------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                | 32:03   |       |       | 100.0 |
| Active                                                 |         | 32:03 |       | 100.0 |
| Edit release notes for previous sprint                 |         |       |  3:37 |  11.3 |
| Create a video demo for the previous sprint's features |         |       |  3:46 |  11.8 |
| Sprint and product backlog grooming                    |         |       |  1:18 |   4.1 |
| Make wale templates meta-model elements                |         |       |  2:45 |   8.6 |
| Flatten the data directory                             |         |       |  1:11 |   3.7 |
| Rename =dogen::cpp::header_only= stereotypes           |         |       |  0:15 |   0.8 |
| Rename coding model                                    |         |       |  2:17 |   7.1 |
| Windows build is failing on a number of tests          |         |       |  0:30 |   1.6 |
| Read variability papers                                |         |       |  0:56 |   2.9 |
| Add code generation support to static configurations   |         |       | 13:09 |  41.0 |
| Move parent processing to injection                    |         |       |  0:24 |   1.2 |
| Windows clang-cl release build is failing 4 tests      |         |       |  1:55 |   6.0 |
