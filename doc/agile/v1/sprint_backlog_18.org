...
#+CAPTION: Clock summary at [2019-05-24 Fri 14:16]
| <75>                                                   |         |       |      |       |
| Headline                                               | Time    |       |      |     % |
|--------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                           | *22:53* |       |      | 100.0 |
|--------------------------------------------------------+---------+-------+------+-------|
| Stories                                                | 22:53   |       |      | 100.0 |
| Active                                                 |         | 22:53 |      | 100.0 |
| Edit release notes for previous sprint                 |         |       | 3:37 |  15.8 |
| Create a video demo for the previous sprint's features |         |       | 3:46 |  16.5 |
| Sprint and product backlog grooming                    |         |       | 1:08 |   5.0 |
| Make wale templates meta-model elements                |         |       | 2:45 |  12.0 |
| Flatten the data directory                             |         |       | 1:11 |   5.2 |
| Rename =dogen::cpp::header_only= stereotypes           |         |       | 0:15 |   1.1 |
| Rename coding model                                    |         |       | 2:17 |  10.0 |
| Windows build is failing on a number of tests          |         |       | 0:30 |   2.2 |
| Read variability papers                                |         |       | 0:56 |   4.1 |
| Add code generation support to static configurations   |         |       | 6:28 |  28.3 |
