...
#+CAPTION: Clock summary at [2019-06-01 Sat 17:57]
| <75>                                                   |         |       |       |       |
| Headline                                               | Time    |       |       |     % |
|--------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                           | *55:11* |       |       | 100.0 |
|--------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                | 55:11   |       |       | 100.0 |
| Active                                                 |         | 55:11 |       | 100.0 |
| Edit release notes for previous sprint                 |         |       |  3:37 |   6.6 |
| Create a video demo for the previous sprint's features |         |       |  3:46 |   6.8 |
| Sprint and product backlog grooming                    |         |       |  3:32 |   6.4 |
| Make wale templates meta-model elements                |         |       |  2:45 |   5.0 |
| Flatten the data directory                             |         |       |  1:11 |   2.1 |
| Rename =dogen::cpp::header_only= stereotypes           |         |       |  0:15 |   0.5 |
| Rename coding model                                    |         |       |  2:17 |   4.1 |
| Windows build is failing on a number of tests          |         |       |  0:30 |   0.9 |
| Consider a test suite level logging flag               |         |       |  1:40 |   3.0 |
| Move parent processing to injection                    |         |       |  2:06 |   3.8 |
| Use generated static configurations in transforms      |         |       | 30:16 |  54.8 |
| Windows clang-cl release build is failing 4 tests      |         |       |  2:16 |   4.1 |
| Fix issues with nightly build and CI                   |         |       |  0:04 |   0.1 |
| Read variability papers                                |         |       |  0:56 |   1.7 |
