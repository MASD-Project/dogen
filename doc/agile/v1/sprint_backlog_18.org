...
#+CAPTION: Clock summary at [2019-05-21 Tue 10:26]
| <75>                                                   |         |       |      |       |
| Headline                                               | Time    |       |      |     % |
|--------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                           | *10:30* |       |      | 100.0 |
|--------------------------------------------------------+---------+-------+------+-------|
| Stories                                                | 10:30   |       |      | 100.0 |
| Active                                                 |         | 10:30 |      | 100.0 |
| Edit release notes for previous sprint                 |         |       | 3:37 |  34.4 |
| Create a video demo for the previous sprint's features |         |       | 3:46 |  35.9 |
| Sprint and product backlog grooming                    |         |       | 0:22 |   3.5 |
| Make wale templates meta-model elements                |         |       | 2:45 |  26.2 |
...
*** Flatten the data directory                                        :story:
