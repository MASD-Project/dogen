...
#+CAPTION: Clock summary at [2019-05-29 Wed 15:47]
| <75>                                                   |         |       |       |       |
| Headline                                               | Time    |       |       |     % |
|--------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                | 35:26   |       |       | 100.0 |
| Active                                                 |         | 35:26 |       | 100.0 |
| Edit release notes for previous sprint                 |         |       |  3:37 |  10.2 |
| Create a video demo for the previous sprint's features |         |       |  3:46 |  10.6 |
| Sprint and product backlog grooming                    |         |       |  2:07 |   6.0 |
| Make wale templates meta-model elements                |         |       |  2:45 |   7.8 |
| Flatten the data directory                             |         |       |  1:11 |   3.3 |
| Rename =dogen::cpp::header_only= stereotypes           |         |       |  0:15 |   0.7 |
| Rename coding model                                    |         |       |  2:17 |   6.4 |
| Windows build is failing on a number of tests          |         |       |  0:30 |   1.4 |
| Consider a test suite level logging flag               |         |       |  1:40 |   4.7 |
| Read variability papers                                |         |       |  0:56 |   2.6 |
| Add code generation support to static configurations   |         |       | 13:09 |  37.1 |
| Move parent processing to injection                    |         |       |  1:18 |   3.7 |
| Windows clang-cl release build is failing 4 tests      |         |       |  1:55 |   5.4 |
...
*** STARTED Move parent processing to injection                       :story:
    :LOGBOOK:
