...
#+CAPTION: Clock summary at [2019-05-23 Thu 13:31]
| <75>                                                   |         |       |      |       |
| Headline                                               | Time    |       |      |     % |
|--------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                           | *19:38* |       |      | 100.0 |
|--------------------------------------------------------+---------+-------+------+-------|
| Stories                                                | 19:38   |       |      | 100.0 |
| Active                                                 |         | 19:38 |      | 100.0 |
| Edit release notes for previous sprint                 |         |       | 3:37 |  18.4 |
| Create a video demo for the previous sprint's features |         |       | 3:46 |  19.2 |
| Sprint and product backlog grooming                    |         |       | 0:54 |   4.6 |
| Make wale templates meta-model elements                |         |       | 2:45 |  14.0 |
| Flatten the data directory                             |         |       | 1:11 |   6.0 |
| Rename =dogen::cpp::header_only= stereotypes           |         |       | 0:15 |   1.3 |
| Rename coding model                                    |         |       | 2:17 |  11.6 |
| Read variability papers                                |         |       | 0:56 |   4.8 |
| Add code generation support to static configurations   |         |       | 3:57 |  20.1 |
