...
#+CAPTION: Clock summary at [2021-01-03 Sun 17:06]
| <75>                                                |         |       |       |       |
| Headline                                            | Time    |       |       |     % |
|-----------------------------------------------------+---------+-------+-------+-------|
...
| Add org-mode codec for input                        |         |       |  8:56 |  11.0 |
...
| Consider replacing properties drawer with tables    |         |       |  3:30 |   4.3 |
...
*** STARTED Sprint and product backlog grooming                       :story:
    :LOGBOOK:
    CLOCK: [2021-01-02 Sat 13:17]--[2021-01-02 Sat 13:26] =>  0:09
    CLOCK: [2021-01-02 Sat 13:06]--[2021-01-02 Sat 13:16] =>  0:10
    CLOCK: [2021-01-02 Sat 10:20]--[2021-01-02 Sat 10:26] =>  0:06
    CLOCK: [2021-01-01 Fri 18:17]--[2021-01-01 Fri 18:21] =>  0:04
    CLOCK: [2021-01-01 Fri 18:13]--[2021-01-01 Fri 18:16] =>  0:03
    CLOCK: [2021-01-01 Fri 18:09]--[2021-01-01 Fri 18:12] =>  0:03
    CLOCK: [2020-12-31 Thu 15:46]--[2020-12-31 Thu 15:49] =>  0:03
    CLOCK: [2020-12-31 Thu 15:34]--[2020-12-31 Thu 15:46] =>  0:12
...
*** STARTED Solve emacs issues                                        :story:
    :LOGBOOK:
    CLOCK: [2021-01-03 Sun 16:22]--[2021-01-03 Sun 17:00] =>  0:38
    CLOCK: [2021-01-03 Sun 15:00]--[2021-01-03 Sun 15:15] =>  0:15
...
- boost diagnostic information errors have paths that are not
  recognised by emacs. This gets close to solving the problem:
...
*** COMPLETED Add PlantUML markup language support                    :story:
    ...
    :LOGBOOK:
    CLOCK: [2021-01-01 Fri 13:32]--[2021-01-01 Fri 13:40] =>  0:08
    CLOCK: [2021-01-01 Fri 13:24]--[2021-01-01 Fri 13:31] =>  0:07
...
*** COMPLETED codecs: encoders and decoders should work in terms of strings :story:
    CLOSED: [2020-12-31 Thu 15:52]

*Rationale*: largely implemented as part of previous refactors. The
remaining just needs tidy-up as we go along.
...
*** COMPLETED Merge dia codec model into main codec model             :story:
    CLOSED: [2021-01-01 Fri 13:23]
    :LOGBOOK:
    CLOCK: [2021-01-01 Fri 12:41]--[2021-01-01 Fri 13:23] =>  0:42
    CLOCK: [2021-01-01 Fri 11:32]--[2021-01-01 Fri 12:40] =>  1:08
    CLOCK: [2020-12-31 Thu 15:51]--[2020-12-31 Thu 17:05] =>  1:14
    :END:
...
- remove the documentation concept and associated code.
...
*Move graph of containment to codec model*
...
*** COMPLETED Add include directories to models                       :story:
    CLOSED: [2021-01-01 Fri 18:12]
    :LOGBOOK:
    CLOCK: [2021-01-01 Fri 15:45]--[2021-01-01 Fri 18:08] =>  2:23
    CLOCK: [2021-01-01 Fri 14:47]--[2021-01-01 Fri 14:50] =>  0:03
    CLOCK: [2021-01-01 Fri 13:41]--[2021-01-01 Fri 14:46] =>  1:05
    :END:
...
parameter. We also need to dump the include directories in
dumpspecs. Actually lets call it =--reference-dir= instead since it is
used for the reference directories.

Notes:

- relational model is using generated cake files. We need to add
  modeling to the generated file. However, we can't always add it
  because in some cases we won't be using this directory layout. It is
  not clear how we would solve this problem; it may need to wait until
  we support the =model= element.

*** COMPLETED Move documentation transform to codec model             :story:
    CLOSED: [2021-01-02 Sat 12:43]
    :LOGBOOK:
    CLOCK: [2021-01-02 Sat 10:46]--[2021-01-02 Sat 12:22] =>  1:36
    :END:

We initially added the documentation transform to the logical model,
but there is no particular reason for that. In addition, we already
have multiple types, making the transform much more complicated. Try
instead to perform the trimming in the codec model. Also, name the
transform more appropriately.

*** COMPLETED Analysis on org mode round-tripping                     :story:
    CLOSED: [2021-01-02 Sat 12:43]
    :LOGBOOK:
    CLOCK: [2021-01-02 Sat 12:23]--[2021-01-02 Sat 12:43] =>  0:20
    CLOCK: [2021-01-02 Sat 10:33]--[2021-01-02 Sat 10:45] =>  0:12
    :END:
...
tripping does add a lot of complexity so we should take this into
account.

Notes:

- a big advantage of round tripping is that every time we want to test
  a new feature in org, we could just implement it in the codec and
  then convert from org to org. This way we wouldn't need to go back
  to the dia diagrams in frozen all the time.

*** COMPLETED Add org-to-org tests                                    :story:
    CLOSED: [2021-01-02 Sat 14:17]
    :LOGBOOK:
    CLOCK: [2021-01-02 Sat 13:27]--[2021-01-02 Sat 14:17] =>  0:50
    :END:

Now that we can round trip org models, we should add tests to ensure
there are no diffs. We need to create some hacks around the current
...
*** COMPLETED Add comments to PlantUML diagrams                       :story:
    CLOSED: [2021-01-03 Sun 17:37]
    :LOGBOOK:
    CLOCK: [2021-01-01 Fri 18:33]--[2021-01-01 Fri 18:36] =>  0:03
    CLOCK: [2021-01-01 Fri 18:21]--[2021-01-01 Fri 18:33] =>  0:12
    :END:

It would be nice to be able to output element commentary on the UML
diagram.

*** CANCELLED Consider replacing properties drawer with tables        :story:
    CLOSED: [2021-01-03 Sun 17:37]
    :LOGBOOK:
...
*Rationale*: We ran out of time to implement this story and since it
was a nice to have and an experiment, we'll leave it at that. We
stashed the changes if we have time to resume the experiment.
