...
#+CAPTION: Clock summary at [2020-12-30 Wed 17:52]
| <75>                                                |         |       |       |       |
| Headline                                            | Time    |       |       |     % |
|-----------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                        | *61:22* |       |       | 100.0 |
|-----------------------------------------------------+---------+-------+-------+-------|
| Stories                                             | 61:22   |       |       | 100.0 |
| Active                                              |         | 61:22 |       | 100.0 |
| Edit release notes for previous sprint              |         |       |  6:04 |   9.9 |
| Create a demo and presentation for previous sprint  |         |       |  0:34 |   0.9 |
| Sprint and product backlog grooming                 |         |       |  1:13 |   2.0 |
| Solve emacs issues                                  |         |       |  2:48 |   4.6 |
| Add support for reading org mode documents          |         |       | 19:46 |  32.2 |
| Remove leading and trailing new lines from comments |         |       |  1:03 |   1.7 |
| Stitch templates are consuming whitespace           |         |       |  1:56 |   3.2 |
| Add org-mode codec for input                        |         |       |  8:56 |  14.6 |
| Convert library models into org                     |         |       |  1:26 |   2.3 |
| Convert reference models into org                   |         |       |  2:56 |   4.8 |
| Assorted improvements to org model                  |         |       |  0:37 |   1.0 |
| Create a model to org transform                     |         |       |  3:57 |   6.4 |
| Remove JSON and Dia models for Dogen                |         |       |  1:17 |   2.1 |
| Split orchestration tests by model and codec        |         |       |  1:58 |   3.2 |
| Create a "frozen" project                           |         |       |  1:49 |   3.0 |
| Add tags to org model                               |         |       |  1:15 |   2.0 |
| Inject custom IDs into org documents                |         |       |  0:38 |   1.0 |
| Add PlantUML markup language support                |         |       |  3:09 |   5.1 |
