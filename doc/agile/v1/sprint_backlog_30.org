...
#+CAPTION: Clock summary at [2020-12-28 Mon 16:37]
| <75>                                                |         |       |       |       |
| Headline                                            | Time    |       |       |     % |
|-----------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                             | 48:52   |       |       | 100.0 |
| Active                                              |         | 48:52 |       | 100.0 |
| Edit release notes for previous sprint              |         |       |  6:04 |  12.4 |
| Create a demo and presentation for previous sprint  |         |       |  0:34 |   1.2 |
| Sprint and product backlog grooming                 |         |       |  1:13 |   2.5 |
| Add support for reading org mode documents          |         |       | 19:46 |  40.5 |
| Remove leading and trailing new lines from comments |         |       |  1:03 |   2.1 |
| Stitch templates are consuming whitespace           |         |       |  1:56 |   4.0 |
| Add org-mode codec for input                        |         |       |  8:56 |  18.3 |
| Convert library models into org                     |         |       |  1:26 |   2.9 |
| Convert reference models into org                   |         |       |  2:56 |   6.0 |
| Assorted improvements to org model                  |         |       |  0:37 |   1.3 |
| Create a model to org transform                     |         |       |  3:57 |   8.1 |
| Remove JSON and Dia models for Dogen                |         |       |  0:24 |   0.8 |
