...
#+CAPTION: Clock summary at [2021-01-01 Fri 14:50]
| <75>                                                |         |       |       |       |
| Headline                                            | Time    |       |       |     % |
|-----------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                        | *69:52* |       |       | 100.0 |
|-----------------------------------------------------+---------+-------+-------+-------|
| Stories                                             | 69:52   |       |       | 100.0 |
| Active                                              |         | 69:52 |       | 100.0 |
| Edit release notes for previous sprint              |         |       |  6:04 |   8.7 |
| Create a demo and presentation for previous sprint  |         |       |  0:34 |   0.8 |
| Sprint and product backlog grooming                 |         |       |  2:17 |   3.3 |
| Solve emacs issues                                  |         |       |  2:48 |   4.0 |
| Add support for reading org mode documents          |         |       | 19:46 |  28.3 |
| Remove leading and trailing new lines from comments |         |       |  1:03 |   1.5 |
| Stitch templates are consuming whitespace           |         |       |  1:56 |   2.8 |
| Add org-mode codec for input                        |         |       |  8:56 |  12.8 |
| Convert library models into org                     |         |       |  1:26 |   2.1 |
| Convert reference models into org                   |         |       |  2:56 |   4.2 |
| Assorted improvements to org model                  |         |       |  0:37 |   0.9 |
| Create a model to org transform                     |         |       |  3:57 |   5.7 |
| Remove JSON and Dia models for Dogen                |         |       |  1:17 |   1.8 |
| Split orchestration tests by model and codec        |         |       |  1:58 |   2.8 |
| Create a "frozen" project                           |         |       |  1:49 |   2.6 |
| Add tags to org model                               |         |       |  1:15 |   1.8 |
| Inject custom IDs into org documents                |         |       |  0:38 |   0.9 |
| Allow spaces in headlines for org mode documents    |         |       |  0:54 |   1.3 |
| Add PlantUML markup language support                |         |       |  5:29 |   7.8 |
| Merge dia codec model into main codec model         |         |       |  3:04 |   4.4 |
| Add include directories to models                   |         |       |  1:08 |   1.6 |
...
*** STARTED Add include directories to models                         :story:
    :LOGBOOK:
