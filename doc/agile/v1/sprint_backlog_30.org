...
#+CAPTION: Clock summary at [2020-12-28 Mon 09:38]
| <75>                                                |         |       |       |       |
| Headline                                            | Time    |       |       |     % |
|-----------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                             | 43:54   |       |       | 100.0 |
| Active                                              |         | 43:54 |       | 100.0 |
| Edit release notes for previous sprint              |         |       |  6:04 |  13.8 |
| Create a demo and presentation for previous sprint  |         |       |  0:34 |   1.3 |
| Sprint and product backlog grooming                 |         |       |  1:13 |   2.8 |
| Add support for reading org mode documents          |         |       | 19:46 |  45.0 |
| Remove leading and trailing new lines from comments |         |       |  1:03 |   2.4 |
| Stitch templates are consuming whitespace           |         |       |  1:56 |   4.4 |
| Add org-mode codec for input                        |         |       |  8:56 |  20.3 |
...
*** Improvements to org model                                         :story:
...
- try adding =references= tag. Content is a list of links to org
  ...
  path. To start off with, it can be ignored and managed manually.
- upper case all drawer contents to see if it fixes github
  ...
  pretty bad all in upper case as well.
- add spaces between drawers and comments.
- inject the custom ID into all headlines. See previous analysis on
  this.

*** Create a model to org transform                                   :story:
...
*** Remove JSON and Dia models for Dogen                              :story:
