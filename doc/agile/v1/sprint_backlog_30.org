...
#+CAPTION: Clock summary at [2021-01-02 Sat 12:45]
| <75>                                                |         |       |       |       |
| Headline                                            | Time    |       |       |     % |
|-----------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                        | *75:00* |       |       | 100.0 |
|-----------------------------------------------------+---------+-------+-------+-------|
| Stories                                             | 75:00   |       |       | 100.0 |
| Active                                              |         | 75:00 |       | 100.0 |
| Edit release notes for previous sprint              |         |       |  6:04 |   8.1 |
| Create a demo and presentation for previous sprint  |         |       |  0:34 |   0.8 |
| Sprint and product backlog grooming                 |         |       |  2:33 |   3.4 |
| Solve emacs issues                                  |         |       |  2:48 |   3.7 |
| Add support for reading org mode documents          |         |       | 19:46 |  26.4 |
| Remove leading and trailing new lines from comments |         |       |  1:03 |   1.4 |
| Stitch templates are consuming whitespace           |         |       |  1:56 |   2.6 |
| Add org-mode codec for input                        |         |       |  8:56 |  11.9 |
...
| Create a model to org transform                     |         |       |  3:57 |   5.3 |
...
| Add tags to org model                               |         |       |  1:15 |   1.7 |
| Inject custom IDs into org documents                |         |       |  0:38 |   0.8 |
| Allow spaces in headlines for org mode documents    |         |       |  0:54 |   1.2 |
| Add PlantUML markup language support                |         |       |  5:29 |   7.3 |
| Merge dia codec model into main codec model         |         |       |  3:04 |   4.1 |
| Add include directories to models                   |         |       |  3:31 |   4.7 |
...
- relational model is using generated cmake files. We need to add
