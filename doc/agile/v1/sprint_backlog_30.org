...
#+CAPTION: Clock summary at [2020-12-26 Sat 20:58]
| <75>                                                |         |       |       |       |
| Headline                                            | Time    |       |       |     % |
|-----------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                        | *38:14* |       |       | 100.0 |
|-----------------------------------------------------+---------+-------+-------+-------|
| Stories                                             | 38:14   |       |       | 100.0 |
| Active                                              |         | 38:14 |       | 100.0 |
| Edit release notes for previous sprint              |         |       |  6:04 |  15.9 |
| Create a demo and presentation for previous sprint  |         |       |  0:34 |   1.5 |
| Sprint and product backlog grooming                 |         |       |  0:36 |   1.6 |
| Add support for reading org mode documents          |         |       | 19:46 |  51.7 |
| Remove leading and trailing new lines from comments |         |       |  1:03 |   2.7 |
| Stitch templates are consuming whitespace           |         |       |  1:56 |   5.1 |
| Add org-mode codec for input                        |         |       |  8:10 |  21.4 |
| Convert library models into org                     |         |       |  0:05 |   0.2 |
...
*** STARTED Convert library models into org                           :story:
    :LOGBOOK:
