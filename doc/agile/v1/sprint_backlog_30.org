...
#+CAPTION: Clock summary at [2020-12-28 Mon 14:14]
| <75>                                                |         |       |       |       |
| Headline                                            | Time    |       |       |     % |
|-----------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                             | 47:18   |       |       | 100.0 |
| Active                                              |         | 47:18 |       | 100.0 |
| Edit release notes for previous sprint              |         |       |  6:04 |  12.8 |
| Create a demo and presentation for previous sprint  |         |       |  0:34 |   1.2 |
| Sprint and product backlog grooming                 |         |       |  1:13 |   2.6 |
| Add support for reading org mode documents          |         |       | 19:46 |  41.8 |
| Remove leading and trailing new lines from comments |         |       |  1:03 |   2.2 |
| Stitch templates are consuming whitespace           |         |       |  1:56 |   4.1 |
| Add org-mode codec for input                        |         |       |  8:56 |  18.9 |
| Convert library models into org                     |         |       |  1:26 |   3.0 |
| Convert reference models into org                   |         |       |  2:56 |   6.2 |
| Assorted improvements to org model                  |         |       |  0:37 |   1.3 |
| Create a model to org transform                     |         |       |  2:36 |   5.5 |
| Remove JSON and Dia models for Dogen                |         |       |  0:11 |   0.4 |
...
*** STARTED Create a model to org transform                           :story:
    :LOGBOOK:
...
*** STARTED Remove JSON and Dia models for Dogen                      :story:
    :LOGBOOK:
