...
#+CAPTION: Clock summary at [2020-12-30 Wed 14:28]
| <75>                                                |         |       |       |       |
| Headline                                            | Time    |       |       |     % |
|-----------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                        | *59:01* |       |       | 100.0 |
|-----------------------------------------------------+---------+-------+-------+-------|
| Stories                                             | 59:01   |       |       | 100.0 |
| Active                                              |         | 59:01 |       | 100.0 |
| Edit release notes for previous sprint              |         |       |  6:04 |  10.3 |
| Create a demo and presentation for previous sprint  |         |       |  0:34 |   1.0 |
| Sprint and product backlog grooming                 |         |       |  1:13 |   2.1 |
| Solve emacs issues                                  |         |       |  2:48 |   4.7 |
| Add support for reading org mode documents          |         |       | 19:46 |  33.5 |
| Remove leading and trailing new lines from comments |         |       |  1:03 |   1.8 |
| Stitch templates are consuming whitespace           |         |       |  1:56 |   3.3 |
| Add org-mode codec for input                        |         |       |  8:56 |  15.1 |
| Convert library models into org                     |         |       |  1:26 |   2.4 |
| Convert reference models into org                   |         |       |  2:56 |   5.0 |
| Assorted improvements to org model                  |         |       |  0:37 |   1.0 |
| Create a model to org transform                     |         |       |  3:57 |   6.7 |
| Remove JSON and Dia models for Dogen                |         |       |  1:17 |   2.2 |
| Split orchestration tests by model and codec        |         |       |  1:58 |   3.3 |
| Create a "frozen" project                           |         |       |  1:49 |   3.1 |
| Add tags to org model                               |         |       |  1:15 |   2.1 |
| Inject custom IDs into org documents                |         |       |  0:38 |   1.1 |
| Add PlantUML markup language support                |         |       |  0:48 |   1.4 |
