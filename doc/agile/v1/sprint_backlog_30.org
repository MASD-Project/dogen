...
#+CAPTION: Clock summary at [2020-12-31 Thu 17:05]
| <75>                                                |         |       |       |       |
| Headline                                            | Time    |       |       |     % |
|-----------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                        | *66:39* |       |       | 100.0 |
|-----------------------------------------------------+---------+-------+-------+-------|
| Stories                                             | 66:39   |       |       | 100.0 |
| Active                                              |         | 66:39 |       | 100.0 |
| Edit release notes for previous sprint              |         |       |  6:04 |   9.1 |
| Create a demo and presentation for previous sprint  |         |       |  0:34 |   0.9 |
| Sprint and product backlog grooming                 |         |       |  2:17 |   3.4 |
| Solve emacs issues                                  |         |       |  2:48 |   4.2 |
| Add support for reading org mode documents          |         |       | 19:46 |  29.7 |
| Remove leading and trailing new lines from comments |         |       |  1:03 |   1.6 |
| Stitch templates are consuming whitespace           |         |       |  1:56 |   2.9 |
| Add org-mode codec for input                        |         |       |  8:56 |  13.4 |
| Convert library models into org                     |         |       |  1:26 |   2.2 |
| Convert reference models into org                   |         |       |  2:56 |   4.4 |
| Assorted improvements to org model                  |         |       |  0:37 |   0.9 |
| Create a model to org transform                     |         |       |  3:57 |   5.9 |
| Remove JSON and Dia models for Dogen                |         |       |  1:17 |   1.9 |
| Split orchestration tests by model and codec        |         |       |  1:58 |   3.0 |
| Create a "frozen" project                           |         |       |  1:49 |   2.7 |
...
| Add PlantUML markup language support                |         |       |  5:14 |   7.9 |
| Merge dia codec model into main codec model         |         |       |  1:14 |   1.9 |
...
*** STARTED Merge dia codec model into main codec model               :story:
    :LOGBOOK:
