...
#+CAPTION: Clock summary at [2021-01-01 Fri 18:34]
| <75>                                                |         |       |       |       |
| Headline                                            | Time    |       |       |     % |
|-----------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                        | *72:37* |       |       | 100.0 |
|-----------------------------------------------------+---------+-------+-------+-------|
| Stories                                             | 72:37   |       |       | 100.0 |
| Active                                              |         | 72:37 |       | 100.0 |
| Edit release notes for previous sprint              |         |       |  6:04 |   8.4 |
| Create a demo and presentation for previous sprint  |         |       |  0:34 |   0.8 |
| Sprint and product backlog grooming                 |         |       |  2:27 |   3.4 |
| Solve emacs issues                                  |         |       |  2:48 |   3.9 |
| Add support for reading org mode documents          |         |       | 19:46 |  27.2 |
| Remove leading and trailing new lines from comments |         |       |  1:03 |   1.4 |
| Stitch templates are consuming whitespace           |         |       |  1:56 |   2.7 |
| Add org-mode codec for input                        |         |       |  8:56 |  12.3 |
| Convert library models into org                     |         |       |  1:26 |   2.0 |
| Convert reference models into org                   |         |       |  2:56 |   4.0 |
| Assorted improvements to org model                  |         |       |  0:37 |   0.8 |
| Create a model to org transform                     |         |       |  3:57 |   5.4 |
| Remove JSON and Dia models for Dogen                |         |       |  1:17 |   1.8 |
| Split orchestration tests by model and codec        |         |       |  1:58 |   2.7 |
| Create a "frozen" project                           |         |       |  1:49 |   2.5 |
| Add tags to org model                               |         |       |  1:15 |   1.7 |
| Inject custom IDs into org documents                |         |       |  0:38 |   0.9 |
| Allow spaces in headlines for org mode documents    |         |       |  0:54 |   1.2 |
| Add PlantUML markup language support                |         |       |  5:29 |   7.6 |
| Merge dia codec model into main codec model         |         |       |  3:04 |   4.2 |
| Add include directories to models                   |         |       |  3:31 |   4.8 |
| Add comments to PlantUML diagrams                   |         |       |  0:12 |   0.3 |
