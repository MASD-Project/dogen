...
#+CAPTION: Clock summary at [2019-02-12 Tue 18:43]
| <75>                                                 |          |        |        |       |
| Headline                                             | Time     |        |        |     % |
|------------------------------------------------------+----------+--------+--------+-------|
| *Total time*                                         | *173:18* |        |        | 100.0 |
|------------------------------------------------------+----------+--------+--------+-------|
| Stories                                              | 173:18   |        |        | 100.0 |
| Active                                               |          | 173:18 |        | 100.0 |
| Edit release notes for previous sprint               |          |        |   2:03 |   1.2 |
| Sprint and product backlog grooming                  |          |        |   4:11 |   2.4 |
| Work on MASD theory                                  |          |        | 113:38 |  65.6 |
...
| Create the =orchestration= model                     |          |        |   4:15 |   2.5 |
| Update vcpkg across all operative systems            |          |        |   4:35 |   2.6 |
| Update C# reference models to latest dogen           |          |        |   0:42 |   0.4 |
| Convert the utility model into a regular dogen model |          |        |   7:27 |   4.3 |
| Great meta-data rename                               |          |        |   4:54 |   2.8 |
| Create a single binary for all of dogen              |          |        |  15:50 |   9.1 |
| Dogen's vcpkg export for OSX was created from master |          |        |   0:46 |   0.4 |
| Finish adding support for clang-cl builds            |          |        |   1:30 |   0.9 |
| Move generation properties into meta-data            |          |        |   1:07 |   0.6 |
