...
#+CAPTION: Clock summary at [2019-02-08 Fri 16:01]
| <75>                                       |          |        |        |       |
| Headline                                   | Time     |        |        |     % |
|--------------------------------------------+----------+--------+--------+-------|
| *Total time*                               | *156:29* |        |        | 100.0 |
|--------------------------------------------+----------+--------+--------+-------|
| Stories                                    | 156:29   |        |        | 100.0 |
| Active                                     |          | 156:29 |        | 100.0 |
| Edit release notes for previous sprint     |          |        |   2:03 |   1.3 |
| Sprint and product backlog grooming        |          |        |   3:50 |   2.4 |
| Work on MASD theory                        |          |        | 113:38 |  72.6 |
| Rename models to fit MASD architecture     |          |        |   4:56 |   3.2 |
| Read up on framework and API design        |          |        |   0:57 |   0.6 |
| Analyse the state of the mess of refactors |          |        |   6:27 |   4.1 |
| Create the =orchestration= model           |          |        |   4:15 |   2.7 |
| Great meta-data rename                     |          |        |   4:54 |   3.1 |
| Create a single binary for all of dogen    |          |        |  10:54 |   7.0 |
| Update vcpkg across all operative systems  |          |        |   4:35 |   2.9 |
...
*** STARTED Update vcpkg across all operative systems                 :story:
    :LOGBOOK:
