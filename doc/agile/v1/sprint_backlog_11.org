...
#+CAPTION: Clock summary at [2019-02-08 Fri 14:02]
| <75>                                       |          |        |        |       |
| Headline                                   | Time     |        |        |     % |
|--------------------------------------------+----------+--------+--------+-------|
| *Total time*                               | *154:32* |        |        | 100.0 |
|--------------------------------------------+----------+--------+--------+-------|
| Stories                                    | 154:32   |        |        | 100.0 |
| Active                                     |          | 154:32 |        | 100.0 |
| Edit release notes for previous sprint     |          |        |   2:03 |   1.3 |
| Sprint and product backlog grooming        |          |        |   3:50 |   2.5 |
| Work on MASD theory                        |          |        | 113:38 |  73.5 |
| Rename models to fit MASD architecture     |          |        |   4:56 |   3.2 |
| Read up on framework and API design        |          |        |   0:57 |   0.6 |
| Analyse the state of the mess of refactors |          |        |   6:27 |   4.2 |
| Create the =orchestration= model           |          |        |   4:15 |   2.8 |
| Great meta-data rename                     |          |        |   4:54 |   3.2 |
| Create a single binary for all of dogen    |          |        |   8:57 |   5.8 |
| Update vcpkg across all operative systems  |          |        |   4:35 |   3.0 |
