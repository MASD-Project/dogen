...
#+CAPTION: Clock summary at [2019-02-18 Mon 13:02]
| <75>                                                        |          |        |        |       |
| Headline                                                    | Time     |        |        |     % |
|-------------------------------------------------------------+----------+--------+--------+-------|
| *Total time*                                                | *190:47* |        |        | 100.0 |
|-------------------------------------------------------------+----------+--------+--------+-------|
| Stories                                                     | 190:47   |        |        | 100.0 |
| Active                                                      |          | 190:47 |        | 100.0 |
| Edit release notes for previous sprint                      |          |        |   2:03 |   1.1 |
| Sprint and product backlog grooming                         |          |        |   5:02 |   2.6 |
| Work on MASD theory                                         |          |        | 113:38 |  59.6 |
...
| Convert the utility model into a regular dogen model        |          |        |   7:27 |   3.9 |
| Improve support for clang-cl builds                         |          |        |   2:02 |   1.1 |
| Move generation properties into meta-data                   |          |        |   9:26 |   4.9 |
| Disabling facet globally and enabling locally does not work |          |        |   2:00 |   1.0 |
| Great meta-data rename                                      |          |        |   4:54 |   2.6 |
| Create a single binary for all of dogen                     |          |        |  19:02 |  10.0 |
| Dogen's vcpkg export for OSX was created from master        |          |        |   0:46 |   0.4 |
| Fix clang-cl warnings                                       |          |        |   1:50 |   1.0 |
| Use tracing options in existing code                        |          |        |   0:30 |   0.3 |
...
*** COMPLETED Disabling facet globally and enabling locally does not work :story:
