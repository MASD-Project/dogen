...
| Great meta-data rename                               |          |        |   4:54 |   2.9 |
| Create a single binary for all of dogen              |          |        |  15:50 |   9.4 |
| Dogen's vcpkg export for OSX was created from master |          |        |   0:46 |   0.5 |
| Finish adding support for clang-cl builds            |          |        |   1:11 |   0.7 |
| Convert the utility model into a regular dogen model |          |        |   4:15 |   2.5 |
