...
#+CAPTION: Clock summary at [2019-02-20 Wed 18:43]
| <75>                                                      |          |        |        |       |
| Headline                                                  | Time     |        |        |     % |
|-----------------------------------------------------------+----------+--------+--------+-------|
| *Total time*                                              | *206:58* |        |        | 100.0 |
|-----------------------------------------------------------+----------+--------+--------+-------|
| Stories                                                   | 206:58   |        |        | 100.0 |
| Active                                                    |          | 206:58 |        | 100.0 |
| Edit release notes for previous sprint                    |          |        |   2:03 |   1.0 |
| Sprint and product backlog grooming                       |          |        |   5:13 |   2.5 |
| Work on MASD theory                                       |          |        | 113:38 |  54.9 |
| Rename models to fit MASD architecture                    |          |        |   4:56 |   2.4 |
| Read up on framework and API design                       |          |        |   0:57 |   0.5 |
| Analyse the state of the mess of refactors                |          |        |   6:27 |   3.1 |
...
| Convert the utility model into a regular dogen model      |          |        |   7:27 |   3.6 |
...
| Create a single binary for all of dogen                   |          |        |  28:51 |  13.9 |
