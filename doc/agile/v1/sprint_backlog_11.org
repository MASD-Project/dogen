...
#+CAPTION: Clock summary at [2019-02-14 Thu 15:32]
| <75>                                                 |          |        |        |       |
| Headline                                             | Time     |        |        |     % |
|------------------------------------------------------+----------+--------+--------+-------|
| *Total time*                                         | *180:23* |        |        | 100.0 |
|------------------------------------------------------+----------+--------+--------+-------|
| Stories                                              | 180:23   |        |        | 100.0 |
| Active                                               |          | 180:23 |        | 100.0 |
| Edit release notes for previous sprint               |          |        |   2:03 |   1.1 |
| Sprint and product backlog grooming                  |          |        |   4:43 |   2.6 |
| Work on MASD theory                                  |          |        | 113:38 |  63.0 |
...
| Update vcpkg across all operative systems            |          |        |   4:35 |   2.5 |
| Update C# reference models to latest dogen           |          |        |   0:42 |   0.4 |
| Convert the utility model into a regular dogen model |          |        |   7:27 |   4.1 |
| Improve support for clang-cl builds                  |          |        |   2:02 |   1.1 |
| Great meta-data rename                               |          |        |   4:54 |   2.7 |
| Create a single binary for all of dogen              |          |        |  16:27 |   9.1 |
| Dogen's vcpkg export for OSX was created from master |          |        |   0:46 |   0.4 |
| Move generation properties into meta-data            |          |        |   6:00 |   3.3 |
