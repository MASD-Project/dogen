...
#+CAPTION: Clock summary at [2019-02-13 Wed 18:34]
| <75>                                                 |          |        |        |       |
| Headline                                             | Time     |        |        |     % |
|------------------------------------------------------+----------+--------+--------+-------|
| *Total time*                                         | *176:30* |        |        | 100.0 |
|------------------------------------------------------+----------+--------+--------+-------|
| Stories                                              | 176:30   |        |        | 100.0 |
| Active                                               |          | 176:30 |        | 100.0 |
| Edit release notes for previous sprint               |          |        |   2:03 |   1.2 |
| Sprint and product backlog grooming                  |          |        |   4:43 |   2.7 |
| Work on MASD theory                                  |          |        | 113:38 |  64.4 |
| Rename models to fit MASD architecture               |          |        |   4:56 |   2.8 |
| Read up on framework and API design                  |          |        |   0:57 |   0.5 |
| Analyse the state of the mess of refactors           |          |        |   6:27 |   3.7 |
| Create the =orchestration= model                     |          |        |   4:15 |   2.4 |
| Update vcpkg across all operative systems            |          |        |   4:35 |   2.6 |
| Update C# reference models to latest dogen           |          |        |   0:42 |   0.4 |
| Convert the utility model into a regular dogen model |          |        |   7:27 |   4.2 |
| Improve support for clang-cl builds                  |          |        |   2:02 |   1.2 |
| Great meta-data rename                               |          |        |   4:54 |   2.8 |
| Create a single binary for all of dogen              |          |        |  16:27 |   9.3 |
| Dogen's vcpkg export for OSX was created from master |          |        |   0:46 |   0.4 |
| Move generation properties into meta-data            |          |        |   2:38 |   1.5 |
...
*** STARTED Move generation properties into meta-data                 :story:
    :LOGBOOK:
...
*** Fix clang-cl broken test and warnings                             :story:
