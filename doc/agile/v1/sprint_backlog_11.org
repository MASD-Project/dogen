...
#+CAPTION: Clock summary at [2019-02-20 Wed 15:33]
| <75>                                                      |          |        |        |       |
| Headline                                                  | Time     |        |        |     % |
|-----------------------------------------------------------+----------+--------+--------+-------|
| *Total time*                                              | *203:53* |        |        | 100.0 |
|-----------------------------------------------------------+----------+--------+--------+-------|
| Stories                                                   | 203:53   |        |        | 100.0 |
| Active                                                    |          | 203:53 |        | 100.0 |
| Edit release notes for previous sprint                    |          |        |   2:03 |   1.0 |
| Sprint and product backlog grooming                       |          |        |   5:13 |   2.6 |
| Work on MASD theory                                       |          |        | 113:38 |  55.7 |
| Rename models to fit MASD architecture                    |          |        |   4:56 |   2.4 |
| Read up on framework and API design                       |          |        |   0:57 |   0.5 |
| Analyse the state of the mess of refactors                |          |        |   6:27 |   3.2 |
| Create the =orchestration= model                          |          |        |   4:15 |   2.1 |
| Update vcpkg across all operative systems                 |          |        |   4:35 |   2.2 |
| Update C# reference models to latest dogen                |          |        |   0:42 |   0.3 |
| Convert the utility model into a regular dogen model      |          |        |   7:27 |   3.7 |
| Improve support for clang-cl builds                       |          |        |   2:02 |   1.0 |
| Move generation properties into meta-data                 |          |        |   9:26 |   4.6 |
...
| Create a colour palette test model                        |          |        |   1:09 |   0.6 |
| Great meta-data rename                                    |          |        |   4:54 |   2.4 |
| Create a single binary for all of dogen                   |          |        |  25:46 |  12.6 |
| Dogen's vcpkg export for OSX was created from master      |          |        |   0:46 |   0.4 |
| Fix clang-cl warnings                                     |          |        |   5:07 |   2.5 |
| Use tracing options in existing code                      |          |        |   0:57 |   0.5 |
