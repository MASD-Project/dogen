...
#+CAPTION: Clock summary at [2020-02-04 Tue 22:57]
| <75>                                                  |         |       |       |       |
| Headline                                              | Time    |       |       |     % |
|-------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                          | *43:58* |       |       | 100.0 |
|-------------------------------------------------------+---------+-------+-------+-------|
| Stories                                               | 43:58   |       |       | 100.0 |
| Active                                                |         | 43:58 |       | 100.0 |
| Edit release notes for previous sprint                |         |       |  7:01 |  16.0 |
| Create a demo and presentation for previous sprint    |         |       |  1:49 |   4.1 |
| Sprint and product backlog grooming                   |         |       |  2:20 |   5.3 |
| Create new playlist for assets work                   |         |       |  1:57 |   4.4 |
| Create the final video on the relational model series |         |       |  0:30 |   1.1 |
| Move registrar into assets                            |         |       |  5:34 |  12.7 |
| Fix error in asserter tests                           |         |       |  0:38 |   1.4 |
| Add injection details to all models                   |         |       |  0:25 |   0.9 |
| Fix nightly error in registrar                        |         |       |  0:33 |   1.3 |
| Nightly code coverage is not being reported           |         |       |  0:25 |   0.9 |
| Move visual studio fabric types into assets           |         |       | 18:34 |  42.2 |
| Fixes to setup                                        |         |       |  1:05 |   2.5 |
| Cannot see source file in coveralls                   |         |       |  0:16 |   0.6 |
| Integration of archetypes into assets                 |         |       |  2:41 |   6.1 |
