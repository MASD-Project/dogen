...
#+CAPTION: Clock summary at [2020-02-10 Mon 08:44]
| <75>                                                  |         |       |       |       |
| Headline                                              | Time    |       |       |     % |
|-------------------------------------------------------+---------+-------+-------+-------|
...
| Move visual studio fabric types into assets           |         |       | 18:34 |  30.5 |
| Create metamodel elements for =entry_point=           |         |       |  7:18 |  12.0 |
| Remove support for element extensions                 |         |       |  0:44 |   1.2 |
| Move =object_odb_options= into assets                 |         |       |  6:43 |  11.1 |
| Fixes to setup                                        |         |       |  1:05 |   1.8 |
| Cannot see source file in coveralls                   |         |       |  0:16 |   0.4 |
| Integration of archetypes into assets                 |         |       |  2:41 |   4.4 |
| Move common ODB options into assets                   |         |       |  0:43 |   1.2 |
