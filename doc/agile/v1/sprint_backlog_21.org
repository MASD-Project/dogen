...
#+CAPTION: Clock summary at [2020-01-31 Fri 17:22]
| <75>                                                  |         |       |      |       |
| Headline                                              | Time    |       |      |     % |
|-------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                               | 28:34   |       |      | 100.0 |
| Active                                                |         | 28:34 |      | 100.0 |
| Edit release notes for previous sprint                |         |       | 7:01 |  24.6 |
| Create a demo and presentation for previous sprint    |         |       | 1:49 |   6.4 |
| Sprint and product backlog grooming                   |         |       | 2:08 |   7.5 |
| Create new playlist for assets work                   |         |       | 1:10 |   4.1 |
| Create the final video on the relational model series |         |       | 0:30 |   1.8 |
| Move registrar into assets                            |         |       | 5:34 |  19.5 |
| Fix error in asserter tests                           |         |       | 0:38 |   2.2 |
| Add injection details to all models                   |         |       | 0:25 |   1.5 |
| Fix nightly error in registrar                        |         |       | 0:33 |   1.9 |
| Nightly code coverage is not being reported           |         |       | 0:25 |   1.5 |
| Fixes to setup                                        |         |       | 1:05 |   3.8 |
| Cannot see source file in coveralls                   |         |       | 0:16 |   0.9 |
| Move visual studio fabric types into assets           |         |       | 7:00 |  24.5 |
