...
#+CAPTION: Clock summary at [2020-02-15 Sat 23:51]
| <75>                                                  |         |       |       |       |
| Headline                                              | Time    |       |       |     % |
|-------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                          | *77:03* |       |       | 100.0 |
|-------------------------------------------------------+---------+-------+-------+-------|
| Stories                                               | 77:03   |       |       | 100.0 |
| Active                                                |         | 77:03 |       | 100.0 |
| Edit release notes for previous sprint                |         |       |  7:01 |   9.1 |
| Create a demo and presentation for previous sprint    |         |       |  1:49 |   2.4 |
| Sprint and product backlog grooming                   |         |       |  3:53 |   5.0 |
...
| Move visual studio fabric types into assets           |         |       | 18:34 |  24.1 |
