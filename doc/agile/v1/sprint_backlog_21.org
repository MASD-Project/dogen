...
#+CAPTION: Clock summary at [2020-02-14 Fri 16:50]
| <75>                                                  |         |       |       |       |
| Headline                                              | Time    |       |       |     % |
|-------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                          | *70:02* |       |       | 100.0 |
|-------------------------------------------------------+---------+-------+-------+-------|
| Stories                                               | 70:02   |       |       | 100.0 |
| Active                                                |         | 70:02 |       | 100.0 |
| Edit release notes for previous sprint                |         |       |  7:01 |  10.0 |
| Create a demo and presentation for previous sprint    |         |       |  1:49 |   2.6 |
| Sprint and product backlog grooming                   |         |       |  3:38 |   5.2 |
| Create new playlist for assets work                   |         |       |  2:19 |   3.3 |
| Create the final video on the relational model series |         |       |  0:30 |   0.7 |
| Move registrar into assets                            |         |       |  5:34 |   7.9 |
...
| Move visual studio fabric types into assets           |         |       | 18:34 |  26.5 |
| Create metamodel elements for =entry_point=           |         |       |  7:18 |  10.4 |
| Remove support for element extensions                 |         |       |  0:44 |   1.0 |
| Move =object_odb_options= into assets                 |         |       |  6:43 |   9.6 |
| Move common ODB options into assets                   |         |       |  4:34 |   6.5 |
| Fixes to setup                                        |         |       |  1:05 |   1.5 |
| Cannot see source file in coveralls                   |         |       |  0:16 |   0.4 |
| Integration of archetypes into assets                 |         |       |  2:41 |   3.8 |
| Move msbuild and cmakelists into assets               |         |       |  5:15 |   7.5 |
