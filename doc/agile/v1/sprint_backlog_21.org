...
#+CAPTION: Clock summary at [2020-02-13 Thu 00:11]
| <75>                                                  |         |       |       |       |
| Headline                                              | Time    |       |       |     % |
|-------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                          | *65:19* |       |       | 100.0 |
|-------------------------------------------------------+---------+-------+-------+-------|
| Stories                                               | 65:19   |       |       | 100.0 |
| Active                                                |         | 65:19 |       | 100.0 |
| Edit release notes for previous sprint                |         |       |  7:01 |  10.7 |
| Create a demo and presentation for previous sprint    |         |       |  1:49 |   2.8 |
| Sprint and product backlog grooming                   |         |       |  3:38 |   5.6 |
| Create new playlist for assets work                   |         |       |  2:19 |   3.5 |
| Create the final video on the relational model series |         |       |  0:30 |   0.8 |
| Move registrar into assets                            |         |       |  5:34 |   8.5 |
...
| Move visual studio fabric types into assets           |         |       | 18:34 |  28.4 |
| Create metamodel elements for =entry_point=           |         |       |  7:18 |  11.2 |
| Remove support for element extensions                 |         |       |  0:44 |   1.1 |
| Move =object_odb_options= into assets                 |         |       |  6:43 |  10.3 |
| Move common ODB options into assets                   |         |       |  4:34 |   7.0 |
| Fixes to setup                                        |         |       |  1:05 |   1.7 |
| Cannot see source file in coveralls                   |         |       |  0:16 |   0.4 |
| Integration of archetypes into assets                 |         |       |  2:41 |   4.1 |
| Move msbuild and cmakelists into assets               |         |       |  0:32 |   0.8 |
