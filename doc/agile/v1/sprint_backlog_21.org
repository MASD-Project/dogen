...
#+CAPTION: Clock summary at [2020-02-02 Sun 17:58]
| <75>                                                  |         |       |       |       |
| Headline                                              | Time    |       |       |     % |
|-------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                               | 36:38   |       |       | 100.0 |
| Active                                                |         | 36:38 |       | 100.0 |
| Edit release notes for previous sprint                |         |       |  7:01 |  19.2 |
| Create a demo and presentation for previous sprint    |         |       |  1:49 |   5.0 |
| Sprint and product backlog grooming                   |         |       |  2:20 |   6.4 |
| Create new playlist for assets work                   |         |       |  1:22 |   3.7 |
| Create the final video on the relational model series |         |       |  0:30 |   1.4 |
| Move registrar into assets                            |         |       |  5:34 |  15.2 |
| Fix error in asserter tests                           |         |       |  0:38 |   1.7 |
| Add injection details to all models                   |         |       |  0:25 |   1.1 |
| Fix nightly error in registrar                        |         |       |  0:33 |   1.5 |
| Nightly code coverage is not being reported           |         |       |  0:25 |   1.1 |
| Fixes to setup                                        |         |       |  1:05 |   3.0 |
| Cannot see source file in coveralls                   |         |       |  0:16 |   0.7 |
| Move visual studio fabric types into assets           |         |       | 13:27 |  36.7 |
| Integration of archetypes into assets                 |         |       |  1:13 |   3.3 |
