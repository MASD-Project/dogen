...
#+CAPTION: Clock summary at [2020-02-01 Sat 16:25]
| <75>                                                  |         |       |       |       |
| Headline                                              | Time    |       |       |     % |
|-------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                          | *32:34* |       |       | 100.0 |
|-------------------------------------------------------+---------+-------+-------+-------|
| Stories                                               | 32:34   |       |       | 100.0 |
| Active                                                |         | 32:34 |       | 100.0 |
| Edit release notes for previous sprint                |         |       |  7:01 |  21.5 |
| Create a demo and presentation for previous sprint    |         |       |  1:49 |   5.6 |
| Sprint and product backlog grooming                   |         |       |  2:08 |   6.6 |
| Create new playlist for assets work                   |         |       |  1:22 |   4.2 |
| Create the final video on the relational model series |         |       |  0:30 |   1.5 |
| Move registrar into assets                            |         |       |  5:34 |  17.1 |
| Fix error in asserter tests                           |         |       |  0:38 |   1.9 |
| Add injection details to all models                   |         |       |  0:25 |   1.3 |
| Fix nightly error in registrar                        |         |       |  0:33 |   1.7 |
| Nightly code coverage is not being reported           |         |       |  0:25 |   1.3 |
| Fixes to setup                                        |         |       |  1:05 |   3.3 |
| Cannot see source file in coveralls                   |         |       |  0:16 |   0.8 |
| Move visual studio fabric types into assets           |         |       | 10:48 |  33.2 |
