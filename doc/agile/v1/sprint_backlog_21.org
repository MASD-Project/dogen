...
#+CAPTION: Clock summary at [2020-02-14 Fri 12:17]
| <75>                                                  |         |       |       |       |
| Headline                                              | Time    |       |       |     % |
|-------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                               | 67:29   |       |       | 100.0 |
| Active                                                |         | 67:29 |       | 100.0 |
| Edit release notes for previous sprint                |         |       |  7:01 |  10.4 |
| Create a demo and presentation for previous sprint    |         |       |  1:49 |   2.7 |
| Sprint and product backlog grooming                   |         |       |  3:38 |   5.4 |
| Create new playlist for assets work                   |         |       |  2:19 |   3.4 |
| Create the final video on the relational model series |         |       |  0:30 |   0.7 |
| Move registrar into assets                            |         |       |  5:34 |   8.2 |
...
| Move visual studio fabric types into assets           |         |       | 18:34 |  27.5 |
| Create metamodel elements for =entry_point=           |         |       |  7:18 |  10.8 |
| Remove support for element extensions                 |         |       |  0:44 |   1.1 |
| Move =object_odb_options= into assets                 |         |       |  6:43 |  10.0 |
| Move common ODB options into assets                   |         |       |  4:34 |   6.8 |
| Fixes to setup                                        |         |       |  1:05 |   1.6 |
| Cannot see source file in coveralls                   |         |       |  0:16 |   0.4 |
| Integration of archetypes into assets                 |         |       |  2:41 |   4.0 |
| Move msbuild and cmakelists into assets               |         |       |  2:42 |   4.0 |
...
- drop =build= in visual studio stereotypes.
