...
#+CAPTION: Clock summary at [2020-01-31 Fri 16:39]
| <75>                                                  |         |       |      |       |
| Headline                                              | Time    |       |      |     % |
|-------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                               | 27:58   |       |      | 100.0 |
| Active                                                |         | 27:58 |      | 100.0 |
| Edit release notes for previous sprint                |         |       | 7:01 |  25.1 |
| Create a demo and presentation for previous sprint    |         |       | 1:49 |   6.5 |
| Sprint and product backlog grooming                   |         |       | 2:08 |   7.6 |
| Create new playlist for assets work                   |         |       | 1:10 |   4.2 |
| Create the final video on the relational model series |         |       | 0:30 |   1.8 |
| Move registrar into assets                            |         |       | 5:34 |  19.9 |
| Fix error in asserter tests                           |         |       | 0:38 |   2.3 |
| Add injection details to all models                   |         |       | 0:25 |   1.5 |
| Fix nightly error in registrar                        |         |       | 0:33 |   2.0 |
| Nightly code coverage is not being reported           |         |       | 0:25 |   1.5 |
| Fixes to setup                                        |         |       | 1:05 |   3.9 |
| Cannot see source file in coveralls                   |         |       | 0:16 |   1.0 |
| Move visual studio fabric types into assets           |         |       | 6:24 |  22.9 |
