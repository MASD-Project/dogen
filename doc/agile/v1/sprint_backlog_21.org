...
#+CAPTION: Clock summary at [2020-02-15 Sat 23:33]
| <75>                                                  |         |       |       |       |
| Headline                                              | Time    |       |       |     % |
|-------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                          | *76:47* |       |       | 100.0 |
|-------------------------------------------------------+---------+-------+-------+-------|
| Stories                                               | 76:47   |       |       | 100.0 |
| Active                                                |         | 76:47 |       | 100.0 |
| Edit release notes for previous sprint                |         |       |  7:01 |   9.1 |
| Create a demo and presentation for previous sprint    |         |       |  1:49 |   2.4 |
| Sprint and product backlog grooming                   |         |       |  3:46 |   4.9 |
| Create new playlist for assets work                   |         |       |  2:19 |   3.0 |
| Create the final video on the relational model series |         |       |  0:30 |   0.7 |
| Move registrar into assets                            |         |       |  5:34 |   7.2 |
...
| Move visual studio fabric types into assets           |         |       | 18:34 |  24.2 |
| Create metamodel elements for =entry_point=           |         |       |  7:18 |   9.5 |
| Remove support for element extensions                 |         |       |  0:44 |   1.0 |
| Move =object_odb_options= into assets                 |         |       |  6:43 |   8.7 |
| Move common ODB options into assets                   |         |       |  4:34 |   5.9 |
| Move msbuild and cmakelists into assets               |         |       |  9:50 |  12.8 |
| Move assembly info and assistant into assets          |         |       |  1:35 |   2.1 |
| Fixes to setup                                        |         |       |  1:05 |   1.4 |
| Cannot see source file in coveralls                   |         |       |  0:16 |   0.3 |
| Integration of archetypes into assets                 |         |       |  2:41 |   3.5 |
