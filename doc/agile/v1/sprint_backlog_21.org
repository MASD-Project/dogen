...
#+CAPTION: Clock summary at [2020-01-31 Fri 11:51]
| <75>                                                  |         |       |      |       |
| Headline                                              | Time    |       |      |     % |
|-------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                          | *25:13* |       |      | 100.0 |
|-------------------------------------------------------+---------+-------+------+-------|
| Stories                                               | 25:13   |       |      | 100.0 |
| Active                                                |         | 25:13 |      | 100.0 |
| Edit release notes for previous sprint                |         |       | 7:01 |  27.8 |
| Create a demo and presentation for previous sprint    |         |       | 1:49 |   7.2 |
| Sprint and product backlog grooming                   |         |       | 1:57 |   7.7 |
| Create new playlist for assets work                   |         |       | 1:06 |   4.4 |
| Create the final video on the relational model series |         |       | 0:30 |   2.0 |
| Move registrar into assets                            |         |       | 5:34 |  22.1 |
| Fix error in asserter tests                           |         |       | 0:38 |   2.5 |
| Add injection details to all models                   |         |       | 0:25 |   1.7 |
| Fix nightly error in registrar                        |         |       | 0:33 |   2.2 |
| Fixes to setup                                        |         |       | 1:05 |   4.3 |
| Move visual studio fabric types into assets           |         |       | 4:10 |  16.5 |
| Nightly code coverage is not being reported           |         |       | 0:25 |   1.7 |
