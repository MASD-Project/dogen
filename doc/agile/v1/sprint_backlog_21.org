...
#+CAPTION: Clock summary at [2020-01-30 Thu 00:30]
| <75>                                                  |         |       |      |       |
| Headline                                              | Time    |       |      |     % |
|-------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                               | 22:09   |       |      | 100.0 |
| Active                                                |         | 22:09 |      | 100.0 |
| Edit release notes for previous sprint                |         |       | 7:01 |  31.7 |
| Create a demo and presentation for previous sprint    |         |       | 1:49 |   8.2 |
| Sprint and product backlog grooming                   |         |       | 1:37 |   7.3 |
| Create the final video on the relational model series |         |       | 0:30 |   2.3 |
| Move registrar into assets                            |         |       | 5:34 |  25.1 |
| Fix error in asserter tests                           |         |       | 0:38 |   2.9 |
| Add injection details to all models                   |         |       | 0:25 |   1.9 |
| Fix nightly error in registrar                        |         |       | 0:33 |   2.5 |
| Move visual studio fabric types into assets           |         |       | 3:37 |  16.3 |
| Nightly code coverage is not being reported           |         |       | 0:25 |   1.9 |
