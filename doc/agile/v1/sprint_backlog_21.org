...
#+CAPTION: Clock summary at [2020-02-01 Sat 20:52]
| <75>                                                  |         |       |       |       |
| Headline                                              | Time    |       |       |     % |
|-------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                          | *35:13* |       |       | 100.0 |
|-------------------------------------------------------+---------+-------+-------+-------|
| Stories                                               | 35:13   |       |       | 100.0 |
| Active                                                |         | 35:13 |       | 100.0 |
| Edit release notes for previous sprint                |         |       |  7:01 |  19.9 |
| Create a demo and presentation for previous sprint    |         |       |  1:49 |   5.2 |
| Sprint and product backlog grooming                   |         |       |  2:08 |   6.1 |
| Create new playlist for assets work                   |         |       |  1:22 |   3.9 |
| Create the final video on the relational model series |         |       |  0:30 |   1.4 |
| Move registrar into assets                            |         |       |  5:34 |  15.8 |
| Fix error in asserter tests                           |         |       |  0:38 |   1.8 |
| Add injection details to all models                   |         |       |  0:25 |   1.2 |
| Fix nightly error in registrar                        |         |       |  0:33 |   1.6 |
| Nightly code coverage is not being reported           |         |       |  0:25 |   1.2 |
| Fixes to setup                                        |         |       |  1:05 |   3.1 |
| Cannot see source file in coveralls                   |         |       |  0:16 |   0.8 |
| Move visual studio fabric types into assets           |         |       | 13:27 |  38.2 |
