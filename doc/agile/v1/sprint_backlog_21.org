...
#+CAPTION: Clock summary at [2020-02-09 Sun 14:33]
| <75>                                                  |         |       |       |       |
| Headline                                              | Time    |       |       |     % |
|-------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                               | 56:14   |       |       | 100.0 |
| Active                                                |         | 56:14 |       | 100.0 |
| Edit release notes for previous sprint                |         |       |  7:01 |  12.5 |
| Create a demo and presentation for previous sprint    |         |       |  1:49 |   3.2 |
| Sprint and product backlog grooming                   |         |       |  3:29 |   6.2 |
| Create new playlist for assets work                   |         |       |  2:19 |   4.1 |
| Create the final video on the relational model series |         |       |  0:30 |   0.9 |
| Move registrar into assets                            |         |       |  5:34 |   9.9 |
| Fix error in asserter tests                           |         |       |  0:38 |   1.1 |
...
| Move visual studio fabric types into assets           |         |       | 18:34 |  33.0 |
| Create metamodel elements for =entry_point=           |         |       |  7:18 |  13.0 |
| Fixes to setup                                        |         |       |  1:05 |   1.9 |
| Cannot see source file in coveralls                   |         |       |  0:16 |   0.5 |
| Integration of archetypes into assets                 |         |       |  2:41 |   4.8 |
| Remove support for element extensions                 |         |       |  0:10 |   0.3 |
| Move =object_odb_options= into assets                 |         |       |  3:27 |   6.1 |
...
looking at the stereotypes. This then results
