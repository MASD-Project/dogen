...
#+CAPTION: Clock summary at [2020-01-28 Tue 00:00]
| <75>                                                  |         |       |      |       |
| Headline                                              | Time    |       |      |     % |
|-------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                          | *17:49* |       |      | 100.0 |
|-------------------------------------------------------+---------+-------+------+-------|
| Stories                                               | 17:49   |       |      | 100.0 |
| Active                                                |         | 17:49 |      | 100.0 |
| Edit release notes for previous sprint                |         |       | 7:01 |  39.4 |
| Create a demo and presentation for previous sprint    |         |       | 1:49 |  10.2 |
| Sprint and product backlog grooming                   |         |       | 0:37 |   3.5 |
| Create the final video on the relational model series |         |       | 0:30 |   2.8 |
| Move registrar into assets                            |         |       | 5:34 |  31.2 |
| Fix error in asserter tests                           |         |       | 0:38 |   3.6 |
| Add injection details to all models                   |         |       | 0:25 |   2.3 |
| Fix nightly error in registrar                        |         |       | 0:33 |   3.1 |
| Move visual studio fabric types into assets           |         |       | 0:35 |   3.3 |
| Nightly code coverage is not being reported           |         |       | 0:07 |   0.7 |
