...
#+CAPTION: Clock summary at [2020-01-29 Wed 09:00]
| <75>                                                  |         |       |      |       |
| Headline                                              | Time    |       |      |     % |
|-------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                               | 20:07   |       |      | 100.0 |
| Active                                                |         | 20:07 |      | 100.0 |
| Edit release notes for previous sprint                |         |       | 7:01 |  34.9 |
| Create a demo and presentation for previous sprint    |         |       | 1:49 |   9.0 |
| Sprint and product backlog grooming                   |         |       | 1:37 |   8.0 |
| Create the final video on the relational model series |         |       | 0:30 |   2.5 |
| Move registrar into assets                            |         |       | 5:34 |  27.7 |
| Fix error in asserter tests                           |         |       | 0:38 |   3.1 |
| Add injection details to all models                   |         |       | 0:25 |   2.1 |
| Fix nightly error in registrar                        |         |       | 0:33 |   2.7 |
| Move visual studio fabric types into assets           |         |       | 1:35 |   7.9 |
| Nightly code coverage is not being reported           |         |       | 0:25 |   2.1 |
