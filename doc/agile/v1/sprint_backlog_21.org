...
#+CAPTION: Clock summary at [2020-02-09 Sun 20:01]
| <75>                                                  |         |       |       |       |
| Headline                                              | Time    |       |       |     % |
|-------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                          | *59:41* |       |       | 100.0 |
|-------------------------------------------------------+---------+-------+-------+-------|
| Stories                                               | 59:41   |       |       | 100.0 |
| Active                                                |         | 59:41 |       | 100.0 |
| Edit release notes for previous sprint                |         |       |  7:01 |  11.8 |
| Create a demo and presentation for previous sprint    |         |       |  1:49 |   3.0 |
| Sprint and product backlog grooming                   |         |       |  3:29 |   5.8 |
| Create new playlist for assets work                   |         |       |  2:19 |   3.9 |
| Create the final video on the relational model series |         |       |  0:30 |   0.8 |
| Move registrar into assets                            |         |       |  5:34 |   9.3 |
...
| Move visual studio fabric types into assets           |         |       | 18:34 |  31.1 |
| Create metamodel elements for =entry_point=           |         |       |  7:18 |  12.2 |
| Fixes to setup                                        |         |       |  1:05 |   1.8 |
| Cannot see source file in coveralls                   |         |       |  0:16 |   0.4 |
| Integration of archetypes into assets                 |         |       |  2:41 |   4.5 |
| Remove support for element extensions                 |         |       |  0:21 |   0.6 |
| Move =object_odb_options= into assets                 |         |       |  6:43 |  11.3 |
