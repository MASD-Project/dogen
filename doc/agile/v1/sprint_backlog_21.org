...
#+CAPTION: Clock summary at [2020-01-28 Tue 21:45]
| <75>                                                  |         |       |      |       |
| Headline                                              | Time    |       |      |     % |
|-------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                               | 18:33   |       |      | 100.0 |
| Active                                                |         | 18:33 |      | 100.0 |
| Edit release notes for previous sprint                |         |       | 7:01 |  37.8 |
| Create a demo and presentation for previous sprint    |         |       | 1:49 |   9.8 |
| Sprint and product backlog grooming                   |         |       | 1:03 |   5.7 |
| Create the final video on the relational model series |         |       | 0:30 |   2.7 |
| Move registrar into assets                            |         |       | 5:34 |  30.0 |
| Fix error in asserter tests                           |         |       | 0:38 |   3.4 |
| Add injection details to all models                   |         |       | 0:25 |   2.2 |
| Fix nightly error in registrar                        |         |       | 0:33 |   3.0 |
| Move visual studio fabric types into assets           |         |       | 0:35 |   3.1 |
