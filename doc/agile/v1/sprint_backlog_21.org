...
#+CAPTION: Clock summary at [2020-02-07 Fri 16:35]
| <75>                                                  |         |       |       |       |
| Headline                                              | Time    |       |       |     % |
|-------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                               | 51:22   |       |       | 100.0 |
| Active                                                |         | 51:22 |       | 100.0 |
| Edit release notes for previous sprint                |         |       |  7:01 |  13.7 |
| Create a demo and presentation for previous sprint    |         |       |  1:49 |   3.5 |
| Sprint and product backlog grooming                   |         |       |  3:29 |   6.8 |
| Create new playlist for assets work                   |         |       |  2:19 |   4.5 |
| Create the final video on the relational model series |         |       |  0:30 |   1.0 |
| Move registrar into assets                            |         |       |  5:34 |  10.8 |
...
| Move visual studio fabric types into assets           |         |       | 18:34 |  36.1 |
| Create metamodel elements for =entry_point=           |         |       |  4:05 |   7.9 |
| Fixes to setup                                        |         |       |  1:05 |   2.1 |
| Cannot see source file in coveralls                   |         |       |  0:16 |   0.5 |
| Integration of archetypes into assets                 |         |       |  2:41 |   5.2 |
| Remove support for element extensions                 |         |       |  0:10 |   0.3 |
| Move =object_odb_options= into assets                 |         |       |  1:48 |   3.5 |
