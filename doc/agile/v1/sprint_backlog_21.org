...
#+CAPTION: Clock summary at [2020-02-15 Sat 20:20]
| <75>                                                  |         |       |       |       |
| Headline                                              | Time    |       |       |     % |
|-------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                          | *74:17* |       |       | 100.0 |
|-------------------------------------------------------+---------+-------+-------+-------|
| Stories                                               | 74:17   |       |       | 100.0 |
| Active                                                |         | 74:17 |       | 100.0 |
| Edit release notes for previous sprint                |         |       |  7:01 |   9.4 |
| Create a demo and presentation for previous sprint    |         |       |  1:49 |   2.4 |
| Sprint and product backlog grooming                   |         |       |  3:46 |   5.1 |
| Create new playlist for assets work                   |         |       |  2:19 |   3.1 |
| Create the final video on the relational model series |         |       |  0:30 |   0.7 |
| Move registrar into assets                            |         |       |  5:34 |   7.5 |
...
| Move visual studio fabric types into assets           |         |       | 18:34 |  25.0 |
| Create metamodel elements for =entry_point=           |         |       |  7:18 |   9.8 |
| Remove support for element extensions                 |         |       |  0:44 |   1.0 |
| Move =object_odb_options= into assets                 |         |       |  6:43 |   9.0 |
| Move common ODB options into assets                   |         |       |  4:34 |   6.1 |
| Fixes to setup                                        |         |       |  1:05 |   1.5 |
| Cannot see source file in coveralls                   |         |       |  0:16 |   0.4 |
| Integration of archetypes into assets                 |         |       |  2:41 |   3.6 |
| Move msbuild and cmakelists into assets               |         |       |  8:55 |  12.0 |
