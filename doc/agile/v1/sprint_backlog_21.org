...
#+CAPTION: Clock summary at [2020-02-02 Sun 19:03]
| <75>                                                  |         |       |       |       |
| Headline                                              | Time    |       |       |     % |
|-------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                               | 37:41   |       |       | 100.0 |
| Active                                                |         | 37:41 |       | 100.0 |
| Edit release notes for previous sprint                |         |       |  7:01 |  18.6 |
| Create a demo and presentation for previous sprint    |         |       |  1:49 |   4.8 |
| Sprint and product backlog grooming                   |         |       |  2:20 |   6.2 |
| Create new playlist for assets work                   |         |       |  1:22 |   3.6 |
| Create the final video on the relational model series |         |       |  0:30 |   1.3 |
| Move registrar into assets                            |         |       |  5:34 |  14.8 |
...
| Fixes to setup                                        |         |       |  1:05 |   2.9 |
| Cannot see source file in coveralls                   |         |       |  0:16 |   0.7 |
| Move visual studio fabric types into assets           |         |       | 14:30 |  38.5 |
