...
#+CAPTION: Clock summary at [2020-02-05 Wed 18:28]
| <75>                                                  |         |       |       |       |
| Headline                                              | Time    |       |       |     % |
|-------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                               | 45:24   |       |       | 100.0 |
| Active                                                |         | 45:24 |       | 100.0 |
| Edit release notes for previous sprint                |         |       |  7:01 |  15.5 |
| Create a demo and presentation for previous sprint    |         |       |  1:49 |   4.0 |
| Sprint and product backlog grooming                   |         |       |  2:24 |   5.3 |
| Create new playlist for assets work                   |         |       |  1:57 |   4.3 |
| Create the final video on the relational model series |         |       |  0:30 |   1.1 |
| Move registrar into assets                            |         |       |  5:34 |  12.3 |
...
| Move visual studio fabric types into assets           |         |       | 18:34 |  40.9 |
| Fixes to setup                                        |         |       |  1:05 |   2.4 |
| Cannot see source file in coveralls                   |         |       |  0:16 |   0.6 |
| Integration of archetypes into assets                 |         |       |  2:41 |   5.9 |
| Remove support for element extensions                 |         |       |  0:10 |   0.4 |
| Create metamodel elements for =entry_point=           |         |       |  1:22 |   3.0 |
