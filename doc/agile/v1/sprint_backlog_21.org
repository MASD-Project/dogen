...
#+CAPTION: Clock summary at [2020-02-11 Tue 22:27]
| <75>                                                  |         |       |       |       |
| Headline                                              | Time    |       |       |     % |
|-------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                          | *63:11* |       |       | 100.0 |
|-------------------------------------------------------+---------+-------+-------+-------|
| Stories                                               | 63:11   |       |       | 100.0 |
| Active                                                |         | 63:11 |       | 100.0 |
| Edit release notes for previous sprint                |         |       |  7:01 |  11.1 |
| Create a demo and presentation for previous sprint    |         |       |  1:49 |   2.9 |
| Sprint and product backlog grooming                   |         |       |  3:29 |   5.5 |
| Create new playlist for assets work                   |         |       |  2:19 |   3.7 |
| Create the final video on the relational model series |         |       |  0:30 |   0.8 |
| Move registrar into assets                            |         |       |  5:34 |   8.8 |
...
| Move visual studio fabric types into assets           |         |       | 18:34 |  29.4 |
| Create metamodel elements for =entry_point=           |         |       |  7:18 |  11.6 |
| Remove support for element extensions                 |         |       |  0:44 |   1.2 |
| Move =object_odb_options= into assets                 |         |       |  6:43 |  10.6 |
| Fixes to setup                                        |         |       |  1:05 |   1.7 |
| Cannot see source file in coveralls                   |         |       |  0:16 |   0.4 |
| Integration of archetypes into assets                 |         |       |  2:41 |   4.2 |
| Move common ODB options into assets                   |         |       |  3:07 |   4.9 |
...
- the generation of odb options file names is at present very
  ...
  postfix to =odb= so that we can reuse the existing infrastructure.
