...
#+CAPTION: Clock summary at [2020-01-31 Fri 21:27]
| <75>                                                  |         |       |      |       |
| Headline                                              | Time    |       |      |     % |
|-------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                               | 31:01   |       |      | 100.0 |
| Active                                                |         | 31:01 |      | 100.0 |
| Edit release notes for previous sprint                |         |       | 7:01 |  22.6 |
| Create a demo and presentation for previous sprint    |         |       | 1:49 |   5.9 |
| Sprint and product backlog grooming                   |         |       | 2:08 |   6.9 |
| Create new playlist for assets work                   |         |       | 1:22 |   4.4 |
| Create the final video on the relational model series |         |       | 0:30 |   1.6 |
| Move registrar into assets                            |         |       | 5:34 |  17.9 |
| Fix error in asserter tests                           |         |       | 0:38 |   2.0 |
| Add injection details to all models                   |         |       | 0:25 |   1.3 |
| Fix nightly error in registrar                        |         |       | 0:33 |   1.8 |
| Nightly code coverage is not being reported           |         |       | 0:25 |   1.3 |
| Fixes to setup                                        |         |       | 1:05 |   3.5 |
| Cannot see source file in coveralls                   |         |       | 0:16 |   0.9 |
| Move visual studio fabric types into assets           |         |       | 9:15 |  29.8 |
