...
#+CAPTION: Clock summary at [2020-01-27 Mon 23:02]
| <75>                                                  |         |       |      |       |
| Headline                                              | Time    |       |      |     % |
|-------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                          | *16:30* |       |      | 100.0 |
|-------------------------------------------------------+---------+-------+------+-------|
| Stories                                               | 16:30   |       |      | 100.0 |
| Active                                                |         | 16:30 |      | 100.0 |
| Edit release notes for previous sprint                |         |       | 7:01 |  42.5 |
| Create a demo and presentation for previous sprint    |         |       | 1:49 |  11.0 |
| Sprint and product backlog grooming                   |         |       | 0:37 |   3.7 |
| Create the final video on the relational model series |         |       | 0:30 |   3.0 |
| Move registrar into assets                            |         |       | 5:16 |  31.9 |
| Fix error in asserter tests                           |         |       | 0:38 |   3.8 |
| Fix nightly error in registrar                        |         |       | 0:33 |   3.3 |
| Move visual studio fabric types into assets           |         |       | 0:06 |   0.6 |
