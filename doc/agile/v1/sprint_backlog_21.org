...
#+CAPTION: Clock summary at [2020-02-03 Mon 18:32]
| <75>                                                  |         |       |       |       |
| Headline                                              | Time    |       |       |     % |
|-------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                          | *40:41* |       |       | 100.0 |
|-------------------------------------------------------+---------+-------+-------+-------|
| Stories                                               | 40:41   |       |       | 100.0 |
| Active                                                |         | 40:41 |       | 100.0 |
| Edit release notes for previous sprint                |         |       |  7:01 |  17.2 |
| Create a demo and presentation for previous sprint    |         |       |  1:49 |   4.5 |
| Sprint and product backlog grooming                   |         |       |  2:20 |   5.7 |
| Create new playlist for assets work                   |         |       |  1:48 |   4.4 |
| Create the final video on the relational model series |         |       |  0:30 |   1.2 |
| Move registrar into assets                            |         |       |  5:34 |  13.7 |
| Fix error in asserter tests                           |         |       |  0:38 |   1.6 |
| Add injection details to all models                   |         |       |  0:25 |   1.0 |
| Fix nightly error in registrar                        |         |       |  0:33 |   1.4 |
| Nightly code coverage is not being reported           |         |       |  0:25 |   1.0 |
| Fixes to setup                                        |         |       |  1:05 |   2.7 |
| Cannot see source file in coveralls                   |         |       |  0:16 |   0.7 |
| Move visual studio fabric types into assets           |         |       | 15:36 |  38.3 |
| Integration of archetypes into assets                 |         |       |  2:41 |   6.6 |
