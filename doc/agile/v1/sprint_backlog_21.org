...
#+CAPTION: Clock summary at [2020-02-09 Sun 09:09]
| <75>                                                  |         |       |       |       |
| Headline                                              | Time    |       |       |     % |
|-------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                               | 55:05   |       |       | 100.0 |
| Active                                                |         | 55:05 |       | 100.0 |
| Edit release notes for previous sprint                |         |       |  7:01 |  12.7 |
| Create a demo and presentation for previous sprint    |         |       |  1:49 |   3.3 |
| Sprint and product backlog grooming                   |         |       |  3:29 |   6.3 |
| Create new playlist for assets work                   |         |       |  2:19 |   4.2 |
| Create the final video on the relational model series |         |       |  0:30 |   0.9 |
| Move registrar into assets                            |         |       |  5:34 |  10.1 |
...
| Move visual studio fabric types into assets           |         |       | 18:34 |  33.7 |
| Create metamodel elements for =entry_point=           |         |       |  7:18 |  13.3 |
...
| Move =object_odb_options= into assets                 |         |       |  2:18 |   4.2 |
