...
#+CAPTION: Clock summary at [2020-02-07 Fri 11:29]
| <75>                                                  |         |       |       |       |
| Headline                                              | Time    |       |       |     % |
|-------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                          | *48:51* |       |       | 100.0 |
|-------------------------------------------------------+---------+-------+-------+-------|
| Stories                                               | 48:51   |       |       | 100.0 |
| Active                                                |         | 48:51 |       | 100.0 |
| Edit release notes for previous sprint                |         |       |  7:01 |  14.4 |
| Create a demo and presentation for previous sprint    |         |       |  1:49 |   3.7 |
| Sprint and product backlog grooming                   |         |       |  2:46 |   5.7 |
| Create new playlist for assets work                   |         |       |  2:19 |   4.7 |
| Create the final video on the relational model series |         |       |  0:30 |   1.0 |
| Move registrar into assets                            |         |       |  5:34 |  11.4 |
| Fix error in asserter tests                           |         |       |  0:38 |   1.3 |
| Add injection details to all models                   |         |       |  0:25 |   0.9 |
| Fix nightly error in registrar                        |         |       |  0:33 |   1.1 |
| Nightly code coverage is not being reported           |         |       |  0:25 |   0.9 |
| Move visual studio fabric types into assets           |         |       | 18:34 |  38.0 |
| Create metamodel elements for =entry_point=           |         |       |  4:05 |   8.4 |
| Fixes to setup                                        |         |       |  1:05 |   2.2 |
| Cannot see source file in coveralls                   |         |       |  0:16 |   0.5 |
| Integration of archetypes into assets                 |         |       |  2:41 |   5.5 |
