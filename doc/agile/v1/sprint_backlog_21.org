...
#+CAPTION: Clock summary at [2020-01-28 Tue 22:35]
| <75>                                                  |         |       |      |       |
| Headline                                              | Time    |       |      |     % |
|-------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                               | 19:22   |       |      | 100.0 |
| Active                                                |         | 19:22 |      | 100.0 |
| Edit release notes for previous sprint                |         |       | 7:01 |  36.2 |
| Create a demo and presentation for previous sprint    |         |       | 1:49 |   9.4 |
| Sprint and product backlog grooming                   |         |       | 1:03 |   5.4 |
| Create the final video on the relational model series |         |       | 0:30 |   2.6 |
| Move registrar into assets                            |         |       | 5:34 |  28.7 |
| Fix error in asserter tests                           |         |       | 0:38 |   3.3 |
| Add injection details to all models                   |         |       | 0:25 |   2.2 |
| Fix nightly error in registrar                        |         |       | 0:33 |   2.8 |
| Move visual studio fabric types into assets           |         |       | 1:24 |   7.2 |
| Nightly code coverage is not being reported           |         |       | 0:25 |   2.2 |
