...
#+CAPTION: Clock summary at [2019-11-29 Fri 11:11]
| <75>                                               |         |       |       |       |
| Headline                                           | Time    |       |       |     % |
|----------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                       | *28:26* |       |       | 100.0 |
|----------------------------------------------------+---------+-------+-------+-------|
| Stories                                            | 28:26   |       |       | 100.0 |
| Active                                             |         | 28:26 |       | 100.0 |
| Edit release notes for previous sprint             |         |       | 11:24 |  40.1 |
| Create a demo and presentation for previous sprint |         |       |  2:31 |   8.9 |
| Sprint and product backlog grooming                |         |       |  2:21 |   8.3 |
| Fix OSX build errors                               |         |       |  0:25 |   1.5 |
| Fix broken build due to incorrect postgres library |         |       |  2:31 |   8.9 |
| Add relational tracing support                     |         |       |  6:57 |  24.4 |
