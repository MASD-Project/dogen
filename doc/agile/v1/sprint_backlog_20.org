...
#+CAPTION: Clock summary at [2019-11-29 Fri 14:54]
| <75>                                               |         |       |       |       |
| Headline                                           | Time    |       |       |     % |
|----------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                            | 30:45   |       |       | 100.0 |
| Active                                             |         | 30:45 |       | 100.0 |
| Edit release notes for previous sprint             |         |       | 11:24 |  37.1 |
| Create a demo and presentation for previous sprint |         |       |  2:31 |   8.2 |
| Sprint and product backlog grooming                |         |       |  2:24 |   7.8 |
| Fix OSX build errors                               |         |       |  0:25 |   1.4 |
| Fix broken build due to incorrect postgres library |         |       |  2:31 |   8.2 |
| Add relational tracing support                     |         |       |  6:57 |  22.6 |
| Add type overrides to primitives                   |         |       |  3:29 |  11.3 |
| Nightly code coverage is not being reported        |         |       |  0:23 |   1.2 |
| Allow non-throwing casts for enums                 |         |       |  0:41 |   2.2 |
