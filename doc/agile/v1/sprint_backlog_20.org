...
#+CAPTION: Clock summary at [2019-11-29 Fri 11:25]
| <75>                                               |         |       |       |       |
| Headline                                           | Time    |       |       |     % |
|----------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                            | 28:38   |       |       | 100.0 |
| Active                                             |         | 28:38 |       | 100.0 |
| Edit release notes for previous sprint             |         |       | 11:24 |  39.8 |
| Create a demo and presentation for previous sprint |         |       |  2:31 |   8.8 |
| Sprint and product backlog grooming                |         |       |  2:24 |   8.4 |
| Fix OSX build errors                               |         |       |  0:25 |   1.5 |
| Fix broken build due to incorrect postgres library |         |       |  2:31 |   8.8 |
| Add relational tracing support                     |         |       |  6:57 |  24.3 |
| Add type overrides to primitives                   |         |       |  2:03 |   7.2 |
