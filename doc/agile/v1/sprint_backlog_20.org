...
#+CAPTION: Clock summary at [2019-12-13 Fri 22:41]
| <75>                                                 |         |       |       |       |
| Headline                                             | Time    |       |       |     % |
|------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                         | *58:21* |       |       | 100.0 |
|------------------------------------------------------+---------+-------+-------+-------|
| Stories                                              | 58:21   |       |       | 100.0 |
| Active                                               |         | 58:21 |       | 100.0 |
| Edit release notes for previous sprint               |         |       | 11:24 |  19.5 |
| Create a demo and presentation for previous sprint   |         |       |  2:31 |   4.3 |
| Sprint and product backlog grooming                  |         |       |  4:00 |   6.9 |
| Fix OSX build errors                                 |         |       |  0:25 |   0.7 |
| Fix broken build due to incorrect postgres library   |         |       |  2:31 |   4.3 |
| Fix borked nightly  due to serialisation link errors |         |       |  1:18 |   2.2 |
| Create a profile called =untested=                   |         |       |  0:17 |   0.5 |
| Remove =odb_properties= in element properties        |         |       |  2:36 |   4.5 |
| Allow non-throwing casts for enums                   |         |       |  0:41 |   1.2 |
| Add type overrides to primitives                     |         |       |  8:55 |  15.3 |
| Create a string-based tracing backend interface      |         |       |  5:22 |   9.2 |
...
| Add relational tracing support                       |         |       | 15:50 |  27.1 |
