...
#+CAPTION: Clock summary at [2019-12-01 Sun 19:03]
| <75>                                                 |         |       |       |       |
| Headline                                             | Time    |       |       |     % |
|------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                         | *37:25* |       |       | 100.0 |
|------------------------------------------------------+---------+-------+-------+-------|
| Stories                                              | 37:25   |       |       | 100.0 |
| Active                                               |         | 37:25 |       | 100.0 |
| Edit release notes for previous sprint               |         |       | 11:24 |  30.5 |
| Create a demo and presentation for previous sprint   |         |       |  2:31 |   6.7 |
| Sprint and product backlog grooming                  |         |       |  2:24 |   6.4 |
| Fix OSX build errors                                 |         |       |  0:25 |   1.1 |
| Fix broken build due to incorrect postgres library   |         |       |  2:31 |   6.7 |
| Fix borked nightly  due to serialisation link errors |         |       |  1:18 |   3.5 |
| Add relational tracing support                       |         |       |  9:08 |  24.4 |
| Add type overrides to primitives                     |         |       |  5:44 |  15.3 |
| Nightly code coverage is not being reported          |         |       |  0:23 |   1.0 |
| Allow non-throwing casts for enums                   |         |       |  0:41 |   1.8 |
| Remove =odb_properties= in element properties        |         |       |  0:56 |   2.5 |
