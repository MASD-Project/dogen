...
#+CAPTION: Clock summary at [2019-11-29 Fri 10:31]
| <75>                                               |         |       |       |       |
| Headline                                           | Time    |       |       |     % |
|----------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                       | *27:50* |       |       | 100.0 |
|----------------------------------------------------+---------+-------+-------+-------|
| Stories                                            | 27:50   |       |       | 100.0 |
| Active                                             |         | 27:50 |       | 100.0 |
| Edit release notes for previous sprint             |         |       | 11:24 |  41.0 |
| Create a demo and presentation for previous sprint |         |       |  2:31 |   9.0 |
| Sprint and product backlog grooming                |         |       |  2:12 |   7.9 |
| Fix OSX build errors                               |         |       |  0:25 |   1.5 |
| Fix broken build due to incorrect postgres library |         |       |  2:04 |   7.4 |
| Add relational tracing support                     |         |       |  6:57 |  25.0 |
| Add type overrides to primitives                   |         |       |  1:54 |   6.8 |
