...
#+CAPTION: Clock summary at [2019-12-04 Wed 18:42]
| <75>                                                 |         |       |       |       |
| Headline                                             | Time    |       |       |     % |
|------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                              | 45:10   |       |       | 100.0 |
| Active                                               |         | 45:10 |       | 100.0 |
| Edit release notes for previous sprint               |         |       | 11:24 |  25.2 |
| Create a demo and presentation for previous sprint   |         |       |  2:31 |   5.6 |
| Sprint and product backlog grooming                  |         |       |  3:32 |   7.8 |
| Fix OSX build errors                                 |         |       |  0:25 |   0.9 |
| Fix broken build due to incorrect postgres library   |         |       |  2:31 |   5.6 |
| Fix borked nightly  due to serialisation link errors |         |       |  1:18 |   2.9 |
| Create a profile called =untested=                   |         |       |  0:17 |   0.6 |
| Remove =odb_properties= in element properties        |         |       |  2:36 |   5.8 |
| Allow non-throwing casts for enums                   |         |       |  0:41 |   1.5 |
| Add type overrides to primitives                     |         |       |  8:55 |  19.7 |
| Add relational tracing support                       |         |       |  9:48 |  21.7 |
| Nightly code coverage is not being reported          |         |       |  0:23 |   0.8 |
| Move member variable name to assets                  |         |       |  0:09 |   0.3 |
| Create a string-based tracing backend interface      |         |       |  0:40 |   1.5 |
