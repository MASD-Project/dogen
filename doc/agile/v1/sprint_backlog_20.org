...
#+CAPTION: Clock summary at [2019-11-29 Fri 11:00]
| <75>                                               |         |       |       |       |
| Headline                                           | Time    |       |       |     % |
|----------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                       | *28:17* |       |       | 100.0 |
|----------------------------------------------------+---------+-------+-------+-------|
| Stories                                            | 28:17   |       |       | 100.0 |
| Active                                             |         | 28:17 |       | 100.0 |
| Edit release notes for previous sprint             |         |       | 11:24 |  40.3 |
| Create a demo and presentation for previous sprint |         |       |  2:31 |   8.9 |
| Sprint and product backlog grooming                |         |       |  2:12 |   7.8 |
| Fix OSX build errors                               |         |       |  0:25 |   1.5 |
| Fix broken build due to incorrect postgres library |         |       |  2:31 |   8.9 |
| Add relational tracing support                     |         |       |  6:57 |  24.6 |
| Add type overrides to primitives                   |         |       |  1:54 |   6.7 |
