...
#+CAPTION: Clock summary at [2019-12-02 Mon 19:57]
| <75>                                                 |         |       |       |       |
| Headline                                             | Time    |       |       |     % |
|------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                              | 39:11   |       |       | 100.0 |
| Active                                               |         | 39:11 |       | 100.0 |
| Edit release notes for previous sprint               |         |       | 11:24 |  29.1 |
| Create a demo and presentation for previous sprint   |         |       |  2:31 |   6.4 |
| Sprint and product backlog grooming                  |         |       |  2:24 |   6.1 |
| Fix OSX build errors                                 |         |       |  0:25 |   1.1 |
| Fix broken build due to incorrect postgres library   |         |       |  2:31 |   6.4 |
| Fix borked nightly  due to serialisation link errors |         |       |  1:18 |   3.3 |
| Create a profile called =untested=                   |         |       |  0:17 |   0.7 |
| Add relational tracing support                       |         |       |  9:08 |  23.3 |
| Add type overrides to primitives                     |         |       |  5:44 |  14.6 |
| Nightly code coverage is not being reported          |         |       |  0:23 |   1.0 |
| Allow non-throwing casts for enums                   |         |       |  0:41 |   1.7 |
| Remove =odb_properties= in element properties        |         |       |  2:25 |   6.2 |
