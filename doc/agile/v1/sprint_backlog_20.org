...
#+CAPTION: Clock summary at [2020-01-19 Sun 09:47]
| <75>                                                 |         |       |       |       |
| Headline                                             | Time    |       |       |     % |
|------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                         | *79:55* |       |       | 100.0 |
|------------------------------------------------------+---------+-------+-------+-------|
| Stories                                              | 79:55   |       |       | 100.0 |
| Active                                               |         | 79:55 |       | 100.0 |
| Edit release notes for previous sprint               |         |       | 11:24 |  14.3 |
| Create a demo and presentation for previous sprint   |         |       |  2:31 |   3.1 |
| Sprint and product backlog grooming                  |         |       |  4:42 |   5.9 |
| Fix OSX build errors                                 |         |       |  0:25 |   0.5 |
| Fix broken build due to incorrect postgres library   |         |       |  2:31 |   3.1 |
...
| Create a string-based tracing backend interface      |         |       |  5:22 |   6.7 |
...
| Record a SHA1 of loaded injection models             |         |       |  5:38 |   7.0 |
| Add relational tracing support                       |         |       | 27:47 |  34.8 |
