...
#+CAPTION: Clock summary at [2019-11-25 Mon 23:40]
| <75>                                               |         |       |       |       |
| Headline                                           | Time    |       |       |     % |
|----------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                       | *24:36* |       |       | 100.0 |
|----------------------------------------------------+---------+-------+-------+-------|
| Stories                                            | 24:36   |       |       | 100.0 |
| Active                                             |         | 24:36 |       | 100.0 |
| Edit release notes for previous sprint             |         |       | 11:24 |  46.3 |
...
| Add relational tracing support                     |         |       |  6:39 |  27.0 |
| Add type overrides to primitives                   |         |       |  0:21 |   1.4 |
| Fix broken build due to incorrect postgres library |         |       |  0:52 |   3.5 |
