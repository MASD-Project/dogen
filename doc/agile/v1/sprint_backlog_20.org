...
#+CAPTION: Clock summary at [2019-12-14 Sat 15:30]
| <75>                                                 |         |       |       |       |
| Headline                                             | Time    |       |       |     % |
|------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                              | 59:29   |       |       | 100.0 |
| Active                                               |         | 59:29 |       | 100.0 |
| Edit release notes for previous sprint               |         |       | 11:24 |  19.2 |
| Create a demo and presentation for previous sprint   |         |       |  2:31 |   4.2 |
| Sprint and product backlog grooming                  |         |       |  4:00 |   6.7 |
| Fix OSX build errors                                 |         |       |  0:25 |   0.7 |
| Fix broken build due to incorrect postgres library   |         |       |  2:31 |   4.2 |
| Fix borked nightly  due to serialisation link errors |         |       |  1:18 |   2.2 |
| Create a profile called =untested=                   |         |       |  0:17 |   0.5 |
| Remove =odb_properties= in element properties        |         |       |  2:36 |   4.4 |
| Allow non-throwing casts for enums                   |         |       |  0:41 |   1.1 |
| Add type overrides to primitives                     |         |       |  8:55 |  15.0 |
| Create a string-based tracing backend interface      |         |       |  5:22 |   9.0 |
| Create a tracing registrar                           |         |       |  1:10 |   2.0 |
| Move member variable name to assets                  |         |       |  0:09 |   0.3 |
| Create a transform instance ID property              |         |       |  0:31 |   0.9 |
| Laptop issues                                        |         |       |  0:18 |   0.5 |
| Add relational tracing support                       |         |       | 16:58 |  28.5 |
