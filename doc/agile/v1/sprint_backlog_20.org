...
#+CAPTION: Clock summary at [2019-12-16 Mon 19:27]
| <75>                                                 |         |       |       |       |
| Headline                                             | Time    |       |       |     % |
|------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                              | 65:47   |       |       | 100.0 |
| Active                                               |         | 65:47 |       | 100.0 |
| Edit release notes for previous sprint               |         |       | 11:24 |  17.3 |
| Create a demo and presentation for previous sprint   |         |       |  2:31 |   3.8 |
| Sprint and product backlog grooming                  |         |       |  4:00 |   6.1 |
| Fix OSX build errors                                 |         |       |  0:25 |   0.6 |
| Fix broken build due to incorrect postgres library   |         |       |  2:31 |   3.8 |
...
| Add type overrides to primitives                     |         |       |  8:55 |  13.6 |
| Create a string-based tracing backend interface      |         |       |  5:22 |   8.2 |
...
| Add relational tracing support                       |         |       | 23:16 |  35.4 |
