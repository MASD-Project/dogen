...
#+CAPTION: Clock summary at [2019-12-13 Fri 17:33]
| <75>                                                 |         |       |       |       |
| Headline                                             | Time    |       |       |     % |
|------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                              | 55:11   |       |       | 100.0 |
| Active                                               |         | 55:11 |       | 100.0 |
| Edit release notes for previous sprint               |         |       | 11:24 |  20.7 |
| Create a demo and presentation for previous sprint   |         |       |  2:31 |   4.6 |
| Sprint and product backlog grooming                  |         |       |  4:00 |   7.2 |
| Fix OSX build errors                                 |         |       |  0:25 |   0.8 |
| Fix broken build due to incorrect postgres library   |         |       |  2:31 |   4.6 |
| Fix borked nightly  due to serialisation link errors |         |       |  1:18 |   2.4 |
...
| Add type overrides to primitives                     |         |       |  8:55 |  16.2 |
| Create a string-based tracing backend interface      |         |       |  5:22 |   9.7 |
| Create a tracing registrar                           |         |       |  1:10 |   2.1 |
| Move member variable name to assets                  |         |       |  0:09 |   0.3 |
| Laptop issues                                        |         |       |  0:18 |   0.5 |
| Add relational tracing support                       |         |       | 13:11 |  23.9 |
