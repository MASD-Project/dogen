...
#+CAPTION: Clock summary at [2019-12-01 Sun 12:20]
| <75>                                                 |         |       |       |       |
| Headline                                             | Time    |       |       |     % |
|------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                              | 34:39   |       |       | 100.0 |
| Active                                               |         | 34:39 |       | 100.0 |
| Edit release notes for previous sprint               |         |       | 11:24 |  32.9 |
| Create a demo and presentation for previous sprint   |         |       |  2:31 |   7.3 |
| Sprint and product backlog grooming                  |         |       |  2:24 |   6.9 |
| Fix OSX build errors                                 |         |       |  0:25 |   1.2 |
| Fix broken build due to incorrect postgres library   |         |       |  2:31 |   7.3 |
| Fix borked nightly  due to serialisation link errors |         |       |  1:18 |   3.8 |
| Add relational tracing support                       |         |       |  9:08 |  26.4 |
| Add type overrides to primitives                     |         |       |  3:54 |  11.3 |
| Nightly code coverage is not being reported          |         |       |  0:23 |   1.1 |
| Allow non-throwing casts for enums                   |         |       |  0:41 |   2.0 |
