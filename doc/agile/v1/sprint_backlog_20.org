...
#+CAPTION: Clock summary at [2019-12-21 Sat 14:46]
| <75>                                                 |         |       |       |       |
| Headline                                             | Time    |       |       |     % |
|------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                         | *66:54* |       |       | 100.0 |
|------------------------------------------------------+---------+-------+-------+-------|
| Stories                                              | 66:54   |       |       | 100.0 |
| Active                                               |         | 66:54 |       | 100.0 |
| Edit release notes for previous sprint               |         |       | 11:24 |  17.0 |
| Create a demo and presentation for previous sprint   |         |       |  2:31 |   3.8 |
| Sprint and product backlog grooming                  |         |       |  4:00 |   6.0 |
...
| Remove =odb_properties= in element properties        |         |       |  2:36 |   3.9 |
| Allow non-throwing casts for enums                   |         |       |  0:41 |   1.0 |
| Add type overrides to primitives                     |         |       |  8:55 |  13.3 |
| Create a string-based tracing backend interface      |         |       |  5:22 |   8.0 |
...
| Add relational tracing support                       |         |       | 24:23 |  36.4 |
