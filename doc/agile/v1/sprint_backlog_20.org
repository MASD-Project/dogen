...
#+CAPTION: Clock summary at [2019-12-03 Tue 00:26]
| <75>                                                 |         |       |       |       |
| Headline                                             | Time    |       |       |     % |
|------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                         | *41:09* |       |       | 100.0 |
|------------------------------------------------------+---------+-------+-------+-------|
| Stories                                              | 41:09   |       |       | 100.0 |
| Active                                               |         | 41:09 |       | 100.0 |
| Edit release notes for previous sprint               |         |       | 11:24 |  27.7 |
| Create a demo and presentation for previous sprint   |         |       |  2:31 |   6.1 |
| Sprint and product backlog grooming                  |         |       |  2:30 |   6.1 |
| Fix OSX build errors                                 |         |       |  0:25 |   1.0 |
| Fix broken build due to incorrect postgres library   |         |       |  2:31 |   6.1 |
| Fix borked nightly  due to serialisation link errors |         |       |  1:18 |   3.2 |
| Create a profile called =untested=                   |         |       |  0:17 |   0.7 |
| Add relational tracing support                       |         |       |  9:08 |  22.2 |
| Add type overrides to primitives                     |         |       |  7:36 |  18.5 |
| Nightly code coverage is not being reported          |         |       |  0:23 |   0.9 |
| Allow non-throwing casts for enums                   |         |       |  0:41 |   1.7 |
| Remove =odb_properties= in element properties        |         |       |  2:25 |   5.9 |
...
*** STARTED Remove =odb_properties= in element properties             :story:
    :LOGBOOK:
...
FIXME: We detect containment for modules, but not recursive
containment.

*** Move member variable name to assets                               :story:
