...
#+CAPTION: Clock summary at [2019-11-22 Fri 11:05]
| <75>                                               |         |       |       |       |
| Headline                                           | Time    |       |       |     % |
|----------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                       | *11:26* |       |       | 100.0 |
|----------------------------------------------------+---------+-------+-------+-------|
| Stories                                            | 11:26   |       |       | 100.0 |
| Active                                             |         | 11:26 |       | 100.0 |
| Edit release notes for previous sprint             |         |       | 10:28 |  91.5 |
| Create a demo and presentation for previous sprint |         |       |  0:15 |   2.2 |
| Sprint and product backlog grooming                |         |       |  0:31 |   4.5 |
| Fix OSX build errors                               |         |       |  0:12 |   1.7 |
...
*** STARTED Fix OSX build errors                                      :story:
    :LOGBOOK:
...
We can try to remove the brew version of boost:
