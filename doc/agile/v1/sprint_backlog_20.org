...
#+CAPTION: Clock summary at [2019-12-01 Sun 13:53]
| <75>                                                 |         |       |       |       |
| Headline                                             | Time    |       |       |     % |
|------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                              | 36:08   |       |       | 100.0 |
| Active                                               |         | 36:08 |       | 100.0 |
| Edit release notes for previous sprint               |         |       | 11:24 |  31.5 |
| Create a demo and presentation for previous sprint   |         |       |  2:31 |   7.0 |
| Sprint and product backlog grooming                  |         |       |  2:24 |   6.6 |
| Fix OSX build errors                                 |         |       |  0:25 |   1.2 |
| Fix broken build due to incorrect postgres library   |         |       |  2:31 |   7.0 |
| Fix borked nightly  due to serialisation link errors |         |       |  1:18 |   3.6 |
| Add relational tracing support                       |         |       |  9:08 |  25.3 |
| Add type overrides to primitives                     |         |       |  5:23 |  14.9 |
| Nightly code coverage is not being reported          |         |       |  0:23 |   1.1 |
| Allow non-throwing casts for enums                   |         |       |  0:41 |   1.9 |
