...
#+CAPTION: Clock summary at [2020-01-17 Fri 20:02]
| <75>                                                 |         |       |       |       |
| Headline                                             | Time    |       |       |     % |
|------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                         | *75:35* |       |       | 100.0 |
|------------------------------------------------------+---------+-------+-------+-------|
| Stories                                              | 75:35   |       |       | 100.0 |
| Active                                               |         | 75:35 |       | 100.0 |
| Edit release notes for previous sprint               |         |       | 11:24 |  15.1 |
| Create a demo and presentation for previous sprint   |         |       |  2:31 |   3.3 |
| Sprint and product backlog grooming                  |         |       |  4:15 |   5.6 |
| Fix OSX build errors                                 |         |       |  0:25 |   0.6 |
| Fix broken build due to incorrect postgres library   |         |       |  2:31 |   3.3 |
| Fix borked nightly  due to serialisation link errors |         |       |  1:18 |   1.7 |
| Create a profile called =untested=                   |         |       |  0:17 |   0.4 |
| Remove =odb_properties= in element properties        |         |       |  2:36 |   3.4 |
| Allow non-throwing casts for enums                   |         |       |  0:41 |   0.9 |
| Add type overrides to primitives                     |         |       |  8:55 |  11.8 |
| Create a string-based tracing backend interface      |         |       |  5:22 |   7.1 |
| Create a tracing registrar                           |         |       |  1:10 |   1.5 |
| Move member variable name to assets                  |         |       |  0:09 |   0.2 |
| Create a transform instance ID property              |         |       |  0:31 |   0.7 |
| Laptop issues                                        |         |       |  0:18 |   0.4 |
| Add relational tracing support                       |         |       | 27:47 |  36.8 |
| Nightly code coverage is not being reported          |         |       |  0:23 |   0.5 |
| Move registrar into assets                           |         |       |  0:59 |   1.3 |
| Do not compute the timestamp at formatting time      |         |       |  1:53 |   2.5 |
| Record a SHA1 of loaded injection models             |         |       |  1:45 |   2.3 |
...
*** STARTED Do not compute the timestamp at formatting time           :story:
    :LOGBOOK:
...
*** STARTED Record a SHA1 of loaded injection models                  :story:
    :LOGBOOK:
