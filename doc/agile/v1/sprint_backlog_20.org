...
#+CAPTION: Clock summary at [2019-12-13 Fri 12:26]
| <75>                                                 |         |       |       |       |
| Headline                                             | Time    |       |       |     % |
|------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                              | 52:41   |       |       | 100.0 |
| Active                                               |         | 52:41 |       | 100.0 |
| Edit release notes for previous sprint               |         |       | 11:24 |  21.6 |
| Create a demo and presentation for previous sprint   |         |       |  2:31 |   4.8 |
| Sprint and product backlog grooming                  |         |       |  3:54 |   7.4 |
| Fix OSX build errors                                 |         |       |  0:25 |   0.8 |
| Fix broken build due to incorrect postgres library   |         |       |  2:31 |   4.8 |
| Fix borked nightly  due to serialisation link errors |         |       |  1:18 |   2.5 |
| Create a profile called =untested=                   |         |       |  0:17 |   0.5 |
| Remove =odb_properties= in element properties        |         |       |  2:36 |   4.9 |
| Allow non-throwing casts for enums                   |         |       |  0:41 |   1.3 |
| Add type overrides to primitives                     |         |       |  8:55 |  16.9 |
| Laptop issues                                        |         |       |  0:18 |   0.6 |
| Create a tracing registrar                           |         |       |  1:10 |   2.2 |
| Add relational tracing support                       |         |       | 13:11 |  25.0 |
| Nightly code coverage is not being reported          |         |       |  0:23 |   0.7 |
| Move member variable name to assets                  |         |       |  0:09 |   0.3 |
| Create a string-based tracing backend interface      |         |       |  2:58 |   5.6 |
