...
#+CAPTION: Clock summary at [2019-12-14 Sat 22:41]
| <75>                                                 |         |       |       |       |
| Headline                                             | Time    |       |       |     % |
|------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                         | *64:59* |       |       | 100.0 |
|------------------------------------------------------+---------+-------+-------+-------|
| Stories                                              | 64:59   |       |       | 100.0 |
| Active                                               |         | 64:59 |       | 100.0 |
| Edit release notes for previous sprint               |         |       | 11:24 |  17.5 |
| Create a demo and presentation for previous sprint   |         |       |  2:31 |   3.9 |
| Sprint and product backlog grooming                  |         |       |  4:00 |   6.2 |
| Fix OSX build errors                                 |         |       |  0:25 |   0.6 |
| Fix broken build due to incorrect postgres library   |         |       |  2:31 |   3.9 |
| Fix borked nightly  due to serialisation link errors |         |       |  1:18 |   2.0 |
| Create a profile called =untested=                   |         |       |  0:17 |   0.4 |
| Remove =odb_properties= in element properties        |         |       |  2:36 |   4.0 |
| Allow non-throwing casts for enums                   |         |       |  0:41 |   1.1 |
| Add type overrides to primitives                     |         |       |  8:55 |  13.7 |
| Create a string-based tracing backend interface      |         |       |  5:22 |   8.3 |
| Create a tracing registrar                           |         |       |  1:10 |   1.8 |
| Move member variable name to assets                  |         |       |  0:09 |   0.2 |
| Create a transform instance ID property              |         |       |  0:31 |   0.8 |
| Laptop issues                                        |         |       |  0:18 |   0.5 |
| Add relational tracing support                       |         |       | 22:28 |  34.6 |
