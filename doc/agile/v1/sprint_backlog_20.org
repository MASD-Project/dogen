...
#+CAPTION: Clock summary at [2019-11-29 Fri 12:40]
| <75>                                               |         |       |       |       |
| Headline                                           | Time    |       |       |     % |
|----------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                       | *29:41* |       |       | 100.0 |
|----------------------------------------------------+---------+-------+-------+-------|
| Stories                                            | 29:41   |       |       | 100.0 |
| Active                                             |         | 29:41 |       | 100.0 |
| Edit release notes for previous sprint             |         |       | 11:24 |  38.4 |
| Create a demo and presentation for previous sprint |         |       |  2:31 |   8.5 |
| Sprint and product backlog grooming                |         |       |  2:24 |   8.1 |
| Fix OSX build errors                               |         |       |  0:25 |   1.4 |
| Fix broken build due to incorrect postgres library |         |       |  2:31 |   8.5 |
| Add relational tracing support                     |         |       |  6:57 |  23.4 |
| Add type overrides to primitives                   |         |       |  2:25 |   8.1 |
| Nightly code coverage is not being reported        |         |       |  0:23 |   1.3 |
| Allow non-throwing casts for enums                 |         |       |  0:41 |   2.3 |
