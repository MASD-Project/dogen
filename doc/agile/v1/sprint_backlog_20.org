...
#+CAPTION: Clock summary at [2019-12-04 Wed 23:20]
| <75>                                                 |         |       |       |       |
| Headline                                             | Time    |       |       |     % |
|------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                         | *47:28* |       |       | 100.0 |
|------------------------------------------------------+---------+-------+-------+-------|
| Stories                                              | 47:28   |       |       | 100.0 |
| Active                                               |         | 47:28 |       | 100.0 |
| Edit release notes for previous sprint               |         |       | 11:24 |  24.0 |
| Create a demo and presentation for previous sprint   |         |       |  2:31 |   5.3 |
| Sprint and product backlog grooming                  |         |       |  3:32 |   7.4 |
| Fix OSX build errors                                 |         |       |  0:25 |   0.9 |
| Fix broken build due to incorrect postgres library   |         |       |  2:31 |   5.3 |
| Fix borked nightly  due to serialisation link errors |         |       |  1:18 |   2.7 |
| Create a profile called =untested=                   |         |       |  0:17 |   0.6 |
| Remove =odb_properties= in element properties        |         |       |  2:36 |   5.5 |
| Allow non-throwing casts for enums                   |         |       |  0:41 |   1.4 |
| Add type overrides to primitives                     |         |       |  8:55 |  18.8 |
| Add relational tracing support                       |         |       | 12:06 |  25.5 |
