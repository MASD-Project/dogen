...
#+CAPTION: Clock summary at [2019-12-03 Tue 23:22]
| <75>                                                 |         |       |       |       |
| Headline                                             | Time    |       |       |     % |
|------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                              | 43:36   |       |       | 100.0 |
| Active                                               |         | 43:36 |       | 100.0 |
| Edit release notes for previous sprint               |         |       | 11:24 |  26.1 |
| Create a demo and presentation for previous sprint   |         |       |  2:31 |   5.8 |
| Sprint and product backlog grooming                  |         |       |  3:29 |   8.0 |
| Fix OSX build errors                                 |         |       |  0:25 |   1.0 |
| Fix broken build due to incorrect postgres library   |         |       |  2:31 |   5.8 |
| Fix borked nightly  due to serialisation link errors |         |       |  1:18 |   3.0 |
| Create a profile called =untested=                   |         |       |  0:17 |   0.6 |
| Remove =odb_properties= in element properties        |         |       |  2:25 |   5.5 |
| Allow non-throwing casts for enums                   |         |       |  0:41 |   1.6 |
| Add type overrides to primitives                     |         |       |  8:55 |  20.5 |
| Add relational tracing support                       |         |       |  9:08 |  20.9 |
