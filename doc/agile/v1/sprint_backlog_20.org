...
#+CAPTION: Clock summary at [2019-12-01 Sun 18:52]
| <75>                                                 |         |       |       |       |
| Headline                                             | Time    |       |       |     % |
|------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                              | 37:15   |       |       | 100.0 |
| Active                                               |         | 37:15 |       | 100.0 |
| Edit release notes for previous sprint               |         |       | 11:24 |  30.6 |
| Create a demo and presentation for previous sprint   |         |       |  2:31 |   6.8 |
| Sprint and product backlog grooming                  |         |       |  2:24 |   6.4 |
| Fix OSX build errors                                 |         |       |  0:25 |   1.1 |
| Fix broken build due to incorrect postgres library   |         |       |  2:31 |   6.8 |
| Fix borked nightly  due to serialisation link errors |         |       |  1:18 |   3.5 |
| Add relational tracing support                       |         |       |  9:08 |  24.5 |
| Add type overrides to primitives                     |         |       |  5:44 |  15.4 |
| Nightly code coverage is not being reported          |         |       |  0:23 |   1.0 |
| Allow non-throwing casts for enums                   |         |       |  0:41 |   1.8 |
| Remove =odb_properties= in element properties        |         |       |  0:46 |   2.1 |
