...
#+CAPTION: Clock summary at [2019-12-01 Sun 21:43]
| <75>                                                 |         |       |       |       |
| Headline                                             | Time    |       |       |     % |
|------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                         | *38:33* |       |       | 100.0 |
|------------------------------------------------------+---------+-------+-------+-------|
| Stories                                              | 38:33   |       |       | 100.0 |
| Active                                               |         | 38:33 |       | 100.0 |
| Edit release notes for previous sprint               |         |       | 11:24 |  29.6 |
| Create a demo and presentation for previous sprint   |         |       |  2:31 |   6.5 |
| Sprint and product backlog grooming                  |         |       |  2:24 |   6.2 |
| Fix OSX build errors                                 |         |       |  0:25 |   1.1 |
| Fix broken build due to incorrect postgres library   |         |       |  2:31 |   6.5 |
| Fix borked nightly  due to serialisation link errors |         |       |  1:18 |   3.4 |
| Add relational tracing support                       |         |       |  9:08 |  23.7 |
| Add type overrides to primitives                     |         |       |  5:44 |  14.9 |
| Nightly code coverage is not being reported          |         |       |  0:23 |   1.0 |
| Allow non-throwing casts for enums                   |         |       |  0:41 |   1.8 |
| Remove =odb_properties= in element properties        |         |       |  2:04 |   5.4 |
