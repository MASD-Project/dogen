...
#+CAPTION: Clock summary at [2019-12-02 Mon 23:36]
| <75>                                                 |         |       |       |       |
| Headline                                             | Time    |       |       |     % |
|------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                         | *40:22* |       |       | 100.0 |
|------------------------------------------------------+---------+-------+-------+-------|
| Stories                                              | 40:22   |       |       | 100.0 |
| Active                                               |         | 40:22 |       | 100.0 |
| Edit release notes for previous sprint               |         |       | 11:24 |  28.2 |
| Create a demo and presentation for previous sprint   |         |       |  2:31 |   6.2 |
| Sprint and product backlog grooming                  |         |       |  2:24 |   5.9 |
| Fix OSX build errors                                 |         |       |  0:25 |   1.0 |
| Fix broken build due to incorrect postgres library   |         |       |  2:31 |   6.2 |
| Fix borked nightly  due to serialisation link errors |         |       |  1:18 |   3.2 |
| Create a profile called =untested=                   |         |       |  0:17 |   0.7 |
| Add relational tracing support                       |         |       |  9:08 |  22.6 |
| Add type overrides to primitives                     |         |       |  6:55 |  17.1 |
| Nightly code coverage is not being reported          |         |       |  0:23 |   0.9 |
| Allow non-throwing casts for enums                   |         |       |  0:41 |   1.7 |
| Remove =odb_properties= in element properties        |         |       |  2:25 |   6.0 |
