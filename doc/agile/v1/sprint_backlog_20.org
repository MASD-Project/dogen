...
#+CAPTION: Clock summary at [2019-12-22 Sun 21:27]
| <75>                                                 |         |       |       |       |
| Headline                                             | Time    |       |       |     % |
|------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                         | *68:20* |       |       | 100.0 |
|------------------------------------------------------+---------+-------+-------+-------|
| Stories                                              | 68:20   |       |       | 100.0 |
| Active                                               |         | 68:20 |       | 100.0 |
| Edit release notes for previous sprint               |         |       | 11:24 |  16.7 |
| Create a demo and presentation for previous sprint   |         |       |  2:31 |   3.7 |
| Sprint and product backlog grooming                  |         |       |  4:00 |   5.9 |
| Fix OSX build errors                                 |         |       |  0:25 |   0.6 |
| Fix broken build due to incorrect postgres library   |         |       |  2:31 |   3.7 |
| Fix borked nightly  due to serialisation link errors |         |       |  1:18 |   1.9 |
| Create a profile called =untested=                   |         |       |  0:17 |   0.4 |
| Remove =odb_properties= in element properties        |         |       |  2:36 |   3.8 |
| Allow non-throwing casts for enums                   |         |       |  0:41 |   1.0 |
| Add type overrides to primitives                     |         |       |  8:55 |  13.0 |
| Create a string-based tracing backend interface      |         |       |  5:22 |   7.9 |
...
| Add relational tracing support                       |         |       | 25:49 |  37.8 |
