...
#+CAPTION: Clock summary at [2020-01-18 Sat 18:11]
| <75>                                                 |         |       |       |       |
| Headline                                             | Time    |       |       |     % |
|------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                         | *78:21* |       |       | 100.0 |
|------------------------------------------------------+---------+-------+-------+-------|
| Stories                                              | 78:21   |       |       | 100.0 |
| Active                                               |         | 78:21 |       | 100.0 |
| Edit release notes for previous sprint               |         |       | 11:24 |  14.6 |
| Create a demo and presentation for previous sprint   |         |       |  2:31 |   3.2 |
| Sprint and product backlog grooming                  |         |       |  4:15 |   5.4 |
| Fix OSX build errors                                 |         |       |  0:25 |   0.5 |
| Fix broken build due to incorrect postgres library   |         |       |  2:31 |   3.2 |
| Fix borked nightly  due to serialisation link errors |         |       |  1:18 |   1.7 |
| Create a profile called =untested=                   |         |       |  0:17 |   0.4 |
| Remove =odb_properties= in element properties        |         |       |  2:36 |   3.3 |
| Allow non-throwing casts for enums                   |         |       |  0:41 |   0.9 |
| Add type overrides to primitives                     |         |       |  8:55 |  11.4 |
| Create a string-based tracing backend interface      |         |       |  5:22 |   6.8 |
...
| Add relational tracing support                       |         |       | 27:47 |  35.5 |
| Nightly code coverage is not being reported          |         |       |  0:23 |   0.5 |
| Move registrar into assets                           |         |       |  0:59 |   1.3 |
| Do not compute the timestamp at formatting time      |         |       |  1:53 |   2.4 |
| Record a SHA1 of loaded injection models             |         |       |  4:31 |   5.8 |
