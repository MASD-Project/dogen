...
#+CAPTION: Clock summary at [2019-11-25 Mon 18:27]
| <75>                                               |         |       |       |       |
| Headline                                           | Time    |       |       |     % |
|----------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                       | *23:44* |       |       | 100.0 |
|----------------------------------------------------+---------+-------+-------+-------|
| Stories                                            | 23:44   |       |       | 100.0 |
| Active                                             |         | 23:44 |       | 100.0 |
| Edit release notes for previous sprint             |         |       | 11:24 |  48.0 |
| Create a demo and presentation for previous sprint |         |       |  2:31 |  10.6 |
| Sprint and product backlog grooming                |         |       |  2:01 |   8.5 |
| Fix OSX build errors                               |         |       |  0:25 |   1.8 |
| Nightly code coverage is not being reported        |         |       |  0:23 |   1.6 |
| Add relational tracing support                     |         |       |  6:39 |  28.0 |
| Add type overrides to primitives                   |         |       |  0:21 |   1.5 |
