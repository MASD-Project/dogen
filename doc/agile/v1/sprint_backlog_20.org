...
#+CAPTION: Clock summary at [2019-11-25 Mon 23:46]
| <75>                                               |         |       |       |       |
| Headline                                           | Time    |       |       |     % |
|----------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                       | *24:41* |       |       | 100.0 |
|----------------------------------------------------+---------+-------+-------+-------|
| Stories                                            | 24:41   |       |       | 100.0 |
| Active                                             |         | 24:41 |       | 100.0 |
| Edit release notes for previous sprint             |         |       | 11:24 |  46.2 |
| Create a demo and presentation for previous sprint |         |       |  2:31 |  10.2 |
| Sprint and product backlog grooming                |         |       |  2:01 |   8.2 |
| Fix OSX build errors                               |         |       |  0:25 |   1.7 |
| Nightly code coverage is not being reported        |         |       |  0:23 |   1.6 |
| Add relational tracing support                     |         |       |  6:39 |  26.9 |
| Add type overrides to primitives                   |         |       |  0:21 |   1.4 |
| Fix broken build due to incorrect postgres library |         |       |  0:57 |   3.8 |
...
*** STARTED Fix broken build due to incorrect postgres library        :story:
    :LOGBOOK:
...
we can maybe disable the relational model in CI.
...
*** Remove =odb_properties= in element properties                     :story:
