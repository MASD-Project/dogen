...
#+CAPTION: Clock summary at [2019-11-28 Thu 00:13]
| <75>                                               |         |       |       |       |
| Headline                                           | Time    |       |       |     % |
|----------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                            | 26:44   |       |       | 100.0 |
| Active                                             |         | 26:44 |       | 100.0 |
| Edit release notes for previous sprint             |         |       | 11:24 |  42.6 |
| Create a demo and presentation for previous sprint |         |       |  2:31 |   9.4 |
| Sprint and product backlog grooming                |         |       |  2:01 |   7.5 |
| Fix OSX build errors                               |         |       |  0:25 |   1.6 |
| Add relational tracing support                     |         |       |  6:57 |  26.0 |
| Add type overrides to primitives                   |         |       |  1:54 |   7.1 |
| Fix broken build due to incorrect postgres library |         |       |  1:09 |   4.3 |
| Nightly code coverage is not being reported        |         |       |  0:23 |   1.4 |
