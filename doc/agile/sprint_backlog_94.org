...
#+CAPTION: Clock summary at [2016-12-17 Sat 14:01]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| COMPLETED Add helper infrastructure to C#                                   |         |       |  5:55 |  18.7 |
| COMPLETED Add support for Equals in C#                                      |         |       |  1:24 |   4.4 |
| COMPLETED Create a test model solution to validate C# code                  |         |       |  3:47 |  12.0 |
| COMPLETED Add basic io support to C#                                        |         |       | 11:56 |  37.8 |
| COMPLETED Add basic test data generation support to C#                      |         |       |  0:41 |   2.2 |
| COMPLETED Add io and equality canned unit tests to C# model                 |         |       |  3:55 |  12.4 |
| STARTED Update C# stitch templates to match code                            |         |       |  2:29 |   7.9 |
