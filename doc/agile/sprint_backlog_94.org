...
#+CAPTION: Clock summary at [2016-12-17 Sat 18:23]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *34:32* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 34:32   |       |       | 100.0 |
| Active                                                                      |         | 34:32 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:56 |   2.7 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:31 |   1.5 |
| COMPLETED Add helper infrastructure to C#                                   |         |       |  5:55 |  17.1 |
| COMPLETED Add support for Equals in C#                                      |         |       |  1:24 |   4.1 |
| COMPLETED Create a test model solution to validate C# code                  |         |       |  3:47 |  11.0 |
| COMPLETED Add basic io support to C#                                        |         |       | 11:56 |  34.6 |
| COMPLETED Add basic test data generation support to C#                      |         |       |  0:41 |   2.0 |
| COMPLETED Add io and equality canned unit tests to C# model                 |         |       |  3:55 |  11.3 |
| STARTED Update C# stitch templates to match code                            |         |       |  5:27 |  15.8 |
