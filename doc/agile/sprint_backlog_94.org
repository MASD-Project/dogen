...
#+CAPTION: Clock summary at [2016-12-17 Sat 14:14]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *31:46* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 31:46   |       |       | 100.0 |
| Active                                                                      |         | 31:46 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:56 |   2.9 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:31 |   1.6 |
| COMPLETED Add helper infrastructure to C#                                   |         |       |  5:55 |  18.6 |
| COMPLETED Add support for Equals in C#                                      |         |       |  1:24 |   4.4 |
| COMPLETED Create a test model solution to validate C# code                  |         |       |  3:47 |  11.9 |
| COMPLETED Add basic io support to C#                                        |         |       | 11:56 |  37.6 |
| COMPLETED Add basic test data generation support to C#                      |         |       |  0:41 |   2.2 |
| COMPLETED Add io and equality canned unit tests to C# model                 |         |       |  3:55 |  12.3 |
| STARTED Update C# stitch templates to match code                            |         |       |  2:41 |   8.4 |
