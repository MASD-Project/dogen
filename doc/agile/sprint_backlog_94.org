...
#+CAPTION: Clock summary at [2016-12-17 Sat 16:08]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *33:31* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 33:31   |       |       | 100.0 |
| Active                                                                      |         | 33:31 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:56 |   2.8 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:31 |   1.5 |
| COMPLETED Add helper infrastructure to C#                                   |         |       |  5:55 |  17.7 |
| COMPLETED Add support for Equals in C#                                      |         |       |  1:24 |   4.2 |
| COMPLETED Create a test model solution to validate C# code                  |         |       |  3:47 |  11.3 |
| COMPLETED Add basic io support to C#                                        |         |       | 11:56 |  35.6 |
| COMPLETED Add basic test data generation support to C#                      |         |       |  0:41 |   2.0 |
| COMPLETED Add io and equality canned unit tests to C# model                 |         |       |  3:55 |  11.7 |
| STARTED Update C# stitch templates to match code                            |         |       |  4:26 |  13.2 |
