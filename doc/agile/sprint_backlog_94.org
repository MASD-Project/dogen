...
#+CAPTION: Clock summary at [2016-12-19 Mon 21:55]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                                     | 44:30   |       |       | 100.0 |
| Active                                                                      |         | 44:30 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:03 |   2.4 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:31 |   1.2 |
| COMPLETED Add helper infrastructure to C#                                   |         |       |  5:55 |  13.3 |
| COMPLETED Add support for Equals in C#                                      |         |       |  1:24 |   3.1 |
| COMPLETED Create a test model solution to validate C# code                  |         |       |  3:47 |   8.5 |
| COMPLETED Add basic io support to C#                                        |         |       | 11:56 |  26.8 |
| COMPLETED Add basic test data generation support to C#                      |         |       |  0:41 |   1.5 |
| COMPLETED Add io and equality canned unit tests to C# model                 |         |       |  3:55 |   8.8 |
| COMPLETED Update C# stitch templates to match code                          |         |       |  7:28 |  16.8 |
...
| COMPLETED Add support for associations in C#                                |         |       |  3:14 |   7.3 |
| STARTED Add complete constructor for C# types                               |         |       |  0:03 |   0.1 |
| STARTED Add support for inheritance in C#                                   |         |       |  1:30 |   3.4 |
