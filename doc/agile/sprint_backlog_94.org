...
#+CAPTION: Clock summary at [2016-12-12 Mon 13:43]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
...
| Stories                                                                     | 0:25   |      |      | 100.0 |
| Active                                                                      |        | 0:25 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:17 |  68.0 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 0:08 |  32.0 |
...
Overview
========
The sprint's headline feature is the start of the C# kernel. It is only an experimental feature, but Dogen can already generate the basic infrastructure such as projects, solutions and simple classes.

Most of the work carried out this sprint was related to adding multiple kernels to Dogen, so it is not user visible. The remaining work was related to the required C# infrastructure.
