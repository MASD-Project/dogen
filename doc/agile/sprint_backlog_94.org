...
#+CAPTION: Clock summary at [2016-12-19 Mon 14:04]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *39:19* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 39:19   |       |       | 100.0 |
| Active                                                                      |         | 39:19 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:56 |   2.4 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:31 |   1.3 |
| COMPLETED Add helper infrastructure to C#                                   |         |       |  5:55 |  15.0 |
| COMPLETED Add support for Equals in C#                                      |         |       |  1:24 |   3.6 |
| COMPLETED Create a test model solution to validate C# code                  |         |       |  3:47 |   9.6 |
| COMPLETED Add basic io support to C#                                        |         |       | 11:56 |  30.4 |
| COMPLETED Add basic test data generation support to C#                      |         |       |  0:41 |   1.7 |
| COMPLETED Add io and equality canned unit tests to C# model                 |         |       |  3:55 |  10.0 |
| COMPLETED Update C# stitch templates to match code                          |         |       |  7:28 |  19.0 |
| COMPLETED Move enumeration population to yarn                               |         |       |  0:43 |   1.8 |
| COMPLETED Add support for types in packages in C#                           |         |       |  0:18 |   0.8 |
| COMPLETED Add support for enumerations in C#                                |         |       |  1:45 |   4.5 |
