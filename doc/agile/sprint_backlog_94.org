...
#+CAPTION: Clock summary at [2016-12-14 Wed 10:24]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 12:51   |       |      | 100.0 |
| Active                                                                      |         | 12:51 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:23 |   3.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:31 |   4.0 |
| COMPLETED Add helper infrastructure to C#                                   |         |       | 5:55 |  46.0 |
| COMPLETED Add support for Equals in C#                                      |         |       | 1:24 |  10.9 |
| STARTED Add io support in C#                                                |         |       | 3:17 |  25.6 |
| STARTED Create a test model solution to validate C# code                    |         |       | 1:21 |  10.5 |
...
- at the meta-model level we need to be able to distinguish between
  ...
  with helpers c) regular model types with dumpers.
...
*** STARTED Create a test model solution to validate C# code          :story:
