...
#+CAPTION: Clock summary at [2016-12-23 Fri 17:39]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *54:44* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 54:44   |       |       | 100.0 |
| Active                                                                      |         | 54:44 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:09 |   2.1 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:31 |   0.9 |
| COMPLETED Add helper infrastructure to C#                                   |         |       |  5:55 |  10.8 |
| COMPLETED Add support for Equals in C#                                      |         |       |  1:24 |   2.6 |
| COMPLETED Create a test model solution to validate C# code                  |         |       |  3:47 |   6.9 |
| COMPLETED Add basic io support to C#                                        |         |       | 11:56 |  21.8 |
| COMPLETED Add basic test data generation support to C#                      |         |       |  0:41 |   1.2 |
| COMPLETED Add io and equality canned unit tests to C# model                 |         |       |  3:55 |   7.2 |
| COMPLETED Update C# stitch templates to match code                          |         |       |  7:28 |  13.6 |
| COMPLETED Move enumeration population to yarn                               |         |       |  0:43 |   1.3 |
| COMPLETED Add support for types in packages in C#                           |         |       |  0:18 |   0.5 |
| COMPLETED Add support for enumerations in C#                                |         |       |  1:48 |   3.3 |
| COMPLETED Add support for exceptions in C#                                  |         |       |  0:14 |   0.4 |
| COMPLETED Add support for associations in C#                                |         |       |  3:14 |   5.9 |
| COMPLETED Add support for inheritance in C#                                 |         |       |  6:21 |  11.6 |
| COMPLETED Consider changing inherited attributes to a list                  |         |       |  0:34 |   1.0 |
| COMPLETED Add complete constructor for C# types                             |         |       |  1:44 |   3.2 |
| COMPLETED Add immutability support for C# types                             |         |       |  0:13 |   0.4 |
| STARTED Add handcrafted class to C# test model                              |         |       |  0:03 |   0.1 |
| STARTED Add container types to C# proxy models                              |         |       |  2:46 |   5.1 |
...
*** STARTED Add handcrafted class to C# test model                    :story:
...
*** Consider supporting multiple inheritance on non-proxy models      :story:
