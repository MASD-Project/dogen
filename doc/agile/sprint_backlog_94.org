...
#+CAPTION: Clock summary at [2016-12-15 Thu 12:39]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *20:03* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 20:03   |       |      | 100.0 |
| Active                                                                      |         | 20:03 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:23 |   1.9 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:31 |   2.6 |
| COMPLETED Add helper infrastructure to C#                                   |         |       | 5:55 |  29.5 |
| COMPLETED Add support for Equals in C#                                      |         |       | 1:24 |   7.0 |
| COMPLETED Create a test model solution to validate C# code                  |         |       | 3:47 |  18.9 |
| STARTED Add io support in C#                                                |         |       | 8:03 |  40.1 |
