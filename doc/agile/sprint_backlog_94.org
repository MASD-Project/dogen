...
#+CAPTION: Clock summary at [2016-12-17 Sat 15:07]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *32:30* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 32:30   |       |       | 100.0 |
| Active                                                                      |         | 32:30 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:56 |   2.9 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:31 |   1.6 |
| COMPLETED Add helper infrastructure to C#                                   |         |       |  5:55 |  18.2 |
| COMPLETED Add support for Equals in C#                                      |         |       |  1:24 |   4.3 |
| COMPLETED Create a test model solution to validate C# code                  |         |       |  3:47 |  11.6 |
| COMPLETED Add basic io support to C#                                        |         |       | 11:56 |  36.7 |
| COMPLETED Add basic test data generation support to C#                      |         |       |  0:41 |   2.1 |
| COMPLETED Add io and equality canned unit tests to C# model                 |         |       |  3:55 |  12.1 |
| STARTED Update C# stitch templates to match code                            |         |       |  3:25 |  10.5 |
