...
#+CAPTION: Clock summary at [2016-12-17 Sat 16:58]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *34:18* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 34:18   |       |       | 100.0 |
| Active                                                                      |         | 34:18 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:56 |   2.7 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:31 |   1.5 |
| COMPLETED Add helper infrastructure to C#                                   |         |       |  5:55 |  17.2 |
| COMPLETED Add support for Equals in C#                                      |         |       |  1:24 |   4.1 |
| COMPLETED Create a test model solution to validate C# code                  |         |       |  3:47 |  11.0 |
| COMPLETED Add basic io support to C#                                        |         |       | 11:56 |  34.8 |
| COMPLETED Add basic test data generation support to C#                      |         |       |  0:41 |   2.0 |
| COMPLETED Add io and equality canned unit tests to C# model                 |         |       |  3:55 |  11.4 |
| STARTED Update C# stitch templates to match code                            |         |       |  5:13 |  15.2 |
...
*** STARTED Update C# stitch templates to match code                  :story:
