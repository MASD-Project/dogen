...
#+CAPTION: Clock summary at [2016-12-15 Thu 14:44]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *21:04* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 21:04   |       |      | 100.0 |
| Active                                                                      |         | 21:04 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:56 |   4.4 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:31 |   2.5 |
| COMPLETED Add helper infrastructure to C#                                   |         |       | 5:55 |  28.1 |
| COMPLETED Add support for Equals in C#                                      |         |       | 1:24 |   6.6 |
| COMPLETED Create a test model solution to validate C# code                  |         |       | 3:47 |  18.0 |
| STARTED Add io support in C#                                                |         |       | 8:31 |  40.4 |
