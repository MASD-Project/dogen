...
#+CAPTION: Clock summary at [2016-12-14 Wed 12:53]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 14:42   |       |      | 100.0 |
| Active                                                                      |         | 14:42 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:23 |   2.6 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:31 |   3.5 |
| COMPLETED Add helper infrastructure to C#                                   |         |       | 5:55 |  40.2 |
| COMPLETED Add support for Equals in C#                                      |         |       | 1:24 |   9.5 |
| STARTED Add io support in C#                                                |         |       | 3:17 |  22.3 |
| STARTED Create a test model solution to validate C# code                    |         |       | 3:12 |  21.8 |
