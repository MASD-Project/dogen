...
#+CAPTION: Clock summary at [2016-12-14 Wed 17:24]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *16:36* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 16:36   |       |      | 100.0 |
| Active                                                                      |         | 16:36 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:23 |   2.3 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:31 |   3.1 |
| COMPLETED Add helper infrastructure to C#                                   |         |       | 5:55 |  35.6 |
| COMPLETED Add support for Equals in C#                                      |         |       | 1:24 |   8.4 |
| COMPLETED Create a test model solution to validate C# code                  |         |       | 3:47 |  22.8 |
| STARTED Add io support in C#                                                |         |       | 4:36 |  27.7 |
