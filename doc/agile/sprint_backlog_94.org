...
#+CAPTION: Clock summary at [2016-12-16 Fri 10:41]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                                     | 26:13   |       |       | 100.0 |
| Active                                                                      |         | 26:13 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:56 |   3.6 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:31 |   2.0 |
| COMPLETED Add helper infrastructure to C#                                   |         |       |  5:55 |  22.6 |
| COMPLETED Add support for Equals in C#                                      |         |       |  1:24 |   5.3 |
| COMPLETED Create a test model solution to validate C# code                  |         |       |  3:47 |  14.4 |
| COMPLETED Add basic io support to C#                                        |         |       | 11:56 |  45.5 |
| COMPLETED Add basic test data generation support to C#                      |         |       |  0:41 |   2.6 |
| STARTED Add canned unit tests to C# model                                   |         |       |  1:03 |   4.0 |
