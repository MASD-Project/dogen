...
#+CAPTION: Clock summary at [2016-12-16 Fri 12:13]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *27:43* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 27:43   |       |       | 100.0 |
| Active                                                                      |         | 27:43 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:56 |   3.4 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:31 |   1.9 |
| COMPLETED Add helper infrastructure to C#                                   |         |       |  5:55 |  21.3 |
| COMPLETED Add support for Equals in C#                                      |         |       |  1:24 |   5.1 |
| COMPLETED Create a test model solution to validate C# code                  |         |       |  3:47 |  13.7 |
| COMPLETED Add basic io support to C#                                        |         |       | 11:56 |  43.1 |
| COMPLETED Add basic test data generation support to C#                      |         |       |  0:41 |   2.5 |
| STARTED Add canned unit tests to C# model                                   |         |       |  2:33 |   9.2 |
...
*** STARTED Add canned unit tests to C# model                         :story:
