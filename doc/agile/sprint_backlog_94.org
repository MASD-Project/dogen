...
#+CAPTION: Clock summary at [2016-12-19 Mon 13:12]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *38:28* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 38:28   |       |       | 100.0 |
| Active                                                                      |         | 38:28 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:56 |   2.4 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:31 |   1.3 |
| COMPLETED Add helper infrastructure to C#                                   |         |       |  5:55 |  15.4 |
| COMPLETED Add support for Equals in C#                                      |         |       |  1:24 |   3.6 |
| COMPLETED Create a test model solution to validate C# code                  |         |       |  3:47 |   9.8 |
| COMPLETED Add basic io support to C#                                        |         |       | 11:56 |  31.0 |
| COMPLETED Add basic test data generation support to C#                      |         |       |  0:41 |   1.8 |
| COMPLETED Add io and equality canned unit tests to C# model                 |         |       |  3:55 |  10.2 |
| COMPLETED Update C# stitch templates to match code                          |         |       |  7:28 |  19.4 |
| COMPLETED Move enumeration population to yarn                               |         |       |  0:43 |   1.9 |
| STARTED Add support for enumerations in C#                                  |         |       |  1:12 |   3.1 |
