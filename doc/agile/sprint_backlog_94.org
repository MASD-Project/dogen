...
#+CAPTION: Clock summary at [2016-12-19 Mon 14:24]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| COMPLETED Add helper infrastructure to C#                                   |         |       |  5:55 |  14.9 |
| COMPLETED Add support for Equals in C#                                      |         |       |  1:24 |   3.5 |
| COMPLETED Create a test model solution to validate C# code                  |         |       |  3:47 |   9.6 |
| COMPLETED Add basic io support to C#                                        |         |       | 11:56 |  30.1 |
| COMPLETED Add basic test data generation support to C#                      |         |       |  0:41 |   1.7 |
| COMPLETED Add io and equality canned unit tests to C# model                 |         |       |  3:55 |   9.9 |
| COMPLETED Update C# stitch templates to match code                          |         |       |  7:28 |  18.9 |
| COMPLETED Move enumeration population to yarn                               |         |       |  0:43 |   1.8 |
| COMPLETED Add support for types in packages in C#                           |         |       |  0:18 |   0.8 |
| COMPLETED Add support for enumerations in C#                                |         |       |  1:48 |   4.5 |
