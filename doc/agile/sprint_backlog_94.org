...
#+CAPTION: Clock summary at [2016-12-17 Sat 15:30]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:31 |   1.6 |
| COMPLETED Add helper infrastructure to C#                                   |         |       |  5:55 |  18.0 |
| COMPLETED Add support for Equals in C#                                      |         |       |  1:24 |   4.3 |
| COMPLETED Create a test model solution to validate C# code                  |         |       |  3:47 |  11.5 |
| COMPLETED Add basic io support to C#                                        |         |       | 11:56 |  36.3 |
| COMPLETED Add basic test data generation support to C#                      |         |       |  0:41 |   2.1 |
| COMPLETED Add io and equality canned unit tests to C# model                 |         |       |  3:55 |  11.9 |
| STARTED Update C# stitch templates to match code                            |         |       |  3:49 |  11.6 |
