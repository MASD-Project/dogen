...
#+CAPTION: Clock summary at [2016-12-16 Fri 15:20]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *28:48* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 28:48   |       |       | 100.0 |
| Active                                                                      |         | 28:48 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:56 |   3.2 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:31 |   1.8 |
| COMPLETED Add helper infrastructure to C#                                   |         |       |  5:55 |  20.5 |
| COMPLETED Add support for Equals in C#                                      |         |       |  1:24 |   4.9 |
| COMPLETED Create a test model solution to validate C# code                  |         |       |  3:47 |  13.1 |
| COMPLETED Add basic io support to C#                                        |         |       | 11:56 |  41.4 |
| COMPLETED Add basic test data generation support to C#                      |         |       |  0:41 |   2.4 |
| STARTED Add canned unit tests to C# model                                   |         |       |  3:38 |  12.6 |
