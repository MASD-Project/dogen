...
#+CAPTION: Clock summary at [2016-12-23 Fri 14:15]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *51:42* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 51:42   |       |       | 100.0 |
| Active                                                                      |         | 51:42 |       | 100.0 |
...
| COMPLETED Add basic io support to C#                                        |         |       | 11:56 |  23.1 |
| COMPLETED Add basic test data generation support to C#                      |         |       |  0:41 |   1.3 |
| COMPLETED Add io and equality canned unit tests to C# model                 |         |       |  3:55 |   7.6 |
...
| COMPLETED Add support for associations in C#                                |         |       |  3:14 |   6.3 |
| COMPLETED Add support for inheritance in C#                                 |         |       |  6:21 |  12.3 |
| COMPLETED Consider changing inherited attributes to a list                  |         |       |  0:34 |   1.1 |
| COMPLETED Add complete constructor for C# types                             |         |       |  1:44 |   3.4 |
