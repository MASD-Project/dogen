...
#+CAPTION: Clock summary at [2016-12-23 Fri 13:04]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *50:31* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 50:31   |       |       | 100.0 |
| Active                                                                      |         | 50:31 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:09 |   2.3 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:31 |   1.0 |
| COMPLETED Add helper infrastructure to C#                                   |         |       |  5:55 |  11.7 |
| COMPLETED Add support for Equals in C#                                      |         |       |  1:24 |   2.8 |
| COMPLETED Create a test model solution to validate C# code                  |         |       |  3:47 |   7.5 |
| COMPLETED Add basic io support to C#                                        |         |       | 11:56 |  23.6 |
| COMPLETED Add basic test data generation support to C#                      |         |       |  0:41 |   1.4 |
| COMPLETED Add io and equality canned unit tests to C# model                 |         |       |  3:55 |   7.8 |
| COMPLETED Update C# stitch templates to match code                          |         |       |  7:28 |  14.8 |
...
| COMPLETED Add support for associations in C#                                |         |       |  3:14 |   6.4 |
| COMPLETED Add support for inheritance in C#                                 |         |       |  6:21 |  12.6 |
| STARTED Add complete constructor for C# types                               |         |       |  0:51 |   1.7 |
| CANCELLED Inherited attributes should just be a list                        |         |       |  0:16 |   0.5 |
