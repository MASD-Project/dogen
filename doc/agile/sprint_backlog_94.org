...
#+CAPTION: Clock summary at [2016-12-17 Sat 14:51]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *32:17* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 32:17   |       |       | 100.0 |
| Active                                                                      |         | 32:17 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:56 |   2.9 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:31 |   1.6 |
| COMPLETED Add helper infrastructure to C#                                   |         |       |  5:55 |  18.3 |
| COMPLETED Add support for Equals in C#                                      |         |       |  1:24 |   4.3 |
| COMPLETED Create a test model solution to validate C# code                  |         |       |  3:47 |  11.7 |
| COMPLETED Add basic io support to C#                                        |         |       | 11:56 |  37.0 |
...
| STARTED Update C# stitch templates to match code                            |         |       |  3:12 |   9.9 |
