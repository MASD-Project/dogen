...
#+CAPTION: Clock summary at [2016-12-17 Sat 12:19]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *31:14* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 31:14   |       |       | 100.0 |
| Active                                                                      |         | 31:14 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:56 |   3.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:31 |   1.7 |
| COMPLETED Add helper infrastructure to C#                                   |         |       |  5:55 |  18.9 |
| COMPLETED Add support for Equals in C#                                      |         |       |  1:24 |   4.5 |
| COMPLETED Create a test model solution to validate C# code                  |         |       |  3:47 |  12.1 |
| COMPLETED Add basic io support to C#                                        |         |       | 11:56 |  38.2 |
| COMPLETED Add basic test data generation support to C#                      |         |       |  0:41 |   2.2 |
| COMPLETED Add io and equality canned unit tests to C# model                 |         |       |  3:55 |  12.5 |
| STARTED Update C# stitch templates to match code                            |         |       |  2:09 |   6.9 |
