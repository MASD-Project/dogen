...
#+CAPTION: Clock summary at [2016-12-23 Fri 22:13]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                                     | 56:39   |       |       | 100.0 |
| Active                                                                      |         | 56:39 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:09 |   2.0 |
...
| STARTED Consider supporting multiple inheritance on non-proxy models        |         |       |  1:55 |   3.4 |
| STARTED Add handcrafted class to C# test model                              |         |       |  0:03 |   0.1 |
| STARTED Add container types to C# proxy models                              |         |       |  2:46 |   4.9 |
...
concept, etc.
*** STARTED Consider supporting multiple inheritance on non-proxy models :story:
