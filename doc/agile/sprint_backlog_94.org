...
#+CAPTION: Clock summary at [2016-12-19 Mon 13:47]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| COMPLETED Add helper infrastructure to C#                                   |         |       |  5:55 |  15.2 |
| COMPLETED Add support for Equals in C#                                      |         |       |  1:24 |   3.6 |
| COMPLETED Create a test model solution to validate C# code                  |         |       |  3:47 |   9.7 |
| COMPLETED Add basic io support to C#                                        |         |       | 11:56 |  30.6 |
| COMPLETED Add basic test data generation support to C#                      |         |       |  0:41 |   1.8 |
| COMPLETED Add io and equality canned unit tests to C# model                 |         |       |  3:55 |  10.0 |
| COMPLETED Update C# stitch templates to match code                          |         |       |  7:28 |  19.1 |
| COMPLETED Move enumeration population to yarn                               |         |       |  0:43 |   1.8 |
| STARTED Add support for enumerations in C#                                  |         |       |  1:45 |   4.5 |
