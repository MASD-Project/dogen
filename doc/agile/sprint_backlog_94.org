...
#+CAPTION: Clock summary at [2016-12-14 Wed 10:29]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| COMPLETED Add helper infrastructure to C#                                   |         |       | 5:55 |  45.8 |
| COMPLETED Add support for Equals in C#                                      |         |       | 1:24 |  10.8 |
| STARTED Add io support in C#                                                |         |       | 3:17 |  25.4 |
| STARTED Create a test model solution to validate C# code                    |         |       | 1:25 |  11.0 |
