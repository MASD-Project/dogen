...
#+CAPTION: Clock summary at [2016-12-19 Mon 12:17]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:31 |   1.4 |
| COMPLETED Add helper infrastructure to C#                                   |         |       |  5:55 |  15.6 |
| COMPLETED Add support for Equals in C#                                      |         |       |  1:24 |   3.7 |
| COMPLETED Create a test model solution to validate C# code                  |         |       |  3:47 |  10.0 |
| COMPLETED Add basic io support to C#                                        |         |       | 11:56 |  31.4 |
| COMPLETED Add basic test data generation support to C#                      |         |       |  0:41 |   1.8 |
| COMPLETED Add io and equality canned unit tests to C# model                 |         |       |  3:55 |  10.3 |
| COMPLETED Update C# stitch templates to match code                          |         |       |  7:28 |  19.7 |
| COMPLETED Move enumeration population to yarn                               |         |       |  0:43 |   1.9 |
| STARTED Add support for enumerations in C#                                  |         |       |  0:41 |   1.8 |
...
*** STARTED Add support for enumerations in C#                        :story:
...
*** Add support for types in packages in C#                           :story:
