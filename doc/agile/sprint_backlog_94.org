...
#+CAPTION: Clock summary at [2016-12-23 Fri 09:34]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *47:56* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 47:56   |       |       | 100.0 |
| Active                                                                      |         | 47:56 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:03 |   2.2 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:31 |   1.1 |
| COMPLETED Add helper infrastructure to C#                                   |         |       |  5:55 |  12.3 |
| COMPLETED Add support for Equals in C#                                      |         |       |  1:24 |   2.9 |
| COMPLETED Create a test model solution to validate C# code                  |         |       |  3:47 |   7.9 |
| COMPLETED Add basic io support to C#                                        |         |       | 11:56 |  24.9 |
| COMPLETED Add basic test data generation support to C#                      |         |       |  0:41 |   1.4 |
| COMPLETED Add io and equality canned unit tests to C# model                 |         |       |  3:55 |   8.2 |
| COMPLETED Update C# stitch templates to match code                          |         |       |  7:28 |  15.6 |
...
| COMPLETED Add support for associations in C#                                |         |       |  3:14 |   6.7 |
| COMPLETED Add support for inheritance in C#                                 |         |       |  4:56 |  10.3 |
