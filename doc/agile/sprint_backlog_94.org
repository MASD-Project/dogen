...
#+CAPTION: Clock summary at [2016-12-22 Thu 11:53]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *46:55* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 46:55   |       |       | 100.0 |
| Active                                                                      |         | 46:55 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:03 |   2.2 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:31 |   1.1 |
| COMPLETED Add helper infrastructure to C#                                   |         |       |  5:55 |  12.6 |
| COMPLETED Add support for Equals in C#                                      |         |       |  1:24 |   3.0 |
| COMPLETED Create a test model solution to validate C# code                  |         |       |  3:47 |   8.1 |
| COMPLETED Add basic io support to C#                                        |         |       | 11:56 |  25.4 |
...
| COMPLETED Update C# stitch templates to match code                          |         |       |  7:28 |  15.9 |
...
| COMPLETED Add support for associations in C#                                |         |       |  3:14 |   6.9 |
| COMPLETED Add support for inheritance in C#                                 |         |       |  3:55 |   8.3 |
