...
#+CAPTION: Clock summary at [2016-12-17 Sat 18:42]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| COMPLETED Add helper infrastructure to C#                                   |         |       |  5:55 |  17.0 |
| COMPLETED Add support for Equals in C#                                      |         |       |  1:24 |   4.0 |
| COMPLETED Create a test model solution to validate C# code                  |         |       |  3:47 |  10.9 |
| COMPLETED Add basic io support to C#                                        |         |       | 11:56 |  34.3 |
| COMPLETED Add basic test data generation support to C#                      |         |       |  0:41 |   2.0 |
| COMPLETED Add io and equality canned unit tests to C# model                 |         |       |  3:55 |  11.2 |
| STARTED Update C# stitch templates to match code                            |         |       |  5:45 |  16.5 |
