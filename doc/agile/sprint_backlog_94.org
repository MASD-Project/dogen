...
#+CAPTION: Clock summary at [2016-12-17 Sat 10:38]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *29:38* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 29:38   |       |       | 100.0 |
| Active                                                                      |         | 29:38 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:56 |   3.1 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:31 |   1.7 |
| COMPLETED Add helper infrastructure to C#                                   |         |       |  5:55 |  20.0 |
| COMPLETED Add support for Equals in C#                                      |         |       |  1:24 |   4.7 |
| COMPLETED Create a test model solution to validate C# code                  |         |       |  3:47 |  12.8 |
| COMPLETED Add basic io support to C#                                        |         |       | 11:56 |  40.3 |
| COMPLETED Add basic test data generation support to C#                      |         |       |  0:41 |   2.3 |
| COMPLETED Add io and equality canned unit tests to C# model                 |         |       |  3:55 |  13.2 |
| STARTED Update C# stitch templates to match code                            |         |       |  0:33 |   1.9 |
