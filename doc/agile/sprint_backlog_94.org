...
#+CAPTION: Clock summary at [2016-12-15 Thu 17:48]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *24:07* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 24:07   |       |       | 100.0 |
| Active                                                                      |         | 24:07 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:56 |   3.9 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:31 |   2.1 |
| COMPLETED Add helper infrastructure to C#                                   |         |       |  5:55 |  24.5 |
| COMPLETED Add support for Equals in C#                                      |         |       |  1:24 |   5.8 |
| COMPLETED Create a test model solution to validate C# code                  |         |       |  3:47 |  15.7 |
| STARTED Add io support in C#                                                |         |       | 11:34 |  48.0 |
