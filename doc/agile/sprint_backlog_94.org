...
#+CAPTION: Clock summary at [2016-12-14 Wed 15:40]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *15:17* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 15:17   |       |      | 100.0 |
| Active                                                                      |         | 15:17 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:23 |   2.5 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:31 |   3.4 |
| COMPLETED Add helper infrastructure to C#                                   |         |       | 5:55 |  38.7 |
| COMPLETED Add support for Equals in C#                                      |         |       | 1:24 |   9.2 |
| STARTED Add io support in C#                                                |         |       | 3:17 |  21.5 |
| STARTED Create a test model solution to validate C# code                    |         |       | 3:47 |  24.8 |
