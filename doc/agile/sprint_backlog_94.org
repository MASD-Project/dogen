...
#+CAPTION: Clock summary at [2016-12-17 Sat 11:44]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *30:42* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 30:42   |       |       | 100.0 |
| Active                                                                      |         | 30:42 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:56 |   3.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:31 |   1.7 |
| COMPLETED Add helper infrastructure to C#                                   |         |       |  5:55 |  19.3 |
| COMPLETED Add support for Equals in C#                                      |         |       |  1:24 |   4.6 |
| COMPLETED Create a test model solution to validate C# code                  |         |       |  3:47 |  12.3 |
| COMPLETED Add basic io support to C#                                        |         |       | 11:56 |  38.9 |
| COMPLETED Add basic test data generation support to C#                      |         |       |  0:41 |   2.2 |
| COMPLETED Add io and equality canned unit tests to C# model                 |         |       |  3:55 |  12.8 |
| STARTED Update C# stitch templates to match code                            |         |       |  1:37 |   5.3 |
