...
#+CAPTION: Clock summary at [2016-12-19 Mon 18:12]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *42:21* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 42:21   |       |       | 100.0 |
| Active                                                                      |         | 42:21 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:56 |   2.2 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:31 |   1.2 |
| COMPLETED Add helper infrastructure to C#                                   |         |       |  5:55 |  14.0 |
| COMPLETED Add support for Equals in C#                                      |         |       |  1:24 |   3.3 |
| COMPLETED Create a test model solution to validate C# code                  |         |       |  3:47 |   8.9 |
| COMPLETED Add basic io support to C#                                        |         |       | 11:56 |  28.2 |
| COMPLETED Add basic test data generation support to C#                      |         |       |  0:41 |   1.6 |
| COMPLETED Add io and equality canned unit tests to C# model                 |         |       |  3:55 |   9.2 |
| COMPLETED Update C# stitch templates to match code                          |         |       |  7:28 |  17.6 |
...
| STARTED Add support for associations in C#                                  |         |       |  2:45 |   6.5 |
