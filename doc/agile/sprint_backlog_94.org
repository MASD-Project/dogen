...
#+CAPTION: Clock summary at [2016-12-17 Sat 11:51]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| COMPLETED Add helper infrastructure to C#                                   |         |       |  5:55 |  19.2 |
| COMPLETED Add support for Equals in C#                                      |         |       |  1:24 |   4.5 |
| COMPLETED Create a test model solution to validate C# code                  |         |       |  3:47 |  12.3 |
| COMPLETED Add basic io support to C#                                        |         |       | 11:56 |  38.7 |
| COMPLETED Add basic test data generation support to C#                      |         |       |  0:41 |   2.2 |
| COMPLETED Add io and equality canned unit tests to C# model                 |         |       |  3:55 |  12.7 |
| STARTED Update C# stitch templates to match code                            |         |       |  1:43 |   5.6 |
