...
Clock summary at [2013-06-05 Wed 07:58]

| Headline                                          | Time   |      |      |
|---------------------------------------------------+--------+------+------|
| *Total time*                                      | *3:45* |      |      |
|---------------------------------------------------+--------+------+------|
| Development Stories Implemented                   |        | 3:45 |      |
...
*** Create a base class for SML types                                 :story:

Refactoring for concepts would be made a lot easier if we only had a
base class that contained all the type features.

**** Find the correct name for base class
     CLOCK: [2013-06-05 Wed 07:58]

Get inspiration for eCore.
