...
Clock summary at [2013-06-13 Thu 22:58]

| Headline                                                         | Time    |       |       |
|------------------------------------------------------------------+---------+-------+-------|
| *Total time*                                                     | *27:50* |       |       |
|------------------------------------------------------------------+---------+-------+-------|
| Development Stories Implemented                                  |         | 27:50 |       |
...
| IMPLEMENTATION Complete the introduction in manual               |         |       |  0:31 |
| IMPLEMENTATION Release notes and backlog grooming                |         |       |  1:04 |
| IMPLEMENTATION Improve modeling of domain driven concepts in SML |         |       | 14:40 |
...
*** IMPLEMENTATION Complete the introduction in manual                :story:
