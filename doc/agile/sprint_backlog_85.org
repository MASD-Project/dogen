...
#+CAPTION: Clock summary at [2016-07-21 Thu 22:42]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
...
| Stories                                                                     | 9:25   |      |      | 100.0 |
| Active                                                                      |        | 9:25 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:39 |   6.9 |
| COMPLETED Implement hashing using dynamic helpers                           |        |      | 2:53 |  30.6 |
| COMPLETED Analysis on pointers and type parameters                          |        |      | 0:37 |   6.5 |
| COMPLETED Add support for numbers in dynamic                                |        |      | 0:32 |   5.7 |
| STARTED Add type parameters support to yarn                                 |        |      | 1:48 |  19.1 |
| STARTED Implement test data using dynamic helpers                           |        |      | 2:56 |  31.2 |
