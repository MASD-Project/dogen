...
#+CAPTION: Clock summary at [2016-07-23 Sat 21:55]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *15:34* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 15:34   |       |      | 100.0 |
| Active                                                                      |         | 15:34 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:43 |   4.6 |
| COMPLETED Implement hashing using dynamic helpers                           |         |       | 2:53 |  18.5 |
| COMPLETED Analysis on pointers and type parameters                          |         |       | 0:37 |   4.0 |
| COMPLETED Add support for numbers in dynamic                                |         |       | 0:32 |   3.4 |
| COMPLETED Add type parameters support to yarn                               |         |       | 1:56 |  12.4 |
| COMPLETED Implement is circular dependency correctly                        |         |       | 0:13 |   1.4 |
| COMPLETED Implement "fallback" helpers                                      |         |       | 1:03 |   6.7 |
| COMPLETED Implement test data using dynamic helpers                         |         |       | 7:13 |  46.4 |
| STARTED Implement types in terms of =yarn::object=                          |         |       | 0:24 |   2.6 |
