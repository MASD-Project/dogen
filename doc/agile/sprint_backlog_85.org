...
#+CAPTION: Clock summary at [2016-07-27 Wed 19:28]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 24:35   |       |      | 100.0 |
| Active                                                                      |         | 24:35 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:21 |   5.5 |
| COMPLETED Implement hashing using dynamic helpers                           |         |       | 2:53 |  11.7 |
| COMPLETED Analysis on pointers and type parameters                          |         |       | 0:37 |   2.5 |
| COMPLETED Add support for numbers in dynamic                                |         |       | 0:32 |   2.2 |
| COMPLETED Add type parameters support to yarn                               |         |       | 1:56 |   7.9 |
| COMPLETED Implement is circular dependency correctly                        |         |       | 0:13 |   0.9 |
| COMPLETED Implement "fallback" helpers                                      |         |       | 1:03 |   4.3 |
| COMPLETED Implement test data using dynamic helpers                         |         |       | 7:13 |  29.4 |
...
| COMPLETED Add aspect properties infrastructure                              |         |       | 3:40 |  14.9 |
| COMPLETED Mark name trees with simple types                                 |         |       | 0:19 |   1.3 |
| STARTED Implement types in terms of =yarn::object=                          |         |       | 3:52 |  15.7 |
