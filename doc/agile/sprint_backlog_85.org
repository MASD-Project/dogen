...
#+CAPTION: Clock summary at [2016-07-22 Fri 23:33]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *12:38* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 12:38   |       |      | 100.0 |
| Active                                                                      |         | 12:38 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:39 |   5.1 |
| COMPLETED Implement hashing using dynamic helpers                           |         |       | 2:53 |  22.8 |
| COMPLETED Analysis on pointers and type parameters                          |         |       | 0:37 |   4.9 |
| COMPLETED Add support for numbers in dynamic                                |         |       | 0:32 |   4.2 |
| COMPLETED Add type parameters support to yarn                               |         |       | 1:56 |  15.3 |
| COMPLETED Implement is circular dependency correctly                        |         |       | 0:13 |   1.7 |
| COMPLETED Implement "fallback" helpers                                      |         |       | 1:03 |   8.3 |
| STARTED Implement test data using dynamic helpers                           |         |       | 4:45 |  37.6 |
