...
#+CAPTION: Clock summary at [2016-07-22 Fri 21:41]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *10:49* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 10:49   |       |      | 100.0 |
| Active                                                                      |         | 10:49 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:39 |   6.0 |
| COMPLETED Implement hashing using dynamic helpers                           |         |       | 2:53 |  26.7 |
| COMPLETED Analysis on pointers and type parameters                          |         |       | 0:37 |   5.7 |
| COMPLETED Add support for numbers in dynamic                                |         |       | 0:32 |   4.9 |
| COMPLETED Add type parameters support to yarn                               |         |       | 1:56 |  17.9 |
| COMPLETED Implement is circular dependency correctly                        |         |       | 0:13 |   2.0 |
| STARTED Implement "fallback" helpers                                        |         |       | 1:03 |   9.7 |
| STARTED Implement test data using dynamic helpers                           |         |       | 2:56 |  27.1 |
