...
#+CAPTION: Clock summary at [2016-07-26 Tue 22:35]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 22:32   |       |      | 100.0 |
| Active                                                                      |         | 22:32 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:21 |   6.0 |
| COMPLETED Implement hashing using dynamic helpers                           |         |       | 2:53 |  12.8 |
| COMPLETED Analysis on pointers and type parameters                          |         |       | 0:37 |   2.7 |
| COMPLETED Add support for numbers in dynamic                                |         |       | 0:32 |   2.4 |
| COMPLETED Add type parameters support to yarn                               |         |       | 1:56 |   8.6 |
| COMPLETED Implement is circular dependency correctly                        |         |       | 0:13 |   1.0 |
| COMPLETED Implement "fallback" helpers                                      |         |       | 1:03 |   4.7 |
| COMPLETED Implement test data using dynamic helpers                         |         |       | 7:13 |  32.0 |
| COMPLETED Remove optionality from helper settings                           |         |       | 0:22 |   1.6 |
| COMPLETED Remove unused aspect settings                                     |         |       | 0:31 |   2.3 |
| COMPLETED Reactivate compressed tests                                       |         |       | 0:03 |   0.2 |
| COMPLETED Add aspect properties infrastructure                              |         |       | 3:40 |  16.3 |
| COMPLETED Mark name trees with simple types                                 |         |       | 0:19 |   1.4 |
| STARTED Implement types in terms of =yarn::object=                          |         |       | 1:49 |   8.1 |
