...
#+CAPTION: Clock summary at [2016-07-21 Thu 23:29]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *10:07* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 10:07   |       |      | 100.0 |
| Active                                                                      |         | 10:07 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:39 |   6.4 |
| COMPLETED Implement hashing using dynamic helpers                           |         |       | 2:53 |  28.5 |
| COMPLETED Analysis on pointers and type parameters                          |         |       | 0:37 |   6.1 |
| COMPLETED Add support for numbers in dynamic                                |         |       | 0:32 |   5.3 |
| COMPLETED Add type parameters support to yarn                               |         |       | 1:56 |  19.1 |
| COMPLETED Implement is circular dependency correctly                        |         |       | 0:13 |   2.1 |
| STARTED Implement "fallback" helpers                                        |         |       | 0:21 |   3.5 |
| STARTED Implement test data using dynamic helpers                           |         |       | 2:56 |  29.0 |
...
*** STARTED Implement "fallback" helpers                              :story:
    CLOCK: [2016-07-21 Thu 23:24]--[2016-07-21 Thu 23:29] =>  0:05
    CLOCK: [2016-07-21 Thu 23:07]--[2016-07-21 Thu 23:23] =>  0:16

Tor test data we need to introduce the notion of "fallback helpers":
