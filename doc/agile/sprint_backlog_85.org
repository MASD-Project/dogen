...
#+CAPTION: Clock summary at [2016-07-21 Thu 07:11]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *7:35* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 7:35   |      |      | 100.0 |
| Active                                                                      |        | 7:35 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:39 |   8.6 |
| COMPLETED Implement hashing using dynamic helpers                           |        |      | 2:53 |  38.0 |
| COMPLETED Analysis on pointers and type parameters                          |        |      | 0:37 |   8.1 |
| STARTED Add type parameters support to yarn                                 |        |      | 0:30 |   6.6 |
| STARTED Implement test data using dynamic helpers                           |        |      | 2:56 |  38.7 |
