...
#+CAPTION: Clock summary at [2016-07-20 Wed 19:14]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *6:04* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 6:04   |      |      | 100.0 |
| Active                                                                      |        | 6:04 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:39 |  10.7 |
| COMPLETED Implement hashing using dynamic helpers                           |        |      | 2:53 |  47.5 |
| COMPLETED Analysis on pointers and type parameters                          |        |      | 0:37 |  10.2 |
| STARTED Implement test data using dynamic helpers                           |        |      | 1:55 |  31.6 |
...
*** Add type parameters support to yarn                               :story:
