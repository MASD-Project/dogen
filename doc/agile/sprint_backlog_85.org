...
#+CAPTION: Clock summary at [2016-07-31 Sun 22:21]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *31:33* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 31:33   |       |      | 100.0 |
| Active                                                                      |         | 31:33 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:32 |   4.9 |
| COMPLETED Implement hashing using dynamic helpers                           |         |       | 2:53 |   9.1 |
...
| COMPLETED Add aspect properties infrastructure                              |         |       | 3:40 |  11.6 |
...
| COMPLETED Implement type' class header in terms of =yarn::object=           |         |       | 4:14 |  13.4 |
| COMPLETED Add streaming settings to context                                 |         |       | 0:48 |   2.5 |
| COMPLETED Implement types' class implementation in terms of =yarn::object=  |         |       | 4:16 |  13.5 |
