...
#+CAPTION: Clock summary at [2016-07-31 Sun 21:54]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *31:08* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 31:08   |       |      | 100.0 |
| Active                                                                      |         | 31:08 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:32 |   4.9 |
| COMPLETED Implement hashing using dynamic helpers                           |         |       | 2:53 |   9.3 |
| COMPLETED Analysis on pointers and type parameters                          |         |       | 0:37 |   2.0 |
| COMPLETED Add support for numbers in dynamic                                |         |       | 0:32 |   1.7 |
| COMPLETED Add type parameters support to yarn                               |         |       | 1:56 |   6.2 |
| COMPLETED Implement is circular dependency correctly                        |         |       | 0:13 |   0.7 |
| COMPLETED Implement "fallback" helpers                                      |         |       | 1:03 |   3.4 |
| COMPLETED Implement test data using dynamic helpers                         |         |       | 7:13 |  23.2 |
| COMPLETED Remove optionality from helper settings                           |         |       | 0:22 |   1.2 |
| COMPLETED Remove unused aspect settings                                     |         |       | 0:31 |   1.7 |
| COMPLETED Reactivate compressed tests                                       |         |       | 0:03 |   0.2 |
| COMPLETED Add aspect properties infrastructure                              |         |       | 3:40 |  11.8 |
...
| COMPLETED Implement type' class header in terms of =yarn::object=           |         |       | 4:14 |  13.6 |
| COMPLETED Add streaming settings to context                                 |         |       | 0:48 |   2.6 |
| COMPLETED Implement types' class implementation in terms of =yarn::object=  |         |       | 4:16 |  13.7 |
