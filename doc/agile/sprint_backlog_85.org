...
#+CAPTION: Clock summary at [2016-07-21 Thu 20:41]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
...
| Stories                                                                     | 8:44   |      |      | 100.0 |
| Active                                                                      |        | 8:44 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:39 |   7.4 |
| COMPLETED Implement hashing using dynamic helpers                           |        |      | 2:53 |  33.0 |
| COMPLETED Analysis on pointers and type parameters                          |        |      | 0:37 |   7.1 |
| COMPLETED Add support for numbers in dynamic                                |        |      | 0:32 |   6.1 |
| STARTED Add type parameters support to yarn                                 |        |      | 1:07 |  12.8 |
| STARTED Implement test data using dynamic helpers                           |        |      | 2:56 |  33.6 |
...
*** STARTED Add type parameters support to yarn                       :story:
...
*** Implement is circular dependency correctly                        :story:
