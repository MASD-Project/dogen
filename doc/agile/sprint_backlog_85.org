...
#+CAPTION: Clock summary at [2016-07-27 Wed 19:49]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| COMPLETED Implement hashing using dynamic helpers                           |         |       | 2:53 |  11.6 |
...
| COMPLETED Implement test data using dynamic helpers                         |         |       | 7:13 |  29.0 |
...
| COMPLETED Add aspect properties infrastructure                              |         |       | 3:40 |  14.7 |
| COMPLETED Mark name trees with simple types                                 |         |       | 0:19 |   1.3 |
| COMPLETED Use id in attributes indexer instead of name                      |         |       | 0:08 |   0.5 |
| STARTED Remove primitive id generation in helpers                           |         |       | 0:10 |   0.7 |
| STARTED Implement types in terms of =yarn::object=                          |         |       | 3:52 |  15.5 |
...
*** STARTED Remove primitive id generation in helpers                 :story:
