...
#+CAPTION: Clock summary at [2016-07-24 Sun 23:04]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *17:51* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 17:51   |       |      | 100.0 |
| Active                                                                      |         | 17:51 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:56 |   5.2 |
| COMPLETED Implement hashing using dynamic helpers                           |         |       | 2:53 |  16.2 |
| COMPLETED Analysis on pointers and type parameters                          |         |       | 0:37 |   3.5 |
| COMPLETED Add support for numbers in dynamic                                |         |       | 0:32 |   3.0 |
| COMPLETED Add type parameters support to yarn                               |         |       | 1:56 |  10.8 |
| COMPLETED Implement is circular dependency correctly                        |         |       | 0:13 |   1.2 |
| COMPLETED Implement "fallback" helpers                                      |         |       | 1:03 |   5.9 |
| COMPLETED Implement test data using dynamic helpers                         |         |       | 7:13 |  40.4 |
| COMPLETED Remove optionality from helper settings                           |         |       | 0:22 |   2.1 |
| STARTED Add aspect properties infrastructure                                |         |       | 1:18 |   7.3 |
| STARTED Implement types in terms of =yarn::object=                          |         |       | 0:48 |   4.5 |
