...
#+CAPTION: Clock summary at [2016-07-31 Sun 23:08]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| COMPLETED Implement test data using dynamic helpers                         |         |       | 7:13 |  22.4 |
...
*** STARTED Implement serialisation's header in terms of =yarn::object= :story:
