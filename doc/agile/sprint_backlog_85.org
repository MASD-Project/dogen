...
#+CAPTION: Clock summary at [2016-07-23 Sat 01:16]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *14:18* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 14:18   |       |      | 100.0 |
| Active                                                                      |         | 14:18 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:39 |   4.5 |
| COMPLETED Implement hashing using dynamic helpers                           |         |       | 2:53 |  20.2 |
| COMPLETED Analysis on pointers and type parameters                          |         |       | 0:37 |   4.3 |
| COMPLETED Add support for numbers in dynamic                                |         |       | 0:32 |   3.7 |
| COMPLETED Add type parameters support to yarn                               |         |       | 1:56 |  13.5 |
| COMPLETED Implement is circular dependency correctly                        |         |       | 0:13 |   1.5 |
| COMPLETED Implement "fallback" helpers                                      |         |       | 1:03 |   7.3 |
| STARTED Implement test data using dynamic helpers                           |         |       | 6:25 |  44.9 |
