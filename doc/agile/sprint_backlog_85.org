...
#+CAPTION: Clock summary at [2016-07-23 Sat 23:24]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *16:55* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 16:55   |       |      | 100.0 |
| Active                                                                      |         | 16:55 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:56 |   5.5 |
| COMPLETED Implement hashing using dynamic helpers                           |         |       | 2:53 |  17.0 |
| COMPLETED Analysis on pointers and type parameters                          |         |       | 0:37 |   3.6 |
| COMPLETED Add support for numbers in dynamic                                |         |       | 0:32 |   3.2 |
| COMPLETED Add type parameters support to yarn                               |         |       | 1:56 |  11.4 |
| COMPLETED Implement is circular dependency correctly                        |         |       | 0:13 |   1.3 |
| COMPLETED Implement "fallback" helpers                                      |         |       | 1:03 |   6.2 |
| COMPLETED Implement test data using dynamic helpers                         |         |       | 7:13 |  42.7 |
| STARTED Add aspect properties infrastructure                                |         |       | 0:44 |   4.3 |
| STARTED Implement types in terms of =yarn::object=                          |         |       | 0:48 |   4.7 |
