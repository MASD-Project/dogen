...
#+CAPTION: Clock summary at [2016-07-21 Thu 23:05]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *9:46* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 9:46   |      |      | 100.0 |
| Active                                                                      |        | 9:46 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:39 |   6.7 |
| COMPLETED Implement hashing using dynamic helpers                           |        |      | 2:53 |  29.5 |
| COMPLETED Analysis on pointers and type parameters                          |        |      | 0:37 |   6.3 |
| COMPLETED Add support for numbers in dynamic                                |        |      | 0:32 |   5.5 |
| COMPLETED Add type parameters support to yarn                               |        |      | 1:56 |  19.8 |
| COMPLETED Implement is circular dependency correctly                        |        |      | 0:13 |   2.2 |
| STARTED Implement test data using dynamic helpers                           |        |      | 2:56 |  30.0 |
