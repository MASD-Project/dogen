...
#+CAPTION: Clock summary at [2016-07-31 Sun 20:59]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *30:55* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 30:55   |       |      | 100.0 |
| Active                                                                      |         | 30:55 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:32 |   5.0 |
...
| COMPLETED Add type parameters support to yarn                               |         |       | 1:56 |   6.3 |
| COMPLETED Implement is circular dependency correctly                        |         |       | 0:13 |   0.7 |
| COMPLETED Implement "fallback" helpers                                      |         |       | 1:03 |   3.4 |
| COMPLETED Implement test data using dynamic helpers                         |         |       | 7:13 |  23.3 |
...
| COMPLETED Add aspect properties infrastructure                              |         |       | 3:40 |  11.9 |
...
| COMPLETED Implement type' class header in terms of =yarn::object=           |         |       | 4:14 |  13.7 |
| COMPLETED Add streaming settings to context                                 |         |       | 0:48 |   2.6 |
| COMPLETED Implement types' class implementation in terms of =yarn::object=  |         |       | 4:16 |  13.8 |
