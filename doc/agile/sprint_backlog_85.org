...
#+CAPTION: Clock summary at [2016-07-20 Wed 22:44]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *7:05* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 7:05   |      |      | 100.0 |
| Active                                                                      |        | 7:05 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:39 |   9.2 |
| COMPLETED Implement hashing using dynamic helpers                           |        |      | 2:53 |  40.7 |
| COMPLETED Analysis on pointers and type parameters                          |        |      | 0:37 |   8.7 |
| STARTED Implement test data using dynamic helpers                           |        |      | 2:56 |  41.4 |
