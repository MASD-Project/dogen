...
#+CAPTION: Clock summary at [2016-07-23 Sat 09:21]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *15:10* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 15:10   |       |      | 100.0 |
| Active                                                                      |         | 15:10 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:43 |   4.7 |
| COMPLETED Implement hashing using dynamic helpers                           |         |       | 2:53 |  19.0 |
| COMPLETED Analysis on pointers and type parameters                          |         |       | 0:37 |   4.1 |
| COMPLETED Add support for numbers in dynamic                                |         |       | 0:32 |   3.5 |
| COMPLETED Add type parameters support to yarn                               |         |       | 1:56 |  12.7 |
| COMPLETED Implement is circular dependency correctly                        |         |       | 0:13 |   1.4 |
| COMPLETED Implement "fallback" helpers                                      |         |       | 1:03 |   6.9 |
| COMPLETED Implement test data using dynamic helpers                         |         |       | 7:13 |  47.6 |
...
*** Implement types in terms of =yarn::object=                        :story:
