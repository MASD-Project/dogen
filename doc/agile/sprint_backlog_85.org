...
#+CAPTION: Clock summary at [2016-07-24 Sun 23:34]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *18:30* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 18:30   |       |      | 100.0 |
| Active                                                                      |         | 18:30 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:02 |   5.6 |
| COMPLETED Implement hashing using dynamic helpers                           |         |       | 2:53 |  15.6 |
| COMPLETED Analysis on pointers and type parameters                          |         |       | 0:37 |   3.3 |
...
| COMPLETED Implement test data using dynamic helpers                         |         |       | 7:13 |  39.0 |
| COMPLETED Remove optionality from helper settings                           |         |       | 0:22 |   2.0 |
| STARTED Add aspect properties infrastructure                                |         |       | 1:51 |  10.0 |
