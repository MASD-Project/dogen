...
#+CAPTION: Clock summary at [2016-07-25 Mon 21:57]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *19:18* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 19:18   |       |      | 100.0 |
| Active                                                                      |         | 19:18 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:02 |   5.4 |
| COMPLETED Implement hashing using dynamic helpers                           |         |       | 2:53 |  14.9 |
| COMPLETED Analysis on pointers and type parameters                          |         |       | 0:37 |   3.2 |
| COMPLETED Add support for numbers in dynamic                                |         |       | 0:32 |   2.8 |
| COMPLETED Add type parameters support to yarn                               |         |       | 1:56 |  10.0 |
| COMPLETED Implement is circular dependency correctly                        |         |       | 0:13 |   1.1 |
| COMPLETED Implement "fallback" helpers                                      |         |       | 1:03 |   5.4 |
| COMPLETED Implement test data using dynamic helpers                         |         |       | 7:13 |  37.4 |
| COMPLETED Remove optionality from helper settings                           |         |       | 0:22 |   1.9 |
| COMPLETED Remove unused aspect settings                                     |         |       | 0:31 |   2.7 |
| STARTED Add aspect properties infrastructure                                |         |       | 2:08 |  11.1 |
| STARTED Implement types in terms of =yarn::object=                          |         |       | 0:48 |   4.1 |
