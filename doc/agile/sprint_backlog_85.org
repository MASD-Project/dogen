...
#+CAPTION: Clock summary at [2016-07-31 Sun 22:58]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *32:07* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 32:07   |       |      | 100.0 |
| Active                                                                      |         | 32:07 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:32 |   4.8 |
| COMPLETED Implement hashing using dynamic helpers                           |         |       | 2:53 |   9.0 |
...
| COMPLETED Implement test data using dynamic helpers                         |         |       | 7:13 |  22.5 |
...
| COMPLETED Add aspect properties infrastructure                              |         |       | 3:40 |  11.4 |
...
| COMPLETED Implement type' class header in terms of =yarn::object=           |         |       | 4:14 |  13.2 |
| COMPLETED Add streaming settings to context                                 |         |       | 0:48 |   2.5 |
| COMPLETED Implement types' class implementation in terms of =yarn::object=  |         |       | 4:16 |  13.3 |
...
| COMPLETED Implement hash's header in terms of =yarn::object=                |         |       | 0:34 |   1.8 |
