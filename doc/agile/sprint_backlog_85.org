...
#+CAPTION: Clock summary at [2016-07-27 Wed 19:00]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| COMPLETED Implement hashing using dynamic helpers                           |         |       | 2:53 |  11.8 |
...
| COMPLETED Implement test data using dynamic helpers                         |         |       | 7:13 |  29.6 |
...
| COMPLETED Add aspect properties infrastructure                              |         |       | 3:40 |  15.0 |
| COMPLETED Mark name trees with simple types                                 |         |       | 0:19 |   1.3 |
| STARTED Implement types in terms of =yarn::object=                          |         |       | 3:39 |  15.0 |
