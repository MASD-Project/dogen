...
#+CAPTION: Clock summary at [2016-07-21 Thu 22:51]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *9:33* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 9:33   |      |      | 100.0 |
| Active                                                                      |        | 9:33 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:39 |   6.8 |
| COMPLETED Implement hashing using dynamic helpers                           |        |      | 2:53 |  30.2 |
| COMPLETED Analysis on pointers and type parameters                          |        |      | 0:37 |   6.5 |
| COMPLETED Add support for numbers in dynamic                                |        |      | 0:32 |   5.6 |
| COMPLETED Add type parameters support to yarn                               |        |      | 1:56 |  20.2 |
| STARTED Implement test data using dynamic helpers                           |        |      | 2:56 |  30.7 |
