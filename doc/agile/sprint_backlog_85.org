...
#+CAPTION: Clock summary at [2016-07-23 Sat 09:03]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *14:56* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 14:56   |       |      | 100.0 |
| Active                                                                      |         | 14:56 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:39 |   4.4 |
| COMPLETED Implement hashing using dynamic helpers                           |         |       | 2:53 |  19.3 |
| COMPLETED Analysis on pointers and type parameters                          |         |       | 0:37 |   4.1 |
| COMPLETED Add support for numbers in dynamic                                |         |       | 0:32 |   3.6 |
| COMPLETED Add type parameters support to yarn                               |         |       | 1:56 |  12.9 |
| COMPLETED Implement is circular dependency correctly                        |         |       | 0:13 |   1.5 |
| COMPLETED Implement "fallback" helpers                                      |         |       | 1:03 |   7.0 |
| STARTED Implement test data using dynamic helpers                           |         |       | 7:03 |  47.2 |
