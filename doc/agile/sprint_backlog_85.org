...
#+CAPTION: Clock summary at [2016-07-23 Sat 22:53]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 16:31   |       |      | 100.0 |
| Active                                                                      |         | 16:31 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:43 |   4.3 |
| COMPLETED Implement hashing using dynamic helpers                           |         |       | 2:53 |  17.5 |
| COMPLETED Analysis on pointers and type parameters                          |         |       | 0:37 |   3.7 |
| COMPLETED Add support for numbers in dynamic                                |         |       | 0:32 |   3.2 |
| COMPLETED Add type parameters support to yarn                               |         |       | 1:56 |  11.7 |
| COMPLETED Implement is circular dependency correctly                        |         |       | 0:13 |   1.3 |
| COMPLETED Implement "fallback" helpers                                      |         |       | 1:03 |   6.4 |
| COMPLETED Implement test data using dynamic helpers                         |         |       | 7:13 |  43.7 |
| STARTED Add aspect properties infrastructure                                |         |       | 0:33 |   3.3 |
| STARTED Implement types in terms of =yarn::object=                          |         |       | 0:48 |   4.8 |
