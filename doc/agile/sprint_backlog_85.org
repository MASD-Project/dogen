...
#+CAPTION: Clock summary at [2016-07-25 Mon 22:28]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 19:46   |       |      | 100.0 |
| Active                                                                      |         | 19:46 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:02 |   5.2 |
| COMPLETED Implement hashing using dynamic helpers                           |         |       | 2:53 |  14.6 |
| COMPLETED Analysis on pointers and type parameters                          |         |       | 0:37 |   3.1 |
| COMPLETED Add support for numbers in dynamic                                |         |       | 0:32 |   2.7 |
| COMPLETED Add type parameters support to yarn                               |         |       | 1:56 |   9.8 |
| COMPLETED Implement is circular dependency correctly                        |         |       | 0:13 |   1.1 |
| COMPLETED Implement "fallback" helpers                                      |         |       | 1:03 |   5.3 |
| COMPLETED Implement test data using dynamic helpers                         |         |       | 7:13 |  36.5 |
...
| STARTED Add aspect properties infrastructure                                |         |       | 2:33 |  12.9 |
| STARTED Implement types in terms of =yarn::object=                          |         |       | 0:48 |   4.0 |
