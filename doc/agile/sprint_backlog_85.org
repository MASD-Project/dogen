...
#+CAPTION: Clock summary at [2016-07-25 Mon 22:54]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *20:11* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 20:11   |       |      | 100.0 |
| Active                                                                      |         | 20:11 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:02 |   5.1 |
| COMPLETED Implement hashing using dynamic helpers                           |         |       | 2:53 |  14.3 |
| COMPLETED Analysis on pointers and type parameters                          |         |       | 0:37 |   3.1 |
| COMPLETED Add support for numbers in dynamic                                |         |       | 0:32 |   2.6 |
| COMPLETED Add type parameters support to yarn                               |         |       | 1:56 |   9.6 |
| COMPLETED Implement is circular dependency correctly                        |         |       | 0:13 |   1.1 |
| COMPLETED Implement "fallback" helpers                                      |         |       | 1:03 |   5.2 |
| COMPLETED Implement test data using dynamic helpers                         |         |       | 7:13 |  35.8 |
...
| STARTED Add aspect properties infrastructure                                |         |       | 2:58 |  14.7 |
