...
#+CAPTION: Clock summary at [2016-07-20 Wed 23:03]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
...
| Stories                                                                     | 7:23   |      |      | 100.0 |
| Active                                                                      |        | 7:23 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:39 |   8.8 |
| COMPLETED Implement hashing using dynamic helpers                           |        |      | 2:53 |  39.1 |
| COMPLETED Analysis on pointers and type parameters                          |        |      | 0:37 |   8.4 |
| STARTED Add type parameters support to yarn                                 |        |      | 0:18 |   4.1 |
| STARTED Implement test data using dynamic helpers                           |        |      | 2:56 |  39.7 |
