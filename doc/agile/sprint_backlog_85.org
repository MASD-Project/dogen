...
#+CAPTION: Clock summary at [2016-07-27 Wed 08:25]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 23:37   |       |      | 100.0 |
| Active                                                                      |         | 23:37 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:21 |   5.7 |
| COMPLETED Implement hashing using dynamic helpers                           |         |       | 2:53 |  12.2 |
| COMPLETED Analysis on pointers and type parameters                          |         |       | 0:37 |   2.6 |
| COMPLETED Add support for numbers in dynamic                                |         |       | 0:32 |   2.3 |
| COMPLETED Add type parameters support to yarn                               |         |       | 1:56 |   8.2 |
| COMPLETED Implement is circular dependency correctly                        |         |       | 0:13 |   0.9 |
| COMPLETED Implement "fallback" helpers                                      |         |       | 1:03 |   4.4 |
| COMPLETED Implement test data using dynamic helpers                         |         |       | 7:13 |  30.6 |
| COMPLETED Remove optionality from helper settings                           |         |       | 0:22 |   1.6 |
| COMPLETED Remove unused aspect settings                                     |         |       | 0:31 |   2.2 |
| COMPLETED Reactivate compressed tests                                       |         |       | 0:03 |   0.2 |
| COMPLETED Add aspect properties infrastructure                              |         |       | 3:40 |  15.5 |
| COMPLETED Mark name trees with simple types                                 |         |       | 0:19 |   1.3 |
| STARTED Implement types in terms of =yarn::object=                          |         |       | 2:54 |  12.3 |
