...
#+CAPTION: Clock summary at [2016-07-25 Mon 22:18]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *19:37* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 19:37   |       |      | 100.0 |
| Active                                                                      |         | 19:37 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:02 |   5.3 |
| COMPLETED Implement hashing using dynamic helpers                           |         |       | 2:53 |  14.7 |
| COMPLETED Analysis on pointers and type parameters                          |         |       | 0:37 |   3.1 |
| COMPLETED Add support for numbers in dynamic                                |         |       | 0:32 |   2.7 |
| COMPLETED Add type parameters support to yarn                               |         |       | 1:56 |   9.9 |
| COMPLETED Implement is circular dependency correctly                        |         |       | 0:13 |   1.1 |
| COMPLETED Implement "fallback" helpers                                      |         |       | 1:03 |   5.4 |
| COMPLETED Implement test data using dynamic helpers                         |         |       | 7:13 |  36.8 |
| COMPLETED Remove optionality from helper settings                           |         |       | 0:22 |   1.9 |
| COMPLETED Remove unused aspect settings                                     |         |       | 0:31 |   2.6 |
| COMPLETED Reactivate compressed tests                                       |         |       | 0:03 |   0.3 |
| STARTED Add aspect properties infrastructure                                |         |       | 2:24 |  12.2 |
