...
Clock summary at [2015-05-13 Wed 17:58]
...
|-----------------------------------------------------------------------------+---------+-------+------|
| Active                                                                      |         | 14:53 |      |
| STARTED Sprint and product backlog grooming                                 |         |       | 2:09 |
...
*** Move the path derivatives workflow into formatables               :story:
...
*** Move the inclusion dependencies workflow into formatables         :story:
...
*** Consider creating a formatter properties factory                  :story:

It probably makes sense to create a factory that handles the
manufacturing of all path derivatives and inclusion dependencies gunk
and then generates the formatter properties. We just need the
enablement map as input (as well as the model) and we can then output
qname to formatter name to formatter properties.
...
*** Remove unused classes and properties in cpp                       :story:
