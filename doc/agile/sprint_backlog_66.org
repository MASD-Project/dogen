...
Clock summary at [2015-05-18 Mon 21:39]
...
| STARTED Implement namespace header formatter using stitch                   |         |       | 1:00 |
#+end:
...
*** STARTED Implement namespace header formatter using stitch         :story:
