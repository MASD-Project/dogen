...
Clock summary at [2015-05-22 Fri 18:04]
...
| STARTED Implement a basic =needle= model with io support                    |         |       | 5:35 |
| STARTED Implement class implementation formatter using stitch               |         |       | 3:00 |
| STARTED Update legacy formatters to use needle for io                       |         |       | 0:46 |
#+end:
...
*** STARTED Implement a basic =needle= model with io support          :story:
...
- missing types: deque, variant, ptime, date, path, time_duration,
  ptree.
