...
Clock summary at [2015-05-18 Mon 16:22]
...
| STARTED Implement types enumeration header formatter using stitch           |         |       | 1:04 |
#+end:
...
*** STARTED Implement types enumeration header formatter using stitch :story:
