...
Clock summary at [2015-05-19 Tue 14:11]
...
|-----------------------------------------------------------------------------+---------+-------+------|
| Active                                                                      |         | 41:23 |      |
| STARTED Sprint and product backlog grooming                                 |         |       | 2:56 |
...
| STARTED Implement visitor header formatter using stitch                     |         |       | 0:58 |
#+end:
...
*** STARTED Implement visitor header formatter using stitch           :story:
