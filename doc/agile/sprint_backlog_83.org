...
#+CAPTION: Clock summary at [2016-06-20 Mon 21:39]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *18:11* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 18:11   |       |      | 100.0 |
| Active                                                                      |         | 18:11 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 2:07 |  11.6 |
| COMPLETED Refactor helper settings                                          |         |       | 0:35 |   3.2 |
| COMPLETED Add properties for helpers                                        |         |       | 1:35 |   8.7 |
| COMPLETED Consider renaming =yarn::property= to attribute                   |         |       | 1:23 |   7.6 |
| COMPLETED Rename formattables to properties                                 |         |       | 0:50 |   4.6 |
| COMPLETED Rename helper instances                                           |         |       | 0:37 |   3.4 |
| COMPLETED Tidy-up pretty printer                                            |         |       | 1:10 |   6.4 |
| COMPLETED Rename qualified to id                                            |         |       | 0:34 |   3.1 |
| COMPLETED Rename unparsed type  in name tree                                |         |       | 0:47 |   4.3 |
| COMPLETED Add a builder-like API to pretty printer                          |         |       | 1:18 |   7.1 |
| COMPLETED Implement automatic model name detection in name builder          |         |       | 0:51 |   4.7 |
| COMPLETED Populate qualified and identifiable name                          |         |       | 2:05 |  11.5 |
| COMPLETED Rename =name_tree='s parent                                       |         |       | 0:16 |   1.5 |
| COMPLETED Compute yarn property related information                         |         |       | 1:36 |   8.8 |
| COMPLETED Remove redundancy in properties' repositories                     |         |       | 0:22 |   2.0 |
| COMPLETED Create a top-level type to aggregate properties and helpers       |         |       | 1:42 |   9.3 |
| COMPLETED Refactor helper descriptor                                        |         |       | 0:23 |   2.1 |
