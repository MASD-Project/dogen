...
#+CAPTION: Clock summary at [2016-06-29 Wed 15:00]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 37:24   |       |      | 100.0 |
| Active                                                                      |         | 37:24 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 3:57 |  10.6 |
| STARTED Manual updates and blog posts                                       |         |       | 0:53 |   2.4 |
| COMPLETED Refactor helper settings                                          |         |       | 0:35 |   1.6 |
| COMPLETED Add properties for helpers                                        |         |       | 1:35 |   4.2 |
| COMPLETED Consider renaming =yarn::property= to attribute                   |         |       | 1:23 |   3.7 |
...
| COMPLETED Rename qualified to id                                            |         |       | 0:51 |   2.3 |
| COMPLETED Rename unparsed type  in name tree                                |         |       | 0:47 |   2.1 |
| COMPLETED Add a builder-like API to pretty printer                          |         |       | 1:18 |   3.5 |
| COMPLETED Implement automatic model name detection in name builder          |         |       | 0:51 |   2.3 |
| COMPLETED Populate qualified and identifiable name                          |         |       | 2:05 |   5.6 |
| COMPLETED Rename =name_tree='s parent                                       |         |       | 0:16 |   0.7 |
| COMPLETED Compute yarn property related information                         |         |       | 2:17 |   6.1 |
...
| COMPLETED Implement types helper methods with new helper infrastructure     |         |       | 3:12 |   8.6 |
| COMPLETED Move identifiable and qualified to assistant                      |         |       | 0:32 |   1.4 |
| COMPLETED Refactor helper properties yet again                              |         |       | 2:56 |   7.8 |
| COMPLETED Remove =aggregator= in dynamic                                    |         |       | 0:07 |   0.3 |
| STARTED Implement IO helper methods with new helper infrastructure          |         |       | 3:21 |   9.0 |
...
*** STARTED Rename aspect settings to type settings                   :story:
...
Also add =string_conversion_method= to type settings.

*** Add string conversion method support to context                   :story:

We need to preprocess the global settings bundle, extract the string
