...
#+CAPTION: Clock summary at [2016-06-27 Mon 16:15]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *30:13* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 30:13   |       |      | 100.0 |
| Active                                                                      |         | 30:13 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 3:42 |  12.2 |
...
| COMPLETED Consider renaming =yarn::property= to attribute                   |         |       | 1:23 |   4.6 |
...
| COMPLETED Add a builder-like API to pretty printer                          |         |       | 1:18 |   4.3 |
| COMPLETED Implement automatic model name detection in name builder          |         |       | 0:51 |   2.8 |
| COMPLETED Populate qualified and identifiable name                          |         |       | 2:05 |   6.9 |
| COMPLETED Rename =name_tree='s parent                                       |         |       | 0:16 |   0.9 |
| COMPLETED Compute yarn property related information                         |         |       | 2:17 |   7.6 |
| COMPLETED Remove redundancy in properties' repositories                     |         |       | 0:22 |   1.2 |
| COMPLETED Create a top-level type to aggregate properties and helpers       |         |       | 1:42 |   5.6 |
| COMPLETED Refactor helper descriptor                                        |         |       | 0:23 |   1.3 |
| COMPLETED Add an helper method interface                                    |         |       | 1:03 |   3.5 |
...
| STARTED Implement types helper methods with new helper infrastructure       |         |       | 3:12 |  10.6 |
...
- for associative containers, we need to access first and second
  (e.g. key and value) in the name tree.
-
