...
#+CAPTION: Clock summary at [2016-06-22 Wed 00:15]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *23:37* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 23:37   |       |      | 100.0 |
| Active                                                                      |         | 23:37 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 2:19 |   9.8 |
| STARTED Manual updates and blog posts                                       |         |       | 0:44 |   3.1 |
| COMPLETED Refactor helper settings                                          |         |       | 0:35 |   2.5 |
| COMPLETED Add properties for helpers                                        |         |       | 1:35 |   6.7 |
| COMPLETED Consider renaming =yarn::property= to attribute                   |         |       | 1:23 |   5.9 |
| COMPLETED Rename formattables to properties                                 |         |       | 0:50 |   3.5 |
| COMPLETED Rename helper instances                                           |         |       | 0:37 |   2.6 |
| COMPLETED Tidy-up pretty printer                                            |         |       | 1:10 |   4.9 |
| COMPLETED Rename qualified to id                                            |         |       | 0:51 |   3.6 |
| COMPLETED Rename unparsed type  in name tree                                |         |       | 0:47 |   3.3 |
| COMPLETED Add a builder-like API to pretty printer                          |         |       | 1:18 |   5.5 |
| COMPLETED Implement automatic model name detection in name builder          |         |       | 0:51 |   3.6 |
| COMPLETED Populate qualified and identifiable name                          |         |       | 2:05 |   8.8 |
| COMPLETED Rename =name_tree='s parent                                       |         |       | 0:16 |   1.1 |
| COMPLETED Compute yarn property related information                         |         |       | 2:17 |   9.7 |
| COMPLETED Remove redundancy in properties' repositories                     |         |       | 0:22 |   1.6 |
| COMPLETED Create a top-level type to aggregate properties and helpers       |         |       | 1:42 |   7.2 |
| COMPLETED Refactor helper descriptor                                        |         |       | 0:23 |   1.6 |
| COMPLETED Add an helper method interface                                    |         |       | 1:03 |   4.4 |
| COMPLETED Remove encoded from yarn's name tree                              |         |       | 1:24 |   5.9 |
| STARTED Implement types helper methods with new helper infrastructure       |         |       | 1:05 |   4.6 |
