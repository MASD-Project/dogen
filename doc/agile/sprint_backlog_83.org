...
#+CAPTION: Clock summary at [2016-06-17 Fri 12:29]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *1:43* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 1:43   |      |      | 100.0 |
| Active                                                                      |        | 1:43 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:24 |  23.3 |
| COMPLETED Refactor helper settings                                          |        |      | 0:35 |  34.0 |
| STARTED Add properties for helpers                                          |        |      | 0:44 |  42.7 |
...
Parent is not a good name as we are referring to the current node.
