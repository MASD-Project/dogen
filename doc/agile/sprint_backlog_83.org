...
#+CAPTION: Clock summary at [2016-06-22 Wed 22:55]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *26:12* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 26:12   |       |      | 100.0 |
| Active                                                                      |         | 26:12 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 2:50 |  10.8 |
| STARTED Manual updates and blog posts                                       |         |       | 0:53 |   3.4 |
| COMPLETED Refactor helper settings                                          |         |       | 0:35 |   2.2 |
| COMPLETED Add properties for helpers                                        |         |       | 1:35 |   6.0 |
| COMPLETED Consider renaming =yarn::property= to attribute                   |         |       | 1:23 |   5.3 |
...
| COMPLETED Rename qualified to id                                            |         |       | 0:51 |   3.2 |
| COMPLETED Rename unparsed type  in name tree                                |         |       | 0:47 |   3.0 |
| COMPLETED Add a builder-like API to pretty printer                          |         |       | 1:18 |   5.0 |
| COMPLETED Implement automatic model name detection in name builder          |         |       | 0:51 |   3.2 |
| COMPLETED Populate qualified and identifiable name                          |         |       | 2:05 |   8.0 |
| COMPLETED Rename =name_tree='s parent                                       |         |       | 0:16 |   1.0 |
| COMPLETED Compute yarn property related information                         |         |       | 2:17 |   8.7 |
| COMPLETED Remove redundancy in properties' repositories                     |         |       | 0:22 |   1.4 |
| COMPLETED Create a top-level type to aggregate properties and helpers       |         |       | 1:42 |   6.5 |
| COMPLETED Refactor helper descriptor                                        |         |       | 0:23 |   1.5 |
| COMPLETED Add an helper method interface                                    |         |       | 1:03 |   4.0 |
| COMPLETED Remove encoded from yarn's name tree                              |         |       | 1:24 |   5.3 |
| COMPLETED Add support for helpers bound to multiple formatters.             |         |       | 0:41 |   2.6 |
| COMPLETED Add class info to is enabled in formatter helper interface        |         |       | 0:29 |   1.8 |
| STARTED Implement types helper methods with new helper infrastructure       |         |       | 1:50 |   7.0 |
