...
#+CAPTION: Clock summary at [2016-06-20 Mon 23:23]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *19:31* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 19:31   |       |      | 100.0 |
| Active                                                                      |         | 19:31 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 2:07 |  10.8 |
| COMPLETED Refactor helper settings                                          |         |       | 0:35 |   3.0 |
| COMPLETED Add properties for helpers                                        |         |       | 1:35 |   8.1 |
| COMPLETED Consider renaming =yarn::property= to attribute                   |         |       | 1:23 |   7.1 |
| COMPLETED Rename formattables to properties                                 |         |       | 0:50 |   4.3 |
| COMPLETED Rename helper instances                                           |         |       | 0:37 |   3.2 |
| COMPLETED Tidy-up pretty printer                                            |         |       | 1:10 |   6.0 |
| COMPLETED Rename qualified to id                                            |         |       | 0:51 |   4.4 |
| COMPLETED Rename unparsed type  in name tree                                |         |       | 0:47 |   4.0 |
| COMPLETED Add a builder-like API to pretty printer                          |         |       | 1:18 |   6.7 |
| COMPLETED Implement automatic model name detection in name builder          |         |       | 0:51 |   4.4 |
| COMPLETED Populate qualified and identifiable name                          |         |       | 2:05 |  10.7 |
| COMPLETED Rename =name_tree='s parent                                       |         |       | 0:16 |   1.4 |
| COMPLETED Compute yarn property related information                         |         |       | 1:36 |   8.2 |
| COMPLETED Remove redundancy in properties' repositories                     |         |       | 0:22 |   1.9 |
| COMPLETED Create a top-level type to aggregate properties and helpers       |         |       | 1:42 |   8.7 |
| COMPLETED Refactor helper descriptor                                        |         |       | 0:23 |   2.0 |
| COMPLETED Add an helper method interface                                    |         |       | 1:03 |   5.4 |
...
*** Implement types helper methods with new helper infrastructure     :story:
