...
#+CAPTION: Clock summary at [2016-06-28 Tue 21:48]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *35:26* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 35:26   |       |      | 100.0 |
| Active                                                                      |         | 35:26 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 3:42 |  10.4 |
| STARTED Manual updates and blog posts                                       |         |       | 0:53 |   2.5 |
| COMPLETED Refactor helper settings                                          |         |       | 0:35 |   1.6 |
| COMPLETED Add properties for helpers                                        |         |       | 1:35 |   4.5 |
| COMPLETED Consider renaming =yarn::property= to attribute                   |         |       | 1:23 |   3.9 |
| COMPLETED Rename formattables to properties                                 |         |       | 0:50 |   2.4 |
| COMPLETED Rename helper instances                                           |         |       | 0:37 |   1.7 |
| COMPLETED Tidy-up pretty printer                                            |         |       | 1:10 |   3.3 |
| COMPLETED Rename qualified to id                                            |         |       | 0:51 |   2.4 |
| COMPLETED Rename unparsed type  in name tree                                |         |       | 0:47 |   2.2 |
| COMPLETED Add a builder-like API to pretty printer                          |         |       | 1:18 |   3.7 |
| COMPLETED Implement automatic model name detection in name builder          |         |       | 0:51 |   2.4 |
| COMPLETED Populate qualified and identifiable name                          |         |       | 2:05 |   5.9 |
| COMPLETED Rename =name_tree='s parent                                       |         |       | 0:16 |   0.8 |
| COMPLETED Compute yarn property related information                         |         |       | 2:17 |   6.4 |
| COMPLETED Remove redundancy in properties' repositories                     |         |       | 0:22 |   1.0 |
| COMPLETED Create a top-level type to aggregate properties and helpers       |         |       | 1:42 |   4.8 |
| COMPLETED Refactor helper descriptor                                        |         |       | 0:23 |   1.1 |
| COMPLETED Add an helper method interface                                    |         |       | 1:03 |   3.0 |
| COMPLETED Remove encoded from yarn's name tree                              |         |       | 1:24 |   4.0 |
| COMPLETED Add support for helpers bound to multiple formatters.             |         |       | 0:41 |   1.9 |
...
| COMPLETED Fix a number of Windows build errors                              |         |       | 0:41 |   1.9 |
| COMPLETED Fix Mingw build's warning                                         |         |       | 0:10 |   0.5 |
| COMPLETED Implement types helper methods with new helper infrastructure     |         |       | 3:12 |   9.0 |
| COMPLETED Move identifiable and qualified to assistant                      |         |       | 0:32 |   1.5 |
| COMPLETED Refactor helper properties yet again                              |         |       | 2:56 |   8.3 |
| STARTED Implement IO helper methods with new helper infrastructure          |         |       | 1:45 |   4.9 |
