...
#+CAPTION: Clock summary at [2016-06-20 Mon 16:08]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *15:45* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 15:45   |       |      | 100.0 |
| Active                                                                      |         | 15:45 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:45 |  11.1 |
| COMPLETED Refactor helper settings                                          |         |       | 0:35 |   3.7 |
| COMPLETED Add properties for helpers                                        |         |       | 1:35 |  10.1 |
| COMPLETED Consider renaming =yarn::property= to attribute                   |         |       | 1:23 |   8.8 |
| COMPLETED Rename formattables to properties                                 |         |       | 0:50 |   5.3 |
| COMPLETED Rename helper instances                                           |         |       | 0:37 |   3.9 |
| COMPLETED Tidy-up pretty printer                                            |         |       | 1:10 |   7.4 |
| COMPLETED Rename qualified to id                                            |         |       | 0:34 |   3.6 |
| COMPLETED Rename unparsed type  in name tree                                |         |       | 0:47 |   5.0 |
| COMPLETED Add a builder-like API to pretty printer                          |         |       | 1:18 |   8.3 |
| COMPLETED Implement automatic model name detection in name builder          |         |       | 0:51 |   5.4 |
| COMPLETED Populate qualified and identifiable name                          |         |       | 2:05 |  13.2 |
| COMPLETED Rename =name_tree='s parent                                       |         |       | 0:16 |   1.7 |
| COMPLETED Compute yarn property related information                         |         |       | 1:36 |  10.2 |
| STARTED Create a top-level type to aggregate properties and helpers         |         |       | 0:23 |   2.4 |
...
*** COMPLETED Consider reducing the number of qname lookups in cpp model :story:
    CLOSED: [2016-06-20 Mon 15:39]

*Rationale*: This has largely been done, where it can be done.
