...
#+CAPTION: Clock summary at [2016-06-21 Tue 21:43]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 21:11   |       |      | 100.0 |
| Active                                                                      |         | 21:11 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 2:19 |  10.9 |
| STARTED Manual updates and blog posts                                       |         |       | 0:44 |   3.5 |
| COMPLETED Refactor helper settings                                          |         |       | 0:35 |   2.8 |
| COMPLETED Add properties for helpers                                        |         |       | 1:35 |   7.5 |
| COMPLETED Consider renaming =yarn::property= to attribute                   |         |       | 1:23 |   6.5 |
| COMPLETED Rename formattables to properties                                 |         |       | 0:50 |   3.9 |
| COMPLETED Rename helper instances                                           |         |       | 0:37 |   2.9 |
| COMPLETED Tidy-up pretty printer                                            |         |       | 1:10 |   5.5 |
| COMPLETED Rename qualified to id                                            |         |       | 0:51 |   4.0 |
| COMPLETED Rename unparsed type  in name tree                                |         |       | 0:47 |   3.7 |
| COMPLETED Add a builder-like API to pretty printer                          |         |       | 1:18 |   6.1 |
| COMPLETED Implement automatic model name detection in name builder          |         |       | 0:51 |   4.0 |
| COMPLETED Populate qualified and identifiable name                          |         |       | 2:05 |   9.8 |
| COMPLETED Rename =name_tree='s parent                                       |         |       | 0:16 |   1.3 |
| COMPLETED Compute yarn property related information                         |         |       | 1:36 |   7.6 |
| COMPLETED Remove redundancy in properties' repositories                     |         |       | 0:22 |   1.7 |
| COMPLETED Create a top-level type to aggregate properties and helpers       |         |       | 1:42 |   8.0 |
| COMPLETED Refactor helper descriptor                                        |         |       | 0:23 |   1.8 |
| COMPLETED Add an helper method interface                                    |         |       | 1:03 |   5.0 |
| STARTED Implement types helper methods with new helper infrastructure       |         |       | 0:44 |   3.5 |
