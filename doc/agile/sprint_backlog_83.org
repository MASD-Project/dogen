...
#+CAPTION: Clock summary at [2016-06-19 Sun 21:00]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *11:43* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 11:43   |       |      | 100.0 |
| Active                                                                      |         | 11:43 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:18 |  11.1 |
| COMPLETED Refactor helper settings                                          |         |       | 0:35 |   5.0 |
| COMPLETED Add properties for helpers                                        |         |       | 1:35 |  13.5 |
| COMPLETED Consider renaming =yarn::property= to attribute                   |         |       | 1:23 |  11.8 |
| COMPLETED Rename formattables to properties                                 |         |       | 0:50 |   7.1 |
| COMPLETED Rename helper instances                                           |         |       | 0:37 |   5.3 |
| COMPLETED Tidy-up pretty printer                                            |         |       | 1:10 |  10.0 |
| COMPLETED Rename qualified to id                                            |         |       | 0:34 |   4.8 |
| COMPLETED Rename unparsed type  in name tree                                |         |       | 0:47 |   6.7 |
| COMPLETED Add a builder-like API to pretty printer                          |         |       | 1:18 |  11.1 |
| STARTED Compute yarn property related information                           |         |       | 1:36 |  13.7 |
...
*** STARTED Implement automatic model name detection in name builder  :story:
