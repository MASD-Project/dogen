...
#+CAPTION: Clock summary at [2016-06-19 Sun 23:19]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *12:57* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 12:57   |       |      | 100.0 |
| Active                                                                      |         | 12:57 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:18 |  10.0 |
| COMPLETED Refactor helper settings                                          |         |       | 0:35 |   4.5 |
| COMPLETED Add properties for helpers                                        |         |       | 1:35 |  12.2 |
| COMPLETED Consider renaming =yarn::property= to attribute                   |         |       | 1:23 |  10.7 |
| COMPLETED Rename formattables to properties                                 |         |       | 0:50 |   6.4 |
| COMPLETED Rename helper instances                                           |         |       | 0:37 |   4.8 |
| COMPLETED Tidy-up pretty printer                                            |         |       | 1:10 |   9.0 |
| COMPLETED Rename qualified to id                                            |         |       | 0:34 |   4.4 |
| COMPLETED Rename unparsed type  in name tree                                |         |       | 0:47 |   6.0 |
| COMPLETED Add a builder-like API to pretty printer                          |         |       | 1:18 |  10.0 |
| COMPLETED Implement automatic model name detection in name builder          |         |       | 0:51 |   6.6 |
| STARTED Populate qualified and identifiable name                            |         |       | 0:23 |   3.0 |
| STARTED Compute yarn property related information                           |         |       | 1:36 |  12.4 |
...
*** STARTED Populate qualified and identifiable name                  :story:
...
- we can use model name detection in name builder instead of the
  multiple Boolean flags we have at the moment.
- location could have a "all modules" list that concatenates external,
  model and internal modules. We should look at performance before
  doing this change though.
