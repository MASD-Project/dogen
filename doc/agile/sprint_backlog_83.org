...
#+CAPTION: Clock summary at [2016-06-20 Mon 01:21]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *14:55* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 14:55   |       |      | 100.0 |
| Active                                                                      |         | 14:55 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:18 |   8.7 |
| COMPLETED Refactor helper settings                                          |         |       | 0:35 |   3.9 |
| COMPLETED Add properties for helpers                                        |         |       | 1:35 |  10.6 |
| COMPLETED Consider renaming =yarn::property= to attribute                   |         |       | 1:23 |   9.3 |
| COMPLETED Rename formattables to properties                                 |         |       | 0:50 |   5.6 |
| COMPLETED Rename helper instances                                           |         |       | 0:37 |   4.1 |
| COMPLETED Tidy-up pretty printer                                            |         |       | 1:10 |   7.8 |
| COMPLETED Rename qualified to id                                            |         |       | 0:34 |   3.8 |
| COMPLETED Rename unparsed type  in name tree                                |         |       | 0:47 |   5.3 |
| COMPLETED Add a builder-like API to pretty printer                          |         |       | 1:18 |   8.7 |
| COMPLETED Implement automatic model name detection in name builder          |         |       | 0:51 |   5.7 |
| COMPLETED Populate qualified and identifiable name                          |         |       | 2:05 |  14.0 |
| COMPLETED Rename =name_tree='s parent                                       |         |       | 0:16 |   1.8 |
| STARTED Compute yarn property related information                           |         |       | 1:36 |  10.7 |
