...
#+CAPTION: Clock summary at [2016-06-24 Fri 13:20]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 28:16   |       |      | 100.0 |
| Active                                                                      |         | 28:16 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 3:02 |  10.7 |
...
| COMPLETED Rename formattables to properties                                 |         |       | 0:50 |   2.9 |
...
*** STARTED Fix a number of Windows build errors                       :epic:
...
*** STARTED Fix Mingw build's warning                                 :story:
