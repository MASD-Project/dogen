...
#+CAPTION: Clock summary at [2016-06-20 Mon 19:00]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 17:18   |       |      | 100.0 |
| Active                                                                      |         | 17:18 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:45 |  10.1 |
| COMPLETED Refactor helper settings                                          |         |       | 0:35 |   3.4 |
| COMPLETED Add properties for helpers                                        |         |       | 1:35 |   9.2 |
| COMPLETED Consider renaming =yarn::property= to attribute                   |         |       | 1:23 |   8.0 |
| COMPLETED Rename formattables to properties                                 |         |       | 0:50 |   4.8 |
| COMPLETED Rename helper instances                                           |         |       | 0:37 |   3.6 |
| COMPLETED Tidy-up pretty printer                                            |         |       | 1:10 |   6.7 |
| COMPLETED Rename qualified to id                                            |         |       | 0:34 |   3.3 |
| COMPLETED Rename unparsed type  in name tree                                |         |       | 0:47 |   4.5 |
| COMPLETED Add a builder-like API to pretty printer                          |         |       | 1:18 |   7.5 |
| COMPLETED Implement automatic model name detection in name builder          |         |       | 0:51 |   4.9 |
| COMPLETED Populate qualified and identifiable name                          |         |       | 2:05 |  12.0 |
| COMPLETED Rename =name_tree='s parent                                       |         |       | 0:16 |   1.5 |
| COMPLETED Compute yarn property related information                         |         |       | 1:36 |   9.2 |
| COMPLETED Remove redundancy in properties' repositories                     |         |       | 0:14 |   1.3 |
| COMPLETED Create a top-level type to aggregate properties and helpers       |         |       | 1:42 |   9.8 |
