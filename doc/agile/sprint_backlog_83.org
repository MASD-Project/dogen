...
#+CAPTION: Clock summary at [2016-06-28 Tue 22:21]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 35:57   |       |      | 100.0 |
| Active                                                                      |         | 35:57 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 3:42 |  10.3 |
| STARTED Manual updates and blog posts                                       |         |       | 0:53 |   2.5 |
| COMPLETED Refactor helper settings                                          |         |       | 0:35 |   1.6 |
| COMPLETED Add properties for helpers                                        |         |       | 1:35 |   4.4 |
| COMPLETED Consider renaming =yarn::property= to attribute                   |         |       | 1:23 |   3.8 |
| COMPLETED Rename formattables to properties                                 |         |       | 0:50 |   2.3 |
| COMPLETED Rename helper instances                                           |         |       | 0:37 |   1.7 |
| COMPLETED Tidy-up pretty printer                                            |         |       | 1:10 |   3.2 |
| COMPLETED Rename qualified to id                                            |         |       | 0:51 |   2.4 |
| COMPLETED Rename unparsed type  in name tree                                |         |       | 0:47 |   2.2 |
| COMPLETED Add a builder-like API to pretty printer                          |         |       | 1:18 |   3.6 |
| COMPLETED Implement automatic model name detection in name builder          |         |       | 0:51 |   2.4 |
| COMPLETED Populate qualified and identifiable name                          |         |       | 2:05 |   5.8 |
...
| COMPLETED Create a top-level type to aggregate properties and helpers       |         |       | 1:42 |   4.7 |
| COMPLETED Refactor helper descriptor                                        |         |       | 0:23 |   1.1 |
| COMPLETED Add an helper method interface                                    |         |       | 1:03 |   2.9 |
| COMPLETED Remove encoded from yarn's name tree                              |         |       | 1:24 |   3.9 |
...
| COMPLETED Fix issues with build in laptop                                   |         |       | 0:48 |   2.2 |
...
| COMPLETED Implement types helper methods with new helper infrastructure     |         |       | 3:12 |   8.9 |
| COMPLETED Move identifiable and qualified to assistant                      |         |       | 0:32 |   1.5 |
| COMPLETED Refactor helper properties yet again                              |         |       | 2:56 |   8.2 |
| STARTED Implement IO helper methods with new helper infrastructure          |         |       | 2:16 |   6.3 |
