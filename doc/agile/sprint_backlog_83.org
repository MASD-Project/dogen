...
#+CAPTION: Clock summary at [2016-06-27 Mon 16:48]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *30:43* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 30:43   |       |      | 100.0 |
| Active                                                                      |         | 30:43 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 3:42 |  12.0 |
| STARTED Manual updates and blog posts                                       |         |       | 0:53 |   2.9 |
| COMPLETED Refactor helper settings                                          |         |       | 0:35 |   1.9 |
| COMPLETED Add properties for helpers                                        |         |       | 1:35 |   5.2 |
| COMPLETED Consider renaming =yarn::property= to attribute                   |         |       | 1:23 |   4.5 |
| COMPLETED Rename formattables to properties                                 |         |       | 0:50 |   2.7 |
| COMPLETED Rename helper instances                                           |         |       | 0:37 |   2.0 |
| COMPLETED Tidy-up pretty printer                                            |         |       | 1:10 |   3.8 |
| COMPLETED Rename qualified to id                                            |         |       | 0:51 |   2.8 |
| COMPLETED Rename unparsed type  in name tree                                |         |       | 0:47 |   2.6 |
| COMPLETED Add a builder-like API to pretty printer                          |         |       | 1:18 |   4.2 |
| COMPLETED Implement automatic model name detection in name builder          |         |       | 0:51 |   2.8 |
| COMPLETED Populate qualified and identifiable name                          |         |       | 2:05 |   6.8 |
| COMPLETED Rename =name_tree='s parent                                       |         |       | 0:16 |   0.9 |
| COMPLETED Compute yarn property related information                         |         |       | 2:17 |   7.4 |
| COMPLETED Remove redundancy in properties' repositories                     |         |       | 0:22 |   1.2 |
| COMPLETED Create a top-level type to aggregate properties and helpers       |         |       | 1:42 |   5.5 |
| COMPLETED Refactor helper descriptor                                        |         |       | 0:23 |   1.2 |
| COMPLETED Add an helper method interface                                    |         |       | 1:03 |   3.4 |
| COMPLETED Remove encoded from yarn's name tree                              |         |       | 1:24 |   4.6 |
...
| COMPLETED Fix issues with build in laptop                                   |         |       | 0:48 |   2.6 |
...
| COMPLETED Implement types helper methods with new helper infrastructure     |         |       | 3:12 |  10.4 |
...
*** Move identifiable and qualified to assistant                      :story:
...
*** Checek which properties need to loop through the entire model     :story:
