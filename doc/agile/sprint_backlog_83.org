...
#+CAPTION: Clock summary at [2016-06-19 Sun 18:44]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *10:56* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 10:56   |       |      | 100.0 |
| Active                                                                      |         | 10:56 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:18 |  11.9 |
| COMPLETED Refactor helper settings                                          |         |       | 0:35 |   5.3 |
| COMPLETED Add properties for helpers                                        |         |       | 1:35 |  14.5 |
| COMPLETED Consider renaming =yarn::property= to attribute                   |         |       | 1:23 |  12.7 |
| COMPLETED Rename formattables to properties                                 |         |       | 0:50 |   7.6 |
| COMPLETED Rename helper instances                                           |         |       | 0:37 |   5.6 |
| COMPLETED Tidy-up pretty printer                                            |         |       | 1:10 |  10.7 |
| COMPLETED Rename qualified to id                                            |         |       | 0:34 |   5.2 |
| COMPLETED Rename unparsed type  in name tree                                |         |       | 0:47 |   7.2 |
| STARTED Add a builder-like API to pretty printer                            |         |       | 0:31 |   4.7 |
| STARTED Compute yarn property related information                           |         |       | 1:36 |  14.6 |
...
*** STARTED Add a builder-like API to pretty printer                  :story:
