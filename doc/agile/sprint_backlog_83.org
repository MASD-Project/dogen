...
#+CAPTION: Clock summary at [2016-06-20 Mon 15:39]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *15:22* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 15:22   |       |      | 100.0 |
| Active                                                                      |         | 15:22 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:45 |  11.4 |
| COMPLETED Refactor helper settings                                          |         |       | 0:35 |   3.8 |
| COMPLETED Add properties for helpers                                        |         |       | 1:35 |  10.3 |
| COMPLETED Consider renaming =yarn::property= to attribute                   |         |       | 1:23 |   9.0 |
| COMPLETED Rename formattables to properties                                 |         |       | 0:50 |   5.4 |
| COMPLETED Rename helper instances                                           |         |       | 0:37 |   4.0 |
| COMPLETED Tidy-up pretty printer                                            |         |       | 1:10 |   7.6 |
| COMPLETED Rename qualified to id                                            |         |       | 0:34 |   3.7 |
| COMPLETED Rename unparsed type  in name tree                                |         |       | 0:47 |   5.1 |
| COMPLETED Add a builder-like API to pretty printer                          |         |       | 1:18 |   8.5 |
| COMPLETED Implement automatic model name detection in name builder          |         |       | 0:51 |   5.5 |
| COMPLETED Populate qualified and identifiable name                          |         |       | 2:05 |  13.6 |
| COMPLETED Rename =name_tree='s parent                                       |         |       | 0:16 |   1.7 |
| STARTED Compute yarn property related information                           |         |       | 1:36 |  10.4 |
