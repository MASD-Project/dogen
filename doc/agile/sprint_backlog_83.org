...
#+CAPTION: Clock summary at [2016-06-20 Mon 21:16]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *17:48* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 17:48   |       |      | 100.0 |
| Active                                                                      |         | 17:48 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 2:07 |  11.9 |
| COMPLETED Refactor helper settings                                          |         |       | 0:35 |   3.3 |
| COMPLETED Add properties for helpers                                        |         |       | 1:35 |   8.9 |
| COMPLETED Consider renaming =yarn::property= to attribute                   |         |       | 1:23 |   7.8 |
| COMPLETED Rename formattables to properties                                 |         |       | 0:50 |   4.7 |
| COMPLETED Rename helper instances                                           |         |       | 0:37 |   3.5 |
| COMPLETED Tidy-up pretty printer                                            |         |       | 1:10 |   6.6 |
| COMPLETED Rename qualified to id                                            |         |       | 0:34 |   3.2 |
| COMPLETED Rename unparsed type  in name tree                                |         |       | 0:47 |   4.4 |
| COMPLETED Add a builder-like API to pretty printer                          |         |       | 1:18 |   7.3 |
| COMPLETED Implement automatic model name detection in name builder          |         |       | 0:51 |   4.8 |
| COMPLETED Populate qualified and identifiable name                          |         |       | 2:05 |  11.7 |
| COMPLETED Rename =name_tree='s parent                                       |         |       | 0:16 |   1.5 |
| COMPLETED Compute yarn property related information                         |         |       | 1:36 |   9.0 |
| COMPLETED Remove redundancy in properties' repositories                     |         |       | 0:22 |   2.1 |
| COMPLETED Create a top-level type to aggregate properties and helpers       |         |       | 1:42 |   9.6 |
