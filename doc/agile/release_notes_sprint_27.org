...
Clock summary at [2013-05-28 Tue 18:44]

| Headline                                                | Time    |       |       |
|---------------------------------------------------------+---------+-------+-------|
| *Total time*                                            | *27:27* |       |       |
|---------------------------------------------------------+---------+-------+-------|
| Development Stories Implemented                         |         | 27:27 |       |
...
| IMPLEMENTATION Create a basic skeleton for manuals      |         |       |  0:10 |
| IMPLEMENTATION Remove location request                  |         |       |  1:08 |
#+end:
...
*** COMPLETED Use content descriptors in includer
...
*** IMPLEMENTATION Create a basic skeleton for manuals
    CLOCK: [2013-05-28 Tue 07:55]--[2013-05-28 Tue 08:05] =>  0:10

*** IMPLEMENTATION Remove location request

Now we have content descriptor, the location request is no longer required.

**** IMPLEMENTATION Update all private methods in includer to use content descriptor
...
**** Update locator to use content descriptor
