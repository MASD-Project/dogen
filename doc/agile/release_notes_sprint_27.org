...
Clock summary at [2013-05-29 Wed 00:05]

| Headline                                                | Time    |       |       |
|---------------------------------------------------------+---------+-------+-------|
| *Total time*                                            | *29:29* |       |       |
|---------------------------------------------------------+---------+-------+-------|
| Development Stories Implemented                         |         | 29:29 |       |
...
| COMPLETED Update C++ dia model to reflect code changes  |         |       |  0:58 |
#+end:
...
*** COMPLETED Remove location request
...
*** COMPLETED Create a basic skeleton for manual
...
*** COMPLETED Update C++ dia model to reflect code changes
