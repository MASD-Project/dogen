...
#+CAPTION: Clock summary at [2016-11-10 Thu 18:16]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *23:50* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 23:50   |       |      | 100.0 |
| Active                                                                      |         | 23:50 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:10 |   0.7 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:27 |   1.9 |
| COMPLETED Tidy-up README file                                               |         |       | 1:07 |   4.7 |
| COMPLETED Sort out PIC/PIE linking problems                                 |         |       | 1:55 |   8.0 |
| COMPLETED Try to fix BinTray problems                                       |         |       | 1:09 |   4.8 |
| COMPLETED Supply model references via meta-data rather than command line    |         |       | 3:43 |  15.6 |
| COMPLETED Remove trailing blank lines in comments                           |         |       | 0:39 |   2.7 |
| STARTED Make JSON yarn a fully supported frontend                           |         |       | 9:57 |  41.7 |
| STARTED Add a utility that converts a dia model into JSON                   |         |       | 4:25 |  18.5 |
