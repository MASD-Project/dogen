...
#+CAPTION: Clock summary at [2016-11-07 Mon 18:25]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *8:31* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 8:31   |      |      | 100.0 |
| Active                                                                      |        | 8:31 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:10 |   2.0 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 0:27 |   5.3 |
| COMPLETED Tidy-up README file                                               |        |      | 1:07 |  13.1 |
| COMPLETED Sort out PIC/PIE linking problems                                 |        |      | 1:55 |  22.5 |
| COMPLETED Try to fix BinTray problems                                       |        |      | 1:09 |  13.5 |
| STARTED Supply model references via meta-data rather than command line      |        |      | 3:43 |  43.6 |
