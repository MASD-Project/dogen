...
#+CAPTION: Clock summary at [2016-11-10 Thu 13:13]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| COMPLETED Tidy-up README file                                               |         |       | 1:07 |   5.5 |
| COMPLETED Sort out PIC/PIE linking problems                                 |         |       | 1:55 |   9.4 |
| COMPLETED Try to fix BinTray problems                                       |         |       | 1:09 |   5.6 |
| COMPLETED Supply model references via meta-data rather than command line    |         |       | 3:43 |  18.2 |
| COMPLETED Remove trailing blank lines in comments                           |         |       | 0:39 |   3.2 |
| STARTED Make JSON yarn a fully supported frontend                           |         |       | 9:54 |  48.6 |
| STARTED Add a utility that converts a dia model into JSON                   |         |       | 1:00 |   4.9 |
| STARTED External module path for target should be in diagram                |         |       | 0:18 |   1.5 |
