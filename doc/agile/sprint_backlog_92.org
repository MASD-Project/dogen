...
#+CAPTION: Clock summary at [2016-11-10 Thu 14:42]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *20:55* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 20:55   |       |      | 100.0 |
| Active                                                                      |         | 20:55 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:10 |   0.8 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:27 |   2.2 |
| COMPLETED Tidy-up README file                                               |         |       | 1:07 |   5.3 |
| COMPLETED Sort out PIC/PIE linking problems                                 |         |       | 1:55 |   9.2 |
| COMPLETED Try to fix BinTray problems                                       |         |       | 1:09 |   5.5 |
| COMPLETED Supply model references via meta-data rather than command line    |         |       | 3:43 |  17.8 |
| COMPLETED Remove trailing blank lines in comments                           |         |       | 0:39 |   3.1 |
| STARTED Make JSON yarn a fully supported frontend                           |         |       | 9:54 |  47.3 |
| STARTED Add a utility that converts a dia model into JSON                   |         |       | 1:33 |   7.4 |
| STARTED External module path for target should be in diagram                |         |       | 0:18 |   1.4 |
