...
#+CAPTION: Clock summary at [2016-11-10 Thu 22:52]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:27 |   1.8 |
| COMPLETED Tidy-up README file                                               |         |       | 1:07 |   4.4 |
| COMPLETED Sort out PIC/PIE linking problems                                 |         |       | 1:55 |   7.6 |
| COMPLETED Try to fix BinTray problems                                       |         |       | 1:09 |   4.6 |
| COMPLETED Supply model references via meta-data rather than command line    |         |       | 3:43 |  14.8 |
| COMPLETED Remove trailing blank lines in comments                           |         |       | 0:39 |   2.6 |
| COMPLETED External module path for target should be in diagram              |         |       | 1:28 |   5.8 |
| STARTED Make JSON yarn a fully supported frontend                           |         |       | 9:57 |  39.5 |
| STARTED Add a utility that converts a dia model into JSON                   |         |       | 4:36 |  18.3 |
