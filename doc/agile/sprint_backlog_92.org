...
#+CAPTION: Clock summary at [2016-11-11 Fri 13:16]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *27:23* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 27:23   |       |      | 100.0 |
| Active                                                                      |         | 27:23 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:10 |   0.6 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:27 |   1.6 |
| COMPLETED Tidy-up README file                                               |         |       | 1:07 |   4.1 |
| COMPLETED Sort out PIC/PIE linking problems                                 |         |       | 1:55 |   7.0 |
| COMPLETED Try to fix BinTray problems                                       |         |       | 1:09 |   4.2 |
| COMPLETED Supply model references via meta-data rather than command line    |         |       | 3:43 |  13.6 |
| COMPLETED Remove trailing blank lines in comments                           |         |       | 0:39 |   2.4 |
| COMPLETED External module path for target should be in diagram              |         |       | 1:28 |   5.4 |
| STARTED Make JSON yarn a fully supported frontend                           |         |       | 9:57 |  36.3 |
| STARTED Add a utility that converts a dia model into JSON                   |         |       | 6:48 |  24.8 |
