...
#+CAPTION: Clock summary at [2016-11-12 Sat 17:14]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| COMPLETED Tidy-up README file                                               |         |       |  1:07 |   3.7 |
| COMPLETED Sort out PIC/PIE linking problems                                 |         |       |  1:55 |   6.4 |
| COMPLETED Try to fix BinTray problems                                       |         |       |  1:09 |   3.9 |
| COMPLETED Supply model references via meta-data rather than command line    |         |       |  3:43 |  12.5 |
| COMPLETED Remove trailing blank lines in comments                           |         |       |  0:39 |   2.2 |
| COMPLETED External module path for target should be in diagram              |         |       |  1:28 |   4.9 |
| COMPLETED Make JSON yarn a fully supported frontend                         |         |       | 10:26 |  35.0 |
| COMPLETED Add a utility that converts a dia model into JSON                 |         |       |  6:48 |  22.8 |
| COMPLETED Split yarn.json output from yarn.dia                              |         |       |  0:58 |   3.2 |
| COMPLETED Possible performance regression at =2ac04ea=                      |         |       |  0:31 |   1.7 |
| COMPLETED Check that all dogen models convert to JSON                       |         |       |  0:27 |   1.5 |
