...
#+CAPTION: Clock summary at [2016-11-07 Mon 22:06]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *9:45* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 9:45   |      |      | 100.0 |
| Active                                                                      |        | 9:45 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:10 |   1.7 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 0:27 |   4.6 |
| COMPLETED Tidy-up README file                                               |        |      | 1:07 |  11.5 |
| COMPLETED Sort out PIC/PIE linking problems                                 |        |      | 1:55 |  19.7 |
| COMPLETED Try to fix BinTray problems                                       |        |      | 1:09 |  11.8 |
| COMPLETED Supply model references via meta-data rather than command line    |        |      | 3:43 |  38.1 |
| STARTED Make JSON yarn a fully supported frontend                           |        |      | 1:14 |  12.6 |
