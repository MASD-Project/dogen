...
#+CAPTION: Clock summary at [2016-11-14 Mon 13:52]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *31:03* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 31:03   |       |       | 100.0 |
| Active                                                                      |         | 31:03 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:10 |   0.5 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:27 |   1.4 |
| COMPLETED Tidy-up README file                                               |         |       |  1:07 |   3.6 |
| COMPLETED Sort out PIC/PIE linking problems                                 |         |       |  1:55 |   6.2 |
| COMPLETED Try to fix BinTray problems                                       |         |       |  1:09 |   3.7 |
| COMPLETED Supply model references via meta-data rather than command line    |         |       |  3:43 |  12.0 |
| COMPLETED Remove trailing blank lines in comments                           |         |       |  0:39 |   2.1 |
| COMPLETED External module path for target should be in diagram              |         |       |  1:28 |   4.7 |
| COMPLETED Make JSON yarn a fully supported frontend                         |         |       | 10:26 |  33.6 |
| COMPLETED Add a utility that converts a dia model into JSON                 |         |       |  6:48 |  21.9 |
| COMPLETED Split yarn.json output from yarn.dia                              |         |       |  0:58 |   3.1 |
| COMPLETED Possible performance regression at =2ac04ea=                      |         |       |  0:31 |   1.7 |
| COMPLETED Check that all dogen models convert to JSON                       |         |       |  0:27 |   1.4 |
| STARTED Create a tool to generate product skeletons                         |         |       |  1:15 |   4.0 |
...
*** STARTED Create a tool to generate product skeletons               :story:
