...
#+CAPTION: Clock summary at [2016-11-10 Thu 17:14]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *22:52* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 22:52   |       |      | 100.0 |
| Active                                                                      |         | 22:52 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:10 |   0.7 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:27 |   2.0 |
| COMPLETED Tidy-up README file                                               |         |       | 1:07 |   4.9 |
| COMPLETED Sort out PIC/PIE linking problems                                 |         |       | 1:55 |   8.4 |
| COMPLETED Try to fix BinTray problems                                       |         |       | 1:09 |   5.0 |
| COMPLETED Supply model references via meta-data rather than command line    |         |       | 3:43 |  16.3 |
| COMPLETED Remove trailing blank lines in comments                           |         |       | 0:39 |   2.8 |
| STARTED Make JSON yarn a fully supported frontend                           |         |       | 9:54 |  43.3 |
| STARTED Add a utility that converts a dia model into JSON                   |         |       | 3:30 |  15.3 |
