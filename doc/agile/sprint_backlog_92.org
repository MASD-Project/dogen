...
#+CAPTION: Clock summary at [2016-11-09 Wed 21:38]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 17:11   |       |      | 100.0 |
| Active                                                                      |         | 17:11 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:10 |   1.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:27 |   2.6 |
| COMPLETED Tidy-up README file                                               |         |       | 1:07 |   6.5 |
| COMPLETED Sort out PIC/PIE linking problems                                 |         |       | 1:55 |  11.2 |
| COMPLETED Try to fix BinTray problems                                       |         |       | 1:09 |   6.7 |
| COMPLETED Supply model references via meta-data rather than command line    |         |       | 3:43 |  21.6 |
| STARTED Make JSON yarn a fully supported frontend                           |         |       | 8:22 |  48.7 |
| STARTED External module path for target should be in diagram                |         |       | 0:18 |   1.7 |
