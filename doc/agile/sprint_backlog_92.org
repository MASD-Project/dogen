...
#+CAPTION: Clock summary at [2016-11-07 Mon 22:53]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *10:31* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 10:31   |       |      | 100.0 |
| Active                                                                      |         | 10:31 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:10 |   1.6 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:27 |   4.3 |
| COMPLETED Tidy-up README file                                               |         |       | 1:07 |  10.6 |
| COMPLETED Sort out PIC/PIE linking problems                                 |         |       | 1:55 |  18.2 |
| COMPLETED Try to fix BinTray problems                                       |         |       | 1:09 |  10.9 |
| COMPLETED Supply model references via meta-data rather than command line    |         |       | 3:43 |  35.3 |
| STARTED Make JSON yarn a fully supported frontend                           |         |       | 2:00 |  19.0 |
