...
#+CAPTION: Clock summary at [2016-11-10 Thu 16:22]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *22:02* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 22:02   |       |      | 100.0 |
| Active                                                                      |         | 22:02 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:10 |   0.8 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:27 |   2.0 |
| COMPLETED Tidy-up README file                                               |         |       | 1:07 |   5.1 |
| COMPLETED Sort out PIC/PIE linking problems                                 |         |       | 1:55 |   8.7 |
| COMPLETED Try to fix BinTray problems                                       |         |       | 1:09 |   5.2 |
| COMPLETED Supply model references via meta-data rather than command line    |         |       | 3:43 |  16.9 |
| COMPLETED Remove trailing blank lines in comments                           |         |       | 0:39 |   3.0 |
| STARTED Make JSON yarn a fully supported frontend                           |         |       | 9:54 |  44.9 |
| STARTED Add a utility that converts a dia model into JSON                   |         |       | 2:40 |  12.1 |
