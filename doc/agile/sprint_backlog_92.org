...
#+CAPTION: Clock summary at [2016-11-11 Fri 10:07]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| COMPLETED Tidy-up README file                                               |         |       | 1:07 |   4.3 |
| COMPLETED Sort out PIC/PIE linking problems                                 |         |       | 1:55 |   7.4 |
| COMPLETED Try to fix BinTray problems                                       |         |       | 1:09 |   4.4 |
| COMPLETED Supply model references via meta-data rather than command line    |         |       | 3:43 |  14.3 |
| COMPLETED Remove trailing blank lines in comments                           |         |       | 0:39 |   2.5 |
| COMPLETED External module path for target should be in diagram              |         |       | 1:28 |   5.6 |
| STARTED Make JSON yarn a fully supported frontend                           |         |       | 9:57 |  38.2 |
| STARTED Add a utility that converts a dia model into JSON                   |         |       | 5:28 |  21.0 |
