...
#+CAPTION: Clock summary at [2016-11-10 Thu 22:14]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *24:35* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 24:35   |       |      | 100.0 |
| Active                                                                      |         | 24:35 |      | 100.0 |
...
| COMPLETED Sort out PIC/PIE linking problems                                 |         |       | 1:55 |   7.8 |
| COMPLETED Try to fix BinTray problems                                       |         |       | 1:09 |   4.7 |
| COMPLETED Supply model references via meta-data rather than command line    |         |       | 3:43 |  15.1 |
| COMPLETED Remove trailing blank lines in comments                           |         |       | 0:39 |   2.6 |
| STARTED Make JSON yarn a fully supported frontend                           |         |       | 9:57 |  40.5 |
| STARTED Add a utility that converts a dia model into JSON                   |         |       | 4:25 |  18.0 |
| STARTED External module path for target should be in diagram                |         |       | 1:03 |   4.3 |
