...
#+CAPTION: Clock summary at [2016-11-11 Fri 15:10]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| COMPLETED Tidy-up README file                                               |         |       |  1:07 |   4.0 |
| COMPLETED Sort out PIC/PIE linking problems                                 |         |       |  1:55 |   6.9 |
| COMPLETED Try to fix BinTray problems                                       |         |       |  1:09 |   4.1 |
| COMPLETED Supply model references via meta-data rather than command line    |         |       |  3:43 |  13.3 |
| COMPLETED Remove trailing blank lines in comments                           |         |       |  0:39 |   2.3 |
| COMPLETED External module path for target should be in diagram              |         |       |  1:28 |   5.3 |
| COMPLETED Make JSON yarn a fully supported frontend                         |         |       | 10:26 |  37.4 |
| COMPLETED Add a utility that converts a dia model into JSON                 |         |       |  6:48 |  24.4 |
