...
#+CAPTION: Clock summary at [2016-11-12 Sat 16:27]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| COMPLETED Supply model references via meta-data rather than command line    |         |       |  3:43 |  12.8 |
...
| COMPLETED Make JSON yarn a fully supported frontend                         |         |       | 10:26 |  35.9 |
| COMPLETED Add a utility that converts a dia model into JSON                 |         |       |  6:48 |  23.4 |
| COMPLETED Split yarn.json output from yarn.dia                              |         |       |  0:58 |   3.3 |
| STARTED Performance regression at =2ac04ea=                                 |         |       |  0:13 |   0.7 |
...
*** STARTED Performance regression at =2ac04ea=                       :story:
