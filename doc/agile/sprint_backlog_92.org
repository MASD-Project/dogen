...
#+CAPTION: Clock summary at [2016-11-10 Thu 22:41]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *25:00* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 25:00   |       |      | 100.0 |
| Active                                                                      |         | 25:00 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:10 |   0.7 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:27 |   1.8 |
| COMPLETED Tidy-up README file                                               |         |       | 1:07 |   4.5 |
| COMPLETED Sort out PIC/PIE linking problems                                 |         |       | 1:55 |   7.7 |
| COMPLETED Try to fix BinTray problems                                       |         |       | 1:09 |   4.6 |
| COMPLETED Supply model references via meta-data rather than command line    |         |       | 3:43 |  14.9 |
| COMPLETED Remove trailing blank lines in comments                           |         |       | 0:39 |   2.6 |
| COMPLETED External module path for target should be in diagram              |         |       | 1:28 |   5.9 |
| STARTED Make JSON yarn a fully supported frontend                           |         |       | 9:57 |  39.8 |
| STARTED Add a utility that converts a dia model into JSON                   |         |       | 4:25 |  17.7 |
