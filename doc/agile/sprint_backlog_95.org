...
#+CAPTION: Clock summary at [2017-01-15 Sun 12:48]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *83:06* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 83:06   |       |       | 100.0 |
| Active                                                                      |         | 83:06 |       | 100.0 |
...
| COMPLETED Add basic validation infrastructure                               |         |       |  8:40 |  10.4 |
| COMPLETED Fix borked windows build                                          |         |       |  0:26 |   0.5 |
| COMPLETED Clean up enumerator implementation                                |         |       |  1:05 |   1.3 |
| COMPLETED Measure validation slowdown                                       |         |       |  6:38 |   8.0 |
...
| COMPLETED Add read support for upsilon models                               |         |       | 13:26 |  16.2 |
| STARTED Create an upsilon yarn frontend                                     |         |       |  8:30 |  10.2 |
| STARTED Add auxiliary function properties to c#                             |         |       |  1:11 |   1.4 |
| STARTED Add internal object dumper resolution                               |         |       |  4:51 |   5.8 |
