...
#+CAPTION: Clock summary at [2017-01-06 Fri 23:27]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *36:27* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 36:27   |       |      | 100.0 |
| Active                                                                      |         | 36:27 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:30 |   1.4 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:57 |   2.6 |
| COMPLETED Consider supporting multiple inheritance on non-proxy models      |         |       | 3:24 |   9.3 |
| COMPLETED Add basic validation infrastructure                               |         |       | 8:40 |  23.8 |
| COMPLETED Fix borked windows build                                          |         |       | 0:26 |   1.2 |
| COMPLETED Clean up enumerator implementation                                |         |       | 1:05 |   3.0 |
| COMPLETED Measure validation slowdown                                       |         |       | 6:38 |  18.2 |
| COMPLETED Parsing should support dot notation                               |         |       | 2:54 |   8.0 |
| COMPLETED Add internal object dumper resolution                             |         |       | 4:51 |  13.3 |
| STARTED Add container types to C# proxy models                              |         |       | 7:02 |  19.3 |
