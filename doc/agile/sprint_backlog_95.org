...
#+CAPTION: Clock summary at [2017-01-07 Sat 13:29]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| COMPLETED Consider supporting multiple inheritance on non-proxy models      |         |       | 3:24 |   8.9 |
| COMPLETED Add basic validation infrastructure                               |         |       | 8:40 |  22.6 |
| COMPLETED Fix borked windows build                                          |         |       | 0:26 |   1.1 |
| COMPLETED Clean up enumerator implementation                                |         |       | 1:05 |   2.8 |
| COMPLETED Measure validation slowdown                                       |         |       | 6:38 |  17.3 |
| COMPLETED Parsing should support dot notation                               |         |       | 2:54 |   7.6 |
| COMPLETED Add internal object dumper resolution                             |         |       | 4:51 |  12.7 |
| STARTED Add container types to C# proxy models                              |         |       | 8:53 |  23.2 |
