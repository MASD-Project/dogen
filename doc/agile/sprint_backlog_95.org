...
#+CAPTION: Clock summary at [2017-01-15 Sun 00:12]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *80:43* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 80:43   |       |       | 100.0 |
| Active                                                                      |         | 80:43 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:35 |   0.7 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:57 |   1.2 |
| COMPLETED Consider supporting multiple inheritance on non-proxy models      |         |       |  3:24 |   4.2 |
| COMPLETED Add basic validation infrastructure                               |         |       |  8:40 |  10.7 |
| COMPLETED Fix borked windows build                                          |         |       |  0:26 |   0.5 |
| COMPLETED Clean up enumerator implementation                                |         |       |  1:05 |   1.3 |
| COMPLETED Measure validation slowdown                                       |         |       |  6:38 |   8.2 |
| COMPLETED Parsing should support dot notation                               |         |       |  2:54 |   3.6 |
| COMPLETED Analysis for changes required in order to support containers      |         |       |  3:15 |   4.0 |
| COMPLETED Add support for object based container types in C#                |         |       |  5:48 |   7.2 |
...
| COMPLETED Build dogen on windows locally                                    |         |       |  7:32 |   9.3 |
...
| COMPLETED Add read support for upsilon models                               |         |       | 13:26 |  16.6 |
| STARTED Create an upsilon yarn frontend                                     |         |       |  6:07 |   7.6 |
| STARTED Add auxiliary function properties to c#                             |         |       |  1:11 |   1.5 |
| STARTED Add internal object dumper resolution                               |         |       |  4:51 |   6.0 |
