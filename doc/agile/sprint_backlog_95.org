...
#+CAPTION: Clock summary at [2017-01-11 Wed 10:52]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *57:01* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 57:01   |       |      | 100.0 |
| Active                                                                      |         | 57:01 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:35 |   1.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:57 |   1.7 |
| COMPLETED Consider supporting multiple inheritance on non-proxy models      |         |       | 3:24 |   6.0 |
| COMPLETED Add basic validation infrastructure                               |         |       | 8:40 |  15.2 |
| COMPLETED Fix borked windows build                                          |         |       | 0:26 |   0.8 |
| COMPLETED Clean up enumerator implementation                                |         |       | 1:05 |   1.9 |
| COMPLETED Measure validation slowdown                                       |         |       | 6:38 |  11.6 |
| COMPLETED Parsing should support dot notation                               |         |       | 2:54 |   5.1 |
| COMPLETED Analysis for changes required in order to support containers      |         |       | 3:15 |   5.7 |
| COMPLETED Add support for object based container types in C#                |         |       | 5:48 |  10.2 |
...
| COMPLETED Build dogen on windows locally                                    |         |       | 7:32 |  13.2 |
| COMPLETED Fix borked windows build                                          |         |       | 1:54 |   3.3 |
| STARTED Generate windows packages with WIX                                  |         |       | 3:28 |   6.1 |
| STARTED Add appveyor support for bintray                                    |         |       | 1:00 |   1.8 |
| STARTED Add auxiliary function properties to c#                             |         |       | 1:11 |   2.1 |
| STARTED Add internal object dumper resolution                               |         |       | 4:51 |   8.5 |
