...
#+CAPTION: Clock summary at [2017-01-10 Tue 16:12]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *54:04* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 54:04   |       |      | 100.0 |
| Active                                                                      |         | 54:04 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:35 |   1.1 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:57 |   1.8 |
| COMPLETED Consider supporting multiple inheritance on non-proxy models      |         |       | 3:24 |   6.3 |
| COMPLETED Add basic validation infrastructure                               |         |       | 8:40 |  16.0 |
| COMPLETED Fix borked windows build                                          |         |       | 0:26 |   0.8 |
| COMPLETED Clean up enumerator implementation                                |         |       | 1:05 |   2.0 |
| COMPLETED Measure validation slowdown                                       |         |       | 6:38 |  12.3 |
| COMPLETED Parsing should support dot notation                               |         |       | 2:54 |   5.4 |
...
| COMPLETED Understand the behaviour of helpers and assistants                |         |       | 1:13 |   2.3 |
| CANCELLED Add support for generic parents in yarn                           |         |       | 0:35 |   1.1 |
| STARTED Build dogen on windows locally                                      |         |       | 7:32 |  13.9 |
| STARTED Generate windows packages with WIX                                  |         |       | 2:44 |   5.1 |
| STARTED Add auxiliary function properties to c#                             |         |       | 1:11 |   2.2 |
| STARTED Add internal object dumper resolution                               |         |       | 4:51 |   9.0 |
...
*** STARTED Build dogen on windows locally                            :story:
