...
#+CAPTION: Clock summary at [2017-01-12 Thu 10:21]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *63:47* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 63:47   |       |      | 100.0 |
| Active                                                                      |         | 63:47 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:35 |   0.9 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:57 |   1.5 |
| COMPLETED Consider supporting multiple inheritance on non-proxy models      |         |       | 3:24 |   5.3 |
...
| COMPLETED Parsing should support dot notation                               |         |       | 2:54 |   4.5 |
...
| COMPLETED Build dogen on windows locally                                    |         |       | 7:32 |  11.8 |
| COMPLETED Fix borked windows build                                          |         |       | 1:54 |   3.0 |
| COMPLETED Generate windows packages with WIX                                |         |       | 3:28 |   5.4 |
...
| STARTED Add upsilon support                                                 |         |       | 3:12 |   5.0 |
