...
#+CAPTION: Clock summary at [2017-01-13 Fri 10:11]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *72:09* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 72:09   |       |       | 100.0 |
| Active                                                                      |         | 72:09 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:35 |   0.8 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:57 |   1.3 |
| COMPLETED Consider supporting multiple inheritance on non-proxy models      |         |       |  3:24 |   4.7 |
| COMPLETED Add basic validation infrastructure                               |         |       |  8:40 |  12.0 |
| COMPLETED Fix borked windows build                                          |         |       |  0:26 |   0.6 |
| COMPLETED Clean up enumerator implementation                                |         |       |  1:05 |   1.5 |
| COMPLETED Measure validation slowdown                                       |         |       |  6:38 |   9.2 |
| COMPLETED Parsing should support dot notation                               |         |       |  2:54 |   4.0 |
| COMPLETED Analysis for changes required in order to support containers      |         |       |  3:15 |   4.5 |
| COMPLETED Add support for object based container types in C#                |         |       |  5:48 |   8.0 |
...
| COMPLETED Build dogen on windows locally                                    |         |       |  7:32 |  10.4 |
| COMPLETED Fix borked windows build                                          |         |       |  1:54 |   2.6 |
| COMPLETED Generate windows packages with WIX                                |         |       |  3:28 |   4.8 |
...
| COMPLETED Add appveyor support for bintray                                  |         |       |  2:23 |   3.3 |
| STARTED Add upsilon support                                                 |         |       | 10:59 |  15.2 |
| STARTED Add auxiliary function properties to c#                             |         |       |  1:11 |   1.6 |
| STARTED Add internal object dumper resolution                               |         |       |  4:51 |   6.7 |
