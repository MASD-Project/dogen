...
#+CAPTION: Clock summary at [2017-01-12 Thu 20:42]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *68:17* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 68:17   |       |      | 100.0 |
| Active                                                                      |         | 68:17 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:35 |   0.9 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:57 |   1.4 |
| COMPLETED Consider supporting multiple inheritance on non-proxy models      |         |       | 3:24 |   5.0 |
| COMPLETED Add basic validation infrastructure                               |         |       | 8:40 |  12.7 |
| COMPLETED Fix borked windows build                                          |         |       | 0:26 |   0.6 |
| COMPLETED Clean up enumerator implementation                                |         |       | 1:05 |   1.6 |
| COMPLETED Measure validation slowdown                                       |         |       | 6:38 |   9.7 |
| COMPLETED Parsing should support dot notation                               |         |       | 2:54 |   4.2 |
| COMPLETED Analysis for changes required in order to support containers      |         |       | 3:15 |   4.8 |
| COMPLETED Add support for object based container types in C#                |         |       | 5:48 |   8.5 |
...
| COMPLETED Build dogen on windows locally                                    |         |       | 7:32 |  11.0 |
| COMPLETED Fix borked windows build                                          |         |       | 1:54 |   2.8 |
| COMPLETED Generate windows packages with WIX                                |         |       | 3:28 |   5.1 |
...
| STARTED Add upsilon support                                                 |         |       | 7:07 |  10.4 |
| STARTED Add auxiliary function properties to c#                             |         |       | 1:11 |   1.7 |
| STARTED Add internal object dumper resolution                               |         |       | 4:51 |   7.1 |
