...
#+CAPTION: Clock summary at [2017-01-03 Tue 23:43]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *16:08* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 16:08   |       |      | 100.0 |
| Active                                                                      |         | 16:08 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:30 |   3.1 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:57 |   5.9 |
| COMPLETED Consider supporting multiple inheritance on non-proxy models      |         |       | 3:24 |  21.1 |
| COMPLETED Add basic validation infrastructure                               |         |       | 8:40 |  53.7 |
| COMPLETED Fix borked windows build                                          |         |       | 0:26 |   2.7 |
| COMPLETED Clean up enumerator implementation                                |         |       | 1:05 |   6.7 |
| STARTED Measure validation slowdown                                         |         |       | 1:06 |   6.8 |
