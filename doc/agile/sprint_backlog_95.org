...
#+CAPTION: Clock summary at [2017-01-05 Thu 12:30]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 27:55   |       |      | 100.0 |
| Active                                                                      |         | 27:55 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:30 |   1.8 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:57 |   3.4 |
| COMPLETED Consider supporting multiple inheritance on non-proxy models      |         |       | 3:24 |  12.2 |
| COMPLETED Add basic validation infrastructure                               |         |       | 8:40 |  31.0 |
| COMPLETED Fix borked windows build                                          |         |       | 0:26 |   1.6 |
| COMPLETED Clean up enumerator implementation                                |         |       | 1:05 |   3.9 |
| COMPLETED Measure validation slowdown                                       |         |       | 6:38 |  23.8 |
| COMPLETED Parsing should support dot notation                               |         |       | 2:54 |  10.4 |
| STARTED Add container types to C# proxy models                              |         |       | 3:21 |  12.0 |
