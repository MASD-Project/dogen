...
#+CAPTION: Clock summary at [2017-01-12 Thu 11:01]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *64:26* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 64:26   |       |      | 100.0 |
| Active                                                                      |         | 64:26 |      | 100.0 |
...
| COMPLETED Add basic validation infrastructure                               |         |       | 8:40 |  13.5 |
| COMPLETED Fix borked windows build                                          |         |       | 0:26 |   0.7 |
| COMPLETED Clean up enumerator implementation                                |         |       | 1:05 |   1.7 |
| COMPLETED Measure validation slowdown                                       |         |       | 6:38 |  10.3 |
| COMPLETED Parsing should support dot notation                               |         |       | 2:54 |   4.5 |
| COMPLETED Analysis for changes required in order to support containers      |         |       | 3:15 |   5.0 |
| COMPLETED Add support for object based container types in C#                |         |       | 5:48 |   9.0 |
...
| COMPLETED Build dogen on windows locally                                    |         |       | 7:32 |  11.7 |
| COMPLETED Fix borked windows build                                          |         |       | 1:54 |   2.9 |
...
| STARTED Add upsilon support                                                 |         |       | 3:51 |   6.0 |
| STARTED Add auxiliary function properties to c#                             |         |       | 1:11 |   1.8 |
| STARTED Add internal object dumper resolution                               |         |       | 4:51 |   7.5 |
