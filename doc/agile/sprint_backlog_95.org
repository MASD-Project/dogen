...
#+CAPTION: Clock summary at [2016-12-28 Wed 20:23]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *5:51* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 5:51   |      |      | 100.0 |
| Active                                                                      |        | 5:51 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:21 |   6.0 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 0:57 |  16.2 |
| COMPLETED Consider supporting multiple inheritance on non-proxy models      |        |      | 3:24 |  58.1 |
| STARTED Create a validator in yarn                                          |        |      | 1:09 |  19.7 |
...
*** STARTED Create a validator in yarn                                :story:
...
- concepts must have at least one property (or method). Maybe just warn?
...
- type names, model names, etc must not contain spaces or other
  ...
  keywords by language. See [[http://en.cppreference.com/w/cpp/keyword][C++ keywords]]
