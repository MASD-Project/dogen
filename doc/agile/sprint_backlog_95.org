...
#+CAPTION: Clock summary at [2016-12-28 Wed 12:48]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
...
| Stories                                                                     | 0:46   |      |      | 100.0 |
| Active                                                                      |        | 0:46 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:21 |  45.7 |
| STARTED Edit release notes for previous sprint                              |        |      | 0:25 |  54.3 |
...
Overview
=======
The sprint's headline feature is the continued work on the C# kernel. It is still considered experimental.
...
- **improved ```Types``` facet support**: including exceptions and enumerations, immutability, complete constructors, improvements around equality, associations and inheritance with other model types, as well as support for modules (namespaces) and inheritance.
...
For more details see the [sprint log](https://github.com/DomainDrivenConsulting/dogen/blob/master/doc/agile/sprint_backlog_94.org).
