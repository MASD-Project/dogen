...
#+CAPTION: Clock summary at [2017-01-10 Tue 21:35]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *55:02* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 55:02   |       |      | 100.0 |
| Active                                                                      |         | 55:02 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:35 |   1.1 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:57 |   1.7 |
| COMPLETED Consider supporting multiple inheritance on non-proxy models      |         |       | 3:24 |   6.2 |
| COMPLETED Add basic validation infrastructure                               |         |       | 8:40 |  15.7 |
| COMPLETED Fix borked windows build                                          |         |       | 0:26 |   0.8 |
| COMPLETED Clean up enumerator implementation                                |         |       | 1:05 |   2.0 |
| COMPLETED Measure validation slowdown                                       |         |       | 6:38 |  12.1 |
| COMPLETED Parsing should support dot notation                               |         |       | 2:54 |   5.3 |
| COMPLETED Analysis for changes required in order to support containers      |         |       | 3:15 |   5.9 |
| COMPLETED Add support for object based container types in C#                |         |       | 5:48 |  10.5 |
| COMPLETED Understand the behaviour of helpers and assistants                |         |       | 1:13 |   2.2 |
| CANCELLED Add support for generic parents in yarn                           |         |       | 0:35 |   1.1 |
| COMPLETED Fix assorted windows warnings                                     |         |       | 0:19 |   0.6 |
| COMPLETED Build dogen on windows locally                                    |         |       | 7:32 |  13.7 |
| COMPLETED Fix borked windows build                                          |         |       | 0:39 |   1.2 |
| STARTED Generate windows packages with WIX                                  |         |       | 2:44 |   5.0 |
| STARTED Add appveyor support for bintray                                    |         |       | 1:00 |   1.8 |
| STARTED Add auxiliary function properties to c#                             |         |       | 1:11 |   2.2 |
| STARTED Add internal object dumper resolution                               |         |       | 4:51 |   8.8 |
| STARTED Add support for generic container types to C#                       |         |       | 1:16 |   2.3 |
...
*** STARTED Generate windows packages with WIX                        :story:
