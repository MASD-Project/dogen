...
#+CAPTION: Clock summary at [2017-01-07 Sat 11:57]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *37:22* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 37:22   |       |      | 100.0 |
| Active                                                                      |         | 37:22 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:30 |   1.3 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:57 |   2.5 |
| COMPLETED Consider supporting multiple inheritance on non-proxy models      |         |       | 3:24 |   9.1 |
| COMPLETED Add basic validation infrastructure                               |         |       | 8:40 |  23.2 |
| COMPLETED Fix borked windows build                                          |         |       | 0:26 |   1.2 |
| COMPLETED Clean up enumerator implementation                                |         |       | 1:05 |   2.9 |
| COMPLETED Measure validation slowdown                                       |         |       | 6:38 |  17.8 |
| COMPLETED Parsing should support dot notation                               |         |       | 2:54 |   7.8 |
| COMPLETED Add internal object dumper resolution                             |         |       | 4:51 |  13.0 |
| STARTED Add container types to C# proxy models                              |         |       | 7:57 |  21.3 |
