...
#+CAPTION: Clock summary at [2017-01-04 Wed 22:20]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| COMPLETED Consider supporting multiple inheritance on non-proxy models      |         |       | 3:24 |  13.6 |
| COMPLETED Add basic validation infrastructure                               |         |       | 8:40 |  34.7 |
| COMPLETED Fix borked windows build                                          |         |       | 0:26 |   1.7 |
| COMPLETED Clean up enumerator implementation                                |         |       | 1:05 |   4.3 |
| COMPLETED Measure validation slowdown                                       |         |       | 6:38 |  26.6 |
| COMPLETED Parsing should support dot notation                               |         |       | 2:33 |  10.2 |
| STARTED Add container types to C# proxy models                              |         |       | 0:46 |   3.1 |
