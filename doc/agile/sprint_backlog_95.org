...
#+CAPTION: Clock summary at [2017-01-12 Thu 12:28]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| COMPLETED Consider supporting multiple inheritance on non-proxy models      |         |       | 3:24 |   5.2 |
| COMPLETED Add basic validation infrastructure                               |         |       | 8:40 |  13.2 |
| COMPLETED Fix borked windows build                                          |         |       | 0:26 |   0.7 |
| COMPLETED Clean up enumerator implementation                                |         |       | 1:05 |   1.6 |
| COMPLETED Measure validation slowdown                                       |         |       | 6:38 |  10.1 |
| COMPLETED Parsing should support dot notation                               |         |       | 2:54 |   4.4 |
| COMPLETED Analysis for changes required in order to support containers      |         |       | 3:15 |   4.9 |
| COMPLETED Add support for object based container types in C#                |         |       | 5:48 |   8.8 |
...
| COMPLETED Build dogen on windows locally                                    |         |       | 7:32 |  11.4 |
| COMPLETED Fix borked windows build                                          |         |       | 1:54 |   2.9 |
| COMPLETED Generate windows packages with WIX                                |         |       | 3:28 |   5.3 |
| COMPLETED Add validation around instatitation of abstract classes           |         |       | 2:25 |   3.7 |
...
| STARTED Add upsilon support                                                 |         |       | 4:40 |   7.1 |
| STARTED Add auxiliary function properties to c#                             |         |       | 1:11 |   1.8 |
| STARTED Add internal object dumper resolution                               |         |       | 4:51 |   7.4 |
