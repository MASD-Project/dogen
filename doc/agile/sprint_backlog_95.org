...
#+CAPTION: Clock summary at [2017-01-06 Fri 17:36]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *34:34* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 34:34   |       |      | 100.0 |
| Active                                                                      |         | 34:34 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:30 |   1.4 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:57 |   2.7 |
| COMPLETED Consider supporting multiple inheritance on non-proxy models      |         |       | 3:24 |   9.8 |
| COMPLETED Add basic validation infrastructure                               |         |       | 8:40 |  25.1 |
| COMPLETED Fix borked windows build                                          |         |       | 0:26 |   1.3 |
| COMPLETED Clean up enumerator implementation                                |         |       | 1:05 |   3.1 |
| COMPLETED Measure validation slowdown                                       |         |       | 6:38 |  19.2 |
| COMPLETED Parsing should support dot notation                               |         |       | 2:54 |   8.4 |
| COMPLETED Add internal object dumper resolution                             |         |       | 4:51 |  14.0 |
| STARTED Add container types to C# proxy models                              |         |       | 5:09 |  14.9 |
