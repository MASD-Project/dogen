...
#+CAPTION: Clock summary at [2017-01-12 Thu 22:00]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *69:32* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 69:32   |       |      | 100.0 |
| Active                                                                      |         | 69:32 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:35 |   0.8 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:57 |   1.4 |
| COMPLETED Consider supporting multiple inheritance on non-proxy models      |         |       | 3:24 |   4.9 |
| COMPLETED Add basic validation infrastructure                               |         |       | 8:40 |  12.5 |
| COMPLETED Fix borked windows build                                          |         |       | 0:26 |   0.6 |
| COMPLETED Clean up enumerator implementation                                |         |       | 1:05 |   1.6 |
| COMPLETED Measure validation slowdown                                       |         |       | 6:38 |   9.5 |
| COMPLETED Parsing should support dot notation                               |         |       | 2:54 |   4.2 |
| COMPLETED Analysis for changes required in order to support containers      |         |       | 3:15 |   4.7 |
| COMPLETED Add support for object based container types in C#                |         |       | 5:48 |   8.3 |
| COMPLETED Understand the behaviour of helpers and assistants                |         |       | 1:13 |   1.7 |
| CANCELLED Add support for generic parents in yarn                           |         |       | 0:35 |   0.8 |
| COMPLETED Fix assorted windows warnings                                     |         |       | 0:19 |   0.5 |
| COMPLETED Build dogen on windows locally                                    |         |       | 7:32 |  10.8 |
| COMPLETED Fix borked windows build                                          |         |       | 1:54 |   2.7 |
| COMPLETED Generate windows packages with WIX                                |         |       | 3:28 |   5.0 |
| COMPLETED Add validation around instatitation of abstract classes           |         |       | 2:25 |   3.5 |
| COMPLETED Add validation to ensure enumerators do not have types            |         |       | 0:21 |   0.5 |
| COMPLETED Add appveyor support for bintray                                  |         |       | 2:23 |   3.4 |
| STARTED Add upsilon support                                                 |         |       | 8:22 |  12.0 |
| STARTED Add auxiliary function properties to c#                             |         |       | 1:11 |   1.7 |
| STARTED Add internal object dumper resolution                               |         |       | 4:51 |   7.0 |
| STARTED Add support for generic container types to C#                       |         |       | 1:16 |   1.8 |
