...
#+CAPTION: Clock summary at [2017-01-11 Wed 22:28]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| COMPLETED Add basic validation infrastructure                               |         |       | 8:40 |  14.1 |
| COMPLETED Fix borked windows build                                          |         |       | 0:26 |   0.7 |
| COMPLETED Clean up enumerator implementation                                |         |       | 1:05 |   1.8 |
| COMPLETED Measure validation slowdown                                       |         |       | 6:38 |  10.8 |
| COMPLETED Parsing should support dot notation                               |         |       | 2:54 |   4.7 |
| COMPLETED Analysis for changes required in order to support containers      |         |       | 3:15 |   5.3 |
| COMPLETED Add support for object based container types in C#                |         |       | 5:48 |   9.4 |
...
| COMPLETED Build dogen on windows locally                                    |         |       | 7:32 |  12.2 |
...
| STARTED Add internal object dumper resolution                               |         |       | 4:51 |   7.9 |
| STARTED Add support for generic container types to C#                       |         |       | 1:16 |   2.1 |
