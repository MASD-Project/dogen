...
#+CAPTION: Clock summary at [2017-01-04 Wed 11:48]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *18:54* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 18:54   |       |      | 100.0 |
| Active                                                                      |         | 18:54 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:30 |   2.6 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:57 |   5.0 |
| COMPLETED Consider supporting multiple inheritance on non-proxy models      |         |       | 3:24 |  18.0 |
| COMPLETED Add basic validation infrastructure                               |         |       | 8:40 |  45.9 |
| COMPLETED Fix borked windows build                                          |         |       | 0:26 |   2.3 |
| COMPLETED Clean up enumerator implementation                                |         |       | 1:05 |   5.7 |
| STARTED Measure validation slowdown                                         |         |       | 3:52 |  20.5 |
