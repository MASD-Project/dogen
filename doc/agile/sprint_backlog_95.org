...
#+CAPTION: Clock summary at [2017-01-06 Fri 17:51]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| COMPLETED Add basic validation infrastructure                               |         |       | 8:40 |  24.9 |
| COMPLETED Fix borked windows build                                          |         |       | 0:26 |   1.2 |
| COMPLETED Clean up enumerator implementation                                |         |       | 1:05 |   3.1 |
| COMPLETED Measure validation slowdown                                       |         |       | 6:38 |  19.1 |
| COMPLETED Parsing should support dot notation                               |         |       | 2:54 |   8.3 |
| COMPLETED Add internal object dumper resolution                             |         |       | 4:51 |  13.9 |
| STARTED Add container types to C# proxy models                              |         |       | 5:23 |  15.5 |
