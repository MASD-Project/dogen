...
#+CAPTION: Clock summary at [2017-01-03 Tue 22:28]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *14:54* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 14:54   |       |      | 100.0 |
| Active                                                                      |         | 14:54 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:30 |   3.4 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:57 |   6.4 |
| COMPLETED Consider supporting multiple inheritance on non-proxy models      |         |       | 3:24 |  22.8 |
| COMPLETED Add basic validation infrastructure                               |         |       | 8:40 |  58.2 |
| COMPLETED Fix borked windows build                                          |         |       | 0:26 |   2.9 |
| STARTED Clean up enumerator implementation                                  |         |       | 0:57 |   6.4 |
...
*** Measure validation slowdown                                       :story:
