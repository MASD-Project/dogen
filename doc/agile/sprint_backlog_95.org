...
#+CAPTION: Clock summary at [2017-01-04 Wed 22:43]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:57 |   3.8 |
| COMPLETED Consider supporting multiple inheritance on non-proxy models      |         |       | 3:24 |  13.4 |
| COMPLETED Add basic validation infrastructure                               |         |       | 8:40 |  34.2 |
| COMPLETED Fix borked windows build                                          |         |       | 0:26 |   1.7 |
| COMPLETED Clean up enumerator implementation                                |         |       | 1:05 |   4.3 |
| COMPLETED Measure validation slowdown                                       |         |       | 6:38 |  26.2 |
| COMPLETED Parsing should support dot notation                               |         |       | 2:54 |  11.4 |
| STARTED Add container types to C# proxy models                              |         |       | 0:46 |   3.0 |
