...
#+CAPTION: Clock summary at [2017-01-14 Sat 16:53]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *78:28* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 78:28   |       |       | 100.0 |
| Active                                                                      |         | 78:28 |       | 100.0 |
...
| COMPLETED Add basic validation infrastructure                               |         |       |  8:40 |  11.0 |
| COMPLETED Fix borked windows build                                          |         |       |  0:26 |   0.6 |
| COMPLETED Clean up enumerator implementation                                |         |       |  1:05 |   1.4 |
| COMPLETED Measure validation slowdown                                       |         |       |  6:38 |   8.5 |
| COMPLETED Parsing should support dot notation                               |         |       |  2:54 |   3.7 |
| COMPLETED Analysis for changes required in order to support containers      |         |       |  3:15 |   4.1 |
| COMPLETED Add support for object based container types in C#                |         |       |  5:48 |   7.4 |
...
| COMPLETED Build dogen on windows locally                                    |         |       |  7:32 |   9.6 |
| COMPLETED Fix borked windows build                                          |         |       |  1:54 |   2.4 |
| COMPLETED Generate windows packages with WIX                                |         |       |  3:28 |   4.4 |
| COMPLETED Add validation around instatitation of abstract classes           |         |       |  2:25 |   3.1 |
...
| COMPLETED Add read support for upsilon models                               |         |       | 13:26 |  17.1 |
| STARTED Create an upsilon yarn frontend                                     |         |       |  3:52 |   4.9 |
| STARTED Add auxiliary function properties to c#                             |         |       |  1:11 |   1.5 |
| STARTED Add internal object dumper resolution                               |         |       |  4:51 |   6.2 |
