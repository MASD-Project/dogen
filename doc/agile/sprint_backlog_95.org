...
#+CAPTION: Clock summary at [2017-01-11 Wed 20:24]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| COMPLETED Consider supporting multiple inheritance on non-proxy models      |         |       | 3:24 |   5.7 |
| COMPLETED Add basic validation infrastructure                               |         |       | 8:40 |  14.4 |
| COMPLETED Fix borked windows build                                          |         |       | 0:26 |   0.7 |
| COMPLETED Clean up enumerator implementation                                |         |       | 1:05 |   1.8 |
| COMPLETED Measure validation slowdown                                       |         |       | 6:38 |  11.0 |
| COMPLETED Parsing should support dot notation                               |         |       | 2:54 |   4.8 |
| COMPLETED Analysis for changes required in order to support containers      |         |       | 3:15 |   5.4 |
| COMPLETED Add support for object based container types in C#                |         |       | 5:48 |   9.6 |
...
*** STARTED Add validation around instatitation of abstract classes   :story:
