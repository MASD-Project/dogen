...
#+CAPTION: Clock summary at [2017-01-11 Wed 21:17]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *60:57* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 60:57   |       |      | 100.0 |
| Active                                                                      |         | 60:57 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:35 |   1.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:57 |   1.6 |
| COMPLETED Consider supporting multiple inheritance on non-proxy models      |         |       | 3:24 |   5.6 |
| COMPLETED Add basic validation infrastructure                               |         |       | 8:40 |  14.2 |
| COMPLETED Fix borked windows build                                          |         |       | 0:26 |   0.7 |
| COMPLETED Clean up enumerator implementation                                |         |       | 1:05 |   1.8 |
| COMPLETED Measure validation slowdown                                       |         |       | 6:38 |  10.9 |
| COMPLETED Parsing should support dot notation                               |         |       | 2:54 |   4.8 |
| COMPLETED Analysis for changes required in order to support containers      |         |       | 3:15 |   5.3 |
| COMPLETED Add support for object based container types in C#                |         |       | 5:48 |   9.5 |
...
| COMPLETED Build dogen on windows locally                                    |         |       | 7:32 |  12.4 |
| COMPLETED Fix borked windows build                                          |         |       | 1:54 |   3.1 |
| COMPLETED Generate windows packages with WIX                                |         |       | 3:28 |   5.7 |
| COMPLETED Add validation around instatitation of abstract classes           |         |       | 1:48 |   3.0 |
| STARTED Add appveyor support for bintray                                    |         |       | 1:00 |   1.6 |
| STARTED Add auxiliary function properties to c#                             |         |       | 1:11 |   1.9 |
| STARTED Add internal object dumper resolution                               |         |       | 4:51 |   8.0 |
| STARTED Add support for generic container types to C#                       |         |       | 1:16 |   2.1 |
| STARTED Add upsilon support                                                 |         |       | 2:08 |   3.5 |
