...
#+CAPTION: Clock summary at [2017-01-08 Sun 11:40]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:57 |   2.2 |
| COMPLETED Consider supporting multiple inheritance on non-proxy models      |         |       | 3:24 |   7.9 |
| COMPLETED Add basic validation infrastructure                               |         |       | 8:40 |  20.2 |
| COMPLETED Fix borked windows build                                          |         |       | 0:26 |   1.0 |
| COMPLETED Clean up enumerator implementation                                |         |       | 1:05 |   2.5 |
| COMPLETED Measure validation slowdown                                       |         |       | 6:38 |  15.5 |
| COMPLETED Parsing should support dot notation                               |         |       | 2:54 |   6.8 |
| COMPLETED Analysis for changes required in order to support containers      |         |       | 3:15 |   7.6 |
| COMPLETED Add support for object based container types in C#                |         |       | 5:48 |  13.6 |
| COMPLETED Understand the behaviour of helpers and assistants                |         |       | 1:13 |   2.8 |
| CANCELLED Add support for generic parents in yarn                           |         |       | 0:35 |   1.4 |
| STARTED Add auxiliary function properties to c#                             |         |       | 1:11 |   2.8 |
| STARTED Add internal object dumper resolution                               |         |       | 4:51 |  11.3 |
| STARTED Add support for generic container types to C#                       |         |       | 1:16 |   3.0 |
