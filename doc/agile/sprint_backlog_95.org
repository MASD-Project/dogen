...
#+CAPTION: Clock summary at [2017-01-12 Thu 23:28]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *70:59* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 70:59   |       |      | 100.0 |
| Active                                                                      |         | 70:59 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:35 |   0.8 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:57 |   1.3 |
| COMPLETED Consider supporting multiple inheritance on non-proxy models      |         |       | 3:24 |   4.8 |
| COMPLETED Add basic validation infrastructure                               |         |       | 8:40 |  12.2 |
| COMPLETED Fix borked windows build                                          |         |       | 0:26 |   0.6 |
| COMPLETED Clean up enumerator implementation                                |         |       | 1:05 |   1.5 |
| COMPLETED Measure validation slowdown                                       |         |       | 6:38 |   9.3 |
| COMPLETED Parsing should support dot notation                               |         |       | 2:54 |   4.1 |
| COMPLETED Analysis for changes required in order to support containers      |         |       | 3:15 |   4.6 |
| COMPLETED Add support for object based container types in C#                |         |       | 5:48 |   8.2 |
...
| COMPLETED Build dogen on windows locally                                    |         |       | 7:32 |  10.6 |
| COMPLETED Fix borked windows build                                          |         |       | 1:54 |   2.7 |
| COMPLETED Generate windows packages with WIX                                |         |       | 3:28 |   4.9 |
| COMPLETED Add validation around instatitation of abstract classes           |         |       | 2:25 |   3.4 |
...
| STARTED Add upsilon support                                                 |         |       | 9:49 |  13.8 |
| STARTED Add auxiliary function properties to c#                             |         |       | 1:11 |   1.7 |
| STARTED Add internal object dumper resolution                               |         |       | 4:51 |   6.8 |
