...
#+CAPTION: Clock summary at [2017-01-03 Tue 17:11]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 12:48   |       |      | 100.0 |
| Active                                                                      |         | 12:48 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:30 |   3.9 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:57 |   7.4 |
| COMPLETED Consider supporting multiple inheritance on non-proxy models      |         |       | 3:24 |  26.6 |
| STARTED Add basic validation infrastructure                                 |         |       | 7:57 |  62.1 |
...
*** STARTED Add basic validation infrastructure                       :story:
