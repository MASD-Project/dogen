...
#+CAPTION: Clock summary at [2017-01-07 Sat 12:57]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *37:49* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 37:49   |       |      | 100.0 |
| Active                                                                      |         | 37:49 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:30 |   1.3 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:57 |   2.5 |
| COMPLETED Consider supporting multiple inheritance on non-proxy models      |         |       | 3:24 |   9.0 |
| COMPLETED Add basic validation infrastructure                               |         |       | 8:40 |  22.9 |
| COMPLETED Fix borked windows build                                          |         |       | 0:26 |   1.1 |
| COMPLETED Clean up enumerator implementation                                |         |       | 1:05 |   2.9 |
| COMPLETED Measure validation slowdown                                       |         |       | 6:38 |  17.5 |
| COMPLETED Parsing should support dot notation                               |         |       | 2:54 |   7.7 |
| COMPLETED Add internal object dumper resolution                             |         |       | 4:51 |  12.8 |
| STARTED Add container types to C# proxy models                              |         |       | 8:24 |  22.2 |
