...
#+CAPTION: Clock summary at [2017-01-15 Sun 12:01]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *82:20* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 82:20   |       |       | 100.0 |
| Active                                                                      |         | 82:20 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:35 |   0.7 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:57 |   1.2 |
| COMPLETED Consider supporting multiple inheritance on non-proxy models      |         |       |  3:24 |   4.1 |
| COMPLETED Add basic validation infrastructure                               |         |       |  8:40 |  10.5 |
| COMPLETED Fix borked windows build                                          |         |       |  0:26 |   0.5 |
| COMPLETED Clean up enumerator implementation                                |         |       |  1:05 |   1.3 |
| COMPLETED Measure validation slowdown                                       |         |       |  6:38 |   8.1 |
| COMPLETED Parsing should support dot notation                               |         |       |  2:54 |   3.5 |
| COMPLETED Analysis for changes required in order to support containers      |         |       |  3:15 |   3.9 |
| COMPLETED Add support for object based container types in C#                |         |       |  5:48 |   7.0 |
...
| COMPLETED Build dogen on windows locally                                    |         |       |  7:32 |   9.1 |
| COMPLETED Fix borked windows build                                          |         |       |  1:54 |   2.3 |
| COMPLETED Generate windows packages with WIX                                |         |       |  3:28 |   4.2 |
| COMPLETED Add validation around instatitation of abstract classes           |         |       |  2:25 |   2.9 |
| COMPLETED Add validation to ensure enumerators do not have types            |         |       |  0:21 |   0.4 |
| COMPLETED Add appveyor support for bintray                                  |         |       |  2:23 |   2.9 |
| COMPLETED Add read support for upsilon models                               |         |       | 13:26 |  16.3 |
| STARTED Create an upsilon yarn frontend                                     |         |       |  7:44 |   9.4 |
| STARTED Add auxiliary function properties to c#                             |         |       |  1:11 |   1.4 |
| STARTED Add internal object dumper resolution                               |         |       |  4:51 |   5.9 |
| STARTED Add support for generic container types to C#                       |         |       |  1:16 |   1.5 |
...
*** STARTED Create an upsilon yarn frontend                           :story:
    CLOCK: [2017-01-15 Sun 11:36]--[2017-01-15 Sun 12:01] =>  0:25
