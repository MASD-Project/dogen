...
Clock summary at [2014-08-22 Fri 13:40]
...
| IMPLEMENTATION Tidy-up test model folder structure   |        |      | 0:50 |
#+end:
...
*** IMPLEMENTATION Tidy-up test model folder structure                :story:
...
**** IMPLEMENTATION Create =test_models= folder and move all test code to it :task:
     CLOCK: [2014-08-22 Fri 12:53]--[2014-08-22 Fri 13:05] =>  0:12

Create the folder and move code manually.

**** Fix code generation to generate on new folder                     :task:
