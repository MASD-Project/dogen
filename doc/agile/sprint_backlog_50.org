...
Clock summary at [2014-08-22 Fri 20:20]

| Headline                                             | Time   |      |      |
|------------------------------------------------------+--------+------+------|
| *Total time*                                         | *6:48* |      |      |
|------------------------------------------------------+--------+------+------|
| Development Stories Implemented                      |        | 6:48 |      |
| IMPLEMENTATION Sprint and product backlog grooming   |        |      | 0:39 |
| COMPLETED Update instructions in manual for Postgres |        |      | 0:50 |
| IMPLEMENTATION Tidy-up test model folder structure   |        |      | 5:19 |
#+end:
