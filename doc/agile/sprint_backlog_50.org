...
Clock summary at [2014-09-05 Fri 23:54]

| Headline                                                | Time    |       |      |
|---------------------------------------------------------+---------+-------+------|
| *Total time*                                            | *22:07* |       |      |
|---------------------------------------------------------+---------+-------+------|
| Development Stories Implemented                         |         | 22:07 |      |
...
| IMPLEMENTATION Make model a simple repository           |         |       | 1:15 |
#+end:
...
**** IMPLEMENTATION Check to see if we are generating a module for the model :story:
...
**** Remove properties from model and deal with fallout               :story:
