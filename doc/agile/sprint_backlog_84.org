...
#+CAPTION: Clock summary at [2016-07-15 Fri 20:38]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *29:06* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 29:06   |       |      | 100.0 |
| Active                                                                      |         | 29:06 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 2:26 |   8.4 |
| STARTED Manual updates and blog posts                                       |         |       | 1:21 |   4.6 |
| COMPLETED Try to fix tag build issues                                       |         |       | 1:28 |   5.0 |
| COMPLETED Enable =BUILD_TYPE= on travis                                     |         |       | 1:17 |   4.4 |
| COMPLETED Add initial support for coveralls                                 |         |       | 0:29 |   1.7 |
| COMPLETED Simplify local builds on emacs                                    |         |       | 0:20 |   1.1 |
| COMPLETED Create a debug build for clang in travis                          |         |       | 0:10 |   0.6 |
| COMPLETED Rename element settings back to aspect settings                   |         |       | 0:50 |   2.9 |
| COMPLETED Rename bundle to element settings                                 |         |       | 0:27 |   1.5 |
| COMPLETED Rename bundle in stitch to properties                             |         |       | 0:16 |   0.9 |
| COMPLETED Refactor general settings                                         |         |       | 5:50 |  20.0 |
| COMPLETED Rename specs to tests                                             |         |       | 1:24 |   4.8 |
| COMPLETED Create a IO settings class                                        |         |       | 1:15 |   4.3 |
| COMPLETED Implement streaming for type in terms of IO settings              |         |       | 1:24 |   4.8 |
...
| COMPLETED Refactor formatter interfaces                                     |         |       | 0:36 |   2.1 |
...
| COMPLETED Add formatter id to file and helper formatters                    |         |       | 1:20 |   4.6 |
| COMPLETED Add IO to formatter container                                     |         |       | 1:19 |   4.5 |
| COMPLETED Includers formatter id is incorrect                               |         |       | 0:07 |   0.4 |
| COMPLETED Enable IO helpers for types                                       |         |       | 5:51 |  20.1 |
