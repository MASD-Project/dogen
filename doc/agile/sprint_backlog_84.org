...
#+CAPTION: Clock summary at [2016-07-14 Thu 23:16]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *28:05* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 28:05   |       |      | 100.0 |
| Active                                                                      |         | 28:05 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 2:26 |   8.7 |
| STARTED Manual updates and blog posts                                       |         |       | 1:21 |   4.8 |
| COMPLETED Try to fix tag build issues                                       |         |       | 1:28 |   5.2 |
...
| COMPLETED Refactor general settings                                         |         |       | 5:50 |  20.8 |
| COMPLETED Rename specs to tests                                             |         |       | 1:24 |   5.0 |
| COMPLETED Create a IO settings class                                        |         |       | 1:15 |   4.5 |
| COMPLETED Implement streaming for type in terms of IO settings              |         |       | 1:24 |   5.0 |
...
| COMPLETED Add formatter id to file and helper formatters                    |         |       | 1:20 |   4.7 |
| COMPLETED Add IO to formatter container                                     |         |       | 1:19 |   4.7 |
| STARTED Enable IO helpers for types                                         |         |       | 4:57 |  17.6 |
