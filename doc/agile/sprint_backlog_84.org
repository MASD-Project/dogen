...
#+CAPTION: Clock summary at [2016-07-14 Thu 21:50]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *26:42* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 26:42   |       |      | 100.0 |
| Active                                                                      |         | 26:42 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 2:26 |   9.1 |
| STARTED Manual updates and blog posts                                       |         |       | 1:21 |   5.1 |
| COMPLETED Try to fix tag build issues                                       |         |       | 1:28 |   5.5 |
| COMPLETED Enable =BUILD_TYPE= on travis                                     |         |       | 1:17 |   4.8 |
...
| COMPLETED Rename element settings back to aspect settings                   |         |       | 0:50 |   3.1 |
| COMPLETED Rename bundle to element settings                                 |         |       | 0:27 |   1.7 |
| COMPLETED Rename bundle in stitch to properties                             |         |       | 0:16 |   1.0 |
| COMPLETED Refactor general settings                                         |         |       | 5:50 |  21.8 |
| COMPLETED Rename specs to tests                                             |         |       | 1:24 |   5.2 |
| COMPLETED Create a IO settings class                                        |         |       | 1:15 |   4.7 |
| COMPLETED Implement streaming for type in terms of IO settings              |         |       | 1:24 |   5.2 |
...
| COMPLETED Add a pretty printer for ownership hierarchy                      |         |       | 0:13 |   0.8 |
| STARTED Add formatter id to file and helper formatter                       |         |       | 0:44 |   2.7 |
| STARTED Add IO to formatter container                                       |         |       | 0:35 |   2.2 |
| STARTED Enable IO helpers for types                                         |         |       | 4:54 |  18.4 |
...
*** COMPLETED Add a pretty printer for ownership hierarchy            :story:
...
*** STARTED Add formatter id to file and helper formatter             :story:
