...
#+CAPTION: Clock summary at [2016-07-06 Wed 18:35]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
...
| Stories                                                                     | 8:23   |      |      | 100.0 |
| Active                                                                      |        | 8:23 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:55 |  10.9 |
| STARTED Manual updates and blog posts                                       |        |      | 0:37 |   7.4 |
| COMPLETED Try to fix tag build issues                                       |        |      | 1:28 |  17.5 |
| COMPLETED Enable build type on travis                                       |        |      | 1:17 |  15.3 |
| COMPLETED Add initial support for coveralls                                 |        |      | 0:29 |   5.8 |
| COMPLETED Simplify local builds on emacs                                    |        |      | 0:20 |   4.0 |
| STARTED Create a debug build for clang in travis                            |        |      | 0:10 |   2.0 |
| STARTED Refactor general settings                                           |        |      | 3:07 |  37.2 |
