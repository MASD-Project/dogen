...
#+CAPTION: Clock summary at [2016-07-17 Sun 01:32]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *32:19* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 32:19   |       |      | 100.0 |
| Active                                                                      |         | 32:19 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 2:26 |   7.5 |
| STARTED Manual updates and blog posts                                       |         |       | 1:21 |   4.2 |
| COMPLETED Try to fix tag build issues                                       |         |       | 1:28 |   4.5 |
| COMPLETED Enable =BUILD_TYPE= on travis                                     |         |       | 1:17 |   4.0 |
...
| COMPLETED Refactor general settings                                         |         |       | 5:50 |  18.1 |
| COMPLETED Rename specs to tests                                             |         |       | 1:24 |   4.3 |
| COMPLETED Create a IO settings class                                        |         |       | 1:15 |   3.9 |
...
| COMPLETED Add IO to formatter container                                     |         |       | 1:19 |   4.1 |
| COMPLETED Includers formatter id is incorrect                               |         |       | 0:07 |   0.4 |
| COMPLETED Enable IO helpers for types                                       |         |       | 5:51 |  18.1 |
...
| COMPLETED Fix Windows debug errors in linking                               |         |       | 0:31 |   1.6 |
...
*** COMPLETED Fix Windows debug errors in linking                     :story:
