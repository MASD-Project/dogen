...
#+CAPTION: Clock summary at [2016-07-12 Tue 22:22]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 20:50   |       |      | 100.0 |
| Active                                                                      |         | 20:50 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 2:26 |  11.7 |
| STARTED Manual updates and blog posts                                       |         |       | 1:21 |   6.5 |
| COMPLETED Try to fix tag build issues                                       |         |       | 1:28 |   7.0 |
| COMPLETED Enable =BUILD_TYPE= on travis                                     |         |       | 1:17 |   6.2 |
| COMPLETED Add initial support for coveralls                                 |         |       | 0:29 |   2.3 |
| COMPLETED Simplify local builds on emacs                                    |         |       | 0:20 |   1.6 |
| COMPLETED Create a debug build for clang in travis                          |         |       | 0:10 |   0.8 |
| COMPLETED Rename element settings back to aspect settings                   |         |       | 0:50 |   4.0 |
| COMPLETED Rename bundle to element settings                                 |         |       | 0:27 |   2.2 |
| COMPLETED Rename bundle in stitch to properties                             |         |       | 0:16 |   1.3 |
| COMPLETED Refactor general settings                                         |         |       | 5:50 |  28.0 |
| COMPLETED Rename specs to tests                                             |         |       | 1:24 |   6.7 |
| COMPLETED Create a IO settings class                                        |         |       | 1:15 |   6.0 |
| COMPLETED Implement streaming for type in terms of IO settings              |         |       | 1:24 |   6.7 |
| STARTED Enable IO helpers for types                                         |         |       | 1:38 |   7.8 |
