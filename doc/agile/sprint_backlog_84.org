...
#+CAPTION: Clock summary at [2016-07-06 Wed 19:51]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *9:40* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 9:40   |      |      | 100.0 |
| Active                                                                      |        | 9:40 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:55 |   9.5 |
| STARTED Manual updates and blog posts                                       |        |      | 0:37 |   6.4 |
| COMPLETED Try to fix tag build issues                                       |        |      | 1:28 |  15.2 |
| COMPLETED Enable build type on travis                                       |        |      | 1:17 |  13.3 |
| COMPLETED Add initial support for coveralls                                 |        |      | 0:29 |   5.0 |
| COMPLETED Simplify local builds on emacs                                    |        |      | 0:20 |   3.4 |
| COMPLETED Create a debug build for clang in travis                          |        |      | 0:10 |   1.7 |
| COMPLETED Rename element settings back to aspect settings                   |        |      | 0:50 |   8.6 |
| COMPLETED Rename bundle to element settings                                 |        |      | 0:27 |   4.7 |
| STARTED Refactor general settings                                           |        |      | 3:07 |  32.2 |
