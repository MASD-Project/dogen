...
#+CAPTION: Clock summary at [2016-07-09 Sat 18:52]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *14:31* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 14:31   |       |      | 100.0 |
| Active                                                                      |         | 14:31 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:55 |   6.3 |
| STARTED Manual updates and blog posts                                       |         |       | 0:37 |   4.2 |
| COMPLETED Try to fix tag build issues                                       |         |       | 1:28 |  10.1 |
| COMPLETED Enable =BUILD_TYPE= on travis                                     |         |       | 1:17 |   8.8 |
| COMPLETED Add initial support for coveralls                                 |         |       | 0:29 |   3.3 |
| COMPLETED Simplify local builds on emacs                                    |         |       | 0:20 |   2.3 |
| COMPLETED Create a debug build for clang in travis                          |         |       | 0:10 |   1.1 |
| COMPLETED Rename element settings back to aspect settings                   |         |       | 0:50 |   5.7 |
| COMPLETED Rename bundle to element settings                                 |         |       | 0:27 |   3.1 |
| COMPLETED Rename bundle in stitch to properties                             |         |       | 0:16 |   1.8 |
| COMPLETED Refactor general settings                                         |         |       | 5:50 |  40.2 |
| COMPLETED Rename specs to tests                                             |         |       | 1:24 |   9.6 |
| STARTED Create a IO settings class                                          |         |       | 0:28 |   3.2 |
