...
#+CAPTION: Clock summary at [2016-07-17 Sun 08:53]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *32:59* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 32:59   |       |      | 100.0 |
| Active                                                                      |         | 32:59 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 2:26 |   7.4 |
| STARTED Manual updates and blog posts                                       |         |       | 1:21 |   4.1 |
| COMPLETED Try to fix tag build issues                                       |         |       | 1:28 |   4.4 |
| COMPLETED Enable =BUILD_TYPE= on travis                                     |         |       | 1:17 |   3.9 |
| COMPLETED Add initial support for coveralls                                 |         |       | 0:29 |   1.5 |
...
| COMPLETED Rename bundle to element settings                                 |         |       | 0:27 |   1.4 |
| COMPLETED Rename bundle in stitch to properties                             |         |       | 0:16 |   0.8 |
| COMPLETED Refactor general settings                                         |         |       | 5:50 |  17.7 |
| COMPLETED Rename specs to tests                                             |         |       | 1:24 |   4.2 |
| COMPLETED Create a IO settings class                                        |         |       | 1:15 |   3.8 |
...
| COMPLETED Add IO to formatter container                                     |         |       | 1:19 |   4.0 |
| COMPLETED Includers formatter id is incorrect                               |         |       | 0:07 |   0.4 |
| COMPLETED Enable IO helpers for types                                       |         |       | 5:51 |  17.7 |
| COMPLETED Implement IO helper methods with new helper infrastructure        |         |       | 1:03 |   3.2 |
...
| COMPLETED Windows build fails to find tests                                 |         |       | 0:23 |   1.2 |
