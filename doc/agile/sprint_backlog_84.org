...
#+CAPTION: Clock summary at [2016-07-13 Wed 23:19]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *24:59* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 24:59   |       |      | 100.0 |
| Active                                                                      |         | 24:59 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 2:26 |   9.7 |
| STARTED Manual updates and blog posts                                       |         |       | 1:21 |   5.4 |
| COMPLETED Try to fix tag build issues                                       |         |       | 1:28 |   5.9 |
| COMPLETED Enable =BUILD_TYPE= on travis                                     |         |       | 1:17 |   5.1 |
| COMPLETED Add initial support for coveralls                                 |         |       | 0:29 |   1.9 |
| COMPLETED Simplify local builds on emacs                                    |         |       | 0:20 |   1.3 |
| COMPLETED Create a debug build for clang in travis                          |         |       | 0:10 |   0.7 |
| COMPLETED Rename element settings back to aspect settings                   |         |       | 0:50 |   3.3 |
| COMPLETED Rename bundle to element settings                                 |         |       | 0:27 |   1.8 |
| COMPLETED Rename bundle in stitch to properties                             |         |       | 0:16 |   1.1 |
| COMPLETED Refactor general settings                                         |         |       | 5:50 |  23.3 |
| COMPLETED Rename specs to tests                                             |         |       | 1:24 |   5.6 |
| COMPLETED Create a IO settings class                                        |         |       | 1:15 |   5.0 |
| COMPLETED Implement streaming for type in terms of IO settings              |         |       | 1:24 |   5.6 |
| COMPLETED Usage of rev-list in version causes problems                      |         |       | 0:03 |   0.2 |
| CANCELLED Consider not running initialisers in a static context             |         |       | 0:10 |   0.7 |
| COMPLETED Refactor formatter interfaces                                     |         |       | 0:36 |   2.4 |
| STARTED Move formatter helpers into formatter container                     |         |       | 0:04 |   0.3 |
| STARTED Enable IO helpers for types                                         |         |       | 4:54 |  19.6 |
| STARTED Implement IO helper methods with new helper infrastructure          |         |       | 0:15 |   1.0 |
...
*** STARTED Move formatter helpers into formatter container           :story:
...
*** Add IO to formatter container                                     :story:
