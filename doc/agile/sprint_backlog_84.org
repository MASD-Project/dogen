...
#+CAPTION: Clock summary at [2016-07-11 Mon 21:21]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *15:38* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 15:38   |       |      | 100.0 |
| Active                                                                      |         | 15:38 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:55 |   5.9 |
| STARTED Manual updates and blog posts                                       |         |       | 1:21 |   8.6 |
| COMPLETED Try to fix tag build issues                                       |         |       | 1:28 |   9.4 |
| COMPLETED Enable =BUILD_TYPE= on travis                                     |         |       | 1:17 |   8.2 |
| COMPLETED Add initial support for coveralls                                 |         |       | 0:29 |   3.1 |
| COMPLETED Simplify local builds on emacs                                    |         |       | 0:20 |   2.1 |
| COMPLETED Create a debug build for clang in travis                          |         |       | 0:10 |   1.1 |
| COMPLETED Rename element settings back to aspect settings                   |         |       | 0:50 |   5.3 |
| COMPLETED Rename bundle to element settings                                 |         |       | 0:27 |   2.9 |
| COMPLETED Rename bundle in stitch to properties                             |         |       | 0:16 |   1.7 |
| COMPLETED Refactor general settings                                         |         |       | 5:50 |  37.3 |
| COMPLETED Rename specs to tests                                             |         |       | 1:24 |   9.0 |
| STARTED Create a IO settings class                                          |         |       | 0:51 |   5.4 |
