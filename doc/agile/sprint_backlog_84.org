...
#+CAPTION: Clock summary at [2016-07-17 Sun 19:30]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *35:35* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 35:35   |       |      | 100.0 |
| Active                                                                      |         | 35:35 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 2:36 |   7.3 |
| STARTED Manual updates and blog posts                                       |         |       | 1:21 |   3.8 |
| COMPLETED Try to fix tag build issues                                       |         |       | 1:28 |   4.1 |
...
| COMPLETED Refactor general settings                                         |         |       | 5:50 |  16.4 |
| COMPLETED Rename specs to tests                                             |         |       | 1:24 |   3.9 |
| COMPLETED Create a IO settings class                                        |         |       | 1:15 |   3.5 |
| COMPLETED Implement streaming for type in terms of IO settings              |         |       | 1:24 |   3.9 |
...
| COMPLETED Enable IO helpers for types                                       |         |       | 5:51 |  16.4 |
...
| STARTED Implement hashing using dynamic helpers                             |         |       | 3:26 |   9.6 |
