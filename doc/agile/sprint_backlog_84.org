...
#+CAPTION: Clock summary at [2016-07-17 Sun 18:11]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *34:19* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 34:19   |       |      | 100.0 |
| Active                                                                      |         | 34:19 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 2:36 |   7.6 |
| STARTED Manual updates and blog posts                                       |         |       | 1:21 |   3.9 |
| COMPLETED Try to fix tag build issues                                       |         |       | 1:28 |   4.3 |
| COMPLETED Enable =BUILD_TYPE= on travis                                     |         |       | 1:17 |   3.7 |
...
| COMPLETED Rename element settings back to aspect settings                   |         |       | 0:50 |   2.4 |
| COMPLETED Rename bundle to element settings                                 |         |       | 0:27 |   1.3 |
| COMPLETED Rename bundle in stitch to properties                             |         |       | 0:16 |   0.8 |
| COMPLETED Refactor general settings                                         |         |       | 5:50 |  17.0 |
| COMPLETED Rename specs to tests                                             |         |       | 1:24 |   4.1 |
| COMPLETED Create a IO settings class                                        |         |       | 1:15 |   3.6 |
| COMPLETED Implement streaming for type in terms of IO settings              |         |       | 1:24 |   4.1 |
...
| COMPLETED Refactor formatter interfaces                                     |         |       | 0:36 |   1.7 |
...
| COMPLETED Add formatter id to file and helper formatters                    |         |       | 1:20 |   3.9 |
| COMPLETED Add IO to formatter container                                     |         |       | 1:19 |   3.8 |
| COMPLETED Includers formatter id is incorrect                               |         |       | 0:07 |   0.3 |
| COMPLETED Enable IO helpers for types                                       |         |       | 5:51 |  17.0 |
...
| COMPLETED Fix Windows linking errors for debug builds                       |         |       | 0:48 |   2.3 |
| COMPLETED Windows build fails to find tests                                 |         |       | 0:23 |   1.1 |
| COMPLETED Document windows failures and get build green                     |         |       | 0:30 |   1.5 |
| STARTED Implement hashing using dynamic helpers                             |         |       | 2:10 |   6.3 |
