...
#+CAPTION: Clock summary at [2016-07-13 Wed 22:11]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 23:56   |       |      | 100.0 |
| Active                                                                      |         | 23:56 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 2:26 |  10.2 |
| STARTED Manual updates and blog posts                                       |         |       | 1:21 |   5.6 |
| COMPLETED Try to fix tag build issues                                       |         |       | 1:28 |   6.1 |
| COMPLETED Enable =BUILD_TYPE= on travis                                     |         |       | 1:17 |   5.4 |
| COMPLETED Add initial support for coveralls                                 |         |       | 0:29 |   2.0 |
| COMPLETED Simplify local builds on emacs                                    |         |       | 0:20 |   1.4 |
| COMPLETED Create a debug build for clang in travis                          |         |       | 0:10 |   0.7 |
| COMPLETED Rename element settings back to aspect settings                   |         |       | 0:50 |   3.5 |
| COMPLETED Rename bundle to element settings                                 |         |       | 0:27 |   1.9 |
| COMPLETED Rename bundle in stitch to properties                             |         |       | 0:16 |   1.1 |
| COMPLETED Refactor general settings                                         |         |       | 5:50 |  24.4 |
| COMPLETED Rename specs to tests                                             |         |       | 1:24 |   5.8 |
| COMPLETED Create a IO settings class                                        |         |       | 1:15 |   5.2 |
| COMPLETED Implement streaming for type in terms of IO settings              |         |       | 1:24 |   5.8 |
| COMPLETED Usage of rev-list in version causes problems                      |         |       | 0:03 |   0.2 |
| STARTED Enable IO helpers for types                                         |         |       | 4:41 |  19.6 |
