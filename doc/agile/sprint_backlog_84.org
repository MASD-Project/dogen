...
#+CAPTION: Clock summary at [2016-07-17 Sun 19:13]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *35:19* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 35:19   |       |      | 100.0 |
| Active                                                                      |         | 35:19 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 2:36 |   7.4 |
| STARTED Manual updates and blog posts                                       |         |       | 1:21 |   3.8 |
| COMPLETED Try to fix tag build issues                                       |         |       | 1:28 |   4.2 |
| COMPLETED Enable =BUILD_TYPE= on travis                                     |         |       | 1:17 |   3.6 |
...
| COMPLETED Refactor general settings                                         |         |       | 5:50 |  16.5 |
| COMPLETED Rename specs to tests                                             |         |       | 1:24 |   4.0 |
| COMPLETED Create a IO settings class                                        |         |       | 1:15 |   3.5 |
...
| COMPLETED Add IO to formatter container                                     |         |       | 1:19 |   3.7 |
| COMPLETED Includers formatter id is incorrect                               |         |       | 0:07 |   0.3 |
| COMPLETED Enable IO helpers for types                                       |         |       | 5:51 |  16.6 |
...
| STARTED Implement hashing using dynamic helpers                             |         |       | 3:10 |   9.0 |
