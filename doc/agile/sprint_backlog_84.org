...
#+CAPTION: Clock summary at [2016-07-17 Sun 17:29]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *33:39* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 33:39   |       |      | 100.0 |
| Active                                                                      |         | 33:39 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 2:36 |   7.7 |
| STARTED Manual updates and blog posts                                       |         |       | 1:21 |   4.0 |
| COMPLETED Try to fix tag build issues                                       |         |       | 1:28 |   4.4 |
| COMPLETED Enable =BUILD_TYPE= on travis                                     |         |       | 1:17 |   3.8 |
| COMPLETED Add initial support for coveralls                                 |         |       | 0:29 |   1.4 |
| COMPLETED Simplify local builds on emacs                                    |         |       | 0:20 |   1.0 |
| COMPLETED Create a debug build for clang in travis                          |         |       | 0:10 |   0.5 |
| COMPLETED Rename element settings back to aspect settings                   |         |       | 0:50 |   2.5 |
| COMPLETED Rename bundle to element settings                                 |         |       | 0:27 |   1.3 |
| COMPLETED Rename bundle in stitch to properties                             |         |       | 0:16 |   0.8 |
| COMPLETED Refactor general settings                                         |         |       | 5:50 |  17.3 |
| COMPLETED Rename specs to tests                                             |         |       | 1:24 |   4.2 |
| COMPLETED Create a IO settings class                                        |         |       | 1:15 |   3.7 |
| COMPLETED Implement streaming for type in terms of IO settings              |         |       | 1:24 |   4.2 |
...
| COMPLETED Refactor formatter interfaces                                     |         |       | 0:36 |   1.8 |
...
| COMPLETED Add formatter id to file and helper formatters                    |         |       | 1:20 |   4.0 |
| COMPLETED Add IO to formatter container                                     |         |       | 1:19 |   3.9 |
| COMPLETED Includers formatter id is incorrect                               |         |       | 0:07 |   0.3 |
| COMPLETED Enable IO helpers for types                                       |         |       | 5:51 |  17.4 |
| COMPLETED Implement IO helper methods with new helper infrastructure        |         |       | 1:03 |   3.1 |
| COMPLETED Fix cmake installations problems on windows build                 |         |       | 0:24 |   1.2 |
| COMPLETED Fix Windows linking errors for debug builds                       |         |       | 0:48 |   2.4 |
| COMPLETED Windows build fails to find tests                                 |         |       | 0:23 |   1.1 |
| COMPLETED Document windows failures and get build green                     |         |       | 0:30 |   1.5 |
| STARTED Implement hashing using dynamic helpers                             |         |       | 1:30 |   4.5 |
...
*** Windows build release test failures
...
*** Windows build debug failures                                      :story:
