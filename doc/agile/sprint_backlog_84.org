...
#+CAPTION: Clock summary at [2016-07-09 Sat 00:23]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *14:03* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 14:03   |       |      | 100.0 |
| Active                                                                      |         | 14:03 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:55 |   6.5 |
| STARTED Manual updates and blog posts                                       |         |       | 0:37 |   4.4 |
| COMPLETED Try to fix tag build issues                                       |         |       | 1:28 |  10.4 |
| COMPLETED Enable build type on travis                                       |         |       | 1:17 |   9.1 |
| COMPLETED Add initial support for coveralls                                 |         |       | 0:29 |   3.4 |
| COMPLETED Simplify local builds on emacs                                    |         |       | 0:20 |   2.4 |
| COMPLETED Create a debug build for clang in travis                          |         |       | 0:10 |   1.2 |
| COMPLETED Rename element settings back to aspect settings                   |         |       | 0:50 |   5.9 |
| COMPLETED Rename bundle to element settings                                 |         |       | 0:27 |   3.2 |
| COMPLETED Rename bundle in stitch to properties                             |         |       | 0:16 |   1.9 |
| COMPLETED Refactor general settings                                         |         |       | 5:50 |  41.5 |
| COMPLETED Consider renaming specs to tests                                  |         |       | 1:24 |  10.0 |
...
*** COMPLETED Consider renaming specs to tests                        :story:
