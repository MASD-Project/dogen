...
#+CAPTION: Clock summary at [2016-07-13 Wed 23:49]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *25:26* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 25:26   |       |      | 100.0 |
| Active                                                                      |         | 25:26 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 2:26 |   9.6 |
| STARTED Manual updates and blog posts                                       |         |       | 1:21 |   5.3 |
| COMPLETED Try to fix tag build issues                                       |         |       | 1:28 |   5.8 |
| COMPLETED Enable =BUILD_TYPE= on travis                                     |         |       | 1:17 |   5.0 |
...
| COMPLETED Refactor general settings                                         |         |       | 5:50 |  22.9 |
| COMPLETED Rename specs to tests                                             |         |       | 1:24 |   5.5 |
| COMPLETED Create a IO settings class                                        |         |       | 1:15 |   4.9 |
| COMPLETED Implement streaming for type in terms of IO settings              |         |       | 1:24 |   5.5 |
...
| STARTED Add IO to formatter container                                       |         |       | 0:18 |   1.2 |
| STARTED Enable IO helpers for types                                         |         |       | 4:54 |  19.3 |
