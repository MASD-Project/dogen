...
#+CAPTION: Clock summary at [2016-07-06 Wed 00:40]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *7:50* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 7:50   |      |      | 100.0 |
| Active                                                                      |        | 7:50 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:51 |  10.9 |
| STARTED Manual updates and blog posts                                       |        |      | 0:37 |   7.9 |
| COMPLETED Try to fix tag build issues                                       |        |      | 1:28 |  18.7 |
| COMPLETED Enable build type on travis                                       |        |      | 1:17 |  16.4 |
| STARTED Simplify local builds on emacs                                      |        |      | 0:20 |   4.3 |
| STARTED Create a debug build for clang in travis                            |        |      | 0:10 |   2.1 |
| STARTED Refactor general settings                                           |        |      | 3:07 |  39.8 |
...
*** STARTED Simplify local builds on emacs                            :story:
