...
#+CAPTION: Clock summary at [2016-07-11 Mon 22:14]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *16:28* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 16:28   |       |      | 100.0 |
| Active                                                                      |         | 16:28 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:55 |   5.6 |
| STARTED Manual updates and blog posts                                       |         |       | 1:21 |   8.2 |
| COMPLETED Try to fix tag build issues                                       |         |       | 1:28 |   8.9 |
| COMPLETED Enable =BUILD_TYPE= on travis                                     |         |       | 1:17 |   7.8 |
| COMPLETED Add initial support for coveralls                                 |         |       | 0:29 |   2.9 |
| COMPLETED Simplify local builds on emacs                                    |         |       | 0:20 |   2.0 |
| COMPLETED Create a debug build for clang in travis                          |         |       | 0:10 |   1.0 |
| COMPLETED Rename element settings back to aspect settings                   |         |       | 0:50 |   5.1 |
| COMPLETED Rename bundle to element settings                                 |         |       | 0:27 |   2.7 |
| COMPLETED Rename bundle in stitch to properties                             |         |       | 0:16 |   1.6 |
| COMPLETED Refactor general settings                                         |         |       | 5:50 |  35.4 |
| COMPLETED Rename specs to tests                                             |         |       | 1:24 |   8.5 |
| STARTED Create a IO settings class                                          |         |       | 1:41 |  10.2 |
