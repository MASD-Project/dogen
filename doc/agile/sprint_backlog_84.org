...
#+CAPTION: Clock summary at [2016-07-05 Tue 21:26]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *4:42* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 4:42   |      |      | 100.0 |
| Active                                                                      |        | 4:42 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:31 |  11.0 |
| COMPLETED Try to fix tag build issues                                       |        |      | 1:28 |  31.2 |
| COMPLETED Enable build type on travis                                       |        |      | 1:17 |  27.3 |
| STARTED Create a debug build for clang in travis                            |        |      | 0:10 |   3.5 |
| STARTED Refactor general settings                                           |        |      | 1:16 |  27.0 |
