...
#+CAPTION: Clock summary at [2016-07-05 Tue 21:10]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *4:28* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 4:28   |      |      | 100.0 |
| Active                                                                      |        | 4:28 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:17 |   6.3 |
| COMPLETED Try to fix tag build issues                                       |        |      | 1:28 |  32.8 |
| COMPLETED Enable build type on travis                                       |        |      | 1:17 |  28.7 |
| STARTED Create a debug build for clang in travis                            |        |      | 0:10 |   3.7 |
| STARTED Refactor general settings                                           |        |      | 1:16 |  28.4 |
