...
#+CAPTION: Clock summary at [2016-07-12 Tue 16:10]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *18:39* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 18:39   |       |      | 100.0 |
| Active                                                                      |         | 18:39 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:15 |   6.7 |
| STARTED Manual updates and blog posts                                       |         |       | 1:21 |   7.2 |
| COMPLETED Try to fix tag build issues                                       |         |       | 1:28 |   7.9 |
| COMPLETED Enable =BUILD_TYPE= on travis                                     |         |       | 1:17 |   6.9 |
| COMPLETED Add initial support for coveralls                                 |         |       | 0:29 |   2.6 |
| COMPLETED Simplify local builds on emacs                                    |         |       | 0:20 |   1.8 |
| COMPLETED Create a debug build for clang in travis                          |         |       | 0:10 |   0.9 |
| COMPLETED Rename element settings back to aspect settings                   |         |       | 0:50 |   4.5 |
| COMPLETED Rename bundle to element settings                                 |         |       | 0:27 |   2.4 |
| COMPLETED Rename bundle in stitch to properties                             |         |       | 0:16 |   1.4 |
| COMPLETED Refactor general settings                                         |         |       | 5:50 |  31.3 |
| COMPLETED Rename specs to tests                                             |         |       | 1:24 |   7.5 |
| COMPLETED Create a IO settings class                                        |         |       | 1:15 |   6.7 |
| COMPLETED Implement streaming for type in terms of IO settings              |         |       | 1:24 |   7.5 |
| STARTED Enable IO helpers for types                                         |         |       | 0:38 |   3.4 |
| STARTED Implement IO helper methods with new helper infrastructure          |         |       | 0:15 |   1.3 |
