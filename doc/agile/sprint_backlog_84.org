...
#+CAPTION: Clock summary at [2016-07-14 Thu 22:27]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *27:18* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 27:18   |       |      | 100.0 |
| Active                                                                      |         | 27:18 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 2:26 |   8.9 |
| STARTED Manual updates and blog posts                                       |         |       | 1:21 |   4.9 |
| COMPLETED Try to fix tag build issues                                       |         |       | 1:28 |   5.4 |
| COMPLETED Enable =BUILD_TYPE= on travis                                     |         |       | 1:17 |   4.7 |
...
| COMPLETED Refactor general settings                                         |         |       | 5:50 |  21.4 |
| COMPLETED Rename specs to tests                                             |         |       | 1:24 |   5.1 |
| COMPLETED Create a IO settings class                                        |         |       | 1:15 |   4.6 |
...
| COMPLETED Add formatter id to file and helper formatters                    |         |       | 1:20 |   4.9 |
| STARTED Add IO to formatter container                                       |         |       | 0:35 |   2.1 |
| STARTED Enable IO helpers for types                                         |         |       | 4:54 |  17.9 |
