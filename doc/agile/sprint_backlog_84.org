...
#+CAPTION: Clock summary at [2016-07-13 Wed 23:30]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| COMPLETED Try to fix tag build issues                                       |         |       | 1:28 |   5.8 |
...
| COMPLETED Refactor general settings                                         |         |       | 5:50 |  23.2 |
...
| COMPLETED Move formatter helpers into formatter container                   |         |       | 0:13 |   0.9 |
| STARTED Enable IO helpers for types                                         |         |       | 4:54 |  19.5 |
