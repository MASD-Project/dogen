...
#+CAPTION: Clock summary at [2016-07-12 Tue 13:30]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *18:19* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 18:19   |       |      | 100.0 |
| Active                                                                      |         | 18:19 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:55 |   5.0 |
| STARTED Manual updates and blog posts                                       |         |       | 1:21 |   7.4 |
| COMPLETED Try to fix tag build issues                                       |         |       | 1:28 |   8.0 |
| COMPLETED Enable =BUILD_TYPE= on travis                                     |         |       | 1:17 |   7.0 |
...
| COMPLETED Rename bundle to element settings                                 |         |       | 0:27 |   2.5 |
| COMPLETED Rename bundle in stitch to properties                             |         |       | 0:16 |   1.5 |
| COMPLETED Refactor general settings                                         |         |       | 5:50 |  31.8 |
| COMPLETED Rename specs to tests                                             |         |       | 1:24 |   7.6 |
| COMPLETED Create a IO settings class                                        |         |       | 1:15 |   6.8 |
| COMPLETED Implement streaming for type in terms of IO settings              |         |       | 1:24 |   7.6 |
| STARTED Enable IO helpers for types                                         |         |       | 0:38 |   3.5 |
| STARTED Implement IO helper methods with new helper infrastructure          |         |       | 0:15 |   1.4 |
