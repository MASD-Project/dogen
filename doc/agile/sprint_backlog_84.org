...
#+CAPTION: Clock summary at [2016-07-06 Wed 00:20]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *7:30* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 7:30   |      |      | 100.0 |
| Active                                                                      |        | 7:30 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:51 |  11.3 |
| STARTED Manual updates and blog posts                                       |        |      | 0:37 |   8.2 |
| COMPLETED Try to fix tag build issues                                       |        |      | 1:28 |  19.6 |
| COMPLETED Enable build type on travis                                       |        |      | 1:17 |  17.1 |
| STARTED Create a debug build for clang in travis                            |        |      | 0:10 |   2.2 |
| STARTED Refactor general settings                                           |        |      | 3:07 |  41.6 |
