...
#+CAPTION: Clock summary at [2016-07-05 Tue 23:15]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *6:28* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 6:28   |      |      | 100.0 |
| Active                                                                      |        | 6:28 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:51 |  13.1 |
| STARTED Manual updates and blog posts                                       |        |      | 0:37 |   9.5 |
| COMPLETED Try to fix tag build issues                                       |        |      | 1:28 |  22.7 |
| COMPLETED Enable build type on travis                                       |        |      | 1:17 |  19.8 |
| STARTED Create a debug build for clang in travis                            |        |      | 0:10 |   2.6 |
| STARTED Refactor general settings                                           |        |      | 2:05 |  32.2 |
