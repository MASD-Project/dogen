...
#+CAPTION: Clock summary at [2016-07-17 Sun 18:33]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 34:40   |       |      | 100.0 |
| Active                                                                      |         | 34:40 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 2:36 |   7.5 |
| STARTED Manual updates and blog posts                                       |         |       | 1:21 |   3.9 |
| COMPLETED Try to fix tag build issues                                       |         |       | 1:28 |   4.2 |
...
| COMPLETED Refactor general settings                                         |         |       | 5:50 |  16.8 |
| COMPLETED Rename specs to tests                                             |         |       | 1:24 |   4.0 |
| COMPLETED Create a IO settings class                                        |         |       | 1:15 |   3.6 |
| COMPLETED Implement streaming for type in terms of IO settings              |         |       | 1:24 |   4.0 |
...
| COMPLETED Add formatter id to file and helper formatters                    |         |       | 1:20 |   3.8 |
| COMPLETED Add IO to formatter container                                     |         |       | 1:19 |   3.8 |
| COMPLETED Includers formatter id is incorrect                               |         |       | 0:07 |   0.3 |
| COMPLETED Enable IO helpers for types                                       |         |       | 5:51 |  16.9 |
| COMPLETED Implement IO helper methods with new helper infrastructure        |         |       | 1:03 |   3.0 |
...
| STARTED Implement hashing using dynamic helpers                             |         |       | 2:31 |   7.3 |
