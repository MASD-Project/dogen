...
#+CAPTION: Clock summary at [2016-07-17 Sun 01:51]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *32:36* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 32:36   |       |      | 100.0 |
| Active                                                                      |         | 32:36 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 2:26 |   7.5 |
| STARTED Manual updates and blog posts                                       |         |       | 1:21 |   4.1 |
| COMPLETED Try to fix tag build issues                                       |         |       | 1:28 |   4.5 |
...
| COMPLETED Rename element settings back to aspect settings                   |         |       | 0:50 |   2.6 |
| COMPLETED Rename bundle to element settings                                 |         |       | 0:27 |   1.4 |
| COMPLETED Rename bundle in stitch to properties                             |         |       | 0:16 |   0.8 |
| COMPLETED Refactor general settings                                         |         |       | 5:50 |  17.9 |
| COMPLETED Rename specs to tests                                             |         |       | 1:24 |   4.3 |
| COMPLETED Create a IO settings class                                        |         |       | 1:15 |   3.8 |
| COMPLETED Implement streaming for type in terms of IO settings              |         |       | 1:24 |   4.3 |
...
| COMPLETED Add formatter id to file and helper formatters                    |         |       | 1:20 |   4.1 |
| COMPLETED Add IO to formatter container                                     |         |       | 1:19 |   4.0 |
| COMPLETED Includers formatter id is incorrect                               |         |       | 0:07 |   0.4 |
| COMPLETED Enable IO helpers for types                                       |         |       | 5:51 |  17.9 |
...
| COMPLETED Fix Windows linking errors for debug builds                       |         |       | 0:48 |   2.5 |
| STARTED Implement hashing using dynamic helpers                             |         |       | 1:30 |   4.6 |
