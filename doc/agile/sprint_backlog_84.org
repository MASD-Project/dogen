...
#+CAPTION: Clock summary at [2016-07-14 Thu 20:51]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *25:45* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 25:45   |       |      | 100.0 |
| Active                                                                      |         | 25:45 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 2:26 |   9.4 |
| STARTED Manual updates and blog posts                                       |         |       | 1:21 |   5.2 |
| COMPLETED Try to fix tag build issues                                       |         |       | 1:28 |   5.7 |
...
| COMPLETED Rename element settings back to aspect settings                   |         |       | 0:50 |   3.2 |
| COMPLETED Rename bundle to element settings                                 |         |       | 0:27 |   1.7 |
| COMPLETED Rename bundle in stitch to properties                             |         |       | 0:16 |   1.0 |
| COMPLETED Refactor general settings                                         |         |       | 5:50 |  22.7 |
| COMPLETED Rename specs to tests                                             |         |       | 1:24 |   5.4 |
| COMPLETED Create a IO settings class                                        |         |       | 1:15 |   4.9 |
| COMPLETED Implement streaming for type in terms of IO settings              |         |       | 1:24 |   5.4 |
...
| COMPLETED Refactor formatter interfaces                                     |         |       | 0:36 |   2.3 |
...
| STARTED Add IO to formatter container                                       |         |       | 0:35 |   2.3 |
| STARTED Enable IO helpers for types                                         |         |       | 4:54 |  19.0 |
