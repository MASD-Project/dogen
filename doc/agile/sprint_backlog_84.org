...
#+CAPTION: Clock summary at [2016-07-05 Tue 21:47]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *5:02* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 5:02   |      |      | 100.0 |
| Active                                                                      |        | 5:02 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:51 |  16.9 |
| COMPLETED Try to fix tag build issues                                       |        |      | 1:28 |  29.1 |
| COMPLETED Enable build type on travis                                       |        |      | 1:17 |  25.5 |
| STARTED Create a debug build for clang in travis                            |        |      | 0:10 |   3.3 |
| STARTED Refactor general settings                                           |        |      | 1:16 |  25.2 |
