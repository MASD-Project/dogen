...
#+CAPTION: Clock summary at [2016-07-11 Mon 21:59]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *16:14* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 16:14   |       |      | 100.0 |
| Active                                                                      |         | 16:14 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:55 |   5.6 |
| STARTED Manual updates and blog posts                                       |         |       | 1:21 |   8.3 |
| COMPLETED Try to fix tag build issues                                       |         |       | 1:28 |   9.0 |
| COMPLETED Enable =BUILD_TYPE= on travis                                     |         |       | 1:17 |   7.9 |
| COMPLETED Add initial support for coveralls                                 |         |       | 0:29 |   3.0 |
| COMPLETED Simplify local builds on emacs                                    |         |       | 0:20 |   2.1 |
...
| COMPLETED Rename bundle to element settings                                 |         |       | 0:27 |   2.8 |
| COMPLETED Rename bundle in stitch to properties                             |         |       | 0:16 |   1.6 |
| COMPLETED Refactor general settings                                         |         |       | 5:50 |  35.9 |
| COMPLETED Rename specs to tests                                             |         |       | 1:24 |   8.6 |
| STARTED Create a IO settings class                                          |         |       | 1:27 |   8.9 |
