...
#+CAPTION: Clock summary at [2016-07-09 Sat 23:40]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *15:02* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 15:02   |       |      | 100.0 |
| Active                                                                      |         | 15:02 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:55 |   6.1 |
| STARTED Manual updates and blog posts                                       |         |       | 1:08 |   7.5 |
| COMPLETED Try to fix tag build issues                                       |         |       | 1:28 |   9.8 |
| COMPLETED Enable =BUILD_TYPE= on travis                                     |         |       | 1:17 |   8.5 |
| COMPLETED Add initial support for coveralls                                 |         |       | 0:29 |   3.2 |
| COMPLETED Simplify local builds on emacs                                    |         |       | 0:20 |   2.2 |
| COMPLETED Create a debug build for clang in travis                          |         |       | 0:10 |   1.1 |
| COMPLETED Rename element settings back to aspect settings                   |         |       | 0:50 |   5.5 |
| COMPLETED Rename bundle to element settings                                 |         |       | 0:27 |   3.0 |
| COMPLETED Rename bundle in stitch to properties                             |         |       | 0:16 |   1.8 |
| COMPLETED Refactor general settings                                         |         |       | 5:50 |  38.8 |
| COMPLETED Rename specs to tests                                             |         |       | 1:24 |   9.3 |
| STARTED Create a IO settings class                                          |         |       | 0:28 |   3.1 |
