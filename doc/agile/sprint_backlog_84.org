...
#+CAPTION: Clock summary at [2016-07-13 Wed 18:45]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *22:59* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 22:59   |       |      | 100.0 |
| Active                                                                      |         | 22:59 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 2:26 |  10.6 |
| STARTED Manual updates and blog posts                                       |         |       | 1:21 |   5.9 |
| COMPLETED Try to fix tag build issues                                       |         |       | 1:28 |   6.4 |
| COMPLETED Enable =BUILD_TYPE= on travis                                     |         |       | 1:17 |   5.6 |
...
| COMPLETED Rename bundle to element settings                                 |         |       | 0:27 |   2.0 |
| COMPLETED Rename bundle in stitch to properties                             |         |       | 0:16 |   1.2 |
| COMPLETED Refactor general settings                                         |         |       | 5:50 |  25.4 |
| COMPLETED Rename specs to tests                                             |         |       | 1:24 |   6.1 |
| COMPLETED Create a IO settings class                                        |         |       | 1:15 |   5.4 |
| COMPLETED Implement streaming for type in terms of IO settings              |         |       | 1:24 |   6.1 |
| COMPLETED Usage of rev-list in version causes problems                      |         |       | 0:03 |   0.2 |
| STARTED Enable IO helpers for types                                         |         |       | 3:44 |  16.2 |
