...
Clock summary at [2014-01-15 Wed 23:43]

| Headline                                                                     | Time   |      |      |
|------------------------------------------------------------------------------+--------+------+------|
| *Total time*                                                                 | *7:19* |      |      |
|------------------------------------------------------------------------------+--------+------+------|
| Development Stories Implemented                                              |        | 7:19 |      |
...
| IMPLEMENTATION Refactor types header into new style file formatter           |        |      | 0:23 |
#+end:
...
**** Rename formatter into =types_main_header_formatter=               :task:
