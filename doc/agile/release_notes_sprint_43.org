...
Clock summary at [2014-01-24 Fri 10:02]

| Headline                                                                     | Time    |       |      |
|------------------------------------------------------------------------------+---------+-------+------|
| *Total time*                                                                 | *22:50* |       |      |
|------------------------------------------------------------------------------+---------+-------+------|
| Development Stories Implemented                                              |         | 22:50 |      |
| IMPLEMENTATION Release notes and backlog grooming                            |         |       | 3:01 |
| IMPLEMENTATION Create a blog post on dogen's development methodology         |         |       | 1:37 |
...
| IMPLEMENTATION Sync C++ model structure with SML                             |         |       | 3:32 |
