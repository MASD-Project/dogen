...
Clock summary at [2014-01-15 Wed 19:36]

| Headline                                                                     | Time   |      |      |
|------------------------------------------------------------------------------+--------+------+------|
| *Total time*                                                                 | *6:34* |      |      |
|------------------------------------------------------------------------------+--------+------+------|
| Development Stories Implemented                                              |        | 6:34 |      |
...
| IMPLEMENTATION Make use of =cpp_includes= in =source_file=                   |        |      | 1:50 |
#+end:
...
*** IMPLEMENTATION Make use of =cpp_includes= in =source_file=        :story:
