...
*** The command-line option for the types facet is =domain=           :story:

When we performed the rename of =domain= to =types= we left the
command-line facet. We should rename it to =types= too.
...
*** Log start and finish of dogen with version                        :story:
...
*** Sprint number is not being added to the version                   :story:
...
It should be v.0.46.2233 to reflect the tags.

Also, we should probably consider removing the leading 0, as we do not
have a good policy to manage it.

*** Enable support for manual code at the facet level                 :story:
...
*** Remove =--info= option from command line                          :story:
...
: [2014-03-11 18:22:21.365440] [0x0b6ffc70] [info]    /home/marco/Development/DomainDrivenConsulting/dogen/projects/driver/src/program_options_parser.cpp(364): Throw in function void dogen::driver::program_options_parser::throw_missing_target() const
: Dynamic exception type: N5boost16exception_detail10clone_implIN5dogen6driver23parser_validation_errorEEE
...
*** Add support for unique log files                                  :story:
