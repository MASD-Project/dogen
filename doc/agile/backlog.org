...
We should move the transformation code outside of the C++ model, to a
=sml_to_cpp= model. This would make maintenance a lot easier.
...
Once dogen supports concepts, the natural thing to do is to express
