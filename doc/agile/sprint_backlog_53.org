...
Clock summary at [2014-10-06 Mon 09:16]

| Headline                                           | Time   |      |      |
|----------------------------------------------------+--------+------+------|
| *Total time*                                       | *0:53* |      |      |
|----------------------------------------------------+--------+------+------|
| Development Stories Implemented                    |        | 0:53 |      |
| IMPLEMENTATION Sprint and product backlog grooming |        |      | 0:27 |
| IMPLEMENTATION Implement the =backend= model       |        |      | 0:26 |
#+end:
...
**** IMPLEMENTATION Code generate the =backend= model
