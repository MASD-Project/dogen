...
Clock summary at [2014-10-07 Tue 22:46]

| Headline                                                            | Time   |      |      |
|---------------------------------------------------------------------+--------+------+------|
| *Total time*                                                        | *3:07* |      |      |
|---------------------------------------------------------------------+--------+------+------|
| Development Stories Implemented                                     |        | 3:07 |      |
...
| IMPLEMENTATION Implement the general settings handler               |        |      | 0:37 |
#+end:
...
*** IMPLEMENTATION Implement the general settings handler     :task:refactor:
