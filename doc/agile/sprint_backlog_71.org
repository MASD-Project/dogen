...
#+CAPTION: Clock summary at [2015-08-04 Tue 23:04]
| <75>                                                                        |         |       |      |
| Headline                                                                    | Time    |       |      |
|-----------------------------------------------------------------------------+---------+-------+------|
| *Total time*                                                                | *19:39* |       |      |
...
| STARTED Compile dogen in Windows using Visual Studio 2015                   |         |       | 8:18 |
...
*** Dia hydrator should hydrate with path                             :story:
