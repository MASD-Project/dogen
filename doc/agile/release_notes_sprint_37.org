...
Clock summary at [2013-10-24 Thu 20:29]
...
| COMPLETED Add types header formatter to workflow  |        |      | 2:28 |
#+end:
...
**** IMPLEMENTATION add all types traversal and hook it up to workflow
