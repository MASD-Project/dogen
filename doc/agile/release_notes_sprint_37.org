...
Clock summary at [2013-10-28 Mon 00:33]

| Headline                                                                        | Time    |       |      |
|---------------------------------------------------------------------------------+---------+-------+------|
| *Total time*                                                                    | *13:08* |       |      |
|---------------------------------------------------------------------------------+---------+-------+------|
| Development Stories Implemented                                                 |         | 13:08 |      |
...
| IMPLEMENTATION Simplify usage of router and adaptor by using native =ptree= API |         |       | 0:33 |
...
*** IMPLEMENTATION Simplify usage of router and adaptor by using native =ptree= API :story:
...
**** Rename router to =ptree_writer=                                   :task:
**** Rename adaptor to =ptree_reader=                                  :task:
**** Remove =make_tag_xyz= methods                                     :task:
**** Make template methods in workflow use meta-data directly          :task:
