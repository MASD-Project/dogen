...
#+CAPTION: Clock summary at [2016-04-14 Thu 07:35]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *0:36* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 0:36   |      |      | 100.0 |
| Active                                                                      |        | 0:36 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:03 |   8.3 |
| STARTED Manual updates and blog posts                                       |        |      | 0:33 |  91.7 |
...
*** Add properties for helpers                                        :story:
