...
#+CAPTION: Clock summary at [2016-09-13 Tue 09:57]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *7:53* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 7:53   |      |      | 100.0 |
| Active                                                                      |        | 7:53 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 1:19 |  16.7 |
| COMPLETED Fix chocolatey warning                                            |        |      | 0:08 |   1.7 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 0:27 |   5.7 |
| COMPLETED Analysis on current state of file path generation                 |        |      | 0:57 |  12.1 |
| CANCELLED Remove inclusion dependencies builder factory                     |        |      | 0:14 |   3.0 |
| COMPLETED Analysis on formatters, elements and extensibility                |        |      | 1:18 |  16.5 |
| COMPLETED Refactor =inclusion_dependencies_provider_interface=              |        |      | 1:12 |  15.2 |
| STARTED Refactor path derivatives factory for usage in formatters           |        |      | 0:54 |  11.4 |
| STARTED Move file path generation to formatters                             |        |      | 0:24 |   5.1 |
| STARTED Path derivatives factory generates all possible includes            |        |      | 0:44 |   9.3 |
| STARTED Remove formattable origin type                                      |        |      | 0:16 |   3.4 |
