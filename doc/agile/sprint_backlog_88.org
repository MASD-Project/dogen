...
#+CAPTION: Clock summary at [2016-09-21 Wed 12:13]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *56:10* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 56:10   |       |       | 100.0 |
| Active                                                                      |         | 56:10 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  3:33 |   6.3 |
...
| COMPLETED Refactor path derivatives factory for usage in formatters         |         |       |  5:14 |   9.3 |
| COMPLETED Move file path generation to formatters                           |         |       |  1:58 |   3.5 |
| CANCELLED Path derivatives factory generates all possible includes          |         |       |  3:07 |   5.5 |
| COMPLETED Analysis on inclusion derivatives and path derivatives            |         |       |  1:04 |   1.9 |
| COMPLETED Split path factory from provider factory                          |         |       |  2:32 |   4.5 |
| COMPLETED Use providers when building inclusion directives                  |         |       | 12:01 |  21.4 |
...
| COMPLETED Add facet folder and formatter enablement to formatter properties |         |       |  2:52 |   5.1 |
| COMPLETED Move =cmakelists_info= to fabric                                  |         |       |  6:34 |  11.7 |
| COMPLETED Move =odb_options_info= to fabric                                 |         |       |  1:29 |   2.6 |
...
| STARTED Big rename for "final" terminology clean up                         |         |       |  1:06 |   2.0 |
