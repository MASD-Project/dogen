...
#+CAPTION: Clock summary at [2016-09-20 Tue 13:12]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *48:47* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 48:47   |       |       | 100.0 |
| Active                                                                      |         | 48:47 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  2:34 |   5.3 |
...
| COMPLETED Analysis on formatters, elements and extensibility                |         |       |  1:18 |   2.7 |
| COMPLETED Refactor =inclusion_dependencies_provider_interface=              |         |       |  1:12 |   2.5 |
| COMPLETED Investigate broken windows builds                                 |         |       |  0:32 |   1.1 |
| COMPLETED Refactor path derivatives factory for usage in formatters         |         |       |  5:14 |  10.7 |
| COMPLETED Move file path generation to formatters                           |         |       |  1:58 |   4.0 |
| CANCELLED Path derivatives factory generates all possible includes          |         |       |  3:07 |   6.4 |
| COMPLETED Analysis on inclusion derivatives and path derivatives            |         |       |  1:04 |   2.2 |
| COMPLETED Split path factory from provider factory                          |         |       |  2:32 |   5.2 |
| COMPLETED Use providers when building inclusion directives                  |         |       | 12:01 |  24.6 |
| COMPLETED Fix AppVeyor notifications                                        |         |       |  0:22 |   0.8 |
| COMPLETED Static use of element types does more harm than good              |         |       |  0:32 |   1.1 |
| COMPLETED Analysis: major rethink of the implementation of quilt            |         |       |  1:30 |   3.1 |
| CANCELLED Create a simple Emacs mode for stitch                             |         |       |  1:12 |   2.5 |
| COMPLETED Add facet folder and formatter enablement to formatter properties |         |       |  2:52 |   5.9 |
| COMPLETED Move =cmakelists_info= to fabric                                  |         |       |  6:34 |  13.5 |
| STARTED Terminology clean up                                                |         |       |  0:02 |   0.1 |
| STARTED Remove formattable origin type                                      |         |       |  2:25 |   5.0 |
