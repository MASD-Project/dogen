...
#+CAPTION: Clock summary at [2016-09-16 Fri 23:59]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *35:18* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 35:18   |       |       | 100.0 |
| Active                                                                      |         | 35:18 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  2:13 |   6.3 |
...
| COMPLETED Analysis on formatters, elements and extensibility                |         |       |  1:18 |   3.7 |
...
| COMPLETED Refactor path derivatives factory for usage in formatters         |         |       |  5:14 |  14.8 |
| COMPLETED Move file path generation to formatters                           |         |       |  1:58 |   5.6 |
...
| COMPLETED Split path factory from provider factory                          |         |       |  2:32 |   7.2 |
| STARTED Use providers when building inclusion directives                    |         |       | 11:25 |  32.3 |
