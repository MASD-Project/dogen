...
#+CAPTION: Clock summary at [2016-09-17 Sat 01:01]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *36:16* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 36:16   |       |       | 100.0 |
| Active                                                                      |         | 36:16 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  2:13 |   6.1 |
| COMPLETED Fix chocolatey warning                                            |         |       |  0:08 |   0.4 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:27 |   1.2 |
| COMPLETED Analysis on current state of file path generation                 |         |       |  0:57 |   2.6 |
| CANCELLED Remove inclusion dependencies builder factory                     |         |       |  0:14 |   0.6 |
| COMPLETED Analysis on formatters, elements and extensibility                |         |       |  1:18 |   3.6 |
| COMPLETED Refactor =inclusion_dependencies_provider_interface=              |         |       |  1:12 |   3.3 |
| COMPLETED Investigate broken windows builds                                 |         |       |  0:32 |   1.5 |
| COMPLETED Refactor path derivatives factory for usage in formatters         |         |       |  5:14 |  14.4 |
| COMPLETED Move file path generation to formatters                           |         |       |  1:58 |   5.4 |
| CANCELLED Path derivatives factory generates all possible includes          |         |       |  3:07 |   8.6 |
| COMPLETED Analysis on inclusion derivatives and path derivatives            |         |       |  1:04 |   2.9 |
| COMPLETED Split path factory from provider factory                          |         |       |  2:32 |   7.0 |
| COMPLETED Use providers when building inclusion directives                  |         |       | 12:01 |  33.1 |
| COMPLETED Fix AppVeyor notifications                                        |         |       |  0:22 |   1.0 |
| STARTED Remove formattable origin type                                      |         |       |  2:25 |   6.7 |
| STARTED Static use of element types does more harm than good                |         |       |  0:32 |   1.5 |
...
*** STARTED Static use of element types does more harm than good      :story:
