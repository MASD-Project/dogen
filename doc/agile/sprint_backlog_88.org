...
#+CAPTION: Clock summary at [2016-09-13 Tue 21:56]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 12:00   |       |      | 100.0 |
| Active                                                                      |         | 12:00 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 2:00 |  16.7 |
| COMPLETED Fix chocolatey warning                                            |         |       | 0:08 |   1.1 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:27 |   3.8 |
| COMPLETED Analysis on current state of file path generation                 |         |       | 0:57 |   7.9 |
| CANCELLED Remove inclusion dependencies builder factory                     |         |       | 0:14 |   1.9 |
| COMPLETED Analysis on formatters, elements and extensibility                |         |       | 1:18 |  10.8 |
| COMPLETED Refactor =inclusion_dependencies_provider_interface=              |         |       | 1:12 |  10.0 |
| STARTED Refactor path derivatives factory for usage in formatters           |         |       | 3:15 |  27.1 |
| STARTED Move file path generation to formatters                             |         |       | 1:29 |  12.4 |
| STARTED Path derivatives factory generates all possible includes            |         |       | 0:44 |   6.1 |
