...
#+CAPTION: Clock summary at [2016-09-13 Tue 12:25]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *10:14* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 10:14   |       |      | 100.0 |
| Active                                                                      |         | 10:14 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:19 |  12.9 |
| COMPLETED Fix chocolatey warning                                            |         |       | 0:08 |   1.3 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:27 |   4.4 |
| COMPLETED Analysis on current state of file path generation                 |         |       | 0:57 |   9.3 |
| CANCELLED Remove inclusion dependencies builder factory                     |         |       | 0:14 |   2.3 |
| COMPLETED Analysis on formatters, elements and extensibility                |         |       | 1:18 |  12.7 |
| COMPLETED Refactor =inclusion_dependencies_provider_interface=              |         |       | 1:12 |  11.7 |
| STARTED Refactor path derivatives factory for usage in formatters           |         |       | 3:15 |  31.8 |
| STARTED Move file path generation to formatters                             |         |       | 0:24 |   3.9 |
| STARTED Path derivatives factory generates all possible includes            |         |       | 0:44 |   7.2 |
| STARTED Remove formattable origin type                                      |         |       | 0:16 |   2.6 |
