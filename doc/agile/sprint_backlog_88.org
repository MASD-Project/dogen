...
#+CAPTION: Clock summary at [2016-09-17 Sat 00:19]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *35:37* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 35:37   |       |       | 100.0 |
| Active                                                                      |         | 35:37 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  2:13 |   6.2 |
| COMPLETED Fix chocolatey warning                                            |         |       |  0:08 |   0.4 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:27 |   1.3 |
| COMPLETED Analysis on current state of file path generation                 |         |       |  0:57 |   2.7 |
| CANCELLED Remove inclusion dependencies builder factory                     |         |       |  0:14 |   0.7 |
| COMPLETED Analysis on formatters, elements and extensibility                |         |       |  1:18 |   3.6 |
| COMPLETED Refactor =inclusion_dependencies_provider_interface=              |         |       |  1:12 |   3.4 |
| COMPLETED Investigate broken windows builds                                 |         |       |  0:32 |   1.5 |
| COMPLETED Refactor path derivatives factory for usage in formatters         |         |       |  5:14 |  14.7 |
| COMPLETED Move file path generation to formatters                           |         |       |  1:58 |   5.5 |
| CANCELLED Path derivatives factory generates all possible includes          |         |       |  3:07 |   8.8 |
| COMPLETED Analysis on inclusion derivatives and path derivatives            |         |       |  1:04 |   3.0 |
| COMPLETED Split path factory from provider factory                          |         |       |  2:32 |   7.1 |
| STARTED Use providers when building inclusion directives                    |         |       | 11:44 |  32.9 |
| STARTED Remove formattable origin type                                      |         |       |  2:25 |   6.8 |
