...
#+CAPTION: Clock summary at [2016-09-23 Fri 13:16]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *73:16* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 73:16   |       |       | 100.0 |
| Active                                                                      |         | 73:16 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  3:53 |   5.3 |
| COMPLETED Fix chocolatey warning                                            |         |       |  0:08 |   0.2 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:27 |   0.6 |
| COMPLETED Analysis on current state of file path generation                 |         |       |  0:57 |   1.3 |
| CANCELLED Remove inclusion dependencies builder factory                     |         |       |  0:14 |   0.3 |
| COMPLETED Analysis on formatters, elements and extensibility                |         |       |  1:18 |   1.8 |
| COMPLETED Refactor =inclusion_dependencies_provider_interface=              |         |       |  1:12 |   1.6 |
| COMPLETED Investigate broken windows builds                                 |         |       |  0:32 |   0.7 |
| COMPLETED Refactor path derivatives factory for usage in formatters         |         |       |  5:14 |   7.1 |
| COMPLETED Move file path generation to formatters                           |         |       |  1:58 |   2.7 |
| CANCELLED Path derivatives factory generates all possible includes          |         |       |  3:07 |   4.3 |
| COMPLETED Analysis on inclusion derivatives and path derivatives            |         |       |  1:04 |   1.5 |
| COMPLETED Split path factory from provider factory                          |         |       |  2:32 |   3.5 |
| COMPLETED Use providers when building inclusion directives                  |         |       | 12:01 |  16.4 |
| COMPLETED Fix AppVeyor notifications                                        |         |       |  0:22 |   0.5 |
| COMPLETED Static use of element types does more harm than good              |         |       |  0:32 |   0.7 |
| COMPLETED Analysis: major rethink of the implementation of quilt            |         |       |  1:30 |   2.0 |
| CANCELLED Create a simple Emacs mode for stitch                             |         |       |  1:12 |   1.6 |
| COMPLETED Add facet folder and formatter enablement to formatter properties |         |       |  2:52 |   3.9 |
| COMPLETED Move =cmakelists_info= to fabric                                  |         |       |  6:34 |   9.0 |
| COMPLETED Move =odb_options_info= to fabric                                 |         |       |  1:29 |   2.0 |
| COMPLETED Remove =formattable_origin_type=                                  |         |       |  0:17 |   0.4 |
| COMPLETED Remove formattable origin type                                    |         |       |  2:25 |   3.3 |
| COMPLETED Rename config model to options                                    |         |       |  1:07 |   1.5 |
| COMPLETED Rename annotation to decoration in formatters model               |         |       |  0:30 |   0.7 |
| COMPLETED Fix appveyor Visual Studio build                                  |         |       |  1:04 |   1.5 |
| COMPLETED Big rename for "final" terminology clean up                       |         |       |  2:19 |   3.2 |
| COMPLETED Tidy-up file configuration in formatters                          |         |       |  3:03 |   4.2 |
...
| COMPLETED Do a cursory investigation of dia plugin support                  |         |       |  0:49 |   1.1 |
| STARTED Consider merging provider interface with file formatter             |         |       |  5:36 |   7.6 |
| STARTED Add type index to name and to formatter interface                   |         |       |  5:36 |   7.6 |
