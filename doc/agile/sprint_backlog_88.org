...
#+CAPTION: Clock summary at [2016-09-21 Wed 17:42]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                                     | 59:29   |       |       | 100.0 |
| Active                                                                      |         | 59:29 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  3:33 |   6.0 |
...
| COMPLETED Refactor =inclusion_dependencies_provider_interface=              |         |       |  1:12 |   2.0 |
| COMPLETED Investigate broken windows builds                                 |         |       |  0:32 |   0.9 |
| COMPLETED Refactor path derivatives factory for usage in formatters         |         |       |  5:14 |   8.8 |
| COMPLETED Move file path generation to formatters                           |         |       |  1:58 |   3.3 |
| CANCELLED Path derivatives factory generates all possible includes          |         |       |  3:07 |   5.2 |
...
| COMPLETED Use providers when building inclusion directives                  |         |       | 12:01 |  20.2 |
| COMPLETED Fix AppVeyor notifications                                        |         |       |  0:22 |   0.6 |
| COMPLETED Static use of element types does more harm than good              |         |       |  0:32 |   0.9 |
| COMPLETED Analysis: major rethink of the implementation of quilt            |         |       |  1:30 |   2.5 |
| CANCELLED Create a simple Emacs mode for stitch                             |         |       |  1:12 |   2.0 |
| COMPLETED Add facet folder and formatter enablement to formatter properties |         |       |  2:52 |   4.8 |
| COMPLETED Move =cmakelists_info= to fabric                                  |         |       |  6:34 |  11.0 |
...
| COMPLETED Big rename for "final" terminology clean up                       |         |       |  2:19 |   3.9 |
| STARTED Tidy-up file configuration in formatters                            |         |       |  2:06 |   3.5 |
