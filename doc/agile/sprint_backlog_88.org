...
#+CAPTION: Clock summary at [2016-09-12 Mon 11:02]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *2:42* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 2:42   |      |      | 100.0 |
| Active                                                                      |        | 2:42 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 1:10 |  43.2 |
| COMPLETED Fix chocolatey warning                                            |        |      | 0:08 |   4.9 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 0:27 |  16.7 |
| COMPLETED Analysis on current state of file path generation                 |        |      | 0:57 |  35.2 |
...
*** Move file path generation to formatters                           :story:
...
- update the path derivatives factory to take in the formatters'
  container; look up the formatter and generate the path derivatives.
- remove =file_types=.
...
*** Remove formattable origin type                                    :story:

This should not be in use any longer so remove it.
