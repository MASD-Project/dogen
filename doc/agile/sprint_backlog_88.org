...
#+CAPTION: Clock summary at [2016-09-13 Tue 22:27]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *12:29* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 12:29   |       |      | 100.0 |
| Active                                                                      |         | 12:29 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 2:00 |  16.0 |
| COMPLETED Fix chocolatey warning                                            |         |       | 0:08 |   1.1 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:27 |   3.6 |
| COMPLETED Analysis on current state of file path generation                 |         |       | 0:57 |   7.6 |
| CANCELLED Remove inclusion dependencies builder factory                     |         |       | 0:14 |   1.9 |
| COMPLETED Analysis on formatters, elements and extensibility                |         |       | 1:18 |  10.4 |
| COMPLETED Refactor =inclusion_dependencies_provider_interface=              |         |       | 1:12 |   9.6 |
| STARTED Refactor path derivatives factory for usage in formatters           |         |       | 3:15 |  26.0 |
| STARTED Move file path generation to formatters                             |         |       | 1:58 |  15.8 |
