...
#+CAPTION: Clock summary at [2016-09-25 Sun 11:45]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *88:21* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 88:21   |       |       | 100.0 |
| Active                                                                      |         | 88:21 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  4:10 |   4.7 |
...
| COMPLETED Refactor path derivatives factory for usage in formatters         |         |       |  5:14 |   5.9 |
| COMPLETED Move file path generation to formatters                           |         |       |  1:58 |   2.2 |
| CANCELLED Path derivatives factory generates all possible includes          |         |       |  3:07 |   3.5 |
...
| COMPLETED Use providers when building inclusion directives                  |         |       | 12:01 |  13.6 |
...
| COMPLETED Add facet folder and formatter enablement to formatter properties |         |       |  2:52 |   3.2 |
| COMPLETED Move =cmakelists_info= to fabric                                  |         |       |  6:34 |   7.4 |
| COMPLETED Move =odb_options_info= to fabric                                 |         |       |  1:29 |   1.7 |
| COMPLETED Remove =formattable_origin_type=                                  |         |       |  0:17 |   0.3 |
| COMPLETED Remove formattable origin type                                    |         |       |  2:25 |   2.7 |
...
| COMPLETED Consider merging provider interface with file formatter           |         |       |  9:26 |  10.7 |
| COMPLETED Add type index to name and to formatter interface                 |         |       |  5:41 |   6.4 |
...
| STARTED Add includer to quilt.cpp                                           |         |       |  1:17 |   1.5 |
