...
#+CAPTION: Clock summary at [2016-09-13 Tue 10:35]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
...
| Stories                                                                     | 8:30   |      |      | 100.0 |
| Active                                                                      |        | 8:30 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 1:19 |  15.5 |
| COMPLETED Fix chocolatey warning                                            |        |      | 0:08 |   1.6 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 0:27 |   5.3 |
| COMPLETED Analysis on current state of file path generation                 |        |      | 0:57 |  11.2 |
| CANCELLED Remove inclusion dependencies builder factory                     |        |      | 0:14 |   2.7 |
| COMPLETED Analysis on formatters, elements and extensibility                |        |      | 1:18 |  15.3 |
| COMPLETED Refactor =inclusion_dependencies_provider_interface=              |        |      | 1:12 |  14.1 |
| STARTED Refactor path derivatives factory for usage in formatters           |        |      | 1:31 |  17.8 |
| STARTED Move file path generation to formatters                             |        |      | 0:24 |   4.7 |
| STARTED Path derivatives factory generates all possible includes            |        |      | 0:44 |   8.6 |
| STARTED Remove formattable origin type                                      |        |      | 0:16 |   3.1 |
