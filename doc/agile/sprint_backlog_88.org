...
#+CAPTION: Clock summary at [2016-09-23 Fri 21:52]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *78:34* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 78:34   |       |       | 100.0 |
| Active                                                                      |         | 78:34 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  3:53 |   4.9 |
...
| COMPLETED Refactor path derivatives factory for usage in formatters         |         |       |  5:14 |   6.7 |
...
| COMPLETED Use providers when building inclusion directives                  |         |       | 12:01 |  15.3 |
...
| COMPLETED Move =cmakelists_info= to fabric                                  |         |       |  6:34 |   8.4 |
...
| COMPLETED Consider merging provider interface with file formatter           |         |       |  9:26 |  12.0 |
| COMPLETED Add type index to name and to formatter interface                 |         |       |  5:41 |   7.2 |
| COMPLETED Rename formattables properties to configuration                   |         |       |  1:04 |   1.4 |
