...
#+CAPTION: Clock summary at [2016-09-25 Sun 00:38]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *85:24* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 85:24   |       |       | 100.0 |
| Active                                                                      |         | 85:24 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  3:53 |   4.5 |
| COMPLETED Fix chocolatey warning                                            |         |       |  0:08 |   0.2 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:27 |   0.5 |
| COMPLETED Analysis on current state of file path generation                 |         |       |  0:57 |   1.1 |
| CANCELLED Remove inclusion dependencies builder factory                     |         |       |  0:14 |   0.3 |
| COMPLETED Analysis on formatters, elements and extensibility                |         |       |  1:18 |   1.5 |
| COMPLETED Refactor =inclusion_dependencies_provider_interface=              |         |       |  1:12 |   1.4 |
| COMPLETED Investigate broken windows builds                                 |         |       |  0:32 |   0.6 |
| COMPLETED Refactor path derivatives factory for usage in formatters         |         |       |  5:14 |   6.1 |
| COMPLETED Move file path generation to formatters                           |         |       |  1:58 |   2.3 |
| CANCELLED Path derivatives factory generates all possible includes          |         |       |  3:07 |   3.6 |
| COMPLETED Analysis on inclusion derivatives and path derivatives            |         |       |  1:04 |   1.2 |
| COMPLETED Split path factory from provider factory                          |         |       |  2:32 |   3.0 |
| COMPLETED Use providers when building inclusion directives                  |         |       | 12:01 |  14.1 |
| COMPLETED Fix AppVeyor notifications                                        |         |       |  0:22 |   0.4 |
| COMPLETED Static use of element types does more harm than good              |         |       |  0:32 |   0.6 |
| COMPLETED Analysis: major rethink of the implementation of quilt            |         |       |  1:30 |   1.8 |
| CANCELLED Create a simple Emacs mode for stitch                             |         |       |  1:12 |   1.4 |
| COMPLETED Add facet folder and formatter enablement to formatter properties |         |       |  2:52 |   3.4 |
| COMPLETED Move =cmakelists_info= to fabric                                  |         |       |  6:34 |   7.7 |
| COMPLETED Move =odb_options_info= to fabric                                 |         |       |  1:29 |   1.7 |
| COMPLETED Remove =formattable_origin_type=                                  |         |       |  0:17 |   0.3 |
| COMPLETED Remove formattable origin type                                    |         |       |  2:25 |   2.8 |
| COMPLETED Rename config model to options                                    |         |       |  1:07 |   1.3 |
...
| COMPLETED Big rename for "final" terminology clean up                       |         |       |  2:19 |   2.7 |
| COMPLETED Tidy-up file configuration in formatters                          |         |       |  3:03 |   3.6 |
...
| COMPLETED Consider merging provider interface with file formatter           |         |       |  9:26 |  11.0 |
| COMPLETED Add type index to name and to formatter interface                 |         |       |  5:41 |   6.7 |
...
| COMPLETED Add transformer to quilt.cpp                                      |         |       |  1:28 |   1.7 |
| STARTED Add enabler to quilt.cpp                                            |         |       |  4:36 |   5.4 |
| Add formattable element                                                     |         |       |  0:21 |   0.4 |
...
*** STARTED Add enabler to quilt.cpp                                  :story:
