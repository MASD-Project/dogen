...
#+CAPTION: Clock summary at [2016-09-13 Tue 11:05]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
...
| Stories                                                                     | 8:59   |      |      | 100.0 |
| Active                                                                      |        | 8:59 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 1:19 |  14.7 |
| COMPLETED Fix chocolatey warning                                            |        |      | 0:08 |   1.5 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 0:27 |   5.0 |
| COMPLETED Analysis on current state of file path generation                 |        |      | 0:57 |  10.6 |
| CANCELLED Remove inclusion dependencies builder factory                     |        |      | 0:14 |   2.6 |
| COMPLETED Analysis on formatters, elements and extensibility                |        |      | 1:18 |  14.5 |
| COMPLETED Refactor =inclusion_dependencies_provider_interface=              |        |      | 1:12 |  13.4 |
| STARTED Refactor path derivatives factory for usage in formatters           |        |      | 2:00 |  22.3 |
| STARTED Move file path generation to formatters                             |        |      | 0:24 |   4.5 |
| STARTED Path derivatives factory generates all possible includes            |        |      | 0:44 |   8.2 |
| STARTED Remove formattable origin type                                      |        |      | 0:16 |   3.0 |
