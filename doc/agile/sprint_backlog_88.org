...
#+CAPTION: Clock summary at [2016-09-24 Sat 13:09]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *80:48* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 80:48   |       |       | 100.0 |
| Active                                                                      |         | 80:48 |       | 100.0 |
...
| COMPLETED Split path factory from provider factory                          |         |       |  2:32 |   3.1 |
| COMPLETED Use providers when building inclusion directives                  |         |       | 12:01 |  14.9 |
...
| COMPLETED Add facet folder and formatter enablement to formatter properties |         |       |  2:52 |   3.5 |
| COMPLETED Move =cmakelists_info= to fabric                                  |         |       |  6:34 |   8.1 |
...
| COMPLETED Consider merging provider interface with file formatter           |         |       |  9:26 |  11.7 |
| COMPLETED Add type index to name and to formatter interface                 |         |       |  5:41 |   7.0 |
