...
#+CAPTION: Clock summary at [2016-09-14 Wed 12:27]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *16:25* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 16:25   |       |      | 100.0 |
| Active                                                                      |         | 16:25 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 2:00 |  12.2 |
| COMPLETED Fix chocolatey warning                                            |         |       | 0:08 |   0.8 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:27 |   2.7 |
| COMPLETED Analysis on current state of file path generation                 |         |       | 0:57 |   5.8 |
| CANCELLED Remove inclusion dependencies builder factory                     |         |       | 0:14 |   1.4 |
| COMPLETED Analysis on formatters, elements and extensibility                |         |       | 1:18 |   7.9 |
| COMPLETED Refactor =inclusion_dependencies_provider_interface=              |         |       | 1:12 |   7.3 |
| COMPLETED Investigate broken windows builds                                 |         |       | 0:32 |   3.2 |
| STARTED Refactor path derivatives factory for usage in formatters           |         |       | 5:14 |  31.9 |
| STARTED Move file path generation to formatters                             |         |       | 1:58 |  12.0 |
| STARTED Path derivatives factory generates all possible includes            |         |       | 2:09 |  13.1 |
| STARTED Remove formattable origin type                                      |         |       | 0:16 |   1.6 |
