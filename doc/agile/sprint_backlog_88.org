...
#+CAPTION: Clock summary at [2016-09-18 Sun 11:13]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *41:10* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 41:10   |       |       | 100.0 |
| Active                                                                      |         | 41:10 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  2:34 |   6.2 |
| COMPLETED Fix chocolatey warning                                            |         |       |  0:08 |   0.3 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:27 |   1.1 |
| COMPLETED Analysis on current state of file path generation                 |         |       |  0:57 |   2.3 |
...
| COMPLETED Refactor =inclusion_dependencies_provider_interface=              |         |       |  1:12 |   2.9 |
| COMPLETED Investigate broken windows builds                                 |         |       |  0:32 |   1.3 |
| COMPLETED Refactor path derivatives factory for usage in formatters         |         |       |  5:14 |  12.7 |
| COMPLETED Move file path generation to formatters                           |         |       |  1:58 |   4.8 |
| CANCELLED Path derivatives factory generates all possible includes          |         |       |  3:07 |   7.6 |
| COMPLETED Analysis on inclusion derivatives and path derivatives            |         |       |  1:04 |   2.6 |
| COMPLETED Split path factory from provider factory                          |         |       |  2:32 |   6.2 |
| COMPLETED Use providers when building inclusion directives                  |         |       | 12:01 |  29.2 |
| COMPLETED Fix AppVeyor notifications                                        |         |       |  0:22 |   0.9 |
| COMPLETED Static use of element types does more harm than good              |         |       |  0:32 |   1.3 |
| COMPLETED Analysis: major rethink of the implementation of quilt            |         |       |  1:30 |   3.6 |
| STARTED Terminology clean up                                                |         |       |  0:02 |   0.1 |
| STARTED Remove formattable origin type                                      |         |       |  2:25 |   5.9 |
| STARTED Move =cmakelists_info= to fabric                                    |         |       |  3:01 |   7.3 |
