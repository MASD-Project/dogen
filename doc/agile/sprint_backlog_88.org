...
#+CAPTION: Clock summary at [2016-09-15 Thu 10:11]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *19:49* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 19:49   |       |      | 100.0 |
| Active                                                                      |         | 19:49 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 2:13 |  11.2 |
| COMPLETED Fix chocolatey warning                                            |         |       | 0:08 |   0.7 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:27 |   2.3 |
| COMPLETED Analysis on current state of file path generation                 |         |       | 0:57 |   4.8 |
| CANCELLED Remove inclusion dependencies builder factory                     |         |       | 0:14 |   1.2 |
| COMPLETED Analysis on formatters, elements and extensibility                |         |       | 1:18 |   6.6 |
| COMPLETED Refactor =inclusion_dependencies_provider_interface=              |         |       | 1:12 |   6.1 |
| COMPLETED Investigate broken windows builds                                 |         |       | 0:32 |   2.7 |
| COMPLETED Refactor path derivatives factory for usage in formatters         |         |       | 5:14 |  26.4 |
| COMPLETED Move file path generation to formatters                           |         |       | 1:58 |   9.9 |
| CANCELLED Path derivatives factory generates all possible includes          |         |       | 3:07 |  15.7 |
| COMPLETED Analysis on inclusion derivatives and path derivatives            |         |       | 1:04 |   5.4 |
| STARTED Split path factory from provider factory                            |         |       | 1:09 |   5.8 |
