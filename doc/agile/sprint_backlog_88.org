...
#+CAPTION: Clock summary at [2016-09-18 Sun 12:35]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *42:28* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 42:28   |       |       | 100.0 |
| Active                                                                      |         | 42:28 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  2:34 |   6.0 |
...
| COMPLETED Analysis on formatters, elements and extensibility                |         |       |  1:18 |   3.1 |
| COMPLETED Refactor =inclusion_dependencies_provider_interface=              |         |       |  1:12 |   2.8 |
| COMPLETED Investigate broken windows builds                                 |         |       |  0:32 |   1.3 |
| COMPLETED Refactor path derivatives factory for usage in formatters         |         |       |  5:14 |  12.3 |
| COMPLETED Move file path generation to formatters                           |         |       |  1:58 |   4.6 |
| CANCELLED Path derivatives factory generates all possible includes          |         |       |  3:07 |   7.3 |
| COMPLETED Analysis on inclusion derivatives and path derivatives            |         |       |  1:04 |   2.5 |
| COMPLETED Split path factory from provider factory                          |         |       |  2:32 |   6.0 |
| COMPLETED Use providers when building inclusion directives                  |         |       | 12:01 |  28.3 |
| COMPLETED Fix AppVeyor notifications                                        |         |       |  0:22 |   0.9 |
| COMPLETED Static use of element types does more harm than good              |         |       |  0:32 |   1.3 |
| COMPLETED Analysis: major rethink of the implementation of quilt            |         |       |  1:30 |   3.5 |
| CANCELLED Create a simple Emacs mode for stitch                             |         |       |  1:12 |   2.8 |
| STARTED Terminology clean up                                                |         |       |  0:02 |   0.1 |
| STARTED Remove formattable origin type                                      |         |       |  2:25 |   5.7 |
| STARTED Move =cmakelists_info= to fabric                                    |         |       |  3:07 |   7.3 |
