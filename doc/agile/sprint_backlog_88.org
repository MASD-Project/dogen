...
#+CAPTION: Clock summary at [2016-09-20 Tue 20:39]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *50:16* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 50:16   |       |       | 100.0 |
| Active                                                                      |         | 50:16 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  2:34 |   5.1 |
| COMPLETED Fix chocolatey warning                                            |         |       |  0:08 |   0.3 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:27 |   0.9 |
| COMPLETED Analysis on current state of file path generation                 |         |       |  0:57 |   1.9 |
| CANCELLED Remove inclusion dependencies builder factory                     |         |       |  0:14 |   0.5 |
| COMPLETED Analysis on formatters, elements and extensibility                |         |       |  1:18 |   2.6 |
| COMPLETED Refactor =inclusion_dependencies_provider_interface=              |         |       |  1:12 |   2.4 |
| COMPLETED Investigate broken windows builds                                 |         |       |  0:32 |   1.1 |
| COMPLETED Refactor path derivatives factory for usage in formatters         |         |       |  5:14 |  10.4 |
| COMPLETED Move file path generation to formatters                           |         |       |  1:58 |   3.9 |
| CANCELLED Path derivatives factory generates all possible includes          |         |       |  3:07 |   6.2 |
| COMPLETED Analysis on inclusion derivatives and path derivatives            |         |       |  1:04 |   2.1 |
| COMPLETED Split path factory from provider factory                          |         |       |  2:32 |   5.0 |
| COMPLETED Use providers when building inclusion directives                  |         |       | 12:01 |  23.9 |
| COMPLETED Fix AppVeyor notifications                                        |         |       |  0:22 |   0.7 |
| COMPLETED Static use of element types does more harm than good              |         |       |  0:32 |   1.1 |
| COMPLETED Analysis: major rethink of the implementation of quilt            |         |       |  1:30 |   3.0 |
| CANCELLED Create a simple Emacs mode for stitch                             |         |       |  1:12 |   2.4 |
| COMPLETED Add facet folder and formatter enablement to formatter properties |         |       |  2:52 |   5.7 |
| COMPLETED Move =cmakelists_info= to fabric                                  |         |       |  6:34 |  13.1 |
| STARTED Terminology clean up                                                |         |       |  0:02 |   0.1 |
| STARTED Remove formattable origin type                                      |         |       |  2:25 |   4.8 |
| STARTED Move =odb_options_info= to fabric                                   |         |       |  1:29 |   3.0 |
...
*** STARTED Move =odb_options_info= to fabric                         :story:
