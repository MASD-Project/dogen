...
#+CAPTION: Clock summary at [2016-09-14 Wed 08:22]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *12:45* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 12:45   |       |      | 100.0 |
| Active                                                                      |         | 12:45 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 2:00 |  15.7 |
| COMPLETED Fix chocolatey warning                                            |         |       | 0:08 |   1.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:27 |   3.5 |
| COMPLETED Analysis on current state of file path generation                 |         |       | 0:57 |   7.5 |
| CANCELLED Remove inclusion dependencies builder factory                     |         |       | 0:14 |   1.8 |
| COMPLETED Analysis on formatters, elements and extensibility                |         |       | 1:18 |  10.2 |
| COMPLETED Refactor =inclusion_dependencies_provider_interface=              |         |       | 1:12 |   9.4 |
| STARTED Investigate broken windows builds                                   |         |       | 0:16 |   2.1 |
| STARTED Refactor path derivatives factory for usage in formatters           |         |       | 3:15 |  25.5 |
| STARTED Move file path generation to formatters                             |         |       | 1:58 |  15.4 |
| STARTED Path derivatives factory generates all possible includes            |         |       | 0:44 |   5.8 |
| STARTED Remove formattable origin type                                      |         |       | 0:16 |   2.1 |
...
*** STARTED Investigate broken windows builds                         :story:
...
*** STARTED Refactor path derivatives factory for usage in formatters :story:
...
*** STARTED Move file path generation to formatters                   :story:
...
*** STARTED Path derivatives factory generates all possible includes  :story:
