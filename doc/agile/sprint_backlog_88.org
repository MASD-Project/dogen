...
#+CAPTION: Clock summary at [2016-09-12 Mon 22:03]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
...
| Stories                                                                     | 6:41   |      |      | 100.0 |
| Active                                                                      |        | 6:41 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 1:19 |  19.7 |
| COMPLETED Fix chocolatey warning                                            |        |      | 0:08 |   2.0 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 0:27 |   6.7 |
| COMPLETED Analysis on current state of file path generation                 |        |      | 0:57 |  14.2 |
| CANCELLED Remove inclusion dependencies builder factory                     |        |      | 0:14 |   3.5 |
| COMPLETED Analysis on formatters, elements and extensibility                |        |      | 1:18 |  19.5 |
| STARTED Refactor path derivatives factory for usage in formatters           |        |      | 0:54 |  13.5 |
| STARTED Move file path generation to formatters                             |        |      | 0:24 |   6.0 |
| STARTED Path derivatives factory generates all possible includes            |        |      | 0:44 |  11.0 |
| STARTED Remove formattable origin type                                      |        |      | 0:16 |   4.0 |
...
*** Refactor =inclusion_dependencies_provider_interface=              :story:
