...
#+CAPTION: Clock summary at [2016-09-22 Thu 23:51]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *70:56* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 70:56   |       |       | 100.0 |
| Active                                                                      |         | 70:56 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  3:53 |   5.5 |
...
| COMPLETED Refactor =inclusion_dependencies_provider_interface=              |         |       |  1:12 |   1.7 |
| COMPLETED Investigate broken windows builds                                 |         |       |  0:32 |   0.8 |
| COMPLETED Refactor path derivatives factory for usage in formatters         |         |       |  5:14 |   7.4 |
| COMPLETED Move file path generation to formatters                           |         |       |  1:58 |   2.8 |
| CANCELLED Path derivatives factory generates all possible includes          |         |       |  3:07 |   4.4 |
| COMPLETED Analysis on inclusion derivatives and path derivatives            |         |       |  1:04 |   1.5 |
| COMPLETED Split path factory from provider factory                          |         |       |  2:32 |   3.6 |
| COMPLETED Use providers when building inclusion directives                  |         |       | 12:01 |  16.9 |
| COMPLETED Fix AppVeyor notifications                                        |         |       |  0:22 |   0.5 |
| COMPLETED Static use of element types does more harm than good              |         |       |  0:32 |   0.8 |
| COMPLETED Analysis: major rethink of the implementation of quilt            |         |       |  1:30 |   2.1 |
| CANCELLED Create a simple Emacs mode for stitch                             |         |       |  1:12 |   1.7 |
| COMPLETED Add facet folder and formatter enablement to formatter properties |         |       |  2:52 |   4.0 |
| COMPLETED Move =cmakelists_info= to fabric                                  |         |       |  6:34 |   9.3 |
| COMPLETED Move =odb_options_info= to fabric                                 |         |       |  1:29 |   2.1 |
| COMPLETED Remove =formattable_origin_type=                                  |         |       |  0:17 |   0.4 |
| COMPLETED Remove formattable origin type                                    |         |       |  2:25 |   3.4 |
| COMPLETED Rename config model to options                                    |         |       |  1:07 |   1.6 |
...
| COMPLETED Big rename for "final" terminology clean up                       |         |       |  2:19 |   3.3 |
| COMPLETED Tidy-up file configuration in formatters                          |         |       |  3:03 |   4.3 |
...
| COMPLETED Do a cursory investigation of dia plugin support                  |         |       |  0:49 |   1.2 |
| STARTED Consider merging provider interface with file formatter             |         |       |  3:16 |   4.6 |
| STARTED Add type index to name and to formatter interface                   |         |       |  5:36 |   7.9 |
