...
#+CAPTION: Clock summary at [2016-09-20 Tue 14:15]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *49:17* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 49:17   |       |       | 100.0 |
| Active                                                                      |         | 49:17 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  2:34 |   5.2 |
...
| COMPLETED Refactor path derivatives factory for usage in formatters         |         |       |  5:14 |  10.6 |
| COMPLETED Move file path generation to formatters                           |         |       |  1:58 |   4.0 |
| CANCELLED Path derivatives factory generates all possible includes          |         |       |  3:07 |   6.3 |
| COMPLETED Analysis on inclusion derivatives and path derivatives            |         |       |  1:04 |   2.2 |
| COMPLETED Split path factory from provider factory                          |         |       |  2:32 |   5.1 |
| COMPLETED Use providers when building inclusion directives                  |         |       | 12:01 |  24.4 |
...
| COMPLETED Add facet folder and formatter enablement to formatter properties |         |       |  2:52 |   5.8 |
| COMPLETED Move =cmakelists_info= to fabric                                  |         |       |  6:34 |  13.3 |
| STARTED Terminology clean up                                                |         |       |  0:02 |   0.1 |
| STARTED Remove formattable origin type                                      |         |       |  2:25 |   4.9 |
| STARTED Move =odb_options_info= to fabric                                   |         |       |  0:30 |   1.0 |
