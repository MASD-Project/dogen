...
#+CAPTION: Clock summary at [2016-09-13 Tue 22:17]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *12:20* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 12:20   |       |      | 100.0 |
| Active                                                                      |         | 12:20 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 2:00 |  16.2 |
| COMPLETED Fix chocolatey warning                                            |         |       | 0:08 |   1.1 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:27 |   3.6 |
| COMPLETED Analysis on current state of file path generation                 |         |       | 0:57 |   7.7 |
| CANCELLED Remove inclusion dependencies builder factory                     |         |       | 0:14 |   1.9 |
| COMPLETED Analysis on formatters, elements and extensibility                |         |       | 1:18 |  10.5 |
| COMPLETED Refactor =inclusion_dependencies_provider_interface=              |         |       | 1:12 |   9.7 |
| STARTED Refactor path derivatives factory for usage in formatters           |         |       | 3:15 |  26.4 |
| STARTED Move file path generation to formatters                             |         |       | 1:49 |  14.7 |
| STARTED Path derivatives factory generates all possible includes            |         |       | 0:44 |   5.9 |
| STARTED Remove formattable origin type                                      |         |       | 0:16 |   2.2 |
