...
#+CAPTION: Clock summary at [2016-09-19 Mon 10:32]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *43:41* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 43:41   |       |       | 100.0 |
| Active                                                                      |         | 43:41 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  2:34 |   5.9 |
| COMPLETED Fix chocolatey warning                                            |         |       |  0:08 |   0.3 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:27 |   1.0 |
| COMPLETED Analysis on current state of file path generation                 |         |       |  0:57 |   2.2 |
| CANCELLED Remove inclusion dependencies builder factory                     |         |       |  0:14 |   0.5 |
| COMPLETED Analysis on formatters, elements and extensibility                |         |       |  1:18 |   3.0 |
| COMPLETED Refactor =inclusion_dependencies_provider_interface=              |         |       |  1:12 |   2.7 |
| COMPLETED Investigate broken windows builds                                 |         |       |  0:32 |   1.2 |
| COMPLETED Refactor path derivatives factory for usage in formatters         |         |       |  5:14 |  12.0 |
| COMPLETED Move file path generation to formatters                           |         |       |  1:58 |   4.5 |
| CANCELLED Path derivatives factory generates all possible includes          |         |       |  3:07 |   7.1 |
| COMPLETED Analysis on inclusion derivatives and path derivatives            |         |       |  1:04 |   2.4 |
| COMPLETED Split path factory from provider factory                          |         |       |  2:32 |   5.8 |
| COMPLETED Use providers when building inclusion directives                  |         |       | 12:01 |  27.5 |
| COMPLETED Fix AppVeyor notifications                                        |         |       |  0:22 |   0.8 |
| COMPLETED Static use of element types does more harm than good              |         |       |  0:32 |   1.2 |
| COMPLETED Analysis: major rethink of the implementation of quilt            |         |       |  1:30 |   3.4 |
| CANCELLED Create a simple Emacs mode for stitch                             |         |       |  1:12 |   2.7 |
| STARTED Terminology clean up                                                |         |       |  0:02 |   0.1 |
| STARTED Remove formattable origin type                                      |         |       |  2:25 |   5.5 |
| STARTED Move =cmakelists_info= to fabric                                    |         |       |  3:18 |   7.6 |
| STARTED Add facet folder and formatter enablement to formatter properties   |         |       |  1:02 |   2.4 |
...
*** STARTED Add facet folder and formatter enablement to formatter properties :story:
