...
#+CAPTION: Clock summary at [2016-09-25 Sun 09:24]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *86:47* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 86:47   |       |       | 100.0 |
| Active                                                                      |         | 86:47 |       | 100.0 |
...
| COMPLETED Refactor path derivatives factory for usage in formatters         |         |       |  5:14 |   6.0 |
...
| COMPLETED Split path factory from provider factory                          |         |       |  2:32 |   2.9 |
| COMPLETED Use providers when building inclusion directives                  |         |       | 12:01 |  13.8 |
| COMPLETED Fix AppVeyor notifications                                        |         |       |  0:22 |   0.4 |
| COMPLETED Static use of element types does more harm than good              |         |       |  0:32 |   0.6 |
| COMPLETED Analysis: major rethink of the implementation of quilt            |         |       |  1:30 |   1.7 |
| CANCELLED Create a simple Emacs mode for stitch                             |         |       |  1:12 |   1.4 |
| COMPLETED Add facet folder and formatter enablement to formatter properties |         |       |  2:52 |   3.3 |
| COMPLETED Move =cmakelists_info= to fabric                                  |         |       |  6:34 |   7.6 |
...
| COMPLETED Tidy-up file configuration in formatters                          |         |       |  3:03 |   3.5 |
...
| COMPLETED Consider merging provider interface with file formatter           |         |       |  9:26 |  10.9 |
| COMPLETED Add type index to name and to formatter interface                 |         |       |  5:41 |   6.5 |
...
| COMPLETED Add enabler to quilt.cpp                                          |         |       |  5:59 |   6.9 |
