...
#+CAPTION: Clock summary at [2016-09-13 Tue 12:01]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *9:50* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 9:50   |      |      | 100.0 |
| Active                                                                      |        | 9:50 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 1:19 |  13.4 |
| COMPLETED Fix chocolatey warning                                            |        |      | 0:08 |   1.4 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 0:27 |   4.6 |
| COMPLETED Analysis on current state of file path generation                 |        |      | 0:57 |   9.7 |
| CANCELLED Remove inclusion dependencies builder factory                     |        |      | 0:14 |   2.4 |
| COMPLETED Analysis on formatters, elements and extensibility                |        |      | 1:18 |  13.2 |
| COMPLETED Refactor =inclusion_dependencies_provider_interface=              |        |      | 1:12 |  12.2 |
| STARTED Refactor path derivatives factory for usage in formatters           |        |      | 2:51 |  29.0 |
| STARTED Move file path generation to formatters                             |        |      | 0:24 |   4.1 |
| STARTED Path derivatives factory generates all possible includes            |        |      | 0:44 |   7.5 |
| STARTED Remove formattable origin type                                      |        |      | 0:16 |   2.7 |
