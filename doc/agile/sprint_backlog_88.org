...
#+CAPTION: Clock summary at [2016-09-14 Wed 21:49]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *18:03* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 18:03   |       |      | 100.0 |
| Active                                                                      |         | 18:03 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 2:00 |  11.1 |
| COMPLETED Fix chocolatey warning                                            |         |       | 0:08 |   0.7 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:27 |   2.5 |
| COMPLETED Analysis on current state of file path generation                 |         |       | 0:57 |   5.3 |
| CANCELLED Remove inclusion dependencies builder factory                     |         |       | 0:14 |   1.3 |
| COMPLETED Analysis on formatters, elements and extensibility                |         |       | 1:18 |   7.2 |
| COMPLETED Refactor =inclusion_dependencies_provider_interface=              |         |       | 1:12 |   6.6 |
| COMPLETED Investigate broken windows builds                                 |         |       | 0:32 |   3.0 |
| COMPLETED Refactor path derivatives factory for usage in formatters         |         |       | 5:14 |  29.0 |
| COMPLETED Move file path generation to formatters                           |         |       | 1:58 |  10.9 |
| CANCELLED Path derivatives factory generates all possible includes          |         |       | 3:07 |  17.3 |
| STARTED Analysis on inclusion derivatives and path derivatives              |         |       | 0:40 |   3.7 |
| STARTED Remove formattable origin type                                      |         |       | 0:16 |   1.5 |
...
*** STARTED Analysis on inclusion derivatives and path derivatives    :story:
