...
#+CAPTION: Clock summary at [2016-09-20 Tue 22:50]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *52:10* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 52:10   |       |       | 100.0 |
| Active                                                                      |         | 52:10 |       | 100.0 |
...
| COMPLETED Move file path generation to formatters                           |         |       |  1:58 |   3.8 |
| CANCELLED Path derivatives factory generates all possible includes          |         |       |  3:07 |   6.0 |
| COMPLETED Analysis on inclusion derivatives and path derivatives            |         |       |  1:04 |   2.0 |
| COMPLETED Split path factory from provider factory                          |         |       |  2:32 |   4.9 |
| COMPLETED Use providers when building inclusion directives                  |         |       | 12:01 |  23.0 |
...
| COMPLETED Move =cmakelists_info= to fabric                                  |         |       |  6:34 |  12.6 |
