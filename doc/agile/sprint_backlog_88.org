...
#+CAPTION: Clock summary at [2016-09-21 Wed 14:44]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *57:23* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 57:23   |       |       | 100.0 |
| Active                                                                      |         | 57:23 |       | 100.0 |
...
| COMPLETED Refactor path derivatives factory for usage in formatters         |         |       |  5:14 |   9.1 |
| COMPLETED Move file path generation to formatters                           |         |       |  1:58 |   3.4 |
| CANCELLED Path derivatives factory generates all possible includes          |         |       |  3:07 |   5.4 |
...
| COMPLETED Use providers when building inclusion directives                  |         |       | 12:01 |  20.9 |
...
| COMPLETED Move =cmakelists_info= to fabric                                  |         |       |  6:34 |  11.4 |
...
| STARTED Big rename for "final" terminology clean up                         |         |       |  2:19 |   4.0 |
