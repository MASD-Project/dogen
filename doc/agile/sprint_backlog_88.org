...
#+CAPTION: Clock summary at [2016-09-20 Tue 22:11]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *51:40* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 51:40   |       |       | 100.0 |
| Active                                                                      |         | 51:40 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  2:34 |   5.0 |
...
| COMPLETED Refactor path derivatives factory for usage in formatters         |         |       |  5:14 |  10.1 |
...
| COMPLETED Analysis on inclusion derivatives and path derivatives            |         |       |  1:04 |   2.1 |
| COMPLETED Split path factory from provider factory                          |         |       |  2:32 |   4.9 |
| COMPLETED Use providers when building inclusion directives                  |         |       | 12:01 |  23.3 |
...
| COMPLETED Move =cmakelists_info= to fabric                                  |         |       |  6:34 |  12.7 |
| COMPLETED Move =odb_options_info= to fabric                                 |         |       |  1:29 |   2.9 |
| COMPLETED Remove =formattable_origin_type=                                  |         |       |  0:17 |   0.5 |
| COMPLETED Remove formattable origin type                                    |         |       |  2:25 |   4.7 |
| COMPLETED Rename config model to options                                    |         |       |  1:07 |   2.2 |
