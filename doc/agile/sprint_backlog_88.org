...
#+CAPTION: Clock summary at [2016-09-12 Mon 12:22]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *3:57* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 3:57   |      |      | 100.0 |
| Active                                                                      |        | 3:57 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 1:10 |  29.5 |
| COMPLETED Fix chocolatey warning                                            |        |      | 0:08 |   3.4 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 0:27 |  11.4 |
| COMPLETED Analysis on current state of file path generation                 |        |      | 0:57 |  24.1 |
| STARTED Remove formattable origin type                                      |        |      | 0:16 |   6.8 |
| STARTED Refactor path derivatives factory for usage in formatters           |        |      | 0:35 |  14.8 |
| STARTED Move file path generation to formatters                             |        |      | 0:24 |  10.1 |
...
- change initialiser to register the include providers.
- remove registration from formatter interface.
