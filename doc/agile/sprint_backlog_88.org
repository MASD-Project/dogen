...
#+CAPTION: Clock summary at [2016-09-17 Sat 20:25]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *38:26* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 38:26   |       |       | 100.0 |
| Active                                                                      |         | 38:26 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  2:34 |   6.7 |
| COMPLETED Fix chocolatey warning                                            |         |       |  0:08 |   0.3 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:27 |   1.2 |
| COMPLETED Analysis on current state of file path generation                 |         |       |  0:57 |   2.5 |
| CANCELLED Remove inclusion dependencies builder factory                     |         |       |  0:14 |   0.6 |
| COMPLETED Analysis on formatters, elements and extensibility                |         |       |  1:18 |   3.4 |
| COMPLETED Refactor =inclusion_dependencies_provider_interface=              |         |       |  1:12 |   3.1 |
| COMPLETED Investigate broken windows builds                                 |         |       |  0:32 |   1.4 |
| COMPLETED Refactor path derivatives factory for usage in formatters         |         |       |  5:14 |  13.6 |
| COMPLETED Move file path generation to formatters                           |         |       |  1:58 |   5.1 |
| CANCELLED Path derivatives factory generates all possible includes          |         |       |  3:07 |   8.1 |
| COMPLETED Analysis on inclusion derivatives and path derivatives            |         |       |  1:04 |   2.8 |
| COMPLETED Split path factory from provider factory                          |         |       |  2:32 |   6.6 |
| COMPLETED Use providers when building inclusion directives                  |         |       | 12:01 |  31.3 |
| COMPLETED Fix AppVeyor notifications                                        |         |       |  0:22 |   1.0 |
| COMPLETED Static use of element types does more harm than good              |         |       |  0:32 |   1.4 |
| COMPLETED Analysis: major rethink of the implementation of quilt            |         |       |  1:30 |   3.9 |
| STARTED Terminology clean up                                                |         |       |  0:02 |   0.1 |
| STARTED Remove formattable origin type                                      |         |       |  2:25 |   6.3 |
| STARTED Move =cmakelists_info= to fabric                                    |         |       |  0:17 |   0.7 |
