...
#+CAPTION: Clock summary at [2016-09-23 Fri 11:52]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *72:30* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 72:30   |       |       | 100.0 |
| Active                                                                      |         | 72:30 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  3:53 |   5.4 |
...
| COMPLETED Refactor path derivatives factory for usage in formatters         |         |       |  5:14 |   7.2 |
...
| COMPLETED Use providers when building inclusion directives                  |         |       | 12:01 |  16.6 |
...
| COMPLETED Move =cmakelists_info= to fabric                                  |         |       |  6:34 |   9.1 |
...
| STARTED Consider merging provider interface with file formatter             |         |       |  4:50 |   6.7 |
| STARTED Add type index to name and to formatter interface                   |         |       |  5:36 |   7.7 |
