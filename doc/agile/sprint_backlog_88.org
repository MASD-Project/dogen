...
#+CAPTION: Clock summary at [2016-09-13 Tue 20:49]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *10:55* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 10:55   |       |      | 100.0 |
| Active                                                                      |         | 10:55 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 2:00 |  18.3 |
| COMPLETED Fix chocolatey warning                                            |         |       | 0:08 |   1.2 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:27 |   4.1 |
| COMPLETED Analysis on current state of file path generation                 |         |       | 0:57 |   8.7 |
| CANCELLED Remove inclusion dependencies builder factory                     |         |       | 0:14 |   2.1 |
| COMPLETED Analysis on formatters, elements and extensibility                |         |       | 1:18 |  11.9 |
| COMPLETED Refactor =inclusion_dependencies_provider_interface=              |         |       | 1:12 |  11.0 |
| STARTED Refactor path derivatives factory for usage in formatters           |         |       | 3:15 |  29.8 |
| STARTED Move file path generation to formatters                             |         |       | 0:24 |   3.7 |
| STARTED Path derivatives factory generates all possible includes            |         |       | 0:44 |   6.7 |
| STARTED Remove formattable origin type                                      |         |       | 0:16 |   2.4 |
