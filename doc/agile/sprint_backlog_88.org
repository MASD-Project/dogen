...
#+CAPTION: Clock summary at [2016-09-23 Fri 17:26]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *75:44* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 75:44   |       |       | 100.0 |
| Active                                                                      |         | 75:44 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  3:53 |   5.1 |
...
| COMPLETED Analysis on formatters, elements and extensibility                |         |       |  1:18 |   1.7 |
...
| COMPLETED Refactor path derivatives factory for usage in formatters         |         |       |  5:14 |   6.9 |
| COMPLETED Move file path generation to formatters                           |         |       |  1:58 |   2.6 |
| CANCELLED Path derivatives factory generates all possible includes          |         |       |  3:07 |   4.1 |
| COMPLETED Analysis on inclusion derivatives and path derivatives            |         |       |  1:04 |   1.4 |
| COMPLETED Split path factory from provider factory                          |         |       |  2:32 |   3.3 |
| COMPLETED Use providers when building inclusion directives                  |         |       | 12:01 |  15.9 |
...
| COMPLETED Add facet folder and formatter enablement to formatter properties |         |       |  2:52 |   3.8 |
| COMPLETED Move =cmakelists_info= to fabric                                  |         |       |  6:34 |   8.7 |
| COMPLETED Move =odb_options_info= to fabric                                 |         |       |  1:29 |   2.0 |
| COMPLETED Remove =formattable_origin_type=                                  |         |       |  0:17 |   0.4 |
| COMPLETED Remove formattable origin type                                    |         |       |  2:25 |   3.2 |
| COMPLETED Rename config model to options                                    |         |       |  1:07 |   1.5 |
| COMPLETED Rename annotation to decoration in formatters model               |         |       |  0:30 |   0.7 |
| COMPLETED Fix appveyor Visual Studio build                                  |         |       |  1:04 |   1.4 |
| COMPLETED Big rename for "final" terminology clean up                       |         |       |  2:19 |   3.1 |
| COMPLETED Tidy-up file configuration in formatters                          |         |       |  3:03 |   4.0 |
...
| STARTED Consider merging provider interface with file formatter             |         |       |  8:04 |  10.7 |
| STARTED Add type index to name and to formatter interface                   |         |       |  5:36 |   7.4 |
