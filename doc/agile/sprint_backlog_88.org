...
#+CAPTION: Clock summary at [2016-09-21 Wed 21:20]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *60:53* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 60:53   |       |       | 100.0 |
| Active                                                                      |         | 60:53 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  3:33 |   5.8 |
...
| COMPLETED Analysis on formatters, elements and extensibility                |         |       |  1:18 |   2.1 |
...
| COMPLETED Refactor path derivatives factory for usage in formatters         |         |       |  5:14 |   8.6 |
| COMPLETED Move file path generation to formatters                           |         |       |  1:58 |   3.2 |
| CANCELLED Path derivatives factory generates all possible includes          |         |       |  3:07 |   5.1 |
| COMPLETED Analysis on inclusion derivatives and path derivatives            |         |       |  1:04 |   1.8 |
| COMPLETED Split path factory from provider factory                          |         |       |  2:32 |   4.2 |
| COMPLETED Use providers when building inclusion directives                  |         |       | 12:01 |  19.7 |
...
| COMPLETED Add facet folder and formatter enablement to formatter properties |         |       |  2:52 |   4.7 |
| COMPLETED Move =cmakelists_info= to fabric                                  |         |       |  6:34 |  10.8 |
| COMPLETED Move =odb_options_info= to fabric                                 |         |       |  1:29 |   2.4 |
| COMPLETED Remove =formattable_origin_type=                                  |         |       |  0:17 |   0.5 |
| COMPLETED Remove formattable origin type                                    |         |       |  2:25 |   4.0 |
| COMPLETED Rename config model to options                                    |         |       |  1:07 |   1.8 |
...
| COMPLETED Big rename for "final" terminology clean up                       |         |       |  2:19 |   3.8 |
| COMPLETED Tidy-up file configuration in formatters                          |         |       |  3:03 |   5.0 |
| STARTED Stitch still uses "properties"                                      |         |       |  0:27 |   0.7 |
...
*** STARTED Stitch still uses "properties"                            :story:
...
*** Add a stitch prefix to stitch fields                              :story:
