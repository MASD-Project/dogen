...
#+CAPTION: Clock summary at [2016-09-14 Wed 10:30]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *14:32* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 14:32   |       |      | 100.0 |
| Active                                                                      |         | 14:32 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 2:00 |  13.8 |
| COMPLETED Fix chocolatey warning                                            |         |       | 0:08 |   0.9 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:27 |   3.1 |
| COMPLETED Analysis on current state of file path generation                 |         |       | 0:57 |   6.5 |
| CANCELLED Remove inclusion dependencies builder factory                     |         |       | 0:14 |   1.6 |
| COMPLETED Analysis on formatters, elements and extensibility                |         |       | 1:18 |   8.9 |
| COMPLETED Refactor =inclusion_dependencies_provider_interface=              |         |       | 1:12 |   8.3 |
| COMPLETED Investigate broken windows builds                                 |         |       | 0:32 |   3.7 |
| STARTED Refactor path derivatives factory for usage in formatters           |         |       | 4:46 |  32.8 |
| STARTED Move file path generation to formatters                             |         |       | 1:58 |  13.5 |
| STARTED Path derivatives factory generates all possible includes            |         |       | 0:44 |   5.0 |
| STARTED Remove formattable origin type                                      |         |       | 0:16 |   1.8 |
