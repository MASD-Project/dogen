...
#+CAPTION: Clock summary at [2016-09-24 Sat 19:43]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *83:30* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 83:30   |       |       | 100.0 |
| Active                                                                      |         | 83:30 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  3:53 |   4.7 |
...
| COMPLETED Refactor path derivatives factory for usage in formatters         |         |       |  5:14 |   6.3 |
| COMPLETED Move file path generation to formatters                           |         |       |  1:58 |   2.4 |
| CANCELLED Path derivatives factory generates all possible includes          |         |       |  3:07 |   3.7 |
...
| COMPLETED Use providers when building inclusion directives                  |         |       | 12:01 |  14.4 |
...
| COMPLETED Move =cmakelists_info= to fabric                                  |         |       |  6:34 |   7.9 |
| COMPLETED Move =odb_options_info= to fabric                                 |         |       |  1:29 |   1.8 |
| COMPLETED Remove =formattable_origin_type=                                  |         |       |  0:17 |   0.3 |
| COMPLETED Remove formattable origin type                                    |         |       |  2:25 |   2.9 |
...
| COMPLETED Big rename for "final" terminology clean up                       |         |       |  2:19 |   2.8 |
| COMPLETED Tidy-up file configuration in formatters                          |         |       |  3:03 |   3.7 |
...
| COMPLETED Consider merging provider interface with file formatter           |         |       |  9:26 |  11.3 |
| COMPLETED Add type index to name and to formatter interface                 |         |       |  5:41 |   6.8 |
...
| COMPLETED Add transformer to quilt.cpp                                      |         |       |  1:28 |   1.8 |
| STARTED Add enabler to quilt.cpp                                            |         |       |  2:42 |   3.2 |
