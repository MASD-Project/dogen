...
Clock summary at [2014-05-04 Sun 20:28]

| Headline                                                      | Time    |       |      |
|---------------------------------------------------------------+---------+-------+------|
| *Total time*                                                  | *16:35* |       |      |
|---------------------------------------------------------------+---------+-------+------|
| Development Stories Implemented                               |         | 16:35 |      |
...
| IMPLEMENTATION Use the =formatters= model in =cpp_formatters= |         |       | 3:25 |
...
*** IMPLEMENTATION Use the =formatters= model in =cpp_formatters=     :story:
