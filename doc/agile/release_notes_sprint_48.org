...
Clock summary at [2014-05-04 Sun 23:00]

| Headline                                                      | Time    |       |      |
|---------------------------------------------------------------+---------+-------+------|
| *Total time*                                                  | *18:41* |       |      |
|---------------------------------------------------------------+---------+-------+------|
| Development Stories Implemented                               |         | 18:41 |      |
...
| IMPLEMENTATION Use the =formatters= model in =cpp_formatters= |         |       | 5:31 |
...
**** IMPLEMENTATION Merge source file with entity                      :task:
...
**** =formatter::entity= should be renamed and use composition         :task:

Now that we don't have interfaces any more we can use composition
between the formatting entity and the c++ entity.
