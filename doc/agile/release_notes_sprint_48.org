...
Clock summary at [2014-04-28 Mon 16:32]

| Headline                                                  | Time   |      |      |
|-----------------------------------------------------------+--------+------+------|
| *Total time*                                              | *5:59* |      |      |
|-----------------------------------------------------------+--------+------+------|
| Development Stories Implemented                           |        | 5:59 |      |
| IMPLEMENTATION Release notes and backlog grooming         |        |      | 0:12 |
| IMPLEMENTATION Log start and finish of dogen with version |        |      | 0:10 |
| COMPLETED Install packages into =/usr=                    |        |      | 2:23 |
| IMPLEMENTATION Fix issues with database tests             |        |      | 2:54 |
