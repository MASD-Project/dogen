...
Clock summary at [2014-04-30 Wed 22:01]

| Headline                                                  | Time    |       |      |
|-----------------------------------------------------------+---------+-------+------|
| *Total time*                                              | *10:25* |       |      |
|-----------------------------------------------------------+---------+-------+------|
| Development Stories Implemented                           |         | 10:25 |      |
...
*** IMPLEMENTATION Knitter: Only log if logger has been initialised   :story:
    CLOCK: [2014-04-30 Wed 18:26]
