...
#+CAPTION: Clock summary at [2017-01-31 Tue 16:00]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| COMPLETED Add support for configurable enumerations types                   |         |       | 4:10 |  23.4 |
| COMPLETED Allow disabling =invalid= value in enumerations                   |         |       | 0:12 |   1.1 |
| COMPLETED Add support for configurable enumeration values                   |         |       | 5:26 |  30.5 |
| STARTED Add support for primitives across the pipeline                      |         |       | 7:17 |  40.9 |
