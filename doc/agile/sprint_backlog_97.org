...
#+CAPTION: Clock summary at [2017-02-01 Wed 11:39]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *21:20* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 21:20   |       |       | 100.0 |
| Active                                                                      |         | 21:20 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:01 |   0.1 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:43 |   3.4 |
| COMPLETED Add support for configurable enumerations types                   |         |       |  4:10 |  19.5 |
| COMPLETED Allow disabling =invalid= value in enumerations                   |         |       |  0:12 |   0.9 |
| COMPLETED Add support for configurable enumeration values                   |         |       |  5:26 |  25.5 |
| STARTED Add support for primitives across the pipeline                      |         |       | 10:48 |  50.6 |
