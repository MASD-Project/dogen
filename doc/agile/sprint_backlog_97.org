...
#+CAPTION: Clock summary at [2017-01-31 Tue 06:58]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *11:05* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 11:05   |       |      | 100.0 |
| Active                                                                      |         | 11:05 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:01 |   0.2 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:43 |   6.5 |
| COMPLETED Add support for configurable enumerations types                   |         |       | 4:10 |  37.6 |
| COMPLETED Allow disabling =invalid= value in enumerations                   |         |       | 0:12 |   1.8 |
| COMPLETED Add support for configurable enumeration values                   |         |       | 5:26 |  49.0 |
| STARTED Create a new yarn type for primitives                               |         |       | 0:33 |   5.0 |
...
- Add validation to ensure the underlier is valid (separate story).
