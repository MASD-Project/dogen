...
#+CAPTION: Clock summary at [2017-01-30 Mon 15:22]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *5:15* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 5:15   |      |      | 100.0 |
| Active                                                                      |        | 5:15 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:01 |   0.3 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 0:20 |   6.3 |
| COMPLETED Add support for configurable enumerations types                   |        |      | 4:10 |  79.4 |
| COMPLETED Allow disabling =invalid= value in enumerations                   |        |      | 0:12 |   3.8 |
| STARTED Add support for configurable enumeration values                     |        |      | 0:32 |  10.2 |
