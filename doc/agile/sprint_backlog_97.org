...
#+CAPTION: Clock summary at [2017-01-31 Tue 14:50]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *16:43* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 16:43   |       |      | 100.0 |
| Active                                                                      |         | 16:43 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:01 |   0.1 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:43 |   4.3 |
| COMPLETED Add support for configurable enumerations types                   |         |       | 4:10 |  24.9 |
| COMPLETED Allow disabling =invalid= value in enumerations                   |         |       | 0:12 |   1.2 |
| COMPLETED Add support for configurable enumeration values                   |         |       | 5:26 |  32.5 |
| STARTED Add support for primitives across the pipeline                      |         |       | 6:11 |  37.0 |
