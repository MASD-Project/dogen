...
#+CAPTION: Clock summary at [2017-01-30 Mon 18:23]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *8:12* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 8:12   |      |      | 100.0 |
| Active                                                                      |        | 8:12 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:01 |   0.2 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 0:20 |   4.1 |
| COMPLETED Add support for configurable enumerations types                   |        |      | 4:10 |  50.8 |
| COMPLETED Allow disabling =invalid= value in enumerations                   |        |      | 0:12 |   2.4 |
| STARTED Add support for configurable enumeration values                     |        |      | 3:29 |  42.5 |
