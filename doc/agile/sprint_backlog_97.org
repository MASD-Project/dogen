...
#+CAPTION: Clock summary at [2017-02-02 Thu 23:38]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| COMPLETED Add support for configurable enumerations types                   |         |       |  4:10 |  11.5 |
| COMPLETED Allow disabling =invalid= value in enumerations                   |         |       |  0:12 |   0.6 |
| COMPLETED Add support for configurable enumeration values                   |         |       |  5:26 |  15.0 |
...
| COMPLETED Handle "special includes" generically                             |         |       | 10:34 |  29.2 |
| STARTED Add support for primitives across the pipeline                      |         |       | 12:29 |  34.5 |
