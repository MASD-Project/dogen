...
#+CAPTION: Clock summary at [2017-02-03 Fri 11:13]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:43 |   1.8 |
| COMPLETED Add support for configurable enumerations types                   |         |       |  4:10 |  10.6 |
| COMPLETED Allow disabling =invalid= value in enumerations                   |         |       |  0:12 |   0.5 |
| COMPLETED Add support for configurable enumeration values                   |         |       |  5:26 |  13.9 |
| COMPLETED Test data for booleans is not oscillating correctly               |         |       |  1:15 |   3.2 |
| COMPLETED Inclusion directive logic is too complex                          |         |       |  1:20 |   3.4 |
| COMPLETED Handle "special includes" generically                             |         |       | 10:34 |  27.0 |
| POSTPONED Partial matching of built-ins doesn't work for certain types      |         |       |  0:50 |   2.1 |
| STARTED Add support for primitives across the pipeline                      |         |       | 14:38 |  37.4 |
