...
#+CAPTION: Clock summary at [2017-01-31 Tue 15:30]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:43 |   4.1 |
| COMPLETED Add support for configurable enumerations types                   |         |       | 4:10 |  24.0 |
| COMPLETED Allow disabling =invalid= value in enumerations                   |         |       | 0:12 |   1.2 |
| COMPLETED Add support for configurable enumeration values                   |         |       | 5:26 |  31.3 |
| STARTED Add support for primitives across the pipeline                      |         |       | 6:50 |  39.3 |
