...
#+CAPTION: Clock summary at [2017-01-31 Tue 16:42]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| COMPLETED Add support for configurable enumerations types                   |         |       | 4:10 |  22.6 |
| COMPLETED Allow disabling =invalid= value in enumerations                   |         |       | 0:12 |   1.1 |
| COMPLETED Add support for configurable enumeration values                   |         |       | 5:26 |  29.4 |
| STARTED Add support for primitives across the pipeline                      |         |       | 7:55 |  42.9 |
