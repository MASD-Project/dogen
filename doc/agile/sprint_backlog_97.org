...
#+CAPTION: Clock summary at [2017-02-03 Fri 12:55]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| COMPLETED Add support for configurable enumerations types                   |         |       |  4:10 |  10.2 |
| COMPLETED Allow disabling =invalid= value in enumerations                   |         |       |  0:12 |   0.5 |
| COMPLETED Add support for configurable enumeration values                   |         |       |  5:26 |  13.3 |
...
| COMPLETED Handle "special includes" generically                             |         |       | 10:34 |  25.9 |
| POSTPONED Partial matching of built-ins doesn't work for certain types      |         |       |  0:50 |   2.0 |
| STARTED Add support for primitives across the pipeline                      |         |       | 16:17 |  39.9 |
