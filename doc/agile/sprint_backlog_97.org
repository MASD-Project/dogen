...
#+CAPTION: Clock summary at [2017-02-01 Wed 16:53]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:43 |   2.9 |
| COMPLETED Add support for configurable enumerations types                   |         |       |  4:10 |  17.0 |
| COMPLETED Allow disabling =invalid= value in enumerations                   |         |       |  0:12 |   0.8 |
| COMPLETED Add support for configurable enumeration values                   |         |       |  5:26 |  22.2 |
| STARTED Handle "special includes" correctly                                 |         |       |  1:44 |   7.1 |
| STARTED Add support for primitives across the pipeline                      |         |       | 12:15 |  50.0 |
