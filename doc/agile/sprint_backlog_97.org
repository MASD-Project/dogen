...
#+CAPTION: Clock summary at [2017-02-02 Thu 15:53]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *31:42* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 31:42   |       |       | 100.0 |
| Active                                                                      |         | 31:42 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:01 |   0.1 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:43 |   2.3 |
| COMPLETED Add support for configurable enumerations types                   |         |       |  4:10 |  13.1 |
| COMPLETED Allow disabling =invalid= value in enumerations                   |         |       |  0:12 |   0.6 |
| COMPLETED Add support for configurable enumeration values                   |         |       |  5:26 |  17.1 |
| COMPLETED Test data for booleans is not oscillating correctly               |         |       |  0:17 |   0.9 |
| STARTED Handle "special includes" generically                               |         |       |  8:38 |  27.2 |
| STARTED Add support for primitives across the pipeline                      |         |       | 12:15 |  38.6 |
