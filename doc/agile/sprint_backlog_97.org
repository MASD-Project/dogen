...
#+CAPTION: Clock summary at [2017-02-04 Sat 17:24]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| COMPLETED Add support for configurable enumerations types                   |         |       |  4:10 |   9.6 |
| COMPLETED Allow disabling =invalid= value in enumerations                   |         |       |  0:12 |   0.5 |
| COMPLETED Add support for configurable enumeration values                   |         |       |  5:26 |  12.5 |
...
| COMPLETED Handle "special includes" generically                             |         |       | 10:34 |  24.3 |
| POSTPONED Partial matching of built-ins doesn't work for certain types      |         |       |  0:50 |   1.9 |
| STARTED Improve compilation times                                           |         |       |  1:19 |   3.0 |
| STARTED Add support for primitives across the pipeline                      |         |       | 16:28 |  37.9 |
