...
#+CAPTION: Clock summary at [2017-02-04 Sat 15:27]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                                     | 42:11   |       |       | 100.0 |
| Active                                                                      |         | 42:11 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:13 |   2.9 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:43 |   1.7 |
| COMPLETED Add support for configurable enumerations types                   |         |       |  4:10 |   9.9 |
| COMPLETED Allow disabling =invalid= value in enumerations                   |         |       |  0:12 |   0.5 |
| COMPLETED Add support for configurable enumeration values                   |         |       |  5:26 |  12.9 |
| COMPLETED Test data for booleans is not oscillating correctly               |         |       |  1:15 |   3.0 |
| COMPLETED Inclusion directive logic is too complex                          |         |       |  1:20 |   3.2 |
| COMPLETED Handle "special includes" generically                             |         |       | 10:34 |  25.0 |
| POSTPONED Partial matching of built-ins doesn't work for certain types      |         |       |  0:50 |   2.0 |
| STARTED Add support for primitives across the pipeline                      |         |       | 16:28 |  39.0 |
