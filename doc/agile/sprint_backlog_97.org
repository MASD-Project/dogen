...
#+CAPTION: Clock summary at [2017-02-02 Thu 23:23]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:43 |   2.0 |
| COMPLETED Add support for configurable enumerations types                   |         |       |  4:10 |  11.6 |
| COMPLETED Allow disabling =invalid= value in enumerations                   |         |       |  0:12 |   0.6 |
| COMPLETED Add support for configurable enumeration values                   |         |       |  5:26 |  15.1 |
| COMPLETED Test data for booleans is not oscillating correctly               |         |       |  1:15 |   3.5 |
| COMPLETED Inclusion directive logic is too complex                          |         |       |  1:20 |   3.7 |
| COMPLETED Handle "special includes" generically                             |         |       | 10:34 |  29.4 |
| STARTED Add support for primitives across the pipeline                      |         |       | 12:15 |  34.1 |
