...
#+CAPTION: Clock summary at [2017-02-02 Thu 09:20]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:43 |   2.6 |
| COMPLETED Add support for configurable enumerations types                   |         |       |  4:10 |  15.3 |
| COMPLETED Allow disabling =invalid= value in enumerations                   |         |       |  0:12 |   0.7 |
| COMPLETED Add support for configurable enumeration values                   |         |       |  5:26 |  19.9 |
| STARTED Handle "special includes" correctly                                 |         |       |  4:32 |  16.6 |
| STARTED Add support for primitives across the pipeline                      |         |       | 12:15 |  44.8 |
...
*** STARTED Handle "special includes" correctly                       :story:
