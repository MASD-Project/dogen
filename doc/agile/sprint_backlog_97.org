...
#+CAPTION: Clock summary at [2017-02-04 Sat 16:28]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| COMPLETED Add support for configurable enumerations types                   |         |       |  4:10 |   9.8 |
| COMPLETED Allow disabling =invalid= value in enumerations                   |         |       |  0:12 |   0.5 |
| COMPLETED Add support for configurable enumeration values                   |         |       |  5:26 |  12.7 |
...
| COMPLETED Handle "special includes" generically                             |         |       | 10:34 |  24.8 |
| POSTPONED Partial matching of built-ins doesn't work for certain types      |         |       |  0:50 |   2.0 |
| STARTED Improve compilation times                                           |         |       |  0:27 |   1.1 |
| STARTED Add support for primitives across the pipeline                      |         |       | 16:28 |  38.6 |
...
*** STARTED Improve compilation times                                 :story:
