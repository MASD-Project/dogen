...
#+CAPTION: Clock summary at [2017-01-31 Tue 16:19]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *18:07* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 18:07   |       |      | 100.0 |
| Active                                                                      |         | 18:07 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:01 |   0.1 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:43 |   4.0 |
| COMPLETED Add support for configurable enumerations types                   |         |       | 4:10 |  23.0 |
| COMPLETED Allow disabling =invalid= value in enumerations                   |         |       | 0:12 |   1.1 |
| COMPLETED Add support for configurable enumeration values                   |         |       | 5:26 |  30.0 |
| STARTED Add support for primitives across the pipeline                      |         |       | 7:35 |  41.9 |
