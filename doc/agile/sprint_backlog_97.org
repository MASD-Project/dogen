...
#+CAPTION: Clock summary at [2017-02-03 Fri 10:31]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:43 |   1.9 |
| COMPLETED Add support for configurable enumerations types                   |         |       |  4:10 |  11.1 |
| COMPLETED Allow disabling =invalid= value in enumerations                   |         |       |  0:12 |   0.5 |
| COMPLETED Add support for configurable enumeration values                   |         |       |  5:26 |  14.5 |
| COMPLETED Test data for booleans is not oscillating correctly               |         |       |  1:15 |   3.3 |
| COMPLETED Inclusion directive logic is too complex                          |         |       |  1:20 |   3.5 |
| COMPLETED Handle "special includes" generically                             |         |       | 10:34 |  28.1 |
| POSTPONED Partial matching of built-ins doesn't work for certain types      |         |       |  0:50 |   2.2 |
| STARTED Add support for primitives across the pipeline                      |         |       | 13:04 |  34.8 |
