...
#+CAPTION: Clock summary at [2017-01-31 Tue 09:45]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *13:15* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 13:15   |       |      | 100.0 |
| Active                                                                      |         | 13:15 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:01 |   0.1 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:43 |   5.4 |
| COMPLETED Add support for configurable enumerations types                   |         |       | 4:10 |  31.4 |
| COMPLETED Allow disabling =invalid= value in enumerations                   |         |       | 0:12 |   1.5 |
| COMPLETED Add support for configurable enumeration values                   |         |       | 5:26 |  41.0 |
| STARTED Add support for primitives across the pipeline                      |         |       | 2:43 |  20.5 |
