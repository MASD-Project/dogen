...
#+CAPTION: Clock summary at [2017-02-01 Wed 10:54]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:43 |   3.5 |
| COMPLETED Add support for configurable enumerations types                   |         |       |  4:10 |  20.2 |
| COMPLETED Allow disabling =invalid= value in enumerations                   |         |       |  0:12 |   1.0 |
| COMPLETED Add support for configurable enumeration values                   |         |       |  5:26 |  26.4 |
| STARTED Add support for primitives across the pipeline                      |         |       | 10:05 |  48.9 |
