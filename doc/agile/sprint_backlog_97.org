...
#+CAPTION: Clock summary at [2017-02-04 Sat 22:46]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| COMPLETED Add support for configurable enumerations types                   |         |       |  4:10 |   9.2 |
| COMPLETED Allow disabling =invalid= value in enumerations                   |         |       |  0:12 |   0.4 |
| COMPLETED Add support for configurable enumeration values                   |         |       |  5:26 |  12.0 |
| COMPLETED Test data for booleans is not oscillating correctly               |         |       |  1:15 |   2.8 |
| COMPLETED Inclusion directive logic is too complex                          |         |       |  1:20 |   2.9 |
| COMPLETED Handle "special includes" generically                             |         |       | 10:34 |  23.3 |
...
| STARTED Add support for primitives across the pipeline                      |         |       | 18:02 |  39.7 |
