...
#+CAPTION: Clock summary at [2017-02-05 Sun 16:44]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| COMPLETED Add support for configurable enumerations types                   |         |       |  4:10 |   8.6 |
| COMPLETED Allow disabling =invalid= value in enumerations                   |         |       |  0:12 |   0.4 |
| COMPLETED Add support for configurable enumeration values                   |         |       |  5:26 |  11.2 |
...
| COMPLETED Handle "special includes" generically                             |         |       | 10:34 |  21.7 |
...
| COMPLETED Add support for primitives across the pipeline                    |         |       | 19:48 |  40.6 |
...
| STARTED Refactor yarn model validators                                      |         |       |  0:34 |   1.2 |
