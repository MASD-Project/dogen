...
#+CAPTION: Clock summary at [2017-01-30 Mon 17:50]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *7:41* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 7:41   |      |      | 100.0 |
| Active                                                                      |        | 7:41 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:01 |   0.2 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 0:20 |   4.3 |
| COMPLETED Add support for configurable enumerations types                   |        |      | 4:10 |  54.2 |
| COMPLETED Allow disabling =invalid= value in enumerations                   |        |      | 0:12 |   2.6 |
| STARTED Add support for configurable enumeration values                     |        |      | 2:58 |  38.6 |
