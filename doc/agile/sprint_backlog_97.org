...
#+CAPTION: Clock summary at [2017-01-31 Tue 10:27]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *13:55* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 13:55   |       |      | 100.0 |
| Active                                                                      |         | 13:55 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:01 |   0.1 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:43 |   5.1 |
| COMPLETED Add support for configurable enumerations types                   |         |       | 4:10 |  29.9 |
| COMPLETED Allow disabling =invalid= value in enumerations                   |         |       | 0:12 |   1.4 |
| COMPLETED Add support for configurable enumeration values                   |         |       | 5:26 |  39.0 |
| STARTED Add support for primitives across the pipeline                      |         |       | 3:23 |  24.3 |
