...
#+CAPTION: Clock summary at [2017-01-31 Tue 09:16]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *12:46* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 12:46   |       |      | 100.0 |
| Active                                                                      |         | 12:46 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:01 |   0.1 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:43 |   5.6 |
| COMPLETED Add support for configurable enumerations types                   |         |       | 4:10 |  32.6 |
| COMPLETED Allow disabling =invalid= value in enumerations                   |         |       | 0:12 |   1.6 |
| COMPLETED Add support for configurable enumeration values                   |         |       | 5:26 |  42.6 |
| STARTED Add support for primitives across the pipeline                      |         |       | 2:14 |  17.5 |
