...
#+CAPTION: Clock summary at [2017-01-31 Tue 07:07]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *11:13* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 11:13   |       |      | 100.0 |
| Active                                                                      |         | 11:13 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:01 |   0.1 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:43 |   6.4 |
| COMPLETED Add support for configurable enumerations types                   |         |       | 4:10 |  37.1 |
| COMPLETED Allow disabling =invalid= value in enumerations                   |         |       | 0:12 |   1.8 |
| COMPLETED Add support for configurable enumeration values                   |         |       | 5:26 |  48.4 |
| STARTED Create a new yarn type for primitives                               |         |       | 0:41 |   6.1 |
