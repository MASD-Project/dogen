...
#+CAPTION: Clock summary at [2017-02-05 Sun 17:22]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *49:19* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 49:19   |       |       | 100.0 |
| Active                                                                      |         | 49:19 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:13 |   2.5 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:43 |   1.5 |
| COMPLETED Add support for configurable enumerations types                   |         |       |  4:10 |   8.4 |
| COMPLETED Allow disabling =invalid= value in enumerations                   |         |       |  0:12 |   0.4 |
| COMPLETED Add support for configurable enumeration values                   |         |       |  5:26 |  11.0 |
...
| COMPLETED Handle "special includes" generically                             |         |       | 10:34 |  21.4 |
...
| COMPLETED Add support for primitives across the pipeline                    |         |       | 19:48 |  40.1 |
...
| STARTED Refactor yarn model validators                                      |         |       |  1:10 |   2.4 |
