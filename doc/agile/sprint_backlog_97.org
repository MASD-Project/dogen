...
#+CAPTION: Clock summary at [2017-02-02 Thu 20:36]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| COMPLETED Add support for configurable enumerations types                   |         |       |  4:10 |  12.1 |
| COMPLETED Allow disabling =invalid= value in enumerations                   |         |       |  0:12 |   0.6 |
| COMPLETED Add support for configurable enumeration values                   |         |       |  5:26 |  15.8 |
| COMPLETED Test data for booleans is not oscillating correctly               |         |       |  1:15 |   3.6 |
| COMPLETED Inclusion directive logic is too complex                          |         |       |  1:20 |   3.9 |
| STARTED Handle "special includes" generically                               |         |       |  9:07 |  26.4 |
| STARTED Add support for primitives across the pipeline                      |         |       | 12:15 |  35.5 |
