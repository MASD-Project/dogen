...
#+CAPTION: Clock summary at [2017-02-05 Sun 11:58]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *48:09* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 48:09   |       |       | 100.0 |
| Active                                                                      |         | 48:09 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:13 |   2.5 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:43 |   1.5 |
| COMPLETED Add support for configurable enumerations types                   |         |       |  4:10 |   8.7 |
| COMPLETED Allow disabling =invalid= value in enumerations                   |         |       |  0:12 |   0.4 |
| COMPLETED Add support for configurable enumeration values                   |         |       |  5:26 |  11.3 |
| COMPLETED Test data for booleans is not oscillating correctly               |         |       |  1:15 |   2.6 |
| COMPLETED Inclusion directive logic is too complex                          |         |       |  1:20 |   2.8 |
| COMPLETED Handle "special includes" generically                             |         |       | 10:34 |  21.9 |
...
| COMPLETED Add support for primitives across the pipeline                    |         |       | 19:48 |  41.1 |
| COMPLETED Drop "inclusion" prefix in quilt.cpp                              |         |       |  0:40 |   1.4 |
| COMPLETED Mark elements that are valid enumeration underlying elements      |         |       |  0:19 |   0.7 |
...
*** Refactor yarn model validators                                    :story:
