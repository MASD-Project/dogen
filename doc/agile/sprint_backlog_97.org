...
#+CAPTION: Clock summary at [2017-02-02 Thu 16:53]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *32:40* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 32:40   |       |       | 100.0 |
| Active                                                                      |         | 32:40 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:01 |   0.1 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:43 |   2.2 |
| COMPLETED Add support for configurable enumerations types                   |         |       |  4:10 |  12.8 |
| COMPLETED Allow disabling =invalid= value in enumerations                   |         |       |  0:12 |   0.6 |
| COMPLETED Add support for configurable enumeration values                   |         |       |  5:26 |  16.6 |
| COMPLETED Test data for booleans is not oscillating correctly               |         |       |  1:15 |   3.8 |
| STARTED Handle "special includes" generically                               |         |       |  8:38 |  26.4 |
| STARTED Add support for primitives across the pipeline                      |         |       | 12:15 |  37.5 |
