...
#+CAPTION: Clock summary at [2017-01-31 Tue 15:09]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *17:02* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 17:02   |       |      | 100.0 |
| Active                                                                      |         | 17:02 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:01 |   0.1 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:43 |   4.2 |
| COMPLETED Add support for configurable enumerations types                   |         |       | 4:10 |  24.5 |
| COMPLETED Allow disabling =invalid= value in enumerations                   |         |       | 0:12 |   1.2 |
| COMPLETED Add support for configurable enumeration values                   |         |       | 5:26 |  31.9 |
| STARTED Add support for primitives across the pipeline                      |         |       | 6:30 |  38.2 |
