...
#+CAPTION: Clock summary at [2017-01-31 Tue 11:49]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *14:47* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 14:47   |       |      | 100.0 |
| Active                                                                      |         | 14:47 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:01 |   0.1 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:43 |   4.8 |
| COMPLETED Add support for configurable enumerations types                   |         |       | 4:10 |  28.2 |
| COMPLETED Allow disabling =invalid= value in enumerations                   |         |       | 0:12 |   1.4 |
| COMPLETED Add support for configurable enumeration values                   |         |       | 5:26 |  36.8 |
| STARTED Add support for primitives across the pipeline                      |         |       | 4:15 |  28.7 |
