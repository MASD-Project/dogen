...
#+CAPTION: Clock summary at [2017-02-01 Wed 10:42]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| COMPLETED Add support for configurable enumerations types                   |         |       | 4:10 |  20.4 |
| COMPLETED Allow disabling =invalid= value in enumerations                   |         |       | 0:12 |   1.0 |
| COMPLETED Add support for configurable enumeration values                   |         |       | 5:26 |  26.6 |
| STARTED Add support for primitives across the pipeline                      |         |       | 9:54 |  48.5 |
