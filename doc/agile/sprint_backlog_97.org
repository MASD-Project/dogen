...
#+CAPTION: Clock summary at [2017-02-05 Sun 22:42]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *50:49* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 50:49   |       |       | 100.0 |
| Active                                                                      |         | 50:49 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:13 |   2.4 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:43 |   1.4 |
| COMPLETED Add support for configurable enumerations types                   |         |       |  4:10 |   8.2 |
| COMPLETED Allow disabling =invalid= value in enumerations                   |         |       |  0:12 |   0.4 |
| COMPLETED Add support for configurable enumeration values                   |         |       |  5:26 |  10.7 |
...
| COMPLETED Handle "special includes" generically                             |         |       | 10:34 |  20.8 |
...
| COMPLETED Add support for primitives across the pipeline                    |         |       | 19:48 |  39.0 |
