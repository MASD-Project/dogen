...
#+CAPTION: Clock summary at [2017-01-30 Mon 17:37]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *7:29* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 7:29   |      |      | 100.0 |
| Active                                                                      |        | 7:29 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:01 |   0.2 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 0:20 |   4.5 |
| COMPLETED Add support for configurable enumerations types                   |        |      | 4:10 |  55.7 |
| COMPLETED Allow disabling =invalid= value in enumerations                   |        |      | 0:12 |   2.7 |
| STARTED Add support for configurable enumeration values                     |        |      | 2:46 |  37.0 |
...
*** STARTED Add support for configurable enumeration values           :story:
    CLOCK: [2017-01-30 Mon 15:23]--[2017-01-30 Mon 17:37] =>  2:14
...
*** Create a new yarn type for primitives                             :story:
