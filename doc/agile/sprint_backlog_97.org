...
#+CAPTION: Clock summary at [2017-01-31 Tue 13:52]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *16:06* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 16:06   |       |      | 100.0 |
| Active                                                                      |         | 10:32 |      |  65.4 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:01 |   0.1 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:43 |   4.5 |
| COMPLETED Add support for configurable enumerations types                   |         |       | 4:10 |  25.9 |
| COMPLETED Allow disabling =invalid= value in enumerations                   |         |       | 0:12 |   1.2 |
| COMPLETED Add support for configurable enumeration values                   |         |       | 5:26 |  33.7 |
| STARTED Add support for primitives across the pipeline                      |         |  5:34 |      |  34.6 |
