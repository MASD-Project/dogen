...
#+CAPTION: Clock summary at [2017-01-31 Tue 16:27]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *18:14* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 18:14   |       |      | 100.0 |
| Active                                                                      |         | 18:14 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:01 |   0.1 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:43 |   3.9 |
| COMPLETED Add support for configurable enumerations types                   |         |       | 4:10 |  22.9 |
| COMPLETED Allow disabling =invalid= value in enumerations                   |         |       | 0:12 |   1.1 |
| COMPLETED Add support for configurable enumeration values                   |         |       | 5:26 |  29.8 |
| STARTED Add support for primitives across the pipeline                      |         |       | 7:42 |  42.2 |
