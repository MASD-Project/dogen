...
#+CAPTION: Clock summary at [2017-02-02 Thu 22:40]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *35:17* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 35:17   |       |       | 100.0 |
| Active                                                                      |         | 35:17 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:01 |   0.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:43 |   2.0 |
| COMPLETED Add support for configurable enumerations types                   |         |       |  4:10 |  11.8 |
| COMPLETED Allow disabling =invalid= value in enumerations                   |         |       |  0:12 |   0.6 |
| COMPLETED Add support for configurable enumeration values                   |         |       |  5:26 |  15.4 |
...
| STARTED Handle "special includes" generically                               |         |       |  9:55 |  28.1 |
| STARTED Add support for primitives across the pipeline                      |         |       | 12:15 |  34.7 |
