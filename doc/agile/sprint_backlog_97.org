...
#+CAPTION: Clock summary at [2017-02-02 Thu 10:28]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *28:23* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 28:23   |       |       | 100.0 |
| Active                                                                      |         | 28:23 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:01 |   0.1 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:43 |   2.5 |
| COMPLETED Add support for configurable enumerations types                   |         |       |  4:10 |  14.7 |
| COMPLETED Allow disabling =invalid= value in enumerations                   |         |       |  0:12 |   0.7 |
| COMPLETED Add support for configurable enumeration values                   |         |       |  5:26 |  19.1 |
| STARTED Handle "special includes" correctly                                 |         |       |  5:36 |  19.7 |
| STARTED Add support for primitives across the pipeline                      |         |       | 12:15 |  43.2 |
