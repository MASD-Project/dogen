...
#+CAPTION: Clock summary at [2017-01-31 Tue 13:24]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *15:39* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 15:39   |       |      | 100.0 |
| Active                                                                      |         | 15:39 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:01 |   0.1 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:43 |   4.6 |
| COMPLETED Add support for configurable enumerations types                   |         |       | 4:10 |  26.6 |
| COMPLETED Allow disabling =invalid= value in enumerations                   |         |       | 0:12 |   1.3 |
| COMPLETED Add support for configurable enumeration values                   |         |       | 5:26 |  34.7 |
| STARTED Add support for primitives across the pipeline                      |         |       | 5:07 |  32.7 |
