...
#+CAPTION: Clock summary at [2017-02-05 Sun 10:57]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *47:10* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 47:10   |       |       | 100.0 |
| Active                                                                      |         | 47:10 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:13 |   2.6 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:43 |   1.5 |
| COMPLETED Add support for configurable enumerations types                   |         |       |  4:10 |   8.8 |
| COMPLETED Allow disabling =invalid= value in enumerations                   |         |       |  0:12 |   0.4 |
| COMPLETED Add support for configurable enumeration values                   |         |       |  5:26 |  11.5 |
| COMPLETED Test data for booleans is not oscillating correctly               |         |       |  1:15 |   2.7 |
| COMPLETED Inclusion directive logic is too complex                          |         |       |  1:20 |   2.8 |
| COMPLETED Handle "special includes" generically                             |         |       | 10:34 |  22.4 |
| POSTPONED Partial matching of built-ins doesn't work for certain types      |         |       |  0:50 |   1.8 |
| COMPLETED Try to improve compilation times                                  |         |       |  1:39 |   3.5 |
| COMPLETED Add support for primitives across the pipeline                    |         |       | 19:48 |  42.0 |
