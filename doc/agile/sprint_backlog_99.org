...
#+CAPTION: Clock summary at [2017-03-07 Tue 13:33]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *9:18* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 9:18   |      |      | 100.0 |
| Active                                                                      |        | 9:18 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:16 |   2.9 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 0:26 |   4.7 |
| COMPLETED Add test model for path meta-data                                 |        |      | 2:58 |  31.9 |
| COMPLETED ODB CMakeLists does not cope with changes to project paths        |        |      | 4:33 |  48.9 |
| STARTED Check for incompatibility between input language and enabled kernels |        |      | 0:11 |   2.0 |
| STARTED Build on tags for Windows                                           |        |      | 0:15 |   2.7 |
| STARTED Add a "flat directory" mode                                         |        |      | 0:08 |   1.4 |
| STARTED Split include and source directories                                |        |      | 0:31 |   5.6 |
