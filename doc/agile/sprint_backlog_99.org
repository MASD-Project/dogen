...
#+CAPTION: Clock summary at [2017-03-06 Mon 22:15]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
...
| Stories                                                                     | 4:25   |      |      | 100.0 |
| Active                                                                      |        | 4:25 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:16 |   6.0 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 0:26 |   9.8 |
| COMPLETED Add test model for path meta-data                                 |        |      | 2:49 |  63.8 |
| STARTED Build on tags for Windows                                           |        |      | 0:15 |   5.7 |
| STARTED Add a "flat directory" mode                                         |        |      | 0:08 |   3.0 |
| STARTED Split include and source directories                                |        |      | 0:31 |  11.7 |
