...
#+CAPTION: Clock summary at [2017-03-08 Wed 10:09]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *13:26* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 13:26   |       |      | 100.0 |
| Active                                                                      |         | 13:26 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:49 |   6.1 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:26 |   3.2 |
| COMPLETED Add test model for path meta-data                                 |         |       | 2:58 |  22.1 |
| COMPLETED ODB CMakeLists does not cope with changes to project paths        |         |       | 5:04 |  37.7 |
| STARTED Check for incompatibility between input language and enabled kernels |         |       | 0:11 |   1.4 |
| STARTED Add a LAM test model just to validate existing functionality        |         |       | 1:48 |  13.4 |
| STARTED Build on tags for Windows                                           |         |       | 0:15 |   1.9 |
| STARTED Add a "flat directory" mode                                         |         |       | 0:08 |   1.0 |
| STARTED Split include and source directories                                |         |       | 0:58 |   7.2 |
| STARTED Handling of visual studio projects and solutions is incorrect       |         |       | 0:49 |   6.1 |
