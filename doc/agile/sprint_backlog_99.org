...
#+CAPTION: Clock summary at [2017-03-13 Mon 22:44]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| COMPLETED Add test model for path meta-data                                 |         |       |  2:58 |   7.1 |
| COMPLETED ODB CMakeLists does not cope with changes to project paths        |         |       |  5:04 |  12.2 |
| COMPLETED Split include and source directories                              |         |       |  5:22 |  12.9 |
| COMPLETED Add C++-03 mode                                                   |         |       |  8:19 |  20.0 |
| COMPLETED Add a LAM test model just to validate existing functionality      |         |       |  2:38 |   6.3 |
...
| STARTED Implement the database model using Northwind                        |         |       | 14:06 |  33.9 |
