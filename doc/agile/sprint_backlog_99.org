...
#+CAPTION: Clock summary at [2017-03-14 Tue 07:22]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *42:20* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 42:20   |       |       | 100.0 |
| Active                                                                      |         | 42:20 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:01 |   2.4 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:26 |   1.0 |
| COMPLETED Add test model for path meta-data                                 |         |       |  2:58 |   7.0 |
| COMPLETED ODB CMakeLists does not cope with changes to project paths        |         |       |  5:04 |  12.0 |
| COMPLETED Split include and source directories                              |         |       |  5:22 |  12.7 |
| COMPLETED Add C++-03 mode                                                   |         |       |  8:19 |  19.6 |
| COMPLETED Add a LAM test model just to validate existing functionality      |         |       |  2:38 |   6.2 |
...
| STARTED Handling of visual studio projects and solutions is incorrect       |         |       |  1:11 |   2.8 |
| STARTED Implement the database model using Northwind                        |         |       | 14:47 |  34.9 |
