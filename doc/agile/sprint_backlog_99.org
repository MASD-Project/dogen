...
#+CAPTION: Clock summary at [2017-03-13 Mon 18:31]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *38:32* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 38:32   |       |       | 100.0 |
| Active                                                                      |         | 38:32 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:01 |   2.6 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:26 |   1.1 |
| COMPLETED Add test model for path meta-data                                 |         |       |  2:58 |   7.7 |
| COMPLETED ODB CMakeLists does not cope with changes to project paths        |         |       |  5:04 |  13.1 |
| COMPLETED Split include and source directories                              |         |       |  5:22 |  13.9 |
| COMPLETED Add C++-03 mode                                                   |         |       |  8:19 |  21.6 |
| COMPLETED Add a LAM test model just to validate existing functionality      |         |       |  2:38 |   6.8 |
...
| STARTED Implement the database model using Northwind                        |         |       | 10:59 |  28.5 |
