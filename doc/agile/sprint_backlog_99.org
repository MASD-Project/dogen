...
#+CAPTION: Clock summary at [2017-03-17 Fri 15:44]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *49:01* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 49:01   |       |       | 100.0 |
| Active                                                                      |         | 49:01 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:01 |   2.1 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:26 |   0.9 |
| COMPLETED Add test model for path meta-data                                 |         |       |  2:58 |   6.1 |
| COMPLETED ODB CMakeLists does not cope with changes to project paths        |         |       |  5:04 |  10.3 |
| COMPLETED Split include and source directories                              |         |       |  5:22 |  10.9 |
| COMPLETED Add C++-03 mode                                                   |         |       |  8:19 |  17.0 |
| COMPLETED Add a LAM test model just to validate existing functionality      |         |       |  2:38 |   5.4 |
...
| COMPLETED Fix issues with dropbox downloads                                 |         |       |  3:38 |   7.4 |
| STARTED Create a UML profile to formalise yarn concepts                     |         |       |  0:23 |   0.8 |
...
| STARTED Handling of visual studio projects and solutions is incorrect       |         |       |  1:11 |   2.4 |
| STARTED Implement the database model using Northwind                        |         |       | 17:06 |  34.9 |
