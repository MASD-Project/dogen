...
#+CAPTION: Clock summary at [2017-03-07 Tue 21:23]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *12:48* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 12:48   |       |      | 100.0 |
| Active                                                                      |         | 12:48 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:38 |   4.9 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:26 |   3.4 |
| COMPLETED Add test model for path meta-data                                 |         |       | 2:58 |  23.2 |
| COMPLETED ODB CMakeLists does not cope with changes to project paths        |         |       | 5:04 |  39.6 |
| STARTED Check for incompatibility between input language and enabled kernels |         |       | 0:11 |   1.4 |
| STARTED Add a LAM test model just to validate existing functionality        |         |       | 1:48 |  14.1 |
| STARTED Build on tags for Windows                                           |         |       | 0:15 |   2.0 |
| STARTED Add a "flat directory" mode                                         |         |       | 0:08 |   1.0 |
| STARTED Split include and source directories                                |         |       | 0:31 |   4.0 |
| STARTED Handling of visual studio projects and solutions is incorrect       |         |       | 0:49 |   6.4 |
