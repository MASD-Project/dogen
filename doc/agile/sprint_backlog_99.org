...
#+CAPTION: Clock summary at [2017-03-17 Fri 10:58]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| COMPLETED Add test model for path meta-data                                 |         |       |  2:58 |   6.4 |
| COMPLETED ODB CMakeLists does not cope with changes to project paths        |         |       |  5:04 |  10.9 |
| COMPLETED Split include and source directories                              |         |       |  5:22 |  11.5 |
| COMPLETED Add C++-03 mode                                                   |         |       |  8:19 |  17.8 |
| COMPLETED Add a LAM test model just to validate existing functionality      |         |       |  2:38 |   5.7 |
...
| STARTED Fix issues with dropbox downloads                                   |         |       |  1:56 |   4.1 |
...
| STARTED Implement the database model using Northwind                        |         |       | 16:46 |  36.0 |
