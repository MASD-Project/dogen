...
#+CAPTION: Clock summary at [2017-03-08 Wed 15:46]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *16:49* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 16:49   |       |      | 100.0 |
| Active                                                                      |         | 16:49 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:49 |   4.9 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:26 |   2.6 |
| COMPLETED Add test model for path meta-data                                 |         |       | 2:58 |  17.6 |
| COMPLETED ODB CMakeLists does not cope with changes to project paths        |         |       | 5:04 |  30.1 |
| COMPLETED Split include and source directories                              |         |       | 4:21 |  25.9 |
| STARTED Check for incompatibility between input language and enabled kernels |         |       | 0:11 |   1.1 |
| STARTED Add a LAM test model just to validate existing functionality        |         |       | 1:48 |  10.7 |
| STARTED Build on tags for Windows                                           |         |       | 0:15 |   1.5 |
| STARTED Add a "flat directory" mode                                         |         |       | 0:08 |   0.8 |
| STARTED Handling of visual studio projects and solutions is incorrect       |         |       | 0:49 |   4.9 |
