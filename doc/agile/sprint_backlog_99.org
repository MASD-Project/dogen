...
#+CAPTION: Clock summary at [2017-03-14 Tue 22:32]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *43:55* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 43:55   |       |       | 100.0 |
| Active                                                                      |         | 43:55 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:01 |   2.3 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:26 |   1.0 |
| COMPLETED Add test model for path meta-data                                 |         |       |  2:58 |   6.8 |
| COMPLETED ODB CMakeLists does not cope with changes to project paths        |         |       |  5:04 |  11.5 |
| COMPLETED Split include and source directories                              |         |       |  5:22 |  12.2 |
| COMPLETED Add C++-03 mode                                                   |         |       |  8:19 |  18.9 |
| COMPLETED Add a LAM test model just to validate existing functionality      |         |       |  2:38 |   6.0 |
| COMPLETED Split project should not include model name                       |         |       |  0:18 |   0.7 |
...
| STARTED Implement the database model using Northwind                        |         |       | 16:01 |  36.5 |
