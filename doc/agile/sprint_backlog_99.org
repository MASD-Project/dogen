...
#+CAPTION: Clock summary at [2017-03-12 Sun 21:36]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 32:09   |       |      | 100.0 |
| Active                                                                      |         | 32:09 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:01 |   3.2 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:26 |   1.3 |
| COMPLETED Add test model for path meta-data                                 |         |       | 2:58 |   9.2 |
| COMPLETED ODB CMakeLists does not cope with changes to project paths        |         |       | 5:04 |  15.8 |
| COMPLETED Split include and source directories                              |         |       | 5:22 |  16.7 |
| COMPLETED Add C++-03 mode                                                   |         |       | 8:19 |  25.9 |
| STARTED Check for incompatibility between input language and enabled kernels |         |       | 0:11 |   0.6 |
| STARTED Add a LAM test model just to validate existing functionality        |         |       | 2:38 |   8.2 |
...
| STARTED Implement the database model using Northwind                        |         |       | 4:36 |  14.3 |
