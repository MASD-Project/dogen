...
#+CAPTION: Clock summary at [2017-03-07 Tue 21:01]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *12:26* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 12:26   |       |      | 100.0 |
| Active                                                                      |         | 12:26 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:16 |   2.1 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:26 |   3.5 |
| COMPLETED Add test model for path meta-data                                 |         |       | 2:58 |  23.9 |
| COMPLETED ODB CMakeLists does not cope with changes to project paths        |         |       | 5:04 |  40.8 |
| STARTED Check for incompatibility between input language and enabled kernels |         |       | 0:11 |   1.5 |
| STARTED Add a LAM test model just to validate existing functionality        |         |       | 1:48 |  14.5 |
| STARTED Build on tags for Windows                                           |         |       | 0:15 |   2.0 |
| STARTED Add a "flat directory" mode                                         |         |       | 0:08 |   1.1 |
| STARTED Split include and source directories                                |         |       | 0:31 |   4.2 |
| STARTED Handling of visual studio projects and solutions is incorrect       |         |       | 0:49 |   6.6 |
