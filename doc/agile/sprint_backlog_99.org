...
#+CAPTION: Clock summary at [2017-03-13 Mon 15:15]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *35:20* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 35:20   |       |      | 100.0 |
| Active                                                                      |         | 35:20 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:01 |   2.9 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:26 |   1.2 |
| COMPLETED Add test model for path meta-data                                 |         |       | 2:58 |   8.4 |
| COMPLETED ODB CMakeLists does not cope with changes to project paths        |         |       | 5:04 |  14.3 |
| COMPLETED Split include and source directories                              |         |       | 5:22 |  15.2 |
| COMPLETED Add C++-03 mode                                                   |         |       | 8:19 |  23.5 |
| COMPLETED Add a LAM test model just to validate existing functionality      |         |       | 2:38 |   7.5 |
...
| STARTED Implement the database model using Northwind                        |         |       | 7:47 |  22.0 |
