...
#+CAPTION: Clock summary at [2017-03-19 Sun 18:05]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                                     | 56:17   |       |       | 100.0 |
| Active                                                                      |         | 56:17 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  3:18 |   5.9 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:26 |   0.8 |
| COMPLETED Add test model for path meta-data                                 |         |       |  2:58 |   5.3 |
| COMPLETED ODB CMakeLists does not cope with changes to project paths        |         |       |  5:04 |   9.0 |
| COMPLETED Split include and source directories                              |         |       |  5:22 |   9.5 |
| COMPLETED Add C++-03 mode                                                   |         |       |  8:19 |  14.8 |
| COMPLETED Add a LAM test model just to validate existing functionality      |         |       |  2:38 |   4.7 |
...
| COMPLETED Fix issues with dropbox downloads                                 |         |       |  3:38 |   6.5 |
...
| STARTED Implement the database model using Northwind                        |         |       | 22:05 |  39.2 |
