...
#+CAPTION: Clock summary at [2017-03-08 Wed 11:38]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *13:48* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 13:48   |       |      | 100.0 |
| Active                                                                      |         | 13:48 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:49 |   5.9 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:26 |   3.1 |
| COMPLETED Add test model for path meta-data                                 |         |       | 2:58 |  21.5 |
| COMPLETED ODB CMakeLists does not cope with changes to project paths        |         |       | 5:04 |  36.7 |
| STARTED Check for incompatibility between input language and enabled kernels |         |       | 0:11 |   1.3 |
| STARTED Add a LAM test model just to validate existing functionality        |         |       | 1:48 |  13.0 |
| STARTED Build on tags for Windows                                           |         |       | 0:15 |   1.8 |
| STARTED Add a "flat directory" mode                                         |         |       | 0:08 |   1.0 |
| STARTED Split include and source directories                                |         |       | 1:20 |   9.7 |
| STARTED Handling of visual studio projects and solutions is incorrect       |         |       | 0:49 |   5.9 |
