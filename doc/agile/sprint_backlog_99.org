...
#+CAPTION: Clock summary at [2017-03-14 Tue 22:10]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *43:35* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 43:35   |       |       | 100.0 |
| Active                                                                      |         | 43:35 |       | 100.0 |
...
| COMPLETED ODB CMakeLists does not cope with changes to project paths        |         |       |  5:04 |  11.6 |
| COMPLETED Split include and source directories                              |         |       |  5:22 |  12.3 |
| COMPLETED Add C++-03 mode                                                   |         |       |  8:19 |  19.1 |
...
| STARTED Implement the database model using Northwind                        |         |       | 15:41 |  36.0 |
