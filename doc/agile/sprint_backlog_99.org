...
#+CAPTION: Clock summary at [2017-03-19 Sun 23:09]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                                     | 59:10   |       |       | 100.0 |
| Active                                                                      |         | 59:10 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  3:18 |   5.6 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:26 |   0.7 |
| COMPLETED Add test model for path meta-data                                 |         |       |  2:58 |   5.0 |
...
| STARTED Create a UML profile to formalise yarn concepts                     |         |       |  0:23 |   0.6 |
...
| STARTED Handling of visual studio projects and solutions is incorrect       |         |       |  1:11 |   2.0 |
| STARTED Implement the database model using Northwind                        |         |       | 24:58 |  42.2 |
