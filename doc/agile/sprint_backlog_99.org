...
#+CAPTION: Clock summary at [2017-03-13 Mon 16:44]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *36:47* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 36:47   |       |      | 100.0 |
| Active                                                                      |         | 36:47 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:01 |   2.8 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:26 |   1.2 |
| COMPLETED Add test model for path meta-data                                 |         |       | 2:58 |   8.1 |
| COMPLETED ODB CMakeLists does not cope with changes to project paths        |         |       | 5:04 |  13.8 |
| COMPLETED Split include and source directories                              |         |       | 5:22 |  14.6 |
| COMPLETED Add C++-03 mode                                                   |         |       | 8:19 |  22.6 |
| COMPLETED Add a LAM test model just to validate existing functionality      |         |       | 2:38 |   7.2 |
...
| STARTED Handling of visual studio projects and solutions is incorrect       |         |       | 1:11 |   3.2 |
| STARTED Implement the database model using Northwind                        |         |       | 9:14 |  25.1 |
