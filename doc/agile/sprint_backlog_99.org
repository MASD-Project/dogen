...
#+CAPTION: Clock summary at [2017-03-08 Wed 14:39]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *15:44* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 15:44   |       |      | 100.0 |
| Active                                                                      |         | 15:44 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:49 |   5.2 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:26 |   2.8 |
| COMPLETED Add test model for path meta-data                                 |         |       | 2:58 |  18.9 |
| COMPLETED ODB CMakeLists does not cope with changes to project paths        |         |       | 5:04 |  32.2 |
| COMPLETED Split include and source directories                              |         |       | 3:16 |  20.8 |
| STARTED Check for incompatibility between input language and enabled kernels |         |       | 0:11 |   1.2 |
| STARTED Add a LAM test model just to validate existing functionality        |         |       | 1:48 |  11.4 |
| STARTED Build on tags for Windows                                           |         |       | 0:15 |   1.6 |
| STARTED Add a "flat directory" mode                                         |         |       | 0:08 |   0.8 |
| STARTED Handling of visual studio projects and solutions is incorrect       |         |       | 0:49 |   5.2 |
