...
#+CAPTION: Clock summary at [2017-03-19 Sun 12:02]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *54:30* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 54:30   |       |       | 100.0 |
| Active                                                                      |         | 54:30 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  3:18 |   6.1 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:26 |   0.8 |
| COMPLETED Add test model for path meta-data                                 |         |       |  2:58 |   5.4 |
| COMPLETED ODB CMakeLists does not cope with changes to project paths        |         |       |  5:04 |   9.3 |
| COMPLETED Split include and source directories                              |         |       |  5:22 |   9.8 |
| COMPLETED Add C++-03 mode                                                   |         |       |  8:19 |  15.3 |
| COMPLETED Add a LAM test model just to validate existing functionality      |         |       |  2:38 |   4.8 |
...
| COMPLETED Fix issues with dropbox downloads                                 |         |       |  3:38 |   6.7 |
...
| STARTED Handling of visual studio projects and solutions is incorrect       |         |       |  1:11 |   2.2 |
| STARTED Implement the database model using Northwind                        |         |       | 20:18 |  37.2 |
