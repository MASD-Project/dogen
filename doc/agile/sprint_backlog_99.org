...
#+CAPTION: Clock summary at [2017-03-07 Tue 10:05]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *6:54* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 6:54   |      |      | 100.0 |
| Active                                                                      |        | 6:54 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:16 |   3.9 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 0:26 |   6.3 |
| COMPLETED Add test model for path meta-data                                 |        |      | 2:58 |  43.0 |
| STARTED Check for incompatibility between input language and enabled kernels |        |      | 0:11 |   2.7 |
| STARTED Build on tags for Windows                                           |        |      | 0:15 |   3.6 |
| STARTED Add a "flat directory" mode                                         |        |      | 0:08 |   1.9 |
| STARTED Split include and source directories                                |        |      | 0:31 |   7.5 |
| STARTED ODB CMakeLists does not cope with changes to project paths          |        |      | 2:09 |  31.2 |
...
*** STARTED ODB CMakeLists does not cope with changes to project paths :story:
