...
#+CAPTION: Clock summary at [2017-03-17 Fri 11:50]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| COMPLETED ODB CMakeLists does not cope with changes to project paths        |         |       |  5:04 |  10.7 |
| COMPLETED Split include and source directories                              |         |       |  5:22 |  11.3 |
| COMPLETED Add C++-03 mode                                                   |         |       |  8:19 |  17.6 |
...
| COMPLETED Fix issues with dropbox downloads                                 |         |       |  2:23 |   5.0 |
...
| STARTED Implement the database model using Northwind                        |         |       | 17:06 |  36.1 |
