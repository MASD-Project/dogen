...
#+CAPTION: Clock summary at [2017-03-06 Mon 22:32]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *4:45* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 4:45   |      |      | 100.0 |
| Active                                                                      |        | 4:45 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:16 |   5.6 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 0:26 |   9.1 |
| COMPLETED Add test model for path meta-data                                 |        |      | 2:58 |  62.5 |
| STARTED Check for incompatibility between input language and enabled kernels |        |      | 0:11 |   3.9 |
| STARTED Build on tags for Windows                                           |        |      | 0:15 |   5.3 |
| STARTED Add a "flat directory" mode                                         |        |      | 0:08 |   2.8 |
| STARTED Split include and source directories                                |        |      | 0:31 |  10.9 |
...
*** ODB CMakeLists does not cope with changes to project paths        :story:
