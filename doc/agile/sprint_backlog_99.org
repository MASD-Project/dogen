...
#+CAPTION: Clock summary at [2017-03-08 Wed 23:50]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *20:18* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 20:18   |       |      | 100.0 |
| Active                                                                      |         | 20:18 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:49 |   4.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:26 |   2.1 |
| COMPLETED Add test model for path meta-data                                 |         |       | 2:58 |  14.6 |
| COMPLETED ODB CMakeLists does not cope with changes to project paths        |         |       | 5:04 |  25.0 |
| COMPLETED Split include and source directories                              |         |       | 5:22 |  26.4 |
| STARTED Check for incompatibility between input language and enabled kernels |         |       | 0:11 |   0.9 |
| STARTED Add a LAM test model just to validate existing functionality        |         |       | 1:48 |   8.9 |
| STARTED Build on tags for Windows                                           |         |       | 0:15 |   1.2 |
| STARTED Add a "flat directory" mode                                         |         |       | 0:08 |   0.7 |
| STARTED Handling of visual studio projects and solutions is incorrect       |         |       | 0:49 |   4.0 |
| STARTED Add C++-03 mode                                                     |         |       | 2:28 |  12.2 |
