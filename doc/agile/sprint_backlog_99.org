...
#+CAPTION: Clock summary at [2017-03-08 Wed 15:51]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 16:53   |       |      | 100.0 |
| Active                                                                      |         | 16:53 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:49 |   4.8 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:26 |   2.6 |
| COMPLETED Add test model for path meta-data                                 |         |       | 2:58 |  17.6 |
| COMPLETED ODB CMakeLists does not cope with changes to project paths        |         |       | 5:04 |  30.0 |
| COMPLETED Split include and source directories                              |         |       | 4:25 |  26.2 |
...
| STARTED Handling of visual studio projects and solutions is incorrect       |         |       | 0:49 |   4.8 |
