...
#+CAPTION: Clock summary at [2017-03-19 Sun 17:53]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *56:06* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 56:06   |       |       | 100.0 |
| Active                                                                      |         | 56:06 |       | 100.0 |
...
| COMPLETED Split include and source directories                              |         |       |  5:22 |   9.6 |
...
| STARTED Implement the database model using Northwind                        |         |       | 21:54 |  39.0 |
