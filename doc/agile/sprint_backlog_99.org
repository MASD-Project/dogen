...
#+CAPTION: Clock summary at [2017-03-08 Wed 12:33]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *14:42* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 14:42   |       |      | 100.0 |
| Active                                                                      |         | 14:42 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:49 |   5.6 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:26 |   2.9 |
| COMPLETED Add test model for path meta-data                                 |         |       | 2:58 |  20.2 |
| COMPLETED ODB CMakeLists does not cope with changes to project paths        |         |       | 5:04 |  34.5 |
| STARTED Check for incompatibility between input language and enabled kernels |         |       | 0:11 |   1.2 |
| STARTED Add a LAM test model just to validate existing functionality        |         |       | 1:48 |  12.2 |
| STARTED Build on tags for Windows                                           |         |       | 0:15 |   1.7 |
| STARTED Add a "flat directory" mode                                         |         |       | 0:08 |   0.9 |
| STARTED Split include and source directories                                |         |       | 2:14 |  15.2 |
| STARTED Handling of visual studio projects and solutions is incorrect       |         |       | 0:49 |   5.6 |
