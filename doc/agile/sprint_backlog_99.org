...
#+CAPTION: Clock summary at [2017-03-19 Sun 17:31]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *55:45* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 55:45   |       |       | 100.0 |
| Active                                                                      |         | 55:45 |       | 100.0 |
...
| COMPLETED ODB CMakeLists does not cope with changes to project paths        |         |       |  5:04 |   9.1 |
| COMPLETED Split include and source directories                              |         |       |  5:22 |   9.6 |
| COMPLETED Add C++-03 mode                                                   |         |       |  8:19 |  14.9 |
...
| STARTED Implement the database model using Northwind                        |         |       | 21:33 |  38.7 |
