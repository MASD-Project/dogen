...
#+CAPTION: Clock summary at [2017-03-19 Sun 17:04]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                                     | 55:19   |       |       | 100.0 |
| Active                                                                      |         | 55:19 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  3:18 |   6.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:26 |   0.8 |
| COMPLETED Add test model for path meta-data                                 |         |       |  2:58 |   5.4 |
| COMPLETED ODB CMakeLists does not cope with changes to project paths        |         |       |  5:04 |   9.2 |
| COMPLETED Split include and source directories                              |         |       |  5:22 |   9.7 |
| COMPLETED Add C++-03 mode                                                   |         |       |  8:19 |  15.0 |
...
| COMPLETED Fix issues with dropbox downloads                                 |         |       |  3:38 |   6.6 |
...
| STARTED Implement the database model using Northwind                        |         |       | 21:07 |  38.2 |
