...
#+CAPTION: Clock summary at [2017-03-13 Mon 15:50]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 35:54   |       |      | 100.0 |
| Active                                                                      |         | 35:54 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:01 |   2.8 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:26 |   1.2 |
| COMPLETED Add test model for path meta-data                                 |         |       | 2:58 |   8.3 |
| COMPLETED ODB CMakeLists does not cope with changes to project paths        |         |       | 5:04 |  14.1 |
| COMPLETED Split include and source directories                              |         |       | 5:22 |  14.9 |
| COMPLETED Add C++-03 mode                                                   |         |       | 8:19 |  23.2 |
| COMPLETED Add a LAM test model just to validate existing functionality      |         |       | 2:38 |   7.3 |
...
| STARTED Handling of visual studio projects and solutions is incorrect       |         |       | 1:11 |   3.3 |
| STARTED Implement the database model using Northwind                        |         |       | 8:21 |  23.3 |
