...
#+CAPTION: Clock summary at [2017-03-18 Sat 22:15]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                                     | 52:10   |       |       | 100.0 |
| Active                                                                      |         | 52:10 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:01 |   1.9 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:26 |   0.8 |
| COMPLETED Add test model for path meta-data                                 |         |       |  2:58 |   5.7 |
| COMPLETED ODB CMakeLists does not cope with changes to project paths        |         |       |  5:04 |   9.7 |
| COMPLETED Split include and source directories                              |         |       |  5:22 |  10.3 |
| COMPLETED Add C++-03 mode                                                   |         |       |  8:19 |  15.9 |
| COMPLETED Add a LAM test model just to validate existing functionality      |         |       |  2:38 |   5.0 |
...
| COMPLETED Fix issues with dropbox downloads                                 |         |       |  3:38 |   7.0 |
...
| STARTED Implement the database model using Northwind                        |         |       | 20:15 |  38.8 |
