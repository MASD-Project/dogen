...
#+CAPTION: Clock summary at [2017-03-17 Fri 11:18]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *46:54* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 46:54   |       |       | 100.0 |
| Active                                                                      |         | 46:54 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:01 |   2.2 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:26 |   0.9 |
| COMPLETED Add test model for path meta-data                                 |         |       |  2:58 |   6.3 |
| COMPLETED ODB CMakeLists does not cope with changes to project paths        |         |       |  5:04 |  10.8 |
| COMPLETED Split include and source directories                              |         |       |  5:22 |  11.4 |
| COMPLETED Add C++-03 mode                                                   |         |       |  8:19 |  17.7 |
| COMPLETED Add a LAM test model just to validate existing functionality      |         |       |  2:38 |   5.6 |
| COMPLETED Split project should not include model name                       |         |       |  0:18 |   0.6 |
| COMPLETED Always add multiple databases to ODB options                      |         |       |  0:03 |   0.1 |
| STARTED Fix issues with dropbox downloads                                   |         |       |  2:14 |   4.8 |
| STARTED Check for incompatibility between input language and enabled kernels |         |       |  0:11 |   0.4 |
| STARTED Build on tags for Windows                                           |         |       |  0:15 |   0.5 |
| STARTED Add a "flat directory" mode                                         |         |       |  0:08 |   0.3 |
| STARTED Handling of visual studio projects and solutions is incorrect       |         |       |  1:11 |   2.5 |
| STARTED Implement the database model using Northwind                        |         |       | 16:46 |  35.7 |
...
*** STARTED Fix issues with dropbox downloads                         :story:
...
- paper: [[http://eduglopedia.org/resource/cea008e18dee42899aeff7a0c58dddaf8e9b5bc6/download][Adapting the Access Northwind Database to Support a Database Course]]
