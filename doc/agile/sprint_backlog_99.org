...
#+CAPTION: Clock summary at [2017-03-14 Tue 18:35]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *43:02* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 43:02   |       |       | 100.0 |
| Active                                                                      |         | 43:02 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:01 |   2.4 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:26 |   1.0 |
| COMPLETED Add test model for path meta-data                                 |         |       |  2:58 |   6.9 |
| COMPLETED ODB CMakeLists does not cope with changes to project paths        |         |       |  5:04 |  11.8 |
| COMPLETED Split include and source directories                              |         |       |  5:22 |  12.5 |
| COMPLETED Add C++-03 mode                                                   |         |       |  8:19 |  19.3 |
| COMPLETED Add a LAM test model just to validate existing functionality      |         |       |  2:38 |   6.1 |
...
| STARTED Handling of visual studio projects and solutions is incorrect       |         |       |  1:11 |   2.7 |
| STARTED Implement the database model using Northwind                        |         |       | 15:11 |  35.3 |
| STARTED Split project should not include model name                         |         |       |  0:18 |   0.7 |
...
*** STARTED Split project should not include model name               :story:
...
*** Always add multiple databases to ODB options                      :story:
