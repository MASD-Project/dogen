...
#+CAPTION: Clock summary at [2017-03-13 Mon 10:34]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| COMPLETED Add test model for path meta-data                                 |         |       | 2:58 |   8.9 |
| COMPLETED ODB CMakeLists does not cope with changes to project paths        |         |       | 5:04 |  15.2 |
| COMPLETED Split include and source directories                              |         |       | 5:22 |  16.1 |
| COMPLETED Add C++-03 mode                                                   |         |       | 8:19 |  25.0 |
| STARTED Check for incompatibility between input language and enabled kernels |         |       | 0:11 |   0.6 |
| STARTED Add a LAM test model just to validate existing functionality        |         |       | 2:38 |   7.9 |
| STARTED Build on tags for Windows                                           |         |       | 0:15 |   0.8 |
| STARTED Add a "flat directory" mode                                         |         |       | 0:08 |   0.4 |
| STARTED Handling of visual studio projects and solutions is incorrect       |         |       | 1:11 |   3.6 |
| STARTED Implement the database model using Northwind                        |         |       | 5:45 |  17.3 |
