...
#+CAPTION: Clock summary at [2017-03-18 Sat 18:53]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *50:46* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 50:46   |       |       | 100.0 |
| Active                                                                      |         | 50:46 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:01 |   2.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:26 |   0.9 |
| COMPLETED Add test model for path meta-data                                 |         |       |  2:58 |   5.8 |
| COMPLETED ODB CMakeLists does not cope with changes to project paths        |         |       |  5:04 |  10.0 |
| COMPLETED Split include and source directories                              |         |       |  5:22 |  10.6 |
| COMPLETED Add C++-03 mode                                                   |         |       |  8:19 |  16.4 |
| COMPLETED Add a LAM test model just to validate existing functionality      |         |       |  2:38 |   5.2 |
...
| COMPLETED Fix issues with dropbox downloads                                 |         |       |  3:38 |   7.2 |
...
| STARTED Handling of visual studio projects and solutions is incorrect       |         |       |  1:11 |   2.3 |
| STARTED Implement the database model using Northwind                        |         |       | 18:51 |  37.1 |
