...
#+CAPTION: Clock summary at [2017-03-07 Tue 08:26]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
...
| Stories                                                                     | 5:16   |      |      | 100.0 |
| Active                                                                      |        | 5:16 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:16 |   5.1 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 0:26 |   8.2 |
| COMPLETED Add test model for path meta-data                                 |        |      | 2:58 |  56.3 |
| STARTED Check for incompatibility between input language and enabled kernels |        |      | 0:11 |   3.5 |
| STARTED Build on tags for Windows                                           |        |      | 0:15 |   4.7 |
| STARTED Add a "flat directory" mode                                         |        |      | 0:08 |   2.5 |
| STARTED Split include and source directories                                |        |      | 0:31 |   9.8 |
| STARTED ODB CMakeLists does not cope with changes to project paths          |        |      | 0:31 |   9.8 |
