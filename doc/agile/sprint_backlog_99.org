...
#+CAPTION: Clock summary at [2017-03-13 Mon 13:53]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 33:59   |       |      | 100.0 |
| Active                                                                      |         | 33:59 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:01 |   3.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:26 |   1.3 |
| COMPLETED Add test model for path meta-data                                 |         |       | 2:58 |   8.7 |
| COMPLETED ODB CMakeLists does not cope with changes to project paths        |         |       | 5:04 |  14.9 |
| COMPLETED Split include and source directories                              |         |       | 5:22 |  15.8 |
| COMPLETED Add C++-03 mode                                                   |         |       | 8:19 |  24.5 |
| STARTED Check for incompatibility between input language and enabled kernels |         |       | 0:11 |   0.5 |
| STARTED Add a LAM test model just to validate existing functionality        |         |       | 2:38 |   7.7 |
| STARTED Build on tags for Windows                                           |         |       | 0:15 |   0.7 |
| STARTED Add a "flat directory" mode                                         |         |       | 0:08 |   0.4 |
| STARTED Handling of visual studio projects and solutions is incorrect       |         |       | 1:11 |   3.5 |
| STARTED Implement the database model using Northwind                        |         |       | 6:26 |  18.9 |
