...
#+CAPTION: Clock summary at [2017-03-06 Mon 22:19]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *4:34* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 4:34   |      |      | 100.0 |
| Active                                                                      |        | 4:34 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:16 |   5.8 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 0:26 |   9.5 |
| COMPLETED Add test model for path meta-data                                 |        |      | 2:58 |  65.0 |
| STARTED Build on tags for Windows                                           |        |      | 0:15 |   5.5 |
| STARTED Add a "flat directory" mode                                         |        |      | 0:08 |   2.9 |
| STARTED Split include and source directories                                |        |      | 0:31 |  11.3 |
...
*** Check for incomatibility between input language and enabled kernels :story:
