...
#+CAPTION: Clock summary at [2017-03-13 Mon 21:10]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *40:06* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 40:06   |       |       | 100.0 |
| Active                                                                      |         | 40:06 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:01 |   2.5 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:26 |   1.1 |
| COMPLETED Add test model for path meta-data                                 |         |       |  2:58 |   7.4 |
| COMPLETED ODB CMakeLists does not cope with changes to project paths        |         |       |  5:04 |  12.6 |
| COMPLETED Split include and source directories                              |         |       |  5:22 |  13.4 |
| COMPLETED Add C++-03 mode                                                   |         |       |  8:19 |  20.7 |
| COMPLETED Add a LAM test model just to validate existing functionality      |         |       |  2:38 |   6.6 |
...
| STARTED Implement the database model using Northwind                        |         |       | 12:33 |  31.3 |
