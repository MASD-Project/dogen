...
#+CAPTION: Clock summary at [2017-03-12 Sun 18:19]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *30:46* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 30:46   |       |      | 100.0 |
| Active                                                                      |         | 30:46 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:01 |   3.3 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:26 |   1.4 |
| COMPLETED Add test model for path meta-data                                 |         |       | 2:58 |   9.6 |
| COMPLETED ODB CMakeLists does not cope with changes to project paths        |         |       | 5:04 |  16.5 |
| COMPLETED Split include and source directories                              |         |       | 5:22 |  17.4 |
| COMPLETED Add C++-03 mode                                                   |         |       | 8:19 |  27.0 |
| STARTED Check for incompatibility between input language and enabled kernels |         |       | 0:11 |   0.6 |
| STARTED Add a LAM test model just to validate existing functionality        |         |       | 2:38 |   8.6 |
| STARTED Build on tags for Windows                                           |         |       | 0:15 |   0.8 |
| STARTED Add a "flat directory" mode                                         |         |       | 0:08 |   0.4 |
| STARTED Handling of visual studio projects and solutions is incorrect       |         |       | 1:11 |   3.8 |
| STARTED Implement the database model using Northwind                        |         |       | 3:13 |  10.5 |
