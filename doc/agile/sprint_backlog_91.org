...
#+CAPTION: Clock summary at [2016-11-03 Thu 00:45]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *41:01* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 41:01   |       |      | 100.0 |
| Active                                                                      |         | 41:01 |      | 100.0 |
...
| COMPLETED Implement wale                                                    |         |       | 7:00 |  17.1 |
| COMPLETED Add artefact source properties support                            |         |       | 3:11 |   7.8 |
| COMPLETED Stitch not writing when template has changed                      |         |       | 0:33 |   1.3 |
| COMPLETED Implement helper headers using wale                               |         |       | 2:40 |   6.5 |
| COMPLETED Implement formatter headers using wale                            |         |       | 0:30 |   1.2 |
| COMPLETED Add profile support to stitch                                     |         |       | 3:48 |   9.3 |
| COMPLETED Changes to stitch to accommodate wale                             |         |       | 9:34 |  23.3 |
| COMPLETED Implement formatter helpers implementation using stitch and wale  |         |       | 5:00 |  12.2 |
| COMPLETED Merge stitch templates with formatters                            |         |       | 3:14 |   7.9 |
