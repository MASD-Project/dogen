...
#+CAPTION: Clock summary at [2016-11-03 Thu 11:56]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *43:22* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 43:22   |       |      | 100.0 |
| Active                                                                      |         | 43:22 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:14 |   2.8 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:22 |   0.8 |
| COMPLETED Improve bintray support                                           |         |       | 2:26 |   5.6 |
...
| COMPLETED Implement wale                                                    |         |       | 7:00 |  16.1 |
| COMPLETED Add artefact source properties support                            |         |       | 3:11 |   7.3 |
| COMPLETED Stitch not writing when template has changed                      |         |       | 0:33 |   1.3 |
| COMPLETED Implement helper headers using wale                               |         |       | 2:40 |   6.1 |
| COMPLETED Implement formatter headers using wale                            |         |       | 0:30 |   1.2 |
| COMPLETED Add profile support to stitch                                     |         |       | 3:48 |   8.8 |
| COMPLETED Changes to stitch to accommodate wale                             |         |       | 9:34 |  22.1 |
| COMPLETED Implement formatter helpers implementation using stitch and wale  |         |       | 5:00 |  11.5 |
| COMPLETED Merge stitch templates with formatters                            |         |       | 3:14 |   7.5 |
| COMPLETED Fix borked build due to seam errors                               |         |       | 0:12 |   0.5 |
| COMPLETED Various fixes due to stitch changes                               |         |       | 0:22 |   0.8 |
| COMPLETED Implement formatter implementation using stitch and wale          |         |       | 1:04 |   2.5 |
| STARTED Move stitching into knit                                            |         |       | 0:43 |   1.7 |
...
- move wale template name into profile; this cannot be done because we
  now have four different wale templates:
...
: <#@ stitch.wale.template=helper_formatter_implementation_enabled.wale #>
  ...
  In order to use a profile we would need four different
  profiles. Since its only one field, the work is not worth the effort.
