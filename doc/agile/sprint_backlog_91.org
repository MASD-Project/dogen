...
#+CAPTION: Clock summary at [2016-10-31 Mon 12:05]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *18:25* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 18:25   |       |      | 100.0 |
| Active                                                                      |         | 18:25 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:14 |   6.7 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:22 |   2.0 |
| COMPLETED Improve bintray support                                           |         |       | 2:26 |  13.2 |
| COMPLETED Add logo with white background                                    |         |       | 0:14 |   1.3 |
| COMPLETED Consider renaming =diagrams= to =input_models=                    |         |       | 0:38 |   3.4 |
| COMPLETED Add kvp support to annotations                                    |         |       | 0:37 |   3.3 |
| COMPLETED Implement wale                                                    |         |       | 7:00 |  38.0 |
| COMPLETED Add artefact source properties support                            |         |       | 3:11 |  17.3 |
| COMPLETED Stitch not writing when template has changed                      |         |       | 0:33 |   3.0 |
| STARTED Implement helper headers using wale                                 |         |       | 1:38 |   8.9 |
| STARTED Changes to stitch to accommodate wale                               |         |       | 0:32 |   2.9 |
...
*** STARTED Implement helper headers using wale                       :story:
...
*** Implement formatter headers using wale                            :story:
