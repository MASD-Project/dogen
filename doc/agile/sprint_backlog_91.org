...
#+CAPTION: Clock summary at [2016-11-02 Wed 17:59]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 37:02   |       |      | 100.0 |
| Active                                                                      |         | 37:02 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:14 |   3.3 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:22 |   1.0 |
| COMPLETED Improve bintray support                                           |         |       | 2:26 |   6.6 |
| COMPLETED Add logo with white background                                    |         |       | 0:14 |   0.6 |
| COMPLETED Consider renaming =diagrams= to =input_models=                    |         |       | 0:38 |   1.7 |
| COMPLETED Add kvp support to annotations                                    |         |       | 0:37 |   1.7 |
| COMPLETED Implement wale                                                    |         |       | 7:00 |  18.9 |
| COMPLETED Add artefact source properties support                            |         |       | 3:11 |   8.6 |
| COMPLETED Stitch not writing when template has changed                      |         |       | 0:33 |   1.5 |
| COMPLETED Implement helper headers using wale                               |         |       | 2:40 |   7.2 |
| COMPLETED Implement formatter headers using wale                            |         |       | 0:30 |   1.4 |
| COMPLETED Add profile support to stitch                                     |         |       | 3:48 |  10.3 |
| COMPLETED Changes to stitch to accommodate wale                             |         |       | 9:34 |  25.8 |
| STARTED Implement formatter helpers implementation using stitch and wale    |         |       | 4:15 |  11.5 |
