...
#+CAPTION: Clock summary at [2016-11-02 Wed 22:33]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| COMPLETED Improve bintray support                                           |         |       | 2:26 |   6.3 |
...
| COMPLETED Implement wale                                                    |         |       | 7:00 |  18.0 |
| COMPLETED Add artefact source properties support                            |         |       | 3:11 |   8.2 |
| COMPLETED Stitch not writing when template has changed                      |         |       | 0:33 |   1.4 |
| COMPLETED Implement helper headers using wale                               |         |       | 2:40 |   6.9 |
| COMPLETED Implement formatter headers using wale                            |         |       | 0:30 |   1.3 |
| COMPLETED Add profile support to stitch                                     |         |       | 3:48 |   9.8 |
| COMPLETED Changes to stitch to accommodate wale                             |         |       | 9:34 |  24.6 |
| COMPLETED Implement formatter helpers implementation using stitch and wale  |         |       | 5:00 |  12.9 |
| STARTED Merge stitch templates with formatters                              |         |       | 1:07 |   2.9 |
