...
#+CAPTION: Clock summary at [2016-10-27 Thu 16:00]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 16:14   |       |      | 100.0 |
| Active                                                                      |         | 16:14 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:14 |   7.6 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:22 |   2.3 |
| COMPLETED Improve bintray support                                           |         |       | 2:26 |  15.0 |
| COMPLETED Add logo with white background                                    |         |       | 0:14 |   1.4 |
| COMPLETED Consider renaming =diagrams= to =input_models=                    |         |       | 0:38 |   3.9 |
| COMPLETED Add kvp support to annotations                                    |         |       | 0:37 |   3.8 |
| COMPLETED Implement wale                                                    |         |       | 7:00 |  43.1 |
| STARTED Add artefact source properties support                              |         |       | 3:11 |  19.6 |
| STARTED Changes to stitch to accommodate wale                               |         |       | 0:32 |   3.3 |
...
*** STARTED Add artefact source properties support                    :story:
...
*** Implement helper headers using wale                               :story:
