...
#+CAPTION: Clock summary at [2016-11-03 Thu 10:42]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *42:15* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 42:15   |       |      | 100.0 |
| Active                                                                      |         | 42:15 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:14 |   2.9 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:22 |   0.9 |
| COMPLETED Improve bintray support                                           |         |       | 2:26 |   5.8 |
...
| COMPLETED Implement wale                                                    |         |       | 7:00 |  16.6 |
...
| COMPLETED Merge stitch templates with formatters                            |         |       | 3:14 |   7.7 |
| COMPLETED Fix borked build due to seam errors                               |         |       | 0:12 |   0.5 |
| COMPLETED Various fixes due to stitch changes                               |         |       | 0:22 |   0.9 |
| STARTED Implement formatter implementation using stitch and wale            |         |       | 0:40 |   1.6 |
