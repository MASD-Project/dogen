...
#+CAPTION: Clock summary at [2016-10-31 Mon 22:15]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 23:23   |       |      | 100.0 |
| Active                                                                      |         | 23:23 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:14 |   5.3 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:22 |   1.6 |
| COMPLETED Improve bintray support                                           |         |       | 2:26 |  10.4 |
...
| COMPLETED Implement wale                                                    |         |       | 7:00 |  29.9 |
| COMPLETED Add artefact source properties support                            |         |       | 3:11 |  13.6 |
| COMPLETED Stitch not writing when template has changed                      |         |       | 0:33 |   2.4 |
| COMPLETED Implement helper headers using wale                               |         |       | 2:40 |  11.4 |
| COMPLETED Implement formatter headers using wale                            |         |       | 0:28 |   2.0 |
| STARTED Add profile support to stitch                                       |         |       | 3:28 |  14.8 |
...
*** STARTED Add profile support to stitch                             :story:
