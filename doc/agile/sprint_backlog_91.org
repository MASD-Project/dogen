...
#+CAPTION: Clock summary at [2016-11-02 Wed 22:49]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *39:09* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 39:09   |       |      | 100.0 |
| Active                                                                      |         | 39:09 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:14 |   3.2 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:22 |   0.9 |
| COMPLETED Improve bintray support                                           |         |       | 2:26 |   6.2 |
...
| COMPLETED Implement wale                                                    |         |       | 7:00 |  17.9 |
| COMPLETED Add artefact source properties support                            |         |       | 3:11 |   8.1 |
| COMPLETED Stitch not writing when template has changed                      |         |       | 0:33 |   1.4 |
| COMPLETED Implement helper headers using wale                               |         |       | 2:40 |   6.8 |
| COMPLETED Implement formatter headers using wale                            |         |       | 0:30 |   1.3 |
| COMPLETED Add profile support to stitch                                     |         |       | 3:48 |   9.7 |
| COMPLETED Changes to stitch to accommodate wale                             |         |       | 9:34 |  24.4 |
| COMPLETED Implement formatter helpers implementation using stitch and wale  |         |       | 5:00 |  12.8 |
| STARTED Merge stitch templates with formatters                              |         |       | 1:22 |   3.5 |
