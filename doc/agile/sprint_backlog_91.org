...
#+CAPTION: Clock summary at [2016-11-03 Thu 10:52]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *42:23* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 42:23   |       |      | 100.0 |
| Active                                                                      |         | 42:23 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:14 |   2.9 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:22 |   0.9 |
| COMPLETED Improve bintray support                                           |         |       | 2:26 |   5.7 |
| COMPLETED Add logo with white background                                    |         |       | 0:14 |   0.6 |
| COMPLETED Consider renaming =diagrams= to =input_models=                    |         |       | 0:38 |   1.5 |
| COMPLETED Add kvp support to annotations                                    |         |       | 0:37 |   1.5 |
| COMPLETED Implement wale                                                    |         |       | 7:00 |  16.5 |
| COMPLETED Add artefact source properties support                            |         |       | 3:11 |   7.5 |
| COMPLETED Stitch not writing when template has changed                      |         |       | 0:33 |   1.3 |
| COMPLETED Implement helper headers using wale                               |         |       | 2:40 |   6.3 |
| COMPLETED Implement formatter headers using wale                            |         |       | 0:30 |   1.2 |
| COMPLETED Add profile support to stitch                                     |         |       | 3:48 |   9.0 |
| COMPLETED Changes to stitch to accommodate wale                             |         |       | 9:34 |  22.6 |
| COMPLETED Implement formatter helpers implementation using stitch and wale  |         |       | 5:00 |  11.8 |
| COMPLETED Merge stitch templates with formatters                            |         |       | 3:14 |   7.6 |
| COMPLETED Fix borked build due to seam errors                               |         |       | 0:12 |   0.5 |
| COMPLETED Various fixes due to stitch changes                               |         |       | 0:22 |   0.9 |
| STARTED Implement formatter implementation using stitch and wale            |         |       | 0:48 |   1.9 |
...
*** STARTED Implement formatter implementation using stitch and wale  :story:
...
*** Move stitching into knit                                          :story:

Once all templates have been updated with wale, we need to:

- setup the profiles with the correct input;
- move wale template name into profile;
- remove kvps from templates;
