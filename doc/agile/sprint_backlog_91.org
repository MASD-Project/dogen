...
#+CAPTION: Clock summary at [2016-11-02 Wed 23:58]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *40:17* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 40:17   |       |      | 100.0 |
| Active                                                                      |         | 40:17 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:14 |   3.1 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:22 |   0.9 |
| COMPLETED Improve bintray support                                           |         |       | 2:26 |   6.0 |
...
| COMPLETED Implement wale                                                    |         |       | 7:00 |  17.4 |
| COMPLETED Add artefact source properties support                            |         |       | 3:11 |   7.9 |
| COMPLETED Stitch not writing when template has changed                      |         |       | 0:33 |   1.4 |
| COMPLETED Implement helper headers using wale                               |         |       | 2:40 |   6.6 |
| COMPLETED Implement formatter headers using wale                            |         |       | 0:30 |   1.2 |
| COMPLETED Add profile support to stitch                                     |         |       | 3:48 |   9.4 |
| COMPLETED Changes to stitch to accommodate wale                             |         |       | 9:34 |  23.7 |
| COMPLETED Implement formatter helpers implementation using stitch and wale  |         |       | 5:00 |  12.4 |
| STARTED Merge stitch templates with formatters                              |         |       | 2:30 |   6.2 |
...
*** STARTED Merge stitch templates with formatters                    :story:
    CLOCK: [2016-11-02 Wed 23:29]--[2016-11-02 Wed 23:58] =>  0:29
