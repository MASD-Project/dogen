...
#+CAPTION: Clock summary at [2016-10-24 Mon 10:31]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *0:29* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 0:29   |      |      | 100.0 |
| Active                                                                      |        | 0:29 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:09 |  31.0 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 0:14 |  48.3 |
| COMPLETED Improve bintray support                                           |        |      | 0:06 |  20.7 |
...
- integration of stereotypes with profiles: its now possible to annotate a type with a stereotype and, if a profile with the same name exists, dogen will apply the profile to the type.
...
- rename of a lot of the meta-data tags, removing the postfix ```_formatter```.
