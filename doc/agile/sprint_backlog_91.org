...
#+CAPTION: Clock summary at [2016-11-01 Tue 19:42]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 30:10   |       |      | 100.0 |
| Active                                                                      |         | 30:10 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:14 |   4.1 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:22 |   1.2 |
| COMPLETED Improve bintray support                                           |         |       | 2:26 |   8.1 |
| COMPLETED Add logo with white background                                    |         |       | 0:14 |   0.8 |
| COMPLETED Consider renaming =diagrams= to =input_models=                    |         |       | 0:38 |   2.1 |
| COMPLETED Add kvp support to annotations                                    |         |       | 0:37 |   2.0 |
| COMPLETED Implement wale                                                    |         |       | 7:00 |  23.2 |
| COMPLETED Add artefact source properties support                            |         |       | 3:11 |  10.6 |
| COMPLETED Stitch not writing when template has changed                      |         |       | 0:33 |   1.8 |
| COMPLETED Implement helper headers using wale                               |         |       | 2:40 |   8.8 |
| COMPLETED Implement formatter headers using wale                            |         |       | 0:30 |   1.7 |
| COMPLETED Add profile support to stitch                                     |         |       | 3:48 |  12.6 |
| STARTED Changes to stitch to accommodate wale                               |         |       | 6:57 |  23.0 |
