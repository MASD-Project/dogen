...
#+CAPTION: Clock summary at [2016-11-02 Wed 20:54]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *37:21* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 37:21   |       |      | 100.0 |
| Active                                                                      |         | 37:21 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:14 |   3.3 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:22 |   1.0 |
| COMPLETED Improve bintray support                                           |         |       | 2:26 |   6.5 |
...
| COMPLETED Implement wale                                                    |         |       | 7:00 |  18.7 |
| COMPLETED Add artefact source properties support                            |         |       | 3:11 |   8.5 |
| COMPLETED Stitch not writing when template has changed                      |         |       | 0:33 |   1.5 |
| COMPLETED Implement helper headers using wale                               |         |       | 2:40 |   7.1 |
| COMPLETED Implement formatter headers using wale                            |         |       | 0:30 |   1.3 |
| COMPLETED Add profile support to stitch                                     |         |       | 3:48 |  10.2 |
| COMPLETED Changes to stitch to accommodate wale                             |         |       | 9:34 |  25.6 |
| STARTED Implement formatter helpers implementation using stitch and wale    |         |       | 4:34 |  12.2 |
