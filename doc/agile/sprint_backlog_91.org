...
#+CAPTION: Clock summary at [2016-11-02 Wed 12:01]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *33:16* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 33:16   |       |      | 100.0 |
| Active                                                                      |         | 33:16 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:14 |   3.7 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:22 |   1.1 |
| COMPLETED Improve bintray support                                           |         |       | 2:26 |   7.3 |
| COMPLETED Add logo with white background                                    |         |       | 0:14 |   0.7 |
| COMPLETED Consider renaming =diagrams= to =input_models=                    |         |       | 0:38 |   1.9 |
| COMPLETED Add kvp support to annotations                                    |         |       | 0:37 |   1.9 |
| COMPLETED Implement wale                                                    |         |       | 7:00 |  21.0 |
| COMPLETED Add artefact source properties support                            |         |       | 3:11 |   9.6 |
| COMPLETED Stitch not writing when template has changed                      |         |       | 0:33 |   1.7 |
| COMPLETED Implement helper headers using wale                               |         |       | 2:40 |   8.0 |
| COMPLETED Implement formatter headers using wale                            |         |       | 0:30 |   1.5 |
| COMPLETED Add profile support to stitch                                     |         |       | 3:48 |  11.4 |
| COMPLETED Changes to stitch to accommodate wale                             |         |       | 9:34 |  28.8 |
| STARTED Implement formatter implementation using stitch and wale            |         |       | 0:29 |   1.5 |
