...
#+CAPTION: Clock summary at [2016-11-02 Wed 14:53]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *35:25* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 35:25   |       |      | 100.0 |
| Active                                                                      |         | 35:25 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:14 |   3.5 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:22 |   1.0 |
| COMPLETED Improve bintray support                                           |         |       | 2:26 |   6.9 |
| COMPLETED Add logo with white background                                    |         |       | 0:14 |   0.7 |
| COMPLETED Consider renaming =diagrams= to =input_models=                    |         |       | 0:38 |   1.8 |
| COMPLETED Add kvp support to annotations                                    |         |       | 0:37 |   1.7 |
| COMPLETED Implement wale                                                    |         |       | 7:00 |  19.8 |
| COMPLETED Add artefact source properties support                            |         |       | 3:11 |   9.0 |
| COMPLETED Stitch not writing when template has changed                      |         |       | 0:33 |   1.6 |
| COMPLETED Implement helper headers using wale                               |         |       | 2:40 |   7.5 |
| COMPLETED Implement formatter headers using wale                            |         |       | 0:30 |   1.4 |
| COMPLETED Add profile support to stitch                                     |         |       | 3:48 |  10.7 |
| COMPLETED Changes to stitch to accommodate wale                             |         |       | 9:34 |  27.0 |
| STARTED Implement formatter helpers implementation using stitch and wale    |         |       | 2:38 |   7.4 |
...
*** STARTED Implement formatter helpers implementation using stitch and wale :story:
