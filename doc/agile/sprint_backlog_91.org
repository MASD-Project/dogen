...
#+CAPTION: Clock summary at [2016-11-03 Thu 09:45]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *41:35* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 41:35   |       |      | 100.0 |
| Active                                                                      |         | 41:35 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:14 |   3.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:22 |   0.9 |
| COMPLETED Improve bintray support                                           |         |       | 2:26 |   5.9 |
...
| COMPLETED Implement wale                                                    |         |       | 7:00 |  16.8 |
| COMPLETED Add artefact source properties support                            |         |       | 3:11 |   7.7 |
| COMPLETED Stitch not writing when template has changed                      |         |       | 0:33 |   1.3 |
| COMPLETED Implement helper headers using wale                               |         |       | 2:40 |   6.4 |
| COMPLETED Implement formatter headers using wale                            |         |       | 0:30 |   1.2 |
| COMPLETED Add profile support to stitch                                     |         |       | 3:48 |   9.1 |
| COMPLETED Changes to stitch to accommodate wale                             |         |       | 9:34 |  23.0 |
| COMPLETED Implement formatter helpers implementation using stitch and wale  |         |       | 5:00 |  12.0 |
| COMPLETED Merge stitch templates with formatters                            |         |       | 3:14 |   7.8 |
