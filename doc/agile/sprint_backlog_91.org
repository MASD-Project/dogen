...
#+CAPTION: Clock summary at [2016-11-02 Wed 21:24]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *37:47* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 37:47   |       |      | 100.0 |
| Active                                                                      |         | 37:47 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:14 |   3.3 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:22 |   1.0 |
| COMPLETED Improve bintray support                                           |         |       | 2:26 |   6.4 |
| COMPLETED Add logo with white background                                    |         |       | 0:14 |   0.6 |
| COMPLETED Consider renaming =diagrams= to =input_models=                    |         |       | 0:38 |   1.7 |
| COMPLETED Add kvp support to annotations                                    |         |       | 0:37 |   1.6 |
| COMPLETED Implement wale                                                    |         |       | 7:00 |  18.5 |
| COMPLETED Add artefact source properties support                            |         |       | 3:11 |   8.4 |
...
| COMPLETED Add profile support to stitch                                     |         |       | 3:48 |  10.1 |
| COMPLETED Changes to stitch to accommodate wale                             |         |       | 9:34 |  25.3 |
| STARTED Implement formatter helpers implementation using stitch and wale    |         |       | 5:00 |  13.2 |
