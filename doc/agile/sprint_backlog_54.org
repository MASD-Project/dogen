...
Clock summary at [2014-10-30 Thu 00:01]

| Headline                                                           | Time   |      |      |
|--------------------------------------------------------------------+--------+------+------|
| *Total time*                                                       | *1:18* |      |      |
|--------------------------------------------------------------------+--------+------+------|
| Development Stories Implemented                                    |        | 1:18 |      |
...
| IMPLEMENTATION Add registrar to =cpp= with class formatter support |        |      | 0:26 |
#+end:
...
*** IMPLEMENTATION Add registrar to =cpp= with class formatter support :story:
