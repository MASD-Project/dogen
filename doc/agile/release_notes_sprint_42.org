...
Clock summary at [2014-01-01 Wed 17:48]
...
| IMPLEMENTATION Add include file support to main type formatter          |         |       | 2:00 |
...
**** IMPLEMENTATION Solve the new lines issue in formatters            :task:
