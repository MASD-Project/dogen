...
Clock summary at [2013-12-31 Tue 16:28]

| Headline                                                                     | Time    |       |      |
|------------------------------------------------------------------------------+---------+-------+------|
| *Total time*                                                                 | *11:18* |       |      |
|------------------------------------------------------------------------------+---------+-------+------|
| Development Stories Implemented                                              |         | 11:18 |      |
...
| IMPLEMENTATION Fix differences in code generation between =om= and C++ model |         |       | 3:58 |
