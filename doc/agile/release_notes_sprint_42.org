...
Clock summary at [2014-01-04 Sat 22:10]

| Headline                                                                | Time    |       |       |
|-------------------------------------------------------------------------+---------+-------+-------|
| *Total time*                                                            | *29:19* |       |       |
|-------------------------------------------------------------------------+---------+-------+-------|
| Development Stories Implemented                                         |         | 29:19 |       |
| IMPLEMENTATION Release notes and backlog grooming                       |         |       |  1:35 |
...
| IMPLEMENTATION Add include file support to main type formatter          |         |       |  1:14 |
