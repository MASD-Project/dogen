...
Clock summary at [2013-12-31 Tue 13:29]

| Headline                                                                     | Time   |      |      |
|------------------------------------------------------------------------------+--------+------+------|
| *Total time*                                                                 | *8:33* |      |      |
|------------------------------------------------------------------------------+--------+------+------|
| Development Stories Implemented                                              |        | 8:33 |      |
...
| IMPLEMENTATION Fix differences in code generation between =om= and C++ model |        |      | 1:13 |
