...
Clock summary at [2014-01-03 Fri 01:31]

| Headline                                                                | Time    |       |      |
|-------------------------------------------------------------------------+---------+-------+------|
| *Total time*                                                            | *23:08* |       |      |
|-------------------------------------------------------------------------+---------+-------+------|
| Development Stories Implemented                                         |         | 23:08 |      |
...
| IMPLEMENTATION Solve the new lines issue in formatters                  |         |       | 7:50 |
...
**** Replace existing =om= code with new ostream filter                :task:
