...
Clock summary at [2013-12-31 Tue 16:52]

| Headline                                                                     | Time    |       |      |
|------------------------------------------------------------------------------+---------+-------+------|
| *Total time*                                                                 | *11:34* |       |      |
|------------------------------------------------------------------------------+---------+-------+------|
| Development Stories Implemented                                              |         | 11:34 |      |
...
| IMPLEMENTATION Fix differences in code generation between =om= and C++ model |         |       | 4:14 |
...
**** IMPLEMENTATION No external =std::swap=                            :task:
