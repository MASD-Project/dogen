...
Clock summary at [2014-01-03 Fri 17:06]

| Headline                                                                | Time    |       |       |
|-------------------------------------------------------------------------+---------+-------+-------|
| *Total time*                                                            | *25:53* |       |       |
|-------------------------------------------------------------------------+---------+-------+-------|
| Development Stories Implemented                                         |         | 25:53 |       |
...
| IMPLEMENTATION Solve the new lines issue in formatters                  |         |       | 10:22 |
| IMPLEMENTATION Investigate why clang is not producing code coverage     |         |       |  0:13 |
...
**** IMPLEMENTATION Replace existing =om= code with new ostream filter :task:
...
*** IMPLEMENTATION Investigate why clang is not producing code coverage :story:
