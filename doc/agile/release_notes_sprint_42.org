...
Clock summary at [2013-12-30 Mon 19:46]
...
| IMPLEMENTATION Fix differences in code generation between =om= and C++ model |        |      | 0:08 |
...
*** IMPLEMENTATION Fix differences in code generation between =om= and C++ model :story:
    CLOCK: [2013-12-30 Mon 19:38]--[2013-12-30 Mon 19:46] =>  0:08

The following problems have been detected by the diff:

- missing licence: need to add appropriate meta data
- missing includes: covered by this [[*Add%20include%20file%20support%20to%20main%20type%20formatter][story]].
- default constructor is compiler generated even thought we have an
  int
- type of the variables is blank
- =to_stream= has unexpectedly been added
- =operator== has unexpectedly been added
- member variables are public
- no =std::swap=

This story is concerned with sorting out all of these differences.
