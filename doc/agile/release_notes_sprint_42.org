...
Clock summary at [2014-01-01 Wed 15:46]

| Headline                                                                | Time    |       |      |
|-------------------------------------------------------------------------+---------+-------+------|
| *Total time*                                                            | *15:13* |       |      |
|-------------------------------------------------------------------------+---------+-------+------|
| Development Stories Implemented                                         |         | 15:13 |      |
...
| IMPLEMENTATION Add include file support to main type formatter          |         |       | 1:08 |
...
**** Fix modeling errors in terms of forward declaration files         :task:
