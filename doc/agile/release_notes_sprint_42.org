...
Clock summary at [2013-12-30 Mon 13:01]

| Headline                                                    | Time   |      |      |
|-------------------------------------------------------------+--------+------+------|
| *Total time*                                                | *2:06* |      |      |
|-------------------------------------------------------------+--------+------+------|
| Development Stories Implemented                             |        | 2:06 |      |
...
*** IMPLEMENTATION Add absolute path support to =om=                  :story:

- Transport settings all the way through to the OM workflow
- Use settings to compute the key paths: project directory, source
  directory, include directory
- Supply key paths to the formatter factory
