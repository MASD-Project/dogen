...
Clock summary at [2014-01-02 Thu 13:32]

| Headline                                                                | Time    |       |      |
|-------------------------------------------------------------------------+---------+-------+------|
| *Total time*                                                            | *18:00* |       |      |
|-------------------------------------------------------------------------+---------+-------+------|
| Development Stories Implemented                                         |         | 18:00 |      |
...
| IMPLEMENTATION Solve the new lines issue in formatters                  |         |       | 2:42 |
...
**** Add classes modeling stream and blocks                            :task:
