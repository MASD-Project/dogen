...
Clock summary at [2014-01-07 Tue 08:06]

| Headline                                                                | Time    |       |       |
|-------------------------------------------------------------------------+---------+-------+-------|
| *Total time*                                                            | *34:56* |       |       |
|-------------------------------------------------------------------------+---------+-------+-------|
| Development Stories Implemented                                         |         | 34:56 |       |
...
| IMPLEMENTATION Update all tests to use =om= formatter                   |         |       |  5:14 |
...
- create a SML transformer that takes in a =ptree= and returns the
  appropriate meta-data object model.
...
- update meta-data tagger and all other classes that use =ptree= to
  use the new meta-data object model.
...
**** IMPLEMENTATION Model =trivial_association=                        :task:
