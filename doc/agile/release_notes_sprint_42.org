...
Clock summary at [2014-01-10 Fri 19:26]

| Headline                                                                | Time    |       |       |
|-------------------------------------------------------------------------+---------+-------+-------|
| *Total time*                                                            | *45:37* |       |       |
|-------------------------------------------------------------------------+---------+-------+-------|
| Development Stories Implemented                                         |         | 45:37 |       |
...
| IMPLEMENTATION Update all tests to use =om= formatter                   |         |       | 13:13 |
...
*** IMPLEMENTATION Update all tests to use =om= formatter             :story:
...
***** IMPLEMENTATION Cope with multiple object types in formatter      :task:
