...
Clock summary at [2015-05-08 Fri 18:27]
...
| STARTED Implement types class header formatter using stitch                |         |       | 7:42 |
| STARTED Implement options copier and remove options from context           |         |       | 0:50 |
| STARTED Consider dropping the prefix inclusion in expansion                |         |       | 0:08 |
#+end:
...
- base visitor includes in descendants.
- class marked as service is being generated.
- services are being generated.
...
*** STARTED Consider dropping the prefix inclusion in expansion       :story:
...
*** Tests failing on Windows and Linux                                :story:
