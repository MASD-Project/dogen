...
Clock summary at [2015-05-01 Fri 23:25]
...
| STARTED Refactor SML association indexer                                   |         |       | 1:16 |
| STARTED Improve references management                                      |         |       | 0:13 |
| STARTED Assignment operator seems to pass types by value                   |         |       | 0:07 |
| STARTED Move injection to merging workflow                                 |         |       | 0:21 |
| STARTED Try making path expansion a merged model expansion                 |         |       | 0:52 |
#+end:
...
*** STARTED Refactor SML association indexer                          :story:
...
*** STARTED Improve references management                             :story:
...
*** STARTED Move injection to merging workflow                        :story:
...
*** STARTED Try making path expansion a merged model expansion        :story:
