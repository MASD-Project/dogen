...
#+CAPTION: Clock summary at [2017-01-18 Wed 17:39]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *19:47* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 19:47   |       |       | 100.0 |
| Active                                                                      |         |  1:32 |       |   7.8 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:32 |   7.8 |
| COMPLETED Edit release notes for previous sprint                            |         | 18:15 |       |  92.2 |
| COMPLETED Add test in knit to validate upsilon                              |         |       |  0:51 |   4.3 |
| COMPLETED Create an upsilon yarn frontend                                   |         |       | 10:18 |  52.1 |
| COMPLETED Fields with collections in upsilon cause errors                   |         |       |  1:20 |   6.7 |
| COMPLETED Bind language to kernel                                           |         |       |  1:29 |   7.5 |
| COMPLETED Upsilon can have collections of collections                       |         |       |  1:01 |   5.1 |
| STARTED Add multi-language support                                          |         |       |  2:23 |  12.0 |
| STARTED Add a type mapper                                                   |         |       |  0:18 |   1.5 |
