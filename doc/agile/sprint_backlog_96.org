...
#+CAPTION: Clock summary at [2017-01-18 Wed 15:56]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *18:06* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 18:06   |       |       | 100.0 |
| Active                                                                      |         | 18:06 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:32 |   8.5 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:35 |   3.2 |
| COMPLETED Add test in knit to validate upsilon                              |         |       |  0:51 |   4.7 |
| COMPLETED Create an upsilon yarn frontend                                   |         |       | 10:18 |  56.9 |
| COMPLETED Fields with collections in upsilon cause errors                   |         |       |  1:20 |   7.4 |
| COMPLETED Bind language to kernel                                           |         |       |  1:29 |   8.2 |
| COMPLETED Upsilon can have collections of collections                       |         |       |  1:01 |   5.6 |
| STARTED Add multi-language support                                          |         |       |  0:42 |   3.9 |
| STARTED Add a type mapper                                                   |         |       |  0:18 |   1.7 |
