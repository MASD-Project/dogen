...
#+CAPTION: Clock summary at [2017-01-21 Sat 10:05]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *31:10* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 31:10   |       |       | 100.0 |
| Active                                                                      |         | 31:10 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:32 |   4.9 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:35 |   1.9 |
| COMPLETED Add test in knit to validate upsilon                              |         |       |  0:51 |   2.7 |
| COMPLETED Create an upsilon yarn frontend                                   |         |       | 10:18 |  33.0 |
| COMPLETED Fields with collections in upsilon cause errors                   |         |       |  1:20 |   4.3 |
| COMPLETED Bind language to kernel                                           |         |       |  1:29 |   4.8 |
| COMPLETED Upsilon can have collections of collections                       |         |       |  1:01 |   3.3 |
| COMPLETED Upsilon test borked due to no output                              |         |       |  0:21 |   1.1 |
| STARTED Add multi-language support                                          |         |       |  7:24 |  23.7 |
| STARTED Add a type mapper                                                   |         |       |  6:19 |  20.3 |
