...
#+CAPTION: Clock summary at [2017-01-18 Wed 23:23]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                                     | 23:10   |       |       | 100.0 |
| Active                                                                      |         | 23:10 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:32 |   6.6 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:35 |   2.5 |
| COMPLETED Add test in knit to validate upsilon                              |         |       |  0:51 |   3.7 |
| COMPLETED Create an upsilon yarn frontend                                   |         |       | 10:18 |  44.5 |
| COMPLETED Fields with collections in upsilon cause errors                   |         |       |  1:20 |   5.8 |
| COMPLETED Bind language to kernel                                           |         |       |  1:29 |   6.4 |
| COMPLETED Upsilon can have collections of collections                       |         |       |  1:01 |   4.4 |
| COMPLETED Upsilon test borked due to no output                              |         |       |  0:21 |   1.5 |
| STARTED Add multi-language support                                          |         |       |  5:25 |  23.4 |
| STARTED Add a type mapper                                                   |         |       |  0:18 |   1.3 |
