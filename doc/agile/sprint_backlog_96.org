...
#+CAPTION: Clock summary at [2017-01-26 Thu 16:42]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *66:34* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 66:34   |       |       | 100.0 |
| Active                                                                      |         | 66:34 |       | 100.0 |
...
| COMPLETED Add support for pointers to mapper in upsilon                     |         |       |  4:44 |   7.1 |
| COMPLETED Discuss the current approach with end users                       |         |       |  1:31 |   2.3 |
| COMPLETED Rename primitives to built-in                                     |         |       |  2:20 |   3.5 |
| STARTED Create a new yarn type for primitives                               |         |       |  2:05 |   3.1 |
| STARTED Add mapping support between upsilon and LAM                         |         |       |  1:56 |   2.9 |
| STARTED Make the Zeta model compilable                                      |         |       |  0:45 |   1.1 |
| STARTED Add support for Language Agnostic Models (LAM)                      |         |       |  6:55 |  10.4 |
| STARTED Map upsilon primitives to intrinsics                                |         |       |  3:04 |   4.6 |
