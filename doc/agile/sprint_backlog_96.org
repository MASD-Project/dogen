...
*** COMPLETED Rename primitives to built-insert                       :story:
...
While we're at it, we should introduce "point type" enumeration to
replace "is floating point":
...
*** STARTED Strong type aliasing                                      :story:
