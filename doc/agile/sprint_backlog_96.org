...
#+CAPTION: Clock summary at [2017-01-26 Thu 23:21]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *68:36* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 68:36   |       |       | 100.0 |
| Active                                                                      |         | 68:36 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  3:02 |   4.4 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:35 |   0.9 |
| COMPLETED Add test in knit to validate upsilon                              |         |       |  0:51 |   1.2 |
| COMPLETED Create an upsilon yarn frontend                                   |         |       | 10:18 |  15.0 |
...
| COMPLETED Add multi-language support                                        |         |       | 13:28 |  19.6 |
| COMPLETED Add a type mapper                                                 |         |       |  6:19 |   9.2 |
...
| STARTED Create a new yarn type for primitives                               |         |       |  4:07 |   6.0 |
| STARTED Add mapping support between upsilon and LAM                         |         |       |  1:56 |   2.8 |
| STARTED Make the Zeta model compilable                                      |         |       |  0:45 |   1.1 |
| STARTED Add support for Language Agnostic Models (LAM)                      |         |       |  6:55 |  10.1 |
