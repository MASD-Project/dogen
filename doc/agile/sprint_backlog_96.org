...
#+CAPTION: Clock summary at [2017-01-26 Thu 11:37]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *63:52* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 63:52   |       |       | 100.0 |
| Active                                                                      |         | 63:52 |       | 100.0 |
...
| COMPLETED Create an upsilon yarn frontend                                   |         |       | 10:18 |  16.1 |
...
| COMPLETED Add multi-language support                                        |         |       | 13:28 |  21.1 |
| COMPLETED Add a type mapper                                                 |         |       |  6:19 |   9.9 |
...
| COMPLETED Add support for pointers to mapper in upsilon                     |         |       |  4:44 |   7.4 |
| COMPLETED Discuss the current approach with end users                       |         |       |  1:31 |   2.4 |
| STARTED Rename primitives to built-insert                                   |         |       |  1:35 |   2.5 |
| STARTED Add mapping support between upsilon and LAM                         |         |       |  1:56 |   3.0 |
| STARTED Make the Zeta model compilable                                      |         |       |  0:45 |   1.2 |
| STARTED Add support for Language Agnostic Models (LAM)                      |         |       |  6:55 |  10.8 |
