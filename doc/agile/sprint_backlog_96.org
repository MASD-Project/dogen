...
#+CAPTION: Clock summary at [2017-01-24 Tue 12:06]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *45:36* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 45:36   |       |       | 100.0 |
| Active                                                                      |         | 45:36 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  2:37 |   5.7 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:35 |   1.3 |
| COMPLETED Add test in knit to validate upsilon                              |         |       |  0:51 |   1.9 |
| COMPLETED Create an upsilon yarn frontend                                   |         |       | 10:18 |  22.6 |
| COMPLETED Fields with collections in upsilon cause errors                   |         |       |  1:20 |   2.9 |
| COMPLETED Bind language to kernel                                           |         |       |  1:29 |   3.3 |
| COMPLETED Upsilon can have collections of collections                       |         |       |  1:01 |   2.2 |
| COMPLETED Upsilon test borked due to no output                              |         |       |  0:21 |   0.8 |
| COMPLETED Add multi-language support                                        |         |       | 13:28 |  29.5 |
| COMPLETED Add a type mapper                                                 |         |       |  6:19 |  13.9 |
| COMPLETED Backslashes in strings cause JSON parsing to fail                 |         |       |  0:49 |   1.8 |
| COMPLETED Add log-level to command line                                     |         |       |  1:20 |   2.9 |
| COMPLETED Fix recursive path lookup for upsilon                             |         |       |  1:02 |   2.3 |
| COMPLETED In JSON hydrator rename simple name to simple                     |         |       |  1:03 |   2.3 |
| COMPLETED Add tailor support for upsilon                                    |         |       |  0:16 |   0.6 |
| STARTED Add mapping support between upsilon and LAM                         |         |       |  0:43 |   1.6 |
| STARTED Make the Zeta model compilable                                      |         |       |  0:45 |   1.6 |
| STARTED Add support for Language Agnostic Models (LAM)                      |         |       |  1:19 |   2.9 |
...
| lam::string                     | std::string                      | string                                      | Binary, Guid, String |
...
| lam::ordered_dictionary<K, V>   | std::map<K, V>                   | System.Collections.Generic.Dictionary<K, V> |                      |
...
*** Add support for pointers to mapper in upsilon                     :story:
...
*** Add defaults for cases where mapping is not bijective             :story:
...
*** Allow users to choose mappings                                    :story:
