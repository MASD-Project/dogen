...
#+CAPTION: Clock summary at [2017-01-25 Wed 11:53]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *55:56* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 55:56   |       |       | 100.0 |
| Active                                                                      |         | 55:56 |       | 100.0 |
...
| COMPLETED Create an upsilon yarn frontend                                   |         |       | 10:18 |  18.4 |
...
| COMPLETED Add multi-language support                                        |         |       | 13:28 |  24.1 |
| COMPLETED Add a type mapper                                                 |         |       |  6:19 |  11.3 |
| COMPLETED Backslashes in strings cause JSON parsing to fail                 |         |       |  0:49 |   1.5 |
| COMPLETED Add log-level to command line                                     |         |       |  1:20 |   2.4 |
| COMPLETED Fix recursive path lookup for upsilon                             |         |       |  1:02 |   1.8 |
| COMPLETED In JSON hydrator rename simple name to simple                     |         |       |  1:03 |   1.9 |
| COMPLETED Add tailor support for upsilon                                    |         |       |  0:16 |   0.5 |
| COMPLETED Add support for pointers to mapper in upsilon                     |         |       |  4:44 |   8.5 |
| STARTED Add mapping support between upsilon and LAM                         |         |       |  0:43 |   1.3 |
| STARTED Make the Zeta model compilable                                      |         |       |  0:45 |   1.3 |
| STARTED Add support for Language Agnostic Models (LAM)                      |         |       |  6:55 |  12.4 |
