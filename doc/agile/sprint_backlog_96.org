...
#+CAPTION: Clock summary at [2017-01-26 Thu 07:40]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| COMPLETED Add multi-language support                                        |         |       | 13:28 |  22.1 |
| COMPLETED Add a type mapper                                                 |         |       |  6:19 |  10.4 |
...
| COMPLETED Add support for pointers to mapper in upsilon                     |         |       |  4:44 |   7.8 |
| COMPLETED Discuss the current approach with end users                       |         |       |  1:31 |   2.5 |
| STARTED Add mapping support between upsilon and LAM                         |         |       |  1:56 |   3.2 |
| STARTED Make the Zeta model compilable                                      |         |       |  0:45 |   1.2 |
| STARTED Add support for Language Agnostic Models (LAM)                      |         |       |  6:55 |  11.4 |
