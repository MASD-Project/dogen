...
#+CAPTION: Clock summary at [2017-01-25 Wed 20:33]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *60:13* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 60:13   |       |       | 100.0 |
| Active                                                                      |         | 60:13 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  2:50 |   4.7 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:35 |   1.0 |
| COMPLETED Add test in knit to validate upsilon                              |         |       |  0:51 |   1.4 |
| COMPLETED Create an upsilon yarn frontend                                   |         |       | 10:18 |  17.1 |
| COMPLETED Fields with collections in upsilon cause errors                   |         |       |  1:20 |   2.2 |
| COMPLETED Bind language to kernel                                           |         |       |  1:29 |   2.5 |
| COMPLETED Upsilon can have collections of collections                       |         |       |  1:01 |   1.7 |
| COMPLETED Upsilon test borked due to no output                              |         |       |  0:21 |   0.6 |
| COMPLETED Add multi-language support                                        |         |       | 13:28 |  22.4 |
| COMPLETED Add a type mapper                                                 |         |       |  6:19 |  10.5 |
| COMPLETED Backslashes in strings cause JSON parsing to fail                 |         |       |  0:49 |   1.4 |
| COMPLETED Add log-level to command line                                     |         |       |  1:20 |   2.2 |
...
| COMPLETED Add support for pointers to mapper in upsilon                     |         |       |  4:44 |   7.9 |
| COMPLETED Discuss the current approach with end users                       |         |       |  1:31 |   2.5 |
| STARTED Add mapping support between upsilon and LAM                         |         |       |  1:13 |   2.0 |
| STARTED Make the Zeta model compilable                                      |         |       |  0:45 |   1.2 |
| STARTED Add support for Language Agnostic Models (LAM)                      |         |       |  6:55 |  11.5 |
| STARTED Map upsilon primitives to intrinsics                                |         |       |  2:03 |   3.4 |
