...
#+CAPTION: Clock summary at [2017-01-28 Sat 21:39]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *78:49* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 78:49   |       |       | 100.0 |
| Active                                                                      |         | 78:49 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  4:21 |   5.5 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:35 |   0.7 |
| COMPLETED Add test in knit to validate upsilon                              |         |       |  0:51 |   1.1 |
| COMPLETED Create an upsilon yarn frontend                                   |         |       | 10:18 |  13.1 |
...
| COMPLETED Add multi-language support                                        |         |       | 13:28 |  17.1 |
...
| STARTED Create a new yarn type for primitives                               |         |       |  9:19 |  11.8 |
| STARTED Add mapping support between upsilon and LAM                         |         |       |  1:56 |   2.5 |
| STARTED Make the Zeta model compilable                                      |         |       |  0:45 |   1.0 |
| STARTED Add support for Language Agnostic Models (LAM)                      |         |       |  6:55 |   8.8 |
| STARTED Map upsilon primitives to intrinsics                                |         |       |  3:04 |   3.9 |
| STARTED Add support for configurable enumerations types                     |         |       |  3:42 |   4.7 |
