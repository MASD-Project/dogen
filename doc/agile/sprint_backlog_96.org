...
#+CAPTION: Clock summary at [2017-01-26 Thu 22:53]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| COMPLETED Create an upsilon yarn frontend                                   |         |       | 10:18 |  15.1 |
...
| COMPLETED Add multi-language support                                        |         |       | 13:28 |  19.8 |
| COMPLETED Add a type mapper                                                 |         |       |  6:19 |   9.3 |
...
| COMPLETED Add support for pointers to mapper in upsilon                     |         |       |  4:44 |   6.9 |
| COMPLETED Discuss the current approach with end users                       |         |       |  1:31 |   2.2 |
| COMPLETED Rename primitives to built-in                                     |         |       |  2:20 |   3.4 |
| STARTED Create a new yarn type for primitives                               |         |       |  3:38 |   5.3 |
| STARTED Add mapping support between upsilon and LAM                         |         |       |  1:56 |   2.8 |
