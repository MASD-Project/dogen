...
#+CAPTION: Clock summary at [2017-01-18 Wed 22:53]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *22:41* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 22:41   |       |       | 100.0 |
| Active                                                                      |         | 22:41 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:32 |   6.8 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:35 |   2.6 |
| COMPLETED Add test in knit to validate upsilon                              |         |       |  0:51 |   3.7 |
| COMPLETED Create an upsilon yarn frontend                                   |         |       | 10:18 |  45.4 |
| COMPLETED Fields with collections in upsilon cause errors                   |         |       |  1:20 |   5.9 |
| COMPLETED Bind language to kernel                                           |         |       |  1:29 |   6.5 |
| COMPLETED Upsilon can have collections of collections                       |         |       |  1:01 |   4.5 |
| COMPLETED Upsilon test borked due to no output                              |         |       |  0:21 |   1.5 |
| STARTED Add multi-language support                                          |         |       |  4:56 |  21.7 |
