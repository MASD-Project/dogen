...
#+CAPTION: Clock summary at [2017-01-23 Mon 18:01]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *40:49* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 40:49   |       |       | 100.0 |
| Active                                                                      |         | 40:49 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:53 |   4.6 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:35 |   1.4 |
| COMPLETED Add test in knit to validate upsilon                              |         |       |  0:51 |   2.1 |
| COMPLETED Create an upsilon yarn frontend                                   |         |       | 10:18 |  25.2 |
| COMPLETED Fields with collections in upsilon cause errors                   |         |       |  1:20 |   3.3 |
| COMPLETED Bind language to kernel                                           |         |       |  1:29 |   3.6 |
| COMPLETED Upsilon can have collections of collections                       |         |       |  1:01 |   2.5 |
| COMPLETED Upsilon test borked due to no output                              |         |       |  0:21 |   0.9 |
| COMPLETED Add multi-language support                                        |         |       | 13:28 |  33.0 |
| COMPLETED Add a type mapper                                                 |         |       |  6:19 |  15.5 |
| COMPLETED Backslashes in strings cause JSON parsing to fail                 |         |       |  0:49 |   2.0 |
| COMPLETED Add log-level to command line                                     |         |       |  1:20 |   3.3 |
| COMPLETED Fix recursive path lookup for upsilon                             |         |       |  1:02 |   2.5 |
| STARTED In JSON hydrator rename simple name to simple                       |         |       |  0:03 |   0.1 |
...
*** STARTED In JSON hydrator rename simple name to simple             :story:
