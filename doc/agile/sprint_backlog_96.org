...
#+CAPTION: Clock summary at [2017-01-26 Thu 15:56]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *65:49* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 65:49   |       |       | 100.0 |
| Active                                                                      |         | 65:49 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  3:02 |   4.6 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:35 |   0.9 |
| COMPLETED Add test in knit to validate upsilon                              |         |       |  0:51 |   1.3 |
| COMPLETED Create an upsilon yarn frontend                                   |         |       | 10:18 |  15.6 |
| COMPLETED Fields with collections in upsilon cause errors                   |         |       |  1:20 |   2.0 |
| COMPLETED Bind language to kernel                                           |         |       |  1:29 |   2.3 |
| COMPLETED Upsilon can have collections of collections                       |         |       |  1:01 |   1.5 |
| COMPLETED Upsilon test borked due to no output                              |         |       |  0:21 |   0.5 |
| COMPLETED Add multi-language support                                        |         |       | 13:28 |  20.5 |
| COMPLETED Add a type mapper                                                 |         |       |  6:19 |   9.6 |
| COMPLETED Backslashes in strings cause JSON parsing to fail                 |         |       |  0:49 |   1.2 |
| COMPLETED Add log-level to command line                                     |         |       |  1:20 |   2.0 |
...
| COMPLETED Add support for pointers to mapper in upsilon                     |         |       |  4:44 |   7.2 |
| COMPLETED Discuss the current approach with end users                       |         |       |  1:31 |   2.3 |
| COMPLETED Rename primitives to built-in                                     |         |       |  2:20 |   3.5 |
| STARTED Create a new yarn type for primitives                               |         |       |  1:20 |   2.0 |
| STARTED Add mapping support between upsilon and LAM                         |         |       |  1:56 |   2.9 |
| STARTED Make the Zeta model compilable                                      |         |       |  0:45 |   1.1 |
| STARTED Add support for Language Agnostic Models (LAM)                      |         |       |  6:55 |  10.5 |
| STARTED Map upsilon primitives to intrinsics                                |         |       |  3:04 |   4.7 |
