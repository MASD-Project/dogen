...
#+CAPTION: Clock summary at [2017-01-23 Mon 22:11]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *42:48* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 42:48   |       |       | 100.0 |
| Active                                                                      |         | 42:48 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:53 |   4.4 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:35 |   1.4 |
| COMPLETED Add test in knit to validate upsilon                              |         |       |  0:51 |   2.0 |
| COMPLETED Create an upsilon yarn frontend                                   |         |       | 10:18 |  24.1 |
| COMPLETED Fields with collections in upsilon cause errors                   |         |       |  1:20 |   3.1 |
| COMPLETED Bind language to kernel                                           |         |       |  1:29 |   3.5 |
| COMPLETED Upsilon can have collections of collections                       |         |       |  1:01 |   2.4 |
| COMPLETED Upsilon test borked due to no output                              |         |       |  0:21 |   0.8 |
| COMPLETED Add multi-language support                                        |         |       | 13:28 |  31.5 |
| COMPLETED Add a type mapper                                                 |         |       |  6:19 |  14.8 |
| COMPLETED Backslashes in strings cause JSON parsing to fail                 |         |       |  0:49 |   1.9 |
| COMPLETED Add log-level to command line                                     |         |       |  1:20 |   3.1 |
| COMPLETED Fix recursive path lookup for upsilon                             |         |       |  1:02 |   2.4 |
| COMPLETED In JSON hydrator rename simple name to simple                     |         |       |  1:03 |   2.5 |
| COMPLETED Add tailor support for upsilon                                    |         |       |  0:16 |   0.6 |
| STARTED Add mapping support between upsilon and LAM                         |         |       |  0:43 |   1.7 |
