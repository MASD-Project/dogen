...
#+CAPTION: Clock summary at [2017-01-18 Wed 21:21]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *21:13* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 21:13   |       |       | 100.0 |
| Active                                                                      |         | 21:13 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:32 |   7.2 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:35 |   2.7 |
| COMPLETED Add test in knit to validate upsilon                              |         |       |  0:51 |   4.0 |
| COMPLETED Create an upsilon yarn frontend                                   |         |       | 10:18 |  48.5 |
| COMPLETED Fields with collections in upsilon cause errors                   |         |       |  1:20 |   6.3 |
| COMPLETED Bind language to kernel                                           |         |       |  1:29 |   7.0 |
| COMPLETED Upsilon can have collections of collections                       |         |       |  1:01 |   4.8 |
| COMPLETED Upsilon test borked due to no output                              |         |       |  0:21 |   1.6 |
| STARTED Add multi-language support                                          |         |       |  3:28 |  16.3 |
| STARTED Add a type mapper                                                   |         |       |  0:18 |   1.4 |
