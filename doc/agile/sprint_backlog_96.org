...
#+CAPTION: Clock summary at [2017-01-18 Wed 13:51]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *16:05* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 16:05   |       |       | 100.0 |
| Active                                                                      |         | 16:05 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:32 |   9.5 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:35 |   3.6 |
| COMPLETED Add test in knit to validate upsilon                              |         |       |  0:51 |   5.3 |
| COMPLETED Create an upsilon yarn frontend                                   |         |       | 10:18 |  64.0 |
| COMPLETED Fields with collections in upsilon cause errors                   |         |       |  1:20 |   8.3 |
| STARTED Bind language to kernel                                             |         |       |  1:29 |   9.2 |
...
*** STARTED Bind language to kernel                                   :story:
