...
#+CAPTION: Clock summary at [2017-01-26 Thu 18:42]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *67:24* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 67:24   |       |       | 100.0 |
| Active                                                                      |         | 67:24 |       | 100.0 |
...
| STARTED Create a new yarn type for primitives                               |         |       |  2:55 |   4.3 |
| STARTED Add mapping support between upsilon and LAM                         |         |       |  1:56 |   2.9 |
| STARTED Make the Zeta model compilable                                      |         |       |  0:45 |   1.1 |
| STARTED Add support for Language Agnostic Models (LAM)                      |         |       |  6:55 |  10.3 |
