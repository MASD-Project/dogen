...
#+CAPTION: Clock summary at [2017-01-24 Tue 22:56]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *52:37* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 52:37   |       |       | 100.0 |
| Active                                                                      |         | 52:37 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  2:37 |   5.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:35 |   1.1 |
| COMPLETED Add test in knit to validate upsilon                              |         |       |  0:51 |   1.6 |
| COMPLETED Create an upsilon yarn frontend                                   |         |       | 10:18 |  19.6 |
| COMPLETED Fields with collections in upsilon cause errors                   |         |       |  1:20 |   2.5 |
| COMPLETED Bind language to kernel                                           |         |       |  1:29 |   2.8 |
| COMPLETED Upsilon can have collections of collections                       |         |       |  1:01 |   1.9 |
| COMPLETED Upsilon test borked due to no output                              |         |       |  0:21 |   0.7 |
| COMPLETED Add multi-language support                                        |         |       | 13:28 |  25.6 |
| COMPLETED Add a type mapper                                                 |         |       |  6:19 |  12.0 |
| COMPLETED Backslashes in strings cause JSON parsing to fail                 |         |       |  0:49 |   1.6 |
| COMPLETED Add log-level to command line                                     |         |       |  1:20 |   2.5 |
| COMPLETED Fix recursive path lookup for upsilon                             |         |       |  1:02 |   2.0 |
| COMPLETED In JSON hydrator rename simple name to simple                     |         |       |  1:03 |   2.0 |
| COMPLETED Add tailor support for upsilon                                    |         |       |  0:16 |   0.5 |
| STARTED Add mapping support between upsilon and LAM                         |         |       |  0:43 |   1.4 |
| STARTED Make the Zeta model compilable                                      |         |       |  0:45 |   1.4 |
| STARTED Add support for Language Agnostic Models (LAM)                      |         |       |  6:55 |  13.1 |
| STARTED Add support for pointers to mapper in upsilon                       |         |       |  1:25 |   2.7 |
...
*** STARTED Add support for pointers to mapper in upsilon             :story:
