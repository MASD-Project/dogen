...
#+CAPTION: Clock summary at [2017-01-19 Thu 14:36]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| COMPLETED Create an upsilon yarn frontend                                   |         |       | 10:18 |  39.5 |
| COMPLETED Fields with collections in upsilon cause errors                   |         |       |  1:20 |   5.1 |
| COMPLETED Bind language to kernel                                           |         |       |  1:29 |   5.7 |
| COMPLETED Upsilon can have collections of collections                       |         |       |  1:01 |   3.9 |
| COMPLETED Upsilon test borked due to no output                              |         |       |  0:21 |   1.3 |
| STARTED Add multi-language support                                          |         |       |  5:36 |  21.5 |
| STARTED Add a type mapper                                                   |         |       |  3:02 |  11.6 |
