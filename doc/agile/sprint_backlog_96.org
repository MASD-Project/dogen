...
#+CAPTION: Clock summary at [2017-01-18 Wed 16:13]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *18:23* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 18:23   |       |       | 100.0 |
| Active                                                                      |         |  1:32 |       |   8.3 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:32 |   8.3 |
| COMPLETED Edit release notes for previous sprint                            |         | 16:51 |       |  91.7 |
| COMPLETED Add test in knit to validate upsilon                              |         |       |  0:51 |   4.6 |
| COMPLETED Create an upsilon yarn frontend                                   |         |       | 10:18 |  56.0 |
| COMPLETED Fields with collections in upsilon cause errors                   |         |       |  1:20 |   7.3 |
| COMPLETED Bind language to kernel                                           |         |       |  1:29 |   8.1 |
| COMPLETED Upsilon can have collections of collections                       |         |       |  1:01 |   5.5 |
| STARTED Add multi-language support                                          |         |       |  0:59 |   5.3 |
| STARTED Add a type mapper                                                   |         |       |  0:18 |   1.6 |
