...
#+CAPTION: Clock summary at [2017-01-26 Thu 18:53]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *67:33* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 67:33   |       |       | 100.0 |
| Active                                                                      |         | 67:33 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  3:02 |   4.5 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:35 |   0.9 |
| COMPLETED Add test in knit to validate upsilon                              |         |       |  0:51 |   1.3 |
| COMPLETED Create an upsilon yarn frontend                                   |         |       | 10:18 |  15.2 |
...
| COMPLETED Add multi-language support                                        |         |       | 13:28 |  19.9 |
| COMPLETED Add a type mapper                                                 |         |       |  6:19 |   9.4 |
...
| COMPLETED Add support for pointers to mapper in upsilon                     |         |       |  4:44 |   7.0 |
| COMPLETED Discuss the current approach with end users                       |         |       |  1:31 |   2.2 |
| COMPLETED Rename primitives to built-in                                     |         |       |  2:20 |   3.5 |
| STARTED Create a new yarn type for primitives                               |         |       |  3:04 |   4.5 |
| STARTED Add mapping support between upsilon and LAM                         |         |       |  1:56 |   2.9 |
| STARTED Make the Zeta model compilable                                      |         |       |  0:45 |   1.1 |
| STARTED Add support for Language Agnostic Models (LAM)                      |         |       |  6:55 |  10.2 |
| STARTED Map upsilon primitives to intrinsics                                |         |       |  3:04 |   4.5 |
