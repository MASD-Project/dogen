...
#+CAPTION: Clock summary at [2017-01-21 Sat 12:55]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *32:33* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 32:33   |       |       | 100.0 |
| Active                                                                      |         | 32:33 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:32 |   4.7 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:35 |   1.8 |
| COMPLETED Add test in knit to validate upsilon                              |         |       |  0:51 |   2.6 |
| COMPLETED Create an upsilon yarn frontend                                   |         |       | 10:18 |  31.6 |
| COMPLETED Fields with collections in upsilon cause errors                   |         |       |  1:20 |   4.1 |
| COMPLETED Bind language to kernel                                           |         |       |  1:29 |   4.6 |
| COMPLETED Upsilon can have collections of collections                       |         |       |  1:01 |   3.1 |
| COMPLETED Upsilon test borked due to no output                              |         |       |  0:21 |   1.1 |
| STARTED Add multi-language support                                          |         |       |  8:47 |  27.0 |
| STARTED Add a type mapper                                                   |         |       |  6:19 |  19.4 |
