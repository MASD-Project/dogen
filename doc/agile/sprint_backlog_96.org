...
#+CAPTION: Clock summary at [2017-01-28 Sat 19:08]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *76:44* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 76:44   |       |       | 100.0 |
| Active                                                                      |         | 76:44 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  4:21 |   5.7 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:35 |   0.8 |
| COMPLETED Add test in knit to validate upsilon                              |         |       |  0:51 |   1.1 |
| COMPLETED Create an upsilon yarn frontend                                   |         |       | 10:18 |  13.4 |
...
| COMPLETED Add multi-language support                                        |         |       | 13:28 |  17.5 |
| COMPLETED Add a type mapper                                                 |         |       |  6:19 |   8.2 |
...
| COMPLETED Add support for pointers to mapper in upsilon                     |         |       |  4:44 |   6.2 |
| COMPLETED Discuss the current approach with end users                       |         |       |  1:31 |   2.0 |
| COMPLETED Rename primitives to built-in                                     |         |       |  2:20 |   3.0 |
| STARTED Create a new yarn type for primitives                               |         |       |  9:19 |  12.1 |
| STARTED Add mapping support between upsilon and LAM                         |         |       |  1:56 |   2.5 |
| STARTED Make the Zeta model compilable                                      |         |       |  0:45 |   1.0 |
| STARTED Add support for Language Agnostic Models (LAM)                      |         |       |  6:55 |   9.0 |
| STARTED Map upsilon primitives to intrinsics                                |         |       |  3:04 |   4.0 |
| STARTED Add support for configurable enumerations types                     |         |       |  1:37 |   2.1 |
...
*** STARTED Add support for configurable enumerations types           :story:
