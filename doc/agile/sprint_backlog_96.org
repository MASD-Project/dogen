...
#+CAPTION: Clock summary at [2017-01-24 Tue 17:25]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                                     | 49:59   |       |       | 100.0 |
| Active                                                                      |         | 49:59 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  2:37 |   5.2 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:35 |   1.2 |
| COMPLETED Add test in knit to validate upsilon                              |         |       |  0:51 |   1.7 |
| COMPLETED Create an upsilon yarn frontend                                   |         |       | 10:18 |  20.6 |
| COMPLETED Fields with collections in upsilon cause errors                   |         |       |  1:20 |   2.7 |
| COMPLETED Bind language to kernel                                           |         |       |  1:29 |   3.0 |
| COMPLETED Upsilon can have collections of collections                       |         |       |  1:01 |   2.0 |
| COMPLETED Upsilon test borked due to no output                              |         |       |  0:21 |   0.7 |
| COMPLETED Add multi-language support                                        |         |       | 13:28 |  26.9 |
| COMPLETED Add a type mapper                                                 |         |       |  6:19 |  12.6 |
| COMPLETED Backslashes in strings cause JSON parsing to fail                 |         |       |  0:49 |   1.6 |
| COMPLETED Add log-level to command line                                     |         |       |  1:20 |   2.7 |
| COMPLETED Fix recursive path lookup for upsilon                             |         |       |  1:02 |   2.1 |
...
| STARTED Add support for Language Agnostic Models (LAM)                      |         |       |  5:42 |  11.4 |
