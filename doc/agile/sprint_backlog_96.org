...
#+CAPTION: Clock summary at [2017-01-16 Mon 18:01]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *5:58* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 5:58   |      |      | 100.0 |
| Active                                                                      |        | 5:58 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:23 |   6.4 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 0:35 |   9.8 |
| COMPLETED Add test in knit to validate upsilon                              |        |      | 0:51 |  14.2 |
| STARTED Create an upsilon yarn frontend                                     |        |      | 4:09 |  69.6 |
...
is always the same. However, with upsilon things change: we need upsilon
