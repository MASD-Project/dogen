...
#+CAPTION: Clock summary at [2017-01-23 Mon 21:10]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *41:49* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 41:49   |       |       | 100.0 |
| Active                                                                      |         | 41:49 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:53 |   4.5 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:35 |   1.4 |
| COMPLETED Add test in knit to validate upsilon                              |         |       |  0:51 |   2.0 |
| COMPLETED Create an upsilon yarn frontend                                   |         |       | 10:18 |  24.6 |
| COMPLETED Fields with collections in upsilon cause errors                   |         |       |  1:20 |   3.2 |
...
| COMPLETED Add multi-language support                                        |         |       | 13:28 |  32.2 |
| COMPLETED Add a type mapper                                                 |         |       |  6:19 |  15.1 |
| COMPLETED Backslashes in strings cause JSON parsing to fail                 |         |       |  0:49 |   2.0 |
| COMPLETED Add log-level to command line                                     |         |       |  1:20 |   3.2 |
| COMPLETED Fix recursive path lookup for upsilon                             |         |       |  1:02 |   2.5 |
