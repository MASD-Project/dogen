...
#+CAPTION: Clock summary at [2016-10-03 Mon 23:06]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *52:45* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 52:45   |       |      | 100.0 |
| Active                                                                      |         | 52:45 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 4:37 |   8.8 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:07 |   0.2 |
| COMPLETED Generation of formattable is incorrect                            |         |       | 2:30 |   4.7 |
| COMPLETED Visitor includes are incorrect                                    |         |       | 0:20 |   0.6 |
| COMPLETED Add includer to quilt.cpp                                         |         |       | 1:46 |   3.3 |
...
| COMPLETED Investigate element annotation support                            |         |       | 2:05 |   3.9 |
| CANCELLED Add streaming settings expander                                   |         |       | 0:36 |   1.1 |
| COMPLETED Create the formattables model                                     |         |       | 1:32 |   2.9 |
| COMPLETED Hook formattables into formatters                                 |         |       | 3:58 |   7.5 |
| COMPLETED Remove empty context                                              |         |       | 1:09 |   2.2 |
| COMPLETED Review main classes in quilt.cpp                                  |         |       | 3:42 |   7.0 |
| COMPLETED Clean up element segmentation                                     |         |       | 1:20 |   2.5 |
| COMPLETED Get OSX build to compile code                                     |         |       | 7:05 |  13.4 |
...
| COMPLETED Analysis around terminology in formatting space                   |         |       | 3:24 |   6.4 |
| COMPLETED Remove =original_model_name=                                      |         |       | 0:16 |   0.5 |
| COMPLETED Refactor code around model origination                            |         |       | 4:08 |   7.8 |
...
| STARTED Handle registration of services properly                            |         |       | 2:13 |   4.2 |
| STARTED Expander refactor in =quilt.cpp=                                    |         |       | 2:10 |   4.1 |
