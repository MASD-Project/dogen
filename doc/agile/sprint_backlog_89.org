...
#+CAPTION: Clock summary at [2016-10-07 Fri 13:15]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *82:48* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 82:48   |       |       | 100.0 |
| Active                                                                      |         | 82:48 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  5:30 |   6.6 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:07 |   0.1 |
| COMPLETED Generation of formattable is incorrect                            |         |       |  2:30 |   3.0 |
| COMPLETED Visitor includes are incorrect                                    |         |       |  0:20 |   0.4 |
| COMPLETED Add includer to quilt.cpp                                         |         |       |  1:46 |   2.1 |
...
| COMPLETED Get OSX build to compile code                                     |         |       |  7:05 |   8.6 |
...
| COMPLETED Analysis around terminology in formatting space                   |         |       |  3:24 |   4.1 |
| COMPLETED Remove =original_model_name=                                      |         |       |  0:16 |   0.3 |
| COMPLETED Refactor code around model origination                            |         |       |  4:08 |   5.0 |
...
| COMPLETED Create the notion of a formatter alias                            |         |       |  3:15 |   3.9 |
| COMPLETED Remove enabled formatters from formatter configuration            |         |       |  0:22 |   0.4 |
| COMPLETED Handle registration of services properly                          |         |       |  3:41 |   4.4 |
| COMPLETED Move stereotypes to element                                       |         |       |  0:21 |   0.4 |
| COMPLETED Improve project banner                                            |         |       |  0:32 |   0.6 |
| CANCELLED Add support for profiles                                          |         |       | 10:40 |  12.9 |
| COMPLETED Refactor =yarn.dia= transformer                                   |         |       |  8:49 |  10.6 |
| STARTED Create a dynamic expander in yarn                                   |         |       |  1:55 |   2.3 |
| STARTED Rewrite profile support                                             |         |       |  1:26 |   1.7 |
