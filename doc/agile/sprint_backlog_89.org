...
#+CAPTION: Clock summary at [2016-10-06 Thu 09:56]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                                     | 70:23   |       |       | 100.0 |
| Active                                                                      |         | 70:23 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  5:15 |   7.5 |
...
| COMPLETED Hook formattables into formatters                                 |         |       |  3:58 |   5.6 |
| COMPLETED Remove empty context                                              |         |       |  1:09 |   1.6 |
| COMPLETED Review main classes in quilt.cpp                                  |         |       |  3:42 |   5.3 |
| COMPLETED Clean up element segmentation                                     |         |       |  1:20 |   1.9 |
| COMPLETED Get OSX build to compile code                                     |         |       |  7:05 |  10.1 |
...
| COMPLETED Analysis around terminology in formatting space                   |         |       |  3:24 |   4.8 |
| COMPLETED Remove =original_model_name=                                      |         |       |  0:16 |   0.4 |
| COMPLETED Refactor code around model origination                            |         |       |  4:08 |   5.9 |
...
| COMPLETED Expander refactor in =quilt.cpp=                                  |         |       |  3:03 |   4.3 |
| COMPLETED Create the notion of a formatter alias                            |         |       |  3:15 |   4.6 |
| COMPLETED Remove enabled formatters from formatter configuration            |         |       |  0:22 |   0.5 |
| COMPLETED Handle registration of services properly                          |         |       |  3:41 |   5.2 |
| COMPLETED Move stereotypes to element                                       |         |       |  0:21 |   0.5 |
| COMPLETED Improve project banner                                            |         |       |  0:32 |   0.8 |
| STARTED Add support for profiles                                            |         |       | 10:40 |  15.2 |
