...
#+CAPTION: Clock summary at [2016-10-05 Wed 14:52]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *62:51* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 62:51   |       |      | 100.0 |
| Active                                                                      |         | 62:51 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 4:50 |   7.7 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:07 |   0.2 |
| COMPLETED Generation of formattable is incorrect                            |         |       | 2:30 |   4.0 |
| COMPLETED Visitor includes are incorrect                                    |         |       | 0:20 |   0.5 |
| COMPLETED Add includer to quilt.cpp                                         |         |       | 1:46 |   2.8 |
...
| COMPLETED Investigate element annotation support                            |         |       | 2:05 |   3.3 |
| CANCELLED Add streaming settings expander                                   |         |       | 0:36 |   1.0 |
| COMPLETED Create the formattables model                                     |         |       | 1:32 |   2.4 |
| COMPLETED Hook formattables into formatters                                 |         |       | 3:58 |   6.3 |
| COMPLETED Remove empty context                                              |         |       | 1:09 |   1.8 |
| COMPLETED Review main classes in quilt.cpp                                  |         |       | 3:42 |   5.9 |
| COMPLETED Clean up element segmentation                                     |         |       | 1:20 |   2.1 |
| COMPLETED Get OSX build to compile code                                     |         |       | 7:05 |  11.3 |
...
| COMPLETED Analysis around terminology in formatting space                   |         |       | 3:24 |   5.4 |
| COMPLETED Remove =original_model_name=                                      |         |       | 0:16 |   0.4 |
| COMPLETED Refactor code around model origination                            |         |       | 4:08 |   6.6 |
...
| COMPLETED Expander refactor in =quilt.cpp=                                  |         |       | 3:03 |   4.9 |
| COMPLETED Create the notion of a formatter alias                            |         |       | 3:15 |   5.2 |
| COMPLETED Remove enabled formatters from formatter configuration            |         |       | 0:22 |   0.6 |
| COMPLETED Handle registration of services properly                          |         |       | 3:41 |   5.9 |
| STARTED Add support for profiles                                            |         |       | 4:26 |   7.1 |
