...
#+CAPTION: Clock summary at [2016-10-07 Fri 10:06]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *79:47* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 79:47   |       |       | 100.0 |
| Active                                                                      |         | 79:47 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  5:30 |   6.9 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:07 |   0.1 |
| COMPLETED Generation of formattable is incorrect                            |         |       |  2:30 |   3.1 |
...
| COMPLETED Remove empty context                                              |         |       |  1:09 |   1.4 |
| COMPLETED Review main classes in quilt.cpp                                  |         |       |  3:42 |   4.6 |
| COMPLETED Clean up element segmentation                                     |         |       |  1:20 |   1.7 |
| COMPLETED Get OSX build to compile code                                     |         |       |  7:05 |   8.9 |
...
| COMPLETED Refactor code around model origination                            |         |       |  4:08 |   5.2 |
...
| COMPLETED Expander refactor in =quilt.cpp=                                  |         |       |  3:03 |   3.8 |
...
| COMPLETED Handle registration of services properly                          |         |       |  3:41 |   4.6 |
| COMPLETED Move stereotypes to element                                       |         |       |  0:21 |   0.4 |
| COMPLETED Improve project banner                                            |         |       |  0:32 |   0.7 |
| CANCELLED Add support for profiles                                          |         |       | 10:40 |  13.4 |
| STARTED Refactor =yarn.dia= transformer                                     |         |       |  7:23 |   9.3 |
