...
#+CAPTION: Clock summary at [2016-10-09 Sun 18:08]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *98:45* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 98:45   |       |       | 100.0 |
| Active                                                                      |         | 98:45 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  5:36 |   5.7 |
...
| COMPLETED Hook formattables into formatters                                 |         |       |  3:58 |   4.0 |
...
| COMPLETED Get OSX build to compile code                                     |         |       |  7:05 |   7.2 |
...
| COMPLETED Handle registration of services properly                          |         |       |  3:41 |   3.7 |
| COMPLETED Move stereotypes to element                                       |         |       |  0:21 |   0.4 |
| COMPLETED Improve project banner                                            |         |       |  0:32 |   0.5 |
| CANCELLED Add support for profiles                                          |         |       | 10:40 |  10.8 |
| COMPLETED Move emacs to rtags                                               |         |       |  5:28 |   5.5 |
| COMPLETED Refactor =yarn.dia= transformer                                   |         |       |  8:49 |   8.9 |
| COMPLETED Create a dynamic expander in yarn                                 |         |       |  5:52 |   5.9 |
...
*** Refactor facet directory expander                                 :story:
