...
#+CAPTION: Clock summary at [2016-10-01 Sat 22:50]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 33:41   |       |      | 100.0 |
| Active                                                                      |         | 33:41 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:49 |   2.4 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:07 |   0.3 |
| COMPLETED Generation of formattable is incorrect                            |         |       | 2:30 |   7.4 |
| COMPLETED Visitor includes are incorrect                                    |         |       | 0:20 |   1.0 |
| COMPLETED Add includer to quilt.cpp                                         |         |       | 1:46 |   5.2 |
| COMPLETED Add reducer to quilt.cpp                                          |         |       | 0:22 |   1.1 |
| COMPLETED Add new index to formtter container                               |         |       | 0:19 |   0.9 |
| COMPLETED Add path expander to quilt.cpp                                    |         |       | 0:49 |   2.4 |
| COMPLETED Add guard expander to quilt.cpp                                   |         |       | 0:27 |   1.3 |
| COMPLETED Investigate borked travis build                                   |         |       | 0:37 |   1.8 |
| COMPLETED Add decoration expander to quilt.cpp                              |         |       | 0:23 |   1.1 |
| COMPLETED Add aspect expander to quilt.cpp                                  |         |       | 1:26 |   4.3 |
| COMPLETED Run tests that are passing on windows                             |         |       | 0:10 |   0.5 |
| COMPLETED Add helper expander to quilt.cpp                                  |         |       | 1:26 |   4.3 |
| COMPLETED Merge pre and post workflows                                      |         |       | 0:16 |   0.8 |
| COMPLETED Fix bug in aspect and helper generation                           |         |       | 0:15 |   0.7 |
| COMPLETED Investigate element annotation support                            |         |       | 2:05 |   6.2 |
| CANCELLED Add streaming settings expander                                   |         |       | 0:36 |   1.8 |
| COMPLETED Create the formattables model                                     |         |       | 1:32 |   4.6 |
| COMPLETED Hook formattables into formatters                                 |         |       | 3:58 |  11.8 |
| COMPLETED Remove empty context                                              |         |       | 1:09 |   3.4 |
| COMPLETED Review main classes in quilt.cpp                                  |         |       | 3:42 |  11.0 |
| COMPLETED Clean up element segmentation                                     |         |       | 1:20 |   4.0 |
| STARTED Remove formatter id                                                 |         |       | 0:04 |   0.2 |
| STARTED Generate formatter interfaces                                       |         |       | 0:19 |   0.9 |
| STARTED Get OSX build to compile code                                       |         |       | 6:54 |  20.5 |
