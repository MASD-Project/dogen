...
#+CAPTION: Clock summary at [2016-10-07 Fri 18:08]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| COMPLETED Create the formattables model                                     |         |       |  1:32 |   1.8 |
| COMPLETED Hook formattables into formatters                                 |         |       |  3:58 |   4.7 |
| COMPLETED Remove empty context                                              |         |       |  1:09 |   1.4 |
| COMPLETED Review main classes in quilt.cpp                                  |         |       |  3:42 |   4.4 |
| COMPLETED Clean up element segmentation                                     |         |       |  1:20 |   1.6 |
| COMPLETED Get OSX build to compile code                                     |         |       |  7:05 |   8.4 |
...
| COMPLETED Analysis around terminology in formatting space                   |         |       |  3:24 |   4.0 |
| COMPLETED Remove =original_model_name=                                      |         |       |  0:16 |   0.3 |
| COMPLETED Refactor code around model origination                            |         |       |  4:08 |   4.9 |
...
| COMPLETED Expander refactor in =quilt.cpp=                                  |         |       |  3:03 |   3.6 |
...
| CANCELLED Add support for profiles                                          |         |       | 10:40 |  12.7 |
| COMPLETED Refactor =yarn.dia= transformer                                   |         |       |  8:49 |  10.5 |
| STARTED Create a dynamic expander in yarn                                   |         |       |  3:05 |   3.7 |
