...
#+CAPTION: Clock summary at [2016-10-02 Sun 21:41]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *40:34* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 40:34   |       |      | 100.0 |
| Active                                                                      |         | 40:34 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 3:17 |   8.1 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:07 |   0.3 |
| COMPLETED Generation of formattable is incorrect                            |         |       | 2:30 |   6.2 |
| COMPLETED Visitor includes are incorrect                                    |         |       | 0:20 |   0.8 |
| COMPLETED Add includer to quilt.cpp                                         |         |       | 1:46 |   4.4 |
...
| COMPLETED Create the formattables model                                     |         |       | 1:32 |   3.8 |
| COMPLETED Hook formattables into formatters                                 |         |       | 3:58 |   9.8 |
| COMPLETED Remove empty context                                              |         |       | 1:09 |   2.8 |
| COMPLETED Review main classes in quilt.cpp                                  |         |       | 3:42 |   9.1 |
| COMPLETED Clean up element segmentation                                     |         |       | 1:20 |   3.3 |
| COMPLETED Get OSX build to compile code                                     |         |       | 7:05 |  17.5 |
| COMPLETED Add a banner to readme                                            |         |       | 1:29 |   3.7 |
| STARTED Remove formatter id                                                 |         |       | 0:04 |   0.2 |
| STARTED Generate formatter interfaces                                       |         |       | 0:19 |   0.8 |
| STARTED Analysis around terminology in formatting space                     |         |       | 2:45 |   6.8 |
