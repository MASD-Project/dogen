...
#+CAPTION: Clock summary at [2016-10-06 Thu 23:34]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *77:29* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 77:29   |       |       | 100.0 |
| Active                                                                      |         | 77:29 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  5:30 |   7.1 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:07 |   0.2 |
| COMPLETED Generation of formattable is incorrect                            |         |       |  2:30 |   3.2 |
...
| COMPLETED Add aspect expander to quilt.cpp                                  |         |       |  1:26 |   1.8 |
| COMPLETED Run tests that are passing on windows                             |         |       |  0:10 |   0.2 |
| COMPLETED Add helper expander to quilt.cpp                                  |         |       |  1:26 |   1.8 |
| COMPLETED Merge pre and post workflows                                      |         |       |  0:16 |   0.3 |
| COMPLETED Fix bug in aspect and helper generation                           |         |       |  0:15 |   0.3 |
| COMPLETED Investigate element annotation support                            |         |       |  2:05 |   2.7 |
| CANCELLED Add streaming settings expander                                   |         |       |  0:36 |   0.8 |
| COMPLETED Create the formattables model                                     |         |       |  1:32 |   2.0 |
| COMPLETED Hook formattables into formatters                                 |         |       |  3:58 |   5.1 |
| COMPLETED Remove empty context                                              |         |       |  1:09 |   1.5 |
| COMPLETED Review main classes in quilt.cpp                                  |         |       |  3:42 |   4.8 |
| COMPLETED Clean up element segmentation                                     |         |       |  1:20 |   1.7 |
| COMPLETED Get OSX build to compile code                                     |         |       |  7:05 |   9.1 |
| COMPLETED Add a banner to readme                                            |         |       |  1:29 |   1.9 |
...
| COMPLETED Analysis around terminology in formatting space                   |         |       |  3:24 |   4.4 |
| COMPLETED Remove =original_model_name=                                      |         |       |  0:16 |   0.3 |
| COMPLETED Refactor code around model origination                            |         |       |  4:08 |   5.3 |
...
| COMPLETED Expander refactor in =quilt.cpp=                                  |         |       |  3:03 |   3.9 |
| COMPLETED Create the notion of a formatter alias                            |         |       |  3:15 |   4.2 |
| COMPLETED Remove enabled formatters from formatter configuration            |         |       |  0:22 |   0.5 |
| COMPLETED Handle registration of services properly                          |         |       |  3:41 |   4.8 |
| COMPLETED Move stereotypes to element                                       |         |       |  0:21 |   0.5 |
| COMPLETED Improve project banner                                            |         |       |  0:32 |   0.7 |
| CANCELLED Add support for profiles                                          |         |       | 10:40 |  13.8 |
| STARTED Refactor =yarn.dia= transformer                                     |         |       |  5:05 |   6.6 |
| STARTED Create a dynamic expander in yarn                                   |         |       |  0:20 |   0.4 |
| STARTED Rewrite profile support                                             |         |       |  1:26 |   1.8 |
