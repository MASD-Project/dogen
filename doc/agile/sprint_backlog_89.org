...
#+CAPTION: Clock summary at [2016-09-26 Mon 17:49]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *6:53* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 6:53   |      |      | 100.0 |
| Active                                                                      |        | 6:53 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:40 |   9.7 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 0:07 |   1.7 |
| COMPLETED Generation of formattable is incorrect                            |        |      | 2:30 |  36.3 |
| COMPLETED Visitor includes are incorrect                                    |        |      | 0:20 |   4.8 |
| COMPLETED Add includer to quilt.cpp                                         |        |      | 1:46 |  25.7 |
| COMPLETED Add reducer to quilt.cpp                                          |        |      | 0:22 |   5.3 |
| COMPLETED Add new index to formtter container                               |        |      | 0:19 |   4.6 |
| COMPLETED Add path generator to quilt.cpp                                   |        |      | 0:49 |  11.9 |
