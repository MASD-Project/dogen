...
#+CAPTION: Clock summary at [2016-10-07 Fri 11:07]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *80:46* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 80:46   |       |       | 100.0 |
| Active                                                                      |         | 80:46 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  5:30 |   6.8 |
...
| COMPLETED Hook formattables into formatters                                 |         |       |  3:58 |   4.9 |
...
| COMPLETED Get OSX build to compile code                                     |         |       |  7:05 |   8.8 |
| COMPLETED Add a banner to readme                                            |         |       |  1:29 |   1.8 |
...
| COMPLETED Analysis around terminology in formatting space                   |         |       |  3:24 |   4.2 |
| COMPLETED Remove =original_model_name=                                      |         |       |  0:16 |   0.3 |
| COMPLETED Refactor code around model origination                            |         |       |  4:08 |   5.1 |
...
| COMPLETED Create the notion of a formatter alias                            |         |       |  3:15 |   4.0 |
...
| CANCELLED Add support for profiles                                          |         |       | 10:40 |  13.2 |
| STARTED Refactor =yarn.dia= transformer                                     |         |       |  8:22 |  10.4 |
