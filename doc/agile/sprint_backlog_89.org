...
#+CAPTION: Clock summary at [2016-10-03 Mon 10:21]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *43:11* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 43:11   |       |      | 100.0 |
| Active                                                                      |         | 43:11 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 4:37 |  10.7 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:07 |   0.3 |
| COMPLETED Generation of formattable is incorrect                            |         |       | 2:30 |   5.8 |
| COMPLETED Visitor includes are incorrect                                    |         |       | 0:20 |   0.8 |
| COMPLETED Add includer to quilt.cpp                                         |         |       | 1:46 |   4.1 |
| COMPLETED Add reducer to quilt.cpp                                          |         |       | 0:22 |   0.8 |
| COMPLETED Add new index to formtter container                               |         |       | 0:19 |   0.7 |
| COMPLETED Add path expander to quilt.cpp                                    |         |       | 0:49 |   1.9 |
...
| COMPLETED Add aspect expander to quilt.cpp                                  |         |       | 1:26 |   3.3 |
| COMPLETED Run tests that are passing on windows                             |         |       | 0:10 |   0.4 |
| COMPLETED Add helper expander to quilt.cpp                                  |         |       | 1:26 |   3.3 |
| COMPLETED Merge pre and post workflows                                      |         |       | 0:16 |   0.6 |
| COMPLETED Fix bug in aspect and helper generation                           |         |       | 0:15 |   0.6 |
| COMPLETED Investigate element annotation support                            |         |       | 2:05 |   4.8 |
| CANCELLED Add streaming settings expander                                   |         |       | 0:36 |   1.4 |
| COMPLETED Create the formattables model                                     |         |       | 1:32 |   3.6 |
| COMPLETED Hook formattables into formatters                                 |         |       | 3:58 |   9.2 |
| COMPLETED Remove empty context                                              |         |       | 1:09 |   2.7 |
| COMPLETED Review main classes in quilt.cpp                                  |         |       | 3:42 |   8.6 |
| COMPLETED Clean up element segmentation                                     |         |       | 1:20 |   3.1 |
| COMPLETED Get OSX build to compile code                                     |         |       | 7:05 |  16.4 |
| COMPLETED Add a banner to readme                                            |         |       | 1:29 |   3.4 |
| COMPLETED Remove formatter group                                            |         |       | 0:23 |   0.9 |
| COMPLETED Add more types to =quilt::cpp= canned tests                       |         |       | 0:15 |   0.6 |
| CANCELLED Remove formatter id                                               |         |       | 0:04 |   0.2 |
| COMPLETED Analysis around terminology in formatting space                   |         |       | 3:24 |   7.9 |
