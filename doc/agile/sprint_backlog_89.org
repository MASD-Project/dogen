...
#+CAPTION: Clock summary at [2016-10-09 Sun 13:18]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *90:27* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 90:27   |       |       | 100.0 |
| Active                                                                      |         | 90:27 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  5:30 |   6.1 |
...
| COMPLETED Hook formattables into formatters                                 |         |       |  3:58 |   4.4 |
| COMPLETED Remove empty context                                              |         |       |  1:09 |   1.3 |
| COMPLETED Review main classes in quilt.cpp                                  |         |       |  3:42 |   4.1 |
| COMPLETED Clean up element segmentation                                     |         |       |  1:20 |   1.5 |
| COMPLETED Get OSX build to compile code                                     |         |       |  7:05 |   7.8 |
...
| COMPLETED Analysis around terminology in formatting space                   |         |       |  3:24 |   3.8 |
| COMPLETED Remove =original_model_name=                                      |         |       |  0:16 |   0.3 |
| COMPLETED Refactor code around model origination                            |         |       |  4:08 |   4.6 |
...
| COMPLETED Expander refactor in =quilt.cpp=                                  |         |       |  3:03 |   3.4 |
| COMPLETED Create the notion of a formatter alias                            |         |       |  3:15 |   3.6 |
| COMPLETED Remove enabled formatters from formatter configuration            |         |       |  0:22 |   0.4 |
| COMPLETED Handle registration of services properly                          |         |       |  3:41 |   4.1 |
| COMPLETED Move stereotypes to element                                       |         |       |  0:21 |   0.4 |
| COMPLETED Improve project banner                                            |         |       |  0:32 |   0.6 |
| CANCELLED Add support for profiles                                          |         |       | 10:40 |  11.8 |
| COMPLETED Refactor =yarn.dia= transformer                                   |         |       |  8:49 |   9.7 |
| COMPLETED Create a dynamic expander in yarn                                 |         |       |  5:52 |   6.5 |
| STARTED Merge annotations with formattables                                 |         |       |  2:35 |   2.9 |
...
*** Create a streaming configuration expander                         :story:
...
*** Merge helper annotations with helper expander
