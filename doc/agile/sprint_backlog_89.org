...
#+CAPTION: Clock summary at [2016-09-26 Mon 18:17]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
...
| Stories                                                                     | 7:20   |      |      | 100.0 |
| Active                                                                      |        | 7:20 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:40 |   9.1 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 0:07 |   1.6 |
| COMPLETED Generation of formattable is incorrect                            |        |      | 2:30 |  34.1 |
| COMPLETED Visitor includes are incorrect                                    |        |      | 0:20 |   4.5 |
| COMPLETED Add includer to quilt.cpp                                         |        |      | 1:46 |  24.1 |
| COMPLETED Add reducer to quilt.cpp                                          |        |      | 0:22 |   5.0 |
| COMPLETED Add new index to formtter container                               |        |      | 0:19 |   4.3 |
| COMPLETED Add path generator to quilt.cpp                                   |        |      | 0:49 |  11.1 |
| COMPLETED Add guard generator to quilt.cpp                                  |        |      | 0:27 |   6.1 |
...
*** COMPLETED Add path generator to quilt.cpp                         :story:
...
*** COMPLETED Add guard generator to quilt.cpp                        :story:
