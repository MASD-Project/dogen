...
#+CAPTION: Clock summary at [2016-10-03 Mon 22:29]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *52:09* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 52:09   |       |      | 100.0 |
| Active                                                                      |         | 52:09 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 4:37 |   8.9 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:07 |   0.2 |
| COMPLETED Generation of formattable is incorrect                            |         |       | 2:30 |   4.8 |
| COMPLETED Visitor includes are incorrect                                    |         |       | 0:20 |   0.6 |
| COMPLETED Add includer to quilt.cpp                                         |         |       | 1:46 |   3.4 |
| COMPLETED Add reducer to quilt.cpp                                          |         |       | 0:22 |   0.7 |
| COMPLETED Add new index to formtter container                               |         |       | 0:19 |   0.6 |
| COMPLETED Add path expander to quilt.cpp                                    |         |       | 0:49 |   1.6 |
| COMPLETED Add guard expander to quilt.cpp                                   |         |       | 0:27 |   0.9 |
| COMPLETED Investigate borked travis build                                   |         |       | 0:37 |   1.2 |
| COMPLETED Add decoration expander to quilt.cpp                              |         |       | 0:23 |   0.7 |
| COMPLETED Add aspect expander to quilt.cpp                                  |         |       | 1:26 |   2.7 |
| COMPLETED Run tests that are passing on windows                             |         |       | 0:10 |   0.3 |
| COMPLETED Add helper expander to quilt.cpp                                  |         |       | 1:26 |   2.7 |
| COMPLETED Merge pre and post workflows                                      |         |       | 0:16 |   0.5 |
| COMPLETED Fix bug in aspect and helper generation                           |         |       | 0:15 |   0.5 |
| COMPLETED Investigate element annotation support                            |         |       | 2:05 |   4.0 |
| CANCELLED Add streaming settings expander                                   |         |       | 0:36 |   1.2 |
| COMPLETED Create the formattables model                                     |         |       | 1:32 |   2.9 |
| COMPLETED Hook formattables into formatters                                 |         |       | 3:58 |   7.6 |
| COMPLETED Remove empty context                                              |         |       | 1:09 |   2.2 |
| COMPLETED Review main classes in quilt.cpp                                  |         |       | 3:42 |   7.1 |
| COMPLETED Clean up element segmentation                                     |         |       | 1:20 |   2.6 |
| COMPLETED Get OSX build to compile code                                     |         |       | 7:05 |  13.6 |
| COMPLETED Add a banner to readme                                            |         |       | 1:29 |   2.8 |
...
| COMPLETED Analysis around terminology in formatting space                   |         |       | 3:24 |   6.5 |
| COMPLETED Remove =original_model_name=                                      |         |       | 0:16 |   0.5 |
| COMPLETED Refactor code around model origination                            |         |       | 4:08 |   7.9 |
...
| STARTED Handle registration of services properly                            |         |       | 2:13 |   4.3 |
| STARTED Expander refactor in =quilt.cpp=                                    |         |       | 1:34 |   3.0 |
| STARTED Create the notion of a formatter alias                              |         |       | 0:40 |   1.3 |
...
*** STARTED Expander refactor in =quilt.cpp=                          :story:
...
*** STARTED Create the notion of a formatter alias                    :story:
