...
#+CAPTION: Clock summary at [2016-10-07 Fri 00:22]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *78:17* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 78:17   |       |       | 100.0 |
| Active                                                                      |         | 78:17 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  5:30 |   7.0 |
...
| COMPLETED Add path expander to quilt.cpp                                    |         |       |  0:49 |   1.0 |
...
| COMPLETED Review main classes in quilt.cpp                                  |         |       |  3:42 |   4.7 |
| COMPLETED Clean up element segmentation                                     |         |       |  1:20 |   1.7 |
| COMPLETED Get OSX build to compile code                                     |         |       |  7:05 |   9.0 |
...
| COMPLETED Analysis around terminology in formatting space                   |         |       |  3:24 |   4.3 |
...
| COMPLETED Handle registration of services properly                          |         |       |  3:41 |   4.7 |
| COMPLETED Move stereotypes to element                                       |         |       |  0:21 |   0.4 |
| COMPLETED Improve project banner                                            |         |       |  0:32 |   0.7 |
| CANCELLED Add support for profiles                                          |         |       | 10:40 |  13.6 |
| STARTED Refactor =yarn.dia= transformer                                     |         |       |  5:53 |   7.5 |
