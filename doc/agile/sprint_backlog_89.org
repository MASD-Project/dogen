...
#+CAPTION: Clock summary at [2016-09-26 Mon 18:52]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
...
| Stories                                                                     | 7:53   |      |      | 100.0 |
| Active                                                                      |        | 7:53 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:40 |   8.5 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 0:07 |   1.5 |
| COMPLETED Generation of formattable is incorrect                            |        |      | 2:30 |  31.7 |
| COMPLETED Visitor includes are incorrect                                    |        |      | 0:20 |   4.2 |
| COMPLETED Add includer to quilt.cpp                                         |        |      | 1:46 |  22.4 |
| COMPLETED Add reducer to quilt.cpp                                          |        |      | 0:22 |   4.7 |
| COMPLETED Add new index to formtter container                               |        |      | 0:19 |   4.0 |
| COMPLETED Add path expander to quilt.cpp                                    |        |      | 0:49 |  10.4 |
| COMPLETED Add guard expander to quilt.cpp                                   |        |      | 0:27 |   5.7 |
| COMPLETED Investigate borked travis build                                   |        |      | 0:15 |   3.2 |
| STARTED Add decoration expander to quilt.cpp                                |        |      | 0:18 |   3.8 |
...
*** STARTED Add decoration expander to quilt.cpp                      :story:
