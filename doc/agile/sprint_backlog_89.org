...
#+CAPTION: Clock summary at [2016-09-26 Mon 21:04]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *8:15* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 8:15   |      |      | 100.0 |
| Active                                                                      |        | 8:15 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:40 |   8.1 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 0:07 |   1.4 |
| COMPLETED Generation of formattable is incorrect                            |        |      | 2:30 |  30.3 |
| COMPLETED Visitor includes are incorrect                                    |        |      | 0:20 |   4.0 |
| COMPLETED Add includer to quilt.cpp                                         |        |      | 1:46 |  21.4 |
| COMPLETED Add reducer to quilt.cpp                                          |        |      | 0:22 |   4.4 |
| COMPLETED Add new index to formtter container                               |        |      | 0:19 |   3.8 |
| COMPLETED Add path expander to quilt.cpp                                    |        |      | 0:49 |   9.9 |
| COMPLETED Add guard expander to quilt.cpp                                   |        |      | 0:27 |   5.5 |
| COMPLETED Investigate borked travis build                                   |        |      | 0:37 |   7.5 |
| STARTED Add decoration expander to quilt.cpp                                |        |      | 0:18 |   3.6 |
