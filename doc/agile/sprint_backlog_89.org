...
#+CAPTION: Clock summary at [2016-09-27 Tue 09:46]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *11:22* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 11:22   |       |      | 100.0 |
| Active                                                                      |         | 11:22 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:40 |   5.9 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:07 |   1.0 |
| COMPLETED Generation of formattable is incorrect                            |         |       | 2:30 |  22.0 |
| COMPLETED Visitor includes are incorrect                                    |         |       | 0:20 |   2.9 |
| COMPLETED Add includer to quilt.cpp                                         |         |       | 1:46 |  15.5 |
| COMPLETED Add reducer to quilt.cpp                                          |         |       | 0:22 |   3.2 |
| COMPLETED Add new index to formtter container                               |         |       | 0:19 |   2.8 |
| COMPLETED Add path expander to quilt.cpp                                    |         |       | 0:49 |   7.2 |
| COMPLETED Add guard expander to quilt.cpp                                   |         |       | 0:27 |   4.0 |
| COMPLETED Investigate borked travis build                                   |         |       | 0:37 |   5.4 |
| COMPLETED Add decoration expander to quilt.cpp                              |         |       | 0:23 |   3.4 |
| COMPLETED Add aspect expander to quilt.cpp                                  |         |       | 1:26 |  12.6 |
| COMPLETED Run tests that are passing on windows                             |         |       | 0:10 |   1.5 |
| COMPLETED Add helper expander to quilt.cpp                                  |         |       | 1:26 |  12.6 |
...
*** Merge pre and post workflows                                      :story:
