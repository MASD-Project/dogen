...
#+CAPTION: Clock summary at [2016-10-02 Sun 22:21]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *41:12* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 41:12   |       |      | 100.0 |
| Active                                                                      |         | 41:12 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 3:17 |   8.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:07 |   0.3 |
| COMPLETED Generation of formattable is incorrect                            |         |       | 2:30 |   6.1 |
| COMPLETED Visitor includes are incorrect                                    |         |       | 0:20 |   0.8 |
| COMPLETED Add includer to quilt.cpp                                         |         |       | 1:46 |   4.3 |
| COMPLETED Add reducer to quilt.cpp                                          |         |       | 0:22 |   0.9 |
| COMPLETED Add new index to formtter container                               |         |       | 0:19 |   0.8 |
| COMPLETED Add path expander to quilt.cpp                                    |         |       | 0:49 |   2.0 |
| COMPLETED Add guard expander to quilt.cpp                                   |         |       | 0:27 |   1.1 |
| COMPLETED Investigate borked travis build                                   |         |       | 0:37 |   1.5 |
| COMPLETED Add decoration expander to quilt.cpp                              |         |       | 0:23 |   0.9 |
| COMPLETED Add aspect expander to quilt.cpp                                  |         |       | 1:26 |   3.5 |
| COMPLETED Run tests that are passing on windows                             |         |       | 0:10 |   0.4 |
| COMPLETED Add helper expander to quilt.cpp                                  |         |       | 1:26 |   3.5 |
| COMPLETED Merge pre and post workflows                                      |         |       | 0:16 |   0.6 |
| COMPLETED Fix bug in aspect and helper generation                           |         |       | 0:15 |   0.6 |
| COMPLETED Investigate element annotation support                            |         |       | 2:05 |   5.1 |
| CANCELLED Add streaming settings expander                                   |         |       | 0:36 |   1.5 |
| COMPLETED Create the formattables model                                     |         |       | 1:32 |   3.7 |
| COMPLETED Hook formattables into formatters                                 |         |       | 3:58 |   9.6 |
| COMPLETED Remove empty context                                              |         |       | 1:09 |   2.8 |
| COMPLETED Review main classes in quilt.cpp                                  |         |       | 3:42 |   9.0 |
| COMPLETED Clean up element segmentation                                     |         |       | 1:20 |   3.2 |
| COMPLETED Get OSX build to compile code                                     |         |       | 7:05 |  17.2 |
| COMPLETED Add a banner to readme                                            |         |       | 1:29 |   3.6 |
| COMPLETED Remove formatter group                                            |         |       | 0:23 |   0.9 |
| COMPLETED Add more types to =quilt::cpp= canned tests                       |         |       | 0:15 |   0.6 |
| STARTED Remove formatter id                                                 |         |       | 0:04 |   0.2 |
| STARTED Generate formatter interfaces                                       |         |       | 0:19 |   0.8 |
| STARTED Analysis around terminology in formatting space                     |         |       | 2:45 |   6.7 |
...
*** STARTED Remove formatter id                                       :story:
...
*** STARTED Analysis around terminology in formatting space           :story:
...
*** Remove formatter level facet folders                              :story:
