...
#+CAPTION: Clock summary at [2016-10-07 Fri 23:05]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *85:34* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 85:34   |       |       | 100.0 |
| Active                                                                      |         | 85:34 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  5:30 |   6.4 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:07 |   0.1 |
| COMPLETED Generation of formattable is incorrect                            |         |       |  2:30 |   2.9 |
...
| COMPLETED Investigate element annotation support                            |         |       |  2:05 |   2.4 |
| CANCELLED Add streaming settings expander                                   |         |       |  0:36 |   0.7 |
| COMPLETED Create the formattables model                                     |         |       |  1:32 |   1.8 |
| COMPLETED Hook formattables into formatters                                 |         |       |  3:58 |   4.6 |
| COMPLETED Remove empty context                                              |         |       |  1:09 |   1.3 |
| COMPLETED Review main classes in quilt.cpp                                  |         |       |  3:42 |   4.3 |
| COMPLETED Clean up element segmentation                                     |         |       |  1:20 |   1.6 |
| COMPLETED Get OSX build to compile code                                     |         |       |  7:05 |   8.3 |
| COMPLETED Add a banner to readme                                            |         |       |  1:29 |   1.7 |
...
| COMPLETED Refactor code around model origination                            |         |       |  4:08 |   4.8 |
...
| COMPLETED Create the notion of a formatter alias                            |         |       |  3:15 |   3.8 |
| COMPLETED Remove enabled formatters from formatter configuration            |         |       |  0:22 |   0.4 |
| COMPLETED Handle registration of services properly                          |         |       |  3:41 |   4.3 |
| COMPLETED Move stereotypes to element                                       |         |       |  0:21 |   0.4 |
| COMPLETED Improve project banner                                            |         |       |  0:32 |   0.6 |
| CANCELLED Add support for profiles                                          |         |       | 10:40 |  12.5 |
| COMPLETED Refactor =yarn.dia= transformer                                   |         |       |  8:49 |  10.3 |
| STARTED Create a dynamic expander in yarn                                   |         |       |  4:41 |   5.5 |
