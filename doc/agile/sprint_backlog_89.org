...
#+CAPTION: Clock summary at [2016-10-04 Tue 14:13]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *56:40* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 56:40   |       |      | 100.0 |
| Active                                                                      |         | 56:40 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 4:37 |   8.1 |
...
| COMPLETED Hook formattables into formatters                                 |         |       | 3:58 |   7.0 |
| COMPLETED Remove empty context                                              |         |       | 1:09 |   2.0 |
| COMPLETED Review main classes in quilt.cpp                                  |         |       | 3:42 |   6.5 |
| COMPLETED Clean up element segmentation                                     |         |       | 1:20 |   2.4 |
| COMPLETED Get OSX build to compile code                                     |         |       | 7:05 |  12.5 |
...
| COMPLETED Refactor code around model origination                            |         |       | 4:08 |   7.3 |
...
| COMPLETED Create the notion of a formatter alias                            |         |       | 3:15 |   5.7 |
| STARTED Remove enabled formatters from formatter configuration              |         |       | 0:22 |   0.6 |
| STARTED Generate formatter interfaces                                       |         |       | 0:19 |   0.6 |
| STARTED Handle registration of services properly                            |         |       | 2:18 |   4.1 |
...
*** STARTED Remove enabled formatters from formatter configuration    :story:
