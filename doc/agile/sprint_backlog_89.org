...
#+CAPTION: Clock summary at [2016-10-04 Tue 12:04]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *55:04* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 55:04   |       |      | 100.0 |
| Active                                                                      |         | 55:04 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 4:37 |   8.4 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:07 |   0.2 |
| COMPLETED Generation of formattable is incorrect                            |         |       | 2:30 |   4.5 |
| COMPLETED Visitor includes are incorrect                                    |         |       | 0:20 |   0.6 |
| COMPLETED Add includer to quilt.cpp                                         |         |       | 1:46 |   3.2 |
...
| COMPLETED Add aspect expander to quilt.cpp                                  |         |       | 1:26 |   2.6 |
| COMPLETED Run tests that are passing on windows                             |         |       | 0:10 |   0.3 |
| COMPLETED Add helper expander to quilt.cpp                                  |         |       | 1:26 |   2.6 |
| COMPLETED Merge pre and post workflows                                      |         |       | 0:16 |   0.5 |
| COMPLETED Fix bug in aspect and helper generation                           |         |       | 0:15 |   0.5 |
| COMPLETED Investigate element annotation support                            |         |       | 2:05 |   3.8 |
| CANCELLED Add streaming settings expander                                   |         |       | 0:36 |   1.1 |
| COMPLETED Create the formattables model                                     |         |       | 1:32 |   2.8 |
| COMPLETED Hook formattables into formatters                                 |         |       | 3:58 |   7.2 |
| COMPLETED Remove empty context                                              |         |       | 1:09 |   2.1 |
| COMPLETED Review main classes in quilt.cpp                                  |         |       | 3:42 |   6.7 |
| COMPLETED Clean up element segmentation                                     |         |       | 1:20 |   2.4 |
| COMPLETED Get OSX build to compile code                                     |         |       | 7:05 |  12.9 |
| COMPLETED Add a banner to readme                                            |         |       | 1:29 |   2.7 |
...
| COMPLETED Analysis around terminology in formatting space                   |         |       | 3:24 |   6.2 |
| COMPLETED Remove =original_model_name=                                      |         |       | 0:16 |   0.5 |
| COMPLETED Refactor code around model origination                            |         |       | 4:08 |   7.5 |
...
| COMPLETED Expander refactor in =quilt.cpp=                                  |         |       | 3:03 |   5.5 |
| STARTED Generate formatter interfaces                                       |         |       | 0:19 |   0.6 |
| STARTED Handle registration of services properly                            |         |       | 2:13 |   4.0 |
| STARTED Create the notion of a formatter alias                              |         |       | 2:06 |   3.8 |
