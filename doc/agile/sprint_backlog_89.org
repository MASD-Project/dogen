...
#+CAPTION: Clock summary at [2016-10-03 Mon 12:43]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *45:32* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 45:32   |       |      | 100.0 |
| Active                                                                      |         | 45:32 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 4:37 |  10.1 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:07 |   0.3 |
| COMPLETED Generation of formattable is incorrect                            |         |       | 2:30 |   5.5 |
| COMPLETED Visitor includes are incorrect                                    |         |       | 0:20 |   0.7 |
| COMPLETED Add includer to quilt.cpp                                         |         |       | 1:46 |   3.9 |
...
| COMPLETED Investigate borked travis build                                   |         |       | 0:37 |   1.4 |
...
| COMPLETED Investigate element annotation support                            |         |       | 2:05 |   4.6 |
| CANCELLED Add streaming settings expander                                   |         |       | 0:36 |   1.3 |
| COMPLETED Create the formattables model                                     |         |       | 1:32 |   3.4 |
| COMPLETED Hook formattables into formatters                                 |         |       | 3:58 |   8.7 |
| COMPLETED Remove empty context                                              |         |       | 1:09 |   2.5 |
| COMPLETED Review main classes in quilt.cpp                                  |         |       | 3:42 |   8.1 |
| COMPLETED Clean up element segmentation                                     |         |       | 1:20 |   2.9 |
| COMPLETED Get OSX build to compile code                                     |         |       | 7:05 |  15.6 |
| COMPLETED Add a banner to readme                                            |         |       | 1:29 |   3.3 |
...
| COMPLETED Analysis around terminology in formatting space                   |         |       | 3:24 |   7.5 |
| STARTED Generate formatter interfaces                                       |         |       | 0:19 |   0.7 |
| STARTED Refactor code around model origination                              |         |       | 2:21 |   5.2 |
...
*** Remove =original_model_name=                                      :story:
