...
#+CAPTION: Clock summary at [2016-10-06 Thu 20:35]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *75:22* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 75:22   |       |       | 100.0 |
| Active                                                                      |         | 75:22 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  5:30 |   7.3 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:07 |   0.2 |
| COMPLETED Generation of formattable is incorrect                            |         |       |  2:30 |   3.3 |
| COMPLETED Visitor includes are incorrect                                    |         |       |  0:20 |   0.4 |
| COMPLETED Add includer to quilt.cpp                                         |         |       |  1:46 |   2.3 |
| COMPLETED Add reducer to quilt.cpp                                          |         |       |  0:22 |   0.5 |
| COMPLETED Add new index to formtter container                               |         |       |  0:19 |   0.4 |
| COMPLETED Add path expander to quilt.cpp                                    |         |       |  0:49 |   1.1 |
| COMPLETED Add guard expander to quilt.cpp                                   |         |       |  0:27 |   0.6 |
| COMPLETED Investigate borked travis build                                   |         |       |  0:37 |   0.8 |
| COMPLETED Add decoration expander to quilt.cpp                              |         |       |  0:23 |   0.5 |
| COMPLETED Add aspect expander to quilt.cpp                                  |         |       |  1:26 |   1.9 |
| COMPLETED Run tests that are passing on windows                             |         |       |  0:10 |   0.2 |
| COMPLETED Add helper expander to quilt.cpp                                  |         |       |  1:26 |   1.9 |
| COMPLETED Merge pre and post workflows                                      |         |       |  0:16 |   0.4 |
| COMPLETED Fix bug in aspect and helper generation                           |         |       |  0:15 |   0.3 |
| COMPLETED Investigate element annotation support                            |         |       |  2:05 |   2.8 |
| CANCELLED Add streaming settings expander                                   |         |       |  0:36 |   0.8 |
| COMPLETED Create the formattables model                                     |         |       |  1:32 |   2.0 |
| COMPLETED Hook formattables into formatters                                 |         |       |  3:58 |   5.3 |
| COMPLETED Remove empty context                                              |         |       |  1:09 |   1.5 |
| COMPLETED Review main classes in quilt.cpp                                  |         |       |  3:42 |   4.9 |
| COMPLETED Clean up element segmentation                                     |         |       |  1:20 |   1.8 |
| COMPLETED Get OSX build to compile code                                     |         |       |  7:05 |   9.4 |
| COMPLETED Add a banner to readme                                            |         |       |  1:29 |   2.0 |
| COMPLETED Remove formatter group                                            |         |       |  0:23 |   0.5 |
| COMPLETED Add more types to =quilt::cpp= canned tests                       |         |       |  0:15 |   0.3 |
| CANCELLED Remove formatter id                                               |         |       |  0:04 |   0.1 |
| COMPLETED Analysis around terminology in formatting space                   |         |       |  3:24 |   4.5 |
| COMPLETED Remove =original_model_name=                                      |         |       |  0:16 |   0.4 |
| COMPLETED Refactor code around model origination                            |         |       |  4:08 |   5.5 |
...
| COMPLETED Expander refactor in =quilt.cpp=                                  |         |       |  3:03 |   4.0 |
| COMPLETED Create the notion of a formatter alias                            |         |       |  3:15 |   4.3 |
| COMPLETED Remove enabled formatters from formatter configuration            |         |       |  0:22 |   0.5 |
| COMPLETED Handle registration of services properly                          |         |       |  3:41 |   4.9 |
| COMPLETED Move stereotypes to element                                       |         |       |  0:21 |   0.5 |
| COMPLETED Improve project banner                                            |         |       |  0:32 |   0.7 |
| CANCELLED Add support for profiles                                          |         |       | 10:40 |  14.2 |
| STARTED Refactor =yarn.dia= transformer                                     |         |       |  2:58 |   3.9 |
| STARTED Create a dynamic expander in yarn                                   |         |       |  0:20 |   0.4 |
| STARTED Rewrite profile support                                             |         |       |  1:26 |   1.9 |
| STARTED Generate formatter interfaces                                       |         |       |  0:28 |   0.6 |
...
*** STARTED Refactor =yarn.dia= transformer                           :story:
...
*** STARTED Create a dynamic expander in yarn                         :story:
