...
#+CAPTION: Clock summary at [2016-10-07 Fri 11:54]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *81:31* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 81:31   |       |       | 100.0 |
| Active                                                                      |         | 81:31 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  5:30 |   6.7 |
...
| COMPLETED Review main classes in quilt.cpp                                  |         |       |  3:42 |   4.5 |
| COMPLETED Clean up element segmentation                                     |         |       |  1:20 |   1.6 |
| COMPLETED Get OSX build to compile code                                     |         |       |  7:05 |   8.7 |
...
| COMPLETED Expander refactor in =quilt.cpp=                                  |         |       |  3:03 |   3.7 |
...
| COMPLETED Handle registration of services properly                          |         |       |  3:41 |   4.5 |
| COMPLETED Move stereotypes to element                                       |         |       |  0:21 |   0.4 |
| COMPLETED Improve project banner                                            |         |       |  0:32 |   0.7 |
| CANCELLED Add support for profiles                                          |         |       | 10:40 |  13.1 |
| COMPLETED Refactor =yarn.dia= transformer                                   |         |       |  8:49 |  10.8 |
| STARTED Create a dynamic expander in yarn                                   |         |       |  0:38 |   0.8 |
