...
#+CAPTION: Clock summary at [2016-10-02 Sun 18:56]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *39:10* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 39:10   |       |      | 100.0 |
| Active                                                                      |         | 39:10 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:53 |   4.8 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:07 |   0.3 |
| COMPLETED Generation of formattable is incorrect                            |         |       | 2:30 |   6.4 |
| COMPLETED Visitor includes are incorrect                                    |         |       | 0:20 |   0.9 |
| COMPLETED Add includer to quilt.cpp                                         |         |       | 1:46 |   4.5 |
| COMPLETED Add reducer to quilt.cpp                                          |         |       | 0:22 |   0.9 |
| COMPLETED Add new index to formtter container                               |         |       | 0:19 |   0.8 |
| COMPLETED Add path expander to quilt.cpp                                    |         |       | 0:49 |   2.1 |
| COMPLETED Add guard expander to quilt.cpp                                   |         |       | 0:27 |   1.1 |
| COMPLETED Investigate borked travis build                                   |         |       | 0:37 |   1.6 |
| COMPLETED Add decoration expander to quilt.cpp                              |         |       | 0:23 |   1.0 |
| COMPLETED Add aspect expander to quilt.cpp                                  |         |       | 1:26 |   3.7 |
| COMPLETED Run tests that are passing on windows                             |         |       | 0:10 |   0.4 |
| COMPLETED Add helper expander to quilt.cpp                                  |         |       | 1:26 |   3.7 |
| COMPLETED Merge pre and post workflows                                      |         |       | 0:16 |   0.7 |
| COMPLETED Fix bug in aspect and helper generation                           |         |       | 0:15 |   0.6 |
| COMPLETED Investigate element annotation support                            |         |       | 2:05 |   5.3 |
| CANCELLED Add streaming settings expander                                   |         |       | 0:36 |   1.5 |
| COMPLETED Create the formattables model                                     |         |       | 1:32 |   3.9 |
| COMPLETED Hook formattables into formatters                                 |         |       | 3:58 |  10.1 |
| COMPLETED Remove empty context                                              |         |       | 1:09 |   2.9 |
| COMPLETED Review main classes in quilt.cpp                                  |         |       | 3:42 |   9.4 |
| COMPLETED Clean up element segmentation                                     |         |       | 1:20 |   3.4 |
| COMPLETED Get OSX build to compile code                                     |         |       | 7:05 |  18.1 |
| COMPLETED Add a banner to readme                                            |         |       | 1:29 |   3.8 |
| STARTED Remove formatter id                                                 |         |       | 0:04 |   0.2 |
| STARTED Generate formatter interfaces                                       |         |       | 0:19 |   0.8 |
| STARTED Analysis around terminology in formatting space                     |         |       | 2:45 |   7.0 |
