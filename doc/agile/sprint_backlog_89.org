...
#+CAPTION: Clock summary at [2016-10-08 Sat 10:43]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *87:54* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 87:54   |       |       | 100.0 |
| Active                                                                      |         | 87:54 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  5:30 |   6.3 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:07 |   0.1 |
| COMPLETED Generation of formattable is incorrect                            |         |       |  2:30 |   2.8 |
...
| COMPLETED Hook formattables into formatters                                 |         |       |  3:58 |   4.5 |
| COMPLETED Remove empty context                                              |         |       |  1:09 |   1.3 |
| COMPLETED Review main classes in quilt.cpp                                  |         |       |  3:42 |   4.2 |
| COMPLETED Clean up element segmentation                                     |         |       |  1:20 |   1.5 |
| COMPLETED Get OSX build to compile code                                     |         |       |  7:05 |   8.1 |
...
| COMPLETED Refactor code around model origination                            |         |       |  4:08 |   4.7 |
...
| CANCELLED Add support for profiles                                          |         |       | 10:40 |  12.1 |
| COMPLETED Refactor =yarn.dia= transformer                                   |         |       |  8:49 |  10.0 |
| COMPLETED Create a dynamic expander in yarn                                 |         |       |  5:52 |   6.7 |
| STARTED Merge annotations with formattables                                 |         |       |  0:02 |   0.0 |
| STARTED Clean up terminology in dynamic                                     |         |       |  1:07 |   1.3 |
...
*** STARTED Merge annotations with formattables                       :story:
