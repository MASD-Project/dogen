...
#+CAPTION: Clock summary at [2016-10-05 Wed 15:21]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *63:19* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 63:19   |       |      | 100.0 |
| Active                                                                      |         | 63:19 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 4:50 |   7.6 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:07 |   0.2 |
| COMPLETED Generation of formattable is incorrect                            |         |       | 2:30 |   3.9 |
...
| COMPLETED Review main classes in quilt.cpp                                  |         |       | 3:42 |   5.8 |
| COMPLETED Clean up element segmentation                                     |         |       | 1:20 |   2.1 |
| COMPLETED Get OSX build to compile code                                     |         |       | 7:05 |  11.2 |
| COMPLETED Add a banner to readme                                            |         |       | 1:29 |   2.3 |
...
| COMPLETED Refactor code around model origination                            |         |       | 4:08 |   6.5 |
...
| COMPLETED Expander refactor in =quilt.cpp=                                  |         |       | 3:03 |   4.8 |
| COMPLETED Create the notion of a formatter alias                            |         |       | 3:15 |   5.1 |
| COMPLETED Remove enabled formatters from formatter configuration            |         |       | 0:22 |   0.6 |
| COMPLETED Handle registration of services properly                          |         |       | 3:41 |   5.8 |
| STARTED Add support for profiles                                            |         |       | 4:54 |   7.7 |
