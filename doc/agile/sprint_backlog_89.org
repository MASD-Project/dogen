...
#+CAPTION: Clock summary at [2016-10-05 Wed 11:28]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *60:25* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 60:25   |       |      | 100.0 |
| Active                                                                      |         | 60:25 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 4:50 |   8.0 |
...
| COMPLETED Add aspect expander to quilt.cpp                                  |         |       | 1:26 |   2.4 |
| COMPLETED Run tests that are passing on windows                             |         |       | 0:10 |   0.3 |
| COMPLETED Add helper expander to quilt.cpp                                  |         |       | 1:26 |   2.4 |
...
| COMPLETED Hook formattables into formatters                                 |         |       | 3:58 |   6.6 |
...
| COMPLETED Get OSX build to compile code                                     |         |       | 7:05 |  11.7 |
| COMPLETED Add a banner to readme                                            |         |       | 1:29 |   2.5 |
...
| COMPLETED Create the notion of a formatter alias                            |         |       | 3:15 |   5.4 |
| COMPLETED Remove enabled formatters from formatter configuration            |         |       | 0:22 |   0.6 |
| COMPLETED Handle registration of services properly                          |         |       | 3:41 |   6.1 |
| STARTED Add support for profiles                                            |         |       | 2:00 |   3.3 |
