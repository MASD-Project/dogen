...
#+CAPTION: Clock summary at [2016-10-05 Wed 12:15]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *61:00* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 61:00   |       |      | 100.0 |
| Active                                                                      |         | 61:00 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 4:50 |   7.9 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:07 |   0.2 |
| COMPLETED Generation of formattable is incorrect                            |         |       | 2:30 |   4.1 |
| COMPLETED Visitor includes are incorrect                                    |         |       | 0:20 |   0.5 |
| COMPLETED Add includer to quilt.cpp                                         |         |       | 1:46 |   2.9 |
| COMPLETED Add reducer to quilt.cpp                                          |         |       | 0:22 |   0.6 |
| COMPLETED Add new index to formtter container                               |         |       | 0:19 |   0.5 |
| COMPLETED Add path expander to quilt.cpp                                    |         |       | 0:49 |   1.3 |
| COMPLETED Add guard expander to quilt.cpp                                   |         |       | 0:27 |   0.7 |
| COMPLETED Investigate borked travis build                                   |         |       | 0:37 |   1.0 |
| COMPLETED Add decoration expander to quilt.cpp                              |         |       | 0:23 |   0.6 |
| COMPLETED Add aspect expander to quilt.cpp                                  |         |       | 1:26 |   2.3 |
| COMPLETED Run tests that are passing on windows                             |         |       | 0:10 |   0.3 |
| COMPLETED Add helper expander to quilt.cpp                                  |         |       | 1:26 |   2.3 |
| COMPLETED Merge pre and post workflows                                      |         |       | 0:16 |   0.4 |
| COMPLETED Fix bug in aspect and helper generation                           |         |       | 0:15 |   0.4 |
| COMPLETED Investigate element annotation support                            |         |       | 2:05 |   3.4 |
| CANCELLED Add streaming settings expander                                   |         |       | 0:36 |   1.0 |
| COMPLETED Create the formattables model                                     |         |       | 1:32 |   2.5 |
| COMPLETED Hook formattables into formatters                                 |         |       | 3:58 |   6.5 |
| COMPLETED Remove empty context                                              |         |       | 1:09 |   1.9 |
| COMPLETED Review main classes in quilt.cpp                                  |         |       | 3:42 |   6.1 |
| COMPLETED Clean up element segmentation                                     |         |       | 1:20 |   2.2 |
| COMPLETED Get OSX build to compile code                                     |         |       | 7:05 |  11.6 |
| COMPLETED Add a banner to readme                                            |         |       | 1:29 |   2.4 |
...
| COMPLETED Analysis around terminology in formatting space                   |         |       | 3:24 |   5.6 |
| COMPLETED Remove =original_model_name=                                      |         |       | 0:16 |   0.4 |
| COMPLETED Refactor code around model origination                            |         |       | 4:08 |   6.8 |
...
| COMPLETED Expander refactor in =quilt.cpp=                                  |         |       | 3:03 |   5.0 |
| COMPLETED Create the notion of a formatter alias                            |         |       | 3:15 |   5.3 |
| COMPLETED Remove enabled formatters from formatter configuration            |         |       | 0:22 |   0.6 |
| COMPLETED Handle registration of services properly                          |         |       | 3:41 |   6.0 |
| STARTED Add support for profiles                                            |         |       | 2:35 |   4.2 |
| STARTED Generate formatter interfaces                                       |         |       | 0:28 |   0.8 |
