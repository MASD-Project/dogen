...
#+CAPTION: Clock summary at [2016-10-03 Mon 15:30]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *47:35* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 47:35   |       |      | 100.0 |
| Active                                                                      |         | 47:35 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 4:37 |   9.7 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:07 |   0.2 |
| COMPLETED Generation of formattable is incorrect                            |         |       | 2:30 |   5.3 |
...
| COMPLETED Investigate element annotation support                            |         |       | 2:05 |   4.4 |
| CANCELLED Add streaming settings expander                                   |         |       | 0:36 |   1.3 |
| COMPLETED Create the formattables model                                     |         |       | 1:32 |   3.2 |
| COMPLETED Hook formattables into formatters                                 |         |       | 3:58 |   8.3 |
| COMPLETED Remove empty context                                              |         |       | 1:09 |   2.4 |
| COMPLETED Review main classes in quilt.cpp                                  |         |       | 3:42 |   7.8 |
| COMPLETED Clean up element segmentation                                     |         |       | 1:20 |   2.8 |
| COMPLETED Get OSX build to compile code                                     |         |       | 7:05 |  14.9 |
...
| COMPLETED Refactor code around model origination                            |         |       | 4:08 |   8.7 |
