...
#+CAPTION: Clock summary at [2016-10-05 Wed 18:14]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *66:11* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 66:11   |       |      | 100.0 |
| Active                                                                      |         | 66:11 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 4:50 |   7.3 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:07 |   0.2 |
| COMPLETED Generation of formattable is incorrect                            |         |       | 2:30 |   3.8 |
| COMPLETED Visitor includes are incorrect                                    |         |       | 0:20 |   0.5 |
| COMPLETED Add includer to quilt.cpp                                         |         |       | 1:46 |   2.7 |
...
| COMPLETED Add aspect expander to quilt.cpp                                  |         |       | 1:26 |   2.2 |
| COMPLETED Run tests that are passing on windows                             |         |       | 0:10 |   0.3 |
| COMPLETED Add helper expander to quilt.cpp                                  |         |       | 1:26 |   2.2 |
...
| COMPLETED Hook formattables into formatters                                 |         |       | 3:58 |   6.0 |
| COMPLETED Remove empty context                                              |         |       | 1:09 |   1.7 |
| COMPLETED Review main classes in quilt.cpp                                  |         |       | 3:42 |   5.6 |
| COMPLETED Clean up element segmentation                                     |         |       | 1:20 |   2.0 |
| COMPLETED Get OSX build to compile code                                     |         |       | 7:05 |  10.7 |
...
| COMPLETED Analysis around terminology in formatting space                   |         |       | 3:24 |   5.1 |
| COMPLETED Remove =original_model_name=                                      |         |       | 0:16 |   0.4 |
| COMPLETED Refactor code around model origination                            |         |       | 4:08 |   6.2 |
...
| COMPLETED Expander refactor in =quilt.cpp=                                  |         |       | 3:03 |   4.6 |
| COMPLETED Create the notion of a formatter alias                            |         |       | 3:15 |   4.9 |
| COMPLETED Remove enabled formatters from formatter configuration            |         |       | 0:22 |   0.6 |
| COMPLETED Handle registration of services properly                          |         |       | 3:41 |   5.6 |
| STARTED Add support for profiles                                            |         |       | 7:46 |  11.7 |
