...
#+CAPTION: Clock summary at [2016-10-06 Thu 11:47]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *72:04* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 72:04   |       |       | 100.0 |
| Active                                                                      |         | 72:04 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  5:30 |   7.6 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:07 |   0.2 |
| COMPLETED Generation of formattable is incorrect                            |         |       |  2:30 |   3.5 |
| COMPLETED Visitor includes are incorrect                                    |         |       |  0:20 |   0.5 |
| COMPLETED Add includer to quilt.cpp                                         |         |       |  1:46 |   2.5 |
...
| COMPLETED Add aspect expander to quilt.cpp                                  |         |       |  1:26 |   2.0 |
| COMPLETED Run tests that are passing on windows                             |         |       |  0:10 |   0.2 |
| COMPLETED Add helper expander to quilt.cpp                                  |         |       |  1:26 |   2.0 |
| COMPLETED Merge pre and post workflows                                      |         |       |  0:16 |   0.4 |
| COMPLETED Fix bug in aspect and helper generation                           |         |       |  0:15 |   0.3 |
| COMPLETED Investigate element annotation support                            |         |       |  2:05 |   2.9 |
| CANCELLED Add streaming settings expander                                   |         |       |  0:36 |   0.8 |
| COMPLETED Create the formattables model                                     |         |       |  1:32 |   2.1 |
| COMPLETED Hook formattables into formatters                                 |         |       |  3:58 |   5.5 |
| COMPLETED Remove empty context                                              |         |       |  1:09 |   1.6 |
| COMPLETED Review main classes in quilt.cpp                                  |         |       |  3:42 |   5.1 |
| COMPLETED Clean up element segmentation                                     |         |       |  1:20 |   1.9 |
| COMPLETED Get OSX build to compile code                                     |         |       |  7:05 |   9.8 |
...
| COMPLETED Analysis around terminology in formatting space                   |         |       |  3:24 |   4.7 |
| COMPLETED Remove =original_model_name=                                      |         |       |  0:16 |   0.4 |
| COMPLETED Refactor code around model origination                            |         |       |  4:08 |   5.7 |
...
| COMPLETED Expander refactor in =quilt.cpp=                                  |         |       |  3:03 |   4.2 |
| COMPLETED Create the notion of a formatter alias                            |         |       |  3:15 |   4.5 |
| COMPLETED Remove enabled formatters from formatter configuration            |         |       |  0:22 |   0.5 |
| COMPLETED Handle registration of services properly                          |         |       |  3:41 |   5.1 |
| COMPLETED Move stereotypes to element                                       |         |       |  0:21 |   0.5 |
| COMPLETED Improve project banner                                            |         |       |  0:32 |   0.7 |
| CANCELLED Add support for profiles                                          |         |       | 10:40 |  14.8 |
| STARTED Rewrite profile support                                             |         |       |  1:26 |   2.0 |
...
*** Create a dynamic expander in yarn                                 :story:
