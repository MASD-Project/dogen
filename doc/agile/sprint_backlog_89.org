...
#+CAPTION: Clock summary at [2016-10-03 Mon 16:05]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *48:08* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 48:08   |       |      | 100.0 |
| Active                                                                      |         | 48:08 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 4:37 |   9.6 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:07 |   0.2 |
| COMPLETED Generation of formattable is incorrect                            |         |       | 2:30 |   5.2 |
| COMPLETED Visitor includes are incorrect                                    |         |       | 0:20 |   0.7 |
| COMPLETED Add includer to quilt.cpp                                         |         |       | 1:46 |   3.7 |
| COMPLETED Add reducer to quilt.cpp                                          |         |       | 0:22 |   0.8 |
| COMPLETED Add new index to formtter container                               |         |       | 0:19 |   0.7 |
| COMPLETED Add path expander to quilt.cpp                                    |         |       | 0:49 |   1.7 |
| COMPLETED Add guard expander to quilt.cpp                                   |         |       | 0:27 |   0.9 |
| COMPLETED Investigate borked travis build                                   |         |       | 0:37 |   1.3 |
| COMPLETED Add decoration expander to quilt.cpp                              |         |       | 0:23 |   0.8 |
| COMPLETED Add aspect expander to quilt.cpp                                  |         |       | 1:26 |   3.0 |
| COMPLETED Run tests that are passing on windows                             |         |       | 0:10 |   0.3 |
| COMPLETED Add helper expander to quilt.cpp                                  |         |       | 1:26 |   3.0 |
| COMPLETED Merge pre and post workflows                                      |         |       | 0:16 |   0.6 |
| COMPLETED Fix bug in aspect and helper generation                           |         |       | 0:15 |   0.5 |
| COMPLETED Investigate element annotation support                            |         |       | 2:05 |   4.3 |
| CANCELLED Add streaming settings expander                                   |         |       | 0:36 |   1.2 |
| COMPLETED Create the formattables model                                     |         |       | 1:32 |   3.2 |
| COMPLETED Hook formattables into formatters                                 |         |       | 3:58 |   8.2 |
| COMPLETED Remove empty context                                              |         |       | 1:09 |   2.4 |
| COMPLETED Review main classes in quilt.cpp                                  |         |       | 3:42 |   7.7 |
| COMPLETED Clean up element segmentation                                     |         |       | 1:20 |   2.8 |
| COMPLETED Get OSX build to compile code                                     |         |       | 7:05 |  14.7 |
| COMPLETED Add a banner to readme                                            |         |       | 1:29 |   3.1 |
...
| COMPLETED Analysis around terminology in formatting space                   |         |       | 3:24 |   7.1 |
| COMPLETED Remove =original_model_name=                                      |         |       | 0:16 |   0.6 |
| COMPLETED Refactor code around model origination                            |         |       | 4:08 |   8.6 |
| COMPLETED Remove formatter level facet folders                              |         |       | 0:06 |   0.2 |
| STARTED Generate formatter interfaces                                       |         |       | 0:19 |   0.7 |
| STARTED Handle registration of services properly                            |         |       | 0:27 |   0.9 |
...
*** STARTED Add the concept of hand-crafting                          :story:
