...
#+CAPTION: Clock summary at [2016-09-29 Thu 09:41]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *22:00* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 22:00   |       |      | 100.0 |
| Active                                                                      |         | 22:00 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:49 |   3.7 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:07 |   0.5 |
| COMPLETED Generation of formattable is incorrect                            |         |       | 2:30 |  11.4 |
...
| COMPLETED Investigate element annotation support                            |         |       | 2:05 |   9.5 |
| CANCELLED Add streaming settings expander                                   |         |       | 0:36 |   2.7 |
| COMPLETED Create the formattables model                                     |         |       | 1:32 |   7.0 |
| COMPLETED Hook formattables into formatters                                 |         |       | 3:58 |  18.0 |
| COMPLETED Remove include builder legacy classes                             |         |       | 1:09 |   5.2 |
| STARTED Review main classes in quilt.cpp                                    |         |       | 0:34 |   2.6 |
