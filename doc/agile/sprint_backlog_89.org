...
#+CAPTION: Clock summary at [2016-10-04 Tue 10:50]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *53:51* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 53:51   |       |      | 100.0 |
| Active                                                                      |         | 53:51 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 4:37 |   8.6 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:07 |   0.2 |
| COMPLETED Generation of formattable is incorrect                            |         |       | 2:30 |   4.6 |
...
| COMPLETED Create the formattables model                                     |         |       | 1:32 |   2.8 |
| COMPLETED Hook formattables into formatters                                 |         |       | 3:58 |   7.4 |
| COMPLETED Remove empty context                                              |         |       | 1:09 |   2.1 |
| COMPLETED Review main classes in quilt.cpp                                  |         |       | 3:42 |   6.9 |
| COMPLETED Clean up element segmentation                                     |         |       | 1:20 |   2.5 |
| COMPLETED Get OSX build to compile code                                     |         |       | 7:05 |  13.2 |
...
| COMPLETED Analysis around terminology in formatting space                   |         |       | 3:24 |   6.3 |
| COMPLETED Remove =original_model_name=                                      |         |       | 0:16 |   0.5 |
| COMPLETED Refactor code around model origination                            |         |       | 4:08 |   7.7 |
...
| COMPLETED Expander refactor in =quilt.cpp=                                  |         |       | 3:03 |   5.7 |
| STARTED Generate formatter interfaces                                       |         |       | 0:19 |   0.6 |
| STARTED Handle registration of services properly                            |         |       | 2:13 |   4.1 |
| STARTED Create the notion of a formatter alias                              |         |       | 0:53 |   1.6 |
