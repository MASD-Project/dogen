...
#+CAPTION: Clock summary at [2016-09-27 Tue 10:58]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *12:30* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 12:30   |       |      | 100.0 |
| Active                                                                      |         | 12:30 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:49 |   6.5 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:07 |   0.9 |
| COMPLETED Generation of formattable is incorrect                            |         |       | 2:30 |  20.0 |
| COMPLETED Visitor includes are incorrect                                    |         |       | 0:20 |   2.7 |
| COMPLETED Add includer to quilt.cpp                                         |         |       | 1:46 |  14.1 |
| COMPLETED Add reducer to quilt.cpp                                          |         |       | 0:22 |   2.9 |
| COMPLETED Add new index to formtter container                               |         |       | 0:19 |   2.5 |
| COMPLETED Add path expander to quilt.cpp                                    |         |       | 0:49 |   6.5 |
| COMPLETED Add guard expander to quilt.cpp                                   |         |       | 0:27 |   3.6 |
| COMPLETED Investigate borked travis build                                   |         |       | 0:37 |   4.9 |
| COMPLETED Add decoration expander to quilt.cpp                              |         |       | 0:23 |   3.1 |
| COMPLETED Add aspect expander to quilt.cpp                                  |         |       | 1:26 |  11.5 |
| COMPLETED Run tests that are passing on windows                             |         |       | 0:10 |   1.3 |
| COMPLETED Add helper expander to quilt.cpp                                  |         |       | 1:26 |  11.5 |
| COMPLETED Merge pre and post workflows                                      |         |       | 0:16 |   2.1 |
| COMPLETED Fix bug in aspect and helper generation                           |         |       | 0:15 |   2.0 |
| STARTED Investigate element annotation support                              |         |       | 0:28 |   3.7 |
