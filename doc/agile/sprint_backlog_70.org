...
#+CAPTION: Clock summary at [2015-07-14 Tue 22:23]
| <75>                                                                        |         |       |      |
| Headline                                                                    | Time    |       |      |
|-----------------------------------------------------------------------------+---------+-------+------|
| *Total time*                                                                | *35:21* |       |      |
...
| STARTED Define end to end terminology given all refactoring stories         |         |       | 9:26 |
...
Separation of code classes. This involves the adaptation of the target architecture in such a
way that manually-created code must be written into classes specifically created for this
purpose.
