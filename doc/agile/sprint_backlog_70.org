...
#+CAPTION: Clock summary at [2015-07-09 Thu 21:05]
| <75>                                                                        |         |       |      |
| Headline                                                                    | Time    |       |      |
|-----------------------------------------------------------------------------+---------+-------+------|
| *Total time*                                                                | *15:25* |       |      |
...
| STARTED Remove knit backends and use backend model instead                  |         |       | 1:27 |
#+end:
...
*** STARTED Remove knit backends and use backend model instead        :story:
    CLOCK: [2015-07-09 Thu 20:56]--[2015-07-09 Thu 21:05] =>  0:09
