...
#+CAPTION: Clock summary at [2015-07-10 Fri 11:38]
| <75>                                                                        |         |       |      |
| Headline                                                                    | Time    |       |      |
|-----------------------------------------------------------------------------+---------+-------+------|
| *Total time*                                                                | *18:24* |       |      |
...
| STARTED Remove unused stereotypes and object types                          |         |       | 0:19 |
#+end:
...
*** STARTED Remove unused stereotypes and object types                :story:
