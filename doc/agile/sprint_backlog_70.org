...
#+CAPTION: Clock summary at [2015-07-08 Wed 17:30]
| <75>                                                                        |         |       |      |
| Headline                                                                    | Time    |       |      |
|-----------------------------------------------------------------------------+---------+-------+------|
| *Total time*                                                                | *11:52* |       |      |
...
| STARTED Implement odb pragma formatter for enumerations                     |         |       | 0:33 |
#+end:
...
*** Implement serialisation formatter for enumerations                :story:
