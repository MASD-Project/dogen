...
#+CAPTION: Clock summary at [2015-07-10 Fri 15:10]
| <75>                                                                        |         |       |      |
| Headline                                                                    | Time    |       |      |
|-----------------------------------------------------------------------------+---------+-------+------|
| *Total time*                                                                | *20:19* |       |      |
...
*** Remove is comparable from SML                                     :story:

We never did implement comparable properly. Remove all remnants of the
previous attempt.

*** Remove is final from SML                                          :story:

We never did implement comparable properly. Remove all remnants of the
previous attempt.

*** Add forward declarations to visitor                               :story:
...
*** Set enumeration underlying type in SML
...
*** Remove generation failure exception in knit                       :story:
