...
Clock summary at [2014-02-18 Tue 08:42]
...
| IMPLEMENTATION Fix Debian packages to use system boost |        |      | 0:19 |
#+end:
...
*** IMPLEMENTATION Fix Debian packages to use system boost            :story:
...
*** Integral: test with rspec                                         :story:

We started by using minitest for unit testing, but it seems rspec is
more widely used.

*** Integral: re-implement bash script in ruby                        :story:
