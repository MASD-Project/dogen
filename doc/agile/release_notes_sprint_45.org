...
Clock summary at [2014-02-20 Thu 22:21]

| Headline                                                  | Time   |      |      |
|-----------------------------------------------------------+--------+------+------|
| *Total time*                                              | *3:36* |      |      |
|-----------------------------------------------------------+--------+------+------|
| Development Stories Implemented                           |        | 3:36 |      |
...
| IMPLEMENTATION Integral: re-implement bash script in ruby |        |      | 1:18 |
| IMPLEMENTATION Integral: test with rspec                  |        |      | 0:12 |
#+end:
...
*** IMPLEMENTATION Integral: test with rspec                          :story:
