...
#+CAPTION: Clock summary at [2016-08-01 Mon 20:53]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *1:38* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 1:38   |      |      | 100.0 |
| Active                                                                      |        | 1:38 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:09 |   9.2 |
| COMPLETED Implement boost path's serialisation via a helper                 |        |      | 0:40 |  40.8 |
| COMPLETED Implement serialisation's implementation in terms of =yarn::object= |        |      | 0:32 |  32.7 |
| COMPLETED Implement odb's header in terms of =yarn::object=                 |        |      | 0:17 |  17.3 |
