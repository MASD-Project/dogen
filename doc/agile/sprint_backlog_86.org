...
#+CAPTION: Clock summary at [2016-08-01 Mon 22:13]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *2:27* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 2:27   |      |      | 100.0 |
| Active                                                                      |        | 2:27 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:09 |   6.1 |
| COMPLETED Implement boost path's serialisation via a helper                 |        |      | 0:40 |  27.2 |
| COMPLETED Implement serialisation's implementation in terms of =yarn::object= |        |      | 0:32 |  21.8 |
| COMPLETED Implement odb's header in terms of =yarn::object=                 |        |      | 0:17 |  11.6 |
| COMPLETED Implement test data's header in terms of =yarn::object=           |        |      | 0:11 |   7.5 |
| COMPLETED Implement test data's implementation in terms of =yarn::object=   |        |      | 0:14 |   9.5 |
| STARTED Remove all of class info infrastructure                             |        |      | 0:24 |  16.3 |
