...
#+CAPTION: Clock summary at [2016-08-01 Mon 21:31]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
...
| Stories                                                                     | 1:49   |      |      | 100.0 |
| Active                                                                      |        | 1:49 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:09 |   8.3 |
| COMPLETED Implement boost path's serialisation via a helper                 |        |      | 0:40 |  36.7 |
| COMPLETED Implement serialisation's implementation in terms of =yarn::object= |        |      | 0:32 |  29.4 |
| COMPLETED Implement odb's header in terms of =yarn::object=                 |        |      | 0:17 |  15.6 |
| COMPLETED Implement test data's header in terms of =yarn::object=           |        |      | 0:11 |  10.1 |
