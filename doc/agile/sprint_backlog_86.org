...
#+CAPTION: Clock summary at [2016-08-01 Mon 22:47]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
...
| Stories                                                                     | 2:56   |      |      | 100.0 |
| Active                                                                      |        | 2:56 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:09 |   5.1 |
| COMPLETED Implement boost path's serialisation via a helper                 |        |      | 0:40 |  22.7 |
| COMPLETED Implement serialisation's implementation in terms of =yarn::object= |        |      | 0:32 |  18.2 |
| COMPLETED Implement odb's header in terms of =yarn::object=                 |        |      | 0:17 |   9.7 |
| COMPLETED Implement test data's header in terms of =yarn::object=           |        |      | 0:11 |   6.2 |
| COMPLETED Implement test data's implementation in terms of =yarn::object=   |        |      | 0:14 |   8.0 |
| COMPLETED Remove all of class info infrastructure                           |        |      | 0:34 |  19.3 |
| COMPLETED Remove unused helper related properties                           |        |      | 0:19 |  10.8 |
