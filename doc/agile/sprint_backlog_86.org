...
#+CAPTION: Clock summary at [2016-08-01 Mon 23:01]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
...
| Stories                                                                     | 3:09   |      |      | 100.0 |
| Active                                                                      |        | 3:09 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:09 |   4.8 |
| COMPLETED Implement boost path's serialisation via a helper                 |        |      | 0:40 |  21.2 |
| COMPLETED Implement serialisation's implementation in terms of =yarn::object= |        |      | 0:32 |  16.9 |
| COMPLETED Implement odb's header in terms of =yarn::object=                 |        |      | 0:17 |   9.0 |
| COMPLETED Implement test data's header in terms of =yarn::object=           |        |      | 0:11 |   5.8 |
| COMPLETED Implement test data's implementation in terms of =yarn::object=   |        |      | 0:14 |   7.4 |
| COMPLETED Remove all of class info infrastructure                           |        |      | 0:34 |  18.0 |
| COMPLETED Remove unused helper related properties                           |        |      | 0:32 |  16.9 |
