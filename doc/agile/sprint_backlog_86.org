...
#+CAPTION: Clock summary at [2016-08-01 Mon 20:22]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *1:09* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 1:09   |      |      | 100.0 |
| Active                                                                      |        | 1:09 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:09 |  13.0 |
| STARTED Implement boost path's serialisation via a helper                   |        |      | 0:33 |  47.8 |
| STARTED Implement serialisation's header in terms of =yarn::object=         |        |      | 0:27 |  39.1 |
...
*** STARTED Implement boost path's serialisation via a helper         :story:
