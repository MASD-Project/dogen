...
#+CAPTION: Clock summary at [2016-08-01 Mon 21:46]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *2:03* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 2:03   |      |      | 100.0 |
| Active                                                                      |        | 2:03 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:09 |   7.3 |
| COMPLETED Implement boost path's serialisation via a helper                 |        |      | 0:40 |  32.5 |
| COMPLETED Implement serialisation's implementation in terms of =yarn::object= |        |      | 0:32 |  26.0 |
| COMPLETED Implement odb's header in terms of =yarn::object=                 |        |      | 0:17 |  13.8 |
| COMPLETED Implement test data's header in terms of =yarn::object=           |        |      | 0:11 |   8.9 |
| COMPLETED Implement test data's implementation in terms of =yarn::object=   |        |      | 0:14 |  11.4 |
