...
#+CAPTION: Clock summary at [2016-08-01 Mon 22:24]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
...
| Stories                                                                     | 2:37   |      |      | 100.0 |
| Active                                                                      |        | 2:37 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:09 |   5.7 |
| COMPLETED Implement boost path's serialisation via a helper                 |        |      | 0:40 |  25.5 |
| COMPLETED Implement serialisation's implementation in terms of =yarn::object= |        |      | 0:32 |  20.4 |
| COMPLETED Implement odb's header in terms of =yarn::object=                 |        |      | 0:17 |  10.8 |
| COMPLETED Implement test data's header in terms of =yarn::object=           |        |      | 0:11 |   7.0 |
| COMPLETED Implement test data's implementation in terms of =yarn::object=   |        |      | 0:14 |   8.9 |
| COMPLETED Remove all of class info infrastructure                           |        |      | 0:34 |  21.7 |
