...
#+CAPTION: Clock summary at [2016-08-04 Thu 22:59]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
...
| Stories                                                                     | 5:55   |      |      | 100.0 |
| Active                                                                      |        | 5:55 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:52 |  14.6 |
| COMPLETED Implement boost path's serialisation via a helper                 |        |      | 0:40 |  11.3 |
| COMPLETED Implement serialisation's implementation in terms of =yarn::object= |        |      | 0:32 |   9.0 |
| COMPLETED Implement odb's header in terms of =yarn::object=                 |        |      | 0:17 |   4.8 |
| COMPLETED Implement test data's header in terms of =yarn::object=           |        |      | 0:11 |   3.1 |
| COMPLETED Implement test data's implementation in terms of =yarn::object=   |        |      | 0:14 |   3.9 |
| COMPLETED Remove all of class info infrastructure                           |        |      | 0:34 |   9.6 |
| COMPLETED Remove unused helper related properties                           |        |      | 0:32 |   9.0 |
| STARTED Add support for bintray                                             |        |      | 1:08 |  19.2 |
| STARTED Consider adding support for inheritance via meta-data               |        |      | 0:55 |  15.5 |
