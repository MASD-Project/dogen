...
#+CAPTION: Clock summary at [2016-08-01 Mon 22:41]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *2:50* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 2:50   |      |      | 100.0 |
| Active                                                                      |        | 2:50 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:09 |   5.3 |
| COMPLETED Implement boost path's serialisation via a helper                 |        |      | 0:40 |  23.5 |
| COMPLETED Implement serialisation's implementation in terms of =yarn::object= |        |      | 0:32 |  18.8 |
| COMPLETED Implement odb's header in terms of =yarn::object=                 |        |      | 0:17 |  10.0 |
| COMPLETED Implement test data's header in terms of =yarn::object=           |        |      | 0:11 |   6.5 |
| COMPLETED Implement test data's implementation in terms of =yarn::object=   |        |      | 0:14 |   8.2 |
| COMPLETED Remove all of class info infrastructure                           |        |      | 0:34 |  20.0 |
| STARTED Remove unused helper related properties                             |        |      | 0:13 |   7.6 |
...
*** STARTED Remove unused helper related properties                   :story:
