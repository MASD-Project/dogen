...
#+CAPTION: Clock summary at [2017-03-25 Sat 11:28]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                                     | 30:13   |       |       | 100.0 |
| Active                                                                      |         | 30:13 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:52 |   2.9 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:30 |   1.7 |
| COMPLETED Header directory is not part of housekeeping                      |         |       |  0:49 |   2.7 |
| COMPLETED Disable common support on ODB for a single database               |         |       |  0:08 |   0.4 |
| COMPLETED Concepts cannot be placed inside of packages                      |         |       |  8:26 |  27.9 |
| COMPLETED Use =cxx= extension with ODB files                                |         |       |  0:32 |   1.8 |
| STARTED Implement the database model using Northwind                        |         |       |  1:58 |   6.5 |
| STARTED Allow users to override string prefixes in test data                |         |       |  0:37 |   2.0 |
| STARTED Ignore ODB files automatically                                      |         |       |  1:55 |   6.3 |
| STARTED Improve ODB implementation                                          |         |       | 14:26 |  47.8 |
