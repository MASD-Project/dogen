...
#+CAPTION: Clock summary at [2017-03-21 Tue 12:09]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *4:13* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 4:13   |      |      | 100.0 |
| Active                                                                      |        | 4:13 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:11 |   4.3 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 0:30 |  11.9 |
| COMPLETED Header directory is not part of housekeeping                      |        |      | 0:49 |  19.4 |
| COMPLETED Disable common support on ODB for a single database               |        |      | 0:08 |   3.2 |
| STARTED Implement the database model using Northwind                        |        |      | 1:58 |  46.6 |
| STARTED Allow users to override string prefixes in test data                |        |      | 0:37 |  14.6 |
...
*** Concepts do not work in namespaces                                :story:
