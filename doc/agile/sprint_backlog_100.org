...
#+CAPTION: Clock summary at [2017-03-23 Thu 14:11]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 20:28   |       |      | 100.0 |
| Active                                                                      |         | 20:28 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:52 |   4.2 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:30 |   2.4 |
| COMPLETED Header directory is not part of housekeeping                      |         |       | 0:49 |   4.0 |
| COMPLETED Disable common support on ODB for a single database               |         |       | 0:08 |   0.7 |
| COMPLETED Concepts cannot be placed inside of packages                      |         |       | 8:26 |  41.2 |
| COMPLETED Use =cxx= extension with ODB files                                |         |       | 0:32 |   2.6 |
| STARTED Implement the database model using Northwind                        |         |       | 1:58 |   9.6 |
| STARTED Allow users to override string prefixes in test data                |         |       | 0:37 |   3.0 |
| STARTED Ignore ODB files automatically                                      |         |       | 1:55 |   9.4 |
| STARTED Improve ODB implementation                                          |         |       | 4:41 |  22.9 |
