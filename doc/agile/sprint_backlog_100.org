...
#+CAPTION: Clock summary at [2017-03-24 Fri 09:44]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *24:23* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 24:23   |       |      | 100.0 |
| Active                                                                      |         | 24:23 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:52 |   3.6 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:30 |   2.1 |
| COMPLETED Header directory is not part of housekeeping                      |         |       | 0:49 |   3.3 |
| COMPLETED Disable common support on ODB for a single database               |         |       | 0:08 |   0.5 |
| COMPLETED Concepts cannot be placed inside of packages                      |         |       | 8:26 |  34.6 |
| COMPLETED Use =cxx= extension with ODB files                                |         |       | 0:32 |   2.2 |
| STARTED Implement the database model using Northwind                        |         |       | 1:58 |   8.1 |
| STARTED Allow users to override string prefixes in test data                |         |       | 0:37 |   2.5 |
| STARTED Ignore ODB files automatically                                      |         |       | 1:55 |   7.9 |
| STARTED Improve ODB implementation                                          |         |       | 8:36 |  35.3 |
