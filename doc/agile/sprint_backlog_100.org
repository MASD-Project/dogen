...
#+CAPTION: Clock summary at [2017-03-22 Wed 16:35]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:30 |   4.1 |
| COMPLETED Header directory is not part of housekeeping                      |         |       | 0:49 |   6.6 |
| COMPLETED Disable common support on ODB for a single database               |         |       | 0:08 |   1.1 |
| STARTED Implement the database model using Northwind                        |         |       | 1:58 |  16.0 |
| STARTED Allow users to override string prefixes in test data                |         |       | 0:37 |   5.0 |
| STARTED Concepts cannot be placed inside of packages                        |         |       | 8:04 |  65.7 |
