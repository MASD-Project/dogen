...
#+CAPTION: Clock summary at [2017-03-24 Fri 10:05]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *25:27* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 25:27   |       |      | 100.0 |
| Active                                                                      |         | 25:27 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:52 |   3.4 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:30 |   2.0 |
| COMPLETED Header directory is not part of housekeeping                      |         |       | 0:49 |   3.2 |
| COMPLETED Disable common support on ODB for a single database               |         |       | 0:08 |   0.5 |
| COMPLETED Concepts cannot be placed inside of packages                      |         |       | 8:26 |  33.1 |
| COMPLETED Use =cxx= extension with ODB files                                |         |       | 0:32 |   2.1 |
| STARTED Implement the database model using Northwind                        |         |       | 1:58 |   7.7 |
| STARTED Allow users to override string prefixes in test data                |         |       | 0:37 |   2.4 |
| STARTED Ignore ODB files automatically                                      |         |       | 1:55 |   7.5 |
| STARTED Improve ODB implementation                                          |         |       | 9:40 |  38.0 |
