...
#+CAPTION: Clock summary at [2017-03-22 Wed 15:20]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:30 |   4.5 |
| COMPLETED Header directory is not part of housekeeping                      |         |       | 0:49 |   7.3 |
| COMPLETED Disable common support on ODB for a single database               |         |       | 0:08 |   1.2 |
| STARTED Implement the database model using Northwind                        |         |       | 1:58 |  17.6 |
| STARTED Allow users to override string prefixes in test data                |         |       | 0:37 |   5.5 |
| STARTED Concepts cannot be placed inside of packages                        |         |       | 6:56 |  62.2 |
