...
#+CAPTION: Clock summary at [2017-03-22 Wed 18:10]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| COMPLETED Concepts cannot be placed inside of packages                      |         |       | 8:26 |  61.0 |
| COMPLETED Use =cxx= extension with ODB files                                |         |       | 0:32 |   3.9 |
| STARTED Implement the database model using Northwind                        |         |       | 1:58 |  14.2 |
