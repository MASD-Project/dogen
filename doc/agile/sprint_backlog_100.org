...
#+CAPTION: Clock summary at [2017-03-23 Thu 16:21]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *22:44* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 22:44   |       |      | 100.0 |
| Active                                                                      |         | 22:44 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:52 |   3.8 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:30 |   2.2 |
| COMPLETED Header directory is not part of housekeeping                      |         |       | 0:49 |   3.6 |
| COMPLETED Disable common support on ODB for a single database               |         |       | 0:08 |   0.6 |
| COMPLETED Concepts cannot be placed inside of packages                      |         |       | 8:26 |  37.1 |
| COMPLETED Use =cxx= extension with ODB files                                |         |       | 0:32 |   2.3 |
| STARTED Implement the database model using Northwind                        |         |       | 1:58 |   8.7 |
| STARTED Allow users to override string prefixes in test data                |         |       | 0:37 |   2.7 |
| STARTED Ignore ODB files automatically                                      |         |       | 1:55 |   8.4 |
| STARTED Improve ODB implementation                                          |         |       | 6:57 |  30.6 |
