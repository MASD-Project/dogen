...
#+CAPTION: Clock summary at [2017-03-21 Tue 11:52]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *4:05* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 4:05   |      |      | 100.0 |
| Active                                                                      |        | 4:05 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:11 |   4.5 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 0:30 |  12.2 |
| COMPLETED Header directory is not part of housekeeping                      |        |      | 0:49 |  20.0 |
| STARTED Implement the database model using Northwind                        |        |      | 1:58 |  48.2 |
| STARTED Allow users to override string prefixes in test data                |        |      | 0:37 |  15.1 |
