...
#+CAPTION: Clock summary at [2017-03-22 Wed 18:05]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *13:46* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 13:46   |       |      | 100.0 |
| Active                                                                      |         | 13:46 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:11 |   1.3 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:30 |   3.6 |
| COMPLETED Header directory is not part of housekeeping                      |         |       | 0:49 |   5.9 |
| COMPLETED Disable common support on ODB for a single database               |         |       | 0:08 |   1.0 |
| COMPLETED Concepts cannot be placed inside of packages                      |         |       | 8:26 |  61.3 |
| STARTED Implement the database model using Northwind                        |         |       | 1:58 |  14.3 |
| STARTED Allow users to override string prefixes in test data                |         |       | 0:37 |   4.5 |
| STARTED Ignore ODB files automatically                                      |         |       | 0:39 |   4.7 |
| STARTED Use =cxx= extension with ODB files                                  |         |       | 0:28 |   3.4 |
...
*** STARTED Use =cxx= extension with ODB files                        :story:
