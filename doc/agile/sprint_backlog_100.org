...
#+CAPTION: Clock summary at [2017-03-22 Wed 12:59]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *9:53* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 9:53   |      |      | 100.0 |
| Active                                                                      |        | 9:53 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:11 |   1.9 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 0:30 |   5.1 |
| COMPLETED Header directory is not part of housekeeping                      |        |      | 0:49 |   8.3 |
| COMPLETED Disable common support on ODB for a single database               |        |      | 0:08 |   1.3 |
| STARTED Implement the database model using Northwind                        |        |      | 1:58 |  19.9 |
| STARTED Allow users to override string prefixes in test data                |        |      | 0:37 |   6.2 |
| STARTED Concepts cannot be placed inside of packages                        |        |      | 5:40 |  57.3 |
