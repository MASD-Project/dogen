...
#+CAPTION: Clock summary at [2017-03-24 Fri 20:50]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *28:47* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 28:47   |       |       | 100.0 |
| Active                                                                      |         | 28:47 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:52 |   3.0 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:30 |   1.7 |
| COMPLETED Header directory is not part of housekeeping                      |         |       |  0:49 |   2.8 |
| COMPLETED Disable common support on ODB for a single database               |         |       |  0:08 |   0.5 |
| COMPLETED Concepts cannot be placed inside of packages                      |         |       |  8:26 |  29.3 |
| COMPLETED Use =cxx= extension with ODB files                                |         |       |  0:32 |   1.9 |
| STARTED Implement the database model using Northwind                        |         |       |  1:58 |   6.8 |
| STARTED Allow users to override string prefixes in test data                |         |       |  0:37 |   2.1 |
| STARTED Ignore ODB files automatically                                      |         |       |  1:55 |   6.7 |
| STARTED Improve ODB implementation                                          |         |       | 13:00 |  45.2 |
