...
#+CAPTION: Clock summary at [2017-03-24 Fri 13:31]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *27:47* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 27:47   |       |       | 100.0 |
| Active                                                                      |         | 27:47 |       | 100.0 |
...
| COMPLETED Concepts cannot be placed inside of packages                      |         |       |  8:26 |  30.4 |
| COMPLETED Use =cxx= extension with ODB files                                |         |       |  0:32 |   1.9 |
| STARTED Implement the database model using Northwind                        |         |       |  1:58 |   7.1 |
| STARTED Allow users to override string prefixes in test data                |         |       |  0:37 |   2.2 |
| STARTED Ignore ODB files automatically                                      |         |       |  1:55 |   6.9 |
| STARTED Improve ODB implementation                                          |         |       | 12:00 |  43.2 |
