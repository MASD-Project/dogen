...
#+CAPTION: Clock summary at [2017-03-22 Wed 22:06]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| COMPLETED Edit release notes for previous sprint                            |         |       | 0:30 |   3.3 |
| COMPLETED Header directory is not part of housekeeping                      |         |       | 0:49 |   5.4 |
| COMPLETED Disable common support on ODB for a single database               |         |       | 0:08 |   0.9 |
| COMPLETED Concepts cannot be placed inside of packages                      |         |       | 8:26 |  55.8 |
| COMPLETED Use =cxx= extension with ODB files                                |         |       | 0:32 |   3.5 |
| STARTED Implement the database model using Northwind                        |         |       | 1:58 |  13.0 |
| STARTED Allow users to override string prefixes in test data                |         |       | 0:37 |   4.1 |
| STARTED Ignore ODB files automatically                                      |         |       | 1:55 |  12.7 |
...
*** Improve ODB implementation                                        :story:
