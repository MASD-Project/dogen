...
#+CAPTION: Clock summary at [2017-03-24 Fri 11:57]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *27:17* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 27:17   |       |       | 100.0 |
| Active                                                                      |         | 27:17 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:52 |   3.2 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:30 |   1.8 |
| COMPLETED Header directory is not part of housekeeping                      |         |       |  0:49 |   3.0 |
| COMPLETED Disable common support on ODB for a single database               |         |       |  0:08 |   0.5 |
| COMPLETED Concepts cannot be placed inside of packages                      |         |       |  8:26 |  30.9 |
| COMPLETED Use =cxx= extension with ODB files                                |         |       |  0:32 |   2.0 |
| STARTED Implement the database model using Northwind                        |         |       |  1:58 |   7.2 |
| STARTED Allow users to override string prefixes in test data                |         |       |  0:37 |   2.3 |
| STARTED Ignore ODB files automatically                                      |         |       |  1:55 |   7.0 |
| STARTED Improve ODB implementation                                          |         |       | 11:30 |  42.2 |
