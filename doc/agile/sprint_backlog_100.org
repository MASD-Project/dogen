...
#+CAPTION: Clock summary at [2017-03-21 Tue 14:26]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *4:49* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 4:49   |      |      | 100.0 |
| Active                                                                      |        | 4:49 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:11 |   3.8 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 0:30 |  10.4 |
| COMPLETED Header directory is not part of housekeeping                      |        |      | 0:49 |  17.0 |
| COMPLETED Disable common support on ODB for a single database               |        |      | 0:08 |   2.8 |
| STARTED Implement the database model using Northwind                        |        |      | 1:58 |  40.8 |
| STARTED Allow users to override string prefixes in test data                |        |      | 0:37 |  12.8 |
| STARTED Concepts cannot be placed inside of packages                        |        |      | 0:36 |  12.5 |
