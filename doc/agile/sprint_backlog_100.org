...
#+CAPTION: Clock summary at [2017-03-20 Mon 22:43]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *2:39* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 2:39   |      |      | 100.0 |
| Active                                                                      |        | 2:39 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:11 |   6.9 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 0:30 |  18.9 |
| STARTED Implement the database model using Northwind                        |        |      | 1:58 |  74.2 |
