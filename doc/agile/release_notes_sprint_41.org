...
Clock summary at [2013-12-23 Mon 19:09]

| Headline                                                | Time    |       |       |
|---------------------------------------------------------+---------+-------+-------|
| *Total time*                                            | *22:31* |       |       |
|---------------------------------------------------------+---------+-------+-------|
| Development Stories Implemented                         |         | 22:31 |       |
...
| IMPLEMENTATION Compile code without PFH                 |         |       | 11:03 |
#+end:
...
***** IMPLEMENTATION Regenerate all models without EOS
