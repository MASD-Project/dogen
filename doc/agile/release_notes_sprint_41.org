...
Clock summary at [2013-12-29 Sun 19:19]

| Headline                                                      | Time    |       |       |
|---------------------------------------------------------------+---------+-------+-------|
| *Total time*                                                  | *43:13* |       |       |
|---------------------------------------------------------------+---------+-------+-------|
| Development Stories Implemented                               |         | 43:13 |       |
...
| IMPLEMENTATION Fix broken builds due to a variety of errors   |         |       |  3:39 |
| IMPLEMENTATION Add om's workflow to engine                    |         |       |  7:20 |
#+end:
