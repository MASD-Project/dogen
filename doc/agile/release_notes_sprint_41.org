...
Clock summary at [2013-12-20 Fri 08:24]

| Headline                                                     | Time   |      |      |
|--------------------------------------------------------------+--------+------+------|
| *Total time*                                                 | *7:23* |      |      |
|--------------------------------------------------------------+--------+------+------|
| Development Stories Implemented                              |        | 7:23 |      |
| IMPLEMENTATION Release notes and backlog grooming            |        |      | 0:19 |
| COMPLETED Use relationship container for visitors            |        |      | 1:13 |
| IMPLEMENTATION Create an =association_indexer= and add tests |        |      | 5:51 |
#+end:
...
**** IMPLEMENTATION Copy across applicable extractor tests            :spike:
