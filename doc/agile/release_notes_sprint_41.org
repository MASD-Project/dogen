...
Clock summary at [2013-12-28 Sat 23:23]

| Headline                                                      | Time    |       |       |
|---------------------------------------------------------------+---------+-------+-------|
| *Total time*                                                  | *38:06* |       |       |
|---------------------------------------------------------------+---------+-------+-------|
| Development Stories Implemented                               |         | 38:06 |       |
...
| IMPLEMENTATION Fix broken builds due to a variety of errors   |         |       |  3:00 |
| IMPLEMENTATION Add om's workflow to engine                    |         |       |  3:22 |
#+end:
...
**** IMPLEMENTATION Handle models without meta-data such as licence, etc :task:
