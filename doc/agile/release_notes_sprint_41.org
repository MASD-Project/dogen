...
Clock summary at [2013-12-28 Sat 09:30]

| Headline                                                           | Time    |       |       |
|--------------------------------------------------------------------+---------+-------+-------|
| *Total time*                                                       | *31:10* |       |       |
|--------------------------------------------------------------------+---------+-------+-------|
| Development Stories Implemented                                    |         | 31:10 |       |
...
| IMPLEMENTATION Fix broken builds due to a variety of errors        |         |       |  0:18 |
...
- OSX: seems to have a EOS error
- Linux: seems to have naming errors in tests
- Windows: we do not seem to be detecting the location of boost
  correctly.
