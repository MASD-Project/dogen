...
Clock summary at [2013-12-23 Mon 14:45]

| Headline                                                | Time    |       |      |
|---------------------------------------------------------+---------+-------+------|
| *Total time*                                            | *19:38* |       |      |
|---------------------------------------------------------+---------+-------+------|
| Development Stories Implemented                         |         | 19:38 |      |
...
| IMPLEMENTATION Compile code without PFH                 |         |       | 8:10 |
#+end:
...
**** IMPLEMENTATION Detect PFH and disable system headers              :task:

If PFH is not found we should use system directories for boost.

**** Split EOS from main serialisation test                            :task:
