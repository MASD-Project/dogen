...
Clock summary at [2013-12-17 Tue 19:57]

| Headline                                                     | Time   |      |      |
|--------------------------------------------------------------+--------+------+------|
| *Total time*                                                 | *4:02* |      |      |
|--------------------------------------------------------------+--------+------+------|
| Development Stories Implemented                              |        | 4:02 |      |
| IMPLEMENTATION Release notes and backlog grooming            |        |      | 0:04 |
| COMPLETED Use relationship container for visitors            |        |      | 1:13 |
| IMPLEMENTATION Create an =association_indexer= and add tests |        |      | 2:45 |
#+end:
...
**** IMPLEMENTATION Implement class and add unit tests                 :task:
