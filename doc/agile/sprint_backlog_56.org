...
Clock summary at [2014-11-20 Thu 08:35]

| Headline                                                       | Time   |      |      |
|----------------------------------------------------------------+--------+------+------|
| *Total time*                                                   | *2:34* |      |      |
|----------------------------------------------------------------+--------+------+------|
| Development Stories Implemented                                |        | 2:34 |      |
...
| IMPLEMENTATION Make use of path spec details in formatter      |        |      | 0:13 |
| IMPLEMENTATION Create a compact form of qname io               |        |      | 0:13 |
#+end:
...
*** IMPLEMENTATION Make use of path spec details in formatter          :task:
...
*** IMPLEMENTATION Create a compact form of qname io                  :story:
...
*** Rename =identifier_name_builder= to =name_builder=        :task:refactor:
