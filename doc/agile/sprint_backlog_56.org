...
Clock summary at [2014-11-27 Thu 08:39]

| Headline                                                               | Time    |       |      |
|------------------------------------------------------------------------+---------+-------+------|
| *Total time*                                                           | *13:04* |       |      |
|------------------------------------------------------------------------+---------+-------+------|
| Development Stories Implemented                                        |         | 13:04 |      |
| IMPLEMENTATION Sprint and product backlog grooming                     |         |       | 1:14 |
...
| IMPLEMENTATION Rename bundle to global settings                        |         |       | 0:11 |
...
*** Add support for opaque settings                                    :task:

- create an empty opaque settings class. Create a opaque settings
  factory interface class. Formatter interface to return an optional
  opaque settings factory interface.
- add opaque settings to global settings.
- when formatting, cast opaque settings (if available) and throw if
  cast fails. For formatters without opaque settings, throw if any
  supplied.
