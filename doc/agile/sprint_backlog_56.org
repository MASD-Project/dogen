...
Clock summary at [2014-11-29 Sat 23:46]

| Headline                                                               | Time    |       |      |
|------------------------------------------------------------------------+---------+-------+------|
| *Total time*                                                           | *17:01* |       |      |
|------------------------------------------------------------------------+---------+-------+------|
| Development Stories Implemented                                        |         | 17:01 |      |
...
| IMPLEMENTATION Remove header validation from build                     |         |       | 1:00 |
...
*** IMPLEMENTATION Remove header validation from build           :task:build:
