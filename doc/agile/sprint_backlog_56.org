...
Clock summary at [2014-11-23 Sun 16:59]

| Headline                                                               | Time   |      |      |
|------------------------------------------------------------------------+--------+------+------|
| *Total time*                                                           | *8:02* |      |      |
|------------------------------------------------------------------------+--------+------+------|
| Development Stories Implemented                                        |        | 8:02 |      |
...
| IMPLEMENTATION Add dogen to travis                                     |        |      | 0:39 |
#+end:
...
*** IMPLEMENTATION Add dogen to travis                           :task:build:
