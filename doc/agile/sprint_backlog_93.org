...
#+CAPTION: Clock summary at [2016-12-07 Wed 13:51]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *37:42* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 37:42   |       |       | 100.0 |
| Active                                                                      |         | 37:42 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:51 |   4.9 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  1:02 |   2.7 |
| COMPLETED Update readme                                                     |         |       |  0:11 |   0.5 |
| COMPLETED Test data generation for dates generates invalid dates            |         |       |  0:33 |   1.5 |
| COMPLETED Handle missing stitch templates scenario                          |         |       |  1:04 |   2.8 |
| COMPLETED Move project directory to output options                          |         |       |  1:10 |   3.1 |
| COMPLETED Update the conceptual model to clarify backends and kernels       |         |       |  4:20 |  11.5 |
| COMPLETED Detect knitter and disable code generation accordingly            |         |       |  1:15 |   3.3 |
| COMPLETED Clean up kernel and backend confusion                             |         |       |  5:17 |  14.0 |
| COMPLETED Add a "language" directory for each backend                       |         |       |  5:44 |  15.2 |
| COMPLETED Split C++ profiles and templates from C#                          |         |       |  1:11 |   3.1 |
| COMPLETED Formatter registrar validation is not being called                |         |       |  0:20 |   0.9 |
| COMPLETED Move decoration repository to quilt                               |         |       |  0:43 |   1.9 |
| STARTED Move module id container into yarn                                  |         |       |  0:09 |   0.4 |
| STARTED Add basic infrastructure for C#                                     |         |       | 12:20 |  32.7 |
| STARTED Add support for Decimal numbers                                     |         |       |  0:32 |   1.4 |
...
*** STARTED Move module id container into yarn                        :story:
