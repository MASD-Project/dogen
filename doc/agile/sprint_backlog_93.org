...
#+CAPTION: Clock summary at [2016-12-10 Sat 20:55]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *62:42* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 62:42   |       |       | 100.0 |
| Active                                                                      |         | 62:42 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  2:48 |   4.5 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  1:02 |   1.6 |
| COMPLETED Update readme                                                     |         |       |  0:11 |   0.3 |
| COMPLETED Test data generation for dates generates invalid dates            |         |       |  0:33 |   0.9 |
| COMPLETED Handle missing stitch templates scenario                          |         |       |  1:04 |   1.7 |
| COMPLETED Move project directory to output options                          |         |       |  1:10 |   1.9 |
| COMPLETED Update the conceptual model to clarify backends and kernels       |         |       |  4:20 |   6.9 |
| COMPLETED Detect knitter and disable code generation accordingly            |         |       |  1:15 |   2.0 |
| COMPLETED Clean up kernel and backend confusion                             |         |       |  5:17 |   8.4 |
| COMPLETED Add a "language" directory for each backend                       |         |       |  5:44 |   9.1 |
| COMPLETED Split C++ profiles and templates from C#                          |         |       |  1:11 |   1.9 |
| COMPLETED Formatter registrar validation is not being called                |         |       |  0:20 |   0.5 |
| COMPLETED Move decoration repository to quilt                               |         |       |  0:43 |   1.1 |
| COMPLETED Move module id container into yarn                                |         |       |  0:24 |   0.6 |
| COMPLETED Add basic infrastructure for C#                                   |         |       | 17:02 |  27.2 |
| COMPLETED Add support for C#-style documentation                            |         |       |  1:57 |   3.1 |
| COMPLETED Add support for visual studio projects and solutions              |         |       |  6:05 |   9.7 |
| COMPLETED OSX build is borked                                               |         |       |  0:21 |   0.6 |
| COMPLETED Add facet directories to locator                                  |         |       |  1:09 |   1.8 |
| COMPLETED Split json and dia tests                                          |         |       |  0:12 |   0.3 |
| COMPLETED Split the "built-ins" by language                                 |         |       |  0:28 |   0.7 |
| COMPLETED Models should have an associated language                         |         |       |  2:57 |   4.7 |
| COMPLETED Add support for properties in C#                                  |         |       |  2:20 |   3.7 |
...
| STARTED Fix clang borked build                                              |         |       |  0:10 |   0.3 |
| STARTED Add support for test data generation in C#                          |         |       |  1:03 |   1.7 |
| STARTED Add support for Equals in C#                                        |         |       |  1:30 |   2.4 |
| STARTED Language namespaces and modeling element locations                  |         |       |  0:39 |   1.0 |
...
*** STARTED Fix clang borked build                                    :story:
    CLOCK: [2016-12-10 Sat 20:20]--[2016-12-10 Sat 20:30] =>  0:10

We seem to have generated some diffs with clang.
...
the easiest thing is to use helpers.
