...
#+CAPTION: Clock summary at [2016-12-06 Tue 10:22]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *27:55* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 27:55   |       |      | 100.0 |
| Active                                                                      |         | 27:55 |      | 100.0 |
...
| COMPLETED Update the conceptual model to clarify backends and kernels       |         |       | 4:20 |  15.5 |
| COMPLETED Detect knitter and disable code generation accordingly            |         |       | 1:15 |   4.5 |
| COMPLETED Clean up kernel and backend confusion                             |         |       | 5:17 |  18.9 |
| STARTED Add a "language" directory for each backend                         |         |       | 4:54 |  17.6 |
| STARTED Add support for C#                                                  |         |       | 5:46 |  20.7 |
