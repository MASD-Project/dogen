...
#+CAPTION: Clock summary at [2016-12-08 Thu 11:35]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *45:06* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 45:06   |       |       | 100.0 |
| Active                                                                      |         | 45:06 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  2:24 |   5.3 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  1:02 |   2.3 |
| COMPLETED Update readme                                                     |         |       |  0:11 |   0.4 |
| COMPLETED Test data generation for dates generates invalid dates            |         |       |  0:33 |   1.2 |
| COMPLETED Handle missing stitch templates scenario                          |         |       |  1:04 |   2.4 |
| COMPLETED Move project directory to output options                          |         |       |  1:10 |   2.6 |
| COMPLETED Update the conceptual model to clarify backends and kernels       |         |       |  4:20 |   9.6 |
| COMPLETED Detect knitter and disable code generation accordingly            |         |       |  1:15 |   2.8 |
| COMPLETED Clean up kernel and backend confusion                             |         |       |  5:17 |  11.7 |
| COMPLETED Add a "language" directory for each backend                       |         |       |  5:44 |  12.7 |
| COMPLETED Split C++ profiles and templates from C#                          |         |       |  1:11 |   2.6 |
| COMPLETED Formatter registrar validation is not being called                |         |       |  0:20 |   0.7 |
| COMPLETED Move decoration repository to quilt                               |         |       |  0:43 |   1.6 |
| COMPLETED Move module id container into yarn                                |         |       |  0:24 |   0.9 |
| COMPLETED Add basic infrastructure for C#                                   |         |       | 16:59 |  37.7 |
| COMPLETED Add support for C#-style documentation                            |         |       |  1:57 |   4.3 |
| STARTED Add support for Decimal numbers                                     |         |       |  0:32 |   1.2 |
