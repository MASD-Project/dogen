...
#+CAPTION: Clock summary at [2016-12-05 Mon 21:29]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *26:06* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 26:06   |       |      | 100.0 |
| Active                                                                      |         | 26:06 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:51 |   7.1 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 1:02 |   4.0 |
| COMPLETED Update readme                                                     |         |       | 0:11 |   0.7 |
| COMPLETED Test data generation for dates generates invalid dates            |         |       | 0:33 |   2.1 |
| COMPLETED Handle missing stitch templates scenario                          |         |       | 1:04 |   4.1 |
| COMPLETED Move project directory to output options                          |         |       | 1:10 |   4.5 |
| COMPLETED Update the conceptual model to clarify backends and kernels       |         |       | 4:20 |  16.6 |
| COMPLETED Detect knitter and disable code generation accordingly            |         |       | 1:15 |   4.8 |
| COMPLETED Clean up kernel and backend confusion                             |         |       | 5:17 |  20.2 |
| STARTED Add a "language" directory for each backend                         |         |       | 3:05 |  11.8 |
| STARTED Add support for C#                                                  |         |       | 5:46 |  22.1 |
