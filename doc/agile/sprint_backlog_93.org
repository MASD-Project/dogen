...
#+CAPTION: Clock summary at [2016-12-06 Tue 10:34]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *28:06* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 28:06   |       |      | 100.0 |
| Active                                                                      |         | 28:06 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:51 |   6.6 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 1:02 |   3.7 |
| COMPLETED Update readme                                                     |         |       | 0:11 |   0.7 |
| COMPLETED Test data generation for dates generates invalid dates            |         |       | 0:33 |   2.0 |
| COMPLETED Handle missing stitch templates scenario                          |         |       | 1:04 |   3.8 |
| COMPLETED Move project directory to output options                          |         |       | 1:10 |   4.2 |
| COMPLETED Update the conceptual model to clarify backends and kernels       |         |       | 4:20 |  15.4 |
| COMPLETED Detect knitter and disable code generation accordingly            |         |       | 1:15 |   4.4 |
| COMPLETED Clean up kernel and backend confusion                             |         |       | 5:17 |  18.8 |
| STARTED Add a "language" directory for each backend                         |         |       | 5:05 |  18.1 |
| STARTED Add support for C#                                                  |         |       | 5:46 |  20.5 |
