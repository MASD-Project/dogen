...
#+CAPTION: Clock summary at [2016-11-21 Mon 10:29]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *0:18* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 0:18   |      |      | 100.0 |
| Active                                                                      |        | 0:18 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:10 |  55.6 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 0:08 |  44.4 |
...
Overview
========
The main feature added in this sprint in full support for the JSON frontend. In the past JSON was used just to proivde proxy models; it should now provide the same level of support as the Dia frontend.

For examples of JSON models, see [the JSON test data pack](https://github.com/DomainDrivenConsulting/dogen/tree/master/test_data/yarn.json/input).

Other user visible changes:

- the External path is now supplied as part of the diagram rather than via the command line. This also means that references no longer require the External Path.
- the Tailor command line utility was added to convert Dia models into JSON models. This was mainly added to simplify the work on JSON support.
