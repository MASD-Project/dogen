...
#+CAPTION: Clock summary at [2016-12-10 Sat 18:11]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *62:08* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 62:08   |       |       | 100.0 |
| Active                                                                      |         | 62:08 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  2:24 |   3.9 |
...
| COMPLETED Update the conceptual model to clarify backends and kernels       |         |       |  4:20 |   7.0 |
| COMPLETED Detect knitter and disable code generation accordingly            |         |       |  1:15 |   2.0 |
| COMPLETED Clean up kernel and backend confusion                             |         |       |  5:17 |   8.5 |
| COMPLETED Add a "language" directory for each backend                       |         |       |  5:44 |   9.2 |
...
| COMPLETED Add basic infrastructure for C#                                   |         |       | 17:02 |  27.4 |
| COMPLETED Add support for C#-style documentation                            |         |       |  1:57 |   3.1 |
| COMPLETED Add support for visual studio projects and solutions              |         |       |  6:05 |   9.8 |
...
| COMPLETED Add support for properties in C#                                  |         |       |  2:20 |   3.8 |
