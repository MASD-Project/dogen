...
#+CAPTION: Clock summary at [2016-12-01 Thu 12:16]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *8:22* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 8:22   |      |      | 100.0 |
| Active                                                                      |        | 8:22 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 1:43 |  20.5 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 1:02 |  12.4 |
| COMPLETED Update readme                                                     |        |      | 0:11 |   2.2 |
| COMPLETED Test data generation for dates generates invalid dates            |        |      | 0:33 |   6.6 |
| STARTED Add support for Decimal numbers                                     |        |      | 0:32 |   6.4 |
| STARTED Add support for C#                                                  |        |      | 4:21 |  52.0 |
