...
#+CAPTION: Clock summary at [2016-12-05 Mon 16:19]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 23:21   |       |      | 100.0 |
| Active                                                                      |         | 23:21 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:51 |   7.9 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 1:02 |   4.4 |
| COMPLETED Update readme                                                     |         |       | 0:11 |   0.8 |
| COMPLETED Test data generation for dates generates invalid dates            |         |       | 0:33 |   2.4 |
| COMPLETED Handle missing stitch templates scenario                          |         |       | 1:04 |   4.6 |
| COMPLETED Move project directory to output options                          |         |       | 1:10 |   5.0 |
| COMPLETED Update the conceptual model to clarify backends and kernels       |         |       | 4:20 |  18.6 |
| COMPLETED Detect knitter and disable code generation accordingly            |         |       | 1:15 |   5.4 |
| STARTED Clean up kernel and backend confusion                               |         |       | 5:00 |  21.4 |
| STARTED Add a "language" directory for each backend                         |         |       | 0:37 |   2.6 |
| STARTED Add support for C#                                                  |         |       | 5:46 |  24.7 |
| STARTED Add support for Decimal numbers                                     |         |       | 0:32 |   2.3 |
