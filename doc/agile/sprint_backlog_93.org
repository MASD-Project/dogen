...
#+CAPTION: Clock summary at [2016-12-09 Fri 10:18]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *53:12* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 53:12   |       |       | 100.0 |
| Active                                                                      |         | 53:12 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  2:24 |   4.5 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  1:02 |   1.9 |
| COMPLETED Update readme                                                     |         |       |  0:11 |   0.3 |
| COMPLETED Test data generation for dates generates invalid dates            |         |       |  0:33 |   1.0 |
| COMPLETED Handle missing stitch templates scenario                          |         |       |  1:04 |   2.0 |
| COMPLETED Move project directory to output options                          |         |       |  1:10 |   2.2 |
| COMPLETED Update the conceptual model to clarify backends and kernels       |         |       |  4:20 |   8.1 |
| COMPLETED Detect knitter and disable code generation accordingly            |         |       |  1:15 |   2.3 |
| COMPLETED Clean up kernel and backend confusion                             |         |       |  5:17 |   9.9 |
| COMPLETED Add a "language" directory for each backend                       |         |       |  5:44 |  10.8 |
| COMPLETED Split C++ profiles and templates from C#                          |         |       |  1:11 |   2.2 |
...
| COMPLETED Move module id container into yarn                                |         |       |  0:24 |   0.8 |
| COMPLETED Add basic infrastructure for C#                                   |         |       | 16:59 |  31.9 |
| COMPLETED Add support for C#-style documentation                            |         |       |  1:57 |   3.7 |
| COMPLETED Add support for visual studio projects and solutions              |         |       |  6:05 |  11.4 |
| COMPLETED OSX build is borked                                               |         |       |  0:21 |   0.7 |
| COMPLETED Add facet directories to locator                                  |         |       |  1:09 |   2.2 |
| STARTED Mapping of language namespaces to modeling element locations        |         |       |  0:31 |   1.0 |
| STARTED Add support for Decimal numbers                                     |         |       |  0:32 |   1.0 |
...
thus they are not related to modules. So it is that the domain type is
[[https://github.com/DomainDrivenConsulting/dogen/blob/master/projects/yarn/include/dogen/yarn/types/enumeration.hpp][defined as]]:
...
And so forth. This worked well for C++. However, this approach may
...
*** Split the "built-ins" by language                                 :story:

At present we have a had
