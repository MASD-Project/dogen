...
#+CAPTION: Clock summary at [2016-12-07 Wed 11:14]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *35:34* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 35:34   |       |       | 100.0 |
| Active                                                                      |         | 35:34 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:51 |   5.2 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  1:02 |   2.9 |
| COMPLETED Update readme                                                     |         |       |  0:11 |   0.5 |
| COMPLETED Test data generation for dates generates invalid dates            |         |       |  0:33 |   1.5 |
| COMPLETED Handle missing stitch templates scenario                          |         |       |  1:04 |   3.0 |
| COMPLETED Move project directory to output options                          |         |       |  1:10 |   3.3 |
| COMPLETED Update the conceptual model to clarify backends and kernels       |         |       |  4:20 |  12.2 |
| COMPLETED Detect knitter and disable code generation accordingly            |         |       |  1:15 |   3.5 |
| COMPLETED Clean up kernel and backend confusion                             |         |       |  5:17 |  14.9 |
| COMPLETED Add a "language" directory for each backend                       |         |       |  5:44 |  16.1 |
| COMPLETED Split C++ profiles and templates from C#                          |         |       |  1:11 |   3.3 |
...
| STARTED Add basic infrastructure for C#                                     |         |       | 10:21 |  29.1 |
