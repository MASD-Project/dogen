...
#+CAPTION: Clock summary at [2016-12-06 Tue 12:19]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *29:49* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 29:49   |       |      | 100.0 |
| Active                                                                      |         | 29:49 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:51 |   6.2 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 1:02 |   3.5 |
| COMPLETED Update readme                                                     |         |       | 0:11 |   0.6 |
| COMPLETED Test data generation for dates generates invalid dates            |         |       | 0:33 |   1.8 |
| COMPLETED Handle missing stitch templates scenario                          |         |       | 1:04 |   3.6 |
| COMPLETED Move project directory to output options                          |         |       | 1:10 |   3.9 |
| COMPLETED Update the conceptual model to clarify backends and kernels       |         |       | 4:20 |  14.5 |
| COMPLETED Detect knitter and disable code generation accordingly            |         |       | 1:15 |   4.2 |
| COMPLETED Clean up kernel and backend confusion                             |         |       | 5:17 |  17.7 |
| COMPLETED Add a "language" directory for each backend                       |         |       | 5:44 |  19.2 |
| STARTED Add support for C#                                                  |         |       | 6:50 |  22.9 |
| STARTED Add support for Decimal numbers                                     |         |       | 0:32 |   1.8 |
