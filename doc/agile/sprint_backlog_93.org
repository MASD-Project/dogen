...
#+CAPTION: Clock summary at [2016-12-05 Mon 18:08]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *24:40* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 24:40   |       |      | 100.0 |
| Active                                                                      |         | 24:40 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:51 |   7.5 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 1:02 |   4.2 |
| COMPLETED Update readme                                                     |         |       | 0:11 |   0.7 |
| COMPLETED Test data generation for dates generates invalid dates            |         |       | 0:33 |   2.2 |
| COMPLETED Handle missing stitch templates scenario                          |         |       | 1:04 |   4.3 |
| COMPLETED Move project directory to output options                          |         |       | 1:10 |   4.7 |
| COMPLETED Update the conceptual model to clarify backends and kernels       |         |       | 4:20 |  17.6 |
| COMPLETED Detect knitter and disable code generation accordingly            |         |       | 1:15 |   5.1 |
| COMPLETED Clean up kernel and backend confusion                             |         |       | 5:17 |  21.4 |
| STARTED Add a "language" directory for each backend                         |         |       | 1:39 |   6.7 |
| STARTED Add support for C#                                                  |         |       | 5:46 |  23.4 |
