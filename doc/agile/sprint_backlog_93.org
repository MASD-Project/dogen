...
#+CAPTION: Clock summary at [2016-12-05 Mon 17:26]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *23:59* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 23:59   |       |      | 100.0 |
| Active                                                                      |         | 23:59 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:51 |   7.7 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 1:02 |   4.3 |
| COMPLETED Update readme                                                     |         |       | 0:11 |   0.8 |
| COMPLETED Test data generation for dates generates invalid dates            |         |       | 0:33 |   2.3 |
| COMPLETED Handle missing stitch templates scenario                          |         |       | 1:04 |   4.4 |
| COMPLETED Move project directory to output options                          |         |       | 1:10 |   4.9 |
| COMPLETED Update the conceptual model to clarify backends and kernels       |         |       | 4:20 |  18.1 |
| COMPLETED Detect knitter and disable code generation accordingly            |         |       | 1:15 |   5.2 |
| COMPLETED Clean up kernel and backend confusion                             |         |       | 5:17 |  22.0 |
| STARTED Add a "language" directory for each backend                         |         |       | 0:58 |   4.0 |
| STARTED Add support for C#                                                  |         |       | 5:46 |  24.0 |
| STARTED Add support for Decimal numbers                                     |         |       | 0:32 |   2.2 |
