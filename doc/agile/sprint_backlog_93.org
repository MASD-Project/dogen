...
#+CAPTION: Clock summary at [2016-12-11 Sun 18:43]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *67:59* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 67:59   |       |       | 100.0 |
| Active                                                                      |         | 67:59 |       | 100.0 |
...
| COMPLETED Add a "language" directory for each backend                       |         |       |  5:44 |   8.4 |
...
| COMPLETED Add basic infrastructure for C#                                   |         |       | 17:02 |  25.1 |
| COMPLETED Add support for C#-style documentation                            |         |       |  1:57 |   2.9 |
| COMPLETED Add support for visual studio projects and solutions              |         |       |  6:05 |   8.9 |
...
| COMPLETED Models should have an associated language                         |         |       |  2:57 |   4.3 |
| COMPLETED Add support for properties in C#                                  |         |       |  2:20 |   3.4 |
...
| STARTED Add helper infrastructure to C#                                     |         |       |  2:12 |   3.2 |
| STARTED Add support for test data generation in C#                          |         |       |  1:03 |   1.5 |
| STARTED Add support for Equals in C#                                        |         |       |  2:49 |   4.1 |
