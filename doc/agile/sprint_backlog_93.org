...
#+CAPTION: Clock summary at [2016-12-11 Sun 17:57]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *67:29* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 67:29   |       |       | 100.0 |
| Active                                                                      |         | 67:29 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  2:48 |   4.1 |
...
| COMPLETED Update the conceptual model to clarify backends and kernels       |         |       |  4:20 |   6.4 |
| COMPLETED Detect knitter and disable code generation accordingly            |         |       |  1:15 |   1.9 |
| COMPLETED Clean up kernel and backend confusion                             |         |       |  5:17 |   7.8 |
| COMPLETED Add a "language" directory for each backend                       |         |       |  5:44 |   8.5 |
...
| COMPLETED Add basic infrastructure for C#                                   |         |       | 17:02 |  25.2 |
| COMPLETED Add support for C#-style documentation                            |         |       |  1:57 |   2.9 |
| COMPLETED Add support for visual studio projects and solutions              |         |       |  6:05 |   9.0 |
...
| STARTED Add helper infrastructure to C#                                     |         |       |  1:42 |   2.5 |
