...
#+CAPTION: Clock summary at [2016-12-10 Sat 11:39]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *57:56* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 57:56   |       |       | 100.0 |
| Active                                                                      |         | 57:56 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  2:24 |   4.1 |
...
| COMPLETED Update the conceptual model to clarify backends and kernels       |         |       |  4:20 |   7.5 |
| COMPLETED Detect knitter and disable code generation accordingly            |         |       |  1:15 |   2.2 |
| COMPLETED Clean up kernel and backend confusion                             |         |       |  5:17 |   9.1 |
| COMPLETED Add a "language" directory for each backend                       |         |       |  5:44 |   9.9 |
...
| COMPLETED Add basic infrastructure for C#                                   |         |       | 17:02 |  29.4 |
| COMPLETED Add support for C#-style documentation                            |         |       |  1:57 |   3.4 |
| COMPLETED Add support for visual studio projects and solutions              |         |       |  6:05 |  10.5 |
...
| COMPLETED Models should have an associated language                         |         |       |  2:57 |   5.1 |
| STARTED Add support for properties in C#                                    |         |       |  0:56 |   1.6 |
