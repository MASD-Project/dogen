...
#+CAPTION: Clock summary at [2016-12-08 Thu 16:15]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *48:34* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 48:34   |       |       | 100.0 |
| Active                                                                      |         | 48:34 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  2:24 |   4.9 |
...
| COMPLETED Handle missing stitch templates scenario                          |         |       |  1:04 |   2.2 |
| COMPLETED Move project directory to output options                          |         |       |  1:10 |   2.4 |
| COMPLETED Update the conceptual model to clarify backends and kernels       |         |       |  4:20 |   8.9 |
| COMPLETED Detect knitter and disable code generation accordingly            |         |       |  1:15 |   2.6 |
| COMPLETED Clean up kernel and backend confusion                             |         |       |  5:17 |  10.9 |
| COMPLETED Add a "language" directory for each backend                       |         |       |  5:44 |  11.8 |
...
| COMPLETED Move decoration repository to quilt                               |         |       |  0:43 |   1.5 |
| COMPLETED Move module id container into yarn                                |         |       |  0:24 |   0.8 |
| COMPLETED Add basic infrastructure for C#                                   |         |       | 16:59 |  35.0 |
| COMPLETED Add support for C#-style documentation                            |         |       |  1:57 |   4.0 |
| STARTED Add support for Decimal numbers                                     |         |       |  0:32 |   1.1 |
| STARTED Add support for visual studio projects and solutions                |         |       |  3:28 |   7.1 |
