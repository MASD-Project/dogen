...
#+CAPTION: Clock summary at [2016-12-02 Fri 10:14]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *9:34* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 9:34   |      |      | 100.0 |
| Active                                                                      |        | 9:34 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 1:51 |  19.3 |
| COMPLETED Edit release notes for previous sprint                            |        |      | 1:02 |  10.8 |
| COMPLETED Update readme                                                     |        |      | 0:11 |   1.9 |
| COMPLETED Test data generation for dates generates invalid dates            |        |      | 0:33 |   5.7 |
| COMPLETED Handle missing stitch templates scenario                          |        |      | 1:04 |  11.1 |
| STARTED Add support for Decimal numbers                                     |        |      | 0:32 |   5.6 |
| STARTED Add support for C#                                                  |        |      | 4:21 |  45.5 |
