...
#+CAPTION: Clock summary at [2016-12-07 Wed 22:24]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                                     | 41:25   |       |       | 100.0 |
| Active                                                                      |         | 41:25 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:51 |   4.5 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  1:02 |   2.5 |
...
| COMPLETED Move project directory to output options                          |         |       |  1:10 |   2.8 |
| COMPLETED Update the conceptual model to clarify backends and kernels       |         |       |  4:20 |  10.5 |
| COMPLETED Detect knitter and disable code generation accordingly            |         |       |  1:15 |   3.0 |
| COMPLETED Clean up kernel and backend confusion                             |         |       |  5:17 |  12.8 |
| COMPLETED Add a "language" directory for each backend                       |         |       |  5:44 |  13.8 |
...
| STARTED Add basic infrastructure for C#                                     |         |       | 15:48 |  38.1 |
