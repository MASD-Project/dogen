...
#+CAPTION: Clock summary at [2016-12-08 Thu 15:02]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                                     | 47:23   |       |       | 100.0 |
| Active                                                                      |         | 47:23 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  2:24 |   5.1 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  1:02 |   2.2 |
| COMPLETED Update readme                                                     |         |       |  0:11 |   0.4 |
| COMPLETED Test data generation for dates generates invalid dates            |         |       |  0:33 |   1.2 |
| COMPLETED Handle missing stitch templates scenario                          |         |       |  1:04 |   2.3 |
| COMPLETED Move project directory to output options                          |         |       |  1:10 |   2.5 |
| COMPLETED Update the conceptual model to clarify backends and kernels       |         |       |  4:20 |   9.1 |
| COMPLETED Detect knitter and disable code generation accordingly            |         |       |  1:15 |   2.6 |
| COMPLETED Clean up kernel and backend confusion                             |         |       |  5:17 |  11.2 |
| COMPLETED Add a "language" directory for each backend                       |         |       |  5:44 |  12.1 |
| COMPLETED Split C++ profiles and templates from C#                          |         |       |  1:11 |   2.5 |
...
| COMPLETED Add basic infrastructure for C#                                   |         |       | 16:59 |  35.8 |
| COMPLETED Add support for C#-style documentation                            |         |       |  1:57 |   4.1 |
| STARTED Add support for Decimal numbers                                     |         |       |  0:32 |   1.1 |
| STARTED Add support for visual studio projects and solutions                |         |       |  2:17 |   4.8 |
