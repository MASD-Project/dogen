...
#+CAPTION: Clock summary at [2016-12-08 Thu 17:27]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *49:46* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 49:46   |       |       | 100.0 |
| Active                                                                      |         | 49:46 |       | 100.0 |
...
| COMPLETED Update the conceptual model to clarify backends and kernels       |         |       |  4:20 |   8.7 |
| COMPLETED Detect knitter and disable code generation accordingly            |         |       |  1:15 |   2.5 |
| COMPLETED Clean up kernel and backend confusion                             |         |       |  5:17 |  10.6 |
| COMPLETED Add a "language" directory for each backend                       |         |       |  5:44 |  11.5 |
...
| COMPLETED Add basic infrastructure for C#                                   |         |       | 16:59 |  34.1 |
| COMPLETED Add support for C#-style documentation                            |         |       |  1:57 |   3.9 |
| STARTED Add support for Decimal numbers                                     |         |       |  0:32 |   1.1 |
| STARTED Add support for visual studio projects and solutions                |         |       |  4:40 |   9.4 |
