...
#+CAPTION: Clock summary at [2016-12-08 Thu 19:34]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *50:19* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 50:19   |       |       | 100.0 |
| Active                                                                      |         | 50:19 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  2:24 |   4.8 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  1:02 |   2.1 |
| COMPLETED Update readme                                                     |         |       |  0:11 |   0.4 |
| COMPLETED Test data generation for dates generates invalid dates            |         |       |  0:33 |   1.1 |
| COMPLETED Handle missing stitch templates scenario                          |         |       |  1:04 |   2.1 |
| COMPLETED Move project directory to output options                          |         |       |  1:10 |   2.3 |
| COMPLETED Update the conceptual model to clarify backends and kernels       |         |       |  4:20 |   8.6 |
| COMPLETED Detect knitter and disable code generation accordingly            |         |       |  1:15 |   2.5 |
| COMPLETED Clean up kernel and backend confusion                             |         |       |  5:17 |  10.5 |
| COMPLETED Add a "language" directory for each backend                       |         |       |  5:44 |  11.4 |
| COMPLETED Split C++ profiles and templates from C#                          |         |       |  1:11 |   2.4 |
| COMPLETED Formatter registrar validation is not being called                |         |       |  0:20 |   0.7 |
| COMPLETED Move decoration repository to quilt                               |         |       |  0:43 |   1.4 |
| COMPLETED Move module id container into yarn                                |         |       |  0:24 |   0.8 |
| COMPLETED Add basic infrastructure for C#                                   |         |       | 16:59 |  33.8 |
| COMPLETED Add support for C#-style documentation                            |         |       |  1:57 |   3.9 |
| STARTED OSX build is borked                                                 |         |       |  0:21 |   0.7 |
| STARTED Add support for Decimal numbers                                     |         |       |  0:32 |   1.1 |
| STARTED Add support for visual studio projects and solutions                |         |       |  4:52 |   9.7 |
...
*** STARTED Add support for visual studio projects and solutions      :story:
