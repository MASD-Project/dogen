...
#+CAPTION: Clock summary at [2016-12-07 Wed 12:15]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *36:34* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 36:34   |       |       | 100.0 |
| Active                                                                      |         | 36:34 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:51 |   5.1 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  1:02 |   2.8 |
| COMPLETED Update readme                                                     |         |       |  0:11 |   0.5 |
| COMPLETED Test data generation for dates generates invalid dates            |         |       |  0:33 |   1.5 |
| COMPLETED Handle missing stitch templates scenario                          |         |       |  1:04 |   2.9 |
| COMPLETED Move project directory to output options                          |         |       |  1:10 |   3.2 |
| COMPLETED Update the conceptual model to clarify backends and kernels       |         |       |  4:20 |  11.9 |
| COMPLETED Detect knitter and disable code generation accordingly            |         |       |  1:15 |   3.4 |
| COMPLETED Clean up kernel and backend confusion                             |         |       |  5:17 |  14.4 |
| COMPLETED Add a "language" directory for each backend                       |         |       |  5:44 |  15.7 |
| COMPLETED Split C++ profiles and templates from C#                          |         |       |  1:11 |   3.2 |
| COMPLETED Formatter registrar validation is not being called                |         |       |  0:20 |   0.9 |
| COMPLETED Move decoration repository to quilt                               |         |       |  0:43 |   2.0 |
| STARTED Add basic infrastructure for C#                                     |         |       | 11:21 |  31.0 |
| STARTED Add support for Decimal numbers                                     |         |       |  0:32 |   1.5 |
