...
#+CAPTION: Clock summary at [2016-12-04 Sun 18:45]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 12:02   |       |      | 100.0 |
| Active                                                                      |         | 12:02 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:51 |  15.4 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 1:02 |   8.6 |
| COMPLETED Update readme                                                     |         |       | 0:11 |   1.5 |
| COMPLETED Test data generation for dates generates invalid dates            |         |       | 0:33 |   4.6 |
| COMPLETED Handle missing stitch templates scenario                          |         |       | 1:04 |   8.9 |
| COMPLETED Move project directory to output options                          |         |       | 1:10 |   9.7 |
| STARTED Add support for Decimal numbers                                     |         |       | 0:32 |   4.4 |
| STARTED Add support for C#                                                  |         |       | 5:39 |  47.0 |
