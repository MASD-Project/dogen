...
#+CAPTION: Clock summary at [2016-12-05 Mon 09:40]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *18:22* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 18:22   |       |      | 100.0 |
| Active                                                                      |         | 18:22 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:51 |  10.1 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 1:02 |   5.6 |
| COMPLETED Update readme                                                     |         |       | 0:11 |   1.0 |
| COMPLETED Test data generation for dates generates invalid dates            |         |       | 0:33 |   3.0 |
| COMPLETED Handle missing stitch templates scenario                          |         |       | 1:04 |   5.8 |
| COMPLETED Move project directory to output options                          |         |       | 1:10 |   6.4 |
| COMPLETED Update the conceptual model to clarify backends and kernels       |         |       | 4:20 |  23.6 |
| STARTED Clean up kernel and backend confusion                               |         |       | 1:16 |   6.9 |
| STARTED Add support for Decimal numbers                                     |         |       | 0:32 |   2.9 |
| STARTED Add support for C#                                                  |         |       | 5:46 |  31.4 |
