...
#+CAPTION: Clock summary at [2016-12-07 Wed 12:41]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *36:59* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 36:59   |       |       | 100.0 |
| Active                                                                      |         | 36:59 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:51 |   5.0 |
...
| COMPLETED Update the conceptual model to clarify backends and kernels       |         |       |  4:20 |  11.7 |
| COMPLETED Detect knitter and disable code generation accordingly            |         |       |  1:15 |   3.4 |
| COMPLETED Clean up kernel and backend confusion                             |         |       |  5:17 |  14.3 |
| COMPLETED Add a "language" directory for each backend                       |         |       |  5:44 |  15.5 |
...
| STARTED Add basic infrastructure for C#                                     |         |       | 11:46 |  31.8 |
