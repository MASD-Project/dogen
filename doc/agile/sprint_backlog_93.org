...
#+CAPTION: Clock summary at [2016-12-02 Fri 13:28]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 11:47   |       |      | 100.0 |
| Active                                                                      |         | 11:47 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:51 |  15.7 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 1:02 |   8.8 |
| COMPLETED Update readme                                                     |         |       | 0:11 |   1.6 |
| COMPLETED Test data generation for dates generates invalid dates            |         |       | 0:33 |   4.7 |
| COMPLETED Handle missing stitch templates scenario                          |         |       | 1:04 |   9.1 |
| COMPLETED Move project directory to output options                          |         |       | 0:59 |   8.3 |
| STARTED Add support for Decimal numbers                                     |         |       | 0:32 |   4.5 |
| STARTED Add support for C#                                                  |         |       | 5:35 |  47.4 |
