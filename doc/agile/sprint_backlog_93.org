...
#+CAPTION: Clock summary at [2016-12-07 Wed 14:08]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *37:57* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 37:57   |       |       | 100.0 |
| Active                                                                      |         | 37:57 |       | 100.0 |
...
| COMPLETED Test data generation for dates generates invalid dates            |         |       |  0:33 |   1.4 |
| COMPLETED Handle missing stitch templates scenario                          |         |       |  1:04 |   2.8 |
| COMPLETED Move project directory to output options                          |         |       |  1:10 |   3.1 |
| COMPLETED Update the conceptual model to clarify backends and kernels       |         |       |  4:20 |  11.4 |
| COMPLETED Detect knitter and disable code generation accordingly            |         |       |  1:15 |   3.3 |
| COMPLETED Clean up kernel and backend confusion                             |         |       |  5:17 |  13.9 |
| COMPLETED Add a "language" directory for each backend                       |         |       |  5:44 |  15.1 |
...
| COMPLETED Move module id container into yarn                                |         |       |  0:24 |   1.1 |
| STARTED Add basic infrastructure for C#                                     |         |       | 12:20 |  32.5 |
