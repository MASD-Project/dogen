...
#+CAPTION: Clock summary at [2016-12-10 Sat 12:37]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *58:51* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 58:51   |       |       | 100.0 |
| Active                                                                      |         | 58:51 |       | 100.0 |
...
| COMPLETED Update the conceptual model to clarify backends and kernels       |         |       |  4:20 |   7.4 |
| COMPLETED Detect knitter and disable code generation accordingly            |         |       |  1:15 |   2.1 |
| COMPLETED Clean up kernel and backend confusion                             |         |       |  5:17 |   9.0 |
| COMPLETED Add a "language" directory for each backend                       |         |       |  5:44 |   9.7 |
...
| COMPLETED Add basic infrastructure for C#                                   |         |       | 17:02 |  28.9 |
| COMPLETED Add support for C#-style documentation                            |         |       |  1:57 |   3.3 |
| COMPLETED Add support for visual studio projects and solutions              |         |       |  6:05 |  10.3 |
...
| STARTED Add support for properties in C#                                    |         |       |  1:51 |   3.1 |
