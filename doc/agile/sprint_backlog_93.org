...
#+CAPTION: Clock summary at [2016-12-08 Thu 14:20]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *46:42* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 46:42   |       |       | 100.0 |
| Active                                                                      |         | 46:42 |       | 100.0 |
...
| COMPLETED Update the conceptual model to clarify backends and kernels       |         |       |  4:20 |   9.3 |
| COMPLETED Detect knitter and disable code generation accordingly            |         |       |  1:15 |   2.7 |
| COMPLETED Clean up kernel and backend confusion                             |         |       |  5:17 |  11.3 |
| COMPLETED Add a "language" directory for each backend                       |         |       |  5:44 |  12.3 |
...
| COMPLETED Add basic infrastructure for C#                                   |         |       | 16:59 |  36.4 |
| COMPLETED Add support for C#-style documentation                            |         |       |  1:57 |   4.2 |
| STARTED Add support for Decimal numbers                                     |         |       |  0:32 |   1.1 |
| STARTED Add support for visual studio projects and solutions                |         |       |  1:36 |   3.4 |
