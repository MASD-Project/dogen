...
#+CAPTION: Clock summary at [2016-12-07 Wed 21:18]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *40:20* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 40:20   |       |       | 100.0 |
| Active                                                                      |         | 40:20 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:51 |   4.6 |
...
| COMPLETED Handle missing stitch templates scenario                          |         |       |  1:04 |   2.6 |
| COMPLETED Move project directory to output options                          |         |       |  1:10 |   2.9 |
| COMPLETED Update the conceptual model to clarify backends and kernels       |         |       |  4:20 |  10.7 |
| COMPLETED Detect knitter and disable code generation accordingly            |         |       |  1:15 |   3.1 |
| COMPLETED Clean up kernel and backend confusion                             |         |       |  5:17 |  13.1 |
| COMPLETED Add a "language" directory for each backend                       |         |       |  5:44 |  14.2 |
| COMPLETED Split C++ profiles and templates from C#                          |         |       |  1:11 |   2.9 |
...
| STARTED Add basic infrastructure for C#                                     |         |       | 14:43 |  36.5 |
