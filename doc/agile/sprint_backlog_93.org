...
#+CAPTION: Clock summary at [2016-12-07 Wed 10:29]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| Stories                                                                     | 34:51   |       |       | 100.0 |
| Active                                                                      |         | 34:51 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  1:51 |   5.3 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  1:02 |   3.0 |
| COMPLETED Update readme                                                     |         |       |  0:11 |   0.5 |
| COMPLETED Test data generation for dates generates invalid dates            |         |       |  0:33 |   1.6 |
| COMPLETED Handle missing stitch templates scenario                          |         |       |  1:04 |   3.1 |
| COMPLETED Move project directory to output options                          |         |       |  1:10 |   3.3 |
| COMPLETED Update the conceptual model to clarify backends and kernels       |         |       |  4:20 |  12.4 |
| COMPLETED Detect knitter and disable code generation accordingly            |         |       |  1:15 |   3.6 |
| COMPLETED Clean up kernel and backend confusion                             |         |       |  5:17 |  15.2 |
| COMPLETED Add a "language" directory for each backend                       |         |       |  5:44 |  16.5 |
| COMPLETED Split C++ profiles and templates from C#                          |         |       |  1:11 |   3.4 |
| COMPLETED Formatter registrar validation is not being called                |         |       |  0:20 |   1.0 |
| STARTED Add basic infrastructure for C#                                     |         |       | 10:21 |  29.7 |
