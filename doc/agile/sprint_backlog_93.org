...
#+CAPTION: Clock summary at [2016-12-09 Fri 12:12]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *55:01* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 55:01   |       |       | 100.0 |
| Active                                                                      |         | 55:01 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  2:24 |   4.4 |
...
| COMPLETED Update the conceptual model to clarify backends and kernels       |         |       |  4:20 |   7.9 |
| COMPLETED Detect knitter and disable code generation accordingly            |         |       |  1:15 |   2.3 |
| COMPLETED Clean up kernel and backend confusion                             |         |       |  5:17 |   9.6 |
| COMPLETED Add a "language" directory for each backend                       |         |       |  5:44 |  10.4 |
...
| COMPLETED Add basic infrastructure for C#                                   |         |       | 16:59 |  30.9 |
| COMPLETED Add support for C#-style documentation                            |         |       |  1:57 |   3.5 |
| COMPLETED Add support for visual studio projects and solutions              |         |       |  6:05 |  11.1 |
| COMPLETED OSX build is borked                                               |         |       |  0:21 |   0.6 |
| COMPLETED Add facet directories to locator                                  |         |       |  1:09 |   2.1 |
| STARTED Split the "built-ins" by language                                   |         |       |  0:28 |   0.8 |
| STARTED Models should have an associated language                           |         |       |  1:13 |   2.2 |
