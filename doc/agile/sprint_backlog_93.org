...
#+CAPTION: Clock summary at [2016-12-10 Sat 16:33]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *60:33* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 60:33   |       |       | 100.0 |
| Active                                                                      |         | 60:33 |       | 100.0 |
...
| COMPLETED Update the conceptual model to clarify backends and kernels       |         |       |  4:20 |   7.2 |
| COMPLETED Detect knitter and disable code generation accordingly            |         |       |  1:15 |   2.1 |
| COMPLETED Clean up kernel and backend confusion                             |         |       |  5:17 |   8.7 |
| COMPLETED Add a "language" directory for each backend                       |         |       |  5:44 |   9.5 |
...
| COMPLETED Add basic infrastructure for C#                                   |         |       | 17:02 |  28.1 |
| COMPLETED Add support for C#-style documentation                            |         |       |  1:57 |   3.2 |
| COMPLETED Add support for visual studio projects and solutions              |         |       |  6:05 |  10.0 |
...
| COMPLETED Models should have an associated language                         |         |       |  2:57 |   4.9 |
