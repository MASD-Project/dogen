...
#+CAPTION: Clock summary at [2016-12-06 Tue 17:17]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 32:10   |       |      | 100.0 |
| Active                                                                      |         | 32:10 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:51 |   5.8 |
...
| COMPLETED Update the conceptual model to clarify backends and kernels       |         |       | 4:20 |  13.5 |
| COMPLETED Detect knitter and disable code generation accordingly            |         |       | 1:15 |   3.9 |
| COMPLETED Clean up kernel and backend confusion                             |         |       | 5:17 |  16.4 |
| COMPLETED Add a "language" directory for each backend                       |         |       | 5:44 |  17.8 |
| COMPLETED Split C++ profiles and templates from C#                          |         |       | 1:11 |   3.7 |
| COMPLETED Formatter registrar validation is not being called                |         |       | 0:20 |   1.0 |
| STARTED Add support for C#                                                  |         |       | 7:40 |  23.8 |
