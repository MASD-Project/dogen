...
#+CAPTION: Clock summary at [2016-12-11 Sun 12:38]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *65:21* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 65:21   |       |       | 100.0 |
| Active                                                                      |         | 65:21 |       | 100.0 |
...
| COMPLETED Handle missing stitch templates scenario                          |         |       |  1:04 |   1.6 |
| COMPLETED Move project directory to output options                          |         |       |  1:10 |   1.8 |
| COMPLETED Update the conceptual model to clarify backends and kernels       |         |       |  4:20 |   6.6 |
| COMPLETED Detect knitter and disable code generation accordingly            |         |       |  1:15 |   1.9 |
| COMPLETED Clean up kernel and backend confusion                             |         |       |  5:17 |   8.1 |
| COMPLETED Add a "language" directory for each backend                       |         |       |  5:44 |   8.8 |
...
| COMPLETED Add basic infrastructure for C#                                   |         |       | 17:02 |  26.1 |
| COMPLETED Add support for C#-style documentation                            |         |       |  1:57 |   3.0 |
| COMPLETED Add support for visual studio projects and solutions              |         |       |  6:05 |   9.3 |
...
| COMPLETED Models should have an associated language                         |         |       |  2:57 |   4.5 |
...
| STARTED Add support for Equals in C#                                        |         |       |  2:23 |   3.6 |
