...
#+CAPTION: Clock summary at [2016-12-11 Sun 11:53]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *64:37* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 64:37   |       |       | 100.0 |
| Active                                                                      |         | 64:37 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  2:48 |   4.3 |
...
| COMPLETED Move project directory to output options                          |         |       |  1:10 |   1.8 |
| COMPLETED Update the conceptual model to clarify backends and kernels       |         |       |  4:20 |   6.7 |
| COMPLETED Detect knitter and disable code generation accordingly            |         |       |  1:15 |   1.9 |
| COMPLETED Clean up kernel and backend confusion                             |         |       |  5:17 |   8.2 |
| COMPLETED Add a "language" directory for each backend                       |         |       |  5:44 |   8.9 |
| COMPLETED Split C++ profiles and templates from C#                          |         |       |  1:11 |   1.8 |
...
| COMPLETED Add basic infrastructure for C#                                   |         |       | 17:02 |  26.4 |
| COMPLETED Add support for C#-style documentation                            |         |       |  1:57 |   3.0 |
| COMPLETED Add support for visual studio projects and solutions              |         |       |  6:05 |   9.4 |
...
| COMPLETED Models should have an associated language                         |         |       |  2:57 |   4.6 |
| COMPLETED Add support for properties in C#                                  |         |       |  2:20 |   3.6 |
...
| COMPLETED Identify floating point types in yarn                             |         |       |  1:25 |   2.2 |
| STARTED Add support for test data generation in C#                          |         |       |  1:03 |   1.6 |
| STARTED Add support for Equals in C#                                        |         |       |  1:39 |   2.6 |
| STARTED Language namespaces and modeling element locations                  |         |       |  0:53 |   1.4 |
