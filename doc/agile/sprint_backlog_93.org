...
#+CAPTION: Clock summary at [2016-12-06 Tue 16:18]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *31:13* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 31:13   |       |      | 100.0 |
| Active                                                                      |         | 31:13 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:51 |   5.9 |
...
| COMPLETED Update the conceptual model to clarify backends and kernels       |         |       | 4:20 |  13.9 |
| COMPLETED Detect knitter and disable code generation accordingly            |         |       | 1:15 |   4.0 |
| COMPLETED Clean up kernel and backend confusion                             |         |       | 5:17 |  16.9 |
| COMPLETED Add a "language" directory for each backend                       |         |       | 5:44 |  18.4 |
| COMPLETED Split C++ profiles and templates from C#                          |         |       | 1:11 |   3.8 |
| STARTED Add support for C#                                                  |         |       | 7:03 |  22.6 |
