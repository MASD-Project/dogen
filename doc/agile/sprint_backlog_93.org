...
#+CAPTION: Clock summary at [2016-12-06 Tue 18:09]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *33:00* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 33:00   |       |      | 100.0 |
| Active                                                                      |         | 33:00 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:51 |   5.6 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 1:02 |   3.1 |
| COMPLETED Update readme                                                     |         |       | 0:11 |   0.6 |
| COMPLETED Test data generation for dates generates invalid dates            |         |       | 0:33 |   1.7 |
| COMPLETED Handle missing stitch templates scenario                          |         |       | 1:04 |   3.2 |
| COMPLETED Move project directory to output options                          |         |       | 1:10 |   3.5 |
| COMPLETED Update the conceptual model to clarify backends and kernels       |         |       | 4:20 |  13.1 |
| COMPLETED Detect knitter and disable code generation accordingly            |         |       | 1:15 |   3.8 |
| COMPLETED Clean up kernel and backend confusion                             |         |       | 5:17 |  16.0 |
| COMPLETED Add a "language" directory for each backend                       |         |       | 5:44 |  17.4 |
| COMPLETED Split C++ profiles and templates from C#                          |         |       | 1:11 |   3.6 |
| COMPLETED Formatter registrar validation is not being called                |         |       | 0:20 |   1.0 |
| STARTED Add support for C#                                                  |         |       | 8:30 |  25.8 |
| STARTED Add support for Decimal numbers                                     |         |       | 0:32 |   1.6 |
