...
#+CAPTION: Clock summary at [2016-12-06 Tue 17:53]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *32:45* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 32:45   |       |      | 100.0 |
| Active                                                                      |         | 32:45 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:51 |   5.6 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 1:02 |   3.2 |
| COMPLETED Update readme                                                     |         |       | 0:11 |   0.6 |
| COMPLETED Test data generation for dates generates invalid dates            |         |       | 0:33 |   1.7 |
| COMPLETED Handle missing stitch templates scenario                          |         |       | 1:04 |   3.3 |
| COMPLETED Move project directory to output options                          |         |       | 1:10 |   3.6 |
| COMPLETED Update the conceptual model to clarify backends and kernels       |         |       | 4:20 |  13.2 |
| COMPLETED Detect knitter and disable code generation accordingly            |         |       | 1:15 |   3.8 |
| COMPLETED Clean up kernel and backend confusion                             |         |       | 5:17 |  16.1 |
| COMPLETED Add a "language" directory for each backend                       |         |       | 5:44 |  17.5 |
...
| STARTED Add support for C#                                                  |         |       | 8:15 |  25.2 |
