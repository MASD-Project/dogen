...
#+CAPTION: Clock summary at [2016-12-05 Mon 09:18]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *18:00* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 18:00   |       |      | 100.0 |
| Active                                                                      |         | 18:00 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:51 |  10.3 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 1:02 |   5.7 |
| COMPLETED Update readme                                                     |         |       | 0:11 |   1.0 |
| COMPLETED Test data generation for dates generates invalid dates            |         |       | 0:33 |   3.1 |
| COMPLETED Handle missing stitch templates scenario                          |         |       | 1:04 |   5.9 |
| COMPLETED Move project directory to output options                          |         |       | 1:10 |   6.5 |
| COMPLETED Update the conceptual model to clarify backends and kernels       |         |       | 4:20 |  24.1 |
| STARTED Clean up kernel and backend confusion                               |         |       | 0:54 |   5.0 |
| STARTED Add support for Decimal numbers                                     |         |       | 0:32 |   3.0 |
| STARTED Add support for C#                                                  |         |       | 5:46 |  32.0 |
| STARTED Add a "language" directory for each backend                         |         |       | 0:37 |   3.4 |
