...
#+CAPTION: Clock summary at [2016-12-05 Mon 20:38]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *25:16* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 25:16   |       |      | 100.0 |
| Active                                                                      |         | 25:16 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:51 |   7.3 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 1:02 |   4.1 |
| COMPLETED Update readme                                                     |         |       | 0:11 |   0.7 |
| COMPLETED Test data generation for dates generates invalid dates            |         |       | 0:33 |   2.2 |
| COMPLETED Handle missing stitch templates scenario                          |         |       | 1:04 |   4.2 |
| COMPLETED Move project directory to output options                          |         |       | 1:10 |   4.6 |
| COMPLETED Update the conceptual model to clarify backends and kernels       |         |       | 4:20 |  17.2 |
| COMPLETED Detect knitter and disable code generation accordingly            |         |       | 1:15 |   4.9 |
| COMPLETED Clean up kernel and backend confusion                             |         |       | 5:17 |  20.9 |
| STARTED Add a "language" directory for each backend                         |         |       | 2:15 |   8.9 |
| STARTED Add support for C#                                                  |         |       | 5:46 |  22.8 |
| STARTED Add support for Decimal numbers                                     |         |       | 0:32 |   2.1 |
