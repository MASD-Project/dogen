...
#+CAPTION: Clock summary at [2016-12-02 Fri 12:11]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *11:29* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 11:29   |       |      | 100.0 |
| Active                                                                      |         | 11:29 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:51 |  16.1 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 1:02 |   9.0 |
| COMPLETED Update readme                                                     |         |       | 0:11 |   1.6 |
| COMPLETED Test data generation for dates generates invalid dates            |         |       | 0:33 |   4.8 |
| COMPLETED Handle missing stitch templates scenario                          |         |       | 1:04 |   9.3 |
| COMPLETED Move project directory to output options                          |         |       | 0:59 |   8.6 |
| STARTED Add support for Decimal numbers                                     |         |       | 0:32 |   4.6 |
| STARTED Add support for C#                                                  |         |       | 5:17 |  46.0 |
