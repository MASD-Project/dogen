...
#+CAPTION: Clock summary at [2016-12-11 Sun 17:04]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *66:38* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 66:38   |       |       | 100.0 |
| Active                                                                      |         | 66:38 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  2:48 |   4.2 |
...
| COMPLETED Update the conceptual model to clarify backends and kernels       |         |       |  4:20 |   6.5 |
| COMPLETED Detect knitter and disable code generation accordingly            |         |       |  1:15 |   1.9 |
| COMPLETED Clean up kernel and backend confusion                             |         |       |  5:17 |   7.9 |
| COMPLETED Add a "language" directory for each backend                       |         |       |  5:44 |   8.6 |
...
| COMPLETED Add basic infrastructure for C#                                   |         |       | 17:02 |  25.6 |
| COMPLETED Add support for C#-style documentation                            |         |       |  1:57 |   2.9 |
| COMPLETED Add support for visual studio projects and solutions              |         |       |  6:05 |   9.1 |
| COMPLETED OSX build is borked                                               |         |       |  0:21 |   0.5 |
| COMPLETED Add facet directories to locator                                  |         |       |  1:09 |   1.7 |
| COMPLETED Split json and dia tests                                          |         |       |  0:12 |   0.3 |
| COMPLETED Split the "built-ins" by language                                 |         |       |  0:28 |   0.7 |
| COMPLETED Models should have an associated language                         |         |       |  2:57 |   4.4 |
| COMPLETED Add support for properties in C#                                  |         |       |  2:20 |   3.5 |
...
| COMPLETED Identify floating point types in yarn                             |         |       |  1:25 |   2.1 |
| STARTED Add support for test data generation in C#                          |         |       |  1:03 |   1.6 |
| STARTED Add helper infrastructure to C#                                     |         |       |  0:51 |   1.3 |
| STARTED Add support for Equals in C#                                        |         |       |  2:49 |   4.2 |
