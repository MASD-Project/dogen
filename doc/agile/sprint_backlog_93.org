...
#+CAPTION: Clock summary at [2016-12-06 Tue 16:57]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| COMPLETED Move project directory to output options                          |         |       | 1:10 |   3.7 |
| COMPLETED Update the conceptual model to clarify backends and kernels       |         |       | 4:20 |  13.6 |
| COMPLETED Detect knitter and disable code generation accordingly            |         |       | 1:15 |   3.9 |
| COMPLETED Clean up kernel and backend confusion                             |         |       | 5:17 |  16.6 |
| COMPLETED Add a "language" directory for each backend                       |         |       | 5:44 |  18.0 |
| COMPLETED Split C++ profiles and templates from C#                          |         |       | 1:11 |   3.7 |
| STARTED Add support for C#                                                  |         |       | 7:40 |  24.1 |
...
*** Formatter registrar validation is not being called                :story:
