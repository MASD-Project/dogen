...
#+CAPTION: Clock summary at [2016-12-09 Fri 09:03]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *52:01* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 52:01   |       |       | 100.0 |
| Active                                                                      |         | 52:01 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  2:24 |   4.6 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  1:02 |   2.0 |
...
| COMPLETED Update the conceptual model to clarify backends and kernels       |         |       |  4:20 |   8.3 |
| COMPLETED Detect knitter and disable code generation accordingly            |         |       |  1:15 |   2.4 |
| COMPLETED Clean up kernel and backend confusion                             |         |       |  5:17 |  10.2 |
| COMPLETED Add a "language" directory for each backend                       |         |       |  5:44 |  11.0 |
| COMPLETED Split C++ profiles and templates from C#                          |         |       |  1:11 |   2.3 |
...
| COMPLETED Add basic infrastructure for C#                                   |         |       | 16:59 |  32.6 |
| COMPLETED Add support for C#-style documentation                            |         |       |  1:57 |   3.7 |
| COMPLETED Add support for visual studio projects and solutions              |         |       |  6:05 |  11.7 |
| COMPLETED OSX build is borked                                               |         |       |  0:21 |   0.7 |
| STARTED Add facet directories to locator                                    |         |       |  0:29 |   0.9 |
...
*** STARTED Add facet directories to locator                          :story:
