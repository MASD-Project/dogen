...
#+CAPTION: Clock summary at [2016-12-05 Mon 15:29]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *22:31* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 22:31   |       |      | 100.0 |
| Active                                                                      |         | 22:31 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:51 |   8.2 |
| COMPLETED Edit release notes for previous sprint                            |         |       | 1:02 |   4.6 |
| COMPLETED Update readme                                                     |         |       | 0:11 |   0.8 |
| COMPLETED Test data generation for dates generates invalid dates            |         |       | 0:33 |   2.4 |
| COMPLETED Handle missing stitch templates scenario                          |         |       | 1:04 |   4.7 |
| COMPLETED Move project directory to output options                          |         |       | 1:10 |   5.2 |
| COMPLETED Update the conceptual model to clarify backends and kernels       |         |       | 4:20 |  19.2 |
| COMPLETED Detect knitter and disable code generation accordingly            |         |       | 1:15 |   5.6 |
| STARTED Clean up kernel and backend confusion                               |         |       | 4:10 |  18.5 |
| STARTED Add support for Decimal numbers                                     |         |       | 0:32 |   2.4 |
| STARTED Add support for C#                                                  |         |       | 5:46 |  25.6 |
| STARTED Add a "language" directory for each backend                         |         |       | 0:37 |   2.7 |
