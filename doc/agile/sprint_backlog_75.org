...
#+CAPTION: Clock summary at [2015-12-05 Sat 00:05]
| <75>                                                                        |        |      |      |
| Headline                                                                    | Time   |      |      |
|-----------------------------------------------------------------------------+--------+------+------|
| *Total time*                                                                | *7:56* |      |      |
...
| STARTED Yarn minor tidy-ups                                                 |        |      | 0:57 |
#+end:
...
- assembler, association indexer.

*** STARTED Add support for composite model names in name             :story:
...
*** STARTED Use pdflatex for the manual                               :story:
    CLOCK: [2015-12-05 Sat 16:35]
