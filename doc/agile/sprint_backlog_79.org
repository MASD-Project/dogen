...
#+CAPTION: Clock summary at [2016-01-24 Sun 16:40]
| <75>                                                                        |         |       |      |
| Headline                                                                    | Time    |       |      |
|-----------------------------------------------------------------------------+---------+-------+------|
| *Total time*                                                                | *17:54* |       |      |
...
| Stories                                                                     | 17:54   |       |      |
| Active                                                                      |         | 17:54 |      |
| STARTED Sprint and product backlog grooming                                 |         |       | 2:50 |
...
| COMPLETED How to attach helper methods to types dynamically                 |         |       | 1:10 |
#+end:
...
*** Rename aspect settings to type settings                           :story:

These will no longer be confined to aspects so need to be renamed.

*** Add a field for =cpp.type.family=                                 :story:
...
- determine all of the required values given the existing helper
  methods.
- add the field.
- add a type family property in type settings.
