...
#+CAPTION: Clock summary at [2016-01-24 Sun 23:07]
| <75>                                                                        |         |       |      |
| Headline                                                                    | Time    |       |      |
|-----------------------------------------------------------------------------+---------+-------+------|
| *Total time*                                                                | *19:20* |       |      |
...
| STARTED How to handle composition and pointers                              |         |       | 1:08 |
| STARTED Rename aspect settings to element settings                          |         |       | 0:12 |
#+end:
...
*** STARTED How to handle composition and pointers                    :story:
...
*** STARTED Rename aspect settings to element settings                :story:
...
*** Add a field for =quilt.cpp.family=                                :story:
