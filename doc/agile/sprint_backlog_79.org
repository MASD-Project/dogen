...
#+CAPTION: Clock summary at [2016-01-19 Tue 23:28]
| <75>                                                                        |        |      |      |
| Headline                                                                    | Time   |      |      |
|-----------------------------------------------------------------------------+--------+------+------|
| *Total time*                                                                | *3:09* |      |      |
...
| STARTED Generate exceptions using yarn types                                |        |      | 0:16 |
...
*** ODB options file is generated even when disabled                  :story:
...
*** Name builder should take only model name                          :story:
