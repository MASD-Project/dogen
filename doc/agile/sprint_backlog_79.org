...
#+CAPTION: Clock summary at [2016-01-21 Thu 22:56]
| <75>                                                                        |        |      |      |
| Headline                                                                    | Time   |      |      |
|-----------------------------------------------------------------------------+--------+------+------|
| *Total time*                                                                | *8:39* |      |      |
...
| STARTED Use dots to separate namespaces in binary names                     |        |      | 1:33 |
| STARTED Generate enumerations using yarn types                              |        |      | 0:13 |
...
*** STARTED Use dots to separate namespaces in binary names           :story:
...
*** STARTED Generate enumerations using yarn types                    :story:
