...
Clock summary at [2014-02-05 Wed 08:42]

| Headline                                                                          | Time   |      |      |
|-----------------------------------------------------------------------------------+--------+------+------|
| *Total time*                                                                      | *1:56* |      |      |
|-----------------------------------------------------------------------------------+--------+------+------|
| Development Stories Implemented                                                   |        | 1:56 |      |
| COMPLETED Create a road map for the work ahead                                    |        |      | 0:31 |
| IMPLEMENTATION Release notes and backlog grooming                                 |        |      | 0:47 |
...
*** Add concept properties to entity                                  :story:
