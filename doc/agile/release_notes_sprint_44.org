...
Clock summary at [2014-02-07 Fri 08:46]

| Headline                                                         | Time   |      |      |
|------------------------------------------------------------------+--------+------+------|
| *Total time*                                                     | *6:41* |      |      |
|------------------------------------------------------------------+--------+------+------|
| Development Stories Implemented                                  |        | 6:41 |      |
| IMPLEMENTATION Release notes and backlog grooming                |        |      | 1:49 |
| COMPLETED Create a road map for the work ahead                   |        |      | 0:31 |
| COMPLETED Add common properties to C++ entity                    |        |      | 1:23 |
| IMPLEMENTATION When on clang 3.4 enable code coverage flags      |        |      | 0:53 |
| IMPLEMENTATION Design and implement the formatter model workflow |        |      | 2:05 |
#+end:
...
**** Implement the workflow and add tests                              :task:
...
*** Add all data required by types formatter constructor to C++ entity :story:
