...
Clock summary at [2014-11-12 Wed 23:21]

| Headline                                                               | Time    |       |      |
|------------------------------------------------------------------------+---------+-------+------|
| *Total time*                                                           | *19:34* |       |      |
|------------------------------------------------------------------------+---------+-------+------|
| Development Stories Implemented                                        |         | 19:34 |      |
| IMPLEMENTATION Sprint and product backlog grooming                     |         |       | 0:31 |
...
| IMPLEMENTATION Implement include builder for class header              |         |       | 1:11 |
| IMPLEMENTATION Implement the path spec workflow and associated classes |         |       | 3:28 |
...
*** IMPLEMENTATION Implement the path spec workflow and associated classes :task:
...
- move formatter facade to formatters and call it entity
  formatter. could also be the =formatters::workflow= as a
  sub-workflow.
- find a way to create the bundles upfront and pass them to the entity
  formatter as well as path spec details builder.
