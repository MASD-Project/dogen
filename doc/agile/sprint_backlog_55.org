...
Clock summary at [2014-11-10 Mon 08:41]

| Headline                                                                    | Time    |       |      |
|-----------------------------------------------------------------------------+---------+-------+------|
| *Total time*                                                                | *13:57* |       |      |
|-----------------------------------------------------------------------------+---------+-------+------|
| Development Stories Implemented                                             |         | 13:57 |      |
...
| IMPLEMENTATION Implement the new file name method in class header formatter |         |       | 0:11 |
...
*** IMPLEMENTATION Implement the new file name method in class header formatter :task:
