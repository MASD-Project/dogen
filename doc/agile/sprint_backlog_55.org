...
Clock summary at [2014-11-10 Mon 18:43]

| Headline                                                               | Time    |       |      |
|------------------------------------------------------------------------+---------+-------+------|
| *Total time*                                                           | *14:48* |       |      |
|------------------------------------------------------------------------+---------+-------+------|
| Development Stories Implemented                                        |         | 14:48 |      |
...
| IMPLEMENTATION Create a base interface for all formatters              |         |       | 0:26 |
...
*** IMPLEMENTATION Create a base interface for all formatters :task:refactor:
