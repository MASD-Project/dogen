...
Clock summary at [2013-11-14 Thu 09:10]

| Headline                                                              | Time    |       |       |
|-----------------------------------------------------------------------+---------+-------+-------|
| *Total time*                                                          | *15:29* |       |       |
|-----------------------------------------------------------------------+---------+-------+-------|
| Development Stories Implemented                                       |         | 15:29 |       |
...
| IMPLEMENTATION Create an indexer class and plug it to SML workflow    |         |       |  2:16 |
#+end:
...
*** IMPLEMENTATION Remove new lines from output of property tree      :spike:
