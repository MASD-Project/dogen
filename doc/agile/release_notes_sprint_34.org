...
Clock summary at [2013-09-09 Mon 21:58]

| Headline                                                               | Time   |      |      |
|------------------------------------------------------------------------+--------+------+------|
| *Total time*                                                           | *0:41* |      |      |
|------------------------------------------------------------------------+--------+------+------|
| Development Stories Implemented                                        |        | 0:41 |      |
| IMPLEMENTATION Release notes and backlog grooming                      |        |      | 0:04 |
| IMPLEMENTATION Implement hydration manager in terms of other hydrators |        |      | 0:37 |
#+end:

*** IMPLEMENTATION Release notes and backlog grooming                  :task:
    CLOCK: [2013-09-09 Mon 08:10]--[2013-09-09 Mon 08:14] =>  0:04

*** IMPLEMENTATION Implement hydration manager in terms of other hydrators :story:
