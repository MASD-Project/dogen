...
#+CAPTION: Clock summary at [2016-10-13 Thu 20:28]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| COMPLETED Refactor opaque infrastructure                                    |         |       |  1:17 |   4.1 |
| COMPLETED Remove any remnants of annotations from quilt                     |         |       |  0:05 |   0.3 |
| COMPLETED Solve the issue of too many "configurations"                      |         |       |  4:01 |  12.9 |
...
| COMPLETED Clean up terminology in dynamic                                   |         |       | 15:12 |  48.9 |
| COMPLETED Minor tidy-up of the quilt.cpp diagram                            |         |       |  0:29 |   1.6 |
| COMPLETED Create a ownership hierarchy repository                           |         |       |  1:43 |   5.5 |
| COMPLETED Use vector of elements in model                                   |         |       |  0:10 |   0.5 |
| STARTED Rewrite profile support                                             |         |       |  5:31 |  17.8 |
