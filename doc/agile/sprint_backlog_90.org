...
#+CAPTION: Clock summary at [2016-10-13 Thu 23:24]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:19 |   0.9 |
| COMPLETED Improve bintray support                                           |         |       |  0:26 |   1.3 |
| COMPLETED Refactor opaque infrastructure                                    |         |       |  1:17 |   3.8 |
| COMPLETED Remove any remnants of annotations from quilt                     |         |       |  0:05 |   0.2 |
| COMPLETED Solve the issue of too many "configurations"                      |         |       |  4:01 |  11.8 |
| COMPLETED Merge decoration configuration and annotations factories          |         |       |  0:18 |   0.9 |
| COMPLETED Move annotation factories into expander in yarn                   |         |       |  1:11 |   3.5 |
| COMPLETED Clean up terminology in dynamic                                   |         |       | 15:12 |  44.8 |
| COMPLETED Minor tidy-up of the quilt.cpp diagram                            |         |       |  0:29 |   1.4 |
| COMPLETED Create a ownership hierarchy repository                           |         |       |  1:43 |   5.1 |
| COMPLETED Use vector of elements in model                                   |         |       |  0:10 |   0.5 |
| STARTED Rewrite profile support                                             |         |       |  8:24 |  24.7 |
