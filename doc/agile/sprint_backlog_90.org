...
#+CAPTION: Clock summary at [2016-10-17 Mon 22:53]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *67:06* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 67:06   |       |       | 100.0 |
| Active                                                                      |         | 67:06 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:32 |   0.8 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:19 |   0.5 |
| COMPLETED Improve bintray support                                           |         |       |  0:26 |   0.6 |
| COMPLETED Refactor opaque infrastructure                                    |         |       |  1:17 |   1.9 |
| COMPLETED Remove any remnants of annotations from quilt                     |         |       |  0:05 |   0.1 |
| COMPLETED Solve the issue of too many "configurations"                      |         |       |  4:01 |   6.0 |
| COMPLETED Merge decoration configuration and annotations factories          |         |       |  0:18 |   0.4 |
| COMPLETED Move annotation factories into expander in yarn                   |         |       |  1:11 |   1.8 |
| COMPLETED Clean up terminology in dynamic                                   |         |       | 15:12 |  22.7 |
| COMPLETED Minor tidy-up of the quilt.cpp diagram                            |         |       |  0:29 |   0.7 |
| COMPLETED Create a ownership hierarchy repository                           |         |       |  1:43 |   2.6 |
| COMPLETED Use vector of elements in model                                   |         |       |  0:10 |   0.2 |
| COMPLETED Rewrite profile support                                           |         |       | 11:50 |  17.6 |
| COMPLETED Merge annotation type and profile folders                         |         |       |  0:20 |   0.5 |
| COMPLETED Push stereotypes processing into yarn                             |         |       |  1:51 |   2.8 |
| COMPLETED Implement defaulting within the profiler                          |         |       |  1:13 |   1.8 |
| COMPLETED Add binding of stereotypes with profiles                          |         |       |  1:40 |   2.5 |
| COMPLETED Update dogen models to use profiles                               |         |       |  0:19 |   0.5 |
| COMPLETED Finish overwriting support                                        |         |       |  2:38 |   3.9 |
| COMPLETED Remove service stereotype                                         |         |       |  3:32 |   5.3 |
| COMPLETED IOable services                                                   |         |       |  0:06 |   0.1 |
| COMPLETED Generate skeleton for "non-generatable" files                     |         |       |  0:51 |   1.3 |
| COMPLETED Merge profiles with processed object in yarn.dia                  |         |       |  2:04 |   3.1 |
| COMPLETED Fix yarn.dia tests                                                |         |       |  2:48 |   4.2 |
| COMPLETED Perform the archetype / artefact renames                          |         |       | 11:44 |  17.5 |
| STARTED Integration of stitch and dogen                                     |         |       |  0:27 |   0.7 |
