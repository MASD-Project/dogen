...
#+CAPTION: Clock summary at [2016-10-18 Tue 16:08]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *67:34* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 67:34   |       |       | 100.0 |
| Active                                                                      |         | 67:34 |       | 100.0 |
...
| COMPLETED Solve the issue of too many "configurations"                      |         |       |  4:01 |   5.9 |
...
| COMPLETED Clean up terminology in dynamic                                   |         |       | 15:12 |  22.5 |
| COMPLETED Minor tidy-up of the quilt.cpp diagram                            |         |       |  0:29 |   0.7 |
| COMPLETED Create a ownership hierarchy repository                           |         |       |  1:43 |   2.5 |
| COMPLETED Use vector of elements in model                                   |         |       |  0:10 |   0.2 |
| COMPLETED Rewrite profile support                                           |         |       | 11:50 |  17.5 |
| COMPLETED Merge annotation type and profile folders                         |         |       |  0:20 |   0.5 |
| COMPLETED Push stereotypes processing into yarn                             |         |       |  1:51 |   2.7 |
...
| COMPLETED Remove service stereotype                                         |         |       |  3:32 |   5.2 |
...
| COMPLETED Fix yarn.dia tests                                                |         |       |  2:48 |   4.1 |
| COMPLETED Perform the archetype / artefact renames                          |         |       | 12:12 |  18.1 |
