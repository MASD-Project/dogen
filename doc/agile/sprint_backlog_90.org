...
#+CAPTION: Clock summary at [2016-10-15 Sat 00:15]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
...
| COMPLETED Refactor opaque infrastructure                                    |         |       |  1:17 |   3.0 |
| COMPLETED Remove any remnants of annotations from quilt                     |         |       |  0:05 |   0.2 |
| COMPLETED Solve the issue of too many "configurations"                      |         |       |  4:01 |   9.2 |
...
| COMPLETED Clean up terminology in dynamic                                   |         |       | 15:12 |  35.0 |
| COMPLETED Minor tidy-up of the quilt.cpp diagram                            |         |       |  0:29 |   1.1 |
| COMPLETED Create a ownership hierarchy repository                           |         |       |  1:43 |   4.0 |
| COMPLETED Use vector of elements in model                                   |         |       |  0:10 |   0.4 |
| COMPLETED Rewrite profile support                                           |         |       | 11:50 |  27.2 |
| COMPLETED Merge annotation type and profile folders                         |         |       |  0:20 |   0.8 |
| COMPLETED Push stereotypes processing into yarn                             |         |       |  1:51 |   4.3 |
| COMPLETED Implement defaulting within the profiler                          |         |       |  1:13 |   2.8 |
| COMPLETED Add binding of stereotypes with profiles                          |         |       |  1:40 |   3.8 |
| COMPLETED Update dogen models to use profiles                               |         |       |  0:19 |   0.7 |
| STARTED Finish overwriting support                                          |         |       |  0:39 |   1.5 |
