...
#+CAPTION: Clock summary at [2016-10-16 Sun 23:31]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *57:31* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 57:31   |       |       | 100.0 |
| Active                                                                      |         | 57:31 |       | 100.0 |
...
| COMPLETED Refactor opaque infrastructure                                    |         |       |  1:17 |   2.2 |
| COMPLETED Remove any remnants of annotations from quilt                     |         |       |  0:05 |   0.1 |
| COMPLETED Solve the issue of too many "configurations"                      |         |       |  4:01 |   7.0 |
...
| COMPLETED Clean up terminology in dynamic                                   |         |       | 15:12 |  26.4 |
| COMPLETED Minor tidy-up of the quilt.cpp diagram                            |         |       |  0:29 |   0.8 |
| COMPLETED Create a ownership hierarchy repository                           |         |       |  1:43 |   3.0 |
| COMPLETED Use vector of elements in model                                   |         |       |  0:10 |   0.3 |
| COMPLETED Rewrite profile support                                           |         |       | 11:50 |  20.6 |
| COMPLETED Merge annotation type and profile folders                         |         |       |  0:20 |   0.6 |
| COMPLETED Push stereotypes processing into yarn                             |         |       |  1:51 |   3.2 |
| COMPLETED Implement defaulting within the profiler                          |         |       |  1:13 |   2.1 |
| COMPLETED Add binding of stereotypes with profiles                          |         |       |  1:40 |   2.9 |
| COMPLETED Update dogen models to use profiles                               |         |       |  0:19 |   0.6 |
| COMPLETED Finish overwriting support                                        |         |       |  2:38 |   4.6 |
| COMPLETED Remove service stereotype                                         |         |       |  3:32 |   6.1 |
| COMPLETED IOable services                                                   |         |       |  0:06 |   0.2 |
| COMPLETED Generate skeleton for "non-generatable" files                     |         |       |  0:51 |   1.5 |
| COMPLETED Merge profiles with processed object in yarn.dia                  |         |       |  2:04 |   3.6 |
| COMPLETED Fix yarn.dia tests                                                |         |       |  2:48 |   4.9 |
| STARTED Perform the archetype / artefact renames                            |         |       |  2:09 |   3.7 |
