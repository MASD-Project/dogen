...
#+CAPTION: Clock summary at [2016-10-16 Sun 00:51]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *52:15* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 52:15   |       |       | 100.0 |
| Active                                                                      |         | 52:15 |       | 100.0 |
...
| COMPLETED Solve the issue of too many "configurations"                      |         |       |  4:01 |   7.7 |
...
| COMPLETED Clean up terminology in dynamic                                   |         |       | 15:12 |  29.1 |
| COMPLETED Minor tidy-up of the quilt.cpp diagram                            |         |       |  0:29 |   0.9 |
| COMPLETED Create a ownership hierarchy repository                           |         |       |  1:43 |   3.3 |
| COMPLETED Use vector of elements in model                                   |         |       |  0:10 |   0.3 |
| COMPLETED Rewrite profile support                                           |         |       | 11:50 |  22.6 |
| COMPLETED Merge annotation type and profile folders                         |         |       |  0:20 |   0.6 |
| COMPLETED Push stereotypes processing into yarn                             |         |       |  1:51 |   3.5 |
| COMPLETED Implement defaulting within the profiler                          |         |       |  1:13 |   2.3 |
| COMPLETED Add binding of stereotypes with profiles                          |         |       |  1:40 |   3.2 |
| COMPLETED Update dogen models to use profiles                               |         |       |  0:19 |   0.6 |
| COMPLETED Finish overwriting support                                        |         |       |  2:38 |   5.0 |
| COMPLETED Remove service stereotype                                         |         |       |  3:32 |   6.8 |
| COMPLETED IOable services                                                   |         |       |  0:06 |   0.2 |
| COMPLETED Generate skeleton for "non-generatable" files                     |         |       |  0:51 |   1.6 |
| COMPLETED Merge profiles with processed object in yarn.dia                  |         |       |  2:04 |   4.0 |
| STARTED Fix yarn.dia tests                                                  |         |       |  0:11 |   0.4 |
...
*** STARTED Fix yarn.dia tests                                        :story:
