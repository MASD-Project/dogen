...
#+CAPTION: Clock summary at [2016-10-15 Sat 19:30]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *47:19* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 47:19   |       |       | 100.0 |
| Active                                                                      |         | 47:19 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  0:24 |   0.8 |
| COMPLETED Edit release notes for previous sprint                            |         |       |  0:19 |   0.7 |
| COMPLETED Improve bintray support                                           |         |       |  0:26 |   0.9 |
| COMPLETED Refactor opaque infrastructure                                    |         |       |  1:17 |   2.7 |
| COMPLETED Remove any remnants of annotations from quilt                     |         |       |  0:05 |   0.2 |
| COMPLETED Solve the issue of too many "configurations"                      |         |       |  4:01 |   8.5 |
| COMPLETED Merge decoration configuration and annotations factories          |         |       |  0:18 |   0.6 |
| COMPLETED Move annotation factories into expander in yarn                   |         |       |  1:11 |   2.5 |
| COMPLETED Clean up terminology in dynamic                                   |         |       | 15:12 |  32.1 |
| COMPLETED Minor tidy-up of the quilt.cpp diagram                            |         |       |  0:29 |   1.0 |
| COMPLETED Create a ownership hierarchy repository                           |         |       |  1:43 |   3.6 |
| COMPLETED Use vector of elements in model                                   |         |       |  0:10 |   0.4 |
| COMPLETED Rewrite profile support                                           |         |       | 11:50 |  25.0 |
| COMPLETED Merge annotation type and profile folders                         |         |       |  0:20 |   0.7 |
| COMPLETED Push stereotypes processing into yarn                             |         |       |  1:51 |   3.9 |
| COMPLETED Implement defaulting within the profiler                          |         |       |  1:13 |   2.6 |
| COMPLETED Add binding of stereotypes with profiles                          |         |       |  1:40 |   3.5 |
| COMPLETED Update dogen models to use profiles                               |         |       |  0:19 |   0.7 |
| COMPLETED Finish overwriting support                                        |         |       |  2:38 |   5.6 |
| STARTED Remove service stereotype                                           |         |       |  1:53 |   4.0 |
...
*** Remove force write feature                                        :story:

We never force write and now the logic is a bit at odds with the
overwriting logic.
...
*** Generate skeleton for "non-generatable" files                     :story:
