...
#+CAPTION: Clock summary at [2016-10-14 Fri 14:41]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *38:43* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 38:43   |       |       | 100.0 |
| Active                                                                      |         | 38:43 |       | 100.0 |
...
| COMPLETED Refactor opaque infrastructure                                    |         |       |  1:17 |   3.3 |
| COMPLETED Remove any remnants of annotations from quilt                     |         |       |  0:05 |   0.2 |
| COMPLETED Solve the issue of too many "configurations"                      |         |       |  4:01 |  10.4 |
| COMPLETED Merge decoration configuration and annotations factories          |         |       |  0:18 |   0.8 |
| COMPLETED Move annotation factories into expander in yarn                   |         |       |  1:11 |   3.1 |
| COMPLETED Clean up terminology in dynamic                                   |         |       | 15:12 |  39.3 |
| COMPLETED Minor tidy-up of the quilt.cpp diagram                            |         |       |  0:29 |   1.2 |
| COMPLETED Create a ownership hierarchy repository                           |         |       |  1:43 |   4.4 |
| COMPLETED Use vector of elements in model                                   |         |       |  0:10 |   0.4 |
| COMPLETED Rewrite profile support                                           |         |       | 11:50 |  30.6 |
| COMPLETED Merge annotation type and profile folders                         |         |       |  0:20 |   0.9 |
| STARTED Push stereotypes processing into yarn                               |         |       |  0:40 |   1.7 |
| STARTED Implement defaulting within the profiler                            |         |       |  0:14 |   0.6 |
| STARTED Finish overwriting support                                          |         |       |  0:06 |   0.3 |
...
*** STARTED Push stereotypes processing into yarn                     :story:
...
*** STARTED Implement defaulting within the profiler                  :story:
