...
#+CAPTION: Clock summary at [2016-10-19 Wed 22:49]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *71:12* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 71:12   |       |       | 100.0 |
| Active                                                                      |         | 71:12 |       | 100.0 |
...
| COMPLETED Refactor opaque infrastructure                                    |         |       |  1:17 |   1.8 |
| COMPLETED Remove any remnants of annotations from quilt                     |         |       |  0:05 |   0.1 |
| COMPLETED Solve the issue of too many "configurations"                      |         |       |  4:01 |   5.6 |
| COMPLETED Merge decoration configuration and annotations factories          |         |       |  0:18 |   0.4 |
| COMPLETED Move annotation factories into expander in yarn                   |         |       |  1:11 |   1.7 |
| COMPLETED Clean up terminology in dynamic                                   |         |       | 15:12 |  21.3 |
| COMPLETED Minor tidy-up of the quilt.cpp diagram                            |         |       |  0:29 |   0.7 |
| COMPLETED Create a ownership hierarchy repository                           |         |       |  1:43 |   2.4 |
| COMPLETED Use vector of elements in model                                   |         |       |  0:10 |   0.2 |
| COMPLETED Rewrite profile support                                           |         |       | 11:50 |  16.6 |
| COMPLETED Merge annotation type and profile folders                         |         |       |  0:20 |   0.5 |
| COMPLETED Push stereotypes processing into yarn                             |         |       |  1:51 |   2.6 |
| COMPLETED Implement defaulting within the profiler                          |         |       |  1:13 |   1.7 |
| COMPLETED Add binding of stereotypes with profiles                          |         |       |  1:40 |   2.3 |
| COMPLETED Update dogen models to use profiles                               |         |       |  0:19 |   0.4 |
| COMPLETED Finish overwriting support                                        |         |       |  2:38 |   3.7 |
| COMPLETED Remove service stereotype                                         |         |       |  3:32 |   5.0 |
| COMPLETED IOable services                                                   |         |       |  0:06 |   0.1 |
| COMPLETED Generate skeleton for "non-generatable" files                     |         |       |  0:51 |   1.2 |
| COMPLETED Merge profiles with processed object in yarn.dia                  |         |       |  2:04 |   2.9 |
| COMPLETED Fix yarn.dia tests                                                |         |       |  2:48 |   3.9 |
| COMPLETED Perform the archetype / artefact renames                          |         |       | 12:12 |  17.1 |
| STARTED Integration of stitch and dogen                                     |         |       |  0:27 |   0.6 |
| STARTED Document the conceptual model                                       |         |       |  3:38 |   5.1 |
