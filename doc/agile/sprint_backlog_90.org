...
#+CAPTION: Clock summary at [2016-10-15 Sat 21:24]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *48:58* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 48:58   |       |       | 100.0 |
| Active                                                                      |         | 48:58 |       | 100.0 |
...
| COMPLETED Solve the issue of too many "configurations"                      |         |       |  4:01 |   8.2 |
...
| COMPLETED Clean up terminology in dynamic                                   |         |       | 15:12 |  31.0 |
| COMPLETED Minor tidy-up of the quilt.cpp diagram                            |         |       |  0:29 |   1.0 |
| COMPLETED Create a ownership hierarchy repository                           |         |       |  1:43 |   3.5 |
| COMPLETED Use vector of elements in model                                   |         |       |  0:10 |   0.3 |
| COMPLETED Rewrite profile support                                           |         |       | 11:50 |  24.2 |
| COMPLETED Merge annotation type and profile folders                         |         |       |  0:20 |   0.7 |
| COMPLETED Push stereotypes processing into yarn                             |         |       |  1:51 |   3.8 |
| COMPLETED Implement defaulting within the profiler                          |         |       |  1:13 |   2.5 |
| COMPLETED Add binding of stereotypes with profiles                          |         |       |  1:40 |   3.4 |
| COMPLETED Update dogen models to use profiles                               |         |       |  0:19 |   0.6 |
| COMPLETED Finish overwriting support                                        |         |       |  2:38 |   5.4 |
| COMPLETED Remove service stereotype                                         |         |       |  3:32 |   7.2 |
