...
#+CAPTION: Clock summary at [2016-10-17 Mon 20:17]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *64:33* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 64:33   |       |       | 100.0 |
| Active                                                                      |         | 64:33 |       | 100.0 |
...
| COMPLETED Refactor opaque infrastructure                                    |         |       |  1:17 |   2.0 |
| COMPLETED Remove any remnants of annotations from quilt                     |         |       |  0:05 |   0.1 |
| COMPLETED Solve the issue of too many "configurations"                      |         |       |  4:01 |   6.2 |
...
| COMPLETED Clean up terminology in dynamic                                   |         |       | 15:12 |  23.5 |
| COMPLETED Minor tidy-up of the quilt.cpp diagram                            |         |       |  0:29 |   0.7 |
| COMPLETED Create a ownership hierarchy repository                           |         |       |  1:43 |   2.7 |
| COMPLETED Use vector of elements in model                                   |         |       |  0:10 |   0.3 |
| COMPLETED Rewrite profile support                                           |         |       | 11:50 |  18.3 |
| COMPLETED Merge annotation type and profile folders                         |         |       |  0:20 |   0.5 |
| COMPLETED Push stereotypes processing into yarn                             |         |       |  1:51 |   2.9 |
| COMPLETED Implement defaulting within the profiler                          |         |       |  1:13 |   1.9 |
| COMPLETED Add binding of stereotypes with profiles                          |         |       |  1:40 |   2.6 |
| COMPLETED Update dogen models to use profiles                               |         |       |  0:19 |   0.5 |
| COMPLETED Finish overwriting support                                        |         |       |  2:38 |   4.1 |
| COMPLETED Remove service stereotype                                         |         |       |  3:32 |   5.5 |
| COMPLETED IOable services                                                   |         |       |  0:06 |   0.2 |
| COMPLETED Generate skeleton for "non-generatable" files                     |         |       |  0:51 |   1.3 |
| COMPLETED Merge profiles with processed object in yarn.dia                  |         |       |  2:04 |   3.2 |
| COMPLETED Fix yarn.dia tests                                                |         |       |  2:48 |   4.3 |
| COMPLETED Perform the archetype / artefact renames                          |         |       |  9:11 |  14.2 |
