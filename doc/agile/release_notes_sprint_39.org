...
Clock summary at [2013-11-21 Thu 18:53]
...
| IMPLEMENTATION Finish indexer class and plug it to SML workflow |        |      | 6:32 |
#+end:
...
This is actually pretty complicated. Some things to make our life
easier:

- add =is_parent= and =is_child= to concepts to make recursion easier
- consider splitting concept processing from inheritance
  processing. this may not make sense because the structure of the
  processing is probably identical, but we need a thought experiment.
