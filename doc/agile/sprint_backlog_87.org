...
#+CAPTION: Clock summary at [2016-09-10 Sat 16:05]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *50:50* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 50:50   |       |      | 100.0 |
| Active                                                                      |         | 50:50 |      | 100.0 |
...
| COMPLETED Yarn naming tidy-up                                               |         |       | 4:19 |   8.5 |
| COMPLETED Generalisation tidy-up                                            |         |       | 5:07 |  10.1 |
...
| COMPLETED Consider adding support for inheritance via meta-data             |         |       | 4:55 |   9.7 |
| CANCELLED Pick-up Boost 1.61 from Debian Testing                            |         |       | 1:23 |   2.7 |
| COMPLETED Allow cross model inheritance                                     |         |       | 1:09 |   2.3 |
| COMPLETED Add support for visitor inheritance                               |         |       | 7:27 |  14.7 |
...
| COMPLETED Implement includers in fabric                                     |         |       | 6:10 |  12.1 |
| COMPLETED Quilt's formatter names are incorrect                             |         |       | 0:41 |   1.3 |
| COMPLETED Implement registrar in fabric                                     |         |       | 3:27 |   6.8 |
| STARTED Move injection to intermediate model                                |         |       | 0:29 |   1.0 |
...
*** STARTED Move injection to intermediate model                      :story:
