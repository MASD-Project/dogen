...
#+CAPTION: Clock summary at [2016-09-07 Wed 21:01]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *32:05* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 32:05   |       |      | 100.0 |
| Active                                                                      |         | 32:05 |      | 100.0 |
...
| COMPLETED Move file instantiation code into yarn                            |         |       | 2:22 |   7.4 |
| COMPLETED Yarn naming tidy-up                                               |         |       | 4:19 |  13.5 |
| COMPLETED Generalisation tidy-up                                            |         |       | 5:07 |  15.9 |
| COMPLETED Create an indexer for resolution data                             |         |       | 1:38 |   5.1 |
| COMPLETED First chat with IS about current state of dogen                   |         |       | 1:57 |   6.1 |
| COMPLETED Extend name builder with required functionality                   |         |       | 1:28 |   4.6 |
| COMPLETED Consider adding support for inheritance via meta-data             |         |       | 4:55 |  15.3 |
| CANCELLED Pick-up Boost 1.61 from Debian Testing                            |         |       | 1:23 |   4.3 |
| COMPLETED Allow cross model inheritance                                     |         |       | 1:09 |   3.6 |
| STARTED Add support for visitor inheritance                                 |         |       | 5:37 |  17.5 |
