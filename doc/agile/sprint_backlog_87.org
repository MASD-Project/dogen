...
#+CAPTION: Clock summary at [2016-09-06 Tue 22:28]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *27:21* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 27:21   |       |      | 100.0 |
| Active                                                                      |         | 27:21 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:52 |   3.2 |
| COMPLETED Move readme to markdown                                           |         |       | 0:49 |   3.0 |
| COMPLETED Use =element= base class in  =update_element=                     |         |       | 0:29 |   1.8 |
| COMPLETED Move file instantiation code into yarn                            |         |       | 2:22 |   8.7 |
| COMPLETED Yarn naming tidy-up                                               |         |       | 4:19 |  15.8 |
| COMPLETED Generalisation tidy-up                                            |         |       | 5:07 |  18.7 |
| COMPLETED Create an indexer for resolution data                             |         |       | 1:38 |   6.0 |
| COMPLETED First chat with IS about current state of dogen                   |         |       | 1:57 |   7.1 |
| COMPLETED Extend name builder with required functionality                   |         |       | 1:28 |   5.4 |
| COMPLETED Consider adding support for inheritance via meta-data             |         |       | 4:55 |  18.0 |
| CANCELLED Pick-up Boost 1.61 from Debian Testing                            |         |       | 1:23 |   5.1 |
| COMPLETED Allow cross model inheritance                                     |         |       | 1:09 |   4.2 |
| STARTED Add support for visitor inheritance                                 |         |       | 0:53 |   3.2 |
