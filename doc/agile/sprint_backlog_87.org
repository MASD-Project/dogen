...
#+CAPTION: Clock summary at [2016-09-09 Fri 08:49]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *41:17* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 41:17   |       |      | 100.0 |
| Active                                                                      |         | 41:17 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:57 |   2.3 |
| COMPLETED Move readme to markdown                                           |         |       | 0:49 |   2.0 |
| COMPLETED Use =element= base class in  =update_element=                     |         |       | 0:29 |   1.2 |
| COMPLETED Move file instantiation code into yarn                            |         |       | 2:22 |   5.7 |
| COMPLETED Yarn naming tidy-up                                               |         |       | 4:19 |  10.5 |
| COMPLETED Generalisation tidy-up                                            |         |       | 5:07 |  12.4 |
| COMPLETED Create an indexer for resolution data                             |         |       | 1:38 |   4.0 |
| COMPLETED First chat with IS about current state of dogen                   |         |       | 1:57 |   4.7 |
| COMPLETED Extend name builder with required functionality                   |         |       | 1:28 |   3.6 |
| COMPLETED Consider adding support for inheritance via meta-data             |         |       | 4:55 |  11.9 |
| CANCELLED Pick-up Boost 1.61 from Debian Testing                            |         |       | 1:23 |   3.4 |
| COMPLETED Allow cross model inheritance                                     |         |       | 1:09 |   2.8 |
| COMPLETED Add support for visitor inheritance                               |         |       | 7:27 |  18.0 |
| COMPLETED Move visitor =accept= methods to cpp file                         |         |       | 0:41 |   1.7 |
| COMPLETED Analysis work on implementing remaining yarn types                |         |       | 0:52 |   2.1 |
| COMPLETED Split injector into separate classes                              |         |       | 0:56 |   2.3 |
| COMPLETED Add injector interface and registrar                              |         |       | 1:02 |   2.5 |
| COMPLETED Analysis: supporting multiple elements for one id                 |         |       | 1:12 |   2.9 |
| COMPLETED Add language-specific element injection                           |         |       | 0:41 |   1.7 |
| STARTED Implement includers in fabric                                       |         |       | 1:53 |   4.6 |
