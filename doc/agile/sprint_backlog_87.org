...
#+CAPTION: Clock summary at [2016-09-10 Sat 00:14]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| COMPLETED Move file instantiation code into yarn                            |         |       | 2:22 |   4.9 |
| COMPLETED Yarn naming tidy-up                                               |         |       | 4:19 |   8.9 |
| COMPLETED Generalisation tidy-up                                            |         |       | 5:07 |  10.6 |
| COMPLETED Create an indexer for resolution data                             |         |       | 1:38 |   3.4 |
...
| COMPLETED Consider adding support for inheritance via meta-data             |         |       | 4:55 |  10.2 |
| CANCELLED Pick-up Boost 1.61 from Debian Testing                            |         |       | 1:23 |   2.9 |
| COMPLETED Allow cross model inheritance                                     |         |       | 1:09 |   2.4 |
| COMPLETED Add support for visitor inheritance                               |         |       | 7:27 |  15.4 |
...
| COMPLETED Implement includers in fabric                                     |         |       | 6:10 |  12.8 |
| COMPLETED Quilt's formatter names are incorrect                             |         |       | 0:41 |   1.4 |
| STARTED Implement registrar in fabric                                       |         |       | 2:00 |   4.1 |
