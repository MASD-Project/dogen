...
#+CAPTION: Clock summary at [2016-09-11 Sun 14:34]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *57:47* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 57:47   |       |      | 100.0 |
| Active                                                                      |         | 57:47 |      | 100.0 |
...
| COMPLETED Consider adding support for inheritance via meta-data             |         |       | 4:55 |   8.5 |
| CANCELLED Pick-up Boost 1.61 from Debian Testing                            |         |       | 1:23 |   2.4 |
| COMPLETED Allow cross model inheritance                                     |         |       | 1:09 |   2.0 |
| COMPLETED Add support for visitor inheritance                               |         |       | 7:27 |  12.9 |
...
| COMPLETED Introduce the notion of composite elements                        |         |       | 0:54 |   1.6 |
