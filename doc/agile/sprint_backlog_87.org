...
#+CAPTION: Clock summary at [2016-09-05 Mon 21:46]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 19:31   |       |      | 100.0 |
| Active                                                                      |         | 19:31 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:19 |   1.6 |
| COMPLETED Move readme to markdown                                           |         |       | 0:49 |   4.2 |
| COMPLETED Use =element= base class in  =update_element=                     |         |       | 0:29 |   2.5 |
| COMPLETED Move file instantiation code into yarn                            |         |       | 2:22 |  12.1 |
| COMPLETED Yarn naming tidy-up                                               |         |       | 4:19 |  22.1 |
| COMPLETED Generalisation tidy-up                                            |         |       | 5:07 |  26.2 |
| COMPLETED Create an indexer for resolution data                             |         |       | 1:38 |   8.4 |
| COMPLETED First chat with IS about current state of dogen                   |         |       | 1:57 |  10.0 |
| STARTED Create a name parser                                                |         |       | 1:09 |   5.9 |
| STARTED Consider adding support for inheritance via meta-data               |         |       | 1:22 |   7.0 |
