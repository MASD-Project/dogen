...
#+CAPTION: Clock summary at [2016-09-04 Sun 08:59]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| COMPLETED Use =element= base class in  =update_element=                     |         |       | 0:29 |   3.2 |
| COMPLETED Move file instantiation code into yarn                            |         |       | 2:22 |  15.5 |
| COMPLETED Yarn naming tidy-up                                               |         |       | 4:19 |  28.2 |
| COMPLETED Generalisation tidy-up                                            |         |       | 5:07 |  33.4 |
| STARTED Create an indexer for resolution data                               |         |       | 0:32 |   3.5 |
