...
#+CAPTION: Clock summary at [2016-09-08 Thu 09:37]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *35:56* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 35:56   |       |      | 100.0 |
| Active                                                                      |         | 35:56 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:52 |   2.4 |
| COMPLETED Move readme to markdown                                           |         |       | 0:49 |   2.3 |
| COMPLETED Use =element= base class in  =update_element=                     |         |       | 0:29 |   1.3 |
| COMPLETED Move file instantiation code into yarn                            |         |       | 2:22 |   6.6 |
| COMPLETED Yarn naming tidy-up                                               |         |       | 4:19 |  12.0 |
| COMPLETED Generalisation tidy-up                                            |         |       | 5:07 |  14.2 |
| COMPLETED Create an indexer for resolution data                             |         |       | 1:38 |   4.5 |
| COMPLETED First chat with IS about current state of dogen                   |         |       | 1:57 |   5.4 |
| COMPLETED Extend name builder with required functionality                   |         |       | 1:28 |   4.1 |
| COMPLETED Consider adding support for inheritance via meta-data             |         |       | 4:55 |  13.7 |
| CANCELLED Pick-up Boost 1.61 from Debian Testing                            |         |       | 1:23 |   3.8 |
| COMPLETED Allow cross model inheritance                                     |         |       | 1:09 |   3.2 |
| COMPLETED Add support for visitor inheritance                               |         |       | 7:27 |  20.7 |
...
| STARTED Split injector into separate classes                                |         |       | 0:28 |   1.3 |
...
*** STARTED Split injector into separate classes                      :story:
