...
#+CAPTION: Clock summary at [2016-09-02 Fri 17:52]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *10:03* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 10:03   |       |      | 100.0 |
| Active                                                                      |         | 10:03 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:19 |   3.2 |
| COMPLETED Move readme to markdown                                           |         |       | 0:49 |   8.1 |
| COMPLETED Use =element= base class in  =update_element=                     |         |       | 0:29 |   4.8 |
| COMPLETED Move file instantiation code into yarn                            |         |       | 2:22 |  23.5 |
| COMPLETED Yarn naming tidy-up                                               |         |       | 4:19 |  43.0 |
| STARTED Generalisation tidy-up                                              |         |       | 0:39 |   6.5 |
| STARTED Consider adding support for inheritance via meta-data               |         |       | 1:06 |  10.9 |
