...
#+CAPTION: Clock summary at [2016-09-07 Wed 22:13]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *33:15* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 33:15   |       |      | 100.0 |
| Active                                                                      |         | 33:15 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:52 |   2.6 |
| COMPLETED Move readme to markdown                                           |         |       | 0:49 |   2.5 |
| COMPLETED Use =element= base class in  =update_element=                     |         |       | 0:29 |   1.5 |
| COMPLETED Move file instantiation code into yarn                            |         |       | 2:22 |   7.1 |
| COMPLETED Yarn naming tidy-up                                               |         |       | 4:19 |  13.0 |
| COMPLETED Generalisation tidy-up                                            |         |       | 5:07 |  15.4 |
| COMPLETED Create an indexer for resolution data                             |         |       | 1:38 |   4.9 |
| COMPLETED First chat with IS about current state of dogen                   |         |       | 1:57 |   5.9 |
| COMPLETED Extend name builder with required functionality                   |         |       | 1:28 |   4.4 |
| COMPLETED Consider adding support for inheritance via meta-data             |         |       | 4:55 |  14.8 |
| CANCELLED Pick-up Boost 1.61 from Debian Testing                            |         |       | 1:23 |   4.2 |
| COMPLETED Allow cross model inheritance                                     |         |       | 1:09 |   3.5 |
| STARTED Add support for visitor inheritance                                 |         |       | 6:47 |  20.4 |
