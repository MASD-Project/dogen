...
#+CAPTION: Clock summary at [2016-09-08 Thu 11:33]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *37:44* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 37:44   |       |      | 100.0 |
| Active                                                                      |         | 37:44 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:52 |   2.3 |
| COMPLETED Move readme to markdown                                           |         |       | 0:49 |   2.2 |
| COMPLETED Use =element= base class in  =update_element=                     |         |       | 0:29 |   1.3 |
| COMPLETED Move file instantiation code into yarn                            |         |       | 2:22 |   6.3 |
| COMPLETED Yarn naming tidy-up                                               |         |       | 4:19 |  11.4 |
| COMPLETED Generalisation tidy-up                                            |         |       | 5:07 |  13.6 |
| COMPLETED Create an indexer for resolution data                             |         |       | 1:38 |   4.3 |
| COMPLETED First chat with IS about current state of dogen                   |         |       | 1:57 |   5.2 |
| COMPLETED Extend name builder with required functionality                   |         |       | 1:28 |   3.9 |
| COMPLETED Consider adding support for inheritance via meta-data             |         |       | 4:55 |  13.0 |
| CANCELLED Pick-up Boost 1.61 from Debian Testing                            |         |       | 1:23 |   3.7 |
| COMPLETED Allow cross model inheritance                                     |         |       | 1:09 |   3.0 |
| COMPLETED Add support for visitor inheritance                               |         |       | 7:27 |  19.7 |
| COMPLETED Move visitor =accept= methods to cpp file                         |         |       | 0:41 |   1.8 |
| COMPLETED Analysis work on implementing remaining yarn types                |         |       | 0:52 |   2.3 |
| COMPLETED Split injector into separate classes                              |         |       | 0:56 |   2.5 |
| COMPLETED Add injector interface and registrar                              |         |       | 1:02 |   2.7 |
| STARTED Add language-specific element injection                             |         |       | 0:18 |   0.8 |
...
*** STARTED Add language-specific element injection                   :story:
