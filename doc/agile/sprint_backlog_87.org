...
#+CAPTION: Clock summary at [2016-09-07 Wed 18:06]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| COMPLETED Move readme to markdown                                           |         |       | 0:49 |   2.6 |
| COMPLETED Use =element= base class in  =update_element=                     |         |       | 0:29 |   1.6 |
| COMPLETED Move file instantiation code into yarn                            |         |       | 2:22 |   7.6 |
| COMPLETED Yarn naming tidy-up                                               |         |       | 4:19 |  13.9 |
| COMPLETED Generalisation tidy-up                                            |         |       | 5:07 |  16.4 |
| COMPLETED Create an indexer for resolution data                             |         |       | 1:38 |   5.2 |
| COMPLETED First chat with IS about current state of dogen                   |         |       | 1:57 |   6.3 |
| COMPLETED Extend name builder with required functionality                   |         |       | 1:28 |   4.7 |
| COMPLETED Consider adding support for inheritance via meta-data             |         |       | 4:55 |  15.8 |
| CANCELLED Pick-up Boost 1.61 from Debian Testing                            |         |       | 1:23 |   4.4 |
| COMPLETED Allow cross model inheritance                                     |         |       | 1:09 |   3.7 |
| STARTED Add support for visitor inheritance                                 |         |       | 4:39 |  14.9 |
