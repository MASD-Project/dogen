...
#+CAPTION: Clock summary at [2016-09-08 Thu 11:11]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *37:24* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 37:24   |       |      | 100.0 |
| Active                                                                      |         | 37:24 |      | 100.0 |
...
| COMPLETED Yarn naming tidy-up                                               |         |       | 4:19 |  11.5 |
| COMPLETED Generalisation tidy-up                                            |         |       | 5:07 |  13.7 |
| COMPLETED Create an indexer for resolution data                             |         |       | 1:38 |   4.4 |
...
| COMPLETED Consider adding support for inheritance via meta-data             |         |       | 4:55 |  13.1 |
| CANCELLED Pick-up Boost 1.61 from Debian Testing                            |         |       | 1:23 |   3.7 |
| COMPLETED Allow cross model inheritance                                     |         |       | 1:09 |   3.1 |
| COMPLETED Add support for visitor inheritance                               |         |       | 7:27 |  19.9 |
...
| STARTED Add injector interface and registrar                                |         |       | 1:00 |   2.7 |
...
*** STARTED Add injector interface and registrar                      :story:
