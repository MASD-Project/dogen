...
#+CAPTION: Clock summary at [2016-09-07 Wed 09:58]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *28:16* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 28:16   |       |      | 100.0 |
| Active                                                                      |         | 28:16 |      | 100.0 |
...
| COMPLETED Move file instantiation code into yarn                            |         |       | 2:22 |   8.4 |
| COMPLETED Yarn naming tidy-up                                               |         |       | 4:19 |  15.3 |
| COMPLETED Generalisation tidy-up                                            |         |       | 5:07 |  18.1 |
...
| COMPLETED Consider adding support for inheritance via meta-data             |         |       | 4:55 |  17.4 |
| CANCELLED Pick-up Boost 1.61 from Debian Testing                            |         |       | 1:23 |   4.9 |
| COMPLETED Allow cross model inheritance                                     |         |       | 1:09 |   4.1 |
| STARTED Add support for visitor inheritance                                 |         |       | 1:48 |   6.4 |
