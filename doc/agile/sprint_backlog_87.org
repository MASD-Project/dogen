...
#+CAPTION: Clock summary at [2016-09-11 Sun 09:41]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *53:52* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 53:52   |       |      | 100.0 |
| Active                                                                      |         | 53:52 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:25 |   2.6 |
| COMPLETED Move readme to markdown                                           |         |       | 0:49 |   1.5 |
| COMPLETED Use =element= base class in  =update_element=                     |         |       | 0:29 |   0.9 |
| COMPLETED Move file instantiation code into yarn                            |         |       | 2:22 |   4.4 |
| COMPLETED Yarn naming tidy-up                                               |         |       | 4:19 |   8.0 |
| COMPLETED Generalisation tidy-up                                            |         |       | 5:07 |   9.5 |
| COMPLETED Create an indexer for resolution data                             |         |       | 1:38 |   3.0 |
| COMPLETED First chat with IS about current state of dogen                   |         |       | 1:57 |   3.6 |
| COMPLETED Extend name builder with required functionality                   |         |       | 1:28 |   2.7 |
| COMPLETED Consider adding support for inheritance via meta-data             |         |       | 4:55 |   9.1 |
| CANCELLED Pick-up Boost 1.61 from Debian Testing                            |         |       | 1:23 |   2.6 |
| COMPLETED Allow cross model inheritance                                     |         |       | 1:09 |   2.1 |
| COMPLETED Add support for visitor inheritance                               |         |       | 7:27 |  13.8 |
...
| COMPLETED Split injector into separate classes                              |         |       | 0:56 |   1.7 |
| COMPLETED Add injector interface and registrar                              |         |       | 1:02 |   1.9 |
| COMPLETED Analysis: supporting multiple elements for one id                 |         |       | 1:12 |   2.2 |
| COMPLETED Add language-specific element injection                           |         |       | 0:41 |   1.3 |
| COMPLETED Implement includers in fabric                                     |         |       | 6:10 |  11.4 |
| COMPLETED Quilt's formatter names are incorrect                             |         |       | 0:41 |   1.3 |
| COMPLETED Implement registrar in fabric                                     |         |       | 3:27 |   6.4 |
| COMPLETED Move injection to intermediate model                              |         |       | 1:30 |   2.8 |
| COMPLETED Use a list in model rather than a map                             |         |       | 1:38 |   3.0 |
| STARTED Introduce the notion of composite elements                          |         |       | 0:34 |   1.1 |
