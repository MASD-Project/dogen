...
#+CAPTION: Clock summary at [2016-09-03 Sat 23:41]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| COMPLETED Move file instantiation code into yarn                            |         |       | 2:22 |  16.3 |
| COMPLETED Yarn naming tidy-up                                               |         |       | 4:19 |  29.7 |
| STARTED Generalisation tidy-up                                              |         |       | 5:07 |  35.2 |
| STARTED Consider adding support for inheritance via meta-data               |         |       | 1:06 |   7.6 |
