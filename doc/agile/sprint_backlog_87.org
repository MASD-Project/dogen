...
#+CAPTION: Clock summary at [2016-09-08 Thu 11:58]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *38:07* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 38:07   |       |      | 100.0 |
| Active                                                                      |         | 38:07 |      | 100.0 |
...
| COMPLETED Move file instantiation code into yarn                            |         |       | 2:22 |   6.2 |
| COMPLETED Yarn naming tidy-up                                               |         |       | 4:19 |  11.3 |
| COMPLETED Generalisation tidy-up                                            |         |       | 5:07 |  13.4 |
| COMPLETED Create an indexer for resolution data                             |         |       | 1:38 |   4.3 |
| COMPLETED First chat with IS about current state of dogen                   |         |       | 1:57 |   5.1 |
| COMPLETED Extend name builder with required functionality                   |         |       | 1:28 |   3.8 |
| COMPLETED Consider adding support for inheritance via meta-data             |         |       | 4:55 |  12.9 |
| CANCELLED Pick-up Boost 1.61 from Debian Testing                            |         |       | 1:23 |   3.6 |
| COMPLETED Allow cross model inheritance                                     |         |       | 1:09 |   3.0 |
| COMPLETED Add support for visitor inheritance                               |         |       | 7:27 |  19.5 |
...
| STARTED Add language-specific element injection                             |         |       | 0:41 |   1.8 |
