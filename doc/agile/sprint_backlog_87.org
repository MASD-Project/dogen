...
#+CAPTION: Clock summary at [2016-09-08 Thu 09:49]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *36:07* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 36:07   |       |      | 100.0 |
| Active                                                                      |         | 36:07 |      | 100.0 |
...
| COMPLETED Consider adding support for inheritance via meta-data             |         |       | 4:55 |  13.6 |
| CANCELLED Pick-up Boost 1.61 from Debian Testing                            |         |       | 1:23 |   3.8 |
| COMPLETED Allow cross model inheritance                                     |         |       | 1:09 |   3.2 |
| COMPLETED Add support for visitor inheritance                               |         |       | 7:27 |  20.6 |
...
| STARTED Split injector into separate classes                                |         |       | 0:39 |   1.8 |
