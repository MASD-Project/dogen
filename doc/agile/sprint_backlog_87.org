...
#+CAPTION: Clock summary at [2016-09-02 Fri 14:51]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
...
| Stories                                                                     | 7:37   |      |      | 100.0 |
| Active                                                                      |        | 7:37 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:19 |   4.2 |
| COMPLETED Move readme to markdown                                           |        |      | 0:49 |  10.7 |
| COMPLETED Use =element= base class in  =update_element=                     |        |      | 0:29 |   6.3 |
| COMPLETED Move file instantiation code into yarn                            |        |      | 2:22 |  31.1 |
| STARTED Yarn naming tidy-up                                                 |        |      | 2:32 |  33.3 |
| STARTED Consider adding support for inheritance via meta-data               |        |      | 1:06 |  14.4 |
