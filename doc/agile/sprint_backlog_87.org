...
#+CAPTION: Clock summary at [2016-09-09 Fri 22:12]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *46:15* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 46:15   |       |      | 100.0 |
| Active                                                                      |         | 46:15 |      | 100.0 |
...
| COMPLETED Move file instantiation code into yarn                            |         |       | 2:22 |   5.1 |
| COMPLETED Yarn naming tidy-up                                               |         |       | 4:19 |   9.3 |
| COMPLETED Generalisation tidy-up                                            |         |       | 5:07 |  11.1 |
| COMPLETED Create an indexer for resolution data                             |         |       | 1:38 |   3.5 |
| COMPLETED First chat with IS about current state of dogen                   |         |       | 1:57 |   4.2 |
| COMPLETED Extend name builder with required functionality                   |         |       | 1:28 |   3.2 |
| COMPLETED Consider adding support for inheritance via meta-data             |         |       | 4:55 |  10.6 |
| CANCELLED Pick-up Boost 1.61 from Debian Testing                            |         |       | 1:23 |   3.0 |
| COMPLETED Allow cross model inheritance                                     |         |       | 1:09 |   2.5 |
| COMPLETED Add support for visitor inheritance                               |         |       | 7:27 |  16.1 |
...
| COMPLETED Implement includers in fabric                                     |         |       | 6:10 |  13.3 |
| COMPLETED Quilt's formatter names are incorrect                             |         |       | 0:41 |   1.5 |
