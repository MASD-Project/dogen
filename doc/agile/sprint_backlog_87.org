...
#+CAPTION: Clock summary at [2016-09-07 Wed 10:52]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *29:08* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 29:08   |       |      | 100.0 |
| Active                                                                      |         | 29:08 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:52 |   3.0 |
| COMPLETED Move readme to markdown                                           |         |       | 0:49 |   2.8 |
| COMPLETED Use =element= base class in  =update_element=                     |         |       | 0:29 |   1.7 |
| COMPLETED Move file instantiation code into yarn                            |         |       | 2:22 |   8.1 |
| COMPLETED Yarn naming tidy-up                                               |         |       | 4:19 |  14.8 |
| COMPLETED Generalisation tidy-up                                            |         |       | 5:07 |  17.6 |
| COMPLETED Create an indexer for resolution data                             |         |       | 1:38 |   5.6 |
| COMPLETED First chat with IS about current state of dogen                   |         |       | 1:57 |   6.7 |
| COMPLETED Extend name builder with required functionality                   |         |       | 1:28 |   5.0 |
| COMPLETED Consider adding support for inheritance via meta-data             |         |       | 4:55 |  16.9 |
| CANCELLED Pick-up Boost 1.61 from Debian Testing                            |         |       | 1:23 |   4.7 |
| COMPLETED Allow cross model inheritance                                     |         |       | 1:09 |   3.9 |
| STARTED Add support for visitor inheritance                                 |         |       | 2:40 |   9.2 |
