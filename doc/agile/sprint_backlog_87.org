...
#+CAPTION: Clock summary at [2016-09-10 Sat 23:26]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *53:24* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 53:24   |       |      | 100.0 |
| Active                                                                      |         | 53:24 |      | 100.0 |
...
| COMPLETED Yarn naming tidy-up                                               |         |       | 4:19 |   8.1 |
| COMPLETED Generalisation tidy-up                                            |         |       | 5:07 |   9.6 |
...
| COMPLETED Consider adding support for inheritance via meta-data             |         |       | 4:55 |   9.2 |
| CANCELLED Pick-up Boost 1.61 from Debian Testing                            |         |       | 1:23 |   2.6 |
| COMPLETED Allow cross model inheritance                                     |         |       | 1:09 |   2.2 |
| COMPLETED Add support for visitor inheritance                               |         |       | 7:27 |  14.0 |
...
| COMPLETED Implement includers in fabric                                     |         |       | 6:10 |  11.5 |
