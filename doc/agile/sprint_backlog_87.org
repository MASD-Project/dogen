...
#+CAPTION: Clock summary at [2016-09-09 Fri 21:07]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *45:14* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 45:14   |       |      | 100.0 |
| Active                                                                      |         | 45:14 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:57 |   2.1 |
| COMPLETED Move readme to markdown                                           |         |       | 0:49 |   1.8 |
| COMPLETED Use =element= base class in  =update_element=                     |         |       | 0:29 |   1.1 |
| COMPLETED Move file instantiation code into yarn                            |         |       | 2:22 |   5.2 |
| COMPLETED Yarn naming tidy-up                                               |         |       | 4:19 |   9.5 |
| COMPLETED Generalisation tidy-up                                            |         |       | 5:07 |  11.3 |
| COMPLETED Create an indexer for resolution data                             |         |       | 1:38 |   3.6 |
| COMPLETED First chat with IS about current state of dogen                   |         |       | 1:57 |   4.3 |
| COMPLETED Extend name builder with required functionality                   |         |       | 1:28 |   3.2 |
| COMPLETED Consider adding support for inheritance via meta-data             |         |       | 4:55 |  10.9 |
| CANCELLED Pick-up Boost 1.61 from Debian Testing                            |         |       | 1:23 |   3.1 |
| COMPLETED Allow cross model inheritance                                     |         |       | 1:09 |   2.5 |
| COMPLETED Add support for visitor inheritance                               |         |       | 7:27 |  16.5 |
| COMPLETED Move visitor =accept= methods to cpp file                         |         |       | 0:41 |   1.5 |
| COMPLETED Analysis work on implementing remaining yarn types                |         |       | 0:52 |   1.9 |
| COMPLETED Split injector into separate classes                              |         |       | 0:56 |   2.1 |
| COMPLETED Add injector interface and registrar                              |         |       | 1:02 |   2.3 |
| COMPLETED Analysis: supporting multiple elements for one id                 |         |       | 1:12 |   2.7 |
| COMPLETED Add language-specific element injection                           |         |       | 0:41 |   1.5 |
| STARTED Implement includers in fabric                                       |         |       | 5:50 |  12.9 |
...
*** Quilt's formatter names are incorrect                             :story:
