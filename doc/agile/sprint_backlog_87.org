...
#+CAPTION: Clock summary at [2016-09-06 Tue 21:32]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| COMPLETED Move readme to markdown                                           |         |       | 0:49 |   3.1 |
| COMPLETED Use =element= base class in  =update_element=                     |         |       | 0:29 |   1.8 |
| COMPLETED Move file instantiation code into yarn                            |         |       | 2:22 |   8.8 |
| COMPLETED Yarn naming tidy-up                                               |         |       | 4:19 |  16.1 |
| COMPLETED Generalisation tidy-up                                            |         |       | 5:07 |  19.1 |
| COMPLETED Create an indexer for resolution data                             |         |       | 1:38 |   6.1 |
| COMPLETED First chat with IS about current state of dogen                   |         |       | 1:57 |   7.3 |
| COMPLETED Extend name builder with required functionality                   |         |       | 1:28 |   5.5 |
| COMPLETED Consider adding support for inheritance via meta-data             |         |       | 4:55 |  18.4 |
| CANCELLED Pick-up Boost 1.61 from Debian Testing                            |         |       | 1:23 |   5.2 |
| COMPLETED Allow cross model inheritance                                     |         |       | 1:09 |   4.3 |
| STARTED Add support for visitor inheritance                                 |         |       | 0:17 |   1.1 |
