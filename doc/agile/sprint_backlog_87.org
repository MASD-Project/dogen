...
#+CAPTION: Clock summary at [2016-09-05 Mon 21:34]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| COMPLETED Move file instantiation code into yarn                            |         |       | 2:22 |  12.2 |
| COMPLETED Yarn naming tidy-up                                               |         |       | 4:19 |  22.3 |
| COMPLETED Generalisation tidy-up                                            |         |       | 5:07 |  26.5 |
| COMPLETED Create an indexer for resolution data                             |         |       | 1:38 |   8.4 |
| COMPLETED First chat with IS about current state of dogen                   |         |       | 1:57 |  10.1 |
| STARTED Create a name parser                                                |         |       | 0:58 |   5.0 |
| STARTED Consider adding support for inheritance via meta-data               |         |       | 1:22 |   7.1 |
