...
#+CAPTION: Clock summary at [2016-09-09 Fri 21:28]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *45:34* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 45:34   |       |      | 100.0 |
| Active                                                                      |         | 45:34 |      | 100.0 |
...
| COMPLETED Generalisation tidy-up                                            |         |       | 5:07 |  11.2 |
...
| COMPLETED Consider adding support for inheritance via meta-data             |         |       | 4:55 |  10.8 |
| CANCELLED Pick-up Boost 1.61 from Debian Testing                            |         |       | 1:23 |   3.0 |
| COMPLETED Allow cross model inheritance                                     |         |       | 1:09 |   2.5 |
| COMPLETED Add support for visitor inheritance                               |         |       | 7:27 |  16.3 |
...
| COMPLETED Analysis: supporting multiple elements for one id                 |         |       | 1:12 |   2.6 |
| COMPLETED Add language-specific element injection                           |         |       | 0:41 |   1.5 |
| COMPLETED Implement includers in fabric                                     |         |       | 6:10 |  13.5 |
...
*** STARTED Quilt's formatter names are incorrect                     :story:
