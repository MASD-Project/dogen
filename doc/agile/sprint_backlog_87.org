...
#+CAPTION: Clock summary at [2016-09-08 Thu 11:01]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *37:15* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 37:15   |       |      | 100.0 |
| Active                                                                      |         | 37:15 |      | 100.0 |
...
| COMPLETED Yarn naming tidy-up                                               |         |       | 4:19 |  11.6 |
...
| COMPLETED Consider adding support for inheritance via meta-data             |         |       | 4:55 |  13.2 |
| CANCELLED Pick-up Boost 1.61 from Debian Testing                            |         |       | 1:23 |   3.7 |
| COMPLETED Allow cross model inheritance                                     |         |       | 1:09 |   3.1 |
| COMPLETED Add support for visitor inheritance                               |         |       | 7:27 |  20.0 |
...
| STARTED Add injector interface and registrar                                |         |       | 0:51 |   2.3 |
