...
#+CAPTION: Clock summary at [2016-09-02 Fri 09:10]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *4:10* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 4:10   |      |      | 100.0 |
| Active                                                                      |        | 4:10 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:19 |   7.6 |
| COMPLETED Move readme to markdown                                           |        |      | 0:49 |  19.6 |
| COMPLETED Use =element= base class in  =update_element=                     |        |      | 0:29 |  11.6 |
| STARTED Move file instantiation code into yarn                              |        |      | 0:35 |  14.0 |
| STARTED Yarn naming tidy-update                                             |        |      | 0:52 |  20.8 |
| STARTED Consider adding support for inheritance via meta-data               |        |      | 1:06 |  26.4 |
...
*** STARTED Move file instantiation code into yarn                    :story:
...
*** STARTED Yarn naming tidy-update                                   :story:
