...
#+CAPTION: Clock summary at [2016-09-10 Sat 13:59]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *48:50* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 48:50   |       |      | 100.0 |
| Active                                                                      |         | 48:50 |      | 100.0 |
...
| COMPLETED Yarn naming tidy-up                                               |         |       | 4:19 |   8.8 |
| COMPLETED Generalisation tidy-up                                            |         |       | 5:07 |  10.5 |
| COMPLETED Create an indexer for resolution data                             |         |       | 1:38 |   3.3 |
| COMPLETED First chat with IS about current state of dogen                   |         |       | 1:57 |   4.0 |
| COMPLETED Extend name builder with required functionality                   |         |       | 1:28 |   3.0 |
| COMPLETED Consider adding support for inheritance via meta-data             |         |       | 4:55 |  10.1 |
| CANCELLED Pick-up Boost 1.61 from Debian Testing                            |         |       | 1:23 |   2.8 |
| COMPLETED Allow cross model inheritance                                     |         |       | 1:09 |   2.4 |
| COMPLETED Add support for visitor inheritance                               |         |       | 7:27 |  15.3 |
...
| COMPLETED Implement includers in fabric                                     |         |       | 6:10 |  12.6 |
| COMPLETED Quilt's formatter names are incorrect                             |         |       | 0:41 |   1.4 |
| STARTED Implement registrar in fabric                                       |         |       | 2:35 |   5.3 |
