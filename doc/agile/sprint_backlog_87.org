...
#+CAPTION: Clock summary at [2016-09-07 Wed 23:20]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| COMPLETED Move file instantiation code into yarn                            |         |       | 2:22 |   6.9 |
| COMPLETED Yarn naming tidy-up                                               |         |       | 4:19 |  12.6 |
| COMPLETED Generalisation tidy-up                                            |         |       | 5:07 |  14.9 |
| COMPLETED Create an indexer for resolution data                             |         |       | 1:38 |   4.8 |
| COMPLETED First chat with IS about current state of dogen                   |         |       | 1:57 |   5.7 |
| COMPLETED Extend name builder with required functionality                   |         |       | 1:28 |   4.3 |
| COMPLETED Consider adding support for inheritance via meta-data             |         |       | 4:55 |  14.3 |
| CANCELLED Pick-up Boost 1.61 from Debian Testing                            |         |       | 1:23 |   4.0 |
| COMPLETED Allow cross model inheritance                                     |         |       | 1:09 |   3.4 |
| COMPLETED Add support for visitor inheritance                               |         |       | 7:27 |  21.7 |
| COMPLETED Move visitor =accept= methods to cpp file                         |         |       | 0:24 |   1.2 |
