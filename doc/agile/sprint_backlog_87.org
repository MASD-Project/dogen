...
#+CAPTION: Clock summary at [2016-09-02 Fri 09:47]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
...
| Stories                                                                     | 4:25   |      |      | 100.0 |
| Active                                                                      |        | 4:25 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:19 |   7.2 |
| COMPLETED Move readme to markdown                                           |        |      | 0:49 |  18.5 |
| COMPLETED Use =element= base class in  =update_element=                     |        |      | 0:29 |  10.9 |
| STARTED Move file instantiation code into yarn                              |        |      | 0:50 |  18.9 |
| STARTED Yarn naming tidy-update                                             |        |      | 0:52 |  19.6 |
| STARTED Consider adding support for inheritance via meta-data               |        |      | 1:06 |  24.9 |
