...
#+CAPTION: Clock summary at [2016-09-05 Mon 21:59]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *19:43* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 19:43   |       |      | 100.0 |
| Active                                                                      |         | 19:43 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:19 |   1.6 |
| COMPLETED Move readme to markdown                                           |         |       | 0:49 |   4.1 |
| COMPLETED Use =element= base class in  =update_element=                     |         |       | 0:29 |   2.5 |
| COMPLETED Move file instantiation code into yarn                            |         |       | 2:22 |  12.0 |
| COMPLETED Yarn naming tidy-up                                               |         |       | 4:19 |  21.9 |
| COMPLETED Generalisation tidy-up                                            |         |       | 5:07 |  26.0 |
| COMPLETED Create an indexer for resolution data                             |         |       | 1:38 |   8.3 |
| COMPLETED First chat with IS about current state of dogen                   |         |       | 1:57 |   9.9 |
| STARTED Create a name parser                                                |         |       | 1:21 |   6.8 |
| STARTED Consider adding support for inheritance via meta-data               |         |       | 1:22 |   6.9 |
