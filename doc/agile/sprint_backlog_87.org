...
#+CAPTION: Clock summary at [2016-09-06 Tue 20:37]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *25:53* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 25:53   |       |      | 100.0 |
| Active                                                                      |         | 25:53 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:52 |   3.3 |
| COMPLETED Move readme to markdown                                           |         |       | 0:49 |   3.2 |
| COMPLETED Use =element= base class in  =update_element=                     |         |       | 0:29 |   1.9 |
| COMPLETED Move file instantiation code into yarn                            |         |       | 2:22 |   9.1 |
| COMPLETED Yarn naming tidy-up                                               |         |       | 4:19 |  16.7 |
| COMPLETED Generalisation tidy-up                                            |         |       | 5:07 |  19.8 |
| COMPLETED Create an indexer for resolution data                             |         |       | 1:38 |   6.3 |
| COMPLETED First chat with IS about current state of dogen                   |         |       | 1:57 |   7.5 |
| COMPLETED Extend name builder with required functionality                   |         |       | 1:28 |   5.7 |
| COMPLETED Consider adding support for inheritance via meta-data             |         |       | 4:55 |  19.0 |
| CANCELLED Pick-up Boost 1.61 from Debian Testing                            |         |       | 1:23 |   5.3 |
| COMPLETED Allow cross model inheritance                                     |         |       | 0:34 |   2.2 |
