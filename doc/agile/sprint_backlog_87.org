...
#+CAPTION: Clock summary at [2016-09-05 Mon 13:07]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 18:44   |       |      | 100.0 |
| Active                                                                      |         | 18:44 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:19 |   1.7 |
| COMPLETED Move readme to markdown                                           |         |       | 0:49 |   4.4 |
| COMPLETED Use =element= base class in  =update_element=                     |         |       | 0:29 |   2.6 |
| COMPLETED Move file instantiation code into yarn                            |         |       | 2:22 |  12.6 |
| COMPLETED Yarn naming tidy-up                                               |         |       | 4:19 |  23.0 |
| COMPLETED Generalisation tidy-up                                            |         |       | 5:07 |  27.3 |
| COMPLETED Create an indexer for resolution data                             |         |       | 1:38 |   8.7 |
| COMPLETED First chat with IS about current state of dogen                   |         |       | 1:49 |   9.7 |
| STARTED Create a name parser                                                |         |       | 0:30 |   2.7 |
| STARTED Consider adding support for inheritance via meta-data               |         |       | 1:22 |   7.3 |
...
*** COMPLETED First chat with IS about current state of dogen         :story:
    ...
    CLOCK: [2016-09-05 Mon 11:16]--[2016-09-05 Mon 13:05] =>  1:49
...
*** STARTED Create a name parser                                      :story:
