...
#+CAPTION: Clock summary at [2016-09-07 Wed 23:39]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *34:36* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 34:36   |       |      | 100.0 |
| Active                                                                      |         | 34:36 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:52 |   2.5 |
| COMPLETED Move readme to markdown                                           |         |       | 0:49 |   2.4 |
| COMPLETED Use =element= base class in  =update_element=                     |         |       | 0:29 |   1.4 |
| COMPLETED Move file instantiation code into yarn                            |         |       | 2:22 |   6.8 |
| COMPLETED Yarn naming tidy-up                                               |         |       | 4:19 |  12.5 |
| COMPLETED Generalisation tidy-up                                            |         |       | 5:07 |  14.8 |
| COMPLETED Create an indexer for resolution data                             |         |       | 1:38 |   4.7 |
| COMPLETED First chat with IS about current state of dogen                   |         |       | 1:57 |   5.6 |
| COMPLETED Extend name builder with required functionality                   |         |       | 1:28 |   4.2 |
| COMPLETED Consider adding support for inheritance via meta-data             |         |       | 4:55 |  14.2 |
| CANCELLED Pick-up Boost 1.61 from Debian Testing                            |         |       | 1:23 |   4.0 |
| COMPLETED Allow cross model inheritance                                     |         |       | 1:09 |   3.3 |
| COMPLETED Add support for visitor inheritance                               |         |       | 7:27 |  21.5 |
| COMPLETED Move visitor =accept= methods to cpp file                         |         |       | 0:41 |   2.0 |
