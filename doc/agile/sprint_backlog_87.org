...
#+CAPTION: Clock summary at [2016-09-04 Sun 22:31]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 16:02   |       |      | 100.0 |
| Active                                                                      |         | 16:02 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:19 |   2.0 |
| COMPLETED Move readme to markdown                                           |         |       | 0:49 |   5.1 |
| COMPLETED Use =element= base class in  =update_element=                     |         |       | 0:29 |   3.0 |
| COMPLETED Move file instantiation code into yarn                            |         |       | 2:22 |  14.8 |
| COMPLETED Yarn naming tidy-up                                               |         |       | 4:19 |  26.9 |
| COMPLETED Generalisation tidy-up                                            |         |       | 5:07 |  31.9 |
| STARTED Create an indexer for resolution data                               |         |       | 1:15 |   7.8 |
| STARTED Consider adding support for inheritance via meta-data               |         |       | 1:22 |   8.5 |
