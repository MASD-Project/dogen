...
#+CAPTION: Clock summary at [2016-09-02 Fri 22:19]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *10:20* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 10:20   |       |      | 100.0 |
| Active                                                                      |         | 10:20 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:19 |   3.1 |
| COMPLETED Move readme to markdown                                           |         |       | 0:49 |   7.9 |
| COMPLETED Use =element= base class in  =update_element=                     |         |       | 0:29 |   4.7 |
| COMPLETED Move file instantiation code into yarn                            |         |       | 2:22 |  22.9 |
| COMPLETED Yarn naming tidy-up                                               |         |       | 4:19 |  41.8 |
| STARTED Generalisation tidy-up                                              |         |       | 0:56 |   9.0 |
| STARTED Consider adding support for inheritance via meta-data               |         |       | 1:06 |  10.6 |
