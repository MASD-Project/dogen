...
#+CAPTION: Clock summary at [2016-09-02 Fri 13:52]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *6:40* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 6:40   |      |      | 100.0 |
| Active                                                                      |        | 6:40 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:19 |   4.8 |
| COMPLETED Move readme to markdown                                           |        |      | 0:49 |  12.2 |
| COMPLETED Use =element= base class in  =update_element=                     |        |      | 0:29 |   7.2 |
| COMPLETED Move file instantiation code into yarn                            |        |      | 2:22 |  35.5 |
| STARTED Yarn naming tidy-update                                             |        |      | 1:35 |  23.8 |
| STARTED Consider adding support for inheritance via meta-data               |        |      | 1:06 |  16.5 |
