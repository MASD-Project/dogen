...
#+CAPTION: Clock summary at [2016-09-04 Sun 23:26]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 16:55   |       |      | 100.0 |
| Active                                                                      |         | 16:55 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:19 |   1.9 |
| COMPLETED Move readme to markdown                                           |         |       | 0:49 |   4.8 |
| COMPLETED Use =element= base class in  =update_element=                     |         |       | 0:29 |   2.9 |
| COMPLETED Move file instantiation code into yarn                            |         |       | 2:22 |  14.0 |
| COMPLETED Yarn naming tidy-up                                               |         |       | 4:19 |  25.5 |
| COMPLETED Generalisation tidy-up                                            |         |       | 5:07 |  30.2 |
| COMPLETED Create an indexer for resolution data                             |         |       | 1:38 |   9.7 |
| STARTED Create a name parser                                                |         |       | 0:30 |   3.0 |
| STARTED Consider adding support for inheritance via meta-data               |         |       | 1:22 |   8.1 |
