...
#+CAPTION: Clock summary at [2016-09-02 Fri 12:11]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *5:34* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 5:34   |      |      | 100.0 |
| Active                                                                      |        | 5:34 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:19 |   5.7 |
| COMPLETED Move readme to markdown                                           |        |      | 0:49 |  14.7 |
| COMPLETED Use =element= base class in  =update_element=                     |        |      | 0:29 |   8.7 |
| STARTED Move file instantiation code into yarn                              |        |      | 1:59 |  35.6 |
| STARTED Yarn naming tidy-update                                             |        |      | 0:52 |  15.6 |
| STARTED Consider adding support for inheritance via meta-data               |        |      | 1:06 |  19.8 |
