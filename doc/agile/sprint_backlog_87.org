...
#+CAPTION: Clock summary at [2016-09-05 Mon 23:45]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *21:24* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 21:24   |       |      | 100.0 |
| Active                                                                      |         | 21:24 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:52 |   4.0 |
| COMPLETED Move readme to markdown                                           |         |       | 0:49 |   3.8 |
| COMPLETED Use =element= base class in  =update_element=                     |         |       | 0:29 |   2.3 |
| COMPLETED Move file instantiation code into yarn                            |         |       | 2:22 |  11.1 |
| COMPLETED Yarn naming tidy-up                                               |         |       | 4:19 |  20.2 |
| COMPLETED Generalisation tidy-up                                            |         |       | 5:07 |  23.9 |
| COMPLETED Create an indexer for resolution data                             |         |       | 1:38 |   7.6 |
| COMPLETED First chat with IS about current state of dogen                   |         |       | 1:57 |   9.1 |
| COMPLETED Extend name builder with required functionality                   |         |       | 1:28 |   6.9 |
| STARTED Consider adding support for inheritance via meta-data               |         |       | 2:23 |  11.1 |
