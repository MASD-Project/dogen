...
#+CAPTION: Clock summary at [2016-09-07 Wed 22:59]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *33:55* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 33:55   |       |      | 100.0 |
| Active                                                                      |         | 33:55 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:52 |   2.6 |
| COMPLETED Move readme to markdown                                           |         |       | 0:49 |   2.4 |
| COMPLETED Use =element= base class in  =update_element=                     |         |       | 0:29 |   1.4 |
| COMPLETED Move file instantiation code into yarn                            |         |       | 2:22 |   7.0 |
| COMPLETED Yarn naming tidy-up                                               |         |       | 4:19 |  12.7 |
| COMPLETED Generalisation tidy-up                                            |         |       | 5:07 |  15.1 |
...
| COMPLETED Consider adding support for inheritance via meta-data             |         |       | 4:55 |  14.5 |
| CANCELLED Pick-up Boost 1.61 from Debian Testing                            |         |       | 1:23 |   4.1 |
| COMPLETED Allow cross model inheritance                                     |         |       | 1:09 |   3.4 |
| COMPLETED Add support for visitor inheritance                               |         |       | 7:27 |  22.0 |
...
*** Move visitor =accept= methods to cpp file                         :story:
