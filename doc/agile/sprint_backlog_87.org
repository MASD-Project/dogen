...
#+CAPTION: Clock summary at [2016-09-07 Wed 10:28]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *28:44* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 28:44   |       |      | 100.0 |
| Active                                                                      |         | 28:44 |      | 100.0 |
...
| COMPLETED Move file instantiation code into yarn                            |         |       | 2:22 |   8.2 |
| COMPLETED Yarn naming tidy-up                                               |         |       | 4:19 |  15.0 |
| COMPLETED Generalisation tidy-up                                            |         |       | 5:07 |  17.8 |
| COMPLETED Create an indexer for resolution data                             |         |       | 1:38 |   5.7 |
| COMPLETED First chat with IS about current state of dogen                   |         |       | 1:57 |   6.8 |
| COMPLETED Extend name builder with required functionality                   |         |       | 1:28 |   5.1 |
| COMPLETED Consider adding support for inheritance via meta-data             |         |       | 4:55 |  17.1 |
| CANCELLED Pick-up Boost 1.61 from Debian Testing                            |         |       | 1:23 |   4.8 |
| COMPLETED Allow cross model inheritance                                     |         |       | 1:09 |   4.0 |
| STARTED Add support for visitor inheritance                                 |         |       | 2:16 |   7.9 |
