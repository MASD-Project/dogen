...
#+CAPTION: Clock summary at [2016-09-02 Fri 17:47]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *9:58* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 9:58   |      |      | 100.0 |
| Active                                                                      |        | 9:58 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:19 |   3.2 |
| COMPLETED Move readme to markdown                                           |        |      | 0:49 |   8.2 |
| COMPLETED Use =element= base class in  =update_element=                     |        |      | 0:29 |   4.8 |
| COMPLETED Move file instantiation code into yarn                            |        |      | 2:22 |  23.7 |
| COMPLETED Yarn naming tidy-up                                               |        |      | 4:19 |  43.3 |
| STARTED Generalisation tidy-up                                              |        |      | 0:34 |   5.7 |
| STARTED Consider adding support for inheritance via meta-data               |        |      | 1:06 |  11.0 |
