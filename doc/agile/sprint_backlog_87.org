...
#+CAPTION: Clock summary at [2016-09-02 Fri 17:11]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *9:24* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 9:24   |      |      | 100.0 |
| Active                                                                      |        | 9:24 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:19 |   3.4 |
| COMPLETED Move readme to markdown                                           |        |      | 0:49 |   8.7 |
| COMPLETED Use =element= base class in  =update_element=                     |        |      | 0:29 |   5.1 |
| COMPLETED Move file instantiation code into yarn                            |        |      | 2:22 |  25.2 |
| COMPLETED Yarn naming tidy-up                                               |        |      | 4:19 |  45.9 |
| STARTED Consider adding support for inheritance via meta-data               |        |      | 1:06 |  11.7 |
