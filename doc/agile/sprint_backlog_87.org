...
#+CAPTION: Clock summary at [2016-09-10 Sat 14:52]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *49:42* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 49:42   |       |      | 100.0 |
| Active                                                                      |         | 49:42 |      | 100.0 |
...
| COMPLETED Move file instantiation code into yarn                            |         |       | 2:22 |   4.8 |
| COMPLETED Yarn naming tidy-up                                               |         |       | 4:19 |   8.7 |
| COMPLETED Generalisation tidy-up                                            |         |       | 5:07 |  10.3 |
...
| COMPLETED Extend name builder with required functionality                   |         |       | 1:28 |   3.0 |
| COMPLETED Consider adding support for inheritance via meta-data             |         |       | 4:55 |   9.9 |
| CANCELLED Pick-up Boost 1.61 from Debian Testing                            |         |       | 1:23 |   2.8 |
| COMPLETED Allow cross model inheritance                                     |         |       | 1:09 |   2.3 |
| COMPLETED Add support for visitor inheritance                               |         |       | 7:27 |  15.0 |
...
| COMPLETED Implement includers in fabric                                     |         |       | 6:10 |  12.4 |
