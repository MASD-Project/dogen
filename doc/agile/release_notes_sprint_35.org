...
Clock summary at [2013-10-03 Thu 08:25]

| Headline                                                                 | Time    |       |       |
|--------------------------------------------------------------------------+---------+-------+-------|
| *Total time*                                                             | *29:07* |       |       |
|--------------------------------------------------------------------------+---------+-------+-------|
| Development Stories Implemented                                          |         | 29:07 |       |
...
| IMPLEMENTATION Implement tagger                                          |         |       |  2:44 |
#+end:
...
*** Rename domain header formatter to types header formatter          :spike:
