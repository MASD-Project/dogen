...
Clock summary at [2013-09-07 Sat 23:43]

| Headline                                                            | Time    |       |      |
|---------------------------------------------------------------------+---------+-------+------|
| *Total time*                                                        | *18:01* |       |      |
|---------------------------------------------------------------------+---------+-------+------|
| Development Stories Implemented                                     |         | 18:01 |      |
...
| IMPLEMENTATION Implement the preamble factory                       |         |       | 3:59 |
#+end:
