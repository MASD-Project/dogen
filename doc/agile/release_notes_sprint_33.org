...
Clock summary at [2013-09-08 Sun 17:57]

| Headline                                                            | Time    |       |      |
|---------------------------------------------------------------------+---------+-------+------|
| *Total time*                                                        | *23:47* |       |      |
|---------------------------------------------------------------------+---------+-------+------|
| Development Stories Implemented                                     |         | 23:47 |      |
...
| IMPLEMENTATION Create a comments formatter                          |         |       | 1:09 |
#+end:
...
*** IMPLEMENTATION Create a comments formatter                        :story:
