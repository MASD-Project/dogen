...
Clock summary at [2015-01-11 Sun 23:35]
...
*** Create a class to store the field definitions                     :story:
...
#+begin_example
const auto s(o[field_definitions::identity_attribute().complete_name()]);
#+end_example
