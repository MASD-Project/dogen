...
Clock summary at [2015-01-12 Mon 23:47]
...
*** STARTED Inject all missing fields to object                       :story:

Log whenever we are skipping a field because there is no associated
field definition. Add all required field definitions. Remove
optionality from =obtain_field_definition=.

**** COMPLETED Determine what fields need to be injected
     CLOSED: [2015-01-13 Tue 00:01]
