...
#+CAPTION: Clock summary at [2015-06-16 Tue 22:35]
| <75>                                                                        |         |       |       |
| Headline                                                                    | Time    |       |       |
|-----------------------------------------------------------------------------+---------+-------+-------|
| *Total time*                                                                | *27:56* |       |       |
...
| STARTED Implement class implementation formatter in io                      |         |       |  1:48 |
#+end:
...
*** STARTED Implement class implementation formatter in io            :story:
...
- quoted char (expected unquoted in variant, but we quote it when by itself).
- path does not require generic string
...
*** Implement enum header formatter in io                             :story:
