...
#+CAPTION: Clock summary at [2015-06-20 Sat 18:45]
| <75>                                                                        |         |       |       |
| Headline                                                                    | Time    |       |       |
|-----------------------------------------------------------------------------+---------+-------+-------|
| *Total time*                                                                | *45:09* |       |       |
...
| Stories                                                                     | 45:09   |       |       |
| Active                                                                      |         | 45:09 |       |
| STARTED Sprint and product backlog grooming                                 |         |       |  2:52 |
...
| STARTED Implement enum implementation formatter in test_data                |         |       |  0:13 |
#+end:
...
*** STARTED Implement enum implementation formatter in test_data      :story:
