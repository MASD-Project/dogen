...
#+CAPTION: Clock summary at [2015-06-21 Sun 00:13]
| <75>                                                                        |         |       |       |
| Headline                                                                    | Time    |       |       |
|-----------------------------------------------------------------------------+---------+-------+-------|
| *Total time*                                                                | *48:14* |       |       |
...
| STARTED Implement class implementation formatter in serialisation           |         |       |  1:11 |
#+end:
...
- missing all of the includes. Need a way to figure out if XML and EOS
  are enabled at include time.
