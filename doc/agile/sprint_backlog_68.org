...
#+CAPTION: Clock summary at [2015-06-15 Mon 21:30]
| <75>                                                                        |         |       |       |
| Headline                                                                    | Time    |       |       |
|-----------------------------------------------------------------------------+---------+-------+-------|
| *Total time*                                                                | *25:20* |       |       |
...
| STARTED Implement enum header formatter in hash                             |         |       |  0:43 |
#+end:
...
*** STARTED Implement enum header formatter in hash                   :story:
