...
#+CAPTION: Clock summary at [2015-06-10 Wed 18:06]
| <75>                                                                        |        |      |      |
| Headline                                                                    | Time   |      |      |
|-----------------------------------------------------------------------------+--------+------+------|
| *Total time*                                                                | *9:45* |      |      |
...
| STARTED Implement class implementation formatter using stitch               |        |      | 6:27 |
...
- borked models: boost, std, enumeration, stereotypes.
