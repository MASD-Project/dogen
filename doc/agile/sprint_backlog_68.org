...
#+CAPTION: Clock summary at [2015-06-11 Thu 18:51]
| <75>                                                                        |         |       |      |
| Headline                                                                    | Time    |       |      |
|-----------------------------------------------------------------------------+---------+-------+------|
| *Total time*                                                                | *13:23* |       |      |
...
| STARTED Implement class implementation formatter using stitch               |         |       | 9:14 |
...
*** Inclusion relies on knowing sml to cpp mapping                    :story:
