...
Clock summary at [2013-06-24 Mon 22:51]

| Headline                                                           | Time    |       |      |
|--------------------------------------------------------------------+---------+-------+------|
| *Total time*                                                       | *17:05* |       |      |
|--------------------------------------------------------------------+---------+-------+------|
| Development Stories Implemented                                    |         | 17:05 |      |
...
| IMPLEMENTATION Update SML to make use of concepts                  |         |       | 0:18 |
#+end:
...
**** Implement modules in terms of concepts                            :task:
