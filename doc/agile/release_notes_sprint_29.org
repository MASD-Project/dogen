...
Clock summary at [2013-06-24 Mon 23:18]

| Headline                                                           | Time    |       |      |
|--------------------------------------------------------------------+---------+-------+------|
| *Total time*                                                       | *17:33* |       |      |
|--------------------------------------------------------------------+---------+-------+------|
| Development Stories Implemented                                    |         | 17:33 |      |
...
| IMPLEMENTATION Update SML to make use of concepts                  |         |       | 0:06 |
#+end:
...
**** IMPLEMENTATION Implement modules in terms of concepts             :task:
