...
Clock summary at [2013-06-29 Sat 19:08]

| Headline                                                           | Time    |       |       |
|--------------------------------------------------------------------+---------+-------+-------|
| *Total time*                                                       | *33:21* |       |       |
|--------------------------------------------------------------------+---------+-------+-------|
| Development Stories Implemented                                    |         | 33:21 |       |
...
| IMPLEMENTATION Model should model appropriate concepts             |         |       |  0:19 |
| IMPLEMENTATION Update SML to make use of concepts                  |         |       | 13:01 |
#+end:
...
*** IMPLEMENTATION Model should model appropriate concepts            :story:
