...
Clock summary at [2013-06-24 Mon 23:29]

| Headline                                                           | Time    |       |      |
|--------------------------------------------------------------------+---------+-------+------|
| *Total time*                                                       | *17:43* |       |      |
|--------------------------------------------------------------------+---------+-------+------|
| Development Stories Implemented                                    |         | 17:43 |      |
...
| IMPLEMENTATION Update SML to make use of concepts                  |         |       | 0:16 |
#+end:
...
**** Implement concepts in terms of concepts                           :task:
