...
Clock summary at [2013-06-30 Sun 18:59]

| Headline                                                           | Time    |       |       |
|--------------------------------------------------------------------+---------+-------+-------|
| *Total time*                                                       | *47:13* |       |       |
|--------------------------------------------------------------------+---------+-------+-------|
| Development Stories Implemented                                    |         | 47:13 |       |
...
| IMPLEMENTATION Update SML to make use of concepts                  |         |       | 23:59 |
#+end:
...
*** IMPLEMENTATION Visitor as an injected system type                 :story:
