...
Clock summary at [2013-06-25 Tue 20:00]

| Headline                                                           | Time    |       |      |
|--------------------------------------------------------------------+---------+-------+------|
| *Total time*                                                       | *19:29* |       |      |
|--------------------------------------------------------------------+---------+-------+------|
| Development Stories Implemented                                    |         | 19:29 |      |
...
| IMPLEMENTATION Update SML to make use of concepts                  |         |       | 2:02 |
#+end:
...
**** IMPLEMENTATION Revert back to an enumeration class but now based on concepts :task:
