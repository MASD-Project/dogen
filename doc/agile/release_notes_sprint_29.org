...
Clock summary at [2013-06-30 Sun 13:28]

| Headline                                                           | Time    |       |       |
|--------------------------------------------------------------------+---------+-------+-------|
| *Total time*                                                       | *41:38* |       |       |
|--------------------------------------------------------------------+---------+-------+-------|
| Development Stories Implemented                                    |         | 41:38 |       |
...
| IMPLEMENTATION Update SML to make use of concepts                  |         |       | 19:22 |
#+end:
...
*** IMPLEMENTATION Remove meta types enumeration                      :spike:
