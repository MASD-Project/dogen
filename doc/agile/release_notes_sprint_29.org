...
Clock summary at [2013-06-23 Sun 22:06]

| Headline                                                           | Time    |       |      |
|--------------------------------------------------------------------+---------+-------+------|
| *Total time*                                                       | *13:37* |       |      |
|--------------------------------------------------------------------+---------+-------+------|
| Development Stories Implemented                                    |         | 13:37 |      |
...
| IMPLEMENTATION Implement concepts in SML                           |         |       | 7:09 |
#+end:
...
**** IMPLEMENTATION When transforming a pod, copy across properties from concept :task:
