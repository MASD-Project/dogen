...
Clock summary at [2013-06-25 Tue 00:06]

| Headline                                                           | Time    |       |      |
|--------------------------------------------------------------------+---------+-------+------|
| *Total time*                                                       | *18:17* |       |      |
|--------------------------------------------------------------------+---------+-------+------|
| Development Stories Implemented                                    |         | 18:17 |      |
...
| IMPLEMENTATION Update SML to make use of concepts                  |         |       | 0:50 |
#+end:
...
**** IMPLEMENTATION Revert back to a primitive class but now based on concepts :task:
