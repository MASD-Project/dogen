...
Clock summary at [2013-06-26 Wed 07:54]

| Headline                                                               | Time    |       |      |
|------------------------------------------------------------------------+---------+-------+------|
| *Total time*                                                           | *22:26* |       |      |
|------------------------------------------------------------------------+---------+-------+------|
| Development Stories Implemented                                        |         | 22:26 |      |
...
| IMPLEMENTATION Descendents modeling different concepts from base break |         |       | 1:44 |
| IMPLEMENTATION Update SML to make use of concepts                      |         |       | 3:15 |
#+end:
