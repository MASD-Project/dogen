...
Clock summary at [2014-12-07 Sun 16:00]
...
| STARTED Add support for coveralls                               |        |      | 1:06 |
#+end:
...
Note also that we must add coverage after the script executes or else
we risk doing coverage whilst the build is taking place. Hopefully
this is the reason for these errors:
