...
Clock summary at [2014-12-05 Fri 19:25]
...
[[https://github.com/apolukhin/Boost.DLL][Boost.DLL]] [[https://github.com/apolukhin/Boost.DLL/blob/master/.travis.yml][example]]. We also need to enable coverage on all builds,
...
*** Resolve the breaches of maximum build time                        :story:
...
*** Sanity check packages in travis                                   :story:
