...
Clock summary at [2014-12-02 Tue 19:58]
...
| STARTED Analysis on returning global settings by formatter      |        |      | 1:30 |
#+end:
...
- change the formatter interface to format on entity rather than
  concrete classes. Add validation for the dynamic casting.
...
- change splitter and container to work off of RTTI instead: container
  ...
  splitting.
- create a settings workflow that outputs a settings class 
