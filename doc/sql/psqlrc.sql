...
/**
 * useful currency table management
 */
\set selccy '(select * from kitanda.currency)'
\set delccy '(delete from kitanda.currency)'
\set ccycomplete '(select kitanda.test_currency_complete_generator())'
\set ccymajors '(select kitanda.test_currency_majors_generator())'
...
set SEARCH_PATH to "kitanda", "$user", "public";
