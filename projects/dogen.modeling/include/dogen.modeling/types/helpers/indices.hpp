 ...
 *
 */
#ifndef DOGEN_MODELING_TYPES_HELPERS_INDICES_HPP
#define DOGEN_MODELING_TYPES_HELPERS_INDICES_HPP
...
template<>
inline void swap(
    dogen::modeling::helpers::indices& lhs,
    dogen::modeling::helpers::indices& rhs) {
    lhs.swap(rhs);
}
