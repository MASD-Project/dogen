 ...
 *
 */
#ifndef DOGEN_MODELING_TYPES_META_MODEL_GLOBAL_ARCHETYPE_LOCATION_PROPERTIES_HPP
#define DOGEN_MODELING_TYPES_META_MODEL_GLOBAL_ARCHETYPE_LOCATION_PROPERTIES_HPP
