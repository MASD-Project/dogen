 ...
 *
 */
#ifndef DOGEN_MODELING_TYPES_META_MODEL_ORM_ATTRIBUTE_PROPERTIES_HPP
#define DOGEN_MODELING_TYPES_META_MODEL_ORM_ATTRIBUTE_PROPERTIES_HPP
...
public:
     ...
     */
    /**@{*/
    const std::unordered_map<dogen::modeling::meta_model::orm_database_systems, std::string>& type_overrides() const;
    std::unordered_map<dogen::modeling::meta_model::orm_database_systems, std::string>& type_overrides();
    void type_overrides(const std::unordered_map<dogen::modeling::meta_model::orm_database_systems, std::string>& v);
    void type_overrides(const std::unordered_map<dogen::modeling::meta_model::orm_database_systems, std::string>&& v);
    /**@}*/
...
private:
    ...
    std::unordered_map<dogen::modeling::meta_model::orm_database_systems, std::string> type_overrides_;
    bool is_composite_;
};
...
template<>
inline void swap(
    dogen::modeling::meta_model::orm_attribute_properties& lhs,
    dogen::modeling::meta_model::orm_attribute_properties& rhs) {
    lhs.swap(rhs);
}
