 ...
 *
 */
#ifndef DOGEN_MODELING_TYPES_META_MODEL_DENORMALISED_ARCHETYPE_PROPERTIES_HPP
#define DOGEN_MODELING_TYPES_META_MODEL_DENORMALISED_ARCHETYPE_PROPERTIES_HPP
...
#include "dogen.modeling/serialization/meta_model/denormalised_archetype_properties_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::modeling::meta_model::denormalised_archetype_properties& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::modeling::meta_model::denormalised_archetype_properties& v, unsigned int version);
...
template<>
inline void swap(
    dogen::modeling::meta_model::denormalised_archetype_properties& lhs,
    dogen::modeling::meta_model::denormalised_archetype_properties& rhs) {
    lhs.swap(rhs);
}
