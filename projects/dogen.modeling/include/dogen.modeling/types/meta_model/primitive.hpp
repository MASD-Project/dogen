 ...
 *
 */
#ifndef DOGEN_MODELING_TYPES_META_MODEL_PRIMITIVE_HPP
#define DOGEN_MODELING_TYPES_META_MODEL_PRIMITIVE_HPP
...
#include "dogen.modeling/serialization/meta_model/primitive_fwd_ser.hpp"
 ...
 */
class primitive final : public dogen::modeling::meta_model::element {
public:
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::modeling::meta_model::primitive& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::modeling::meta_model::primitive& v, unsigned int version);
...
public:
     ...
     */
    /**@{*/
    const dogen::modeling::meta_model::attribute& value_attribute() const;
    dogen::modeling::meta_model::attribute& value_attribute();
    void value_attribute(const dogen::modeling::meta_model::attribute& v);
    void value_attribute(const dogen::modeling::meta_model::attribute&& v);
    /**@}*/
    ...
    const boost::optional<dogen::modeling::meta_model::orm_primitive_properties>& orm_properties() const;
    boost::optional<dogen::modeling::meta_model::orm_primitive_properties>& orm_properties();
    void orm_properties(const boost::optional<dogen::modeling::meta_model::orm_primitive_properties>& v);
    void orm_properties(const boost::optional<dogen::modeling::meta_model::orm_primitive_properties>&& v);
...
private:
    bool is_nullable_;
    dogen::modeling::meta_model::attribute value_attribute_;
...
template<>
inline void swap(
    dogen::modeling::meta_model::primitive& lhs,
    dogen::modeling::meta_model::primitive& rhs) {
    lhs.swap(rhs);
}
