 ...
 *
 */
#ifndef DOGEN_MODELING_TYPES_META_MODEL_INTRA_BACKEND_SEGMENT_PROPERTIES_HPP
#define DOGEN_MODELING_TYPES_META_MODEL_INTRA_BACKEND_SEGMENT_PROPERTIES_HPP
...
#include "dogen.modeling/serialization/meta_model/intra_backend_segment_properties_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::modeling::meta_model::intra_backend_segment_properties& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::modeling::meta_model::intra_backend_segment_properties& v, unsigned int version);
...
public:
     ...
     */
    /**@{*/
    dogen::modeling::meta_model::path_contribution_types internal_modules() const;
    void internal_modules(const dogen::modeling::meta_model::path_contribution_types v);
    /**@}*/
     ...
     */
    /**@{*/
    dogen::modeling::meta_model::path_contribution_types facet() const;
    void facet(const dogen::modeling::meta_model::path_contribution_types v);
    /**@}*/
...
private:
    ...
    dogen::modeling::meta_model::path_contribution_types internal_modules_;
    dogen::modeling::meta_model::path_contribution_types facet_;
};
...
template<>
inline void swap(
    dogen::modeling::meta_model::intra_backend_segment_properties& lhs,
    dogen::modeling::meta_model::intra_backend_segment_properties& rhs) {
    lhs.swap(rhs);
}
