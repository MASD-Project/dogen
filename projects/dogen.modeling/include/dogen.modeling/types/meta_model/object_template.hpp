 ...
 *
 */
#ifndef DOGEN_MODELING_TYPES_META_MODEL_OBJECT_TEMPLATE_HPP
#define DOGEN_MODELING_TYPES_META_MODEL_OBJECT_TEMPLATE_HPP
...
#include "dogen.modeling/serialization/meta_model/object_template_fwd_ser.hpp"
 ...
 */
class object_template final : public dogen::modeling::meta_model::element {
public:
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::modeling::meta_model::object_template& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::modeling::meta_model::object_template& v, unsigned int version);
...
template<>
inline void swap(
    dogen::modeling::meta_model::object_template& lhs,
    dogen::modeling::meta_model::object_template& rhs) {
    lhs.swap(rhs);
}
