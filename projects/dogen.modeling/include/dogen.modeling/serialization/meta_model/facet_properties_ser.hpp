 ...
 *
 */
#ifndef DOGEN_MODELING_SERIALIZATION_META_MODEL_FACET_PROPERTIES_SER_HPP
#define DOGEN_MODELING_SERIALIZATION_META_MODEL_FACET_PROPERTIES_SER_HPP
...
BOOST_SERIALIZATION_SPLIT_FREE(dogen::modeling::meta_model::facet_properties)
namespace boost {
