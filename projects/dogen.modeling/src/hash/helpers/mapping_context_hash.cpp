...
std::size_t mapping_context_hasher::hash(const mapping_context& v) {
    ...
    combine(seed, hash_std_unordered_map_std_string_dogen_modeling_meta_model_name(v.translations()));
    combine(seed, hash_std_unordered_set_std_string(v.erasures()));
    combine(seed, hash_std_unordered_map_std_string_dogen_modeling_meta_model_name(v.injections()));
