...
const std::unordered_map<dogen::modeling::meta_model::languages, std::unordered_map<std::string, dogen::modeling::meta_model::name> >& mapping_set::by_language_agnostic_id() const {
    return by_language_agnostic_id_;
}

std::unordered_map<dogen::modeling::meta_model::languages, std::unordered_map<std::string, dogen::modeling::meta_model::name> >& mapping_set::by_language_agnostic_id() {
    return by_language_agnostic_id_;
}

void mapping_set::by_language_agnostic_id(const std::unordered_map<dogen::modeling::meta_model::languages, std::unordered_map<std::string, dogen::modeling::meta_model::name> >& v) {
...
const std::unordered_map<dogen::modeling::meta_model::languages, std::unordered_set<std::string> >& mapping_set::erasures_by_language() const {
    return erasures_by_language_;
}

std::unordered_map<dogen::modeling::meta_model::languages, std::unordered_set<std::string> >& mapping_set::erasures_by_language() {
    return erasures_by_language_;
}

void mapping_set::erasures_by_language(const std::unordered_map<dogen::modeling::meta_model::languages, std::unordered_set<std::string> >& v) {
