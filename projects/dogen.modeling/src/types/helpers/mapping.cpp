...
const std::unordered_map<dogen::modeling::meta_model::languages, dogen::modeling::helpers::mapping_value>& mapping::by_language() const {
    return by_language_;
}

std::unordered_map<dogen::modeling::meta_model::languages, dogen::modeling::helpers::mapping_value>& mapping::by_language() {
    return by_language_;
}

void mapping::by_language(const std::unordered_map<dogen::modeling::meta_model::languages, dogen::modeling::helpers::mapping_value>& v) {
    by_language_ = v;
}
