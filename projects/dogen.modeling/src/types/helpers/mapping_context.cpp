...
const std::unordered_map<std::string, dogen::modeling::meta_model::name>& mapping_context::translations() const {
    return translations_;
}

std::unordered_map<std::string, dogen::modeling::meta_model::name>& mapping_context::translations() {
    return translations_;
}

void mapping_context::translations(const std::unordered_map<std::string, dogen::modeling::meta_model::name>& v) {
    translations_ = v;
}
...
const std::unordered_map<std::string, dogen::modeling::meta_model::name>& mapping_context::injections() const {
    return injections_;
}

std::unordered_map<std::string, dogen::modeling::meta_model::name>& mapping_context::injections() {
    return injections_;
}

void mapping_context::injections(const std::unordered_map<std::string, dogen::modeling::meta_model::name>& v) {
    injections_ = v;
}
