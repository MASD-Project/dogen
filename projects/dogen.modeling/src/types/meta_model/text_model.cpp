...
const std::list<dogen::modeling::meta_model::artefact>& text_model::artefacts() const {
    return artefacts_;
}

std::list<dogen::modeling::meta_model::artefact>& text_model::artefacts() {
    return artefacts_;
}

void text_model::artefacts(const std::list<dogen::modeling::meta_model::artefact>& v) {
    artefacts_ = v;
}
