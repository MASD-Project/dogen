...
const boost::optional<dogen::modeling::meta_model::letter_cases>& orm_object_properties::letter_case() const {
    return letter_case_;
}

boost::optional<dogen::modeling::meta_model::letter_cases>& orm_object_properties::letter_case() {
    return letter_case_;
}

void orm_object_properties::letter_case(const boost::optional<dogen::modeling::meta_model::letter_cases>& v) {
    letter_case_ = v;
}
