...
const std::string& orm_attribute_properties::column_name() const {
    return column_name_;
}

std::string& orm_attribute_properties::column_name() {
    return column_name_;
}

void orm_attribute_properties::column_name(const std::string& v) {
    column_name_ = v;
}
...
bool orm_attribute_properties::is_primary_key() const {
    return is_primary_key_;
}

void orm_attribute_properties::is_primary_key(const bool v) {
    is_primary_key_ = v;
}

const boost::optional<bool>& orm_attribute_properties::is_nullable() const {
    return is_nullable_;
}

boost::optional<bool>& orm_attribute_properties::is_nullable() {
    return is_nullable_;
}

void orm_attribute_properties::is_nullable(const boost::optional<bool>& v) {
    is_nullable_ = v;
}
...
const std::unordered_map<dogen::modeling::meta_model::orm_database_systems, std::string>& orm_attribute_properties::type_overrides() const {
    return type_overrides_;
}

std::unordered_map<dogen::modeling::meta_model::orm_database_systems, std::string>& orm_attribute_properties::type_overrides() {
    return type_overrides_;
}

void orm_attribute_properties::type_overrides(const std::unordered_map<dogen::modeling::meta_model::orm_database_systems, std::string>& v) {
    type_overrides_ = v;
}
