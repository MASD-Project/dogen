...
inline std::ostream& operator<<(std::ostream& s, const boost::optional<dogen::modeling::meta_model::orm_attribute_properties>& v) {
...
std::ostream& operator<<(std::ostream& s, const attribute& v) {
    ...
    s << " { "
      << "\"__type__\": " << "\"dogen::modeling::meta_model::attribute\"" << ", "
