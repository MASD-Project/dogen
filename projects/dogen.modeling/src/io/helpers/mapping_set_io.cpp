...
inline std::ostream& operator<<(std::ostream& s, const std::unordered_map<dogen::modeling::meta_model::languages, std::unordered_map<std::string, dogen::modeling::meta_model::name> >& v) {
    s << "[";
    for (auto i(v.begin()); i != v.end(); ++i) {
        if (i != v.begin()) s << ", ";
        s << "[ { " << "\"__type__\": " << "\"key\"" << ", " << "\"data\": ";
...
inline std::ostream& operator<<(std::ostream& s, const std::unordered_map<dogen::modeling::meta_model::languages, std::unordered_set<std::string> >& v) {
    s << "[";
    for (auto i(v.begin()); i != v.end(); ++i) {
        if (i != v.begin()) s << ", ";
        s << "[ { " << "\"__type__\": " << "\"key\"" << ", " << "\"data\": ";
...
std::ostream& operator<<(std::ostream& s, const mapping_set& v) {
    s << " { "
      << "\"__type__\": " << "\"dogen::modeling::helpers::mapping_set\"" << ", "
