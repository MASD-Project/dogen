...
create_dogen_modeling_meta_model_artefact(const unsigned int position) {
    return dogen::modeling::meta_model::artefact_generator::create(position);
}

std::list<dogen::modeling::meta_model::artefact> create_std_list_dogen_modeling_meta_model_artefact(unsigned int position) {
    std::list<dogen::modeling::meta_model::artefact> r;
    for (unsigned int i(0); i < 4; ++i) {
        r.push_back(create_dogen_modeling_meta_model_artefact(position + i));
    }
    return r;
}
...
populate(const unsigned int position, result_type& v) {
    v.artefacts(create_std_list_dogen_modeling_meta_model_artefact(position + 0));
