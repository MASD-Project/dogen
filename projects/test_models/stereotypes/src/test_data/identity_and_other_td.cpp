...
identity_and_other_generator::identity_and_other_generator() : position_(0) { }

void identity_and_other_generator::
...
identity_and_other_generator::create(const unsigned int position) {
    identity_and_other r;
...
identity_and_other_generator::create_ptr(const unsigned int position) {
    ...
    identity_and_other_generator::populate(position, *p);
    return p;
}

identity_and_other_generator::result_type
identity_and_other_generator::operator()() {
