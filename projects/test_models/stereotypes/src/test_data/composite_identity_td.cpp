...
composite_identity_generator::composite_identity_generator() : position_(0) { }
...
composite_identity_generator::create(const unsigned int position) {
    composite_identity r;
...
composite_identity_generator::create_ptr(const unsigned int position) {
    ...
    composite_identity_generator::populate(position, *p);
    return p;
}

composite_identity_generator::result_type
composite_identity_generator::operator()() {
