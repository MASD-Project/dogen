...
composite_identity_unversioned_key_generator::composite_identity_unversioned_key_generator() : position_(0) { }

void composite_identity_unversioned_key_generator::
...
composite_identity_unversioned_key_generator::create(const unsigned int position) {
    composite_identity_unversioned_key r;
...
composite_identity_unversioned_key_generator::create_ptr(const unsigned int position) {
    ...
    composite_identity_unversioned_key_generator::populate(position, *p);
    return p;
}

composite_identity_unversioned_key_generator::result_type
composite_identity_unversioned_key_generator::operator()() {
