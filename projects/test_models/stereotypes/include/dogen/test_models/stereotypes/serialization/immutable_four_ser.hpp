 ...
 *
 */
#ifndef DOGEN_TEST_MODELS_STEREOTYPES_SERIALIZATION_IMMUTABLE_FOUR_SER_HPP
#define DOGEN_TEST_MODELS_STEREOTYPES_SERIALIZATION_IMMUTABLE_FOUR_SER_HPP
...
BOOST_SERIALIZATION_SPLIT_FREE(dogen::test_models::stereotypes::immutable_four)
namespace boost {
