 ...
 *
 */
#ifndef DOGEN_TEST_MODELS_STEREOTYPES_TYPES_MULTIPLE_REFINEMENT_CONCEPT_MODEL_HPP
#define DOGEN_TEST_MODELS_STEREOTYPES_TYPES_MULTIPLE_REFINEMENT_CONCEPT_MODEL_HPP
...
#include <algorithm>
#include <string>
#include "dogen/test_models/stereotypes/serialization/multiple_refinement_concept_model_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::test_models::stereotypes::multiple_refinement_concept_model& lhs,
    dogen::test_models::stereotypes::multiple_refinement_concept_model& rhs) {
    lhs.swap(rhs);
}
