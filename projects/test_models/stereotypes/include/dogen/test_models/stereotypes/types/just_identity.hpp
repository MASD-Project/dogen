 ...
 *
 */
#ifndef DOGEN_TEST_MODELS_STEREOTYPES_TYPES_JUST_IDENTITY_HPP
#define DOGEN_TEST_MODELS_STEREOTYPES_TYPES_JUST_IDENTITY_HPP
...
#include <algorithm>
#include "dogen/test_models/stereotypes/serialization/just_identity_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::test_models::stereotypes::just_identity& lhs,
    dogen::test_models::stereotypes::just_identity& rhs) {
    lhs.swap(rhs);
}
