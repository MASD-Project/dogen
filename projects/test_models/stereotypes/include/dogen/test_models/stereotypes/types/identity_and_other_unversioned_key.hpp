 ...
 *
 */
#ifndef DOGEN_TEST_MODELS_STEREOTYPES_TYPES_IDENTITY_AND_OTHER_UNVERSIONED_KEY_HPP
#define DOGEN_TEST_MODELS_STEREOTYPES_TYPES_IDENTITY_AND_OTHER_UNVERSIONED_KEY_HPP
...
#include <algorithm>
#include "dogen/test_models/stereotypes/serialization/identity_and_other_unversioned_key_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::test_models::stereotypes::identity_and_other_unversioned_key& lhs,
    dogen::test_models::stereotypes::identity_and_other_unversioned_key& rhs) {
    lhs.swap(rhs);
}
