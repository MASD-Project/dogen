 ...
 *
 */
#ifndef DOGEN_TEST_MODELS_STEREOTYPES_TYPES_PKG1_KEYED_IN_PACKAGE_UNVERSIONED_KEY_HPP
#define DOGEN_TEST_MODELS_STEREOTYPES_TYPES_PKG1_KEYED_IN_PACKAGE_UNVERSIONED_KEY_HPP
...
#include <algorithm>
#include "dogen/test_models/stereotypes/serialization/pkg1/keyed_in_package_unversioned_key_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::test_models::stereotypes::pkg1::keyed_in_package_unversioned_key& lhs,
    dogen::test_models::stereotypes::pkg1::keyed_in_package_unversioned_key& rhs) {
    lhs.swap(rhs);
}
