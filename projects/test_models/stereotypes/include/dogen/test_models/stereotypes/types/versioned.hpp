 ...
 *
 */
#ifndef DOGEN_TEST_MODELS_STEREOTYPES_TYPES_VERSIONED_HPP
#define DOGEN_TEST_MODELS_STEREOTYPES_TYPES_VERSIONED_HPP
...
#include <algorithm>
#include "dogen/test_models/stereotypes/serialization/versioned_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::test_models::stereotypes::versioned& lhs,
    dogen::test_models::stereotypes::versioned& rhs) {
    lhs.swap(rhs);
}
