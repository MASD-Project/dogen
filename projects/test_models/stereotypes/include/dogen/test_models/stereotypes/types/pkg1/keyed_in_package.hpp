 ...
 *
 */
#ifndef DOGEN_TEST_MODELS_STEREOTYPES_TYPES_PKG1_KEYED_IN_PACKAGE_HPP
#define DOGEN_TEST_MODELS_STEREOTYPES_TYPES_PKG1_KEYED_IN_PACKAGE_HPP
...
#include <algorithm>
#include "dogen/test_models/stereotypes/serialization/pkg1/keyed_in_package_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::test_models::stereotypes::pkg1::keyed_in_package& lhs,
    dogen::test_models::stereotypes::pkg1::keyed_in_package& rhs) {
    lhs.swap(rhs);
}
