 ...
 *
 */
#ifndef DOGEN_TEST_MODELS_STEREOTYPES_TYPES_JUST_IDENTITY_VER_UNVERSIONED_KEY_HPP
#define DOGEN_TEST_MODELS_STEREOTYPES_TYPES_JUST_IDENTITY_VER_UNVERSIONED_KEY_HPP
...
#include <algorithm>
#include "dogen/test_models/stereotypes/serialization/just_identity_ver_unversioned_key_fwd_ser.hpp"
...
/**
 * @brief Unversioned key for just_identity_ver
 */
...
template<>
inline void swap(
    dogen::test_models::stereotypes::just_identity_ver_unversioned_key& lhs,
    dogen::test_models::stereotypes::just_identity_ver_unversioned_key& rhs) {
    lhs.swap(rhs);
}
