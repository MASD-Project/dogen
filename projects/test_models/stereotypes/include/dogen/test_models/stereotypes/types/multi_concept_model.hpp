 ...
 *
 */
#ifndef DOGEN_TEST_MODELS_STEREOTYPES_TYPES_MULTI_CONCEPT_MODEL_HPP
#define DOGEN_TEST_MODELS_STEREOTYPES_TYPES_MULTI_CONCEPT_MODEL_HPP
...
#include <string>
#include <algorithm>
#include "dogen/test_models/stereotypes/serialization/multi_concept_model_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::test_models::stereotypes::multi_concept_model& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::test_models::stereotypes::multi_concept_model& v, unsigned int version);
...
template<>
inline void swap(
    dogen::test_models::stereotypes::multi_concept_model& lhs,
    dogen::test_models::stereotypes::multi_concept_model& rhs) {
    lhs.swap(rhs);
}
