 ...
 *
 */
#ifndef DOGEN_TEST_MODELS_STEREOTYPES_TYPES_ENTITY_HPP
#define DOGEN_TEST_MODELS_STEREOTYPES_TYPES_ENTITY_HPP
...
#include <algorithm>
#include "dogen/test_models/stereotypes/serialization/entity_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::test_models::stereotypes::entity& lhs,
    dogen::test_models::stereotypes::entity& rhs) {
    lhs.swap(rhs);
}
