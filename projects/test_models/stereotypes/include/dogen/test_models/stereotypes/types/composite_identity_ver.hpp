 ...
 *
 */
#ifndef DOGEN_TEST_MODELS_STEREOTYPES_TYPES_COMPOSITE_IDENTITY_VER_HPP
#define DOGEN_TEST_MODELS_STEREOTYPES_TYPES_COMPOSITE_IDENTITY_VER_HPP
...
#include <algorithm>
#include "dogen/test_models/stereotypes/serialization/composite_identity_ver_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::test_models::stereotypes::composite_identity_ver& lhs,
    dogen::test_models::stereotypes::composite_identity_ver& rhs) {
    lhs.swap(rhs);
}
