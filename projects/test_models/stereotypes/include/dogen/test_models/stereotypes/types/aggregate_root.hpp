 ...
 *
 */
#ifndef DOGEN_TEST_MODELS_STEREOTYPES_TYPES_AGGREGATE_ROOT_HPP
#define DOGEN_TEST_MODELS_STEREOTYPES_TYPES_AGGREGATE_ROOT_HPP
...
#include <algorithm>
#include "dogen/test_models/stereotypes/serialization/aggregate_root_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::test_models::stereotypes::aggregate_root& lhs,
    dogen::test_models::stereotypes::aggregate_root& rhs) {
    lhs.swap(rhs);
}
