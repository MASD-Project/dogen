 ...
 *
 */
#ifndef DOGEN_TEST_MODELS_STEREOTYPES_TYPES_FLUENT_HPP
#define DOGEN_TEST_MODELS_STEREOTYPES_TYPES_FLUENT_HPP
...
#include "dogen/test_models/stereotypes/serialization/fluent_fwd_ser.hpp"
...
public:
    ...
    dogen::test_models::stereotypes::value& prop_2();
    fluent& prop_2(const dogen::test_models::stereotypes::value& v);
    fluent& prop_2(const dogen::test_models::stereotypes::value&& v);
...
template<>
inline void swap(
    dogen::test_models::stereotypes::fluent& lhs,
    dogen::test_models::stereotypes::fluent& rhs) {
    lhs.swap(rhs);
}
