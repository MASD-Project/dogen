 ...
 *
 */
#ifndef DOGEN_TEST_MODELS_STEREOTYPES_TYPES_IDENTITY_POD_HPP
#define DOGEN_TEST_MODELS_STEREOTYPES_TYPES_IDENTITY_POD_HPP
...
#include "dogen/test_models/stereotypes/serialization/identity_pod_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::test_models::stereotypes::identity_pod& lhs,
    dogen::test_models::stereotypes::identity_pod& rhs) {
    lhs.swap(rhs);
}
