 ...
 *
 */
#ifndef DOGEN_TEST_MODELS_STEREOTYPES_TYPES_BASE_WITH_CONCEPT_HPP
#define DOGEN_TEST_MODELS_STEREOTYPES_TYPES_BASE_WITH_CONCEPT_HPP
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::test_models::stereotypes::base_with_concept& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::test_models::stereotypes::base_with_concept& v, unsigned int version);
