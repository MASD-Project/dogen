...
{
    public sealed class Descendant3 : Dogen.TestModels.CSharpModel.Descendant1
    {
        #region Properties
        ...
        public static bool operator ==(Descendant3 lhs, Descendant3 rhs)
        {
        ...
        {
            return Descendant3Dumper.Dump(this);
        }
        #endregion
    }
}
