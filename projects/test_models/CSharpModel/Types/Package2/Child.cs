...
{
    public sealed class Child : Dogen.TestModels.CSharpModel.Package2.Parent
    {
        #region Properties
        ...
        public static bool operator ==(Child lhs, Child rhs)
        {
