...
namespace Dogen.TestModels.CSharpModel.Package1
{
    ...
    /// </summary>
    public static class Class3Dumper
    {
        static internal void Dump(AssistantDumper assistant, Class3 value, bool withSeparator = false)
        {
        ...
        public static string Dump(Class3 value)
        {
