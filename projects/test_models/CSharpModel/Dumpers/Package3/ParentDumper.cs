...
namespace Dogen.TestModels.CSharpModel.Package3
{
    ...
    /// </summary>
    public static class ParentDumper
    {
        static internal void Dump(AssistantDumper assistant, Parent value, bool withSeparator = false)
        {
            ...
            assistant.AddType("Dogen.TestModels.CSharpModel.Package3.Parent", true/*withSeparator*/);
            if (value == null)
            {
        ...
        public static string Dump(Parent value)
        {
            return value.Dump();
        }
    }
