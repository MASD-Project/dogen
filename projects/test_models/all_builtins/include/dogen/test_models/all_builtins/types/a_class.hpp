 ...
 *
 */
#ifndef DOGEN_TEST_MODELS_ALL_BUILTINS_TYPES_A_CLASS_HPP
#define DOGEN_TEST_MODELS_ALL_BUILTINS_TYPES_A_CLASS_HPP
...
#include <algorithm>
#include "dogen/test_models/all_builtins/serialization/a_class_fwd_ser.hpp"

namespace dogen {
namespace test_models {
namespace all_builtins {
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::test_models::all_builtins::a_class& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::test_models::all_builtins::a_class& v, unsigned int version);
...
template<>
inline void swap(
    dogen::test_models::all_builtins::a_class& lhs,
    dogen::test_models::all_builtins::a_class& rhs) {
    lhs.swap(rhs);
}
