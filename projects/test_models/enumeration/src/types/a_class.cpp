...
a_class::a_class()
    : colour_type_(static_cast<dogen::test_models::enumeration::colour_types>(0)),
      book_type_(static_cast<dogen::test_models::enumeration::book_types>(0)),
...
dogen::test_models::enumeration::colour_types a_class::colour_type() const {
    return colour_type_;
}
...
dogen::test_models::enumeration::book_types a_class::book_type() const {
    return book_type_;
}
...
dogen::test_models::enumeration::pkg1::shape_types a_class::shape_type() const {
    return shape_type_;
}
