 ...
 *
 */
#ifndef DOGEN_TEST_MODELS_EOS_SERIALIZATION_TYPES_FIRST_CLASS_HPP
#define DOGEN_TEST_MODELS_EOS_SERIALIZATION_TYPES_FIRST_CLASS_HPP
...
#include <algorithm>
#include "dogen/test_models/eos_serialization/serialization/first_class_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::test_models::eos_serialization::first_class& lhs,
    dogen::test_models::eos_serialization::first_class& rhs) {
    lhs.swap(rhs);
}
