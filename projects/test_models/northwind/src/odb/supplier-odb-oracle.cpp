...
#include "dogen/northwind/odb/supplier-odb-oracle.hxx"
...
namespace odb
{
  ...
  struct access::object_traits_impl< ::dogen::test_models::northwind::supplier, id_oracle >::extra_statement_cache_type
  {
  ...
  access::object_traits_impl< ::dogen::test_models::northwind::supplier, id_oracle >::id_type
  access::object_traits_impl< ::dogen::test_models::northwind::supplier, id_oracle >::
  ...
  void access::object_traits_impl< ::dogen::test_models::northwind::supplier, id_oracle >::
  bind (oracle::bind* b,
        image_type& i,
  ...
  const char access::object_traits_impl< ::dogen::test_models::northwind::supplier, id_oracle >::persist_statement[] =
  ...
  const char access::object_traits_impl< ::dogen::test_models::northwind::supplier, id_oracle >::find_statement[] =
  "SELECT "
  ...
  const char access::object_traits_impl< ::dogen::test_models::northwind::supplier, id_oracle >::update_statement[] =
  ...
  const char access::object_traits_impl< ::dogen::test_models::northwind::supplier, id_oracle >::erase_statement[] =
  "DELETE FROM \"NORTHWIND\".\"SUPPLIER\" "
  "WHERE \"SUPPLIER_ID\"=:1";

  const char access::object_traits_impl< ::dogen::test_models::northwind::supplier, id_oracle >::query_statement[] =
  "SELECT "
  "\"NORTHWIND\".\"SUPPLIER\".\"SUPPLIER_ID\", "
  "\"NORTHWIND\".\"SUPPLIER\".\"COMPANY_NAME\", "
  "\"NORTHWIND\".\"SUPPLIER\".\"CONTACT_NAME\", "
  ...
  const char access::object_traits_impl< ::dogen::test_models::northwind::supplier, id_oracle >::erase_query_statement[] =
  "DELETE FROM \"NORTHWIND\".\"SUPPLIER\"";

  const char access::object_traits_impl< ::dogen::test_models::northwind::supplier, id_oracle >::table_name[] =
  "\"NORTHWIND\".\"SUPPLIER\"";
  ...
  access::object_traits_impl< ::dogen::test_models::northwind::supplier, id_oracle >::pointer_type
  access::object_traits_impl< ::dogen::test_models::northwind::supplier, id_oracle >::
  ...
  bool access::object_traits_impl< ::dogen::test_models::northwind::supplier, id_oracle >::
  ...
  result< access::object_traits_impl< ::dogen::test_models::northwind::supplier, id_oracle >::object_type >
  access::object_traits_impl< ::dogen::test_models::northwind::supplier, id_oracle >::
  ...
  unsigned long long access::object_traits_impl< ::dogen::test_models::northwind::supplier, id_oracle >::
