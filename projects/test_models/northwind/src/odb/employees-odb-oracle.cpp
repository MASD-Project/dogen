...
#include "dogen/northwind/odb/employees-odb-oracle.hxx"
...
namespace odb
{
        ...
        oracle::statement_kind sk)
  {
    ...
    b[n].buffer = &i.photo_lob;
    b[n].indicator = &i.photo_indicator;
    b[n].callback = &i.photo_callback;
    ...
    //
    b[n].type = oracle::bind::string;
    b[n].buffer = i.photo_path_value;
    b[n].capacity = static_cast<ub4> (sizeof (i.photo_path_value));
    b[n].size = &i.photo_path_size;
    b[n].indicator = &i.photo_path_indicator;
    n++;
  }
        ...
        oracle::statement_kind sk)
  {
    ...
    //
    {
      ...
      bool is_null (true);
      i.photo_lob.position = 0;
      oracle::value_traits<
          ::std::vector< char >,
          oracle::id_blob >::set_image (
        i.photo_callback.callback.param,
        i.photo_callback.context.param,
        is_null,
        v);
    ...
    //
    {
      ...
      oracle::value_traits<
          ...
          oracle::id_string >::set_image (
        i.photo_path_value,
        sizeof (i.photo_path_value),
        size,
        is_null,
        v);
      i.photo_path_indicator = is_null ? -1 : 0;
      i.photo_path_size = static_cast<ub2> (size);
    }
  }
        ...
        database* db)
  {
    ...
    //
    {
      ...
      oracle::value_traits<
        ...
        v,
        i.photo_callback.callback.result,
        i.photo_callback.context.result,
        i.photo_indicator == -1);
    }
