 ...
 *
 */
#ifndef ZANGO_NORTHWIND_TYPES_SUPPLIER_HPP
#define ZANGO_NORTHWIND_TYPES_SUPPLIER_HPP
...
#include "zango/northwind/serialization/supplier_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const zango::northwind::supplier& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, zango::northwind::supplier& v, unsigned int version);
...
template<>
inline void swap(
    zango::northwind::supplier& lhs,
    zango::northwind::supplier& rhs) {
    lhs.swap(rhs);
}
