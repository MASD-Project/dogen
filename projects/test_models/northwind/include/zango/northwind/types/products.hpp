 ...
 *
 */
#ifndef ZANGO_NORTHWIND_TYPES_PRODUCTS_HPP
#define ZANGO_NORTHWIND_TYPES_PRODUCTS_HPP
...
#include "zango/northwind/types/supplier_id.hpp"
#include "zango/northwind/serialization/products_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const zango::northwind::products& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, zango::northwind::products& v, unsigned int version);
...
public:
    ...
    const zango::northwind::supplier_id& supplier_id() const;
    zango::northwind::supplier_id& supplier_id();
    void supplier_id(const zango::northwind::supplier_id& v);
    void supplier_id(const zango::northwind::supplier_id&& v);
...
private:
    ...
    zango::northwind::supplier_id supplier_id_;
...
template<>
inline void swap(
    zango::northwind::products& lhs,
    zango::northwind::products& rhs) {
    lhs.swap(rhs);
}
