 ...
 *
 */
#ifndef ZANGO_NORTHWIND_TYPES_ORDERS_HPP
#define ZANGO_NORTHWIND_TYPES_ORDERS_HPP
...
#include "zango/northwind/serialization/orders_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const zango::northwind::orders& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, zango::northwind::orders& v, unsigned int version);
...
template<>
inline void swap(
    zango::northwind::orders& lhs,
    zango::northwind::orders& rhs) {
    lhs.swap(rhs);
}
