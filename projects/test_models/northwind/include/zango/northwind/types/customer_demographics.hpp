 ...
 *
 */
#ifndef ZANGO_NORTHWIND_TYPES_CUSTOMER_DEMOGRAPHICS_HPP
#define ZANGO_NORTHWIND_TYPES_CUSTOMER_DEMOGRAPHICS_HPP
...
#include "zango/northwind/serialization/customer_demographics_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const zango::northwind::customer_demographics& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, zango::northwind::customer_demographics& v, unsigned int version);
...
template<>
inline void swap(
    zango::northwind::customer_demographics& lhs,
    zango::northwind::customer_demographics& rhs) {
    lhs.swap(rhs);
}
