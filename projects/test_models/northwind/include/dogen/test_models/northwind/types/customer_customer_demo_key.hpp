 ...
 *
 */
#ifndef DOGEN_TEST_MODELS_NORTHWIND_TYPES_CUSTOMER_CUSTOMER_DEMO_KEY_HPP
#define DOGEN_TEST_MODELS_NORTHWIND_TYPES_CUSTOMER_CUSTOMER_DEMO_KEY_HPP
...
#include "dogen/test_models/northwind/serialization/customer_customer_demo_key_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::test_models::northwind::customer_customer_demo_key& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::test_models::northwind::customer_customer_demo_key& v, unsigned int version);
...
template<>
inline void swap(
    dogen::test_models::northwind::customer_customer_demo_key& lhs,
    dogen::test_models::northwind::customer_customer_demo_key& rhs) {
    lhs.swap(rhs);
}
