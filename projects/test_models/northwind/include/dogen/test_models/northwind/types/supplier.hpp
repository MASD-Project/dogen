 ...
 *
 */
#ifndef DOGEN_TEST_MODELS_NORTHWIND_TYPES_SUPPLIER_HPP
#define DOGEN_TEST_MODELS_NORTHWIND_TYPES_SUPPLIER_HPP
...
#include "dogen/test_models/northwind/serialization/supplier_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::test_models::northwind::supplier& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::test_models::northwind::supplier& v, unsigned int version);
...
template<>
inline void swap(
    dogen::test_models::northwind::supplier& lhs,
    dogen::test_models::northwind::supplier& rhs) {
    lhs.swap(rhs);
}
