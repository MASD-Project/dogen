...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::dogen::test_models::northwind::orders >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::dogen::test_models::northwind::orders >
  {
    public:
    typedef ::dogen::test_models::northwind::orders object_type;
    typedef ::boost::shared_ptr< ::dogen::test_models::northwind::orders > pointer_type;
    typedef odb::pointer_traits<pointer_type> pointer_traits;

    static const bool polymorphic = false;

    typedef ::dogen::test_models::northwind::order_id id_type;
