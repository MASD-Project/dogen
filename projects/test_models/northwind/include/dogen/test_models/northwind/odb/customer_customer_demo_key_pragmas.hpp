 ...
 *
 */
#ifndef DOGEN_TEST_MODELS_NORTHWIND_ODB_CUSTOMER_CUSTOMER_DEMO_KEY_PRAGMAS_HPP
#define DOGEN_TEST_MODELS_NORTHWIND_ODB_CUSTOMER_CUSTOMER_DEMO_KEY_PRAGMAS_HPP
