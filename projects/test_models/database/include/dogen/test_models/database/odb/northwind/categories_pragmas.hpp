 ...
 *
 */
#ifndef DOGEN_TEST_MODELS_DATABASE_ODB_NORTHWIND_CATEGORIES_PRAGMAS_HPP
#define DOGEN_TEST_MODELS_DATABASE_ODB_NORTHWIND_CATEGORIES_PRAGMAS_HPP
...
#pragma db object(categories) no_id
