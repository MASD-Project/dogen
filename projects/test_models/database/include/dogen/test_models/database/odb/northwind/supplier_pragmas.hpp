 ...
 *
 */
#ifndef DOGEN_TEST_MODELS_DATABASE_ODB_NORTHWIND_SUPPLIER_PRAGMAS_HPP
#define DOGEN_TEST_MODELS_DATABASE_ODB_NORTHWIND_SUPPLIER_PRAGMAS_HPP
...
#pragma db object(supplier) no_id
