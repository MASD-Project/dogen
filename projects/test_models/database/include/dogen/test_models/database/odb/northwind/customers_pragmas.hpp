 ...
 *
 */
#ifndef DOGEN_TEST_MODELS_DATABASE_ODB_NORTHWIND_CUSTOMERS_PRAGMAS_HPP
#define DOGEN_TEST_MODELS_DATABASE_ODB_NORTHWIND_CUSTOMERS_PRAGMAS_HPP
...
#pragma db member(customers::company_name_) not_null
