 ...
 *
 */
#ifndef DOGEN_TEST_MODELS_DATABASE_ODB_NORTHWIND_TERRITORY_PRAGMAS_HPP
#define DOGEN_TEST_MODELS_DATABASE_ODB_NORTHWIND_TERRITORY_PRAGMAS_HPP
...
#pragma db object(territory) no_id
