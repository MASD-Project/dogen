 ...
 *
 */
#ifndef DOGEN_TEST_MODELS_DATABASE_TYPES_NORTHWIND_EMPLOYEES_HPP
#define DOGEN_TEST_MODELS_DATABASE_TYPES_NORTHWIND_EMPLOYEES_HPP
...
#include "dogen/test_models/database/serialization/northwind/employees_fwd_ser.hpp"
...
public:
    employees(
        ...
        const dogen::test_models::database::northwind::employee_id& reports_to,
        const std::string& photo_path);

private:
    template<typename Archive>
    friend void boost::serialization::save(Archive& ar, const dogen::test_models::database::northwind::employees& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::test_models::database::northwind::employees& v, unsigned int version);
...
public:
    ...
    const dogen::test_models::database::northwind::employee_id& reports_to() const;
    dogen::test_models::database::northwind::employee_id& reports_to();
    void reports_to(const dogen::test_models::database::northwind::employee_id& v);
    void reports_to(const dogen::test_models::database::northwind::employee_id&& v);
...
private:
    ...
    std::string notes_;
    dogen::test_models::database::northwind::employee_id reports_to_;
...
template<>
inline void swap(
    dogen::test_models::database::northwind::employees& lhs,
    dogen::test_models::database::northwind::employees& rhs) {
    lhs.swap(rhs);
}
