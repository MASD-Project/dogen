 ...
 *
 */
#ifndef DOGEN_TEST_MODELS_DATABASE_TYPES_NORTHWIND_ORDERS_HPP
#define DOGEN_TEST_MODELS_DATABASE_TYPES_NORTHWIND_ORDERS_HPP
...
#include "dogen/test_models/database/serialization/northwind/orders_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::test_models::database::northwind::orders& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::test_models::database::northwind::orders& v, unsigned int version);
...
template<>
inline void swap(
    dogen::test_models::database::northwind::orders& lhs,
    dogen::test_models::database::northwind::orders& rhs) {
    lhs.swap(rhs);
}
