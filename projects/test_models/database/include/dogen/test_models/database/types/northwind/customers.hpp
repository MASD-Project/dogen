 ...
 *
 */
#ifndef DOGEN_TEST_MODELS_DATABASE_TYPES_NORTHWIND_CUSTOMERS_HPP
#define DOGEN_TEST_MODELS_DATABASE_TYPES_NORTHWIND_CUSTOMERS_HPP
...
#include "dogen/test_models/database/serialization/northwind/customers_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::test_models::database::northwind::customers& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::test_models::database::northwind::customers& v, unsigned int version);
...
template<>
inline void swap(
    dogen::test_models::database::northwind::customers& lhs,
    dogen::test_models::database::northwind::customers& rhs) {
    lhs.swap(rhs);
}
