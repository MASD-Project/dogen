 ...
 *
 */
#ifndef DOGEN_TEST_MODELS_DATABASE_TYPES_NORTHWIND_PRODUCTS_HPP
#define DOGEN_TEST_MODELS_DATABASE_TYPES_NORTHWIND_PRODUCTS_HPP
...
#include "dogen/test_models/database/serialization/northwind/products_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::test_models::database::northwind::products& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::test_models::database::northwind::products& v, unsigned int version);
...
template<>
inline void swap(
    dogen::test_models::database::northwind::products& lhs,
    dogen::test_models::database::northwind::products& rhs) {
    lhs.swap(rhs);
}
