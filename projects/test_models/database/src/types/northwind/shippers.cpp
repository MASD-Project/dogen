...
const dogen::test_models::database::northwind::shipper_id& shippers::shipper_id() const {
    return shipper_id_;
}

dogen::test_models::database::northwind::shipper_id& shippers::shipper_id() {
    return shipper_id_;
}

void shippers::shipper_id(const dogen::test_models::database::northwind::shipper_id& v) {
    shipper_id_ = v;
}
