...
const dogen::test_models::database::northwind::category_id& categories::category_id() const {
    return category_id_;
}

dogen::test_models::database::northwind::category_id& categories::category_id() {
    return category_id_;
}

void categories::category_id(const dogen::test_models::database::northwind::category_id& v) {
    category_id_ = v;
}
