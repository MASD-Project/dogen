 ...
 *
 */
#include "dogen/test_models/database/types/northwind/territory.hpp"
...
const dogen::test_models::database::northwind::territory_id& territory::territory_id() const {
    return territory_id_;
}

dogen::test_models::database::northwind::territory_id& territory::territory_id() {
    return territory_id_;
}

void territory::territory_id(const dogen::test_models::database::northwind::territory_id& v) {
    territory_id_ = v;
}
...
const dogen::test_models::database::northwind::region_id& territory::region_id() const {
    return region_id_;
}

dogen::test_models::database::northwind::region_id& territory::region_id() {
    return region_id_;
}

void territory::region_id(const dogen::test_models::database::northwind::region_id& v) {
    region_id_ = v;
}
