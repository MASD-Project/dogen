 ...
 *
 */
#include "dogen/test_models/database/types/northwind/orders.hpp"
...
const dogen::test_models::database::northwind::order_id& orders::order_id() const {
    return order_id_;
}

dogen::test_models::database::northwind::order_id& orders::order_id() {
    return order_id_;
}

void orders::order_id(const dogen::test_models::database::northwind::order_id& v) {
    order_id_ = v;
}
...
const dogen::test_models::database::northwind::customer_id& orders::customer_id() const {
    return customer_id_;
}

dogen::test_models::database::northwind::customer_id& orders::customer_id() {
    return customer_id_;
}

void orders::customer_id(const dogen::test_models::database::northwind::customer_id& v) {
    customer_id_ = v;
}
...
const dogen::test_models::database::northwind::employee_id& orders::employee_id() const {
    return employee_id_;
}

dogen::test_models::database::northwind::employee_id& orders::employee_id() {
    return employee_id_;
}

void orders::employee_id(const dogen::test_models::database::northwind::employee_id& v) {
    employee_id_ = v;
}
