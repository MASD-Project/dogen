...
const dogen::test_models::database::northwind::supplier_id& supplier::supplier_id() const {
    return supplier_id_;
}

dogen::test_models::database::northwind::supplier_id& supplier::supplier_id() {
    return supplier_id_;
}

void supplier::supplier_id(const dogen::test_models::database::northwind::supplier_id& v) {
    supplier_id_ = v;
}
