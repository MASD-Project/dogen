...
const dogen::test_models::database::northwind::order_details_key& order_details::order_details_key() const {
    return order_details_key_;
}

dogen::test_models::database::northwind::order_details_key& order_details::order_details_key() {
    return order_details_key_;
}

void order_details::order_details_key(const dogen::test_models::database::northwind::order_details_key& v) {
