...
const dogen::test_models::database::northwind::employee_id& employees::employee_id() const {
    return employee_id_;
}

dogen::test_models::database::northwind::employee_id& employees::employee_id() {
    return employee_id_;
}

void employees::employee_id(const dogen::test_models::database::northwind::employee_id& v) {
    employee_id_ = v;
}
...
const dogen::test_models::database::northwind::employee_id& employees::reports_to() const {
    return reports_to_;
}

dogen::test_models::database::northwind::employee_id& employees::reports_to() {
    return reports_to_;
}

void employees::reports_to(const dogen::test_models::database::northwind::employee_id& v) {
    reports_to_ = v;
}
