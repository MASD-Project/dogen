...
customer_customer_demo::customer_customer_demo(const dogen::test_models::database::northwind::customer_customer_demo_key& customer_customer_demo_key)
...
const dogen::test_models::database::northwind::customer_customer_demo_key& customer_customer_demo::customer_customer_demo_key() const {
    return customer_customer_demo_key_;
}

dogen::test_models::database::northwind::customer_customer_demo_key& customer_customer_demo::customer_customer_demo_key() {
    return customer_customer_demo_key_;
}

void customer_customer_demo::customer_customer_demo_key(const dogen::test_models::database::northwind::customer_customer_demo_key& v) {
