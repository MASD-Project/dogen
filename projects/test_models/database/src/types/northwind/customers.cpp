...
const dogen::test_models::database::northwind::customer_id& customers::customer_id() const {
    return customer_id_;
}

dogen::test_models::database::northwind::customer_id& customers::customer_id() {
    return customer_id_;
}

void customers::customer_id(const dogen::test_models::database::northwind::customer_id& v) {
    customer_id_ = v;
}
