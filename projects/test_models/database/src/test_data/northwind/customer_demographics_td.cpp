...
#include "dogen/test_models/database/test_data/northwind/customer_demographics_td.hpp"
...
populate(const unsigned int position, result_type& v) {
    v.customer_type_id(create_dogen_test_models_database_northwind_customer_type_id(position + 0));
