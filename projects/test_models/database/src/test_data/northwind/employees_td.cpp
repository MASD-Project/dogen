 ...
 */
#include <sstream>
#include "dogen/test_models/database/test_data/northwind/employees_td.hpp"
...
populate(const unsigned int position, result_type& v) {
    ...
    v.reports_to(create_dogen_test_models_database_northwind_employee_id(position + 16));
