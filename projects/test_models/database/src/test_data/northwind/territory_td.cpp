...
#include "dogen/test_models/database/test_data/northwind/territory_td.hpp"
...
populate(const unsigned int position, result_type& v) {
    v.territory_id(create_dogen_test_models_database_northwind_territory_id(position + 0));
    v.territory_description(create_std_string(position + 1));
    v.region_id(create_dogen_test_models_database_northwind_region_id(position + 2));
}
