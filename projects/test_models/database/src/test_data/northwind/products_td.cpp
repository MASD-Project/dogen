 ...
 */
#include <sstream>
#include "dogen/test_models/database/test_data/northwind/products_td.hpp"
#include "dogen/test_models/database/test_data/northwind/product_id_td.hpp"
#include "dogen/test_models/database/test_data/northwind/category_id_td.hpp"
#include "dogen/test_models/database/test_data/northwind/supplier_id_td.hpp"

namespace {

dogen::test_models::database::northwind::product_id
create_dogen_test_models_database_northwind_product_id(const unsigned int position) {
    return dogen::test_models::database::northwind::product_id_generator::create(position);
}
...
dogen::test_models::database::northwind::supplier_id
create_dogen_test_models_database_northwind_supplier_id(const unsigned int position) {
    return dogen::test_models::database::northwind::supplier_id_generator::create(position);
}
...
populate(const unsigned int position, result_type& v) {
    v.product_id(create_dogen_test_models_database_northwind_product_id(position + 0));
    v.product_name(create_std_string(position + 1));
    v.supplier_id(create_dogen_test_models_database_northwind_supplier_id(position + 2));
    v.category_id(create_dogen_test_models_database_northwind_category_id(position + 3));
