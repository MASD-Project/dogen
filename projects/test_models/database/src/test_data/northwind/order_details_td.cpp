 ...
 *
 */
#include "dogen/test_models/database/test_data/northwind/order_details_td.hpp"
#include "dogen/test_models/database/test_data/northwind/order_details_key_td.hpp"

namespace {

dogen::test_models::database::northwind::order_details_key
create_dogen_test_models_database_northwind_order_details_key(const unsigned int position) {
    return dogen::test_models::database::northwind::order_details_key_generator::create(position);
}
...
populate(const unsigned int position, result_type& v) {
    v.order_details_key(create_dogen_test_models_database_northwind_order_details_key(position + 0));
