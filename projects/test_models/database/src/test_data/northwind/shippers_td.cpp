 ...
 */
#include <sstream>
#include "dogen/test_models/database/test_data/northwind/shippers_td.hpp"
#include "dogen/test_models/database/test_data/northwind/shipper_id_td.hpp"

namespace {

dogen::test_models::database::northwind::shipper_id
create_dogen_test_models_database_northwind_shipper_id(const unsigned int position) {
    return dogen::test_models::database::northwind::shipper_id_generator::create(position);
}
...
populate(const unsigned int position, result_type& v) {
    v.shipper_id(create_dogen_test_models_database_northwind_shipper_id(position + 0));
