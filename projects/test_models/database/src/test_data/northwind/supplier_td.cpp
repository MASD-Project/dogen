 ...
 */
#include <sstream>
#include "dogen/test_models/database/test_data/northwind/supplier_td.hpp"
...
populate(const unsigned int position, result_type& v) {
    v.supplier_id(create_dogen_test_models_database_northwind_supplier_id(position + 0));
