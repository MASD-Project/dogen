 ...
 */
#include <sstream>
#include "dogen/test_models/database/test_data/northwind/orders_td.hpp"
...
populate(const unsigned int position, result_type& v) {
    v.order_id(create_dogen_test_models_database_northwind_order_id(position + 0));
    v.customer_id(create_dogen_test_models_database_northwind_customer_id(position + 1));
    v.employee_id(create_dogen_test_models_database_northwind_employee_id(position + 2));
