 ...
 *
 */
#ifndef DOGEN_TEST_MODELS_SPLIT_PROJECT_TYPES_PACKAGE_A_CLASS_HPP
#define DOGEN_TEST_MODELS_SPLIT_PROJECT_TYPES_PACKAGE_A_CLASS_HPP
...
#include <algorithm>
#include "dogen/test_models/split_project/serialization/package/a_class_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::test_models::split_project::package::a_class& lhs,
    dogen::test_models::split_project::package::a_class& rhs) {
    lhs.swap(rhs);
}
