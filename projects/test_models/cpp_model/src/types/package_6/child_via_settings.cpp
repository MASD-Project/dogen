...
child_via_settings::child_via_settings(
    ...
    const int prop_1)
    : dogen::test_models::cpp_model::package_6::parent(prop_0),
      prop_1_(prop_1) { }

void child_via_settings::to_stream(std::ostream& s) const {
    s << " { "
      << "\"__type__\": " << "\"dogen::test_models::cpp_model::package_6::child_via_settings\"" << ", "
      << "\"__parent_0__\": ";
    dogen::test_models::cpp_model::package_6::parent::to_stream(s);
    s << ", "
      << "\"prop_1\": " << prop_1_
      << " }";
}
...
void child_via_settings::swap(child_via_settings& other) noexcept {
    dogen::test_models::cpp_model::package_6::parent::swap(other);

    using std::swap;
    swap(prop_1_, other.prop_1_);
}

bool child_via_settings::equals(const dogen::test_models::cpp_model::package_6::parent& other) const {
...
bool child_via_settings::operator==(const child_via_settings& rhs) const {
    return dogen::test_models::cpp_model::package_6::parent::compare(rhs) &&
        prop_1_ == rhs.prop_1_;
}
