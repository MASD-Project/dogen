...
void further_refined::to_stream(std::ostream& s) const {
    s << " { "
      << "\"__type__\": " << "\"dogen::test_models::cpp_model::further_refined\"" << ", "
      << "\"__parent_0__\": ";
    dogen::test_models::cpp_model::base_with_concept::to_stream(s);
    s << ", "
      << "\"prop_3\": " << prop_3_ << ", "
      << "\"prop_1\": " << prop_1_
      << " }";
...
void further_refined::swap(further_refined& other) noexcept {
    dogen::test_models::cpp_model::base_with_concept::swap(other);
...
bool further_refined::equals(const dogen::test_models::cpp_model::base_with_concept& other) const {
...
bool further_refined::operator==(const further_refined& rhs) const {
    return dogen::test_models::cpp_model::base_with_concept::compare(rhs) &&
        prop_3_ == rhs.prop_3_ &&
        prop_1_ == rhs.prop_1_;
}
