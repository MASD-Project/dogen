...
#include "dogen/test_models/trivial_association/types/all.hpp"
#include "dogen/test_models/trivial_association/io/all_io.hpp"
#include "dogen/test_models/trivial_association/serialization/all_ser.hpp"
#include "dogen/test_models/test_model_sanitizer/register_types.hpp"
#include "dogen/test_models/trivial_association/test_data/all_td.hpp"
#include "dogen/test_models/trivial_association/hash/all_hash.hpp"

namespace {

const std::string empty;
const std::string test_module("test_model_sanitizer");
const std::string test_suite("trivial_association_tests");

}

using namespace dogen::test_models::trivial_association;
using namespace dogen::utility::test;

BOOST_AUTO_TEST_SUITE(trivial_association_tests)
