...
#include "dogen/test_models/all_primitives/types/all.hpp"
#include "dogen/test_models/all_primitives/io/all_io.hpp"
#include "dogen/test_models/all_primitives/serialization/all_ser.hpp"
#include "dogen/test_models/test_model_sanitizer/register_types.hpp"
#include "dogen/test_models/all_primitives/test_data/all_td.hpp"
#include "dogen/test_models/all_primitives/hash/all_hash.hpp"

namespace {

const std::string empty;
const std::string test_module("test_model_sanitizer");
const std::string test_suite("all_primitives_tests");

}

using namespace dogen::test_models::all_primitives;
using namespace dogen::utility::test;

BOOST_AUTO_TEST_SUITE(all_primitives_tests)
