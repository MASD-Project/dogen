...
#include "dogen/test_models/exception/types/all.hpp"
#include "dogen/test_models/exception/io/all_io.hpp"
#include "dogen/test_models/exception/test_data/all_td.hpp"
#include "dogen/test_models/exception/hash/all_hash.hpp"

namespace {

const std::string empty;
const std::string test_module("test_model_sanitizer");
const std::string test_suite("exception_tests");

}

using namespace dogen::test_models::exception;
