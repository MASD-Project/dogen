...
#include "dogen/test_models/classes_without_package/types/all.hpp"
#include "dogen/test_models/classes_without_package/io/all_io.hpp"
#include "dogen/test_models/classes_without_package/serialization/all_ser.hpp"
#include "dogen/test_models/test_model_sanitizer/register_types.hpp"
#include "dogen/test_models/classes_without_package/test_data/all_td.hpp"
#include "dogen/test_models/classes_without_package/hash/all_hash.hpp"

namespace {

const std::string empty;
const std::string test_module("test_model_sanitizer");
const std::string test_suite("classes_without_package_tests");

}

using namespace dogen::test_models::classes_without_package;
using namespace dogen::utility::test;

BOOST_AUTO_TEST_SUITE(classes_without_package_tests)
