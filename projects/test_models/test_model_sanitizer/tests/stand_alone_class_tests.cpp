...
#include "dogen/test_models/stand_alone_class/types/all.hpp"
#include "dogen/test_models/stand_alone_class/io/all_io.hpp"
#include "dogen/test_models/stand_alone_class/serialization/all_ser.hpp"
#include "dogen/test_models/test_model_sanitizer/register_types.hpp"
#include "dogen/test_models/stand_alone_class/test_data/all_td.hpp"
#include "dogen/test_models/stand_alone_class/hash/all_hash.hpp"

namespace {

const std::string empty;
const std::string test_module("test_model_sanitizer");
const std::string test_suite("stand_alone_class_tests");

}

using namespace dogen::test_models::stand_alone_class;
using namespace dogen::utility::test;

BOOST_AUTO_TEST_SUITE(stand_alone_class_tests)
