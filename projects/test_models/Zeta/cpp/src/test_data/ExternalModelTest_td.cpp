...
std::list<std::list<std::string> > create_std_list_std_list_std_string(unsigned int position) {
    std::list<std::list<std::string> > r;
    for (unsigned int i(0); i < 4; ++i) {
        r.push_back(create_std_list_std_string(position + i));
    }
    return r;
}

std::list<std::list<std::list<std::string> > > create_std_list_std_list_std_list_std_string(unsigned int position) {
    std::list<std::list<std::list<std::string> > > r;
    for (unsigned int i(0); i < 4; ++i) {
        r.push_back(create_std_list_std_list_std_string(position + i));
    }
    return r;
}
...
populate(const unsigned int position, result_type& v) {
    ...
    v.BinariesTest(create_std_list_std_string(position + 1));
    v.CollectionOfCollectionTest(create_std_list_std_list_std_string(position + 2));
    v.CollectionOfCollectionOfCollectionTest(create_std_list_std_list_std_list_std_string(position + 3));
}
