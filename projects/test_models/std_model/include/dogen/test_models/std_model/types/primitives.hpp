 ...
 *
 */
#ifndef DOGEN_TEST_MODELS_STD_MODEL_TYPES_PRIMITIVES_HPP
#define DOGEN_TEST_MODELS_STD_MODEL_TYPES_PRIMITIVES_HPP
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::test_models::std_model::primitives& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::test_models::std_model::primitives& v, unsigned int version);
...
template<>
inline void swap(
    dogen::test_models::std_model::primitives& lhs,
    dogen::test_models::std_model::primitives& rhs) {
    lhs.swap(rhs);
}
