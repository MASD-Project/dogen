 ...
 *
 */
#ifndef DOGEN_TEST_MODELS_STD_MODEL_TYPES_CLASS_A_UNVERSIONED_KEY_HPP
#define DOGEN_TEST_MODELS_STD_MODEL_TYPES_CLASS_A_UNVERSIONED_KEY_HPP
...
#include <string>
#include <algorithm>
#include "dogen/test_models/std_model/serialization/class_a_unversioned_key_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::test_models::std_model::class_a_unversioned_key& lhs,
    dogen::test_models::std_model::class_a_unversioned_key& rhs) {
    lhs.swap(rhs);
}
