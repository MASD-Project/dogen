...
primitives_generator::primitives_generator() : position_(0) { }

void primitives_generator::
...
primitives_generator::create(const unsigned int position) {
    primitives r;
...
primitives_generator::create_ptr(const unsigned int position) {
    ...
    primitives_generator::populate(position, *p);
    return p;
}

primitives_generator::result_type
primitives_generator::operator()() {
