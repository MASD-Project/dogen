 ...
 *
 */
#ifndef DOGEN_TEST_MODELS_TRIVIAL_INHERITANCE_TYPES_DESCENDANT2_HPP
#define DOGEN_TEST_MODELS_TRIVIAL_INHERITANCE_TYPES_DESCENDANT2_HPP
...
#include "dogen/test_models/trivial_inheritance/serialization/descendant2_fwd_ser.hpp"

namespace dogen {
namespace test_models {
namespace trivial_inheritance {

class descendant2 final : public dogen::test_models::trivial_inheritance::base {
public:
...
template<>
inline void swap(
    dogen::test_models::trivial_inheritance::descendant2& lhs,
    dogen::test_models::trivial_inheritance::descendant2& rhs) {
    lhs.swap(rhs);
}
