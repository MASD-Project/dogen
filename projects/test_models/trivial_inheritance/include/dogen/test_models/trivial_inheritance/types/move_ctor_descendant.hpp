 ...
 *
 */
#ifndef DOGEN_TEST_MODELS_TRIVIAL_INHERITANCE_TYPES_MOVE_CTOR_DESCENDANT_HPP
#define DOGEN_TEST_MODELS_TRIVIAL_INHERITANCE_TYPES_MOVE_CTOR_DESCENDANT_HPP
...
#include "dogen/test_models/trivial_inheritance/serialization/move_ctor_descendant_fwd_ser.hpp"
 ...
 */
class move_ctor_descendant final : public dogen::test_models::trivial_inheritance::move_ctor_base {
public:
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::test_models::trivial_inheritance::move_ctor_descendant& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::test_models::trivial_inheritance::move_ctor_descendant& v, unsigned int version);
...
template<>
inline void swap(
    dogen::test_models::trivial_inheritance::move_ctor_descendant& lhs,
    dogen::test_models::trivial_inheritance::move_ctor_descendant& rhs) {
    lhs.swap(rhs);
}
