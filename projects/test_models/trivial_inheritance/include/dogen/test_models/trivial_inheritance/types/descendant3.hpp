...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const descendant3& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, descendant3& v, unsigned int version);
