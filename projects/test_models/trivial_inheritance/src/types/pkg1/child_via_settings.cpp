...
child_via_settings::child_via_settings(
    ...
    const int prop_1)
    : dogen::test_models::trivial_inheritance::pkg1::parent(prop_0),
      prop_1_(prop_1) { }

void child_via_settings::to_stream(std::ostream& s) const {
    s << " { "
      << "\"__type__\": " << "\"dogen::test_models::trivial_inheritance::pkg1::child_via_settings\"" << ", "
      << "\"__parent_0__\": ";
...
bool child_via_settings::equals(const dogen::test_models::trivial_inheritance::pkg1::parent& other) const {
