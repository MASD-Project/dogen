...
move_ctor_descendant::move_ctor_descendant(move_ctor_descendant&& rhs)
    : dogen::test_models::trivial_inheritance::move_ctor_base(
        std::forward<dogen::test_models::trivial_inheritance::move_ctor_base>(rhs)),
...
move_ctor_descendant::move_ctor_descendant(
    ...
    : dogen::test_models::trivial_inheritance::move_ctor_base(prop_0),
      prop_1_(prop_1) { }
...
bool move_ctor_descendant::equals(const dogen::test_models::trivial_inheritance::move_ctor_base& other) const {
