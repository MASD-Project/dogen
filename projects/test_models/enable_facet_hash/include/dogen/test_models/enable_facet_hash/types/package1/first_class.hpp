 ...
 *
 */
#ifndef DOGEN_TEST_MODELS_ENABLE_FACET_HASH_TYPES_PACKAGE1_FIRST_CLASS_HPP
#define DOGEN_TEST_MODELS_ENABLE_FACET_HASH_TYPES_PACKAGE1_FIRST_CLASS_HPP
...
template<>
inline void swap(
    dogen::test_models::enable_facet_hash::package1::first_class& lhs,
    dogen::test_models::enable_facet_hash::package1::first_class& rhs) {
    lhs.swap(rhs);
}
