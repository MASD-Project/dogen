 ...
 *
 */
#ifndef DOGEN_TEST_MODELS_ALL_PRIMITIVES_TYPES_A_CLASS_HPP
#define DOGEN_TEST_MODELS_ALL_PRIMITIVES_TYPES_A_CLASS_HPP
...
#include <algorithm>
#include "dogen/test_models/all_primitives/serialization/a_class_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::test_models::all_primitives::a_class& lhs,
    dogen::test_models::all_primitives::a_class& rhs) {
    lhs.swap(rhs);
}
