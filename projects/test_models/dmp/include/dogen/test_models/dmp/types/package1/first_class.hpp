 ...
 *
 */
#ifndef DOGEN_TEST_MODELS_DMP_TYPES_PACKAGE1_FIRST_CLASS_HPP
#define DOGEN_TEST_MODELS_DMP_TYPES_PACKAGE1_FIRST_CLASS_HPP
...
#include <algorithm>
#include "dogen/test_models/dmp/serialization/package1/first_class_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::test_models::dmp::package1::first_class& lhs,
    dogen::test_models::dmp::package1::first_class& rhs) {
    lhs.swap(rhs);
}
