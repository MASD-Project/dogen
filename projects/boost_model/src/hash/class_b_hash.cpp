...
inline std::size_t hash_boost_shared_ptr_dogen_boost_model_class_a(const boost::shared_ptr<dogen::boost_model::class_a>& v){
    std::size_t seed(0);
    combine(seed, *v);
    return seed;
}
...
inline std::size_t hash_std_unordered_map_int_boost_shared_ptr_dogen_boost_model_class_a_(const std::unordered_map<int, boost::shared_ptr<dogen::boost_model::class_a> >& v){
    std::size_t seed(0);
    for (const auto i : v) {
        combine(seed, i.first);
        combine(seed, hash_boost_shared_ptr_dogen_boost_model_class_a(i.second));
    }
    return seed;
}

inline std::size_t hash_boost_shared_ptr_dogen_boost_model_pkg1_class_c(const boost::shared_ptr<dogen::boost_model::pkg1::class_c>& v){
    std::size_t seed(0);
    combine(seed, *v);
    return seed;
}
...
inline std::size_t hash_std_vector_boost_shared_ptr_dogen_boost_model_class_base_(const std::vector<boost::shared_ptr<dogen::boost_model::class_base> >& v){
    std::size_t seed(0);
    for (const auto i : v) {
        combine(seed, hash_boost_shared_ptr_dogen_boost_model_class_base(i));
    }
    return seed;
}
