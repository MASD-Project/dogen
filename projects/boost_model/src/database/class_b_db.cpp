...
const std::string load_sql("select * from boost_model_class_b_load($0, $1, $2, $3, $4, $5, $6);");
...
const std::string erase_sql("select * from boost_model_class_b_erase($0, $1, $2, $3, $4, $5, $6);");
...
const std::string save_sql("select boost_model_class_b_save($0, $1, $2, $3, $4, $5, $6);");
