 ...
 *
 */
#ifndef DOGEN_BOOST_MODEL_DOMAIN_UNVERSIONED_KEY_HPP
#define DOGEN_BOOST_MODEL_DOMAIN_UNVERSIONED_KEY_HPP
...
#include <algorithm>
#include "dogen/boost_model/serialization/unversioned_key_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::boost_model::unversioned_key& lhs,
    dogen::boost_model::unversioned_key& rhs) {
    lhs.swap(rhs);
}
