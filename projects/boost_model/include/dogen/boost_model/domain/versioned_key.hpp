 ...
 *
 */
#ifndef DOGEN_BOOST_MODEL_DOMAIN_VERSIONED_KEY_HPP
#define DOGEN_BOOST_MODEL_DOMAIN_VERSIONED_KEY_HPP
...
#include "dogen/boost_model/serialization/versioned_key_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::boost_model::versioned_key& lhs,
    dogen::boost_model::versioned_key& rhs) {
    lhs.swap(rhs);
}
