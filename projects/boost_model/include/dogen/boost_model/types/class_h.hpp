 ...
 *
 */
#ifndef DOGEN_BOOST_MODEL_TYPES_CLASS_H_HPP
#define DOGEN_BOOST_MODEL_TYPES_CLASS_H_HPP
...
#include "dogen/boost_model/serialization/class_h_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::boost_model::class_h& lhs,
    dogen::boost_model::class_h& rhs) {
    lhs.swap(rhs);
}
