 ...
 *
 */
#ifndef DOGEN_BOOST_MODEL_TYPES_CLASS_G_HPP
#define DOGEN_BOOST_MODEL_TYPES_CLASS_G_HPP
...
#include <list>
#include "dogen/boost_model/serialization/class_g_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::boost_model::class_g& lhs,
    dogen::boost_model::class_g& rhs) {
    lhs.swap(rhs);
}
