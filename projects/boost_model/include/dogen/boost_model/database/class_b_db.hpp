 ...
 *
 */
#ifndef DOGEN_BOOST_MODEL_DATABASE_CLASS_B_DB_HPP
#define DOGEN_BOOST_MODEL_DATABASE_CLASS_B_DB_HPP
...
private:
    ...
    std::vector<dogen::boost_model::class_b> load_internal(
...
public:
    std::vector<dogen::boost_model::class_b> load(
        pqxx::connection& connection,
        const boost::optional<versioned_key> id =boost::optional<versioned_key>());

    void save(
        pqxx::connection& connection,
        std::vector<dogen::boost_model::class_b> values);
