...
BOOST_AUTO_TEST_CASE(empty_model_generates_expected_code) {
    ...
    const auto a(dia_sml::actual_empty_cpp_xml());
    const auto e(dia_sml::expected_empty_cpp_xml());
...
BOOST_AUTO_TEST_CASE(comments_model_generates_expected_code) {
    ...
    const auto e(dia_sml::expected_comments_cpp_xml());
...
BOOST_AUTO_TEST_CASE(enumeration_model_generates_expected_code) {
    ...
    const auto e(dia_sml::expected_enumeration_cpp_xml());
