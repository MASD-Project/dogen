...
// BOOST_IGNORE_AUTO_TEST_CASE(creating_file_info_for_pod_with_all_facets_enabled_produces_expected_results) {
...
// BOOST_IGNORE_AUTO_TEST_CASE(creating_file_info_for_pod_with_some_facets_enabled_produces_expected_results) {
