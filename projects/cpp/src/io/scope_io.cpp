...
inline std::ostream& operator<<(std::ostream& s, const std::list<dogen::cpp::scope>& v) {
    s << "[ ";
...
std::ostream& operator<<(std::ostream& s, const scope& v) {
    s << " { "
      << "\"__type__\": " << "\"dogen::cpp::scope\"" << ", "
      << "\"type\": " << v.type() << ", "
      << "\"inner_scopes\": " << v.inner_scopes() << ", "
      << "\"entities\": " << v.entities()
      << " }";
    return(s);
}
