...
inline std::ostream& operator<<(std::ostream& s, const std::list<dogen::cpp::property_view_model>& v) {
    s << "[ ";
    for (auto i(v.begin()); i != v.end(); ++i) {
        if (i != v.begin()) s << ", ";
        s << *i;
...
inline std::ostream& operator<<(std::ostream& s, const std::list<dogen::cpp::parent_view_model>& v) {
    s << "[ ";
    for (auto i(v.begin()); i != v.end(); ++i) {
        if (i != v.begin()) s << ", ";
        s << *i;
...
std::ostream& operator<<(std::ostream& s, const class_view_model& v) {
    ...
    s << " { "
      << "\"__type__\": " << "\"dogen::cpp::class_view_model\"" << ", "
