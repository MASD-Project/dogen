...
inline std::ostream& operator<<(std::ostream& s, const std::list<dogen::cpp::view_models::nested_type_view_model>& v) {
    s << "[ ";
...
std::ostream& operator<<(std::ostream& s, const nested_type_view_model& v) {
    ...
    s << " { "
      << "\"__type__\": " << "\"dogen::cpp::view_models::nested_type_view_model\"" << ", "
