...
std::ostream& operator<<(std::ostream& s, const specialized_property_sheet& v) {
    ...
    s << " { "
      << "\"__type__\": " << "\"dogen::cpp::specialized_property_sheet\"" << ", "
      ...
      << "\"forward_declaration_postfix\": " << "\"" << tidy_up_string(v.forward_declaration_postfix()) << "\""
      << " }";
    return(s);
}
