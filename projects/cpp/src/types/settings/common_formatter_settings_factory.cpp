...
static logger lg(logger_factory(
        "cpp.settings.common_formatter_settings_factory"));
...
common_formatter_settings_factory::common_formatter_settings_factory(
...
void common_formatter_settings_factory::
...
common_formatter_settings common_formatter_settings_factory::
...
common_formatter_settings_factory::
make(const dynamic::schema::object& o) const {
    std::unordered_map<std::string, common_formatter_settings> r;
