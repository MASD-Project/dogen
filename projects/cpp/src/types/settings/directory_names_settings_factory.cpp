...
directory_names_settings_factory::
directory_names_settings_factory(const dynamic::repository& rp)
  : fields_(setup_fields(rp)) { }

directory_names_settings_factory::fields directory_names_settings_factory::
...
directory_names_settings_factory::make(const dynamic::object& o) const {
