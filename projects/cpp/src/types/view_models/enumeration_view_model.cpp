...
const std::list<dogen::cpp::view_models::enumerator_view_model>& enumeration_view_model::enumerators() const {
    return enumerators_;
}

std::list<dogen::cpp::view_models::enumerator_view_model>& enumeration_view_model::enumerators() {
    return enumerators_;
}

void enumeration_view_model::enumerators(const std::list<dogen::cpp::view_models::enumerator_view_model>& v) {
    enumerators_ = v;
}
