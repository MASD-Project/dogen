...
const std::list<dogen::cpp::view_models::nested_type_view_model>& nested_type_view_model::children() const {
    return children_;
}

std::list<dogen::cpp::view_models::nested_type_view_model>& nested_type_view_model::children() {
    return children_;
}

void nested_type_view_model::children(const std::list<dogen::cpp::view_models::nested_type_view_model>& v) {
    children_ = v;
}
