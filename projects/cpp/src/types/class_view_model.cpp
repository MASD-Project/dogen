...
const std::list<dogen::cpp::property_view_model>& class_view_model::properties() const {
    return properties_;
}

std::list<dogen::cpp::property_view_model>& class_view_model::properties() {
    return properties_;
}

void class_view_model::properties(const std::list<dogen::cpp::property_view_model>& v) {
    properties_ = v;
}
...
const std::list<dogen::cpp::property_view_model>& class_view_model::all_properties() const {
    return all_properties_;
}

std::list<dogen::cpp::property_view_model>& class_view_model::all_properties() {
    return all_properties_;
}

void class_view_model::all_properties(const std::list<dogen::cpp::property_view_model>& v) {
    all_properties_ = v;
}
...
const std::list<dogen::cpp::parent_view_model>& class_view_model::parents() const {
    return parents_;
}

std::list<dogen::cpp::parent_view_model>& class_view_model::parents() {
    return parents_;
}

void class_view_model::parents(const std::list<dogen::cpp::parent_view_model>& v) {
    parents_ = v;
}
