 ...
 *
 */
#include "dogen/cpp/types/class_settings.hpp"
...
void class_settings::swap(class_settings& other) noexcept {
    using std::swap;
...
bool class_settings::operator==(const class_settings& rhs) const {
...
class_settings& class_settings::operator=(class_settings other) {
    using std::swap;
    swap(*this, other);
    return *this;
}

bool class_settings::enable_complete_constructor() const {
    return enable_complete_constructor_;
}

void class_settings::enable_complete_constructor(const bool v) {
    enable_complete_constructor_ = v;
}

bool class_settings::generate_defaulted_functions() const {
    return generate_defaulted_functions_;
}

void class_settings::generate_defaulted_functions(const bool v) {
    generate_defaulted_functions_ = v;
}

bool class_settings::generate_explicit_default_constructor() const {
    return generate_explicit_default_constructor_;
}

void class_settings::generate_explicit_default_constructor(const bool v) {
    generate_explicit_default_constructor_ = v;
}

bool class_settings::generate_explicit_move_constructor() const {
    return generate_explicit_move_constructor_;
}

void class_settings::generate_explicit_move_constructor(const bool v) {
    generate_explicit_move_constructor_ = v;
}

bool class_settings::generate_explicit_destructor() const {
    return generate_explicit_destructor_;
}

void class_settings::generate_explicit_destructor(const bool v) {
    generate_explicit_destructor_ = v;
}

bool class_settings::destructor_is_pure_virtual() const {
    return destructor_is_pure_virtual_;
}

void class_settings::destructor_is_pure_virtual(const bool v) {
    destructor_is_pure_virtual_ = v;
}

bool class_settings::generate_explicit_assignment_operator() const {
    return generate_explicit_assignment_operator_;
}

void class_settings::generate_explicit_assignment_operator(const bool v) {
    generate_explicit_assignment_operator_ = v;
}

bool class_settings::generate_complete_constructor() const {
    return generate_complete_constructor_;
}

void class_settings::generate_complete_constructor(const bool v) {
    generate_complete_constructor_ = v;
}

bool class_settings::generate_equality() const {
    return generate_equality_;
}

void class_settings::generate_equality(const bool v) {
