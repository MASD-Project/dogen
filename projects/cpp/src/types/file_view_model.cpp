...
const boost::optional<dogen::cpp::class_view_model>& file_view_model::class_vm() const {
    return class_vm_;
}

boost::optional<dogen::cpp::class_view_model>& file_view_model::class_vm() {
    return class_vm_;
}

void file_view_model::class_vm(const boost::optional<dogen::cpp::class_view_model>& v) {
    class_vm_ = v;
}
...
const boost::optional<dogen::cpp::enumeration_view_model>& file_view_model::enumeration_vm() const {
    return enumeration_vm_;
}

boost::optional<dogen::cpp::enumeration_view_model>& file_view_model::enumeration_vm() {
    return enumeration_vm_;
}

void file_view_model::enumeration_vm(const boost::optional<dogen::cpp::enumeration_view_model>& v) {
    enumeration_vm_ = v;
}
...
const boost::optional<dogen::cpp::exception_view_model>& file_view_model::exception_vm() const {
    return exception_vm_;
}

boost::optional<dogen::cpp::exception_view_model>& file_view_model::exception_vm() {
    return exception_vm_;
}

void file_view_model::exception_vm(const boost::optional<dogen::cpp::exception_view_model>& v) {
    exception_vm_ = v;
}
...
const boost::optional<dogen::cpp::registrar_view_model>& file_view_model::registrar_vm() const {
    return registrar_vm_;
}

boost::optional<dogen::cpp::registrar_view_model>& file_view_model::registrar_vm() {
    return registrar_vm_;
}

void file_view_model::registrar_vm(const boost::optional<dogen::cpp::registrar_view_model>& v) {
    registrar_vm_ = v;
}
...
const boost::optional<dogen::cpp::namespace_view_model>& file_view_model::namespace_vm() const {
    return namespace_vm_;
}

boost::optional<dogen::cpp::namespace_view_model>& file_view_model::namespace_vm() {
    return namespace_vm_;
}

void file_view_model::namespace_vm(const boost::optional<dogen::cpp::namespace_view_model>& v) {
    namespace_vm_ = v;
}
...
const boost::optional<dogen::cpp::visitor_view_model>& file_view_model::visitor_vm() const {
    return visitor_vm_;
}

boost::optional<dogen::cpp::visitor_view_model>& file_view_model::visitor_vm() {
    return visitor_vm_;
}

void file_view_model::visitor_vm(const boost::optional<dogen::cpp::visitor_view_model>& v) {
    visitor_vm_ = v;
}
