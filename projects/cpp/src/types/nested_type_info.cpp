...
const std::list<dogen::cpp::nested_type_info>& nested_type_info::children() const {
    return children_;
}

std::list<dogen::cpp::nested_type_info>& nested_type_info::children() {
    return children_;
}

void nested_type_info::children(const std::list<dogen::cpp::nested_type_info>& v) {
    children_ = v;
}
