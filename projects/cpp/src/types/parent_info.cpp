...
const std::list<dogen::cpp::property_info>& parent_info::properties() const {
    return properties_;
}

std::list<dogen::cpp::property_info>& parent_info::properties() {
    return properties_;
}

void parent_info::properties(const std::list<dogen::cpp::property_info>& v) {
    properties_ = v;
}
