...
#include "dogen/cpp/types/formattables/enabled_flag_expander.hpp"

namespace {

using namespace dogen::utility::log;
static logger lg(logger_factory("cpp.formattables.enabled_flag_expander"));
...
std::string enabled_flag_expander::name() const {
    static std::string name("cpp.formattables.enabled_flag_expander");
    return name;
}
