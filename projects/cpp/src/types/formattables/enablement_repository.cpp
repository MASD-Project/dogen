...
enablement_repository::enablement_repository(const std::unordered_map<dogen::sml::qname, std::unordered_map<std::string, bool> >& enablement_by_qname)
...
const std::unordered_map<dogen::sml::qname, std::unordered_map<std::string, bool> >& enablement_repository::enablement_by_qname() const {
    return enablement_by_qname_;
}

std::unordered_map<dogen::sml::qname, std::unordered_map<std::string, bool> >& enablement_repository::enablement_by_qname() {
    return enablement_by_qname_;
}

void enablement_repository::enablement_by_qname(const std::unordered_map<dogen::sml::qname, std::unordered_map<std::string, bool> >& v) {
