...
const std::list<dogen::cpp::formattables::property_info>& state::personal_properties() const {
    return personal_properties_;
}

std::list<dogen::cpp::formattables::property_info>& state::personal_properties() {
    return personal_properties_;
}

void state::personal_properties(const std::list<dogen::cpp::formattables::property_info>& v) {
...
const std::list<dogen::cpp::formattables::property_info>& state::all_properties() const {
    return all_properties_;
}

std::list<dogen::cpp::formattables::property_info>& state::all_properties() {
    return all_properties_;
}

void state::all_properties(const std::list<dogen::cpp::formattables::property_info>& v) {
    all_properties_ = v;
}
