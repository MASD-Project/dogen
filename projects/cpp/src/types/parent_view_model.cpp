...
const std::list<dogen::cpp::property_view_model>& parent_view_model::properties() const {
    return properties_;
}

std::list<dogen::cpp::property_view_model>& parent_view_model::properties() {
    return properties_;
}

void parent_view_model::properties(const std::list<dogen::cpp::property_view_model>& v) {
    properties_ = v;
}
