...
auto lg(logger_factory("cpp.sml_to_view_model"));
...
void sml_dfs_visitor::transform_nested_qname(
    ...
    using dogen::cpp::nested_type_view_model;
...
std::vector<file_view_model> sml_to_cpp_view_model::transform_packages() {
    std::vector<file_view_model> r;
...
sml_to_cpp_view_model::transform_registrar() const {
    ...
    using config::cpp_facet_types;
    auto lambda([&](const file_types flt) ->  file_view_model {
            file_view_model fvm;
