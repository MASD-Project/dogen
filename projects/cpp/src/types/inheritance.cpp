...
const std::list<dogen::cpp::parent_info>& inheritance::parents() const {
    return parents_;
}

std::list<dogen::cpp::parent_info>& inheritance::parents() {
    return parents_;
}

void inheritance::parents(const std::list<dogen::cpp::parent_info>& v) {
    parents_ = v;
}
