...
const dogen::cpp::nested_type_view_model& property_view_model::type() const {
    return type_;
}

dogen::cpp::nested_type_view_model& property_view_model::type() {
    return type_;
}

void property_view_model::type(const dogen::cpp::nested_type_view_model& v) {
    type_ = v;
}
