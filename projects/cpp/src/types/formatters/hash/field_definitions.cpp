...
dogen::dynamic::schema::field_definition create_supported() {
    ...
    r.scope(dogen::dynamic::schema::scope_types::entity);
    r.default_value(boost::make_shared<dogen::dynamic::schema::boolean>(true));
    return r;
}
...
field_definition create_class_header_formatter_inclusion_delimiter() {
    ...
    r.type(value_types::text);
    r.scope(scope_types::entity);
    r.default_value(boost::make_shared<text>("angle_brackets"));
    return r;
}
