...
common_formatter_settings_generator::common_formatter_settings_generator() : position_(0) { }

void common_formatter_settings_generator::
...
common_formatter_settings_generator::result_type
common_formatter_settings_generator::create(const unsigned int position) {
    common_formatter_settings r;
    common_formatter_settings_generator::populate(position, r);
    return r;
}
common_formatter_settings_generator::result_type*
common_formatter_settings_generator::create_ptr(const unsigned int position) {
    common_formatter_settings* p = new common_formatter_settings();
    common_formatter_settings_generator::populate(position, *p);
    return p;
}

common_formatter_settings_generator::result_type
common_formatter_settings_generator::operator()() {
