...
create_dogen_cpp_nested_type_view_model(const unsigned int position) {
    return dogen::cpp::nested_type_view_model_generator::create(position);
}
...
populate(const unsigned int position, result_type& v) {
    ...
    v.type(create_dogen_cpp_nested_type_view_model(position + 1));
