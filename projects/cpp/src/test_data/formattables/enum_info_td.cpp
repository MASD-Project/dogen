...
dogen::cpp::formattables::enumerator_info
create_dogen_cpp_formattables_enumerator_info(const unsigned int position) {
    return dogen::cpp::formattables::enumerator_info_generator::create(position);
}

std::list<dogen::cpp::formattables::enumerator_info> create_std_list_dogen_cpp_formattables_enumerator_info(unsigned int position) {
    std::list<dogen::cpp::formattables::enumerator_info> r;
    for (unsigned int i(0); i < 4; ++i) {
        r.push_back(create_dogen_cpp_formattables_enumerator_info(position + i));
    }
    return r;
}
