...
dogen::cpp::formattables::file_types
create_dogen_cpp_formattables_file_types(const unsigned int position) {
    return dogen::cpp::formattables::file_types_generator::create(position);
}
...
dogen::cpp::formattables::aspect_types
create_dogen_cpp_formattables_aspect_types(const unsigned int position) {
    return dogen::cpp::formattables::aspect_types_generator::create(position);
}
...
dogen::cpp::formattables::content_types
create_dogen_cpp_formattables_content_types(const unsigned int position) {
    return dogen::cpp::formattables::content_types_generator::create(position);
}
...
populate(const unsigned int position, result_type& v) {
    v.file_type(create_dogen_cpp_formattables_file_types(position + 0));
    v.facet_type(create_dogen_config_cpp_facet_types(position + 1));
    v.aspect_type(create_dogen_cpp_formattables_aspect_types(position + 2));
    v.name(create_dogen_sml_qname(position + 3));
    v.content_type(create_dogen_cpp_formattables_content_types(position + 4));
}
