...
std::unordered_map<dogen::tack::name, std::unordered_map<std::string, std::list<std::string> > > create_std_unordered_map_dogen_tack_name_std_unordered_map_std_string_std_list_std_string__(unsigned int position) {
    std::unordered_map<dogen::tack::name, std::unordered_map<std::string, std::list<std::string> > > r;
    for (unsigned int i(0); i < 4; ++i) {
        r.insert(std::make_pair(create_dogen_tack_name(position + i), create_std_unordered_map_std_string_std_list_std_string_(position + i)));
    }
    return r;
}
...
populate(const unsigned int position, result_type& v) {
    v.inclusion_dependencies_by_name(create_std_unordered_map_dogen_tack_name_std_unordered_map_std_string_std_list_std_string__(position + 0));
}
