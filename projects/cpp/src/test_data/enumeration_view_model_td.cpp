...
#include "dogen/cpp/test_data/enumerator_view_model_td.hpp"
...
dogen::cpp::enumerator_view_model
create_dogen_cpp_enumerator_view_model(const unsigned int position) {
    return dogen::cpp::enumerator_view_model_generator::create(position);
}

std::list<dogen::cpp::enumerator_view_model> create_std_list_dogen_cpp_enumerator_view_model(unsigned int position) {
    std::list<dogen::cpp::enumerator_view_model> r;
    for (unsigned int i(0); i < 10; ++i) {
        r.push_back(create_dogen_cpp_enumerator_view_model(position + i));
    }
    return r;
}
...
populate(const unsigned int position, result_type& v) {
    ...
    v.enumerators(create_std_list_dogen_cpp_enumerator_view_model(position + 1));
