...
create_dogen_cpp_nested_type_info(const unsigned int) {
    return dogen::cpp::nested_type_info();
}
...
populate(const unsigned int position, result_type& v) {
    ...
    v.children(create_std_list_dogen_cpp_nested_type_info(position + 15));
