 ...
 *
 */
#include "dogen/cpp/test_data/class_settings_td.hpp"
...
class_settings_generator::class_settings_generator() : position_(0) { }

void class_settings_generator::
...
class_settings_generator::result_type
class_settings_generator::create(const unsigned int position) {
    class_settings r;
    class_settings_generator::populate(position, r);
    return r;
}
class_settings_generator::result_type*
class_settings_generator::create_ptr(const unsigned int position) {
    class_settings* p = new class_settings();
    class_settings_generator::populate(position, *p);
    return p;
}

class_settings_generator::result_type
class_settings_generator::operator()() {
