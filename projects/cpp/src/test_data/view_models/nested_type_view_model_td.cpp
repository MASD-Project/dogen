...
create_dogen_cpp_view_models_nested_type_view_model(const unsigned int) {
    return dogen::cpp::view_models::nested_type_view_model();
}

std::list<dogen::cpp::view_models::nested_type_view_model> create_std_list_dogen_cpp_view_models_nested_type_view_model(unsigned int position) {
    std::list<dogen::cpp::view_models::nested_type_view_model> r;
    for (unsigned int i(0); i < 10; ++i) {
        r.push_back(create_dogen_cpp_view_models_nested_type_view_model(position + i));
    }
    return r;
}
