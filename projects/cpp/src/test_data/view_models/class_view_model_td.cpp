...
dogen::cpp::view_models::property_view_model
create_dogen_cpp_view_models_property_view_model(const unsigned int position) {
    return dogen::cpp::view_models::property_view_model_generator::create(position);
}

std::list<dogen::cpp::view_models::property_view_model> create_std_list_dogen_cpp_view_models_property_view_model(unsigned int position) {
    std::list<dogen::cpp::view_models::property_view_model> r;
    for (unsigned int i(0); i < 10; ++i) {
        r.push_back(create_dogen_cpp_view_models_property_view_model(position + i));
    }
    return r;
}
...
dogen::cpp::view_models::parent_view_model
create_dogen_cpp_view_models_parent_view_model(const unsigned int position) {
    return dogen::cpp::view_models::parent_view_model_generator::create(position);
}

std::list<dogen::cpp::view_models::parent_view_model> create_std_list_dogen_cpp_view_models_parent_view_model(unsigned int position) {
    std::list<dogen::cpp::view_models::parent_view_model> r;
    for (unsigned int i(0); i < 10; ++i) {
        r.push_back(create_dogen_cpp_view_models_parent_view_model(position + i));
    }
    return r;
}
...
populate(const unsigned int position, result_type& v) {
    ...
    v.properties(create_std_list_dogen_cpp_view_models_property_view_model(position + 2));
    v.all_properties(create_std_list_dogen_cpp_view_models_property_view_model(position + 3));
    ...
    v.parents(create_std_list_dogen_cpp_view_models_parent_view_model(position + 8));
