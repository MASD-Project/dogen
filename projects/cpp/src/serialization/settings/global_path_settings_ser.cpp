...
#include "dogen/cpp/serialization/settings/global_path_settings_ser.hpp"
...
void save(Archive& ar,
    const dogen::cpp::settings::global_path_settings& v,
...
void load(Archive& ar,
    dogen::cpp::settings::global_path_settings& v,
    const unsigned int /*version*/) {
    ar >> make_nvp("split_project", v.split_project_);
    ar >> make_nvp("file_type", v.file_type_);
    ar >> make_nvp("facet_directory", v.facet_directory_);
...
template void save(archive::polymorphic_oarchive& ar, const dogen::cpp::settings::global_path_settings& v, unsigned int version);
template void load(archive::polymorphic_iarchive& ar, dogen::cpp::settings::global_path_settings& v, unsigned int version);

template void save(archive::text_oarchive& ar, const dogen::cpp::settings::global_path_settings& v, unsigned int version);
template void load(archive::text_iarchive& ar, dogen::cpp::settings::global_path_settings& v, unsigned int version);

template void save(archive::binary_oarchive& ar, const dogen::cpp::settings::global_path_settings& v, unsigned int version);
template void load(archive::binary_iarchive& ar, dogen::cpp::settings::global_path_settings& v, unsigned int version);

template void save(archive::xml_oarchive& ar, const dogen::cpp::settings::global_path_settings& v, unsigned int version);
template void load(archive::xml_iarchive& ar, dogen::cpp::settings::global_path_settings& v, unsigned int version);
