...
#ifdef __linux__
template void save(eos::portable_oarchive& ar, const dogen::cpp::registrar_info& v, unsigned int version);
template void load(eos::portable_iarchive& ar, dogen::cpp::registrar_info& v, unsigned int version);
#endif
