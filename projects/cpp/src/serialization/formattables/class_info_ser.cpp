...
void save(Archive& ar,
    const dogen::cpp::formattables::class_info& v,
...
void load(Archive& ar,
    dogen::cpp::formattables::class_info& v,
    const unsigned int /*version*/) {
    ar >> make_nvp("entity", base_object<dogen::cpp::formattables::entity>(v));
...
template void save(archive::polymorphic_oarchive& ar, const dogen::cpp::formattables::class_info& v, unsigned int version);
template void load(archive::polymorphic_iarchive& ar, dogen::cpp::formattables::class_info& v, unsigned int version);

template void save(archive::text_oarchive& ar, const dogen::cpp::formattables::class_info& v, unsigned int version);
template void load(archive::text_iarchive& ar, dogen::cpp::formattables::class_info& v, unsigned int version);

template void save(archive::binary_oarchive& ar, const dogen::cpp::formattables::class_info& v, unsigned int version);
template void load(archive::binary_iarchive& ar, dogen::cpp::formattables::class_info& v, unsigned int version);

template void save(archive::xml_oarchive& ar, const dogen::cpp::formattables::class_info& v, unsigned int version);
template void load(archive::xml_iarchive& ar, dogen::cpp::formattables::class_info& v, unsigned int version);
