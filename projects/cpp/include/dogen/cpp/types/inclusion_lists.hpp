 ...
 *
 */
#ifndef DOGEN_CPP_TYPES_INCLUSION_LISTS_HPP
#define DOGEN_CPP_TYPES_INCLUSION_LISTS_HPP
...
#include <list>
#include <string>
#include "dogen/cpp/serialization/inclusion_lists_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::cpp::inclusion_lists& lhs,
    dogen::cpp::inclusion_lists& rhs) {
    lhs.swap(rhs);
}
