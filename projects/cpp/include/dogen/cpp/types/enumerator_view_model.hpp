 ...
 *
 */
#ifndef DOGEN_CPP_TYPES_ENUMERATOR_VIEW_MODEL_HPP
#define DOGEN_CPP_TYPES_ENUMERATOR_VIEW_MODEL_HPP
...
#include <algorithm>
#include <string>
#include "dogen/cpp/serialization/enumerator_view_model_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::cpp::enumerator_view_model& lhs,
    dogen::cpp::enumerator_view_model& rhs) {
    lhs.swap(rhs);
}
