 ...
 *
 */
#ifndef DOGEN_CPP_TYPES_VIEW_MODELS_ENUMERATION_VIEW_MODEL_HPP
#define DOGEN_CPP_TYPES_VIEW_MODELS_ENUMERATION_VIEW_MODEL_HPP
...
#include <list>
#include <string>
#include "dogen/cpp/serialization/view_models/enumeration_view_model_fwd_ser.hpp"
...
public:
    enumeration_view_model(
        ...
        const std::list<dogen::cpp::view_models::enumerator_view_model>& enumerators,
...
public:
    ...
    const std::list<dogen::cpp::view_models::enumerator_view_model>& enumerators() const;
    std::list<dogen::cpp::view_models::enumerator_view_model>& enumerators();
    void enumerators(const std::list<dogen::cpp::view_models::enumerator_view_model>& v);
    void enumerators(const std::list<dogen::cpp::view_models::enumerator_view_model>&& v);
...
private:
    ...
    std::list<dogen::cpp::view_models::enumerator_view_model> enumerators_;
    std::string name_;
...
template<>
inline void swap(
    dogen::cpp::view_models::enumeration_view_model& lhs,
    dogen::cpp::view_models::enumeration_view_model& rhs) {
    lhs.swap(rhs);
}
