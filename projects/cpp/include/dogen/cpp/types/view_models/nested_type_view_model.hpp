 ...
 *
 */
#ifndef DOGEN_CPP_TYPES_VIEW_MODELS_NESTED_TYPE_VIEW_MODEL_HPP
#define DOGEN_CPP_TYPES_VIEW_MODELS_NESTED_TYPE_VIEW_MODEL_HPP
...
#include <list>
#include <string>
#include "dogen/cpp/serialization/view_models/nested_type_view_model_fwd_ser.hpp"
...
public:
    ...
    const std::list<dogen::cpp::view_models::nested_type_view_model>& children() const;
    std::list<dogen::cpp::view_models::nested_type_view_model>& children();
    void children(const std::list<dogen::cpp::view_models::nested_type_view_model>& v);
    void children(const std::list<dogen::cpp::view_models::nested_type_view_model>&& v);
...
template<>
inline void swap(
    dogen::cpp::view_models::nested_type_view_model& lhs,
    dogen::cpp::view_models::nested_type_view_model& rhs) {
    lhs.swap(rhs);
}
