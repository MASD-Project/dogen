 ...
 *
 */
#ifndef DOGEN_CPP_TYPES_VIEW_MODELS_CMAKELISTS_VIEW_MODEL_HPP
#define DOGEN_CPP_TYPES_VIEW_MODELS_CMAKELISTS_VIEW_MODEL_HPP
...
#include <string>
#include "dogen/cpp/serialization/view_models/cmakelists_view_model_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::cpp::view_models::cmakelists_view_model& lhs,
    dogen::cpp::view_models::cmakelists_view_model& rhs) {
    lhs.swap(rhs);
}
