 ...
 *
 */
#ifndef DOGEN_CPP_TYPES_PARENT_INFO_HPP
#define DOGEN_CPP_TYPES_PARENT_INFO_HPP
...
#include <list>
#include <string>
#include "dogen/cpp/serialization/parent_info_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::cpp::parent_info& lhs,
    dogen::cpp::parent_info& rhs) {
    lhs.swap(rhs);
}
