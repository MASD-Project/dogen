 ...
 *
 */
#ifndef DOGEN_CPP_TYPES_CLASS_INFO_HPP
#define DOGEN_CPP_TYPES_CLASS_INFO_HPP
...
public:
     ...
     */
    /**@{*/
    const std::list<dogen::cpp::property_info>& properties() const;
    std::list<dogen::cpp::property_info>& properties();
    void properties(const std::list<dogen::cpp::property_info>& v);
    void properties(const std::list<dogen::cpp::property_info>&& v);
    /**@}*/
...
template<>
inline void swap(
    dogen::cpp::class_info& lhs,
    dogen::cpp::class_info& rhs) {
    lhs.swap(rhs);
}
