 ...
 *
 */
#ifndef DOGEN_CPP_TYPES_FORMATTERS_TYPES_FIELD_DEFINITIONS_HPP
#define DOGEN_CPP_TYPES_FORMATTERS_TYPES_FIELD_DEFINITIONS_HPP
...
/**
 * @brief Fields supported by the types facet and its formatters.
 */
