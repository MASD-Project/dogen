 ...
 *
 */
#ifndef DOGEN_CPP_TYPES_FORMATTERS_TEST_DATA_FIELD_DEFINITIONS_HPP
#define DOGEN_CPP_TYPES_FORMATTERS_TEST_DATA_FIELD_DEFINITIONS_HPP
...
/**
 * @brief Fields supported by the test data facet and its formatters.
 */
