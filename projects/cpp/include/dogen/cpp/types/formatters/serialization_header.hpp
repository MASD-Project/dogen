 ...
 *
 */
#ifndef DOGEN_CPP_TYPES_FORMATTERS_CPP_SERIALIZATION_HEADER_HPP
#define DOGEN_CPP_TYPES_FORMATTERS_CPP_SERIALIZATION_HEADER_HPP
...
private:
    void load_and_save_functions(const class_view_model& vm);
