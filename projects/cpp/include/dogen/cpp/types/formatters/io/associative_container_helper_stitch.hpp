 ...
 *
 */
#ifndef DOGEN_CPP_TYPES_FORMATTERS_IO_ASSOCIATIVE_CONTAINER_HELPER_STITCH_HPP
#define DOGEN_CPP_TYPES_FORMATTERS_IO_ASSOCIATIVE_CONTAINER_HELPER_STITCH_HPP
