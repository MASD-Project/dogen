 ...
 *
 */
#ifndef DOGEN_CPP_TYPES_FORMATTERS_IO_INSERTER_IMPLEMENTATION_HELPER_STITCH_HPP
#define DOGEN_CPP_TYPES_FORMATTERS_IO_INSERTER_IMPLEMENTATION_HELPER_STITCH_HPP
