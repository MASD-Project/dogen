 ...
 *
 */
#ifndef DOGEN_CPP_TYPES_FORMATTERS_IO_FIELD_DEFINITIONS_HPP
#define DOGEN_CPP_TYPES_FORMATTERS_IO_FIELD_DEFINITIONS_HPP
...
/**
 * @brief Fields supported by the io facet and its formatters.
 */
