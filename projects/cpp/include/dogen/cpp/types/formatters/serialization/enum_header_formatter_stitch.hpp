 ...
 *
 */
#ifndef DOGEN_CPP_TYPES_FORMATTERS_SERIALIZATION_ENUM_IMPLEMENTATION_FORMATTER_STITCH_HPP
#define DOGEN_CPP_TYPES_FORMATTERS_SERIALIZATION_ENUM_IMPLEMENTATION_FORMATTER_STITCH_HPP
