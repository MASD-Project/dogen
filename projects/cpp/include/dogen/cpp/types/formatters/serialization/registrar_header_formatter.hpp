 ...
 *
 */
#ifndef DOGEN_CPP_TYPES_FORMATTERS_SERIALIZATION_REGISTRAR_HEADER_FORMATTER_HPP
#define DOGEN_CPP_TYPES_FORMATTERS_SERIALIZATION_REGISTRAR_HEADER_FORMATTER_HPP
...
class registrar_header_formatter final : registrar_formatter_interface {
public:
    /**
