 ...
 *
 */
#ifndef DOGEN_CPP_TYPES_FORMATTERS_SERIALIZATION_REGISTRAR_HEADER_FORMATTER_STITCH_HPP
#define DOGEN_CPP_TYPES_FORMATTERS_SERIALIZATION_REGISTRAR_HEADER_FORMATTER_STITCH_HPP
