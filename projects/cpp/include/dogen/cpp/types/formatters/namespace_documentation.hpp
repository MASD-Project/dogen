 ...
 *
 */
#ifndef DOGEN_CPP_TYPES_FORMATTERS_NAMESPACE_DOCUMENTATION_HPP
#define DOGEN_CPP_TYPES_FORMATTERS_NAMESPACE_DOCUMENTATION_HPP
...
private:
    void format_namespace(const file_view_model& vm);
