 ...
 *
 */
#ifndef DOGEN_CPP_TYPES_FORMATTERS_ODB_ODB_OPTIONS_FORMATTER_HPP
#define DOGEN_CPP_TYPES_FORMATTERS_ODB_ODB_OPTIONS_FORMATTER_HPP
...
public:
    ...
    odb_options_formatter(odb_options_formatter&&) = default;
    ~odb_options_formatter() noexcept = default;
...
public:
    ...
    dogen::formatters::file
        format(const formattables::odb_options_info& c) const override;
