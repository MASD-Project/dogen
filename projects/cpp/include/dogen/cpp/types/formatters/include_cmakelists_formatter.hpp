 ...
 *
 */
#ifndef DOGEN_CPP_TYPES_FORMATTERS_INCLUDE_CMAKELISTS_FORMATTER_HPP
#define DOGEN_CPP_TYPES_FORMATTERS_INCLUDE_CMAKELISTS_FORMATTER_HPP
...
public:
    ...
    include_cmakelists_formatter(include_cmakelists_formatter&&) = default;
    ~include_cmakelists_formatter() noexcept = default;
