 ...
 *
 */
#ifndef DOGEN_CPP_TYPES_ODB_OPTIONS_INFO_HPP
#define DOGEN_CPP_TYPES_ODB_OPTIONS_INFO_HPP
...
#include <string>
#include "dogen/cpp/serialization/odb_options_info_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::cpp::odb_options_info& lhs,
    dogen::cpp::odb_options_info& rhs) {
    lhs.swap(rhs);
}
