 ...
 *
 */
#ifndef DOGEN_CPP_TYPES_PROPERTY_VIEW_MODEL_HPP
#define DOGEN_CPP_TYPES_PROPERTY_VIEW_MODEL_HPP
...
#include <utility>
#include <vector>
#include "dogen/cpp/serialization/property_view_model_fwd_ser.hpp"
...
public:
    property_view_model(
        ...
        const dogen::cpp::nested_type_view_model& type,
...
public:
     ...
     */
    /**@{*/
    const dogen::cpp::nested_type_view_model& type() const;
    dogen::cpp::nested_type_view_model& type();
    void type(const dogen::cpp::nested_type_view_model& v);
    void type(const dogen::cpp::nested_type_view_model&& v);
    /**@}*/
...
private:
    std::string name_;
    dogen::cpp::nested_type_view_model type_;
...
template<>
inline void swap(
    dogen::cpp::property_view_model& lhs,
    dogen::cpp::property_view_model& rhs) {
    lhs.swap(rhs);
}
