 ...
 *
 */
#ifndef DOGEN_CPP_TYPES_REGISTRAR_VIEW_MODEL_HPP
#define DOGEN_CPP_TYPES_REGISTRAR_VIEW_MODEL_HPP
...
#include <list>
#include <string>
#include "dogen/cpp/serialization/registrar_view_model_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::cpp::registrar_view_model& lhs,
    dogen::cpp::registrar_view_model& rhs) {
    lhs.swap(rhs);
}
