 ...
 *
 */
#ifndef DOGEN_CPP_TYPES_FORMATTABLES_CONTENT_DESCRIPTOR_HPP
#define DOGEN_CPP_TYPES_FORMATTABLES_CONTENT_DESCRIPTOR_HPP
...
private:
    dogen::cpp::formattables::file_types file_type_;
    dogen::config::cpp_facet_types facet_type_;
    dogen::cpp::formattables::aspect_types aspect_type_;
    dogen::sml::qname name_;
    dogen::cpp::formattables::content_types content_type_;
};
...
template<>
inline void swap(
    dogen::cpp::formattables::content_descriptor& lhs,
    dogen::cpp::formattables::content_descriptor& rhs) {
    lhs.swap(rhs);
}
