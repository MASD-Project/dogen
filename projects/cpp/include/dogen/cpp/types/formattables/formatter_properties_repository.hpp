...
public:
    explicit formatter_properties_repository(const std::unordered_map<std::string, std::unordered_map<std::string, dogen::cpp::formattables::formatter_properties> >& formatter_properties_by_name);
...
public:
    const std::unordered_map<std::string, std::unordered_map<std::string, dogen::cpp::formattables::formatter_properties> >& formatter_properties_by_name() const;
    std::unordered_map<std::string, std::unordered_map<std::string, dogen::cpp::formattables::formatter_properties> >& formatter_properties_by_name();
    void formatter_properties_by_name(const std::unordered_map<std::string, std::unordered_map<std::string, dogen::cpp::formattables::formatter_properties> >& v);
    void formatter_properties_by_name(const std::unordered_map<std::string, std::unordered_map<std::string, dogen::cpp::formattables::formatter_properties> >&& v);
...
private:
    std::unordered_map<std::string, std::unordered_map<std::string, dogen::cpp::formattables::formatter_properties> > formatter_properties_by_name_;
};
