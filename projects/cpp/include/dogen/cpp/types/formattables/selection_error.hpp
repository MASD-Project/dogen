 ...
 *
 */
#ifndef DOGEN_CPP_TYPES_FORMATTABLES_SELECTION_ERROR_HPP
#define DOGEN_CPP_TYPES_FORMATTABLES_SELECTION_ERROR_HPP
...
/**
 * @brief An error occurred whilst selecting data.
 */
