 ...
 *
 */
#ifndef DOGEN_CPP_TYPES_FORMATTABLES_CLASS_ASPECTS_HPP
#define DOGEN_CPP_TYPES_FORMATTABLES_CLASS_ASPECTS_HPP
...
#include <algorithm>
#include "dogen/cpp/serialization/formattables/class_aspects_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::cpp::formattables::class_aspects& lhs,
    dogen::cpp::formattables::class_aspects& rhs) {
    lhs.swap(rhs);
}
