 ...
 *
 */
#ifndef DOGEN_CPP_TYPES_FORMATTABLES_ABILITIES_HPP
#define DOGEN_CPP_TYPES_FORMATTABLES_ABILITIES_HPP
...
#include <algorithm>
#include "dogen/cpp/serialization/formattables/abilities_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::cpp::formattables::abilities& lhs,
    dogen::cpp::formattables::abilities& rhs) {
    lhs.swap(rhs);
}
