 ...
 *
 */
#ifndef DOGEN_CPP_TYPES_FORMATTABLES_INHERITANCE_HPP
#define DOGEN_CPP_TYPES_FORMATTABLES_INHERITANCE_HPP
...
#include <list>
#include <string>
#include "dogen/cpp/serialization/formattables/inheritance_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::cpp::formattables::inheritance& lhs,
    dogen::cpp::formattables::inheritance& rhs) {
    lhs.swap(rhs);
}
