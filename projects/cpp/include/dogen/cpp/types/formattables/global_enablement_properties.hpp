 ...
 *
 */
#ifndef DOGEN_CPP_TYPES_FORMATTABLES_GLOBAL_ENABLEMENT_PROPERTIES_HPP
#define DOGEN_CPP_TYPES_FORMATTABLES_GLOBAL_ENABLEMENT_PROPERTIES_HPP
...
#include <algorithm>
#include "dogen/cpp/serialization/formattables/global_enablement_properties_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::cpp::formattables::global_enablement_properties& lhs,
    dogen::cpp::formattables::global_enablement_properties& rhs) {
    lhs.swap(rhs);
}
