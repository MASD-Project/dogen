 ...
 *
 */
#ifndef DOGEN_CPP_TYPES_FORMATTABLES_PATH_DERIVATIVES_HPP
#define DOGEN_CPP_TYPES_FORMATTABLES_PATH_DERIVATIVES_HPP
...
#include "dogen/cpp/serialization/formattables/path_derivatives_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const path_derivatives& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, path_derivatives& v, unsigned int version);
...
template<>
inline void swap(
    dogen::cpp::formattables::path_derivatives& lhs,
    dogen::cpp::formattables::path_derivatives& rhs) {
    lhs.swap(rhs);
}
