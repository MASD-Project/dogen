 ...
 *
 */
#ifndef DOGEN_CPP_TYPES_FORMATTABLES_INCLUSION_DEPENDENCIES_REPOSITORY_HPP
#define DOGEN_CPP_TYPES_FORMATTABLES_INCLUSION_DEPENDENCIES_REPOSITORY_HPP
...
template<>
inline void swap(
    dogen::cpp::formattables::inclusion_dependencies_repository& lhs,
    dogen::cpp::formattables::inclusion_dependencies_repository& rhs) {
    lhs.swap(rhs);
}
