 ...
 *
 */
#ifndef DOGEN_CPP_TYPES_ELEMENT_INFO_VISITOR_HPP
#define DOGEN_CPP_TYPES_ELEMENT_INFO_VISITOR_HPP
...
class element_info_visitor {
public:
    virtual ~element_info_visitor() noexcept = 0;
...
inline element_info_visitor::~element_info_visitor() noexcept { }
