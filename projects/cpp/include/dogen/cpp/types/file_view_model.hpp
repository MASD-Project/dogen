 ...
 *
 */
#ifndef DOGEN_CPP_TYPES_FILE_VIEW_MODEL_HPP
#define DOGEN_CPP_TYPES_FILE_VIEW_MODEL_HPP
...
#include "dogen/cpp/serialization/file_view_model_fwd_ser.hpp"
...
public:
    file_view_model(
        ...
        const boost::optional<dogen::cpp::class_view_model>& class_vm,
        const boost::optional<dogen::cpp::enumeration_view_model>& enumeration_vm,
        const boost::optional<dogen::cpp::exception_view_model>& exception_vm,
        const boost::optional<dogen::cpp::registrar_view_model>& registrar_vm,
        const std::string& header_guard,
        const std::list<std::string>& system_includes,
        const std::list<std::string>& user_includes,
        const boost::filesystem::path& file_path,
        const boost::optional<dogen::cpp::namespace_view_model>& namespace_vm,
        const boost::optional<dogen::cpp::visitor_view_model>& visitor_vm);
...
public:
    ...
    const boost::optional<dogen::cpp::class_view_model>& class_vm() const;
    boost::optional<dogen::cpp::class_view_model>& class_vm();
    void class_vm(const boost::optional<dogen::cpp::class_view_model>& v);
    void class_vm(const boost::optional<dogen::cpp::class_view_model>&& v);

    const boost::optional<dogen::cpp::enumeration_view_model>& enumeration_vm() const;
    boost::optional<dogen::cpp::enumeration_view_model>& enumeration_vm();
    void enumeration_vm(const boost::optional<dogen::cpp::enumeration_view_model>& v);
    void enumeration_vm(const boost::optional<dogen::cpp::enumeration_view_model>&& v);

    const boost::optional<dogen::cpp::exception_view_model>& exception_vm() const;
    boost::optional<dogen::cpp::exception_view_model>& exception_vm();
    void exception_vm(const boost::optional<dogen::cpp::exception_view_model>& v);
    void exception_vm(const boost::optional<dogen::cpp::exception_view_model>&& v);

    const boost::optional<dogen::cpp::registrar_view_model>& registrar_vm() const;
    boost::optional<dogen::cpp::registrar_view_model>& registrar_vm();
    void registrar_vm(const boost::optional<dogen::cpp::registrar_view_model>& v);
    void registrar_vm(const boost::optional<dogen::cpp::registrar_view_model>&& v);
    ...
    const boost::optional<dogen::cpp::namespace_view_model>& namespace_vm() const;
    boost::optional<dogen::cpp::namespace_view_model>& namespace_vm();
    void namespace_vm(const boost::optional<dogen::cpp::namespace_view_model>& v);
    void namespace_vm(const boost::optional<dogen::cpp::namespace_view_model>&& v);

    const boost::optional<dogen::cpp::visitor_view_model>& visitor_vm() const;
    boost::optional<dogen::cpp::visitor_view_model>& visitor_vm();
    void visitor_vm(const boost::optional<dogen::cpp::visitor_view_model>& v);
    void visitor_vm(const boost::optional<dogen::cpp::visitor_view_model>&& v);
...
private:
    ...
    boost::optional<dogen::cpp::class_view_model> class_vm_;
    boost::optional<dogen::cpp::enumeration_view_model> enumeration_vm_;
    boost::optional<dogen::cpp::exception_view_model> exception_vm_;
    boost::optional<dogen::cpp::registrar_view_model> registrar_vm_;
    std::string header_guard_;
    std::list<std::string> system_includes_;
    std::list<std::string> user_includes_;
    boost::filesystem::path file_path_;
    boost::optional<dogen::cpp::namespace_view_model> namespace_vm_;
    boost::optional<dogen::cpp::visitor_view_model> visitor_vm_;
};
...
template<>
inline void swap(
    dogen::cpp::file_view_model& lhs,
    dogen::cpp::file_view_model& rhs) {
    lhs.swap(rhs);
}
