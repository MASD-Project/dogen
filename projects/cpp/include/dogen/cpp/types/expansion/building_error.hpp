 ...
 *
 */
#ifndef DOGEN_CPP_TYPES_EXPANSION_BUILDING_ERROR_HPP
#define DOGEN_CPP_TYPES_EXPANSION_BUILDING_ERROR_HPP
...
/**
 * @brief An error occurred in a factory whilst building.
 */
