 ...
 *
 */
#ifndef DOGEN_CPP_TYPES_EXPANSION_PATH_DERIVATIVES_HPP
#define DOGEN_CPP_TYPES_EXPANSION_PATH_DERIVATIVES_HPP
...
#include "dogen/cpp/serialization/expansion/path_derivatives_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::cpp::expansion::path_derivatives& lhs,
    dogen::cpp::expansion::path_derivatives& rhs) {
    lhs.swap(rhs);
}
