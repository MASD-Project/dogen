 ...
 *
 */
#ifndef DOGEN_CPP_TYPES_STATE_HPP
#define DOGEN_CPP_TYPES_STATE_HPP
...
#include <algorithm>
#include <list>
#include "dogen/cpp/serialization/state_fwd_ser.hpp"
...
public:
     ...
     */
    /**@{*/
    const std::list<dogen::cpp::property_info>& personal_properties() const;
    std::list<dogen::cpp::property_info>& personal_properties();
    void personal_properties(const std::list<dogen::cpp::property_info>& v);
    void personal_properties(const std::list<dogen::cpp::property_info>&& v);
    /**@}*/
     ...
     */
    /**@{*/
    const std::list<dogen::cpp::property_info>& all_properties() const;
    std::list<dogen::cpp::property_info>& all_properties();
    void all_properties(const std::list<dogen::cpp::property_info>& v);
    void all_properties(const std::list<dogen::cpp::property_info>&& v);
    /**@}*/
...
private:
    std::list<dogen::cpp::property_info> personal_properties_;
