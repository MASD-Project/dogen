 ...
 *
 */
#ifndef DOGEN_CPP_TYPES_CMAKELISTS_INFO_HPP
#define DOGEN_CPP_TYPES_CMAKELISTS_INFO_HPP
...
#include <string>
#include "dogen/cpp/serialization/cmakelists_info_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::cpp::cmakelists_info& lhs,
    dogen::cpp::cmakelists_info& rhs) {
    lhs.swap(rhs);
}
