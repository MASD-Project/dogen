 ...
 *
 */
#ifndef DOGEN_CPP_TYPES_STRING_TABLE_VIEW_MODEL_HPP
#define DOGEN_CPP_TYPES_STRING_TABLE_VIEW_MODEL_HPP
...
#include <string>
#include <utility>
#include "dogen/cpp/serialization/string_table_view_model_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::cpp::string_table_view_model& lhs,
    dogen::cpp::string_table_view_model& rhs) {
    lhs.swap(rhs);
}
