 ...
 *
 */
#ifndef DOGEN_CPP_TYPES_CLASS_VIEW_MODEL_HPP
#define DOGEN_CPP_TYPES_CLASS_VIEW_MODEL_HPP
...
#include <utility>
#include <vector>
#include "dogen/cpp/serialization/class_view_model_fwd_ser.hpp"
...
public:
    class_view_model(
        ...
        const std::list<dogen::cpp::property_view_model>& properties,
        const std::list<dogen::cpp::property_view_model>& all_properties,
        ...
        const std::list<dogen::cpp::parent_view_model>& parents,
...
public:
     ...
     */
    /**@{*/
    const std::list<dogen::cpp::property_view_model>& properties() const;
    std::list<dogen::cpp::property_view_model>& properties();
    void properties(const std::list<dogen::cpp::property_view_model>& v);
    void properties(const std::list<dogen::cpp::property_view_model>&& v);
    /**@}*/
     ...
     */
    /**@{*/
    const std::list<dogen::cpp::property_view_model>& all_properties() const;
    std::list<dogen::cpp::property_view_model>& all_properties();
    void all_properties(const std::list<dogen::cpp::property_view_model>& v);
    void all_properties(const std::list<dogen::cpp::property_view_model>&& v);
    /**@}*/
     ...
     */
    /**@{*/
    const std::list<dogen::cpp::parent_view_model>& parents() const;
    std::list<dogen::cpp::parent_view_model>& parents();
    void parents(const std::list<dogen::cpp::parent_view_model>& v);
    void parents(const std::list<dogen::cpp::parent_view_model>&& v);
    /**@}*/
...
private:
    ...
    std::string name_;
    std::list<dogen::cpp::property_view_model> properties_;
    std::list<dogen::cpp::property_view_model> all_properties_;
    ...
    std::list<dogen::cpp::parent_view_model> parents_;
    bool is_parent_;
...
template<>
inline void swap(
    dogen::cpp::class_view_model& lhs,
    dogen::cpp::class_view_model& rhs) {
    lhs.swap(rhs);
}
