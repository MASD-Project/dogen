 ...
 *
 */
#ifndef DOGEN_CPP_TYPES_SETTINGS_ODB_SETTINGS_HPP
#define DOGEN_CPP_TYPES_SETTINGS_ODB_SETTINGS_HPP
 ...
 */
class odb_settings final : public dogen::cpp::settings::opaque_settings {
public:
...
public:
    bool equals(const dogen::cpp::settings::opaque_settings& other) const override;
...
template<>
inline void swap(
    dogen::cpp::settings::odb_settings& lhs,
    dogen::cpp::settings::odb_settings& rhs) {
    lhs.swap(rhs);
}
