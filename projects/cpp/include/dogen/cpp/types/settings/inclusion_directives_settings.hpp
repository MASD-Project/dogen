 ...
 *
 */
#ifndef DOGEN_CPP_TYPES_SETTINGS_INCLUSION_DIRECTIVES_SETTINGS_HPP
#define DOGEN_CPP_TYPES_SETTINGS_INCLUSION_DIRECTIVES_SETTINGS_HPP
...
template<>
inline void swap(
    dogen::cpp::settings::inclusion_directives_settings& lhs,
    dogen::cpp::settings::inclusion_directives_settings& rhs) {
    lhs.swap(rhs);
}
