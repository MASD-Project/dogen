...
public:
    explicit bundle_repository(const std::unordered_map<dogen::sml::qname, dogen::cpp::settings::bundle>& bundles_by_qname);
...
public:
    const std::unordered_map<dogen::sml::qname, dogen::cpp::settings::bundle>& bundles_by_qname() const;
    std::unordered_map<dogen::sml::qname, dogen::cpp::settings::bundle>& bundles_by_qname();
    void bundles_by_qname(const std::unordered_map<dogen::sml::qname, dogen::cpp::settings::bundle>& v);
    void bundles_by_qname(const std::unordered_map<dogen::sml::qname, dogen::cpp::settings::bundle>&& v);
...
private:
    std::unordered_map<dogen::sml::qname, dogen::cpp::settings::bundle> bundles_by_qname_;
};
