 ...
 *
 */
#ifndef DOGEN_CPP_TYPES_SETTINGS_COMMON_FORMATTER_SETTINGS_HPP
#define DOGEN_CPP_TYPES_SETTINGS_COMMON_FORMATTER_SETTINGS_HPP
...
#include <set>
#include <string>
#include "dogen/cpp/serialization/settings/common_formatter_settings_fwd_ser.hpp"
...
class common_formatter_settings final {
public:
    common_formatter_settings(const common_formatter_settings&) = default;
    ~common_formatter_settings() = default;

public:
    common_formatter_settings();

public:
    common_formatter_settings(common_formatter_settings&& rhs);
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const common_formatter_settings& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, common_formatter_settings& v, unsigned int version);
...
public:
    bool operator==(const common_formatter_settings& rhs) const;
    bool operator!=(const common_formatter_settings& rhs) const {
        return !this->operator==(rhs);
    }

public:
    void swap(common_formatter_settings& other) noexcept;
    common_formatter_settings& operator=(common_formatter_settings other);
...
template<>
inline void swap(
    dogen::cpp::settings::common_formatter_settings& lhs,
    dogen::cpp::settings::common_formatter_settings& rhs) {
    lhs.swap(rhs);
}
