 ...
 *
 */
#ifndef DOGEN_CPP_TYPES_SETTINGS_COMMON_FORMATTER_SETTINGS_FACTORY_HPP
#define DOGEN_CPP_TYPES_SETTINGS_COMMON_FORMATTER_SETTINGS_FACTORY_HPP
...
/**
 * @brief Produces the common formatter settings for all formatters.
 */
class common_formatter_settings_factory {
public:
    /**
     ...
     */
    explicit common_formatter_settings_factory(
...
private:
    ...
    /**
     * @brief Creates the common settings for a given formatter.
     */
...
public:
    /**
     * @brief Produce the common formatter settings
     */
