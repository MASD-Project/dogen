 ...
 *
 */
#ifndef DOGEN_CPP_SERIALIZATION_SETTINGS_PATH_SETTINGS_SER_HPP
#define DOGEN_CPP_SERIALIZATION_SETTINGS_PATH_SETTINGS_SER_HPP
...
BOOST_SERIALIZATION_SPLIT_FREE(dogen::cpp::settings::path_settings)
namespace boost {
