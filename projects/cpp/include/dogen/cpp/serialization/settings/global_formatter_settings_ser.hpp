 ...
 *
 */
#ifndef DOGEN_CPP_SERIALIZATION_SETTINGS_GLOBAL_FORMATTER_SETTINGS_SER_HPP
#define DOGEN_CPP_SERIALIZATION_SETTINGS_GLOBAL_FORMATTER_SETTINGS_SER_HPP
...
BOOST_SERIALIZATION_SPLIT_FREE(dogen::cpp::settings::global_formatter_settings)
namespace boost {
