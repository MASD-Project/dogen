 ...
 *
 */
#ifndef DOGEN_CPP_SERIALIZATION_CONCEPT_INFO_SER_HPP
#define DOGEN_CPP_SERIALIZATION_CONCEPT_INFO_SER_HPP
...
BOOST_SERIALIZATION_SPLIT_FREE(dogen::cpp::concept_info)
namespace boost {
