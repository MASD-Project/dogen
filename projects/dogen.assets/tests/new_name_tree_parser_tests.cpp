...
/*
#include "dogen.assets/types/name_builder.hpp"
#include "dogen.assets/types/name_factory.hpp"
#include "dogen.assets/types/model.hpp"
#include "dogen.assets/types/parsing_error.hpp"
#include "dogen.assets/io/name_tree_io.hpp"
#include "dogen.assets/io/name_io.hpp"
#include "dogen.assets/types/merging_error.hpp"
#include "dogen.assets/types/name_tree_parser.hpp"
#include "dogen.assets/types/merger.hpp"*/
#include "dogen.utility/types/test/exception_checkers.hpp"
#include "dogen.assets/types/helpers/new_name_tree_parser.hpp"
...
const std::string test_module("dogen.assets.tests");
const std::string test_suite("name_tree_parser_tests");

const auto cpp(dogen::assets::meta_model::technical_space::cpp);

const auto top_level_modules = std::unordered_set<std::string>();
const auto model_location = dogen::assets::meta_model::location();
...
using dogen::assets::helpers::parsing_error;
...
/*
    dogen::assets::name_tree e;
    dogen::assets::name_factory nf;
    e.current(nf.build_element_name("type"));

    dogen::assets::name_tree c;
    c.current(nf.build_element_name("abc"));

    e.children(std::list<dogen::assets::name_tree> { c });

    const std::string s("type<abc>");
    dogen::assets::name_tree_parser ntp(top_level_modules, model_location, cpp);
...
/*
    ...
    dogen::assets::name_tree d;
    d.current(nf.build_element_name("cde"));

    e.children(std::list<dogen::assets::name_tree> { c, d });
...
BOOST_AUTO_TEST_CASE(parsing_vector_of_shared_ptr_produces_expected_name_trees) {
  ...
  /*  dogen::assets::name_tree e;
    ...
    c.children(std::list<dogen::assets::name_tree> { d });
    e.children(std::list<dogen::assets::name_tree> { c });
