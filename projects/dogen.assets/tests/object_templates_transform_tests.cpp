...
using dogen::assets::transforms::transformation_error;
using dogen::utility::test::asserter;
using dogen::assets::transforms::object_templates_transform;
using dogen::assets::meta_model::origin_types;
using object_types = dogen::assets::test::mock_model_factory::
    object_types;
using attribute_types = dogen::assets::test::mock_model_factory::
    attribute_types;
