...
#include "dogen.assets/types/helpers/validation_error.hpp"
...
using dogen::assets::helpers::validation_error;
using dogen::assets::meta_model::origin_types;
using dogen::assets::meta_model::technical_space;
using dogen::assets::helpers::pre_assembly_validator;
