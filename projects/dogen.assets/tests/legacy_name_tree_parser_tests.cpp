...
using dogen::assets::meta_model::name_tree;
using dogen::assets::helpers::legacy_name_tree_parser;
using dogen::assets::helpers::name_factory;
...
name_tree make(const dogen::assets::meta_model::name& n) {
    name_tree r;
    r.current(n);
    return r;
}
