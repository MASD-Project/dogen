...
using dogen::assets::transforms::associations_transform;
using object_types =
    dogen::assets::test::mock_model_factory::object_types;
using attribute_types =
    dogen::assets::test::mock_model_factory::attribute_types;
