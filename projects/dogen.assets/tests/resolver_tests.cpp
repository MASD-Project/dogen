...
#include "dogen.assets/test/mock_model_factory.hpp"
...
using dogen::assets::test::mock_model_factory;
...
const auto idx = dogen::assets::helpers::indices();
...
using dogen::assets::helpers::resolution_error;
using dogen::assets::helpers::indexer;
using dogen::assets::helpers::resolver;
using dogen::assets::transforms::merge_transform;
using dogen::assets::meta_model::model;
using dogen::assets::test::mock_context_factory;
...
BOOST_AUTO_TEST_CASE(object_with_attribute_type_in_the_same_model_resolves_successfully) {
    ...
    for (auto& pair : m.structural_elements().objects()) {
        ...
        if (o.local_attributes().size() == 1) {
            ...
            using dogen::assets::meta_model::fully_qualified_representation;
    ...
    using namespace dogen::assets::meta_model::structural;
...
BOOST_AUTO_TEST_CASE(object_with_attribute_type_in_different_model_results_in_successful_merge) {
    ...
    dogen::assets::meta_model::model_set ms;
