 ...
 *
 */
#ifndef DOGEN_ASSETS_LEXICAL_CAST_META_MODEL_ORIGIN_TYPES_LC_HPP
#define DOGEN_ASSETS_LEXICAL_CAST_META_MODEL_ORIGIN_TYPES_LC_HPP
...
template<>
inline std::string lexical_cast(const dogen::assets::meta_model::origin_types& v) {
...
template<>
inline dogen::assets::meta_model::origin_types lexical_cast(const std::string & s) {
    using dogen::assets::meta_model::origin_types;
