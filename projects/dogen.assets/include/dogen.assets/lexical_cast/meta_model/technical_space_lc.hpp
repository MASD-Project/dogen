 ...
 *
 */
#ifndef DOGEN_ASSETS_LEXICAL_CAST_META_MODEL_TECHNICAL_SPACE_LC_HPP
#define DOGEN_ASSETS_LEXICAL_CAST_META_MODEL_TECHNICAL_SPACE_LC_HPP
...
template<>
inline std::string lexical_cast(const dogen::assets::meta_model::technical_space& v) {
...
template<>
inline dogen::assets::meta_model::technical_space lexical_cast(const std::string & s) {
    using dogen::assets::meta_model::technical_space;
