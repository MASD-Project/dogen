 ...
 *
 */
#ifndef DOGEN_ASSETS_LEXICAL_CAST_META_MODEL_STATIC_STEREOTYPES_LC_HPP
#define DOGEN_ASSETS_LEXICAL_CAST_META_MODEL_STATIC_STEREOTYPES_LC_HPP
...
template<>
inline std::string lexical_cast(const dogen::assets::meta_model::static_stereotypes& v) {
...
template<>
inline dogen::assets::meta_model::static_stereotypes lexical_cast(const std::string & s) {
    using dogen::assets::meta_model::static_stereotypes;
