 ...
 *
 */
#ifndef DOGEN_ASSETS_LEXICAL_CAST_META_MODEL_FORMATTING_STYLES_LC_HPP
#define DOGEN_ASSETS_LEXICAL_CAST_META_MODEL_FORMATTING_STYLES_LC_HPP
...
template<>
inline std::string lexical_cast(const dogen::assets::meta_model::formatting_styles& v) {
    using dogen::assets::meta_model::formatting_styles;
...
template<>
inline dogen::assets::meta_model::formatting_styles lexical_cast(const std::string & s) {
    using dogen::assets::meta_model::formatting_styles;
