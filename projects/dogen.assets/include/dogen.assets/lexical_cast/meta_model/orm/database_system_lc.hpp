 ...
 *
 */
#ifndef DOGEN_ASSETS_LEXICAL_CAST_META_MODEL_ORM_DATABASE_SYSTEM_LC_HPP
#define DOGEN_ASSETS_LEXICAL_CAST_META_MODEL_ORM_DATABASE_SYSTEM_LC_HPP
...
template<>
inline std::string lexical_cast(const dogen::assets::meta_model::orm::database_system& v) {
...
template<>
inline dogen::assets::meta_model::orm::database_system lexical_cast(const std::string & s) {
    using dogen::assets::meta_model::orm::database_system;
