 ...
 *
 */
#ifndef DOGEN_ASSETS_LEXICAL_CAST_META_MODEL_ORM_LETTER_CASE_LC_HPP
#define DOGEN_ASSETS_LEXICAL_CAST_META_MODEL_ORM_LETTER_CASE_LC_HPP
...
template<>
inline std::string lexical_cast(const dogen::assets::meta_model::orm::letter_case& v) {
    using dogen::assets::meta_model::orm::letter_case;
...
template<>
inline dogen::assets::meta_model::orm::letter_case lexical_cast(const std::string & s) {
    using dogen::assets::meta_model::orm::letter_case;
