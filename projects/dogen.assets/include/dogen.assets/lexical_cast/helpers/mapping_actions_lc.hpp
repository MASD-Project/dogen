 ...
 *
 */
#ifndef DOGEN_ASSETS_LEXICAL_CAST_HELPERS_MAPPING_ACTIONS_LC_HPP
#define DOGEN_ASSETS_LEXICAL_CAST_HELPERS_MAPPING_ACTIONS_LC_HPP
...
template<>
inline std::string lexical_cast(const dogen::assets::helpers::mapping_actions& v) {
    using dogen::assets::helpers::mapping_actions;
...
template<>
inline dogen::assets::helpers::mapping_actions lexical_cast(const std::string & s) {
    using dogen::assets::helpers::mapping_actions;
