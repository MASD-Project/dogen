 ...
 *
 */
#ifndef DOGEN_ASSETS_TYPES_META_MODEL_LOCATION_HPP
#define DOGEN_ASSETS_TYPES_META_MODEL_LOCATION_HPP
...
template<>
inline void swap(
    dogen::assets::meta_model::location& lhs,
    dogen::assets::meta_model::location& rhs) {
    lhs.swap(rhs);
}
