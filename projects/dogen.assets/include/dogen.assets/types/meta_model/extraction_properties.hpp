 ...
 *
 */
#ifndef DOGEN_ASSETS_TYPES_META_MODEL_EXTRACTION_PROPERTIES_HPP
#define DOGEN_ASSETS_TYPES_META_MODEL_EXTRACTION_PROPERTIES_HPP
...
template<>
inline void swap(
    dogen::assets::meta_model::extraction_properties& lhs,
    dogen::assets::meta_model::extraction_properties& rhs) {
    lhs.swap(rhs);
}
