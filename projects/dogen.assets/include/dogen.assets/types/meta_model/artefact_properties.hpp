 ...
 *
 */
#ifndef DOGEN_ASSETS_TYPES_META_MODEL_ARTEFACT_PROPERTIES_HPP
#define DOGEN_ASSETS_TYPES_META_MODEL_ARTEFACT_PROPERTIES_HPP
...
public:
    artefact_properties(
        ...
        const dogen::assets::meta_model::formatting_styles formatting_style,
...
public:
    ...
    dogen::assets::meta_model::formatting_styles formatting_style() const;
    void formatting_style(const dogen::assets::meta_model::formatting_styles v);
...
private:
    ...
    dogen::assets::meta_model::formatting_styles formatting_style_;
...
template<>
inline void swap(
    dogen::assets::meta_model::artefact_properties& lhs,
    dogen::assets::meta_model::artefact_properties& rhs) {
    lhs.swap(rhs);
}
