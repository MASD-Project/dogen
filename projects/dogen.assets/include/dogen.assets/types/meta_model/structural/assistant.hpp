 ...
 *
 */
#ifndef DOGEN_ASSETS_TYPES_META_MODEL_STRUCTURAL_ASSISTANT_HPP
#define DOGEN_ASSETS_TYPES_META_MODEL_STRUCTURAL_ASSISTANT_HPP
...
template<>
inline void swap(
    dogen::assets::meta_model::structural::assistant& lhs,
    dogen::assets::meta_model::structural::assistant& rhs) {
    lhs.swap(rhs);
}
