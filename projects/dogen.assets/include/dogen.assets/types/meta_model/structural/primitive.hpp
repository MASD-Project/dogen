 ...
 *
 */
#ifndef DOGEN_ASSETS_TYPES_META_MODEL_STRUCTURAL_PRIMITIVE_HPP
#define DOGEN_ASSETS_TYPES_META_MODEL_STRUCTURAL_PRIMITIVE_HPP
 ...
 */
class primitive final : public dogen::assets::meta_model::element {
public:
...
public:
     ...
     */
    /**@{*/
    const dogen::assets::meta_model::attribute& value_attribute() const;
    dogen::assets::meta_model::attribute& value_attribute();
    void value_attribute(const dogen::assets::meta_model::attribute& v);
    void value_attribute(const dogen::assets::meta_model::attribute&& v);
    /**@}*/
    ...
    const boost::optional<dogen::assets::meta_model::orm::primitive_properties>& orm_properties() const;
    boost::optional<dogen::assets::meta_model::orm::primitive_properties>& orm_properties();
    void orm_properties(const boost::optional<dogen::assets::meta_model::orm::primitive_properties>& v);
    void orm_properties(const boost::optional<dogen::assets::meta_model::orm::primitive_properties>&& v);
...
private:
    bool is_nullable_;
    dogen::assets::meta_model::attribute value_attribute_;
    bool use_type_aliasing_;
    bool is_immutable_;
    boost::optional<dogen::assets::meta_model::orm::primitive_properties> orm_properties_;
};
...
template<>
inline void swap(
    dogen::assets::meta_model::structural::primitive& lhs,
    dogen::assets::meta_model::structural::primitive& rhs) {
    lhs.swap(rhs);
}
