 ...
 *
 */
#ifndef DOGEN_ASSETS_TYPES_META_MODEL_STRUCTURAL_ENUMERATOR_HPP
#define DOGEN_ASSETS_TYPES_META_MODEL_STRUCTURAL_ENUMERATOR_HPP
...
template<>
inline void swap(
    dogen::assets::meta_model::structural::enumerator& lhs,
    dogen::assets::meta_model::structural::enumerator& rhs) {
    lhs.swap(rhs);
}
