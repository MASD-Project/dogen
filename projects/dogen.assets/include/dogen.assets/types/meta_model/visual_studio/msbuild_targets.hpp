 ...
 *
 */
#ifndef DOGEN_ASSETS_TYPES_META_MODEL_VISUAL_STUDIO_MSBUILD_TARGETS_HPP
#define DOGEN_ASSETS_TYPES_META_MODEL_VISUAL_STUDIO_MSBUILD_TARGETS_HPP
...
public:
    msbuild_targets(
        ...
        const dogen::assets::meta_model::orm::odb_targets& odb_targets);
...
public:
    const dogen::assets::meta_model::orm::odb_targets& odb_targets() const;
    dogen::assets::meta_model::orm::odb_targets& odb_targets();
    void odb_targets(const dogen::assets::meta_model::orm::odb_targets& v);
    void odb_targets(const dogen::assets::meta_model::orm::odb_targets&& v);
...
private:
    dogen::assets::meta_model::orm::odb_targets odb_targets_;
};
...
template<>
inline void swap(
    dogen::assets::meta_model::visual_studio::msbuild_targets& lhs,
    dogen::assets::meta_model::visual_studio::msbuild_targets& rhs) {
    lhs.swap(rhs);
}
