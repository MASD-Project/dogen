 ...
 *
 */
#ifndef DOGEN_ASSETS_TYPES_META_MODEL_BUILD_CMAKELISTS_HPP
#define DOGEN_ASSETS_TYPES_META_MODEL_BUILD_CMAKELISTS_HPP
...
template<>
inline void swap(
    dogen::assets::meta_model::build::cmakelists& lhs,
    dogen::assets::meta_model::build::cmakelists& rhs) {
    lhs.swap(rhs);
}
