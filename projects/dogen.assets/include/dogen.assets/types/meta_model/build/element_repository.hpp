...
public:
    explicit element_repository(const std::unordered_map<std::string, boost::shared_ptr<dogen::assets::meta_model::build::cmakelists> >& cmakelists);

public:
    const std::unordered_map<std::string, boost::shared_ptr<dogen::assets::meta_model::build::cmakelists> >& cmakelists() const;
    std::unordered_map<std::string, boost::shared_ptr<dogen::assets::meta_model::build::cmakelists> >& cmakelists();
    void cmakelists(const std::unordered_map<std::string, boost::shared_ptr<dogen::assets::meta_model::build::cmakelists> >& v);
    void cmakelists(const std::unordered_map<std::string, boost::shared_ptr<dogen::assets::meta_model::build::cmakelists> >&& v);
...
private:
    std::unordered_map<std::string, boost::shared_ptr<dogen::assets::meta_model::build::cmakelists> > cmakelists_;
};
