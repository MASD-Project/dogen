 ...
 *
 */
#ifndef DOGEN_ASSETS_TYPES_META_MODEL_NAME_TREE_HPP
#define DOGEN_ASSETS_TYPES_META_MODEL_NAME_TREE_HPP
...
public:
     ...
     */
    /**@{*/
    const dogen::assets::meta_model::name& current() const;
    dogen::assets::meta_model::name& current();
    void current(const dogen::assets::meta_model::name& v);
    void current(const dogen::assets::meta_model::name&& v);
    /**@}*/
     ...
     */
    /**@{*/
    const std::list<dogen::assets::meta_model::name_tree>& children() const;
    std::list<dogen::assets::meta_model::name_tree>& children();
    void children(const std::list<dogen::assets::meta_model::name_tree>& v);
    void children(const std::list<dogen::assets::meta_model::name_tree>&& v);
    /**@}*/
...
private:
    ...
    dogen::assets::meta_model::name current_;
    std::list<dogen::assets::meta_model::name_tree> children_;
...
template<>
inline void swap(
    dogen::assets::meta_model::name_tree& lhs,
    dogen::assets::meta_model::name_tree& rhs) {
    lhs.swap(rhs);
}
