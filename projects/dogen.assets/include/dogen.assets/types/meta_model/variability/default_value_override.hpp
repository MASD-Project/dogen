 ...
 *
 */
#ifndef DOGEN_ASSETS_TYPES_META_MODEL_VARIABILITY_DEFAULT_VALUE_OVERRIDE_HPP
#define DOGEN_ASSETS_TYPES_META_MODEL_VARIABILITY_DEFAULT_VALUE_OVERRIDE_HPP
...
template<>
inline void swap(
    dogen::assets::meta_model::variability::default_value_override& lhs,
    dogen::assets::meta_model::variability::default_value_override& rhs) {
    lhs.swap(rhs);
}
