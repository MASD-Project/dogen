 ...
 *
 */
#ifndef DOGEN_ASSETS_TYPES_META_MODEL_MAPPING_FIXED_MAPPABLE_HPP
#define DOGEN_ASSETS_TYPES_META_MODEL_MAPPING_FIXED_MAPPABLE_HPP
 ...
 * variability types.
 */
class fixed_mappable final : public dogen::assets::meta_model::element {
public:
...
template<>
inline void swap(
    dogen::assets::meta_model::mapping::fixed_mappable& lhs,
    dogen::assets::meta_model::mapping::fixed_mappable& rhs) {
    lhs.swap(rhs);
}
