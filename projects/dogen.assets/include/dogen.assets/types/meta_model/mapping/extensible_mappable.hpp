 ...
 *
 */
#ifndef DOGEN_ASSETS_TYPES_META_MODEL_MAPPING_EXTENSIBLE_MAPPABLE_HPP
#define DOGEN_ASSETS_TYPES_META_MODEL_MAPPING_EXTENSIBLE_MAPPABLE_HPP
 ...
 */
class extensible_mappable final : public dogen::assets::meta_model::element {
public:
...
public:
    extensible_mappable(
        ...
        const std::list<dogen::assets::meta_model::mapping::destination>& destinations);
...
public:
     ...
     */
    /**@{*/
    const std::list<dogen::assets::meta_model::mapping::destination>& destinations() const;
    std::list<dogen::assets::meta_model::mapping::destination>& destinations();
    void destinations(const std::list<dogen::assets::meta_model::mapping::destination>& v);
    void destinations(const std::list<dogen::assets::meta_model::mapping::destination>&& v);
    /**@}*/
...
private:
    std::list<dogen::assets::meta_model::mapping::destination> destinations_;
};
...
template<>
inline void swap(
    dogen::assets::meta_model::mapping::extensible_mappable& lhs,
    dogen::assets::meta_model::mapping::extensible_mappable& rhs) {
    lhs.swap(rhs);
}
