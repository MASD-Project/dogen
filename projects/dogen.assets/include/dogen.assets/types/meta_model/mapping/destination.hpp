 ...
 *
 */
#ifndef DOGEN_ASSETS_TYPES_META_MODEL_MAPPING_DESTINATION_HPP
#define DOGEN_ASSETS_TYPES_META_MODEL_MAPPING_DESTINATION_HPP
...
template<>
inline void swap(
    dogen::assets::meta_model::mapping::destination& lhs,
    dogen::assets::meta_model::mapping::destination& rhs) {
    lhs.swap(rhs);
}
