 ...
 *
 */
#ifndef DOGEN_ASSETS_TYPES_META_MODEL_DECORATION_MODELINE_FIELD_HPP
#define DOGEN_ASSETS_TYPES_META_MODEL_DECORATION_MODELINE_FIELD_HPP
...
template<>
inline void swap(
    dogen::assets::meta_model::decoration::modeline_field& lhs,
    dogen::assets::meta_model::decoration::modeline_field& rhs) {
    lhs.swap(rhs);
}
