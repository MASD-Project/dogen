 ...
 *
 */
#ifndef DOGEN_ASSETS_TYPES_META_MODEL_DECORATION_ELEMENT_PROPERTIES_HPP
#define DOGEN_ASSETS_TYPES_META_MODEL_DECORATION_ELEMENT_PROPERTIES_HPP
...
template<>
inline void swap(
    dogen::assets::meta_model::decoration::element_properties& lhs,
    dogen::assets::meta_model::decoration::element_properties& rhs) {
    lhs.swap(rhs);
}
