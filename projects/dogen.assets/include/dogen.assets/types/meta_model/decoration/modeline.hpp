 ...
 *
 */
#ifndef DOGEN_ASSETS_TYPES_META_MODEL_DECORATION_MODELINE_HPP
#define DOGEN_ASSETS_TYPES_META_MODEL_DECORATION_MODELINE_HPP
...
#include "dogen.assets/types/meta_model/decoration/modeline_field.hpp"
 ...
 * separator is @e ;.
 */
class modeline final : public dogen::assets::meta_model::element {
public:
...
public:
     ...
     */
    /**@{*/
    dogen::assets::meta_model::decoration::editor editor() const;
    void editor(const dogen::assets::meta_model::decoration::editor v);
    /**@}*/
     ...
     */
    /**@{*/
    dogen::assets::meta_model::decoration::modeline_location location() const;
    void location(const dogen::assets::meta_model::decoration::modeline_location v);
    /**@}*/
     ...
     */
    /**@{*/
    const std::list<dogen::assets::meta_model::decoration::modeline_field>& fields() const;
    std::list<dogen::assets::meta_model::decoration::modeline_field>& fields();
    void fields(const std::list<dogen::assets::meta_model::decoration::modeline_field>& v);
    void fields(const std::list<dogen::assets::meta_model::decoration::modeline_field>&& v);
    /**@}*/
...
private:
    dogen::assets::meta_model::decoration::editor editor_;
    dogen::assets::meta_model::decoration::modeline_location location_;
    std::list<dogen::assets::meta_model::decoration::modeline_field> fields_;
...
template<>
inline void swap(
    dogen::assets::meta_model::decoration::modeline& lhs,
    dogen::assets::meta_model::decoration::modeline& rhs) {
    lhs.swap(rhs);
}
