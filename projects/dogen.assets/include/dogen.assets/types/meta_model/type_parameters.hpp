 ...
 *
 */
#ifndef DOGEN_ASSETS_TYPES_META_MODEL_TYPE_PARAMETERS_HPP
#define DOGEN_ASSETS_TYPES_META_MODEL_TYPE_PARAMETERS_HPP
...
template<>
inline void swap(
    dogen::assets::meta_model::type_parameters& lhs,
    dogen::assets::meta_model::type_parameters& rhs) {
    lhs.swap(rhs);
}
