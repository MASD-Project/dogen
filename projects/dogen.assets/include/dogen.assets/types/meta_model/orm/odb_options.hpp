 ...
 *
 */
#ifndef DOGEN_ASSETS_TYPES_META_MODEL_ORM_ODB_OPTIONS_HPP
#define DOGEN_ASSETS_TYPES_META_MODEL_ORM_ODB_OPTIONS_HPP
...
template<>
inline void swap(
    dogen::assets::meta_model::orm::odb_options& lhs,
    dogen::assets::meta_model::orm::odb_options& rhs) {
    lhs.swap(rhs);
}
