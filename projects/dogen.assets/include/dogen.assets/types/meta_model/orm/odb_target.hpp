 ...
 *
 */
#ifndef DOGEN_ASSETS_TYPES_META_MODEL_ORM_ODB_TARGET_HPP
#define DOGEN_ASSETS_TYPES_META_MODEL_ORM_ODB_TARGET_HPP
...
template<>
inline void swap(
    dogen::assets::meta_model::orm::odb_target& lhs,
    dogen::assets::meta_model::orm::odb_target& rhs) {
    lhs.swap(rhs);
}
