 ...
 *
 */
#ifndef DOGEN_ASSETS_TYPES_META_MODEL_ORM_TYPE_MAPPING_HPP
#define DOGEN_ASSETS_TYPES_META_MODEL_ORM_TYPE_MAPPING_HPP
...
public:
    type_mapping(
        ...
        const boost::optional<dogen::assets::meta_model::orm::database_system>& database);
...
public:
     ...
     */
    /**@{*/
    const boost::optional<dogen::assets::meta_model::orm::database_system>& database() const;
    boost::optional<dogen::assets::meta_model::orm::database_system>& database();
    void database(const boost::optional<dogen::assets::meta_model::orm::database_system>& v);
    void database(const boost::optional<dogen::assets::meta_model::orm::database_system>&& v);
    /**@}*/
...
private:
    ...
    boost::optional<dogen::assets::meta_model::orm::database_system> database_;
};
...
template<>
inline void swap(
    dogen::assets::meta_model::orm::type_mapping& lhs,
    dogen::assets::meta_model::orm::type_mapping& rhs) {
    lhs.swap(rhs);
}
