 ...
 *
 */
#ifndef DOGEN_ASSETS_TYPES_META_MODEL_ORM_MODEL_PROPERTIES_HPP
#define DOGEN_ASSETS_TYPES_META_MODEL_ORM_MODEL_PROPERTIES_HPP
...
public:
    ...
    const std::vector<dogen::assets::meta_model::orm::database_system>& database_systems() const;
    std::vector<dogen::assets::meta_model::orm::database_system>& database_systems();
    void database_systems(const std::vector<dogen::assets::meta_model::orm::database_system>& v);
    void database_systems(const std::vector<dogen::assets::meta_model::orm::database_system>&& v);
...
template<>
inline void swap(
    dogen::assets::meta_model::orm::model_properties& lhs,
    dogen::assets::meta_model::orm::model_properties& rhs) {
    lhs.swap(rhs);
}
