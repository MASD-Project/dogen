 ...
 *
 */
#ifndef DOGEN_ASSETS_TYPES_META_MODEL_ORM_MODULE_PROPERTIES_HPP
#define DOGEN_ASSETS_TYPES_META_MODEL_ORM_MODULE_PROPERTIES_HPP
...
template<>
inline void swap(
    dogen::assets::meta_model::orm::module_properties& lhs,
    dogen::assets::meta_model::orm::module_properties& rhs) {
    lhs.swap(rhs);
}
