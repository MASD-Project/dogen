 ...
 *
 */
#ifndef DOGEN_ASSETS_TYPES_META_MODEL_ORM_PRIMITIVE_PROPERTIES_HPP
#define DOGEN_ASSETS_TYPES_META_MODEL_ORM_PRIMITIVE_PROPERTIES_HPP
...
template<>
inline void swap(
    dogen::assets::meta_model::orm::primitive_properties& lhs,
    dogen::assets::meta_model::orm::primitive_properties& rhs) {
    lhs.swap(rhs);
}
