 ...
 *
 */
#ifndef DOGEN_ASSETS_TYPES_META_MODEL_ORM_ODB_TARGETS_HPP
#define DOGEN_ASSETS_TYPES_META_MODEL_ORM_ODB_TARGETS_HPP
...
public:
    odb_targets(
        ...
        const std::list<dogen::assets::meta_model::orm::odb_target>& targets);
...
public:
    ...
    const std::list<dogen::assets::meta_model::orm::odb_target>& targets() const;
    std::list<dogen::assets::meta_model::orm::odb_target>& targets();
    void targets(const std::list<dogen::assets::meta_model::orm::odb_target>& v);
    void targets(const std::list<dogen::assets::meta_model::orm::odb_target>&& v);
...
private:
    ...
    std::list<dogen::assets::meta_model::orm::odb_target> targets_;
};
...
template<>
inline void swap(
    dogen::assets::meta_model::orm::odb_targets& lhs,
    dogen::assets::meta_model::orm::odb_targets& rhs) {
    lhs.swap(rhs);
}
