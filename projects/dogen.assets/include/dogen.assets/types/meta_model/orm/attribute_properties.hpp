 ...
 *
 */
#ifndef DOGEN_ASSETS_TYPES_META_MODEL_ORM_ATTRIBUTE_PROPERTIES_HPP
#define DOGEN_ASSETS_TYPES_META_MODEL_ORM_ATTRIBUTE_PROPERTIES_HPP
...
template<>
inline void swap(
    dogen::assets::meta_model::orm::attribute_properties& lhs,
    dogen::assets::meta_model::orm::attribute_properties& rhs) {
    lhs.swap(rhs);
}
