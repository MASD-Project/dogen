 ...
 *
 */
#ifndef DOGEN_ASSETS_TYPES_META_MODEL_FULLY_QUALIFIED_REPRESENTATION_HPP
#define DOGEN_ASSETS_TYPES_META_MODEL_FULLY_QUALIFIED_REPRESENTATION_HPP
...
template<>
inline void swap(
    dogen::assets::meta_model::fully_qualified_representation& lhs,
    dogen::assets::meta_model::fully_qualified_representation& rhs) {
    lhs.swap(rhs);
}
