 ...
 *
 */
#ifndef DOGEN_ASSETS_TYPES_TRANSFORMS_EXTENSIBLE_MAPPING_TRANSFORM_HPP
#define DOGEN_ASSETS_TYPES_TRANSFORMS_EXTENSIBLE_MAPPING_TRANSFORM_HPP
...
private:
    ...
    static std::unordered_map<std::string,
                       ...
                       >
    obtain_mappables(const assets::meta_model::model_set& ms);
...
public:
    static assets::meta_model::model_set apply(const context& ctx,
        const assets::meta_model::model_set& src,
