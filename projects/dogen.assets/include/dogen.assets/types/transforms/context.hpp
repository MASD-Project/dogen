 ...
 *
 */
#ifndef DOGEN_ASSETS_TYPES_TRANSFORMS_CONTEXT_HPP
#define DOGEN_ASSETS_TYPES_TRANSFORMS_CONTEXT_HPP
...
#include "dogen.assets/types/helpers/mapping_set_repository_fwd.hpp"
...
public:
    ...
    void mapping_repository(const boost::shared_ptr<dogen::assets::helpers::mapping_set_repository>& v);
    void mapping_repository(const boost::shared_ptr<dogen::assets::helpers::mapping_set_repository>&& v);
...
template<>
inline void swap(
    dogen::assets::transforms::context& lhs,
    dogen::assets::transforms::context& rhs) {
    lhs.swap(rhs);
}
