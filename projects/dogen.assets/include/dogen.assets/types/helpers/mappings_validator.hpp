 ...
 *
 */
#ifndef DOGEN_ASSETS_TYPES_HELPERS_MAPPINGS_VALIDATOR_HPP
#define DOGEN_ASSETS_TYPES_HELPERS_MAPPINGS_VALIDATOR_HPP
...
private:
    void validate(const meta_model::technical_space ts,
