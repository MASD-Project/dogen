 ...
 *
 */
#ifndef DOGEN_ASSETS_TYPES_HELPERS_NEW_NAME_TREE_PARSER_HPP
#define DOGEN_ASSETS_TYPES_HELPERS_NEW_NAME_TREE_PARSER_HPP
...
#include "dogen.assets/types/helpers/parsing_error.hpp"
#include "dogen.assets/types/helpers/name_tree_builder.hpp"
...
using dogen::assets::helpers::name_tree_builder;
...
struct name_tree_listener
{
    ...
    */
    ...
    name_tree_listener(const std::unordered_set<std::string>& top_level_modules,
        const dogen::assets::meta_model::location& model_location)
...
struct custom_type_grammar : qi::grammar<Iterator, Skipper>
{
    ...
    std::string scope_operator_for_technical_space(
        const dogen::assets::meta_model::technical_space ts) {
        switch (ts) {
        case dogen::assets::meta_model::technical_space::csharp:
            return ".";
        case dogen::assets::meta_model::technical_space::cpp:
            return "::";
        default: {
            const auto s(boost::lexical_cast<std::string>(ts));
            BOOST_LOG_SEV(lg, error) << unsupported_technical_space << s;
            BOOST_THROW_EXCEPTION(
                dogen::assets::helpers::parsing_error(
