 ...
 *
 */
#ifndef DOGEN_ASSETS_TYPES_HELPERS_INDICES_HPP
#define DOGEN_ASSETS_TYPES_HELPERS_INDICES_HPP
...
template<>
inline void swap(
    dogen::assets::helpers::indices& lhs,
    dogen::assets::helpers::indices& rhs) {
    lhs.swap(rhs);
}
