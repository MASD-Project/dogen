...
inline std::ostream& operator<<(std::ostream& s, const boost::optional<dogen::assets::meta_model::orm::attribute_properties>& v) {
...
std::ostream& operator<<(std::ostream& s, const attribute& v) {
    ...
    s << " { "
      << "\"__type__\": " << "\"dogen::assets::meta_model::attribute\"" << ", "
