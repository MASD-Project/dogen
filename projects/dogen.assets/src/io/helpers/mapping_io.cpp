...
inline std::ostream& operator<<(std::ostream& s, const std::unordered_map<dogen::assets::meta_model::technical_space, dogen::assets::helpers::mapping_value>& v) {
    s << "[";
...
std::ostream& operator<<(std::ostream& s, const mapping& v) {
    s << " { "
      << "\"__type__\": " << "\"dogen::assets::helpers::mapping\"" << ", "
