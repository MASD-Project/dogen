...
dogen::assets::meta_model::formatting_styles
create_dogen_assets_meta_model_formatting_styles(const unsigned int position) {
    return dogen::assets::meta_model::formatting_styles_generator::create(position);
}
...
populate(const unsigned int position, result_type& v) {
    ...
    v.formatting_style(create_dogen_assets_meta_model_formatting_styles(position + 3));
