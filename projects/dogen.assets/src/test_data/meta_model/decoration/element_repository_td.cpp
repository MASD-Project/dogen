...
dogen::assets::meta_model::decoration::modeline_group*
create_dogen_assets_meta_model_decoration_modeline_group_ptr(const unsigned int position) {
    return dogen::assets::meta_model::decoration::modeline_group_generator::create_ptr(position);
}

boost::shared_ptr<dogen::assets::meta_model::decoration::modeline_group>
create_boost_shared_ptr_dogen_assets_meta_model_decoration_modeline_group(unsigned int position) {
    boost::shared_ptr<dogen::assets::meta_model::decoration::modeline_group> r(
        create_dogen_assets_meta_model_decoration_modeline_group_ptr(position));
    return r;
}

std::unordered_map<std::string, boost::shared_ptr<dogen::assets::meta_model::decoration::modeline_group> > create_std_unordered_map_std_string_boost_shared_ptr_dogen_assets_meta_model_decoration_modeline_group(unsigned int position) {
    std::unordered_map<std::string, boost::shared_ptr<dogen::assets::meta_model::decoration::modeline_group> > r;
    for (unsigned int i(0); i < 4; ++i) {
        r.insert(std::make_pair(create_std_string(position + i), create_boost_shared_ptr_dogen_assets_meta_model_decoration_modeline_group(position + i)));
    }
    return r;
}
...
std::unordered_map<std::string, boost::shared_ptr<dogen::assets::meta_model::decoration::modeline> > create_std_unordered_map_std_string_boost_shared_ptr_dogen_assets_meta_model_decoration_modeline(unsigned int position) {
    std::unordered_map<std::string, boost::shared_ptr<dogen::assets::meta_model::decoration::modeline> > r;
    for (unsigned int i(0); i < 4; ++i) {
        r.insert(std::make_pair(create_std_string(position + i), create_boost_shared_ptr_dogen_assets_meta_model_decoration_modeline(position + i)));
    }
    return r;
}
...
populate(const unsigned int position, result_type& v) {
    v.modeline_groups(create_std_unordered_map_std_string_boost_shared_ptr_dogen_assets_meta_model_decoration_modeline_group(position + 0));
    v.modelines(create_std_unordered_map_std_string_boost_shared_ptr_dogen_assets_meta_model_decoration_modeline(position + 1));
    v.licences(create_std_unordered_map_std_string_boost_shared_ptr_dogen_assets_meta_model_decoration_licence(position + 2));
    v.generation_markers(create_std_unordered_map_std_string_boost_shared_ptr_dogen_assets_meta_model_decoration_generation_marker(position + 3));
}
