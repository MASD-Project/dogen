...
std::list<boost::shared_ptr<dogen::assets::meta_model::decoration::modeline> > create_std_list_boost_shared_ptr_dogen_assets_meta_model_decoration_modeline(unsigned int position) {
    std::list<boost::shared_ptr<dogen::assets::meta_model::decoration::modeline> > r;
    for (unsigned int i(0); i < 4; ++i) {
        r.push_back(create_boost_shared_ptr_dogen_assets_meta_model_decoration_modeline(position + i));
    }
    return r;
}
...
populate(const unsigned int position, result_type& v) {
    ...
    v.modelines(create_std_list_boost_shared_ptr_dogen_assets_meta_model_decoration_modeline(position + 1));
}
