...
std::unordered_map<dogen::assets::meta_model::orm::database_system, std::string> create_std_unordered_map_dogen_assets_meta_model_orm_database_system_std_string(unsigned int position) {
    std::unordered_map<dogen::assets::meta_model::orm::database_system, std::string> r;
    for (unsigned int i(0); i < 4; ++i) {
        r.insert(std::make_pair(create_dogen_assets_meta_model_orm_database_system(position + i), create_std_string(position + i)));
    }
    return r;
}
...
populate(const unsigned int position, result_type& v) {
    ...
    v.type_overrides(create_std_unordered_map_dogen_assets_meta_model_orm_database_system_std_string(position + 3));
