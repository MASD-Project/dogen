...
type_registrar_generator::type_registrar_generator() : position_(0) { }

void type_registrar_generator::
...
type_registrar_generator::result_type
type_registrar_generator::create(const unsigned int position) {
    type_registrar r;
    type_registrar_generator::populate(position, r);
    return r;
}

type_registrar_generator::result_type*
type_registrar_generator::create_ptr(const unsigned int position) {
    type_registrar* p = new type_registrar();
    type_registrar_generator::populate(position, *p);
    return p;
}

type_registrar_generator::result_type
type_registrar_generator::operator()() {
