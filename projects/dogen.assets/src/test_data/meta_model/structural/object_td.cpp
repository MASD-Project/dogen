...
populate(const unsigned int position, result_type& v) {
    ...
    v.root_parents(create_std_list_dogen_assets_meta_model_name(position + 17));
    v.parents(create_std_list_dogen_assets_meta_model_name(position + 18));
    v.leaves(create_std_list_dogen_assets_meta_model_name(position + 19));
    v.type_parameters(create_dogen_assets_meta_model_type_parameters(position + 20));
    v.is_associative_container(create_bool(position + 21));
    v.object_templates(create_std_list_dogen_assets_meta_model_name(position + 22));
    v.associative_container_keys(create_std_list_dogen_assets_meta_model_name(position + 23));
