...
dogen::assets::helpers::mapping_actions
create_dogen_assets_helpers_mapping_actions(const unsigned int position) {
    return dogen::assets::helpers::mapping_actions_generator::create(position);
}
...
populate(const unsigned int position, result_type& v) {
    v.mapping_action(create_dogen_assets_helpers_mapping_actions(position + 0));
    v.default_name(create_boost_optional_dogen_assets_meta_model_name(position + 1));
}
