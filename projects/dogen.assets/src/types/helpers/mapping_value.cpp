...
mapping_value::mapping_value()
    : mapping_action_(static_cast<dogen::assets::helpers::mapping_actions>(0)) { }
...
dogen::assets::helpers::mapping_actions mapping_value::mapping_action() const {
    return mapping_action_;
}

void mapping_value::mapping_action(const dogen::assets::helpers::mapping_actions v) {
    mapping_action_ = v;
}

const boost::optional<dogen::assets::meta_model::name>& mapping_value::default_name() const {
    return default_name_;
}

boost::optional<dogen::assets::meta_model::name>& mapping_value::default_name() {
    return default_name_;
}

void mapping_value::default_name(const boost::optional<dogen::assets::meta_model::name>& v) {
    default_name_ = v;
}
