...
void visual_studio_project::accept(const element_visitor& v) const {
    v.visit(*this);
}

void visual_studio_project::accept(element_visitor& v) const {
    v.visit(*this);
    }

void visual_studio_project::accept(const element_visitor& v) {
    v.visit(*this);
}

void visual_studio_project::accept(element_visitor& v) {
    v.visit(*this);
}

void visual_studio_project::to_stream(std::ostream& s) const {
    s << " { "
      << "\"__type__\": " << "\"dogen::assets::meta_model::build::visual_studio_project\"" << ", "
      << "\"__parent_0__\": ";
