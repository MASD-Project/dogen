...
#include "dogen.assets/io/meta_model/orm/odb_targets_io.hpp"
...
void cmakelists::to_stream(std::ostream& s) const {
    s << " { "
      << "\"__type__\": " << "\"dogen::assets::meta_model::build::cmakelists\"" << ", "
      << "\"__parent_0__\": ";
...
bool cmakelists::equals(const dogen::assets::meta_model::element& other) const {
...
const dogen::assets::meta_model::orm::odb_targets& cmakelists::odb_targets() const {
    return odb_targets_;
}

dogen::assets::meta_model::orm::odb_targets& cmakelists::odb_targets() {
    return odb_targets_;
}

void cmakelists::odb_targets(const dogen::assets::meta_model::orm::odb_targets& v) {
    odb_targets_ = v;
}
