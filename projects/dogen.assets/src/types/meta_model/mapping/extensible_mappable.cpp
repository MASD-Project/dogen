...
inline std::ostream& operator<<(std::ostream& s, const std::list<dogen::assets::meta_model::mapping::destination>& v) {
    s << "[ ";
...
void extensible_mappable::to_stream(std::ostream& s) const {
    s << " { "
      << "\"__type__\": " << "\"dogen::assets::meta_model::mapping::extensible_mappable\"" << ", "
      << "\"__parent_0__\": ";
...
bool extensible_mappable::equals(const dogen::assets::meta_model::element& other) const {
...
const std::list<dogen::assets::meta_model::mapping::destination>& extensible_mappable::destinations() const {
    return destinations_;
}

std::list<dogen::assets::meta_model::mapping::destination>& extensible_mappable::destinations() {
    return destinations_;
}

void extensible_mappable::destinations(const std::list<dogen::assets::meta_model::mapping::destination>& v) {
    destinations_ = v;
}
