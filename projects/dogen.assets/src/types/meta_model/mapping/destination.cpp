...
const dogen::assets::meta_model::name& destination::name() const {
    return name_;
}

dogen::assets::meta_model::name& destination::name() {
    return name_;
}

void destination::name(const dogen::assets::meta_model::name& v) {
    name_ = v;
}
...
dogen::assets::meta_model::technical_space destination::technical_space() const {
    return technical_space_;
}

void destination::technical_space(const dogen::assets::meta_model::technical_space v) {
    technical_space_ = v;
}
