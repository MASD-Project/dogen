...
const boost::optional<dogen::assets::meta_model::orm::database_system>& type_mapping::database() const {
    return database_;
}

boost::optional<dogen::assets::meta_model::orm::database_system>& type_mapping::database() {
    return database_;
}

void type_mapping::database(const boost::optional<dogen::assets::meta_model::orm::database_system>& v) {
    database_ = v;
}
