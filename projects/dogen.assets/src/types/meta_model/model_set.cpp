...
const dogen::assets::meta_model::model& model_set::target() const {
    return target_;
}

dogen::assets::meta_model::model& model_set::target() {
    return target_;
}

void model_set::target(const dogen::assets::meta_model::model& v) {
    target_ = v;
}
...
const std::list<dogen::assets::meta_model::model>& model_set::references() const {
    return references_;
}

std::list<dogen::assets::meta_model::model>& model_set::references() {
    return references_;
}

void model_set::references(const std::list<dogen::assets::meta_model::model>& v) {
    references_ = v;
}
