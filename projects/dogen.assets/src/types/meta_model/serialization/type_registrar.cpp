...
void type_registrar::to_stream(std::ostream& s) const {
    s << " { "
      << "\"__type__\": " << "\"dogen::assets::meta_model::serialization::type_registrar\"" << ", "
      << "\"__parent_0__\": ";
...
bool type_registrar::equals(const dogen::assets::meta_model::element& other) const {
...
const std::list<dogen::assets::meta_model::name>& type_registrar::leaves() const {
    return leaves_;
}

std::list<dogen::assets::meta_model::name>& type_registrar::leaves() {
    return leaves_;
}
...
std::list<dogen::assets::meta_model::name>& type_registrar::registrar_dependencies() {
    return registrar_dependencies_;
}

void type_registrar::registrar_dependencies(const std::list<dogen::assets::meta_model::name>& v) {
