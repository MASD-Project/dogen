...
artefact_properties::artefact_properties()
    : enabled_(static_cast<bool>(0)),
      ...
      formatting_style_(static_cast<dogen::assets::meta_model::formatting_styles>(0)) { }
...
dogen::assets::meta_model::formatting_styles artefact_properties::formatting_style() const {
    return formatting_style_;
}

void artefact_properties::formatting_style(const dogen::assets::meta_model::formatting_styles v) {
    formatting_style_ = v;
}
