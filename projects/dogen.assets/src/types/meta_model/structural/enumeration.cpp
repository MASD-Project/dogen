...
void enumeration::to_stream(std::ostream& s) const {
    ...
    s << " { "
      << "\"__type__\": " << "\"dogen::assets::meta_model::structural::enumeration\"" << ", "
      << "\"__parent_0__\": ";
...
bool enumeration::equals(const dogen::assets::meta_model::element& other) const {
...
const dogen::assets::meta_model::name& enumeration::underlying_element() const {
    return underlying_element_;
}

dogen::assets::meta_model::name& enumeration::underlying_element() {
    return underlying_element_;
}

void enumeration::underlying_element(const dogen::assets::meta_model::name& v) {
