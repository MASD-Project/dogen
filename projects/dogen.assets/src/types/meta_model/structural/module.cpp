...
inline std::ostream& operator<<(std::ostream& s, const boost::optional<dogen::assets::meta_model::orm::module_properties>& v) {
...
void module::to_stream(std::ostream& s) const {
    ...
    s << " { "
      << "\"__type__\": " << "\"dogen::assets::meta_model::structural::module\"" << ", "
      << "\"__parent_0__\": ";
...
bool module::equals(const dogen::assets::meta_model::element& other) const {
...
const boost::optional<dogen::assets::meta_model::orm::module_properties>& module::orm_properties() const {
    return orm_properties_;
}

boost::optional<dogen::assets::meta_model::orm::module_properties>& module::orm_properties() {
    return orm_properties_;
}

void module::orm_properties(const boost::optional<dogen::assets::meta_model::orm::module_properties>& v) {
    orm_properties_ = v;
}
