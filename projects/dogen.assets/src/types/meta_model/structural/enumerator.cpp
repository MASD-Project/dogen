...
const dogen::assets::meta_model::name& enumerator::name() const {
    return name_;
}

dogen::assets::meta_model::name& enumerator::name() {
    return name_;
}

void enumerator::name(const dogen::assets::meta_model::name& v) {
    name_ = v;
}
...
const std::list<dogen::assets::meta_model::static_stereotypes>& enumerator::static_stereotypes() const {
    return static_stereotypes_;
}

std::list<dogen::assets::meta_model::static_stereotypes>& enumerator::static_stereotypes() {
    return static_stereotypes_;
}

void enumerator::static_stereotypes(const std::list<dogen::assets::meta_model::static_stereotypes>& v) {
