...
const std::unordered_map<std::string, dogen::formatting::modeline>& modeline_group::modelines() const {
    return modelines_;
}

std::unordered_map<std::string, dogen::formatting::modeline>& modeline_group::modelines() {
    return modelines_;
}

void modeline_group::modelines(const std::unordered_map<std::string, dogen::formatting::modeline>& v) {
    modelines_ = v;
}
