 ...
 *
 */
#ifndef DOGEN_CLASS_IN_A_PACKAGE_DOMAIN_PACKAGE1_FIRST_CLASS_UNVERSIONED_KEY_HPP
#define DOGEN_CLASS_IN_A_PACKAGE_DOMAIN_PACKAGE1_FIRST_CLASS_UNVERSIONED_KEY_HPP
