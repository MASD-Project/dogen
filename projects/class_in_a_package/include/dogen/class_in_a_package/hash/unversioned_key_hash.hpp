 ...
 *
 */
#ifndef DOGEN_CLASS_IN_A_PACKAGE_HASH_UNVERSIONED_KEY_HASH_HPP
#define DOGEN_CLASS_IN_A_PACKAGE_HASH_UNVERSIONED_KEY_HASH_HPP
...
public:
    size_t operator()(dogen::class_in_a_package::unversioned_key value) const {
