...
BOOST_AUTO_TEST_SUITE(entities_variability_abstract_profile_entry_tests)

BOOST_AUTO_TEST_CASE(inserter_operator_produces_valid_json) {
    dogen::logical::entities::variability::abstract_profile_entry_generator g;
    const boost::shared_ptr<dogen::logical::entities::variability::abstract_profile_entry> a(g.create_ptr(1));
    std::stringstream s;
    s << *a;
...
BOOST_AUTO_TEST_CASE(xml_roundtrip_produces_the_same_entity) {
    ...
    boost::shared_ptr<dogen::logical::entities::variability::abstract_profile_entry> b;
