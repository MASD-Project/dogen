...
BOOST_AUTO_TEST_SUITE(entities_templating_logic_less_template_tests)

BOOST_AUTO_TEST_CASE(identical_objects_are_equal) {
    dogen::logical::entities::templating::logic_less_template_generator g;
    const auto a(g());
    const auto b(a);
...
BOOST_AUTO_TEST_CASE(moved_objects_are_equal) {
    ...
    g();
    auto a(g());
    const auto b = dogen::logical::entities::templating::logic_less_template();
    const auto c(a);
    BOOST_CHECK(a != b);
    BOOST_CHECK(a == c);
...
BOOST_AUTO_TEST_CASE(assigned_objects_are_equal) {
    ...
    g();
    const auto a(g());
    dogen::logical::entities::templating::logic_less_template b;
    BOOST_CHECK(a != b);
...
BOOST_AUTO_TEST_CASE(copy_constructed_objects_are_equal) {
    ...
    b = dogen::logical::entities::templating::logic_less_template();
    BOOST_CHECK(a != b);
}
...
BOOST_AUTO_TEST_CASE(xml_roundtrip_produces_the_same_entity) {
    ...
    dogen::logical::entities::templating::logic_less_template b = dogen::logical::entities::templating::logic_less_template();
...
BOOST_AUTO_TEST_CASE(equal_objects_generate_the_same_hash) {
    ...
    std::hash<dogen::logical::entities::templating::logic_less_template> hasher;
