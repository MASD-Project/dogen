...
BOOST_AUTO_TEST_CASE(inserter_operator_produces_valid_json) {
    dogen::logical::entities::element_generator g;
    const boost::shared_ptr<dogen::logical::entities::element> a(g.create_ptr(1));
    std::stringstream s;
    s << *a;
...
BOOST_AUTO_TEST_CASE(xml_roundtrip_produces_the_same_entity) {
    ...
    boost::shared_ptr<dogen::logical::entities::element> b;
