...
BOOST_AUTO_TEST_CASE(inserter_operator_produces_valid_json) {
    dogen::logical::entities::decoration::editor_generator g;
    const auto a(g());
    std::stringstream s;
    s << a;
...
BOOST_AUTO_TEST_CASE(xml_roundtrip_produces_the_same_entity) {
    ...
    dogen::logical::entities::decoration::editor b = dogen::logical::entities::decoration::editor();
...
BOOST_AUTO_TEST_CASE(equal_enums_generate_the_same_hash) {
    ...
    std::hash<dogen::logical::entities::decoration::editor> hasher;
