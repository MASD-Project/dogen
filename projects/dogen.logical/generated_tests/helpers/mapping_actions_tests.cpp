...
#include "dogen.logical/lexical_cast/helpers/mapping_actions_lc.hpp"
...
BOOST_AUTO_TEST_CASE(inserter_operator_produces_valid_json) {
    dogen::logical::helpers::mapping_actions_generator g;
    const auto a(g());
    std::stringstream s;
    s << a;
...
BOOST_AUTO_TEST_CASE(xml_roundtrip_produces_the_same_entity) {
    ...
    dogen::logical::helpers::mapping_actions b = dogen::logical::helpers::mapping_actions();
...
BOOST_AUTO_TEST_CASE(equal_enums_generate_the_same_hash) {
    ...
    std::hash<dogen::logical::helpers::mapping_actions> hasher;
