 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_ENTITIES_LABEL_HPP
#define DOGEN_LOGICAL_TYPES_ENTITIES_LABEL_HPP
...
template<>
inline void swap(
    dogen::logical::entities::label& lhs,
    dogen::logical::entities::label& rhs) {
    lhs.swap(rhs);
}
