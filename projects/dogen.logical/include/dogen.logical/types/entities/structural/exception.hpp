...
#include "dogen.logical/serialization/entities/structural/exception_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::logical::entities::structural::exception& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::logical::entities::structural::exception& v, unsigned int version);
