...
#include "dogen.logical/serialization/entities/templating/element_repository_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::logical::entities::templating::element_repository& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::logical::entities::templating::element_repository& v, unsigned int version);
