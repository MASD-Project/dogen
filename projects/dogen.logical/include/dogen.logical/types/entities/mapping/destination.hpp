...
#include "dogen.logical/serialization/entities/mapping/destination_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::logical::entities::mapping::destination& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::logical::entities::mapping::destination& v, unsigned int version);
