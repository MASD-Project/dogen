 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_ENTITIES_VISUAL_STUDIO_ITEM_HPP
#define DOGEN_LOGICAL_TYPES_ENTITIES_VISUAL_STUDIO_ITEM_HPP
...
template<>
inline void swap(
    dogen::logical::entities::visual_studio::item& lhs,
    dogen::logical::entities::visual_studio::item& rhs) {
    lhs.swap(rhs);
}
