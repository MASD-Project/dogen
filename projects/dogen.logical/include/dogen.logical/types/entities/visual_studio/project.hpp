...
#include "dogen.logical/serialization/entities/visual_studio/project_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::logical::entities::visual_studio::project& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::logical::entities::visual_studio::project& v, unsigned int version);
