 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_ENTITIES_VISUAL_STUDIO_PROJECT_PERSISTENCE_BLOCK_HPP
#define DOGEN_LOGICAL_TYPES_ENTITIES_VISUAL_STUDIO_PROJECT_PERSISTENCE_BLOCK_HPP
...
template<>
inline void swap(
    dogen::logical::entities::visual_studio::project_persistence_block& lhs,
    dogen::logical::entities::visual_studio::project_persistence_block& rhs) {
    lhs.swap(rhs);
}
