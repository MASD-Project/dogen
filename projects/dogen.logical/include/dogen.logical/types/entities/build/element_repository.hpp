 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_ENTITIES_BUILD_ELEMENT_REPOSITORY_HPP
#define DOGEN_LOGICAL_TYPES_ENTITIES_BUILD_ELEMENT_REPOSITORY_HPP
...
template<>
inline void swap(
    dogen::logical::entities::build::element_repository& lhs,
    dogen::logical::entities::build::element_repository& rhs) {
    lhs.swap(rhs);
}
