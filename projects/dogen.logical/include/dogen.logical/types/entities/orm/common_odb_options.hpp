...
#include "dogen.logical/serialization/entities/orm/common_odb_options_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::logical::entities::orm::common_odb_options& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::logical::entities::orm::common_odb_options& v, unsigned int version);
