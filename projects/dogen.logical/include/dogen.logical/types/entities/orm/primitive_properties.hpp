 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_ENTITIES_ORM_PRIMITIVE_PROPERTIES_HPP
#define DOGEN_LOGICAL_TYPES_ENTITIES_ORM_PRIMITIVE_PROPERTIES_HPP
...
template<>
inline void swap(
    dogen::logical::entities::orm::primitive_properties& lhs,
    dogen::logical::entities::orm::primitive_properties& rhs) {
    lhs.swap(rhs);
}
