...
#include "dogen.logical/serialization/entities/orm/primitive_properties_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::logical::entities::orm::primitive_properties& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::logical::entities::orm::primitive_properties& v, unsigned int version);
