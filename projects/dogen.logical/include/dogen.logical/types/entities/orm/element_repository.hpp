 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_ENTITIES_ORM_ELEMENT_REPOSITORY_HPP
#define DOGEN_LOGICAL_TYPES_ENTITIES_ORM_ELEMENT_REPOSITORY_HPP
...
template<>
inline void swap(
    dogen::logical::entities::orm::element_repository& lhs,
    dogen::logical::entities::orm::element_repository& rhs) {
    lhs.swap(rhs);
}
