...
#include <algorithm>
#include "dogen.logical/serialization/entities/type_parameters_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::logical::entities::type_parameters& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::logical::entities::type_parameters& v, unsigned int version);
