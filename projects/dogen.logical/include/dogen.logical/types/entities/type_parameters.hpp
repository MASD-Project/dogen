 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_ENTITIES_TYPE_PARAMETERS_HPP
#define DOGEN_LOGICAL_TYPES_ENTITIES_TYPE_PARAMETERS_HPP
...
template<>
inline void swap(
    dogen::logical::entities::type_parameters& lhs,
    dogen::logical::entities::type_parameters& rhs) {
    lhs.swap(rhs);
}
