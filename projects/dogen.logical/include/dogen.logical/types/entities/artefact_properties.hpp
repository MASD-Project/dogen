 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_ENTITIES_ARTEFACT_PROPERTIES_HPP
#define DOGEN_LOGICAL_TYPES_ENTITIES_ARTEFACT_PROPERTIES_HPP
...
public:
    ...
    dogen::logical::entities::formatting_styles formatting_style() const;
    void formatting_style(const dogen::logical::entities::formatting_styles v);
...
private:
    ...
    dogen::logical::entities::formatting_styles formatting_style_;
...
template<>
inline void swap(
    dogen::logical::entities::artefact_properties& lhs,
    dogen::logical::entities::artefact_properties& rhs) {
    lhs.swap(rhs);
}
