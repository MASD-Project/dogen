...
#include <string>
#include <algorithm>
#include "dogen.logical/serialization/entities/physical/variable_relation_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::logical::entities::physical::variable_relation& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::logical::entities::physical::variable_relation& v, unsigned int version);
