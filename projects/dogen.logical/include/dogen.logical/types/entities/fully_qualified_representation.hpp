 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_ENTITIES_FULLY_QUALIFIED_REPRESENTATION_HPP
#define DOGEN_LOGICAL_TYPES_ENTITIES_FULLY_QUALIFIED_REPRESENTATION_HPP
...
template<>
inline void swap(
    dogen::logical::entities::fully_qualified_representation& lhs,
    dogen::logical::entities::fully_qualified_representation& rhs) {
    lhs.swap(rhs);
}
