...
#include "dogen.logical/serialization/entities/serialization/type_registrar_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::logical::entities::serialization::type_registrar& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::logical::entities::serialization::type_registrar& v, unsigned int version);
