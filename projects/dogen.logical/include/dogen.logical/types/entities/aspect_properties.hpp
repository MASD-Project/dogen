 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_ENTITIES_ASPECT_PROPERTIES_HPP
#define DOGEN_LOGICAL_TYPES_ENTITIES_ASPECT_PROPERTIES_HPP
...
template<>
inline void swap(
    dogen::logical::entities::aspect_properties& lhs,
    dogen::logical::entities::aspect_properties& rhs) {
    lhs.swap(rhs);
}
