 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_ENTITIES_LOCATION_HPP
#define DOGEN_LOGICAL_TYPES_ENTITIES_LOCATION_HPP
...
template<>
inline void swap(
    dogen::logical::entities::location& lhs,
    dogen::logical::entities::location& rhs) {
    lhs.swap(rhs);
}
