...
#include "dogen.logical/serialization/entities/variability/abstract_profile_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::logical::entities::variability::abstract_profile& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::logical::entities::variability::abstract_profile& v, unsigned int version);
