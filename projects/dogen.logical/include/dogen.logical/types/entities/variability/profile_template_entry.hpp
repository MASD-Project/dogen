...
#include "dogen.logical/serialization/entities/variability/profile_template_entry_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::logical::entities::variability::profile_template_entry& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::logical::entities::variability::profile_template_entry& v, unsigned int version);
