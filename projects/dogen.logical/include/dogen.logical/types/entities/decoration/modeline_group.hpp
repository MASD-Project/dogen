...
#include "dogen.logical/serialization/entities/decoration/modeline_group_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::logical::entities::decoration::modeline_group& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::logical::entities::decoration::modeline_group& v, unsigned int version);
