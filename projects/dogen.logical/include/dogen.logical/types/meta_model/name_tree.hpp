 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_META_MODEL_NAME_TREE_HPP
#define DOGEN_LOGICAL_TYPES_META_MODEL_NAME_TREE_HPP
...
public:
    name_tree(
        ...
        const dogen::logical::meta_model::name& current,
        const std::list<dogen::logical::meta_model::name_tree>& children,
...
public:
    const dogen::logical::meta_model::fully_qualified_representation& qualified() const;
    dogen::logical::meta_model::fully_qualified_representation& qualified();
    void qualified(const dogen::logical::meta_model::fully_qualified_representation& v);
    void qualified(const dogen::logical::meta_model::fully_qualified_representation&& v);
     ...
     */
    /**@{*/
    const dogen::logical::meta_model::name& current() const;
    dogen::logical::meta_model::name& current();
    void current(const dogen::logical::meta_model::name& v);
    void current(const dogen::logical::meta_model::name&& v);
    /**@}*/
     ...
     */
    /**@{*/
    const std::list<dogen::logical::meta_model::name_tree>& children() const;
    std::list<dogen::logical::meta_model::name_tree>& children();
    void children(const std::list<dogen::logical::meta_model::name_tree>& v);
    void children(const std::list<dogen::logical::meta_model::name_tree>&& v);
    /**@}*/
...
private:
    dogen::logical::meta_model::fully_qualified_representation qualified_;
    dogen::logical::meta_model::name current_;
    std::list<dogen::logical::meta_model::name_tree> children_;
...
template<>
inline void swap(
    dogen::logical::meta_model::name_tree& lhs,
    dogen::logical::meta_model::name_tree& rhs) {
    lhs.swap(rhs);
}
