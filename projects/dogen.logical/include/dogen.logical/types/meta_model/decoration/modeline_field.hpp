 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_META_MODEL_DECORATION_MODELINE_FIELD_HPP
#define DOGEN_LOGICAL_TYPES_META_MODEL_DECORATION_MODELINE_FIELD_HPP
...
template<>
inline void swap(
    dogen::logical::meta_model::decoration::modeline_field& lhs,
    dogen::logical::meta_model::decoration::modeline_field& rhs) {
    lhs.swap(rhs);
}
