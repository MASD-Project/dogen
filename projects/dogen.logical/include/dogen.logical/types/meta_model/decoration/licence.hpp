 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_META_MODEL_DECORATION_LICENCE_HPP
#define DOGEN_LOGICAL_TYPES_META_MODEL_DECORATION_LICENCE_HPP
 ...
 */
class licence final : public dogen::logical::meta_model::element {
public:
    licence() = default;
...
template<>
inline void swap(
    dogen::logical::meta_model::decoration::licence& lhs,
    dogen::logical::meta_model::decoration::licence& rhs) {
    lhs.swap(rhs);
}
