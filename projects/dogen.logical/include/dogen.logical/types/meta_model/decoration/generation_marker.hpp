 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_META_MODEL_DECORATION_GENERATION_MARKER_HPP
#define DOGEN_LOGICAL_TYPES_META_MODEL_DECORATION_GENERATION_MARKER_HPP
 ...
 */
class generation_marker final : public dogen::logical::meta_model::element {
public:
...
template<>
inline void swap(
    dogen::logical::meta_model::decoration::generation_marker& lhs,
    dogen::logical::meta_model::decoration::generation_marker& rhs) {
    lhs.swap(rhs);
}
