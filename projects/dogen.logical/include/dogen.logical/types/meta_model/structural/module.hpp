 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_META_MODEL_STRUCTURAL_MODULE_HPP
#define DOGEN_LOGICAL_TYPES_META_MODEL_STRUCTURAL_MODULE_HPP
 ...
 */
class module final : public dogen::logical::meta_model::element {
public:
...
public:
    module(
        ...
        const boost::optional<dogen::logical::meta_model::orm::module_properties>& orm_properties);
...
public:
    ...
    const boost::optional<dogen::logical::meta_model::orm::module_properties>& orm_properties() const;
    boost::optional<dogen::logical::meta_model::orm::module_properties>& orm_properties();
    void orm_properties(const boost::optional<dogen::logical::meta_model::orm::module_properties>& v);
    void orm_properties(const boost::optional<dogen::logical::meta_model::orm::module_properties>&& v);
...
private:
    ...
    boost::optional<dogen::logical::meta_model::orm::module_properties> orm_properties_;
};
...
template<>
inline void swap(
    dogen::logical::meta_model::structural::module& lhs,
    dogen::logical::meta_model::structural::module& rhs) {
    lhs.swap(rhs);
}
