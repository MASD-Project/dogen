 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_META_MODEL_STRUCTURAL_ASSISTANT_HPP
#define DOGEN_LOGICAL_TYPES_META_MODEL_STRUCTURAL_ASSISTANT_HPP
 ...
 */
class assistant final : public dogen::logical::meta_model::element {
public:
    assistant() = default;
...
template<>
inline void swap(
    dogen::logical::meta_model::structural::assistant& lhs,
    dogen::logical::meta_model::structural::assistant& rhs) {
    lhs.swap(rhs);
}
