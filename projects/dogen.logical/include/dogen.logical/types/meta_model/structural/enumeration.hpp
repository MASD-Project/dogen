 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_META_MODEL_STRUCTURAL_ENUMERATION_HPP
#define DOGEN_LOGICAL_TYPES_META_MODEL_STRUCTURAL_ENUMERATION_HPP
 ...
 * or a string.
 */
class enumeration final : public dogen::logical::meta_model::element {
public:
...
public:
     ...
     */
    /**@{*/
    const dogen::logical::meta_model::name& underlying_element() const;
    dogen::logical::meta_model::name& underlying_element();
    void underlying_element(const dogen::logical::meta_model::name& v);
    void underlying_element(const dogen::logical::meta_model::name&& v);
    /**@}*/
     ...
     */
    /**@{*/
    const std::list<dogen::logical::meta_model::structural::enumerator>& enumerators() const;
    std::list<dogen::logical::meta_model::structural::enumerator>& enumerators();
    void enumerators(const std::list<dogen::logical::meta_model::structural::enumerator>& v);
    void enumerators(const std::list<dogen::logical::meta_model::structural::enumerator>&& v);
    /**@}*/
...
private:
    dogen::logical::meta_model::name underlying_element_;
    std::list<dogen::logical::meta_model::structural::enumerator> enumerators_;
...
template<>
inline void swap(
    dogen::logical::meta_model::structural::enumeration& lhs,
    dogen::logical::meta_model::structural::enumeration& rhs) {
    lhs.swap(rhs);
}
