 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_META_MODEL_STRUCTURAL_VISITOR_HPP
#define DOGEN_LOGICAL_TYPES_META_MODEL_STRUCTURAL_VISITOR_HPP
...
class visitor final : public dogen::logical::meta_model::element {
public:
    visitor() = default;
...
public:
    visitor(
        ...
        const std::list<dogen::logical::meta_model::name>& visits,
        const boost::optional<dogen::logical::meta_model::name>& parent);
...
public:
     ...
     */
    /**@{*/
    const std::list<dogen::logical::meta_model::name>& visits() const;
    std::list<dogen::logical::meta_model::name>& visits();
    void visits(const std::list<dogen::logical::meta_model::name>& v);
    void visits(const std::list<dogen::logical::meta_model::name>&& v);
    /**@}*/

    const boost::optional<dogen::logical::meta_model::name>& parent() const;
    boost::optional<dogen::logical::meta_model::name>& parent();
    void parent(const boost::optional<dogen::logical::meta_model::name>& v);
    void parent(const boost::optional<dogen::logical::meta_model::name>&& v);
...
private:
    std::list<dogen::logical::meta_model::name> visits_;
    boost::optional<dogen::logical::meta_model::name> parent_;
};
...
template<>
inline void swap(
    dogen::logical::meta_model::structural::visitor& lhs,
    dogen::logical::meta_model::structural::visitor& rhs) {
    lhs.swap(rhs);
}
