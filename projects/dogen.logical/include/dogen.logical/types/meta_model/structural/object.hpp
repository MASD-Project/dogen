 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_META_MODEL_STRUCTURAL_OBJECT_HPP
#define DOGEN_LOGICAL_TYPES_META_MODEL_STRUCTURAL_OBJECT_HPP
 ...
 */
class object final : public dogen::logical::meta_model::element {
public:
...
public:
     ...
     */
    /**@{*/
    const std::list<dogen::logical::meta_model::attribute>& all_attributes() const;
    std::list<dogen::logical::meta_model::attribute>& all_attributes();
    void all_attributes(const std::list<dogen::logical::meta_model::attribute>& v);
    void all_attributes(const std::list<dogen::logical::meta_model::attribute>&& v);
    /**@}*/
     ...
     */
    /**@{*/
    const std::list<dogen::logical::meta_model::attribute>& local_attributes() const;
    std::list<dogen::logical::meta_model::attribute>& local_attributes();
    void local_attributes(const std::list<dogen::logical::meta_model::attribute>& v);
    void local_attributes(const std::list<dogen::logical::meta_model::attribute>&& v);
    /**@}*/
     ...
     */
    /**@{*/
    const std::unordered_map<dogen::logical::meta_model::name, std::list<dogen::logical::meta_model::attribute> >& inherited_attributes() const;
    std::unordered_map<dogen::logical::meta_model::name, std::list<dogen::logical::meta_model::attribute> >& inherited_attributes();
    void inherited_attributes(const std::unordered_map<dogen::logical::meta_model::name, std::list<dogen::logical::meta_model::attribute> >& v);
    void inherited_attributes(const std::unordered_map<dogen::logical::meta_model::name, std::list<dogen::logical::meta_model::attribute> >&& v);
    /**@}*/
     ...
     */
    /**@{*/
    const boost::optional<dogen::logical::meta_model::name>& base_visitor() const;
    boost::optional<dogen::logical::meta_model::name>& base_visitor();
    void base_visitor(const boost::optional<dogen::logical::meta_model::name>& v);
    void base_visitor(const boost::optional<dogen::logical::meta_model::name>&& v);
    /**@}*/
     ...
     */
    /**@{*/
    const boost::optional<dogen::logical::meta_model::name>& derived_visitor() const;
    boost::optional<dogen::logical::meta_model::name>& derived_visitor();
    void derived_visitor(const boost::optional<dogen::logical::meta_model::name>& v);
    void derived_visitor(const boost::optional<dogen::logical::meta_model::name>&& v);
    /**@}*/
     ...
     */
    /**@{*/
    const std::list<dogen::logical::meta_model::name>& transparent_associations() const;
    std::list<dogen::logical::meta_model::name>& transparent_associations();
    void transparent_associations(const std::list<dogen::logical::meta_model::name>& v);
    void transparent_associations(const std::list<dogen::logical::meta_model::name>&& v);
    /**@}*/
     ...
     */
    /**@{*/
    const std::list<dogen::logical::meta_model::name>& opaque_associations() const;
    std::list<dogen::logical::meta_model::name>& opaque_associations();
    void opaque_associations(const std::list<dogen::logical::meta_model::name>& v);
    void opaque_associations(const std::list<dogen::logical::meta_model::name>&& v);
    /**@}*/
     ...
     */
    /**@{*/
    const std::list<dogen::logical::meta_model::name>& associative_container_keys() const;
    std::list<dogen::logical::meta_model::name>& associative_container_keys();
    void associative_container_keys(const std::list<dogen::logical::meta_model::name>& v);
    void associative_container_keys(const std::list<dogen::logical::meta_model::name>&& v);
    /**@}*/
     ...
     */
    /**@{*/
    const std::list<dogen::logical::meta_model::name>& root_parents() const;
    std::list<dogen::logical::meta_model::name>& root_parents();
    void root_parents(const std::list<dogen::logical::meta_model::name>& v);
    void root_parents(const std::list<dogen::logical::meta_model::name>&& v);
    /**@}*/
     ...
     */
    /**@{*/
    const std::list<dogen::logical::meta_model::name>& parents() const;
    std::list<dogen::logical::meta_model::name>& parents();
    void parents(const std::list<dogen::logical::meta_model::name>& v);
    void parents(const std::list<dogen::logical::meta_model::name>&& v);
    /**@}*/
     ...
     */
    /**@{*/
    const std::list<dogen::logical::meta_model::name>& leaves() const;
    std::list<dogen::logical::meta_model::name>& leaves();
    void leaves(const std::list<dogen::logical::meta_model::name>& v);
    void leaves(const std::list<dogen::logical::meta_model::name>&& v);
    /**@}*/

    const boost::optional<dogen::logical::meta_model::name>& type_registrar() const;
    boost::optional<dogen::logical::meta_model::name>& type_registrar();
    void type_registrar(const boost::optional<dogen::logical::meta_model::name>& v);
    void type_registrar(const boost::optional<dogen::logical::meta_model::name>&& v);

    const dogen::logical::meta_model::type_parameters& type_parameters() const;
    dogen::logical::meta_model::type_parameters& type_parameters();
    void type_parameters(const dogen::logical::meta_model::type_parameters& v);
    void type_parameters(const dogen::logical::meta_model::type_parameters&& v);
     ...
     */
    /**@{*/
    const std::list<dogen::logical::meta_model::name>& object_templates() const;
    std::list<dogen::logical::meta_model::name>& object_templates();
    void object_templates(const std::list<dogen::logical::meta_model::name>& v);
    void object_templates(const std::list<dogen::logical::meta_model::name>&& v);
    /**@}*/
    ...
    const boost::optional<dogen::logical::meta_model::orm::object_properties>& orm_properties() const;
    boost::optional<dogen::logical::meta_model::orm::object_properties>& orm_properties();
    void orm_properties(const boost::optional<dogen::logical::meta_model::orm::object_properties>& v);
    void orm_properties(const boost::optional<dogen::logical::meta_model::orm::object_properties>&& v);
...
private:
    std::list<dogen::logical::meta_model::attribute> all_attributes_;
    std::list<dogen::logical::meta_model::attribute> local_attributes_;
    std::unordered_map<dogen::logical::meta_model::name, std::list<dogen::logical::meta_model::attribute> > inherited_attributes_;
    bool is_immutable_;
    bool is_fluent_;
    boost::optional<dogen::logical::meta_model::name> base_visitor_;
    boost::optional<dogen::logical::meta_model::name> derived_visitor_;
    bool is_visitation_root_;
    bool is_visitation_leaf_;
    std::list<dogen::logical::meta_model::name> transparent_associations_;
    std::list<dogen::logical::meta_model::name> opaque_associations_;
    std::list<dogen::logical::meta_model::name> associative_container_keys_;
    bool is_parent_;
    bool is_child_;
    bool is_leaf_;
    bool is_final_;
    ...
    std::list<dogen::logical::meta_model::name> root_parents_;
    std::list<dogen::logical::meta_model::name> parents_;
    std::list<dogen::logical::meta_model::name> leaves_;
    boost::optional<dogen::logical::meta_model::name> type_registrar_;
    dogen::logical::meta_model::type_parameters type_parameters_;
    bool is_associative_container_;
    std::list<dogen::logical::meta_model::name> object_templates_;
    bool provides_opaqueness_;
    bool can_be_primitive_underlier_;
    boost::optional<dogen::logical::meta_model::orm::object_properties> orm_properties_;
};
...
template<>
inline void swap(
    dogen::logical::meta_model::structural::object& lhs,
    dogen::logical::meta_model::structural::object& rhs) {
    lhs.swap(rhs);
}
