 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_META_MODEL_STRUCTURAL_OBJECT_TEMPLATE_HPP
#define DOGEN_LOGICAL_TYPES_META_MODEL_STRUCTURAL_OBJECT_TEMPLATE_HPP
 ...
 */
class object_template final : public dogen::logical::meta_model::element {
public:
...
template<>
inline void swap(
    dogen::logical::meta_model::structural::object_template& lhs,
    dogen::logical::meta_model::structural::object_template& rhs) {
    lhs.swap(rhs);
}
