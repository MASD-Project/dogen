 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_META_MODEL_STRUCTURAL_ENTRY_POINT_HPP
#define DOGEN_LOGICAL_TYPES_META_MODEL_STRUCTURAL_ENTRY_POINT_HPP
 ...
 */
class entry_point final : public dogen::logical::meta_model::element {
public:
    entry_point() = default;
...
template<>
inline void swap(
    dogen::logical::meta_model::structural::entry_point& lhs,
    dogen::logical::meta_model::structural::entry_point& rhs) {
    lhs.swap(rhs);
}
