 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_META_MODEL_STRUCTURAL_BUILTIN_HPP
#define DOGEN_LOGICAL_TYPES_META_MODEL_STRUCTURAL_BUILTIN_HPP
 ...
 */
class builtin final : public dogen::logical::meta_model::element {
public:
...
template<>
inline void swap(
    dogen::logical::meta_model::structural::builtin& lhs,
    dogen::logical::meta_model::structural::builtin& rhs) {
    lhs.swap(rhs);
}
