 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_META_MODEL_STRUCTURAL_ENUMERATOR_HPP
#define DOGEN_LOGICAL_TYPES_META_MODEL_STRUCTURAL_ENUMERATOR_HPP
...
template<>
inline void swap(
    dogen::logical::meta_model::structural::enumerator& lhs,
    dogen::logical::meta_model::structural::enumerator& rhs) {
    lhs.swap(rhs);
}
