 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_META_MODEL_STRUCTURAL_EXCEPTION_HPP
#define DOGEN_LOGICAL_TYPES_META_MODEL_STRUCTURAL_EXCEPTION_HPP
 ...
 */
class exception final : public dogen::logical::meta_model::element {
public:
    exception() = default;
...
template<>
inline void swap(
    dogen::logical::meta_model::structural::exception& lhs,
    dogen::logical::meta_model::structural::exception& rhs) {
    lhs.swap(rhs);
}
