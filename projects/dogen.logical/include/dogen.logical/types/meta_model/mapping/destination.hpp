 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_META_MODEL_MAPPING_DESTINATION_HPP
#define DOGEN_LOGICAL_TYPES_META_MODEL_MAPPING_DESTINATION_HPP
...
template<>
inline void swap(
    dogen::logical::meta_model::mapping::destination& lhs,
    dogen::logical::meta_model::mapping::destination& rhs) {
    lhs.swap(rhs);
}
