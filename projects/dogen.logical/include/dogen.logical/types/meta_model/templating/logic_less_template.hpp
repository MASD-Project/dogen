 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_META_MODEL_TEMPLATING_LOGIC_LESS_TEMPLATE_HPP
#define DOGEN_LOGICAL_TYPES_META_MODEL_TEMPLATING_LOGIC_LESS_TEMPLATE_HPP
 ...
 */
class logic_less_template final : public dogen::logical::meta_model::element {
public:
...
template<>
inline void swap(
    dogen::logical::meta_model::templating::logic_less_template& lhs,
    dogen::logical::meta_model::templating::logic_less_template& rhs) {
    lhs.swap(rhs);
}
