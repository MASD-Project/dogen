 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_META_MODEL_TYPE_PARAMETERS_HPP
#define DOGEN_LOGICAL_TYPES_META_MODEL_TYPE_PARAMETERS_HPP
...
template<>
inline void swap(
    dogen::logical::meta_model::type_parameters& lhs,
    dogen::logical::meta_model::type_parameters& rhs) {
    lhs.swap(rhs);
}
