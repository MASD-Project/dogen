 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_META_MODEL_EXTRACTION_PROPERTIES_HPP
#define DOGEN_LOGICAL_TYPES_META_MODEL_EXTRACTION_PROPERTIES_HPP
...
template<>
inline void swap(
    dogen::logical::meta_model::extraction_properties& lhs,
    dogen::logical::meta_model::extraction_properties& rhs) {
    lhs.swap(rhs);
}
