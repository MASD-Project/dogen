 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_META_MODEL_VISUAL_STUDIO_PROJECT_HPP
#define DOGEN_LOGICAL_TYPES_META_MODEL_VISUAL_STUDIO_PROJECT_HPP
...
#include "dogen.logical/types/meta_model/visual_studio/item_group.hpp"
 ...
 */
class project final : public dogen::logical::meta_model::element {
public:
    project() = default;
...
public:
    project(
        ...
        const std::list<dogen::logical::meta_model::visual_studio::item_group>& item_groups,
...
public:
     ...
     */
    /**@{*/
    const std::list<dogen::logical::meta_model::visual_studio::item_group>& item_groups() const;
    std::list<dogen::logical::meta_model::visual_studio::item_group>& item_groups();
    void item_groups(const std::list<dogen::logical::meta_model::visual_studio::item_group>& v);
    void item_groups(const std::list<dogen::logical::meta_model::visual_studio::item_group>&& v);
    /**@}*/
...
private:
    ...
    std::list<dogen::logical::meta_model::visual_studio::item_group> item_groups_;
...
template<>
inline void swap(
    dogen::logical::meta_model::visual_studio::project& lhs,
    dogen::logical::meta_model::visual_studio::project& rhs) {
    lhs.swap(rhs);
}
