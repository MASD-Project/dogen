 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_META_MODEL_VISUAL_STUDIO_ITEM_HPP
#define DOGEN_LOGICAL_TYPES_META_MODEL_VISUAL_STUDIO_ITEM_HPP
...
template<>
inline void swap(
    dogen::logical::meta_model::visual_studio::item& lhs,
    dogen::logical::meta_model::visual_studio::item& rhs) {
    lhs.swap(rhs);
}
