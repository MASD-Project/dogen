 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_META_MODEL_VISUAL_STUDIO_PROJECT_PERSISTENCE_BLOCK_HPP
#define DOGEN_LOGICAL_TYPES_META_MODEL_VISUAL_STUDIO_PROJECT_PERSISTENCE_BLOCK_HPP
...
template<>
inline void swap(
    dogen::logical::meta_model::visual_studio::project_persistence_block& lhs,
    dogen::logical::meta_model::visual_studio::project_persistence_block& rhs) {
    lhs.swap(rhs);
}
