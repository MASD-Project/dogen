 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_META_MODEL_VISUAL_STUDIO_MSBUILD_TARGETS_HPP
#define DOGEN_LOGICAL_TYPES_META_MODEL_VISUAL_STUDIO_MSBUILD_TARGETS_HPP
...
class msbuild_targets final : public dogen::logical::meta_model::element {
public:
...
public:
    msbuild_targets(
        ...
        const dogen::logical::meta_model::orm::odb_targets& odb_targets);
...
public:
    const dogen::logical::meta_model::orm::odb_targets& odb_targets() const;
    dogen::logical::meta_model::orm::odb_targets& odb_targets();
    void odb_targets(const dogen::logical::meta_model::orm::odb_targets& v);
    void odb_targets(const dogen::logical::meta_model::orm::odb_targets&& v);
...
private:
    dogen::logical::meta_model::orm::odb_targets odb_targets_;
};
...
template<>
inline void swap(
    dogen::logical::meta_model::visual_studio::msbuild_targets& lhs,
    dogen::logical::meta_model::visual_studio::msbuild_targets& rhs) {
    lhs.swap(rhs);
}
