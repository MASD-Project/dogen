 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_META_MODEL_VISUAL_STUDIO_SOLUTION_HPP
#define DOGEN_LOGICAL_TYPES_META_MODEL_VISUAL_STUDIO_SOLUTION_HPP
...
class solution final : public dogen::logical::meta_model::element {
public:
    solution() = default;
...
public:
    solution(
        ...
        const std::list<dogen::logical::meta_model::visual_studio::project_persistence_block>& project_persistence_blocks);
...
public:
     ...
     */
    /**@{*/
    const std::list<dogen::logical::meta_model::visual_studio::project_persistence_block>& project_persistence_blocks() const;
    std::list<dogen::logical::meta_model::visual_studio::project_persistence_block>& project_persistence_blocks();
    void project_persistence_blocks(const std::list<dogen::logical::meta_model::visual_studio::project_persistence_block>& v);
    void project_persistence_blocks(const std::list<dogen::logical::meta_model::visual_studio::project_persistence_block>&& v);
    /**@}*/
...
private:
    std::string guid_;
    std::list<dogen::logical::meta_model::visual_studio::project_persistence_block> project_persistence_blocks_;
};
...
template<>
inline void swap(
    dogen::logical::meta_model::visual_studio::solution& lhs,
    dogen::logical::meta_model::visual_studio::solution& rhs) {
    lhs.swap(rhs);
}
