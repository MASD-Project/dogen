 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_META_MODEL_BUILD_CMAKELISTS_HPP
#define DOGEN_LOGICAL_TYPES_META_MODEL_BUILD_CMAKELISTS_HPP
 ...
 */
class cmakelists final : public dogen::logical::meta_model::element {
public:
    cmakelists() = default;
...
template<>
inline void swap(
    dogen::logical::meta_model::build::cmakelists& lhs,
    dogen::logical::meta_model::build::cmakelists& rhs) {
    lhs.swap(rhs);
}
