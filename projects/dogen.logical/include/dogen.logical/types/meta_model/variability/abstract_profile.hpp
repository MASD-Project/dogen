 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_META_MODEL_VARIABILITY_ABSTRACT_PROFILE_HPP
#define DOGEN_LOGICAL_TYPES_META_MODEL_VARIABILITY_ABSTRACT_PROFILE_HPP
...
class abstract_profile : public dogen::logical::meta_model::element {
public:
