 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_META_MODEL_VARIABILITY_FEATURE_TEMPLATE_BUNDLE_HPP
#define DOGEN_LOGICAL_TYPES_META_MODEL_VARIABILITY_FEATURE_TEMPLATE_BUNDLE_HPP
...
#include <string>
#include <algorithm>
#include "dogen.logical/types/meta_model/variability/abstract_bundle.hpp"
#include "dogen.logical/types/meta_model/variability/feature_template.hpp"
 ...
 */
class feature_template_bundle final : public dogen::logical::meta_model::variability::abstract_bundle {
public:
...
public:
     ...
     */
    /**@{*/
    const std::list<dogen::logical::meta_model::variability::feature_template>& feature_templates() const;
    std::list<dogen::logical::meta_model::variability::feature_template>& feature_templates();
    void feature_templates(const std::list<dogen::logical::meta_model::variability::feature_template>& v);
    void feature_templates(const std::list<dogen::logical::meta_model::variability::feature_template>&& v);
    /**@}*/
...
private:
    std::list<dogen::logical::meta_model::variability::feature_template> feature_templates_;
...
template<>
inline void swap(
    dogen::logical::meta_model::variability::feature_template_bundle& lhs,
    dogen::logical::meta_model::variability::feature_template_bundle& rhs) {
    lhs.swap(rhs);
}
