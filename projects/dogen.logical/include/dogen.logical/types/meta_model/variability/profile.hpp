 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_META_MODEL_VARIABILITY_PROFILE_HPP
#define DOGEN_LOGICAL_TYPES_META_MODEL_VARIABILITY_PROFILE_HPP
...
#include <iosfwd>
#include <algorithm>
#include "dogen.logical/types/meta_model/variability/profile_entry.hpp"
#include "dogen.logical/types/meta_model/variability/abstract_profile.hpp"

namespace dogen::logical::meta_model::variability {

class profile final : public dogen::logical::meta_model::variability::abstract_profile {
public:
    profile() = default;
...
public:
    const std::list<dogen::logical::meta_model::variability::profile_entry>& entries() const;
    std::list<dogen::logical::meta_model::variability::profile_entry>& entries();
    void entries(const std::list<dogen::logical::meta_model::variability::profile_entry>& v);
    void entries(const std::list<dogen::logical::meta_model::variability::profile_entry>&& v);
...
private:
    std::list<dogen::logical::meta_model::variability::profile_entry> entries_;
};
...
template<>
inline void swap(
    dogen::logical::meta_model::variability::profile& lhs,
    dogen::logical::meta_model::variability::profile& rhs) {
    lhs.swap(rhs);
}
