 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_META_MODEL_VARIABILITY_ABSTRACT_BUNDLE_HPP
#define DOGEN_LOGICAL_TYPES_META_MODEL_VARIABILITY_ABSTRACT_BUNDLE_HPP
 ...
 */
class abstract_bundle : public dogen::logical::meta_model::element {
public:
...
public:
    virtual bool equals(const dogen::logical::meta_model::element& other) const = 0;
