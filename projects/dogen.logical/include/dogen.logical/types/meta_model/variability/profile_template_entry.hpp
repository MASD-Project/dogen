 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_META_MODEL_VARIABILITY_PROFILE_TEMPLATE_ENTRY_HPP
#define DOGEN_LOGICAL_TYPES_META_MODEL_VARIABILITY_PROFILE_TEMPLATE_ENTRY_HPP
...
class profile_template_entry final : public dogen::logical::meta_model::variability::abstract_profile_entry {
public:
...
public:
    bool equals(const dogen::logical::meta_model::variability::abstract_profile_entry& other) const override;
...
template<>
inline void swap(
    dogen::logical::meta_model::variability::profile_template_entry& lhs,
    dogen::logical::meta_model::variability::profile_template_entry& rhs) {
    lhs.swap(rhs);
}
