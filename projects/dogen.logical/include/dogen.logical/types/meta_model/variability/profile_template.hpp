 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_META_MODEL_VARIABILITY_PROFILE_TEMPLATE_HPP
#define DOGEN_LOGICAL_TYPES_META_MODEL_VARIABILITY_PROFILE_TEMPLATE_HPP
...
#include "dogen.logical/types/meta_model/variability/profile_template_entry.hpp"

namespace dogen::logical::meta_model::variability {

class profile_template final : public dogen::logical::meta_model::variability::abstract_profile {
public:
...
public:
    const std::list<dogen::logical::meta_model::variability::profile_template_entry>& entries() const;
    std::list<dogen::logical::meta_model::variability::profile_template_entry>& entries();
    void entries(const std::list<dogen::logical::meta_model::variability::profile_template_entry>& v);
    void entries(const std::list<dogen::logical::meta_model::variability::profile_template_entry>&& v);
...
private:
    std::list<dogen::logical::meta_model::variability::profile_template_entry> entries_;
};
...
template<>
inline void swap(
    dogen::logical::meta_model::variability::profile_template& lhs,
    dogen::logical::meta_model::variability::profile_template& rhs) {
    lhs.swap(rhs);
}
