 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_META_MODEL_VARIABILITY_FEATURE_BUNDLE_HPP
#define DOGEN_LOGICAL_TYPES_META_MODEL_VARIABILITY_FEATURE_BUNDLE_HPP
 ...
 */
class feature_bundle final : public dogen::logical::meta_model::variability::abstract_bundle {
public:
...
public:
     ...
     */
    /**@{*/
    const std::list<dogen::logical::meta_model::variability::feature>& features() const;
    std::list<dogen::logical::meta_model::variability::feature>& features();
    void features(const std::list<dogen::logical::meta_model::variability::feature>& v);
    void features(const std::list<dogen::logical::meta_model::variability::feature>&& v);
    /**@}*/
...
private:
    std::list<dogen::logical::meta_model::variability::feature> features_;
};
...
template<>
inline void swap(
    dogen::logical::meta_model::variability::feature_bundle& lhs,
    dogen::logical::meta_model::variability::feature_bundle& rhs) {
    lhs.swap(rhs);
}
