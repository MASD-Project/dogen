 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_META_MODEL_VARIABILITY_ABSTRACT_PROFILE_ENTRY_HPP
#define DOGEN_LOGICAL_TYPES_META_MODEL_VARIABILITY_ABSTRACT_PROFILE_ENTRY_HPP
