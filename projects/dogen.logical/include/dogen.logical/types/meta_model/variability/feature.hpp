 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_META_MODEL_VARIABILITY_FEATURE_HPP
#define DOGEN_LOGICAL_TYPES_META_MODEL_VARIABILITY_FEATURE_HPP
 ...
 */
class feature final : public dogen::logical::meta_model::variability::abstract_feature {
public:
    feature() = default;
...
template<>
inline void swap(
    dogen::logical::meta_model::variability::feature& lhs,
    dogen::logical::meta_model::variability::feature& rhs) {
    lhs.swap(rhs);
}
