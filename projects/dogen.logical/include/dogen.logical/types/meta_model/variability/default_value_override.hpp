 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_META_MODEL_VARIABILITY_DEFAULT_VALUE_OVERRIDE_HPP
#define DOGEN_LOGICAL_TYPES_META_MODEL_VARIABILITY_DEFAULT_VALUE_OVERRIDE_HPP
...
template<>
inline void swap(
    dogen::logical::meta_model::variability::default_value_override& lhs,
    dogen::logical::meta_model::variability::default_value_override& rhs) {
    lhs.swap(rhs);
}
