 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_META_MODEL_NAME_HPP
#define DOGEN_LOGICAL_TYPES_META_MODEL_NAME_HPP
...
public:
     ...
     */
    /**@{*/
    const dogen::logical::meta_model::location& location() const;
    dogen::logical::meta_model::location& location();
    void location(const dogen::logical::meta_model::location& v);
    void location(const dogen::logical::meta_model::location&& v);
    /**@}*/
...
private:
    ...
    std::string simple_;
    dogen::logical::meta_model::location location_;
};
...
template<>
inline void swap(
    dogen::logical::meta_model::name& lhs,
    dogen::logical::meta_model::name& rhs) {
    lhs.swap(rhs);
}
