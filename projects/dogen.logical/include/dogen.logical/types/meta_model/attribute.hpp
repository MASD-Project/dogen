 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_META_MODEL_ATTRIBUTE_HPP
#define DOGEN_LOGICAL_TYPES_META_MODEL_ATTRIBUTE_HPP
...
public:
     ...
     */
    /**@{*/
    const dogen::logical::meta_model::name_tree& parsed_type() const;
    dogen::logical::meta_model::name_tree& parsed_type();
    void parsed_type(const dogen::logical::meta_model::name_tree& v);
    void parsed_type(const dogen::logical::meta_model::name_tree&& v);
    /**@}*/
    ...
    const boost::optional<dogen::logical::meta_model::orm::attribute_properties>& orm_properties() const;
    boost::optional<dogen::logical::meta_model::orm::attribute_properties>& orm_properties();
    void orm_properties(const boost::optional<dogen::logical::meta_model::orm::attribute_properties>& v);
    void orm_properties(const boost::optional<dogen::logical::meta_model::orm::attribute_properties>&& v);
...
private:
    ...
    dogen::logical::meta_model::name_tree parsed_type_;
    bool is_immutable_;
    bool is_fluent_;
    boost::optional<dogen::logical::meta_model::orm::attribute_properties> orm_properties_;
...
template<>
inline void swap(
    dogen::logical::meta_model::attribute& lhs,
    dogen::logical::meta_model::attribute& rhs) {
    lhs.swap(rhs);
}
