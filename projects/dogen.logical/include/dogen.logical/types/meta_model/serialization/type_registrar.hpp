 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_META_MODEL_SERIALIZATION_TYPE_REGISTRAR_HPP
#define DOGEN_LOGICAL_TYPES_META_MODEL_SERIALIZATION_TYPE_REGISTRAR_HPP
 ...
 */
class type_registrar final : public dogen::logical::meta_model::element {
public:
...
public:
     ...
     */
    /**@{*/
    const std::list<dogen::logical::meta_model::name>& registrar_dependencies() const;
    std::list<dogen::logical::meta_model::name>& registrar_dependencies();
    void registrar_dependencies(const std::list<dogen::logical::meta_model::name>& v);
    void registrar_dependencies(const std::list<dogen::logical::meta_model::name>&& v);
    /**@}*/
...
private:
    ...
    std::list<dogen::logical::meta_model::name> registrar_dependencies_;
};
...
template<>
inline void swap(
    dogen::logical::meta_model::serialization::type_registrar& lhs,
    dogen::logical::meta_model::serialization::type_registrar& rhs) {
    lhs.swap(rhs);
}
