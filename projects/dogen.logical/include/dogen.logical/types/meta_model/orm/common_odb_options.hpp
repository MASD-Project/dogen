 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_META_MODEL_ORM_COMMON_ODB_OPTIONS_HPP
#define DOGEN_LOGICAL_TYPES_META_MODEL_ORM_COMMON_ODB_OPTIONS_HPP
...
class common_odb_options final : public dogen::logical::meta_model::element {
public:
...
template<>
inline void swap(
    dogen::logical::meta_model::orm::common_odb_options& lhs,
    dogen::logical::meta_model::orm::common_odb_options& rhs) {
    lhs.swap(rhs);
}
