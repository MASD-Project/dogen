 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_META_MODEL_ORM_OBJECT_PROPERTIES_HPP
#define DOGEN_LOGICAL_TYPES_META_MODEL_ORM_OBJECT_PROPERTIES_HPP
...
template<>
inline void swap(
    dogen::logical::meta_model::orm::object_properties& lhs,
    dogen::logical::meta_model::orm::object_properties& rhs) {
    lhs.swap(rhs);
}
