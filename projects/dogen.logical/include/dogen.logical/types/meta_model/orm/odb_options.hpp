 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_META_MODEL_ORM_ODB_OPTIONS_HPP
#define DOGEN_LOGICAL_TYPES_META_MODEL_ORM_ODB_OPTIONS_HPP
...
template<>
inline void swap(
    dogen::logical::meta_model::orm::odb_options& lhs,
    dogen::logical::meta_model::orm::odb_options& rhs) {
    lhs.swap(rhs);
}
