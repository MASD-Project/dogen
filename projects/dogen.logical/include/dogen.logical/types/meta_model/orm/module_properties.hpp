 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_META_MODEL_ORM_MODULE_PROPERTIES_HPP
#define DOGEN_LOGICAL_TYPES_META_MODEL_ORM_MODULE_PROPERTIES_HPP
...
template<>
inline void swap(
    dogen::logical::meta_model::orm::module_properties& lhs,
    dogen::logical::meta_model::orm::module_properties& rhs) {
    lhs.swap(rhs);
}
