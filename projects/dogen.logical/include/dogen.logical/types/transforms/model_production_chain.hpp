 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_TRANSFORMS_MODEL_PRODUCTION_CHAIN_HPP
#define DOGEN_LOGICAL_TYPES_TRANSFORMS_MODEL_PRODUCTION_CHAIN_HPP
...
public:
    static entities::output_model_set
