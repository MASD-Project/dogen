 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_FEATURES_DECORATION_MODELINE_HPP
#define DOGEN_LOGICAL_TYPES_FEATURES_DECORATION_MODELINE_HPP
...
public:
    struct feature_group {
        variability::entities::feature editor;
        variability::entities::feature location;
