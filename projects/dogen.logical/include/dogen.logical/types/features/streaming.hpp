 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_FEATURES_STREAMING_HPP
#define DOGEN_LOGICAL_TYPES_FEATURES_STREAMING_HPP
...
public:
    struct static_configuration {
        ...
        bool requires_quoting;
        bool remove_unprintable_characters;
