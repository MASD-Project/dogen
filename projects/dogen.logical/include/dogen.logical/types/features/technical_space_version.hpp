 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_FEATURES_TECHNICAL_SPACE_VERSION_HPP
#define DOGEN_LOGICAL_TYPES_FEATURES_TECHNICAL_SPACE_VERSION_HPP
...
class technical_space_version final {
public:
    struct feature_group {
        variability::entities::feature standard;
    };
