 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_FEATURES_MAPPING_HPP
#define DOGEN_LOGICAL_TYPES_FEATURES_MAPPING_HPP
...
/**
 * @brief Meta-data related to element mapping.
 */
class mapping final {
public:
    struct feature_group {
        variability::entities::feature target;
        variability::entities::feature destination;
    };
