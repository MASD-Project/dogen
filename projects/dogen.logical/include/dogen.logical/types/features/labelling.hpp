 ...
 *
 */
#ifndef DOGEN_LOGICAL_TYPES_FEATURES_LABELLING_HPP
#define DOGEN_LOGICAL_TYPES_FEATURES_LABELLING_HPP
...
/**
 * @brief Features related to labels.
 */
class labelling final {
public:
    struct feature_group {
        variability::entities::feature label;
    };
...
public:
    struct static_configuration {
        std::list<std::pair<std::string, std::string> > label;
    };
