...
public:
    mapping(
        ...
        const std::unordered_map<dogen::logical::meta_model::technical_space, dogen::logical::helpers::mapping_value>& by_technical_space);
...
public:
     ...
     */
    /**@{*/
    const std::unordered_map<dogen::logical::meta_model::technical_space, dogen::logical::helpers::mapping_value>& by_technical_space() const;
    std::unordered_map<dogen::logical::meta_model::technical_space, dogen::logical::helpers::mapping_value>& by_technical_space();
    void by_technical_space(const std::unordered_map<dogen::logical::meta_model::technical_space, dogen::logical::helpers::mapping_value>& v);
    void by_technical_space(const std::unordered_map<dogen::logical::meta_model::technical_space, dogen::logical::helpers::mapping_value>&& v);
    /**@}*/
...
private:
    ...
    std::unordered_map<dogen::logical::meta_model::technical_space, dogen::logical::helpers::mapping_value> by_technical_space_;
};
