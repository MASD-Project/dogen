...
#include "dogen.logical/serialization/helpers/mapping_value_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::logical::helpers::mapping_value& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::logical::helpers::mapping_value& v, unsigned int version);
