 ...
 *
 */
#ifndef DOGEN_LOGICAL_LEXICAL_CAST_ENTITIES_ORM_DATABASE_SYSTEM_LC_HPP
#define DOGEN_LOGICAL_LEXICAL_CAST_ENTITIES_ORM_DATABASE_SYSTEM_LC_HPP
...
template<>
inline std::string lexical_cast(const dogen::logical::entities::orm::database_system& v) {
    using dogen::logical::entities::orm::database_system;
...
template<>
inline dogen::logical::entities::orm::database_system lexical_cast(const std::string & s) {
    using dogen::logical::entities::orm::database_system;
