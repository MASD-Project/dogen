 ...
 *
 */
#ifndef DOGEN_LOGICAL_LEXICAL_CAST_ENTITIES_ORM_LETTER_CASE_LC_HPP
#define DOGEN_LOGICAL_LEXICAL_CAST_ENTITIES_ORM_LETTER_CASE_LC_HPP
...
template<>
inline std::string lexical_cast(const dogen::logical::entities::orm::letter_case& v) {
    using dogen::logical::entities::orm::letter_case;
...
template<>
inline dogen::logical::entities::orm::letter_case lexical_cast(const std::string & s) {
    using dogen::logical::entities::orm::letter_case;
