 ...
 *
 */
#ifndef DOGEN_LOGICAL_LEXICAL_CAST_ENTITIES_TECHNICAL_SPACE_LC_HPP
#define DOGEN_LOGICAL_LEXICAL_CAST_ENTITIES_TECHNICAL_SPACE_LC_HPP
...
template<>
inline std::string lexical_cast(const dogen::logical::entities::technical_space& v) {
...
template<>
inline dogen::logical::entities::technical_space lexical_cast(const std::string & s) {
    using dogen::logical::entities::technical_space;
