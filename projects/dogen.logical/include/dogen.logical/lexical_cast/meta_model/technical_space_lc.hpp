 ...
 *
 */
#ifndef DOGEN_LOGICAL_LEXICAL_CAST_META_MODEL_TECHNICAL_SPACE_LC_HPP
#define DOGEN_LOGICAL_LEXICAL_CAST_META_MODEL_TECHNICAL_SPACE_LC_HPP
...
template<>
inline std::string lexical_cast(const dogen::logical::meta_model::technical_space& v) {
...
template<>
inline dogen::logical::meta_model::technical_space lexical_cast(const std::string & s) {
    using dogen::logical::meta_model::technical_space;
