...
populate(const unsigned int position, result_type& v) {
    ...
    v.archetypes(create_std_list_dogen_identification_entities_logical_name(position + 5));
    v.helpers(create_std_list_dogen_identification_entities_logical_name(position + 6));
    v.directory_name(create_std_string(position + 7));
    v.postfix(create_std_string(position + 8));
}
