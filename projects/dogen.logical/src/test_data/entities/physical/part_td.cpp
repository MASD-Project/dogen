...
populate(const unsigned int position, result_type& v) {
    ...
    v.external_modules_path_contribution(create_std_string(position + 4));
    v.model_modules_path_contribution(create_std_string(position + 5));
    v.facet_path_contribution(create_std_string(position + 6));
    v.internal_modules_path_contribution(create_std_string(position + 7));
    v.requires_relative_path(create_bool(position + 8));
    v.archetypes(create_std_list_dogen_identification_entities_logical_name(position + 9));
    v.directory_name(create_std_string(position + 10));
}
