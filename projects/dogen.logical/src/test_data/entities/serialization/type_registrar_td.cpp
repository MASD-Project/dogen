...
populate(const unsigned int position, result_type& v) {
    ...
    v.leaves(create_std_list_dogen_identification_entities_logical_name(position + 0));
    v.registrar_dependencies(create_std_list_dogen_identification_entities_logical_name(position + 1));
}
