...
#include "dogen.logical/io/entities/orm/odb_target_io.hpp"
...
inline std::ostream& operator<<(std::ostream& s, const std::list<dogen::logical::entities::orm::odb_target>& v) {
    s << "[ ";
...
std::ostream& operator<<(std::ostream& s, const odb_targets& v) {
    s << " { "
      << "\"__type__\": " << "\"dogen::logical::entities::orm::odb_targets\"" << ", "
