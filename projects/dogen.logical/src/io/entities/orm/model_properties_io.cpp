...
inline std::ostream& operator<<(std::ostream& s, const std::vector<dogen::logical::entities::orm::database_system>& v) {
    s << "[ ";
...
std::ostream& operator<<(std::ostream& s, const model_properties& v) {
    s << " { "
      << "\"__type__\": " << "\"dogen::logical::entities::orm::model_properties\"" << ", "
