...
inline std::ostream& operator<<(std::ostream& s, const boost::optional<dogen::logical::meta_model::orm::database_system>& v) {
...
std::ostream& operator<<(std::ostream& s, const type_mapping& v) {
    s << " { "
      << "\"__type__\": " << "\"dogen::logical::meta_model::orm::type_mapping\"" << ", "
