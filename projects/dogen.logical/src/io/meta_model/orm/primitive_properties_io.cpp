...
#include "dogen.logical/io/meta_model/orm/odb_options_io.hpp"
...
inline std::ostream& operator<<(std::ostream& s, const std::list<dogen::logical::meta_model::orm::type_mapping>& v) {
    s << "[ ";
...
inline std::ostream& operator<<(std::ostream& s, const std::unordered_map<dogen::logical::meta_model::orm::database_system, std::string>& v) {
    s << "[";
    for (auto i(v.begin()); i != v.end(); ++i) {
        if (i != v.begin()) s << ", ";
        s << "[ { " << "\"__type__\": " << "\"key\"" << ", " << "\"data\": ";
...
std::ostream& operator<<(std::ostream& s, const primitive_properties& v) {
    ...
    s << " { "
      << "\"__type__\": " << "\"dogen::logical::meta_model::orm::primitive_properties\"" << ", "
