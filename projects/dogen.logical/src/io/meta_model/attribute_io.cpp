...
inline std::ostream& operator<<(std::ostream& s, const boost::optional<dogen::logical::meta_model::orm::attribute_properties>& v) {
...
std::ostream& operator<<(std::ostream& s, const attribute& v) {
    ...
    s << " { "
      << "\"__type__\": " << "\"dogen::logical::meta_model::attribute\"" << ", "
