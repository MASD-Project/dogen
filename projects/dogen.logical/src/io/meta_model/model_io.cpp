...
#include "dogen.logical/io/meta_model/orm/element_repository_io.hpp"
#include "dogen.logical/io/meta_model/build/element_repository_io.hpp"
#include "dogen.logical/io/meta_model/mapping/element_repository_io.hpp"
#include "dogen.logical/io/meta_model/decoration/element_repository_io.hpp"
#include "dogen.logical/io/meta_model/structural/element_repository_io.hpp"
#include "dogen.logical/io/meta_model/templating/element_repository_io.hpp"
#include "dogen.logical/io/meta_model/variability/element_repository_io.hpp"
#include "dogen.logical/io/meta_model/serialization/element_repository_io.hpp"
...
inline std::ostream& operator<<(std::ostream& s, const std::list<dogen::logical::meta_model::technical_space>& v) {
    s << "[ ";
    for (auto i(v.begin()); i != v.end(); ++i) {
        if (i != v.begin()) s << ", ";
        s << *i;
...
std::ostream& operator<<(std::ostream& s, const model& v) {
    s << " { "
      << "\"__type__\": " << "\"dogen::logical::meta_model::model\"" << ", "
      << "\"name\": " << v.name() << ", "
