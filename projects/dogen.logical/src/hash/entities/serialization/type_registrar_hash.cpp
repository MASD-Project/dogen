...
std::size_t type_registrar_hasher::hash(const type_registrar& v) {
    std::size_t seed(0);
    ...
    combine(seed, hash_std_list_dogen_identification_entities_logical_name(v.registrar_dependencies()));
