...
std::size_t visitor_hasher::hash(const visitor& v) {
    ...
    combine(seed, hash_std_list_dogen_identification_entities_logical_name(v.visits()));
    combine(seed, hash_boost_optional_dogen_identification_entities_logical_name(v.parent()));
