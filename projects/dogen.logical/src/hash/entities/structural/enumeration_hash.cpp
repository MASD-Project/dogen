...
inline std::size_t hash_std_list_dogen_logical_entities_structural_enumerator(const std::list<dogen::logical::entities::structural::enumerator>& v) {
    std::size_t seed(0);
    for (const auto& i : v) {
        combine(seed, i);
    }
...
std::size_t enumeration_hasher::hash(const enumeration& v) {
    ...
    combine(seed, hash_std_list_dogen_logical_entities_structural_enumerator(v.enumerators()));
