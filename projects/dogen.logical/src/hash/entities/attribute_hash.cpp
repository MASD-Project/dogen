...
inline std::size_t hash_boost_optional_dogen_logical_entities_orm_attribute_properties(const boost::optional<dogen::logical::entities::orm::attribute_properties>& v) {
    std::size_t seed(0);
...
std::size_t attribute_hasher::hash(const attribute& v) {
    ...
    combine(seed, hash_boost_optional_dogen_logical_entities_orm_attribute_properties(v.orm_properties()));
    combine(seed, v.member_variable_name());
    combine(seed, v.getter_setter_name());
