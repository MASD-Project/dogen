...
inline std::size_t hash_std_list_boost_shared_ptr_dogen_logical_entities_decoration_modeline(const std::list<boost::shared_ptr<dogen::logical::entities::decoration::modeline> >& v) {
    std::size_t seed(0);
    for (const auto& i : v) {
        combine(seed, hash_boost_shared_ptr_dogen_logical_entities_decoration_modeline(i));
    }
    return seed;
}
...
std::size_t modeline_group_hasher::hash(const modeline_group& v) {
    ...
    combine(seed, hash_std_list_boost_shared_ptr_dogen_logical_entities_decoration_modeline(v.modelines()));
