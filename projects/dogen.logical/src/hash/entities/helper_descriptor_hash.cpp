...
inline std::size_t hash_boost_optional_dogen_logical_entities_streaming_properties(const boost::optional<dogen::logical::entities::streaming_properties>& v) {
    std::size_t seed(0);
...
std::size_t helper_descriptor_hasher::hash(const helper_descriptor& v) {
    ...
    combine(seed, hash_boost_optional_dogen_logical_entities_streaming_properties(v.streaming_properties()));
