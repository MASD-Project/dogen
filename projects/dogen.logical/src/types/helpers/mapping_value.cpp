...
const boost::optional<dogen::identification::entities::logical_name>& mapping_value::default_name() const {
    return default_name_;
}

boost::optional<dogen::identification::entities::logical_name>& mapping_value::default_name() {
    return default_name_;
}

void mapping_value::default_name(const boost::optional<dogen::identification::entities::logical_name>& v) {
    default_name_ = v;
}
