...
inline bool operator==(const boost::shared_ptr<dogen::logical::helpers::node>& lhs,
const boost::shared_ptr<dogen::logical::helpers::node>& rhs) {
    return (!lhs && !rhs) ||(lhs && rhs && (*lhs == *rhs));
}
...
const std::list<boost::shared_ptr<dogen::logical::helpers::node> >& node::children() const {
    return children_;
}

std::list<boost::shared_ptr<dogen::logical::helpers::node> >& node::children() {
    return children_;
}

void node::children(const std::list<boost::shared_ptr<dogen::logical::helpers::node> >& v) {
    children_ = v;
}
