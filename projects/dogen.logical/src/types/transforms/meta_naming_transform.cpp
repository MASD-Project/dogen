...
public:
    ...
    void operator()(logical::meta_model::templating::logic_less_template& v) {
        static const auto n(mnf::make_templating_logic_less_templates_name());
        v.meta_name(n);
    }

    void operator()(logical::meta_model::serialization::type_registrar& v) {
        static const auto n(mnf::make_serialization_type_registrar_name());
        v.meta_name(n);
    }

    void operator()(logical::meta_model::visual_studio::solution& v) {
        static const auto n(mnf::make_visual_studio_solution_name());
        v.meta_name(n);
    }

    void operator()(logical::meta_model::visual_studio::project& v) {
        static const auto n(mnf::make_visual_studio_project_name());
        v.meta_name(n);
    }

    void operator()(logical::meta_model::visual_studio::msbuild_targets& v) {
        static const auto n(mnf::make_visual_studio_msbuild_targets_name());
        v.meta_name(n);
    }

    void operator()(logical::meta_model::orm::common_odb_options& v) {
        static const auto n(mnf::make_orm_common_odb_options_name());
        v.meta_name(n);
    }

    void operator()(logical::meta_model::build::cmakelists& v) {
