...
#include "dogen.logical/io/meta_model/variability/feature_io.hpp"
...
inline std::ostream& operator<<(std::ostream& s, const std::list<dogen::logical::meta_model::variability::feature>& v) {
    s << "[ ";
...
feature_bundle::feature_bundle(
    ...
    const std::list<dogen::logical::meta_model::variability::feature>& features)
...
void feature_bundle::to_stream(std::ostream& s) const {
    s << " { "
      << "\"__type__\": " << "\"dogen::logical::meta_model::variability::feature_bundle\"" << ", "
      << "\"__parent_0__\": ";
...
bool feature_bundle::equals(const dogen::logical::meta_model::element& other) const {
...
const std::list<dogen::logical::meta_model::variability::feature>& feature_bundle::features() const {
    return features_;
}

std::list<dogen::logical::meta_model::variability::feature>& feature_bundle::features() {
    return features_;
}

void feature_bundle::features(const std::list<dogen::logical::meta_model::variability::feature>& v) {
    features_ = v;
}
