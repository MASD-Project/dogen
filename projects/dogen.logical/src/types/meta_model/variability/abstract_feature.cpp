...
void abstract_feature::to_stream(std::ostream& s) const {
    ...
    s << " { "
      << "\"__type__\": " << "\"dogen::logical::meta_model::variability::abstract_feature\"" << ", "
...
const dogen::logical::meta_model::name& abstract_feature::name() const {
    return name_;
}

dogen::logical::meta_model::name& abstract_feature::name() {
    return name_;
}

void abstract_feature::name(const dogen::logical::meta_model::name& v) {
    name_ = v;
}
...
const dogen::logical::meta_model::name_tree& abstract_feature::parsed_type() const {
    return parsed_type_;
}

dogen::logical::meta_model::name_tree& abstract_feature::parsed_type() {
    return parsed_type_;
}

void abstract_feature::parsed_type(const dogen::logical::meta_model::name_tree& v) {
    parsed_type_ = v;
}
