...
#include "dogen.logical/io/meta_model/variability/abstract_bundle_io.hpp"
#include "dogen.logical/io/meta_model/variability/feature_template_io.hpp"
#include "dogen.logical/types/meta_model/variability/feature_template_bundle.hpp"

namespace std {

inline std::ostream& operator<<(std::ostream& s, const std::list<dogen::logical::meta_model::variability::feature_template>& v) {
    s << "[ ";
...
feature_template_bundle::feature_template_bundle(
    ...
    const std::list<dogen::logical::meta_model::variability::feature_template>& feature_templates,
    const std::string& instantiation_domain_name)
    : dogen::logical::meta_model::variability::abstract_bundle(
      name,
      documentation,
      origin_type,
      origin_sha1_hash,
...
void feature_template_bundle::to_stream(std::ostream& s) const {
    s << " { "
      << "\"__type__\": " << "\"dogen::logical::meta_model::variability::feature_template_bundle\"" << ", "
      << "\"__parent_0__\": ";
    dogen::logical::meta_model::variability::abstract_bundle::to_stream(s);
    s << ", "
...
void feature_template_bundle::swap(feature_template_bundle& other) noexcept {
    dogen::logical::meta_model::variability::abstract_bundle::swap(other);
...
bool feature_template_bundle::equals(const dogen::logical::meta_model::element& other) const {
...
bool feature_template_bundle::operator==(const feature_template_bundle& rhs) const {
    return dogen::logical::meta_model::variability::abstract_bundle::compare(rhs) &&
...
const std::list<dogen::logical::meta_model::variability::feature_template>& feature_template_bundle::feature_templates() const {
    return feature_templates_;
}

std::list<dogen::logical::meta_model::variability::feature_template>& feature_template_bundle::feature_templates() {
    return feature_templates_;
}

void feature_template_bundle::feature_templates(const std::list<dogen::logical::meta_model::variability::feature_template>& v) {
