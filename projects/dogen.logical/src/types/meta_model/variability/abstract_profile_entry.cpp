...
void abstract_profile_entry::to_stream(std::ostream& s) const {
    s << " { "
      << "\"__type__\": " << "\"dogen::logical::meta_model::variability::abstract_profile_entry\"" << ", "
...
const dogen::logical::meta_model::name& abstract_profile_entry::name() const {
    return name_;
}

dogen::logical::meta_model::name& abstract_profile_entry::name() {
    return name_;
}

void abstract_profile_entry::name(const dogen::logical::meta_model::name& v) {
    name_ = v;
}
