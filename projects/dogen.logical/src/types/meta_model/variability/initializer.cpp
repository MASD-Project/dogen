...
void initializer::to_stream(std::ostream& s) const {
    s << " { "
      << "\"__type__\": " << "\"dogen::logical::meta_model::variability::initializer\"" << ", "
      << "\"__parent_0__\": ";
...
bool initializer::equals(const dogen::logical::meta_model::element& other) const {
...
const std::list<dogen::logical::meta_model::name>& initializer::feature_template_bundles() const {
    return feature_template_bundles_;
}

std::list<dogen::logical::meta_model::name>& initializer::feature_template_bundles() {
    return feature_template_bundles_;
}

void initializer::feature_template_bundles(const std::list<dogen::logical::meta_model::name>& v) {
...
const std::list<dogen::logical::meta_model::name>& initializer::feature_bundles() const {
    return feature_bundles_;
}

std::list<dogen::logical::meta_model::name>& initializer::feature_bundles() {
    return feature_bundles_;
}

void initializer::feature_bundles(const std::list<dogen::logical::meta_model::name>& v) {
    feature_bundles_ = v;
}
