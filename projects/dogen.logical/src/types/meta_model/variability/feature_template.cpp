...
#include "dogen.logical/io/meta_model/variability/default_value_override_io.hpp"

namespace std {

inline std::ostream& operator<<(std::ostream& s, const std::list<dogen::logical::meta_model::variability::default_value_override>& v) {
    s << "[ ";
...
void feature_template::to_stream(std::ostream& s) const {
    s << " { "
      << "\"__type__\": " << "\"dogen::logical::meta_model::variability::feature_template\"" << ", "
      << "\"__parent_0__\": ";
...
bool feature_template::equals(const dogen::logical::meta_model::variability::abstract_feature& other) const {
...
const std::list<dogen::logical::meta_model::variability::default_value_override>& feature_template::default_value_overrides() const {
    return default_value_overrides_;
}

std::list<dogen::logical::meta_model::variability::default_value_override>& feature_template::default_value_overrides() {
    return default_value_overrides_;
}

void feature_template::default_value_overrides(const std::list<dogen::logical::meta_model::variability::default_value_override>& v) {
