...
#include "dogen.logical/io/meta_model/variability/profile_entry_io.hpp"
#include "dogen.logical/io/meta_model/variability/abstract_profile_io.hpp"

namespace std {

inline std::ostream& operator<<(std::ostream& s, const std::list<dogen::logical::meta_model::variability::profile_entry>& v) {
    s << "[ ";
...
profile::profile(
    ...
    const std::list<dogen::logical::meta_model::variability::profile_entry>& entries)
...
void profile::to_stream(std::ostream& s) const {
    s << " { "
      << "\"__type__\": " << "\"dogen::logical::meta_model::variability::profile\"" << ", "
      << "\"__parent_0__\": ";
...
bool profile::equals(const dogen::logical::meta_model::element& other) const {
...
const std::list<dogen::logical::meta_model::variability::profile_entry>& profile::entries() const {
    return entries_;
}

std::list<dogen::logical::meta_model::variability::profile_entry>& profile::entries() {
    return entries_;
}

void profile::entries(const std::list<dogen::logical::meta_model::variability::profile_entry>& v) {
    entries_ = v;
}
