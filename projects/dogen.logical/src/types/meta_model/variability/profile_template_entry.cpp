...
#include "dogen.logical/io/meta_model/variability/abstract_profile_entry_io.hpp"
...
profile_template_entry::profile_template_entry(
    ...
    : dogen::logical::meta_model::variability::abstract_profile_entry(
      documentation,
      configuration,
      name,
      original_key,
...
void profile_template_entry::to_stream(std::ostream& s) const {
    s << " { "
      << "\"__type__\": " << "\"dogen::logical::meta_model::variability::profile_template_entry\"" << ", "
      << "\"__parent_0__\": ";
    dogen::logical::meta_model::variability::abstract_profile_entry::to_stream(s);
    s << ", "
...
void profile_template_entry::swap(profile_template_entry& other) noexcept {
    dogen::logical::meta_model::variability::abstract_profile_entry::swap(other);

    using std::swap;
    swap(instantiation_domain_name_, other.instantiation_domain_name_);
}

bool profile_template_entry::equals(const dogen::logical::meta_model::variability::abstract_profile_entry& other) const {
...
bool profile_template_entry::operator==(const profile_template_entry& rhs) const {
    return dogen::logical::meta_model::variability::abstract_profile_entry::compare(rhs) &&
