...
void abstract_profile::to_stream(std::ostream& s) const {
    s << " { "
      << "\"__type__\": " << "\"dogen::logical::meta_model::variability::abstract_profile\"" << ", "
      << "\"__parent_0__\": ";
...
const std::list<dogen::logical::meta_model::name>& abstract_profile::parents() const {
    return parents_;
}

std::list<dogen::logical::meta_model::name>& abstract_profile::parents() {
    return parents_;
}

void abstract_profile::parents(const std::list<dogen::logical::meta_model::name>& v) {
    parents_ = v;
}
