...
#include "dogen.logical/io/meta_model/decoration/editor_io.hpp"
#include "dogen.logical/types/meta_model/decoration/modeline.hpp"
#include "dogen.logical/io/meta_model/decoration/modeline_field_io.hpp"
#include "dogen.logical/io/meta_model/decoration/modeline_location_io.hpp"

namespace std {

inline std::ostream& operator<<(std::ostream& s, const std::list<dogen::logical::meta_model::decoration::modeline_field>& v) {
    s << "[ ";
...
modeline::modeline()
    : editor_(static_cast<dogen::logical::meta_model::decoration::editor>(0)),
      location_(static_cast<dogen::logical::meta_model::decoration::modeline_location>(0)),
...
void modeline::to_stream(std::ostream& s) const {
    s << " { "
      << "\"__type__\": " << "\"dogen::logical::meta_model::decoration::modeline\"" << ", "
      << "\"__parent_0__\": ";
...
bool modeline::equals(const dogen::logical::meta_model::element& other) const {
...
dogen::logical::meta_model::decoration::editor modeline::editor() const {
    return editor_;
}

void modeline::editor(const dogen::logical::meta_model::decoration::editor v) {
    editor_ = v;
}

dogen::logical::meta_model::decoration::modeline_location modeline::location() const {
    return location_;
}

void modeline::location(const dogen::logical::meta_model::decoration::modeline_location v) {
    location_ = v;
}

const std::list<dogen::logical::meta_model::decoration::modeline_field>& modeline::fields() const {
    return fields_;
}

std::list<dogen::logical::meta_model::decoration::modeline_field>& modeline::fields() {
    return fields_;
}

void modeline::fields(const std::list<dogen::logical::meta_model::decoration::modeline_field>& v) {
    fields_ = v;
}
...
dogen::logical::meta_model::technical_space modeline::technical_space() const {
    return technical_space_;
}

void modeline::technical_space(const dogen::logical::meta_model::technical_space v) {
    technical_space_ = v;
}
