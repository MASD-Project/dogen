...
#include "dogen.logical/io/meta_model/orm/odb_targets_io.hpp"
...
void cmakelists::to_stream(std::ostream& s) const {
    s << " { "
      << "\"__type__\": " << "\"dogen::logical::meta_model::build::cmakelists\"" << ", "
      << "\"__parent_0__\": ";
...
bool cmakelists::equals(const dogen::logical::meta_model::element& other) const {
...
const dogen::logical::meta_model::orm::odb_targets& cmakelists::odb_targets() const {
    return odb_targets_;
}

dogen::logical::meta_model::orm::odb_targets& cmakelists::odb_targets() {
    return odb_targets_;
}

void cmakelists::odb_targets(const dogen::logical::meta_model::orm::odb_targets& v) {
    odb_targets_ = v;
}
