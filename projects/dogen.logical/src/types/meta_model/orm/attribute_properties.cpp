...
const std::unordered_map<dogen::logical::meta_model::orm::database_system, std::string>& attribute_properties::type_overrides() const {
    return type_overrides_;
}

std::unordered_map<dogen::logical::meta_model::orm::database_system, std::string>& attribute_properties::type_overrides() {
    return type_overrides_;
}

void attribute_properties::type_overrides(const std::unordered_map<dogen::logical::meta_model::orm::database_system, std::string>& v) {
    type_overrides_ = v;
}
