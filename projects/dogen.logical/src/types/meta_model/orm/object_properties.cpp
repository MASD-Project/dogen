...
const dogen::logical::meta_model::orm::odb_options& object_properties::odb_options() const {
    return odb_options_;
}

dogen::logical::meta_model::orm::odb_options& object_properties::odb_options() {
    return odb_options_;
}

void object_properties::odb_options(const dogen::logical::meta_model::orm::odb_options& v) {
    odb_options_ = v;
}
...
const boost::optional<dogen::logical::meta_model::orm::letter_case>& object_properties::letter_case() const {
    return letter_case_;
}

boost::optional<dogen::logical::meta_model::orm::letter_case>& object_properties::letter_case() {
    return letter_case_;
}

void object_properties::letter_case(const boost::optional<dogen::logical::meta_model::orm::letter_case>& v) {
    letter_case_ = v;
}
...
const std::list<dogen::logical::meta_model::orm::type_mapping>& object_properties::type_mappings() const {
    return type_mappings_;
}

std::list<dogen::logical::meta_model::orm::type_mapping>& object_properties::type_mappings() {
    return type_mappings_;
}

void object_properties::type_mappings(const std::list<dogen::logical::meta_model::orm::type_mapping>& v) {
    type_mappings_ = v;
}
