...
model_properties::model_properties(
    ...
    const std::vector<dogen::logical::meta_model::orm::database_system>& database_systems)
...
const boost::optional<dogen::logical::meta_model::orm::letter_case>& model_properties::letter_case() const {
    return letter_case_;
}

boost::optional<dogen::logical::meta_model::orm::letter_case>& model_properties::letter_case() {
    return letter_case_;
}

void model_properties::letter_case(const boost::optional<dogen::logical::meta_model::orm::letter_case>& v) {
    letter_case_ = v;
}
...
const std::vector<dogen::logical::meta_model::orm::database_system>& model_properties::database_systems() const {
    return database_systems_;
}

std::vector<dogen::logical::meta_model::orm::database_system>& model_properties::database_systems() {
    return database_systems_;
}

void model_properties::database_systems(const std::vector<dogen::logical::meta_model::orm::database_system>& v) {
    database_systems_ = v;
}
