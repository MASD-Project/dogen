...
const dogen::logical::meta_model::orm::odb_options& primitive_properties::odb_options() const {
    return odb_options_;
}

dogen::logical::meta_model::orm::odb_options& primitive_properties::odb_options() {
    return odb_options_;
}

void primitive_properties::odb_options(const dogen::logical::meta_model::orm::odb_options& v) {
    odb_options_ = v;
}
...
const boost::optional<dogen::logical::meta_model::orm::letter_case>& primitive_properties::letter_case() const {
    return letter_case_;
}

boost::optional<dogen::logical::meta_model::orm::letter_case>& primitive_properties::letter_case() {
    return letter_case_;
}

void primitive_properties::letter_case(const boost::optional<dogen::logical::meta_model::orm::letter_case>& v) {
    letter_case_ = v;
}
...
const std::list<dogen::logical::meta_model::orm::type_mapping>& primitive_properties::type_mappings() const {
    return type_mappings_;
}

std::list<dogen::logical::meta_model::orm::type_mapping>& primitive_properties::type_mappings() {
    return type_mappings_;
}

void primitive_properties::type_mappings(const std::list<dogen::logical::meta_model::orm::type_mapping>& v) {
    type_mappings_ = v;
}
...
const std::unordered_map<dogen::logical::meta_model::orm::database_system, std::string>& primitive_properties::type_overrides() const {
    return type_overrides_;
}

std::unordered_map<dogen::logical::meta_model::orm::database_system, std::string>& primitive_properties::type_overrides() {
    return type_overrides_;
}

void primitive_properties::type_overrides(const std::unordered_map<dogen::logical::meta_model::orm::database_system, std::string>& v) {
    type_overrides_ = v;
}
