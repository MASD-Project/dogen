...
const std::list<dogen::logical::meta_model::orm::odb_target>& odb_targets::targets() const {
    return targets_;
}

std::list<dogen::logical::meta_model::orm::odb_target>& odb_targets::targets() {
    return targets_;
}

void odb_targets::targets(const std::list<dogen::logical::meta_model::orm::odb_target>& v) {
    targets_ = v;
}
