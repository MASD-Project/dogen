...
void object_template::to_stream(std::ostream& s) const {
    ...
    s << " { "
      << "\"__type__\": " << "\"dogen::logical::meta_model::structural::object_template\"" << ", "
      << "\"__parent_0__\": ";
...
bool object_template::equals(const dogen::logical::meta_model::element& other) const {
...
const std::list<dogen::logical::meta_model::attribute>& object_template::all_attributes() const {
    return all_attributes_;
}

std::list<dogen::logical::meta_model::attribute>& object_template::all_attributes() {
    return all_attributes_;
}

void object_template::all_attributes(const std::list<dogen::logical::meta_model::attribute>& v) {
    all_attributes_ = v;
}
...
const std::list<dogen::logical::meta_model::attribute>& object_template::local_attributes() const {
    return local_attributes_;
}

std::list<dogen::logical::meta_model::attribute>& object_template::local_attributes() {
    return local_attributes_;
}

void object_template::local_attributes(const std::list<dogen::logical::meta_model::attribute>& v) {
    local_attributes_ = v;
}
...
const std::unordered_map<dogen::logical::meta_model::name, std::list<dogen::logical::meta_model::attribute> >& object_template::inherited_attributes() const {
    return inherited_attributes_;
}

std::unordered_map<dogen::logical::meta_model::name, std::list<dogen::logical::meta_model::attribute> >& object_template::inherited_attributes() {
    return inherited_attributes_;
}

void object_template::inherited_attributes(const std::unordered_map<dogen::logical::meta_model::name, std::list<dogen::logical::meta_model::attribute> >& v) {
...
const std::list<dogen::logical::meta_model::name>& object_template::parents() const {
    return parents_;
}

std::list<dogen::logical::meta_model::name>& object_template::parents() {
    return parents_;
}

void object_template::parents(const std::list<dogen::logical::meta_model::name>& v) {
    parents_ = v;
}
