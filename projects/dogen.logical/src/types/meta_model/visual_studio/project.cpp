...
#include "dogen.logical/io/meta_model/visual_studio/item_group_io.hpp"
...
inline std::ostream& operator<<(std::ostream& s, const std::list<dogen::logical::meta_model::visual_studio::item_group>& v) {
    s << "[ ";
...
void project::to_stream(std::ostream& s) const {
    s << " { "
      << "\"__type__\": " << "\"dogen::logical::meta_model::visual_studio::project\"" << ", "
      << "\"__parent_0__\": ";
...
bool project::equals(const dogen::logical::meta_model::element& other) const {
...
const std::list<dogen::logical::meta_model::visual_studio::item_group>& project::item_groups() const {
    return item_groups_;
}

std::list<dogen::logical::meta_model::visual_studio::item_group>& project::item_groups() {
    return item_groups_;
}

void project::item_groups(const std::list<dogen::logical::meta_model::visual_studio::item_group>& v) {
    item_groups_ = v;
}
