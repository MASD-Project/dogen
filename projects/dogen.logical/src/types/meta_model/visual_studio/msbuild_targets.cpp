...
void msbuild_targets::to_stream(std::ostream& s) const {
    s << " { "
      << "\"__type__\": " << "\"dogen::logical::meta_model::visual_studio::msbuild_targets\"" << ", "
      << "\"__parent_0__\": ";
...
bool msbuild_targets::equals(const dogen::logical::meta_model::element& other) const {
...
const dogen::logical::meta_model::orm::odb_targets& msbuild_targets::odb_targets() const {
    return odb_targets_;
}

dogen::logical::meta_model::orm::odb_targets& msbuild_targets::odb_targets() {
    return odb_targets_;
}

void msbuild_targets::odb_targets(const dogen::logical::meta_model::orm::odb_targets& v) {
    odb_targets_ = v;
}
