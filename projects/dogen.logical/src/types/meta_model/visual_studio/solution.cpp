...
#include "dogen.logical/io/meta_model/visual_studio/project_persistence_block_io.hpp"
...
inline std::ostream& operator<<(std::ostream& s, const std::list<dogen::logical::meta_model::visual_studio::project_persistence_block>& v) {
    s << "[ ";
...
void solution::to_stream(std::ostream& s) const {
    s << " { "
      << "\"__type__\": " << "\"dogen::logical::meta_model::visual_studio::solution\"" << ", "
      << "\"__parent_0__\": ";
...
bool solution::equals(const dogen::logical::meta_model::element& other) const {
...
const std::list<dogen::logical::meta_model::visual_studio::project_persistence_block>& solution::project_persistence_blocks() const {
    return project_persistence_blocks_;
}

std::list<dogen::logical::meta_model::visual_studio::project_persistence_block>& solution::project_persistence_blocks() {
    return project_persistence_blocks_;
}

void solution::project_persistence_blocks(const std::list<dogen::logical::meta_model::visual_studio::project_persistence_block>& v) {
