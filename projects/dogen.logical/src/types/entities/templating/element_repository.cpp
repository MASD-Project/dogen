...
inline bool operator==(const boost::shared_ptr<dogen::logical::entities::templating::logic_less_template>& lhs,
const boost::shared_ptr<dogen::logical::entities::templating::logic_less_template>& rhs) {
