...
dogen::identification::entities::technical_space archetype_kind::major_technical_space() const {
    return major_technical_space_;
}

void archetype_kind::major_technical_space(const dogen::identification::entities::technical_space v) {
