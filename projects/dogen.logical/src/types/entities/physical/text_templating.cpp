...
text_templating::text_templating(text_templating&& rhs)
...
text_templating::text_templating(
...
void text_templating::swap(text_templating& other) noexcept {
    using std::swap;
...
bool text_templating::operator==(const text_templating& rhs) const {
...
text_templating& text_templating::operator=(text_templating other) {
    using std::swap;
    swap(*this, other);
    return *this;
}

const boost::shared_ptr<dogen::variability::entities::configuration>& text_templating::configuration() const {
    return configuration_;
}

boost::shared_ptr<dogen::variability::entities::configuration>& text_templating::configuration() {
    return configuration_;
}

void text_templating::configuration(const boost::shared_ptr<dogen::variability::entities::configuration>& v) {
    configuration_ = v;
}
...
const std::string& text_templating::stitch_template_content() const {
    return stitch_template_content_;
}

std::string& text_templating::stitch_template_content() {
    return stitch_template_content_;
}

void text_templating::stitch_template_content(const std::string& v) {
...
const boost::optional<dogen::identification::entities::logical_name>& text_templating::wale_template() const {
    return wale_template_;
}

boost::optional<dogen::identification::entities::logical_name>& text_templating::wale_template() {
    return wale_template_;
}

void text_templating::wale_template(const boost::optional<dogen::identification::entities::logical_name>& v) {
    wale_template_ = v;
}
...
const std::string& text_templating::wale_template_content() const {
    return wale_template_content_;
}

std::string& text_templating::wale_template_content() {
    return wale_template_content_;
}

void text_templating::wale_template_content(const std::string& v) {
...
const std::string& text_templating::rendered_stitch_template() const {
    return rendered_stitch_template_;
}

std::string& text_templating::rendered_stitch_template() {
    return rendered_stitch_template_;
}

void text_templating::rendered_stitch_template(const std::string& v) {
...
const dogen::logical::entities::physical::relations& text_templating::relations() const {
    return relations_;
}

dogen::logical::entities::physical::relations& text_templating::relations() {
    return relations_;
}

void text_templating::relations(const dogen::logical::entities::physical::relations& v) {
    relations_ = v;
}
