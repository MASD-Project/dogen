...
const dogen::logical::entities::fully_qualified_representation& name_tree::qualified() const {
    return qualified_;
}

dogen::logical::entities::fully_qualified_representation& name_tree::qualified() {
    return qualified_;
}

void name_tree::qualified(const dogen::logical::entities::fully_qualified_representation& v) {
    qualified_ = v;
}
...
const dogen::logical::entities::name& name_tree::current() const {
    return current_;
}

dogen::logical::entities::name& name_tree::current() {
    return current_;
}

void name_tree::current(const dogen::logical::entities::name& v) {
    current_ = v;
}
...
const std::list<dogen::logical::entities::name_tree>& name_tree::children() const {
    return children_;
}

std::list<dogen::logical::entities::name_tree>& name_tree::children() {
    return children_;
}

void name_tree::children(const std::list<dogen::logical::entities::name_tree>& v) {
    children_ = v;
}
