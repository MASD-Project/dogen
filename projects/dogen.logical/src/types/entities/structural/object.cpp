...
inline std::ostream& operator<<(std::ostream& s, const boost::optional<dogen::logical::entities::orm::object_properties>& v) {
    s << "{ " << "\"__type__\": " << "\"boost::optional\"" << ", ";
...
void object::to_stream(std::ostream& s) const {
    ...
    s << " { "
      << "\"__type__\": " << "\"dogen::logical::entities::structural::object\"" << ", "
      << "\"__parent_0__\": ";
...
const std::list<dogen::logical::entities::attribute>& object::all_attributes() const {
    return all_attributes_;
}

std::list<dogen::logical::entities::attribute>& object::all_attributes() {
    return all_attributes_;
}

void object::all_attributes(const std::list<dogen::logical::entities::attribute>& v) {
    all_attributes_ = v;
}
...
const std::list<dogen::logical::entities::attribute>& object::local_attributes() const {
    return local_attributes_;
}

std::list<dogen::logical::entities::attribute>& object::local_attributes() {
    return local_attributes_;
}

void object::local_attributes(const std::list<dogen::logical::entities::attribute>& v) {
    local_attributes_ = v;
}
...
const dogen::logical::entities::type_parameters& object::type_parameters() const {
    return type_parameters_;
}

dogen::logical::entities::type_parameters& object::type_parameters() {
    return type_parameters_;
}

void object::type_parameters(const dogen::logical::entities::type_parameters& v) {
    type_parameters_ = v;
}
...
const boost::optional<dogen::logical::entities::orm::object_properties>& object::orm_properties() const {
    return orm_properties_;
}

boost::optional<dogen::logical::entities::orm::object_properties>& object::orm_properties() {
    return orm_properties_;
}
