...
inline bool operator==(const boost::shared_ptr<dogen::logical::entities::serialization::type_registrar>& lhs,
const boost::shared_ptr<dogen::logical::entities::serialization::type_registrar>& rhs) {
