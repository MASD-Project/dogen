...
const boost::optional<dogen::logical::entities::orm::letter_case>& module_properties::letter_case() const {
    return letter_case_;
}

boost::optional<dogen::logical::entities::orm::letter_case>& module_properties::letter_case() {
    return letter_case_;
}

void module_properties::letter_case(const boost::optional<dogen::logical::entities::orm::letter_case>& v) {
    letter_case_ = v;
}
