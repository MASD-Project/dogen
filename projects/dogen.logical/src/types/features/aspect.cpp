...
aspect::feature_group
aspect::make_feature_group(const dogen::variability::entities::feature_model& fm) {
    feature_group r;
...
aspect::static_configuration aspect::make_static_configuration(
