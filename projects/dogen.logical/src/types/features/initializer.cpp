...
register_entities(variability::helpers::registrar& rg) {
    ...
    rg.register_features(dogen::logical::features::helpers::make_features());
    rg.register_features(dogen::logical::features::labelling::make_features());
    ...
    rg.register_features(dogen::logical::features::technical_space_properties::make_features());
