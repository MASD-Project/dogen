...
*** manual associations                                           :attribute:
    :PROPERTIES:
    :masd.codec.type: manual_associations
    :END:

Stores all associations added manually to the model.
...
** manual associations                                              :element:
   :PROPERTIES:
   :custom_id: 2D88CCC8-DEC6-9E74-0503-39772C6A628E
   :END:
...
Represents a part-to-whole relationship between elements.
...
Binary relationship between two elements.
