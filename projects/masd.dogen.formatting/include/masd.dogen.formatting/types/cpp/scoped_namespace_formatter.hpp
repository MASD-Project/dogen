 ...
 *
 */
#ifndef MASD_DOGEN_FORMATTNG_TYPES_CPP_SCOPED_NAMESPACE_FORMATTER_HPP
#define MASD_DOGEN_FORMATTNG_TYPES_CPP_SCOPED_NAMESPACE_FORMATTER_HPP
...
public:
    scoped_namespace_formatter(
        ...
        const bool nested_namespace = false);
