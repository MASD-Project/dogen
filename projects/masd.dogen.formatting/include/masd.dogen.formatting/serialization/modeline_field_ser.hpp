 ...
 *
 */
#ifndef MASD_DOGEN_FORMATTING_SERIALIZATION_MODELINE_FIELD_SER_HPP
#define MASD_DOGEN_FORMATTING_SERIALIZATION_MODELINE_FIELD_SER_HPP
...
BOOST_SERIALIZATION_SPLIT_FREE(masd::dogen::formatting::modeline_field)
namespace boost {
