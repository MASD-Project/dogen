...
BOOST_AUTO_TEST_CASE(identical_objects_are_equal) {
    masd::dogen::variability::meta_model::potential_binding_generator g;
    const auto a(g());
    const auto b(a);
...
BOOST_AUTO_TEST_CASE(moved_objects_are_equal) {
    ...
    g();
    auto a(g());
    const auto b = masd::dogen::variability::meta_model::potential_binding();
    const auto c(a);
    BOOST_CHECK(a != b);
    BOOST_CHECK(a == c);
...
BOOST_AUTO_TEST_CASE(assigned_objects_are_equal) {
    ...
    g();
    const auto a(g());
    masd::dogen::variability::meta_model::potential_binding b;
    BOOST_CHECK(a != b);
...
BOOST_AUTO_TEST_CASE(copy_constructed_objects_are_equal) {
    ...
    b = masd::dogen::variability::meta_model::potential_binding();
    BOOST_CHECK(a != b);
}
