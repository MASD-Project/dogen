...
inline std::ostream& operator<<(std::ostream& s, const std::unordered_map<std::string, masd::dogen::variability::meta_model::profile>& v) {
    s << "[";
...
std::ostream& operator<<(std::ostream& s, const profile_repository& v) {
    s << " { "
      << "\"__type__\": " << "\"masd::dogen::variability::meta_model::profile_repository\"" << ", "
      << "\"by_name\": " << v.by_name() << ", "
