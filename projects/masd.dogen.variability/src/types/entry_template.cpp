...
const masd::dogen::variability::name& entry_template::name() const {
    return name_;
}

masd::dogen::variability::name& entry_template::name() {
    return name_;
}

void entry_template::name(const masd::dogen::variability::name& v) {
    name_ = v;
}
...
const masd::dogen::archetypes::location& entry_template::archetype_location() const {
    return archetype_location_;
}

masd::dogen::archetypes::location& entry_template::archetype_location() {
    return archetype_location_;
}

void entry_template::archetype_location(const masd::dogen::archetypes::location& v) {
...
masd::dogen::variability::template_kinds entry_template::kind() const {
    return kind_;
}

void entry_template::kind(const masd::dogen::variability::template_kinds v) {
    kind_ = v;
}
