...
const std::string transform_id(
    "variability.transforms.configuration_template_hydration_transform");
...
configuration_template_hydration_transform::to_template_directories(
...
configuration_template_hydration_transform::obtain_template_filenames(
...
std::list<meta_model::configuration_template>
configuration_template_hydration_transform::hydrate_templates(
    const std::list<boost::filesystem::path>& tfn) {
    std::list<meta_model::configuration_template> r;
    helpers::configuration_template_hydrator h;
...
std::list<meta_model::configuration_template>
configuration_template_hydration_transform::apply(const context& ctx) {
    tracing::scoped_transform_tracer stp(lg,
        "configuration template hydration transform",
