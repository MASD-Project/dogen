...
const std::list<masd::dogen::variability::archetype_location>& archetype_location_repository_parts::archetype_locations() const {
    return archetype_locations_;
}

std::list<masd::dogen::variability::archetype_location>& archetype_location_repository_parts::archetype_locations() {
    return archetype_locations_;
}

void archetype_location_repository_parts::archetype_locations(const std::list<masd::dogen::variability::archetype_location>& v) {
...
const std::unordered_map<std::string, masd::dogen::variability::archetype_locations_group>& archetype_location_repository_parts::archetype_locations_by_meta_name() const {
    return archetype_locations_by_meta_name_;
}

std::unordered_map<std::string, masd::dogen::variability::archetype_locations_group>& archetype_location_repository_parts::archetype_locations_by_meta_name() {
    return archetype_locations_by_meta_name_;
}

void archetype_location_repository_parts::archetype_locations_by_meta_name(const std::unordered_map<std::string, masd::dogen::variability::archetype_locations_group>& v) {
...
const std::unordered_map<std::string, std::list<masd::dogen::variability::archetype_location> >& archetype_location_repository_parts::archetype_locations_by_family() const {
    return archetype_locations_by_family_;
}

std::unordered_map<std::string, std::list<masd::dogen::variability::archetype_location> >& archetype_location_repository_parts::archetype_locations_by_family() {
    return archetype_locations_by_family_;
}

void archetype_location_repository_parts::archetype_locations_by_family(const std::unordered_map<std::string, std::list<masd::dogen::variability::archetype_location> >& v) {
...
const std::unordered_map<std::string, std::list<masd::dogen::variability::archetype_location> >& archetype_location_repository_parts::archetype_locations_by_intra_backend_segment() const {
    return archetype_locations_by_intra_backend_segment_;
}

std::unordered_map<std::string, std::list<masd::dogen::variability::archetype_location> >& archetype_location_repository_parts::archetype_locations_by_intra_backend_segment() {
    return archetype_locations_by_intra_backend_segment_;
}

void archetype_location_repository_parts::archetype_locations_by_intra_backend_segment(const std::unordered_map<std::string, std::list<masd::dogen::variability::archetype_location> >& v) {
