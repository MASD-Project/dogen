...
const std::list<masd::dogen::variability::entry_template>& profile::templates() const {
    return templates_;
}

std::list<masd::dogen::variability::entry_template>& profile::templates() {
    return templates_;
}

void profile::templates(const std::list<masd::dogen::variability::entry_template>& v) {
    templates_ = v;
}
