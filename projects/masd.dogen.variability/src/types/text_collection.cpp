...
void text_collection::to_stream(std::ostream& s) const {
    s << " { "
      << "\"__type__\": " << "\"masd::dogen::variability::text_collection\"" << ", "
      << "\"__parent_0__\": ";
    masd::dogen::variability::value::to_stream(s);
    s << ", "
      << "\"content\": " << content_
      << " }";
}
...
void text_collection::swap(text_collection& other) noexcept {
    masd::dogen::variability::value::swap(other);

    using std::swap;
    swap(content_, other.content_);
}

bool text_collection::equals(const masd::dogen::variability::value& other) const {
...
bool text_collection::operator==(const text_collection& rhs) const {
    return masd::dogen::variability::value::compare(rhs) &&
