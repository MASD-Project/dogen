...
profile_template_repository::profile_template_repository(const std::list<masd::dogen::variability::meta_model::profile_template>& templates)
...
const std::list<masd::dogen::variability::meta_model::profile_template>& profile_template_repository::templates() const {
    return templates_;
}

std::list<masd::dogen::variability::meta_model::profile_template>& profile_template_repository::templates() {
    return templates_;
}

void profile_template_repository::templates(const std::list<masd::dogen::variability::meta_model::profile_template>& v) {
    templates_ = v;
}
