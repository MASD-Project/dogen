...
void element::to_stream(std::ostream& s) const {
    s << " { "
      << "\"__type__\": " << "\"masd::dogen::variability::meta_model::element\"" << ", "
      << "\"name\": " << name_ << ", "
...
const masd::dogen::variability::meta_model::name& element::name() const {
    return name_;
}

masd::dogen::variability::meta_model::name& element::name() {
    return name_;
}

void element::name(const masd::dogen::variability::meta_model::name& v) {
    name_ = v;
}
