...
masd::dogen::variability::meta_model::binding_action feature_template::profile_binding_action() const {
    return profile_binding_action_;
}

void feature_template::profile_binding_action(const masd::dogen::variability::meta_model::binding_action v) {
    profile_binding_action_ = v;
}

masd::dogen::variability::meta_model::binding_action feature_template::configuration_binding_action() const {
    return configuration_binding_action_;
}

void feature_template::configuration_binding_action(const masd::dogen::variability::meta_model::binding_action v) {
