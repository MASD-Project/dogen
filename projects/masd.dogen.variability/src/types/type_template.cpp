...
type_template::type_template()
    : value_type_(static_cast<masd::dogen::variability::value_types>(0)),
      ...
      kind_(static_cast<masd::dogen::variability::template_kinds>(0)) { }
...
const masd::dogen::variability::name& type_template::name() const {
    return name_;
}

masd::dogen::variability::name& type_template::name() {
    return name_;
}

void type_template::name(const masd::dogen::variability::name& v) {
    name_ = v;
}
...
masd::dogen::variability::value_types type_template::value_type() const {
    return value_type_;
}

void type_template::value_type(const masd::dogen::variability::value_types v) {
    value_type_ = v;
}

masd::dogen::variability::scope_types type_template::scope() const {
    return scope_;
}

void type_template::scope(const masd::dogen::variability::scope_types v) {
    scope_ = v;
}

const masd::dogen::variability::archetype_location& type_template::archetype_location() const {
    return archetype_location_;
}

masd::dogen::variability::archetype_location& type_template::archetype_location() {
    return archetype_location_;
}

void type_template::archetype_location(const masd::dogen::variability::archetype_location& v) {
...
const boost::shared_ptr<masd::dogen::variability::value>& type_template::default_value() const {
    return default_value_;
}

boost::shared_ptr<masd::dogen::variability::value>& type_template::default_value() {
    return default_value_;
}

void type_template::default_value(const boost::shared_ptr<masd::dogen::variability::value>& v) {
    default_value_ = v;
}
...
masd::dogen::variability::template_kinds type_template::kind() const {
    return kind_;
}

void type_template::kind(const masd::dogen::variability::template_kinds v) {
    kind_ = v;
}
