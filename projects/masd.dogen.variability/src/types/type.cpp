...
const masd::dogen::archetypes::location& type::archetype_location() const {
    return archetype_location_;
}

masd::dogen::archetypes::location& type::archetype_location() {
    return archetype_location_;
}

void type::archetype_location(const masd::dogen::archetypes::location& v) {
