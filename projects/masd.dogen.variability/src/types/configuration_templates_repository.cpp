...
configuration_templates_repository::configuration_templates_repository(const std::unordered_map<std::string, masd::dogen::variability::profile>& by_name)
    : by_name_(by_name) { }
...
const std::unordered_map<std::string, masd::dogen::variability::profile>& configuration_templates_repository::by_name() const {
    return by_name_;
}

std::unordered_map<std::string, masd::dogen::variability::profile>& configuration_templates_repository::by_name() {
    return by_name_;
}

void configuration_templates_repository::by_name(const std::unordered_map<std::string, masd::dogen::variability::profile>& v) {
    by_name_ = v;
}
