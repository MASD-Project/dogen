...
const std::unordered_map<std::string, boost::shared_ptr<masd::dogen::variability::value> >& annotation::tagged_values() const {
    return tagged_values_;
}

std::unordered_map<std::string, boost::shared_ptr<masd::dogen::variability::value> >& annotation::tagged_values() {
    return tagged_values_;
}

void annotation::tagged_values(const std::unordered_map<std::string, boost::shared_ptr<masd::dogen::variability::value> >& v) {
    tagged_values_ = v;
}
...
masd::dogen::variability::scope_types annotation::scope() const {
    return scope_;
}

void annotation::scope(const masd::dogen::variability::scope_types v) {
    scope_ = v;
}
