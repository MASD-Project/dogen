...
#include "masd.dogen.variability/test_data/meta_model/configuration_templates_repository_td.hpp"
...
std::unordered_map<std::string, masd::dogen::variability::meta_model::configuration_template> create_std_unordered_map_std_string_masd_dogen_variability_meta_model_configuration_template(unsigned int position) {
    std::unordered_map<std::string, masd::dogen::variability::meta_model::configuration_template> r;
    for (unsigned int i(0); i < 4; ++i) {
        r.insert(std::make_pair(create_std_string(position + i), create_masd_dogen_variability_meta_model_configuration_template(position + i)));
    }
    return r;
}
...
populate(const unsigned int position, result_type& v) {
    v.by_name(create_std_unordered_map_std_string_masd_dogen_variability_meta_model_configuration_template(position + 0));
}
