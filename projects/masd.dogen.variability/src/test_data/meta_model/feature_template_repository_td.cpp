...
create_masd_dogen_variability_meta_model_feature_template(const unsigned int position) {
    return masd::dogen::variability::meta_model::feature_template_generator::create(position);
}

std::list<masd::dogen::variability::meta_model::feature_template> create_std_list_masd_dogen_variability_meta_model_feature_template(unsigned int position) {
    std::list<masd::dogen::variability::meta_model::feature_template> r;
    for (unsigned int i(0); i < 4; ++i) {
        r.push_back(create_masd_dogen_variability_meta_model_feature_template(position + i));
    }
    return r;
}
...
populate(const unsigned int position, result_type& v) {
    v.templates(create_std_list_masd_dogen_variability_meta_model_feature_template(position + 0));
}
