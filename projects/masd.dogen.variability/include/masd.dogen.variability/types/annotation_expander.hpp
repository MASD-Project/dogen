 ...
 *
 */
#ifndef MASD_DOGEN_VARIABILITY_TYPES_ANNOTATION_EXPANDER_HPP
#define MASD_DOGEN_VARIABILITY_TYPES_ANNOTATION_EXPANDER_HPP
...
private:
    ...
    const archetypes::location_repository&
