 ...
 *
 */
#ifndef MASD_DOGEN_VARIABILITY_TYPES_BOOLEAN_HPP
#define MASD_DOGEN_VARIABILITY_TYPES_BOOLEAN_HPP
 ...
 */
class boolean final : public masd::dogen::variability::value {
public:
...
template<>
inline void swap(
    masd::dogen::variability::boolean& lhs,
    masd::dogen::variability::boolean& rhs) {
    lhs.swap(rhs);
}
