 ...
 *
 */
#ifndef MASD_DOGEN_VARIABILITY_TYPES_KEY_VALUE_PAIR_HPP
#define MASD_DOGEN_VARIABILITY_TYPES_KEY_VALUE_PAIR_HPP
...
class key_value_pair final : public masd::dogen::variability::value {
public:
...
template<>
inline void swap(
    masd::dogen::variability::key_value_pair& lhs,
    masd::dogen::variability::key_value_pair& rhs) {
    lhs.swap(rhs);
}
