 ...
 *
 */
#ifndef MASD_DOGEN_VARIABILITY_TYPES_META_MODEL_KEY_VALUE_PAIR_HPP
#define MASD_DOGEN_VARIABILITY_TYPES_META_MODEL_KEY_VALUE_PAIR_HPP
 ...
 */
class key_value_pair final : public masd::dogen::variability::meta_model::value {
public:
...
template<>
inline void swap(
    masd::dogen::variability::meta_model::key_value_pair& lhs,
    masd::dogen::variability::meta_model::key_value_pair& rhs) {
    lhs.swap(rhs);
}
