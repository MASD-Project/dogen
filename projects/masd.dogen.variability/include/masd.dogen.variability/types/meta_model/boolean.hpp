 ...
 *
 */
#ifndef MASD_DOGEN_VARIABILITY_TYPES_META_MODEL_BOOLEAN_HPP
#define MASD_DOGEN_VARIABILITY_TYPES_META_MODEL_BOOLEAN_HPP
 ...
 */
class boolean final : public masd::dogen::variability::meta_model::value {
public:
...
template<>
inline void swap(
    masd::dogen::variability::meta_model::boolean& lhs,
    masd::dogen::variability::meta_model::boolean& rhs) {
    lhs.swap(rhs);
}
