 ...
 *
 */
#ifndef MASD_DOGEN_VARIABILITY_TYPES_META_MODEL_TEXT_HPP
#define MASD_DOGEN_VARIABILITY_TYPES_META_MODEL_TEXT_HPP
 ...
 */
class text final : public masd::dogen::variability::meta_model::value {
public:
    text() = default;
...
template<>
inline void swap(
    masd::dogen::variability::meta_model::text& lhs,
    masd::dogen::variability::meta_model::text& rhs) {
    lhs.swap(rhs);
}
