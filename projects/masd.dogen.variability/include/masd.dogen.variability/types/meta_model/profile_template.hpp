 ...
 *
 */
#ifndef MASD_DOGEN_VARIABILITY_TYPES_META_MODEL_PROFILE_TEMPLATE_HPP
#define MASD_DOGEN_VARIABILITY_TYPES_META_MODEL_PROFILE_TEMPLATE_HPP
 ...
 */
class profile_template final : public masd::dogen::variability::meta_model::element {
public:
...
template<>
inline void swap(
    masd::dogen::variability::meta_model::profile_template& lhs,
    masd::dogen::variability::meta_model::profile_template& rhs) {
    lhs.swap(rhs);
}
