 ...
 *
 */
#ifndef MASD_DOGEN_VARIABILITY_TYPES_META_MODEL_NUMBER_HPP
#define MASD_DOGEN_VARIABILITY_TYPES_META_MODEL_NUMBER_HPP
 ...
 */
class number final : public masd::dogen::variability::meta_model::value {
public:
...
template<>
inline void swap(
    masd::dogen::variability::meta_model::number& lhs,
    masd::dogen::variability::meta_model::number& rhs) {
    lhs.swap(rhs);
}
