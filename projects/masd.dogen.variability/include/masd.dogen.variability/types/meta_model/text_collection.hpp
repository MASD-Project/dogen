 ...
 *
 */
#ifndef MASD_DOGEN_VARIABILITY_TYPES_META_MODEL_TEXT_COLLECTION_HPP
#define MASD_DOGEN_VARIABILITY_TYPES_META_MODEL_TEXT_COLLECTION_HPP
 ...
 */
class text_collection final : public masd::dogen::variability::meta_model::value {
public:
...
public:
    bool equals(const masd::dogen::variability::meta_model::value& other) const override;
...
template<>
inline void swap(
    masd::dogen::variability::meta_model::text_collection& lhs,
    masd::dogen::variability::meta_model::text_collection& rhs) {
    lhs.swap(rhs);
}
