 ...
 *
 */
#ifndef MASD_DOGEN_VARIABILITY_TYPES_TEXT_COLLECTION_HPP
#define MASD_DOGEN_VARIABILITY_TYPES_TEXT_COLLECTION_HPP
 ...
 */
class text_collection final : public masd::dogen::variability::value {
public:
...
template<>
inline void swap(
    masd::dogen::variability::text_collection& lhs,
    masd::dogen::variability::text_collection& rhs) {
    lhs.swap(rhs);
}
