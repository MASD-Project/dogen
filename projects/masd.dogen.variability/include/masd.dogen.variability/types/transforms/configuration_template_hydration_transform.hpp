 ...
 *
 */
#ifndef MASD_DOGEN_VARIABILITY_TYPES_TRANSFORMS_CONFIGURATION_TEMPLATE_HYDRATION_TRANSFORM_HPP
#define MASD_DOGEN_VARIABILITY_TYPES_TRANSFORMS_CONFIGURATION_TEMPLATE_HYDRATION_TRANSFORM_HPP
