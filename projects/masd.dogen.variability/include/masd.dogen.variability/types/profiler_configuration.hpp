 ...
 *
 */
#ifndef MASD_DOGEN_VARIABILITY_TYPES_PROFILER_CONFIGURATION_HPP
#define MASD_DOGEN_VARIABILITY_TYPES_PROFILER_CONFIGURATION_HPP
...
public:
    const masd::dogen::variability::profile& profile() const;
    masd::dogen::variability::profile& profile();
    void profile(const masd::dogen::variability::profile& v);
    void profile(const masd::dogen::variability::profile&& v);
...
private:
    masd::dogen::variability::profile profile_;
...
template<>
inline void swap(
    masd::dogen::variability::profiler_configuration& lhs,
    masd::dogen::variability::profiler_configuration& rhs) {
    lhs.swap(rhs);
}
