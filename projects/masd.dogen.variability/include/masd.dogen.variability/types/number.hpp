 ...
 *
 */
#ifndef MASD_DOGEN_VARIABILITY_TYPES_NUMBER_HPP
#define MASD_DOGEN_VARIABILITY_TYPES_NUMBER_HPP
 ...
 */
class number final : public masd::dogen::variability::value {
public:
...
template<>
inline void swap(
    masd::dogen::variability::number& lhs,
    masd::dogen::variability::number& rhs) {
    lhs.swap(rhs);
}
