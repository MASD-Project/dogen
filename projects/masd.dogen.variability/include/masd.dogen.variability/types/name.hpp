 ...
 *
 */
#ifndef MASD_DOGEN_VARIABILITY_TYPES_NAME_HPP
#define MASD_DOGEN_VARIABILITY_TYPES_NAME_HPP
...
template<>
inline void swap(
    masd::dogen::variability::name& lhs,
    masd::dogen::variability::name& rhs) {
    lhs.swap(rhs);
}
