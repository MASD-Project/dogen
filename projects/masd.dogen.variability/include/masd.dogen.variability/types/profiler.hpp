 ...
 *
 */
#ifndef MASD_DOGEN_VARIABILITY_TYPES_PROFILER_HPP
#define MASD_DOGEN_VARIABILITY_TYPES_PROFILER_HPP
...
private:
    ...
    void setup_annotations(const archetypes::location_repository& alrp,
