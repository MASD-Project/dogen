 ...
 *
 */
#ifndef MASD_DOGEN_VARIABILITY_TYPES_ARCHETYPE_LOCATION_HPP
#define MASD_DOGEN_VARIABILITY_TYPES_ARCHETYPE_LOCATION_HPP
...
template<>
inline void swap(
    masd::dogen::variability::archetype_location& lhs,
    masd::dogen::variability::archetype_location& rhs) {
    lhs.swap(rhs);
}
