 ...
 *
 */
#ifndef DOGEN_SML_TYPES_ENUMERATOR_HPP
#define DOGEN_SML_TYPES_ENUMERATOR_HPP
...
#include <algorithm>
#include <string>
#include "dogen/sml/serialization/enumerator_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::sml::enumerator& lhs,
    dogen::sml::enumerator& rhs) {
    lhs.swap(rhs);
}
