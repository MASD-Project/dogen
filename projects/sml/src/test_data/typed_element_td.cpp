...
populate(const unsigned int position, result_type& v) {
    v.parent_name(create_boost_optional_dogen_sml_qname(position + 0));
    v.original_parent_name(create_boost_optional_dogen_sml_qname(position + 1));
    v.properties(create_std_vector_dogen_sml_property(position + 2));
