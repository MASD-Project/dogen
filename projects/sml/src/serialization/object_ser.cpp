...
#ifdef __linux__
template void save(eos::portable_oarchive& ar, const dogen::sml::object& v, unsigned int version);
template void load(eos::portable_iarchive& ar, dogen::sml::object& v, unsigned int version);
#endif
