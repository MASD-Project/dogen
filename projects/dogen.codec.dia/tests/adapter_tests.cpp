...
#include "dogen.codec.dia/io/context_io.hpp"
...
using mock_factory = dogen::codec::dia::test::mock_processed_object_factory;
...
dogen::codec::dia::context empty_context;
dogen::variability::scribble_group empty_scribble_group;

}

using dogen::codec::dia::adaptation_error;
