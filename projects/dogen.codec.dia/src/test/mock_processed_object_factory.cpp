...
object mock_processed_object_factory::
...
std::array<object, 2> mock_processed_object_factory::
...
std::array<object, 3> mock_processed_object_factory::
...
std::array<object, 4> mock_processed_object_factory::
