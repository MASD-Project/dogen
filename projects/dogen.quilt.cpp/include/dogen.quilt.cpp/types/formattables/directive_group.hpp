 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_TYPES_FORMATTABLES_DIRECTIVE_GROUP_HPP
#define DOGEN_QUILT_CPP_TYPES_FORMATTABLES_DIRECTIVE_GROUP_HPP
...
#include <string>
#include <algorithm>
#include "dogen.quilt.cpp/serialization/formattables/directive_group_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::quilt::cpp::formattables::directive_group& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::quilt::cpp::formattables::directive_group& v, unsigned int version);
...
template<>
inline void swap(
    dogen::quilt::cpp::formattables::directive_group& lhs,
    dogen::quilt::cpp::formattables::directive_group& rhs) {
    lhs.swap(rhs);
}
