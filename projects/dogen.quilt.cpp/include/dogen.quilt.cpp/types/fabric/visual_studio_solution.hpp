 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_TYPES_FABRIC_VISUAL_STUDIO_SOLUTION_HPP
#define DOGEN_QUILT_CPP_TYPES_FABRIC_VISUAL_STUDIO_SOLUTION_HPP
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::quilt::cpp::fabric::visual_studio_solution& v, unsigned int version);
...
template<>
inline void swap(
    dogen::quilt::cpp::fabric::visual_studio_solution& lhs,
    dogen::quilt::cpp::fabric::visual_studio_solution& rhs) {
    lhs.swap(rhs);
}
