 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_TYPES_FORMATTERS_HASH_ASSOCIATIVE_CONTAINER_HELPER_HPP
#define DOGEN_QUILT_CPP_TYPES_FORMATTERS_HASH_ASSOCIATIVE_CONTAINER_HELPER_HPP
