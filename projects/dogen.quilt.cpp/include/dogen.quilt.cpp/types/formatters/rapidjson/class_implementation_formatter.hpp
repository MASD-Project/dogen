 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_TYPES_FORMATTERS_RAPIDJSON_CLASS_IMPLEMENTATION_FORMATTER_HPP
#define DOGEN_QUILT_CPP_TYPES_FORMATTERS_RAPIDJSON_CLASS_IMPLEMENTATION_FORMATTER_HPP
