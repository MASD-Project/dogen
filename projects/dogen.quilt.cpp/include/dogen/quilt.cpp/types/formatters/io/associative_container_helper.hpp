 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_TYPES_FORMATTERS_IO_ASSOCIATIVE_CONTAINER_HELPER_HPP
#define DOGEN_QUILT_CPP_TYPES_FORMATTERS_IO_ASSOCIATIVE_CONTAINER_HELPER_HPP
