 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_TYPES_FORMATTABLES_LOCATOR_CONFIGURATION_HPP
#define DOGEN_QUILT_CPP_TYPES_FORMATTABLES_LOCATOR_CONFIGURATION_HPP
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::quilt::cpp::formattables::locator_configuration& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::quilt::cpp::formattables::locator_configuration& v, unsigned int version);

public:
    const std::unordered_map<std::string, dogen::quilt::cpp::formattables::locator_facet_configuration>& facet_configurations() const;
    std::unordered_map<std::string, dogen::quilt::cpp::formattables::locator_facet_configuration>& facet_configurations();
...
template<>
inline void swap(
    dogen::quilt::cpp::formattables::locator_configuration& lhs,
    dogen::quilt::cpp::formattables::locator_configuration& rhs) {
    lhs.swap(rhs);
}
