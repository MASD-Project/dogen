 ...
 *
 */
#ifndef DOGEN_TEST_MODELS_TWO_LAYERS_WITH_OBJECTS_TYPES_PACKAGE_1_CLASS_1_HPP
#define DOGEN_TEST_MODELS_TWO_LAYERS_WITH_OBJECTS_TYPES_PACKAGE_1_CLASS_1_HPP
...
#include <algorithm>
#include "dogen/test_models/two_layers_with_objects/serialization/package_1/class_1_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::test_models::two_layers_with_objects::package_1::class_1& lhs,
    dogen::test_models::two_layers_with_objects::package_1::class_1& rhs) {
    lhs.swap(rhs);
}
