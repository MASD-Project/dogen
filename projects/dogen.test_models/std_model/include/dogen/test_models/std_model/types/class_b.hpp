 ...
 *
 */
#ifndef DOGEN_TEST_MODELS_STD_MODEL_TYPES_CLASS_B_HPP
#define DOGEN_TEST_MODELS_STD_MODEL_TYPES_CLASS_B_HPP
...
#include "dogen/test_models/std_model/serialization/class_b_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::test_models::std_model::class_b& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::test_models::std_model::class_b& v, unsigned int version);
...
public:
    ...
    const std::vector<dogen::test_models::std_model::pkg1::class_c>& prop_2() const;
    std::vector<dogen::test_models::std_model::pkg1::class_c>& prop_2();
    void prop_2(const std::vector<dogen::test_models::std_model::pkg1::class_c>& v);
    void prop_2(const std::vector<dogen::test_models::std_model::pkg1::class_c>&& v);
    ...
    const std::vector<dogen::test_models::std_model::class_a>& prop_4() const;
    std::vector<dogen::test_models::std_model::class_a>& prop_4();
    void prop_4(const std::vector<dogen::test_models::std_model::class_a>& v);
    void prop_4(const std::vector<dogen::test_models::std_model::class_a>&& v);
...
private:
    ...
    std::vector<dogen::test_models::std_model::pkg1::class_c> prop_2_;
    std::vector<unsigned int> prop_3_;
    std::vector<dogen::test_models::std_model::class_a> prop_4_;
...
template<>
inline void swap(
    dogen::test_models::std_model::class_b& lhs,
    dogen::test_models::std_model::class_b& rhs) {
    lhs.swap(rhs);
}
