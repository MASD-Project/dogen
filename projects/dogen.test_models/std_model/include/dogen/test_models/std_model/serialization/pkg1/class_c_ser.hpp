 ...
 *
 */
#ifndef DOGEN_TEST_MODELS_STD_MODEL_SERIALIZATION_PKG1_CLASS_C_SER_HPP
#define DOGEN_TEST_MODELS_STD_MODEL_SERIALIZATION_PKG1_CLASS_C_SER_HPP
...
BOOST_SERIALIZATION_SPLIT_FREE(dogen::test_models::std_model::pkg1::class_c)
namespace boost {
