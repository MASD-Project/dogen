...
inline std::ostream& operator<<(std::ostream& s, const std::unordered_map<dogen::test_models::std_model::class_a, dogen::test_models::std_model::pkg1::class_c>& v) {
    s << "[";
    for (auto i(v.begin()); i != v.end(); ++i) {
        if (i != v.begin()) s << ", ";
        s << "[ { " << "\"__type__\": " << "\"key\"" << ", " << "\"data\": ";
...
std::ostream& operator<<(std::ostream& s, const class_f& v) {
    s << " { "
      << "\"__type__\": " << "\"dogen::test_models::std_model::class_f\"" << ", "
      << "\"prop_0\": " << v.prop_0() << ", "
      << "\"prop_1\": " << v.prop_1() << ", "
      << "\"prop_2\": " << v.prop_2()
      << " }";
