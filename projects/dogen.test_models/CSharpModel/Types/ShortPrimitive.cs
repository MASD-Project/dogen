...
namespace Dogen.TestModels.CSharpModel
{
    ...
    /// </summary>
    public sealed class ShortPrimitive
    {
        #region Properties
        /// <summary>
        ...
        public ShortPrimitive(short value)
        {
            Value = value;
        }
        #endregion
        ...
        public override bool Equals(object obj)
        {
            ...
            var value = obj as ShortPrimitive;
            if (value == null) return false;
            return
                Value == value.Value;
        }

        public static bool operator ==(ShortPrimitive lhs, ShortPrimitive rhs)
        {
