...
void child_via_settings::to_stream(std::ostream& s) const {
    s << " { "
      << "\"__type__\": " << "\"dogen::test_models::cpp_model::package_9::child_via_settings\"" << ", "
      << "\"__parent_0__\": ";
...
bool child_via_settings::equals(const dogen::test_models::cpp_model::parent_outside& other) const {
