...
rectangle_generator::rectangle_generator() : position_(0) { }

void rectangle_generator::
populate(const unsigned int position, result_type& v) {
    v.value(create_std_string(position + 0));
}

rectangle_generator::result_type
rectangle_generator::create(const unsigned int position) {
    rectangle r;
...
rectangle_generator::create_ptr(const unsigned int position) {
    ...
    rectangle_generator::populate(position, *p);
    return p;
}

rectangle_generator::result_type
rectangle_generator::operator()() {
