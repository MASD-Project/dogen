...
BOOST_AUTO_TEST_CASE(identical_objects_are_equal) {
    masd::dogen::dia::color_generator g;
    const auto a(g());
    const auto b(a);
...
BOOST_AUTO_TEST_CASE(moved_objects_are_equal) {
    masd::dogen::dia::color_generator g;
    auto a(g());
    const auto b = masd::dogen::dia::color();
    const auto c(a);
    BOOST_CHECK(a != b);
    BOOST_CHECK(a == c);
...
BOOST_AUTO_TEST_CASE(xml_roundtrip_produces_the_same_entity) {
    ...
    masd::dogen::dia::color b = masd::dogen::dia::color();
