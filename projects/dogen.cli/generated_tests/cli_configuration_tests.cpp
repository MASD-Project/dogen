...
BOOST_AUTO_TEST_SUITE(cli_configuration_tests)

BOOST_AUTO_TEST_CASE(identical_objects_are_equal) {
    dogen::cli::cli_configuration_generator g;
    const auto a(g());
    const auto b(a);
...
BOOST_AUTO_TEST_CASE(moved_objects_are_equal) {
    ...
    g();
    auto a(g());
    const auto b = dogen::cli::cli_configuration();
    const auto c(a);
    BOOST_CHECK(a != b);
    BOOST_CHECK(a == c);
