...
#include "dogen.cli/serialization/cli_configuration_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::cli::cli_configuration& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::cli::cli_configuration& v, unsigned int version);
