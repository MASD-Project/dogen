...
using dogen::injection::dia::processed_object;
using dogen::injection::dia::processed_attribute;
using dogen::injection::dia::test::mock_processed_object_factory;

processed_object create_object(const dogen::injection::dia::dia_object_types ot,
...
processed_object
create_named_object(const dogen::injection::dia::dia_object_types ot,
    const unsigned int n) {
...
namespace dogen::injection::dia::test {
