...
const dogen::injection::dia::processed_comment& processed_attribute::comment() const {
    return comment_;
}

dogen::injection::dia::processed_comment& processed_attribute::comment() {
    return comment_;
}

void processed_attribute::comment(const dogen::injection::dia::processed_comment& v) {
    comment_ = v;
}
