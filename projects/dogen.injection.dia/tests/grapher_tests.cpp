...
#include "dogen.injection.dia/io/processed_object_io.hpp"
#include "dogen.injection.dia/test/mock_processed_object_factory.hpp"
#include "dogen.injection.dia/types/graphing_error.hpp"
...
using factory = dogen::injection::dia::test::mock_processed_object_factory;
...
bool is_root_id(const std::string id) {
    return id == dogen::injection::dia::grapher::root_id();
}

class visitor : public boost::default_dfs_visitor {
public:
    visitor() : objects_(
        new std::list<dogen::injection::dia::processed_object>()) {}
...
public:
    ...
    const std::list<dogen::injection::dia::processed_object>& result() {
        return *objects_;
    }

private:
    std::shared_ptr<std::list<dogen::injection::dia::processed_object>>
    objects_;
};
...
using dogen::utility::test::contains_checker;
using dogen::injection::dia::graphing_error;
