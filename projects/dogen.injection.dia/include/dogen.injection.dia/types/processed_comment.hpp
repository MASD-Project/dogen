 ...
 *
 */
#ifndef DOGEN_INJECTION_DIA_TYPES_PROCESSED_COMMENT_HPP
#define DOGEN_INJECTION_DIA_TYPES_PROCESSED_COMMENT_HPP
...
template<>
inline void swap(
    dogen::injection::dia::processed_comment& lhs,
    dogen::injection::dia::processed_comment& rhs) {
    lhs.swap(rhs);
}
