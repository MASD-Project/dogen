 ...
 *
 */
#ifndef DOGEN_INJECTION_DIA_TYPES_PROCESSED_OBJECT_HPP
#define DOGEN_INJECTION_DIA_TYPES_PROCESSED_OBJECT_HPP
...
public:
    processed_object(
        ...
        const dogen::injection::dia::dia_object_types dia_object_type,
        const std::string& stereotypes,
        const dogen::injection::dia::processed_comment& comment,
        const std::string& child_node_id,
        const boost::optional<std::pair<std::string, std::string> >& connection,
        const std::list<dogen::injection::dia::processed_attribute>& attributes);
...
public:
     ...
     */
    /**@{*/
    dogen::injection::dia::dia_object_types dia_object_type() const;
    void dia_object_type(const dogen::injection::dia::dia_object_types v);
    /**@}*/
     ...
     */
    /**@{*/
    const dogen::injection::dia::processed_comment& comment() const;
    dogen::injection::dia::processed_comment& comment();
    void comment(const dogen::injection::dia::processed_comment& v);
    void comment(const dogen::injection::dia::processed_comment&& v);
    /**@}*/
     ...
     */
    /**@{*/
    const std::list<dogen::injection::dia::processed_attribute>& attributes() const;
    std::list<dogen::injection::dia::processed_attribute>& attributes();
    void attributes(const std::list<dogen::injection::dia::processed_attribute>& v);
    void attributes(const std::list<dogen::injection::dia::processed_attribute>&& v);
    /**@}*/
...
private:
    std::string id_;
    std::string name_;
    dogen::injection::dia::dia_object_types dia_object_type_;
    std::string stereotypes_;
    dogen::injection::dia::processed_comment comment_;
    std::string child_node_id_;
    boost::optional<std::pair<std::string, std::string> > connection_;
    std::list<dogen::injection::dia::processed_attribute> attributes_;
};
...
template<>
inline void swap(
    dogen::injection::dia::processed_object& lhs,
    dogen::injection::dia::processed_object& rhs) {
    lhs.swap(rhs);
}
