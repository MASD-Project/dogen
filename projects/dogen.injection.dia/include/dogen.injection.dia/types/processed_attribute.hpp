 ...
 *
 */
#ifndef DOGEN_INJECTION_DIA_TYPES_PROCESSED_ATTRIBUTE_HPP
#define DOGEN_INJECTION_DIA_TYPES_PROCESSED_ATTRIBUTE_HPP
...
template<>
inline void swap(
    dogen::injection::dia::processed_attribute& lhs,
    dogen::injection::dia::processed_attribute& rhs) {
    lhs.swap(rhs);
}
