...
#include "dogen.injection.dia/io/processed_attribute_io.hpp"
...
BOOST_AUTO_TEST_CASE(identical_objects_are_equal) {
    dogen::injection::dia::processed_attribute_generator g;
    const auto a(g());
    const auto b(a);
...
BOOST_AUTO_TEST_CASE(moved_objects_are_equal) {
    ...
    g();
    auto a(g());
    const auto b = dogen::injection::dia::processed_attribute();
    const auto c(a);
    BOOST_CHECK(a != b);
    BOOST_CHECK(a == c);
...
BOOST_AUTO_TEST_CASE(assigned_objects_are_equal) {
    ...
    g();
    const auto a(g());
    dogen::injection::dia::processed_attribute b;
    BOOST_CHECK(a != b);
...
BOOST_AUTO_TEST_CASE(copy_constructed_objects_are_equal) {
    ...
    b = dogen::injection::dia::processed_attribute();
    BOOST_CHECK(a != b);
}
