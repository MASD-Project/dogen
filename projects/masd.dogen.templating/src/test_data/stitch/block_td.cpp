...
#include "masd.dogen.templating/test_data/stitch/block_types_td.hpp"

namespace {

masd::dogen::templating::stitch::block_types
create_masd_dogen_templating_stitch_block_types(const unsigned int position) {
    return masd::dogen::templating::stitch::block_types_generator::create(position);
}
...
populate(const unsigned int position, result_type& v) {
    v.type(create_masd_dogen_templating_stitch_block_types(position + 0));
