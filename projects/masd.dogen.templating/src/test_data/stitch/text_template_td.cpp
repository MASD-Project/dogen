...
create_masd_dogen_templating_stitch_text_template_body(const unsigned int position) {
    return masd::dogen::templating::stitch::text_template_body_generator::create(position);
}
