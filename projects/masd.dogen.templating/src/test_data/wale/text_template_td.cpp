 ...
 */
#include <sstream>
#include "masd.dogen.templating/test_data/wale/properties_td.hpp"
#include "masd.dogen.templating/test_data/wale/text_template_td.hpp"

namespace {

masd::dogen::templating::wale::properties
create_masd_dogen_templating_wale_properties(const unsigned int position) {
    return masd::dogen::templating::wale::properties_generator::create(position);
}
...
populate(const unsigned int position, result_type& v) {
    v.properties(create_masd_dogen_templating_wale_properties(position + 0));
