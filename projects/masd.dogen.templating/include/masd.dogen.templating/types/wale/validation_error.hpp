 ...
 *
 */
#ifndef MASD_DOGEN_TEMPLATING_TYPES_WALE_VALIDATION_ERROR_HPP
#define MASD_DOGEN_TEMPLATING_TYPES_WALE_VALIDATION_ERROR_HPP
...
/**
 * @brief An error occurred whilst validating.
 */
