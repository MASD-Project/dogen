 ...
 *
 */
#ifndef MASD_DOGEN_TEMPLATING_TYPES_HELPERS_RESOLUTION_ERROR_HPP
#define MASD_DOGEN_TEMPLATING_TYPES_HELPERS_RESOLUTION_ERROR_HPP
...
/**
 * @brief An error occurred when trying to resolve a key.
 */
