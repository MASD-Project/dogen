 ...
 *
 */
#ifndef MASD_DOGEN_TEMPLATING_TYPES_HELPERS_VALIDATION_ERROR_HPP
#define MASD_DOGEN_TEMPLATING_TYPES_HELPERS_VALIDATION_ERROR_HPP
...
/**
 * @brief An error occurred with the supplied KVPs.
 */
