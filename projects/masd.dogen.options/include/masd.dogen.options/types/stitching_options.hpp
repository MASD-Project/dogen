 ...
 *
 */
#ifndef MASD_DOGEN_OPTIONS_TYPES_STITCHING_OPTIONS_HPP
#define MASD_DOGEN_OPTIONS_TYPES_STITCHING_OPTIONS_HPP
...
template<>
inline void swap(
    masd::dogen::options::stitching_options& lhs,
    masd::dogen::options::stitching_options& rhs) {
    lhs.swap(rhs);
}
