 ...
 *
 */
#ifndef DOGEN_DMP_DOMAIN_UNVERSIONED_KEY_HPP
#define DOGEN_DMP_DOMAIN_UNVERSIONED_KEY_HPP
...
#include <algorithm>
#include "dogen/dmp/serialization/unversioned_key_fwd_ser.hpp"
...
public:
    friend class dogen::dmp::unversioned_key_serializer;
...
template<>
inline void swap(
    dogen::dmp::unversioned_key& lhs,
    dogen::dmp::unversioned_key& rhs) {
    lhs.swap(rhs);
}
