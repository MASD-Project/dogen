...
template<>
struct hash<dogen::dmp::package1::first_class> {
public:
    size_t operator()(const dogen::dmp::package1::first_class& v) const {
        return dogen::dmp::package1::first_class_hasher::hash(v);
    }
};
