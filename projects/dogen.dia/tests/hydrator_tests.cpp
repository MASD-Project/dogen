...
const std::string test_module("dogen.dia.tests");
...
BOOST_AUTO_TEST_CASE(cpp_model_results_in_expected_objects) {
    ...
    const auto input(injection_dia::input_cpp_model_dia());
    const auto actual(injection_dia::actual_cpp_model_dia_xml());
    const auto expected(injection_dia::expected_cpp_model_dia_xml());
...
BOOST_IGNORE_AUTO_TEST_CASE(compressed_diagram_results_in_expected_objects) {
    ...
    const auto input(injection_dia::input_compressed_dia());
    const auto actual(injection_dia::actual_compressed_dia_xml());
    const auto expected(injection_dia::expected_compressed_dia_xml());
    BOOST_CHECK(test_hydrator(input, expected, actual));
}
...
BOOST_AUTO_TEST_CASE(empty_diagram_results_in_expected_objects) {
    ...
    const auto input(injection_dia::input_empty_dia());
    const auto actual(injection_dia::actual_empty_dia_xml());
    const auto expected(injection_dia::expected_empty_dia_xml());
    BOOST_CHECK(test_hydrator(input, expected, actual));
}
...
BOOST_AUTO_TEST_CASE(two_empty_layers_diagram_results_in_expected_objects) {
    ...
    const auto input(injection_dia::input_two_empty_layers_dia());
    const auto actual(injection_dia::actual_two_empty_layers_dia_xml());
    const auto expected(injection_dia::expected_two_empty_layers_dia_xml());
    BOOST_CHECK(test_hydrator(input, expected, actual));
}
...
BOOST_AUTO_TEST_CASE(class_without_name_results_in_expected_objects) {
    ...
    const auto input(injection_dia::input_class_without_name_dia());
    const auto actual(injection_dia::actual_class_without_name_dia_xml());
    const auto expected(injection_dia::expected_class_without_name_dia_xml());
    BOOST_CHECK(test_hydrator(input, expected, actual));
}
...
BOOST_AUTO_TEST_CASE(package_without_name_results_in_expected_objects) {
    ...
    const auto input(injection_dia::input_package_without_name_dia());
    const auto actual(injection_dia::actual_package_without_name_dia_xml());
    const auto expected(injection_dia::expected_package_without_name_dia_xml());
    BOOST_CHECK(test_hydrator(input, expected, actual));
}
...
BOOST_AUTO_TEST_CASE(two_layers_with_objects_results_in_expected_objects) {
    ...
    const auto input(injection_dia::input_two_layers_with_objects_dia());
    const auto actual(injection_dia::actual_two_layers_with_objects_dia_xml());
    const auto expected(injection_dia::expected_two_layers_with_objects_dia_xml());
    BOOST_CHECK(test_hydrator(input, expected, actual));
}
...
BOOST_AUTO_TEST_CASE(boost_model_results_in_expected_objects) {
    ...
    const auto input(injection_dia::input_boost_model_dia());
    const auto actual(injection_dia::actual_boost_model_dia_xml());
    const auto expected(injection_dia::expected_boost_model_dia_xml());
    BOOST_CHECK(test_hydrator(input, expected, actual));
}

BOOST_AUTO_TEST_CASE(std_model_results_in_expected_objects) {
    SETUP_TEST_LOG_SOURCE("std_model_results_in_expected_objects");
    const auto input(injection_dia::input_std_model_dia());
    const auto actual(injection_dia::actual_std_model_dia_xml());
    const auto expected(injection_dia::expected_std_model_dia_xml());
    BOOST_CHECK(test_hydrator(input, expected, actual));
}
