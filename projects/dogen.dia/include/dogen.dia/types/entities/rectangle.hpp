 ...
 *
 */
#ifndef DOGEN_DIA_TYPES_ENTITIES_RECTANGLE_HPP
#define DOGEN_DIA_TYPES_ENTITIES_RECTANGLE_HPP
...
template<>
inline void swap(
    dogen::dia::entities::rectangle& lhs,
    dogen::dia::entities::rectangle& rhs) {
    lhs.swap(rhs);
}
