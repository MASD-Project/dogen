 ...
 *
 */
#ifndef DOGEN_QUILT_CSHARP_TYPES_FORMATTABLES_HELPER_CONFIGURATION_HPP
#define DOGEN_QUILT_CSHARP_TYPES_FORMATTABLES_HELPER_CONFIGURATION_HPP
...
#include "dogen/quilt.csharp/serialization/formattables/helper_configuration_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::quilt::csharp::formattables::helper_configuration& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::quilt::csharp::formattables::helper_configuration& v, unsigned int version);
...
template<>
inline void swap(
    dogen::quilt::csharp::formattables::helper_configuration& lhs,
    dogen::quilt::csharp::formattables::helper_configuration& rhs) {
    lhs.swap(rhs);
}
