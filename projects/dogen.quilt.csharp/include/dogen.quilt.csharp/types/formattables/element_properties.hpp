...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::quilt::csharp::formattables::element_properties& v, unsigned int version);
...
template<>
inline void swap(
    dogen::quilt::csharp::formattables::element_properties& lhs,
    dogen::quilt::csharp::formattables::element_properties& rhs) {
    lhs.swap(rhs);
}
