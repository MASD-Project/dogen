...
inline std::ostream& operator<<(std::ostream& s, const std::unordered_map<std::string, dogen::quilt::csharp::formattables::auxiliary_function_properties>& v) {
    s << "[";
...
std::ostream& operator<<(std::ostream& s, const attribute_properties& v) {
    s << " { "
      << "\"__type__\": " << "\"dogen::quilt::csharp::formattables::attribute_properties\"" << ", "
