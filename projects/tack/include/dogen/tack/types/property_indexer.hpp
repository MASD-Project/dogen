 ...
 *
 */
#ifndef DOGEN_TACK_TYPES_PROPERTY_INDEXER_HPP
#define DOGEN_TACK_TYPES_PROPERTY_INDEXER_HPP
 ...
 *
 * @section tack_property_indexer_0 Model requirements
 *
 * The concept indexer expects to receive a partial model such as ones
 * coming straight out of Dia to Tack transformation. The indexing of
 * concepts is expected to have taken place.
 *
 * @section tack_property_indexer_1 Types of properties
 *
 ...
 *
 * @subsection tack_property_indexer_11 Local properties
 *
 ...
 *
 * @subsection tack_property_indexer_12 Inherited properties
 *
 ...
 *
 * @subsection tack_property_indexer_13 All properties
 *
