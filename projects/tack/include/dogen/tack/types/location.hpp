 ...
 *
 */
#ifndef DOGEN_TACK_TYPES_LOCATION_HPP
#define DOGEN_TACK_TYPES_LOCATION_HPP
...
#include <string>
#include <algorithm>
#include "dogen/tack/serialization/location_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::tack::location& lhs,
    dogen::tack::location& rhs) {
    lhs.swap(rhs);
}
