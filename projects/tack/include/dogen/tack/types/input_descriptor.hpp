 ...
 *
 */
#ifndef DOGEN_TACK_TYPES_INPUT_DESCRIPTOR_HPP
#define DOGEN_TACK_TYPES_INPUT_DESCRIPTOR_HPP
...
#include "dogen/tack/serialization/input_descriptor_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::tack::input_descriptor& lhs,
    dogen::tack::input_descriptor& rhs) {
    lhs.swap(rhs);
}
