 ...
 *
 */
#ifndef DOGEN_TACK_TYPES_TACK_HPP
#define DOGEN_TACK_TYPES_TACK_HPP
...
/**
 * @brief Tack is the intermediate meta-model.
 *
 * @section tack_0 Mission
 *
 * Tack is a meta-model that provides an intermediate representation. Its
 * objectives are:
 *
 ...
 *   etc.).
 * - to provide the tooling required to combine multiple Tack models
