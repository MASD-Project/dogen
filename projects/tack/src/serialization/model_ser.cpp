...
template void save(archive::polymorphic_oarchive& ar, const dogen::tack::model& v, unsigned int version);
template void load(archive::polymorphic_iarchive& ar, dogen::tack::model& v, unsigned int version);

template void save(archive::text_oarchive& ar, const dogen::tack::model& v, unsigned int version);
template void load(archive::text_iarchive& ar, dogen::tack::model& v, unsigned int version);

template void save(archive::binary_oarchive& ar, const dogen::tack::model& v, unsigned int version);
template void load(archive::binary_iarchive& ar, dogen::tack::model& v, unsigned int version);

template void save(archive::xml_oarchive& ar, const dogen::tack::model& v, unsigned int version);
template void load(archive::xml_iarchive& ar, dogen::tack::model& v, unsigned int version);
