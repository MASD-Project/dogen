...
dogen::tack::generation_types type::generation_type() const {
    return generation_type_;
}

void type::generation_type(const dogen::tack::generation_types v) {
    generation_type_ = v;
}

dogen::tack::origin_types type::origin_type() const {
    return origin_type_;
}

void type::origin_type(const dogen::tack::origin_types v) {
    origin_type_ = v;
}
