...
dogen::tack::generation_types model::generation_type() const {
    return generation_type_;
}

void model::generation_type(const dogen::tack::generation_types v) {
    generation_type_ = v;
}

dogen::tack::origin_types model::origin_type() const {
    return origin_type_;
}

void model::origin_type(const dogen::tack::origin_types v) {
    origin_type_ = v;
}
