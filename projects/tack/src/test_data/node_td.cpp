...
dogen::tack::node*
create_dogen_tack_node_ptr(const unsigned int) {
    return nullptr;
}

boost::shared_ptr<dogen::tack::node>
create_boost_shared_ptr_dogen_tack_node(unsigned int position) {
    boost::shared_ptr<dogen::tack::node> r(
        create_dogen_tack_node_ptr(position));
    return r;
}
...
std::list<boost::shared_ptr<dogen::tack::node> > create_std_list_boost_shared_ptr_dogen_tack_node_(unsigned int position) {
    std::list<boost::shared_ptr<dogen::tack::node> > r;
    for (unsigned int i(0); i < 4; ++i) {
        r.push_back(create_boost_shared_ptr_dogen_tack_node(position + i));
    }
    return r;
}
