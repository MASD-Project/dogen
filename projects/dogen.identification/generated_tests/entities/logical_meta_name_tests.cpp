...
BOOST_AUTO_TEST_SUITE(entities_logical_meta_name_tests)

BOOST_AUTO_TEST_CASE(identical_objects_are_equal) {
    dogen::identification::entities::logical_meta_name_generator g;
    const auto a(g());
    const auto b(a);
...
BOOST_AUTO_TEST_CASE(moved_objects_are_equal) {
    ...
    g();
    auto a(g());
    const auto b = dogen::identification::entities::logical_meta_name();
    const auto c(a);
    BOOST_CHECK(a != b);
    BOOST_CHECK(a == c);
...
BOOST_AUTO_TEST_CASE(assigned_objects_are_equal) {
    ...
    g();
    const auto a(g());
    dogen::identification::entities::logical_meta_name b;
    BOOST_CHECK(a != b);
...
BOOST_AUTO_TEST_CASE(copy_constructed_objects_are_equal) {
    ...
    b = dogen::identification::entities::logical_meta_name();
    BOOST_CHECK(a != b);
}
...
BOOST_AUTO_TEST_CASE(xml_roundtrip_produces_the_same_entity) {
    ...
    dogen::identification::entities::logical_meta_name b = dogen::identification::entities::logical_meta_name();
...
BOOST_AUTO_TEST_CASE(equal_objects_generate_the_same_hash) {
    ...
    std::hash<dogen::identification::entities::logical_meta_name> hasher;
