...
#include "dogen.identification/types/helpers/printing_error.hpp"
#include "dogen.identification/types/helpers/pretty_printer.hpp"

namespace {

using namespace dogen::utility::log;
auto lg(logger_factory("identification.helpers.pretty_printer"));
...
to_list(const entities::logical_name& n, const bool model_name_mode) const {
...
void pretty_printer::
add(const entities::logical_name& n, const bool model_name_mode) {
