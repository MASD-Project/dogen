...
#include <string>
#include <algorithm>
#include "dogen.identification/serialization/entities/logical_id_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::identification::entities::logical_id& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::identification::entities::logical_id& v, unsigned int version);
