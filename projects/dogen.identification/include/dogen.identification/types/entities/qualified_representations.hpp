...
#include <string>
#include <algorithm>
#include "dogen.identification/serialization/entities/qualified_representations_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::identification::entities::qualified_representations& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::identification::entities::qualified_representations& v, unsigned int version);
