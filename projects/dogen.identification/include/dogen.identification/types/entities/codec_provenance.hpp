...
#include "dogen.identification/serialization/entities/codec_provenance_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::identification::entities::codec_provenance& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::identification::entities::codec_provenance& v, unsigned int version);
