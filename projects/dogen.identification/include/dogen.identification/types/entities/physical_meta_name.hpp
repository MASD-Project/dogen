...
#include "dogen.identification/serialization/entities/physical_meta_name_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::identification::entities::physical_meta_name& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::identification::entities::physical_meta_name& v, unsigned int version);
