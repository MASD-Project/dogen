...
#include <string>
#include <algorithm>
#include "dogen.identification/serialization/entities/physical_meta_id_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::identification::entities::physical_meta_id& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::identification::entities::physical_meta_id& v, unsigned int version);
