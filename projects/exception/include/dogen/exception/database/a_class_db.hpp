 ...
 *
 */
#ifndef DOGEN_EXCEPTION_DATABASE_A_CLASS_DB_HPP
#define DOGEN_EXCEPTION_DATABASE_A_CLASS_DB_HPP
...
private:
    ...
    std::vector<dogen::exception::a_class> load_internal(
...
public:
    std::vector<dogen::exception::a_class> load(
        pqxx::connection& connection,
        const boost::optional<versioned_key> id =boost::optional<versioned_key>());

    void save(
        pqxx::connection& connection,
        std::vector<dogen::exception::a_class> values);
