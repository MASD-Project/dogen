 ...
 *
 */
#ifndef DOGEN_EXCEPTION_DOMAIN_UNVERSIONED_KEY_HPP
#define DOGEN_EXCEPTION_DOMAIN_UNVERSIONED_KEY_HPP
...
#include <algorithm>
#include "dogen/exception/serialization/unversioned_key_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::exception::unversioned_key& lhs,
    dogen::exception::unversioned_key& rhs) {
    lhs.swap(rhs);
}
