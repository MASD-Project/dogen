 ...
 *
 */
#ifndef DOGEN_ENUMERATION_DOMAIN_UNVERSIONED_KEY_HPP
#define DOGEN_ENUMERATION_DOMAIN_UNVERSIONED_KEY_HPP
...
#include <algorithm>
#include "dogen/enumeration/serialization/unversioned_key_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::enumeration::unversioned_key& lhs,
    dogen::enumeration::unversioned_key& rhs) {
    lhs.swap(rhs);
}
