 ...
 *
 */
#ifndef DOGEN_ENUMERATION_DOMAIN_VERSIONED_KEY_HPP
#define DOGEN_ENUMERATION_DOMAIN_VERSIONED_KEY_HPP
...
#include "dogen/enumeration/serialization/versioned_key_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::enumeration::versioned_key& lhs,
    dogen::enumeration::versioned_key& rhs) {
    lhs.swap(rhs);
}
