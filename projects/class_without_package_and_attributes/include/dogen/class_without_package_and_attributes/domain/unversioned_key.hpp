 ...
 *
 */
#ifndef DOGEN_CLASS_WITHOUT_PACKAGE_AND_ATTRIBUTES_DOMAIN_UNVERSIONED_KEY_HPP
#define DOGEN_CLASS_WITHOUT_PACKAGE_AND_ATTRIBUTES_DOMAIN_UNVERSIONED_KEY_HPP
...
public:
    friend class dogen::class_without_package_and_attributes::unversioned_key_serializer;
...
template<>
inline void swap(
    dogen::class_without_package_and_attributes::unversioned_key& lhs,
    dogen::class_without_package_and_attributes::unversioned_key& rhs) {
    lhs.swap(rhs);
}
