...
#include "dogen/class_without_package_and_attributes/io/versioned_key_io.hpp"
#include "dogen/utility/io/jsonify_io.hpp"

namespace dogen {
namespace class_without_package_and_attributes {

class_1::class_1(dogen::class_without_package_and_attributes::versioned_key versioned_key)
