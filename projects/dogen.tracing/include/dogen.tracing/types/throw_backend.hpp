 ...
 *
 */
#ifndef DOGEN_TRACING_TYPES_THROW_BACKEND_HPP
#define DOGEN_TRACING_TYPES_THROW_BACKEND_HPP
...
class throw_backend final : public dogen::tracing::backend {
public:
    virtual ~throw_backend() noexcept { }
