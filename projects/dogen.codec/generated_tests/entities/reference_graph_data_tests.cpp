...
#include "dogen.codec/serialization/registrar_ser.hpp"
...
BOOST_AUTO_TEST_SUITE(entities_reference_graph_data_tests)

BOOST_AUTO_TEST_CASE(identical_objects_are_equal) {
    dogen::codec::entities::reference_graph_data_generator g;
    const auto a(g());
    const auto b(a);
...
BOOST_AUTO_TEST_CASE(moved_objects_are_equal) {
    ...
    g();
    auto a(g());
    const auto b = dogen::codec::entities::reference_graph_data();
    const auto c(a);
    BOOST_CHECK(a != b);
    BOOST_CHECK(a == c);
...
BOOST_AUTO_TEST_CASE(assigned_objects_are_equal) {
    ...
    g();
    const auto a(g());
    dogen::codec::entities::reference_graph_data b;
    BOOST_CHECK(a != b);
...
BOOST_AUTO_TEST_CASE(copy_constructed_objects_are_equal) {
    ...
    b = dogen::codec::entities::reference_graph_data();
    BOOST_CHECK(a != b);
}
...
BOOST_AUTO_TEST_CASE(xml_roundtrip_produces_the_same_entity) {
    ...
    {
        xml_oarchive oa(os);
        dogen::codec::registrar::register_types<xml_oarchive>(oa);
        oa << BOOST_SERIALIZATION_NVP(a);
    }

    dogen::codec::entities::reference_graph_data b = dogen::codec::entities::reference_graph_data();
    std::istringstream is(os.str());
    {
        xml_iarchive ia(is);
        dogen::codec::registrar::register_types<xml_iarchive>(ia);
...
BOOST_AUTO_TEST_CASE(text_roundtrip_produces_the_same_entity) {
    ...
    {
        text_oarchive oa(os);
        dogen::codec::registrar::register_types<text_oarchive>(oa);
        oa << a;
    }
    ...
    {
        text_iarchive ia(is);
        dogen::codec::registrar::register_types<text_iarchive>(ia);
        ia >> b;
    }
...
BOOST_AUTO_TEST_CASE(binary_roundtrip_produces_the_same_entity) {
    ...
    std::ostringstream os;
    {
        ...
        dogen::codec::registrar::register_types<binary_oarchive>(oa);
        oa << a;
    }
    ...
    std::istringstream is(os.str());
    {
        ...
        dogen::codec::registrar::register_types<binary_iarchive>(ia);
        ia >> b;
    }
...
BOOST_AUTO_TEST_CASE(equal_objects_generate_the_same_hash) {
    ...
    std::hash<dogen::codec::entities::reference_graph_data> hasher;
