 ...
 *
 */
#ifndef DOGEN_CODEC_TYPES_TRANSFORMS_ENCODING_TRANSFORM_HPP
#define DOGEN_CODEC_TYPES_TRANSFORMS_ENCODING_TRANSFORM_HPP
...
/**
 * @brief Transform that converts models in our codec model
