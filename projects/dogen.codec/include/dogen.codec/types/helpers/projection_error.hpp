 ...
 *
 */
#ifndef DOGEN_CODEC_TYPES_HELPERS_PROJECTION_ERROR_HPP
#define DOGEN_CODEC_TYPES_HELPERS_PROJECTION_ERROR_HPP
...
/**
 * @brief An error occurred whilst projecting elements from one space to another.
 */
