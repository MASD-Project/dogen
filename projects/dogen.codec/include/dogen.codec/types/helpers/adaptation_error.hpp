 ...
 *
 */
#ifndef DOGEN_CODEC_TYPES_HELPERS_ADAPTATION_ERROR_HPP
#define DOGEN_CODEC_TYPES_HELPERS_ADAPTATION_ERROR_HPP
...
/**
 * @brief A fatal error has occurred while adapting an object into an element.
 */
