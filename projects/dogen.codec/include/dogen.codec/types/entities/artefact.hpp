...
#include "dogen.codec/serialization/entities/artefact_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::codec::entities::artefact& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::codec::entities::artefact& v, unsigned int version);
