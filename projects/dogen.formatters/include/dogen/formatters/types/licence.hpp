 ...
 *
 */
#ifndef DOGEN_FORMATTERS_TYPES_LICENCE_HPP
#define DOGEN_FORMATTERS_TYPES_LICENCE_HPP
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::formatters::licence& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::formatters::licence& v, unsigned int version);
...
template<>
inline void swap(
    dogen::formatters::licence& lhs,
    dogen::formatters::licence& rhs) {
    lhs.swap(rhs);
}
