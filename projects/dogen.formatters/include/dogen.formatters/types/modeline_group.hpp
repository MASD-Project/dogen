 ...
 *
 */
#ifndef DOGEN_FORMATTERS_TYPES_MODELINE_GROUP_HPP
#define DOGEN_FORMATTERS_TYPES_MODELINE_GROUP_HPP
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::formatters::modeline_group& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::formatters::modeline_group& v, unsigned int version);
...
public:
     ...
     */
    /**@{*/
    const std::unordered_map<std::string, dogen::formatters::modeline>& modelines() const;
    std::unordered_map<std::string, dogen::formatters::modeline>& modelines();
    void modelines(const std::unordered_map<std::string, dogen::formatters::modeline>& v);
    void modelines(const std::unordered_map<std::string, dogen::formatters::modeline>&& v);
    /**@}*/
...
template<>
inline void swap(
    dogen::formatters::modeline_group& lhs,
    dogen::formatters::modeline_group& rhs) {
    lhs.swap(rhs);
}
