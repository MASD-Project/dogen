...
dogen::formatters::modeline_group
create_dogen_formatters_modeline_group(const unsigned int position) {
    return dogen::formatters::modeline_group_generator::create(position);
}

std::unordered_map<std::string, dogen::formatters::modeline_group> create_std_unordered_map_std_string_dogen_formatters_modeline_group(unsigned int position) {
    std::unordered_map<std::string, dogen::formatters::modeline_group> r;
    for (unsigned int i(0); i < 4; ++i) {
        r.insert(std::make_pair(create_std_string(position + i), create_dogen_formatters_modeline_group(position + i)));
    }
    return r;
}
...
populate(const unsigned int position, result_type& v) {
    v.modeline_groups(create_std_unordered_map_std_string_dogen_formatters_modeline_group(position + 0));
