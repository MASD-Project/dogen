...
std::unordered_map<std::string, dogen::formatters::modeline>& modeline_group::modelines() {
    return modelines_;
}

void modeline_group::modelines(const std::unordered_map<std::string, dogen::formatters::modeline>& v) {
    modelines_ = v;
}
