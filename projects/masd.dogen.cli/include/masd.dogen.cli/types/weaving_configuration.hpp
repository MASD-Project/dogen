 ...
 *
 */
#ifndef MASD_DOGEN_CLI_TYPES_WEAVING_CONFIGURATION_HPP
#define MASD_DOGEN_CLI_TYPES_WEAVING_CONFIGURATION_HPP
...
template<>
inline void swap(
    masd::dogen::cli::weaving_configuration& lhs,
    masd::dogen::cli::weaving_configuration& rhs) {
    lhs.swap(rhs);
}
