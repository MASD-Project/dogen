...
boost::variant<masd::dogen::cli::generation_configuration, masd::dogen::cli::conversion_configuration>
create_boost_variant_masd_dogen_cli_generation_configuration_masd_dogen_cli_conversion_configuration(unsigned int position) {
    boost::variant<masd::dogen::cli::generation_configuration, masd::dogen::cli::conversion_configuration> r;
...
populate(const unsigned int position, result_type& v) {
    v.activity(create_boost_variant_masd_dogen_cli_generation_configuration_masd_dogen_cli_conversion_configuration(position + 0));
