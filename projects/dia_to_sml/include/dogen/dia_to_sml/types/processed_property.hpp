 ...
 *
 */
#ifndef DOGEN_DIA_TO_SML_TYPES_PROCESSED_PROPERTY_HPP
#define DOGEN_DIA_TO_SML_TYPES_PROCESSED_PROPERTY_HPP
...
template<>
inline void swap(
    dogen::dia_to_sml::processed_property& lhs,
    dogen::dia_to_sml::processed_property& rhs) {
    lhs.swap(rhs);
}
