 ...
 *
 */
#ifndef DOGEN_DIA_TO_SML_TYPES_OBJECT_TO_PACKAGE_HPP
#define DOGEN_DIA_TO_SML_TYPES_OBJECT_TO_PACKAGE_HPP
...
class object_to_package {
public:
    object_to_package() = default;
    object_to_package(const object_to_package&) = default;
    ~object_to_package() = default;
    object_to_package(object_to_package&&) = default;
    object_to_package& operator=(const object_to_package&) = default;
...
public:
     ...
     */
    object_to_package(const std::string& model_name,
