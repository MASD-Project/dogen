...
static logger lg(logger_factory("dia_to_sml.object_to_exception"));
...
dogen::sml::qname object_to_exception::
...
std::string object_to_exception::
...
bool object_to_exception::is_processable(const dia::object& o) const {
...
void object_to_exception::add_object(const dia::object& o) {
...
sml::exception object_to_exception::
