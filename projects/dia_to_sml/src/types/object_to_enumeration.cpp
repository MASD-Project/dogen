...
static logger lg(logger_factory("dia_to_sml.object_to_enumeration"));
...
dogen::sml::qname object_to_enumeration::
...
std::string object_to_enumeration::
...
void object_to_enumeration::add_object(const dia::object& o) {
...
dogen::sml::enumerator object_to_enumeration::
...
sml::enumeration object_to_enumeration::
