...
BOOST_AUTO_TEST_CASE(setting_more_than_one_sml_type_throws) {
    SETUP_TEST_LOG_SOURCE("setting_more_than_one_sml_type_throws");
    ...
    contains_checker<validation_error> cc(too_many_sml_types);
    BOOST_CHECK_EXCEPTION(v.validate(p1), validation_error, cc);
...
BOOST_AUTO_TEST_CASE(setting_one_sml_type_validates) {
    SETUP_TEST_LOG_SOURCE("setting_one_sml_type_validates");
...
BOOST_AUTO_TEST_CASE(setting_sml_object_flags_on_non_objects_throws) {
    SETUP_TEST_LOG_SOURCE("setting_sml_entity_flags_on_non_entities_throws");
...
BOOST_AUTO_TEST_CASE(setting_sml_object_flags_on_objects_validates) {
    SETUP_TEST_LOG_SOURCE("setting_sml_object_flags_on_objects_validates");
