...
const dogen::dynamic::schema::workflow& dynamic_schema_workflow() {
...
BOOST_AUTO_TEST_CASE(empty_named_uml_class_throws) {
    ...
    auto c(mock_context());
    dogen::dia_to_sml::transformer t(dynamic_schema_workflow(), c);
...
BOOST_AUTO_TEST_CASE(inheritance_with_immutability_throws) {
    ...
    dogen::dia_to_sml::transformer t1(dynamic_schema_workflow(), c);
    ...
    dogen::dia_to_sml::transformer t2(dynamic_schema_workflow(), c);
    auto po2(po[1]);
