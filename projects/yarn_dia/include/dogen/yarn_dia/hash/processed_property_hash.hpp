...
template<>
struct hash<dogen::yarn_dia::processed_property> {
public:
    size_t operator()(const dogen::yarn_dia::processed_property& v) const {
        return dogen::yarn_dia::processed_property_hasher::hash(v);
    }
};
