...
processed_object::processed_object()
    : object_type_(static_cast<dogen::yarn_dia::object_types>(0)) { }
...
dogen::yarn_dia::object_types processed_object::object_type() const {
    return object_type_;
}

void processed_object::object_type(const dogen::yarn_dia::object_types v) {
    object_type_ = v;
}
...
const dogen::yarn_dia::processed_comment& processed_object::comment() const {
    return comment_;
}

dogen::yarn_dia::processed_comment& processed_object::comment() {
    return comment_;
}

void processed_object::comment(const dogen::yarn_dia::processed_comment& v) {
    comment_ = v;
}
...
const std::list<dogen::yarn_dia::processed_property>& processed_object::properties() const {
    return properties_;
}

std::list<dogen::yarn_dia::processed_property>& processed_object::properties() {
    return properties_;
}

void processed_object::properties(const std::list<dogen::yarn_dia::processed_property>& v) {
    properties_ = v;
}
