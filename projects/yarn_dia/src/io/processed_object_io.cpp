...
#include "dogen/yarn_dia/io/processed_property_io.hpp"
...
inline std::ostream& operator<<(std::ostream& s, const std::list<dogen::yarn_dia::processed_property>& v) {
    s << "[ ";
...
std::ostream& operator<<(std::ostream& s, const processed_object& v) {
    s << " { "
      << "\"__type__\": " << "\"dogen::yarn_dia::processed_object\"" << ", "
