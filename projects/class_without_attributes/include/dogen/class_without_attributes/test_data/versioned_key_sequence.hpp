 ...
 *
 */
#ifndef DOGEN_CLASS_WITHOUT_ATTRIBUTES_TEST_DATA_VERSIONED_KEY_SEQUENCE_HPP
#define DOGEN_CLASS_WITHOUT_ATTRIBUTES_TEST_DATA_VERSIONED_KEY_SEQUENCE_HPP
...
public:
    typedef dogen::class_without_attributes::versioned_key value_type;
