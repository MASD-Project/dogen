 ...
 *
 */
#include "dogen/class_without_attributes/test_data/package_1/class_1_sequence.hpp"
#include "dogen/class_without_attributes/test_data/versioned_key_sequence.hpp"
