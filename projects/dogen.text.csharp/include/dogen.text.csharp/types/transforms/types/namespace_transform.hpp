 ...
 *
 */
#ifndef DOGEN_TEXT_CSHARP_TYPES_TRANSFORMS_TYPES_NAMESPACE_TRANSFORM_HPP
#define DOGEN_TEXT_CSHARP_TYPES_TRANSFORMS_TYPES_NAMESPACE_TRANSFORM_HPP
...
class namespace_transform final : public model_to_text_transform {
public:
