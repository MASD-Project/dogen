 ...
 *
 */
#ifndef DOGEN_TEXT_CSHARP_TYPES_TRANSFORMS_TYPES_BUILTIN_TRANSFORM_HPP
#define DOGEN_TEXT_CSHARP_TYPES_TRANSFORMS_TYPES_BUILTIN_TRANSFORM_HPP
...
class builtin_transform final : public text::transforms::model_to_text_transform {
public:
