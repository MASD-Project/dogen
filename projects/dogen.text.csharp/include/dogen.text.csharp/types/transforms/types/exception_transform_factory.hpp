 ...
 *
 */
#ifndef DOGEN_TEXT_CSHARP_TYPES_TRANSFORMS_TYPES_EXCEPTION_TRANSFORM_FACTORY_HPP
#define DOGEN_TEXT_CSHARP_TYPES_TRANSFORMS_TYPES_EXCEPTION_TRANSFORM_FACTORY_HPP
