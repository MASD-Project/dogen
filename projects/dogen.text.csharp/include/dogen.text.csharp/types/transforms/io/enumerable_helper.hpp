 ...
 *
 */
#ifndef DOGEN_TEXT_CSHARP_TYPES_TRANSFORMS_IO_ENUMERABLE_HELPER_HPP
#define DOGEN_TEXT_CSHARP_TYPES_TRANSFORMS_IO_ENUMERABLE_HELPER_HPP
...
class enumerable_helper : public helper_transform {
public:
