 ...
 *
 */
#ifndef DOGEN_TEXT_CSHARP_TYPES_TRANSFORMS_TEST_DATA_CLASS_TRANSFORM_FACTORY_HPP
#define DOGEN_TEXT_CSHARP_TYPES_TRANSFORMS_TEST_DATA_CLASS_TRANSFORM_FACTORY_HPP
 ...
 */
class class_transform_factory final {
public:
    /**
