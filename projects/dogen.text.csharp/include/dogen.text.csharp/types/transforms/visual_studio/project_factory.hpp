 ...
 *
 */
#ifndef DOGEN_TEXT_CSHARP_TYPES_TRANSFORMS_VISUAL_STUDIO_PROJECT_FACTORY_HPP
#define DOGEN_TEXT_CSHARP_TYPES_TRANSFORMS_VISUAL_STUDIO_PROJECT_FACTORY_HPP
