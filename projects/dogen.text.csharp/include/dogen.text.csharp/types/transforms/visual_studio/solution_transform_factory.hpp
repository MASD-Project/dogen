 ...
 *
 */
#ifndef DOGEN_TEXT_CSHARP_TYPES_TRANSFORMS_VISUAL_STUDIO_SOLUTION_TRANSFORM_FACTORY_HPP
#define DOGEN_TEXT_CSHARP_TYPES_TRANSFORMS_VISUAL_STUDIO_SOLUTION_TRANSFORM_FACTORY_HPP
 ...
 */
class solution_transform_factory final {
public:
    /**
