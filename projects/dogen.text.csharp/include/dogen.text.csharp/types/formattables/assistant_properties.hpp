 ...
 *
 */
#ifndef DOGEN_TEXT_CSHARP_TYPES_FORMATTABLES_ASSISTANT_PROPERTIES_HPP
#define DOGEN_TEXT_CSHARP_TYPES_FORMATTABLES_ASSISTANT_PROPERTIES_HPP
...
template<>
inline void swap(
    dogen::text::csharp::formattables::assistant_properties& lhs,
    dogen::text::csharp::formattables::assistant_properties& rhs) {
    lhs.swap(rhs);
}
