 ...
 *
 */
#ifndef DOGEN_TEXT_CSHARP_TYPES_FORMATTABLES_LOCATOR_FACET_CONFIGURATION_HPP
#define DOGEN_TEXT_CSHARP_TYPES_FORMATTABLES_LOCATOR_FACET_CONFIGURATION_HPP
...
template<>
inline void swap(
    dogen::text::csharp::formattables::locator_facet_configuration& lhs,
    dogen::text::csharp::formattables::locator_facet_configuration& rhs) {
    lhs.swap(rhs);
}
