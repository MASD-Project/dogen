...
#include "dogen.text.csharp/types/transforms/visual_studio/solution_transform_factory.hpp"

namespace dogen::text::csharp::transforms::visual_studio {

const physical::entities::archetype& solution_transform_factory::make_archetype() {
    static physical::entities::archetype r([]() {
        physical::entities::archetype r;
            using pmnf = physical::helpers::meta_name_factory;
            r.meta_name(pmnf::make("csharp",
                "visual_studio",
                "solution_transform_factory"));
