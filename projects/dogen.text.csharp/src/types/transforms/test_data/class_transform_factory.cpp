...
#include "dogen.text.csharp/types/transforms/test_data/class_transform_factory.hpp"

namespace dogen::text::csharp::transforms::test_data {

const physical::entities::archetype& class_transform_factory::make_archetype() {
    static physical::entities::archetype r([]() {
        physical::entities::archetype r;
            using pmnf = physical::helpers::meta_name_factory;
            r.meta_name(pmnf::make("csharp",
                "test_data",
                "class_transform_factory"));
