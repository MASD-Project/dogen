...
#include "dogen.text.csharp/types/transforms/types/exception_transform_factory.hpp"

namespace dogen::text::csharp::transforms::types {

const physical::entities::archetype& exception_transform_factory::make_archetype() {
    static physical::entities::archetype r([]() {
        physical::entities::archetype r;
            using pmnf = physical::helpers::meta_name_factory;
            r.meta_name(pmnf::make("csharp",
                "types",
                "exception_transform_factory"));
