...
#include "dogen.text.csharp/types/transforms/types/builtin_transform_factory.hpp"

namespace dogen::text::csharp::transforms::types {

const physical::entities::archetype& builtin_transform_factory::make_archetype() {
