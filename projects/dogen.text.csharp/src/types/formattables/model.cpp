...
const std::unordered_map<std::string, dogen::text::csharp::formattables::formattable>& model::formattables() const {
    return formattables_;
}

std::unordered_map<std::string, dogen::text::csharp::formattables::formattable>& model::formattables() {
    return formattables_;
}

void model::formattables(const std::unordered_map<std::string, dogen::text::csharp::formattables::formattable>& v) {
    formattables_ = v;
}
