...
#include "dogen.text.csharp/io/formattables/helper_descriptor_io.hpp"
#include "dogen.text.csharp/io/formattables/helper_properties_io.hpp"

namespace std {

inline std::ostream& operator<<(std::ostream& s, const std::list<dogen::text::csharp::formattables::helper_descriptor>& v) {
    s << "[ ";
...
std::ostream& operator<<(std::ostream& s, const helper_properties& v) {
    ...
    s << " { "
      << "\"__type__\": " << "\"dogen::text::csharp::formattables::helper_properties\"" << ", "
      << "\"current\": " << v.current() << ", "
