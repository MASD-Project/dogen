...
inline std::ostream& operator<<(std::ostream& s, const std::unordered_map<std::string, dogen::text::csharp::formattables::formattable>& v) {
    s << "[";
...
std::ostream& operator<<(std::ostream& s, const model& v) {
    s << " { "
      << "\"__type__\": " << "\"dogen::text::csharp::formattables::model\"" << ", "
      << "\"name\": " << v.name() << ", "
