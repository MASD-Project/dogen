...
#include "dogen.text.csharp/io/formattables/locator_archetype_configuration_io.hpp"
...
std::ostream& operator<<(std::ostream& s, const locator_archetype_configuration& v) {
    s << " { "
      << "\"__type__\": " << "\"dogen::text::csharp::formattables::locator_archetype_configuration\"" << ", "
