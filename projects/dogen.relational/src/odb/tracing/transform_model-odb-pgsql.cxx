...
#include "dogen.relational/odb/tracing/transform_model-odb-pgsql.hxx"
...
namespace odb
{
  ...
  const char access::object_traits_impl< ::dogen::relational::tracing::transform_model, id_pgsql >::
  persist_statement_name[] = "PERSIST_DOGEN_RELATIONAL_TRACING_TRANSFORM_MODEL";

  const char access::object_traits_impl< ::dogen::relational::tracing::transform_model, id_pgsql >::
  query_statement_name[] = "QUERY_DOGEN_RELATIONAL_TRACING_TRANSFORM_MODEL";

  const char access::object_traits_impl< ::dogen::relational::tracing::transform_model, id_pgsql >::
  erase_query_statement_name[] = "ERASE_QUERY_DOGEN_RELATIONAL_TRACING_TRANSFORM_MODEL";

  const unsigned int access::object_traits_impl< ::dogen::relational::tracing::transform_model, id_pgsql >::
  ...
  bool access::object_traits_impl< ::dogen::relational::tracing::transform_model, id_pgsql >::
  grow (image_type& i,
        bool* t)
  {
  ...
  void access::object_traits_impl< ::dogen::relational::tracing::transform_model, id_pgsql >::
  bind (pgsql::bind* b,
        image_type& i,
  ...
  const char access::object_traits_impl< ::dogen::relational::tracing::transform_model, id_pgsql >::persist_statement[] =
  ...
  const char access::object_traits_impl< ::dogen::relational::tracing::transform_model, id_pgsql >::query_statement[] =
  "SELECT "
  ...
  const char access::object_traits_impl< ::dogen::relational::tracing::transform_model, id_pgsql >::erase_query_statement[] =
  "DELETE FROM \"DOGEN\".\"TRANSFORM_MODEL\"";

  const char access::object_traits_impl< ::dogen::relational::tracing::transform_model, id_pgsql >::table_name[] =
  ...
  result< access::object_traits_impl< ::dogen::relational::tracing::transform_model, id_pgsql >::object_type >
  access::object_traits_impl< ::dogen::relational::tracing::transform_model, id_pgsql >::
  ...
  unsigned long long access::object_traits_impl< ::dogen::relational::tracing::transform_model, id_pgsql >::
  ...
  create_schema (database& db, unsigned short pass, bool drop)
  {
    ...
    if (drop)
    {
      switch (pass)
      {
        ...
        case 2:
        {
          db.execute ("DROP TABLE IF EXISTS \"DOGEN\".\"TRANSFORM_MODEL\" CASCADE");
          return false;
        }
      }
    }
