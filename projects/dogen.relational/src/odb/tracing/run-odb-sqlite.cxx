...
#include "dogen.relational/odb/tracing/run-odb-sqlite.hxx"
...
namespace odb
{
  ...
  struct access::object_traits_impl< ::dogen::relational::tracing::run, id_sqlite >::extra_statement_cache_type
  {
  ...
  access::object_traits_impl< ::dogen::relational::tracing::run, id_sqlite >::id_type
  access::object_traits_impl< ::dogen::relational::tracing::run, id_sqlite >::
  ...
  bool access::object_traits_impl< ::dogen::relational::tracing::run, id_sqlite >::
  grow (image_type& i,
        bool* t)
  {
  ...
  const char access::object_traits_impl< ::dogen::relational::tracing::run, id_sqlite >::persist_statement[] =
  ...
  const char access::object_traits_impl< ::dogen::relational::tracing::run, id_sqlite >::update_statement[] =
  "UPDATE \"DOGEN\".\"RUN\" "
  "SET "
  "\"START\"=?, "
  "\"END\"=?, "
  ...
  const char access::object_traits_impl< ::dogen::relational::tracing::run, id_sqlite >::query_statement[] =
  "SELECT "
  "\"DOGEN\".\"RUN\".\"START\", "
  "\"DOGEN\".\"RUN\".\"END\", "
  "\"DOGEN\".\"RUN\".\"ID\", "
  ...
  const char access::object_traits_impl< ::dogen::relational::tracing::run, id_sqlite >::table_name[] =
  "\"DOGEN\".\"RUN\"";
  ...
  access::object_traits_impl< ::dogen::relational::tracing::run, id_sqlite >::pointer_type
  access::object_traits_impl< ::dogen::relational::tracing::run, id_sqlite >::
  ...
  result< access::object_traits_impl< ::dogen::relational::tracing::run, id_sqlite >::object_type >
  access::object_traits_impl< ::dogen::relational::tracing::run, id_sqlite >::
  ...
  unsigned long long access::object_traits_impl< ::dogen::relational::tracing::run, id_sqlite >::
  ...
  create_schema (database& db, unsigned short pass, bool drop)
  {
    ...
    if (drop)
    {
      switch (pass)
      {
        ...
        case 2:
        {
          db.execute ("DROP TABLE IF EXISTS \"DOGEN\".\"RUN\"");
          return false;
        }
      }
    }
