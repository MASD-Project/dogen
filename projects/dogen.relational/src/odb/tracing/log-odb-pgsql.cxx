...
#include "dogen.relational/odb/tracing/log-odb-pgsql.hxx"
...
namespace odb
{
  ...
  const char access::object_traits_impl< ::dogen::relational::tracing::log, id_pgsql >::
  persist_statement_name[] = "PERSIST_DOGEN_RELATIONAL_TRACING_LOG";

  const char access::object_traits_impl< ::dogen::relational::tracing::log, id_pgsql >::
  query_statement_name[] = "QUERY_DOGEN_RELATIONAL_TRACING_LOG";

  const char access::object_traits_impl< ::dogen::relational::tracing::log, id_pgsql >::
  erase_query_statement_name[] = "ERASE_QUERY_DOGEN_RELATIONAL_TRACING_LOG";

  const unsigned int access::object_traits_impl< ::dogen::relational::tracing::log, id_pgsql >::
  ...
  bool access::object_traits_impl< ::dogen::relational::tracing::log, id_pgsql >::
  grow (image_type& i,
        bool* t)
  {
  ...
  void access::object_traits_impl< ::dogen::relational::tracing::log, id_pgsql >::
  bind (pgsql::bind* b,
        image_type& i,
  ...
  const char access::object_traits_impl< ::dogen::relational::tracing::log, id_pgsql >::erase_query_statement[] =
  "DELETE FROM \"DOGEN\".\"LOG\"";

  const char access::object_traits_impl< ::dogen::relational::tracing::log, id_pgsql >::table_name[] =
  "\"DOGEN\".\"LOG\"";
  ...
  result< access::object_traits_impl< ::dogen::relational::tracing::log, id_pgsql >::object_type >
  access::object_traits_impl< ::dogen::relational::tracing::log, id_pgsql >::
  ...
  unsigned long long access::object_traits_impl< ::dogen::relational::tracing::log, id_pgsql >::
  ...
  create_schema (database& db, unsigned short pass, bool drop)
  {
    ...
    if (drop)
    {
      switch (pass)
      {
        ...
        case 2:
        {
          db.execute ("DROP TABLE IF EXISTS \"DOGEN\".\"LOG\" CASCADE");
          return false;
        }
      }
    }
