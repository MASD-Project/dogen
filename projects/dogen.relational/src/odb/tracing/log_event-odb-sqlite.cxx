...
#include "dogen.relational/odb/tracing/log_event-odb-sqlite.hxx"
...
namespace odb
{
  ...
  bool access::object_traits_impl< ::dogen::relational::tracing::log_event, id_sqlite >::
  grow (image_type& i,
        bool* t)
  {
  ...
  void access::object_traits_impl< ::dogen::relational::tracing::log_event, id_sqlite >::
  bind (sqlite::bind* b,
        image_type& i,
  ...
  const char access::object_traits_impl< ::dogen::relational::tracing::log_event, id_sqlite >::persist_statement[] =
  ...
  const char access::object_traits_impl< ::dogen::relational::tracing::log_event, id_sqlite >::erase_query_statement[] =
  "DELETE FROM \"DOGEN\".\"LOG_EVENT\"";

  const char access::object_traits_impl< ::dogen::relational::tracing::log_event, id_sqlite >::table_name[] =
  "\"DOGEN\".\"LOG_EVENT\"";
  ...
  result< access::object_traits_impl< ::dogen::relational::tracing::log_event, id_sqlite >::object_type >
  access::object_traits_impl< ::dogen::relational::tracing::log_event, id_sqlite >::
  ...
  unsigned long long access::object_traits_impl< ::dogen::relational::tracing::log_event, id_sqlite >::
  ...
  create_schema (database& db, unsigned short pass, bool drop)
  {
    ...
    if (drop)
    {
      switch (pass)
      {
        ...
        case 2:
        {
          db.execute ("DROP TABLE IF EXISTS \"DOGEN\".\"LOG_EVENT\"");
          return false;
        }
      }
    }
