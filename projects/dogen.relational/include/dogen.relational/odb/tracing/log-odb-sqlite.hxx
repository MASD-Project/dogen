...
#ifndef DOGEN_RELATIONAL_ODB_TRACING_LOG_ODB_SQLITE_HXX
#define DOGEN_RELATIONAL_ODB_TRACING_LOG_ODB_SQLITE_HXX
...
namespace odb
{
  ...
  template <typename A>
  const typename query_columns< ::dogen::relational::tracing::log, id_sqlite, A >::message_type_
  query_columns< ::dogen::relational::tracing::log, id_sqlite, A >::
  message (A::table_name, "\"MESSAGE\"", 0);

  template <typename A>
  struct pointer_query_columns< ::dogen::relational::tracing::log, id_sqlite, A >:
    query_columns< ::dogen::relational::tracing::log, id_sqlite, A >
  {
  };

  template <>
  class access::object_traits_impl< ::dogen::relational::tracing::log, id_sqlite >:
...
#include "dogen.relational/odb/tracing/log-odb-sqlite.ixx"

#include <odb/post.hxx>

#endif // DOGEN_RELATIONAL_ODB_TRACING_LOG_ODB_SQLITE_HXX
