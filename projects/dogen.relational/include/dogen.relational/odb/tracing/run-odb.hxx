...
#ifndef DOGEN_RELATIONAL_ODB_TRACING_RUN_ODB_HXX
#define DOGEN_RELATIONAL_ODB_TRACING_RUN_ODB_HXX
...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::dogen::relational::tracing::run >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::dogen::relational::tracing::run >
  {
    public:
    typedef ::dogen::relational::tracing::run object_type;
    typedef ::boost::shared_ptr< ::dogen::relational::tracing::run > pointer_type;
...
namespace odb
{
  ...
  template <>
  class access::object_traits_impl< ::dogen::relational::tracing::run, id_common >:
    public access::object_traits_impl< ::dogen::relational::tracing::run, id_pgsql >
  {
  };
...
#include "dogen.relational/odb/tracing/run-odb.ixx"

#include <odb/post.hxx>

#endif // DOGEN_RELATIONAL_ODB_TRACING_RUN_ODB_HXX
