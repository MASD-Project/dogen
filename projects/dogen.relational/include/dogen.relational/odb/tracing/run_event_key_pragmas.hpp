 ...
 *
 */
#ifndef DOGEN_RELATIONAL_ODB_TRACING_RUN_EVENT_KEY_PRAGMAS_HPP
#define DOGEN_RELATIONAL_ODB_TRACING_RUN_EVENT_KEY_PRAGMAS_HPP
...
#pragma db value(run_event_key) schema("DOGEN")
