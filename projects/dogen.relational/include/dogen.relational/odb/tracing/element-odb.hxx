...
#ifndef DOGEN_RELATIONAL_ODB_TRACING_ELEMENT_ODB_HXX
#define DOGEN_RELATIONAL_ODB_TRACING_ELEMENT_ODB_HXX
...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::dogen::relational::tracing::element >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::dogen::relational::tracing::element >
  {
    public:
    typedef ::dogen::relational::tracing::element object_type;
    typedef ::boost::shared_ptr< ::dogen::relational::tracing::element > pointer_type;
...
namespace odb
{
  ...
  template <>
  class access::object_traits_impl< ::dogen::relational::tracing::element, id_common >:
    public access::object_traits_impl< ::dogen::relational::tracing::element, id_pgsql >
  {
  };
...
#include "dogen.relational/odb/tracing/element-odb.ixx"

#include <odb/post.hxx>

#endif // DOGEN_RELATIONAL_ODB_TRACING_ELEMENT_ODB_HXX
