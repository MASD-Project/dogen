...
#ifndef DOGEN_RELATIONAL_ODB_TRACING_RUN_EVENT_ODB_PGSQL_HXX
#define DOGEN_RELATIONAL_ODB_TRACING_RUN_EVENT_ODB_PGSQL_HXX
...
namespace odb
{
  ...
  //
  template <typename A>
  struct query_columns< ::dogen::relational::tracing::run_event, id_pgsql, A >
  {
    // timestamp
    //
    typedef
  ...
  template <typename A>
  const typename query_columns< ::dogen::relational::tracing::run_event, id_pgsql, A >::timestamp_type_
  ...
  template <typename A>
  const typename query_columns< ::dogen::relational::tracing::run_event, id_pgsql, A >::payload_class_::value_type_
  query_columns< ::dogen::relational::tracing::run_event, id_pgsql, A >::payload_class_::
  value (A::table_name, "\"PAYLOAD\"", "to_jsonb((?)::jsonb)");

  template <typename A>
  const typename query_columns< ::dogen::relational::tracing::run_event, id_pgsql, A >::payload_class_
  ...
  template <>
  class access::object_traits_impl< ::dogen::relational::tracing::run_event, id_pgsql >:
...
#include "dogen.relational/odb/tracing/run_event-odb-pgsql.ixx"

#include <odb/post.hxx>

#endif // DOGEN_RELATIONAL_ODB_TRACING_RUN_EVENT_ODB_PGSQL_HXX
