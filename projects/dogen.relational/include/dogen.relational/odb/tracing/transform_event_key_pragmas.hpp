 ...
 *
 */
#ifndef DOGEN_RELATIONAL_ODB_TRACING_TRANSFORM_EVENT_KEY_PRAGMAS_HPP
#define DOGEN_RELATIONAL_ODB_TRACING_TRANSFORM_EVENT_KEY_PRAGMAS_HPP
...
#pragma db value(transform_event_key) schema("DOGEN")
