 ...
 *
 */
#ifndef DOGEN_RELATIONAL_ODB_TRACING_TRANSFORM_PRAGMAS_HPP
#define DOGEN_RELATIONAL_ODB_TRACING_TRANSFORM_PRAGMAS_HPP
...
#pragma db object(transform) schema("DOGEN")
#pragma db object(transform) no_id
