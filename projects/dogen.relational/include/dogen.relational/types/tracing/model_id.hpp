 ...
 *
 */
#ifndef DOGEN_RELATIONAL_TYPES_TRACING_MODEL_ID_HPP
#define DOGEN_RELATIONAL_TYPES_TRACING_MODEL_ID_HPP
...
template<>
inline void swap(
    dogen::relational::tracing::model_id& lhs,
    dogen::relational::tracing::model_id& rhs) {
    lhs.swap(rhs);
}
