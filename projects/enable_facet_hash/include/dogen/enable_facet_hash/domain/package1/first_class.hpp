 ...
 *
 */
#ifndef DOGEN_ENABLE_FACET_HASH_DOMAIN_PACKAGE1_FIRST_CLASS_HPP
#define DOGEN_ENABLE_FACET_HASH_DOMAIN_PACKAGE1_FIRST_CLASS_HPP
...
public:
    first_class(
        ...
        dogen::enable_facet_hash::versioned_key versioned_key);
...
public:
    ...
    dogen::enable_facet_hash::versioned_key versioned_key() const {
        return versioned_key_;
    }

    void versioned_key(dogen::enable_facet_hash::versioned_key value) {
...
private:
    ...
    dogen::enable_facet_hash::versioned_key versioned_key_;
};
...
template<>
inline void swap(
    dogen::enable_facet_hash::package1::first_class& lhs,
    dogen::enable_facet_hash::package1::first_class& rhs) {
    lhs.swap(rhs);
}
