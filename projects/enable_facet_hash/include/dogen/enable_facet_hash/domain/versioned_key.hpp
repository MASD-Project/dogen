 ...
 *
 */
#ifndef DOGEN_ENABLE_FACET_HASH_DOMAIN_VERSIONED_KEY_HPP
#define DOGEN_ENABLE_FACET_HASH_DOMAIN_VERSIONED_KEY_HPP
...
public:
    friend class dogen::enable_facet_hash::versioned_key_serializer;
...
template<>
inline void swap(
    dogen::enable_facet_hash::versioned_key& lhs,
    dogen::enable_facet_hash::versioned_key& rhs) {
    lhs.swap(rhs);
}
