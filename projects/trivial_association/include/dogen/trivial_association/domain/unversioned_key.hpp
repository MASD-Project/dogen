 ...
 *
 */
#ifndef DOGEN_TRIVIAL_ASSOCIATION_DOMAIN_UNVERSIONED_KEY_HPP
#define DOGEN_TRIVIAL_ASSOCIATION_DOMAIN_UNVERSIONED_KEY_HPP
...
#include <algorithm>
#include "dogen/trivial_association/serialization/unversioned_key_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::trivial_association::unversioned_key& lhs,
    dogen::trivial_association::unversioned_key& rhs) {
    lhs.swap(rhs);
}
