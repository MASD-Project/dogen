 ...
 *
 */
#ifndef DOGEN_TRIVIAL_ASSOCIATION_DOMAIN_VERSIONED_KEY_HPP
#define DOGEN_TRIVIAL_ASSOCIATION_DOMAIN_VERSIONED_KEY_HPP
...
#include "dogen/trivial_association/serialization/versioned_key_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::trivial_association::versioned_key& lhs,
    dogen::trivial_association::versioned_key& rhs) {
    lhs.swap(rhs);
}
