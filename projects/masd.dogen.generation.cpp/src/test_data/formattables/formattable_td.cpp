...
std::list<boost::shared_ptr<masd::dogen::coding::meta_model::element> > create_std_list_boost_shared_ptr_masd_dogen_coding_meta_model_element(unsigned int position) {
    std::list<boost::shared_ptr<masd::dogen::coding::meta_model::element> > r;
...
masd::dogen::generation::cpp::formattables::element_properties
create_masd_dogen_generation_cpp_formattables_element_properties(const unsigned int position) {
    return masd::dogen::generation::cpp::formattables::element_properties_generator::create(position);
}
...
populate(const unsigned int position, result_type& v) {
    v.master_segment(create_boost_shared_ptr_masd_dogen_coding_meta_model_element(position + 0));
    v.all_segments(create_std_list_boost_shared_ptr_masd_dogen_coding_meta_model_element(position + 1));
    v.element_properties(create_masd_dogen_generation_cpp_formattables_element_properties(position + 2));
}
