...
registrar::registrar(
    ...
    const std::list<masd::dogen::modeling::meta_model::name>& model_dependencies,
    const std::list<masd::dogen::modeling::meta_model::name>& registrar_dependencies)
...
void registrar::accept(const masd::dogen::modeling::meta_model::element_visitor& v) const {
...
void registrar::accept(masd::dogen::modeling::meta_model::element_visitor& v) const {
...
void registrar::accept(const masd::dogen::modeling::meta_model::element_visitor& v) {
    typedef const element_visitor* derived_ptr;
    const auto dv(dynamic_cast<derived_ptr>(&v));
    if (dv)
        dv->visit(*this);
...
void registrar::accept(masd::dogen::modeling::meta_model::element_visitor& v) {
    typedef element_visitor* derived_ptr;
    const auto dv(dynamic_cast<derived_ptr>(&v));
    if (dv)
        dv->visit(*this);
...
bool registrar::equals(const masd::dogen::modeling::meta_model::element& other) const {
...
const std::list<masd::dogen::modeling::meta_model::name>& registrar::leaves() const {
    return leaves_;
}

std::list<masd::dogen::modeling::meta_model::name>& registrar::leaves() {
    return leaves_;
}

void registrar::leaves(const std::list<masd::dogen::modeling::meta_model::name>& v) {
    leaves_ = v;
}
...
const std::list<masd::dogen::modeling::meta_model::name>& registrar::model_dependencies() const {
    return model_dependencies_;
}

std::list<masd::dogen::modeling::meta_model::name>& registrar::model_dependencies() {
    return model_dependencies_;
}

void registrar::model_dependencies(const std::list<masd::dogen::modeling::meta_model::name>& v) {
...
const std::list<masd::dogen::modeling::meta_model::name>& registrar::registrar_dependencies() const {
    return registrar_dependencies_;
}

std::list<masd::dogen::modeling::meta_model::name>& registrar::registrar_dependencies() {
    return registrar_dependencies_;
}

void registrar::registrar_dependencies(const std::list<masd::dogen::modeling::meta_model::name>& v) {
