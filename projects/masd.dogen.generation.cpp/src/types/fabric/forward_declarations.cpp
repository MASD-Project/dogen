...
void forward_declarations::accept(const masd::dogen::modeling::meta_model::element_visitor& v) const {
...
void forward_declarations::accept(masd::dogen::modeling::meta_model::element_visitor& v) const {
...
void forward_declarations::accept(const masd::dogen::modeling::meta_model::element_visitor& v) {
    typedef const element_visitor* derived_ptr;
    const auto dv(dynamic_cast<derived_ptr>(&v));
    if (dv)
        dv->visit(*this);
...
void forward_declarations::accept(masd::dogen::modeling::meta_model::element_visitor& v) {
    typedef element_visitor* derived_ptr;
    const auto dv(dynamic_cast<derived_ptr>(&v));
    if (dv)
        dv->visit(*this);
...
bool forward_declarations::equals(const masd::dogen::modeling::meta_model::element& other) const {
...
const masd::dogen::modeling::meta_model::name& forward_declarations::underlying_element() const {
    return underlying_element_;
}

masd::dogen::modeling::meta_model::name& forward_declarations::underlying_element() {
    return underlying_element_;
}

void forward_declarations::underlying_element(const masd::dogen::modeling::meta_model::name& v) {
