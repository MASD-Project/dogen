...
const coding::meta_model::name& msbuild_targets_formatter::meta_name() const {
...
coding::meta_model::artefact msbuild_targets_formatter::
format(const context& ctx, const coding::meta_model::element& e) const {
    assistant a(ctx, e, archetype_location(), false/*requires_header_guard*/);
    const auto& c(a.as<fabric::msbuild_targets>(e));

    {
        const auto cs(dogen::extraction::comment_styles::xml_style);
