 ...
 *
 */
#ifndef MASD_DOGEN_GENERATION_CPP_TYPES_FORMATTABLES_ADAPTATION_ERROR_HPP
#define MASD_DOGEN_GENERATION_CPP_TYPES_FORMATTABLES_ADAPTATION_ERROR_HPP
...
/**
 * @brief An error occurred during adaptation.
 */
