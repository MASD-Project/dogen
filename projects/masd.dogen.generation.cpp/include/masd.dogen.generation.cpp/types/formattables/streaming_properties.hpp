 ...
 *
 */
#ifndef MASD_DOGEN_GENERATION_CPP_TYPES_FORMATTABLES_STREAMING_PROPERTIES_HPP
#define MASD_DOGEN_GENERATION_CPP_TYPES_FORMATTABLES_STREAMING_PROPERTIES_HPP
...
template<>
inline void swap(
    masd::dogen::generation::cpp::formattables::streaming_properties& lhs,
    masd::dogen::generation::cpp::formattables::streaming_properties& rhs) {
    lhs.swap(rhs);
}
