 ...
 *
 */
#ifndef MASD_DOGEN_GENERATION_CPP_TYPES_FABRIC_COMMON_ODB_OPTIONS_HPP
#define MASD_DOGEN_GENERATION_CPP_TYPES_FABRIC_COMMON_ODB_OPTIONS_HPP
...
class common_odb_options final : public masd::dogen::modeling::meta_model::element {
public:
...
template<>
inline void swap(
    masd::dogen::generation::cpp::fabric::common_odb_options& lhs,
    masd::dogen::generation::cpp::fabric::common_odb_options& rhs) {
    lhs.swap(rhs);
}
