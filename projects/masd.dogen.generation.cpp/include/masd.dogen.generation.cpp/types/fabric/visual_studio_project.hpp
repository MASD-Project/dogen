 ...
 *
 */
#ifndef MASD_DOGEN_GENERATION_CPP_TYPES_FABRIC_VISUAL_STUDIO_PROJECT_HPP
#define MASD_DOGEN_GENERATION_CPP_TYPES_FABRIC_VISUAL_STUDIO_PROJECT_HPP
...
template<>
inline void swap(
    masd::dogen::generation::cpp::fabric::visual_studio_project& lhs,
    masd::dogen::generation::cpp::fabric::visual_studio_project& rhs) {
    lhs.swap(rhs);
}
