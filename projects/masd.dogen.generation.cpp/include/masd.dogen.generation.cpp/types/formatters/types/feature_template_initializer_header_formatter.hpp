 ...
 *
 */
#ifndef MASD_DOGEN_GENERATION_CPP_TYPES_FORMATTERS_TYPES_FEATURE_TEMPLATE_INITIALIZER_HEADER_FORMATTER_HPP
#define MASD_DOGEN_GENERATION_CPP_TYPES_FORMATTERS_TYPES_FEATURE_TEMPLATE_INITIALIZER_HEADER_FORMATTER_HPP
...
class feature_template_initializer_header_formatter final : public artefact_formatter_interface {
public:
