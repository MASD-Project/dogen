 ...
 *
 */
#ifndef MASD_DOGEN_GENERATION_CPP_TYPES_FORMATTERS_TYPES_NAMESPACE_HEADER_FORMATTER_HPP
#define MASD_DOGEN_GENERATION_CPP_TYPES_FORMATTERS_TYPES_NAMESPACE_HEADER_FORMATTER_HPP
...
class namespace_header_formatter final : public artefact_formatter_interface {
public:
