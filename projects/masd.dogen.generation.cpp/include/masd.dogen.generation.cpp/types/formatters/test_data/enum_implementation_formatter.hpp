 ...
 *
 */
#ifndef MASD_DOGEN_GENERATION_CPP_TYPES_FORMATTERS_TEST_DATA_ENUM_IMPLEMENTATION_FORMATTER_HPP
#define MASD_DOGEN_GENERATION_CPP_TYPES_FORMATTERS_TEST_DATA_ENUM_IMPLEMENTATION_FORMATTER_HPP
...
class enum_implementation_formatter final : public artefact_formatter_interface {
public:
