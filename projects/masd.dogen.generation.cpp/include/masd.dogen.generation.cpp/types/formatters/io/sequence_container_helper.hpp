 ...
 *
 */
#ifndef MASD_DOGEN_GENERATION_CPP_TYPES_FORMATTERS_IO_SEQUENCE_CONTAINER_HELPER_HPP
#define MASD_DOGEN_GENERATION_CPP_TYPES_FORMATTERS_IO_SEQUENCE_CONTAINER_HELPER_HPP
