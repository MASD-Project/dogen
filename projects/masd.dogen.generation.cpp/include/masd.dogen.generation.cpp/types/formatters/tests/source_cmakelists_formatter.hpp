 ...
 *
 */
#ifndef MASD_DOGEN_GENERATION_CPP_TYPES_FORMATTERS_TESTS_SOURCE_CMAKELISTS_FORMATTER_HPP
#define MASD_DOGEN_GENERATION_CPP_TYPES_FORMATTERS_TESTS_SOURCE_CMAKELISTS_FORMATTER_HPP
