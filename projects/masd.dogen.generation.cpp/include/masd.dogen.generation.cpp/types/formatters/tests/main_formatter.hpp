 ...
 *
 */
#ifndef MASD_DOGEN_GENERATION_CPP_TYPES_FORMATTERS_TESTS_MAIN_FORMATTER_HPP
#define MASD_DOGEN_GENERATION_CPP_TYPES_FORMATTERS_TESTS_MAIN_FORMATTER_HPP
...
class main_formatter final : public artefact_formatter_interface {
public:
