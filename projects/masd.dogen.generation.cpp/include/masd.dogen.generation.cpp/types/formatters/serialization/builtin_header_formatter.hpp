 ...
 *
 */
#ifndef MASD_DOGEN_GENERATION_CPP_TYPES_FORMATTERS_SERIALIZATION_BUILTIN_HEADER_FORMATTER_HPP
#define MASD_DOGEN_GENERATION_CPP_TYPES_FORMATTERS_SERIALIZATION_BUILTIN_HEADER_FORMATTER_HPP
...
class builtin_header_formatter final : public artefact_formatter_interface {
public:
