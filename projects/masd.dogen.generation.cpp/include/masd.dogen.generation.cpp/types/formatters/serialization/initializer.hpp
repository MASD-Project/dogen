 ...
 *
 */
#ifndef MASD_DOGEN_GENERATION_CPP_TYPES_FORMATTERS_SERIALIZATION_INITIALIZER_HPP
#define MASD_DOGEN_GENERATION_CPP_TYPES_FORMATTERS_SERIALIZATION_INITIALIZER_HPP
