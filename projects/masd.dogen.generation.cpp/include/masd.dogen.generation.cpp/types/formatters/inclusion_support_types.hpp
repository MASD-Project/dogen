 ...
 *
 */
#ifndef MASD_DOGEN_GENERATION_CPP_TYPES_FORMATTERS_INCLUSION_SUPPORT_TYPES_HPP
#define MASD_DOGEN_GENERATION_CPP_TYPES_FORMATTERS_INCLUSION_SUPPORT_TYPES_HPP
