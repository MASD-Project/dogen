 ...
 *
 */
#ifndef MASD_DOGEN_GENERATION_CPP_TYPES_FORMATTERS_HASH_TIME_DURATION_HELPER_HPP
#define MASD_DOGEN_GENERATION_CPP_TYPES_FORMATTERS_HASH_TIME_DURATION_HELPER_HPP
