 ...
 *
 */
#ifndef MASD_DOGEN_GENERATION_CPP_TYPES_FORMATTERS_HASH_ENUM_HEADER_FORMATTER_HPP
#define MASD_DOGEN_GENERATION_CPP_TYPES_FORMATTERS_HASH_ENUM_HEADER_FORMATTER_HPP
