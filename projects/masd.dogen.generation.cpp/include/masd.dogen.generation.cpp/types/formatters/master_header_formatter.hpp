 ...
 *
 */
#ifndef MASD_DOGEN_GENERATION_CPP_TYPES_FORMATTERS_MASTER_HEADER_FORMATTER_HPP
#define MASD_DOGEN_GENERATION_CPP_TYPES_FORMATTERS_MASTER_HEADER_FORMATTER_HPP
...
public:
    ...
    boost::filesystem::path inclusion_path(const formattables::locator& l,
        const coding::meta_model::name& n) const override;

    boost::filesystem::path full_path(const formattables::locator& l,
        const coding::meta_model::name& n) const override;
