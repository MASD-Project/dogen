...
const std::string load_sql("select * from std_model_pkg1_class_c_load($0, $1, $2);");
...
const std::string erase_sql("select * from std_model_pkg1_class_c_erase($0, $1, $2);");
...
const std::string save_sql("select std_model_pkg1_class_c_save($0, $1, $2);");
