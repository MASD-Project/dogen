...
const std::string load_sql("select * from std_model_class_b_load($0, $1);");
...
const std::string erase_sql("select * from std_model_class_b_erase($0, $1);");

const std::string save_name("statement_std_model_class_b_save");
const std::string save_work_name("work_std_model_class_b_save");
const std::string save_sql("select std_model_class_b_save($0, $1);");
