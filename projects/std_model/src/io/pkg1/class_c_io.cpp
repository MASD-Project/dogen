...
inline std::ostream& operator<<(std::ostream& s, const std::vector<dogen::std_model::class_a_unversioned_key>& v) {
    s << "[ ";
    for (auto i(v.begin()); i != v.end(); ++i) {
        if (i != v.begin()) s << ", ";
        s << *i;
...
inline std::ostream& operator<<(std::ostream& s, const std::vector<dogen::std_model::class_a_versioned_key>& v) {
    s << "[ ";
    for (auto i(v.begin()); i != v.end(); ++i) {
        if (i != v.begin()) s << ", ";
        s << *i;
