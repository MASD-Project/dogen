 ...
 *
 */
#ifndef DOGEN_STD_MODEL_SERIALIZATION_CLASS_H_SER_HPP
#define DOGEN_STD_MODEL_SERIALIZATION_CLASS_H_SER_HPP
...
BOOST_SERIALIZATION_SPLIT_FREE(dogen::std_model::class_h)
namespace boost {
