 ...
 *
 */
#ifndef DOGEN_STD_MODEL_DOMAIN_CLASS_A_VERSIONED_KEY_HPP
#define DOGEN_STD_MODEL_DOMAIN_CLASS_A_VERSIONED_KEY_HPP
...
template<>
inline void swap(
    dogen::std_model::class_a_versioned_key& lhs,
    dogen::std_model::class_a_versioned_key& rhs) {
    lhs.swap(rhs);
}
