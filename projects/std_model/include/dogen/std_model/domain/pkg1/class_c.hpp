 ...
 *
 */
#ifndef DOGEN_STD_MODEL_DOMAIN_PKG1_CLASS_C_HPP
#define DOGEN_STD_MODEL_DOMAIN_PKG1_CLASS_C_HPP
...
#include "dogen/std_model/serialization/pkg1/class_c_fwd_ser.hpp"
...
private:
    ...
    std::vector<dogen::std_model::class_a_unversioned_key> prop_2_;
    std::vector<dogen::std_model::class_a_versioned_key> prop_3_;
};
...
template<>
inline void swap(
    dogen::std_model::pkg1::class_c& lhs,
    dogen::std_model::pkg1::class_c& rhs) {
    lhs.swap(rhs);
}
