 ...
 *
 */
#ifndef DOGEN_STD_MODEL_DOMAIN_VERSIONED_KEY_HPP
#define DOGEN_STD_MODEL_DOMAIN_VERSIONED_KEY_HPP
...
#include "dogen/std_model/serialization/versioned_key_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::std_model::versioned_key& lhs,
    dogen::std_model::versioned_key& rhs) {
    lhs.swap(rhs);
}
