 ...
 *
 */
#ifndef DOGEN_STD_MODEL_DOMAIN_UNVERSIONED_KEY_HPP
#define DOGEN_STD_MODEL_DOMAIN_UNVERSIONED_KEY_HPP
...
#include <algorithm>
#include "dogen/std_model/serialization/unversioned_key_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::std_model::unversioned_key& lhs,
    dogen::std_model::unversioned_key& rhs) {
    lhs.swap(rhs);
}
