...
void save(Archive& ar,
    ...
    ar << make_nvp("inner_composite", v.inner_composite_);
}
...
#ifdef __linux__
template void save(eos::portable_oarchive& ar, const dogen::dia::composite& v, unsigned int version);
template void load(eos::portable_iarchive& ar, dogen::dia::composite& v, unsigned int version);
#endif
