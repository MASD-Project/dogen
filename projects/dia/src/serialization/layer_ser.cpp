...
#ifdef __linux__
template void save(eos::portable_oarchive& ar, const dogen::dia::layer& v, unsigned int version);
template void load(eos::portable_iarchive& ar, dogen::dia::layer& v, unsigned int version);
#endif
