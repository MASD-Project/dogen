 ...
 *
 */
#ifndef DOGEN_DIA_TYPES_CHILD_NODE_HPP
#define DOGEN_DIA_TYPES_CHILD_NODE_HPP
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const child_node& v, unsigned int version);
...
template<>
inline void swap(
    dogen::dia::child_node& lhs,
    dogen::dia::child_node& rhs) {
    lhs.swap(rhs);
}
