...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const font& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, font& v, unsigned int version);
