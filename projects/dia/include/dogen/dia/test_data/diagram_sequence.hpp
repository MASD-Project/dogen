 ...
 *
 */
#ifndef DOGEN_DIA_TEST_DATA_DIAGRAM_SEQUENCE_HPP
#define DOGEN_DIA_TEST_DATA_DIAGRAM_SEQUENCE_HPP
 ...
 * @see sequence.
 */
class diagram_generator {
public:
    typedef dogen::dia::diagram result_type;
...
typedef utility::test_data::sequence<
    detail::diagram_generator> diagram_sequence;
