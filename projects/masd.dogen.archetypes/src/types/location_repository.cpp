...
const std::list<masd::dogen::archetypes::location>& location_repository::all() const {
    return all_;
}

std::list<masd::dogen::archetypes::location>& location_repository::all() {
    return all_;
}

void location_repository::all(const std::list<masd::dogen::archetypes::location>& v) {
    all_ = v;
}
...
const std::unordered_map<std::string, masd::dogen::archetypes::locations_group>& location_repository::by_meta_name() const {
    return by_meta_name_;
}

std::unordered_map<std::string, masd::dogen::archetypes::locations_group>& location_repository::by_meta_name() {
    return by_meta_name_;
}

void location_repository::by_meta_name(const std::unordered_map<std::string, masd::dogen::archetypes::locations_group>& v) {
    by_meta_name_ = v;
}
...
const std::unordered_map<std::string, std::list<masd::dogen::archetypes::location> >& location_repository::by_family() const {
    return by_family_;
}

std::unordered_map<std::string, std::list<masd::dogen::archetypes::location> >& location_repository::by_family() {
    return by_family_;
}

void location_repository::by_family(const std::unordered_map<std::string, std::list<masd::dogen::archetypes::location> >& v) {
    by_family_ = v;
}
...
const std::unordered_map<std::string, std::list<masd::dogen::archetypes::location> >& location_repository::by_intra_backend_segment() const {
    return by_intra_backend_segment_;
}

std::unordered_map<std::string, std::list<masd::dogen::archetypes::location> >& location_repository::by_intra_backend_segment() {
    return by_intra_backend_segment_;
}

void location_repository::by_intra_backend_segment(const std::unordered_map<std::string, std::list<masd::dogen::archetypes::location> >& v) {
