...
const std::list<masd::dogen::archetypes::archetype_location>& archetype_locations_group::archetype_locations() const {
    return archetype_locations_;
}

std::list<masd::dogen::archetypes::archetype_location>& archetype_locations_group::archetype_locations() {
    return archetype_locations_;
}

void archetype_locations_group::archetype_locations(const std::list<masd::dogen::archetypes::archetype_location>& v) {
