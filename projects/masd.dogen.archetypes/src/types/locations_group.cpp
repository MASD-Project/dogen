...
const std::list<masd::dogen::archetypes::location>& locations_group::locations() const {
    return locations_;
}

std::list<masd::dogen::archetypes::location>& locations_group::locations() {
    return locations_;
}

void locations_group::locations(const std::list<masd::dogen::archetypes::location>& v) {
    locations_ = v;
}
