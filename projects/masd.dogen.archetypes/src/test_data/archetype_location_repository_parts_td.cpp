...
populate(const unsigned int position, result_type& v) {
    ...
    v.archetype_locations_by_meta_name(create_std_unordered_map_std_string_masd_dogen_archetypes_archetype_locations_group(position + 1));
    v.archetype_locations_by_family(create_std_unordered_map_std_string_std_list_masd_dogen_archetypes_archetype_location(position + 2));
    v.archetype_locations_by_intra_backend_segment(create_std_unordered_map_std_string_std_list_masd_dogen_archetypes_archetype_location(position + 3));
}
