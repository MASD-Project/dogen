...
populate(const unsigned int position, result_type& v) {
    ...
    v.by_meta_name(create_std_unordered_map_std_string_masd_dogen_archetypes_locations_group(position + 1));
    v.by_family(create_std_unordered_map_std_string_std_list_masd_dogen_archetypes_location(position + 2));
    v.by_intra_backend_segment(create_std_unordered_map_std_string_std_list_masd_dogen_archetypes_location(position + 3));
}
