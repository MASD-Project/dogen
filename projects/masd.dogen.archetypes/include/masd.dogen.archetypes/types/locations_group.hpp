 ...
 *
 */
#ifndef MASD_DOGEN_ARCHETYPES_TYPES_LOCATIONS_GROUP_HPP
#define MASD_DOGEN_ARCHETYPES_TYPES_LOCATIONS_GROUP_HPP
...
public:
    locations_group(
        const std::list<masd::dogen::archetypes::location>& locations,
...
public:
     ...
     */
    /**@{*/
    const std::list<masd::dogen::archetypes::location>& locations() const;
    std::list<masd::dogen::archetypes::location>& locations();
    void locations(const std::list<masd::dogen::archetypes::location>& v);
    void locations(const std::list<masd::dogen::archetypes::location>&& v);
    /**@}*/
...
private:
    std::list<masd::dogen::archetypes::location> locations_;
...
template<>
inline void swap(
    masd::dogen::archetypes::locations_group& lhs,
    masd::dogen::archetypes::locations_group& rhs) {
    lhs.swap(rhs);
}
