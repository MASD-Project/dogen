 ...
 *
 */
#ifndef MASD_DOGEN_ARCHETYPES_TYPES_ARCHETYPE_LOCATIONS_GROUP_HPP
#define MASD_DOGEN_ARCHETYPES_TYPES_ARCHETYPE_LOCATIONS_GROUP_HPP
...
template<>
inline void swap(
    masd::dogen::archetypes::archetype_locations_group& lhs,
    masd::dogen::archetypes::archetype_locations_group& rhs) {
    lhs.swap(rhs);
}
