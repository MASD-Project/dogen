 ...
 *
 */
#ifndef MASD_DOGEN_ARCHETYPES_TYPES_LOCATION_HPP
#define MASD_DOGEN_ARCHETYPES_TYPES_LOCATION_HPP
...
template<>
inline void swap(
    masd::dogen::archetypes::location& lhs,
    masd::dogen::archetypes::location& rhs) {
    lhs.swap(rhs);
}
