 ...
 *
 */
#ifndef MASD_DOGEN_ARCHETYPES_TYPES_ARCHETYPE_LOCATION_REPOSITORY_HPP
#define MASD_DOGEN_ARCHETYPES_TYPES_ARCHETYPE_LOCATION_REPOSITORY_HPP
...
template<>
inline void swap(
    masd::dogen::archetypes::archetype_location_repository& lhs,
    masd::dogen::archetypes::archetype_location_repository& rhs) {
    lhs.swap(rhs);
}
