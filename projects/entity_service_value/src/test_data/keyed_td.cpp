 ...
 *
 */
#include "dogen/entity_service_value/test_data/keyed_td.hpp"
...
dogen::entity_service_value::keyed_versioned_key
create_dogen_entity_service_value_keyed_versioned_key(const unsigned int position) {
    return dogen::entity_service_value::keyed_versioned_key_generator::create(position);
}
...
populate(const unsigned int position, result_type& v) {
    ...
    v.versioned_key(create_dogen_entity_service_value_keyed_versioned_key(position + 1));
}
