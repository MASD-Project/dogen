...
inline std::ostream& operator<<(std::ostream& s, const std::list<masd::dogen::generation::csharp::formattables::helper_descriptor>& v) {
    s << "[ ";
...
std::ostream& operator<<(std::ostream& s, const helper_properties& v) {
    ...
    s << " { "
      << "\"__type__\": " << "\"masd::dogen::generation::csharp::formattables::helper_properties\"" << ", "
      << "\"current\": " << v.current() << ", "
