...
variability::archetype_location class_formatter::archetype_location() const {
...
const coding::meta_model::name& class_formatter::meta_name() const {
...
a.stream() << std::endl;
a.stream() << "        public " << sn << "(" << std::endl;
                    generation::formatters::sequence_formatter sf(attr_count);
...
a.stream() << "            : base(" << a.make_argument_name(pattrs.front()) << ")" << std::endl;
                        ...
                        generation::formatters::sequence_formatter sf(size);
                        sf.postfix_configuration().last(")");
