...
masd::dogen::generation::csharp::formattables::element_properties
create_masd_dogen_generation_csharp_formattables_element_properties(const unsigned int position) {
    return masd::dogen::generation::csharp::formattables::element_properties_generator::create(position);
}
...
populate(const unsigned int position, result_type& v) {
    v.element_properties(create_masd_dogen_generation_csharp_formattables_element_properties(position + 0));
    v.element(create_boost_shared_ptr_masd_dogen_coding_meta_model_element(position + 1));
}
