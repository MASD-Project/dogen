 ...
 *
 */
#ifndef MASD_DOGEN_GENERATION_CSHARP_TYPES_FABRIC_VISUAL_STUDIO_CONFIGURATION_HPP
#define MASD_DOGEN_GENERATION_CSHARP_TYPES_FABRIC_VISUAL_STUDIO_CONFIGURATION_HPP
...
template<>
inline void swap(
    masd::dogen::generation::csharp::fabric::visual_studio_configuration& lhs,
    masd::dogen::generation::csharp::fabric::visual_studio_configuration& rhs) {
    lhs.swap(rhs);
}
