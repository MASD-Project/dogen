 ...
 *
 */
#ifndef MASD_DOGEN_GENERATION_CSHARP_TYPES_FABRIC_VISUAL_STUDIO_PROJECT_HPP
#define MASD_DOGEN_GENERATION_CSHARP_TYPES_FABRIC_VISUAL_STUDIO_PROJECT_HPP
...
class visual_studio_project final : public masd::dogen::modeling::meta_model::element {
public:
...
template<>
inline void swap(
    masd::dogen::generation::csharp::fabric::visual_studio_project& lhs,
    masd::dogen::generation::csharp::fabric::visual_studio_project& rhs) {
    lhs.swap(rhs);
}
