 ...
 *
 */
#ifndef MASD_DOGEN_GENERATION_CSHARP_TYPES_FORMATTERS_IO_PRIMITIVE_FORMATTER_HPP
#define MASD_DOGEN_GENERATION_CSHARP_TYPES_FORMATTERS_IO_PRIMITIVE_FORMATTER_HPP
