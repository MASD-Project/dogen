 ...
 *
 */
#ifndef MASD_DOGEN_GENERATION_CSHARP_TYPES_FORMATTERS_IO_ENUMERABLE_HELPER_HPP
#define MASD_DOGEN_GENERATION_CSHARP_TYPES_FORMATTERS_IO_ENUMERABLE_HELPER_HPP
