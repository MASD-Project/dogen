 ...
 *
 */
#ifndef DOGEN_ORCHESTRATION_TYPES_FEATURES_MODEL_LOCATION_HPP
#define DOGEN_ORCHESTRATION_TYPES_FEATURES_MODEL_LOCATION_HPP
...
/**
 * @brief Feature group for model location related features.
 */
class model_location final {
public:
    struct feature_group {
        variability::entities::feature external_modules;
        variability::entities::feature model_modules;
    };
