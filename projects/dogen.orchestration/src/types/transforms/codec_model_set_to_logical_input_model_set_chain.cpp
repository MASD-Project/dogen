...
const std::string transform_id(
    "orchestration.transforms.codec_model_set_to_logical_input_model_set_chain");
...
apply(const context& ctx, const codec::entities::model_set& ms) {
    ...
    /*
     * First we convert the target codec model into an logical
    ...
    using tf = codec_model_to_logical_model_transform;
