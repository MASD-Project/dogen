 ...
 *
 */
#ifndef DOGEN_STITCH_TYPES_STITCHING_PROPERTIES_HPP
#define DOGEN_STITCH_TYPES_STITCHING_PROPERTIES_HPP
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::stitch::stitching_properties& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::stitch::stitching_properties& v, unsigned int version);
...
template<>
inline void swap(
    dogen::stitch::stitching_properties& lhs,
    dogen::stitch::stitching_properties& rhs) {
    lhs.swap(rhs);
}
