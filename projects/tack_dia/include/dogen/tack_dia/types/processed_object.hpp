 ...
 *
 */
#ifndef DOGEN_TACK_DIA_TYPES_PROCESSED_OBJECT_HPP
#define DOGEN_TACK_DIA_TYPES_PROCESSED_OBJECT_HPP
...
#include "dogen/tack_dia/serialization/processed_object_fwd_ser.hpp"
...
public:
     ...
     */
    /**@{*/
    dogen::tack_dia::object_types object_type() const;
    void object_type(const dogen::tack_dia::object_types v);
    /**@}*/
     ...
     */
    /**@{*/
    const dogen::tack_dia::processed_comment& comment() const;
    dogen::tack_dia::processed_comment& comment();
    void comment(const dogen::tack_dia::processed_comment& v);
    void comment(const dogen::tack_dia::processed_comment&& v);
    /**@}*/
     ...
     */
    /**@{*/
    const std::list<dogen::tack_dia::processed_property>& properties() const;
    std::list<dogen::tack_dia::processed_property>& properties();
    void properties(const std::list<dogen::tack_dia::processed_property>& v);
    void properties(const std::list<dogen::tack_dia::processed_property>&& v);
    /**@}*/
...
private:
    std::string id_;
    std::string name_;
    dogen::tack_dia::object_types object_type_;
    std::string stereotype_;
    dogen::tack_dia::processed_comment comment_;
    std::string child_node_id_;
    boost::optional<std::pair<std::string, std::string> > connection_;
    std::list<dogen::tack_dia::processed_property> properties_;
};
...
template<>
inline void swap(
    dogen::tack_dia::processed_object& lhs,
    dogen::tack_dia::processed_object& rhs) {
    lhs.swap(rhs);
}
