 ...
 *
 */
#ifndef DOGEN_TACK_DIA_TYPES_PROCESSED_PROPERTY_HPP
#define DOGEN_TACK_DIA_TYPES_PROCESSED_PROPERTY_HPP
...
#include "dogen/tack_dia/serialization/processed_property_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::tack_dia::processed_property& lhs,
    dogen::tack_dia::processed_property& rhs) {
    lhs.swap(rhs);
}
