 ...
 *
 */
#ifndef DOGEN_TACK_DIA_TYPES_PROFILE_HPP
#define DOGEN_TACK_DIA_TYPES_PROFILE_HPP
...
#include <string>
#include <algorithm>
#include "dogen/tack_dia/serialization/profile_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::tack_dia::profile& lhs,
    dogen::tack_dia::profile& rhs) {
    lhs.swap(rhs);
}
