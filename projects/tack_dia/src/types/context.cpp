...
const std::unordered_map<std::string, dogen::tack::name>& context::id_to_name() const {
    return id_to_name_;
}

std::unordered_map<std::string, dogen::tack::name>& context::id_to_name() {
    return id_to_name_;
}

void context::id_to_name(const std::unordered_map<std::string, dogen::tack::name>& v) {
    id_to_name_ = v;
}
