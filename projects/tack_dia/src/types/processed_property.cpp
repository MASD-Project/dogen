...
const dogen::tack_dia::processed_comment& processed_property::comment() const {
    return comment_;
}

dogen::tack_dia::processed_comment& processed_property::comment() {
    return comment_;
}

void processed_property::comment(const dogen::tack_dia::processed_comment& v) {
    comment_ = v;
}
