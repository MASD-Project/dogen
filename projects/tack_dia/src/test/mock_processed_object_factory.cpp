...
using dogen::tack_dia::processed_object;
using dogen::tack_dia::processed_property;
using dogen::tack_dia::test::mock_processed_object_factory;

processed_object
create_object(const dogen::tack_dia::object_types ot, const unsigned int n) {
    processed_object r;
...
processed_object create_named_object(const dogen::tack_dia::object_types ot,
