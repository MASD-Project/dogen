...
dogen::tack_dia::profile
mock_profile(const dogen::tack_dia::processed_object& o) {
...
dogen::tack_dia::context mock_context(const std::string& model_name) {
    dogen::tack_dia::context r;
...
dogen::tack_dia::context mock_context() {
...
void transform(dogen::tack_dia::context& c,
    std::initializer_list<dogen::tack_dia::processed_object> lpo) {
    ...
    dogen::tack_dia::transformer t(w, c);
...
void transform(dogen::tack_dia::context& c,
    const dogen::tack_dia::processed_object& po,
    const dogen::tack_dia::profile& p) {
