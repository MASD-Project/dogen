 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TESTING_FACTORY_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TESTING_FACTORY_HPP
 ...
 * testing.
 *
 * Part documentation: Contains the test files.
