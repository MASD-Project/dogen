 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_ODB_COMMON_ODB_OPTIONS_TRANSFORM_FACTORY_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_ODB_COMMON_ODB_OPTIONS_TRANSFORM_FACTORY_HPP
 ...
 */
class common_odb_options_transform_factory final {
public:
    /**
