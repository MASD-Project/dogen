 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_ODB_PRIMITIVE_ODB_OPTIONS_TRANSFORM_FACTORY_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_ODB_PRIMITIVE_ODB_OPTIONS_TRANSFORM_FACTORY_HPP
 ...
 * primitive_odb_options_transform.
 *
 * Archetype documentation: Generates object options for odb.

 */
class primitive_odb_options_transform_factory final {
public:
    /**
