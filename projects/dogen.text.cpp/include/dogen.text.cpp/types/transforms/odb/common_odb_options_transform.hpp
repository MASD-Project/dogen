 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_ODB_COMMON_ODB_OPTIONS_TRANSFORM_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_ODB_COMMON_ODB_OPTIONS_TRANSFORM_HPP
...
class common_odb_options_transform final : public text::transforms::model_to_text_transform {
public:
