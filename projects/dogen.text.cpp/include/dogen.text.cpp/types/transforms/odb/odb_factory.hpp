 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_ODB_ODB_FACTORY_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_ODB_ODB_FACTORY_HPP
 ...
 * odb.
 *
 * Facet documentation: Formatters for the odb facet of the
C++ technical space.
