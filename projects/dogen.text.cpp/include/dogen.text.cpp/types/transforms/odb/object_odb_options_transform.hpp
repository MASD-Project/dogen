 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_ODB_OBJECT_ODB_OPTIONS_TRANSFORM_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_ODB_OBJECT_ODB_OPTIONS_TRANSFORM_HPP
...
class object_odb_options_transform final : public text::transforms::model_to_text_transform {
public:
