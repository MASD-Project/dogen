 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TRANSFORMS_FACTORY_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TRANSFORMS_FACTORY_HPP
 ...
 * transforms.
 *
 * Backend documentation: Formatters for the C++ model.
 ...
 */
class transforms_factory final {
public:
