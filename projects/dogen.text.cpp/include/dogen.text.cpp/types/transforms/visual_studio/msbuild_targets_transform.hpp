 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_VISUAL_STUDIO_MSBUILD_TARGETS_TRANSFORM_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_VISUAL_STUDIO_MSBUILD_TARGETS_TRANSFORM_HPP
