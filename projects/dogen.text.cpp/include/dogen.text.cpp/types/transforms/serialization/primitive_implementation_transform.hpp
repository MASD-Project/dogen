 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_SERIALIZATION_PRIMITIVE_IMPLEMENTATION_TRANSFORM_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_SERIALIZATION_PRIMITIVE_IMPLEMENTATION_TRANSFORM_HPP
...
class primitive_implementation_transform final : public text::transforms::model_to_text_transform {
public:
