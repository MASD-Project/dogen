 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_SERIALIZATION_BUILTIN_HEADER_TRANSFORM_FACTORY_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_SERIALIZATION_BUILTIN_HEADER_TRANSFORM_FACTORY_HPP
 ...
 */
class builtin_header_transform_factory final {
public:
    /**
