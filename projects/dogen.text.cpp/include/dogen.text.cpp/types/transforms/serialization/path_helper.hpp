 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_SERIALIZATION_PATH_HELPER_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_SERIALIZATION_PATH_HELPER_HPP
...
class path_helper : public helper_transform {
public:
