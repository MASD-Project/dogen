 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_SERIALIZATION_CLASS_IMPLEMENTATION_TRANSFORM_FACTORY_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_SERIALIZATION_CLASS_IMPLEMENTATION_TRANSFORM_FACTORY_HPP
 ...
 */
class class_implementation_transform_factory final {
public:
    /**
