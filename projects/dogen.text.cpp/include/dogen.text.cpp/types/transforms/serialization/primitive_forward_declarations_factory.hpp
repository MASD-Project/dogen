 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_SERIALIZATION_PRIMITIVE_FORWARD_DECLARATIONS_FACTORY_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_SERIALIZATION_PRIMITIVE_FORWARD_DECLARATIONS_FACTORY_HPP
