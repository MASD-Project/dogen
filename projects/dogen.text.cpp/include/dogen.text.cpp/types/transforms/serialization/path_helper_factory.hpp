 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_SERIALIZATION_PATH_HELPER_FACTORY_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_SERIALIZATION_PATH_HELPER_FACTORY_HPP
 ...
 */
class path_helper_factory final {
public:
    /**
