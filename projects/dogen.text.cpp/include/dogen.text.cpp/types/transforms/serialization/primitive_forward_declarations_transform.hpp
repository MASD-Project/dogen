 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_SERIALIZATION_PRIMITIVE_FORWARD_DECLARATIONS_TRANSFORM_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_SERIALIZATION_PRIMITIVE_FORWARD_DECLARATIONS_TRANSFORM_HPP
...
class primitive_forward_declarations_transform final : public text::transforms::model_to_text_transform {
public:
