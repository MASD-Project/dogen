 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_SERIALIZATION_TYPE_REGISTRAR_IMPLEMENTATION_TRANSFORM_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_SERIALIZATION_TYPE_REGISTRAR_IMPLEMENTATION_TRANSFORM_HPP
...
class type_registrar_implementation_transform final : public text::transforms::model_to_text_transform {
public:
