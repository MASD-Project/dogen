 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_SERIALIZATION_PRIMITIVE_HEADER_TRANSFORM_FACTORY_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_SERIALIZATION_PRIMITIVE_HEADER_TRANSFORM_FACTORY_HPP
 ...
 * primitive_header_transform.
 *
 * Archetype documentation: Generates header files for primitives.

 */
class primitive_header_transform_factory final {
public:
    /**
