 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TEST_DATA_BOOL_HELPER_FACTORY_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TEST_DATA_BOOL_HELPER_FACTORY_HPP
 ...
 */
class bool_helper_factory final {
public:
    /**
