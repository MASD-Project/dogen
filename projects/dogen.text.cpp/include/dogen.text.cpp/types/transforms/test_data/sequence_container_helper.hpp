 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TEST_DATA_SEQUENCE_CONTAINER_HELPER_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TEST_DATA_SEQUENCE_CONTAINER_HELPER_HPP
...
class sequence_container_helper : public helper_transform {
public:
