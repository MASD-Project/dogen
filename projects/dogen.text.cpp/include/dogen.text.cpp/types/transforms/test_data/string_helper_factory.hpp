 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TEST_DATA_STRING_HELPER_FACTORY_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TEST_DATA_STRING_HELPER_FACTORY_HPP
 ...
 */
class string_helper_factory final {
public:
    /**
