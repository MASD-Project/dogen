 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TEST_DATA_DOMAIN_TYPE_HELPER_FACTORY_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TEST_DATA_DOMAIN_TYPE_HELPER_FACTORY_HPP
 ...
 */
class domain_type_helper_factory final {
public:
    /**
