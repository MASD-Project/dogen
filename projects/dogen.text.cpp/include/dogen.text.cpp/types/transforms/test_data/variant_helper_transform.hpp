 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TEST_DATA_VARIANT_HELPER_TRANSFORM_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TEST_DATA_VARIANT_HELPER_TRANSFORM_HPP
...
class variant_helper_transform final : public text::transforms::helper_transform {
public:
