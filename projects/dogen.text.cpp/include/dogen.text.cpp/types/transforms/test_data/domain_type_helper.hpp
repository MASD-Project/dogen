 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TEST_DATA_DOMAIN_TYPE_HELPER_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TEST_DATA_DOMAIN_TYPE_HELPER_HPP
...
class domain_type_helper : public helper_transform {
public:
