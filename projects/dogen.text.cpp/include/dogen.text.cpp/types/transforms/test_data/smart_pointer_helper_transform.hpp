 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TEST_DATA_SMART_POINTER_HELPER_TRANSFORM_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TEST_DATA_SMART_POINTER_HELPER_TRANSFORM_HPP
...
class smart_pointer_helper_transform final : public text::transforms::helper_transform {
public:
