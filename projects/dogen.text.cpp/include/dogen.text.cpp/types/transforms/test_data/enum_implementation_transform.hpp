 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TEST_DATA_ENUM_IMPLEMENTATION_TRANSFORM_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TEST_DATA_ENUM_IMPLEMENTATION_TRANSFORM_HPP
...
class enum_implementation_transform final : public text::transforms::model_to_text_transform {
public:
