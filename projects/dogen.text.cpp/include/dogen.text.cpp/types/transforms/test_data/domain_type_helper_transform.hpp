 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TEST_DATA_DOMAIN_TYPE_HELPER_TRANSFORM_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TEST_DATA_DOMAIN_TYPE_HELPER_TRANSFORM_HPP
...
class domain_type_helper_transform final : public text::transforms::helper_transform {
public:
