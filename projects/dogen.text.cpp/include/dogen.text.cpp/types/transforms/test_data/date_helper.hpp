 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TEST_DATA_DATE_HELPER_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TEST_DATA_DATE_HELPER_HPP
...
class date_helper : public helper_transform {
public:
