 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TEST_DATA_ASSOCIATIVE_CONTAINER_HELPER_FACTORY_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TEST_DATA_ASSOCIATIVE_CONTAINER_HELPER_FACTORY_HPP
 ...
 */
class associative_container_helper_factory final {
public:
    /**
