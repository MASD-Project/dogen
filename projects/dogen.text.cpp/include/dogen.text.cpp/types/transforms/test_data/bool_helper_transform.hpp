 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TEST_DATA_BOOL_HELPER_TRANSFORM_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TEST_DATA_BOOL_HELPER_TRANSFORM_HPP
...
class bool_helper_transform final : public text::transforms::helper_transform {
public:
