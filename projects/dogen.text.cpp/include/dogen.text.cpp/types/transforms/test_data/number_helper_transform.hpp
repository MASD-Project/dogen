 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TEST_DATA_NUMBER_HELPER_TRANSFORM_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TEST_DATA_NUMBER_HELPER_TRANSFORM_HPP
...
class number_helper_transform final : public text::transforms::helper_transform {
public:
