 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TEST_DATA_NUMBER_HELPER_FACTORY_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TEST_DATA_NUMBER_HELPER_FACTORY_HPP
 ...
 */
class number_helper_factory final {
public:
    /**
