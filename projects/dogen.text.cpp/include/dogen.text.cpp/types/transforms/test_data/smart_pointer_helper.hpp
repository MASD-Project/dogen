 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TEST_DATA_SMART_POINTER_HELPER_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TEST_DATA_SMART_POINTER_HELPER_HPP
...
class smart_pointer_helper : public helper_transform {
public:
