 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TEST_DATA_PTIME_HELPER_FACTORY_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TEST_DATA_PTIME_HELPER_FACTORY_HPP
 ...
 */
class ptime_helper_factory final {
public:
    /**
