 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_IO_IO_FACTORY_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_IO_IO_FACTORY_HPP
 ...
 * io.
 *
 * Facet documentation: Formatters for the io facet of the
C++ technical space.
