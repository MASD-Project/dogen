 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TESTS_CMAKELISTS_TRANSFORM_FACTORY_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TESTS_CMAKELISTS_TRANSFORM_FACTORY_HPP
 ...
 */
class cmakelists_transform_factory final {
public:
    /**
