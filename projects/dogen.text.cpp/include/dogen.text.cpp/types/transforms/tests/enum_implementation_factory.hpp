 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TESTS_ENUM_IMPLEMENTATION_FACTORY_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TESTS_ENUM_IMPLEMENTATION_FACTORY_HPP
