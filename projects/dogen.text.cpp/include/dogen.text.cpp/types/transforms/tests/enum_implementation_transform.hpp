 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TESTS_ENUM_IMPLEMENTATION_TRANSFORM_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TESTS_ENUM_IMPLEMENTATION_TRANSFORM_HPP
