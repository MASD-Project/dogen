 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TESTS_TESTS_FACTORY_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TESTS_TESTS_FACTORY_HPP
 ...
 * tests.
 *
 * Facet documentation: Formatters that generate tests for generated
code.
