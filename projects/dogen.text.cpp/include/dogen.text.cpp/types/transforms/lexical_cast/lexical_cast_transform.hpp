 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_LEXICAL_CAST_LEXICAL_CAST_TRANSFORM_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_LEXICAL_CAST_LEXICAL_CAST_TRANSFORM_HPP
