 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_LEXICAL_CAST_ENUM_HEADER_TRANSFORM_FACTORY_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_LEXICAL_CAST_ENUM_HEADER_TRANSFORM_FACTORY_HPP
