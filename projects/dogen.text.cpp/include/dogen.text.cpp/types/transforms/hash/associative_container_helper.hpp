 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_HASH_ASSOCIATIVE_CONTAINER_HELPER_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_HASH_ASSOCIATIVE_CONTAINER_HELPER_HPP
