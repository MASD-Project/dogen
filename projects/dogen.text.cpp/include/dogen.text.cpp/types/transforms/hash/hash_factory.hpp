 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_HASH_HASH_FACTORY_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_HASH_HASH_FACTORY_HPP
 ...
 * hash.
 *
 * Facet documentation: Formatters for the hash facet of the
C++ technical space.
