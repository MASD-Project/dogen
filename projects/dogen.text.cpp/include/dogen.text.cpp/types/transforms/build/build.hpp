 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_BUILD_BUILD_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_BUILD_BUILD_HPP
...
/**
 * @brief Formatters related to build files.
 */
class build_facet final {
public:
