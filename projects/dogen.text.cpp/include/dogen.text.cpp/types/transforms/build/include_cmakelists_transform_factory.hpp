 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_BUILD_INCLUDE_CMAKELISTS_TRANSFORM_FACTORY_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_BUILD_INCLUDE_CMAKELISTS_TRANSFORM_FACTORY_HPP
 ...
 * include_cmakelists_transform.
 *
 * Archetype documentation: Generates cmakelists for tests.

 */
class include_cmakelists_transform_factory final {
public:
    /**
