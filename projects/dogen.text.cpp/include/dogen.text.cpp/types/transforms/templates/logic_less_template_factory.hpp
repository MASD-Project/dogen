 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TEMPLATES_LOGIC_LESS_TEMPLATE_FACTORY_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TEMPLATES_LOGIC_LESS_TEMPLATE_FACTORY_HPP
 ...
 */
class logic_less_template_factory final {
public:
    /**
