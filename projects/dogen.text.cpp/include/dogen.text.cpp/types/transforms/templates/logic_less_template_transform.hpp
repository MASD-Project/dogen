 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TEMPLATES_LOGIC_LESS_TEMPLATE_TRANSFORM_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TEMPLATES_LOGIC_LESS_TEMPLATE_TRANSFORM_HPP
...
class logic_less_template_transform final : public model_to_text_transform {
public:
