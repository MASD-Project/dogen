 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TRANSFORMATION_ERROR_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TRANSFORMATION_ERROR_HPP
...
/**
 * @brief An error occurred whilst applying a transform.
 */
