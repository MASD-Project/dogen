 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TYPES_VARIABILITY_INITIALIZER_HEADER_FACTORY_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TYPES_VARIABILITY_INITIALIZER_HEADER_FACTORY_HPP
