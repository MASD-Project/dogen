 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TYPES_ARCHETYPE_CLASS_HEADER_TRANSFORM_OLD_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TYPES_ARCHETYPE_CLASS_HEADER_TRANSFORM_OLD_HPP
...
class archetype_class_header_transform_old final : public model_to_text_transform {
public:
