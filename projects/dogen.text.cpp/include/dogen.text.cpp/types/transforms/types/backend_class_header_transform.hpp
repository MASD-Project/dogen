 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TYPES_BACKEND_CLASS_HEADER_TRANSFORM_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TYPES_BACKEND_CLASS_HEADER_TRANSFORM_HPP
...
class backend_class_header_transform final : public model_to_text_transform {
public:
