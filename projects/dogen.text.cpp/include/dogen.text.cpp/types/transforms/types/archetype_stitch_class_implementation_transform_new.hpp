 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TYPES_ARCHETYPE_STITCH_CLASS_IMPLEMENTATION_TRANSFORM_NEW_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TYPES_ARCHETYPE_STITCH_CLASS_IMPLEMENTATION_TRANSFORM_NEW_HPP
...
class archetype_stitch_class_implementation_transform_new final : public model_to_text_transform {
public:
