 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TYPES_SMART_POINTER_NEW_HELPER_TRANSFORM_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TYPES_SMART_POINTER_NEW_HELPER_TRANSFORM_HPP
...
class smart_pointer_new_helper_transform final : public helper_transform {
public:
