 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TYPES_FEATURE_BUNDLE_IMPLEMENTATION_TRANSFORM_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TYPES_FEATURE_BUNDLE_IMPLEMENTATION_TRANSFORM_HPP
...
class feature_bundle_implementation_transform final : public text::transforms::model_to_text_transform {
public:
