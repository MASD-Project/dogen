 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TYPES_PART_CLASS_IMPLEMENTATION_FACTORY_TRANSFORM_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TYPES_PART_CLASS_IMPLEMENTATION_FACTORY_TRANSFORM_HPP
...
class part_class_implementation_factory_transform final : public text::transforms::model_to_text_transform {
public:
