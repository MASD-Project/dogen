 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TYPES_ARCHETYPE_KIND_CLASS_IMPLEMENTATION_TRANSFORM_TRANSFORM_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TYPES_ARCHETYPE_KIND_CLASS_IMPLEMENTATION_TRANSFORM_TRANSFORM_HPP
...
class archetype_kind_class_implementation_transform_transform final : public model_to_text_transform {
public:
