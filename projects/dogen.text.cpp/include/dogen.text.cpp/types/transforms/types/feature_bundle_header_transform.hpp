 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TYPES_FEATURE_BUNDLE_HEADER_TRANSFORM_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TYPES_FEATURE_BUNDLE_HEADER_TRANSFORM_HPP
...
class feature_bundle_header_transform final : public text::transforms::model_to_text_transform {
public:
