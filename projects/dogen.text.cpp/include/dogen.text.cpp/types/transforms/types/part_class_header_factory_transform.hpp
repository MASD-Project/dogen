 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TYPES_PART_CLASS_HEADER_FACTORY_TRANSFORM_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TYPES_PART_CLASS_HEADER_FACTORY_TRANSFORM_HPP
...
class part_class_header_factory_transform final : public text::transforms::model_to_text_transform {
public:
