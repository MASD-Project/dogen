 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TYPES_NAMESPACE_HEADER_TRANSFORM_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TYPES_NAMESPACE_HEADER_TRANSFORM_HPP
...
class namespace_header_transform final : public text::transforms::model_to_text_transform {
public:
