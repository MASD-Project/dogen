 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TYPES_VISITOR_HEADER_TRANSFORM_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TYPES_VISITOR_HEADER_TRANSFORM_HPP
...
class visitor_header_transform final : public text::transforms::model_to_text_transform {
public:
