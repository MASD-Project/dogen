 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TYPES_FEATURE_BUNDLE_HEADER_FACTORY_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TYPES_FEATURE_BUNDLE_HEADER_FACTORY_HPP
 ...
 */
class feature_bundle_header_factory final {
public:
    /**
