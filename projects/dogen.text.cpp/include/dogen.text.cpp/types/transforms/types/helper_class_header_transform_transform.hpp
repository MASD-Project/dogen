 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TYPES_HELPER_CLASS_HEADER_TRANSFORM_TRANSFORM_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TYPES_HELPER_CLASS_HEADER_TRANSFORM_TRANSFORM_HPP
...
class helper_class_header_transform_transform final : public text::transforms::model_to_text_transform {
public:
