 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TYPES_PART_CLASS_IMPLEMENTATION_TRANSFORM_HPP
#define DOGEN_TEXT_CPP_TYPES_TRANSFORMS_TYPES_PART_CLASS_IMPLEMENTATION_TRANSFORM_HPP
...
class part_class_implementation_transform final : public model_to_text_transform {
public:
