 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_FORMATTABLES_DIRECTIVE_GROUP_REPOSITORY_FACTORY_HPP
#define DOGEN_TEXT_CPP_TYPES_FORMATTABLES_DIRECTIVE_GROUP_REPOSITORY_FACTORY_HPP
