 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_FORMATTABLES_HELPER_DESCRIPTOR_HPP
#define DOGEN_TEXT_CPP_TYPES_FORMATTABLES_HELPER_DESCRIPTOR_HPP
...
template<>
inline void swap(
    dogen::text::cpp::formattables::helper_descriptor& lhs,
    dogen::text::cpp::formattables::helper_descriptor& rhs) {
    lhs.swap(rhs);
}
