 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_FORMATTABLES_DIRECTIVE_GROUP_HPP
#define DOGEN_TEXT_CPP_TYPES_FORMATTABLES_DIRECTIVE_GROUP_HPP
...
template<>
inline void swap(
    dogen::text::cpp::formattables::directive_group& lhs,
    dogen::text::cpp::formattables::directive_group& rhs) {
    lhs.swap(rhs);
}
