 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_FORMATTABLES_ARTEFACT_PROPERTIES_HPP
#define DOGEN_TEXT_CPP_TYPES_FORMATTABLES_ARTEFACT_PROPERTIES_HPP
...
template<>
inline void swap(
    dogen::text::cpp::formattables::artefact_properties& lhs,
    dogen::text::cpp::formattables::artefact_properties& rhs) {
    lhs.swap(rhs);
}
