 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_FORMATTABLES_FORMATTABLE_HPP
#define DOGEN_TEXT_CPP_TYPES_FORMATTABLES_FORMATTABLE_HPP
...
template<>
inline void swap(
    dogen::text::cpp::formattables::formattable& lhs,
    dogen::text::cpp::formattables::formattable& rhs) {
    lhs.swap(rhs);
}
