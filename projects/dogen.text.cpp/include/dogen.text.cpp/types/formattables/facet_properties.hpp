 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_FORMATTABLES_FACET_PROPERTIES_HPP
#define DOGEN_TEXT_CPP_TYPES_FORMATTABLES_FACET_PROPERTIES_HPP
...
template<>
inline void swap(
    dogen::text::cpp::formattables::facet_properties& lhs,
    dogen::text::cpp::formattables::facet_properties& rhs) {
    lhs.swap(rhs);
}
