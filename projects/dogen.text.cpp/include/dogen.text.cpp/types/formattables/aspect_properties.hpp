 ...
 *
 */
#ifndef DOGEN_TEXT_CPP_TYPES_FORMATTABLES_ASPECT_PROPERTIES_HPP
#define DOGEN_TEXT_CPP_TYPES_FORMATTABLES_ASPECT_PROPERTIES_HPP
...
template<>
inline void swap(
    dogen::text::cpp::formattables::aspect_properties& lhs,
    dogen::text::cpp::formattables::aspect_properties& rhs) {
    lhs.swap(rhs);
}
