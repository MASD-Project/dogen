...
const std::unordered_map<std::string, dogen::text::cpp::formattables::locator_facet_configuration>& locator_configuration::facet_configurations() const {
    return facet_configurations_;
}

std::unordered_map<std::string, dogen::text::cpp::formattables::locator_facet_configuration>& locator_configuration::facet_configurations() {
    return facet_configurations_;
}

void locator_configuration::facet_configurations(const std::unordered_map<std::string, dogen::text::cpp::formattables::locator_facet_configuration>& v) {
...
const std::unordered_map<std::string, dogen::text::cpp::formattables::locator_archetype_configuration>& locator_configuration::archetype_configurations() const {
    return archetype_configurations_;
}

std::unordered_map<std::string, dogen::text::cpp::formattables::locator_archetype_configuration>& locator_configuration::archetype_configurations() {
    return archetype_configurations_;
}

void locator_configuration::archetype_configurations(const std::unordered_map<std::string, dogen::text::cpp::formattables::locator_archetype_configuration>& v) {
