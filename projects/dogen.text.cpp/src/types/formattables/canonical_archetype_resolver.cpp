...
#include "dogen.text.cpp/types/formattables/resolution_error.hpp"
#include "dogen.text.cpp/types/formattables/canonical_archetype_resolver.hpp"

namespace {

using namespace dogen::utility::log;
static logger lg(logger_factory(
        "text.cpp.formattables.canonical_archetype_resolver"));
