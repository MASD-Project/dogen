...
physical::entities::archetype type_registrar_implementation_factory::make() {
    ...
    r.logical_meta_element_id(identification::entities::logical_meta_id("dogen.logical.entities.serialization_type_registrar"));
