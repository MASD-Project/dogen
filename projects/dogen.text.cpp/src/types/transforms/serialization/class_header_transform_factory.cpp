...
#include "dogen.text.cpp/types/transforms/serialization/class_header_transform_factory.hpp"

namespace dogen::text::cpp::transforms::serialization {

const physical::entities::archetype& class_header_transform_factory::make_archetype() {
    static physical::entities::archetype r([]() {
        physical::entities::archetype r;
            using pmnf = physical::helpers::meta_name_factory;
            r.meta_name(pmnf::make("cpp",
                "serialization",
                "class_header_transform_factory"));
