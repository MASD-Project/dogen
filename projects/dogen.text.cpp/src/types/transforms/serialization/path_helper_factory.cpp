...
physical::entities::helper path_helper_factory::make() {
    physical::entities::helper r;
    using pmnf = identification::helpers::physical_meta_name_factory;
    r.meta_name(pmnf::make("cpp", "serialization", "path_helper"));
    ...
    r.owning_formatters().push_back(
        physical_meta_id("masd.cpp.serialization.class_implementation"));
    r.owning_formatters().push_back(
        physical_meta_id("masd.cpp.serialization.primitive_implementation"));
    r.owning_facets().push_back(
        physical_meta_id("masd.cpp.serialization"));
