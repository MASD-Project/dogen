...
physical::entities::archetype facet_class_implementation_transform::static_archetype() const {
...
physical::entities::archetype facet_class_implementation_transform::archetype() const {
...
void facet_class_implementation_transform::apply(const context& ctx, const logical::entities::element& e,
    ...
    const auto& arch(ast.as<logical::entities::physical::facet>(e));
