...
const std::string transform_id("text.cpp.transforms.types.facet_class_implementation_transform");
...
const physical::entities::archetype& facet_class_implementation_transform::static_archetype() {
    static physical::entities::archetype r([]() {
        physical::entities::archetype r;
        using pmnf = physical::helpers::meta_name_factory;
        r.meta_name(pmnf::make(cpp::traits::backend_sn(),
            traits::facet_sn(), traits::facet_class_implementation_archetype_sn()));
...
const physical::entities::archetype& facet_class_implementation_transform::archetype() const {
    return static_archetype();
}

inclusion_support_types facet_class_implementation_transform::inclusion_support_type() const {
    return inclusion_support_types::not_supported;
}

boost::filesystem::path facet_class_implementation_transform::inclusion_path(
...
boost::filesystem::path facet_class_implementation_transform::full_path(
    const formattables::locator& l, const logical::entities::name& n) const {
