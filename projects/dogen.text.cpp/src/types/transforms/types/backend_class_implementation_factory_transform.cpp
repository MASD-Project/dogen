...
const physical::entities::archetype& backend_class_implementation_factory_transform::static_archetype() {
    static physical::entities::archetype r([]() {
        ...
        r.meta_name(pmnf::make(cpp::traits::backend_sn(),
            traits::facet_sn(), traits::backend_class_implementation_factory_archetype_sn()));
...
boost::filesystem::path backend_class_implementation_factory_transform::full_path(
    const formattables::locator& l, const logical::entities::name& n) const {
