...
const std::string transform_id("text.cpp.transforms.types.archetype_class_implementation_transform");
...
const physical::entities::archetype& archetype_class_implementation_transform::static_archetype() {
...
const physical::entities::archetype& archetype_class_implementation_transform::archetype() const {
