...
const std::string transform_id("text.cpp.transforms.types.backend_class_implementation_transform");
...
const physical::entities::archetype& backend_class_implementation_transform::static_archetype() {
...
const physical::entities::archetype& backend_class_implementation_transform::archetype() const {
    return static_archetype();
}

inclusion_support_types backend_class_implementation_transform::inclusion_support_type() const {
    return inclusion_support_types::not_supported;
}

boost::filesystem::path backend_class_implementation_transform::inclusion_path(
...
boost::filesystem::path backend_class_implementation_transform::full_path(
    const formattables::locator& l, const logical::entities::name& n) const {
