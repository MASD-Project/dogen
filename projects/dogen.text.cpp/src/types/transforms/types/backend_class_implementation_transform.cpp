...
physical::entities::archetype backend_class_implementation_transform::static_archetype() const {
...
physical::entities::archetype backend_class_implementation_transform::archetype() const {
...
void backend_class_implementation_transform::apply(const context& ctx, const logical::entities::element& e,
    ...
    const auto& arch(ast.as<logical::entities::physical::backend>(e));
