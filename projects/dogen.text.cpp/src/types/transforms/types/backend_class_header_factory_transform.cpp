...
const physical::entities::archetype& backend_class_header_factory_transform::static_archetype() {
    static physical::entities::archetype r([]() {
        ...
        r.meta_name(pmnf::make(cpp::traits::backend_sn(),
            traits::facet_sn(), traits::backend_class_header_factory_archetype_sn()));
...
inclusion_support_types backend_class_header_factory_transform::inclusion_support_type() const {
    return inclusion_support_types::regular_support;
}

boost::filesystem::path backend_class_header_factory_transform::inclusion_path(
    const formattables::locator& l, const logical::entities::name& n) const {
    return l.make_inclusion_path_for_cpp_header(n, archetype().meta_name().qualified());
}

boost::filesystem::path backend_class_header_factory_transform::full_path(
    const formattables::locator& l, const logical::entities::name& n) const {
