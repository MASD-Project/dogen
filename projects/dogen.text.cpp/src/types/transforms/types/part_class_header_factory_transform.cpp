...
const std::string transform_id("text.cpp.transforms.types.part_class_header_factory_transform");
...
inclusion_support_types part_class_header_factory_transform::inclusion_support_type() const {
    return inclusion_support_types::regular_support;
}

boost::filesystem::path part_class_header_factory_transform::inclusion_path(
...
boost::filesystem::path part_class_header_factory_transform::full_path(
    const formattables::locator& l, const identification::entities::logical_name& n) const {
    return l.make_full_path_for_cpp_header(n, archetype().meta_name().id().value());
}

std::list<std::string> part_class_header_factory_transform::inclusion_dependencies(
    const formattables::dependencies_builder_factory& f,
    const logical::entities::element& /*e*/) const {
    auto builder(f.make());
    builder.add_as_user("dogen.physical/types/entities/part.hpp");
