...
#include "dogen.text.cpp/types/transforms/types/archetype_stitch_class_implementation_transform_old.hpp"
...
void archetype_stitch_class_implementation_transform_old::apply(const context& ctx, const logical::entities::element& e,
    ...
    b.add_directive_block("masd.stitch.containing_namespaces", "dogen::text::cpp::transforms::types");
    ...
    b.add_directive_block(dep, "dogen.text.cpp/types/transforms/assistant.hpp");
    b.add_directive_block(dep, "dogen.text.cpp/types/transforms/types/archetype_stitch_class_implementation_transform_old.hpp");
    b.add_directive_block(dep, "dogen.templating/types/helpers/stitch_template_builder.hpp");
    b.add_directive_block(dep, "dogen.text.cpp/types/traits.hpp");
    b.add_directive_block(dep, "dogen.text.cpp/types/transforms/types/traits.hpp");
