...
physical::entities::archetype backend_class_header_transform::static_archetype() const {
...
physical::entities::archetype backend_class_header_transform::archetype() const {
