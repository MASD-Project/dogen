...
const std::string transform_id("text.cpp.transforms.types.facet_class_header_factory_transform");
...
const physical::entities::archetype& facet_class_header_factory_transform::static_archetype() {
    static physical::entities::archetype r([]() {
        physical::entities::archetype r;
        using pmnf = physical::helpers::meta_name_factory;
        r.meta_name(pmnf::make(cpp::traits::backend_sn(),
            traits::facet_sn(), traits::facet_class_header_factory_archetype_sn()));
...
boost::filesystem::path facet_class_header_factory_transform::inclusion_path(
    const formattables::locator& l, const logical::entities::name& n) const {
    return l.make_inclusion_path_for_cpp_header(n, archetype().meta_name().qualified());
}

boost::filesystem::path facet_class_header_factory_transform::full_path(
    const formattables::locator& l, const logical::entities::name& n) const {
