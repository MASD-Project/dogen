...
const physical::entities::archetype& part_class_implementation_transform_transform::static_archetype() {
    static physical::entities::archetype r([]() {
        ...
        r.meta_name(pmnf::make(cpp::traits::backend_sn(),
            traits::facet_sn(), traits::part_class_implementation_transform_archetype_sn()));
...
boost::filesystem::path part_class_implementation_transform_transform::inclusion_path(
...
boost::filesystem::path part_class_implementation_transform_transform::full_path(
    const formattables::locator& l, const logical::entities::name& n) const {
