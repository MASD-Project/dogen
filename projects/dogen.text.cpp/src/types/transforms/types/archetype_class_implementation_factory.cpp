...
const std::string transform_id("text.cpp.transforms.types.archetype_class_implementation_factory");
...
const physical::entities::archetype& archetype_class_implementation_factory::static_archetype() {
...
const physical::entities::archetype& archetype_class_implementation_factory::archetype() const {
    return static_archetype();
}

inclusion_support_types archetype_class_implementation_factory::inclusion_support_type() const {
    return inclusion_support_types::not_supported;
}

boost::filesystem::path archetype_class_implementation_factory::inclusion_path(
...
boost::filesystem::path archetype_class_implementation_factory::full_path(
    const formattables::locator& l, const logical::entities::name& n) const {
    return l.make_full_path_for_cpp_implementation(n, archetype().meta_name().qualified());
}

std::list<std::string> archetype_class_implementation_factory::inclusion_dependencies(
...
void archetype_class_implementation_factory::apply(const context& ctx, const logical::entities::element& e,
