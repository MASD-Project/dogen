...
const std::string transform_id("text.cpp.transforms.types.visitor_forward_declarations_transform");
...
const physical::entities::archetype& visitor_forward_declarations_transform::static_archetype() {
