...
const std::string transform_id("text.cpp.transforms.types.archetype_class_implementation_transform_transform");
...
const physical::entities::archetype& archetype_class_implementation_transform_transform::static_archetype() {
    static physical::entities::archetype r([]() {
        physical::entities::archetype r;
        using pmnf = physical::helpers::meta_name_factory;
        r.meta_name(pmnf::make(cpp::traits::backend_sn(),
            traits::facet_sn(), traits::archetype_class_implementation_transform_archetype_sn()));
...
const physical::entities::archetype& archetype_class_implementation_transform_transform::archetype() const {
    static auto r(archetype_class_implementation_transform_factory::make());
    return r;
}

inclusion_support_types archetype_class_implementation_transform_transform::inclusion_support_type() const {
