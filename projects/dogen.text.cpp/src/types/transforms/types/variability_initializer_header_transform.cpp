...
const std::string transform_id("text.cpp.transforms.types.variability_initializer_header_transform");
...
const physical::entities::archetype& variability_initializer_header_transform::static_archetype() {
    static auto r(variability_initializer_header_factory::make());
    return r;
}
