...
const std::string transform_id("text.cpp.transforms.types.archetype_class_header_factory");
...
const physical::entities::archetype& archetype_class_header_factory::static_archetype() {
...
const physical::entities::archetype& archetype_class_header_factory::archetype() const {
    return static_archetype();
}

inclusion_support_types archetype_class_header_factory::inclusion_support_type() const {
    return inclusion_support_types::regular_support;
}

boost::filesystem::path archetype_class_header_factory::inclusion_path(
    const formattables::locator& l, const logical::entities::name& n) const {
    return l.make_inclusion_path_for_cpp_header(n, archetype().meta_name().qualified());
}

boost::filesystem::path archetype_class_header_factory::full_path(
    const formattables::locator& l, const logical::entities::name& n) const {
