...
static logger lg(logger_factory("dogen.text.cpp.transforms.templates"));
...
physical::entities::facet make_facet() {
    ...
    lambda(logic_less_template_transform::static_archetype());
    return r;
}

}

const physical::entities::facet& templates_facet_chain::static_facet() {
    static const auto r(make_facet());
    return r;
}

const physical::entities::facet& templates_facet_chain::facet() const {
    return static_facet();
}
