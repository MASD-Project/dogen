...
physical::entities::archetype common_odb_options_transform::static_archetype() const {
...
physical::entities::archetype common_odb_options_transform::archetype() const {
...
boost::filesystem::path common_odb_options_transform::inclusion_path(
    ...
    static logger
        lg(logger_factory("text.cpp.transforms.odb.common_odb_options_transform"));
