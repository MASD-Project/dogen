...
physical::entities::archetype cmakelists_transform::static_archetype() const {
    static physical::entities::archetype r([]() {
        ...
        r.meta_name(pmnf::make(cpp::traits::backend_sn(),
            traits::facet_sn(), traits::cmakelists_archetype_sn()));
...
physical::entities::archetype cmakelists_transform::archetype() const {
...
boost::filesystem::path cmakelists_transform::full_path(
    const formattables::locator& l, const logical::entities::name& n) const {
    return l.make_full_path_for_tests_cmakelists(n, archetype().meta_name().qualified());
}
