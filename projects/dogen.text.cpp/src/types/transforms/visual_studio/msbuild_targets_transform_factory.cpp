...
#include "dogen.text.cpp/types/transforms/visual_studio/msbuild_targets_transform_factory.hpp"

namespace dogen::text::cpp::transforms::visual_studio {

const physical::entities::archetype& msbuild_targets_transform_factory::make_archetype() {
    static physical::entities::archetype r([]() {
        physical::entities::archetype r;
            using pmnf = physical::helpers::meta_name_factory;
            r.meta_name(pmnf::make("cpp",
                "visual_studio",
                "msbuild_targets_transform_factory"));
