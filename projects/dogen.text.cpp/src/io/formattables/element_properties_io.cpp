...
inline std::ostream& operator<<(std::ostream& s, const std::unordered_map<dogen::identification::entities::physical_meta_id, dogen::text::cpp::formattables::artefact_properties>& v) {
    s << "[";
