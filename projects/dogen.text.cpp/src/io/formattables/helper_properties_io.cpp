...
inline std::ostream& operator<<(std::ostream& s, const std::list<dogen::text::cpp::formattables::helper_descriptor>& v) {
    s << "[ ";
...
std::ostream& operator<<(std::ostream& s, const helper_properties& v) {
    ...
    s << " { "
      << "\"__type__\": " << "\"dogen::text::cpp::formattables::helper_properties\"" << ", "
      << "\"current\": " << v.current() << ", "
