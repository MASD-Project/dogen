 ...
 *
 */
#ifndef DOGEN_SPLIT_PROJECT_DOMAIN_UNVERSIONED_KEY_HPP
#define DOGEN_SPLIT_PROJECT_DOMAIN_UNVERSIONED_KEY_HPP
...
public:
    friend class dogen::split_project::unversioned_key_serializer;
...
template<>
inline void swap(
    dogen::split_project::unversioned_key& lhs,
    dogen::split_project::unversioned_key& rhs) {
    lhs.swap(rhs);
}
