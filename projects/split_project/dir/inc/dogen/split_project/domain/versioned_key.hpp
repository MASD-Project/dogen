 ...
 *
 */
#ifndef DOGEN_SPLIT_PROJECT_DOMAIN_VERSIONED_KEY_HPP
#define DOGEN_SPLIT_PROJECT_DOMAIN_VERSIONED_KEY_HPP
...
template<>
inline void swap(
    dogen::split_project::versioned_key& lhs,
    dogen::split_project::versioned_key& rhs) {
    lhs.swap(rhs);
}
