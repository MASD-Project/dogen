 ...
 *
 */
#ifndef DOGEN_SPLIT_PROJECT_TEST_DATA_UNVERSIONED_KEY_TD_HPP
#define DOGEN_SPLIT_PROJECT_TEST_DATA_UNVERSIONED_KEY_TD_HPP
...
public:
    typedef dogen::split_project::unversioned_key value_type;
