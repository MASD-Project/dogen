 ...
 *
 */
#ifndef DOGEN_SPLIT_PROJECT_TEST_DATA_VERSIONED_KEY_TD_HPP
#define DOGEN_SPLIT_PROJECT_TEST_DATA_VERSIONED_KEY_TD_HPP
...
public:
    typedef dogen::split_project::versioned_key value_type;
