 ...
 *
 */
#ifndef DOGEN_EOS_SERIALIZATION_TYPES_FIRST_CLASS_HPP
#define DOGEN_EOS_SERIALIZATION_TYPES_FIRST_CLASS_HPP
...
#include <algorithm>
#include "dogen/eos_serialization/serialization/first_class_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::eos_serialization::first_class& lhs,
    dogen::eos_serialization::first_class& rhs) {
    lhs.swap(rhs);
}
