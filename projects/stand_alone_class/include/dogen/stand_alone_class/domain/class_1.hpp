 ...
 *
 */
#ifndef DOGEN_STAND_ALONE_CLASS_DOMAIN_CLASS_1_HPP
#define DOGEN_STAND_ALONE_CLASS_DOMAIN_CLASS_1_HPP
...
#include "dogen/stand_alone_class/serialization/class_1_fwd_ser.hpp"
...
public:
    dogen::stand_alone_class::versioned_key versioned_key() const {
...
private:
    dogen::stand_alone_class::versioned_key versioned_key_;
};
...
template<>
inline void swap(
    dogen::stand_alone_class::class_1& lhs,
    dogen::stand_alone_class::class_1& rhs) {
    lhs.swap(rhs);
}
