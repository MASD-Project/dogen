 ...
 *
 */
#ifndef DOGEN_STAND_ALONE_CLASS_DOMAIN_UNVERSIONED_KEY_HPP
#define DOGEN_STAND_ALONE_CLASS_DOMAIN_UNVERSIONED_KEY_HPP
...
public:
    friend class dogen::stand_alone_class::unversioned_key_serializer;
...
template<>
inline void swap(
    dogen::stand_alone_class::unversioned_key& lhs,
    dogen::stand_alone_class::unversioned_key& rhs) {
    lhs.swap(rhs);
}
