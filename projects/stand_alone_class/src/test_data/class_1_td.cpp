...
dogen::stand_alone_class::versioned_key
create_dogen_stand_alone_class_versioned_key(const unsigned int position) {
    return dogen::stand_alone_class::versioned_key_generator::create(position);
}
...
populate(const unsigned int position, result_type& v) {
    v.versioned_key(create_dogen_stand_alone_class_versioned_key(position + 0));
}
