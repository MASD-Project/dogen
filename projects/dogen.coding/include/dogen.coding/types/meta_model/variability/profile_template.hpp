 ...
 *
 */
#ifndef DOGEN_CODING_TYPES_META_MODEL_VARIABILITY_PROFILE_TEMPLATE_HPP
#define DOGEN_CODING_TYPES_META_MODEL_VARIABILITY_PROFILE_TEMPLATE_HPP
...
class profile_template final : public dogen::coding::meta_model::element {
public:
...
public:
    profile_template(
        ...
        const std::list<dogen::coding::meta_model::variability::profile_template_entry>& entries,
...
public:
    ...
    const std::list<dogen::coding::meta_model::variability::profile_template_entry>& entries() const;
    std::list<dogen::coding::meta_model::variability::profile_template_entry>& entries();
    void entries(const std::list<dogen::coding::meta_model::variability::profile_template_entry>& v);
    void entries(const std::list<dogen::coding::meta_model::variability::profile_template_entry>&& v);
...
private:
    ...
    std::list<dogen::coding::meta_model::variability::profile_template_entry> entries_;
...
template<>
inline void swap(
    dogen::coding::meta_model::variability::profile_template& lhs,
    dogen::coding::meta_model::variability::profile_template& rhs) {
    lhs.swap(rhs);
}
