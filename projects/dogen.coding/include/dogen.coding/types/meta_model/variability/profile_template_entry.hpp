 ...
 *
 */
#ifndef DOGEN_CODING_TYPES_META_MODEL_VARIABILITY_PROFILE_TEMPLATE_ENTRY_HPP
#define DOGEN_CODING_TYPES_META_MODEL_VARIABILITY_PROFILE_TEMPLATE_ENTRY_HPP
...
template<>
inline void swap(
    dogen::coding::meta_model::variability::profile_template_entry& lhs,
    dogen::coding::meta_model::variability::profile_template_entry& rhs) {
    lhs.swap(rhs);
}
