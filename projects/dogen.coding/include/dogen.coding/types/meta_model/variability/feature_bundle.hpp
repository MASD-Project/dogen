 ...
 *
 */
#ifndef DOGEN_CODING_TYPES_META_MODEL_VARIABILITY_FEATURE_BUNDLE_HPP
#define DOGEN_CODING_TYPES_META_MODEL_VARIABILITY_FEATURE_BUNDLE_HPP
...
class feature_bundle final : public dogen::coding::meta_model::element {
public:
...
public:
    const std::list<dogen::coding::meta_model::variability::feature_template>& feature_templates() const;
    std::list<dogen::coding::meta_model::variability::feature_template>& feature_templates();
    void feature_templates(const std::list<dogen::coding::meta_model::variability::feature_template>& v);
    void feature_templates(const std::list<dogen::coding::meta_model::variability::feature_template>&& v);
     ...
     */
    /**@{*/
    const dogen::coding::meta_model::structural::object& static_representation() const;
    dogen::coding::meta_model::structural::object& static_representation();
    void static_representation(const dogen::coding::meta_model::structural::object& v);
    void static_representation(const dogen::coding::meta_model::structural::object&& v);
    /**@}*/
...
private:
    std::list<dogen::coding::meta_model::variability::feature_template> feature_templates_;
    dogen::coding::meta_model::structural::object static_representation_;
};
...
template<>
inline void swap(
    dogen::coding::meta_model::variability::feature_bundle& lhs,
    dogen::coding::meta_model::variability::feature_bundle& rhs) {
    lhs.swap(rhs);
}
