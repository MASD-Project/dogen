 ...
 *
 */
#ifndef DOGEN_CODING_TYPES_META_MODEL_NAME_TREE_HPP
#define DOGEN_CODING_TYPES_META_MODEL_NAME_TREE_HPP
...
public:
    name_tree(
        const dogen::coding::meta_model::fully_qualified_representation& qualified,
        const dogen::coding::meta_model::name& current,
        const std::list<dogen::coding::meta_model::name_tree>& children,
...
public:
    const dogen::coding::meta_model::fully_qualified_representation& qualified() const;
    dogen::coding::meta_model::fully_qualified_representation& qualified();
    void qualified(const dogen::coding::meta_model::fully_qualified_representation& v);
    void qualified(const dogen::coding::meta_model::fully_qualified_representation&& v);
     ...
     */
    /**@{*/
    const dogen::coding::meta_model::name& current() const;
    dogen::coding::meta_model::name& current();
    void current(const dogen::coding::meta_model::name& v);
    void current(const dogen::coding::meta_model::name&& v);
    /**@}*/
     ...
     */
    /**@{*/
    const std::list<dogen::coding::meta_model::name_tree>& children() const;
    std::list<dogen::coding::meta_model::name_tree>& children();
    void children(const std::list<dogen::coding::meta_model::name_tree>& v);
    void children(const std::list<dogen::coding::meta_model::name_tree>&& v);
    /**@}*/
...
private:
    dogen::coding::meta_model::fully_qualified_representation qualified_;
    dogen::coding::meta_model::name current_;
    std::list<dogen::coding::meta_model::name_tree> children_;
...
template<>
inline void swap(
    dogen::coding::meta_model::name_tree& lhs,
    dogen::coding::meta_model::name_tree& rhs) {
    lhs.swap(rhs);
}
