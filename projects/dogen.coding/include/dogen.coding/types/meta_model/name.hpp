 ...
 *
 */
#ifndef DOGEN_CODING_TYPES_META_MODEL_NAME_HPP
#define DOGEN_CODING_TYPES_META_MODEL_NAME_HPP
...
public:
    name(
        ...
        const dogen::coding::meta_model::location& location);
...
public:
     ...
     */
    /**@{*/
    const dogen::coding::meta_model::location& location() const;
    dogen::coding::meta_model::location& location();
    void location(const dogen::coding::meta_model::location& v);
    void location(const dogen::coding::meta_model::location&& v);
    /**@}*/
...
private:
    ...
    std::string simple_;
    dogen::coding::meta_model::location location_;
};
...
template<>
inline void swap(
    dogen::coding::meta_model::name& lhs,
    dogen::coding::meta_model::name& rhs) {
    lhs.swap(rhs);
}
