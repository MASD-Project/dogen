 ...
 *
 */
#ifndef DOGEN_CODING_TYPES_META_MODEL_MAPPING_ELEMENT_REPOSITORY_HPP
#define DOGEN_CODING_TYPES_META_MODEL_MAPPING_ELEMENT_REPOSITORY_HPP
...
template<>
inline void swap(
    dogen::coding::meta_model::mapping::element_repository& lhs,
    dogen::coding::meta_model::mapping::element_repository& rhs) {
    lhs.swap(rhs);
}
