 ...
 *
 */
#ifndef DOGEN_CODING_TYPES_META_MODEL_LOCATION_HPP
#define DOGEN_CODING_TYPES_META_MODEL_LOCATION_HPP
...
public:
     ...
     * dogen::coding. In this case, @e dogen is the external module.
     */
    /**@{*/
...
template<>
inline void swap(
    dogen::coding::meta_model::location& lhs,
    dogen::coding::meta_model::location& rhs) {
    lhs.swap(rhs);
}
