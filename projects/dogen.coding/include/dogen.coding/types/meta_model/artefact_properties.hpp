 ...
 *
 */
#ifndef DOGEN_CODING_TYPES_META_MODEL_ARTEFACT_PROPERTIES_HPP
#define DOGEN_CODING_TYPES_META_MODEL_ARTEFACT_PROPERTIES_HPP
...
public:
    artefact_properties(
        ...
        const dogen::coding::meta_model::formatting_styles formatting_style,
...
public:
    ...
    dogen::coding::meta_model::formatting_styles formatting_style() const;
    void formatting_style(const dogen::coding::meta_model::formatting_styles v);
...
private:
    ...
    dogen::coding::meta_model::formatting_styles formatting_style_;
...
template<>
inline void swap(
    dogen::coding::meta_model::artefact_properties& lhs,
    dogen::coding::meta_model::artefact_properties& rhs) {
    lhs.swap(rhs);
}
