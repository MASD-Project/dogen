 ...
 *
 */
#ifndef DOGEN_CODING_TYPES_META_MODEL_EXTRACTION_PROPERTIES_HPP
#define DOGEN_CODING_TYPES_META_MODEL_EXTRACTION_PROPERTIES_HPP
...
template<>
inline void swap(
    dogen::coding::meta_model::extraction_properties& lhs,
    dogen::coding::meta_model::extraction_properties& rhs) {
    lhs.swap(rhs);
}
