 ...
 *
 */
#ifndef DOGEN_CODING_TYPES_META_MODEL_FULLY_QUALIFIED_REPRESENTATION_HPP
#define DOGEN_CODING_TYPES_META_MODEL_FULLY_QUALIFIED_REPRESENTATION_HPP
...
template<>
inline void swap(
    dogen::coding::meta_model::fully_qualified_representation& lhs,
    dogen::coding::meta_model::fully_qualified_representation& rhs) {
    lhs.swap(rhs);
}
