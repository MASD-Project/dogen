 ...
 *
 */
#ifndef DOGEN_CODING_TYPES_META_MODEL_DECORATION_ELEMENT_PROPERTIES_HPP
#define DOGEN_CODING_TYPES_META_MODEL_DECORATION_ELEMENT_PROPERTIES_HPP
...
template<>
inline void swap(
    dogen::coding::meta_model::decoration::element_properties& lhs,
    dogen::coding::meta_model::decoration::element_properties& rhs) {
    lhs.swap(rhs);
}
