 ...
 *
 */
#ifndef DOGEN_CODING_TYPES_META_MODEL_DECORATION_LICENCE_HPP
#define DOGEN_CODING_TYPES_META_MODEL_DECORATION_LICENCE_HPP
 ...
 */
class licence final : public dogen::coding::meta_model::element {
public:
    licence() = default;
...
template<>
inline void swap(
    dogen::coding::meta_model::decoration::licence& lhs,
    dogen::coding::meta_model::decoration::licence& rhs) {
    lhs.swap(rhs);
}
