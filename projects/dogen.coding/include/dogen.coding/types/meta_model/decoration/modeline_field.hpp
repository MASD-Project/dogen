 ...
 *
 */
#ifndef DOGEN_CODING_TYPES_META_MODEL_DECORATION_MODELINE_FIELD_HPP
#define DOGEN_CODING_TYPES_META_MODEL_DECORATION_MODELINE_FIELD_HPP
...
template<>
inline void swap(
    dogen::coding::meta_model::decoration::modeline_field& lhs,
    dogen::coding::meta_model::decoration::modeline_field& rhs) {
    lhs.swap(rhs);
}
