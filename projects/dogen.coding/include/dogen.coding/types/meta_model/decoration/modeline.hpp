 ...
 *
 */
#ifndef DOGEN_CODING_TYPES_META_MODEL_DECORATION_MODELINE_HPP
#define DOGEN_CODING_TYPES_META_MODEL_DECORATION_MODELINE_HPP
 ...
 * separator is @e ;.
 */
class modeline final : public dogen::coding::meta_model::element {
public:
...
public:
     ...
     */
    /**@{*/
    dogen::coding::meta_model::decoration::editor editor() const;
    void editor(const dogen::coding::meta_model::decoration::editor v);
    /**@}*/
     ...
     */
    /**@{*/
    dogen::coding::meta_model::decoration::modeline_location location() const;
    void location(const dogen::coding::meta_model::decoration::modeline_location v);
    /**@}*/
     ...
     */
    /**@{*/
    const std::list<dogen::coding::meta_model::decoration::modeline_field>& fields() const;
    std::list<dogen::coding::meta_model::decoration::modeline_field>& fields();
    void fields(const std::list<dogen::coding::meta_model::decoration::modeline_field>& v);
    void fields(const std::list<dogen::coding::meta_model::decoration::modeline_field>&& v);
    /**@}*/
...
private:
    dogen::coding::meta_model::decoration::editor editor_;
    dogen::coding::meta_model::decoration::modeline_location location_;
    std::list<dogen::coding::meta_model::decoration::modeline_field> fields_;
...
template<>
inline void swap(
    dogen::coding::meta_model::decoration::modeline& lhs,
    dogen::coding::meta_model::decoration::modeline& rhs) {
    lhs.swap(rhs);
}
