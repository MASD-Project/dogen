 ...
 *
 */
#ifndef DOGEN_CODING_TYPES_META_MODEL_DECORATION_MODELINE_GROUP_HPP
#define DOGEN_CODING_TYPES_META_MODEL_DECORATION_MODELINE_GROUP_HPP
 ...
 * @e vi, etc.
 */
class modeline_group final : public dogen::coding::meta_model::element {
public:
...
public:
     ...
     */
    /**@{*/
    const std::list<boost::shared_ptr<dogen::coding::meta_model::decoration::modeline> >& modelines() const;
    std::list<boost::shared_ptr<dogen::coding::meta_model::decoration::modeline> >& modelines();
    void modelines(const std::list<boost::shared_ptr<dogen::coding::meta_model::decoration::modeline> >& v);
    void modelines(const std::list<boost::shared_ptr<dogen::coding::meta_model::decoration::modeline> >&& v);
    /**@}*/
...
private:
    ...
    std::list<boost::shared_ptr<dogen::coding::meta_model::decoration::modeline> > modelines_;
};
...
template<>
inline void swap(
    dogen::coding::meta_model::decoration::modeline_group& lhs,
    dogen::coding::meta_model::decoration::modeline_group& rhs) {
    lhs.swap(rhs);
}
