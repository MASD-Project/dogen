 ...
 *
 */
#ifndef DOGEN_CODING_TYPES_META_MODEL_DECORATION_GENERATION_MARKER_HPP
#define DOGEN_CODING_TYPES_META_MODEL_DECORATION_GENERATION_MARKER_HPP
 ...
 */
class generation_marker final : public dogen::coding::meta_model::element {
public:
...
template<>
inline void swap(
    dogen::coding::meta_model::decoration::generation_marker& lhs,
    dogen::coding::meta_model::decoration::generation_marker& rhs) {
    lhs.swap(rhs);
}
