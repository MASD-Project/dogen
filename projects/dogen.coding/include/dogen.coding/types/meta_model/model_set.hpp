 ...
 *
 */
#ifndef DOGEN_CODING_TYPES_META_MODEL_MODEL_SET_HPP
#define DOGEN_CODING_TYPES_META_MODEL_MODEL_SET_HPP
...
public:
    ...
    dogen::coding::meta_model::model& target();
    void target(const dogen::coding::meta_model::model& v);
    void target(const dogen::coding::meta_model::model&& v);

    const std::list<dogen::coding::meta_model::model>& references() const;
...
template<>
inline void swap(
    dogen::coding::meta_model::model_set& lhs,
    dogen::coding::meta_model::model_set& rhs) {
    lhs.swap(rhs);
}
