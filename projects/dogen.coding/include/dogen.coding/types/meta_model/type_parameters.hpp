 ...
 *
 */
#ifndef DOGEN_CODING_TYPES_META_MODEL_TYPE_PARAMETERS_HPP
#define DOGEN_CODING_TYPES_META_MODEL_TYPE_PARAMETERS_HPP
...
template<>
inline void swap(
    dogen::coding::meta_model::type_parameters& lhs,
    dogen::coding::meta_model::type_parameters& rhs) {
    lhs.swap(rhs);
}
