 ...
 *
 */
#ifndef DOGEN_CODING_TYPES_META_MODEL_ORM_OBJECT_PROPERTIES_HPP
#define DOGEN_CODING_TYPES_META_MODEL_ORM_OBJECT_PROPERTIES_HPP
...
template<>
inline void swap(
    dogen::coding::meta_model::orm::object_properties& lhs,
    dogen::coding::meta_model::orm::object_properties& rhs) {
    lhs.swap(rhs);
}
