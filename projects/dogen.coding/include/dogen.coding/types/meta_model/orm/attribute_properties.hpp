 ...
 *
 */
#ifndef DOGEN_CODING_TYPES_META_MODEL_ORM_ATTRIBUTE_PROPERTIES_HPP
#define DOGEN_CODING_TYPES_META_MODEL_ORM_ATTRIBUTE_PROPERTIES_HPP
...
public:
     ...
     */
    /**@{*/
    const std::unordered_map<dogen::coding::meta_model::orm::database_system, std::string>& type_overrides() const;
    std::unordered_map<dogen::coding::meta_model::orm::database_system, std::string>& type_overrides();
    void type_overrides(const std::unordered_map<dogen::coding::meta_model::orm::database_system, std::string>& v);
    void type_overrides(const std::unordered_map<dogen::coding::meta_model::orm::database_system, std::string>&& v);
    /**@}*/
...
private:
    ...
    std::unordered_map<dogen::coding::meta_model::orm::database_system, std::string> type_overrides_;
    bool is_composite_;
};
...
template<>
inline void swap(
    dogen::coding::meta_model::orm::attribute_properties& lhs,
    dogen::coding::meta_model::orm::attribute_properties& rhs) {
    lhs.swap(rhs);
}
