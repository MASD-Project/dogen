 ...
 *
 */
#ifndef DOGEN_CODING_TYPES_META_MODEL_ORM_MODULE_PROPERTIES_HPP
#define DOGEN_CODING_TYPES_META_MODEL_ORM_MODULE_PROPERTIES_HPP
...
template<>
inline void swap(
    dogen::coding::meta_model::orm::module_properties& lhs,
    dogen::coding::meta_model::orm::module_properties& rhs) {
    lhs.swap(rhs);
}
