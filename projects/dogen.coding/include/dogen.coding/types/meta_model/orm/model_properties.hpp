 ...
 *
 */
#ifndef DOGEN_CODING_TYPES_META_MODEL_ORM_MODEL_PROPERTIES_HPP
#define DOGEN_CODING_TYPES_META_MODEL_ORM_MODEL_PROPERTIES_HPP
...
public:
    ...
    const std::vector<dogen::coding::meta_model::orm::database_system>& database_systems() const;
    std::vector<dogen::coding::meta_model::orm::database_system>& database_systems();
    void database_systems(const std::vector<dogen::coding::meta_model::orm::database_system>& v);
    void database_systems(const std::vector<dogen::coding::meta_model::orm::database_system>&& v);
...
private:
    ...
    std::vector<dogen::coding::meta_model::orm::database_system> database_systems_;
};
...
template<>
inline void swap(
    dogen::coding::meta_model::orm::model_properties& lhs,
    dogen::coding::meta_model::orm::model_properties& rhs) {
    lhs.swap(rhs);
}
