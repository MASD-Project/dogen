 ...
 *
 */
#ifndef DOGEN_CODING_TYPES_META_MODEL_STRUCTURAL_EXCEPTION_HPP
#define DOGEN_CODING_TYPES_META_MODEL_STRUCTURAL_EXCEPTION_HPP
 ...
 */
class exception final : public dogen::coding::meta_model::element {
public:
    exception() = default;
...
template<>
inline void swap(
    dogen::coding::meta_model::structural::exception& lhs,
    dogen::coding::meta_model::structural::exception& rhs) {
    lhs.swap(rhs);
}
