 ...
 *
 */
#ifndef DOGEN_CODING_TYPES_META_MODEL_STRUCTURAL_MODULE_HPP
#define DOGEN_CODING_TYPES_META_MODEL_STRUCTURAL_MODULE_HPP
 ...
 */
class module final : public dogen::coding::meta_model::element {
public:
...
public:
    ...
    const boost::optional<dogen::coding::meta_model::orm::module_properties>& orm_properties() const;
    boost::optional<dogen::coding::meta_model::orm::module_properties>& orm_properties();
    void orm_properties(const boost::optional<dogen::coding::meta_model::orm::module_properties>& v);
    void orm_properties(const boost::optional<dogen::coding::meta_model::orm::module_properties>&& v);
...
private:
    ...
    boost::optional<dogen::coding::meta_model::orm::module_properties> orm_properties_;
};
...
template<>
inline void swap(
    dogen::coding::meta_model::structural::module& lhs,
    dogen::coding::meta_model::structural::module& rhs) {
    lhs.swap(rhs);
}
