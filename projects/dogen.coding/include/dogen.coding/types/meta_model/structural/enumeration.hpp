 ...
 *
 */
#ifndef DOGEN_CODING_TYPES_META_MODEL_STRUCTURAL_ENUMERATION_HPP
#define DOGEN_CODING_TYPES_META_MODEL_STRUCTURAL_ENUMERATION_HPP
 ...
 * or a string.
 */
class enumeration final : public dogen::coding::meta_model::element {
public:
...
public:
     ...
     */
    /**@{*/
    const std::vector<dogen::coding::meta_model::structural::enumerator>& enumerators() const;
    std::vector<dogen::coding::meta_model::structural::enumerator>& enumerators();
    void enumerators(const std::vector<dogen::coding::meta_model::structural::enumerator>& v);
    void enumerators(const std::vector<dogen::coding::meta_model::structural::enumerator>&& v);
    /**@}*/
...
private:
    ...
    std::vector<dogen::coding::meta_model::structural::enumerator> enumerators_;
...
template<>
inline void swap(
    dogen::coding::meta_model::structural::enumeration& lhs,
    dogen::coding::meta_model::structural::enumeration& rhs) {
    lhs.swap(rhs);
}
