 ...
 *
 */
#ifndef DOGEN_CODING_TYPES_META_MODEL_STRUCTURAL_OBJECT_TEMPLATE_HPP
#define DOGEN_CODING_TYPES_META_MODEL_STRUCTURAL_OBJECT_TEMPLATE_HPP
 ...
 */
class object_template final : public dogen::coding::meta_model::element {
public:
...
template<>
inline void swap(
    dogen::coding::meta_model::structural::object_template& lhs,
    dogen::coding::meta_model::structural::object_template& rhs) {
    lhs.swap(rhs);
}
