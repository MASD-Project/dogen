 ...
 *
 */
#ifndef DOGEN_CODING_TYPES_META_MODEL_STRUCTURAL_BUILTIN_HPP
#define DOGEN_CODING_TYPES_META_MODEL_STRUCTURAL_BUILTIN_HPP
 ...
 */
class builtin final : public dogen::coding::meta_model::element {
public:
...
template<>
inline void swap(
    dogen::coding::meta_model::structural::builtin& lhs,
    dogen::coding::meta_model::structural::builtin& rhs) {
    lhs.swap(rhs);
}
