 ...
 *
 */
#ifndef DOGEN_CODING_TYPES_HELPERS_INDICES_HPP
#define DOGEN_CODING_TYPES_HELPERS_INDICES_HPP
...
template<>
inline void swap(
    dogen::coding::helpers::indices& lhs,
    dogen::coding::helpers::indices& rhs) {
    lhs.swap(rhs);
}
