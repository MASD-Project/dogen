...
/*
#include "dogen.coding/types/name_builder.hpp"
#include "dogen.coding/types/name_factory.hpp"
#include "dogen.coding/types/model.hpp"
#include "dogen.coding/types/parsing_error.hpp"
#include "dogen.coding/io/name_tree_io.hpp"
#include "dogen.coding/io/name_io.hpp"
#include "dogen.coding/types/merging_error.hpp"
#include "dogen.coding/types/name_tree_parser.hpp"
#include "dogen.coding/types/merger.hpp"*/
...
const std::string test_module("dogen.coding.tests");
const std::string test_suite("name_tree_parser_tests");

const auto cpp(dogen::coding::meta_model::technical_space::cpp);

const auto top_level_modules = std::unordered_set<std::string>();
const auto model_location = dogen::coding::meta_model::location();
...
using dogen::coding::helpers::parsing_error;
...
/*
    dogen::coding::name_tree e;
    dogen::coding::name_factory nf;
    e.current(nf.build_element_name("type"));

    dogen::coding::name_tree c;
    c.current(nf.build_element_name("abc"));

    e.children(std::list<dogen::coding::name_tree> { c });

    const std::string s("type<abc>");
    dogen::coding::name_tree_parser ntp(top_level_modules, model_location, cpp);
