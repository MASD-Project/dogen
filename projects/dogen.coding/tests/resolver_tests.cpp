...
#include "dogen.coding/test/mock_model_factory.hpp"
...
using dogen::coding::test::mock_model_factory;
...
const auto idx = dogen::coding::helpers::indices();
...
using dogen::coding::helpers::resolution_error;
using dogen::coding::helpers::indexer;
using dogen::coding::helpers::resolver;
using dogen::coding::transforms::merge_transform;
using dogen::coding::meta_model::model;
...
BOOST_AUTO_TEST_CASE(object_with_attribute_type_in_the_same_model_resolves_successfully) {
    ...
    for (auto& pair : m.structural_elements().objects()) {
        ...
        if (o.local_attributes().size() == 1) {
            ...
            using dogen::coding::meta_model::fully_qualified_representation;
    ...
    using namespace dogen::coding::meta_model::structural;
