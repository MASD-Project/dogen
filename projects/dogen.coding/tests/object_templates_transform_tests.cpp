...
using dogen::coding::transforms::transformation_error;
using dogen::utility::test::asserter;
using dogen::coding::transforms::object_templates_transform;
using dogen::coding::meta_model::origin_types;
using object_types = dogen::coding::test::mock_model_factory::
    object_types;
using attribute_types = dogen::coding::test::mock_model_factory::
    attribute_types;
