...
using dogen::coding::meta_model::name_tree;
using dogen::coding::helpers::legacy_name_tree_parser;
using dogen::coding::helpers::name_factory;
...
name_tree make(const dogen::coding::meta_model::name& n) {
    name_tree r;
    r.current(n);
    return r;
}
