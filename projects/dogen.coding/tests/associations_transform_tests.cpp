...
using dogen::coding::transforms::associations_transform;
using object_types =
    dogen::coding::test::mock_model_factory::object_types;
using attribute_types =
    dogen::coding::test::mock_model_factory::attribute_types;
