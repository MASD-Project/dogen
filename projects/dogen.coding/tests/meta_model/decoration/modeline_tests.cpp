...
BOOST_AUTO_TEST_CASE(identical_objects_are_equal) {
    dogen::coding::meta_model::decoration::modeline_generator g;
    const auto a(g());
    const auto b(a);
...
BOOST_AUTO_TEST_CASE(moved_objects_are_equal) {
    ...
    g();
    auto a(g());
    const auto b = dogen::coding::meta_model::decoration::modeline();
    const auto c(a);
    BOOST_CHECK(a != b);
    BOOST_CHECK(a == c);
...
BOOST_AUTO_TEST_CASE(assigned_objects_are_equal) {
    ...
    g();
    const auto a(g());
    dogen::coding::meta_model::decoration::modeline b;
    BOOST_CHECK(a != b);
...
BOOST_AUTO_TEST_CASE(copy_constructed_objects_are_equal) {
    ...
    b = dogen::coding::meta_model::decoration::modeline();
    BOOST_CHECK(a != b);
}
