...
inline std::ostream& operator<<(std::ostream& s, const boost::shared_ptr<dogen::coding::helpers::mapping_set_repository>& v) {
    s << "{ " << "\"__type__\": " << "\"boost::shared_ptr\"" << ", "
      << "\"memory\": " << "\"" << static_cast<void*>(v.get()) << "\"" << ", ";
...
std::ostream& operator<<(std::ostream& s, const context& v) {
    s << " { "
      << "\"__type__\": " << "\"dogen::coding::transforms::context\"" << ", "
