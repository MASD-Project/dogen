...
inline std::ostream& operator<<(std::ostream& s, const std::unordered_map<dogen::coding::meta_model::orm::database_system, std::string>& v) {
    s << "[";
...
std::ostream& operator<<(std::ostream& s, const attribute_properties& v) {
    ...
    s << " { "
      << "\"__type__\": " << "\"dogen::coding::meta_model::orm::attribute_properties\"" << ", "
