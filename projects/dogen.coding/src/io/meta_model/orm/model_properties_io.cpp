...
inline std::ostream& operator<<(std::ostream& s, const std::vector<dogen::coding::meta_model::orm::database_system>& v) {
    s << "[ ";
...
std::ostream& operator<<(std::ostream& s, const model_properties& v) {
    s << " { "
      << "\"__type__\": " << "\"dogen::coding::meta_model::orm::model_properties\"" << ", "
