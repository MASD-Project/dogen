...
inline std::ostream& operator<<(std::ostream& s, const boost::optional<dogen::coding::meta_model::orm::attribute_properties>& v) {
...
std::ostream& operator<<(std::ostream& s, const attribute& v) {
    ...
    s << " { "
      << "\"__type__\": " << "\"dogen::coding::meta_model::attribute\"" << ", "
