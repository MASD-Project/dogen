...
inline std::ostream& operator<<(std::ostream& s, const std::unordered_map<dogen::coding::meta_model::technical_space, dogen::coding::helpers::mapping_value>& v) {
    s << "[";
...
std::ostream& operator<<(std::ostream& s, const mapping& v) {
    s << " { "
      << "\"__type__\": " << "\"dogen::coding::helpers::mapping\"" << ", "
