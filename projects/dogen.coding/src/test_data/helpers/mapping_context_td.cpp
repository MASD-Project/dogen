...
populate(const unsigned int position, result_type& v) {
    v.translations(create_std_unordered_map_std_string_dogen_coding_meta_model_name(position + 0));
    v.erasures(create_std_unordered_set_std_string(position + 1));
    v.injections(create_std_unordered_map_std_string_dogen_coding_meta_model_name(position + 2));
}
