...
dogen::coding::meta_model::model
create_dogen_coding_meta_model_model(const unsigned int position) {
    return dogen::coding::meta_model::model_generator::create(position);
}

std::list<dogen::coding::meta_model::model> create_std_list_dogen_coding_meta_model_model(unsigned int position) {
    std::list<dogen::coding::meta_model::model> r;
    for (unsigned int i(0); i < 4; ++i) {
        r.push_back(create_dogen_coding_meta_model_model(position + i));
    }
    return r;
}
