...
dogen::coding::meta_model::variability::feature_template
create_dogen_coding_meta_model_variability_feature_template(const unsigned int position) {
    return dogen::coding::meta_model::variability::feature_template_generator::create(position);
}

std::list<dogen::coding::meta_model::variability::feature_template> create_std_list_dogen_coding_meta_model_variability_feature_template(unsigned int position) {
    std::list<dogen::coding::meta_model::variability::feature_template> r;
    for (unsigned int i(0); i < 4; ++i) {
        r.push_back(create_dogen_coding_meta_model_variability_feature_template(position + i));
    }
    return r;
}
