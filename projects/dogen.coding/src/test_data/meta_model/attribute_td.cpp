...
dogen::coding::meta_model::orm::attribute_properties
create_dogen_coding_meta_model_orm_attribute_properties(const unsigned int position) {
    return dogen::coding::meta_model::orm::attribute_properties_generator::create(position);
}

boost::optional<dogen::coding::meta_model::orm::attribute_properties>
create_boost_optional_dogen_coding_meta_model_orm_attribute_properties(unsigned int position) {
    boost::optional<dogen::coding::meta_model::orm::attribute_properties> r(
        create_dogen_coding_meta_model_orm_attribute_properties(position));
    return r;
}
