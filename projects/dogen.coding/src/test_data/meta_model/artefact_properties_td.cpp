...
dogen::coding::meta_model::formatting_styles
create_dogen_coding_meta_model_formatting_styles(const unsigned int position) {
    return dogen::coding::meta_model::formatting_styles_generator::create(position);
}
