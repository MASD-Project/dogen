...
create_dogen_coding_meta_model_name_tree(const unsigned int) {
    return dogen::coding::meta_model::name_tree();
}
...
populate(const unsigned int position, result_type& v) {
    ...
    v.current(create_dogen_coding_meta_model_name(position + 1));
    v.children(create_std_list_dogen_coding_meta_model_name_tree(position + 2));
