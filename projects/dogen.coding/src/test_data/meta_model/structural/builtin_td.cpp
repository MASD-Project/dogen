...
builtin_generator::create(const unsigned int position) {
    builtin r;
    builtin_generator::populate(position, r);
    return r;
}

builtin_generator::result_type*
builtin_generator::create_ptr(const unsigned int position) {
    builtin* p = new builtin();
    builtin_generator::populate(position, *p);
    return p;
}

builtin_generator::result_type
builtin_generator::operator()() {
