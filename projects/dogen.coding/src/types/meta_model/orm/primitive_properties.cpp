...
const boost::optional<dogen::coding::meta_model::orm::letter_case>& primitive_properties::letter_case() const {
    return letter_case_;
}

boost::optional<dogen::coding::meta_model::orm::letter_case>& primitive_properties::letter_case() {
    return letter_case_;
}

void primitive_properties::letter_case(const boost::optional<dogen::coding::meta_model::orm::letter_case>& v) {
    letter_case_ = v;
}
