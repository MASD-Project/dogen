...
const boost::optional<dogen::coding::meta_model::orm::letter_case>& object_properties::letter_case() const {
    return letter_case_;
}

boost::optional<dogen::coding::meta_model::orm::letter_case>& object_properties::letter_case() {
    return letter_case_;
}

void object_properties::letter_case(const boost::optional<dogen::coding::meta_model::orm::letter_case>& v) {
    letter_case_ = v;
}
