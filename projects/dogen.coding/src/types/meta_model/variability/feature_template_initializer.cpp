...
void feature_template_initializer::to_stream(std::ostream& s) const {
    s << " { "
      << "\"__type__\": " << "\"dogen::coding::meta_model::variability::feature_template_initializer\"" << ", "
      << "\"__parent_0__\": ";
...
bool feature_template_initializer::equals(const dogen::coding::meta_model::element& other) const {
...
const std::list<dogen::coding::meta_model::name>& feature_template_initializer::bundles() const {
    return bundles_;
}

std::list<dogen::coding::meta_model::name>& feature_template_initializer::bundles() {
    return bundles_;
}

void feature_template_initializer::bundles(const std::list<dogen::coding::meta_model::name>& v) {
    bundles_ = v;
}
