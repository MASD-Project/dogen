...
const dogen::coding::meta_model::name& profile_template_entry::name() const {
    return name_;
}

dogen::coding::meta_model::name& profile_template_entry::name() {
    return name_;
}

void profile_template_entry::name(const dogen::coding::meta_model::name& v) {
    name_ = v;
}
