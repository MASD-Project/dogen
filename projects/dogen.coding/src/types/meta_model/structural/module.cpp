...
inline std::ostream& operator<<(std::ostream& s, const boost::optional<dogen::coding::meta_model::orm::module_properties>& v) {
...
module::module(
    ...
    const boost::optional<dogen::coding::meta_model::orm::module_properties>& orm_properties)
    : dogen::coding::meta_model::element(
      name,
      documentation,
      origin_type,
...
void module::to_stream(std::ostream& s) const {
    ...
    s << " { "
      << "\"__type__\": " << "\"dogen::coding::meta_model::structural::module\"" << ", "
      << "\"__parent_0__\": ";
...
bool module::equals(const dogen::coding::meta_model::element& other) const {
...
const boost::optional<dogen::coding::meta_model::orm::module_properties>& module::orm_properties() const {
    return orm_properties_;
}

boost::optional<dogen::coding::meta_model::orm::module_properties>& module::orm_properties() {
    return orm_properties_;
}

void module::orm_properties(const boost::optional<dogen::coding::meta_model::orm::module_properties>& v) {
    orm_properties_ = v;
}
