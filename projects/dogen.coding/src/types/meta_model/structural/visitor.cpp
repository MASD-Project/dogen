...
void visitor::to_stream(std::ostream& s) const {
    s << " { "
      << "\"__type__\": " << "\"dogen::coding::meta_model::structural::visitor\"" << ", "
      << "\"__parent_0__\": ";
...
bool visitor::equals(const dogen::coding::meta_model::element& other) const {
...
const std::list<dogen::coding::meta_model::name>& visitor::visits() const {
    return visits_;
}

std::list<dogen::coding::meta_model::name>& visitor::visits() {
    return visits_;
}

void visitor::visits(const std::list<dogen::coding::meta_model::name>& v) {
    visits_ = v;
}
...
const boost::optional<dogen::coding::meta_model::name>& visitor::parent() const {
    return parent_;
}

boost::optional<dogen::coding::meta_model::name>& visitor::parent() {
    return parent_;
}

void visitor::parent(const boost::optional<dogen::coding::meta_model::name>& v) {
    parent_ = v;
}
