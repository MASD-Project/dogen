...
inline std::ostream& operator<<(std::ostream& s, const std::vector<dogen::coding::meta_model::structural::enumerator>& v) {
    s << "[ ";
...
enumeration::enumeration(
    ...
    const std::vector<dogen::coding::meta_model::structural::enumerator>& enumerators,
...
void enumeration::to_stream(std::ostream& s) const {
    ...
    s << " { "
      << "\"__type__\": " << "\"dogen::coding::meta_model::structural::enumeration\"" << ", "
      << "\"__parent_0__\": ";
...
bool enumeration::equals(const dogen::coding::meta_model::element& other) const {
...
const dogen::coding::meta_model::name& enumeration::underlying_element() const {
    return underlying_element_;
}

dogen::coding::meta_model::name& enumeration::underlying_element() {
    return underlying_element_;
}

void enumeration::underlying_element(const dogen::coding::meta_model::name& v) {
...
const std::vector<dogen::coding::meta_model::structural::enumerator>& enumeration::enumerators() const {
    return enumerators_;
}

std::vector<dogen::coding::meta_model::structural::enumerator>& enumeration::enumerators() {
    return enumerators_;
}

void enumeration::enumerators(const std::vector<dogen::coding::meta_model::structural::enumerator>& v) {
    enumerators_ = v;
}
