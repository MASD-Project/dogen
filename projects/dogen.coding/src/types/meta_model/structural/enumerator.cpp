...
const dogen::coding::meta_model::name& enumerator::name() const {
    return name_;
}

dogen::coding::meta_model::name& enumerator::name() {
    return name_;
}

void enumerator::name(const dogen::coding::meta_model::name& v) {
    name_ = v;
}
...
const std::list<dogen::coding::meta_model::static_stereotypes>& enumerator::static_stereotypes() const {
    return static_stereotypes_;
}

std::list<dogen::coding::meta_model::static_stereotypes>& enumerator::static_stereotypes() {
    return static_stereotypes_;
}

void enumerator::static_stereotypes(const std::list<dogen::coding::meta_model::static_stereotypes>& v) {
