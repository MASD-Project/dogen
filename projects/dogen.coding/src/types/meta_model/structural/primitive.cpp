...
inline std::ostream& operator<<(std::ostream& s, const boost::optional<dogen::coding::meta_model::orm::primitive_properties>& v) {
...
primitive::primitive(
    ...
    const dogen::coding::meta_model::attribute& value_attribute,
    const bool use_type_aliasing,
    const bool is_immutable,
    const boost::optional<dogen::coding::meta_model::orm::primitive_properties>& orm_properties)
    : dogen::coding::meta_model::element(
      name,
      documentation,
      origin_type,
...
void primitive::to_stream(std::ostream& s) const {
    ...
    s << " { "
      << "\"__type__\": " << "\"dogen::coding::meta_model::structural::primitive\"" << ", "
      << "\"__parent_0__\": ";
...
bool primitive::equals(const dogen::coding::meta_model::element& other) const {
...
const dogen::coding::meta_model::attribute& primitive::value_attribute() const {
    return value_attribute_;
}

dogen::coding::meta_model::attribute& primitive::value_attribute() {
    return value_attribute_;
}

void primitive::value_attribute(const dogen::coding::meta_model::attribute& v) {
    value_attribute_ = v;
}
...
const boost::optional<dogen::coding::meta_model::orm::primitive_properties>& primitive::orm_properties() const {
    return orm_properties_;
}

boost::optional<dogen::coding::meta_model::orm::primitive_properties>& primitive::orm_properties() {
    return orm_properties_;
}

void primitive::orm_properties(const boost::optional<dogen::coding::meta_model::orm::primitive_properties>& v) {
    orm_properties_ = v;
}
