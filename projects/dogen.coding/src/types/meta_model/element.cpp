...
#include "dogen.coding/io/meta_model/artefact_properties_io.hpp"
#include "dogen.coding/io/meta_model/decoration/element_properties_io.hpp"
#include "dogen.coding/io/meta_model/local_archetype_location_properties_io.hpp"
...
inline std::ostream& operator<<(std::ostream& s, const std::unordered_map<std::string, dogen::coding::meta_model::artefact_properties>& v) {
    s << "[";
    for (auto i(v.begin()); i != v.end(); ++i) {
        if (i != v.begin()) s << ", ";
        s << "[ { " << "\"__type__\": " << "\"key\"" << ", " << "\"data\": ";
...
inline std::ostream& operator<<(std::ostream& s, const std::unordered_map<std::string, dogen::coding::meta_model::local_archetype_location_properties>& v) {
    s << "[";
    for (auto i(v.begin()); i != v.end(); ++i) {
        if (i != v.begin()) s << ", ";
        s << "[ { " << "\"__type__\": " << "\"key\"" << ", " << "\"data\": ";
...
inline std::ostream& operator<<(std::ostream& s, const boost::optional<dogen::coding::meta_model::decoration::element_properties>& v) {
...
element::element()
    : origin_type_(static_cast<dogen::coding::meta_model::origin_types>(0)),
      ...
      intrinsic_technical_space_(static_cast<dogen::coding::meta_model::technical_space>(0)),
...
void element::to_stream(std::ostream& s) const {
    ...
    s << " { "
      << "\"__type__\": " << "\"dogen::coding::meta_model::element\"" << ", "
      << "\"name\": " << name_ << ", "
...
const dogen::coding::meta_model::name& element::name() const {
    return name_;
}

dogen::coding::meta_model::name& element::name() {
    return name_;
}

void element::name(const dogen::coding::meta_model::name& v) {
    name_ = v;
}
...
dogen::coding::meta_model::origin_types element::origin_type() const {
    return origin_type_;
}

void element::origin_type(const dogen::coding::meta_model::origin_types v) {
    origin_type_ = v;
}
...
const std::list<dogen::coding::meta_model::static_stereotypes>& element::static_stereotypes() const {
    return static_stereotypes_;
}

std::list<dogen::coding::meta_model::static_stereotypes>& element::static_stereotypes() {
    return static_stereotypes_;
}

void element::static_stereotypes(const std::list<dogen::coding::meta_model::static_stereotypes>& v) {
...
const dogen::coding::meta_model::name& element::meta_name() const {
    return meta_name_;
}

dogen::coding::meta_model::name& element::meta_name() {
    return meta_name_;
}

void element::meta_name(const dogen::coding::meta_model::name& v) {
    meta_name_ = v;
}
...
dogen::coding::meta_model::technical_space element::intrinsic_technical_space() const {
    return intrinsic_technical_space_;
}

void element::intrinsic_technical_space(const dogen::coding::meta_model::technical_space v) {
...
const std::unordered_map<std::string, dogen::coding::meta_model::artefact_properties>& element::artefact_properties() const {
    return artefact_properties_;
}

std::unordered_map<std::string, dogen::coding::meta_model::artefact_properties>& element::artefact_properties() {
    return artefact_properties_;
}

void element::artefact_properties(const std::unordered_map<std::string, dogen::coding::meta_model::artefact_properties>& v) {
...
const std::unordered_map<std::string, dogen::coding::meta_model::local_archetype_location_properties>& element::archetype_location_properties() const {
    return archetype_location_properties_;
}

std::unordered_map<std::string, dogen::coding::meta_model::local_archetype_location_properties>& element::archetype_location_properties() {
    return archetype_location_properties_;
}

void element::archetype_location_properties(const std::unordered_map<std::string, dogen::coding::meta_model::local_archetype_location_properties>& v) {
...
const boost::optional<dogen::coding::meta_model::decoration::element_properties>& element::decoration() const {
    return decoration_;
}

boost::optional<dogen::coding::meta_model::decoration::element_properties>& element::decoration() {
    return decoration_;
}

void element::decoration(const boost::optional<dogen::coding::meta_model::decoration::element_properties>& v) {
    decoration_ = v;
}
