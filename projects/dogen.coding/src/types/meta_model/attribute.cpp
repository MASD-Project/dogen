...
attribute::attribute(
    ...
    const dogen::coding::meta_model::name_tree& parsed_type,
    const bool is_immutable,
    const bool is_fluent,
    const boost::optional<dogen::coding::meta_model::orm::attribute_properties>& orm_properties)
...
const dogen::coding::meta_model::name& attribute::name() const {
    return name_;
}

dogen::coding::meta_model::name& attribute::name() {
    return name_;
}

void attribute::name(const dogen::coding::meta_model::name& v) {
    name_ = v;
}
...
const std::list<dogen::coding::meta_model::static_stereotypes>& attribute::static_stereotypes() const {
    return static_stereotypes_;
}

std::list<dogen::coding::meta_model::static_stereotypes>& attribute::static_stereotypes() {
    return static_stereotypes_;
}

void attribute::static_stereotypes(const std::list<dogen::coding::meta_model::static_stereotypes>& v) {
...
const dogen::coding::meta_model::name_tree& attribute::parsed_type() const {
    return parsed_type_;
}

dogen::coding::meta_model::name_tree& attribute::parsed_type() {
    return parsed_type_;
}

void attribute::parsed_type(const dogen::coding::meta_model::name_tree& v) {
    parsed_type_ = v;
}
...
const boost::optional<dogen::coding::meta_model::orm::attribute_properties>& attribute::orm_properties() const {
    return orm_properties_;
}

boost::optional<dogen::coding::meta_model::orm::attribute_properties>& attribute::orm_properties() {
    return orm_properties_;
}

void attribute::orm_properties(const boost::optional<dogen::coding::meta_model::orm::attribute_properties>& v) {
    orm_properties_ = v;
}
