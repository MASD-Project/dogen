...
model::model()
    : origin_type_(static_cast<dogen::coding::meta_model::origin_types>(0)),
      input_technical_space_(static_cast<dogen::coding::meta_model::technical_space>(0)) { }
...
const dogen::coding::meta_model::name& model::name() const {
    return name_;
}

dogen::coding::meta_model::name& model::name() {
    return name_;
}

void model::name(const dogen::coding::meta_model::name& v) {
    name_ = v;
}
...
const dogen::coding::meta_model::name& model::meta_name() const {
    return meta_name_;
}

dogen::coding::meta_model::name& model::meta_name() {
    return meta_name_;
}

void model::meta_name(const dogen::coding::meta_model::name& v) {
    meta_name_ = v;
}
...
dogen::coding::meta_model::origin_types model::origin_type() const {
    return origin_type_;
}

void model::origin_type(const dogen::coding::meta_model::origin_types v) {
    origin_type_ = v;
}

const std::unordered_map<dogen::coding::meta_model::name, dogen::coding::meta_model::origin_types>& model::references() const {
    return references_;
}

std::unordered_map<dogen::coding::meta_model::name, dogen::coding::meta_model::origin_types>& model::references() {
    return references_;
}

void model::references(const std::unordered_map<dogen::coding::meta_model::name, dogen::coding::meta_model::origin_types>& v) {
    references_ = v;
}
...
const std::unordered_set<dogen::coding::meta_model::name>& model::leaves() const {
    return leaves_;
}

std::unordered_set<dogen::coding::meta_model::name>& model::leaves() {
    return leaves_;
}

void model::leaves(const std::unordered_set<dogen::coding::meta_model::name>& v) {
    leaves_ = v;
}
...
const boost::shared_ptr<dogen::coding::meta_model::structural::module>& model::root_module() const {
    return root_module_;
}

boost::shared_ptr<dogen::coding::meta_model::structural::module>& model::root_module() {
    return root_module_;
}

void model::root_module(const boost::shared_ptr<dogen::coding::meta_model::structural::module>& v) {
    root_module_ = v;
}
...
dogen::coding::meta_model::technical_space model::input_technical_space() const {
    return input_technical_space_;
}

void model::input_technical_space(const dogen::coding::meta_model::technical_space v) {
    input_technical_space_ = v;
}

const std::list<dogen::coding::meta_model::technical_space>& model::output_technical_spaces() const {
    return output_technical_spaces_;
}

std::list<dogen::coding::meta_model::technical_space>& model::output_technical_spaces() {
    return output_technical_spaces_;
}

void model::output_technical_spaces(const std::list<dogen::coding::meta_model::technical_space>& v) {
...
const boost::optional<dogen::coding::meta_model::orm::model_properties>& model::orm_properties() const {
    return orm_properties_;
}

boost::optional<dogen::coding::meta_model::orm::model_properties>& model::orm_properties() {
    return orm_properties_;
}

void model::orm_properties(const boost::optional<dogen::coding::meta_model::orm::model_properties>& v) {
    orm_properties_ = v;
}
...
const dogen::coding::meta_model::extraction_properties& model::extraction_properties() const {
    return extraction_properties_;
}

dogen::coding::meta_model::extraction_properties& model::extraction_properties() {
    return extraction_properties_;
}

void model::extraction_properties(const dogen::coding::meta_model::extraction_properties& v) {
...
const dogen::coding::meta_model::structural::element_repository& model::structural_elements() const {
    return structural_elements_;
}

dogen::coding::meta_model::structural::element_repository& model::structural_elements() {
    return structural_elements_;
}

void model::structural_elements(const dogen::coding::meta_model::structural::element_repository& v) {
...
const dogen::coding::meta_model::decoration::element_repository& model::decoration_elements() const {
    return decoration_elements_;
}

dogen::coding::meta_model::decoration::element_repository& model::decoration_elements() {
    return decoration_elements_;
}

void model::decoration_elements(const dogen::coding::meta_model::decoration::element_repository& v) {
...
const dogen::coding::meta_model::variability::element_repository& model::variability_elements() const {
    return variability_elements_;
}

dogen::coding::meta_model::variability::element_repository& model::variability_elements() {
    return variability_elements_;
}
