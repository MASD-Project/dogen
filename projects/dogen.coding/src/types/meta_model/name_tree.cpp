...
const dogen::coding::meta_model::fully_qualified_representation& name_tree::qualified() const {
    return qualified_;
}

dogen::coding::meta_model::fully_qualified_representation& name_tree::qualified() {
    return qualified_;
}

void name_tree::qualified(const dogen::coding::meta_model::fully_qualified_representation& v) {
    qualified_ = v;
}
...
const dogen::coding::meta_model::name& name_tree::current() const {
    return current_;
}

dogen::coding::meta_model::name& name_tree::current() {
    return current_;
}

void name_tree::current(const dogen::coding::meta_model::name& v) {
    current_ = v;
}
...
const std::list<dogen::coding::meta_model::name_tree>& name_tree::children() const {
    return children_;
}

std::list<dogen::coding::meta_model::name_tree>& name_tree::children() {
    return children_;
}

void name_tree::children(const std::list<dogen::coding::meta_model::name_tree>& v) {
    children_ = v;
}
