...
const std::unordered_map<dogen::coding::meta_model::technical_space, dogen::coding::helpers::mapping_value>& mapping::by_technical_space() const {
    return by_technical_space_;
}

std::unordered_map<dogen::coding::meta_model::technical_space, dogen::coding::helpers::mapping_value>& mapping::by_technical_space() {
    return by_technical_space_;
}

void mapping::by_technical_space(const std::unordered_map<dogen::coding::meta_model::technical_space, dogen::coding::helpers::mapping_value>& v) {
