...
inline bool operator==(const boost::shared_ptr<dogen::coding::helpers::mapping_set_repository>& lhs,
const boost::shared_ptr<dogen::coding::helpers::mapping_set_repository>& rhs) {
    return (!lhs && !rhs) ||(lhs && rhs && (*lhs == *rhs));
}
...
const boost::shared_ptr<dogen::coding::helpers::mapping_set_repository>& context::mapping_repository() const {
    return mapping_repository_;
}

boost::shared_ptr<dogen::coding::helpers::mapping_set_repository>& context::mapping_repository() {
    return mapping_repository_;
}

void context::mapping_repository(const boost::shared_ptr<dogen::coding::helpers::mapping_set_repository>& v) {
