...
#include "dogen.physical/lexical_cast/entities/operation_type_lc.hpp"
...
BOOST_AUTO_TEST_CASE(inserter_operator_produces_valid_json) {
    dogen::physical::entities::operation_type_generator g;
    const auto a(g());
    std::stringstream s;
    s << a;
...
BOOST_AUTO_TEST_CASE(xml_roundtrip_produces_the_same_entity) {
    ...
    dogen::physical::entities::operation_type b = dogen::physical::entities::operation_type();
...
BOOST_AUTO_TEST_CASE(equal_enums_generate_the_same_hash) {
    ...
    std::hash<dogen::physical::entities::operation_type> hasher;
