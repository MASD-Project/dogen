...
#include "dogen.physical/hash/helpers/files_by_status_hash.hpp"
...
BOOST_AUTO_TEST_CASE(identical_objects_are_equal) {
    dogen::physical::helpers::files_by_status_generator g;
    const auto a(g());
    const auto b(a);
...
BOOST_AUTO_TEST_CASE(moved_objects_are_equal) {
    ...
    g();
    auto a(g());
    const auto b = dogen::physical::helpers::files_by_status();
    const auto c(a);
    BOOST_CHECK(a != b);
    BOOST_CHECK(a == c);
...
BOOST_AUTO_TEST_CASE(assigned_objects_are_equal) {
    ...
    g();
    const auto a(g());
    dogen::physical::helpers::files_by_status b;
    BOOST_CHECK(a != b);
...
BOOST_AUTO_TEST_CASE(copy_constructed_objects_are_equal) {
    ...
    b = dogen::physical::helpers::files_by_status();
    BOOST_CHECK(a != b);
}
...
BOOST_AUTO_TEST_CASE(xml_roundtrip_produces_the_same_entity) {
    ...
    dogen::physical::helpers::files_by_status b = dogen::physical::helpers::files_by_status();
...
BOOST_AUTO_TEST_CASE(equal_objects_generate_the_same_hash) {
    ...
    std::hash<dogen::physical::helpers::files_by_status> hasher;
