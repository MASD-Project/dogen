...
#include "dogen.physical/types/helpers/name_repository_parts_builder.hpp"

namespace {

using namespace dogen::utility::log;
static logger
lg(logger_factory("physical.helpers.name_repository_parts_builder"));
...
void name_repository_parts_builder::validate(const std::string& meta_name,
    const std::string& family, const std::string& intra_backend_segment,
    const entities::location& al) {
...
void name_repository_parts_builder::add(const std::string& meta_name,
    const std::string& family, const std::string& intra_backend_segment,
...
entities::name_repository_parts name_repository_parts_builder::build() {
    return parts_;
}
