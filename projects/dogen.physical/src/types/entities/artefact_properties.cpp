...
dogen::physical::entities::formatting_styles artefact_properties::formatting_style() const {
    return formatting_style_;
}

void artefact_properties::formatting_style(const dogen::physical::entities::formatting_styles v) {
    formatting_style_ = v;
}
