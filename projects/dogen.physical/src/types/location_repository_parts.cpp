...
const std::list<dogen::physical::location>& location_repository_parts::all() const {
    return all_;
}

std::list<dogen::physical::location>& location_repository_parts::all() {
    return all_;
}

void location_repository_parts::all(const std::list<dogen::physical::location>& v) {
    all_ = v;
}
...
const std::unordered_map<std::string, dogen::physical::locations_group>& location_repository_parts::by_meta_name() const {
    return by_meta_name_;
}

std::unordered_map<std::string, dogen::physical::locations_group>& location_repository_parts::by_meta_name() {
    return by_meta_name_;
}

void location_repository_parts::by_meta_name(const std::unordered_map<std::string, dogen::physical::locations_group>& v) {
    by_meta_name_ = v;
}
...
const std::unordered_map<std::string, std::list<dogen::physical::location> >& location_repository_parts::by_family() const {
    return by_family_;
}

std::unordered_map<std::string, std::list<dogen::physical::location> >& location_repository_parts::by_family() {
    return by_family_;
}

void location_repository_parts::by_family(const std::unordered_map<std::string, std::list<dogen::physical::location> >& v) {
    by_family_ = v;
}
...
const std::unordered_map<std::string, std::list<dogen::physical::location> >& location_repository_parts::by_intra_backend_segment() const {
    return by_intra_backend_segment_;
}

std::unordered_map<std::string, std::list<dogen::physical::location> >& location_repository_parts::by_intra_backend_segment() {
    return by_intra_backend_segment_;
}

void location_repository_parts::by_intra_backend_segment(const std::unordered_map<std::string, std::list<dogen::physical::location> >& v) {
