 ...
 *
 */
#ifndef DOGEN_PHYSICAL_TYPES_FEATURES_BACKEND_FEATURES_HPP
#define DOGEN_PHYSICAL_TYPES_FEATURES_BACKEND_FEATURES_HPP
...
/**
 * @brief Physical features common to all backends.
 */
class backend_features final {
public:
