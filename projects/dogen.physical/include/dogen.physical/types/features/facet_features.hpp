 ...
 *
 */
#ifndef DOGEN_PHYSICAL_TYPES_FEATURES_FACET_FEATURES_HPP
#define DOGEN_PHYSICAL_TYPES_FEATURES_FACET_FEATURES_HPP
...
/**
 * @brief Physical features common to all facets.
 */
