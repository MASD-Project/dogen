...
#include "dogen.physical/serialization/entities/variable_relation_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::physical::entities::variable_relation& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::physical::entities::variable_relation& v, unsigned int version);
