...
#include "dogen.physical/serialization/entities/archetype_properties_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::physical::entities::archetype_properties& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::physical::entities::archetype_properties& v, unsigned int version);
