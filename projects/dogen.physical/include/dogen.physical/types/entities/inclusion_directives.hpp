...
#include <string>
#include <algorithm>
#include "dogen.physical/serialization/entities/inclusion_directives_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::physical::entities::inclusion_directives& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::physical::entities::inclusion_directives& v, unsigned int version);
