...
#include <string>
#include <algorithm>
#include "dogen.physical/serialization/entities/archetype_kind_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::physical::entities::archetype_kind& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::physical::entities::archetype_kind& v, unsigned int version);
