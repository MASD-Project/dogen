 ...
 *
 */
#ifndef DOGEN_PHYSICAL_TYPES_ENTITIES_ARTEFACT_PROPERTIES_HPP
#define DOGEN_PHYSICAL_TYPES_ENTITIES_ARTEFACT_PROPERTIES_HPP
...
template<>
inline void swap(
    dogen::physical::entities::artefact_properties& lhs,
    dogen::physical::entities::artefact_properties& rhs) {
    lhs.swap(rhs);
}
