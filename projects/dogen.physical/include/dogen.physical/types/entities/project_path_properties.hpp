...
#include "dogen.physical/serialization/entities/project_path_properties_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::physical::entities::project_path_properties& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::physical::entities::project_path_properties& v, unsigned int version);
