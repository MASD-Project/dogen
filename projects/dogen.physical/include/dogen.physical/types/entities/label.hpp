 ...
 *
 */
#ifndef DOGEN_PHYSICAL_TYPES_ENTITIES_LABEL_HPP
#define DOGEN_PHYSICAL_TYPES_ENTITIES_LABEL_HPP
...
template<>
inline void swap(
    dogen::physical::entities::label& lhs,
    dogen::physical::entities::label& rhs) {
    lhs.swap(rhs);
}
