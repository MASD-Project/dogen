 ...
 *
 */
#ifndef DOGEN_PHYSICAL_TYPES_LOCATION_REPOSITORY_PARTS_HPP
#define DOGEN_PHYSICAL_TYPES_LOCATION_REPOSITORY_PARTS_HPP
...
template<>
inline void swap(
    dogen::physical::location_repository_parts& lhs,
    dogen::physical::location_repository_parts& rhs) {
    lhs.swap(rhs);
}
