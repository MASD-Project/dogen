 ...
 *
 */
#ifndef DOGEN_PHYSICAL_LEXICAL_CAST_ENTITIES_OPERATION_TYPE_LC_HPP
#define DOGEN_PHYSICAL_LEXICAL_CAST_ENTITIES_OPERATION_TYPE_LC_HPP
...
template<>
inline std::string lexical_cast(const dogen::physical::entities::operation_type& v) {
...
template<>
inline dogen::physical::entities::operation_type lexical_cast(const std::string & s) {
    using dogen::physical::entities::operation_type;
