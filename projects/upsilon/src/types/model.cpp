...
const std::unordered_map<std::string, std::vector<dogen::upsilon::type_information> >& model::type_information() const {
    return type_information_;
}

std::unordered_map<std::string, std::vector<dogen::upsilon::type_information> >& model::type_information() {
    return type_information_;
}

void model::type_information(const std::unordered_map<std::string, std::vector<dogen::upsilon::type_information> >& v) {
    type_information_ = v;
}
