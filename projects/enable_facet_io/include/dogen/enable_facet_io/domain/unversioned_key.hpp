 ...
 *
 */
#ifndef DOGEN_ENABLE_FACET_IO_DOMAIN_UNVERSIONED_KEY_HPP
#define DOGEN_ENABLE_FACET_IO_DOMAIN_UNVERSIONED_KEY_HPP
...
template<>
inline void swap(
    dogen::enable_facet_io::unversioned_key& lhs,
    dogen::enable_facet_io::unversioned_key& rhs) {
    lhs.swap(rhs);
}
