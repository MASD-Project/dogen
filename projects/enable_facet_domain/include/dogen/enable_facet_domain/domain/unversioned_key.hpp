 ...
 *
 */
#ifndef DOGEN_ENABLE_FACET_DOMAIN_DOMAIN_UNVERSIONED_KEY_HPP
#define DOGEN_ENABLE_FACET_DOMAIN_DOMAIN_UNVERSIONED_KEY_HPP
...
template<>
inline void swap(
    dogen::enable_facet_domain::unversioned_key& lhs,
    dogen::enable_facet_domain::unversioned_key& rhs) {
    lhs.swap(rhs);
}
