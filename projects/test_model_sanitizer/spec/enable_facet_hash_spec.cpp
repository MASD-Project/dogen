...
#include "dogen/enable_facet_hash/domain/all.hpp"

namespace {

const std::string empty;
const std::string test_module("test_model_sanitizer");
const std::string test_suite("enable_facet_hash");

class first_class_generator {
public:
    typedef dogen::enable_facet_hash::package1::first_class result_type;
...
BOOST_AUTO_TEST_SUITE(enable_facet_hash)
