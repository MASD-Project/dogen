...
BOOST_AUTO_TEST_CASE(validate_equality) {
    ...
    // test_equality<parent_sequence>();
    // test_equality<child_sequence>();
...
BOOST_AUTO_TEST_CASE(validate_serialisation) {
    ...
    rountrip_type<parent_sequence>();
    rountrip_type<child_sequence>();
...
BOOST_AUTO_TEST_CASE(validate_hashing) {
    ...
    // test_hashing<parent_sequence>();
    // test_hashing<child_sequence>();
...
BOOST_AUTO_TEST_CASE(validate_swap) {
    SETUP_TEST_LOG("validate_hashing");
    test_swap<parent_sequence>();
    test_swap<child_sequence>();
