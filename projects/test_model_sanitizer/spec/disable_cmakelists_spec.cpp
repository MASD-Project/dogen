...
#include "dogen/disable_cmakelists/types/all.hpp"
...
const std::string test_suite("disable_cmakelists");

}

using namespace dogen::disable_cmakelists;
using namespace dogen::disable_cmakelists::package1;
