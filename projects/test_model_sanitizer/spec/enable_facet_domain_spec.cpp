...
const std::string test_suite("enable_facet_domain");

class first_class_generator {
public:
    typedef dogen::enable_facet_domain::package1::first_class result_type;
...
BOOST_AUTO_TEST_SUITE(enable_facet_domain)
