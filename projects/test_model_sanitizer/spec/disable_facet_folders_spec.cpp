...
const std::string test_suite("disable_facet_folders");

}

using namespace dogen::disable_facet_folders;
using namespace dogen::disable_facet_folders::package1;
using namespace dogen::utility::test;

BOOST_AUTO_TEST_SUITE(disable_facet_folders)
