...
const dogen::m2t::cpp::formattables::aspect_properties& element_properties::aspect_properties() const {
    return aspect_properties_;
}

dogen::m2t::cpp::formattables::aspect_properties& element_properties::aspect_properties() {
    return aspect_properties_;
}

void element_properties::aspect_properties(const dogen::m2t::cpp::formattables::aspect_properties& v) {
...
const std::unordered_map<std::string, dogen::m2t::cpp::formattables::artefact_properties>& element_properties::artefact_properties() const {
    return artefact_properties_;
}

std::unordered_map<std::string, dogen::m2t::cpp::formattables::artefact_properties>& element_properties::artefact_properties() {
    return artefact_properties_;
}

void element_properties::artefact_properties(const std::unordered_map<std::string, dogen::m2t::cpp::formattables::artefact_properties>& v) {
...
const std::list<dogen::m2t::cpp::formattables::helper_properties>& element_properties::helper_properties() const {
    return helper_properties_;
}

std::list<dogen::m2t::cpp::formattables::helper_properties>& element_properties::helper_properties() {
    return helper_properties_;
}

void element_properties::helper_properties(const std::list<dogen::m2t::cpp::formattables::helper_properties>& v) {
...
const std::unordered_map<std::string, dogen::m2t::cpp::formattables::test_data_properties>& element_properties::attribute_level_test_data_properties() const {
    return attribute_level_test_data_properties_;
}

std::unordered_map<std::string, dogen::m2t::cpp::formattables::test_data_properties>& element_properties::attribute_level_test_data_properties() {
    return attribute_level_test_data_properties_;
}

void element_properties::attribute_level_test_data_properties(const std::unordered_map<std::string, dogen::m2t::cpp::formattables::test_data_properties>& v) {
