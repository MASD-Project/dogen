 ...
 *
 */
#include "dogen.m2t.cpp/types/formattables/helper_configuration.hpp"
...
const std::unordered_map<std::string, dogen::m2t::cpp::formattables::streaming_properties>& helper_configuration::streaming_properties() const {
    return streaming_properties_;
}

std::unordered_map<std::string, dogen::m2t::cpp::formattables::streaming_properties>& helper_configuration::streaming_properties() {
    return streaming_properties_;
}

void helper_configuration::streaming_properties(const std::unordered_map<std::string, dogen::m2t::cpp::formattables::streaming_properties>& v) {
