...
const boost::optional<dogen::m2t::cpp::formattables::streaming_properties>& helper_descriptor::streaming_properties() const {
    return streaming_properties_;
}

boost::optional<dogen::m2t::cpp::formattables::streaming_properties>& helper_descriptor::streaming_properties() {
    return streaming_properties_;
}

void helper_descriptor::streaming_properties(const boost::optional<dogen::m2t::cpp::formattables::streaming_properties>& v) {
