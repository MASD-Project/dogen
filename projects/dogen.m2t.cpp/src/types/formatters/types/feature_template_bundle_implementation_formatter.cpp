...
const logical::entities::name& feature_template_bundle_implementation_formatter::meta_name() const {
...
physical::entities::artefact feature_template_bundle_implementation_formatter::
