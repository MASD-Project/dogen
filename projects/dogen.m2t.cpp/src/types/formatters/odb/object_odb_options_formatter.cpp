...
const logical::entities::name& object_odb_options_formatter::meta_name() const {
...
boost::filesystem::path object_odb_options_formatter::inclusion_path(
    ...
    static logger lg(logger_factory(
            "m2t.cpp.formatters.odb.object_odb_options_formatter"));
...
physical::entities::artefact object_odb_options_formatter::
