...
#include "dogen.m2t.cpp/types/transforms/types/feature_template_bundle_header_transform.hpp"

namespace dogen::m2t::cpp::transforms::types {

std::string feature_template_bundle_header_transform::static_id() {
    return traits::feature_template_bundle_header_archetype();
}

std::string feature_template_bundle_header_transform::id() const {
    return static_id();
}

physical::entities::location
feature_template_bundle_header_transform::archetype_location() const {
    static physical::entities::location
        r(cpp::traits::backend(), traits::facet(),
          feature_template_bundle_header_transform::static_id());
    return r;
}
...
std::string feature_template_bundle_header_transform::family() const {
