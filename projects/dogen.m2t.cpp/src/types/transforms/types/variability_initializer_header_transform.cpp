...
variability_initializer_header_transform::physical_meta_name() const {
...
const logical::entities::name& variability_initializer_header_transform::logical_meta_name() const {
    using logical::helpers::meta_name_factory;
    static auto r(meta_name_factory::make_variability_initializer_name());
    return r;
}

physical::entities::archetype variability_initializer_header_transform::archetype() const {
