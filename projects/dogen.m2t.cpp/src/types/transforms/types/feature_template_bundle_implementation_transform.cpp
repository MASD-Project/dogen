...
feature_template_bundle_implementation_transform::physical_meta_name() const {
...
const logical::entities::name& feature_template_bundle_implementation_transform::logical_meta_name() const {
