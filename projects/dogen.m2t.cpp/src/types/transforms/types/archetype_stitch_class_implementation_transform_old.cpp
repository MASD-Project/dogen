...
std::string archetype_stitch_class_implementation_transform_old::static_id() {
    return traits::archetype_stitch_archetype_qn();
}

std::string archetype_stitch_class_implementation_transform_old::id() const {
    return static_id();
}

physical::entities::meta_name
archetype_stitch_class_implementation_transform_old::physical_meta_name() const {
...
const logical::entities::name& archetype_stitch_class_implementation_transform_old::logical_meta_name() const {
...
ast.stream() << "std::string archetype_stitch_class_implementation_transform_old::static_id() {" << std::endl;
ast.stream() << "    return traits::archetype_stitch_archetype_qn();" << std::endl;
ast.stream() << "}" << std::endl;
ast.stream() << std::endl;
ast.stream() << "std::string archetype_stitch_class_implementation_transform_old::id() const {" << std::endl;
ast.stream() << "    return static_id();" << std::endl;
ast.stream() << "}" << std::endl;
ast.stream() << std::endl;
ast.stream() << "physical::entities::meta_name" << std::endl;
ast.stream() << "archetype_stitch_class_implementation_transform_old::physical_meta_name() const {" << std::endl;
...
ast.stream() << "}" << std::endl;
ast.stream() << std::endl;
ast.stream() << "const logical::entities::name& archetype_stitch_class_implementation_transform_old::logical_meta_name() const {" << std::endl;
