...
std::string feature_bundle_implementation_transform::static_id() {
    return traits::feature_bundle_implementation_archetype_qn();
}
...
feature_bundle_implementation_transform::physical_meta_name() const {
...
const logical::entities::name& feature_bundle_implementation_transform::logical_meta_name() const {
