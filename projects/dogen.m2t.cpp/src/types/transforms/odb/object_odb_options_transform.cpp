...
#include "dogen.m2t.cpp/types/transforms/odb/object_odb_options_transform.hpp"
...
object_odb_options_transform::physical_meta_name() const {
...
const logical::entities::name& object_odb_options_transform::logical_meta_name() const {
    using logical::helpers::meta_name_factory;
    static auto r(meta_name_factory::make_object_name());
    return r;
}

physical::entities::archetype object_odb_options_transform::archetype() const {
...
boost::filesystem::path object_odb_options_transform::inclusion_path(
    ...
    static logger lg(logger_factory(
            "m2t.cpp.transforms.odb.object_odb_options_transform"));
