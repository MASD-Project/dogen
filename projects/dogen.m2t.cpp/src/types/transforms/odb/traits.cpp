...
std::string traits::common_odb_options_archetype_qn() {
...
std::string traits::object_odb_options_archetype_qn() {
...
std::string traits::primitive_odb_options_archetype_qn() {
