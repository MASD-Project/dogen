...
type_registrar_implementation_transform::physical_meta_name() const {
...
const logical::entities::name& type_registrar_implementation_transform::logical_meta_name() const {
