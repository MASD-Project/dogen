...
inline std::ostream& operator<<(std::ostream& s, const std::list<dogen::m2t::cpp::formattables::helper_descriptor>& v) {
    s << "[ ";
...
std::ostream& operator<<(std::ostream& s, const helper_properties& v) {
    ...
    s << " { "
      << "\"__type__\": " << "\"dogen::m2t::cpp::formattables::helper_properties\"" << ", "
      << "\"current\": " << v.current() << ", "
