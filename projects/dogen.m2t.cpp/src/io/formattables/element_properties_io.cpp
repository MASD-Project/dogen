...
#include "dogen.m2t.cpp/io/formattables/element_properties_io.hpp"
#include "dogen.m2t.cpp/io/formattables/artefact_properties_io.hpp"
#include "dogen.m2t.cpp/io/formattables/test_data_properties_io.hpp"
...
inline std::ostream& operator<<(std::ostream& s, const std::unordered_map<std::string, dogen::m2t::cpp::formattables::artefact_properties>& v) {
    s << "[";
...
inline std::ostream& operator<<(std::ostream& s, const std::list<dogen::m2t::cpp::formattables::helper_properties>& v) {
    s << "[ ";
    for (auto i(v.begin()); i != v.end(); ++i) {
        if (i != v.begin()) s << ", ";
        s << *i;
...
inline std::ostream& operator<<(std::ostream& s, const std::unordered_map<std::string, dogen::m2t::cpp::formattables::test_data_properties>& v) {
    s << "[";
    for (auto i(v.begin()); i != v.end(); ++i) {
        if (i != v.begin()) s << ", ";
        s << "[ { " << "\"__type__\": " << "\"key\"" << ", " << "\"data\": ";
...
std::ostream& operator<<(std::ostream& s, const element_properties& v) {
    s << " { "
      << "\"__type__\": " << "\"dogen::m2t::cpp::formattables::element_properties\"" << ", "
