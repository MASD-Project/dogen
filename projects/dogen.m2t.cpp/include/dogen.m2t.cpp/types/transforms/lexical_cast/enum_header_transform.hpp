 ...
 *
 */
#ifndef DOGEN_M2T_CPP_TYPES_TRANSFORMS_LEXICAL_CAST_ENUM_HEADER_TRANSFORM_HPP
#define DOGEN_M2T_CPP_TYPES_TRANSFORMS_LEXICAL_CAST_ENUM_HEADER_TRANSFORM_HPP
