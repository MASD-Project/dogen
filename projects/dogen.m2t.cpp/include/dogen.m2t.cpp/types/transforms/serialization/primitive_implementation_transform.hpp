 ...
 *
 */
#ifndef DOGEN_M2T_CPP_TYPES_TRANSFORMS_SERIALIZATION_PRIMITIVE_IMPLEMENTATION_TRANSFORM_HPP
#define DOGEN_M2T_CPP_TYPES_TRANSFORMS_SERIALIZATION_PRIMITIVE_IMPLEMENTATION_TRANSFORM_HPP
