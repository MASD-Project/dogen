 ...
 *
 */
#ifndef DOGEN_M2T_CPP_TYPES_TRANSFORMS_VISUAL_STUDIO_MSBUILD_TARGETS_TRANSFORM_HPP
#define DOGEN_M2T_CPP_TYPES_TRANSFORMS_VISUAL_STUDIO_MSBUILD_TARGETS_TRANSFORM_HPP
