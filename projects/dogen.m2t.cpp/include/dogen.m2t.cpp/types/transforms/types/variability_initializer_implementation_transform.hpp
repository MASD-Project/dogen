 ...
 *
 */
#ifndef DOGEN_M2T_CPP_TYPES_TRANSFORMS_TYPES_VARIABILITY_INITIALIZER_IMPLEMENTATION_TRANSFORM_HPP
#define DOGEN_M2T_CPP_TYPES_TRANSFORMS_TYPES_VARIABILITY_INITIALIZER_IMPLEMENTATION_TRANSFORM_HPP
