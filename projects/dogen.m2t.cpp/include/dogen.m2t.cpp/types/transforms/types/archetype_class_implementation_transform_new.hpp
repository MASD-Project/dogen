 ...
 *
 */
#ifndef DOGEN_M2T_CPP_TYPES_TRANSFORMS_TYPES_ARCHETYPE_CLASS_IMPLEMENTATION_TRANSFORM_NEW_HPP
#define DOGEN_M2T_CPP_TYPES_TRANSFORMS_TYPES_ARCHETYPE_CLASS_IMPLEMENTATION_TRANSFORM_NEW_HPP
