 ...
 *
 */
#ifndef DOGEN_M2T_CPP_TYPES_TRANSFORMS_TYPES_ARCHETYPE_STITCH_TRANSFORM_OLD_HPP
#define DOGEN_M2T_CPP_TYPES_TRANSFORMS_TYPES_ARCHETYPE_STITCH_TRANSFORM_OLD_HPP
...
class archetype_stitch_transform_old final : public model_to_text_transform {
public:
