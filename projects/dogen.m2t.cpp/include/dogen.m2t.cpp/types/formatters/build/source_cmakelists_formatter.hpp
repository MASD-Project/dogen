 ...
 *
 */
#ifndef DOGEN_M2T_CPP_TYPES_FORMATTERS_BUILD_SOURCE_CMAKELISTS_FORMATTER_HPP
#define DOGEN_M2T_CPP_TYPES_FORMATTERS_BUILD_SOURCE_CMAKELISTS_FORMATTER_HPP
...
class source_cmakelists_formatter final : public model_to_text_transform {
public:
