 ...
 *
 */
#ifndef DOGEN_M2T_CPP_TYPES_FORMATTERS_SERIALIZATION_PRIMITIVE_IMPLEMENTATION_FORMATTER_HPP
#define DOGEN_M2T_CPP_TYPES_FORMATTERS_SERIALIZATION_PRIMITIVE_IMPLEMENTATION_FORMATTER_HPP
...
class primitive_implementation_formatter final : public model_to_text_transform {
public:
