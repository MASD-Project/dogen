 ...
 *
 */
#ifndef DOGEN_M2T_CPP_TYPES_FORMATTERS_SERIALIZATION_TYPE_REGISTRAR_HEADER_TRANSFORM_HPP
#define DOGEN_M2T_CPP_TYPES_FORMATTERS_SERIALIZATION_TYPE_REGISTRAR_HEADER_TRANSFORM_HPP
