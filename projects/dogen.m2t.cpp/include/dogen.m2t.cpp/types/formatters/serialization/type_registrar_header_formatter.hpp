 ...
 *
 */
#ifndef DOGEN_M2T_CPP_TYPES_FORMATTERS_SERIALIZATION_TYPE_REGISTRAR_HEADER_FORMATTER_HPP
#define DOGEN_M2T_CPP_TYPES_FORMATTERS_SERIALIZATION_TYPE_REGISTRAR_HEADER_FORMATTER_HPP
