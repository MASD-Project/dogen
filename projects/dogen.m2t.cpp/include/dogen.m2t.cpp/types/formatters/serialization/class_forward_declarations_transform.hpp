 ...
 *
 */
#ifndef DOGEN_M2T_CPP_TYPES_FORMATTERS_SERIALIZATION_CLASS_FORWARD_DECLARATIONS_TRANSFORM_HPP
#define DOGEN_M2T_CPP_TYPES_FORMATTERS_SERIALIZATION_CLASS_FORWARD_DECLARATIONS_TRANSFORM_HPP
