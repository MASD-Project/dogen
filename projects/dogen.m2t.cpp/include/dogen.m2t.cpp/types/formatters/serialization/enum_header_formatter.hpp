 ...
 *
 */
#ifndef DOGEN_M2T_CPP_TYPES_FORMATTERS_SERIALIZATION_ENUM_HEADER_FORMATTER_HPP
#define DOGEN_M2T_CPP_TYPES_FORMATTERS_SERIALIZATION_ENUM_HEADER_FORMATTER_HPP
...
class enum_header_formatter final : public model_to_text_transform {
public:
