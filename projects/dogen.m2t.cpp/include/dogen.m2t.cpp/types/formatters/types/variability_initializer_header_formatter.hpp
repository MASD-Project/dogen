 ...
 *
 */
#ifndef DOGEN_M2T_CPP_TYPES_FORMATTERS_TYPES_VARIABILITY_INITIALIZER_HEADER_FORMATTER_HPP
#define DOGEN_M2T_CPP_TYPES_FORMATTERS_TYPES_VARIABILITY_INITIALIZER_HEADER_FORMATTER_HPP
...
class variability_initializer_header_formatter final : public model_to_text_transform {
public:
