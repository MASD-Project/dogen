 ...
 *
 */
#ifndef DOGEN_M2T_CPP_TYPES_FORMATTERS_TYPES_FEATURE_BUNDLE_HEADER_FORMATTER_HPP
#define DOGEN_M2T_CPP_TYPES_FORMATTERS_TYPES_FEATURE_BUNDLE_HEADER_FORMATTER_HPP
...
class feature_bundle_header_formatter final : public model_to_text_transform {
public:
