 ...
 *
 */
#ifndef DOGEN_M2T_CPP_TYPES_FORMATTERS_CONTEXT_HPP
#define DOGEN_M2T_CPP_TYPES_FORMATTERS_CONTEXT_HPP
...
class context final {
public:
    context(const std::unordered_set<m2t::entities::element_archetype>&
