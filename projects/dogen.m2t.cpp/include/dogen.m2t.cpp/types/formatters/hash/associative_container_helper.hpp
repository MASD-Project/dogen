 ...
 *
 */
#ifndef DOGEN_M2T_CPP_TYPES_FORMATTERS_HASH_ASSOCIATIVE_CONTAINER_HELPER_HPP
#define DOGEN_M2T_CPP_TYPES_FORMATTERS_HASH_ASSOCIATIVE_CONTAINER_HELPER_HPP
