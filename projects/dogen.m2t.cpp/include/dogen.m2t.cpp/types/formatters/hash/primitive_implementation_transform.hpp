 ...
 *
 */
#ifndef DOGEN_M2T_CPP_TYPES_FORMATTERS_HASH_PRIMITIVE_IMPLEMENTATION_TRANSFORM_HPP
#define DOGEN_M2T_CPP_TYPES_FORMATTERS_HASH_PRIMITIVE_IMPLEMENTATION_TRANSFORM_HPP
