 ...
 *
 */
#ifndef DOGEN_M2T_CPP_TYPES_FORMATTERS_TESTS_CLASS_IMPLEMENTATION_FORMATTER_HPP
#define DOGEN_M2T_CPP_TYPES_FORMATTERS_TESTS_CLASS_IMPLEMENTATION_FORMATTER_HPP
