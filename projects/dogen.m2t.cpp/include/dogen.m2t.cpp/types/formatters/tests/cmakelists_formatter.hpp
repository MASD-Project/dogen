 ...
 *
 */
#ifndef DOGEN_M2T_CPP_TYPES_FORMATTERS_TESTS_CMAKELISTS_FORMATTER_HPP
#define DOGEN_M2T_CPP_TYPES_FORMATTERS_TESTS_CMAKELISTS_FORMATTER_HPP
...
class cmakelists_formatter final : public model_to_text_transform {
public:
