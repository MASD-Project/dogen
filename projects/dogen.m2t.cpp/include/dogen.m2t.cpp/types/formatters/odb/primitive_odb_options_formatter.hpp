 ...
 *
 */
#ifndef DOGEN_M2T_CPP_TYPES_FORMATTERS_ODB_PRIMITIVE_ODB_OPTIONS_FORMATTER_HPP
#define DOGEN_M2T_CPP_TYPES_FORMATTERS_ODB_PRIMITIVE_ODB_OPTIONS_FORMATTER_HPP
