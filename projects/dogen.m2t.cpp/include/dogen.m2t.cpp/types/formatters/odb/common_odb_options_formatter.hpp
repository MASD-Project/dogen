 ...
 *
 */
#ifndef DOGEN_M2T_CPP_TYPES_FORMATTERS_ODB_COMMON_ODB_OPTIONS_FORMATTER_HPP
#define DOGEN_M2T_CPP_TYPES_FORMATTERS_ODB_COMMON_ODB_OPTIONS_FORMATTER_HPP
...
class common_odb_options_formatter final : public model_to_text_transform {
public:
