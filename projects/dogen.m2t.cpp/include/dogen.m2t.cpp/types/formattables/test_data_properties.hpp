 ...
 *
 */
#ifndef DOGEN_M2T_CPP_TYPES_FORMATTABLES_TEST_DATA_PROPERTIES_HPP
#define DOGEN_M2T_CPP_TYPES_FORMATTABLES_TEST_DATA_PROPERTIES_HPP
...
template<>
inline void swap(
    dogen::m2t::cpp::formattables::test_data_properties& lhs,
    dogen::m2t::cpp::formattables::test_data_properties& rhs) {
    lhs.swap(rhs);
}
