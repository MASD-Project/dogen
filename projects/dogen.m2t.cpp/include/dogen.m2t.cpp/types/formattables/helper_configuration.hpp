 ...
 *
 */
#ifndef DOGEN_M2T_CPP_TYPES_FORMATTABLES_HELPER_CONFIGURATION_HPP
#define DOGEN_M2T_CPP_TYPES_FORMATTABLES_HELPER_CONFIGURATION_HPP
...
template<>
inline void swap(
    dogen::m2t::cpp::formattables::helper_configuration& lhs,
    dogen::m2t::cpp::formattables::helper_configuration& rhs) {
    lhs.swap(rhs);
}
