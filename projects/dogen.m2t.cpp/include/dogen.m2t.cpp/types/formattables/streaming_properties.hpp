 ...
 *
 */
#ifndef DOGEN_M2T_CPP_TYPES_FORMATTABLES_STREAMING_PROPERTIES_HPP
#define DOGEN_M2T_CPP_TYPES_FORMATTABLES_STREAMING_PROPERTIES_HPP
...
template<>
inline void swap(
    dogen::m2t::cpp::formattables::streaming_properties& lhs,
    dogen::m2t::cpp::formattables::streaming_properties& rhs) {
    lhs.swap(rhs);
}
