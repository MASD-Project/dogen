 ...
 *
 */
#ifndef DOGEN_M2T_CPP_TYPES_FORMATTABLES_HELPER_DESCRIPTOR_HPP
#define DOGEN_M2T_CPP_TYPES_FORMATTABLES_HELPER_DESCRIPTOR_HPP
...
public:
    helper_descriptor(
        ...
        const boost::optional<dogen::m2t::cpp::formattables::streaming_properties>& streaming_properties,
...
public:
    ...
    const boost::optional<dogen::m2t::cpp::formattables::streaming_properties>& streaming_properties() const;
    boost::optional<dogen::m2t::cpp::formattables::streaming_properties>& streaming_properties();
    void streaming_properties(const boost::optional<dogen::m2t::cpp::formattables::streaming_properties>& v);
    void streaming_properties(const boost::optional<dogen::m2t::cpp::formattables::streaming_properties>&& v);
...
private:
    ...
    boost::optional<dogen::m2t::cpp::formattables::streaming_properties> streaming_properties_;
...
template<>
inline void swap(
    dogen::m2t::cpp::formattables::helper_descriptor& lhs,
    dogen::m2t::cpp::formattables::helper_descriptor& rhs) {
    lhs.swap(rhs);
}
