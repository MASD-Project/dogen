...
#include "dogen/om_formatters/serialization/all_ser.hpp"
#include "dogen/om_formatters/serialization/registrar_ser.hpp"

template<typename Archive> void register_types(Archive& ar) {
    dogen::om_formatters::register_types<Archive>(ar);
}
...
BOOST_AUTO_TEST_CASE(validate_serialization) {
    ...
    rountrip_type<result_generator>();
    rountrip_type<formatted_file_generator>();
