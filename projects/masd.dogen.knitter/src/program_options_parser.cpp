...
coding::transforms::options program_options_parser::
...
boost::optional<coding::transforms::options> program_options_parser::parse() {
    const boost::optional<coding::transforms::options> r;
