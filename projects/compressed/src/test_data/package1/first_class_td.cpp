...
dogen::compressed::versioned_key
create_dogen_compressed_versioned_key(const unsigned int position) {
    return dogen::compressed::versioned_key_generator::create(position);
}
...
populate(const unsigned int position, result_type& v) {
    ...
    v.versioned_key(create_dogen_compressed_versioned_key(position + 2));
}
