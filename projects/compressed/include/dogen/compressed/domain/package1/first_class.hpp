 ...
 *
 */
#ifndef DOGEN_COMPRESSED_DOMAIN_PACKAGE1_FIRST_CLASS_HPP
#define DOGEN_COMPRESSED_DOMAIN_PACKAGE1_FIRST_CLASS_HPP
...
public:
    friend class dogen::compressed::package1::first_class_serializer;
...
public:
    ...
    dogen::compressed::versioned_key versioned_key() const {
        return versioned_key_;
    }

    void versioned_key(const dogen::compressed::versioned_key& v) {
        versioned_key_ = v;
    }
...
private:
    ...
    dogen::compressed::versioned_key versioned_key_;
};
...
template<>
inline void swap(
    dogen::compressed::package1::first_class& lhs,
    dogen::compressed::package1::first_class& rhs) {
    lhs.swap(rhs);
}
