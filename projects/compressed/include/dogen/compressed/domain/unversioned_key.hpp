 ...
 *
 */
#ifndef DOGEN_COMPRESSED_DOMAIN_UNVERSIONED_KEY_HPP
#define DOGEN_COMPRESSED_DOMAIN_UNVERSIONED_KEY_HPP
...
public:
    friend class dogen::compressed::unversioned_key_serializer;
...
template<>
inline void swap(
    dogen::compressed::unversioned_key& lhs,
    dogen::compressed::unversioned_key& rhs) {
    lhs.swap(rhs);
}
