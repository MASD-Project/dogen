 ...
 *
 */
#ifndef DOGEN_COMPRESSED_DOMAIN_VERSIONED_KEY_HPP
#define DOGEN_COMPRESSED_DOMAIN_VERSIONED_KEY_HPP
...
#include "dogen/compressed/serialization/versioned_key_fwd_ser.hpp"
...
public:
    friend class dogen::compressed::versioned_key_serializer;
...
template<>
inline void swap(
    dogen::compressed::versioned_key& lhs,
    dogen::compressed::versioned_key& rhs) {
    lhs.swap(rhs);
}
