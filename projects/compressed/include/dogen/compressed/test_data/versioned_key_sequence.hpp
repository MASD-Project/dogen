 ...
 *
 */
#ifndef DOGEN_COMPRESSED_TEST_DATA_VERSIONED_KEY_SEQUENCE_HPP
#define DOGEN_COMPRESSED_TEST_DATA_VERSIONED_KEY_SEQUENCE_HPP
...
public:
    typedef dogen::compressed::versioned_key value_type;
