 ...
 *
 */
#ifndef DOGEN_CLASS_WITHOUT_PACKAGE_DOMAIN_VERSIONED_KEY_HPP
#define DOGEN_CLASS_WITHOUT_PACKAGE_DOMAIN_VERSIONED_KEY_HPP
...
#include "dogen/class_without_package/serialization/versioned_key_fwd_ser.hpp"
...
public:
    friend class dogen::class_without_package::versioned_key_serializer;
...
template<>
inline void swap(
    dogen::class_without_package::versioned_key& lhs,
    dogen::class_without_package::versioned_key& rhs) {
    lhs.swap(rhs);
}
