 ...
 *
 */
#ifndef DOGEN_CLASS_WITHOUT_PACKAGE_DOMAIN_UNVERSIONED_KEY_HPP
#define DOGEN_CLASS_WITHOUT_PACKAGE_DOMAIN_UNVERSIONED_KEY_HPP
...
#include <algorithm>
#include "dogen/class_without_package/serialization/unversioned_key_fwd_ser.hpp"
...
public:
    friend class dogen::class_without_package::unversioned_key_serializer;
...
template<>
inline void swap(
    dogen::class_without_package::unversioned_key& lhs,
    dogen::class_without_package::unversioned_key& rhs) {
    lhs.swap(rhs);
}
