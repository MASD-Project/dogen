 ...
 *
 */
#ifndef DOGEN_CLASS_WITHOUT_PACKAGE_DATABASE_CLASS_1_DB_HPP
#define DOGEN_CLASS_WITHOUT_PACKAGE_DATABASE_CLASS_1_DB_HPP
...
private:
    ...
    std::vector<dogen::class_without_package::class_1> load_internal(
...
public:
    std::vector<dogen::class_without_package::class_1> load(
        pqxx::connection& connection,
        const boost::optional<versioned_key> id =boost::optional<versioned_key>());

    void save(
        pqxx::connection& connection,
        std::vector<dogen::class_without_package::class_1> values);
