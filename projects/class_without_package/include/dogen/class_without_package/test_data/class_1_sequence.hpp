 ...
 *
 */
#ifndef DOGEN_CLASS_WITHOUT_PACKAGE_TEST_DATA_CLASS_1_SEQUENCE_HPP
#define DOGEN_CLASS_WITHOUT_PACKAGE_TEST_DATA_CLASS_1_SEQUENCE_HPP
...
public:
    typedef dogen::class_without_package::class_1 value_type;
