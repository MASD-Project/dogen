...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::stitch::block& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::stitch::block& v, unsigned int version);
