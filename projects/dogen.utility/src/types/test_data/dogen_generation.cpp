...
const std::string path_dogen_coding_dia("dogen.coding.dia");
...
const std::string path_dogen_engine_dia("dogen.engine.dia");
...
const std::string path_dogen_coding_json("dogen.coding.json");
...
const std::string path_dogen_engine_json("dogen.engine.json");
...
path dogen_generation::input_dogen_coding_dia() {
    ensure_initialized();
    return dia_models_directory_ / path_dogen_coding_dia;
}
...
path dogen_generation::input_dogen_engine_dia() {
    ensure_initialized();
    return dia_models_directory_ / path_dogen_engine_dia;
}
...
path dogen_generation::input_dogen_coding_json() {
    ensure_initialized();
    return json_models_directory_ / path_dogen_coding_json;
}
...
path dogen_generation::input_dogen_engine_json() {
    ensure_initialized();
    return json_models_directory_ / path_dogen_engine_json;
}
