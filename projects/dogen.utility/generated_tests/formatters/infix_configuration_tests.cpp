...
#include "dogen.utility/hash/formatters/infix_configuration_hash.hpp"
...
BOOST_AUTO_TEST_CASE(identical_objects_are_equal) {
    dogen::utility::formatters::infix_configuration_generator g;
    const auto a(g());
    const auto b(a);
...
BOOST_AUTO_TEST_CASE(moved_objects_are_equal) {
    ...
    g();
    auto a(g());
    const auto b = dogen::utility::formatters::infix_configuration();
    const auto c(a);
    BOOST_CHECK(a != b);
    BOOST_CHECK(a == c);
...
BOOST_AUTO_TEST_CASE(assigned_objects_are_equal) {
    ...
    g();
    const auto a(g());
    dogen::utility::formatters::infix_configuration b;
    BOOST_CHECK(a != b);
...
BOOST_AUTO_TEST_CASE(copy_constructed_objects_are_equal) {
    ...
    b = dogen::utility::formatters::infix_configuration();
    BOOST_CHECK(a != b);
}
...
BOOST_AUTO_TEST_CASE(xml_roundtrip_produces_the_same_entity) {
    ...
    dogen::utility::formatters::infix_configuration b = dogen::utility::formatters::infix_configuration();
...
BOOST_AUTO_TEST_CASE(equal_objects_generate_the_same_hash) {
    ...
    std::hash<dogen::utility::formatters::infix_configuration> hasher;
