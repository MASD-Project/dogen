...
#include "dogen.utility/hash/formatters/spacing_type_hash.hpp"
...
#include "dogen.utility/serialization/formatters/spacing_type_ser.hpp"
...
BOOST_AUTO_TEST_CASE(xml_roundtrip_produces_the_same_entity) {
    ...
    dogen::utility::formatters::spacing_type b = dogen::utility::formatters::spacing_type();
...
BOOST_AUTO_TEST_CASE(equal_enums_generate_the_same_hash) {
    ...
    std::hash<dogen::utility::formatters::spacing_type> hasher;
