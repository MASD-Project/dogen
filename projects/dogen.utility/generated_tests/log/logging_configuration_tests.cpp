...
#include "dogen.utility/hash/log/logging_configuration_hash.hpp"
...
BOOST_AUTO_TEST_CASE(xml_roundtrip_produces_the_same_entity) {
    ...
    dogen::utility::log::logging_configuration b = dogen::utility::log::logging_configuration();
...
BOOST_AUTO_TEST_CASE(equal_objects_generate_the_same_hash) {
    ...
    std::hash<dogen::utility::log::logging_configuration> hasher;
