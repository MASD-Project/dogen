 ...
 *
 */
#ifndef DOGEN_UTILITY_LEXICAL_CAST_FORMATTERS_COMMENT_STYLE_LC_HPP
#define DOGEN_UTILITY_LEXICAL_CAST_FORMATTERS_COMMENT_STYLE_LC_HPP
...
template<>
inline std::string lexical_cast(const dogen::utility::formatters::comment_style& v) {
...
template<>
inline dogen::utility::formatters::comment_style lexical_cast(const std::string & s) {
    using dogen::utility::formatters::comment_style;
