...
public:
    ...
    static boost::filesystem::path input_dogen_coding_dia();
    ...
    static boost::filesystem::path input_dogen_engine_dia();
...
public:
    ...
    static boost::filesystem::path input_dogen_coding_json();
    ...
    static boost::filesystem::path input_dogen_engine_json();
