...
const std::list<masd::dogen::injection::meta_model::attribute>& element::attributes() const {
    return attributes_;
}

std::list<masd::dogen::injection::meta_model::attribute>& element::attributes() {
    return attributes_;
}

void element::attributes(const std::list<masd::dogen::injection::meta_model::attribute>& v) {
    attributes_ = v;
}
