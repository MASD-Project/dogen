 ...
 *
 */
#ifndef MASD_DOGEN_INJECTION_TYPES_TRANSFORMS_REGISTRAR_ERROR_HPP
#define MASD_DOGEN_INJECTION_TYPES_TRANSFORMS_REGISTRAR_ERROR_HPP
...
/**
 * @brief A registration error has occurred.
 */
