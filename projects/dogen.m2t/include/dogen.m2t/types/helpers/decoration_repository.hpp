 ...
 *
 */
#ifndef DOGEN_M2T_TYPES_HELPERS_DECORATION_REPOSITORY_HPP
#define DOGEN_M2T_TYPES_HELPERS_DECORATION_REPOSITORY_HPP
...
template<>
inline void swap(
    dogen::m2t::helpers::decoration_repository& lhs,
    dogen::m2t::helpers::decoration_repository& rhs) {
    lhs.swap(rhs);
}
