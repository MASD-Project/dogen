 ...
 *
 */
#ifndef DOGEN_M2T_TYPES_TRANSFORMS_DECORATION_CONFIGURATION_HPP
#define DOGEN_M2T_TYPES_TRANSFORMS_DECORATION_CONFIGURATION_HPP
...
template<>
inline void swap(
    dogen::m2t::transforms::decoration_configuration& lhs,
    dogen::m2t::transforms::decoration_configuration& rhs) {
    lhs.swap(rhs);
}
