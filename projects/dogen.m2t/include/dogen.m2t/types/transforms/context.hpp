 ...
 *
 */
#ifndef DOGEN_M2T_TYPES_TRANSFORMS_CONTEXT_HPP
#define DOGEN_M2T_TYPES_TRANSFORMS_CONTEXT_HPP
...
template<>
inline void swap(
    dogen::m2t::transforms::context& lhs,
    dogen::m2t::transforms::context& rhs) {
    lhs.swap(rhs);
}
