 ...
 */
#ifndef DOGEN_M2T_TYPES_FORMATTERS_INDENT_FILTER_HPP
#define DOGEN_M2T_TYPES_FORMATTERS_INDENT_FILTER_HPP
...
operator++(std::basic_ostream<char_type, traits_type>& s) {
    s << dogen::m2t::formatters::indent_in;
    return s;
}
...
inline std::basic_ostream<char_type, traits_type>&
operator--(std::basic_ostream<char_type, traits_type>& s) {
    s << dogen::m2t::formatters::indent_out;
    return s;
}
/**@}*/
