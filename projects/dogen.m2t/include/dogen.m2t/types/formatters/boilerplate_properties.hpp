 ...
 *
 */
#ifndef DOGEN_M2T_TYPES_FORMATTERS_BOILERPLATE_PROPERTIES_HPP
#define DOGEN_M2T_TYPES_FORMATTERS_BOILERPLATE_PROPERTIES_HPP
...
template<>
inline void swap(
    dogen::m2t::formatters::boilerplate_properties& lhs,
    dogen::m2t::formatters::boilerplate_properties& rhs) {
    lhs.swap(rhs);
}
