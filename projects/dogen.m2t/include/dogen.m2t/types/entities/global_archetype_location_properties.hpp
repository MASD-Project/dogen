...
public:
    const std::unordered_map<std::string, dogen::m2t::entities::backend_properties>& backend_properties() const;
    std::unordered_map<std::string, dogen::m2t::entities::backend_properties>& backend_properties();
    void backend_properties(const std::unordered_map<std::string, dogen::m2t::entities::backend_properties>& v);
    void backend_properties(const std::unordered_map<std::string, dogen::m2t::entities::backend_properties>&& v);

    const std::unordered_map<std::string, dogen::m2t::entities::facet_properties>& facet_properties() const;
    std::unordered_map<std::string, dogen::m2t::entities::facet_properties>& facet_properties();
    void facet_properties(const std::unordered_map<std::string, dogen::m2t::entities::facet_properties>& v);
    void facet_properties(const std::unordered_map<std::string, dogen::m2t::entities::facet_properties>&& v);

    const std::unordered_map<std::string, dogen::m2t::entities::archetype_properties>& archetype_properties() const;
    std::unordered_map<std::string, dogen::m2t::entities::archetype_properties>& archetype_properties();
    void archetype_properties(const std::unordered_map<std::string, dogen::m2t::entities::archetype_properties>& v);
    void archetype_properties(const std::unordered_map<std::string, dogen::m2t::entities::archetype_properties>&& v);

    const std::unordered_map<std::string, dogen::m2t::entities::denormalised_archetype_properties>& denormalised_archetype_properties() const;
    std::unordered_map<std::string, dogen::m2t::entities::denormalised_archetype_properties>& denormalised_archetype_properties();
...
private:
    ...
    std::unordered_map<std::string, dogen::m2t::entities::facet_properties> facet_properties_;
    std::unordered_map<std::string, dogen::m2t::entities::archetype_properties> archetype_properties_;
    std::unordered_map<std::string, dogen::m2t::entities::denormalised_archetype_properties> denormalised_archetype_properties_;
};
