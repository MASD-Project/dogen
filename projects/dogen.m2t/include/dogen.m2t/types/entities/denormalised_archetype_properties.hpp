 ...
 *
 */
#ifndef DOGEN_M2T_TYPES_ENTITIES_DENORMALISED_ARCHETYPE_PROPERTIES_HPP
#define DOGEN_M2T_TYPES_ENTITIES_DENORMALISED_ARCHETYPE_PROPERTIES_HPP
...
template<>
inline void swap(
    dogen::m2t::entities::denormalised_archetype_properties& lhs,
    dogen::m2t::entities::denormalised_archetype_properties& rhs) {
    lhs.swap(rhs);
}
