 ...
 *
 */
#ifndef DOGEN_M2T_TYPES_ENTITIES_MODEL_SET_HPP
#define DOGEN_M2T_TYPES_ENTITIES_MODEL_SET_HPP
...
public:
    model_set(
        ...
        const std::list<dogen::m2t::entities::model>& models);
...
public:
     ...
     */
    /**@{*/
    const std::list<dogen::m2t::entities::model>& models() const;
    std::list<dogen::m2t::entities::model>& models();
    void models(const std::list<dogen::m2t::entities::model>& v);
    void models(const std::list<dogen::m2t::entities::model>&& v);
    /**@}*/
...
private:
    ...
    std::list<dogen::m2t::entities::model> models_;
};
...
template<>
inline void swap(
    dogen::m2t::entities::model_set& lhs,
    dogen::m2t::entities::model_set& rhs) {
    lhs.swap(rhs);
}
