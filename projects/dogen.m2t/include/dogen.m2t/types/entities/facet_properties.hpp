 ...
 *
 */
#ifndef DOGEN_M2T_TYPES_ENTITIES_FACET_PROPERTIES_HPP
#define DOGEN_M2T_TYPES_ENTITIES_FACET_PROPERTIES_HPP
...
template<>
inline void swap(
    dogen::m2t::entities::facet_properties& lhs,
    dogen::m2t::entities::facet_properties& rhs) {
    lhs.swap(rhs);
}
