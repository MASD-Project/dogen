 ...
 *
 */
#ifndef DOGEN_M2T_TYPES_ENTITIES_ELEMENT_ARCHETYPE_HPP
#define DOGEN_M2T_TYPES_ENTITIES_ELEMENT_ARCHETYPE_HPP
...
template<>
inline void swap(
    dogen::m2t::entities::element_archetype& lhs,
    dogen::m2t::entities::element_archetype& rhs) {
    lhs.swap(rhs);
}
