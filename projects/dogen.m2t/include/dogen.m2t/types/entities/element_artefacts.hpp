 ...
 *
 */
#ifndef DOGEN_M2T_TYPES_ENTITIES_ELEMENT_ARTEFACTS_HPP
#define DOGEN_M2T_TYPES_ENTITIES_ELEMENT_ARTEFACTS_HPP
...
template<>
inline void swap(
    dogen::m2t::entities::element_artefacts& lhs,
    dogen::m2t::entities::element_artefacts& rhs) {
    lhs.swap(rhs);
}
