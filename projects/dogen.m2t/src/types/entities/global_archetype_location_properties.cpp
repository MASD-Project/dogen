...
const std::unordered_map<std::string, dogen::m2t::entities::backend_properties>& global_archetype_location_properties::backend_properties() const {
    return backend_properties_;
}

std::unordered_map<std::string, dogen::m2t::entities::backend_properties>& global_archetype_location_properties::backend_properties() {
    return backend_properties_;
}

void global_archetype_location_properties::backend_properties(const std::unordered_map<std::string, dogen::m2t::entities::backend_properties>& v) {
...
const std::unordered_map<std::string, dogen::m2t::entities::facet_properties>& global_archetype_location_properties::facet_properties() const {
    return facet_properties_;
}

std::unordered_map<std::string, dogen::m2t::entities::facet_properties>& global_archetype_location_properties::facet_properties() {
    return facet_properties_;
}

void global_archetype_location_properties::facet_properties(const std::unordered_map<std::string, dogen::m2t::entities::facet_properties>& v) {
    facet_properties_ = v;
}
...
const std::unordered_map<std::string, dogen::m2t::entities::archetype_properties>& global_archetype_location_properties::archetype_properties() const {
    return archetype_properties_;
}

std::unordered_map<std::string, dogen::m2t::entities::archetype_properties>& global_archetype_location_properties::archetype_properties() {
    return archetype_properties_;
}

void global_archetype_location_properties::archetype_properties(const std::unordered_map<std::string, dogen::m2t::entities::archetype_properties>& v) {
...
const std::unordered_map<std::string, dogen::m2t::entities::denormalised_archetype_properties>& global_archetype_location_properties::denormalised_archetype_properties() const {
    return denormalised_archetype_properties_;
}

std::unordered_map<std::string, dogen::m2t::entities::denormalised_archetype_properties>& global_archetype_location_properties::denormalised_archetype_properties() {
    return denormalised_archetype_properties_;
}

void global_archetype_location_properties::denormalised_archetype_properties(const std::unordered_map<std::string, dogen::m2t::entities::denormalised_archetype_properties>& v) {
