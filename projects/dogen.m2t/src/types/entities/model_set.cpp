...
const std::list<dogen::m2t::entities::model>& model_set::models() const {
    return models_;
}

std::list<dogen::m2t::entities::model>& model_set::models() {
    return models_;
}

void model_set::models(const std::list<dogen::m2t::entities::model>& v) {
    models_ = v;
}
