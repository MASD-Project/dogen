...
formatting_configuration::formatting_configuration()
    : style_(static_cast<dogen::m2t::entities::formatting_styles>(0)) { }
...
dogen::m2t::entities::formatting_styles formatting_configuration::style() const {
    return style_;
}

void formatting_configuration::style(const dogen::m2t::entities::formatting_styles v) {
    style_ = v;
}
