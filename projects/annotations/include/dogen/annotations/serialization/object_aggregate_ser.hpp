 ...
 *
 */
#ifndef DOGEN_ANNOTATIONS_SERIALIZATION_OBJECT_AGGREGATE_SER_HPP
#define DOGEN_ANNOTATIONS_SERIALIZATION_OBJECT_AGGREGATE_SER_HPP
...
BOOST_SERIALIZATION_SPLIT_FREE(dogen::annotations::object_aggregate)
namespace boost {
