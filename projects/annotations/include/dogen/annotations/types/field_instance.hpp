 ...
 *
 */
#ifndef DOGEN_ANNOTATIONS_TYPES_FIELD_INSTANCE_HPP
#define DOGEN_ANNOTATIONS_TYPES_FIELD_INSTANCE_HPP
...
#include "dogen/annotations/serialization/field_instance_fwd_ser.hpp"
...
public:
    explicit field_instance(const boost::shared_ptr<dogen::annotations::value>& value);

private:
    template<typename Archive>
    friend void boost::serialization::save(Archive& ar, const dogen::annotations::field_instance& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::annotations::field_instance& v, unsigned int version);
...
template<>
inline void swap(
    dogen::annotations::field_instance& lhs,
    dogen::annotations::field_instance& rhs) {
    lhs.swap(rhs);
}
