...
public:
    static std::size_t hash(const ownership_hierarchy_repository& v);
};
...
template<>
struct hash<dogen::annotations::ownership_hierarchy_repository> {
public:
    size_t operator()(const dogen::annotations::ownership_hierarchy_repository& v) const {
