...
const std::list<dogen::annotations::type>& type_repository::all_field_definitions() const {
    return all_field_definitions_;
}

std::list<dogen::annotations::type>& type_repository::all_field_definitions() {
    return all_field_definitions_;
}

void type_repository::all_field_definitions(const std::list<dogen::annotations::type>& v) {
...
const std::unordered_map<std::string, dogen::annotations::type>& type_repository::field_definitions_by_name() const {
    return field_definitions_by_name_;
}

std::unordered_map<std::string, dogen::annotations::type>& type_repository::field_definitions_by_name() {
    return field_definitions_by_name_;
}

void type_repository::field_definitions_by_name(const std::unordered_map<std::string, dogen::annotations::type>& v) {
...
const std::unordered_map<std::string, std::list<dogen::annotations::type> >& type_repository::field_definitions_by_facet_name() const {
    return field_definitions_by_facet_name_;
}

std::unordered_map<std::string, std::list<dogen::annotations::type> >& type_repository::field_definitions_by_facet_name() {
    return field_definitions_by_facet_name_;
}

void type_repository::field_definitions_by_facet_name(const std::unordered_map<std::string, std::list<dogen::annotations::type> >& v) {
...
const std::unordered_map<std::string, std::list<dogen::annotations::type> >& type_repository::field_definitions_by_formatter_name() const {
    return field_definitions_by_formatter_name_;
}

std::unordered_map<std::string, std::list<dogen::annotations::type> >& type_repository::field_definitions_by_formatter_name() {
    return field_definitions_by_formatter_name_;
}

void type_repository::field_definitions_by_formatter_name(const std::unordered_map<std::string, std::list<dogen::annotations::type> >& v) {
...
const std::unordered_map<std::string, std::list<dogen::annotations::type> >& type_repository::field_definitions_by_model_name() const {
    return field_definitions_by_model_name_;
}

std::unordered_map<std::string, std::list<dogen::annotations::type> >& type_repository::field_definitions_by_model_name() {
    return field_definitions_by_model_name_;
}

void type_repository::field_definitions_by_model_name(const std::unordered_map<std::string, std::list<dogen::annotations::type> >& v) {
