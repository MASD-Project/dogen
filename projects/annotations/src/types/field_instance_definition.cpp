...
field_instance_definition::field_instance_definition()
    : definition_types_(static_cast<dogen::annotations::field_definition_types>(0)) { }
...
const dogen::annotations::ownership_hierarchy& field_instance_definition::ownership_hierarchy() const {
    return ownership_hierarchy_;
}

dogen::annotations::ownership_hierarchy& field_instance_definition::ownership_hierarchy() {
    return ownership_hierarchy_;
}

void field_instance_definition::ownership_hierarchy(const dogen::annotations::ownership_hierarchy& v) {
...
dogen::annotations::field_definition_types field_instance_definition::definition_types() const {
    return definition_types_;
}

void field_instance_definition::definition_types(const dogen::annotations::field_definition_types v) {
    definition_types_ = v;
}
