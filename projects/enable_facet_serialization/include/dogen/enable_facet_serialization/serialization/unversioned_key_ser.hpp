...
BOOST_SERIALIZATION_SPLIT_FREE(dogen::enable_facet_serialization::unversioned_key)
BOOST_CLASS_EXPORT_KEY(dogen::enable_facet_serialization::unversioned_key)
