 ...
 *
 */
#ifndef DOGEN_ENABLE_FACET_SERIALIZATION_SERIALIZATION_PACKAGE1_FIRST_CLASS_FWD_SER_HPP
#define DOGEN_ENABLE_FACET_SERIALIZATION_SERIALIZATION_PACKAGE1_FIRST_CLASS_FWD_SER_HPP
