 ...
 *
 */
#ifndef DOGEN_COMMENTS_DOMAIN_UNVERSIONED_KEY_HPP
#define DOGEN_COMMENTS_DOMAIN_UNVERSIONED_KEY_HPP
...
#include <algorithm>
#include "dogen/comments/serialization/unversioned_key_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::comments::unversioned_key& lhs,
    dogen::comments::unversioned_key& rhs) {
    lhs.swap(rhs);
}
