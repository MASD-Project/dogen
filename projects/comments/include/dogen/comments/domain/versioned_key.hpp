 ...
 *
 */
#ifndef DOGEN_COMMENTS_DOMAIN_VERSIONED_KEY_HPP
#define DOGEN_COMMENTS_DOMAIN_VERSIONED_KEY_HPP
...
#include "dogen/comments/serialization/versioned_key_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::comments::versioned_key& lhs,
    dogen::comments::versioned_key& rhs) {
    lhs.swap(rhs);
}
