...
void save(Archive& ar,
    const dogen::comments::one_line& v,
...
template void save(archive::binary_oarchive& ar, const dogen::comments::one_line& v, unsigned int version);
template void load(archive::binary_iarchive& ar, dogen::comments::one_line& v, unsigned int version);
