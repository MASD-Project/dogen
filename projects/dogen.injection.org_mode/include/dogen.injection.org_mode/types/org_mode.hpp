 ...
 *
 */
#ifndef DOGEN_INJECTION_ORG_MODE_TYPES_ORG_MODE_HPP
#define DOGEN_INJECTION_ORG_MODE_TYPES_ORG_MODE_HPP
...
/**
 * @brief Provides file importing support for org-mode.
 *
