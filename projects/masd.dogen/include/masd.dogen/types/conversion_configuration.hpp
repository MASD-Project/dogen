 ...
 *
 */
#ifndef MASD_DOGEN_TYPES_CONVERSION_CONFIGURATION_HPP
#define MASD_DOGEN_TYPES_CONVERSION_CONFIGURATION_HPP
...
template<>
inline void swap(
    masd::dogen::conversion_configuration& lhs,
    masd::dogen::conversion_configuration& rhs) {
    lhs.swap(rhs);
}
