 ...
 *
 */
#ifndef MASD_DOGEN_EXTRACTION_TYPES_HELPERS_FILESYSTEM_WRITER_HPP
#define MASD_DOGEN_EXTRACTION_TYPES_HELPERS_FILESYSTEM_WRITER_HPP
...
public:
    ...
    void force_write(
        const std::list<meta_model::artefact>& artefacts) const override;
};
