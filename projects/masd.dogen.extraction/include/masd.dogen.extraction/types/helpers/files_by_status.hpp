 ...
 *
 */
#ifndef MASD_DOGEN_EXTRACTION_TYPES_HELPERS_FILES_BY_STATUS_HPP
#define MASD_DOGEN_EXTRACTION_TYPES_HELPERS_FILES_BY_STATUS_HPP
...
template<>
inline void swap(
    masd::dogen::extraction::helpers::files_by_status& lhs,
    masd::dogen::extraction::helpers::files_by_status& rhs) {
    lhs.swap(rhs);
}
