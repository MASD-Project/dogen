 ...
 *
 */
#ifndef MASD_DOGEN_EXTRACTION_TYPES_META_MODEL_ARTEFACT_HPP
#define MASD_DOGEN_EXTRACTION_TYPES_META_MODEL_ARTEFACT_HPP
...
template<>
inline void swap(
    masd::dogen::extraction::meta_model::artefact& lhs,
    masd::dogen::extraction::meta_model::artefact& rhs) {
    lhs.swap(rhs);
}
