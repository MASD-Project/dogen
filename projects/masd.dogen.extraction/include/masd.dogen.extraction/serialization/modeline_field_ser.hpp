 ...
 *
 */
#ifndef MASD_DOGEN_EXTRACTION_SERIALIZATION_MODELINE_FIELD_SER_HPP
#define MASD_DOGEN_EXTRACTION_SERIALIZATION_MODELINE_FIELD_SER_HPP
...
BOOST_SERIALIZATION_SPLIT_FREE(masd::dogen::extraction::modeline_field)
namespace boost {
