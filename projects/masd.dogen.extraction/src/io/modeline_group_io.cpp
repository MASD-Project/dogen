...
inline std::ostream& operator<<(std::ostream& s, const std::unordered_map<std::string, masd::dogen::extraction::modeline>& v) {
    s << "[";
...
std::ostream& operator<<(std::ostream& s, const modeline_group& v) {
    s << " { "
      << "\"__type__\": " << "\"masd::dogen::extraction::modeline_group\"" << ", "
