...
const std::unordered_map<std::string, masd::dogen::extraction::modeline_group>& repository::modeline_groups() const {
    return modeline_groups_;
}

std::unordered_map<std::string, masd::dogen::extraction::modeline_group>& repository::modeline_groups() {
    return modeline_groups_;
}

void repository::modeline_groups(const std::unordered_map<std::string, masd::dogen::extraction::modeline_group>& v) {
    modeline_groups_ = v;
}
