...
masd::dogen::extraction::meta_model::operation_type
create_masd_dogen_extraction_meta_model_operation_type(const unsigned int position) {
    return masd::dogen::extraction::meta_model::operation_type_generator::create(position);
}

masd::dogen::extraction::meta_model::operation_reason
create_masd_dogen_extraction_meta_model_operation_reason(const unsigned int position) {
    return masd::dogen::extraction::meta_model::operation_reason_generator::create(position);
}
...
populate(const unsigned int position, result_type& v) {
    v.type(create_masd_dogen_extraction_meta_model_operation_type(position + 0));
    v.reason(create_masd_dogen_extraction_meta_model_operation_reason(position + 1));
}
