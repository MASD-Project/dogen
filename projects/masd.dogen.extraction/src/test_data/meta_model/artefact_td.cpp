...
masd::dogen::extraction::meta_model::operation
create_masd_dogen_extraction_meta_model_operation(const unsigned int position) {
    return masd::dogen::extraction::meta_model::operation_generator::create(position);
}
...
populate(const unsigned int position, result_type& v) {
    ...
    v.operation(create_masd_dogen_extraction_meta_model_operation(position + 5));
}
