 ...
 *
 */
#ifndef DOGEN_CLASSES_IN_A_PACKAGE_TEST_DATA_VERSIONED_KEY_SEQUENCE_HPP
#define DOGEN_CLASSES_IN_A_PACKAGE_TEST_DATA_VERSIONED_KEY_SEQUENCE_HPP
...
public:
    typedef dogen::classes_in_a_package::versioned_key value_type;
