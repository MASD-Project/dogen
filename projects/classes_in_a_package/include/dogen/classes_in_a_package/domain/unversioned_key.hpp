 ...
 *
 */
#ifndef DOGEN_CLASSES_IN_A_PACKAGE_DOMAIN_UNVERSIONED_KEY_HPP
#define DOGEN_CLASSES_IN_A_PACKAGE_DOMAIN_UNVERSIONED_KEY_HPP
...
#include <algorithm>
#include "dogen/classes_in_a_package/serialization/unversioned_key_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::classes_in_a_package::unversioned_key& lhs,
    dogen::classes_in_a_package::unversioned_key& rhs) {
    lhs.swap(rhs);
}
