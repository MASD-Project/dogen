 ...
 *
 */
#ifndef DOGEN_CLASSES_IN_A_PACKAGE_DATABASE_PACKAGE_1_CLASS_2_DB_HPP
#define DOGEN_CLASSES_IN_A_PACKAGE_DATABASE_PACKAGE_1_CLASS_2_DB_HPP
...
private:
    ...
    std::vector<dogen::classes_in_a_package::package_1::class_2> load_internal(
...
public:
    std::vector<dogen::classes_in_a_package::package_1::class_2> load(
        pqxx::connection& connection,
        const boost::optional<versioned_key> id =boost::optional<versioned_key>());

    void save(
        pqxx::connection& connection,
        std::vector<dogen::classes_in_a_package::package_1::class_2> values);
