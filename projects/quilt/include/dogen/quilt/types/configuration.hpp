 ...
 *
 */
#ifndef DOGEN_QUILT_TYPES_CONFIGURATION_HPP
#define DOGEN_QUILT_TYPES_CONFIGURATION_HPP
...
#include "dogen/quilt/serialization/configuration_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::quilt::configuration& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::quilt::configuration& v, unsigned int version);
...
template<>
inline void swap(
    dogen::quilt::configuration& lhs,
    dogen::quilt::configuration& rhs) {
    lhs.swap(rhs);
}
