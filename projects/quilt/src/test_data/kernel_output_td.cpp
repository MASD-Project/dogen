...
kernel_output_generator::kernel_output_generator() : position_(0) { }

void kernel_output_generator::
...
kernel_output_generator::result_type
kernel_output_generator::create(const unsigned int position) {
    kernel_output r;
    kernel_output_generator::populate(position, r);
    return r;
}

kernel_output_generator::result_type*
kernel_output_generator::create_ptr(const unsigned int position) {
    kernel_output* p = new kernel_output();
    kernel_output_generator::populate(position, *p);
    return p;
}

kernel_output_generator::result_type
kernel_output_generator::operator()() {
