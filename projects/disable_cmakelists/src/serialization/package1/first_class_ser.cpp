...
template void save(archive::polymorphic_oarchive& ar, const dogen::disable_cmakelists::package1::first_class& v, unsigned int version);
template void load(archive::polymorphic_iarchive& ar, dogen::disable_cmakelists::package1::first_class& v, unsigned int version);
...
#ifdef __linux__
template void save(eos::portable_oarchive& ar, const dogen::disable_cmakelists::package1::first_class& v, unsigned int version);
template void load(eos::portable_iarchive& ar, dogen::disable_cmakelists::package1::first_class& v, unsigned int version);
#endif
