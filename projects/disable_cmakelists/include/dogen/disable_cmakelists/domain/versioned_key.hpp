 ...
 *
 */
#ifndef DOGEN_DISABLE_CMAKELISTS_DOMAIN_VERSIONED_KEY_HPP
#define DOGEN_DISABLE_CMAKELISTS_DOMAIN_VERSIONED_KEY_HPP
...
public:
    friend class dogen::disable_cmakelists::versioned_key_serializer;
...
template<>
inline void swap(
    dogen::disable_cmakelists::versioned_key& lhs,
    dogen::disable_cmakelists::versioned_key& rhs) {
    lhs.swap(rhs);
}
