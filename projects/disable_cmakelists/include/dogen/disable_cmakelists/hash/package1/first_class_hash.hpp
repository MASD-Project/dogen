...
template<>
struct hash<dogen::disable_cmakelists::package1::first_class> {
public:
    size_t operator()(const dogen::disable_cmakelists::package1::first_class& v) const {
        return dogen::disable_cmakelists::package1::first_class_hasher::hash(v);
    }
};
