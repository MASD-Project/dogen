 ...
 *
 */
#ifndef DOGEN_DISABLE_CMAKELISTS_DATABASE_PACKAGE1_FIRST_CLASS_DB_HPP
#define DOGEN_DISABLE_CMAKELISTS_DATABASE_PACKAGE1_FIRST_CLASS_DB_HPP
...
private:
    ...
    std::vector<dogen::disable_cmakelists::package1::first_class> load_internal(
...
public:
    std::vector<dogen::disable_cmakelists::package1::first_class> load(
        pqxx::connection& connection,
        const boost::optional<versioned_key> id =boost::optional<versioned_key>());

    void save(
        pqxx::connection& connection,
        std::vector<dogen::disable_cmakelists::package1::first_class> values);
