 ...
 *
 */
#ifndef DOGEN_YARN_TYPES_META_MODEL_MODEL_SEGMENT_PROPERTIES_HPP
#define DOGEN_YARN_TYPES_META_MODEL_MODEL_SEGMENT_PROPERTIES_HPP
...
#include "dogen/yarn/serialization/meta_model/model_segment_properties_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::yarn::meta_model::model_segment_properties& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::yarn::meta_model::model_segment_properties& v, unsigned int version);
...
template<>
inline void swap(
    dogen::yarn::meta_model::model_segment_properties& lhs,
    dogen::yarn::meta_model::model_segment_properties& rhs) {
    lhs.swap(rhs);
}
