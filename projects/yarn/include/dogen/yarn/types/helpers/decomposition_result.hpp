...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::yarn::helpers::decomposition_result& v, unsigned int version);
...
public:
    ...
    const std::list<std::pair<std::string, dogen::yarn::meta_model::name> >& meta_names() const;
    std::list<std::pair<std::string, dogen::yarn::meta_model::name> >& meta_names();
    void meta_names(const std::list<std::pair<std::string, dogen::yarn::meta_model::name> >& v);
    void meta_names(const std::list<std::pair<std::string, dogen::yarn::meta_model::name> >&& v);
...
template<>
inline void swap(
    dogen::yarn::helpers::decomposition_result& lhs,
    dogen::yarn::helpers::decomposition_result& rhs) {
    lhs.swap(rhs);
}
