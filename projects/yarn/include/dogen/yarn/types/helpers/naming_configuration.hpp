 ...
 *
 */
#ifndef DOGEN_YARN_TYPES_HELPERS_NAMING_CONFIGURATION_HPP
#define DOGEN_YARN_TYPES_HELPERS_NAMING_CONFIGURATION_HPP
...
#include <string>
#include <algorithm>
#include "dogen/yarn/serialization/helpers/naming_configuration_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::yarn::helpers::naming_configuration& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::yarn::helpers::naming_configuration& v, unsigned int version);
...
template<>
inline void swap(
    dogen::yarn::helpers::naming_configuration& lhs,
    dogen::yarn::helpers::naming_configuration& rhs) {
    lhs.swap(rhs);
}
