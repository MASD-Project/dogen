 ...
 *
 */
#ifndef DOGEN_YARN_TYPES_HELPERS_MAPPING_CONTEXT_HPP
#define DOGEN_YARN_TYPES_HELPERS_MAPPING_CONTEXT_HPP
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::yarn::helpers::mapping_context& v, unsigned int version);
...
template<>
inline void swap(
    dogen::yarn::helpers::mapping_context& lhs,
    dogen::yarn::helpers::mapping_context& rhs) {
    lhs.swap(rhs);
}
