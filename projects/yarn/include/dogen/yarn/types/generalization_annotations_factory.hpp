 ...
 *
 */
#ifndef DOGEN_YARN_TYPES_GENERALIZATION_ANNOTATIONS_FACTORY_HPP
#define DOGEN_YARN_TYPES_GENERALIZATION_ANNOTATIONS_FACTORY_HPP
...
class generalization_annotations_factory {
public:
    explicit generalization_annotations_factory(const dynamic::repository& rp);
...
public:
    generalization_annotations make(const dynamic::object& o) const;
