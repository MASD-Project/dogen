 ...
 *
 */
#ifndef DOGEN_YARN_TYPES_TRANSFORMS_EXOMODEL_TRANSFORM_REGISTRAR_HPP
#define DOGEN_YARN_TYPES_TRANSFORMS_EXOMODEL_TRANSFORM_REGISTRAR_HPP
 ...
 */
class exomodel_transform_registrar final {
public:
    /**
     ...
     */
    void register_exomodel_transform(
...
private:
    std::unordered_map<std::string,
                       std::shared_ptr<exomodel_transform_interface>>
    exomodel_transforms_;
};
