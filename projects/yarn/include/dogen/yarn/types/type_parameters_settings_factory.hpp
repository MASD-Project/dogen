 ...
 *
 */
#ifndef DOGEN_YARN_TYPES_TYPE_PARAMETERS_SETTINGS_FACTORY_HPP
#define DOGEN_YARN_TYPES_TYPE_PARAMETERS_SETTINGS_FACTORY_HPP
...
class type_parameters_settings_factory {
public:
    explicit type_parameters_settings_factory(const dynamic::repository& rp);
...
public:
    type_parameters_settings make(const dynamic::object& o) const;
