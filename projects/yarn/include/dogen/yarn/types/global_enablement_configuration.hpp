 ...
 *
 */
#ifndef DOGEN_YARN_TYPES_GLOBAL_ENABLEMENT_CONFIGURATION_HPP
#define DOGEN_YARN_TYPES_GLOBAL_ENABLEMENT_CONFIGURATION_HPP
...
#include "dogen/yarn/serialization/global_enablement_configuration_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::yarn::global_enablement_configuration& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::yarn::global_enablement_configuration& v, unsigned int version);
...
template<>
inline void swap(
    dogen::yarn::global_enablement_configuration& lhs,
    dogen::yarn::global_enablement_configuration& rhs) {
    lhs.swap(rhs);
}
