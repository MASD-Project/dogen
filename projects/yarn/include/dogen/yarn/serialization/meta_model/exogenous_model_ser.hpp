 ...
 *
 */
#ifndef DOGEN_YARN_SERIALIZATION_META_MODEL_EXOGENOUS_MODEL_SER_HPP
#define DOGEN_YARN_SERIALIZATION_META_MODEL_EXOGENOUS_MODEL_SER_HPP
...
BOOST_SERIALIZATION_SPLIT_FREE(dogen::yarn::meta_model::exogenous_model)
namespace boost {
