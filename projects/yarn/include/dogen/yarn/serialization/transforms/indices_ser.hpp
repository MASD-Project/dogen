 ...
 *
 */
#ifndef DOGEN_YARN_SERIALIZATION_TRANSFORMS_INDICES_SER_HPP
#define DOGEN_YARN_SERIALIZATION_TRANSFORMS_INDICES_SER_HPP
...
BOOST_SERIALIZATION_SPLIT_FREE(dogen::yarn::transforms::indices)
namespace boost {
