...
inline std::ostream& operator<<(std::ostream& s, const std::unordered_map<std::string, dogen::yarn::helpers::mapping_set>& v) {
    s << "[";
...
std::ostream& operator<<(std::ostream& s, const mapping_set_repository& v) {
    s << " { "
      << "\"__type__\": " << "\"dogen::yarn::helpers::mapping_set_repository\"" << ", "
