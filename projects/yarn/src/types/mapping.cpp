...
std::unordered_map<dogen::yarn::languages, dogen::yarn::mapping_value>& mapping::by_language() {
    return by_language_;
}

void mapping::by_language(const std::unordered_map<dogen::yarn::languages, dogen::yarn::mapping_value>& v) {
    by_language_ = v;
}
