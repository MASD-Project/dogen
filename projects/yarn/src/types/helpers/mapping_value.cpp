...
mapping_value::mapping_value()
    : mapping_action_(static_cast<dogen::yarn::helpers::mapping_actions>(0)) { }
...
dogen::yarn::helpers::mapping_actions mapping_value::mapping_action() const {
    return mapping_action_;
}

void mapping_value::mapping_action(const dogen::yarn::helpers::mapping_actions v) {
    mapping_action_ = v;
}
