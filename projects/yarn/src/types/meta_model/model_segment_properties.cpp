...
dogen::yarn::meta_model::path_contribution_types model_segment_properties::external_modules() const {
    return external_modules_;
}

void model_segment_properties::external_modules(const dogen::yarn::meta_model::path_contribution_types v) {
    external_modules_ = v;
}

dogen::yarn::meta_model::path_contribution_types model_segment_properties::model_modules() const {
    return model_modules_;
}

void model_segment_properties::model_modules(const dogen::yarn::meta_model::path_contribution_types v) {
    model_modules_ = v;
}
