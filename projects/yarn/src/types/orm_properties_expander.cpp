...
static logger lg(logger_factory("yarn.orm_properties_expander"));
...
orm_database_systems orm_properties_expander::
...
std::vector<orm_database_systems> orm_properties_expander::
...
letter_cases
orm_properties_expander::to_letter_case(const std::string& s) const {
    const auto ls(boost::to_lower_copy(s));
    if (ls == upper_case) {
...
std::ostream&
operator<<(std::ostream& s, const orm_properties_expander::type_group& v) {
    s << " { "
      << "\"__type__\": " << "\"yarn::orm_properties_expander::"
      << "type_group\"" << ", "
...
orm_properties_expander::type_group orm_properties_expander::
...
orm_properties_expander::make_model_properties(const type_group& tg,
...
void orm_properties_expander::update_object_properties(
    const type_group& tg, const annotations::annotation& a,
    orm_object_properties& cfg) const {
...
orm_properties_expander::make_attribute_properties(const type_group& tg,
    const annotations::annotation& a) const {
...
void orm_properties_expander::update_primitive_properties(
    const type_group& tg, const annotations::annotation& a,
...
orm_properties_expander::make_module_properties(const type_group& tg,
    const annotations::annotation& a) const {
...
void orm_properties_expander::expand_primitives(
