...
static logger lg(logger_factory("yarn.generalization_settings_factory"));
...
generalization_settings_factory::
generalization_settings_factory(const dynamic::repository& rp)
    : field_definitions_(make_field_definitions(rp)) {}

generalization_settings_factory::field_definitions
generalization_settings_factory::make_field_definitions(
...
generalization_settings generalization_settings_factory::
