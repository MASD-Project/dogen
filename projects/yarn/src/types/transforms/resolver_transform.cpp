...
auto lg(logger_factory("yarn.transforms.resolver_transform"));
...
void resolver_transform::resolve_enumerations(intermediate_model& im) {
...
boost::optional<name> resolver_transform::try_resolve_concept_name(name ctx,
