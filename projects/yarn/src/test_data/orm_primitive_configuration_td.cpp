...
orm_primitive_configuration_generator::orm_primitive_configuration_generator() : position_(0) { }

void orm_primitive_configuration_generator::
...
orm_primitive_configuration_generator::result_type
orm_primitive_configuration_generator::create(const unsigned int position) {
    orm_primitive_configuration r;
    orm_primitive_configuration_generator::populate(position, r);
    return r;
}

orm_primitive_configuration_generator::result_type*
orm_primitive_configuration_generator::create_ptr(const unsigned int position) {
    orm_primitive_configuration* p = new orm_primitive_configuration();
    orm_primitive_configuration_generator::populate(position, *p);
    return p;
}

orm_primitive_configuration_generator::result_type
orm_primitive_configuration_generator::operator()() {
