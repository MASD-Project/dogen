...
#include "dogen/yarn/test_data/mapping_repository_td.hpp"
...
mapping_repository_generator::mapping_repository_generator() : position_(0) { }

void mapping_repository_generator::
populate(const unsigned int position, result_type& v) {
    v.by_upsilon_id(create_std_unordered_map_dogen_yarn_languages_std_unordered_map_std_string_dogen_yarn_name(position + 0));
...
mapping_repository_generator::result_type
mapping_repository_generator::create(const unsigned int position) {
    mapping_repository r;
    mapping_repository_generator::populate(position, r);
    return r;
}

mapping_repository_generator::result_type*
mapping_repository_generator::create_ptr(const unsigned int position) {
    mapping_repository* p = new mapping_repository();
    mapping_repository_generator::populate(position, *p);
    return p;
}

mapping_repository_generator::result_type
mapping_repository_generator::operator()() {
