...
populate(const unsigned int position, result_type& v) {
    ...
    v.external_modules(create_dogen_yarn_meta_model_path_contribution_types(position + 2));
    v.model_modules(create_dogen_yarn_meta_model_path_contribution_types(position + 3));
    v.internal_modules(create_dogen_yarn_meta_model_path_contribution_types(position + 4));
