...
dogen::yarn::node*
create_dogen_yarn_node_ptr(const unsigned int) {
    return nullptr;
}

boost::shared_ptr<dogen::yarn::node>
create_boost_shared_ptr_dogen_yarn_node(unsigned int position) {
    boost::shared_ptr<dogen::yarn::node> r(
        create_dogen_yarn_node_ptr(position));
    return r;
}
