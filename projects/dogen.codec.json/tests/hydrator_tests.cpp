...
#include "dogen.codec.json/types/hydration_error.hpp"
#include "dogen.codec.json/types/hydrator.hpp"
#include "dogen.utility/types/test/exception_checkers.hpp"

namespace {

const std::string test_module("dogen.codec.json.tests");
...
dogen::codec::entities::model hydrate(std::istream& s) {
    dogen::codec::json::hydrator h;
    return h.hydrate(s);
}
...
using dogen::codec::json::hydration_error;
