 ...
 *
 */
#ifndef DOGEN_M2T_CSHARP_TYPES_TRANSFORMS_HELPER_TRANSFORM_HPP
#define DOGEN_M2T_CSHARP_TYPES_TRANSFORMS_HELPER_TRANSFORM_HPP
...
#include <list>
#include <string>
#include "dogen.m2t.csharp/types/transforms/assistant_fwd.hpp"
