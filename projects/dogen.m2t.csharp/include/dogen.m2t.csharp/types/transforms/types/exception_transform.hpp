 ...
 *
 */
#ifndef DOGEN_M2T_CSHARP_TYPES_TRANSFORMS_TYPES_EXCEPTION_TRANSFORM_HPP
#define DOGEN_M2T_CSHARP_TYPES_TRANSFORMS_TYPES_EXCEPTION_TRANSFORM_HPP
...
class exception_transform final : public model_to_text_transform {
public:
