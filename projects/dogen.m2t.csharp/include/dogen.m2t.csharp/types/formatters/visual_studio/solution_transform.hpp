 ...
 *
 */
#ifndef DOGEN_M2T_CSHARP_TYPES_FORMATTERS_VISUAL_STUDIO_SOLUTION_TRANSFORM_HPP
#define DOGEN_M2T_CSHARP_TYPES_FORMATTERS_VISUAL_STUDIO_SOLUTION_TRANSFORM_HPP
...
class solution_transform final : public model_to_text_transform {
public:
