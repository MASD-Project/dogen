 ...
 *
 */
#ifndef DOGEN_M2T_CSHARP_TYPES_FORMATTERS_VISUAL_STUDIO_PROJECT_TRANSFORM_HPP
#define DOGEN_M2T_CSHARP_TYPES_FORMATTERS_VISUAL_STUDIO_PROJECT_TRANSFORM_HPP
...
class project_transform final : public model_to_text_transform {
public:
