 ...
 *
 */
#ifndef DOGEN_M2T_CSHARP_TYPES_FORMATTERS_TYPES_FLOATING_POINT_NUMBER_HELPER_HPP
#define DOGEN_M2T_CSHARP_TYPES_FORMATTERS_TYPES_FLOATING_POINT_NUMBER_HELPER_HPP
