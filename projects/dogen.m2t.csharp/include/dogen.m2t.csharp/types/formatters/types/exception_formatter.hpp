 ...
 *
 */
#ifndef DOGEN_M2T_CSHARP_TYPES_FORMATTERS_TYPES_EXCEPTION_FORMATTER_HPP
#define DOGEN_M2T_CSHARP_TYPES_FORMATTERS_TYPES_EXCEPTION_FORMATTER_HPP
...
class exception_formatter final : public model_to_text_transform {
public:
