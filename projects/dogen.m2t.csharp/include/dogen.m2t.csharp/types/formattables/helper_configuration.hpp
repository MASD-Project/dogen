 ...
 *
 */
#ifndef DOGEN_M2T_CSHARP_TYPES_FORMATTABLES_HELPER_CONFIGURATION_HPP
#define DOGEN_M2T_CSHARP_TYPES_FORMATTABLES_HELPER_CONFIGURATION_HPP
...
template<>
inline void swap(
    dogen::m2t::csharp::formattables::helper_configuration& lhs,
    dogen::m2t::csharp::formattables::helper_configuration& rhs) {
    lhs.swap(rhs);
}
