 ...
 *
 */
#ifndef DOGEN_M2T_CSHARP_TYPES_FORMATTABLES_ASPECT_PROPERTIES_HPP
#define DOGEN_M2T_CSHARP_TYPES_FORMATTABLES_ASPECT_PROPERTIES_HPP
...
template<>
inline void swap(
    dogen::m2t::csharp::formattables::aspect_properties& lhs,
    dogen::m2t::csharp::formattables::aspect_properties& rhs) {
    lhs.swap(rhs);
}
