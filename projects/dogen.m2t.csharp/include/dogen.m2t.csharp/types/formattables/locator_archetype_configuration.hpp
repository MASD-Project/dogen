 ...
 *
 */
#ifndef DOGEN_M2T_CSHARP_TYPES_FORMATTABLES_LOCATOR_ARCHETYPE_CONFIGURATION_HPP
#define DOGEN_M2T_CSHARP_TYPES_FORMATTABLES_LOCATOR_ARCHETYPE_CONFIGURATION_HPP
...
template<>
inline void swap(
    dogen::m2t::csharp::formattables::locator_archetype_configuration& lhs,
    dogen::m2t::csharp::formattables::locator_archetype_configuration& rhs) {
    lhs.swap(rhs);
}
