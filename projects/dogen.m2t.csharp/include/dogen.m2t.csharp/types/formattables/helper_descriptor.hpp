 ...
 *
 */
#ifndef DOGEN_M2T_CSHARP_TYPES_FORMATTABLES_HELPER_DESCRIPTOR_HPP
#define DOGEN_M2T_CSHARP_TYPES_FORMATTABLES_HELPER_DESCRIPTOR_HPP
...
template<>
inline void swap(
    dogen::m2t::csharp::formattables::helper_descriptor& lhs,
    dogen::m2t::csharp::formattables::helper_descriptor& rhs) {
    lhs.swap(rhs);
}
