 ...
 *
 */
#ifndef DOGEN_M2T_CSHARP_TYPES_FORMATTABLES_ARTEFACT_PROPERTIES_HPP
#define DOGEN_M2T_CSHARP_TYPES_FORMATTABLES_ARTEFACT_PROPERTIES_HPP
...
template<>
inline void swap(
    dogen::m2t::csharp::formattables::artefact_properties& lhs,
    dogen::m2t::csharp::formattables::artefact_properties& rhs) {
    lhs.swap(rhs);
}
