...
const dogen::m2t::csharp::formattables::helper_descriptor& helper_properties::current() const {
    return current_;
}

dogen::m2t::csharp::formattables::helper_descriptor& helper_properties::current() {
    return current_;
}

void helper_properties::current(const dogen::m2t::csharp::formattables::helper_descriptor& v) {
    current_ = v;
}
...
const std::list<dogen::m2t::csharp::formattables::helper_descriptor>& helper_properties::direct_descendants() const {
    return direct_descendants_;
}

std::list<dogen::m2t::csharp::formattables::helper_descriptor>& helper_properties::direct_descendants() {
    return direct_descendants_;
}

void helper_properties::direct_descendants(const std::list<dogen::m2t::csharp::formattables::helper_descriptor>& v) {
