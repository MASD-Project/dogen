...
#include "dogen.m2t.csharp/types/formatters/test_data/traits.hpp"
...
physical::entities::location class_formatter::archetype_location() const {
...
const logical::entities::name& class_formatter::meta_name() const {
...
physical::entities::artefact class_formatter::format(
