...
#ifdef __linux__
template void save(eos::portable_oarchive& ar, const dogen::sml_to_cpp::relationships& v, unsigned int version);
template void load(eos::portable_iarchive& ar, dogen::sml_to_cpp::relationships& v, unsigned int version);
#endif
