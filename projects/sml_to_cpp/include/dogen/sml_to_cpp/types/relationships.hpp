 ...
 *
 */
#ifndef DOGEN_SML_TO_CPP_TYPES_RELATIONSHIPS_HPP
#define DOGEN_SML_TO_CPP_TYPES_RELATIONSHIPS_HPP
...
template<>
inline void swap(
    dogen::sml_to_cpp::relationships& lhs,
    dogen::sml_to_cpp::relationships& rhs) {
    lhs.swap(rhs);
}
