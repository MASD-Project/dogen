 ...
 *
 */
#ifndef DOGEN_GENERATION_TYPES_ENTITIES_ARTEFACT_PROPERTIES_HPP
#define DOGEN_GENERATION_TYPES_ENTITIES_ARTEFACT_PROPERTIES_HPP
...
public:
    ...
    dogen::generation::entities::formatting_styles formatting_style() const;
    void formatting_style(const dogen::generation::entities::formatting_styles v);
...
private:
    ...
    dogen::generation::entities::formatting_styles formatting_style_;
...
template<>
inline void swap(
    dogen::generation::entities::artefact_properties& lhs,
    dogen::generation::entities::artefact_properties& rhs) {
    lhs.swap(rhs);
}
