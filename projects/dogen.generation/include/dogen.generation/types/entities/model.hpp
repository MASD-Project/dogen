 ...
 *
 */
#ifndef DOGEN_GENERATION_TYPES_ENTITIES_MODEL_HPP
#define DOGEN_GENERATION_TYPES_ENTITIES_MODEL_HPP
...
public:
    ...
    const std::unordered_set<dogen::generation::entities::element_archetype>& enabled_archetype_for_element() const;
    std::unordered_set<dogen::generation::entities::element_archetype>& enabled_archetype_for_element();
...
template<>
inline void swap(
    dogen::generation::entities::model& lhs,
    dogen::generation::entities::model& rhs) {
    lhs.swap(rhs);
}
