 ...
 *
 */
#ifndef DOGEN_GENERATION_TYPES_ENTITIES_ELEMENT_ARCHETYPE_HPP
#define DOGEN_GENERATION_TYPES_ENTITIES_ELEMENT_ARCHETYPE_HPP
...
template<>
inline void swap(
    dogen::generation::entities::element_archetype& lhs,
    dogen::generation::entities::element_archetype& rhs) {
    lhs.swap(rhs);
}
