 ...
 *
 */
#ifndef DOGEN_GENERATION_TYPES_ENTITIES_ARCHETYPE_PROPERTIES_HPP
#define DOGEN_GENERATION_TYPES_ENTITIES_ARCHETYPE_PROPERTIES_HPP
...
template<>
inline void swap(
    dogen::generation::entities::archetype_properties& lhs,
    dogen::generation::entities::archetype_properties& rhs) {
    lhs.swap(rhs);
}
