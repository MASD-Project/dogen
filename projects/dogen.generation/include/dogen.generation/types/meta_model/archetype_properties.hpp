...
#include "dogen.generation/serialization/meta_model/archetype_properties_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::generation::meta_model::archetype_properties& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::generation::meta_model::archetype_properties& v, unsigned int version);
