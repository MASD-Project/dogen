 ...
 *
 */
#ifndef DOGEN_GENERATION_TYPES_META_MODEL_FACET_PROPERTIES_HPP
#define DOGEN_GENERATION_TYPES_META_MODEL_FACET_PROPERTIES_HPP
...
#include <string>
#include <algorithm>
#include "dogen.generation/serialization/meta_model/facet_properties_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::generation::meta_model::facet_properties& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::generation::meta_model::facet_properties& v, unsigned int version);
...
template<>
inline void swap(
    dogen::generation::meta_model::facet_properties& lhs,
    dogen::generation::meta_model::facet_properties& rhs) {
    lhs.swap(rhs);
}
