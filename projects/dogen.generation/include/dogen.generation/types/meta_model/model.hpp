...
public:
    ...
    const std::vector<boost::shared_ptr<dogen::coding::meta_model::element> >& elements() const;
    std::vector<boost::shared_ptr<dogen::coding::meta_model::element> >& elements();
    void elements(const std::vector<boost::shared_ptr<dogen::coding::meta_model::element> >& v);
    void elements(const std::vector<boost::shared_ptr<dogen::coding::meta_model::element> >&& v);
     ...
     */
    /**@{*/
    dogen::coding::meta_model::technical_space output_technical_space() const;
    void output_technical_space(const dogen::coding::meta_model::technical_space v);
    /**@}*/
     ...
     */
    /**@{*/
    const std::unordered_set<dogen::coding::meta_model::technical_space>& all_technical_spaces() const;
    std::unordered_set<dogen::coding::meta_model::technical_space>& all_technical_spaces();
    void all_technical_spaces(const std::unordered_set<dogen::coding::meta_model::technical_space>& v);
    void all_technical_spaces(const std::unordered_set<dogen::coding::meta_model::technical_space>&& v);
    /**@}*/
...
private:
    ...
    std::vector<boost::shared_ptr<dogen::coding::meta_model::element> > elements_;
    ...
    dogen::coding::meta_model::technical_space output_technical_space_;
    std::unordered_set<dogen::coding::meta_model::technical_space> all_technical_spaces_;
