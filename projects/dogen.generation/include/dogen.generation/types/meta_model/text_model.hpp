 ...
 *
 */
#ifndef DOGEN_GENERATION_TYPES_META_MODEL_TEXT_MODEL_HPP
#define DOGEN_GENERATION_TYPES_META_MODEL_TEXT_MODEL_HPP
...
public:
    ...
    std::list<dogen::generation::meta_model::artefact>& artefacts();
    void artefacts(const std::list<dogen::generation::meta_model::artefact>& v);
    void artefacts(const std::list<dogen::generation::meta_model::artefact>&& v);
...
private:
    std::list<dogen::generation::meta_model::artefact> artefacts_;
...
template<>
inline void swap(
    dogen::generation::meta_model::text_model& lhs,
    dogen::generation::meta_model::text_model& rhs) {
    lhs.swap(rhs);
}
