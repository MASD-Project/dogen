 ...
 *
 */
#ifndef DOGEN_GENERATION_TYPES_TRANSFORMS_DECORATION_CONFIGURATION_HPP
#define DOGEN_GENERATION_TYPES_TRANSFORMS_DECORATION_CONFIGURATION_HPP
...
template<>
inline void swap(
    dogen::generation::transforms::decoration_configuration& lhs,
    dogen::generation::transforms::decoration_configuration& rhs) {
    lhs.swap(rhs);
}
