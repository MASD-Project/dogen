 ...
 *
 */
#ifndef DOGEN_GENERATION_TYPES_FORMATTERS_DECORATION_FORMATTER_HPP
#define DOGEN_GENERATION_TYPES_FORMATTERS_DECORATION_FORMATTER_HPP
...
public:
    void format_preamble(std::ostream& s, const comment_style& single_line_cs,
        ...
        const std::string& origin_shah1_hash,
        const boost::shared_ptr<
        logical::meta_model::decoration::modeline> ml, const
        boost::shared_ptr<
        logical::meta_model::decoration::generation_marker> gm) const;
