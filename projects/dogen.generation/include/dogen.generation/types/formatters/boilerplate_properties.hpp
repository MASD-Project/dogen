 ...
 *
 */
#ifndef DOGEN_GENERATION_TYPES_FORMATTERS_BOILERPLATE_PROPERTIES_HPP
#define DOGEN_GENERATION_TYPES_FORMATTERS_BOILERPLATE_PROPERTIES_HPP
...
template<>
inline void swap(
    dogen::generation::formatters::boilerplate_properties& lhs,
    dogen::generation::formatters::boilerplate_properties& rhs) {
    lhs.swap(rhs);
}
