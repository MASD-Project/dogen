 ...
 *
 */
#ifndef DOGEN_GENERATION_TYPES_FORMATTERS_INFIX_CONFIGURATION_HPP
#define DOGEN_GENERATION_TYPES_FORMATTERS_INFIX_CONFIGURATION_HPP
...
template<>
inline void swap(
    dogen::generation::formatters::infix_configuration& lhs,
    dogen::generation::formatters::infix_configuration& rhs) {
    lhs.swap(rhs);
}
