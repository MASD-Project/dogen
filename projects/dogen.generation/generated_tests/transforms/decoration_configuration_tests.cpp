...
#include "dogen.generation/io/transforms/decoration_configuration_io.hpp"
...
BOOST_AUTO_TEST_SUITE(transforms_decoration_configuration_tests)

BOOST_AUTO_TEST_CASE(identical_objects_are_equal) {
    dogen::generation::transforms::decoration_configuration_generator g;
    const auto a(g());
    const auto b(a);
...
BOOST_AUTO_TEST_CASE(moved_objects_are_equal) {
    ...
    g();
    auto a(g());
    const auto b = dogen::generation::transforms::decoration_configuration();
    const auto c(a);
    BOOST_CHECK(a != b);
    BOOST_CHECK(a == c);
...
BOOST_AUTO_TEST_CASE(assigned_objects_are_equal) {
    ...
    g();
    const auto a(g());
    dogen::generation::transforms::decoration_configuration b;
    BOOST_CHECK(a != b);
...
BOOST_AUTO_TEST_CASE(copy_constructed_objects_are_equal) {
    ...
    b = dogen::generation::transforms::decoration_configuration();
    BOOST_CHECK(a != b);
}
