...
populate(const unsigned int position, result_type& v) {
    v.artefact_properties(create_std_unordered_map_std_string_dogen_generation_meta_model_artefact_properties(position + 0));
    v.archetype_location_properties(create_std_unordered_map_std_string_dogen_generation_meta_model_local_archetype_location_properties(position + 1));
}
