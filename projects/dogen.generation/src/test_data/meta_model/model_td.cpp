...
populate(const unsigned int position, result_type& v) {
    ...
    v.enabled_archetype_for_element(create_std_unordered_set_dogen_generation_meta_model_element_archetype(position + 11));
    v.locator_properties(create_dogen_generation_meta_model_locator_properties(position + 12));
    v.global_archetype_location_properties(create_dogen_generation_meta_model_global_archetype_location_properties(position + 13));
}
