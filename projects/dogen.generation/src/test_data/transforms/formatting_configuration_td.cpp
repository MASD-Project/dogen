...
dogen::generation::meta_model::formatting_styles
create_dogen_generation_meta_model_formatting_styles(const unsigned int position) {
    return dogen::generation::meta_model::formatting_styles_generator::create(position);
}
...
populate(const unsigned int position, result_type& v) {
    v.style(create_dogen_generation_meta_model_formatting_styles(position + 0));
