...
dogen::coding::meta_model::technical_space boilerplate_properties::technical_space() const {
    return technical_space_;
}

void boilerplate_properties::technical_space(const dogen::coding::meta_model::technical_space v) {
    technical_space_ = v;
}
