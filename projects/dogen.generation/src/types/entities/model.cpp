...
const std::unordered_set<dogen::generation::entities::element_archetype>& model::enabled_archetype_for_element() const {
    return enabled_archetype_for_element_;
}

std::unordered_set<dogen::generation::entities::element_archetype>& model::enabled_archetype_for_element() {
    return enabled_archetype_for_element_;
}
...
dogen::generation::entities::global_archetype_location_properties& model::global_archetype_location_properties() {
    return global_archetype_location_properties_;
}

void model::global_archetype_location_properties(const dogen::generation::entities::global_archetype_location_properties& v) {
