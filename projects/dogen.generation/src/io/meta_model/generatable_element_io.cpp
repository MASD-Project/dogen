...
std::ostream& operator<<(std::ostream& s, const generatable_element& v) {
    s << " { "
      << "\"__type__\": " << "\"dogen::generation::meta_model::generatable_element\"" << ", "
      << "\"modeling_element\": " << v.modeling_element() << ", "
