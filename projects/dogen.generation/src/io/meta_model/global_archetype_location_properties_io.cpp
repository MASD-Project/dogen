...
inline std::ostream& operator<<(std::ostream& s, const std::unordered_map<std::string, dogen::generation::meta_model::backend_properties>& v) {
    s << "[";
...
inline std::ostream& operator<<(std::ostream& s, const std::unordered_map<std::string, dogen::generation::meta_model::facet_properties>& v) {
    s << "[";
    for (auto i(v.begin()); i != v.end(); ++i) {
        if (i != v.begin()) s << ", ";
        s << "[ { " << "\"__type__\": " << "\"key\"" << ", " << "\"data\": ";
...
inline std::ostream& operator<<(std::ostream& s, const std::unordered_map<std::string, dogen::generation::meta_model::archetype_properties>& v) {
    s << "[";
    for (auto i(v.begin()); i != v.end(); ++i) {
        if (i != v.begin()) s << ", ";
        s << "[ { " << "\"__type__\": " << "\"key\"" << ", " << "\"data\": ";
...
inline std::ostream& operator<<(std::ostream& s, const std::unordered_map<std::string, dogen::generation::meta_model::denormalised_archetype_properties>& v) {
    s << "[";
    for (auto i(v.begin()); i != v.end(); ++i) {
        if (i != v.begin()) s << ", ";
        s << "[ { " << "\"__type__\": " << "\"key\"" << ", " << "\"data\": ";
...
std::ostream& operator<<(std::ostream& s, const global_archetype_location_properties& v) {
    s << " { "
      << "\"__type__\": " << "\"dogen::generation::meta_model::global_archetype_location_properties\"" << ", "
