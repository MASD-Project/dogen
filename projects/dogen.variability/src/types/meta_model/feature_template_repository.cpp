...
feature_template_repository::feature_template_repository(const std::list<dogen::variability::meta_model::feature_template>& templates)
...
const std::list<dogen::variability::meta_model::feature_template>& feature_template_repository::templates() const {
    return templates_;
}

std::list<dogen::variability::meta_model::feature_template>& feature_template_repository::templates() {
    return templates_;
}

void feature_template_repository::templates(const std::list<dogen::variability::meta_model::feature_template>& v) {
    templates_ = v;
}
