...
void element::to_stream(std::ostream& s) const {
    s << " { "
      << "\"__type__\": " << "\"dogen::variability::meta_model::element\"" << ", "
      << "\"name\": " << name_ << ", "
...
const dogen::variability::meta_model::name& element::name() const {
    return name_;
}

dogen::variability::meta_model::name& element::name() {
    return name_;
}

void element::name(const dogen::variability::meta_model::name& v) {
    name_ = v;
}
