...
#include "dogen.variability/io/meta_model/potential_binding_io.hpp"
...
inline std::ostream& operator<<(std::ostream& s, const std::list<dogen::variability::meta_model::potential_binding>& v) {
    s << "[ ";
    for (auto i(v.begin()); i != v.end(); ++i) {
        if (i != v.begin()) s << ", ";
        s << *i;
...
configuration::configuration()
    : source_binding_point_(static_cast<dogen::variability::meta_model::binding_point>(0)),
...
void configuration::to_stream(std::ostream& s) const {
    ...
    s << " { "
      << "\"__type__\": " << "\"dogen::variability::meta_model::configuration\"" << ", "
      << "\"__parent_0__\": ";
...
bool configuration::equals(const dogen::variability::meta_model::element& other) const {
...
const std::unordered_map<std::string, dogen::variability::meta_model::configuration_point>& configuration::configuration_points() const {
    return configuration_points_;
}

std::unordered_map<std::string, dogen::variability::meta_model::configuration_point>& configuration::configuration_points() {
    return configuration_points_;
}

void configuration::configuration_points(const std::unordered_map<std::string, dogen::variability::meta_model::configuration_point>& v) {
...
const std::list<dogen::variability::meta_model::potential_binding>& configuration::profile_bindings() const {
    return profile_bindings_;
}

std::list<dogen::variability::meta_model::potential_binding>& configuration::profile_bindings() {
    return profile_bindings_;
}

void configuration::profile_bindings(const std::list<dogen::variability::meta_model::potential_binding>& v) {
    profile_bindings_ = v;
}
...
const std::list<dogen::variability::meta_model::potential_binding>& configuration::configuration_bindings() const {
    return configuration_bindings_;
}

std::list<dogen::variability::meta_model::potential_binding>& configuration::configuration_bindings() {
    return configuration_bindings_;
}

void configuration::configuration_bindings(const std::list<dogen::variability::meta_model::potential_binding>& v) {
...
dogen::variability::meta_model::binding_point configuration::source_binding_point() const {
    return source_binding_point_;
}

void configuration::source_binding_point(const dogen::variability::meta_model::binding_point v) {
