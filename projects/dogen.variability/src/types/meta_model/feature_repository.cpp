...
feature_repository::feature_repository(const std::list<dogen::variability::meta_model::feature>& features)
    : features_(features) { }
...
const std::list<dogen::variability::meta_model::feature>& feature_repository::features() const {
    return features_;
}

std::list<dogen::variability::meta_model::feature>& feature_repository::features() {
    return features_;
}

void feature_repository::features(const std::list<dogen::variability::meta_model::feature>& v) {
    features_ = v;
}
