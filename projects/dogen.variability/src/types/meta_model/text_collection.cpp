...
void text_collection::to_stream(std::ostream& s) const {
    s << " { "
      << "\"__type__\": " << "\"dogen::variability::meta_model::text_collection\"" << ", "
      << "\"__parent_0__\": ";
    dogen::variability::meta_model::value::to_stream(s);
    s << ", "
      << "\"content\": " << content_
      << " }";
}
...
void text_collection::swap(text_collection& other) noexcept {
    dogen::variability::meta_model::value::swap(other);

    using std::swap;
    swap(content_, other.content_);
}

bool text_collection::equals(const dogen::variability::meta_model::value& other) const {
...
bool text_collection::operator==(const text_collection& rhs) const {
    return dogen::variability::meta_model::value::compare(rhs) &&
