...
const std::unordered_map<std::string, std::list<dogen::variability::meta_model::feature> >& feature_model::by_facet_name() const {
    return by_facet_name_;
}

std::unordered_map<std::string, std::list<dogen::variability::meta_model::feature> >& feature_model::by_facet_name() {
    return by_facet_name_;
}

void feature_model::by_facet_name(const std::unordered_map<std::string, std::list<dogen::variability::meta_model::feature> >& v) {
    by_facet_name_ = v;
}
...
const std::unordered_map<std::string, std::list<dogen::variability::meta_model::feature> >& feature_model::by_formatter_name() const {
    return by_formatter_name_;
}

std::unordered_map<std::string, std::list<dogen::variability::meta_model::feature> >& feature_model::by_formatter_name() {
    return by_formatter_name_;
}

void feature_model::by_formatter_name(const std::unordered_map<std::string, std::list<dogen::variability::meta_model::feature> >& v) {
...
const std::unordered_map<std::string, std::list<dogen::variability::meta_model::feature> >& feature_model::by_backend_name() const {
    return by_backend_name_;
}

std::unordered_map<std::string, std::list<dogen::variability::meta_model::feature> >& feature_model::by_backend_name() {
    return by_backend_name_;
}

void feature_model::by_backend_name(const std::unordered_map<std::string, std::list<dogen::variability::meta_model::feature> >& v) {
    by_backend_name_ = v;
}
