...
void configuration_point::to_stream(std::ostream& s) const {
    s << " { "
      << "\"__type__\": " << "\"dogen::variability::meta_model::configuration_point\"" << ", "
      << "\"__parent_0__\": ";
...
bool configuration_point::equals(const dogen::variability::meta_model::element& other) const {
...
const boost::shared_ptr<dogen::variability::meta_model::value>& configuration_point::value() const {
    return value_;
}

boost::shared_ptr<dogen::variability::meta_model::value>& configuration_point::value() {
    return value_;
}

void configuration_point::value(const boost::shared_ptr<dogen::variability::meta_model::value>& v) {
    value_ = v;
}
