...
const boost::shared_ptr<dogen::variability::entities::value>& default_value_override::default_value() const {
    return default_value_;
}

boost::shared_ptr<dogen::variability::entities::value>& default_value_override::default_value() {
    return default_value_;
}

void default_value_override::default_value(const boost::shared_ptr<dogen::variability::entities::value>& v) {
    default_value_ = v;
}
