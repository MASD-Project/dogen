...
create_dogen_variability_entities_feature_template(const unsigned int position) {
    return dogen::variability::entities::feature_template_generator::create(position);
}

std::list<dogen::variability::entities::feature_template> create_std_list_dogen_variability_entities_feature_template(unsigned int position) {
    std::list<dogen::variability::entities::feature_template> r;
    for (unsigned int i(0); i < 4; ++i) {
        r.push_back(create_dogen_variability_entities_feature_template(position + i));
    }
    return r;
}
...
populate(const unsigned int position, result_type& v) {
    v.templates(create_std_list_dogen_variability_entities_feature_template(position + 0));
}
