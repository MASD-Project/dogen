...
#include "dogen.variability/test_data/meta_model/profile_template_repository_td.hpp"

namespace {

dogen::variability::meta_model::profile_template
create_dogen_variability_meta_model_profile_template(const unsigned int position) {
    return dogen::variability::meta_model::profile_template_generator::create(position);
}

std::list<dogen::variability::meta_model::profile_template> create_std_list_dogen_variability_meta_model_profile_template(unsigned int position) {
    std::list<dogen::variability::meta_model::profile_template> r;
    for (unsigned int i(0); i < 4; ++i) {
        r.push_back(create_dogen_variability_meta_model_profile_template(position + i));
    }
    return r;
}
...
populate(const unsigned int position, result_type& v) {
    v.templates(create_std_list_dogen_variability_meta_model_profile_template(position + 0));
}
