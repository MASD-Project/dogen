...
std::unordered_map<std::string, boost::shared_ptr<dogen::variability::meta_model::configuration> > create_std_unordered_map_std_string_boost_shared_ptr_dogen_variability_meta_model_configuration(unsigned int position) {
    std::unordered_map<std::string, boost::shared_ptr<dogen::variability::meta_model::configuration> > r;
    for (unsigned int i(0); i < 4; ++i) {
        r.insert(std::make_pair(create_std_string(position + i), create_boost_shared_ptr_dogen_variability_meta_model_configuration(position + i)));
    }
    return r;
}
...
populate(const unsigned int position, result_type& v) {
    v.global(create_boost_shared_ptr_dogen_variability_meta_model_configuration(position + 0));
    v.local(create_std_unordered_map_std_string_boost_shared_ptr_dogen_variability_meta_model_configuration(position + 1));
}
