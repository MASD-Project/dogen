...
inline std::ostream& operator<<(std::ostream& s, const std::unordered_map<std::string, dogen::variability::entities::profile>& v) {
    s << "[";
...
std::ostream& operator<<(std::ostream& s, const profile_repository& v) {
    s << " { "
      << "\"__type__\": " << "\"dogen::variability::entities::profile_repository\"" << ", "
      << "\"by_name\": " << v.by_name() << ", "
