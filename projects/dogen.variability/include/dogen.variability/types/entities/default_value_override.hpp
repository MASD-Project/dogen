...
#include "dogen.variability/serialization/entities/default_value_override_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::variability::entities::default_value_override& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::variability::entities::default_value_override& v, unsigned int version);
