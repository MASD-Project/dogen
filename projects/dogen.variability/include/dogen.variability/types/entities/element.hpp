...
#include "dogen.variability/serialization/entities/element_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::variability::entities::element& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::variability::entities::element& v, unsigned int version);
