 ...
 *
 */
#ifndef DOGEN_VARIABILITY_TYPES_ENTITIES_PROFILE_TEMPLATE_HPP
#define DOGEN_VARIABILITY_TYPES_ENTITIES_PROFILE_TEMPLATE_HPP
...
public:
    ...
    const std::list<dogen::variability::entities::configuration_point_template>& templates() const;
    std::list<dogen::variability::entities::configuration_point_template>& templates();
    void templates(const std::list<dogen::variability::entities::configuration_point_template>& v);
    void templates(const std::list<dogen::variability::entities::configuration_point_template>&& v);
...
template<>
inline void swap(
    dogen::variability::entities::profile_template& lhs,
    dogen::variability::entities::profile_template& rhs) {
    lhs.swap(rhs);
}
