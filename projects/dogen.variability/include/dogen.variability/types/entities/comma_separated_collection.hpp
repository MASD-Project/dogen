...
#include "dogen.variability/serialization/entities/comma_separated_collection_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::variability::entities::comma_separated_collection& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::variability::entities::comma_separated_collection& v, unsigned int version);
