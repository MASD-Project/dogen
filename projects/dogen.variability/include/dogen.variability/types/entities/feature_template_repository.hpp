...
#include "dogen.variability/serialization/entities/feature_template_repository_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::variability::entities::feature_template_repository& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::variability::entities::feature_template_repository& v, unsigned int version);
