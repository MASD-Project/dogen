 ...
 *
 */
#ifndef DOGEN_VARIABILITY_TYPES_ENTITIES_FEATURE_TEMPLATE_HPP
#define DOGEN_VARIABILITY_TYPES_ENTITIES_FEATURE_TEMPLATE_HPP
...
#include "dogen.variability/types/entities/default_value_override.hpp"
 ...
 */
class feature_template final : public dogen::variability::entities::element {
public:
...
public:
     ...
     */
    /**@{*/
    const std::list<dogen::variability::entities::default_value_override>& default_value_overrides() const;
    std::list<dogen::variability::entities::default_value_override>& default_value_overrides();
    void default_value_overrides(const std::list<dogen::variability::entities::default_value_override>& v);
    void default_value_overrides(const std::list<dogen::variability::entities::default_value_override>&& v);
    /**@}*/
...
template<>
inline void swap(
    dogen::variability::entities::feature_template& lhs,
    dogen::variability::entities::feature_template& rhs) {
    lhs.swap(rhs);
}
