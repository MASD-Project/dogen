...
#include "dogen.variability/serialization/entities/key_value_pair_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::variability::entities::key_value_pair& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::variability::entities::key_value_pair& v, unsigned int version);
