 ...
 *
 */
#ifndef DOGEN_VARIABILITY_TYPES_META_MODEL_KEY_VALUE_PAIR_HPP
#define DOGEN_VARIABILITY_TYPES_META_MODEL_KEY_VALUE_PAIR_HPP
 ...
 */
class key_value_pair final : public dogen::variability::meta_model::value {
public:
...
template<>
inline void swap(
    dogen::variability::meta_model::key_value_pair& lhs,
    dogen::variability::meta_model::key_value_pair& rhs) {
    lhs.swap(rhs);
}
