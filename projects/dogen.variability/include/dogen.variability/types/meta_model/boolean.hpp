 ...
 *
 */
#ifndef DOGEN_VARIABILITY_TYPES_META_MODEL_BOOLEAN_HPP
#define DOGEN_VARIABILITY_TYPES_META_MODEL_BOOLEAN_HPP
 ...
 */
class boolean final : public dogen::variability::meta_model::value {
public:
...
template<>
inline void swap(
    dogen::variability::meta_model::boolean& lhs,
    dogen::variability::meta_model::boolean& rhs) {
    lhs.swap(rhs);
}
