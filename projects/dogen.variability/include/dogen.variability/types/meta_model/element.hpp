 ...
 *
 */
#ifndef DOGEN_VARIABILITY_TYPES_META_MODEL_ELEMENT_HPP
#define DOGEN_VARIABILITY_TYPES_META_MODEL_ELEMENT_HPP
...
public:
    const dogen::variability::meta_model::name& name() const;
    dogen::variability::meta_model::name& name();
    void name(const dogen::variability::meta_model::name& v);
    void name(const dogen::variability::meta_model::name&& v);
...
private:
    dogen::variability::meta_model::name name_;
