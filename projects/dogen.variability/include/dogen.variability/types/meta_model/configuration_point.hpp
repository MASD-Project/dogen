 ...
 *
 */
#ifndef DOGEN_VARIABILITY_TYPES_META_MODEL_CONFIGURATION_POINT_HPP
#define DOGEN_VARIABILITY_TYPES_META_MODEL_CONFIGURATION_POINT_HPP
 ...
 */
class configuration_point final : public dogen::variability::meta_model::element {
public:
...
template<>
inline void swap(
    dogen::variability::meta_model::configuration_point& lhs,
    dogen::variability::meta_model::configuration_point& rhs) {
    lhs.swap(rhs);
}
