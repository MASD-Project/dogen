 ...
 *
 */
#ifndef DOGEN_VARIABILITY_TYPES_META_MODEL_CONFIGURATION_POINT_TEMPLATE_HPP
#define DOGEN_VARIABILITY_TYPES_META_MODEL_CONFIGURATION_POINT_TEMPLATE_HPP
...
template<>
inline void swap(
    dogen::variability::meta_model::configuration_point_template& lhs,
    dogen::variability::meta_model::configuration_point_template& rhs) {
    lhs.swap(rhs);
}
