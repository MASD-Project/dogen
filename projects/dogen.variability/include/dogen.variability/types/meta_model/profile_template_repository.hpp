 ...
 *
 */
#ifndef DOGEN_VARIABILITY_TYPES_META_MODEL_PROFILE_TEMPLATE_REPOSITORY_HPP
#define DOGEN_VARIABILITY_TYPES_META_MODEL_PROFILE_TEMPLATE_REPOSITORY_HPP
...
public:
    explicit profile_template_repository(const std::list<dogen::variability::meta_model::profile_template>& templates);
...
template<>
inline void swap(
    dogen::variability::meta_model::profile_template_repository& lhs,
    dogen::variability::meta_model::profile_template_repository& rhs) {
    lhs.swap(rhs);
}
