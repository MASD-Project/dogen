 ...
 *
 */
#ifndef DOGEN_VARIABILITY_TYPES_META_MODEL_TEXT_COLLECTION_HPP
#define DOGEN_VARIABILITY_TYPES_META_MODEL_TEXT_COLLECTION_HPP
 ...
 */
class text_collection final : public dogen::variability::meta_model::value {
public:
...
public:
    bool equals(const dogen::variability::meta_model::value& other) const override;
...
template<>
inline void swap(
    dogen::variability::meta_model::text_collection& lhs,
    dogen::variability::meta_model::text_collection& rhs) {
    lhs.swap(rhs);
}
