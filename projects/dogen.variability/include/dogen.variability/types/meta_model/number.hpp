 ...
 *
 */
#ifndef DOGEN_VARIABILITY_TYPES_META_MODEL_NUMBER_HPP
#define DOGEN_VARIABILITY_TYPES_META_MODEL_NUMBER_HPP
 ...
 */
class number final : public dogen::variability::meta_model::value {
public:
...
template<>
inline void swap(
    dogen::variability::meta_model::number& lhs,
    dogen::variability::meta_model::number& rhs) {
    lhs.swap(rhs);
}
