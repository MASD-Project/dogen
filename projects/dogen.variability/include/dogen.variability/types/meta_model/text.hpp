 ...
 *
 */
#ifndef DOGEN_VARIABILITY_TYPES_META_MODEL_TEXT_HPP
#define DOGEN_VARIABILITY_TYPES_META_MODEL_TEXT_HPP
 ...
 */
class text final : public dogen::variability::meta_model::value {
public:
    text() = default;
...
template<>
inline void swap(
    dogen::variability::meta_model::text& lhs,
    dogen::variability::meta_model::text& rhs) {
    lhs.swap(rhs);
}
