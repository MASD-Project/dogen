...
public:
    /**
     * @brief Processes the content as a comma-separated collection
     * value, and returns the collection.
     *
     * @pre @v must be of comma-separated type.
     */
    static std::list<std::list<std::string>>
    get_comma_separated_collection_content(const entities::value& v);

    /**
     * @brief Retrieves the configuration point associated with the
     * supplied qualified name or feature, and returns the contents of
     * its value as a comma-separated collection.
     *
     * @pre has_configuration_point must be true.
     * @pre Configuration point for qualified name or feature must
     * exist.
     ...
     */
    std::list<std::list<std::string>>
    get_comma_separated_collection_content_or_default(
