...
#include "dogen.variability/hash/transforms/profile_repository_inputs_hash.hpp"
...
BOOST_AUTO_TEST_SUITE(transforms_profile_repository_inputs_tests)

BOOST_AUTO_TEST_CASE(identical_objects_are_equal) {
    dogen::variability::transforms::profile_repository_inputs_generator g;
    const auto a(g());
    const auto b(a);
...
BOOST_AUTO_TEST_CASE(moved_objects_are_equal) {
    ...
    g();
    auto a(g());
    const auto b = dogen::variability::transforms::profile_repository_inputs();
    const auto c(a);
    BOOST_CHECK(a != b);
    BOOST_CHECK(a == c);
...
BOOST_AUTO_TEST_CASE(assigned_objects_are_equal) {
    ...
    g();
    const auto a(g());
    dogen::variability::transforms::profile_repository_inputs b;
    BOOST_CHECK(a != b);
...
BOOST_AUTO_TEST_CASE(copy_constructed_objects_are_equal) {
    ...
    b = dogen::variability::transforms::profile_repository_inputs();
    BOOST_CHECK(a != b);
}
...
BOOST_AUTO_TEST_CASE(xml_roundtrip_produces_the_same_entity) {
    ...
    dogen::variability::transforms::profile_repository_inputs b = dogen::variability::transforms::profile_repository_inputs();
...
BOOST_AUTO_TEST_CASE(equal_objects_generate_the_same_hash) {
    ...
    std::hash<dogen::variability::transforms::profile_repository_inputs> hasher;
