...
#include "dogen.variability/lexical_cast/entities/binding_action_lc.hpp"
...
BOOST_AUTO_TEST_CASE(inserter_operator_produces_valid_json) {
    dogen::variability::entities::binding_action_generator g;
    const auto a(g());
    std::stringstream s;
    s << a;
...
BOOST_AUTO_TEST_CASE(xml_roundtrip_produces_the_same_entity) {
    ...
    dogen::variability::entities::binding_action b = dogen::variability::entities::binding_action();
...
BOOST_AUTO_TEST_CASE(equal_enums_generate_the_same_hash) {
    ...
    std::hash<dogen::variability::entities::binding_action> hasher;
