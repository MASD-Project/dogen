...
#include "dogen.variability/hash/entities/configuration_point_template_hash.hpp"
...
BOOST_AUTO_TEST_SUITE(entities_configuration_point_template_tests)

BOOST_AUTO_TEST_CASE(identical_objects_are_equal) {
    dogen::variability::entities::configuration_point_template_generator g;
    const auto a(g());
    const auto b(a);
...
BOOST_AUTO_TEST_CASE(moved_objects_are_equal) {
    ...
    g();
    auto a(g());
    const auto b = dogen::variability::entities::configuration_point_template();
    const auto c(a);
    BOOST_CHECK(a != b);
    BOOST_CHECK(a == c);
...
BOOST_AUTO_TEST_CASE(assigned_objects_are_equal) {
    ...
    g();
    const auto a(g());
    dogen::variability::entities::configuration_point_template b;
    BOOST_CHECK(a != b);
...
BOOST_AUTO_TEST_CASE(copy_constructed_objects_are_equal) {
    ...
    b = dogen::variability::entities::configuration_point_template();
    BOOST_CHECK(a != b);
}
...
BOOST_AUTO_TEST_CASE(xml_roundtrip_produces_the_same_entity) {
    ...
    dogen::variability::entities::configuration_point_template b = dogen::variability::entities::configuration_point_template();
...
BOOST_AUTO_TEST_CASE(equal_objects_generate_the_same_hash) {
    ...
    std::hash<dogen::variability::entities::configuration_point_template> hasher;
