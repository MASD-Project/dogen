...
#include "dogen.variability/hash/entities/configuration_model_set_hash.hpp"
...
BOOST_AUTO_TEST_SUITE(entities_configuration_model_set_tests)

BOOST_AUTO_TEST_CASE(identical_objects_are_equal) {
    dogen::variability::entities::configuration_model_set_generator g;
    const auto a(g());
    const auto b(a);
...
BOOST_AUTO_TEST_CASE(moved_objects_are_equal) {
    ...
    g();
    auto a(g());
    const auto b = dogen::variability::entities::configuration_model_set();
    const auto c(a);
    BOOST_CHECK(a != b);
    BOOST_CHECK(a == c);
...
BOOST_AUTO_TEST_CASE(assigned_objects_are_equal) {
    ...
    g();
    const auto a(g());
    dogen::variability::entities::configuration_model_set b;
    BOOST_CHECK(a != b);
...
BOOST_AUTO_TEST_CASE(copy_constructed_objects_are_equal) {
    ...
    b = dogen::variability::entities::configuration_model_set();
    BOOST_CHECK(a != b);
}
...
BOOST_AUTO_TEST_CASE(xml_roundtrip_produces_the_same_entity) {
    ...
    dogen::variability::entities::configuration_model_set b = dogen::variability::entities::configuration_model_set();
...
BOOST_AUTO_TEST_CASE(equal_objects_generate_the_same_hash) {
    ...
    std::hash<dogen::variability::entities::configuration_model_set> hasher;
