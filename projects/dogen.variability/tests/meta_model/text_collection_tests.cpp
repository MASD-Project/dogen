...
BOOST_AUTO_TEST_SUITE(meta_model_text_collection_tests)

BOOST_AUTO_TEST_CASE(identical_objects_are_equal) {
    dogen::variability::meta_model::text_collection_generator g;
    const auto a(g());
    const auto b(a);
...
BOOST_AUTO_TEST_CASE(moved_objects_are_equal) {
    ...
    g();
    auto a(g());
    const auto b = dogen::variability::meta_model::text_collection();
    const auto c(a);
    BOOST_CHECK(a != b);
    BOOST_CHECK(a == c);
...
BOOST_AUTO_TEST_CASE(assigned_objects_are_equal) {
    ...
    g();
    const auto a(g());
    dogen::variability::meta_model::text_collection b;
    BOOST_CHECK(a != b);
...
BOOST_AUTO_TEST_CASE(copy_constructed_objects_are_equal) {
    ...
    b = dogen::variability::meta_model::text_collection();
    BOOST_CHECK(a != b);
}
