 ...
 *
 */
#ifndef DOGEN_FORMATTERS_TYPES_DECORATION_ANNOTATIONS_FACTORY_HPP
#define DOGEN_FORMATTERS_TYPES_DECORATION_ANNOTATIONS_FACTORY_HPP
...
class decoration_annotations_factory {
public:
    explicit decoration_annotations_factory(const dynamic::repository& rp);
...
public:
    decoration_annotations make(const dynamic::object& o) const;
