 ...
 *
 */
#ifndef DOGEN_FORMATTERS_TYPES_FILE_WRITER_INTERFACE_HPP
#define DOGEN_FORMATTERS_TYPES_FILE_WRITER_INTERFACE_HPP
...
public:
    virtual ~file_writer_interface() noexcept = 0;
