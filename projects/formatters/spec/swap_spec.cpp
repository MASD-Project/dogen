...
BOOST_AUTO_TEST_CASE(validate_swap) {
    ...
    test_swap<modeline_group_generator>();
    test_swap<editors_generator>();
    test_swap<modeline_locations_generator>();
    test_swap<modeline_field_generator>();
    test_swap<comment_styles_generator>();
}
