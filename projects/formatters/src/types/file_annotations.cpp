...
file_annotations::file_annotations(file_annotations&& rhs)
...
void file_annotations::swap(file_annotations& other) noexcept {
    using std::swap;
...
bool file_annotations::operator==(const file_annotations& rhs) const {
...
file_annotations& file_annotations::operator=(file_annotations other) {
    using std::swap;
    swap(*this, other);
    return *this;
}

const std::list<std::string>& file_annotations::copyright_notices() const {
    return copyright_notices_;
}

std::list<std::string>& file_annotations::copyright_notices() {
    return copyright_notices_;
}

void file_annotations::copyright_notices(const std::list<std::string>& v) {
...
const std::string& file_annotations::licence_name() const {
    return licence_name_;
}

std::string& file_annotations::licence_name() {
    return licence_name_;
}

void file_annotations::licence_name(const std::string& v) {
    licence_name_ = v;
}
...
const std::string& file_annotations::modeline_group_name() const {
    return modeline_group_name_;
}

std::string& file_annotations::modeline_group_name() {
    return modeline_group_name_;
}

void file_annotations::modeline_group_name(const std::string& v) {
...
const boost::optional<bool>& file_annotations::generate_preamble() const {
    return generate_preamble_;
}

boost::optional<bool>& file_annotations::generate_preamble() {
    return generate_preamble_;
}

void file_annotations::generate_preamble(const boost::optional<bool>& v) {
...
const boost::optional<bool>& file_annotations::marker_add_date_time() const {
    return marker_add_date_time_;
}

boost::optional<bool>& file_annotations::marker_add_date_time() {
    return marker_add_date_time_;
}

void file_annotations::marker_add_date_time(const boost::optional<bool>& v) {
...
const boost::optional<bool>& file_annotations::marker_add_warning() const {
    return marker_add_warning_;
}

boost::optional<bool>& file_annotations::marker_add_warning() {
    return marker_add_warning_;
}

void file_annotations::marker_add_warning(const boost::optional<bool>& v) {
...
const std::string& file_annotations::marker_message() const {
    return marker_message_;
}

std::string& file_annotations::marker_message() {
    return marker_message_;
}

void file_annotations::marker_message(const std::string& v) {
    marker_message_ = v;
}
