...
decoration_configuration_workflow::decoration_configuration_workflow(
...
decoration_configuration decoration_configuration_workflow::
execute(const std::string& modeline_name) const {
    const auto da = decoration_annotations();
    return configuration_factory_.make(modeline_name, da);
}

decoration_configuration decoration_configuration_workflow::execute(
