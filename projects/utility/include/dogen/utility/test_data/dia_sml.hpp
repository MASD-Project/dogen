...
public:
    ...
    static boost::filesystem::path input_enable_eos_serialization_dia();
    ...
    static boost::filesystem::path expected_empty_package_sml_xml();
    ...
    static boost::filesystem::path expected_classes_inout_package_sml_xml();
    static boost::filesystem::path expected_class_without_attributes_dia_xml();
    static boost::filesystem::path expected_class_without_attributes_sml_xml();
    static boost::filesystem::path expected_class_without_package_dia_xml();
    static boost::filesystem::path expected_class_without_package_sml_xml();
    ...
    static boost::filesystem::path expected_classes_without_package_sml_xml();
    ...
    static boost::filesystem::path expected_two_layers_with_objects_sml_xml();
    ...
    static boost::filesystem::path expected_all_primitives_sml_xml();
    static boost::filesystem::path expected_trivial_inheritance_dia_xml();
    static boost::filesystem::path expected_trivial_inheritance_sml_xml();
    ...
    static boost::filesystem::path actual_empty_package_sml_xml();
    ...
    static boost::filesystem::path actual_classes_inout_package_sml_xml();
    static boost::filesystem::path actual_class_without_attributes_dia_xml();
    static boost::filesystem::path actual_class_without_attributes_sml_xml();
    static boost::filesystem::path actual_class_without_package_dia_xml();
    static boost::filesystem::path actual_class_without_package_sml_xml();
    ...
    static boost::filesystem::path actual_classes_without_package_sml_xml();
    ...
    static boost::filesystem::path actual_two_layers_with_objects_sml_xml();
    ...
    static boost::filesystem::path actual_all_primitives_sml_xml();
    static boost::filesystem::path actual_trivial_inheritance_dia_xml();
    static boost::filesystem::path actual_trivial_inheritance_sml_xml();
