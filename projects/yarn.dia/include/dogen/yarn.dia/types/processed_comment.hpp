 ...
 *
 */
#ifndef DOGEN_YARN_DIA_TYPES_PROCESSED_COMMENT_HPP
#define DOGEN_YARN_DIA_TYPES_PROCESSED_COMMENT_HPP
...
#include <utility>
#include <algorithm>
#include "dogen/yarn.dia/serialization/processed_comment_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::yarn::dia::processed_comment& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::yarn::dia::processed_comment& v, unsigned int version);
...
template<>
inline void swap(
    dogen::yarn::dia::processed_comment& lhs,
    dogen::yarn::dia::processed_comment& rhs) {
    lhs.swap(rhs);
}
