...
template<>
struct hash<dogen::yarn::dia::processed_comment> {
public:
    size_t operator()(const dogen::yarn::dia::processed_comment& v) const {
        return dogen::yarn::dia::processed_comment_hasher::hash(v);
    }
};
