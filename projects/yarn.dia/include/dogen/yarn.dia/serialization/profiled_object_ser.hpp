 ...
 *
 */
#ifndef DOGEN_YARN_DIA_SERIALIZATION_PROFILED_OBJECT_SER_HPP
#define DOGEN_YARN_DIA_SERIALIZATION_PROFILED_OBJECT_SER_HPP
...
BOOST_SERIALIZATION_SPLIT_FREE(dogen::yarn::dia::profiled_object)
namespace boost {
