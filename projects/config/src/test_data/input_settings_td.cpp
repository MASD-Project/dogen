...
input_settings_generator::input_settings_generator() : position_(0) { }
...
input_settings_generator::result_type
input_settings_generator::create(const unsigned int position) {
    input_settings r;
    input_settings_generator::populate(position, r);
    return r;
}
input_settings_generator::result_type*
input_settings_generator::create_ptr(const unsigned int position) {
    input_settings* p = new input_settings();
    input_settings_generator::populate(position, *p);
    return p;
}

input_settings_generator::result_type
input_settings_generator::operator()() {
