...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const knitting_options& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, knitting_options& v, unsigned int version);
