...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::config::output_options& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::config::output_options& v, unsigned int version);
