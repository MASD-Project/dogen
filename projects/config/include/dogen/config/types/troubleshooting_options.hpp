 ...
 *
 */
#ifndef DOGEN_CONFIG_TYPES_TROUBLESHOOTING_OPTIONS_HPP
#define DOGEN_CONFIG_TYPES_TROUBLESHOOTING_OPTIONS_HPP
...
class troubleshooting_options final {
public:
    troubleshooting_options(const troubleshooting_options&) = default;
    ~troubleshooting_options() = default;

public:
    troubleshooting_options();

public:
    troubleshooting_options(troubleshooting_options&& rhs);
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const troubleshooting_options& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, troubleshooting_options& v, unsigned int version);
...
public:
    bool operator==(const troubleshooting_options& rhs) const;
    bool operator!=(const troubleshooting_options& rhs) const {
        return !this->operator==(rhs);
    }

public:
    void swap(troubleshooting_options& other) noexcept;
    troubleshooting_options& operator=(troubleshooting_options other);
...
template<>
inline void swap(
    dogen::config::troubleshooting_options& lhs,
    dogen::config::troubleshooting_options& rhs) {
    lhs.swap(rhs);
}
