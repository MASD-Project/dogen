 ...
 *
 */
#ifndef DOGEN_CONFIG_HASH_MODELING_SETTINGS_HASH_HPP
#define DOGEN_CONFIG_HASH_MODELING_SETTINGS_HASH_HPP
...
struct modeling_settings_hasher {
public:
    static std::size_t hash(const modeling_settings& v);
};
