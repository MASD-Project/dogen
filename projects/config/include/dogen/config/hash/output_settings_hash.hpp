 ...
 *
 */
#ifndef DOGEN_CONFIG_HASH_OUTPUT_SETTINGS_HASH_HPP
#define DOGEN_CONFIG_HASH_OUTPUT_SETTINGS_HASH_HPP
...
struct output_settings_hasher {
public:
    static std::size_t hash(const output_settings& v);
};
