 ...
 *
 */
#ifndef DOGEN_EXTERNAL_DIA_TYPES_PROCESSED_ATTRIBUTE_HPP
#define DOGEN_EXTERNAL_DIA_TYPES_PROCESSED_ATTRIBUTE_HPP
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::external::dia::processed_attribute& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::external::dia::processed_attribute& v, unsigned int version);
...
template<>
inline void swap(
    dogen::external::dia::processed_attribute& lhs,
    dogen::external::dia::processed_attribute& rhs) {
    lhs.swap(rhs);
}
