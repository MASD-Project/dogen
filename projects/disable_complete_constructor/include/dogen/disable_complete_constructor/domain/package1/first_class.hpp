 ...
 *
 */
#ifndef DOGEN_DISABLE_COMPLETE_CONSTRUCTOR_DOMAIN_PACKAGE1_FIRST_CLASS_HPP
#define DOGEN_DISABLE_COMPLETE_CONSTRUCTOR_DOMAIN_PACKAGE1_FIRST_CLASS_HPP
...
#include "dogen/disable_complete_constructor/serialization/package1/first_class_fwd_ser.hpp"
...
private:
    ...
    dogen::disable_complete_constructor::versioned_key versioned_key_;
};
...
template<>
inline void swap(
    dogen::disable_complete_constructor::package1::first_class& lhs,
    dogen::disable_complete_constructor::package1::first_class& rhs) {
    lhs.swap(rhs);
}
