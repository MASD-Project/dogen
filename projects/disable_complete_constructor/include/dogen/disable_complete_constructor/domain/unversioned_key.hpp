 ...
 *
 */
#ifndef DOGEN_DISABLE_COMPLETE_CONSTRUCTOR_DOMAIN_UNVERSIONED_KEY_HPP
#define DOGEN_DISABLE_COMPLETE_CONSTRUCTOR_DOMAIN_UNVERSIONED_KEY_HPP
...
#include <algorithm>
#include "dogen/disable_complete_constructor/serialization/unversioned_key_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::disable_complete_constructor::unversioned_key& lhs,
    dogen::disable_complete_constructor::unversioned_key& rhs) {
    lhs.swap(rhs);
}
