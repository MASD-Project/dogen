...
BOOST_AUTO_TEST_SUITE(type_repository_tests)

BOOST_AUTO_TEST_CASE(identical_objects_are_equal) {
    masd::dogen::annotations::type_repository_generator g;
    const auto a(g());
    const auto b(a);
...
BOOST_AUTO_TEST_CASE(moved_objects_are_equal) {
    ...
    g();
    auto a(g());
    const auto b = masd::dogen::annotations::type_repository();
    const auto c(a);
    BOOST_CHECK(a != b);
    BOOST_CHECK(a == c);
...
BOOST_AUTO_TEST_CASE(assigned_objects_are_equal) {
    ...
    g();
    const auto a(g());
    masd::dogen::annotations::type_repository b;
    BOOST_CHECK(a != b);
...
BOOST_AUTO_TEST_CASE(copy_constructed_objects_are_equal) {
    ...
    b = masd::dogen::annotations::type_repository();
    BOOST_CHECK(a != b);
}
