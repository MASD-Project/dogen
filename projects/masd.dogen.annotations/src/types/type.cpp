...
const masd::dogen::annotations::name& type::name() const {
    return name_;
}

masd::dogen::annotations::name& type::name() {
    return name_;
}

void type::name(const masd::dogen::annotations::name& v) {
    name_ = v;
}
...
masd::dogen::annotations::value_types type::value_type() const {
    return value_type_;
}

void type::value_type(const masd::dogen::annotations::value_types v) {
    value_type_ = v;
}

masd::dogen::annotations::scope_types type::scope() const {
    return scope_;
}

void type::scope(const masd::dogen::annotations::scope_types v) {
    scope_ = v;
}

const masd::dogen::annotations::archetype_location& type::archetype_location() const {
    return archetype_location_;
}

masd::dogen::annotations::archetype_location& type::archetype_location() {
    return archetype_location_;
}

void type::archetype_location(const masd::dogen::annotations::archetype_location& v) {
...
const boost::shared_ptr<masd::dogen::annotations::value>& type::default_value() const {
    return default_value_;
}

boost::shared_ptr<masd::dogen::annotations::value>& type::default_value() {
    return default_value_;
}

void type::default_value(const boost::shared_ptr<masd::dogen::annotations::value>& v) {
    default_value_ = v;
}
