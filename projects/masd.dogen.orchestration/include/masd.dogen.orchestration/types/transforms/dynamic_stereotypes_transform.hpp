 ...
 *
 */
#ifndef MASD_DOGEN_ORCHESTRATION_TYPES_TRANSFORMS_DYNAMIC_STEREOTYPES_TRANSFORM_HPP
#define MASD_DOGEN_ORCHESTRATION_TYPES_TRANSFORMS_DYNAMIC_STEREOTYPES_TRANSFORM_HPP
