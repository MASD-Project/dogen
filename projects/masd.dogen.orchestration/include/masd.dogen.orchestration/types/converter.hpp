 ...
 *
 */
#ifndef MASD_DOGEN_ORCHESTRATION_TYPES_CONVERTER_HPP
#define MASD_DOGEN_ORCHESTRATION_TYPES_CONVERTER_HPP
...
class converter final : public masd::dogen::converter {
public:
    converter() = default;
