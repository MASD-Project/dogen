 ...
 *
 */
#ifndef DOGEN_WALE_TYPES_PROPERTIES_HPP
#define DOGEN_WALE_TYPES_PROPERTIES_HPP
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::wale::properties& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::wale::properties& v, unsigned int version);
...
template<>
inline void swap(
    dogen::wale::properties& lhs,
    dogen::wale::properties& rhs) {
    lhs.swap(rhs);
}
