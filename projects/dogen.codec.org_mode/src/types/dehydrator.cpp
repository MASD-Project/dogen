...
#include "dogen.codec.org_mode/types/dehydrator.hpp"

namespace {

using namespace dogen::utility::log;
static logger lg(logger_factory("codec.org_mode.dehydrator"));
...
std::string dehydrator::dehydrate(const codec::entities::model& m) {
    std::ostringstream s;
...
void dehydrator::dehydrate(const codec::entities::model& m,
