...
#include "dogen.codec.org_mode/types/encoding_transform.hpp"

namespace {

using namespace dogen::utility::log;
const std::string transform_id("codec.org_mode.encoding_transform");
auto lg(logger_factory(transform_id));

const std::string encoder_id("codec.org_mode");
