 ...
 *
 */
#ifndef DOGEN_EXTRACTION_TYPES_TRANSFORMS_GATHER_EXTERNAL_ARTEFACTS_TRANSFORM_HPP
#define DOGEN_EXTRACTION_TYPES_TRANSFORMS_GATHER_EXTERNAL_ARTEFACTS_TRANSFORM_HPP
