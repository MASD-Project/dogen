 ...
 *
 */
#ifndef DOGEN_EXTRACTION_TYPES_TRANSFORMS_CONTEXT_HPP
#define DOGEN_EXTRACTION_TYPES_TRANSFORMS_CONTEXT_HPP
...
template<>
inline void swap(
    dogen::extraction::transforms::context& lhs,
    dogen::extraction::transforms::context& rhs) {
    lhs.swap(rhs);
}
