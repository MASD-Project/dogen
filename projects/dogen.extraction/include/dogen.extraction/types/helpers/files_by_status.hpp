 ...
 *
 */
#ifndef DOGEN_EXTRACTION_TYPES_HELPERS_FILES_BY_STATUS_HPP
#define DOGEN_EXTRACTION_TYPES_HELPERS_FILES_BY_STATUS_HPP
...
template<>
inline void swap(
    dogen::extraction::helpers::files_by_status& lhs,
    dogen::extraction::helpers::files_by_status& rhs) {
    lhs.swap(rhs);
}
