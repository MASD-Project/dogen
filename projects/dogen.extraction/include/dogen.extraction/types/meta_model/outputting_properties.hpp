 ...
 *
 */
#ifndef DOGEN_EXTRACTION_TYPES_META_MODEL_OUTPUTTING_PROPERTIES_HPP
#define DOGEN_EXTRACTION_TYPES_META_MODEL_OUTPUTTING_PROPERTIES_HPP
...
template<>
inline void swap(
    dogen::extraction::meta_model::outputting_properties& lhs,
    dogen::extraction::meta_model::outputting_properties& rhs) {
    lhs.swap(rhs);
}
