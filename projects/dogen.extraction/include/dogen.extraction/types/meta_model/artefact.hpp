 ...
 *
 */
#ifndef DOGEN_EXTRACTION_TYPES_META_MODEL_ARTEFACT_HPP
#define DOGEN_EXTRACTION_TYPES_META_MODEL_ARTEFACT_HPP
...
public:
    ...
    const dogen::extraction::meta_model::operation& operation() const;
    dogen::extraction::meta_model::operation& operation();
    void operation(const dogen::extraction::meta_model::operation& v);
    void operation(const dogen::extraction::meta_model::operation&& v);
...
private:
    ...
    dogen::extraction::meta_model::operation operation_;
};
...
template<>
inline void swap(
    dogen::extraction::meta_model::artefact& lhs,
    dogen::extraction::meta_model::artefact& rhs) {
    lhs.swap(rhs);
}
