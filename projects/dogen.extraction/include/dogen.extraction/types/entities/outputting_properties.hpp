 ...
 *
 */
#ifndef DOGEN_EXTRACTION_TYPES_ENTITIES_OUTPUTTING_PROPERTIES_HPP
#define DOGEN_EXTRACTION_TYPES_ENTITIES_OUTPUTTING_PROPERTIES_HPP
...
template<>
inline void swap(
    dogen::extraction::entities::outputting_properties& lhs,
    dogen::extraction::entities::outputting_properties& rhs) {
    lhs.swap(rhs);
}
