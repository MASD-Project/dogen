...
const std::list<dogen::extraction::meta_model::artefact>& model::artefacts() const {
    return artefacts_;
}

std::list<dogen::extraction::meta_model::artefact>& model::artefacts() {
    return artefacts_;
}

void model::artefacts(const std::list<dogen::extraction::meta_model::artefact>& v) {
    artefacts_ = v;
}
...
const dogen::extraction::meta_model::outputting_properties& model::outputting_properties() const {
    return outputting_properties_;
}

dogen::extraction::meta_model::outputting_properties& model::outputting_properties() {
    return outputting_properties_;
}

void model::outputting_properties(const dogen::extraction::meta_model::outputting_properties& v) {
