...
const dogen::extraction::entities::operation& artefact::operation() const {
    return operation_;
}

dogen::extraction::entities::operation& artefact::operation() {
    return operation_;
}

void artefact::operation(const dogen::extraction::entities::operation& v) {
    operation_ = v;
}
