...
#include "dogen.extraction/io/entities/outputting_properties_io.hpp"
...
inline std::ostream& operator<<(std::ostream& s, const std::list<dogen::extraction::entities::artefact>& v) {
    s << "[ ";
...
std::ostream& operator<<(std::ostream& s, const model& v) {
    s << " { "
      << "\"__type__\": " << "\"dogen::extraction::entities::model\"" << ", "
