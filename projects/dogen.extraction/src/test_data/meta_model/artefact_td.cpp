...
dogen::extraction::meta_model::operation
create_dogen_extraction_meta_model_operation(const unsigned int position) {
    return dogen::extraction::meta_model::operation_generator::create(position);
}
...
populate(const unsigned int position, result_type& v) {
    ...
    v.unified_diff(create_std_string(position + 4));
    v.operation(create_dogen_extraction_meta_model_operation(position + 5));
}
