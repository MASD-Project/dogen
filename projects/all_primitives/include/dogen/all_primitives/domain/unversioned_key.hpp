 ...
 *
 */
#ifndef DOGEN_ALL_PRIMITIVES_DOMAIN_UNVERSIONED_KEY_HPP
#define DOGEN_ALL_PRIMITIVES_DOMAIN_UNVERSIONED_KEY_HPP
...
public:
    friend class dogen::all_primitives::unversioned_key_serializer;
...
template<>
inline void swap(
    dogen::all_primitives::unversioned_key& lhs,
    dogen::all_primitives::unversioned_key& rhs) {
    lhs.swap(rhs);
}
