 ...
 *
 */
#ifndef DOGEN_ALL_PRIMITIVES_DOMAIN_VERSIONED_KEY_HPP
#define DOGEN_ALL_PRIMITIVES_DOMAIN_VERSIONED_KEY_HPP
...
public:
    friend class dogen::all_primitives::versioned_key_serializer;
...
template<>
inline void swap(
    dogen::all_primitives::versioned_key& lhs,
    dogen::all_primitives::versioned_key& rhs) {
    lhs.swap(rhs);
}
