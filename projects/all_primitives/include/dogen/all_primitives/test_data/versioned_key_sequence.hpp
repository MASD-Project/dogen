 ...
 *
 */
#ifndef DOGEN_ALL_PRIMITIVES_TEST_DATA_VERSIONED_KEY_SEQUENCE_HPP
#define DOGEN_ALL_PRIMITIVES_TEST_DATA_VERSIONED_KEY_SEQUENCE_HPP
...
public:
    typedef dogen::all_primitives::versioned_key value_type;
