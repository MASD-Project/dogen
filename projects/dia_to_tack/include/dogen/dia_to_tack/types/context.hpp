 ...
 *
 */
#ifndef DOGEN_DIA_TO_TACK_TYPES_CONTEXT_HPP
#define DOGEN_DIA_TO_TACK_TYPES_CONTEXT_HPP
...
#include "dogen/dia_to_tack/serialization/context_fwd_ser.hpp"
...
public:
     ...
     */
    /**@{*/
    const dogen::tack::model& model() const;
    dogen::tack::model& model();
    void model(const dogen::tack::model& v);
    void model(const dogen::tack::model&& v);
    /**@}*/
...
template<>
inline void swap(
    dogen::dia_to_tack::context& lhs,
    dogen::dia_to_tack::context& rhs) {
    lhs.swap(rhs);
}
