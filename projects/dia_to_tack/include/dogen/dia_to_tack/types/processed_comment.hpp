 ...
 *
 */
#ifndef DOGEN_DIA_TO_TACK_TYPES_PROCESSED_COMMENT_HPP
#define DOGEN_DIA_TO_TACK_TYPES_PROCESSED_COMMENT_HPP
...
#include <utility>
#include <algorithm>
#include "dogen/dia_to_tack/serialization/processed_comment_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::dia_to_tack::processed_comment& lhs,
    dogen::dia_to_tack::processed_comment& rhs) {
    lhs.swap(rhs);
}
