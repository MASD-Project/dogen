 ...
 *
 */
#ifndef DOGEN_DIA_TO_TACK_TYPES_PROFILE_HPP
#define DOGEN_DIA_TO_TACK_TYPES_PROFILE_HPP
...
#include <string>
#include <algorithm>
#include "dogen/dia_to_tack/serialization/profile_fwd_ser.hpp"
 ...
 * latter.
 *
 * Tack information is all gathered via processing the stereotype of the
 * object. There are two kinds of Tack information we're interested in:
 *
 * @li the type of the Tack modeling element, e.g. enumeration, value
 * object, etc.
 * @li any additional properties that Tack modeling elements may have,
 ...
 * to Tack concepts at a later stage.
 */
class profile final {
public:
...
template<>
inline void swap(
    dogen::dia_to_tack::profile& lhs,
    dogen::dia_to_tack::profile& rhs) {
    lhs.swap(rhs);
}
