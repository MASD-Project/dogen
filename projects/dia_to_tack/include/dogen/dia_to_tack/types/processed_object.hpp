 ...
 *
 */
#ifndef DOGEN_DIA_TO_TACK_TYPES_PROCESSED_OBJECT_HPP
#define DOGEN_DIA_TO_TACK_TYPES_PROCESSED_OBJECT_HPP
...
#include "dogen/dia_to_tack/serialization/processed_object_fwd_ser.hpp"
...
public:
    processed_object(
        ...
        const dogen::dia_to_tack::object_types object_type,
        ...
        const std::list<dogen::dia_to_tack::processed_property>& properties);
...
public:
     ...
     */
    /**@{*/
    dogen::dia_to_tack::object_types object_type() const;
    void object_type(const dogen::dia_to_tack::object_types v);
    /**@}*/
     ...
     */
    /**@{*/
    const std::list<dogen::dia_to_tack::processed_property>& properties() const;
    std::list<dogen::dia_to_tack::processed_property>& properties();
    void properties(const std::list<dogen::dia_to_tack::processed_property>& v);
    void properties(const std::list<dogen::dia_to_tack::processed_property>&& v);
    /**@}*/
...
private:
    std::string id_;
    std::string name_;
    dogen::dia_to_tack::object_types object_type_;
    ...
    std::list<dogen::dia_to_tack::processed_property> properties_;
};
...
template<>
inline void swap(
    dogen::dia_to_tack::processed_object& lhs,
    dogen::dia_to_tack::processed_object& rhs) {
    lhs.swap(rhs);
}
