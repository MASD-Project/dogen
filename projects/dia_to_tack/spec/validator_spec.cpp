...
#include "dogen/dia_to_tack/types/validator.hpp"
#include "dogen/dia_to_tack/io/profile_io.hpp"
#include "dogen/dia_to_tack/types/validation_error.hpp"
...
const std::string test_module("dia_to_tack");
...
const std::string too_many_tack_types("Can only have one TACK");
const std::string stereotypes_require_uml_class("Only UML classes can");

const std::string object_options_on_non_object(
    "Only TACK objects can have object options");
const std::string concepts_require_tack_object(
    "Only TACK objects can have concepts");

}

using dogen::utility::test::contains_checker;
using dogen::dia_to_tack::validation_error;

BOOST_AUTO_TEST_SUITE(validator)

BOOST_AUTO_TEST_CASE(default_profile_throws) {
    SETUP_TEST_LOG_SOURCE("default_profile_throws");
    dogen::dia_to_tack::validator v;
    dogen::dia_to_tack::profile p;
...
BOOST_AUTO_TEST_CASE(setting_more_than_one_tack_type_throws) {
    SETUP_TEST_LOG_SOURCE("setting_more_than_one_tack_type_throws");
    ...
    contains_checker<validation_error> cc(too_many_tack_types);
    BOOST_CHECK_EXCEPTION(v.validate(p1), validation_error, cc);
...
BOOST_AUTO_TEST_CASE(setting_one_tack_type_validates) {
    SETUP_TEST_LOG_SOURCE("setting_one_tack_type_validates");
...
BOOST_AUTO_TEST_CASE(setting_tack_object_flags_on_non_objects_throws) {
    SETUP_TEST_LOG_SOURCE("setting_tack_entity_flags_on_non_entities_throws");
...
BOOST_AUTO_TEST_CASE(setting_tack_object_flags_on_objects_validates) {
    SETUP_TEST_LOG_SOURCE("setting_tack_object_flags_on_objects_validates");
