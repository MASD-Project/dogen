...
using dogen::dia_to_tack::processed_object;
using dogen::dia_to_tack::processed_property;
using dogen::dia_to_tack::test::mock_processed_object_factory;

processed_object
create_object(const dogen::dia_to_tack::object_types ot, const unsigned int n) {
    processed_object r;
...
processed_object create_named_object(const dogen::dia_to_tack::object_types ot,
