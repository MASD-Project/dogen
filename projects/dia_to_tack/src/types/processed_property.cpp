...
const dogen::dia_to_tack::processed_comment& processed_property::comment() const {
    return comment_;
}

dogen::dia_to_tack::processed_comment& processed_property::comment() {
    return comment_;
}

void processed_property::comment(const dogen::dia_to_tack::processed_comment& v) {
    comment_ = v;
}
