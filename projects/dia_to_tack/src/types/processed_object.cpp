...
processed_object::processed_object()
    : object_type_(static_cast<dogen::dia_to_tack::object_types>(0)) { }
...
dogen::dia_to_tack::object_types processed_object::object_type() const {
    return object_type_;
}

void processed_object::object_type(const dogen::dia_to_tack::object_types v) {
    object_type_ = v;
}
...
const dogen::dia_to_tack::processed_comment& processed_object::comment() const {
    return comment_;
}

dogen::dia_to_tack::processed_comment& processed_object::comment() {
    return comment_;
}

void processed_object::comment(const dogen::dia_to_tack::processed_comment& v) {
    comment_ = v;
}
...
const std::list<dogen::dia_to_tack::processed_property>& processed_object::properties() const {
    return properties_;
}

std::list<dogen::dia_to_tack::processed_property>& processed_object::properties() {
    return properties_;
}

void processed_object::properties(const std::list<dogen::dia_to_tack::processed_property>& v) {
    properties_ = v;
}
