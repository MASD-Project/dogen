...
template<>
struct hash<dogen::classes_inout_package::package_1::class_1> {
public:
    size_t operator()(const dogen::classes_inout_package::package_1::class_1& v) const {
        return dogen::classes_inout_package::package_1::class_1_hasher::hash(v);
    }
};
