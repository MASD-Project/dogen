 ...
 *
 */
#ifndef DOGEN_CLASSES_INOUT_PACKAGE_DOMAIN_VERSIONED_KEY_HPP
#define DOGEN_CLASSES_INOUT_PACKAGE_DOMAIN_VERSIONED_KEY_HPP
...
#include "dogen/classes_inout_package/serialization/versioned_key_fwd_ser.hpp"
...
public:
    friend class dogen::classes_inout_package::versioned_key_serializer;
...
template<>
inline void swap(
    dogen::classes_inout_package::versioned_key& lhs,
    dogen::classes_inout_package::versioned_key& rhs) {
    lhs.swap(rhs);
}
