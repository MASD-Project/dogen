 ...
 *
 */
#ifndef MASD_DOGEN_ENGINE_TYPES_TRANSFORMS_NAMING_CONFIGURATION_HPP
#define MASD_DOGEN_ENGINE_TYPES_TRANSFORMS_NAMING_CONFIGURATION_HPP
...
template<>
inline void swap(
    masd::dogen::engine::transforms::naming_configuration& lhs,
    masd::dogen::engine::transforms::naming_configuration& rhs) {
    lhs.swap(rhs);
}
