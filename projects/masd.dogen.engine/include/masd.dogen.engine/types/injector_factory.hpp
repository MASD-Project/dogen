 ...
 *
 */
#ifndef MASD_DOGEN_ENGINE_TYPES_INJECTOR_FACTORY_HPP
#define MASD_DOGEN_ENGINE_TYPES_INJECTOR_FACTORY_HPP
...
public:
    static auto make_injector() {
        ...
        return make_injector(
            ...
            .to<masd::dogen::engine::converter>(),
            bind<masd::dogen::generator>
            .to<masd::dogen::engine::generator>());
    }
};
