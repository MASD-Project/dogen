...
BOOST_AUTO_TEST_CASE(masd_dogen_engine_dia_produces_expected_model) {
    SETUP_TEST_LOG("masd_dogen_engine_dia_produces_expected_model");
    using masd::dogen::utility::test_data::dogen_generation;
    const auto t(dogen_generation::input_masd_dogen_engine_dia());
    const auto od(dogen_generation::project_directory());
    const auto m(apply_extraction_model_production(t, od));
    BOOST_CHECK(check_for_differences(od, m));
}
...
BOOST_AUTO_TEST_CASE(masd_dogen_engine_json_produces_expected_model) {
    SETUP_TEST_LOG("masd_dogen_engine_json_produces_expected_model");
    using masd::dogen::utility::test_data::dogen_generation;
    const auto t(dogen_generation::input_masd_dogen_engine_json());
    const auto od(dogen_generation::project_directory());
    const auto m(apply_extraction_model_production(t, od));
    BOOST_CHECK(check_for_differences(od, m));
}
