...
processed_object::processed_object()
    : dia_object_type_(static_cast<masd::dogen::injection::dia::dia_object_types>(0)) { }
...
masd::dogen::injection::dia::dia_object_types processed_object::dia_object_type() const {
    return dia_object_type_;
}

void processed_object::dia_object_type(const masd::dogen::injection::dia::dia_object_types v) {
    dia_object_type_ = v;
}
...
const masd::dogen::injection::dia::processed_comment& processed_object::comment() const {
    return comment_;
}

masd::dogen::injection::dia::processed_comment& processed_object::comment() {
    return comment_;
}

void processed_object::comment(const masd::dogen::injection::dia::processed_comment& v) {
    comment_ = v;
}
...
const std::list<masd::dogen::injection::dia::processed_attribute>& processed_object::attributes() const {
    return attributes_;
}

std::list<masd::dogen::injection::dia::processed_attribute>& processed_object::attributes() {
    return attributes_;
}

void processed_object::attributes(const std::list<masd::dogen::injection::dia::processed_attribute>& v) {
    attributes_ = v;
}
