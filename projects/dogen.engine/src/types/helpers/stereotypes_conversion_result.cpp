...
const std::list<dogen::assets::meta_model::static_stereotypes>& stereotypes_conversion_result::static_stereotypes() const {
    return static_stereotypes_;
}

std::list<dogen::assets::meta_model::static_stereotypes>& stereotypes_conversion_result::static_stereotypes() {
    return static_stereotypes_;
}

void stereotypes_conversion_result::static_stereotypes(const std::list<dogen::assets::meta_model::static_stereotypes>& v) {
