 ...
 *
 */
#ifndef DOGEN_ENGINE_TYPES_TRANSFORMS_NAMING_CONFIGURATION_HPP
#define DOGEN_ENGINE_TYPES_TRANSFORMS_NAMING_CONFIGURATION_HPP
...
template<>
inline void swap(
    dogen::engine::transforms::naming_configuration& lhs,
    dogen::engine::transforms::naming_configuration& rhs) {
    lhs.swap(rhs);
}
