 ...
 *
 */
#ifndef DOGEN_OPTIONS_TYPES_OUTPUT_OPTIONS_HPP
#define DOGEN_OPTIONS_TYPES_OUTPUT_OPTIONS_HPP
...
#include <vector>
#include <algorithm>
#include "dogen/options/serialization/output_options_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::options::output_options& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::options::output_options& v, unsigned int version);
...
template<>
inline void swap(
    dogen::options::output_options& lhs,
    dogen::options::output_options& rhs) {
    lhs.swap(rhs);
}
