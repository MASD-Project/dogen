 ...
 *
 */
#ifndef DOGEN_EXTERNAL_DIA_TYPES_PROCESSED_OBJECT_HPP
#define DOGEN_EXTERNAL_DIA_TYPES_PROCESSED_OBJECT_HPP
...
public:
     ...
     */
    /**@{*/
    dogen::external::dia::dia_object_types dia_object_type() const;
    void dia_object_type(const dogen::external::dia::dia_object_types v);
    /**@}*/
     ...
     */
    /**@{*/
    const dogen::external::dia::processed_comment& comment() const;
    dogen::external::dia::processed_comment& comment();
    void comment(const dogen::external::dia::processed_comment& v);
    void comment(const dogen::external::dia::processed_comment&& v);
    /**@}*/
     ...
     */
    /**@{*/
    const std::list<dogen::external::dia::processed_attribute>& attributes() const;
    std::list<dogen::external::dia::processed_attribute>& attributes();
    void attributes(const std::list<dogen::external::dia::processed_attribute>& v);
    void attributes(const std::list<dogen::external::dia::processed_attribute>&& v);
    /**@}*/
...
private:
    std::string id_;
    std::string name_;
    dogen::external::dia::dia_object_types dia_object_type_;
...
template<>
inline void swap(
    dogen::external::dia::processed_object& lhs,
    dogen::external::dia::processed_object& rhs) {
    lhs.swap(rhs);
}
