...
inline std::ostream& operator<<(std::ostream& s, const boost::optional<dogen::om::modeline>& v) {
...
inline std::ostream& operator<<(std::ostream& s, const boost::optional<dogen::om::licence>& v) {
    s << "{ " << "\"__type__\": " << "\"boost::optional\"" << ", ";
