...
cpp_file_generator::cpp_file_generator() : position_(0) { }

void cpp_file_generator::
...
cpp_file_generator::result_type
cpp_file_generator::create(const unsigned int position) {
    cpp_file r;
    cpp_file_generator::populate(position, r);
    return r;
}
cpp_file_generator::result_type*
cpp_file_generator::create_ptr(const unsigned int position) {
    cpp_file* p = new cpp_file();
    cpp_file_generator::populate(position, *p);
    return p;
}

cpp_file_generator::result_type
cpp_file_generator::operator()() {
