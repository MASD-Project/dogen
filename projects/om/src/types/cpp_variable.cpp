...
void cpp_variable::to_stream(std::ostream& s) const {
    ...
    s << " { "
      << "\"__type__\": " << "\"dogen::om::cpp_variable\"" << ", "
      << "\"__parent_0__\": ";
...
void cpp_variable::swap(cpp_variable& other) noexcept {
...
bool cpp_variable::equals(const dogen::om::cpp_feature& other) const {
    const cpp_variable* const p(dynamic_cast<const cpp_variable* const>(&other));
    if (!p) return false;
    return *this == *p;
}

bool cpp_variable::operator==(const cpp_variable& rhs) const {
    return cpp_abstract_instance::compare(rhs) &&
        is_extern_ == rhs.is_extern_ &&
        is_static_ == rhs.is_static_;
}

cpp_variable& cpp_variable::operator=(cpp_variable other) {
    using std::swap;
    swap(*this, other);
    return *this;
}

bool cpp_variable::is_extern() const {
    return is_extern_;
}

void cpp_variable::is_extern(const bool v) {
    is_extern_ = v;
}

bool cpp_variable::is_static() const {
    return is_static_;
}

void cpp_variable::is_static(const bool v) {
    is_static_ = v;
}
