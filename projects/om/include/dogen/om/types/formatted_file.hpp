 ...
 *
 */
#ifndef DOGEN_OM_TYPES_FORMATTED_FILE_HPP
#define DOGEN_OM_TYPES_FORMATTED_FILE_HPP
...
#include <string>
#include "dogen/om/serialization/formatted_file_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::om::formatted_file& lhs,
    dogen::om::formatted_file& rhs) {
    lhs.swap(rhs);
}
