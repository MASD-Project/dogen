 ...
 *
 */
#ifndef DOGEN_DATABASE_TYPES_NO_KEYS_HPP
#define DOGEN_DATABASE_TYPES_NO_KEYS_HPP
...
#include <string>
#include "dogen/database/serialization/no_keys_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::database::no_keys& lhs,
    dogen::database::no_keys& rhs) {
    lhs.swap(rhs);
}
