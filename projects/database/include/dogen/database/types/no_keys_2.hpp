 ...
 *
 */
#ifndef DOGEN_DATABASE_TYPES_NO_KEYS_2_HPP
#define DOGEN_DATABASE_TYPES_NO_KEYS_2_HPP
...
#include <algorithm>
#include "dogen/database/serialization/no_keys_2_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::database::no_keys_2& lhs,
    dogen::database::no_keys_2& rhs) {
    lhs.swap(rhs);
}
