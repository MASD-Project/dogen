...
#include "dogen/database/odb/dogen/database/types/primary_key-odb.hxx"
...
namespace odb
{
  ...
  init (image_type& i, const object_type& o, pgsql::statement_kind sk)
  {
    ...
    //
    {
      ::boost::shared_ptr< ::dogen::database::primary_key > const& v =
        o.prop_1 ();

      typedef object_traits< ::dogen::database::primary_key > obj_traits;
      typedef odb::pointer_traits< ::boost::shared_ptr< ::dogen::database::primary_key > > ptr_traits;
  ...
  init (object_type& o, const image_type& i, database* db)
  {
    ...
    //
    {
      ::boost::shared_ptr< ::dogen::database::primary_key >& v =
        o.prop_1 ();
