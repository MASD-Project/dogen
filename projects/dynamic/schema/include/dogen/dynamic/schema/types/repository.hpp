 ...
 *
 */
#ifndef DOGEN_DYNAMIC_SCHEMA_TYPES_REPOSITORY_HPP
#define DOGEN_DYNAMIC_SCHEMA_TYPES_REPOSITORY_HPP
...
public:
     ...
     */
    /**@{*/
    const std::list<dogen::dynamic::schema::field_definition>& all_field_definitions() const;
     ...
     */
    /**@{*/
    const std::unordered_map<std::string, dogen::dynamic::schema::field_definition>& field_definitions_by_name() const;
    std::unordered_map<std::string, dogen::dynamic::schema::field_definition>& field_definitions_by_name();
    void field_definitions_by_name(const std::unordered_map<std::string, dogen::dynamic::schema::field_definition>& v);
    void field_definitions_by_name(const std::unordered_map<std::string, dogen::dynamic::schema::field_definition>&& v);
    /**@}*/
     ...
     */
    /**@{*/
    const std::unordered_map<std::string, std::list<dogen::dynamic::schema::field_definition> >& field_definitions_by_facet_name() const;
    std::unordered_map<std::string, std::list<dogen::dynamic::schema::field_definition> >& field_definitions_by_facet_name();
    void field_definitions_by_facet_name(const std::unordered_map<std::string, std::list<dogen::dynamic::schema::field_definition> >& v);
    void field_definitions_by_facet_name(const std::unordered_map<std::string, std::list<dogen::dynamic::schema::field_definition> >&& v);
    /**@}*/
     ...
     */
    /**@{*/
    const std::unordered_map<std::string, std::list<dogen::dynamic::schema::field_definition> >& field_definitions_by_formatter_name() const;
    std::unordered_map<std::string, std::list<dogen::dynamic::schema::field_definition> >& field_definitions_by_formatter_name();
...
template<>
inline void swap(
    dogen::dynamic::schema::repository& lhs,
    dogen::dynamic::schema::repository& rhs) {
    lhs.swap(rhs);
}
