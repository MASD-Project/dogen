 ...
 *
 */
#ifndef DOGEN_DYNAMIC_SCHEMA_TYPES_OWNERSHIP_HIERARCHY_HPP
#define DOGEN_DYNAMIC_SCHEMA_TYPES_OWNERSHIP_HIERARCHY_HPP
...
#include <algorithm>
#include <string>
#include "dogen/dynamic/schema/serialization/ownership_hierarchy_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const ownership_hierarchy& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, ownership_hierarchy& v, unsigned int version);
...
template<>
inline void swap(
    dogen::dynamic::schema::ownership_hierarchy& lhs,
    dogen::dynamic::schema::ownership_hierarchy& rhs) {
    lhs.swap(rhs);
}
