 ...
 *
 */
#ifndef DOGEN_DYNAMIC_SCHEMA_TYPES_TEXT_COLLECTION_HPP
#define DOGEN_DYNAMIC_SCHEMA_TYPES_TEXT_COLLECTION_HPP
...
#include <list>
#include <string>
#include "dogen/dynamic/schema/serialization/text_collection_fwd_ser.hpp"
 ...
 */
class text_collection final : public dogen::dynamic::schema::value {
public:
...
template<>
inline void swap(
    dogen::dynamic::schema::text_collection& lhs,
    dogen::dynamic::schema::text_collection& rhs) {
    lhs.swap(rhs);
}
