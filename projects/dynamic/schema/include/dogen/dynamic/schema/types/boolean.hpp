 ...
 *
 */
#ifndef DOGEN_DYNAMIC_SCHEMA_TYPES_BOOLEAN_HPP
#define DOGEN_DYNAMIC_SCHEMA_TYPES_BOOLEAN_HPP
...
#include "dogen/dynamic/schema/serialization/boolean_fwd_ser.hpp"
 ...
 */
class boolean final : public dogen::dynamic::schema::value {
public:
...
template<>
inline void swap(
    dogen::dynamic::schema::boolean& lhs,
    dogen::dynamic::schema::boolean& rhs) {
    lhs.swap(rhs);
}
