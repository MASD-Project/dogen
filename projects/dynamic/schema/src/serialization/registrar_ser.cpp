...
void register_types(Archive& ar) {
    ar.template register_type<dogen::dynamic::schema::boolean>();
    ar.template register_type<dogen::dynamic::schema::text>();
    ar.template register_type<dogen::dynamic::schema::text_collection>();
}
