...
inline bool operator==(const boost::shared_ptr<dogen::dynamic::schema::value>& lhs,
const boost::shared_ptr<dogen::dynamic::schema::value>& rhs) {
...
const dogen::dynamic::schema::name& field_definition::name() const {
    return name_;
}

dogen::dynamic::schema::name& field_definition::name() {
    return name_;
}

void field_definition::name(const dogen::dynamic::schema::name& v) {
    name_ = v;
}
...
void field_definition::scope(const dogen::dynamic::schema::scope_types& v) {
    scope_ = v;
}

const dogen::dynamic::schema::ownership_hierarchy& field_definition::ownership_hierarchy() const {
    return ownership_hierarchy_;
}

dogen::dynamic::schema::ownership_hierarchy& field_definition::ownership_hierarchy() {
    return ownership_hierarchy_;
}

void field_definition::ownership_hierarchy(const dogen::dynamic::schema::ownership_hierarchy& v) {
...
const boost::shared_ptr<dogen::dynamic::schema::value>& field_definition::default_value() const {
    return default_value_;
}

boost::shared_ptr<dogen::dynamic::schema::value>& field_definition::default_value() {
    return default_value_;
}
