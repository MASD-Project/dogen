...
const std::unordered_map<std::string, dogen::dynamic::field_instance_definition>& profile::instance_definitions() const {
    return instance_definitions_;
}

std::unordered_map<std::string, dogen::dynamic::field_instance_definition>& profile::instance_definitions() {
    return instance_definitions_;
}

void profile::instance_definitions(const std::unordered_map<std::string, dogen::dynamic::field_instance_definition>& v) {
...
const dogen::dynamic::object& profile::content() const {
    return content_;
}

dogen::dynamic::object& profile::content() {
    return content_;
}

void profile::content(const dogen::dynamic::object& v) {
    content_ = v;
}
