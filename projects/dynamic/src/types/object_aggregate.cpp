...
const dogen::dynamic::object& object_aggregate::element() const {
    return element_;
}

dogen::dynamic::object& object_aggregate::element() {
    return element_;
}

void object_aggregate::element(const dogen::dynamic::object& v) {
    element_ = v;
}
...
const std::unordered_map<std::string, dogen::dynamic::object>& object_aggregate::attributes() const {
    return attributes_;
}

std::unordered_map<std::string, dogen::dynamic::object>& object_aggregate::attributes() {
    return attributes_;
}

void object_aggregate::attributes(const std::unordered_map<std::string, dogen::dynamic::object>& v) {
    attributes_ = v;
}
