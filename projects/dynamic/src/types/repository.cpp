...
const std::list<dogen::dynamic::field_definition>& repository::all_field_definitions() const {
    return all_field_definitions_;
}

std::list<dogen::dynamic::field_definition>& repository::all_field_definitions() {
    return all_field_definitions_;
}

void repository::all_field_definitions(const std::list<dogen::dynamic::field_definition>& v) {
...
const std::unordered_map<std::string, dogen::dynamic::field_definition>& repository::field_definitions_by_name() const {
    return field_definitions_by_name_;
}

std::unordered_map<std::string, dogen::dynamic::field_definition>& repository::field_definitions_by_name() {
    return field_definitions_by_name_;
}

void repository::field_definitions_by_name(const std::unordered_map<std::string, dogen::dynamic::field_definition>& v) {
...
const std::unordered_map<std::string, std::list<dogen::dynamic::field_definition> >& repository::field_definitions_by_facet_name() const {
    return field_definitions_by_facet_name_;
}

std::unordered_map<std::string, std::list<dogen::dynamic::field_definition> >& repository::field_definitions_by_facet_name() {
    return field_definitions_by_facet_name_;
}

void repository::field_definitions_by_facet_name(const std::unordered_map<std::string, std::list<dogen::dynamic::field_definition> >& v) {
...
const std::unordered_map<std::string, std::list<dogen::dynamic::field_definition> >& repository::field_definitions_by_formatter_name() const {
    return field_definitions_by_formatter_name_;
}

std::unordered_map<std::string, std::list<dogen::dynamic::field_definition> >& repository::field_definitions_by_formatter_name() {
    return field_definitions_by_formatter_name_;
}

void repository::field_definitions_by_formatter_name(const std::unordered_map<std::string, std::list<dogen::dynamic::field_definition> >& v) {
...
const std::unordered_map<std::string, std::list<dogen::dynamic::field_definition> >& repository::field_definitions_by_model_name() const {
    return field_definitions_by_model_name_;
}

std::unordered_map<std::string, std::list<dogen::dynamic::field_definition> >& repository::field_definitions_by_model_name() {
    return field_definitions_by_model_name_;
}

void repository::field_definitions_by_model_name(const std::unordered_map<std::string, std::list<dogen::dynamic::field_definition> >& v) {
