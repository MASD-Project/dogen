 ...
 *
 */
#ifndef DOGEN_DYNAMIC_SERIALIZATION_RAW_AGGREGATE_SER_HPP
#define DOGEN_DYNAMIC_SERIALIZATION_RAW_AGGREGATE_SER_HPP
...
BOOST_SERIALIZATION_SPLIT_FREE(dogen::dynamic::raw_aggregate)
namespace boost {
