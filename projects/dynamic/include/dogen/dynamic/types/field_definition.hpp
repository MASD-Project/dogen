...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::dynamic::field_definition& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::dynamic::field_definition& v, unsigned int version);
...
private:
    ...
    dogen::dynamic::value_types value_type_;
    ...
    dogen::dynamic::field_definition_types definition_type_;
};
