 ...
 *
 */
#ifndef DOGEN_DYNAMIC_TYPES_OWNERSHIP_HIERARCHY_HPP
#define DOGEN_DYNAMIC_TYPES_OWNERSHIP_HIERARCHY_HPP
...
#include <string>
#include <algorithm>
#include "dogen/dynamic/serialization/ownership_hierarchy_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::dynamic::ownership_hierarchy& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::dynamic::ownership_hierarchy& v, unsigned int version);
...
template<>
inline void swap(
    dogen::dynamic::ownership_hierarchy& lhs,
    dogen::dynamic::ownership_hierarchy& rhs) {
    lhs.swap(rhs);
}
