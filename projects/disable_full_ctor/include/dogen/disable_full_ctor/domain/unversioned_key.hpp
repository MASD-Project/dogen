 ...
 *
 */
#ifndef DOGEN_DISABLE_FULL_CTOR_DOMAIN_UNVERSIONED_KEY_HPP
#define DOGEN_DISABLE_FULL_CTOR_DOMAIN_UNVERSIONED_KEY_HPP
...
#include <algorithm>
#include "dogen/disable_full_ctor/serialization/unversioned_key_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::disable_full_ctor::unversioned_key& lhs,
    dogen::disable_full_ctor::unversioned_key& rhs) {
    lhs.swap(rhs);
}
