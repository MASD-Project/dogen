 ...
 *
 */
#ifndef DOGEN_DISABLE_FULL_CTOR_DOMAIN_VERSIONED_KEY_HPP
#define DOGEN_DISABLE_FULL_CTOR_DOMAIN_VERSIONED_KEY_HPP
...
#include "dogen/disable_full_ctor/serialization/versioned_key_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::disable_full_ctor::versioned_key& lhs,
    dogen::disable_full_ctor::versioned_key& rhs) {
    lhs.swap(rhs);
}
