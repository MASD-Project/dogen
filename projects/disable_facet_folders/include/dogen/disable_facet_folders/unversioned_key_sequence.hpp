 ...
 *
 */
#ifndef DOGEN_DISABLE_FACET_FOLDERS_UNVERSIONED_KEY_SEQUENCE_HPP
#define DOGEN_DISABLE_FACET_FOLDERS_UNVERSIONED_KEY_SEQUENCE_HPP
...
public:
    typedef dogen::disable_facet_folders::unversioned_key value_type;
