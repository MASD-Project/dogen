 ...
 *
 */
#ifndef DOGEN_DISABLE_FACET_FOLDERS_VERSIONED_KEY_HASH_HPP
#define DOGEN_DISABLE_FACET_FOLDERS_VERSIONED_KEY_HASH_HPP
...
public:
    size_t operator()(dogen::disable_facet_folders::versioned_key value) const {
