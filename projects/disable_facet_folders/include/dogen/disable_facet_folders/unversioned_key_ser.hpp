...
BOOST_SERIALIZATION_SPLIT_FREE(dogen::disable_facet_folders::unversioned_key)
BOOST_CLASS_EXPORT_KEY(dogen::disable_facet_folders::unversioned_key)
...
template<typename Archive>
void load(Archive& ar, dogen::disable_facet_folders::unversioned_key& v, unsigned int version);
