 ...
 *
 */
#ifndef DOGEN_DISABLE_FACET_FOLDERS_UNVERSIONED_KEY_HPP
#define DOGEN_DISABLE_FACET_FOLDERS_UNVERSIONED_KEY_HPP
...
#include <algorithm>
#include "dogen/disable_facet_folders/unversioned_key_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::disable_facet_folders::unversioned_key& lhs,
    dogen::disable_facet_folders::unversioned_key& rhs) {
    lhs.swap(rhs);
}
