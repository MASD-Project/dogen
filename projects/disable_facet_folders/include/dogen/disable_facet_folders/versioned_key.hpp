 ...
 *
 */
#ifndef DOGEN_DISABLE_FACET_FOLDERS_VERSIONED_KEY_HPP
#define DOGEN_DISABLE_FACET_FOLDERS_VERSIONED_KEY_HPP
...
public:
    friend class dogen::disable_facet_folders::versioned_key_serializer;
...
template<>
inline void swap(
    dogen::disable_facet_folders::versioned_key& lhs,
    dogen::disable_facet_folders::versioned_key& rhs) {
    lhs.swap(rhs);
}
