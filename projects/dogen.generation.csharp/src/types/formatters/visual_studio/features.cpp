...
make_masd_generation_csharp_visual_studio_directory() {
    using namespace dogen::variability::meta_model;
    feature_template r;
    r.name().simple("directory");
    r.name().qualified("masd.generation.csharp.visual_studio.directory");
...
dogen::variability::meta_model::feature_template
make_masd_generation_csharp_visual_studio_postfix() {
    using namespace dogen::variability::meta_model;
    feature_template r;
    r.name().simple("postfix");
    r.name().qualified("masd.generation.csharp.visual_studio.postfix");
    const auto vt(value_type::text);
    r.value_type(vt);
    r.binding_point(binding_point::global);
    r.kind(template_kind::instance);
...
dogen::variability::meta_model::feature_template
make_masd_generation_csharp_visual_studio_new_project_postfix() {
    using namespace dogen::variability::meta_model;
    feature_template r;
    r.name().simple("postfix");
    r.name().qualified("masd.generation.csharp.visual_studio.new_project.postfix");
    const auto vt(value_type::text);
    r.value_type(vt);
    r.binding_point(binding_point::global);
    r.kind(template_kind::instance);
