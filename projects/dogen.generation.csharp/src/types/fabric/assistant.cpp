...
void assistant::accept(const dogen::assets::meta_model::element_visitor& v) const {
...
void assistant::accept(dogen::assets::meta_model::element_visitor& v) const {
...
void assistant::accept(const dogen::assets::meta_model::element_visitor& v) {
    typedef const element_visitor* derived_ptr;
    const auto dv(dynamic_cast<derived_ptr>(&v));
    if (dv)
        dv->visit(*this);
...
void assistant::accept(dogen::assets::meta_model::element_visitor& v) {
    typedef element_visitor* derived_ptr;
    const auto dv(dynamic_cast<derived_ptr>(&v));
    if (dv)
        dv->visit(*this);
...
bool assistant::equals(const dogen::assets::meta_model::element& other) const {
