...
#include "dogen.generation.csharp/serialization/registrar_ser.hpp"
...
void register_types(Archive& ar) {
    ...
    ar.template register_type<dogen::generation::csharp::fabric::assembly_info>();
    ar.template register_type<dogen::generation::csharp::fabric::assistant>();
    ar.template register_type<dogen::generation::csharp::fabric::visual_studio_project>();
    ar.template register_type<dogen::generation::csharp::fabric::visual_studio_solution>();
}
