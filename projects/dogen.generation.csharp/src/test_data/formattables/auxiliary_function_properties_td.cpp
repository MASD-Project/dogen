...
dogen::generation::csharp::formattables::auxiliary_function_types
create_dogen_generation_csharp_formattables_auxiliary_function_types(const unsigned int position) {
    return dogen::generation::csharp::formattables::auxiliary_function_types_generator::create(position);
}
...
populate(const unsigned int position, result_type& v) {
    v.type(create_dogen_generation_csharp_formattables_auxiliary_function_types(position + 0));
