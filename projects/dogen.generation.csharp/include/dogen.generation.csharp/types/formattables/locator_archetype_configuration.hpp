...
#include <string>
#include <algorithm>
#include "dogen.generation.csharp/serialization/formattables/locator_archetype_configuration_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::generation::csharp::formattables::locator_archetype_configuration& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::generation::csharp::formattables::locator_archetype_configuration& v, unsigned int version);
