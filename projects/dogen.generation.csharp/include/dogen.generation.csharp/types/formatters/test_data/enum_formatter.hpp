 ...
 *
 */
#ifndef DOGEN_GENERATION_CSHARP_TYPES_FORMATTERS_TEST_DATA_ENUM_FORMATTER_HPP
#define DOGEN_GENERATION_CSHARP_TYPES_FORMATTERS_TEST_DATA_ENUM_FORMATTER_HPP
