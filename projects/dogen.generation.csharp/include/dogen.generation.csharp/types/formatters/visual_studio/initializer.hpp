 ...
 *
 */
#ifndef DOGEN_GENERATION_CSHARP_TYPES_FORMATTERS_VISUAL_STUDIO_INITIALIZER_HPP
#define DOGEN_GENERATION_CSHARP_TYPES_FORMATTERS_VISUAL_STUDIO_INITIALIZER_HPP
