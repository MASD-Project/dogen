 ...
 *
 */
#ifndef DOGEN_GENERATION_CSHARP_TYPES_FORMATTERS_IO_NEW_ASSISTANT_FORMATTER_HPP
#define DOGEN_GENERATION_CSHARP_TYPES_FORMATTERS_IO_NEW_ASSISTANT_FORMATTER_HPP
