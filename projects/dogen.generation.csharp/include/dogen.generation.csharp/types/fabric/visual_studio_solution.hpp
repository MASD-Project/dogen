 ...
 *
 */
#ifndef DOGEN_GENERATION_CSHARP_TYPES_FABRIC_VISUAL_STUDIO_SOLUTION_HPP
#define DOGEN_GENERATION_CSHARP_TYPES_FABRIC_VISUAL_STUDIO_SOLUTION_HPP
...
#include "dogen.generation.csharp/serialization/fabric/visual_studio_solution_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::generation::csharp::fabric::visual_studio_solution& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::generation::csharp::fabric::visual_studio_solution& v, unsigned int version);
...
template<>
inline void swap(
    dogen::generation::csharp::fabric::visual_studio_solution& lhs,
    dogen::generation::csharp::fabric::visual_studio_solution& rhs) {
    lhs.swap(rhs);
}
