 ...
 *
 */
#ifndef DOGEN_GENERATION_CSHARP_TYPES_FABRIC_VISUAL_STUDIO_PROJECT_HPP
#define DOGEN_GENERATION_CSHARP_TYPES_FABRIC_VISUAL_STUDIO_PROJECT_HPP
...
#include "dogen.generation.csharp/serialization/fabric/visual_studio_project_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::generation::csharp::fabric::visual_studio_project& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::generation::csharp::fabric::visual_studio_project& v, unsigned int version);
...
template<>
inline void swap(
    dogen::generation::csharp::fabric::visual_studio_project& lhs,
    dogen::generation::csharp::fabric::visual_studio_project& rhs) {
    lhs.swap(rhs);
}
