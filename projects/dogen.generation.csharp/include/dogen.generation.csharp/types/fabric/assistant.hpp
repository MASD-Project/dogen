...
#include "dogen.generation.csharp/serialization/fabric/assistant_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::generation::csharp::fabric::assistant& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::generation::csharp::fabric::assistant& v, unsigned int version);
