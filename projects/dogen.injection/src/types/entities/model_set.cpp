...
const dogen::injection::entities::model& model_set::target() const {
    return target_;
}

dogen::injection::entities::model& model_set::target() {
    return target_;
}

void model_set::target(const dogen::injection::entities::model& v) {
    target_ = v;
}
...
const std::list<dogen::injection::entities::model>& model_set::references() const {
    return references_;
}

std::list<dogen::injection::entities::model>& model_set::references() {
    return references_;
}

void model_set::references(const std::list<dogen::injection::entities::model>& v) {
    references_ = v;
}
...
const dogen::injection::entities::reference_graph_data& model_set::reference_graph_data() const {
    return reference_graph_data_;
}

dogen::injection::entities::reference_graph_data& model_set::reference_graph_data() {
    return reference_graph_data_;
}

void model_set::reference_graph_data(const dogen::injection::entities::reference_graph_data& v) {
