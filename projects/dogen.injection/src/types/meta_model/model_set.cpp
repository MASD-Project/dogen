...
const dogen::injection::meta_model::model& model_set::target() const {
    return target_;
}

dogen::injection::meta_model::model& model_set::target() {
    return target_;
}

void model_set::target(const dogen::injection::meta_model::model& v) {
    target_ = v;
}
...
const std::list<dogen::injection::meta_model::model>& model_set::references() const {
    return references_;
}

std::list<dogen::injection::meta_model::model>& model_set::references() {
    return references_;
}
