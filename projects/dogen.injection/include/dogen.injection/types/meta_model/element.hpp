 ...
 *
 */
#ifndef DOGEN_INJECTION_TYPES_META_MODEL_ELEMENT_HPP
#define DOGEN_INJECTION_TYPES_META_MODEL_ELEMENT_HPP
...
public:
    ...
    const std::list<dogen::injection::meta_model::attribute>& attributes() const;
    std::list<dogen::injection::meta_model::attribute>& attributes();
    void attributes(const std::list<dogen::injection::meta_model::attribute>& v);
    void attributes(const std::list<dogen::injection::meta_model::attribute>&& v);
...
template<>
inline void swap(
    dogen::injection::meta_model::element& lhs,
    dogen::injection::meta_model::element& rhs) {
    lhs.swap(rhs);
}
