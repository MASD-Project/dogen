 ...
 *
 */
#ifndef DOGEN_INJECTION_TYPES_META_MODEL_REFERENCE_GRAPH_DATA_HPP
#define DOGEN_INJECTION_TYPES_META_MODEL_REFERENCE_GRAPH_DATA_HPP
...
template<>
inline void swap(
    dogen::injection::meta_model::reference_graph_data& lhs,
    dogen::injection::meta_model::reference_graph_data& rhs) {
    lhs.swap(rhs);
}
