 ...
 *
 */
#ifndef DOGEN_INJECTION_TYPES_FEATURES_INPUT_TECHNICAL_SPACE_HPP
#define DOGEN_INJECTION_TYPES_FEATURES_INPUT_TECHNICAL_SPACE_HPP
...
/**
 * @brief Feature bundle for the input technical space.
 */
class input_technical_space final {
public:
    struct feature_group {
        variability::entities::feature input_technical_space;
    };
