 ...
 *
 */
#ifndef DOGEN_INJECTION_TYPES_ENTITIES_REFERENCE_GRAPH_DATA_HPP
#define DOGEN_INJECTION_TYPES_ENTITIES_REFERENCE_GRAPH_DATA_HPP
...
template<>
inline void swap(
    dogen::injection::entities::reference_graph_data& lhs,
    dogen::injection::entities::reference_graph_data& rhs) {
    lhs.swap(rhs);
}
