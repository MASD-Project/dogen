 ...
 *
 */
#ifndef DOGEN_STEREOTYPES_HASH_PKG1_KEYED_IN_PACKAGE_UNVERSIONED_KEY_HASH_HPP
#define DOGEN_STEREOTYPES_HASH_PKG1_KEYED_IN_PACKAGE_UNVERSIONED_KEY_HASH_HPP
...
class keyed_in_package_unversioned_key_hasher {
public:
