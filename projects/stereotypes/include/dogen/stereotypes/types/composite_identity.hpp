 ...
 *
 */
#ifndef DOGEN_STEREOTYPES_TYPES_COMPOSITE_IDENTITY_HPP
#define DOGEN_STEREOTYPES_TYPES_COMPOSITE_IDENTITY_HPP
...
#include <algorithm>
#include "dogen/stereotypes/serialization/composite_identity_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::stereotypes::composite_identity& lhs,
    dogen::stereotypes::composite_identity& rhs) {
    lhs.swap(rhs);
}
