 ...
 *
 */
#ifndef DOGEN_STEREOTYPES_TYPES_COMPOSITE_IDENTITY_VER_UNVERSIONED_KEY_HPP
#define DOGEN_STEREOTYPES_TYPES_COMPOSITE_IDENTITY_VER_UNVERSIONED_KEY_HPP
...
#include <algorithm>
#include "dogen/stereotypes/serialization/composite_identity_ver_unversioned_key_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::stereotypes::composite_identity_ver_unversioned_key& lhs,
    dogen::stereotypes::composite_identity_ver_unversioned_key& rhs) {
    lhs.swap(rhs);
}
