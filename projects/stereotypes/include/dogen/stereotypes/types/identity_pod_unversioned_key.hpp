 ...
 *
 */
#ifndef DOGEN_STEREOTYPES_TYPES_IDENTITY_POD_UNVERSIONED_KEY_HPP
#define DOGEN_STEREOTYPES_TYPES_IDENTITY_POD_UNVERSIONED_KEY_HPP
...
#include <algorithm>
#include "dogen/stereotypes/serialization/identity_pod_unversioned_key_fwd_ser.hpp"
...
public:
    explicit identity_pod_unversioned_key(const dogen::stereotypes::value& prop_0);
...
template<>
inline void swap(
    dogen::stereotypes::identity_pod_unversioned_key& lhs,
    dogen::stereotypes::identity_pod_unversioned_key& rhs) {
    lhs.swap(rhs);
}
