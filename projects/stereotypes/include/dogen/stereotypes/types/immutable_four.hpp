 ...
 *
 */
#ifndef DOGEN_STEREOTYPES_TYPES_IMMUTABLE_FOUR_HPP
#define DOGEN_STEREOTYPES_TYPES_IMMUTABLE_FOUR_HPP
...
#include <algorithm>
#include <string>
#include "dogen/stereotypes/serialization/immutable_four_fwd_ser.hpp"
...
public:
    immutable_four(
        ...
        const dogen::stereotypes::entity& prop_2,
        const dogen::stereotypes::immutable_one_primitive& prop_3);
...
public:
    ...
    const dogen::stereotypes::entity& prop_2() const;

    const dogen::stereotypes::immutable_one_primitive& prop_3() const;
...
private:
    bool prop_0_;
    std::string prop_1_;
    dogen::stereotypes::entity prop_2_;
    dogen::stereotypes::immutable_one_primitive prop_3_;
};
