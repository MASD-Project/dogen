 ...
 *
 */
#ifndef DOGEN_STEREOTYPES_TYPES_VALUE_HPP
#define DOGEN_STEREOTYPES_TYPES_VALUE_HPP
...
#include <algorithm>
#include "dogen/stereotypes/serialization/value_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::stereotypes::value& lhs,
    dogen::stereotypes::value& rhs) {
    lhs.swap(rhs);
}
