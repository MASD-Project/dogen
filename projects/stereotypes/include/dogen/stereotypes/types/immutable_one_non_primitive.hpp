 ...
 *
 */
#ifndef DOGEN_STEREOTYPES_TYPES_IMMUTABLE_ONE_NON_PRIMITIVE_HPP
#define DOGEN_STEREOTYPES_TYPES_IMMUTABLE_ONE_NON_PRIMITIVE_HPP
...
#include <algorithm>
#include <string>
#include "dogen/stereotypes/serialization/immutable_one_non_primitive_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const immutable_one_non_primitive& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, immutable_one_non_primitive& v, unsigned int version);
