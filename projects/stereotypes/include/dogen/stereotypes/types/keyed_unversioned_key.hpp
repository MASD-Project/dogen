 ...
 *
 */
#ifndef DOGEN_STEREOTYPES_TYPES_KEYED_UNVERSIONED_KEY_HPP
#define DOGEN_STEREOTYPES_TYPES_KEYED_UNVERSIONED_KEY_HPP
...
#include <algorithm>
#include "dogen/stereotypes/serialization/keyed_unversioned_key_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::stereotypes::keyed_unversioned_key& lhs,
    dogen::stereotypes::keyed_unversioned_key& rhs) {
    lhs.swap(rhs);
}
