 ...
 *
 */
#ifndef DOGEN_STEREOTYPES_TYPES_IDENTITY_AND_OTHER_VER_HPP
#define DOGEN_STEREOTYPES_TYPES_IDENTITY_AND_OTHER_VER_HPP
...
#include <algorithm>
#include "dogen/stereotypes/serialization/identity_and_other_ver_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::stereotypes::identity_and_other_ver& lhs,
    dogen::stereotypes::identity_and_other_ver& rhs) {
    lhs.swap(rhs);
}
