 ...
 *
 */
#ifndef DOGEN_STEREOTYPES_SERIALIZATION_IMMUTABLE_ONE_NON_PRIMITIVE_SER_HPP
#define DOGEN_STEREOTYPES_SERIALIZATION_IMMUTABLE_ONE_NON_PRIMITIVE_SER_HPP
...
BOOST_SERIALIZATION_SPLIT_FREE(dogen::stereotypes::immutable_one_non_primitive)
namespace boost {
