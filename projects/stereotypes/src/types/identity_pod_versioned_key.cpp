...
const dogen::stereotypes::value& identity_pod_versioned_key::prop_0() const {
    return prop_0_;
}

dogen::stereotypes::value& identity_pod_versioned_key::prop_0() {
    return prop_0_;
}

void identity_pod_versioned_key::prop_0(const dogen::stereotypes::value& v) {
    prop_0_ = v;
}
