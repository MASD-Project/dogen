...
composite_identity_ver_generator::composite_identity_ver_generator() : position_(0) { }

void composite_identity_ver_generator::
populate(const unsigned int position, result_type& v) {
    v.prop_0(create_int(position + 0));
    v.prop_1(create_int(position + 1));
    v.prop_2(create_int(position + 2));
    v.version(create_unsigned_int(position + 3));
}

composite_identity_ver_generator::result_type
composite_identity_ver_generator::create(const unsigned int position) {
    composite_identity_ver r;
...
composite_identity_ver_generator::create_ptr(const unsigned int position) {
    ...
    composite_identity_ver_generator::populate(position, *p);
    return p;
}

composite_identity_ver_generator::result_type
composite_identity_ver_generator::operator()() {
