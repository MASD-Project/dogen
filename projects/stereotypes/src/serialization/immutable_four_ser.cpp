...
void save(Archive& ar,
    const dogen::stereotypes::immutable_four& v,
...
void load(Archive& ar,
    dogen::stereotypes::immutable_four& v,
    const unsigned int /*version*/) {
    ar >> make_nvp("prop_0", v.prop_0_);
    ar >> make_nvp("prop_1", v.prop_1_);
    ar >> make_nvp("prop_2", v.prop_2_);
...
template void save(archive::polymorphic_oarchive& ar, const dogen::stereotypes::immutable_four& v, unsigned int version);
template void load(archive::polymorphic_iarchive& ar, dogen::stereotypes::immutable_four& v, unsigned int version);

template void save(archive::text_oarchive& ar, const dogen::stereotypes::immutable_four& v, unsigned int version);
template void load(archive::text_iarchive& ar, dogen::stereotypes::immutable_four& v, unsigned int version);

template void save(archive::binary_oarchive& ar, const dogen::stereotypes::immutable_four& v, unsigned int version);
template void load(archive::binary_iarchive& ar, dogen::stereotypes::immutable_four& v, unsigned int version);
