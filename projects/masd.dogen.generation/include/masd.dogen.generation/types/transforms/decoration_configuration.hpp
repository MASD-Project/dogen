 ...
 *
 */
#ifndef MASD_DOGEN_GENERATION_TYPES_TRANSFORMS_DECORATION_CONFIGURATION_HPP
#define MASD_DOGEN_GENERATION_TYPES_TRANSFORMS_DECORATION_CONFIGURATION_HPP
...
template<>
inline void swap(
    masd::dogen::generation::transforms::decoration_configuration& lhs,
    masd::dogen::generation::transforms::decoration_configuration& rhs) {
    lhs.swap(rhs);
}
