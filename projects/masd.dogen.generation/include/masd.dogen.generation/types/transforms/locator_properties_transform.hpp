 ...
 *
 */
#ifndef MASD_DOGEN_GENERATION_TYPES_TRANSFORMS_LOCATOR_PROPERTIES_TRANSFORM_HPP
#define MASD_DOGEN_GENERATION_TYPES_TRANSFORMS_LOCATOR_PROPERTIES_TRANSFORM_HPP
