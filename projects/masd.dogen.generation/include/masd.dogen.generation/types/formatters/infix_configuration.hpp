 ...
 *
 */
#ifndef MASD_DOGEN_GENERATION_TYPES_FORMATTERS_INFIX_CONFIGURATION_HPP
#define MASD_DOGEN_GENERATION_TYPES_FORMATTERS_INFIX_CONFIGURATION_HPP
...
template<>
inline void swap(
    masd::dogen::generation::formatters::infix_configuration& lhs,
    masd::dogen::generation::formatters::infix_configuration& rhs) {
    lhs.swap(rhs);
}
