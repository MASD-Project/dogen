 ...
 *
 */
#ifndef MASD_DOGEN_GENERATION_TYPES_FORMATTERS_SCOPED_BOILERPLATE_FORMATTER_HPP
#define MASD_DOGEN_GENERATION_TYPES_FORMATTERS_SCOPED_BOILERPLATE_FORMATTER_HPP
