 ...
 *
 */
#ifndef MASD_DOGEN_GENERATION_TYPES_META_MODEL_LOCATOR_PROPERTIES_HPP
#define MASD_DOGEN_GENERATION_TYPES_META_MODEL_LOCATOR_PROPERTIES_HPP
...
public:
    masd::dogen::generation::meta_model::directory_structure_styles directory_structure_style() const;
    void directory_structure_style(const masd::dogen::generation::meta_model::directory_structure_styles v);
    ...
    const masd::dogen::generation::meta_model::model_segment_properties& model_segment_properties() const;
    masd::dogen::generation::meta_model::model_segment_properties& model_segment_properties();
    void model_segment_properties(const masd::dogen::generation::meta_model::model_segment_properties& v);
    void model_segment_properties(const masd::dogen::generation::meta_model::model_segment_properties&& v);
    ...
    const std::unordered_map<std::string, masd::dogen::generation::meta_model::archetype_family_properties>& archetype_family_properties() const;
    std::unordered_map<std::string, masd::dogen::generation::meta_model::archetype_family_properties>& archetype_family_properties();
    void archetype_family_properties(const std::unordered_map<std::string, masd::dogen::generation::meta_model::archetype_family_properties>& v);
    void archetype_family_properties(const std::unordered_map<std::string, masd::dogen::generation::meta_model::archetype_family_properties>&& v);
...
private:
    masd::dogen::generation::meta_model::directory_structure_styles directory_structure_style_;
    std::string name_separator_;
    masd::dogen::generation::meta_model::model_segment_properties model_segment_properties_;
    ...
    std::unordered_map<std::string, masd::dogen::generation::meta_model::archetype_family_properties> archetype_family_properties_;
...
template<>
inline void swap(
    masd::dogen::generation::meta_model::locator_properties& lhs,
    masd::dogen::generation::meta_model::locator_properties& rhs) {
    lhs.swap(rhs);
}
