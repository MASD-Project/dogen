 ...
 *
 */
#ifndef MASD_DOGEN_GENERATION_TYPES_META_MODEL_BACKEND_PROPERTIES_HPP
#define MASD_DOGEN_GENERATION_TYPES_META_MODEL_BACKEND_PROPERTIES_HPP
...
template<>
inline void swap(
    masd::dogen::generation::meta_model::backend_properties& lhs,
    masd::dogen::generation::meta_model::backend_properties& rhs) {
    lhs.swap(rhs);
}
