 ...
 *
 */
#ifndef MASD_DOGEN_GENERATION_TYPES_META_MODEL_MODEL_HPP
#define MASD_DOGEN_GENERATION_TYPES_META_MODEL_MODEL_HPP
...
public:
    ...
    void enabled_archetype_for_element(const std::unordered_set<masd::dogen::generation::meta_model::element_archetype>& v);
    void enabled_archetype_for_element(const std::unordered_set<masd::dogen::generation::meta_model::element_archetype>&& v);

    const masd::dogen::generation::meta_model::locator_properties& locator_properties() const;
    masd::dogen::generation::meta_model::locator_properties& locator_properties();
    void locator_properties(const masd::dogen::generation::meta_model::locator_properties& v);
    void locator_properties(const masd::dogen::generation::meta_model::locator_properties&& v);

    const masd::dogen::generation::meta_model::global_archetype_location_properties& global_archetype_location_properties() const;
    masd::dogen::generation::meta_model::global_archetype_location_properties& global_archetype_location_properties();
...
template<>
inline void swap(
    masd::dogen::generation::meta_model::model& lhs,
    masd::dogen::generation::meta_model::model& rhs) {
    lhs.swap(rhs);
}
