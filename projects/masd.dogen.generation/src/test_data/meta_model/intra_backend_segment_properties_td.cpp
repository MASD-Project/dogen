...
masd::dogen::generation::meta_model::path_contribution_types
create_masd_dogen_generation_meta_model_path_contribution_types(const unsigned int position) {
    return masd::dogen::generation::meta_model::path_contribution_types_generator::create(position);
}
...
populate(const unsigned int position, result_type& v) {
    ...
    v.external_modules(create_masd_dogen_generation_meta_model_path_contribution_types(position + 2));
    v.model_modules(create_masd_dogen_generation_meta_model_path_contribution_types(position + 3));
    v.internal_modules(create_masd_dogen_generation_meta_model_path_contribution_types(position + 4));
    v.facet(create_masd_dogen_generation_meta_model_path_contribution_types(position + 5));
}
