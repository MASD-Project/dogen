...
#include "masd.dogen.generation/io/transforms/context_io.hpp"
...
inline std::ostream& operator<<(std::ostream& s, const std::unordered_map<std::string, masd::dogen::generation::meta_model::intra_backend_segment_properties>& v) {
    s << "[";
...
inline std::ostream& operator<<(std::ostream& s, const boost::shared_ptr<masd::dogen::variability::meta_model::feature_model>& v) {
    s << "{ " << "\"__type__\": " << "\"boost::shared_ptr\"" << ", "
      << "\"memory\": " << "\"" << static_cast<void*>(v.get()) << "\"" << ", ";
...
std::ostream& operator<<(std::ostream& s, const context& v) {
    s << " { "
      << "\"__type__\": " << "\"masd::dogen::generation::transforms::context\"" << ", "
