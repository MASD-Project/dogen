...
model_to_text_model_transform_registrar::model_to_text_model_transform_registrar(const std::unordered_map<masd::dogen::coding::meta_model::languages, std::shared_ptr<masd::dogen::generation::transforms::model_to_text_model_transform_interface> >& transforms_by_language_)
...
const std::unordered_map<masd::dogen::coding::meta_model::languages, std::shared_ptr<masd::dogen::generation::transforms::model_to_text_model_transform_interface> >& model_to_text_model_transform_registrar::transforms_by_language_() const {
    return transforms_by_language__;
}

std::unordered_map<masd::dogen::coding::meta_model::languages, std::shared_ptr<masd::dogen::generation::transforms::model_to_text_model_transform_interface> >& model_to_text_model_transform_registrar::transforms_by_language_() {
    return transforms_by_language__;
}

void model_to_text_model_transform_registrar::transforms_by_language_(const std::unordered_map<masd::dogen::coding::meta_model::languages, std::shared_ptr<masd::dogen::generation::transforms::model_to_text_model_transform_interface> >& v) {
