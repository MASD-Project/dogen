...
const std::unordered_map<std::string, std::unordered_map<masd::dogen::coding::meta_model::technical_space, boost::shared_ptr<masd::dogen::coding::meta_model::decoration::modeline> > >& decoration_repository::modelines_by_modeline_group_by_technical_space() const {
    return modelines_by_modeline_group_by_technical_space_;
}

std::unordered_map<std::string, std::unordered_map<masd::dogen::coding::meta_model::technical_space, boost::shared_ptr<masd::dogen::coding::meta_model::decoration::modeline> > >& decoration_repository::modelines_by_modeline_group_by_technical_space() {
    return modelines_by_modeline_group_by_technical_space_;
}

void decoration_repository::modelines_by_modeline_group_by_technical_space(const std::unordered_map<std::string, std::unordered_map<masd::dogen::coding::meta_model::technical_space, boost::shared_ptr<masd::dogen::coding::meta_model::decoration::modeline> > >& v) {
...
const std::unordered_map<std::string, boost::shared_ptr<masd::dogen::coding::meta_model::decoration::licence> >& decoration_repository::licences_by_name() const {
    return licences_by_name_;
}

std::unordered_map<std::string, boost::shared_ptr<masd::dogen::coding::meta_model::decoration::licence> >& decoration_repository::licences_by_name() {
    return licences_by_name_;
}

void decoration_repository::licences_by_name(const std::unordered_map<std::string, boost::shared_ptr<masd::dogen::coding::meta_model::decoration::licence> >& v) {
    licences_by_name_ = v;
}
...
const std::unordered_map<std::string, boost::shared_ptr<masd::dogen::coding::meta_model::decoration::generation_marker> >& decoration_repository::generation_markers_by_name() const {
    return generation_markers_by_name_;
}

std::unordered_map<std::string, boost::shared_ptr<masd::dogen::coding::meta_model::decoration::generation_marker> >& decoration_repository::generation_markers_by_name() {
    return generation_markers_by_name_;
}

void decoration_repository::generation_markers_by_name(const std::unordered_map<std::string, boost::shared_ptr<masd::dogen::coding::meta_model::decoration::generation_marker> >& v) {
