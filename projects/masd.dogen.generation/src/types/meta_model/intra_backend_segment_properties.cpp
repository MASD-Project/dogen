...
intra_backend_segment_properties::intra_backend_segment_properties()
    : external_modules_(static_cast<dogen::generation::meta_model::path_contribution_types>(0)),
      ...
      internal_modules_(static_cast<dogen::generation::meta_model::path_contribution_types>(0)),
      facet_(static_cast<dogen::generation::meta_model::path_contribution_types>(0)) { }
...
dogen::generation::meta_model::path_contribution_types intra_backend_segment_properties::external_modules() const {
    return external_modules_;
}

void intra_backend_segment_properties::external_modules(const dogen::generation::meta_model::path_contribution_types v) {
    external_modules_ = v;
}

dogen::generation::meta_model::path_contribution_types intra_backend_segment_properties::model_modules() const {
    return model_modules_;
}

void intra_backend_segment_properties::model_modules(const dogen::generation::meta_model::path_contribution_types v) {
    model_modules_ = v;
}

dogen::generation::meta_model::path_contribution_types intra_backend_segment_properties::internal_modules() const {
    return internal_modules_;
}

void intra_backend_segment_properties::internal_modules(const dogen::generation::meta_model::path_contribution_types v) {
    internal_modules_ = v;
}

dogen::generation::meta_model::path_contribution_types intra_backend_segment_properties::facet() const {
    return facet_;
}

void intra_backend_segment_properties::facet(const dogen::generation::meta_model::path_contribution_types v) {
    facet_ = v;
}
