...
// BOOST_IGNORE_AUTO_TEST_CASE(non_empty_path_produces_expected_header_guards) {
...
//     masd::dogen::extraction::cpp::header_guard_formatter f;
...
// BOOST_IGNORE_AUTO_TEST_CASE(empty_path_produces_no_header_guards) {
