 ...
 *
 */
#ifndef DOGEN_FRONTEND_TYPES_INPUT_DESCRIPTOR_HPP
#define DOGEN_FRONTEND_TYPES_INPUT_DESCRIPTOR_HPP
...
template<>
inline void swap(
    dogen::frontend::input_descriptor& lhs,
    dogen::frontend::input_descriptor& rhs) {
    lhs.swap(rhs);
}
