...
const std::string id("frontend.dia_model_provider");
...
std::string dia_model_provider::id() const {
    return ::id;
}

std::list<std::string> dia_model_provider::supported_extensions() const {
    return ::extensions;
}

dia_model_provider::~dia_model_provider() noexcept { }

sml::model dia_model_provider::
provide(const input_descriptor& d, const provider_settings& s) {
