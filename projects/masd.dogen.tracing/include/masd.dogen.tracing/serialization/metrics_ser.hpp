 ...
 *
 */
#ifndef MASD_DOGEN_TRACING_SERIALIZATION_METRICS_SER_HPP
#define MASD_DOGEN_TRACING_SERIALIZATION_METRICS_SER_HPP
...
BOOST_SERIALIZATION_SPLIT_FREE(masd::dogen::tracing::metrics)
namespace boost {
