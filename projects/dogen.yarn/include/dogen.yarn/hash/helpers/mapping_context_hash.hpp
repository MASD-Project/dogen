...
template<>
struct hash<dogen::yarn::helpers::mapping_context> {
public:
    size_t operator()(const dogen::yarn::helpers::mapping_context& v) const {
        return dogen::yarn::helpers::mapping_context_hasher::hash(v);
    }
};
