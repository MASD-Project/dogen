 ...
 *
 */
#ifndef DOGEN_YARN_TYPES_TRANSFORMS_NAMING_CONFIGURATION_HPP
#define DOGEN_YARN_TYPES_TRANSFORMS_NAMING_CONFIGURATION_HPP
...
#include <string>
#include <algorithm>
#include "dogen.yarn/serialization/transforms/naming_configuration_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::yarn::transforms::naming_configuration& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::yarn::transforms::naming_configuration& v, unsigned int version);
...
template<>
inline void swap(
    dogen::yarn::transforms::naming_configuration& lhs,
    dogen::yarn::transforms::naming_configuration& rhs) {
    lhs.swap(rhs);
}
