 ...
 *
 */
#ifndef DOGEN_YARN_TYPES_HELPERS_MAPPING_VALUE_HPP
#define DOGEN_YARN_TYPES_HELPERS_MAPPING_VALUE_HPP
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::yarn::helpers::mapping_value& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::yarn::helpers::mapping_value& v, unsigned int version);
...
template<>
inline void swap(
    dogen::yarn::helpers::mapping_value& lhs,
    dogen::yarn::helpers::mapping_value& rhs) {
    lhs.swap(rhs);
}
