 ...
 *
 */
#ifndef DOGEN_YARN_TYPES_HELPERS_MAPPING_SET_HPP
#define DOGEN_YARN_TYPES_HELPERS_MAPPING_SET_HPP
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::yarn::helpers::mapping_set& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::yarn::helpers::mapping_set& v, unsigned int version);
...
template<>
inline void swap(
    dogen::yarn::helpers::mapping_set& lhs,
    dogen::yarn::helpers::mapping_set& rhs) {
    lhs.swap(rhs);
}
