...
#include "dogen.yarn/serialization/meta_model/local_archetype_location_properties_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::yarn::meta_model::local_archetype_location_properties& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::yarn::meta_model::local_archetype_location_properties& v, unsigned int version);
...
template<>
inline void swap(
    dogen::yarn::meta_model::local_archetype_location_properties& lhs,
    dogen::yarn::meta_model::local_archetype_location_properties& rhs) {
    lhs.swap(rhs);
}
