...
#include "dogen.yarn/serialization/meta_model/artefact_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::yarn::meta_model::artefact& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::yarn::meta_model::artefact& v, unsigned int version);
...
template<>
inline void swap(
    dogen::yarn::meta_model::artefact& lhs,
    dogen::yarn::meta_model::artefact& rhs) {
    lhs.swap(rhs);
}
