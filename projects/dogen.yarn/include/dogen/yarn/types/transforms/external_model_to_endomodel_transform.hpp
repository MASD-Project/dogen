 ...
 *
 */
#ifndef DOGEN_YARN_TYPES_TRANSFORMS_EXTERNAL_MODEL_TO_ENDOMODEL_TRANSFORM_HPP
#define DOGEN_YARN_TYPES_TRANSFORMS_EXTERNAL_MODEL_TO_ENDOMODEL_TRANSFORM_HPP
