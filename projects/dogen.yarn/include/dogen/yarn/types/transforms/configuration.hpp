 ...
 *
 */
#ifndef DOGEN_YARN_TYPES_TRANSFORMS_CONFIGURATION_HPP
#define DOGEN_YARN_TYPES_TRANSFORMS_CONFIGURATION_HPP
...
#include "dogen/yarn/serialization/transforms/configuration_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::yarn::transforms::configuration& v, unsigned int version);
...
template<>
inline void swap(
    dogen::yarn::transforms::configuration& lhs,
    dogen::yarn::transforms::configuration& rhs) {
    lhs.swap(rhs);
}
