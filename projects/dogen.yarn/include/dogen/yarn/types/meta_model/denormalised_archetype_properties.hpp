...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::yarn::meta_model::denormalised_archetype_properties& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::yarn::meta_model::denormalised_archetype_properties& v, unsigned int version);
...
template<>
inline void swap(
    dogen::yarn::meta_model::denormalised_archetype_properties& lhs,
    dogen::yarn::meta_model::denormalised_archetype_properties& rhs) {
    lhs.swap(rhs);
}
