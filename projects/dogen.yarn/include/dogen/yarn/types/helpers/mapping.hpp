...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::yarn::helpers::mapping& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::yarn::helpers::mapping& v, unsigned int version);
...
template<>
inline void swap(
    dogen::yarn::helpers::mapping& lhs,
    dogen::yarn::helpers::mapping& rhs) {
    lhs.swap(rhs);
}
