...
formatting_configuration::formatting_configuration()
    : style_(static_cast<dogen::yarn::meta_model::formatting_styles>(0)) { }
...
dogen::yarn::meta_model::formatting_styles formatting_configuration::style() const {
    return style_;
}

void formatting_configuration::style(const dogen::yarn::meta_model::formatting_styles v) {
    style_ = v;
}
