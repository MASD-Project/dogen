...
dogen::yarn::helpers::mapping_set
create_dogen_yarn_helpers_mapping_set(const unsigned int position) {
    return dogen::yarn::helpers::mapping_set_generator::create(position);
}
...
std::unordered_map<std::string, dogen::yarn::helpers::mapping_set> create_std_unordered_map_std_string_dogen_yarn_helpers_mapping_set(unsigned int position) {
    std::unordered_map<std::string, dogen::yarn::helpers::mapping_set> r;
    for (unsigned int i(0); i < 4; ++i) {
        r.insert(std::make_pair(create_std_string(position + i), create_dogen_yarn_helpers_mapping_set(position + i)));
    }
    return r;
}
...
populate(const unsigned int position, result_type& v) {
    v.default_mapping_set(create_dogen_yarn_helpers_mapping_set(position + 0));
    v.by_name(create_std_unordered_map_std_string_dogen_yarn_helpers_mapping_set(position + 1));
}
