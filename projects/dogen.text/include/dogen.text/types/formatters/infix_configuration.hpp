 ...
 *
 */
#ifndef DOGEN_TEXT_TYPES_FORMATTERS_INFIX_CONFIGURATION_HPP
#define DOGEN_TEXT_TYPES_FORMATTERS_INFIX_CONFIGURATION_HPP
...
template<>
inline void swap(
    dogen::text::formatters::infix_configuration& lhs,
    dogen::text::formatters::infix_configuration& rhs) {
    lhs.swap(rhs);
}
