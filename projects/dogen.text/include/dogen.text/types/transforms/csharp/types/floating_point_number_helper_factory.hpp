 ...
 *
 */
#ifndef DOGEN_TEXT_TYPES_TRANSFORMS_CSHARP_TYPES_FLOATING_POINT_NUMBER_HELPER_FACTORY_HPP
#define DOGEN_TEXT_TYPES_TRANSFORMS_CSHARP_TYPES_FLOATING_POINT_NUMBER_HELPER_FACTORY_HPP
