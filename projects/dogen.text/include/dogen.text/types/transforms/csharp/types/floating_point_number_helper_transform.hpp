 ...
 *
 */
#ifndef DOGEN_TEXT_TYPES_TRANSFORMS_CSHARP_TYPES_FLOATING_POINT_NUMBER_HELPER_TRANSFORM_HPP
#define DOGEN_TEXT_TYPES_TRANSFORMS_CSHARP_TYPES_FLOATING_POINT_NUMBER_HELPER_TRANSFORM_HPP
...
class floating_point_number_helper_transform final : public text::transforms::helper_transform {
public:
