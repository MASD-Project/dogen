 ...
 *
 */
#ifndef DOGEN_TEXT_TYPES_TRANSFORMS_CSHARP_VISUAL_STUDIO_SOLUTION_FACTORY_HPP
#define DOGEN_TEXT_TYPES_TRANSFORMS_CSHARP_VISUAL_STUDIO_SOLUTION_FACTORY_HPP
