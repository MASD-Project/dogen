 ...
 *
 */
#ifndef DOGEN_TEXT_TYPES_TRANSFORMS_CSHARP_VISUAL_STUDIO_PROJECT_FACTORY_HPP
#define DOGEN_TEXT_TYPES_TRANSFORMS_CSHARP_VISUAL_STUDIO_PROJECT_FACTORY_HPP
