 ...
 *
 */
#ifndef DOGEN_TEXT_TYPES_TRANSFORMS_CSHARP_VISUAL_STUDIO_PROJECT_TRANSFORM_HPP
#define DOGEN_TEXT_TYPES_TRANSFORMS_CSHARP_VISUAL_STUDIO_PROJECT_TRANSFORM_HPP
...
class project_transform final : public text::transforms::model_to_text_transform {
public:
