 ...
 *
 */
#ifndef DOGEN_TEXT_TYPES_TRANSFORMS_CSHARP_CSHARP_TRANSFORM_HPP
#define DOGEN_TEXT_TYPES_TRANSFORMS_CSHARP_CSHARP_TRANSFORM_HPP
 ...
 */
class csharp_backend_chain final {
public:
