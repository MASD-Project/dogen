 ...
 *
 */
#ifndef DOGEN_TEXT_TYPES_TRANSFORMS_CPP_TEST_DATA_CHAR_HELPER_FACTORY_HPP
#define DOGEN_TEXT_TYPES_TRANSFORMS_CPP_TEST_DATA_CHAR_HELPER_FACTORY_HPP
 ...
 */
class char_helper_factory final {
public:
    /**
