 ...
 *
 */
#ifndef DOGEN_TEXT_TYPES_TRANSFORMS_CPP_TEST_DATA_PTREE_HELPER_FACTORY_HPP
#define DOGEN_TEXT_TYPES_TRANSFORMS_CPP_TEST_DATA_PTREE_HELPER_FACTORY_HPP
 ...
 */
class ptree_helper_factory final {
public:
    /**
