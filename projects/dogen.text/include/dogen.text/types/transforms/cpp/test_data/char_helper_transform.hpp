 ...
 *
 */
#ifndef DOGEN_TEXT_TYPES_TRANSFORMS_CPP_TEST_DATA_CHAR_HELPER_TRANSFORM_HPP
#define DOGEN_TEXT_TYPES_TRANSFORMS_CPP_TEST_DATA_CHAR_HELPER_TRANSFORM_HPP
...
class char_helper_transform final : public text::transforms::helper_transform {
public:
