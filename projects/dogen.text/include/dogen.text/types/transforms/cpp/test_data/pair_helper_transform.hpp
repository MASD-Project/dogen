 ...
 *
 */
#ifndef DOGEN_TEXT_TYPES_TRANSFORMS_CPP_TEST_DATA_PAIR_HELPER_TRANSFORM_HPP
#define DOGEN_TEXT_TYPES_TRANSFORMS_CPP_TEST_DATA_PAIR_HELPER_TRANSFORM_HPP
...
class pair_helper_transform final : public text::transforms::helper_transform {
public:
