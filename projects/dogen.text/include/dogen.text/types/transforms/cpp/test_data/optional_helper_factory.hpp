 ...
 *
 */
#ifndef DOGEN_TEXT_TYPES_TRANSFORMS_CPP_TEST_DATA_OPTIONAL_HELPER_FACTORY_HPP
#define DOGEN_TEXT_TYPES_TRANSFORMS_CPP_TEST_DATA_OPTIONAL_HELPER_FACTORY_HPP
 ...
 */
class optional_helper_factory final {
public:
    /**
