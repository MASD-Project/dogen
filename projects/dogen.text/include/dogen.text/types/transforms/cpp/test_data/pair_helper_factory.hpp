 ...
 *
 */
#ifndef DOGEN_TEXT_TYPES_TRANSFORMS_CPP_TEST_DATA_PAIR_HELPER_FACTORY_HPP
#define DOGEN_TEXT_TYPES_TRANSFORMS_CPP_TEST_DATA_PAIR_HELPER_FACTORY_HPP
 ...
 */
class pair_helper_factory final {
public:
    /**
