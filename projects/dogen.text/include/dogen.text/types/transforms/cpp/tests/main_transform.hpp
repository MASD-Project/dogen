 ...
 *
 */
#ifndef DOGEN_TEXT_TYPES_TRANSFORMS_CPP_TESTS_MAIN_TRANSFORM_HPP
#define DOGEN_TEXT_TYPES_TRANSFORMS_CPP_TESTS_MAIN_TRANSFORM_HPP
...
class main_transform final : public text::transforms::model_to_text_transform {
public:
