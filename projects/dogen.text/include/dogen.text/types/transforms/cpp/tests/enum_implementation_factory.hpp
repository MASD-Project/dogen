 ...
 *
 */
#ifndef DOGEN_TEXT_TYPES_TRANSFORMS_CPP_TESTS_ENUM_IMPLEMENTATION_FACTORY_HPP
#define DOGEN_TEXT_TYPES_TRANSFORMS_CPP_TESTS_ENUM_IMPLEMENTATION_FACTORY_HPP
