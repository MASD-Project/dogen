 ...
 *
 */
#ifndef DOGEN_TEXT_TYPES_TRANSFORMS_CPP_TESTS_CMAKELISTS_TRANSFORM_HPP
#define DOGEN_TEXT_TYPES_TRANSFORMS_CPP_TESTS_CMAKELISTS_TRANSFORM_HPP
...
class cmakelists_transform final : public text::transforms::model_to_text_transform {
public:
