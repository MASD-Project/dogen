 ...
 *
 */
#ifndef DOGEN_TEXT_TYPES_TRANSFORMS_CPP_ODB_ODB_TRANSFORM_HPP
#define DOGEN_TEXT_TYPES_TRANSFORMS_CPP_ODB_ODB_TRANSFORM_HPP
...
/**
 * @brief M2T transforms for the ODB facet of the
 * C++ technical space.
 */
