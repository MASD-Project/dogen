 ...
 *
 */
#ifndef DOGEN_TEXT_TYPES_TRANSFORMS_CPP_ODB_PRIMITIVE_ODB_OPTIONS_TRANSFORM_HPP
#define DOGEN_TEXT_TYPES_TRANSFORMS_CPP_ODB_PRIMITIVE_ODB_OPTIONS_TRANSFORM_HPP
...
class primitive_odb_options_transform final : public text::transforms::model_to_text_transform {
public:
