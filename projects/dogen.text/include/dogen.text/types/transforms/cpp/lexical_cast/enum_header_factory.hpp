 ...
 *
 */
#ifndef DOGEN_TEXT_TYPES_TRANSFORMS_CPP_LEXICAL_CAST_ENUM_HEADER_FACTORY_HPP
#define DOGEN_TEXT_TYPES_TRANSFORMS_CPP_LEXICAL_CAST_ENUM_HEADER_FACTORY_HPP
