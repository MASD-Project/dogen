 ...
 *
 */
#ifndef DOGEN_TEXT_TYPES_TRANSFORMS_CPP_LEXICAL_CAST_LEXICAL_CAST_TRANSFORM_HPP
#define DOGEN_TEXT_TYPES_TRANSFORMS_CPP_LEXICAL_CAST_LEXICAL_CAST_TRANSFORM_HPP
...
/**
 * @brief M2T transforms related to conversions from
 * and to string.
 */
