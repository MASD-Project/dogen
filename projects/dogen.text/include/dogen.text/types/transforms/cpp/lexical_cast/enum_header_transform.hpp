 ...
 *
 */
#ifndef DOGEN_TEXT_TYPES_TRANSFORMS_CPP_LEXICAL_CAST_ENUM_HEADER_TRANSFORM_HPP
#define DOGEN_TEXT_TYPES_TRANSFORMS_CPP_LEXICAL_CAST_ENUM_HEADER_TRANSFORM_HPP
