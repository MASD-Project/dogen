 ...
 *
 */
#ifndef DOGEN_TEXT_TYPES_TRANSFORMS_CPP_SERIALIZATION_SERIALIZATION_TRANSFORM_HPP
#define DOGEN_TEXT_TYPES_TRANSFORMS_CPP_SERIALIZATION_SERIALIZATION_TRANSFORM_HPP
...
/**
 * @brief M2T transforms for the boost serialisation
