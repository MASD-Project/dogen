 ...
 *
 */
#ifndef DOGEN_TEXT_TYPES_TRANSFORMS_CPP_SERIALIZATION_ENUM_HEADER_TRANSFORM_HPP
#define DOGEN_TEXT_TYPES_TRANSFORMS_CPP_SERIALIZATION_ENUM_HEADER_TRANSFORM_HPP
...
class enum_header_transform final : public text::transforms::model_to_text_transform {
public:
