 ...
 *
 */
#ifndef DOGEN_TEXT_TYPES_TRANSFORMS_CPP_SERIALIZATION_PATH_HELPER_TRANSFORM_HPP
#define DOGEN_TEXT_TYPES_TRANSFORMS_CPP_SERIALIZATION_PATH_HELPER_TRANSFORM_HPP
...
class path_helper_transform final : public text::transforms::helper_transform {
public:
