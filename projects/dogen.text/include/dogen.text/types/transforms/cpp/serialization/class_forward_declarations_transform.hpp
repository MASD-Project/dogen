 ...
 *
 */
#ifndef DOGEN_TEXT_TYPES_TRANSFORMS_CPP_SERIALIZATION_CLASS_FORWARD_DECLARATIONS_TRANSFORM_HPP
#define DOGEN_TEXT_TYPES_TRANSFORMS_CPP_SERIALIZATION_CLASS_FORWARD_DECLARATIONS_TRANSFORM_HPP
...
class class_forward_declarations_transform final : public text::transforms::model_to_text_transform {
public:
