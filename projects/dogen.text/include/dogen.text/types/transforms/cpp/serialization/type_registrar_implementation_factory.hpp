 ...
 *
 */
#ifndef DOGEN_TEXT_TYPES_TRANSFORMS_CPP_SERIALIZATION_TYPE_REGISTRAR_IMPLEMENTATION_FACTORY_HPP
#define DOGEN_TEXT_TYPES_TRANSFORMS_CPP_SERIALIZATION_TYPE_REGISTRAR_IMPLEMENTATION_FACTORY_HPP
