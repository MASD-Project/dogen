 ...
 *
 */
#ifndef DOGEN_TEXT_TYPES_TRANSFORMS_CPP_SERIALIZATION_PRIMITIVE_FORWARD_DECLARATIONS_TRANSFORM_HPP
#define DOGEN_TEXT_TYPES_TRANSFORMS_CPP_SERIALIZATION_PRIMITIVE_FORWARD_DECLARATIONS_TRANSFORM_HPP
