 ...
 *
 */
#ifndef DOGEN_TEXT_TYPES_TRANSFORMS_CPP_SERIALIZATION_PRIMITIVE_HEADER_TRANSFORM_HPP
#define DOGEN_TEXT_TYPES_TRANSFORMS_CPP_SERIALIZATION_PRIMITIVE_HEADER_TRANSFORM_HPP
...
class primitive_header_transform final : public text::transforms::model_to_text_transform {
public:
