 ...
 *
 */
#ifndef DOGEN_TEXT_TYPES_TRANSFORMS_CPP_HASH_SMART_POINTER_HELPER_FACTORY_HPP
#define DOGEN_TEXT_TYPES_TRANSFORMS_CPP_HASH_SMART_POINTER_HELPER_FACTORY_HPP
