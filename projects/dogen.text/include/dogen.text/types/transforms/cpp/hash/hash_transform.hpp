 ...
 *
 */
#ifndef DOGEN_TEXT_TYPES_TRANSFORMS_CPP_HASH_HASH_TRANSFORM_HPP
#define DOGEN_TEXT_TYPES_TRANSFORMS_CPP_HASH_HASH_TRANSFORM_HPP
...
/**
 * @brief M2T transforms for the hash facet of the
 * C++ technical space.
 */
class hash_facet_chain final {
public:
