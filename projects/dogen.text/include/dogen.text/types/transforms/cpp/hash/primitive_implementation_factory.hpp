 ...
 *
 */
#ifndef DOGEN_TEXT_TYPES_TRANSFORMS_CPP_HASH_PRIMITIVE_IMPLEMENTATION_FACTORY_HPP
#define DOGEN_TEXT_TYPES_TRANSFORMS_CPP_HASH_PRIMITIVE_IMPLEMENTATION_FACTORY_HPP
