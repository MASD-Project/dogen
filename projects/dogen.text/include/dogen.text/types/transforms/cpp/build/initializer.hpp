 ...
 *
 */
#ifndef DOGEN_TEXT_TYPES_TRANSFORMS_CPP_BUILD_INITIALIZER_HPP
#define DOGEN_TEXT_TYPES_TRANSFORMS_CPP_BUILD_INITIALIZER_HPP
...
/**
 * @brief Initialises the build facet.
 */
class initializer {
public:
