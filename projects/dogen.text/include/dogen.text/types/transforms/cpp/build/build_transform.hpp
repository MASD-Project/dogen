 ...
 *
 */
#ifndef DOGEN_TEXT_TYPES_TRANSFORMS_CPP_BUILD_BUILD_TRANSFORM_HPP
#define DOGEN_TEXT_TYPES_TRANSFORMS_CPP_BUILD_BUILD_TRANSFORM_HPP
...
/**
 * @brief M2T transforms related to build files.
 */
