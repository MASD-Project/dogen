 ...
 *
 */
#ifndef DOGEN_TEXT_TYPES_TRANSFORMS_CPP_BUILD_INCLUDE_CMAKELISTS_FACTORY_HPP
#define DOGEN_TEXT_TYPES_TRANSFORMS_CPP_BUILD_INCLUDE_CMAKELISTS_FACTORY_HPP
 ...
 */
class include_cmakelists_factory final {
public:
    /**
