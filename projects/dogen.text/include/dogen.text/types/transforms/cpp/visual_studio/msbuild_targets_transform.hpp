 ...
 *
 */
#ifndef DOGEN_TEXT_TYPES_TRANSFORMS_CPP_VISUAL_STUDIO_MSBUILD_TARGETS_TRANSFORM_HPP
#define DOGEN_TEXT_TYPES_TRANSFORMS_CPP_VISUAL_STUDIO_MSBUILD_TARGETS_TRANSFORM_HPP
...
class msbuild_targets_transform final : public text::transforms::model_to_text_transform {
public:
