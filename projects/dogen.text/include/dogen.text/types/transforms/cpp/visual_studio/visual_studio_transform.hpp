 ...
 *
 */
#ifndef DOGEN_TEXT_TYPES_TRANSFORMS_CPP_VISUAL_STUDIO_VISUAL_STUDIO_TRANSFORM_HPP
#define DOGEN_TEXT_TYPES_TRANSFORMS_CPP_VISUAL_STUDIO_VISUAL_STUDIO_TRANSFORM_HPP
...
/**
 * @brief M2T transforms related to Visual Studio
 * support.
 */
