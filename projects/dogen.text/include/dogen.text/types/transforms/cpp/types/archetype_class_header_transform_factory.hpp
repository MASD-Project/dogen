 ...
 *
 */
#ifndef DOGEN_TEXT_TYPES_TRANSFORMS_CPP_TYPES_ARCHETYPE_CLASS_HEADER_TRANSFORM_FACTORY_HPP
#define DOGEN_TEXT_TYPES_TRANSFORMS_CPP_TYPES_ARCHETYPE_CLASS_HEADER_TRANSFORM_FACTORY_HPP
 ...
 */
class archetype_class_header_transform_factory final {
public:
    /**
