 ...
 *
 */
#ifndef DOGEN_TEXT_TYPES_TRANSFORMS_CPP_TYPES_EXCEPTION_HEADER_TRANSFORM_HPP
#define DOGEN_TEXT_TYPES_TRANSFORMS_CPP_TYPES_EXCEPTION_HEADER_TRANSFORM_HPP
...
class exception_header_transform final : public text::transforms::model_to_text_transform {
public:
