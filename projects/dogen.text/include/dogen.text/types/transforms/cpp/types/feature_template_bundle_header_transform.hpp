 ...
 *
 */
#ifndef DOGEN_TEXT_TYPES_TRANSFORMS_CPP_TYPES_FEATURE_TEMPLATE_BUNDLE_HEADER_TRANSFORM_HPP
#define DOGEN_TEXT_TYPES_TRANSFORMS_CPP_TYPES_FEATURE_TEMPLATE_BUNDLE_HEADER_TRANSFORM_HPP
...
class feature_template_bundle_header_transform final : public text::transforms::model_to_text_transform {
public:
