 ...
 *
 */
#ifndef DOGEN_TEXT_TYPES_TRANSFORMS_CPP_TYPES_VARIABILITY_INITIALIZER_HEADER_FACTORY_HPP
#define DOGEN_TEXT_TYPES_TRANSFORMS_CPP_TYPES_VARIABILITY_INITIALIZER_HEADER_FACTORY_HPP
 ...
 */
class variability_initializer_header_factory final {
public:
    /**
