 ...
 *
 */
#ifndef DOGEN_TEXT_TYPES_TRANSFORMS_CPP_TYPES_VARIABILITY_INITIALIZER_IMPLEMENTATION_FACTORY_HPP
#define DOGEN_TEXT_TYPES_TRANSFORMS_CPP_TYPES_VARIABILITY_INITIALIZER_IMPLEMENTATION_FACTORY_HPP
 ...
 */
class variability_initializer_implementation_factory final {
public:
    /**
