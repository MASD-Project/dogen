 ...
 *
 */
#ifndef DOGEN_TEXT_TYPES_TRANSFORMS_CPP_TYPES_HELPER_CLASS_HEADER_FACTORY_TRANSFORM_HPP
#define DOGEN_TEXT_TYPES_TRANSFORMS_CPP_TYPES_HELPER_CLASS_HEADER_FACTORY_TRANSFORM_HPP
...
class helper_class_header_factory_transform final : public text::transforms::model_to_text_transform {
public:
