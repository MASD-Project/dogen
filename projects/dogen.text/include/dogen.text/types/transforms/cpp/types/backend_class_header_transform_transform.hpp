 ...
 *
 */
#ifndef DOGEN_TEXT_TYPES_TRANSFORMS_CPP_TYPES_BACKEND_CLASS_HEADER_TRANSFORM_TRANSFORM_HPP
#define DOGEN_TEXT_TYPES_TRANSFORMS_CPP_TYPES_BACKEND_CLASS_HEADER_TRANSFORM_TRANSFORM_HPP
...
class backend_class_header_transform_transform final : public text::transforms::model_to_text_transform {
public:
