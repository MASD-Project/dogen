 ...
 *
 */
#ifndef DOGEN_TEXT_TYPES_TRANSFORMS_CPP_TYPES_VARIABILITY_INITIALIZER_IMPLEMENTATION_TRANSFORM_HPP
#define DOGEN_TEXT_TYPES_TRANSFORMS_CPP_TYPES_VARIABILITY_INITIALIZER_IMPLEMENTATION_TRANSFORM_HPP
...
class variability_initializer_implementation_transform final : public text::transforms::model_to_text_transform {
public:
