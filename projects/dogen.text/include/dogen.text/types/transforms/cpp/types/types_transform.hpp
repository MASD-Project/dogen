 ...
 *
 */
#ifndef DOGEN_TEXT_TYPES_TRANSFORMS_CPP_TYPES_TYPES_TRANSFORM_HPP
#define DOGEN_TEXT_TYPES_TRANSFORMS_CPP_TYPES_TYPES_TRANSFORM_HPP
...
/**
 * @brief M2T transforms for the types facet of the
 * C++ technical space.
 */
