 ...
 *
 */
#ifndef DOGEN_TEXT_TYPES_TRANSFORMS_CPP_TYPES_PART_CLASS_IMPLEMENTATION_TRANSFORM_TRANSFORM_HPP
#define DOGEN_TEXT_TYPES_TRANSFORMS_CPP_TYPES_PART_CLASS_IMPLEMENTATION_TRANSFORM_TRANSFORM_HPP
...
class part_class_implementation_transform_transform final : public text::transforms::model_to_text_transform {
public:
