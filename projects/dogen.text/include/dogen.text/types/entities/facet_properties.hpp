 ...
 *
 */
#ifndef DOGEN_TEXT_TYPES_ENTITIES_FACET_PROPERTIES_HPP
#define DOGEN_TEXT_TYPES_ENTITIES_FACET_PROPERTIES_HPP
...
template<>
inline void swap(
    dogen::text::entities::facet_properties& lhs,
    dogen::text::entities::facet_properties& rhs) {
    lhs.swap(rhs);
}
