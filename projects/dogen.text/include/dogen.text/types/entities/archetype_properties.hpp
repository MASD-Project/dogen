 ...
 *
 */
#ifndef DOGEN_TEXT_TYPES_ENTITIES_ARCHETYPE_PROPERTIES_HPP
#define DOGEN_TEXT_TYPES_ENTITIES_ARCHETYPE_PROPERTIES_HPP
...
template<>
inline void swap(
    dogen::text::entities::archetype_properties& lhs,
    dogen::text::entities::archetype_properties& rhs) {
    lhs.swap(rhs);
}
