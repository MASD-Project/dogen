...
#include "dogen.text/serialization/entities/model_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::text::entities::model& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::text::entities::model& v, unsigned int version);
