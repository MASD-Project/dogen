 ...
 *
 */
#ifndef DOGEN_TEXT_TYPES_ENTITIES_BACKEND_PROPERTIES_HPP
#define DOGEN_TEXT_TYPES_ENTITIES_BACKEND_PROPERTIES_HPP
...
template<>
inline void swap(
    dogen::text::entities::backend_properties& lhs,
    dogen::text::entities::backend_properties& rhs) {
    lhs.swap(rhs);
}
