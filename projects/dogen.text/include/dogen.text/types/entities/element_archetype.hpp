 ...
 *
 */
#ifndef DOGEN_TEXT_TYPES_ENTITIES_ELEMENT_ARCHETYPE_HPP
#define DOGEN_TEXT_TYPES_ENTITIES_ELEMENT_ARCHETYPE_HPP
...
template<>
inline void swap(
    dogen::text::entities::element_archetype& lhs,
    dogen::text::entities::element_archetype& rhs) {
    lhs.swap(rhs);
}
