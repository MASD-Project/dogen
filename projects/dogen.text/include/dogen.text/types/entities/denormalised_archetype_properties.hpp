 ...
 *
 */
#ifndef DOGEN_TEXT_TYPES_ENTITIES_DENORMALISED_ARCHETYPE_PROPERTIES_HPP
#define DOGEN_TEXT_TYPES_ENTITIES_DENORMALISED_ARCHETYPE_PROPERTIES_HPP
...
template<>
inline void swap(
    dogen::text::entities::denormalised_archetype_properties& lhs,
    dogen::text::entities::denormalised_archetype_properties& rhs) {
    lhs.swap(rhs);
}
