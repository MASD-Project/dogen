 ...
 *
 */
#ifndef DOGEN_TEXT_TYPES_HELPERS_DECORATION_REPOSITORY_HPP
#define DOGEN_TEXT_TYPES_HELPERS_DECORATION_REPOSITORY_HPP
...
template<>
inline void swap(
    dogen::text::helpers::decoration_repository& lhs,
    dogen::text::helpers::decoration_repository& rhs) {
    lhs.swap(rhs);
}
