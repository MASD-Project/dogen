...
static logger lg(logger_factory("dogen.text.transforms.cpp.build"));
...
const physical::entities::facet& build_facet_chain::static_facet() {
    static const auto r(make_facet());
    return r;
}

const physical::entities::facet& build_facet_chain::facet() const {
    return static_facet();
}
