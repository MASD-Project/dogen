...
const std::string transform_id("text.transforms.test_data.enum_header_transform");
...
ast.stream() << std::endl;
ast.stream() << "class " << ye.name().simple() << "_generator {" << std::endl;
ast.stream() << "public:" << std::endl;
ast.stream() << "    " << ye.name().simple() << "_generator();" << std::endl;
ast.stream() << std::endl;
ast.stream() << "public:" << std::endl;
ast.stream() << "    typedef " << ast.get_qualified_name(ye.name()) << " result_type;" << std::endl;
ast.stream() << std::endl;
ast.stream() << "public:" << std::endl;
