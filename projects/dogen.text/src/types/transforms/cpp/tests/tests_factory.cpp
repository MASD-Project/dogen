...
#include "dogen.text/types/transforms/cpp/tests/class_implementation_factory.hpp"

namespace dogen::text::transforms::cpp::tests {
namespace {

using namespace dogen::utility::log;
static logger lg(logger_factory("dogen.text.transforms.cpp.tests"));
...
physical::entities::facet tests_factory::make() {
    ...
    r.meta_name(b.build());
    r.directory_name("generated_tests");
    r.postfix("tests");
    ...
    lambda(r.archetypes(), cmakelists_factory::make());
