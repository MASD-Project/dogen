...
std::string time_duration_helper_transform::id() const {
    static auto r(std::string("<masd.cpp.hash>") +
        std::string("<") + helper_name() + std::string(">"));
    return r;
}

std::string time_duration_helper_transform::family() const {
...
std::list<std::string>
time_duration_helper_transform::owning_facets() const {
    static auto r(std::list<std::string> {
        "masd.cpp.hash"
    });
    return r;
...
std::string time_duration_helper_transform::helper_name() const {
    static std::string r("time_duration_helper_transform");
    return r;
}
