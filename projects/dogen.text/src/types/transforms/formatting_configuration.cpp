 ...
 *
 */
#include "dogen.text/types/transforms/formatting_configuration.hpp"

namespace dogen::text::transforms {

formatting_configuration::formatting_configuration()
    : style_(static_cast<dogen::text::entities::formatting_styles>(0)) { }
...
dogen::text::entities::formatting_styles formatting_configuration::style() const {
    return style_;
}

void formatting_configuration::style(const dogen::text::entities::formatting_styles v) {
    style_ = v;
}
