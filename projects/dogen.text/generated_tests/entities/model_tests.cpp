...
#include "dogen.text/hash/entities/model_hash.hpp"
...
BOOST_AUTO_TEST_CASE(identical_objects_are_equal) {
    dogen::text::entities::model_generator g;
    const auto a(g());
    const auto b(a);
...
BOOST_AUTO_TEST_CASE(moved_objects_are_equal) {
    ...
    g();
    auto a(g());
    const auto b = dogen::text::entities::model();
    const auto c(a);
    BOOST_CHECK(a != b);
    BOOST_CHECK(a == c);
...
BOOST_AUTO_TEST_CASE(xml_roundtrip_produces_the_same_entity) {
    ...
    dogen::text::entities::model b = dogen::text::entities::model();
...
BOOST_AUTO_TEST_CASE(equal_objects_generate_the_same_hash) {
    ...
    std::hash<dogen::text::entities::model> hasher;
