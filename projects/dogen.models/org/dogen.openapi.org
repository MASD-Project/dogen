...
* security_requirements                                             :element:
* tags                                                              :element:
* externalDocs                                                      :element:
* external_documentation                                            :element:
* contact                                                           :element:
** name                                                           :attribute:
   :PROPERTIES:
   :masd.codec.type: std::string
