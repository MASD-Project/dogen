...
Name of the directory to use for the backend.
...
Name of the directory to use for the facet.
...
Postfix to apply to all artefacts in this facet.
...
Postfix to apply to all artefacts of this archetype.
...
Name of the directory to use for the part.
...
*** relative_paths
:PROPERTIES:
:masd.codec.type: std::unordered_map<identification::entities::physical_meta_id, boost::filesystem::path>
:END:

Paths relative to the part's root directory.
