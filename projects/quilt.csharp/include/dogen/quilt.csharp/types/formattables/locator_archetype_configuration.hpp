 ...
 *
 */
#ifndef DOGEN_QUILT_CSHARP_TYPES_FORMATTABLES_LOCATOR_ARCHETYPE_CONFIGURATION_HPP
#define DOGEN_QUILT_CSHARP_TYPES_FORMATTABLES_LOCATOR_ARCHETYPE_CONFIGURATION_HPP
...
#include <string>
#include <algorithm>
#include "dogen/quilt.csharp/serialization/formattables/locator_archetype_configuration_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::quilt::csharp::formattables::locator_archetype_configuration& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::quilt::csharp::formattables::locator_archetype_configuration& v, unsigned int version);
...
template<>
inline void swap(
    dogen::quilt::csharp::formattables::locator_archetype_configuration& lhs,
    dogen::quilt::csharp::formattables::locator_archetype_configuration& rhs) {
    lhs.swap(rhs);
}
