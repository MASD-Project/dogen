 ...
 *
 */
#ifndef DOGEN_QUILT_CSHARP_TYPES_FORMATTABLES_ASSISTANT_PROPERTIES_HPP
#define DOGEN_QUILT_CSHARP_TYPES_FORMATTABLES_ASSISTANT_PROPERTIES_HPP
...
#include <string>
#include <algorithm>
#include "dogen/quilt.csharp/serialization/formattables/assistant_properties_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::quilt::csharp::formattables::assistant_properties& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::quilt::csharp::formattables::assistant_properties& v, unsigned int version);
...
template<>
inline void swap(
    dogen::quilt::csharp::formattables::assistant_properties& lhs,
    dogen::quilt::csharp::formattables::assistant_properties& rhs) {
    lhs.swap(rhs);
}
