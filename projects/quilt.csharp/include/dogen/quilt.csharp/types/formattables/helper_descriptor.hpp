 ...
 *
 */
#ifndef DOGEN_QUILT_CSHARP_TYPES_FORMATTABLES_HELPER_DESCRIPTOR_HPP
#define DOGEN_QUILT_CSHARP_TYPES_FORMATTABLES_HELPER_DESCRIPTOR_HPP
...
#include <string>
#include <algorithm>
#include "dogen/quilt.csharp/serialization/formattables/helper_descriptor_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::quilt::csharp::formattables::helper_descriptor& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::quilt::csharp::formattables::helper_descriptor& v, unsigned int version);
...
template<>
inline void swap(
    dogen::quilt::csharp::formattables::helper_descriptor& lhs,
    dogen::quilt::csharp::formattables::helper_descriptor& rhs) {
    lhs.swap(rhs);
}
