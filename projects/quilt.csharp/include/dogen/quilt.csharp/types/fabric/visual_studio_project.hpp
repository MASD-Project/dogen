...
class visual_studio_project final : public dogen::yarn::element {
public:
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::quilt::csharp::fabric::visual_studio_project& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::quilt::csharp::fabric::visual_studio_project& v, unsigned int version);
...
template<>
inline void swap(
    dogen::quilt::csharp::fabric::visual_studio_project& lhs,
    dogen::quilt::csharp::fabric::visual_studio_project& rhs) {
    lhs.swap(rhs);
}
