 ...
 *
 */
#ifndef DOGEN_QUILT_CSHARP_TYPES_FORMATTERS_TEST_DATA_OBJECT_HELPER_HPP
#define DOGEN_QUILT_CSHARP_TYPES_FORMATTERS_TEST_DATA_OBJECT_HELPER_HPP
...
class object_helper : public helper_formatter_interface {
public:
