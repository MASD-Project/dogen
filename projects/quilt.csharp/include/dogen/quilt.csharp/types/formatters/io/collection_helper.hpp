 ...
 *
 */
#ifndef DOGEN_QUILT_CSHARP_TYPES_FORMATTERS_IO_COLLECTION_HELPER_HPP
#define DOGEN_QUILT_CSHARP_TYPES_FORMATTERS_IO_COLLECTION_HELPER_HPP
...
class collection_helper : public helper_formatter_interface {
public:
