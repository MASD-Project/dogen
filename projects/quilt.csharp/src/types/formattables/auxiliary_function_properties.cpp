...
auxiliary_function_properties::auxiliary_function_properties()
    : type_(static_cast<dogen::quilt::csharp::formattables::auxiliary_function_types>(0)) { }
...
dogen::quilt::csharp::formattables::auxiliary_function_types auxiliary_function_properties::type() const {
    return type_;
}

void auxiliary_function_properties::type(const dogen::quilt::csharp::formattables::auxiliary_function_types v) {
    type_ = v;
}
