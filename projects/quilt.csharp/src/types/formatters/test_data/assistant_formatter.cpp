...
a.stream() << "        }" << std::endl;
a.stream() << std::endl;
a.stream() << "        public static System.Collections.IEnumerable CreateIEnumerable(uint position)" << std::endl;
a.stream() << "        {" << std::endl;
a.stream() << "            return CreateArrayList(position);" << std::endl;
a.stream() << "        }" << std::endl;
a.stream() << std::endl;
a.stream() << "        public static System.Collections.ICollection CreateICollection(uint position)" << std::endl;
a.stream() << "        {" << std::endl;
a.stream() << "            return CreateArrayList(position);" << std::endl;
a.stream() << "        }" << std::endl;
a.stream() << std::endl;
a.stream() << "        public static System.Collections.IList CreateIList(uint position)" << std::endl;
a.stream() << "        {" << std::endl;
a.stream() << "            return CreateArrayList(position);" << std::endl;
a.stream() << "        }" << std::endl;
a.stream() << std::endl;
a.stream() << "        public static System.Collections.ArrayList CreateArrayList(uint position)" << std::endl;
a.stream() << "        {" << std::endl;
a.stream() << "            var result = new System.Collections.ArrayList();" << std::endl;
