...
std::string character_helper::formatter_name() const {
    static auto r(std::string("<") + traits::facet() + std::string(">") +
        std::string("<") + helper_name() + std::string(">"));
    return r;
}

std::string character_helper::family() const {
    static std::string r("Character");
    return r;
}

std::list<std::string>
character_helper::owning_formatters() const {
...
std::list<std::string>
character_helper::owning_facets() const {
    static auto r(std::list<std::string> {
        traits::facet()
    });
    return r;
...
std::string character_helper::helper_name() const {
    static std::string r("character_helper");
    return r;
}

void character_helper::
format(assistant& a, const formattables::helper_properties& /*hp*/) const {
a.stream() << std::endl;
a.stream() << "bool create_character(const unsigned int position) {" << std::endl;
