...
dogen::quilt::csharp::formattables::element_properties
create_dogen_quilt_csharp_formattables_element_properties(const unsigned int position) {
    return dogen::quilt::csharp::formattables::element_properties_generator::create(position);
}
...
populate(const unsigned int position, result_type& v) {
    v.element_properties(create_dogen_quilt_csharp_formattables_element_properties(position + 0));
    v.element(create_boost_shared_ptr_dogen_yarn_element(position + 1));
}
