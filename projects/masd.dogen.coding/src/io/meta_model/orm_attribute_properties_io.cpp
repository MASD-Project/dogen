...
inline std::ostream& operator<<(std::ostream& s, const std::unordered_map<masd::dogen::coding::meta_model::orm_database_systems, std::string>& v) {
    s << "[";
...
std::ostream& operator<<(std::ostream& s, const orm_attribute_properties& v) {
    ...
    s << " { "
      << "\"__type__\": " << "\"masd::dogen::coding::meta_model::orm_attribute_properties\"" << ", "
