...
inline std::ostream& operator<<(std::ostream& s, const boost::optional<masd::dogen::coding::meta_model::orm::letter_case>& v) {
...
inline std::ostream& operator<<(std::ostream& s, const std::vector<masd::dogen::coding::meta_model::orm::database_system>& v) {
    s << "[ ";
...
std::ostream& operator<<(std::ostream& s, const model_properties& v) {
    s << " { "
      << "\"__type__\": " << "\"masd::dogen::coding::meta_model::orm::model_properties\"" << ", "
