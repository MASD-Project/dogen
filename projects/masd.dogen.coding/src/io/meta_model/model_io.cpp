...
inline std::ostream& operator<<(std::ostream& s, const std::vector<boost::shared_ptr<masd::dogen::coding::meta_model::element> >& v) {
    s << "[ ";
    for (auto i(v.begin()); i != v.end(); ++i) {
        if (i != v.begin()) s << ", ";
        s << *i;
...
inline std::ostream& operator<<(std::ostream& s, const std::unordered_set<masd::dogen::coding::meta_model::element_archetype>& v) {
    s << "[ ";
    for (auto i(v.begin()); i != v.end(); ++i) {
        if (i != v.begin()) s << ", ";
        s << *i;
