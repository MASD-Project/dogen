...
std::ostream& operator<<(std::ostream& s, const global_decoration& v) {
    s << " { "
      << "\"__type__\": " << "\"masd::dogen::coding::meta_model::global_decoration\"" << ", "
      << "\"copyrights\": " << v.copyrights() << ", "
      << "\"licence_short_form\": " << "\"" << tidy_up_string(v.licence_short_form()) << "\"" << ", "
      << "\"licence_long_form\": " << "\"" << tidy_up_string(v.licence_long_form()) << "\"" << ", "
