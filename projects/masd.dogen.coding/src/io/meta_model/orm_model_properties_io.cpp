...
inline std::ostream& operator<<(std::ostream& s, const std::vector<masd::dogen::coding::meta_model::orm_database_systems>& v) {
    s << "[ ";
...
inline std::ostream& operator<<(std::ostream& s, const boost::optional<masd::dogen::coding::meta_model::letter_cases>& v) {
...
std::ostream& operator<<(std::ostream& s, const orm_model_properties& v) {
    s << " { "
      << "\"__type__\": " << "\"masd::dogen::coding::meta_model::orm_model_properties\"" << ", "
