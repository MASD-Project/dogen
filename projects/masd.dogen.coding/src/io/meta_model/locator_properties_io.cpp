...
#include "masd.dogen.coding/io/meta_model/model_segment_properties_io.hpp"
...
inline std::ostream& operator<<(std::ostream& s, const std::unordered_map<std::string, masd::dogen::coding::meta_model::intra_backend_segment_properties>& v) {
    s << "[";
...
inline std::ostream& operator<<(std::ostream& s, const std::unordered_map<std::string, masd::dogen::coding::meta_model::archetype_family_properties>& v) {
    s << "[";
    for (auto i(v.begin()); i != v.end(); ++i) {
        if (i != v.begin()) s << ", ";
        s << "[ { " << "\"__type__\": " << "\"key\"" << ", " << "\"data\": ";
...
std::ostream& operator<<(std::ostream& s, const locator_properties& v) {
    ...
    s << " { "
      << "\"__type__\": " << "\"masd::dogen::coding::meta_model::locator_properties\"" << ", "
