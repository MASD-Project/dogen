...
inline std::size_t hash_std_unordered_set_masd_dogen_coding_meta_model_element_archetype(const std::unordered_set<masd::dogen::coding::meta_model::element_archetype>& v) {
    std::size_t seed(0);
    for (const auto i : v) {
        combine(seed, i);
    }
