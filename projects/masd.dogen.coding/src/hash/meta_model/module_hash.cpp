...
inline std::size_t hash_boost_optional_masd_dogen_coding_meta_model_orm_module_properties(const boost::optional<masd::dogen::coding::meta_model::orm_module_properties>& v) {
    std::size_t seed(0);
...
std::size_t module_hasher::hash(const module& v) {
    ...
    combine(seed, hash_boost_optional_masd_dogen_coding_meta_model_orm_module_properties(v.orm_properties()));
