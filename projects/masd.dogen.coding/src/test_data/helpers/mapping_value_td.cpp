...
masd::dogen::coding::helpers::mapping_actions
create_masd_dogen_coding_helpers_mapping_actions(const unsigned int position) {
    return masd::dogen::coding::helpers::mapping_actions_generator::create(position);
}
...
populate(const unsigned int position, result_type& v) {
    v.mapping_action(create_masd_dogen_coding_helpers_mapping_actions(position + 0));
    v.default_name(create_boost_optional_masd_dogen_coding_meta_model_name(position + 1));
}
