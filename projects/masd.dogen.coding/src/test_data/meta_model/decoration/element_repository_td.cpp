...
populate(const unsigned int position, result_type& v) {
    v.modeline_groups(create_std_unordered_map_std_string_boost_shared_ptr_masd_dogen_coding_meta_model_decoration_modeline_group(position + 0));
    v.modelines(create_std_unordered_map_std_string_boost_shared_ptr_masd_dogen_coding_meta_model_decoration_modeline(position + 1));
    v.licences(create_std_unordered_map_std_string_boost_shared_ptr_masd_dogen_coding_meta_model_decoration_licence(position + 2));
    v.generation_markers(create_std_unordered_map_std_string_boost_shared_ptr_masd_dogen_coding_meta_model_decoration_generation_marker(position + 3));
}
