...
profile_template_entry_new_generator::profile_template_entry_new_generator() : position_(0) { }

void profile_template_entry_new_generator::
...
profile_template_entry_new_generator::result_type
profile_template_entry_new_generator::create(const unsigned int position) {
    profile_template_entry_new r;
    profile_template_entry_new_generator::populate(position, r);
    return r;
}

profile_template_entry_new_generator::result_type*
profile_template_entry_new_generator::create_ptr(const unsigned int position) {
    profile_template_entry_new* p = new profile_template_entry_new();
    profile_template_entry_new_generator::populate(position, *p);
    return p;
}

profile_template_entry_new_generator::result_type
profile_template_entry_new_generator::operator()() {
