...
masd::dogen::coding::meta_model::formatting_styles
create_masd_dogen_coding_meta_model_formatting_styles(const unsigned int position) {
    return masd::dogen::coding::meta_model::formatting_styles_generator::create(position);
}
...
populate(const unsigned int position, result_type& v) {
    ...
    v.formatting_style(create_masd_dogen_coding_meta_model_formatting_styles(position + 3));
