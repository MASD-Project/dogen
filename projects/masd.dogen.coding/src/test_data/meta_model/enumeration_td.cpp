...
masd::dogen::coding::meta_model::enumerator
create_masd_dogen_coding_meta_model_enumerator(const unsigned int position) {
    return masd::dogen::coding::meta_model::enumerator_generator::create(position);
}

std::vector<masd::dogen::coding::meta_model::enumerator> create_std_vector_masd_dogen_coding_meta_model_enumerator(unsigned int position) {
    std::vector<masd::dogen::coding::meta_model::enumerator> r;
    for (unsigned int i(0); i < 4; ++i) {
        r.push_back(create_masd_dogen_coding_meta_model_enumerator(position + i));
    }
    return r;
}
...
populate(const unsigned int position, result_type& v) {
    ...
    v.enumerators(create_std_vector_masd_dogen_coding_meta_model_enumerator(position + 1));
