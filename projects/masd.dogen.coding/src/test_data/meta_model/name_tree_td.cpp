...
create_masd_dogen_coding_meta_model_name_tree(const unsigned int) {
    return masd::dogen::coding::meta_model::name_tree();
}

std::list<masd::dogen::coding::meta_model::name_tree> create_std_list_masd_dogen_coding_meta_model_name_tree(unsigned int position) {
    std::list<masd::dogen::coding::meta_model::name_tree> r;
    for (unsigned int i(0); i < 4; ++i) {
        r.push_back(create_masd_dogen_coding_meta_model_name_tree(position + i));
    }
    return r;
}
