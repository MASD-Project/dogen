...
variability_feature_template_generator::variability_feature_template_generator() : position_(0) { }

void variability_feature_template_generator::
...
variability_feature_template_generator::result_type
variability_feature_template_generator::create(const unsigned int position) {
    variability_feature_template r;
    variability_feature_template_generator::populate(position, r);
    return r;
}

variability_feature_template_generator::result_type*
variability_feature_template_generator::create_ptr(const unsigned int position) {
    variability_feature_template* p = new variability_feature_template();
    variability_feature_template_generator::populate(position, *p);
    return p;
}

variability_feature_template_generator::result_type
variability_feature_template_generator::operator()() {
