...
std::vector<masd::dogen::coding::meta_model::orm::database_system> create_std_vector_masd_dogen_coding_meta_model_orm_database_system(unsigned int position) {
    std::vector<masd::dogen::coding::meta_model::orm::database_system> r;
    for (unsigned int i(0); i < 4; ++i) {
        r.push_back(create_masd_dogen_coding_meta_model_orm_database_system(position + i));
    }
    return r;
}
...
populate(const unsigned int position, result_type& v) {
    ...
    v.database_systems(create_std_vector_masd_dogen_coding_meta_model_orm_database_system(position + 2));
}
