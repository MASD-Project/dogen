...
masd::dogen::coding::meta_model::orm::database_system
create_masd_dogen_coding_meta_model_orm_database_system(const unsigned int position) {
    return masd::dogen::coding::meta_model::orm::database_system_generator::create(position);
}

std::unordered_map<masd::dogen::coding::meta_model::orm::database_system, std::string> create_std_unordered_map_masd_dogen_coding_meta_model_orm_database_system_std_string(unsigned int position) {
    std::unordered_map<masd::dogen::coding::meta_model::orm::database_system, std::string> r;
    for (unsigned int i(0); i < 4; ++i) {
        r.insert(std::make_pair(create_masd_dogen_coding_meta_model_orm_database_system(position + i), create_std_string(position + i)));
    }
    return r;
}
...
populate(const unsigned int position, result_type& v) {
    ...
    v.type_overrides(create_std_unordered_map_masd_dogen_coding_meta_model_orm_database_system_std_string(position + 3));
