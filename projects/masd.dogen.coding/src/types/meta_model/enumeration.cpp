...
inline std::ostream& operator<<(std::ostream& s, const std::vector<masd::dogen::coding::meta_model::enumerator>& v) {
    s << "[ ";
...
void enumeration::to_stream(std::ostream& s) const {
    ...
    s << " { "
      << "\"__type__\": " << "\"masd::dogen::coding::meta_model::enumeration\"" << ", "
      << "\"__parent_0__\": ";
...
const std::vector<masd::dogen::coding::meta_model::enumerator>& enumeration::enumerators() const {
    return enumerators_;
}

std::vector<masd::dogen::coding::meta_model::enumerator>& enumeration::enumerators() {
    return enumerators_;
}

void enumeration::enumerators(const std::vector<masd::dogen::coding::meta_model::enumerator>& v) {
    enumerators_ = v;
}
