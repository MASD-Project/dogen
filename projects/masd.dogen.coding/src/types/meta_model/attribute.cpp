...
masd::dogen::coding::meta_model::name& attribute::name() {
    return name_;
}
...
const masd::dogen::coding::meta_model::name_tree& attribute::parsed_type() const {
    return parsed_type_;
}

masd::dogen::coding::meta_model::name_tree& attribute::parsed_type() {
    return parsed_type_;
}

void attribute::parsed_type(const masd::dogen::coding::meta_model::name_tree& v) {
    parsed_type_ = v;
}
