...
const boost::optional<masd::dogen::coding::meta_model::letter_cases>& orm_primitive_properties::letter_case() const {
    return letter_case_;
}

boost::optional<masd::dogen::coding::meta_model::letter_cases>& orm_primitive_properties::letter_case() {
    return letter_case_;
}

void orm_primitive_properties::letter_case(const boost::optional<masd::dogen::coding::meta_model::letter_cases>& v) {
    letter_case_ = v;
}
