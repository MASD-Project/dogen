...
const std::unordered_set<masd::dogen::coding::meta_model::element_archetype>& model::enabled_archetype_for_element() const {
    return enabled_archetype_for_element_;
}

std::unordered_set<masd::dogen::coding::meta_model::element_archetype>& model::enabled_archetype_for_element() {
    return enabled_archetype_for_element_;
}

void model::enabled_archetype_for_element(const std::unordered_set<masd::dogen::coding::meta_model::element_archetype>& v) {
...
const masd::dogen::coding::meta_model::locator_properties& model::locator_properties() const {
    return locator_properties_;
}

masd::dogen::coding::meta_model::locator_properties& model::locator_properties() {
    return locator_properties_;
}

void model::locator_properties(const masd::dogen::coding::meta_model::locator_properties& v) {
...
const masd::dogen::coding::meta_model::global_archetype_location_properties& model::global_archetype_location_properties() const {
    return global_archetype_location_properties_;
}

masd::dogen::coding::meta_model::global_archetype_location_properties& model::global_archetype_location_properties() {
    return global_archetype_location_properties_;
}

void model::global_archetype_location_properties(const masd::dogen::coding::meta_model::global_archetype_location_properties& v) {
