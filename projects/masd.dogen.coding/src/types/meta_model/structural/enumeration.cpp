...
inline std::ostream& operator<<(std::ostream& s, const std::vector<masd::dogen::coding::meta_model::structural::enumerator>& v) {
    s << "[ ";
...
enumeration::enumeration(
    ...
    const std::vector<masd::dogen::coding::meta_model::structural::enumerator>& enumerators,
...
void enumeration::to_stream(std::ostream& s) const {
    ...
    s << " { "
      << "\"__type__\": " << "\"masd::dogen::coding::meta_model::structural::enumeration\"" << ", "
      << "\"__parent_0__\": ";
...
bool enumeration::equals(const masd::dogen::coding::meta_model::element& other) const {
...
const masd::dogen::coding::meta_model::name& enumeration::underlying_element() const {
    return underlying_element_;
}

masd::dogen::coding::meta_model::name& enumeration::underlying_element() {
    return underlying_element_;
}

void enumeration::underlying_element(const masd::dogen::coding::meta_model::name& v) {
...
const std::vector<masd::dogen::coding::meta_model::structural::enumerator>& enumeration::enumerators() const {
    return enumerators_;
}

std::vector<masd::dogen::coding::meta_model::structural::enumerator>& enumeration::enumerators() {
    return enumerators_;
}

void enumeration::enumerators(const std::vector<masd::dogen::coding::meta_model::structural::enumerator>& v) {
    enumerators_ = v;
}
