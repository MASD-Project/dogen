...
orm_model_properties::orm_model_properties(
    const std::vector<masd::dogen::coding::meta_model::orm_database_systems>& database_systems,
...
const std::vector<masd::dogen::coding::meta_model::orm_database_systems>& orm_model_properties::database_systems() const {
    return database_systems_;
}

std::vector<masd::dogen::coding::meta_model::orm_database_systems>& orm_model_properties::database_systems() {
    return database_systems_;
}

void orm_model_properties::database_systems(const std::vector<masd::dogen::coding::meta_model::orm_database_systems>& v) {
    database_systems_ = v;
}
...
const boost::optional<masd::dogen::coding::meta_model::letter_cases>& orm_model_properties::letter_case() const {
    return letter_case_;
}

boost::optional<masd::dogen::coding::meta_model::letter_cases>& orm_model_properties::letter_case() {
    return letter_case_;
}

void orm_model_properties::letter_case(const boost::optional<masd::dogen::coding::meta_model::letter_cases>& v) {
    letter_case_ = v;
}
