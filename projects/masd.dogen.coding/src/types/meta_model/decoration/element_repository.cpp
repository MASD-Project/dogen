...
const std::unordered_map<std::string, boost::shared_ptr<masd::dogen::coding::meta_model::decoration::modeline_group> >& element_repository::modeline_groups() const {
    return modeline_groups_;
}

std::unordered_map<std::string, boost::shared_ptr<masd::dogen::coding::meta_model::decoration::modeline_group> >& element_repository::modeline_groups() {
    return modeline_groups_;
}

void element_repository::modeline_groups(const std::unordered_map<std::string, boost::shared_ptr<masd::dogen::coding::meta_model::decoration::modeline_group> >& v) {
    modeline_groups_ = v;
}
...
const std::unordered_map<std::string, boost::shared_ptr<masd::dogen::coding::meta_model::decoration::modeline> >& element_repository::modelines() const {
    return modelines_;
}

std::unordered_map<std::string, boost::shared_ptr<masd::dogen::coding::meta_model::decoration::modeline> >& element_repository::modelines() {
    return modelines_;
}

void element_repository::modelines(const std::unordered_map<std::string, boost::shared_ptr<masd::dogen::coding::meta_model::decoration::modeline> >& v) {
    modelines_ = v;
}
...
const std::unordered_map<std::string, boost::shared_ptr<masd::dogen::coding::meta_model::decoration::licence> >& element_repository::licences() const {
    return licences_;
}

std::unordered_map<std::string, boost::shared_ptr<masd::dogen::coding::meta_model::decoration::licence> >& element_repository::licences() {
    return licences_;
}

void element_repository::licences(const std::unordered_map<std::string, boost::shared_ptr<masd::dogen::coding::meta_model::decoration::licence> >& v) {
    licences_ = v;
}
...
const std::unordered_map<std::string, boost::shared_ptr<masd::dogen::coding::meta_model::decoration::generation_marker> >& element_repository::generation_markers() const {
    return generation_markers_;
}

std::unordered_map<std::string, boost::shared_ptr<masd::dogen::coding::meta_model::decoration::generation_marker> >& element_repository::generation_markers() {
    return generation_markers_;
}

void element_repository::generation_markers(const std::unordered_map<std::string, boost::shared_ptr<masd::dogen::coding::meta_model::decoration::generation_marker> >& v) {
