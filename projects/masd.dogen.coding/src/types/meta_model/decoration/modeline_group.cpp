...
inline std::ostream& operator<<(std::ostream& s, const std::list<boost::shared_ptr<masd::dogen::coding::meta_model::decoration::modeline> >& v) {
    s << "[ ";
    for (auto i(v.begin()); i != v.end(); ++i) {
        if (i != v.begin()) s << ", ";
        s << *i;
...
void modeline_group::to_stream(std::ostream& s) const {
    s << " { "
      << "\"__type__\": " << "\"masd::dogen::coding::meta_model::decoration::modeline_group\"" << ", "
      << "\"__parent_0__\": ";
...
const std::list<boost::shared_ptr<masd::dogen::coding::meta_model::decoration::modeline> >& modeline_group::modelines() const {
    return modelines_;
}

std::list<boost::shared_ptr<masd::dogen::coding::meta_model::decoration::modeline> >& modeline_group::modelines() {
    return modelines_;
}

void modeline_group::modelines(const std::list<boost::shared_ptr<masd::dogen::coding::meta_model::decoration::modeline> >& v) {
    modelines_ = v;
}
