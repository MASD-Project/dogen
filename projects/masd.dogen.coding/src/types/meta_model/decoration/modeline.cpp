...
inline std::ostream& operator<<(std::ostream& s, const std::list<masd::dogen::coding::meta_model::decoration::modeline_field>& v) {
    s << "[ ";
...
modeline::modeline()
    : editor_(static_cast<masd::dogen::coding::meta_model::decoration::editor>(0)),
      location_(static_cast<masd::dogen::coding::meta_model::decoration::modeline_location>(0)),
...
void modeline::to_stream(std::ostream& s) const {
    s << " { "
      << "\"__type__\": " << "\"masd::dogen::coding::meta_model::decoration::modeline\"" << ", "
      << "\"__parent_0__\": ";
...
masd::dogen::coding::meta_model::decoration::editor modeline::editor() const {
    return editor_;
}

void modeline::editor(const masd::dogen::coding::meta_model::decoration::editor v) {
    editor_ = v;
}

masd::dogen::coding::meta_model::decoration::modeline_location modeline::location() const {
    return location_;
}

void modeline::location(const masd::dogen::coding::meta_model::decoration::modeline_location v) {
    location_ = v;
}

const std::list<masd::dogen::coding::meta_model::decoration::modeline_field>& modeline::fields() const {
    return fields_;
}

std::list<masd::dogen::coding::meta_model::decoration::modeline_field>& modeline::fields() {
    return fields_;
}

void modeline::fields(const std::list<masd::dogen::coding::meta_model::decoration::modeline_field>& v) {
    fields_ = v;
}
