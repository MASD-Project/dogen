...
const boost::shared_ptr<masd::dogen::variability::meta_model::configuration>& profile_template_entry::configuration() const {
    return configuration_;
}

boost::shared_ptr<masd::dogen::variability::meta_model::configuration>& profile_template_entry::configuration() {
    return configuration_;
}

void profile_template_entry::configuration(const boost::shared_ptr<masd::dogen::variability::meta_model::configuration>& v) {
    configuration_ = v;
}
...
const masd::dogen::coding::meta_model::name& profile_template_entry::name() const {
    return name_;
}

masd::dogen::coding::meta_model::name& profile_template_entry::name() {
    return name_;
}

void profile_template_entry::name(const masd::dogen::coding::meta_model::name& v) {
    name_ = v;
}
