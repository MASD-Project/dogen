...
inline std::ostream& operator<<(std::ostream& s, const std::list<masd::dogen::coding::meta_model::variability::profile_template_entry>& v) {
    s << "[ ";
    for (auto i(v.begin()); i != v.end(); ++i) {
        if (i != v.begin()) s << ", ";
        s << *i;
...
profile_template::profile_template(
    ...
    const std::list<masd::dogen::coding::meta_model::variability::profile_template_entry>& entries,
...
void profile_template::to_stream(std::ostream& s) const {
    s << " { "
      << "\"__type__\": " << "\"masd::dogen::coding::meta_model::variability::profile_template\"" << ", "
      << "\"__parent_0__\": ";
...
bool profile_template::equals(const masd::dogen::coding::meta_model::element& other) const {
...
const std::list<masd::dogen::coding::meta_model::variability::profile_template_entry>& profile_template::entries() const {
    return entries_;
}

std::list<masd::dogen::coding::meta_model::variability::profile_template_entry>& profile_template::entries() {
    return entries_;
}

void profile_template::entries(const std::list<masd::dogen::coding::meta_model::variability::profile_template_entry>& v) {
    entries_ = v;
}
...
const std::list<masd::dogen::coding::meta_model::name>& profile_template::parents() const {
    return parents_;
}

std::list<masd::dogen::coding::meta_model::name>& profile_template::parents() {
    return parents_;
}

void profile_template::parents(const std::list<masd::dogen::coding::meta_model::name>& v) {
    parents_ = v;
}
