...
inline bool operator==(const boost::shared_ptr<masd::dogen::coding::meta_model::variability::feature_bundle>& lhs,
const boost::shared_ptr<masd::dogen::coding::meta_model::variability::feature_bundle>& rhs) {
    return (!lhs && !rhs) ||(lhs && rhs && (*lhs == *rhs));
}
...
const std::unordered_map<std::string, boost::shared_ptr<masd::dogen::coding::meta_model::variability::feature_bundle> >& element_repository::feature_bundles() const {
    return feature_bundles_;
}

std::unordered_map<std::string, boost::shared_ptr<masd::dogen::coding::meta_model::variability::feature_bundle> >& element_repository::feature_bundles() {
    return feature_bundles_;
}

void element_repository::feature_bundles(const std::unordered_map<std::string, boost::shared_ptr<masd::dogen::coding::meta_model::variability::feature_bundle> >& v) {
    feature_bundles_ = v;
}
