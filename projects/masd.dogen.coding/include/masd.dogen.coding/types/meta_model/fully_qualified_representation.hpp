 ...
 *
 */
#ifndef MASD_DOGEN_CODING_TYPES_META_MODEL_FULLY_QUALIFIED_REPRESENTATION_HPP
#define MASD_DOGEN_CODING_TYPES_META_MODEL_FULLY_QUALIFIED_REPRESENTATION_HPP
...
/**
 * @brief Fully qualified representation for a coding identifier such as a name or name tree.
 */
...
template<>
inline void swap(
    masd::dogen::coding::meta_model::fully_qualified_representation& lhs,
    masd::dogen::coding::meta_model::fully_qualified_representation& rhs) {
    lhs.swap(rhs);
}
