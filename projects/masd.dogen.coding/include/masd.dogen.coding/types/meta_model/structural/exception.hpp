 ...
 *
 */
#ifndef MASD_DOGEN_CODING_TYPES_META_MODEL_STRUCTURAL_EXCEPTION_HPP
#define MASD_DOGEN_CODING_TYPES_META_MODEL_STRUCTURAL_EXCEPTION_HPP
...
template<>
inline void swap(
    masd::dogen::coding::meta_model::structural::exception& lhs,
    masd::dogen::coding::meta_model::structural::exception& rhs) {
    lhs.swap(rhs);
}
