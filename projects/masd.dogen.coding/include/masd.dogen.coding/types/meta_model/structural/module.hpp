 ...
 *
 */
#ifndef MASD_DOGEN_CODING_TYPES_META_MODEL_STRUCTURAL_MODULE_HPP
#define MASD_DOGEN_CODING_TYPES_META_MODEL_STRUCTURAL_MODULE_HPP
...
template<>
inline void swap(
    masd::dogen::coding::meta_model::structural::module& lhs,
    masd::dogen::coding::meta_model::structural::module& rhs) {
    lhs.swap(rhs);
}
