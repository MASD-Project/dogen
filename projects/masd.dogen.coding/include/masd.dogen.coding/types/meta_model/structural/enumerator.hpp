 ...
 *
 */
#ifndef MASD_DOGEN_CODING_TYPES_META_MODEL_STRUCTURAL_ENUMERATOR_HPP
#define MASD_DOGEN_CODING_TYPES_META_MODEL_STRUCTURAL_ENUMERATOR_HPP
...
template<>
inline void swap(
    masd::dogen::coding::meta_model::structural::enumerator& lhs,
    masd::dogen::coding::meta_model::structural::enumerator& rhs) {
    lhs.swap(rhs);
}
