 ...
 *
 */
#ifndef MASD_DOGEN_CODING_TYPES_META_MODEL_STRUCTURAL_ENUMERATION_HPP
#define MASD_DOGEN_CODING_TYPES_META_MODEL_STRUCTURAL_ENUMERATION_HPP
...
public:
     ...
     */
    /**@{*/
    const std::vector<masd::dogen::coding::meta_model::structural::enumerator>& enumerators() const;
    std::vector<masd::dogen::coding::meta_model::structural::enumerator>& enumerators();
    void enumerators(const std::vector<masd::dogen::coding::meta_model::structural::enumerator>& v);
    void enumerators(const std::vector<masd::dogen::coding::meta_model::structural::enumerator>&& v);
    /**@}*/
...
private:
    ...
    std::vector<masd::dogen::coding::meta_model::structural::enumerator> enumerators_;
...
template<>
inline void swap(
    masd::dogen::coding::meta_model::structural::enumeration& lhs,
    masd::dogen::coding::meta_model::structural::enumeration& rhs) {
    lhs.swap(rhs);
}
