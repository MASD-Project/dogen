 ...
 *
 */
#ifndef MASD_DOGEN_CODING_TYPES_META_MODEL_STRUCTURAL_PRIMITIVE_HPP
#define MASD_DOGEN_CODING_TYPES_META_MODEL_STRUCTURAL_PRIMITIVE_HPP
...
template<>
inline void swap(
    masd::dogen::coding::meta_model::structural::primitive& lhs,
    masd::dogen::coding::meta_model::structural::primitive& rhs) {
    lhs.swap(rhs);
}
