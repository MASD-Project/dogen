 ...
 *
 */
#ifndef MASD_DOGEN_CODING_TYPES_META_MODEL_STRUCTURAL_VISITOR_HPP
#define MASD_DOGEN_CODING_TYPES_META_MODEL_STRUCTURAL_VISITOR_HPP
...
template<>
inline void swap(
    masd::dogen::coding::meta_model::structural::visitor& lhs,
    masd::dogen::coding::meta_model::structural::visitor& rhs) {
    lhs.swap(rhs);
}
