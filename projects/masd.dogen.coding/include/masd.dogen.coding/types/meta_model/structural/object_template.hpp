 ...
 *
 */
#ifndef MASD_DOGEN_CODING_TYPES_META_MODEL_STRUCTURAL_OBJECT_TEMPLATE_HPP
#define MASD_DOGEN_CODING_TYPES_META_MODEL_STRUCTURAL_OBJECT_TEMPLATE_HPP
...
template<>
inline void swap(
    masd::dogen::coding::meta_model::structural::object_template& lhs,
    masd::dogen::coding::meta_model::structural::object_template& rhs) {
    lhs.swap(rhs);
}
