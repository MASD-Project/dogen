...
public:
    const std::list<masd::dogen::coding::meta_model::name>& bundles() const;
    std::list<masd::dogen::coding::meta_model::name>& bundles();
    void bundles(const std::list<masd::dogen::coding::meta_model::name>& v);
    void bundles(const std::list<masd::dogen::coding::meta_model::name>&& v);
...
private:
    std::list<masd::dogen::coding::meta_model::name> bundles_;
};
