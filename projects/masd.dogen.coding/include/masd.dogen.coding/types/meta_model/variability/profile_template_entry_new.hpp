 ...
 *
 */
#ifndef MASD_DOGEN_CODING_TYPES_META_MODEL_VARIABILITY_PROFILE_TEMPLATE_ENTRY_NEW_HPP
#define MASD_DOGEN_CODING_TYPES_META_MODEL_VARIABILITY_PROFILE_TEMPLATE_ENTRY_NEW_HPP
...
class profile_template_entry_new final {
public:
    profile_template_entry_new() = default;
    profile_template_entry_new(const profile_template_entry_new&) = default;
    profile_template_entry_new(profile_template_entry_new&&) = default;
    ~profile_template_entry_new() = default;

public:
    profile_template_entry_new(
...
public:
    bool operator==(const profile_template_entry_new& rhs) const;
    bool operator!=(const profile_template_entry_new& rhs) const {
        return !this->operator==(rhs);
    }

public:
    void swap(profile_template_entry_new& other) noexcept;
    profile_template_entry_new& operator=(profile_template_entry_new other);
...
template<>
inline void swap(
    masd::dogen::coding::meta_model::variability::profile_template_entry_new& lhs,
    masd::dogen::coding::meta_model::variability::profile_template_entry_new& rhs) {
    lhs.swap(rhs);
}
