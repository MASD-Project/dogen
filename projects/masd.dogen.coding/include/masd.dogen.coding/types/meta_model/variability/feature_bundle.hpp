...
public:
    const std::list<masd::dogen::coding::meta_model::variability::feature_template>& feature_templates() const;
    std::list<masd::dogen::coding::meta_model::variability::feature_template>& feature_templates();
