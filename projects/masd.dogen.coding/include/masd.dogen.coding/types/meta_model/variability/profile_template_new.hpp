 ...
 *
 */
#ifndef MASD_DOGEN_CODING_TYPES_META_MODEL_VARIABILITY_PROFILE_TEMPLATE_NEW_HPP
#define MASD_DOGEN_CODING_TYPES_META_MODEL_VARIABILITY_PROFILE_TEMPLATE_NEW_HPP
...
class profile_template_new final : public masd::dogen::coding::meta_model::element {
public:
    profile_template_new() = default;
    profile_template_new(const profile_template_new&) = default;
    profile_template_new(profile_template_new&&) = default;

    virtual ~profile_template_new() noexcept { }

public:
    profile_template_new(
...
public:
    ...
    const std::list<masd::dogen::coding::meta_model::variability::profile_template_entry_new>& entries() const;
    std::list<masd::dogen::coding::meta_model::variability::profile_template_entry_new>& entries();
    void entries(const std::list<masd::dogen::coding::meta_model::variability::profile_template_entry_new>& v);
    void entries(const std::list<masd::dogen::coding::meta_model::variability::profile_template_entry_new>&& v);
...
public:
    bool operator==(const profile_template_new& rhs) const;
    bool operator!=(const profile_template_new& rhs) const {
...
public:
    void swap(profile_template_new& other) noexcept;
    profile_template_new& operator=(profile_template_new other);

private:
    std::unordered_set<std::string> labels_;
    std::list<masd::dogen::coding::meta_model::variability::profile_template_entry_new> entries_;
...
template<>
inline void swap(
    masd::dogen::coding::meta_model::variability::profile_template_new& lhs,
    masd::dogen::coding::meta_model::variability::profile_template_new& rhs) {
    lhs.swap(rhs);
}
