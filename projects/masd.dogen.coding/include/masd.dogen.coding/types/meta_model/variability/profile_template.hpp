...
class profile_template final : public masd::dogen::coding::meta_model::element {
public:
...
public:
    ...
    const std::list<masd::dogen::coding::meta_model::variability::profile_template_entry>& entries() const;
    std::list<masd::dogen::coding::meta_model::variability::profile_template_entry>& entries();
    void entries(const std::list<masd::dogen::coding::meta_model::variability::profile_template_entry>& v);
    void entries(const std::list<masd::dogen::coding::meta_model::variability::profile_template_entry>&& v);
...
private:
    ...
    std::list<masd::dogen::coding::meta_model::variability::profile_template_entry> entries_;
...
template<>
inline void swap(
    masd::dogen::coding::meta_model::variability::profile_template& lhs,
    masd::dogen::coding::meta_model::variability::profile_template& rhs) {
    lhs.swap(rhs);
}
