 ...
 *
 */
#ifndef MASD_DOGEN_CODING_TYPES_META_MODEL_VARIABILITY_FEATURE_TEMPLATE_NEW_HPP
#define MASD_DOGEN_CODING_TYPES_META_MODEL_VARIABILITY_FEATURE_TEMPLATE_NEW_HPP
...
class feature_template_new final {
public:
    feature_template_new(const feature_template_new&) = default;
    feature_template_new(feature_template_new&&) = default;
    ~feature_template_new() = default;

public:
    feature_template_new();
...
public:
    bool operator==(const feature_template_new& rhs) const;
    bool operator!=(const feature_template_new& rhs) const {
        return !this->operator==(rhs);
    }

public:
    void swap(feature_template_new& other) noexcept;
    feature_template_new& operator=(feature_template_new other);
...
template<>
inline void swap(
    masd::dogen::coding::meta_model::variability::feature_template_new& lhs,
    masd::dogen::coding::meta_model::variability::feature_template_new& rhs) {
    lhs.swap(rhs);
}
