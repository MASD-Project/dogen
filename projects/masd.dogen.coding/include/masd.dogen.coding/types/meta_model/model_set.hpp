...
public:
    ...
    const masd::dogen::variability::meta_model::profile_repository& profile_repository() const;
    masd::dogen::variability::meta_model::profile_repository& profile_repository();
    void profile_repository(const masd::dogen::variability::meta_model::profile_repository& v);
    void profile_repository(const masd::dogen::variability::meta_model::profile_repository&& v);
...
private:
    ...
    masd::dogen::variability::meta_model::profile_repository profile_repository_;
};
