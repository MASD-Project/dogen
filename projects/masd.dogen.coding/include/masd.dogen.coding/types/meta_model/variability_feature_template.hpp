...
class variability_feature_template final {
public:
    variability_feature_template(const variability_feature_template&) = default;
    variability_feature_template(variability_feature_template&&) = default;
    ~variability_feature_template() = default;

public:
    variability_feature_template();
...
public:
    bool operator==(const variability_feature_template& rhs) const;
    bool operator!=(const variability_feature_template& rhs) const {
        return !this->operator==(rhs);
    }

public:
    void swap(variability_feature_template& other) noexcept;
    variability_feature_template& operator=(variability_feature_template other);
...
template<>
inline void swap(
    masd::dogen::coding::meta_model::variability_feature_template& lhs,
    masd::dogen::coding::meta_model::variability_feature_template& rhs) {
    lhs.swap(rhs);
}
