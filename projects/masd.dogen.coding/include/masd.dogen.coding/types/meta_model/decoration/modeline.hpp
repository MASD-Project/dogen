 ...
 *
 */
#ifndef MASD_DOGEN_CODING_TYPES_META_MODEL_DECORATION_MODELINE_HPP
#define MASD_DOGEN_CODING_TYPES_META_MODEL_DECORATION_MODELINE_HPP
...
public:
    modeline(
        ...
        const masd::dogen::coding::meta_model::decoration::editor editor,
        const masd::dogen::coding::meta_model::decoration::modeline_location location,
        const std::list<masd::dogen::coding::meta_model::decoration::modeline_field>& fields,
...
public:
     ...
     */
    /**@{*/
    masd::dogen::coding::meta_model::decoration::editor editor() const;
    void editor(const masd::dogen::coding::meta_model::decoration::editor v);
    /**@}*/
     ...
     */
    /**@{*/
    masd::dogen::coding::meta_model::decoration::modeline_location location() const;
    void location(const masd::dogen::coding::meta_model::decoration::modeline_location v);
    /**@}*/
     ...
     */
    /**@{*/
    const std::list<masd::dogen::coding::meta_model::decoration::modeline_field>& fields() const;
    std::list<masd::dogen::coding::meta_model::decoration::modeline_field>& fields();
    void fields(const std::list<masd::dogen::coding::meta_model::decoration::modeline_field>& v);
    void fields(const std::list<masd::dogen::coding::meta_model::decoration::modeline_field>&& v);
    /**@}*/
...
private:
    masd::dogen::coding::meta_model::decoration::editor editor_;
    masd::dogen::coding::meta_model::decoration::modeline_location location_;
    std::list<masd::dogen::coding::meta_model::decoration::modeline_field> fields_;
...
template<>
inline void swap(
    masd::dogen::coding::meta_model::decoration::modeline& lhs,
    masd::dogen::coding::meta_model::decoration::modeline& rhs) {
    lhs.swap(rhs);
}
