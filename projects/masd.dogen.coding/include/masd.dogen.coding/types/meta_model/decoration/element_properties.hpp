 ...
 *
 */
#ifndef MASD_DOGEN_CODING_TYPES_META_MODEL_DECORATION_ELEMENT_PROPERTIES_HPP
#define MASD_DOGEN_CODING_TYPES_META_MODEL_DECORATION_ELEMENT_PROPERTIES_HPP
...
template<>
inline void swap(
    masd::dogen::coding::meta_model::decoration::element_properties& lhs,
    masd::dogen::coding::meta_model::decoration::element_properties& rhs) {
    lhs.swap(rhs);
}
