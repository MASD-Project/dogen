 ...
 *
 */
#ifndef MASD_DOGEN_CODING_TYPES_META_MODEL_DECORATION_MODELINE_FIELD_HPP
#define MASD_DOGEN_CODING_TYPES_META_MODEL_DECORATION_MODELINE_FIELD_HPP
...
template<>
inline void swap(
    masd::dogen::coding::meta_model::decoration::modeline_field& lhs,
    masd::dogen::coding::meta_model::decoration::modeline_field& rhs) {
    lhs.swap(rhs);
}
