 ...
 *
 */
#ifndef MASD_DOGEN_CODING_TYPES_META_MODEL_DECORATION_MODELINE_GROUP_HPP
#define MASD_DOGEN_CODING_TYPES_META_MODEL_DECORATION_MODELINE_GROUP_HPP
...
public:
    modeline_group(
        ...
        const std::list<boost::shared_ptr<masd::dogen::coding::meta_model::decoration::modeline> >& modelines);
...
public:
     ...
     */
    /**@{*/
    const std::list<boost::shared_ptr<masd::dogen::coding::meta_model::decoration::modeline> >& modelines() const;
    std::list<boost::shared_ptr<masd::dogen::coding::meta_model::decoration::modeline> >& modelines();
    void modelines(const std::list<boost::shared_ptr<masd::dogen::coding::meta_model::decoration::modeline> >& v);
    void modelines(const std::list<boost::shared_ptr<masd::dogen::coding::meta_model::decoration::modeline> >&& v);
    /**@}*/
...
private:
    ...
    std::list<boost::shared_ptr<masd::dogen::coding::meta_model::decoration::modeline> > modelines_;
};
...
template<>
inline void swap(
    masd::dogen::coding::meta_model::decoration::modeline_group& lhs,
    masd::dogen::coding::meta_model::decoration::modeline_group& rhs) {
    lhs.swap(rhs);
}
