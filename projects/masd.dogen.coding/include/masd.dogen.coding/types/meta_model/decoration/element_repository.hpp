 ...
 *
 */
#ifndef MASD_DOGEN_CODING_TYPES_META_MODEL_DECORATION_ELEMENT_REPOSITORY_HPP
#define MASD_DOGEN_CODING_TYPES_META_MODEL_DECORATION_ELEMENT_REPOSITORY_HPP
...
template<>
inline void swap(
    masd::dogen::coding::meta_model::decoration::element_repository& lhs,
    masd::dogen::coding::meta_model::decoration::element_repository& rhs) {
    lhs.swap(rhs);
}
