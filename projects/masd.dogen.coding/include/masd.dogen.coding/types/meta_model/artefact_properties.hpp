 ...
 *
 */
#ifndef MASD_DOGEN_MODELING_TYPES_META_MODEL_ARTEFACT_PROPERTIES_HPP
#define MASD_DOGEN_MODELING_TYPES_META_MODEL_ARTEFACT_PROPERTIES_HPP
...
public:
    ...
    masd::dogen::modeling::meta_model::formatting_styles formatting_style() const;
    void formatting_style(const masd::dogen::modeling::meta_model::formatting_styles v);
...
private:
    ...
    masd::dogen::modeling::meta_model::formatting_styles formatting_style_;
...
template<>
inline void swap(
    masd::dogen::modeling::meta_model::artefact_properties& lhs,
    masd::dogen::modeling::meta_model::artefact_properties& rhs) {
    lhs.swap(rhs);
}
