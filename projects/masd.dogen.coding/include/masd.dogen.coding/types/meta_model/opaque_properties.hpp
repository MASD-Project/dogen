 ...
 *
 */
#ifndef MASD_DOGEN_CODING_TYPES_META_MODEL_OPAQUE_PROPERTIES_HPP
#define MASD_DOGEN_CODING_TYPES_META_MODEL_OPAQUE_PROPERTIES_HPP
...
/**
 * @brief Base class for any properties that are not known to coding.
 */
