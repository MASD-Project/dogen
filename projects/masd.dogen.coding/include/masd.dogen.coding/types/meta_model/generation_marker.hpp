 ...
 *
 */
#ifndef MASD_DOGEN_CODING_TYPES_META_MODEL_GENERATION_MARKER_HPP
#define MASD_DOGEN_CODING_TYPES_META_MODEL_GENERATION_MARKER_HPP
...
template<>
inline void swap(
    masd::dogen::coding::meta_model::generation_marker& lhs,
    masd::dogen::coding::meta_model::generation_marker& rhs) {
    lhs.swap(rhs);
}
