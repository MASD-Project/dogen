 ...
 *
 */
#ifndef MASD_DOGEN_CODING_TYPES_META_MODEL_ARCHETYPE_FAMILY_PROPERTIES_HPP
#define MASD_DOGEN_CODING_TYPES_META_MODEL_ARCHETYPE_FAMILY_PROPERTIES_HPP
...
template<>
inline void swap(
    masd::dogen::coding::meta_model::archetype_family_properties& lhs,
    masd::dogen::coding::meta_model::archetype_family_properties& rhs) {
    lhs.swap(rhs);
}
