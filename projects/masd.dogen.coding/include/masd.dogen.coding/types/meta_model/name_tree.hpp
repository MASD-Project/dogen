 ...
 *
 */
#ifndef MASD_DOGEN_CODING_TYPES_META_MODEL_NAME_TREE_HPP
#define MASD_DOGEN_CODING_TYPES_META_MODEL_NAME_TREE_HPP
...
public:
     ...
     */
    /**@{*/
    const masd::dogen::coding::meta_model::name& current() const;
    masd::dogen::coding::meta_model::name& current();
    void current(const masd::dogen::coding::meta_model::name& v);
    void current(const masd::dogen::coding::meta_model::name&& v);
    /**@}*/
     ...
     */
    /**@{*/
    const std::list<masd::dogen::coding::meta_model::name_tree>& children() const;
    std::list<masd::dogen::coding::meta_model::name_tree>& children();
    void children(const std::list<masd::dogen::coding::meta_model::name_tree>& v);
    void children(const std::list<masd::dogen::coding::meta_model::name_tree>&& v);
    /**@}*/
...
template<>
inline void swap(
    masd::dogen::coding::meta_model::name_tree& lhs,
    masd::dogen::coding::meta_model::name_tree& rhs) {
    lhs.swap(rhs);
}
