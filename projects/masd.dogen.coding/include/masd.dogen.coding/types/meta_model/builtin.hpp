 ...
 *
 */
#ifndef MASD_DOGEN_CODING_TYPES_META_MODEL_BUILTIN_HPP
#define MASD_DOGEN_CODING_TYPES_META_MODEL_BUILTIN_HPP
...
template<>
inline void swap(
    masd::dogen::coding::meta_model::builtin& lhs,
    masd::dogen::coding::meta_model::builtin& rhs) {
    lhs.swap(rhs);
}
