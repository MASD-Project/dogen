...
#include "masd.dogen.coding/hash/meta_model/orm/database_system_hash.hpp"
...
public:
    attribute_properties(
        ...
        const std::unordered_map<masd::dogen::coding::meta_model::orm::database_system, std::string>& type_overrides,
...
public:
     ...
     */
    /**@{*/
    const std::unordered_map<masd::dogen::coding::meta_model::orm::database_system, std::string>& type_overrides() const;
    std::unordered_map<masd::dogen::coding::meta_model::orm::database_system, std::string>& type_overrides();
    void type_overrides(const std::unordered_map<masd::dogen::coding::meta_model::orm::database_system, std::string>& v);
    void type_overrides(const std::unordered_map<masd::dogen::coding::meta_model::orm::database_system, std::string>&& v);
    /**@}*/
...
private:
    ...
    std::unordered_map<masd::dogen::coding::meta_model::orm::database_system, std::string> type_overrides_;
    bool is_composite_;
};
...
template<>
inline void swap(
    masd::dogen::coding::meta_model::orm::attribute_properties& lhs,
    masd::dogen::coding::meta_model::orm::attribute_properties& rhs) {
    lhs.swap(rhs);
}
