 ...
 *
 */
#ifndef MASD_DOGEN_MODELING_TYPES_HELPERS_MAPPING_ERROR_HPP
#define MASD_DOGEN_MODELING_TYPES_HELPERS_MAPPING_ERROR_HPP
...
public:
    explicit mapping_error(const std::string& message) : message_(message) { }
