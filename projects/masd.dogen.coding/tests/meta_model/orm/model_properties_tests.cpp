...
BOOST_AUTO_TEST_CASE(identical_objects_are_equal) {
    masd::dogen::coding::meta_model::orm::model_properties_generator g;
    const auto a(g());
    const auto b(a);
...
BOOST_AUTO_TEST_CASE(moved_objects_are_equal) {
    ...
    g();
    auto a(g());
    const auto b = masd::dogen::coding::meta_model::orm::model_properties();
    const auto c(a);
    BOOST_CHECK(a != b);
    BOOST_CHECK(a == c);
...
BOOST_AUTO_TEST_CASE(assigned_objects_are_equal) {
    ...
    g();
    const auto a(g());
    masd::dogen::coding::meta_model::orm::model_properties b;
    BOOST_CHECK(a != b);
...
BOOST_AUTO_TEST_CASE(copy_constructed_objects_are_equal) {
    ...
    b = masd::dogen::coding::meta_model::orm::model_properties();
    BOOST_CHECK(a != b);
}
