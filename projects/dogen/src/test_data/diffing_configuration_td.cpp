...
dogen::diffing_destination
create_dogen_diffing_destination(const unsigned int position) {
    return dogen::diffing_destination_generator::create(position);
}
...
populate(const unsigned int position, result_type& v) {
    v.destination(create_dogen_diffing_destination(position + 0));
