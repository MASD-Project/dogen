...
#include "dogen/hash/spec_entry_hash.hpp"
#include "dogen/test_data/spec_entry_td.hpp"
#include "dogen/serialization/spec_entry_ser.hpp"

BOOST_AUTO_TEST_SUITE(spec_entry_tests)

BOOST_AUTO_TEST_CASE(identical_objects_are_equal) {
    dogen::spec_entry_generator g;
    const auto a(g());
    const auto b(a);
...
BOOST_AUTO_TEST_CASE(xml_roundtrip_produces_the_same_entity) {
    ...
    dogen::spec_entry b = dogen::spec_entry();
...
BOOST_AUTO_TEST_CASE(equal_objects_generate_the_same_hash) {
    ...
    std::hash<dogen::spec_entry> hasher;
