...
#include "dogen/hash/spec_category_hash.hpp"
#include "dogen/test_data/spec_category_td.hpp"
#include "dogen/serialization/spec_category_ser.hpp"

BOOST_AUTO_TEST_SUITE(spec_category_tests)

BOOST_AUTO_TEST_CASE(identical_objects_are_equal) {
    dogen::spec_category_generator g;
    const auto a(g());
    const auto b(a);
...
BOOST_AUTO_TEST_CASE(moved_objects_are_equal) {
    ...
    g();
    auto a(g());
    const auto b = dogen::spec_category();
    const auto c(a);
    BOOST_CHECK(a != b);
    BOOST_CHECK(a == c);
...
BOOST_AUTO_TEST_CASE(xml_roundtrip_produces_the_same_entity) {
    ...
    dogen::spec_category b = dogen::spec_category();
...
BOOST_AUTO_TEST_CASE(equal_objects_generate_the_same_hash) {
    ...
    std::hash<dogen::spec_category> hasher;
