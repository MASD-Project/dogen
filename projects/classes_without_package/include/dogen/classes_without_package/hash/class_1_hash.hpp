 ...
 *
 */
#ifndef DOGEN_CLASSES_WITHOUT_PACKAGE_HASH_CLASS_1_HASH_HPP
#define DOGEN_CLASSES_WITHOUT_PACKAGE_HASH_CLASS_1_HASH_HPP
...
public:
    size_t operator()(const dogen::classes_without_package::class_1& value) const {
