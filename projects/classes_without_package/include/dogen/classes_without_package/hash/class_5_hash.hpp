...
template<>
struct hash<dogen::classes_without_package::class_5> {
public:
    size_t operator()(const dogen::classes_without_package::class_5& v) const {
        return dogen::classes_without_package::class_5_hasher::hash(v);
    }
};
