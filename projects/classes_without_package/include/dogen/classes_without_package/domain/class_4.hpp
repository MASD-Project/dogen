 ...
 *
 */
#ifndef DOGEN_CLASSES_WITHOUT_PACKAGE_DOMAIN_CLASS_4_HPP
#define DOGEN_CLASSES_WITHOUT_PACKAGE_DOMAIN_CLASS_4_HPP
...
#include "dogen/classes_without_package/serialization/class_4_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::classes_without_package::class_4& lhs,
    dogen::classes_without_package::class_4& rhs) {
    lhs.swap(rhs);
}
