 ...
 *
 */
#ifndef DOGEN_CLASSES_WITHOUT_PACKAGE_DOMAIN_UNVERSIONED_KEY_HPP
#define DOGEN_CLASSES_WITHOUT_PACKAGE_DOMAIN_UNVERSIONED_KEY_HPP
...
#include <algorithm>
#include "dogen/classes_without_package/serialization/unversioned_key_fwd_ser.hpp"
...
public:
    friend class dogen::classes_without_package::unversioned_key_serializer;
...
template<>
inline void swap(
    dogen::classes_without_package::unversioned_key& lhs,
    dogen::classes_without_package::unversioned_key& rhs) {
    lhs.swap(rhs);
}
