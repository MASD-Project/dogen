 ...
 *
 */
#ifndef DOGEN_CLASSES_WITHOUT_PACKAGE_DATABASE_CLASS_2_DB_HPP
#define DOGEN_CLASSES_WITHOUT_PACKAGE_DATABASE_CLASS_2_DB_HPP
...
private:
    ...
    std::vector<dogen::classes_without_package::class_2> load_internal(
...
public:
    std::vector<dogen::classes_without_package::class_2> load(
        pqxx::connection& connection,
        const boost::optional<versioned_key> id =boost::optional<versioned_key>());

    void save(
        pqxx::connection& connection,
        std::vector<dogen::classes_without_package::class_2> values);
