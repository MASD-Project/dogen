 ...
 *
 */
#ifndef DOGEN_CLASSES_WITHOUT_PACKAGE_TEST_DATA_VERSIONED_KEY_SEQUENCE_HPP
#define DOGEN_CLASSES_WITHOUT_PACKAGE_TEST_DATA_VERSIONED_KEY_SEQUENCE_HPP
...
public:
    typedef dogen::classes_without_package::versioned_key value_type;
