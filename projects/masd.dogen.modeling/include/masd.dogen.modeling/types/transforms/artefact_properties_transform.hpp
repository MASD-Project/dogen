 ...
 *
 */
#ifndef MASD_DOGEN_MODELING_TYPES_TRANSFORMS_ARTEFACT_PROPERTIES_TRANSFORM_HPP
#define MASD_DOGEN_MODELING_TYPES_TRANSFORMS_ARTEFACT_PROPERTIES_TRANSFORM_HPP
