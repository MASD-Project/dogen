 ...
 *
 */
#ifndef DOGEN_MODELING_TYPES_META_MODEL_ORM_PRIMITIVE_PROPERTIES_HPP
#define DOGEN_MODELING_TYPES_META_MODEL_ORM_PRIMITIVE_PROPERTIES_HPP
...
template<>
inline void swap(
    dogen::modeling::meta_model::orm_primitive_properties& lhs,
    dogen::modeling::meta_model::orm_primitive_properties& rhs) {
    lhs.swap(rhs);
}
