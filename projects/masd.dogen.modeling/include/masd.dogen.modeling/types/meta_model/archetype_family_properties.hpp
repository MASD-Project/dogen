 ...
 *
 */
#ifndef MASD_DOGEN_MODELING_TYPES_META_MODEL_ARCHETYPE_FAMILY_PROPERTIES_HPP
#define MASD_DOGEN_MODELING_TYPES_META_MODEL_ARCHETYPE_FAMILY_PROPERTIES_HPP
...
template<>
inline void swap(
    masd::dogen::modeling::meta_model::archetype_family_properties& lhs,
    masd::dogen::modeling::meta_model::archetype_family_properties& rhs) {
    lhs.swap(rhs);
}
