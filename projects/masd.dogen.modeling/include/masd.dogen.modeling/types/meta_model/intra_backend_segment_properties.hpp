 ...
 *
 */
#ifndef MASD_DOGEN_MODELING_TYPES_META_MODEL_INTRA_BACKEND_SEGMENT_PROPERTIES_HPP
#define MASD_DOGEN_MODELING_TYPES_META_MODEL_INTRA_BACKEND_SEGMENT_PROPERTIES_HPP
...
#include "masd.dogen.modeling/types/meta_model/path_contribution_types.hpp"
...
public:
     ...
     */
    /**@{*/
    masd::dogen::modeling::meta_model::path_contribution_types external_modules() const;
    void external_modules(const masd::dogen::modeling::meta_model::path_contribution_types v);
    /**@}*/
     ...
     */
    /**@{*/
    masd::dogen::modeling::meta_model::path_contribution_types model_modules() const;
    void model_modules(const masd::dogen::modeling::meta_model::path_contribution_types v);
    /**@}*/
     ...
     */
    /**@{*/
    masd::dogen::modeling::meta_model::path_contribution_types internal_modules() const;
    void internal_modules(const masd::dogen::modeling::meta_model::path_contribution_types v);
    /**@}*/
     ...
     */
    /**@{*/
    masd::dogen::modeling::meta_model::path_contribution_types facet() const;
    void facet(const masd::dogen::modeling::meta_model::path_contribution_types v);
    /**@}*/
...
private:
    ...
    masd::dogen::modeling::meta_model::path_contribution_types external_modules_;
    masd::dogen::modeling::meta_model::path_contribution_types model_modules_;
    masd::dogen::modeling::meta_model::path_contribution_types internal_modules_;
    masd::dogen::modeling::meta_model::path_contribution_types facet_;
};
...
template<>
inline void swap(
    masd::dogen::modeling::meta_model::intra_backend_segment_properties& lhs,
    masd::dogen::modeling::meta_model::intra_backend_segment_properties& rhs) {
    lhs.swap(rhs);
}
