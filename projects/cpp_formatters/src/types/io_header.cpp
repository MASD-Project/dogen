...
void io_header::format_class(const cpp::file_info& fi) {
...
void io_header::format_enumeration(const cpp::file_info& fi) {
...
void io_header::format(const cpp::file_info& fi) {
