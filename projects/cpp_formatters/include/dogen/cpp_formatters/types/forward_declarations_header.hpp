...
private:
    void format_serialization_class(const cpp::formattables::class_info& ci);
    void format_domain_class(const cpp::formattables::class_info& ci);

    void format_class(const cpp::formattables::file_info& f);
    void format_enumeration(const cpp::formattables::file_info& f);
    void format_exception(const cpp::formattables::file_info& f);
