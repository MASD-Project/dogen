...
private:
    void operator_bracket_method(const cpp::formattables::class_info& ci);
    void hash_helper_class(const cpp::formattables::class_info& ci);
    void hash_class(const cpp::formattables::class_info& ci);
