 ...
 *
 */
#ifndef DOGEN_ARCHETYPES_TYPES_LOCATION_REPOSITORY_HPP
#define DOGEN_ARCHETYPES_TYPES_LOCATION_REPOSITORY_HPP
...
template<>
inline void swap(
    dogen::archetypes::location_repository& lhs,
    dogen::archetypes::location_repository& rhs) {
    lhs.swap(rhs);
}
