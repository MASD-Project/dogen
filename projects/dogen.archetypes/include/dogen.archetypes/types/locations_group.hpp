 ...
 *
 */
#ifndef DOGEN_ARCHETYPES_TYPES_LOCATIONS_GROUP_HPP
#define DOGEN_ARCHETYPES_TYPES_LOCATIONS_GROUP_HPP
...
public:
    locations_group(
        const std::list<dogen::archetypes::location>& locations,
...
public:
     ...
     */
    /**@{*/
    const std::list<dogen::archetypes::location>& locations() const;
    std::list<dogen::archetypes::location>& locations();
    void locations(const std::list<dogen::archetypes::location>& v);
    void locations(const std::list<dogen::archetypes::location>&& v);
    /**@}*/
...
private:
    std::list<dogen::archetypes::location> locations_;
...
template<>
inline void swap(
    dogen::archetypes::locations_group& lhs,
    dogen::archetypes::locations_group& rhs) {
    lhs.swap(rhs);
}
