...
#include "dogen.archetypes/test_data/location_repository_td.hpp"
...
populate(const unsigned int position, result_type& v) {
    ...
    v.by_meta_name(create_std_unordered_map_std_string_dogen_archetypes_locations_group(position + 3));
    v.by_family(create_std_unordered_map_std_string_std_list_dogen_archetypes_location(position + 4));
    v.by_backend_by_facet(create_std_unordered_map_std_string_std_unordered_map_std_string_std_list_std_string(position + 5));
    v.by_intra_backend_segment(create_std_unordered_map_std_string_std_list_dogen_archetypes_location(position + 6));
}
