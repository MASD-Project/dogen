...
#include "dogen.templating/hash/stitch/text_template_hash.hpp"
...
BOOST_AUTO_TEST_CASE(xml_roundtrip_produces_the_same_entity) {
    ...
    dogen::templating::stitch::text_template b = dogen::templating::stitch::text_template();
...
BOOST_AUTO_TEST_CASE(equal_objects_generate_the_same_hash) {
    ...
    std::hash<dogen::templating::stitch::text_template> hasher;
