...
#include "dogen.templating/hash/stitch/properties_hash.hpp"
...
BOOST_AUTO_TEST_CASE(xml_roundtrip_produces_the_same_entity) {
    ...
    dogen::templating::stitch::properties b = dogen::templating::stitch::properties();
...
BOOST_AUTO_TEST_CASE(equal_objects_generate_the_same_hash) {
    ...
    std::hash<dogen::templating::stitch::properties> hasher;
