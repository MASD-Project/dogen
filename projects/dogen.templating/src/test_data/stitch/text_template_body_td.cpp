...
dogen::templating::stitch::line
create_dogen_templating_stitch_line(const unsigned int position) {
    return dogen::templating::stitch::line_generator::create(position);
}

std::list<dogen::templating::stitch::line> create_std_list_dogen_templating_stitch_line(unsigned int position) {
    std::list<dogen::templating::stitch::line> r;
    for (unsigned int i(0); i < 4; ++i) {
        r.push_back(create_dogen_templating_stitch_line(position + i));
    }
    return r;
}
...
populate(const unsigned int position, result_type& v) {
    ...
    v.lines(create_std_list_dogen_templating_stitch_line(position + 1));
}
