...
dogen::templating::stitch::block_types
create_dogen_templating_stitch_block_types(const unsigned int position) {
    return dogen::templating::stitch::block_types_generator::create(position);
}
...
populate(const unsigned int position, result_type& v) {
    v.type(create_dogen_templating_stitch_block_types(position + 0));
