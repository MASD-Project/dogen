...
private:
     ...
     * the key settings.
     */
    stitch::text_template make_text_template_with_trivial_properties() const;

    /**
     * @brief Makes @code how_many lines, each with a single text block.
     */
    std::list<stitch::line> make_text_block_only_lines(
     ...
     */
    std::list<stitch::line> make_variable_block(const std::string& v) const;

public:
    /**
     * @brief Creates a template with no content.
     */
    stitch::text_template make_empty_template() const;

    /**
     * @brief Creates a text template with a single line, composed of
     * a text block.
     */
    stitch::text_template make_single_text_block_line() const;

    /**
     * @brief Creates a text template with @code how_many lines, each
     * made up of a single text block.
     */
    stitch::text_template make_multiple_text_block_lines(
     ...
     */
    stitch::text_template make_single_expression_block_line() const;

    /**
     * @brief Creates a text template with @code how_many lines, each
     * made up of a single-line expression block.
     */
    stitch::text_template make_multiple_expression_block_lines(
        const unsigned int how_many = 2) const;
     ...
     */
    stitch::text_template make_single_standard_control_block_line() const;

    /**
     * @brief Creates a text template with @code how_many lines, each
     * made up of a single-line standard control block.
     */
    stitch::text_template make_multiple_standard_control_block_lines(
        const unsigned int how_many = 2) const;
     ...
     */
    stitch::text_template make_text_expression_text_single_line() const;
     ...
     * block.
     */
    stitch::text_template make_expression_text_expression_single_line() const;
     ...
     * block.
     */
    stitch::text_template make_text_expression_text_multi_line(
        const unsigned int how_many = 2) const;
     ...
     * expression block.
     */
    stitch::text_template make_expression_text_expression_multi_line(
        const unsigned int how_many = 2) const;
     ...
     */
    stitch::text_template make_text_standard_control_text_single_line() const;
     ...
     * block.
     */
    stitch::text_template make_text_standard_control_text_multi_line(
        const unsigned int how_many = 2) const;
     ...
     * text block.
     */
    stitch::text_template make_mixed_content_single_line() const;
     ...
     */
    stitch::text_template make_mixed_content_multi_line(
        const unsigned int how_many = 2) const;
     ...
     */
    stitch::text_template make_text_line_with_quotes() const;
...
public:
     ...
     * text block.
     */
    stitch::text_template make_complex_structure() const;

    /**
     * @brief Populate decoration configuration in the template. Also
     * includes a single line of text.
     */
    stitch::text_template make_with_decoration_properties() const;

    /**
     * @brief Populate containing namespace in the text template.
     */
    stitch::text_template make_with_containing_namespace() const;

    /**
     * @brief Text template with lines that have empty text blocks.
     */
    stitch::text_template
    make_empty_text_lines(const unsigned int how_many = 2) const;

    /**
     * @brief Add line with variable. No mapping is added for the variable.
     */
    stitch::text_template make_with_variable(const std::string& v) const;
