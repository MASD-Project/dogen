...
#include "dogen/classes_inside_and_outside_package/io/versioned_key_io.hpp"
...
class_1::class_1(dogen::classes_inside_and_outside_package::versioned_key versioned_key)
