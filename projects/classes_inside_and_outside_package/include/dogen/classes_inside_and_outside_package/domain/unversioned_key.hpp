 ...
 *
 */
#ifndef DOGEN_CLASSES_INSIDE_AND_OUTSIDE_PACKAGE_DOMAIN_UNVERSIONED_KEY_HPP
#define DOGEN_CLASSES_INSIDE_AND_OUTSIDE_PACKAGE_DOMAIN_UNVERSIONED_KEY_HPP
...
public:
    friend class dogen::classes_inside_and_outside_package::unversioned_key_serializer;
...
template<>
inline void swap(
    dogen::classes_inside_and_outside_package::unversioned_key& lhs,
    dogen::classes_inside_and_outside_package::unversioned_key& rhs) {
    lhs.swap(rhs);
}
