 ...
 *
 */
#ifndef DOGEN_CLASSES_INSIDE_AND_OUTSIDE_PACKAGE_SERIALIZATION_VERSIONED_KEY_SER_HPP
#define DOGEN_CLASSES_INSIDE_AND_OUTSIDE_PACKAGE_SERIALIZATION_VERSIONED_KEY_SER_HPP
...
inline void serialize(Archive & archive,
    dogen::classes_inside_and_outside_package::versioned_key& value,
    const unsigned int version) {
    dogen::classes_inside_and_outside_package::versioned_key_serializer serializer;
