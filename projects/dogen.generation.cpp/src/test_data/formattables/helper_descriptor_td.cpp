...
boost::optional<dogen::generation::cpp::formattables::streaming_properties>
create_boost_optional_dogen_generation_cpp_formattables_streaming_properties(unsigned int position) {
    boost::optional<dogen::generation::cpp::formattables::streaming_properties> r(
        create_dogen_generation_cpp_formattables_streaming_properties(position));
    return r;
}
...
populate(const unsigned int position, result_type& v) {
    ...
    v.streaming_properties(create_boost_optional_dogen_generation_cpp_formattables_streaming_properties(position + 6));
