...
const logical::meta_model::name& feature_template_bundle_implementation_formatter::meta_name() const {
...
format(const context& ctx, const logical::meta_model::element& e) const {
    ...
    const auto& ftb(a.as<logical::meta_model::variability::feature_template_bundle>(e));
