...
const logical::meta_model::name& primitive_forward_declarations_formatter::meta_name() const {
...
extraction::meta_model::artefact primitive_forward_declarations_formatter::
