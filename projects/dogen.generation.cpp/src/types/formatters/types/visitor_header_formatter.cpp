...
const assets::meta_model::name& visitor_header_formatter::meta_name() const {
...
std::list<std::string> visitor_header_formatter::inclusion_dependencies(
    ...
    using assets::meta_model::structural::visitor;
...
format(const context& ctx, const assets::meta_model::element& e) const {
    ...
    const auto& v(a.as<assets::meta_model::structural::visitor>(e));
