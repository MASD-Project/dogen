...
std::string type_registrar_implementation_formatter::static_id() {
    return traits::type_registrar_implementation_archetype();
}

std::string type_registrar_implementation_formatter::id() const {
    return static_id();
}

physical::location
type_registrar_implementation_formatter::archetype_location() const {
    static physical::location
        r(cpp::traits::kernel(),  cpp::traits::backend(),
          traits::facet(),
          type_registrar_implementation_formatter::static_id());
    return r;
}

const logical::entities::name& type_registrar_implementation_formatter::meta_name() const {
    using logical::helpers::meta_name_factory;
    static auto r(meta_name_factory::make_serialization_type_registrar_name());
    return r;
}

std::string type_registrar_implementation_formatter::family() const {
    return cpp::traits::implementation_family();
}

inclusion_support_types type_registrar_implementation_formatter::inclusion_support_type() const {
...
boost::filesystem::path type_registrar_implementation_formatter::inclusion_path(
    ...
    static logger lg(
        logger_factory(type_registrar_implementation_formatter::static_id()));
...
extraction::entities::artefact type_registrar_implementation_formatter::
