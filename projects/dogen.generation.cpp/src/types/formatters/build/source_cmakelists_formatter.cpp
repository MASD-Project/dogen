...
physical::entities::location source_cmakelists_formatter::
...
const logical::entities::name& source_cmakelists_formatter::meta_name() const {
...
extraction::entities::artefact source_cmakelists_formatter::
