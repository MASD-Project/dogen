...
formattable::formattable(
    const boost::shared_ptr<dogen::coding::meta_model::element>& master_segment,
    const std::list<boost::shared_ptr<dogen::coding::meta_model::element> >& all_segments,
...
const boost::shared_ptr<dogen::coding::meta_model::element>& formattable::master_segment() const {
    return master_segment_;
}

boost::shared_ptr<dogen::coding::meta_model::element>& formattable::master_segment() {
    return master_segment_;
}

void formattable::master_segment(const boost::shared_ptr<dogen::coding::meta_model::element>& v) {
    master_segment_ = v;
}
...
const std::list<boost::shared_ptr<dogen::coding::meta_model::element> >& formattable::all_segments() const {
    return all_segments_;
}

std::list<boost::shared_ptr<dogen::coding::meta_model::element> >& formattable::all_segments() {
    return all_segments_;
}

void formattable::all_segments(const std::list<boost::shared_ptr<dogen::coding::meta_model::element> >& v) {
    all_segments_ = v;
}
