...
inline std::ostream& operator<<(std::ostream& s, const std::unordered_map<std::string, std::list<dogen::assets::meta_model::name> >& v) {
    s << "[";
    for (auto i(v.begin()); i != v.end(); ++i) {
        if (i != v.begin()) s << ", ";
        s << "[ { " << "\"__type__\": " << "\"key\"" << ", " << "\"data\": ";
...
inline std::ostream& operator<<(std::ostream& s, const std::unordered_map<std::string, std::unordered_map<std::string, std::list<dogen::assets::meta_model::name> > >& v) {
    s << "[";
    for (auto i(v.begin()); i != v.end(); ++i) {
        if (i != v.begin()) s << ", ";
        s << "[ { " << "\"__type__\": " << "\"key\"" << ", " << "\"data\": ";
...
void master_header::accept(const dogen::assets::meta_model::element_visitor& v) const {
...
void master_header::accept(dogen::assets::meta_model::element_visitor& v) const {
...
void master_header::accept(const dogen::assets::meta_model::element_visitor& v) {
    typedef const element_visitor* derived_ptr;
    const auto dv(dynamic_cast<derived_ptr>(&v));
    if (dv)
        dv->visit(*this);
...
void master_header::accept(dogen::assets::meta_model::element_visitor& v) {
    typedef element_visitor* derived_ptr;
    const auto dv(dynamic_cast<derived_ptr>(&v));
    if (dv)
        dv->visit(*this);
...
bool master_header::equals(const dogen::assets::meta_model::element& other) const {
...
const std::unordered_map<std::string, std::unordered_map<std::string, std::list<dogen::assets::meta_model::name> > >& master_header::inclusion_by_facet() const {
    return inclusion_by_facet_;
}

std::unordered_map<std::string, std::unordered_map<std::string, std::list<dogen::assets::meta_model::name> > >& master_header::inclusion_by_facet() {
    return inclusion_by_facet_;
}

void master_header::inclusion_by_facet(const std::unordered_map<std::string, std::unordered_map<std::string, std::list<dogen::assets::meta_model::name> > >& v) {
