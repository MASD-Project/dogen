 ...
 *
 */
#ifndef DOGEN_GENERATION_CPP_SERIALIZATION_FABRIC_MSBUILD_TARGETS_FWD_SER_HPP
#define DOGEN_GENERATION_CPP_SERIALIZATION_FABRIC_MSBUILD_TARGETS_FWD_SER_HPP
