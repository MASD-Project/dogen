 ...
 *
 */
#ifndef DOGEN_GENERATION_CPP_TYPES_FORMATTERS_TYPES_VISITOR_FORWARD_DECLARATIONS_FORMATTER_HPP
#define DOGEN_GENERATION_CPP_TYPES_FORMATTERS_TYPES_VISITOR_FORWARD_DECLARATIONS_FORMATTER_HPP
...
class visitor_forward_declarations_formatter final : public artefact_formatter_interface {
public:
