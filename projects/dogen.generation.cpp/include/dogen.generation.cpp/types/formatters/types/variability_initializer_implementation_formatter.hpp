 ...
 *
 */
#ifndef DOGEN_GENERATION_CPP_TYPES_FORMATTERS_TYPES_VARIABILITY_INITIALIZER_IMPLEMENTATION_FORMATTER_HPP
#define DOGEN_GENERATION_CPP_TYPES_FORMATTERS_TYPES_VARIABILITY_INITIALIZER_IMPLEMENTATION_FORMATTER_HPP
...
class variability_initializer_implementation_formatter final : public artefact_formatter_interface {
public:
