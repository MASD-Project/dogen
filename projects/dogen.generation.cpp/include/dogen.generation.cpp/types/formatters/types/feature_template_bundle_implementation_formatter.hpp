 ...
 *
 */
#ifndef DOGEN_GENERATION_CPP_TYPES_FORMATTERS_TYPES_FEATURE_TEMPLATE_BUNDLE_IMPLEMENTATION_FORMATTER_HPP
#define DOGEN_GENERATION_CPP_TYPES_FORMATTERS_TYPES_FEATURE_TEMPLATE_BUNDLE_IMPLEMENTATION_FORMATTER_HPP
...
class feature_template_bundle_implementation_formatter final : public artefact_formatter_interface {
public:
