 ...
 *
 */
#ifndef DOGEN_GENERATION_CPP_TYPES_FORMATTERS_TYPES_FEATURE_TEMPLATE_INITIALIZER_HEADER_FORMATTER_HPP
#define DOGEN_GENERATION_CPP_TYPES_FORMATTERS_TYPES_FEATURE_TEMPLATE_INITIALIZER_HEADER_FORMATTER_HPP
