 ...
 *
 */
#ifndef DOGEN_GENERATION_CPP_TYPES_FORMATTERS_TYPES_FEATURE_TEMPLATE_BUNDLE_HEADER_FORMATTER_HPP
#define DOGEN_GENERATION_CPP_TYPES_FORMATTERS_TYPES_FEATURE_TEMPLATE_BUNDLE_HEADER_FORMATTER_HPP
...
class feature_template_bundle_header_formatter final : public artefact_formatter_interface {
public:
