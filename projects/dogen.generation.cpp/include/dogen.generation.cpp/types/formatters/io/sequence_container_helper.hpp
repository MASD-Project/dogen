 ...
 *
 */
#ifndef DOGEN_GENERATION_CPP_TYPES_FORMATTERS_IO_SEQUENCE_CONTAINER_HELPER_HPP
#define DOGEN_GENERATION_CPP_TYPES_FORMATTERS_IO_SEQUENCE_CONTAINER_HELPER_HPP
