 ...
 *
 */
#ifndef DOGEN_GENERATION_CPP_TYPES_FORMATTERS_TEST_DATA_CLASS_HEADER_FORMATTER_HPP
#define DOGEN_GENERATION_CPP_TYPES_FORMATTERS_TEST_DATA_CLASS_HEADER_FORMATTER_HPP
