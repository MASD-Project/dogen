 ...
 *
 */
#ifndef DOGEN_GENERATION_CPP_TYPES_FORMATTERS_TESTS_CLASS_IMPLEMENTATION_FORMATTER_HPP
#define DOGEN_GENERATION_CPP_TYPES_FORMATTERS_TESTS_CLASS_IMPLEMENTATION_FORMATTER_HPP
