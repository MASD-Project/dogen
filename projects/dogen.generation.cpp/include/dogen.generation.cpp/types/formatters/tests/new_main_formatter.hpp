 ...
 *
 */
#ifndef DOGEN_GENERATION_CPP_TYPES_FORMATTERS_TESTS_NEW_MAIN_FORMATTER_HPP
#define DOGEN_GENERATION_CPP_TYPES_FORMATTERS_TESTS_NEW_MAIN_FORMATTER_HPP
...
class new_main_formatter final : public artefact_formatter_interface {
public:
