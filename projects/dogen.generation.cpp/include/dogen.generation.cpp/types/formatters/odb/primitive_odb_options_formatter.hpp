 ...
 *
 */
#ifndef DOGEN_GENERATION_CPP_TYPES_FORMATTERS_ODB_PRIMITIVE_ODB_OPTIONS_FORMATTER_HPP
#define DOGEN_GENERATION_CPP_TYPES_FORMATTERS_ODB_PRIMITIVE_ODB_OPTIONS_FORMATTER_HPP
...
class primitive_odb_options_formatter final : public artefact_formatter_interface {
public:
