 ...
 *
 */
#ifndef DOGEN_GENERATION_CPP_TYPES_FORMATTERS_ODB_PRIMITIVE_HEADER_FORMATTER_HPP
#define DOGEN_GENERATION_CPP_TYPES_FORMATTERS_ODB_PRIMITIVE_HEADER_FORMATTER_HPP
