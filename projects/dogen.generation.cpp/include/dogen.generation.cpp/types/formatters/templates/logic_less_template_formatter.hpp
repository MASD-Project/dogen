 ...
 *
 */
#ifndef DOGEN_GENERATION_CPP_TYPES_FORMATTERS_TEMPLATES_LOGIC_LESS_TEMPLATE_FORMATTER_HPP
#define DOGEN_GENERATION_CPP_TYPES_FORMATTERS_TEMPLATES_LOGIC_LESS_TEMPLATE_FORMATTER_HPP
...
class logic_less_template_formatter final : public artefact_formatter_interface {
public:
