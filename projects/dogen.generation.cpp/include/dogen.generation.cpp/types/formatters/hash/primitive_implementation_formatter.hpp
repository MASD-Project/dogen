 ...
 *
 */
#ifndef DOGEN_GENERATION_CPP_TYPES_FORMATTERS_HASH_PRIMITIVE_IMPLEMENTATION_FORMATTER_HPP
#define DOGEN_GENERATION_CPP_TYPES_FORMATTERS_HASH_PRIMITIVE_IMPLEMENTATION_FORMATTER_HPP
