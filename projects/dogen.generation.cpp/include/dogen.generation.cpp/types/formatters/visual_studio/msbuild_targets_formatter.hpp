 ...
 *
 */
#ifndef DOGEN_GENERATION_CPP_TYPES_FORMATTERS_VISUAL_STUDIO_MSBUILD_TARGETS_FORMATTER_HPP
#define DOGEN_GENERATION_CPP_TYPES_FORMATTERS_VISUAL_STUDIO_MSBUILD_TARGETS_FORMATTER_HPP
...
class msbuild_targets_formatter final : public artefact_formatter_interface {
public:
