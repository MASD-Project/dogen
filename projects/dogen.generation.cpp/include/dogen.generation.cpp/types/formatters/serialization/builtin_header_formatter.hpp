 ...
 *
 */
#ifndef DOGEN_GENERATION_CPP_TYPES_FORMATTERS_SERIALIZATION_BUILTIN_HEADER_FORMATTER_HPP
#define DOGEN_GENERATION_CPP_TYPES_FORMATTERS_SERIALIZATION_BUILTIN_HEADER_FORMATTER_HPP
