 ...
 *
 */
#ifndef DOGEN_GENERATION_CPP_TYPES_FORMATTERS_SERIALIZATION_CLASS_FORWARD_DECLARATIONS_FORMATTER_HPP
#define DOGEN_GENERATION_CPP_TYPES_FORMATTERS_SERIALIZATION_CLASS_FORWARD_DECLARATIONS_FORMATTER_HPP
...
class class_forward_declarations_formatter final : public artefact_formatter_interface {
public:
