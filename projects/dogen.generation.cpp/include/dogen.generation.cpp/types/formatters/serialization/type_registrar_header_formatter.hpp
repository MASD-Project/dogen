 ...
 *
 */
#ifndef DOGEN_GENERATION_CPP_TYPES_FORMATTERS_SERIALIZATION_TYPE_REGISTRAR_HEADER_FORMATTER_HPP
#define DOGEN_GENERATION_CPP_TYPES_FORMATTERS_SERIALIZATION_TYPE_REGISTRAR_HEADER_FORMATTER_HPP
...
class type_registrar_header_formatter final : public artefact_formatter_interface {
public:
