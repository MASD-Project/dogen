 ...
 *
 */
#ifndef DOGEN_GENERATION_CPP_TYPES_FORMATTERS_LEXICAL_CAST_ENUM_HEADER_FORMATTER_HPP
#define DOGEN_GENERATION_CPP_TYPES_FORMATTERS_LEXICAL_CAST_ENUM_HEADER_FORMATTER_HPP
