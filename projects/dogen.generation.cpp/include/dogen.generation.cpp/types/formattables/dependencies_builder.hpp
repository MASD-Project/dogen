...
private:
    ...
    get_directive_group(const coding::meta_model::name& n,
...
public:
     ...
     */
    bool is_enabled(const coding::meta_model::name& n,
        const std::string& archetype) const;
...
public:
     ...
     */
    /**@{*/
    void add(const coding::meta_model::name& n, const std::string& archetype);
    void add(const boost::optional<coding::meta_model::name>& n,
     ...
     */
    void add(const std::list<coding::meta_model::name>& names,
        const std::string& archetype);
