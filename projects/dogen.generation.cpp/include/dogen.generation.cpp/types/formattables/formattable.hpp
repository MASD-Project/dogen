...
public:
    const boost::shared_ptr<dogen::coding::meta_model::element>& master_segment() const;
    boost::shared_ptr<dogen::coding::meta_model::element>& master_segment();
    void master_segment(const boost::shared_ptr<dogen::coding::meta_model::element>& v);
    void master_segment(const boost::shared_ptr<dogen::coding::meta_model::element>&& v);

    const std::list<boost::shared_ptr<dogen::coding::meta_model::element> >& all_segments() const;
    std::list<boost::shared_ptr<dogen::coding::meta_model::element> >& all_segments();
    void all_segments(const std::list<boost::shared_ptr<dogen::coding::meta_model::element> >& v);
    void all_segments(const std::list<boost::shared_ptr<dogen::coding::meta_model::element> >&& v);
...
private:
    boost::shared_ptr<dogen::coding::meta_model::element> master_segment_;
    std::list<boost::shared_ptr<dogen::coding::meta_model::element> > all_segments_;
