 ...
 *
 */
#ifndef DOGEN_GENERATION_CPP_TYPES_FABRIC_VISUAL_STUDIO_CONFIGURATION_HPP
#define DOGEN_GENERATION_CPP_TYPES_FABRIC_VISUAL_STUDIO_CONFIGURATION_HPP
...
#include <string>
#include <algorithm>
#include "dogen.generation.cpp/serialization/fabric/visual_studio_configuration_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::generation::cpp::fabric::visual_studio_configuration& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::generation::cpp::fabric::visual_studio_configuration& v, unsigned int version);
...
template<>
inline void swap(
    dogen::generation::cpp::fabric::visual_studio_configuration& lhs,
    dogen::generation::cpp::fabric::visual_studio_configuration& rhs) {
    lhs.swap(rhs);
}
