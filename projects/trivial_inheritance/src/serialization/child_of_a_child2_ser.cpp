...
template void save(archive::polymorphic_oarchive& ar, const dogen::trivial_inheritance::child_of_a_child2& v, unsigned int version);
template void load(archive::polymorphic_iarchive& ar, dogen::trivial_inheritance::child_of_a_child2& v, unsigned int version);
...
#ifdef __linux__
template void save(eos::portable_oarchive& ar, const dogen::trivial_inheritance::child_of_a_child2& v, unsigned int version);
template void load(eos::portable_iarchive& ar, dogen::trivial_inheritance::child_of_a_child2& v, unsigned int version);
#endif
