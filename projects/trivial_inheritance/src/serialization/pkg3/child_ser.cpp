...
void save(Archive& ar,
    const dogen::trivial_inheritance::pkg3::child& v,
    const unsigned int /*version*/) {
    ar << make_nvp("parent", base_object<dogen::trivial_inheritance::pkg2::parent>(v));
...
void load(Archive& ar,
    dogen::trivial_inheritance::pkg3::child& v,
    const unsigned int /*version*/) {
    ar >> make_nvp("parent", base_object<dogen::trivial_inheritance::pkg2::parent>(v));
...
BOOST_CLASS_EXPORT_IMPLEMENT(dogen::trivial_inheritance::pkg3::child)
...
template void save(archive::binary_oarchive& ar, const dogen::trivial_inheritance::pkg3::child& v, unsigned int version);
template void load(archive::binary_iarchive& ar, dogen::trivial_inheritance::pkg3::child& v, unsigned int version);
