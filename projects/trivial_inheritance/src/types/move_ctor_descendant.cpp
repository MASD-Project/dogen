...
move_ctor_descendant::move_ctor_descendant(move_ctor_descendant&& rhs)
    : dogen::trivial_inheritance::move_ctor_base(
        std::forward<dogen::trivial_inheritance::move_ctor_base>(rhs)),
...
move_ctor_descendant::move_ctor_descendant(
    ...
    : dogen::trivial_inheritance::move_ctor_base(prop_0),
      prop_1_(prop_1) { }

void move_ctor_descendant::to_stream(std::ostream& s) const {
    s << " { "
      << "\"__type__\": " << "\"dogen::trivial_inheritance::move_ctor_descendant\"" << ", "
      << "\"__parent_0__\": ";
...
bool move_ctor_descendant::equals(const dogen::trivial_inheritance::move_ctor_base& other) const {
