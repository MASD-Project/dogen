...
void move_ctor_empty_descendant::to_stream(std::ostream& s) const {
    s << " { "
      << "\"__type__\": " << "\"dogen::trivial_inheritance::move_ctor_empty_descendant\"" << ", "
      << "\"__parent_0__\": ";
...
bool move_ctor_empty_descendant::equals(const dogen::trivial_inheritance::move_ctor_base& other) const {
