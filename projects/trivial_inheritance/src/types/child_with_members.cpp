...
void child_with_members::to_stream(std::ostream& s) const {
    s << " { "
      << "\"__type__\": " << "\"dogen::trivial_inheritance::child_with_members\"" << ", "
      << "\"__parent_0__\": ";
...
bool child_with_members::equals(const dogen::trivial_inheritance::parent_without_members& other) const {
