 ...
 *
 */
#ifndef DOGEN_TRIVIAL_INHERITANCE_SERIALIZATION_PARENT_WITHOUT_MEMBERS_SER_HPP
#define DOGEN_TRIVIAL_INHERITANCE_SERIALIZATION_PARENT_WITHOUT_MEMBERS_SER_HPP
