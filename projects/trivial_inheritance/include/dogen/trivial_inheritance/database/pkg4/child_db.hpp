 ...
 *
 */
#ifndef DOGEN_TRIVIAL_INHERITANCE_DATABASE_PKG4_CHILD_DB_HPP
#define DOGEN_TRIVIAL_INHERITANCE_DATABASE_PKG4_CHILD_DB_HPP
...
private:
    ...
    std::vector<dogen::trivial_inheritance::pkg4::child> load_internal(
...
public:
    std::vector<dogen::trivial_inheritance::pkg4::child> load(
        pqxx::connection& connection,
        const boost::optional<versioned_key> id =boost::optional<versioned_key>());

    void save(
        pqxx::connection& connection,
        std::vector<dogen::trivial_inheritance::pkg4::child> values);
