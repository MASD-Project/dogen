 ...
 *
 */
#ifndef DOGEN_TRIVIAL_INHERITANCE_DOMAIN_VERSIONED_KEY_HPP
#define DOGEN_TRIVIAL_INHERITANCE_DOMAIN_VERSIONED_KEY_HPP
...
template<>
inline void swap(
    dogen::trivial_inheritance::versioned_key& lhs,
    dogen::trivial_inheritance::versioned_key& rhs) {
    lhs.swap(rhs);
}
