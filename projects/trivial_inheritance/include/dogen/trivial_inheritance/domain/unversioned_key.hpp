 ...
 *
 */
#ifndef DOGEN_TRIVIAL_INHERITANCE_DOMAIN_UNVERSIONED_KEY_HPP
#define DOGEN_TRIVIAL_INHERITANCE_DOMAIN_UNVERSIONED_KEY_HPP
...
template<>
inline void swap(
    dogen::trivial_inheritance::unversioned_key& lhs,
    dogen::trivial_inheritance::unversioned_key& rhs) {
    lhs.swap(rhs);
}
