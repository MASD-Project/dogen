 ...
 *
 */
#ifndef DOGEN_TRIVIAL_INHERITANCE_TYPES_PKG3_CHILD_HPP
#define DOGEN_TRIVIAL_INHERITANCE_TYPES_PKG3_CHILD_HPP
...
public:
    bool equals(const dogen::trivial_inheritance::pkg2::parent& other) const override;
