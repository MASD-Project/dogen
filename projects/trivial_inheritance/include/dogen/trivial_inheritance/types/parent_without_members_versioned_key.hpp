 ...
 *
 */
#ifndef DOGEN_TRIVIAL_INHERITANCE_TYPES_PARENT_WITHOUT_MEMBERS_VERSIONED_KEY_HPP
#define DOGEN_TRIVIAL_INHERITANCE_TYPES_PARENT_WITHOUT_MEMBERS_VERSIONED_KEY_HPP
