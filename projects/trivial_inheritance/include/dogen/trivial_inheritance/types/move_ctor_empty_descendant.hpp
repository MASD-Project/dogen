 ...
 *
 */
#ifndef DOGEN_TRIVIAL_INHERITANCE_TYPES_MOVE_CTOR_EMPTY_DESCENDANT_HPP
#define DOGEN_TRIVIAL_INHERITANCE_TYPES_MOVE_CTOR_EMPTY_DESCENDANT_HPP
...
#include <algorithm>
#include <iosfwd>
#include "dogen/trivial_inheritance/serialization/move_ctor_empty_descendant_fwd_ser.hpp"
 ...
 */
class move_ctor_empty_descendant final : public dogen::trivial_inheritance::move_ctor_base {
public:
...
template<>
inline void swap(
    dogen::trivial_inheritance::move_ctor_empty_descendant& lhs,
    dogen::trivial_inheritance::move_ctor_empty_descendant& rhs) {
    lhs.swap(rhs);
}
