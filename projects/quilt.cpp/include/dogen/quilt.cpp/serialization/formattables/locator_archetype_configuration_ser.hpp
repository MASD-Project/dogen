 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_SERIALIZATION_FORMATTABLES_LOCATOR_ARCHETYPE_CONFIGURATION_SER_HPP
#define DOGEN_QUILT_CPP_SERIALIZATION_FORMATTABLES_LOCATOR_ARCHETYPE_CONFIGURATION_SER_HPP
...
BOOST_SERIALIZATION_SPLIT_FREE(dogen::quilt::cpp::formattables::locator_archetype_configuration)
namespace boost {
