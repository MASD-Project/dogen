 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_SERIALIZATION_SETTINGS_ASPECT_SETTINGS_REPOSITORY_SER_HPP
#define DOGEN_QUILT_CPP_SERIALIZATION_SETTINGS_ASPECT_SETTINGS_REPOSITORY_SER_HPP
...
BOOST_SERIALIZATION_SPLIT_FREE(dogen::quilt::cpp::settings::aspect_settings_repository)
namespace boost {
