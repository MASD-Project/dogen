 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_TYPES_FORMATTERS_TYPES_EXCEPTION_HEADER_FORMATTER_HPP
#define DOGEN_QUILT_CPP_TYPES_FORMATTERS_TYPES_EXCEPTION_HEADER_FORMATTER_HPP
...
public:
    ...
    exception_header_formatter(exception_header_formatter&&) = default;
    ~exception_header_formatter() noexcept = default;
