 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_TYPES_FORMATTERS_TEST_DATA_PAIR_HELPER_STITCH_HPP
#define DOGEN_QUILT_CPP_TYPES_FORMATTERS_TEST_DATA_PAIR_HELPER_STITCH_HPP
...
class pair_helper : public helper_formatter_interface {
public:
