 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_TYPES_FORMATTERS_TEST_DATA_CLASS_IMPLEMENTATION_FORMATTER_HPP
#define DOGEN_QUILT_CPP_TYPES_FORMATTERS_TEST_DATA_CLASS_IMPLEMENTATION_FORMATTER_HPP
...
/**
 * @brief Creates the C++ test data representation for a class.
 */
