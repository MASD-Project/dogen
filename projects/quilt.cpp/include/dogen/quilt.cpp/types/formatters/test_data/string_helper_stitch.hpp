 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_TYPES_FORMATTERS_TEST_DATA_STRING_HELPER_STITCH_HPP
#define DOGEN_QUILT_CPP_TYPES_FORMATTERS_TEST_DATA_STRING_HELPER_STITCH_HPP
...
class string_helper : public helper_formatter_interface {
public:
