 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_TYPES_FORMATTERS_CMAKELISTS_FORMATTER_INTERFACE_HPP
#define DOGEN_QUILT_CPP_TYPES_FORMATTERS_CMAKELISTS_FORMATTER_INTERFACE_HPP
...
class cmakelists_formatter_interface : public file_formatter_interface {
public:
...
public:
    ...
    format(const context& ctx, const fabric::cmakelists& c) const = 0;
};
