 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_TYPES_FORMATTERS_IO_VARIANT_HELPER_STITCH_HPP
#define DOGEN_QUILT_CPP_TYPES_FORMATTERS_IO_VARIANT_HELPER_STITCH_HPP
...
class variant_helper_stitch : public formatter_helper_interface {
public:
