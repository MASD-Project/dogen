 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_TYPES_FORMATTERS_HASH_ENUM_IMPLEMENTATION_FORMATTER_HPP
#define DOGEN_QUILT_CPP_TYPES_FORMATTERS_HASH_ENUM_IMPLEMENTATION_FORMATTER_HPP
