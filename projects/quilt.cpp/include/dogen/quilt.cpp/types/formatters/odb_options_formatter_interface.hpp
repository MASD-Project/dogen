 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_TYPES_FORMATTERS_ODB_OPTIONS_FORMATTER_INTERFACE_HPP
#define DOGEN_QUILT_CPP_TYPES_FORMATTERS_ODB_OPTIONS_FORMATTER_INTERFACE_HPP
...
class odb_options_formatter_interface : public file_formatter_interface {
public:
...
public:
    ...
    virtual dogen::formatters::file format(const context& ctx,
        const properties::odb_options_info& c) const = 0;
};
