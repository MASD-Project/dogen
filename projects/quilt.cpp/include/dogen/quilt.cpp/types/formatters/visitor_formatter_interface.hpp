 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_TYPES_FORMATTERS_VISITOR_FORMATTER_INTERFACE_HPP
#define DOGEN_QUILT_CPP_TYPES_FORMATTERS_VISITOR_FORMATTER_INTERFACE_HPP
...
class visitor_formatter_interface : public file_formatter_interface {
public:
...
public:
    ...
    format(const context& ctx, const yarn::visitor& v) const = 0;
};
