 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_TYPES_FORMATTERS_SOURCE_CMAKELISTS_FORMATTER_HPP
#define DOGEN_QUILT_CPP_TYPES_FORMATTERS_SOURCE_CMAKELISTS_FORMATTER_HPP
...
public:
    ...
    dogen::formatters::file format(const context& ctx,
        const formattables::cmakelists_info& c) const override;
};
