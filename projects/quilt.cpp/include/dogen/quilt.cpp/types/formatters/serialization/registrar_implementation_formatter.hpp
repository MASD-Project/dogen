 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_TYPES_FORMATTERS_SERIALIZATION_REGISTRAR_IMPLEMENTATION_FORMATTER_HPP
#define DOGEN_QUILT_CPP_TYPES_FORMATTERS_SERIALIZATION_REGISTRAR_IMPLEMENTATION_FORMATTER_HPP
...
class registrar_implementation_formatter final : public file_formatter_interface {
public:
    /**
