 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_TYPES_FORMATTERS_SERIALIZATION_ENUM_HEADER_FORMATTER_HPP
#define DOGEN_QUILT_CPP_TYPES_FORMATTERS_SERIALIZATION_ENUM_HEADER_FORMATTER_HPP
