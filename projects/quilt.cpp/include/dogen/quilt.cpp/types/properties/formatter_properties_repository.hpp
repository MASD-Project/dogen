 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_TYPES_PROPERTIES_FORMATTER_PROPERTIES_REPOSITORY_HPP
#define DOGEN_QUILT_CPP_TYPES_PROPERTIES_FORMATTER_PROPERTIES_REPOSITORY_HPP
...
#include "dogen/quilt.cpp/serialization/properties/formatter_properties_repository_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::quilt::cpp::properties::formatter_properties_repository& lhs,
    dogen::quilt::cpp::properties::formatter_properties_repository& rhs) {
    lhs.swap(rhs);
}
