 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_TYPES_PROPERTIES_PATH_DERIVATIVES_HPP
#define DOGEN_QUILT_CPP_TYPES_PROPERTIES_PATH_DERIVATIVES_HPP
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::quilt::cpp::properties::path_derivatives& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::quilt::cpp::properties::path_derivatives& v, unsigned int version);
...
template<>
inline void swap(
    dogen::quilt::cpp::properties::path_derivatives& lhs,
    dogen::quilt::cpp::properties::path_derivatives& rhs) {
    lhs.swap(rhs);
}
