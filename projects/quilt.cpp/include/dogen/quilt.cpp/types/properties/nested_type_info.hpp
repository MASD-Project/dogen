 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_TYPES_PROPERTIES_NESTED_TYPE_INFO_HPP
#define DOGEN_QUILT_CPP_TYPES_PROPERTIES_NESTED_TYPE_INFO_HPP
...
#include "dogen/quilt.cpp/serialization/properties/nested_type_info_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::quilt::cpp::properties::nested_type_info& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::quilt::cpp::properties::nested_type_info& v, unsigned int version);
...
public:
     ...
     */
    /**@{*/
    const std::list<dogen::quilt::cpp::properties::nested_type_info>& children() const;
    std::list<dogen::quilt::cpp::properties::nested_type_info>& children();
    void children(const std::list<dogen::quilt::cpp::properties::nested_type_info>& v);
    void children(const std::list<dogen::quilt::cpp::properties::nested_type_info>&& v);
    /**@}*/
...
private:
    ...
    std::list<dogen::quilt::cpp::properties::nested_type_info> children_;
...
template<>
inline void swap(
    dogen::quilt::cpp::properties::nested_type_info& lhs,
    dogen::quilt::cpp::properties::nested_type_info& rhs) {
    lhs.swap(rhs);
}
