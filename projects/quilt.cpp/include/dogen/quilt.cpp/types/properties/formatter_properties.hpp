 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_TYPES_PROPERTIES_FORMATTER_PROPERTIES_HPP
#define DOGEN_QUILT_CPP_TYPES_PROPERTIES_FORMATTER_PROPERTIES_HPP
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::quilt::cpp::properties::formatter_properties& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::quilt::cpp::properties::formatter_properties& v, unsigned int version);
...
template<>
inline void swap(
    dogen::quilt::cpp::properties::formatter_properties& lhs,
    dogen::quilt::cpp::properties::formatter_properties& rhs) {
    lhs.swap(rhs);
}
