 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_TYPES_PROPERTIES_GLOBAL_ENABLEMENT_PROPERTIES_HPP
#define DOGEN_QUILT_CPP_TYPES_PROPERTIES_GLOBAL_ENABLEMENT_PROPERTIES_HPP
...
#include <algorithm>
#include "dogen/quilt.cpp/serialization/properties/global_enablement_properties_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::quilt::cpp::properties::global_enablement_properties& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::quilt::cpp::properties::global_enablement_properties& v, unsigned int version);
...
template<>
inline void swap(
    dogen::quilt::cpp::properties::global_enablement_properties& lhs,
    dogen::quilt::cpp::properties::global_enablement_properties& rhs) {
    lhs.swap(rhs);
}
