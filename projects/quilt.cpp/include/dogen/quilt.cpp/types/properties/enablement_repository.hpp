 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_TYPES_PROPERTIES_ENABLEMENT_REPOSITORY_HPP
#define DOGEN_QUILT_CPP_TYPES_PROPERTIES_ENABLEMENT_REPOSITORY_HPP
...
#include "dogen/quilt.cpp/serialization/properties/enablement_repository_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::quilt::cpp::properties::enablement_repository& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::quilt::cpp::properties::enablement_repository& v, unsigned int version);
...
template<>
inline void swap(
    dogen::quilt::cpp::properties::enablement_repository& lhs,
    dogen::quilt::cpp::properties::enablement_repository& rhs) {
    lhs.swap(rhs);
}
