 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_TYPES_PROPERTIES_PATH_DERIVATIVES_REPOSITORY_HPP
#define DOGEN_QUILT_CPP_TYPES_PROPERTIES_PATH_DERIVATIVES_REPOSITORY_HPP
...
#include "dogen/quilt.cpp/serialization/properties/path_derivatives_repository_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::quilt::cpp::properties::path_derivatives_repository& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::quilt::cpp::properties::path_derivatives_repository& v, unsigned int version);
...
template<>
inline void swap(
    dogen::quilt::cpp::properties::path_derivatives_repository& lhs,
    dogen::quilt::cpp::properties::path_derivatives_repository& rhs) {
    lhs.swap(rhs);
}
