 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_TYPES_PROPERTIES_INCLUSION_DIRECTIVES_FACTORY_HPP
#define DOGEN_QUILT_CPP_TYPES_PROPERTIES_INCLUSION_DIRECTIVES_FACTORY_HPP
...
private:
    ...
    path_derivatives_for_name(const yarn::name& n) const;

    /**
     * @brief Get the path derivatives for supplied formatter name.
     */
    path_derivatives path_derivatives_for_formatter_name(
...
public:
    /**
     * @brief Create the inclusion directives for a given Yarn entity.
     */
