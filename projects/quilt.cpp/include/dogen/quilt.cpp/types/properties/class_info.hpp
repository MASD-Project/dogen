 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_TYPES_PROPERTIES_CLASS_INFO_HPP
#define DOGEN_QUILT_CPP_TYPES_PROPERTIES_CLASS_INFO_HPP
...
#include "dogen/quilt.cpp/serialization/properties/class_info_fwd_ser.hpp"
 ...
 */
class class_info final : public dogen::quilt::cpp::properties::entity {
public:
...
public:
     ...
     */
    /**@{*/
    const std::list<dogen::quilt::cpp::properties::property_info>& properties() const;
    std::list<dogen::quilt::cpp::properties::property_info>& properties();
    void properties(const std::list<dogen::quilt::cpp::properties::property_info>& v);
    void properties(const std::list<dogen::quilt::cpp::properties::property_info>&& v);
    /**@}*/
     ...
     */
    /**@{*/
    const std::list<dogen::quilt::cpp::properties::property_info>& all_properties() const;
    std::list<dogen::quilt::cpp::properties::property_info>& all_properties();
    void all_properties(const std::list<dogen::quilt::cpp::properties::property_info>& v);
    void all_properties(const std::list<dogen::quilt::cpp::properties::property_info>&& v);
    /**@}*/
     ...
     */
    /**@{*/
    const std::list<dogen::quilt::cpp::properties::parent_info>& parents() const;
    std::list<dogen::quilt::cpp::properties::parent_info>& parents();
    void parents(const std::list<dogen::quilt::cpp::properties::parent_info>& v);
    void parents(const std::list<dogen::quilt::cpp::properties::parent_info>&& v);
    /**@}*/
...
private:
    std::list<dogen::quilt::cpp::properties::property_info> properties_;
    std::list<dogen::quilt::cpp::properties::property_info> all_properties_;
    bool requires_stream_manipulators_;
    bool requires_manual_move_constructor_;
    bool requires_manual_default_constructor_;
    std::list<dogen::quilt::cpp::properties::parent_info> parents_;
    bool is_parent_;
...
template<>
inline void swap(
    dogen::quilt::cpp::properties::class_info& lhs,
    dogen::quilt::cpp::properties::class_info& rhs) {
    lhs.swap(rhs);
}
