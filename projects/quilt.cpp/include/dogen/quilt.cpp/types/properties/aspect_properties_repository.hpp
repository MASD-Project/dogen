 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_TYPES_PROPERTIES_ASPECT_PROPERTIES_REPOSITORY_HPP
#define DOGEN_QUILT_CPP_TYPES_PROPERTIES_ASPECT_PROPERTIES_REPOSITORY_HPP
...
#include "dogen/quilt.cpp/serialization/properties/aspect_properties_repository_fwd_ser.hpp"
...
class aspect_properties_repository final {
public:
    aspect_properties_repository() = default;
    aspect_properties_repository(const aspect_properties_repository&) = default;
    aspect_properties_repository(aspect_properties_repository&&) = default;
    ~aspect_properties_repository() = default;
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::quilt::cpp::properties::aspect_properties_repository& v, unsigned int version);
...
public:
    void swap(aspect_properties_repository& other) noexcept;
...
template<>
inline void swap(
    dogen::quilt::cpp::properties::aspect_properties_repository& lhs,
    dogen::quilt::cpp::properties::aspect_properties_repository& rhs) {
    lhs.swap(rhs);
}
