 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_TYPES_SETTINGS_INCLUSION_DIRECTIVE_SETTINGS_HPP
#define DOGEN_QUILT_CPP_TYPES_SETTINGS_INCLUSION_DIRECTIVE_SETTINGS_HPP
...
#include "dogen/quilt.cpp/serialization/settings/inclusion_directive_settings_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::quilt::cpp::settings::inclusion_directive_settings& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::quilt::cpp::settings::inclusion_directive_settings& v, unsigned int version);
...
template<>
inline void swap(
    dogen::quilt::cpp::settings::inclusion_directive_settings& lhs,
    dogen::quilt::cpp::settings::inclusion_directive_settings& rhs) {
    lhs.swap(rhs);
}
