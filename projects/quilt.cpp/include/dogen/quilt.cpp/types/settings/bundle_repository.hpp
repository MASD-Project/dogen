 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_TYPES_SETTINGS_BUNDLE_REPOSITORY_HPP
#define DOGEN_QUILT_CPP_TYPES_SETTINGS_BUNDLE_REPOSITORY_HPP
...
#include "dogen/quilt.cpp/serialization/settings/bundle_repository_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::quilt::cpp::settings::bundle_repository& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::quilt::cpp::settings::bundle_repository& v, unsigned int version);
...
template<>
inline void swap(
    dogen::quilt::cpp::settings::bundle_repository& lhs,
    dogen::quilt::cpp::settings::bundle_repository& rhs) {
    lhs.swap(rhs);
}
