 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_TYPES_SETTINGS_DIRECTORY_NAMES_SETTINGS_HPP
#define DOGEN_QUILT_CPP_TYPES_SETTINGS_DIRECTORY_NAMES_SETTINGS_HPP
...
#include <string>
#include <algorithm>
#include "dogen/quilt.cpp/serialization/settings/directory_names_settings_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::quilt::cpp::settings::directory_names_settings& lhs,
    dogen::quilt::cpp::settings::directory_names_settings& rhs) {
    lhs.swap(rhs);
}
