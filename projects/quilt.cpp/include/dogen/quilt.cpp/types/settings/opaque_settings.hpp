 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_TYPES_SETTINGS_OPAQUE_SETTINGS_HPP
#define DOGEN_QUILT_CPP_TYPES_SETTINGS_OPAQUE_SETTINGS_HPP
...
#include <iosfwd>
#include <algorithm>
#include "dogen/quilt.cpp/serialization/settings/opaque_settings_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::quilt::cpp::settings::opaque_settings& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::quilt::cpp::settings::opaque_settings& v, unsigned int version);
