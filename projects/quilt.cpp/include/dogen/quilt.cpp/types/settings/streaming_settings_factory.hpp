 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_TYPES_SETTINGS_STREAMING_SETTINGS_FACTORY_HPP
#define DOGEN_QUILT_CPP_TYPES_SETTINGS_STREAMING_SETTINGS_FACTORY_HPP
...
class streaming_settings_factory {
public:
    explicit streaming_settings_factory(const dynamic::repository& rp);
...
public:
    boost::optional<streaming_settings> make(const dynamic::object& o) const;
