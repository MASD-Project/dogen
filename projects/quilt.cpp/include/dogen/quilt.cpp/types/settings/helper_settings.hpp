...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const helper_settings& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, helper_settings& v, unsigned int version);
