 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_TYPES_ANNOTATIONS_REGISTRAR_ERROR_HPP
#define DOGEN_QUILT_CPP_TYPES_ANNOTATIONS_REGISTRAR_ERROR_HPP
...
/**
 * @brief An error occurred during registration.
 */
