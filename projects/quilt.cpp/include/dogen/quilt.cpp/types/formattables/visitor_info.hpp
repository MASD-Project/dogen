 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_TYPES_FORMATTABLES_VISITOR_INFO_HPP
#define DOGEN_QUILT_CPP_TYPES_FORMATTABLES_VISITOR_INFO_HPP
...
#include "dogen/quilt.cpp/types/formattables/visited_type_info.hpp"
#include "dogen/quilt.cpp/serialization/formattables/visitor_info_fwd_ser.hpp"
 ...
 */
class visitor_info final : public dogen::quilt::cpp::formattables::entity {
public:
...
public:
    visitor_info(
        ...
        const std::list<dogen::quilt::cpp::formattables::visited_type_info>& types);
...
public:
     ...
     */
    /**@{*/
    const std::list<dogen::quilt::cpp::formattables::visited_type_info>& types() const;
    std::list<dogen::quilt::cpp::formattables::visited_type_info>& types();
    void types(const std::list<dogen::quilt::cpp::formattables::visited_type_info>& v);
    void types(const std::list<dogen::quilt::cpp::formattables::visited_type_info>&& v);
    /**@}*/
...
private:
    std::list<dogen::quilt::cpp::formattables::visited_type_info> types_;
};
...
template<>
inline void swap(
    dogen::quilt::cpp::formattables::visitor_info& lhs,
    dogen::quilt::cpp::formattables::visitor_info& rhs) {
    lhs.swap(rhs);
}
