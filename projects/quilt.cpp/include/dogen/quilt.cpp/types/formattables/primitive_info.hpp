 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_TYPES_FORMATTABLES_PRIMITIVE_INFO_HPP
#define DOGEN_QUILT_CPP_TYPES_FORMATTABLES_PRIMITIVE_INFO_HPP
...
#include "dogen/quilt.cpp/serialization/formattables/primitive_info_fwd_ser.hpp"
...
class primitive_info final : public dogen::quilt::cpp::formattables::entity {
public:
...
template<>
inline void swap(
    dogen::quilt::cpp::formattables::primitive_info& lhs,
    dogen::quilt::cpp::formattables::primitive_info& rhs) {
    lhs.swap(rhs);
}
