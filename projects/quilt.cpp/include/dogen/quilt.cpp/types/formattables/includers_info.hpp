 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_TYPES_FORMATTABLES_INCLUDERS_INFO_HPP
#define DOGEN_QUILT_CPP_TYPES_FORMATTABLES_INCLUDERS_INFO_HPP
...
#include "dogen/quilt.cpp/serialization/formattables/includers_info_fwd_ser.hpp"
...
class includers_info final : public dogen::quilt::cpp::formattables::entity {
public:
...
template<>
inline void swap(
    dogen::quilt::cpp::formattables::includers_info& lhs,
    dogen::quilt::cpp::formattables::includers_info& rhs) {
    lhs.swap(rhs);
}
