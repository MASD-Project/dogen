 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_TYPES_FORMATTABLES_CONCEPT_INFO_HPP
#define DOGEN_QUILT_CPP_TYPES_FORMATTABLES_CONCEPT_INFO_HPP
...
#include "dogen/quilt.cpp/serialization/formattables/concept_info_fwd_ser.hpp"
...
class concept_info final : public dogen::quilt::cpp::formattables::entity {
public:
...
template<>
inline void swap(
    dogen::quilt::cpp::formattables::concept_info& lhs,
    dogen::quilt::cpp::formattables::concept_info& rhs) {
    lhs.swap(rhs);
}
