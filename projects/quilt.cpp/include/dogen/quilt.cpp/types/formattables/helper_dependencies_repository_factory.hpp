 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_TYPES_FORMATTABLES_HELPER_DEPENDENCIES_REPOSITORY_FACTORY_HPP
#define DOGEN_QUILT_CPP_TYPES_FORMATTABLES_HELPER_DEPENDENCIES_REPOSITORY_FACTORY_HPP
...
public:
    helper_dependencies_repository
