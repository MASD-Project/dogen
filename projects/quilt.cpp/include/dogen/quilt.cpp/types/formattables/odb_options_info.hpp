 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_TYPES_FORMATTABLES_ODB_OPTIONS_INFO_HPP
#define DOGEN_QUILT_CPP_TYPES_FORMATTABLES_ODB_OPTIONS_INFO_HPP
...
#include "dogen/quilt.cpp/serialization/formattables/odb_options_info_fwd_ser.hpp"
 ...
 */
class odb_options_info final : public dogen::quilt::cpp::formattables::formattable {
public:
...
template<>
inline void swap(
    dogen::quilt::cpp::formattables::odb_options_info& lhs,
    dogen::quilt::cpp::formattables::odb_options_info& rhs) {
    lhs.swap(rhs);
}
