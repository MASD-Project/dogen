 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_TYPES_FORMATTABLES_ENUMERATOR_INFO_HPP
#define DOGEN_QUILT_CPP_TYPES_FORMATTABLES_ENUMERATOR_INFO_HPP
...
#include <string>
#include <algorithm>
#include "dogen/quilt.cpp/serialization/formattables/enumerator_info_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::quilt::cpp::formattables::enumerator_info& lhs,
    dogen::quilt::cpp::formattables::enumerator_info& rhs) {
    lhs.swap(rhs);
}
