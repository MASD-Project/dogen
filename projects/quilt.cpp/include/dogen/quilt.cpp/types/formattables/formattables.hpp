 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_TYPES_FORMATTABLES_FORMATTABLES_HPP
#define DOGEN_QUILT_CPP_TYPES_FORMATTABLES_FORMATTABLES_HPP
 ...
 * with every pair (name, formatter name). The inclusion directive
