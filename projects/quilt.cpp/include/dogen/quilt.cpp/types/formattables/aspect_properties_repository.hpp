 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_TYPES_FORMATTABLES_ASPECT_PROPERTIES_REPOSITORY_HPP
#define DOGEN_QUILT_CPP_TYPES_FORMATTABLES_ASPECT_PROPERTIES_REPOSITORY_HPP
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::quilt::cpp::formattables::aspect_properties_repository& v, unsigned int version);
...
template<>
inline void swap(
    dogen::quilt::cpp::formattables::aspect_properties_repository& lhs,
    dogen::quilt::cpp::formattables::aspect_properties_repository& rhs) {
    lhs.swap(rhs);
}
