 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_TYPES_FORMATTABLES_VISITED_TYPE_INFO_HPP
#define DOGEN_QUILT_CPP_TYPES_FORMATTABLES_VISITED_TYPE_INFO_HPP
...
#include <string>
#include <algorithm>
#include "dogen/quilt.cpp/serialization/formattables/visited_type_info_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::quilt::cpp::formattables::visited_type_info& lhs,
    dogen::quilt::cpp::formattables::visited_type_info& rhs) {
    lhs.swap(rhs);
}
