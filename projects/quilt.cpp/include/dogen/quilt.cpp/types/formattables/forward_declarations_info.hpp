 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_TYPES_FORMATTABLES_FORWARD_DECLARATIONS_INFO_HPP
#define DOGEN_QUILT_CPP_TYPES_FORMATTABLES_FORWARD_DECLARATIONS_INFO_HPP
...
#include "dogen/quilt.cpp/serialization/formattables/forward_declarations_info_fwd_ser.hpp"
...
class forward_declarations_info final : public dogen::quilt::cpp::formattables::entity {
public:
...
template<>
inline void swap(
    dogen::quilt::cpp::formattables::forward_declarations_info& lhs,
    dogen::quilt::cpp::formattables::forward_declarations_info& rhs) {
    lhs.swap(rhs);
}
