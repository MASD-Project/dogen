 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_TYPES_FORMATTABLES_NAMESPACE_INFO_HPP
#define DOGEN_QUILT_CPP_TYPES_FORMATTABLES_NAMESPACE_INFO_HPP
...
#include "dogen/quilt.cpp/serialization/formattables/namespace_info_fwd_ser.hpp"
 ...
 */
class namespace_info final : public dogen::quilt::cpp::formattables::entity {
public:
...
template<>
inline void swap(
    dogen::quilt::cpp::formattables::namespace_info& lhs,
    dogen::quilt::cpp::formattables::namespace_info& rhs) {
    lhs.swap(rhs);
}
