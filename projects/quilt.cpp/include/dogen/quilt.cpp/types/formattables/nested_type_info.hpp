 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_TYPES_FORMATTABLES_NESTED_TYPE_INFO_HPP
#define DOGEN_QUILT_CPP_TYPES_FORMATTABLES_NESTED_TYPE_INFO_HPP
...
#include "dogen/quilt.cpp/serialization/formattables/nested_type_info_fwd_ser.hpp"
...
public:
    nested_type_info(
        ...
        const std::list<dogen::quilt::cpp::formattables::nested_type_info>& children,
...
public:
     ...
     */
    /**@{*/
    const std::list<dogen::quilt::cpp::formattables::nested_type_info>& children() const;
    std::list<dogen::quilt::cpp::formattables::nested_type_info>& children();
    void children(const std::list<dogen::quilt::cpp::formattables::nested_type_info>& v);
    void children(const std::list<dogen::quilt::cpp::formattables::nested_type_info>&& v);
    /**@}*/
...
private:
    ...
    std::list<dogen::quilt::cpp::formattables::nested_type_info> children_;
...
template<>
inline void swap(
    dogen::quilt::cpp::formattables::nested_type_info& lhs,
    dogen::quilt::cpp::formattables::nested_type_info& rhs) {
    lhs.swap(rhs);
}
