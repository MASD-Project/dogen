 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_TYPES_FORMATTABLES_CMAKELISTS_INFO_HPP
#define DOGEN_QUILT_CPP_TYPES_FORMATTABLES_CMAKELISTS_INFO_HPP
...
#include "dogen/quilt.cpp/serialization/formattables/cmakelists_info_fwd_ser.hpp"
 ...
 */
class cmakelists_info final : public dogen::quilt::cpp::formattables::formattable {
public:
...
template<>
inline void swap(
    dogen::quilt::cpp::formattables::cmakelists_info& lhs,
    dogen::quilt::cpp::formattables::cmakelists_info& rhs) {
    lhs.swap(rhs);
}
