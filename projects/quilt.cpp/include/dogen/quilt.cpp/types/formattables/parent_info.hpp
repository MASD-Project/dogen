 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_TYPES_FORMATTABLES_PARENT_INFO_HPP
#define DOGEN_QUILT_CPP_TYPES_FORMATTABLES_PARENT_INFO_HPP
...
#include "dogen/quilt.cpp/serialization/formattables/parent_info_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::quilt::cpp::formattables::parent_info& lhs,
    dogen::quilt::cpp::formattables::parent_info& rhs) {
    lhs.swap(rhs);
}
