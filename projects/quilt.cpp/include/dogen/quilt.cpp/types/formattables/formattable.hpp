...
public:
    ...
    dogen::quilt::cpp::formattables::origin_types origin_type() const;
    void origin_type(const dogen::quilt::cpp::formattables::origin_types v);
...
private:
    ...
    dogen::quilt::cpp::formattables::origin_types origin_type_;
    std::string id_;
};
