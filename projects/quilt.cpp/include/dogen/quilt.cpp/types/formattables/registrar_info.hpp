 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_TYPES_FORMATTABLES_REGISTRAR_INFO_HPP
#define DOGEN_QUILT_CPP_TYPES_FORMATTABLES_REGISTRAR_INFO_HPP
...
#include "dogen/quilt.cpp/serialization/formattables/registrar_info_fwd_ser.hpp"
 ...
 */
class registrar_info final : public dogen::quilt::cpp::formattables::entity {
public:
...
template<>
inline void swap(
    dogen::quilt::cpp::formattables::registrar_info& lhs,
    dogen::quilt::cpp::formattables::registrar_info& rhs) {
    lhs.swap(rhs);
}
