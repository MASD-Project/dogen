 ...
 *
 */
#ifndef DOGEN_QUILT_CPP_TYPES_FORMATTABLES_INTEGRATED_FACETS_REPOSITORY_HPP
#define DOGEN_QUILT_CPP_TYPES_FORMATTABLES_INTEGRATED_FACETS_REPOSITORY_HPP
...
#include "dogen/quilt.cpp/serialization/formattables/integrated_facets_repository_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::quilt::cpp::formattables::integrated_facets_repository& lhs,
    dogen::quilt::cpp::formattables::integrated_facets_repository& rhs) {
    lhs.swap(rhs);
}
