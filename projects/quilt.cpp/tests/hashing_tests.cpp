...
BOOST_AUTO_TEST_CASE(validate_hashing) {
    ...
    test_hashing<formattables::odb_properties_generator>();
    ...
    test_hashing<formattables::artefact_properties_generator>();
    ...
    test_hashing<formattables::locator_formatter_configuration_generator>();
