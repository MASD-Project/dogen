...
BOOST_CLASS_TRACKING(
    dogen::quilt::cpp::properties::cmakelists_info,
...
void save(Archive& ar,
    const dogen::quilt::cpp::properties::cmakelists_info& v,
    const unsigned int /*version*/) {
...
void load(Archive& ar,
    dogen::quilt::cpp::properties::cmakelists_info& v,
    const unsigned int /*version*/) {
    ar >> make_nvp("formattable", base_object<dogen::quilt::cpp::properties::formattable>(v));
...
template void save(archive::polymorphic_oarchive& ar, const dogen::quilt::cpp::properties::cmakelists_info& v, unsigned int version);
template void load(archive::polymorphic_iarchive& ar, dogen::quilt::cpp::properties::cmakelists_info& v, unsigned int version);

template void save(archive::text_oarchive& ar, const dogen::quilt::cpp::properties::cmakelists_info& v, unsigned int version);
template void load(archive::text_iarchive& ar, dogen::quilt::cpp::properties::cmakelists_info& v, unsigned int version);

template void save(archive::binary_oarchive& ar, const dogen::quilt::cpp::properties::cmakelists_info& v, unsigned int version);
template void load(archive::binary_iarchive& ar, dogen::quilt::cpp::properties::cmakelists_info& v, unsigned int version);

template void save(archive::xml_oarchive& ar, const dogen::quilt::cpp::properties::cmakelists_info& v, unsigned int version);
template void load(archive::xml_iarchive& ar, dogen::quilt::cpp::properties::cmakelists_info& v, unsigned int version);
