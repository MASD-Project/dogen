...
inline std::ostream& operator<<(std::ostream& s, const std::unordered_map<std::string, dogen::quilt::cpp::settings::inclusion_directive_settings>& v) {
    s << "[";
...
std::ostream& operator<<(std::ostream& s, const inclusion_directives_settings& v) {
    ...
    s << " { "
      << "\"__type__\": " << "\"dogen::quilt::cpp::settings::inclusion_directives_settings\"" << ", "
