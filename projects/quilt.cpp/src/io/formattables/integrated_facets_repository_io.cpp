...
std::ostream& operator<<(std::ostream& s, const integrated_facets_repository& v) {
    s << " { "
      << "\"__type__\": " << "\"dogen::quilt::cpp::formattables::integrated_facets_repository\"" << ", "
      << "\"integrated_facets_by_formatter_name\": " << v.integrated_facets_by_formatter_name()
      << " }";
    return(s);
}
