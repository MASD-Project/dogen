...
inline std::ostream& operator<<(std::ostream& s, const std::list<dogen::quilt::cpp::formattables::nested_type_info>& v) {
    s << "[ ";
...
std::ostream& operator<<(std::ostream& s, const nested_type_info& v) {
    ...
    s << " { "
      << "\"__type__\": " << "\"dogen::quilt::cpp::formattables::nested_type_info\"" << ", "
