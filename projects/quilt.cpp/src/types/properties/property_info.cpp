...
const dogen::quilt::cpp::properties::nested_type_info& property_info::type() const {
    return type_;
}

dogen::quilt::cpp::properties::nested_type_info& property_info::type() {
    return type_;
}

void property_info::type(const dogen::quilt::cpp::properties::nested_type_info& v) {
    type_ = v;
}
