...
void forward_declarations_info::to_stream(std::ostream& s) const {
    ...
    s << " { "
      << "\"__type__\": " << "\"dogen::quilt::cpp::properties::forward_declarations_info\"" << ", "
      << "\"__parent_0__\": ";
    entity::to_stream(s);
    s << ", "
      << "\"is_enum\": " << is_enum_ << ", "
...
bool forward_declarations_info::equals(const dogen::quilt::cpp::properties::formattable& other) const {
