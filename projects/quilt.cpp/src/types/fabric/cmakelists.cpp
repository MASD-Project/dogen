...
const dogen::quilt::cpp::fabric::odb_targets& cmakelists::odb_targets() const {
    return odb_targets_;
}

dogen::quilt::cpp::fabric::odb_targets& cmakelists::odb_targets() {
    return odb_targets_;
}

void cmakelists::odb_targets(const dogen::quilt::cpp::fabric::odb_targets& v) {
    odb_targets_ = v;
}
