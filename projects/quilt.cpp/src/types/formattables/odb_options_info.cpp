...
odb_options_info::odb_options_info(odb_options_info&& rhs)
    : dogen::quilt::cpp::formattables::formattable(
        std::forward<dogen::quilt::cpp::formattables::formattable>(rhs)),
...
void odb_options_info::to_stream(std::ostream& s) const {
    s << " { "
      << "\"__type__\": " << "\"dogen::quilt::cpp::formattables::odb_options_info\"" << ", "
      << "\"__parent_0__\": ";
...
bool odb_options_info::equals(const dogen::quilt::cpp::formattables::formattable& other) const {
