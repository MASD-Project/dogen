...
helper_properties_repository::helper_properties_repository(const std::unordered_map<std::string, std::string>& helper_properties_by_name)
...
const std::unordered_map<std::string, std::string>& helper_properties_repository::helper_properties_by_name() const {
    return helper_properties_by_name_;
}

std::unordered_map<std::string, std::string>& helper_properties_repository::helper_properties_by_name() {
    return helper_properties_by_name_;
}

void helper_properties_repository::helper_properties_by_name(const std::unordered_map<std::string, std::string>& v) {
