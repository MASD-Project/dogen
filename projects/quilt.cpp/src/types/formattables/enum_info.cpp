...
#include "dogen/quilt.cpp/io/formattables/enumerator_info_io.hpp"

namespace std {

inline std::ostream& operator<<(std::ostream& s, const std::list<dogen::quilt::cpp::formattables::enumerator_info>& v) {
    s << "[ ";
...
void enum_info::to_stream(std::ostream& s) const {
    s << " { "
      << "\"__type__\": " << "\"dogen::quilt::cpp::formattables::enum_info\"" << ", "
      << "\"__parent_0__\": ";
    entity::to_stream(s);
    s << ", "
...
bool enum_info::equals(const dogen::quilt::cpp::formattables::formattable& other) const {
...
const std::list<dogen::quilt::cpp::formattables::enumerator_info>& enum_info::enumerators() const {
    return enumerators_;
}

std::list<dogen::quilt::cpp::formattables::enumerator_info>& enum_info::enumerators() {
    return enumerators_;
}

void enum_info::enumerators(const std::list<dogen::quilt::cpp::formattables::enumerator_info>& v) {
    enumerators_ = v;
}
