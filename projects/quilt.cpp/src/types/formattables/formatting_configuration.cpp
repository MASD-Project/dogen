...
formatting_configuration::formatting_configuration()
    : style_(static_cast<dogen::quilt::cpp::formattables::formatting_styles>(0)) { }
...
dogen::quilt::cpp::formattables::formatting_styles formatting_configuration::style() const {
    return style_;
}

void formatting_configuration::style(const dogen::quilt::cpp::formattables::formatting_styles v) {
    style_ = v;
}
