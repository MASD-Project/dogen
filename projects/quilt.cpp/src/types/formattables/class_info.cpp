...
inline std::ostream& operator<<(std::ostream& s, const std::list<dogen::quilt::cpp::formattables::property_info>& v) {
    s << "[ ";
...
inline std::ostream& operator<<(std::ostream& s, const std::list<dogen::quilt::cpp::formattables::parent_info>& v) {
    s << "[ ";
    for (auto i(v.begin()); i != v.end(); ++i) {
        if (i != v.begin()) s << ", ";
        s << *i;
...
void class_info::to_stream(std::ostream& s) const {
    ...
    s << " { "
      << "\"__type__\": " << "\"dogen::quilt::cpp::formattables::class_info\"" << ", "
      << "\"__parent_0__\": ";
    entity::to_stream(s);
    s << ", "
...
bool class_info::equals(const dogen::quilt::cpp::formattables::formattable& other) const {
...
const std::list<dogen::quilt::cpp::formattables::property_info>& class_info::properties() const {
    return properties_;
}

std::list<dogen::quilt::cpp::formattables::property_info>& class_info::properties() {
    return properties_;
}

void class_info::properties(const std::list<dogen::quilt::cpp::formattables::property_info>& v) {
    properties_ = v;
}
...
const std::list<dogen::quilt::cpp::formattables::property_info>& class_info::all_properties() const {
    return all_properties_;
}

std::list<dogen::quilt::cpp::formattables::property_info>& class_info::all_properties() {
    return all_properties_;
}

void class_info::all_properties(const std::list<dogen::quilt::cpp::formattables::property_info>& v) {
    all_properties_ = v;
}
...
const std::list<dogen::quilt::cpp::formattables::parent_info>& class_info::parents() const {
    return parents_;
}

std::list<dogen::quilt::cpp::formattables::parent_info>& class_info::parents() {
    return parents_;
}

void class_info::parents(const std::list<dogen::quilt::cpp::formattables::parent_info>& v) {
    parents_ = v;
}
