...
void concept_info::to_stream(std::ostream& s) const {
    s << " { "
      << "\"__type__\": " << "\"dogen::quilt::cpp::formattables::concept_info\"" << ", "
      << "\"__parent_0__\": ";
    entity::to_stream(s);
    s << ", "
...
bool concept_info::equals(const dogen::quilt::cpp::formattables::formattable& other) const {
...
const std::list<dogen::quilt::cpp::formattables::property_info>& concept_info::properties() const {
    return properties_;
}

std::list<dogen::quilt::cpp::formattables::property_info>& concept_info::properties() {
    return properties_;
}

void concept_info::properties(const std::list<dogen::quilt::cpp::formattables::property_info>& v) {
    properties_ = v;
}
...
const std::list<dogen::quilt::cpp::formattables::property_info>& concept_info::all_properties() const {
    return all_properties_;
}

std::list<dogen::quilt::cpp::formattables::property_info>& concept_info::all_properties() {
    return all_properties_;
}

void concept_info::all_properties(const std::list<dogen::quilt::cpp::formattables::property_info>& v) {
    all_properties_ = v;
}
