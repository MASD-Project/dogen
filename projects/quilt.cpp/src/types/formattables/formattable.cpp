...
formattable::formattable()
    : origin_type_(static_cast<dogen::quilt::cpp::formattables::origin_types>(0)) { }
...
dogen::quilt::cpp::formattables::origin_types formattable::origin_type() const {
    return origin_type_;
}

void formattable::origin_type(const dogen::quilt::cpp::formattables::origin_types v) {
    origin_type_ = v;
}
