...
static logger lg(logger_factory(
        "quilt.cpp.annotations.streaming_annotations_repository_factory"));
...
streaming_annotations_repository streaming_annotations_repository_factory::
make(const dynamic::repository& rp, const yarn::model& m) const {
    BOOST_LOG_SEV(lg, debug) << "Started making streaming annotations.";

    streaming_annotations_repository r;
    streaming_annotations_factory f(rp);
    ...
    BOOST_LOG_SEV(lg, debug) << "Finished making streaming annotations" << r;
    return r;
}
