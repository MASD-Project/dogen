...
void aspect_annotations::swap(aspect_annotations& other) noexcept {
    using std::swap;
...
bool aspect_annotations::operator==(const aspect_annotations& rhs) const {
...
aspect_annotations& aspect_annotations::operator=(aspect_annotations other) {
    using std::swap;
    swap(*this, other);
    return *this;
}

bool aspect_annotations::requires_manual_default_constructor() const {
    return requires_manual_default_constructor_;
}

void aspect_annotations::requires_manual_default_constructor(const bool v) {
    requires_manual_default_constructor_ = v;
}

bool aspect_annotations::requires_manual_move_constructor() const {
    return requires_manual_move_constructor_;
}

void aspect_annotations::requires_manual_move_constructor(const bool v) {
    requires_manual_move_constructor_ = v;
}

bool aspect_annotations::requires_stream_manipulators() const {
    return requires_stream_manipulators_;
}

void aspect_annotations::requires_stream_manipulators(const bool v) {
