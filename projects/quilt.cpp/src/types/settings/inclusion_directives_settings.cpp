...
const std::unordered_map<std::string, dogen::quilt::cpp::settings::inclusion_directive_settings>& inclusion_directives_settings::inclusion_directive_settings() const {
    return inclusion_directive_settings_;
}

std::unordered_map<std::string, dogen::quilt::cpp::settings::inclusion_directive_settings>& inclusion_directives_settings::inclusion_directive_settings() {
    return inclusion_directive_settings_;
}

void inclusion_directives_settings::inclusion_directive_settings(const std::unordered_map<std::string, dogen::quilt::cpp::settings::inclusion_directive_settings>& v) {
