...
bool streaming_settings_repository::operator==(const streaming_settings_repository& rhs) const {
    return by_id_ == rhs.by_id_;
}

streaming_settings_repository& streaming_settings_repository::operator=(streaming_settings_repository other) {
    using std::swap;
    swap(*this, other);
    return *this;
}
