...
inline std::size_t hash_std_unordered_map_std_string_dogen_quilt_cpp_properties_path_derivatives(const std::unordered_map<std::string, dogen::quilt::cpp::properties::path_derivatives>& v) {
    std::size_t seed(0);
    for (const auto i : v) {
...
inline std::size_t hash_std_unordered_map_dogen_yarn_name_std_unordered_map_std_string_dogen_quilt_cpp_properties_path_derivatives(const std::unordered_map<dogen::yarn::name, std::unordered_map<std::string, dogen::quilt::cpp::properties::path_derivatives> >& v) {
    ...
    for (const auto i : v) {
        combine(seed, i.first);
        combine(seed, hash_std_unordered_map_std_string_dogen_quilt_cpp_properties_path_derivatives(i.second));
    }
    return seed;
}
