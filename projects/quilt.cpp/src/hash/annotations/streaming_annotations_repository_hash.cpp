...
std::size_t streaming_annotations_repository_hasher::hash(const streaming_annotations_repository& v) {
    std::size_t seed(0);

    combine(seed, hash_std_unordered_map_std_string_dogen_quilt_cpp_annotations_streaming_annotations(v.by_id()));
    return seed;
}
