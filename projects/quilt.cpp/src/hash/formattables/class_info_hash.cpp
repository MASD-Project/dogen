...
inline std::size_t hash_std_list_dogen_quilt_cpp_formattables_property_info(const std::list<dogen::quilt::cpp::formattables::property_info>& v) {
    std::size_t seed(0);
    for (const auto i : v) {
        combine(seed, i);
    }
...
inline std::size_t hash_std_list_dogen_quilt_cpp_formattables_parent_info(const std::list<dogen::quilt::cpp::formattables::parent_info>& v) {
    std::size_t seed(0);
    for (const auto i : v) {
        combine(seed, i);
    }
