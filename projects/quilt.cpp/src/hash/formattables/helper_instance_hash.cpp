...
inline std::size_t hash_std_list_dogen_quilt_cpp_formattables_helper_instance_properties(const std::list<dogen::quilt::cpp::formattables::helper_instance_properties>& v) {
    std::size_t seed(0);
    for (const auto i : v) {
        combine(seed, i);
    }
