...
std::unordered_map<dogen::yarn::name, std::unordered_map<std::string, dogen::quilt::cpp::formattables::path_derivatives> > create_std_unordered_map_dogen_yarn_name_std_unordered_map_std_string_dogen_quilt_cpp_formattables_path_derivatives_(unsigned int position) {
...
populate(const unsigned int position, result_type& v) {
    v.path_derivatives_by_name(create_std_unordered_map_dogen_yarn_name_std_unordered_map_std_string_dogen_quilt_cpp_formattables_path_derivatives_(position + 0));
}
