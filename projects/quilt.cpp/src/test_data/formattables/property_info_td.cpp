...
create_dogen_quilt_cpp_formattables_nested_type_info(const unsigned int position) {
    return dogen::quilt::cpp::formattables::nested_type_info_generator::create(position);
}
...
populate(const unsigned int position, result_type& v) {
    ...
    v.type(create_dogen_quilt_cpp_formattables_nested_type_info(position + 3));
