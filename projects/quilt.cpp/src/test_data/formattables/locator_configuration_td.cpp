...
dogen::quilt::cpp::formattables::locator_facet_configuration
create_dogen_quilt_cpp_formattables_locator_facet_configuration(const unsigned int position) {
    return dogen::quilt::cpp::formattables::locator_facet_configuration_generator::create(position);
}

std::unordered_map<std::string, dogen::quilt::cpp::formattables::locator_facet_configuration> create_std_unordered_map_std_string_dogen_quilt_cpp_formattables_locator_facet_configuration(unsigned int position) {
    std::unordered_map<std::string, dogen::quilt::cpp::formattables::locator_facet_configuration> r;
    for (unsigned int i(0); i < 4; ++i) {
        r.insert(std::make_pair(create_std_string(position + i), create_dogen_quilt_cpp_formattables_locator_facet_configuration(position + i)));
    }
    return r;
}
