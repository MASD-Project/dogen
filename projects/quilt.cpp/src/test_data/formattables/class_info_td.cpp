...
#include "dogen/quilt.cpp/test_data/formattables/parent_info_td.hpp"
#include "dogen/quilt.cpp/test_data/formattables/property_info_td.hpp"

namespace {

dogen::quilt::cpp::formattables::property_info
create_dogen_quilt_cpp_formattables_property_info(const unsigned int position) {
    return dogen::quilt::cpp::formattables::property_info_generator::create(position);
}

std::list<dogen::quilt::cpp::formattables::property_info> create_std_list_dogen_quilt_cpp_formattables_property_info(unsigned int position) {
    std::list<dogen::quilt::cpp::formattables::property_info> r;
    for (unsigned int i(0); i < 4; ++i) {
        r.push_back(create_dogen_quilt_cpp_formattables_property_info(position + i));
    }
    return r;
}
...
dogen::quilt::cpp::formattables::parent_info
create_dogen_quilt_cpp_formattables_parent_info(const unsigned int position) {
    return dogen::quilt::cpp::formattables::parent_info_generator::create(position);
}

std::list<dogen::quilt::cpp::formattables::parent_info> create_std_list_dogen_quilt_cpp_formattables_parent_info(unsigned int position) {
    std::list<dogen::quilt::cpp::formattables::parent_info> r;
    for (unsigned int i(0); i < 4; ++i) {
        r.push_back(create_dogen_quilt_cpp_formattables_parent_info(position + i));
    }
    return r;
}
...
populate(const unsigned int position, result_type& v) {
    dogen::quilt::cpp::formattables::entity_generator::populate(position, v);
    v.properties(create_std_list_dogen_quilt_cpp_formattables_property_info(position + 0));
    v.all_properties(create_std_list_dogen_quilt_cpp_formattables_property_info(position + 1));
    ...
    v.parents(create_std_list_dogen_quilt_cpp_formattables_parent_info(position + 5));
