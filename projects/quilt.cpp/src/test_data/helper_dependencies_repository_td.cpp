...
helper_dependencies_repository_generator::create(const unsigned int position) {
    helper_dependencies_repository r;
    helper_dependencies_repository_generator::populate(position, r);
    return r;
}

helper_dependencies_repository_generator::result_type*
helper_dependencies_repository_generator::create_ptr(const unsigned int position) {
    helper_dependencies_repository* p = new helper_dependencies_repository();
    helper_dependencies_repository_generator::populate(position, *p);
    return p;
}

helper_dependencies_repository_generator::result_type
helper_dependencies_repository_generator::operator()() {
