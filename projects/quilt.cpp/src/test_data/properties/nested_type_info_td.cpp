...
create_dogen_quilt_cpp_properties_nested_type_info(const unsigned int) {
    return dogen::quilt::cpp::properties::nested_type_info();
}

std::list<dogen::quilt::cpp::properties::nested_type_info> create_std_list_dogen_quilt_cpp_properties_nested_type_info(unsigned int position) {
    std::list<dogen::quilt::cpp::properties::nested_type_info> r;
    for (unsigned int i(0); i < 4; ++i) {
        r.push_back(create_dogen_quilt_cpp_properties_nested_type_info(position + i));
    }
    return r;
}
...
populate(const unsigned int position, result_type& v) {
    ...
    v.children(create_std_list_dogen_quilt_cpp_properties_nested_type_info(position + 15));
