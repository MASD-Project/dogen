...
#include <string>
#include <algorithm>
#include "dogen.org/serialization/entities/affiliated_keyword_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::org::entities::affiliated_keyword& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::org::entities::affiliated_keyword& v, unsigned int version);
