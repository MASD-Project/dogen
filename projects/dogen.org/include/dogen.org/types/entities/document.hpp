...
#include "dogen.org/serialization/entities/document_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::org::entities::document& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::org::entities::document& v, unsigned int version);
