...
#include <string>
#include <algorithm>
#include "dogen.org/serialization/entities/parameter_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::org::entities::parameter& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::org::entities::parameter& v, unsigned int version);
