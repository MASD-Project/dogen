...
#include <string>
#include <algorithm>
#include "dogen.org/serialization/entities/drawer_content_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::org::entities::drawer_content& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::org::entities::drawer_content& v, unsigned int version);
