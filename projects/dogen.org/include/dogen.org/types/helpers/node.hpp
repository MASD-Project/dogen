...
#include "dogen.org/serialization/helpers/node_fwd_ser.hpp"
...
private:
    ...
    friend void boost::serialization::save(Archive& ar, const dogen::org::helpers::node& v, unsigned int version);

    template<typename Archive>
    friend void boost::serialization::load(Archive& ar, dogen::org::helpers::node& v, unsigned int version);
