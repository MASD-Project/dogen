...
BOOST_AUTO_TEST_SUITE(entities_document_tests)

BOOST_AUTO_TEST_CASE(identical_objects_are_equal) {
    dogen::org::entities::document_generator g;
    const auto a(g());
    const auto b(a);
...
BOOST_AUTO_TEST_CASE(moved_objects_are_equal) {
    ...
    g();
    auto a(g());
    const auto b = dogen::org::entities::document();
    const auto c(a);
    BOOST_CHECK(a != b);
    BOOST_CHECK(a == c);
...
BOOST_AUTO_TEST_CASE(xml_roundtrip_produces_the_same_entity) {
    ...
    dogen::org::entities::document b = dogen::org::entities::document();
...
BOOST_AUTO_TEST_CASE(equal_objects_generate_the_same_hash) {
    ...
    std::hash<dogen::org::entities::document> hasher;
