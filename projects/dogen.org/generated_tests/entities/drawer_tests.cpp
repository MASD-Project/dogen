...
BOOST_AUTO_TEST_SUITE(entities_drawer_tests)

BOOST_AUTO_TEST_CASE(identical_objects_are_equal) {
    dogen::org::entities::drawer_generator g;
    const auto a(g());
    const auto b(a);
...
BOOST_AUTO_TEST_CASE(moved_objects_are_equal) {
    ...
    g();
    auto a(g());
    const auto b = dogen::org::entities::drawer();
    const auto c(a);
    BOOST_CHECK(a != b);
    BOOST_CHECK(a == c);
...
BOOST_AUTO_TEST_CASE(xml_roundtrip_produces_the_same_entity) {
    ...
    dogen::org::entities::drawer b = dogen::org::entities::drawer();
...
BOOST_AUTO_TEST_CASE(equal_objects_generate_the_same_hash) {
    ...
    std::hash<dogen::org::entities::drawer> hasher;
