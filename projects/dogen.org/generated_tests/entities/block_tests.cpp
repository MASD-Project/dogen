...
#include "dogen.org/hash/entities/block_hash.hpp"
...
BOOST_AUTO_TEST_SUITE(entities_block_tests)

BOOST_AUTO_TEST_CASE(identical_objects_are_equal) {
    dogen::org::entities::block_generator g;
    const auto a(g());
    const auto b(a);
...
BOOST_AUTO_TEST_CASE(moved_objects_are_equal) {
    ...
    g();
    auto a(g());
    const auto b = dogen::org::entities::block();
    const auto c(a);
    BOOST_CHECK(a != b);
    BOOST_CHECK(a == c);
...
BOOST_AUTO_TEST_CASE(xml_roundtrip_produces_the_same_entity) {
    ...
    dogen::org::entities::block b = dogen::org::entities::block();
...
BOOST_AUTO_TEST_CASE(equal_objects_generate_the_same_hash) {
    ...
    std::hash<dogen::org::entities::block> hasher;
