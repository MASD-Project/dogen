...
#include "dogen.org/serialization/registrar_ser.hpp"
...
BOOST_AUTO_TEST_SUITE(entities_affiliated_keyword_tests)

BOOST_AUTO_TEST_CASE(identical_objects_are_equal) {
    dogen::org::entities::affiliated_keyword_generator g;
    const auto a(g());
    const auto b(a);
...
BOOST_AUTO_TEST_CASE(moved_objects_are_equal) {
    ...
    g();
    auto a(g());
    const auto b = dogen::org::entities::affiliated_keyword();
    const auto c(a);
    BOOST_CHECK(a != b);
    BOOST_CHECK(a == c);
...
BOOST_AUTO_TEST_CASE(assigned_objects_are_equal) {
    ...
    g();
    const auto a(g());
    dogen::org::entities::affiliated_keyword b;
    BOOST_CHECK(a != b);
...
BOOST_AUTO_TEST_CASE(copy_constructed_objects_are_equal) {
    ...
    b = dogen::org::entities::affiliated_keyword();
    BOOST_CHECK(a != b);
}
...
BOOST_AUTO_TEST_CASE(xml_roundtrip_produces_the_same_entity) {
    ...
    {
        xml_oarchive oa(os);
        dogen::org::registrar::register_types<xml_oarchive>(oa);
        oa << BOOST_SERIALIZATION_NVP(a);
    }

    dogen::org::entities::affiliated_keyword b = dogen::org::entities::affiliated_keyword();
    std::istringstream is(os.str());
    {
        xml_iarchive ia(is);
        dogen::org::registrar::register_types<xml_iarchive>(ia);
...
BOOST_AUTO_TEST_CASE(text_roundtrip_produces_the_same_entity) {
    ...
    {
        text_oarchive oa(os);
        dogen::org::registrar::register_types<text_oarchive>(oa);
        oa << a;
    }
    ...
    {
        text_iarchive ia(is);
        dogen::org::registrar::register_types<text_iarchive>(ia);
        ia >> b;
    }
...
BOOST_AUTO_TEST_CASE(binary_roundtrip_produces_the_same_entity) {
    ...
    std::ostringstream os;
    {
        ...
        dogen::org::registrar::register_types<binary_oarchive>(oa);
        oa << a;
    }
    ...
    std::istringstream is(os.str());
    {
        ...
        dogen::org::registrar::register_types<binary_iarchive>(ia);
        ia >> b;
    }
...
BOOST_AUTO_TEST_CASE(equal_objects_generate_the_same_hash) {
    ...
    std::hash<dogen::org::entities::affiliated_keyword> hasher;
