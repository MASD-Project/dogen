 ...
 *
 */
#ifndef DOGEN_TWO_LAYERS_WITH_OBJECTS_DOMAIN_VERSIONED_KEY_HPP
#define DOGEN_TWO_LAYERS_WITH_OBJECTS_DOMAIN_VERSIONED_KEY_HPP
...
#include "dogen/two_layers_with_objects/serialization/versioned_key_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::two_layers_with_objects::versioned_key& lhs,
    dogen::two_layers_with_objects::versioned_key& rhs) {
    lhs.swap(rhs);
}
