 ...
 *
 */
#ifndef DOGEN_TWO_LAYERS_WITH_OBJECTS_DOMAIN_UNVERSIONED_KEY_HPP
#define DOGEN_TWO_LAYERS_WITH_OBJECTS_DOMAIN_UNVERSIONED_KEY_HPP
...
#include <algorithm>
#include "dogen/two_layers_with_objects/serialization/unversioned_key_fwd_ser.hpp"
...
public:
    friend class dogen::two_layers_with_objects::unversioned_key_serializer;
...
template<>
inline void swap(
    dogen::two_layers_with_objects::unversioned_key& lhs,
    dogen::two_layers_with_objects::unversioned_key& rhs) {
    lhs.swap(rhs);
}
