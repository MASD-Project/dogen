...
if(DEFINED code_coverage)
    if (code_coverage EQUAL 1)
        ...
        if(NOT CTEST_COVERAGE_COMMAND)
            message(STATUS "llvm-cov not found, disabling coverage.")
            set(WITH_COVERAGE false)
        else()
            message(STATUS "Found llvm-cov (${CTEST_COVERAGE_COMMAND})...")
            set(cmake_defines ${cmake_defines} "-DWITH_PROFILING=On")
            set(CTEST_COVERAGE_EXTRA_FLAGS "gcov >/dev/null 2>&1")
